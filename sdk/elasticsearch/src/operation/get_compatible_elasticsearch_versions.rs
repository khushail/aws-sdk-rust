...
impl GetCompatibleElasticsearchVersionsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2015-01-01/es/compatibleVersions").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_compatible_elasticsearch_versions::GetCompatibleElasticsearchVersionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `GetCompatibleElasticsearchVersions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCompatibleElasticsearchVersions {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_compatible_elasticsearch_versions::de_get_compatible_elasticsearch_versions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_compatible_elasticsearch_versions::de_get_compatible_elasticsearch_versions_http_response_with_props(status, headers, body)
                     }
                }
