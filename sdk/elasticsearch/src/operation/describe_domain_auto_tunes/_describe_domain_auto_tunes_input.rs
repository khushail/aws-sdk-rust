...
impl DescribeDomainAutoTunesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_domain_auto_tunes::DescribeDomainAutoTunesInput, ::aws_smithy_http::operation::error::BuildError> {
