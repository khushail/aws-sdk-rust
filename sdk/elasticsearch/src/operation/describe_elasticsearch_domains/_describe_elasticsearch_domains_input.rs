...
impl DescribeElasticsearchDomainsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_elasticsearch_domains::DescribeElasticsearchDomainsInput, ::aws_smithy_http::operation::error::BuildError> {
