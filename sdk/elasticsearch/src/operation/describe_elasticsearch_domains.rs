...
impl DescribeElasticsearchDomainsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeElasticsearchDomains`](crate::operation::describe_elasticsearch_domains::DescribeElasticsearchDomains)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_elasticsearch_domains::DescribeElasticsearchDomains, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_elasticsearch_domains::DescribeElasticsearchDomainsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2015-01-01/es/domain-info").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_elasticsearch_domains::DescribeElasticsearchDomains::new())
...
/// Orchestration and serialization glue logic for `DescribeElasticsearchDomains`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeElasticsearchDomains {
                type Output = ::std::result::Result<crate::operation::describe_elasticsearch_domains::DescribeElasticsearchDomainsOutput, crate::operation::describe_elasticsearch_domains::DescribeElasticsearchDomainsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_elasticsearch_domains::de_describe_elasticsearch_domains_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_elasticsearch_domains::de_describe_elasticsearch_domains_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_elasticsearch_domains::DescribeElasticsearchDomainsError {
...
pub use crate::operation::describe_elasticsearch_domains::_describe_elasticsearch_domains_output::DescribeElasticsearchDomainsOutput;

pub use crate::operation::describe_elasticsearch_domains::_describe_elasticsearch_domains_input::DescribeElasticsearchDomainsInput;

mod _describe_elasticsearch_domains_input;

mod _describe_elasticsearch_domains_output;
