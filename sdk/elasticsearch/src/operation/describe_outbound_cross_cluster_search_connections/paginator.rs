...
/// Paginator for [`DescribeOutboundCrossClusterSearchConnections`](crate::operation::describe_outbound_cross_cluster_search_connections::DescribeOutboundCrossClusterSearchConnections)
            ...
            impl DescribeOutboundCrossClusterSearchConnectionsPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::describe_outbound_cross_cluster_search_connections::builders::DescribeOutboundCrossClusterSearchConnectionsInputBuilder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::describe_outbound_cross_cluster_search_connections::DescribeOutboundCrossClusterSearchConnectionsOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_outbound_cross_cluster_search_connections::DescribeOutboundCrossClusterSearchConnectionsError>>> + ::std::marker::Unpin
                 {
