...
impl DeleteElasticsearchServiceRoleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_elasticsearch_service_role::DeleteElasticsearchServiceRoleInput, ::aws_smithy_http::operation::error::BuildError> {
