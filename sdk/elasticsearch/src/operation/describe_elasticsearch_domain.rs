...
impl DescribeElasticsearchDomainInput {
    /// Consumes the builder and constructs an Operation<[`DescribeElasticsearchDomain`](crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2015-01-01/es/domain/{DomainName}", DomainName = domain_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeElasticsearchDomain", "elasticsearchservice"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeElasticsearchDomain`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeElasticsearchDomain {
                type Output = ::std::result::Result<crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainOutput, crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_elasticsearch_domain::de_describe_elasticsearch_domain_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_elasticsearch_domain::de_describe_elasticsearch_domain_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_elasticsearch_domain::DescribeElasticsearchDomainError {
...
pub use crate::operation::describe_elasticsearch_domain::_describe_elasticsearch_domain_output::DescribeElasticsearchDomainOutput;

pub use crate::operation::describe_elasticsearch_domain::_describe_elasticsearch_domain_input::DescribeElasticsearchDomainInput;

mod _describe_elasticsearch_domain_input;

mod _describe_elasticsearch_domain_output;
