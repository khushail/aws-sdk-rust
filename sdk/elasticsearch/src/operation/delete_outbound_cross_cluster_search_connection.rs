...
impl DeleteOutboundCrossClusterSearchConnectionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteOutboundCrossClusterSearchConnection`](crate::operation::delete_outbound_cross_cluster_search_connection::DeleteOutboundCrossClusterSearchConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_outbound_cross_cluster_search_connection::DeleteOutboundCrossClusterSearchConnection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_outbound_cross_cluster_search_connection::DeleteOutboundCrossClusterSearchConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2015-01-01/es/ccs/outboundConnection/{CrossClusterSearchConnectionId}", CrossClusterSearchConnectionId = cross_cluster_search_connection_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::delete_outbound_cross_cluster_search_connection::DeleteOutboundCrossClusterSearchConnectionInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_outbound_cross_cluster_search_connection::DeleteOutboundCrossClusterSearchConnection::new())
...
/// Orchestration and serialization glue logic for `DeleteOutboundCrossClusterSearchConnection`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteOutboundCrossClusterSearchConnection {
                type Output = ::std::result::Result<crate::operation::delete_outbound_cross_cluster_search_connection::DeleteOutboundCrossClusterSearchConnectionOutput, crate::operation::delete_outbound_cross_cluster_search_connection::DeleteOutboundCrossClusterSearchConnectionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_outbound_cross_cluster_search_connection::de_delete_outbound_cross_cluster_search_connection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_outbound_cross_cluster_search_connection::de_delete_outbound_cross_cluster_search_connection_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_outbound_cross_cluster_search_connection::DeleteOutboundCrossClusterSearchConnectionError {
...
mod _delete_outbound_cross_cluster_search_connection_output;
