...
impl super::Client  {
    ...
    ///   - [`package_id(impl ::std::convert::Into<String>)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::package_id) / [`set_package_id(Option<String>)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::set_package_id): <p>The package for which to list domains.</p>
    ///   - [`max_results(i32)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::set_max_results): <p>Limits results to a maximum number of domains.</p>
