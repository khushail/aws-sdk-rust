...
impl super::Client  {
    ...
    ///   - [`max_results(i32)`](crate::operation::describe_packages::builders::DescribePackagesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::describe_packages::builders::DescribePackagesFluentBuilder::set_max_results): <p>Limits results to a maximum number of packages.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_packages::builders::DescribePackagesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_packages::builders::DescribePackagesFluentBuilder::set_next_token): <p>Used for pagination. Only necessary if a previous API call includes a non-null NextToken value. If provided, returns results for the next page.</p>
