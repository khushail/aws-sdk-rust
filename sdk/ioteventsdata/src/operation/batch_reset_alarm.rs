...
impl BatchResetAlarmInput {
    /// Consumes the builder and constructs an Operation<[`BatchResetAlarm`](crate::operation::batch_reset_alarm::BatchResetAlarm)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_reset_alarm::BatchResetAlarm, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_reset_alarm::BatchResetAlarmInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/alarms/reset").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_reset_alarm::BatchResetAlarm::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchResetAlarm", "ioteventsdata"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchResetAlarm`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchResetAlarm {
                type Output = ::std::result::Result<crate::operation::batch_reset_alarm::BatchResetAlarmOutput, crate::operation::batch_reset_alarm::BatchResetAlarmError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_batch_reset_alarm::de_batch_reset_alarm_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_reset_alarm::de_batch_reset_alarm_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_reset_alarm::BatchResetAlarmError {
