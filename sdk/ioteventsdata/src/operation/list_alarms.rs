...
impl ListAlarmsInput {
    /// Consumes the builder and constructs an Operation<[`ListAlarms`](crate::operation::list_alarms::ListAlarms)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_alarms::ListAlarms, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_alarms::ListAlarmsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_alarms::ListAlarmsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_alarms::ListAlarms::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAlarms {
                type Output = ::std::result::Result<crate::operation::list_alarms::ListAlarmsOutput, crate::operation::list_alarms::ListAlarmsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_alarms::de_list_alarms_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_alarms::ListAlarmsError {
