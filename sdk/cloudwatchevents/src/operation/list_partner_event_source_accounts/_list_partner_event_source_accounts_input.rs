...
impl ListPartnerEventSourceAccountsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_partner_event_source_accounts::ListPartnerEventSourceAccountsInput, ::aws_smithy_http::operation::error::BuildError> {
