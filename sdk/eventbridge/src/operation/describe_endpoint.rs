...
impl DescribeEndpointInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_endpoint::DescribeEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_endpoint::DescribeEndpoint::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeEndpoint", "eventbridge"));
...
impl DescribeEndpointError {
    ...
    /// Returns `true` if the error kind is `DescribeEndpointError::InternalException`.
