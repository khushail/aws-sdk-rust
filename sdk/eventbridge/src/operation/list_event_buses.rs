...
impl ListEventBusesInput {
    /// Consumes the builder and constructs an Operation<[`ListEventBuses`](crate::operation::list_event_buses::ListEventBuses)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_event_buses::ListEventBuses, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_event_buses::ListEventBusesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_event_buses::ListEventBuses::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListEventBuses", "eventbridge"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEventBuses {
                type Output = ::std::result::Result<crate::operation::list_event_buses::ListEventBusesOutput, crate::operation::list_event_buses::ListEventBusesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_event_buses::de_list_event_buses_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_event_buses::ListEventBusesError {
