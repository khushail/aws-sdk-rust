...
impl DeleteEndpointInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_endpoint::DeleteEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_endpoint::DeleteEndpoint::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteEndpoint", "eventbridge"));
...
impl DeleteEndpointError {
    ...
    /// Returns `true` if the error kind is `DeleteEndpointError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `DeleteEndpointError::InternalException`.
