...
impl TestEventPatternInput {
    /// Consumes the builder and constructs an Operation<[`TestEventPattern`](crate::operation::test_event_pattern::TestEventPattern)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::test_event_pattern::TestEventPattern, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::test_event_pattern::TestEventPatternInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::test_event_pattern::TestEventPattern::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("TestEventPattern", "eventbridge"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `TestEventPattern`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for TestEventPattern {
                type Output = ::std::result::Result<crate::operation::test_event_pattern::TestEventPatternOutput, crate::operation::test_event_pattern::TestEventPatternError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_test_event_pattern::de_test_event_pattern_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_test_event_pattern::de_test_event_pattern_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::test_event_pattern::TestEventPatternError {
...
mod _test_event_pattern_output;
