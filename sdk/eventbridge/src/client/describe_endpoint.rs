...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::describe_endpoint::builders::DescribeEndpointFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::describe_endpoint::builders::DescribeEndpointFluentBuilder::set_name): <p>The name of the endpoint you want to get information about. For example, <code>"Name":"us-east-2-custom_bus_A-endpoint"</code>.</p>
    ///   - [`home_region(impl ::std::convert::Into<String>)`](crate::operation::describe_endpoint::builders::DescribeEndpointFluentBuilder::home_region) / [`set_home_region(Option<String>)`](crate::operation::describe_endpoint::builders::DescribeEndpointFluentBuilder::set_home_region): <p>The primary Region of the endpoint you want to get information about. For example <code>"HomeRegion": "us-east-1"</code>.</p>
