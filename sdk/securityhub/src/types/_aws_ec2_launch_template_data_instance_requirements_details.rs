...
impl AwsEc2LaunchTemplateDataInstanceRequirementsDetailsBuilder {
    ...
    /// <p> The minimum and maximum amount of total accelerator memory, in MiB. </p>
    pub fn get_accelerator_total_memory_mi_b(&self) -> &::std::option::Option<crate::types::AwsEc2LaunchTemplateDataInstanceRequirementsAcceleratorTotalMemoryMiBDetails> {
    ...
    /// <p> The minimum and maximum amount of memory per vCPU, in GiB. </p>
    pub fn get_memory_gi_b_per_v_cpu(&self) -> &::std::option::Option<crate::types::AwsEc2LaunchTemplateDataInstanceRequirementsMemoryGiBPerVCpuDetails> {
