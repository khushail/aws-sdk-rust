...
pub struct AutomationRulesConfig  {
    ...
    /// <p> Whether the rule is active after it is created. If this parameter is equal to <code>&gt;ENABLED</code>, Security Hub will apply the rule to findings and finding updates after the rule is created. </p>
    #[doc(hidden)]
