...
/// <p> Identifies the finding fields that the automation rule action will update when a finding matches the defined criteria. </p>
#[non_exhaustive]
...
pub struct AutomationRulesFindingFieldsUpdate  {
    ...
    /// <p> The rule action will update the <code>VerificationState</code> field of a finding. </p>
    #[doc(hidden)]
    pub verification_state: ::std::option::Option<crate::types::VerificationState>,
    /// <p> The rule action will update the <code>Confidence</code> field of a finding. </p>
    #[doc(hidden)]
    pub confidence: i32,
    /// <p> The rule action will update the <code>Criticality</code> field of a finding. </p>
    #[doc(hidden)]
    pub criticality: i32,
    /// <p> The rule action will update the <code>Types</code> field of a finding. </p>
    #[doc(hidden)]
    pub types: ::std::option::Option<::std::vec::Vec<::std::string::String>>,
    /// <p> The rule action will update the <code>UserDefinedFields</code> field of a finding. </p>
    #[doc(hidden)]
