...
pub(crate) fn de_aws_api_gateway_v2_route_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsApiGatewayV2RouteSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
