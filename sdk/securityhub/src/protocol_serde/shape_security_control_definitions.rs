...
pub(crate) fn de_security_control_definitions<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::SecurityControlDefinition>>, ::aws_smithy_json::deserialize::error::DeserializeError>
