...
pub(crate) fn de_aws_guard_duty_detector_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsGuardDutyDetectorDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
