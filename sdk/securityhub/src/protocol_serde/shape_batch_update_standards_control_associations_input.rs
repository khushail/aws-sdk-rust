...
pub fn ser_batch_update_standards_control_associations_input(
        ...
        for item_3 in var_1 {
             {
                ...
                crate::protocol_serde::shape_standards_control_association_update::ser_standards_control_association_update(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
