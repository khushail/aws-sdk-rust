...
pub(crate) fn de_aws_open_search_service_domain_advanced_security_options_details<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsOpenSearchServiceDomainAdvancedSecurityOptionsDetails>, ::aws_smithy_json::deserialize::error::DeserializeError>
