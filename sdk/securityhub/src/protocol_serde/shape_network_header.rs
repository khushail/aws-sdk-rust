...
pub(crate) fn de_network_header<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::NetworkHeader>, ::aws_smithy_json::deserialize::error::DeserializeError>
