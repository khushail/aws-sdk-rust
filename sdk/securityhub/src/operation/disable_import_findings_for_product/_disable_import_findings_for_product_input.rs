...
impl DisableImportFindingsForProductInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disable_import_findings_for_product::DisableImportFindingsForProductInput, ::aws_smithy_http::operation::error::BuildError> {
