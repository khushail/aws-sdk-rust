...
impl UpdateActionTargetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateActionTarget`](crate::operation::update_action_target::UpdateActionTarget)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_action_target::UpdateActionTarget, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_action_target::UpdateActionTargetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if action_target_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("action_target_arn", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_action_target::UpdateActionTarget::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateActionTarget", "securityhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateActionTarget`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateActionTarget {
                type Output = ::std::result::Result<crate::operation::update_action_target::UpdateActionTargetOutput, crate::operation::update_action_target::UpdateActionTargetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_action_target::de_update_action_target_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_action_target::de_update_action_target_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_action_target::UpdateActionTargetError {
...
mod _update_action_target_output;
