...
impl BatchUpdateAutomationRulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_update_automation_rules::BatchUpdateAutomationRulesInput, ::aws_smithy_http::operation::error::BuildError> {
