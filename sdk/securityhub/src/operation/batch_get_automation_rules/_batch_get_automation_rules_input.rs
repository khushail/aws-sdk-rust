...
impl BatchGetAutomationRulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_get_automation_rules::BatchGetAutomationRulesInput, ::aws_smithy_http::operation::error::BuildError> {
