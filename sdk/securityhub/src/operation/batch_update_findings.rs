...
impl BatchUpdateFindingsInput {
    /// Consumes the builder and constructs an Operation<[`BatchUpdateFindings`](crate::operation::batch_update_findings::BatchUpdateFindings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_update_findings::BatchUpdateFindings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_update_findings::BatchUpdateFindingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/findings/batchupdate").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_update_findings::BatchUpdateFindings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchUpdateFindings {
                type Output = ::std::result::Result<crate::operation::batch_update_findings::BatchUpdateFindingsOutput, crate::operation::batch_update_findings::BatchUpdateFindingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_update_findings::de_batch_update_findings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_update_findings::de_batch_update_findings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_update_findings::BatchUpdateFindingsError {
...
pub use crate::operation::batch_update_findings::_batch_update_findings_output::BatchUpdateFindingsOutput;

pub use crate::operation::batch_update_findings::_batch_update_findings_input::BatchUpdateFindingsInput;

mod _batch_update_findings_input;

mod _batch_update_findings_output;
