...
impl UpdateSecurityHubConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
