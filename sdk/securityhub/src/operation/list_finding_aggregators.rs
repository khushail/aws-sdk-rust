...
impl ListFindingAggregatorsInput {
    /// Consumes the builder and constructs an Operation<[`ListFindingAggregators`](crate::operation::list_finding_aggregators::ListFindingAggregators)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_finding_aggregators::ListFindingAggregators, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_finding_aggregators::ListFindingAggregatorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/findingAggregator/list").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_finding_aggregators::ListFindingAggregatorsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_finding_aggregators::ListFindingAggregatorsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_finding_aggregators::ListFindingAggregators::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFindingAggregators {
                type Output = ::std::result::Result<crate::operation::list_finding_aggregators::ListFindingAggregatorsOutput, crate::operation::list_finding_aggregators::ListFindingAggregatorsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_finding_aggregators::de_list_finding_aggregators_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_finding_aggregators::de_list_finding_aggregators_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_finding_aggregators::ListFindingAggregatorsError {
...
pub use crate::operation::list_finding_aggregators::_list_finding_aggregators_output::ListFindingAggregatorsOutput;

pub use crate::operation::list_finding_aggregators::_list_finding_aggregators_input::ListFindingAggregatorsInput;

mod _list_finding_aggregators_input;

mod _list_finding_aggregators_output;
