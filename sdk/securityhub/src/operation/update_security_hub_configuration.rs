...
impl UpdateSecurityHubConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSecurityHubConfiguration`](crate::operation::update_security_hub_configuration::UpdateSecurityHubConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_security_hub_configuration::UpdateSecurityHubConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_security_hub_configuration::UpdateSecurityHubConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSecurityHubConfiguration {
                type Output = ::std::result::Result<crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationOutput, crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_security_hub_configuration::de_update_security_hub_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_security_hub_configuration::de_update_security_hub_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateSecurityHubConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_security_hub_configuration::UpdateSecurityHubConfigurationError {
...
mod _update_security_hub_configuration_output;
