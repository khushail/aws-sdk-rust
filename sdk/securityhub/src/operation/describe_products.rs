...
impl DescribeProductsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeProducts`](crate::operation::describe_products::DescribeProducts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_products::DescribeProducts, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_products::DescribeProductsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/products").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_products::DescribeProductsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.product_arn {
                     {
                        query.push_kv("ProductArn", &::aws_smithy_http::query::fmt_string(&inner_3));
                    }
                }
                ::std::result::Result::Ok(())
            }
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_products::DescribeProductsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_products::DescribeProducts::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeProducts {
                type Output = ::std::result::Result<crate::operation::describe_products::DescribeProductsOutput, crate::operation::describe_products::DescribeProductsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_products::de_describe_products_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_products::de_describe_products_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_products::DescribeProductsError {
...
pub use crate::operation::describe_products::_describe_products_output::DescribeProductsOutput;

pub use crate::operation::describe_products::_describe_products_input::DescribeProductsInput;

mod _describe_products_input;

mod _describe_products_output;
