...
impl EnableImportFindingsForProductInput {
    /// Consumes the builder and constructs an Operation<[`EnableImportFindingsForProduct`](crate::operation::enable_import_findings_for_product::EnableImportFindingsForProduct)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProduct, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_import_findings_for_product::EnableImportFindingsForProduct::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("EnableImportFindingsForProduct", "securityhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `EnableImportFindingsForProduct`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableImportFindingsForProduct {
                type Output = ::std::result::Result<crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductOutput, crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_enable_import_findings_for_product::de_enable_import_findings_for_product_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_enable_import_findings_for_product::de_enable_import_findings_for_product_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnableImportFindingsForProductError {
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_import_findings_for_product::EnableImportFindingsForProductError {
...
mod _enable_import_findings_for_product_output;
