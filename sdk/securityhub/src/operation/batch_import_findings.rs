...
impl BatchImportFindingsInput {
    /// Consumes the builder and constructs an Operation<[`BatchImportFindings`](crate::operation::batch_import_findings::BatchImportFindings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_import_findings::BatchImportFindings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_import_findings::BatchImportFindingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/findings/import").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_import_findings::BatchImportFindings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchImportFindings {
                type Output = ::std::result::Result<crate::operation::batch_import_findings::BatchImportFindingsOutput, crate::operation::batch_import_findings::BatchImportFindingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_import_findings::de_batch_import_findings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_import_findings::de_batch_import_findings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_import_findings::BatchImportFindingsError {
...
pub use crate::operation::batch_import_findings::_batch_import_findings_output::BatchImportFindingsOutput;

pub use crate::operation::batch_import_findings::_batch_import_findings_input::BatchImportFindingsInput;

mod _batch_import_findings_input;

mod _batch_import_findings_output;
