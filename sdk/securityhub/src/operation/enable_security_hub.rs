...
impl EnableSecurityHubInput {
    /// Consumes the builder and constructs an Operation<[`EnableSecurityHub`](crate::operation::enable_security_hub::EnableSecurityHub)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::enable_security_hub::EnableSecurityHub, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_security_hub::EnableSecurityHubInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_security_hub::EnableSecurityHub::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("EnableSecurityHub", "securityhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `EnableSecurityHub`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableSecurityHub {
                type Output = ::std::result::Result<crate::operation::enable_security_hub::EnableSecurityHubOutput, crate::operation::enable_security_hub::EnableSecurityHubError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_enable_security_hub::de_enable_security_hub_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_enable_security_hub::de_enable_security_hub_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_security_hub::EnableSecurityHubError {
...
pub use crate::operation::enable_security_hub::_enable_security_hub_output::EnableSecurityHubOutput;

pub use crate::operation::enable_security_hub::_enable_security_hub_input::EnableSecurityHubInput;

mod _enable_security_hub_input;

mod _enable_security_hub_output;
