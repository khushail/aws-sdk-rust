...
impl BatchDeleteAutomationRulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_delete_automation_rules::BatchDeleteAutomationRulesInput, ::aws_smithy_http::operation::error::BuildError> {
