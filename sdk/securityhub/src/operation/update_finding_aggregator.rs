...
impl UpdateFindingAggregatorInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFindingAggregator`](crate::operation::update_finding_aggregator::UpdateFindingAggregator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_finding_aggregator::UpdateFindingAggregator, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_finding_aggregator::UpdateFindingAggregatorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/findingAggregator/update").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_finding_aggregator::UpdateFindingAggregator::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateFindingAggregator", "securityhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateFindingAggregator`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFindingAggregator {
                type Output = ::std::result::Result<crate::operation::update_finding_aggregator::UpdateFindingAggregatorOutput, crate::operation::update_finding_aggregator::UpdateFindingAggregatorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_finding_aggregator::de_update_finding_aggregator_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_finding_aggregator::de_update_finding_aggregator_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_finding_aggregator::UpdateFindingAggregatorError {
...
mod _update_finding_aggregator_output;
