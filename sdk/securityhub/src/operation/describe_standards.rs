...
impl DescribeStandardsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeStandards`](crate::operation::describe_standards::DescribeStandards)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_standards::DescribeStandards, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_standards::DescribeStandardsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/standards").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_standards::DescribeStandardsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_standards::DescribeStandardsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_standards::DescribeStandards::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeStandards", "securityhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeStandards`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStandards {
                type Output = ::std::result::Result<crate::operation::describe_standards::DescribeStandardsOutput, crate::operation::describe_standards::DescribeStandardsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_standards::de_describe_standards_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_standards::de_describe_standards_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_standards::DescribeStandardsError {
...
mod _describe_standards_output;
