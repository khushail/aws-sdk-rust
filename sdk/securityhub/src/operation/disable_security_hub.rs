...
impl DisableSecurityHubInput {
    /// Consumes the builder and constructs an Operation<[`DisableSecurityHub`](crate::operation::disable_security_hub::DisableSecurityHub)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_security_hub::DisableSecurityHub, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_security_hub::DisableSecurityHubInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::disable_security_hub::DisableSecurityHubInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_security_hub::DisableSecurityHub::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableSecurityHub {
                type Output = ::std::result::Result<crate::operation::disable_security_hub::DisableSecurityHubOutput, crate::operation::disable_security_hub::DisableSecurityHubError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disable_security_hub::de_disable_security_hub_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disable_security_hub::de_disable_security_hub_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_security_hub::DisableSecurityHubError {
...
pub use crate::operation::disable_security_hub::_disable_security_hub_output::DisableSecurityHubOutput;

pub use crate::operation::disable_security_hub::_disable_security_hub_input::DisableSecurityHubInput;

mod _disable_security_hub_input;

mod _disable_security_hub_output;
