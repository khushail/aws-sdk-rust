...
impl DescribeStandardsControlsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeStandardsControls`](crate::operation::describe_standards_controls::DescribeStandardsControls)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_standards_controls::DescribeStandardsControls, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_standards_controls::DescribeStandardsControlsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.standards_subscription_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("standards_subscription_arn", "cannot be empty or unset"))?;
                let standards_subscription_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Greedy);
                if standards_subscription_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("standards_subscription_arn", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/standards/controls/{StandardsSubscriptionArn}", StandardsSubscriptionArn = standards_subscription_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_standards_controls::DescribeStandardsControlsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_standards_controls::DescribeStandardsControlsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_standards_controls::DescribeStandardsControls::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeStandardsControls", "securityhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeStandardsControls`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStandardsControls {
                type Output = ::std::result::Result<crate::operation::describe_standards_controls::DescribeStandardsControlsOutput, crate::operation::describe_standards_controls::DescribeStandardsControlsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_standards_controls::de_describe_standards_controls_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_standards_controls::de_describe_standards_controls_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_standards_controls::DescribeStandardsControlsError {
...
pub use crate::operation::describe_standards_controls::_describe_standards_controls_output::DescribeStandardsControlsOutput;

pub use crate::operation::describe_standards_controls::_describe_standards_controls_input::DescribeStandardsControlsInput;

mod _describe_standards_controls_input;

mod _describe_standards_controls_output;
