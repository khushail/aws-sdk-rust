...
impl UpdateStandardsControlInput {
    /// Consumes the builder and constructs an Operation<[`UpdateStandardsControl`](crate::operation::update_standards_control::UpdateStandardsControl)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_standards_control::UpdateStandardsControl, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_standards_control::UpdateStandardsControlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.standards_control_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("standards_control_arn", "cannot be empty or unset"))?;
                let standards_control_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Greedy);
                if standards_control_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("standards_control_arn", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/standards/control/{StandardsControlArn}", StandardsControlArn = standards_control_arn).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_standards_control::UpdateStandardsControl::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateStandardsControl", "securityhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateStandardsControl`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStandardsControl {
                type Output = ::std::result::Result<crate::operation::update_standards_control::UpdateStandardsControlOutput, crate::operation::update_standards_control::UpdateStandardsControlError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_standards_control::de_update_standards_control_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_standards_control::de_update_standards_control_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_standards_control::UpdateStandardsControlError {
...
mod _update_standards_control_output;
