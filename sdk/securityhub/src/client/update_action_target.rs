...
impl super::Client  {
    ...
    ///   - [`action_target_arn(impl ::std::convert::Into<String>)`](crate::operation::update_action_target::builders::UpdateActionTargetFluentBuilder::action_target_arn) / [`set_action_target_arn(Option<String>)`](crate::operation::update_action_target::builders::UpdateActionTargetFluentBuilder::set_action_target_arn): <p>The ARN of the custom action target to update.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_action_target::builders::UpdateActionTargetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_action_target::builders::UpdateActionTargetFluentBuilder::set_name): <p>The updated name of the custom action target.</p>
