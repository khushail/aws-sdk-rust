...
impl super::Client  {
    ...
    ///   - [`automation_rules_arns(Vec<String>)`](crate::operation::batch_get_automation_rules::builders::BatchGetAutomationRulesFluentBuilder::automation_rules_arns) / [`set_automation_rules_arns(Option<Vec<String>>)`](crate::operation::batch_get_automation_rules::builders::BatchGetAutomationRulesFluentBuilder::set_automation_rules_arns): <p> A list of rule ARNs to get details for. </p>
