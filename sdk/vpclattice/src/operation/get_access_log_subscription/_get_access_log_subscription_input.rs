...
impl GetAccessLogSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_access_log_subscription::GetAccessLogSubscriptionInput, ::aws_smithy_http::operation::error::BuildError> {
