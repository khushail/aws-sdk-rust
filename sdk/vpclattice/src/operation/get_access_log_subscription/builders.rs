...
impl GetAccessLogSubscriptionInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.get_access_log_subscription();
...
impl GetAccessLogSubscriptionFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::get_access_log_subscription::GetAccessLogSubscription, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_access_log_subscription::GetAccessLogSubscriptionOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_access_log_subscription::GetAccessLogSubscriptionError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::get_access_log_subscription::GetAccessLogSubscriptionOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_access_log_subscription::GetAccessLogSubscriptionError>>
                             {
