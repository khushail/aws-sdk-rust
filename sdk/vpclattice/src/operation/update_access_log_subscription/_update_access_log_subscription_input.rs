...
impl UpdateAccessLogSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_access_log_subscription::UpdateAccessLogSubscriptionInput, ::aws_smithy_http::operation::error::BuildError> {
