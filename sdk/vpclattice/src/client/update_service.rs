...
impl super::Client  {
    ...
    ///   - [`service_identifier(impl ::std::convert::Into<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::service_identifier) / [`set_service_identifier(Option<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::set_service_identifier): <p>The ID or Amazon Resource Name (ARN) of the service.</p>
    ///   - [`certificate_arn(impl ::std::convert::Into<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::certificate_arn) / [`set_certificate_arn(Option<String>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::set_certificate_arn): <p>The Amazon Resource Name (ARN) of the certificate. </p>
    ///   - [`auth_type(AuthType)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::auth_type) / [`set_auth_type(Option<AuthType>)`](crate::operation::update_service::builders::UpdateServiceFluentBuilder::set_auth_type): <p>The type of IAM policy.</p>  <ul>   <li> <p> <code>NONE</code>: The resource does not use an IAM policy. This is the default.</p> </li>   <li> <p> <code>AWS_IAM</code>: The resource uses an IAM policy. When this type is used, auth is enabled and an auth policy is required.</p> </li>  </ul>
