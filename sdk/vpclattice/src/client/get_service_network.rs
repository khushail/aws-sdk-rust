...
impl super::Client  {
    ...
    ///   - [`service_network_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_service_network::builders::GetServiceNetworkFluentBuilder::service_network_identifier) / [`set_service_network_identifier(Option<String>)`](crate::operation::get_service_network::builders::GetServiceNetworkFluentBuilder::set_service_network_identifier): <p>The ID or Amazon Resource Name (ARN) of the service network.</p>
