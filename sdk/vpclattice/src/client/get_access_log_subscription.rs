...
impl super::Client  {
    ...
    ///   - [`resource_id(Option<String>)`](crate::operation::get_access_log_subscription::GetAccessLogSubscriptionOutput::resource_id): <p>The ID of the service network or service.</p>
    ///   - [`resource_arn(Option<String>)`](crate::operation::get_access_log_subscription::GetAccessLogSubscriptionOutput::resource_arn): <p>The Amazon Resource Name (ARN) of the service network or service.</p>
    ///   - [`destination_arn(Option<String>)`](crate::operation::get_access_log_subscription::GetAccessLogSubscriptionOutput::destination_arn): <p>The Amazon Resource Name (ARN) of the access log destination.</p>
