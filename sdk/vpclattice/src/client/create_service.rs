...
impl super::Client  {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::set_client_token): <p>A unique, case-sensitive identifier that you provide to ensure the idempotency of the request. If you retry a request that completed successfully using the same client token and parameters, the retry succeeds without performing any actions. If the parameters aren't identical, the retry fails.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::set_name): <p>The name of the service. The name must be unique within the account. The valid characters are a-z, 0-9, and hyphens (-). You can't use a hyphen as the first or last character, or immediately after another hyphen.</p>
    ///   - [`tags(HashMap<String, String>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::set_tags): <p>The tags for the service.</p>
    ///   - [`custom_domain_name(impl ::std::convert::Into<String>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::custom_domain_name) / [`set_custom_domain_name(Option<String>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::set_custom_domain_name): <p>The custom domain name of the service.</p>
    ///   - [`certificate_arn(impl ::std::convert::Into<String>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::certificate_arn) / [`set_certificate_arn(Option<String>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::set_certificate_arn): <p>The Amazon Resource Name (ARN) of the certificate.</p>
    ///   - [`auth_type(AuthType)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::auth_type) / [`set_auth_type(Option<AuthType>)`](crate::operation::create_service::builders::CreateServiceFluentBuilder::set_auth_type): <p>The type of IAM policy.</p>  <ul>   <li> <p> <code>NONE</code>: The resource does not use an IAM policy. This is the default.</p> </li>   <li> <p> <code>AWS_IAM</code>: The resource uses an IAM policy. When this type is used, auth is enabled and an auth policy is required.</p> </li>  </ul>
