...
pub fn de_get_service_network_vpc_association_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationOutput, crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_service_network_vpc_association_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationOutput, crate::operation::get_service_network_vpc_association::GetServiceNetworkVpcAssociationError> {
    Ok({
        #[allow(unused_mut)]
