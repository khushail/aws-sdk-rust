...
impl PutEmailIdentityDkimAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_email_identity_dkim_attributes::PutEmailIdentityDkimAttributesInput, ::aws_smithy_http::operation::error::BuildError> {
