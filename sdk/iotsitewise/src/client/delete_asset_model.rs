...
impl super::Client  {
    ...
    ///   - [`asset_model_id(impl ::std::convert::Into<String>)`](crate::operation::delete_asset_model::builders::DeleteAssetModelFluentBuilder::asset_model_id) / [`set_asset_model_id(Option<String>)`](crate::operation::delete_asset_model::builders::DeleteAssetModelFluentBuilder::set_asset_model_id): <p>The ID of the asset model to delete.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::delete_asset_model::builders::DeleteAssetModelFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_asset_model::builders::DeleteAssetModelFluentBuilder::set_client_token): <p>A unique case-sensitive identifier that you can provide to ensure the idempotency of the request. Don't reuse this client token if a new idempotent request is required.</p>
