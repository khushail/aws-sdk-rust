...
impl super::Client  {
    ...
    ///   - [`gateway_id(impl ::std::convert::Into<String>)`](crate::operation::update_gateway::builders::UpdateGatewayFluentBuilder::gateway_id) / [`set_gateway_id(Option<String>)`](crate::operation::update_gateway::builders::UpdateGatewayFluentBuilder::set_gateway_id): <p>The ID of the gateway to update.</p>
