...
impl UpdateAssetModelInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_asset_model::UpdateAssetModel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_asset_model::UpdateAssetModelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `UpdateAssetModel`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAssetModel {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_update_asset_model::de_update_asset_model_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_asset_model::de_update_asset_model_http_response_with_props(status, headers, body)
                     }
                }
