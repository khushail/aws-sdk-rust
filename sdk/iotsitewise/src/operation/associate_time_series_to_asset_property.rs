...
impl AssociateTimeSeriesToAssetPropertyInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_time_series_to_asset_property::AssociateTimeSeriesToAssetProperty, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_time_series_to_asset_property::AssociateTimeSeriesToAssetPropertyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/timeseries/associate").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::associate_time_series_to_asset_property::AssociateTimeSeriesToAssetPropertyInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateTimeSeriesToAssetProperty {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_time_series_to_asset_property::de_associate_time_series_to_asset_property_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_time_series_to_asset_property::de_associate_time_series_to_asset_property_http_response_with_props(status, headers, body)
                     }
                }
