...
impl BatchPutAssetPropertyValueInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_put_asset_property_value::BatchPutAssetPropertyValue, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_put_asset_property_value::BatchPutAssetPropertyValueInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/properties").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_put_asset_property_value::BatchPutAssetPropertyValue::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchPutAssetPropertyValue {
                type Output = ::std::result::Result<crate::operation::batch_put_asset_property_value::BatchPutAssetPropertyValueOutput, crate::operation::batch_put_asset_property_value::BatchPutAssetPropertyValueError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_put_asset_property_value::de_batch_put_asset_property_value_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_put_asset_property_value::de_batch_put_asset_property_value_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_put_asset_property_value::BatchPutAssetPropertyValueError {
