...
impl BatchDisassociateProjectAssetsInput {
    /// Consumes the builder and constructs an Operation<[`BatchDisassociateProjectAssets`](crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if project_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("project_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/projects/{projectId}/assets/disassociate", projectId = project_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssets::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchDisassociateProjectAssets", "iotsitewise"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchDisassociateProjectAssets`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDisassociateProjectAssets {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_batch_disassociate_project_assets::de_batch_disassociate_project_assets_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for BatchDisassociateProjectAssetsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_disassociate_project_assets::BatchDisassociateProjectAssetsError {
...
pub use crate::operation::batch_disassociate_project_assets::_batch_disassociate_project_assets_output::BatchDisassociateProjectAssetsOutput;

pub use crate::operation::batch_disassociate_project_assets::_batch_disassociate_project_assets_input::BatchDisassociateProjectAssetsInput;

mod _batch_disassociate_project_assets_input;

mod _batch_disassociate_project_assets_output;
