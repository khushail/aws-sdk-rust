...
impl ListAssetModelPropertiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_asset_model_properties::ListAssetModelPropertiesInput, ::aws_smithy_http::operation::error::BuildError> {
