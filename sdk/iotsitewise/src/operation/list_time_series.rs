...
impl ListTimeSeriesInput {
    /// Consumes the builder and constructs an Operation<[`ListTimeSeries`](crate::operation::list_time_series::ListTimeSeries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_time_series::ListTimeSeries, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_time_series::ListTimeSeriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/timeseries").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_time_series::ListTimeSeriesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_4) = &_input.alias_prefix {
                     {
                        query.push_kv("aliasPrefix", &::aws_smithy_http::query::fmt_string(&inner_4));
                    }
                }
                if let ::std::option::Option::Some(inner_5) = &_input.time_series_type {
                     {
                        query.push_kv("timeSeriesType", &::aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                ::std::result::Result::Ok(())
            }
            ...
            fn update_http_builder(
                            input: &crate::operation::list_time_series::ListTimeSeriesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_time_series::ListTimeSeries::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTimeSeries {
                type Output = ::std::result::Result<crate::operation::list_time_series::ListTimeSeriesOutput, crate::operation::list_time_series::ListTimeSeriesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_time_series::de_list_time_series_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_time_series::de_list_time_series_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_time_series::ListTimeSeriesError {
