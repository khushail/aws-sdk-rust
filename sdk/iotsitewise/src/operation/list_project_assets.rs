...
impl ListProjectAssetsInput {
    /// Consumes the builder and constructs an Operation<[`ListProjectAssets`](crate::operation::list_project_assets::ListProjectAssets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_project_assets::ListProjectAssets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_project_assets::ListProjectAssetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/projects/{projectId}/assets", projectId = project_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_project_assets::ListProjectAssetsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_project_assets::ListProjectAssetsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_project_assets::ListProjectAssets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProjectAssets {
                type Output = ::std::result::Result<crate::operation::list_project_assets::ListProjectAssetsOutput, crate::operation::list_project_assets::ListProjectAssetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_project_assets::de_list_project_assets_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_project_assets::ListProjectAssetsError {
...
pub use crate::operation::list_project_assets::_list_project_assets_output::ListProjectAssetsOutput;

pub use crate::operation::list_project_assets::_list_project_assets_input::ListProjectAssetsInput;

mod _list_project_assets_input;

mod _list_project_assets_output;
