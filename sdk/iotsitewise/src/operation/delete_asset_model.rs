...
impl DeleteAssetModelInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAssetModel`](crate::operation::delete_asset_model::DeleteAssetModel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_asset_model::DeleteAssetModel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_asset_model::DeleteAssetModelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if asset_model_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("asset_model_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/asset-models/{assetModelId}", assetModelId = asset_model_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_asset_model::DeleteAssetModelInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_asset_model::DeleteAssetModel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAssetModel", "iotsitewise"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteAssetModel`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAssetModel {
                type Output = ::std::result::Result<crate::operation::delete_asset_model::DeleteAssetModelOutput, crate::operation::delete_asset_model::DeleteAssetModelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        ...
                        crate::protocol_serde::shape_delete_asset_model::de_delete_asset_model_http_response_with_props(status, headers, body)
                     }
                }
...
pub use crate::operation::delete_asset_model::_delete_asset_model_output::DeleteAssetModelOutput;

pub use crate::operation::delete_asset_model::_delete_asset_model_input::DeleteAssetModelInput;

mod _delete_asset_model_input;

mod _delete_asset_model_output;
