...
impl UpdateAccessPolicyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAccessPolicy`](crate::operation::update_access_policy::UpdateAccessPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_access_policy::UpdateAccessPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_access_policy::UpdateAccessPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_access_policy::UpdateAccessPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccessPolicy {
                type Output = ::std::result::Result<crate::operation::update_access_policy::UpdateAccessPolicyOutput, crate::operation::update_access_policy::UpdateAccessPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_access_policy::de_update_access_policy_http_response_with_props(status, headers, body)
                     }
                }
...
mod _update_access_policy_output;
