...
impl BatchGetAssetPropertyValueInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_get_asset_property_value::BatchGetAssetPropertyValueInput, ::aws_smithy_http::operation::error::BuildError> {
