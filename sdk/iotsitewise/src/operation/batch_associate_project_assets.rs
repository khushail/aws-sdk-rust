...
impl BatchAssociateProjectAssetsInput {
    /// Consumes the builder and constructs an Operation<[`BatchAssociateProjectAssets`](crate::operation::batch_associate_project_assets::BatchAssociateProjectAssets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_associate_project_assets::BatchAssociateProjectAssets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_associate_project_assets::BatchAssociateProjectAssetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/projects/{projectId}/assets/associate", projectId = project_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_associate_project_assets::BatchAssociateProjectAssets::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchAssociateProjectAssets", "iotsitewise"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchAssociateProjectAssets`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchAssociateProjectAssets {
                type Output = ::std::result::Result<crate::operation::batch_associate_project_assets::BatchAssociateProjectAssetsOutput, crate::operation::batch_associate_project_assets::BatchAssociateProjectAssetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_associate_project_assets::de_batch_associate_project_assets_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_associate_project_assets::de_batch_associate_project_assets_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_associate_project_assets::BatchAssociateProjectAssetsError {
...
mod _batch_associate_project_assets_output;
