...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_experiment_template::builders::GetExperimentTemplateFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_experiment_template::builders::GetExperimentTemplateFluentBuilder::set_id): <p>The ID of the experiment template.</p>
