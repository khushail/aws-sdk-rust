...
pub use crate::operation::list_experiment_templates::_list_experiment_templates_output::ListExperimentTemplatesOutputBuilder;

pub use crate::operation::list_experiment_templates::_list_experiment_templates_input::ListExperimentTemplatesInputBuilder;
...
impl ListExperimentTemplatesInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.list_experiment_templates();
...
impl ListExperimentTemplatesFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::list_experiment_templates::ListExperimentTemplates, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::list_experiment_templates::ListExperimentTemplatesOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_experiment_templates::ListExperimentTemplatesError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::list_experiment_templates::ListExperimentTemplatesOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_experiment_templates::ListExperimentTemplatesError>>
                             {
