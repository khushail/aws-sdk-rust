...
impl CreateExplainabilityExportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_explainability_export::CreateExplainabilityExportInput, ::aws_smithy_http::operation::error::BuildError> {
