...
impl DeleteForecastInput {
    /// Consumes the builder and constructs an Operation<[`DeleteForecast`](crate::operation::delete_forecast::DeleteForecast)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_forecast::DeleteForecast, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_forecast::DeleteForecastInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_forecast::DeleteForecast::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteForecast", "forecast"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteForecast`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteForecast {
                type Output = ::std::result::Result<crate::operation::delete_forecast::DeleteForecastOutput, crate::operation::delete_forecast::DeleteForecastError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_forecast::de_delete_forecast_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_forecast::de_delete_forecast_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_forecast::DeleteForecastError {
