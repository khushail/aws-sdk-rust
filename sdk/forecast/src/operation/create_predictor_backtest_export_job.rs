...
impl CreatePredictorBacktestExportJobInput {
    /// Consumes the builder and constructs an Operation<[`CreatePredictorBacktestExportJob`](crate::operation::create_predictor_backtest_export_job::CreatePredictorBacktestExportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_predictor_backtest_export_job::CreatePredictorBacktestExportJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_predictor_backtest_export_job::CreatePredictorBacktestExportJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_predictor_backtest_export_job::CreatePredictorBacktestExportJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePredictorBacktestExportJob", "forecast"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreatePredictorBacktestExportJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePredictorBacktestExportJob {
                type Output = ::std::result::Result<crate::operation::create_predictor_backtest_export_job::CreatePredictorBacktestExportJobOutput, crate::operation::create_predictor_backtest_export_job::CreatePredictorBacktestExportJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_predictor_backtest_export_job::de_create_predictor_backtest_export_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_predictor_backtest_export_job::de_create_predictor_backtest_export_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_predictor_backtest_export_job::CreatePredictorBacktestExportJobError {
...
mod _create_predictor_backtest_export_job_output;
