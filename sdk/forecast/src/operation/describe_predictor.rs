...
impl DescribePredictorInput {
    /// Consumes the builder and constructs an Operation<[`DescribePredictor`](crate::operation::describe_predictor::DescribePredictor)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_predictor::DescribePredictor, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_predictor::DescribePredictorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_predictor::DescribePredictor::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribePredictor", "forecast"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribePredictor`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePredictor {
                type Output = ::std::result::Result<crate::operation::describe_predictor::DescribePredictorOutput, crate::operation::describe_predictor::DescribePredictorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_predictor::de_describe_predictor_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_predictor::de_describe_predictor_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_predictor::DescribePredictorError {
...
mod _describe_predictor_output;
