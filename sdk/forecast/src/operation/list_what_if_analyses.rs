...
impl ListWhatIfAnalysesInput {
    /// Consumes the builder and constructs an Operation<[`ListWhatIfAnalyses`](crate::operation::list_what_if_analyses::ListWhatIfAnalyses)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_what_if_analyses::ListWhatIfAnalyses, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_what_if_analyses::ListWhatIfAnalysesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_what_if_analyses::ListWhatIfAnalyses::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListWhatIfAnalyses", "forecast"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListWhatIfAnalyses`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWhatIfAnalyses {
                type Output = ::std::result::Result<crate::operation::list_what_if_analyses::ListWhatIfAnalysesOutput, crate::operation::list_what_if_analyses::ListWhatIfAnalysesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_what_if_analyses::de_list_what_if_analyses_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_what_if_analyses::de_list_what_if_analyses_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_what_if_analyses::ListWhatIfAnalysesError {
...
mod _list_what_if_analyses_output;
