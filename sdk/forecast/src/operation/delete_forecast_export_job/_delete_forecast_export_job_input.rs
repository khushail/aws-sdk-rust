...
impl DeleteForecastExportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_forecast_export_job::DeleteForecastExportJobInput, ::aws_smithy_http::operation::error::BuildError> {
