...
impl CreateWhatIfForecastExportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_what_if_forecast_export::CreateWhatIfForecastExportInput, ::aws_smithy_http::operation::error::BuildError> {
