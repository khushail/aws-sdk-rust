...
impl GetAccuracyMetricsInput {
    /// Consumes the builder and constructs an Operation<[`GetAccuracyMetrics`](crate::operation::get_accuracy_metrics::GetAccuracyMetrics)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_accuracy_metrics::GetAccuracyMetrics, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_accuracy_metrics::GetAccuracyMetricsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_accuracy_metrics::GetAccuracyMetrics::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAccuracyMetrics", "forecast"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetAccuracyMetrics`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccuracyMetrics {
                type Output = ::std::result::Result<crate::operation::get_accuracy_metrics::GetAccuracyMetricsOutput, crate::operation::get_accuracy_metrics::GetAccuracyMetricsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_accuracy_metrics::de_get_accuracy_metrics_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_accuracy_metrics::de_get_accuracy_metrics_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_accuracy_metrics::GetAccuracyMetricsError {
...
mod _get_accuracy_metrics_output;
