...
impl ListPredictorBacktestExportJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListPredictorBacktestExportJobs`](crate::operation::list_predictor_backtest_export_jobs::ListPredictorBacktestExportJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_predictor_backtest_export_jobs::ListPredictorBacktestExportJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_predictor_backtest_export_jobs::ListPredictorBacktestExportJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_predictor_backtest_export_jobs::ListPredictorBacktestExportJobs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPredictorBacktestExportJobs", "forecast"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListPredictorBacktestExportJobs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPredictorBacktestExportJobs {
                type Output = ::std::result::Result<crate::operation::list_predictor_backtest_export_jobs::ListPredictorBacktestExportJobsOutput, crate::operation::list_predictor_backtest_export_jobs::ListPredictorBacktestExportJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_predictor_backtest_export_jobs::de_list_predictor_backtest_export_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_predictor_backtest_export_jobs::de_list_predictor_backtest_export_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_predictor_backtest_export_jobs::ListPredictorBacktestExportJobsError {
...
mod _list_predictor_backtest_export_jobs_output;
