...
impl DeleteExplainabilityExportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_explainability_export::DeleteExplainabilityExportInput, ::aws_smithy_http::operation::error::BuildError> {
