...
impl QueryWhatIfForecastInput {
    /// Consumes the builder and constructs an Operation<[`QueryWhatIfForecast`](crate::operation::query_what_if_forecast::QueryWhatIfForecast)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::query_what_if_forecast::QueryWhatIfForecast, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::query_what_if_forecast::QueryWhatIfForecastInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::query_what_if_forecast::QueryWhatIfForecast::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("QueryWhatIfForecast", "forecastquery"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `QueryWhatIfForecast`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for QueryWhatIfForecast {
                type Output = ::std::result::Result<crate::operation::query_what_if_forecast::QueryWhatIfForecastOutput, crate::operation::query_what_if_forecast::QueryWhatIfForecastError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::query_what_if_forecast::QueryWhatIfForecastError {
...
pub use crate::operation::query_what_if_forecast::_query_what_if_forecast_output::QueryWhatIfForecastOutput;

pub use crate::operation::query_what_if_forecast::_query_what_if_forecast_input::QueryWhatIfForecastInput;

mod _query_what_if_forecast_input;

mod _query_what_if_forecast_output;
