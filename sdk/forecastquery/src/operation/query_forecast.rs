...
impl QueryForecastInput {
    /// Consumes the builder and constructs an Operation<[`QueryForecast`](crate::operation::query_forecast::QueryForecast)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::query_forecast::QueryForecast, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::query_forecast::QueryForecastInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::query_forecast::QueryForecast::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("QueryForecast", "forecastquery"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `QueryForecast`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for QueryForecast {
                type Output = ::std::result::Result<crate::operation::query_forecast::QueryForecastOutput, crate::operation::query_forecast::QueryForecastError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_query_forecast::de_query_forecast_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_query_forecast::de_query_forecast_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::query_forecast::QueryForecastError {
