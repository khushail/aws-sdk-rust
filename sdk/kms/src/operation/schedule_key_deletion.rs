...
impl ScheduleKeyDeletionInput {
    /// Consumes the builder and constructs an Operation<[`ScheduleKeyDeletion`](crate::operation::schedule_key_deletion::ScheduleKeyDeletion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::schedule_key_deletion::ScheduleKeyDeletion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::schedule_key_deletion::ScheduleKeyDeletionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::schedule_key_deletion::ScheduleKeyDeletion::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ScheduleKeyDeletion {
                type Output = ::std::result::Result<crate::operation::schedule_key_deletion::ScheduleKeyDeletionOutput, crate::operation::schedule_key_deletion::ScheduleKeyDeletionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_schedule_key_deletion::de_schedule_key_deletion_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::schedule_key_deletion::ScheduleKeyDeletionError {
