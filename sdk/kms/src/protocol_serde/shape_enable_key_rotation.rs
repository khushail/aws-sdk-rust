...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_key_rotation_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_key_rotation::EnableKeyRotationOutput, crate::operation::enable_key_rotation::EnableKeyRotationError> {
    Ok({
        #[allow(unused_mut)]
