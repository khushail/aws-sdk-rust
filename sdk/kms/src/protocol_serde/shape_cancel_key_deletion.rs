...
pub fn ser_cancel_key_deletion_input(input: &crate::operation::cancel_key_deletion::CancelKeyDeletionInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_cancel_key_deletion_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_key_deletion::CancelKeyDeletionOutput, crate::operation::cancel_key_deletion::CancelKeyDeletionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::cancel_key_deletion::CancelKeyDeletionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_key_deletion_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_key_deletion::CancelKeyDeletionOutput, crate::operation::cancel_key_deletion::CancelKeyDeletionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::cancel_key_deletion::builders::CancelKeyDeletionOutputBuilder::default();
        output = crate::protocol_serde::shape_cancel_key_deletion::de_cancel_key_deletion(_response_body, output).map_err(crate::operation::cancel_key_deletion::CancelKeyDeletionError::unhandled)?;
        output._set_request_id(::aws_http::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_cancel_key_deletion(value: &[u8], mut builder: crate::operation::cancel_key_deletion::builders::CancelKeyDeletionOutputBuilder) -> Result<crate::operation::cancel_key_deletion::builders::CancelKeyDeletionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
