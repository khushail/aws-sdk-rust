...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_servers::builders::GetServersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_servers::builders::GetServersFluentBuilder::set_next_token): <p>The token for the next set of results.</p>
