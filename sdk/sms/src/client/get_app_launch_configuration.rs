...
impl super::Client  {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::get_app_launch_configuration::builders::GetAppLaunchConfigurationFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::get_app_launch_configuration::builders::GetAppLaunchConfigurationFluentBuilder::set_app_id): <p>The ID of the application.</p>
