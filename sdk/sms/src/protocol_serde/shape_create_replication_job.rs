...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_replication_job_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_replication_job::CreateReplicationJobOutput, crate::operation::create_replication_job::CreateReplicationJobError> {
    Ok({
        #[allow(unused_mut)]
