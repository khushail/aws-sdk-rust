...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_server_catalog_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_server_catalog::DeleteServerCatalogOutput, crate::operation::delete_server_catalog::DeleteServerCatalogError> {
    Ok({
        #[allow(unused_mut)]
