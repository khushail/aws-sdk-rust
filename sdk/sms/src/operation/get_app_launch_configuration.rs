...
impl GetAppLaunchConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetAppLaunchConfiguration`](crate::operation::get_app_launch_configuration::GetAppLaunchConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_app_launch_configuration::GetAppLaunchConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_app_launch_configuration::GetAppLaunchConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_app_launch_configuration::GetAppLaunchConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAppLaunchConfiguration", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetAppLaunchConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAppLaunchConfiguration {
                type Output = ::std::result::Result<crate::operation::get_app_launch_configuration::GetAppLaunchConfigurationOutput, crate::operation::get_app_launch_configuration::GetAppLaunchConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_app_launch_configuration::de_get_app_launch_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_app_launch_configuration::de_get_app_launch_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_app_launch_configuration::GetAppLaunchConfigurationError {
...
pub use crate::operation::get_app_launch_configuration::_get_app_launch_configuration_output::GetAppLaunchConfigurationOutput;

pub use crate::operation::get_app_launch_configuration::_get_app_launch_configuration_input::GetAppLaunchConfigurationInput;

mod _get_app_launch_configuration_input;

mod _get_app_launch_configuration_output;
