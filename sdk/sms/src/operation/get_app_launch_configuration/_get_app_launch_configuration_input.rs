...
impl GetAppLaunchConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_app_launch_configuration::GetAppLaunchConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
