...
impl UpdateReplicationJobInput {
    /// Consumes the builder and constructs an Operation<[`UpdateReplicationJob`](crate::operation::update_replication_job::UpdateReplicationJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_replication_job::UpdateReplicationJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_replication_job::UpdateReplicationJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_replication_job::ser_update_replication_job_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_replication_job::UpdateReplicationJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateReplicationJob", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateReplicationJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateReplicationJob {
                type Output = ::std::result::Result<crate::operation::update_replication_job::UpdateReplicationJobOutput, crate::operation::update_replication_job::UpdateReplicationJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_replication_job::de_update_replication_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_replication_job::de_update_replication_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_replication_job::UpdateReplicationJobError {
...
pub use crate::operation::update_replication_job::_update_replication_job_output::UpdateReplicationJobOutput;

pub use crate::operation::update_replication_job::_update_replication_job_input::UpdateReplicationJobInput;

mod _update_replication_job_input;

mod _update_replication_job_output;
