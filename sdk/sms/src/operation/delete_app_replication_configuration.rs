...
impl DeleteAppReplicationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAppReplicationConfiguration`](crate::operation::delete_app_replication_configuration::DeleteAppReplicationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_app_replication_configuration::DeleteAppReplicationConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_app_replication_configuration::DeleteAppReplicationConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_app_replication_configuration::DeleteAppReplicationConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAppReplicationConfiguration", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteAppReplicationConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAppReplicationConfiguration {
                type Output = ::std::result::Result<crate::operation::delete_app_replication_configuration::DeleteAppReplicationConfigurationOutput, crate::operation::delete_app_replication_configuration::DeleteAppReplicationConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_app_replication_configuration::de_delete_app_replication_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_app_replication_configuration::de_delete_app_replication_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteAppReplicationConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_app_replication_configuration::DeleteAppReplicationConfigurationError {
...
pub use crate::operation::delete_app_replication_configuration::_delete_app_replication_configuration_output::DeleteAppReplicationConfigurationOutput;

pub use crate::operation::delete_app_replication_configuration::_delete_app_replication_configuration_input::DeleteAppReplicationConfigurationInput;

mod _delete_app_replication_configuration_input;

mod _delete_app_replication_configuration_output;
