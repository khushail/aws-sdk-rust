...
impl StartOnDemandReplicationRunInput {
    /// Consumes the builder and constructs an Operation<[`StartOnDemandReplicationRun`](crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRun, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRun::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartOnDemandReplicationRun", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartOnDemandReplicationRun`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartOnDemandReplicationRun {
                type Output = ::std::result::Result<crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRunOutput, crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRunError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_on_demand_replication_run::de_start_on_demand_replication_run_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_on_demand_replication_run::de_start_on_demand_replication_run_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_on_demand_replication_run::StartOnDemandReplicationRunError {
...
pub use crate::operation::start_on_demand_replication_run::_start_on_demand_replication_run_output::StartOnDemandReplicationRunOutput;

pub use crate::operation::start_on_demand_replication_run::_start_on_demand_replication_run_input::StartOnDemandReplicationRunInput;

mod _start_on_demand_replication_run_input;

mod _start_on_demand_replication_run_output;
