...
impl DeleteServerCatalogInput {
    /// Consumes the builder and constructs an Operation<[`DeleteServerCatalog`](crate::operation::delete_server_catalog::DeleteServerCatalog)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_server_catalog::DeleteServerCatalog, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_server_catalog::DeleteServerCatalogInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_server_catalog::DeleteServerCatalogInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_server_catalog::ser_delete_server_catalog_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_server_catalog::DeleteServerCatalog::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteServerCatalog", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteServerCatalog`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteServerCatalog {
                type Output = ::std::result::Result<crate::operation::delete_server_catalog::DeleteServerCatalogOutput, crate::operation::delete_server_catalog::DeleteServerCatalogError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_server_catalog::de_delete_server_catalog_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_server_catalog::de_delete_server_catalog_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_server_catalog::DeleteServerCatalogError {
...
pub use crate::operation::delete_server_catalog::_delete_server_catalog_output::DeleteServerCatalogOutput;

pub use crate::operation::delete_server_catalog::_delete_server_catalog_input::DeleteServerCatalogInput;

mod _delete_server_catalog_input;

mod _delete_server_catalog_output;
