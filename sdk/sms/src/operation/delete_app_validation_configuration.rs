...
impl DeleteAppValidationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAppValidationConfiguration`](crate::operation::delete_app_validation_configuration::DeleteAppValidationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_app_validation_configuration::DeleteAppValidationConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_app_validation_configuration::DeleteAppValidationConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_app_validation_configuration::DeleteAppValidationConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAppValidationConfiguration", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteAppValidationConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAppValidationConfiguration {
                type Output = ::std::result::Result<crate::operation::delete_app_validation_configuration::DeleteAppValidationConfigurationOutput, crate::operation::delete_app_validation_configuration::DeleteAppValidationConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_app_validation_configuration::de_delete_app_validation_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_app_validation_configuration::de_delete_app_validation_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteAppValidationConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_app_validation_configuration::DeleteAppValidationConfigurationError {
...
pub use crate::operation::delete_app_validation_configuration::_delete_app_validation_configuration_output::DeleteAppValidationConfigurationOutput;

pub use crate::operation::delete_app_validation_configuration::_delete_app_validation_configuration_input::DeleteAppValidationConfigurationInput;

mod _delete_app_validation_configuration_input;

mod _delete_app_validation_configuration_output;
