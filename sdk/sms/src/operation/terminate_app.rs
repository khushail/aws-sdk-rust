...
impl TerminateAppInput {
    /// Consumes the builder and constructs an Operation<[`TerminateApp`](crate::operation::terminate_app::TerminateApp)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::terminate_app::TerminateApp, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::terminate_app::TerminateAppInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::terminate_app::TerminateApp::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("TerminateApp", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `TerminateApp`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateApp {
                type Output = ::std::result::Result<crate::operation::terminate_app::TerminateAppOutput, crate::operation::terminate_app::TerminateAppError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_terminate_app::de_terminate_app_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_terminate_app::de_terminate_app_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::terminate_app::TerminateAppError {
...
pub use crate::operation::terminate_app::_terminate_app_output::TerminateAppOutput;

pub use crate::operation::terminate_app::_terminate_app_input::TerminateAppInput;

mod _terminate_app_input;

mod _terminate_app_output;
