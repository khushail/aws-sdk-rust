...
impl DeleteReplicationJobInput {
    /// Consumes the builder and constructs an Operation<[`DeleteReplicationJob`](crate::operation::delete_replication_job::DeleteReplicationJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_replication_job::DeleteReplicationJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_replication_job::DeleteReplicationJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_replication_job::ser_delete_replication_job_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_replication_job::DeleteReplicationJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteReplicationJob", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteReplicationJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReplicationJob {
                type Output = ::std::result::Result<crate::operation::delete_replication_job::DeleteReplicationJobOutput, crate::operation::delete_replication_job::DeleteReplicationJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_replication_job::de_delete_replication_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_replication_job::de_delete_replication_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_replication_job::DeleteReplicationJobError {
...
pub use crate::operation::delete_replication_job::_delete_replication_job_output::DeleteReplicationJobOutput;

pub use crate::operation::delete_replication_job::_delete_replication_job_input::DeleteReplicationJobInput;

mod _delete_replication_job_input;

mod _delete_replication_job_output;
