...
impl GetServersInput {
    /// Consumes the builder and constructs an Operation<[`GetServers`](crate::operation::get_servers::GetServers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_servers::GetServers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_servers::GetServersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_servers::GetServers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetServers", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetServers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetServers {
                type Output = ::std::result::Result<crate::operation::get_servers::GetServersOutput, crate::operation::get_servers::GetServersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_servers::de_get_servers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_servers::de_get_servers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_servers::GetServersError {
...
pub use crate::operation::get_servers::_get_servers_output::GetServersOutput;

pub use crate::operation::get_servers::_get_servers_input::GetServersInput;

mod _get_servers_input;

mod _get_servers_output;
