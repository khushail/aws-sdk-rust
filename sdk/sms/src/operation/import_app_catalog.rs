...
impl ImportAppCatalogInput {
    /// Consumes the builder and constructs an Operation<[`ImportAppCatalog`](crate::operation::import_app_catalog::ImportAppCatalog)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_app_catalog::ImportAppCatalog, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_app_catalog::ImportAppCatalogInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::import_app_catalog::ImportAppCatalogInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_app_catalog::ImportAppCatalog::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportAppCatalog {
                type Output = ::std::result::Result<crate::operation::import_app_catalog::ImportAppCatalogOutput, crate::operation::import_app_catalog::ImportAppCatalogError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_import_app_catalog::de_import_app_catalog_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::import_app_catalog::ImportAppCatalogError {
...
pub use crate::operation::import_app_catalog::_import_app_catalog_output::ImportAppCatalogOutput;

pub use crate::operation::import_app_catalog::_import_app_catalog_input::ImportAppCatalogInput;

mod _import_app_catalog_input;

mod _import_app_catalog_output;
