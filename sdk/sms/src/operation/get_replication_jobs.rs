...
impl GetReplicationJobsInput {
    /// Consumes the builder and constructs an Operation<[`GetReplicationJobs`](crate::operation::get_replication_jobs::GetReplicationJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_replication_jobs::GetReplicationJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_replication_jobs::GetReplicationJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_replication_jobs::ser_get_replication_jobs_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_replication_jobs::GetReplicationJobs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetReplicationJobs", "sms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetReplicationJobs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReplicationJobs {
                type Output = ::std::result::Result<crate::operation::get_replication_jobs::GetReplicationJobsOutput, crate::operation::get_replication_jobs::GetReplicationJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_replication_jobs::de_get_replication_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_replication_jobs::de_get_replication_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_replication_jobs::GetReplicationJobsError {
...
pub use crate::operation::get_replication_jobs::_get_replication_jobs_output::GetReplicationJobsOutput;

pub use crate::operation::get_replication_jobs::_get_replication_jobs_input::GetReplicationJobsInput;

mod _get_replication_jobs_input;

mod _get_replication_jobs_output;
