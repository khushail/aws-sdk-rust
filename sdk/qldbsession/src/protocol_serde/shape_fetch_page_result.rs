...
pub(crate) fn de_fetch_page_result<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::FetchPageResult>, ::aws_smithy_json::deserialize::error::DeserializeError>
