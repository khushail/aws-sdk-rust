...
impl DescribeScalingPlanResourcesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeScalingPlanResources`](crate::operation::describe_scaling_plan_resources::DescribeScalingPlanResources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_scaling_plan_resources::DescribeScalingPlanResources, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_scaling_plan_resources::DescribeScalingPlanResourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_scaling_plan_resources::ser_describe_scaling_plan_resources_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_scaling_plan_resources::DescribeScalingPlanResources::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeScalingPlanResources", "autoscalingplans"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeScalingPlanResources`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeScalingPlanResources {
                type Output = ::std::result::Result<crate::operation::describe_scaling_plan_resources::DescribeScalingPlanResourcesOutput, crate::operation::describe_scaling_plan_resources::DescribeScalingPlanResourcesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_scaling_plan_resources::de_describe_scaling_plan_resources_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_scaling_plan_resources::de_describe_scaling_plan_resources_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_scaling_plan_resources::DescribeScalingPlanResourcesError {
...
pub use crate::operation::describe_scaling_plan_resources::_describe_scaling_plan_resources_output::DescribeScalingPlanResourcesOutput;

pub use crate::operation::describe_scaling_plan_resources::_describe_scaling_plan_resources_input::DescribeScalingPlanResourcesInput;

mod _describe_scaling_plan_resources_input;

mod _describe_scaling_plan_resources_output;
