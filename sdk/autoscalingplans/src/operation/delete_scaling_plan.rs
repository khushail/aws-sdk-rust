...
impl DeleteScalingPlanInput {
    /// Consumes the builder and constructs an Operation<[`DeleteScalingPlan`](crate::operation::delete_scaling_plan::DeleteScalingPlan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_scaling_plan::DeleteScalingPlan, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_scaling_plan::DeleteScalingPlanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_scaling_plan::ser_delete_scaling_plan_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_scaling_plan::DeleteScalingPlan::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteScalingPlan {
                type Output = ::std::result::Result<crate::operation::delete_scaling_plan::DeleteScalingPlanOutput, crate::operation::delete_scaling_plan::DeleteScalingPlanError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_scaling_plan::de_delete_scaling_plan_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_scaling_plan::DeleteScalingPlanError {
