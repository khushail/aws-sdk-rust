...
impl DescribeScalingPlanResourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_scaling_plan_resources::DescribeScalingPlanResourcesInput, ::aws_smithy_http::operation::error::BuildError> {
