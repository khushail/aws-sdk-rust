...
impl AssociateExternalConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_external_connection::AssociateExternalConnectionInput, ::aws_smithy_http::operation::error::BuildError> {
