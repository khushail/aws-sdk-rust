...
impl ListPackageVersionDependenciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_package_version_dependencies::ListPackageVersionDependenciesInput, ::aws_smithy_http::operation::error::BuildError> {
