...
impl UpdatePackageVersionsStatusInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePackageVersionsStatus`](crate::operation::update_package_versions_status::UpdatePackageVersionsStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_package_versions_status::UpdatePackageVersionsStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_package_versions_status::UpdatePackageVersionsStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/package/versions/update_status").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::update_package_versions_status::UpdatePackageVersionsStatusInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_package_versions_status::ser_update_package_versions_status_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_package_versions_status::UpdatePackageVersionsStatus::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePackageVersionsStatus {
                type Output = ::std::result::Result<crate::operation::update_package_versions_status::UpdatePackageVersionsStatusOutput, crate::operation::update_package_versions_status::UpdatePackageVersionsStatusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_package_versions_status::de_update_package_versions_status_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_package_versions_status::UpdatePackageVersionsStatusError {
