...
impl PutPackageOriginConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_package_origin_configuration::PutPackageOriginConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
