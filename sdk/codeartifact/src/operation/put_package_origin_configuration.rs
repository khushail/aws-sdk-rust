...
impl PutPackageOriginConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`PutPackageOriginConfiguration`](crate::operation::put_package_origin_configuration::PutPackageOriginConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_package_origin_configuration::PutPackageOriginConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_package_origin_configuration::PutPackageOriginConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/package").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::put_package_origin_configuration::PutPackageOriginConfigurationInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_package_origin_configuration::ser_put_package_origin_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_package_origin_configuration::PutPackageOriginConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutPackageOriginConfiguration {
                type Output = ::std::result::Result<crate::operation::put_package_origin_configuration::PutPackageOriginConfigurationOutput, crate::operation::put_package_origin_configuration::PutPackageOriginConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_put_package_origin_configuration::de_put_package_origin_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_package_origin_configuration::PutPackageOriginConfigurationError {
