...
impl ListPackageVersionDependenciesInput {
    /// Consumes the builder and constructs an Operation<[`ListPackageVersionDependencies`](crate::operation::list_package_version_dependencies::ListPackageVersionDependencies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_package_version_dependencies::ListPackageVersionDependencies, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_package_version_dependencies::ListPackageVersionDependenciesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/package/version/dependencies").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_package_version_dependencies::ListPackageVersionDependenciesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if inner_1.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("domain", "cannot be empty or unset"));
                }
                ...
                if inner_3.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("repository", "cannot be empty or unset"));
                }
                ...
                if inner_6.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("package", "cannot be empty or unset"));
                }
                ...
                if inner_7.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("package_version", "cannot be empty or unset"));
                }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_package_version_dependencies::ListPackageVersionDependencies::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPackageVersionDependencies {
                type Output = ::std::result::Result<crate::operation::list_package_version_dependencies::ListPackageVersionDependenciesOutput, crate::operation::list_package_version_dependencies::ListPackageVersionDependenciesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_package_version_dependencies::de_list_package_version_dependencies_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_package_version_dependencies::ListPackageVersionDependenciesError {
