...
impl GetPackageVersionReadmeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_package_version_readme::GetPackageVersionReadmeInput, ::aws_smithy_http::operation::error::BuildError> {
