...
pub fn de_get_package_version_asset_op_response(op_response: &mut ::aws_smithy_http::operation::Response) -> ::std::result::Result<crate::operation::get_package_version_asset::GetPackageVersionAssetOutput, crate::operation::get_package_version_asset::GetPackageVersionAssetError> {
    #[allow(unused_variables)]
    let (response, properties) = op_response.parts_mut();
    crate::protocol_serde::shape_get_package_version_asset::de_get_package_version_asset_http_response_with_props(response, &properties)
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_get_package_version_asset_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_package_version_asset::GetPackageVersionAssetOutput, crate::operation::get_package_version_asset::GetPackageVersionAssetError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_package_version_asset::GetPackageVersionAssetError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::get_package_version_asset::GetPackageVersionAssetError::unhandled(generic))
                            };
...
#[allow(clippy::unnecessary_wraps)]
#[allow(unused_variables)]
pub fn de_get_package_version_asset_http_response_with_props(response: &mut ::http::Response<::aws_smithy_http::body::SdkBody>, properties: &::aws_smithy_http::property_bag::PropertyBag) -> std::result::Result<crate::operation::get_package_version_asset::GetPackageVersionAssetOutput, crate::operation::get_package_version_asset::GetPackageVersionAssetError> {
    ...
    Ok({
        ...
        output = output.set_asset(
            Some(crate::protocol_serde::shape_get_package_version_asset_output::de_asset_payload(_response_body)?)
        );
        output = output.set_asset_name(
            crate::protocol_serde::shape_get_package_version_asset_output::de_asset_name_header(_response_headers)
                                    .map_err(|_|crate::operation::get_package_version_asset::GetPackageVersionAssetError::unhandled("Failed to parse assetName from header `X-AssetName"))?
        );
