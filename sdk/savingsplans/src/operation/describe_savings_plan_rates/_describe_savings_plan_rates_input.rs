...
impl DescribeSavingsPlanRatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_savings_plan_rates::DescribeSavingsPlanRatesInput, ::aws_smithy_http::operation::error::BuildError> {
