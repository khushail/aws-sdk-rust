...
impl DeleteQueuedSavingsPlanInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_queued_savings_plan::DeleteQueuedSavingsPlanInput, ::aws_smithy_http::operation::error::BuildError> {
