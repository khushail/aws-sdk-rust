...
pub fn ser_pin_generation_attributes(object_3: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PinGenerationAttributes) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
        ...
        crate::types::PinGenerationAttributes::Unknown => return Err(::aws_smithy_http::operation::error::SerializationError::unknown_variant("PinGenerationAttributes"))
    }
    Ok(())
}
