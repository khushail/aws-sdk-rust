...
pub fn ser_session_key_derivation(object_7: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::SessionKeyDerivation) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
        ...
        crate::types::SessionKeyDerivation::Unknown => return Err(::aws_smithy_http::operation::error::SerializationError::unknown_variant("SessionKeyDerivation"))
    }
    Ok(())
}
