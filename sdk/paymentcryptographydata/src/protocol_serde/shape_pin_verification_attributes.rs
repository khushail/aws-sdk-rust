...
pub fn ser_pin_verification_attributes(object_9: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PinVerificationAttributes) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
        ...
        crate::types::PinVerificationAttributes::Unknown => return Err(::aws_smithy_http::operation::error::SerializationError::unknown_variant("PinVerificationAttributes"))
    }
    Ok(())
}
