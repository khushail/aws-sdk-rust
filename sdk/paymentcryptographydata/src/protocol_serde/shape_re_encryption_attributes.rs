...
pub fn ser_re_encryption_attributes(object_3: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ReEncryptionAttributes) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
        ...
        crate::types::ReEncryptionAttributes::Unknown => return Err(::aws_smithy_http::operation::error::SerializationError::unknown_variant("ReEncryptionAttributes"))
    }
    Ok(())
}
