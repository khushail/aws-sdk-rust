...
impl VerifyAuthRequestCryptogramInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::verify_auth_request_cryptogram::VerifyAuthRequestCryptogramInput, ::aws_smithy_http::operation::error::BuildError> {
