...
impl ModifySelfservicePermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_selfservice_permissions::ModifySelfservicePermissionsInput, ::aws_smithy_http::operation::error::BuildError> {
