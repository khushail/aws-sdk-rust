...
impl ImportWorkspaceImageInput {
    /// Consumes the builder and constructs an Operation<[`ImportWorkspaceImage`](crate::operation::import_workspace_image::ImportWorkspaceImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_workspace_image::ImportWorkspaceImage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_workspace_image::ImportWorkspaceImageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_workspace_image::ImportWorkspaceImage::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportWorkspaceImage {
                type Output = ::std::result::Result<crate::operation::import_workspace_image::ImportWorkspaceImageOutput, crate::operation::import_workspace_image::ImportWorkspaceImageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_import_workspace_image::de_import_workspace_image_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_import_workspace_image::de_import_workspace_image_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::import_workspace_image::ImportWorkspaceImageError {
...
pub use crate::operation::import_workspace_image::_import_workspace_image_output::ImportWorkspaceImageOutput;

pub use crate::operation::import_workspace_image::_import_workspace_image_input::ImportWorkspaceImageInput;

mod _import_workspace_image_input;

mod _import_workspace_image_output;
