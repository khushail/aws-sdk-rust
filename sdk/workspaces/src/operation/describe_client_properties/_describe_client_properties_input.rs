...
impl DescribeClientPropertiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_client_properties::DescribeClientPropertiesInput, ::aws_smithy_http::operation::error::BuildError> {
