...
impl DescribeWorkspaceDirectoriesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_workspace_directories::DescribeWorkspaceDirectoriesInput, ::aws_smithy_http::operation::error::BuildError> {
