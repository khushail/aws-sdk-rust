...
impl RegisterWorkspaceDirectoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::register_workspace_directory::RegisterWorkspaceDirectoryInput, ::aws_smithy_http::operation::error::BuildError> {
