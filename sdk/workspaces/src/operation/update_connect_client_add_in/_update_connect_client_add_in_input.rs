...
impl UpdateConnectClientAddInInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_connect_client_add_in::UpdateConnectClientAddInInput, ::aws_smithy_http::operation::error::BuildError> {
