...
impl ModifyWorkspaceAccessPropertiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_workspace_access_properties::ModifyWorkspaceAccessPropertiesInput, ::aws_smithy_http::operation::error::BuildError> {
