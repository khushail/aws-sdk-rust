...
impl DescribeWorkspaceDirectoriesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeWorkspaceDirectories`](crate::operation::describe_workspace_directories::DescribeWorkspaceDirectories)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_workspace_directories::DescribeWorkspaceDirectories, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_workspace_directories::DescribeWorkspaceDirectoriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_workspace_directories::DescribeWorkspaceDirectories::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeWorkspaceDirectories", "workspaces"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeWorkspaceDirectories`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkspaceDirectories {
                type Output = ::std::result::Result<crate::operation::describe_workspace_directories::DescribeWorkspaceDirectoriesOutput, crate::operation::describe_workspace_directories::DescribeWorkspaceDirectoriesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_workspace_directories::de_describe_workspace_directories_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_workspace_directories::de_describe_workspace_directories_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_workspace_directories::DescribeWorkspaceDirectoriesError {
...
pub use crate::operation::describe_workspace_directories::_describe_workspace_directories_output::DescribeWorkspaceDirectoriesOutput;

pub use crate::operation::describe_workspace_directories::_describe_workspace_directories_input::DescribeWorkspaceDirectoriesInput;

mod _describe_workspace_directories_input;

mod _describe_workspace_directories_output;
