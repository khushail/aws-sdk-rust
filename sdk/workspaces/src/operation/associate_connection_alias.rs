...
impl AssociateConnectionAliasInput {
    /// Consumes the builder and constructs an Operation<[`AssociateConnectionAlias`](crate::operation::associate_connection_alias::AssociateConnectionAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_connection_alias::AssociateConnectionAlias, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_connection_alias::AssociateConnectionAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_connection_alias::AssociateConnectionAlias::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateConnectionAlias", "workspaces"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateConnectionAlias`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateConnectionAlias {
                type Output = ::std::result::Result<crate::operation::associate_connection_alias::AssociateConnectionAliasOutput, crate::operation::associate_connection_alias::AssociateConnectionAliasError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_connection_alias::de_associate_connection_alias_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_connection_alias::de_associate_connection_alias_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_connection_alias::AssociateConnectionAliasError {
...
mod _associate_connection_alias_output;
