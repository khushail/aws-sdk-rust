...
impl CreateUpdatedWorkspaceImageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_updated_workspace_image::CreateUpdatedWorkspaceImageInput, ::aws_smithy_http::operation::error::BuildError> {
