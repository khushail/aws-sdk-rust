...
impl ModifySelfservicePermissionsInput {
    /// Consumes the builder and constructs an Operation<[`ModifySelfservicePermissions`](crate::operation::modify_selfservice_permissions::ModifySelfservicePermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_selfservice_permissions::ModifySelfservicePermissions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_selfservice_permissions::ModifySelfservicePermissionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_selfservice_permissions::ModifySelfservicePermissions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifySelfservicePermissions", "workspaces"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifySelfservicePermissions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifySelfservicePermissions {
                type Output = ::std::result::Result<crate::operation::modify_selfservice_permissions::ModifySelfservicePermissionsOutput, crate::operation::modify_selfservice_permissions::ModifySelfservicePermissionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_selfservice_permissions::de_modify_selfservice_permissions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_selfservice_permissions::de_modify_selfservice_permissions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_selfservice_permissions::ModifySelfservicePermissionsError {
...
mod _modify_selfservice_permissions_output;
