...
impl DescribeWorkspaceSnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_workspace_snapshots::DescribeWorkspaceSnapshotsInput, ::aws_smithy_http::operation::error::BuildError> {
