...
impl ModifyWorkspacePropertiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_workspace_properties::ModifyWorkspacePropertiesInput, ::aws_smithy_http::operation::error::BuildError> {
