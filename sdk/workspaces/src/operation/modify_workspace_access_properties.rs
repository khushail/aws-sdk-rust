...
impl ModifyWorkspaceAccessPropertiesInput {
    /// Consumes the builder and constructs an Operation<[`ModifyWorkspaceAccessProperties`](crate::operation::modify_workspace_access_properties::ModifyWorkspaceAccessProperties)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_workspace_access_properties::ModifyWorkspaceAccessProperties, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_workspace_access_properties::ModifyWorkspaceAccessPropertiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_workspace_access_properties::ModifyWorkspaceAccessProperties::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyWorkspaceAccessProperties", "workspaces"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifyWorkspaceAccessProperties`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyWorkspaceAccessProperties {
                type Output = ::std::result::Result<crate::operation::modify_workspace_access_properties::ModifyWorkspaceAccessPropertiesOutput, crate::operation::modify_workspace_access_properties::ModifyWorkspaceAccessPropertiesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_workspace_access_properties::de_modify_workspace_access_properties_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_workspace_access_properties::de_modify_workspace_access_properties_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_workspace_access_properties::ModifyWorkspaceAccessPropertiesError {
...
pub use crate::operation::modify_workspace_access_properties::_modify_workspace_access_properties_output::ModifyWorkspaceAccessPropertiesOutput;

pub use crate::operation::modify_workspace_access_properties::_modify_workspace_access_properties_input::ModifyWorkspaceAccessPropertiesInput;

mod _modify_workspace_access_properties_input;

mod _modify_workspace_access_properties_output;
