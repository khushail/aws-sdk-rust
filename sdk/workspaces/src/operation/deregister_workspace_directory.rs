...
impl DeregisterWorkspaceDirectoryInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterWorkspaceDirectory`](crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectory::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeregisterWorkspaceDirectory", "workspaces"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeregisterWorkspaceDirectory`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterWorkspaceDirectory {
                type Output = ::std::result::Result<crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryOutput, crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deregister_workspace_directory::de_deregister_workspace_directory_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deregister_workspace_directory::de_deregister_workspace_directory_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_workspace_directory::DeregisterWorkspaceDirectoryError {
...
mod _deregister_workspace_directory_output;
