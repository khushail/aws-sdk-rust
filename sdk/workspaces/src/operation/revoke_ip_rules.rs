...
impl RevokeIpRulesInput {
    /// Consumes the builder and constructs an Operation<[`RevokeIpRules`](crate::operation::revoke_ip_rules::RevokeIpRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::revoke_ip_rules::RevokeIpRules, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_ip_rules::RevokeIpRulesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_ip_rules::RevokeIpRules::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RevokeIpRules", "workspaces"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RevokeIpRules`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeIpRules {
                type Output = ::std::result::Result<crate::operation::revoke_ip_rules::RevokeIpRulesOutput, crate::operation::revoke_ip_rules::RevokeIpRulesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_revoke_ip_rules::de_revoke_ip_rules_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_revoke_ip_rules::de_revoke_ip_rules_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::revoke_ip_rules::RevokeIpRulesError {
