...
impl DeleteConnectClientAddInInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_connect_client_add_in::DeleteConnectClientAddInInput, ::aws_smithy_http::operation::error::BuildError> {
