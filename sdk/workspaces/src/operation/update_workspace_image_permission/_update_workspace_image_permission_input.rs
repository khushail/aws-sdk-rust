...
impl UpdateWorkspaceImagePermissionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_workspace_image_permission::UpdateWorkspaceImagePermissionInput, ::aws_smithy_http::operation::error::BuildError> {
