...
impl DisassociateConnectionAliasInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateConnectionAlias`](crate::operation::disassociate_connection_alias::DisassociateConnectionAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_connection_alias::DisassociateConnectionAlias, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_connection_alias::DisassociateConnectionAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::disassociate_connection_alias::DisassociateConnectionAliasInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_connection_alias::DisassociateConnectionAlias::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateConnectionAlias", "workspaces"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisassociateConnectionAlias`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateConnectionAlias {
                type Output = ::std::result::Result<crate::operation::disassociate_connection_alias::DisassociateConnectionAliasOutput, crate::operation::disassociate_connection_alias::DisassociateConnectionAliasError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_connection_alias::de_disassociate_connection_alias_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_connection_alias::de_disassociate_connection_alias_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_connection_alias::DisassociateConnectionAliasError {
...
mod _disassociate_connection_alias_output;
