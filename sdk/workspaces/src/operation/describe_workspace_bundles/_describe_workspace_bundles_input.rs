...
impl DescribeWorkspaceBundlesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_workspace_bundles::DescribeWorkspaceBundlesInput, ::aws_smithy_http::operation::error::BuildError> {
