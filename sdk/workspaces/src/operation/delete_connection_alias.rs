...
impl DeleteConnectionAliasInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_connection_alias::DeleteConnectionAlias, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_connection_alias::DeleteConnectionAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteConnectionAlias {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_connection_alias::de_delete_connection_alias_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_connection_alias::de_delete_connection_alias_http_response_with_props(status, headers, body)
                     }
                }
