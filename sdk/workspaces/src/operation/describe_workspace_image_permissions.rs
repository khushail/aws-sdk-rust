...
impl DescribeWorkspaceImagePermissionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeWorkspaceImagePermissions`](crate::operation::describe_workspace_image_permissions::DescribeWorkspaceImagePermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_workspace_image_permissions::DescribeWorkspaceImagePermissions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_workspace_image_permissions::DescribeWorkspaceImagePermissionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_workspace_image_permissions::DescribeWorkspaceImagePermissions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkspaceImagePermissions {
                type Output = ::std::result::Result<crate::operation::describe_workspace_image_permissions::DescribeWorkspaceImagePermissionsOutput, crate::operation::describe_workspace_image_permissions::DescribeWorkspaceImagePermissionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_workspace_image_permissions::de_describe_workspace_image_permissions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_workspace_image_permissions::de_describe_workspace_image_permissions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_workspace_image_permissions::DescribeWorkspaceImagePermissionsError {
...
mod _describe_workspace_image_permissions_output;
