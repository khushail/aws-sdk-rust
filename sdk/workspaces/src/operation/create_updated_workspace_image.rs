...
impl CreateUpdatedWorkspaceImageInput {
    /// Consumes the builder and constructs an Operation<[`CreateUpdatedWorkspaceImage`](crate::operation::create_updated_workspace_image::CreateUpdatedWorkspaceImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_updated_workspace_image::CreateUpdatedWorkspaceImage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_updated_workspace_image::CreateUpdatedWorkspaceImageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_updated_workspace_image::CreateUpdatedWorkspaceImage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateUpdatedWorkspaceImage", "workspaces"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateUpdatedWorkspaceImage`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUpdatedWorkspaceImage {
                type Output = ::std::result::Result<crate::operation::create_updated_workspace_image::CreateUpdatedWorkspaceImageOutput, crate::operation::create_updated_workspace_image::CreateUpdatedWorkspaceImageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_updated_workspace_image::de_create_updated_workspace_image_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_updated_workspace_image::de_create_updated_workspace_image_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_updated_workspace_image::CreateUpdatedWorkspaceImageError {
...
mod _create_updated_workspace_image_output;
