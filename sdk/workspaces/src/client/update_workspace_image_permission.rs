...
impl super::Client  {
    ...
    ///   - [`image_id(impl ::std::convert::Into<String>)`](crate::operation::update_workspace_image_permission::builders::UpdateWorkspaceImagePermissionFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::update_workspace_image_permission::builders::UpdateWorkspaceImagePermissionFluentBuilder::set_image_id): <p>The identifier of the image.</p>
