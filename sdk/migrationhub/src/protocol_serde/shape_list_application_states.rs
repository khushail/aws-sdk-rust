...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_application_states_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_application_states::ListApplicationStatesOutput, crate::operation::list_application_states::ListApplicationStatesError> {
    Ok({
        #[allow(unused_mut)]
