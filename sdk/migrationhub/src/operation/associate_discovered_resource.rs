...
impl AssociateDiscoveredResourceInput {
    /// Consumes the builder and constructs an Operation<[`AssociateDiscoveredResource`](crate::operation::associate_discovered_resource::AssociateDiscoveredResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_discovered_resource::AssociateDiscoveredResource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_discovered_resource::AssociateDiscoveredResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_discovered_resource::AssociateDiscoveredResource::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateDiscoveredResource", "migrationhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateDiscoveredResource`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDiscoveredResource {
                type Output = ::std::result::Result<crate::operation::associate_discovered_resource::AssociateDiscoveredResourceOutput, crate::operation::associate_discovered_resource::AssociateDiscoveredResourceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_associate_discovered_resource::de_associate_discovered_resource_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_discovered_resource::AssociateDiscoveredResourceError {
...
mod _associate_discovered_resource_output;
