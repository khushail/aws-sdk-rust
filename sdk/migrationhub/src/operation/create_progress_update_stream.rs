...
impl CreateProgressUpdateStreamInput {
    /// Consumes the builder and constructs an Operation<[`CreateProgressUpdateStream`](crate::operation::create_progress_update_stream::CreateProgressUpdateStream)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_progress_update_stream::CreateProgressUpdateStream, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_progress_update_stream::CreateProgressUpdateStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_progress_update_stream::CreateProgressUpdateStream::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateProgressUpdateStream", "migrationhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateProgressUpdateStream`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProgressUpdateStream {
                type Output = ::std::result::Result<crate::operation::create_progress_update_stream::CreateProgressUpdateStreamOutput, crate::operation::create_progress_update_stream::CreateProgressUpdateStreamError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_progress_update_stream::de_create_progress_update_stream_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_progress_update_stream::de_create_progress_update_stream_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_progress_update_stream::CreateProgressUpdateStreamError {
...
mod _create_progress_update_stream_output;
