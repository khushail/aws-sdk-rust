...
impl ListMigrationTasksInput {
    /// Consumes the builder and constructs an Operation<[`ListMigrationTasks`](crate::operation::list_migration_tasks::ListMigrationTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_migration_tasks::ListMigrationTasks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_migration_tasks::ListMigrationTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_migration_tasks::ser_list_migration_tasks_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_migration_tasks::ListMigrationTasks::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMigrationTasks {
                type Output = ::std::result::Result<crate::operation::list_migration_tasks::ListMigrationTasksOutput, crate::operation::list_migration_tasks::ListMigrationTasksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_migration_tasks::de_list_migration_tasks_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_migration_tasks::de_list_migration_tasks_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_migration_tasks::ListMigrationTasksError {
...
mod _list_migration_tasks_output;
