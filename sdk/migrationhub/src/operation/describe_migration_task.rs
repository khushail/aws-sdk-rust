...
impl DescribeMigrationTaskInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMigrationTask`](crate::operation::describe_migration_task::DescribeMigrationTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_migration_task::DescribeMigrationTask, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_migration_task::DescribeMigrationTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_migration_task::DescribeMigrationTask::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMigrationTask {
                type Output = ::std::result::Result<crate::operation::describe_migration_task::DescribeMigrationTaskOutput, crate::operation::describe_migration_task::DescribeMigrationTaskError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_migration_task::de_describe_migration_task_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_migration_task::de_describe_migration_task_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_migration_task::DescribeMigrationTaskError {
...
pub use crate::operation::describe_migration_task::_describe_migration_task_output::DescribeMigrationTaskOutput;

pub use crate::operation::describe_migration_task::_describe_migration_task_input::DescribeMigrationTaskInput;

mod _describe_migration_task_input;

mod _describe_migration_task_output;
