...
impl ImportMigrationTaskInput {
    /// Consumes the builder and constructs an Operation<[`ImportMigrationTask`](crate::operation::import_migration_task::ImportMigrationTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_migration_task::ImportMigrationTask, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_migration_task::ImportMigrationTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_import_migration_task::ser_import_migration_task_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_migration_task::ImportMigrationTask::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ImportMigrationTask", "migrationhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ImportMigrationTask`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportMigrationTask {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_import_migration_task::de_import_migration_task_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::import_migration_task::ImportMigrationTaskError {
...
pub use crate::operation::import_migration_task::_import_migration_task_output::ImportMigrationTaskOutput;

pub use crate::operation::import_migration_task::_import_migration_task_input::ImportMigrationTaskInput;

mod _import_migration_task_input;

mod _import_migration_task_output;
