...
impl ListProgressUpdateStreamsInput {
    /// Consumes the builder and constructs an Operation<[`ListProgressUpdateStreams`](crate::operation::list_progress_update_streams::ListProgressUpdateStreams)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_progress_update_streams::ListProgressUpdateStreams, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_progress_update_streams::ListProgressUpdateStreamsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_progress_update_streams::ListProgressUpdateStreams::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListProgressUpdateStreams", "migrationhub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListProgressUpdateStreams`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProgressUpdateStreams {
                type Output = ::std::result::Result<crate::operation::list_progress_update_streams::ListProgressUpdateStreamsOutput, crate::operation::list_progress_update_streams::ListProgressUpdateStreamsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_progress_update_streams::de_list_progress_update_streams_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_progress_update_streams::de_list_progress_update_streams_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_progress_update_streams::ListProgressUpdateStreamsError {
...
mod _list_progress_update_streams_output;
