...
impl DescribeApplicationStateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_application_state::DescribeApplicationStateInput, ::aws_smithy_http::operation::error::BuildError> {
