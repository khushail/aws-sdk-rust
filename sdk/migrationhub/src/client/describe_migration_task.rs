...
impl super::Client  {
    ...
    ///   - [`progress_update_stream(impl ::std::convert::Into<String>)`](crate::operation::describe_migration_task::builders::DescribeMigrationTaskFluentBuilder::progress_update_stream) / [`set_progress_update_stream(Option<String>)`](crate::operation::describe_migration_task::builders::DescribeMigrationTaskFluentBuilder::set_progress_update_stream): <p>The name of the ProgressUpdateStream. </p>
    ///   - [`migration_task_name(impl ::std::convert::Into<String>)`](crate::operation::describe_migration_task::builders::DescribeMigrationTaskFluentBuilder::migration_task_name) / [`set_migration_task_name(Option<String>)`](crate::operation::describe_migration_task::builders::DescribeMigrationTaskFluentBuilder::set_migration_task_name): <p>The identifier given to the MigrationTask. <i>Do not store personal data in this field.</i> </p>
