...
impl super::Client  {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::notify_application_state::builders::NotifyApplicationStateFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::notify_application_state::builders::NotifyApplicationStateFluentBuilder::set_application_id): <p>The configurationId in Application Discovery Service that uniquely identifies the grouped application.</p>
