...
impl super::Client  {
    ...
    ///   - [`registry_id(impl ::std::convert::Into<String>)`](crate::operation::get_repository_policy::builders::GetRepositoryPolicyFluentBuilder::registry_id) / [`set_registry_id(Option<String>)`](crate::operation::get_repository_policy::builders::GetRepositoryPolicyFluentBuilder::set_registry_id): <p>The Amazon Web Services account ID that's associated with the public registry that contains the repository. If you do not specify a registry, the default public registry is assumed.</p>
