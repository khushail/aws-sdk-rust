...
impl BatchCheckLayerAvailabilityInput {
    /// Consumes the builder and constructs an Operation<[`BatchCheckLayerAvailability`](crate::operation::batch_check_layer_availability::BatchCheckLayerAvailability)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailability, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_check_layer_availability::ser_batch_check_layer_availability_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_check_layer_availability::BatchCheckLayerAvailability::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchCheckLayerAvailability", "ecrpublic"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchCheckLayerAvailability {
                type Output = ::std::result::Result<crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityOutput, crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_check_layer_availability::de_batch_check_layer_availability_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_check_layer_availability::de_batch_check_layer_availability_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_check_layer_availability::BatchCheckLayerAvailabilityError {
...
mod _batch_check_layer_availability_output;
