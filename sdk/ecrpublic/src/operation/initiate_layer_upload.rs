...
impl InitiateLayerUploadInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::initiate_layer_upload::InitiateLayerUpload, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::initiate_layer_upload::InitiateLayerUploadInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::initiate_layer_upload::InitiateLayerUpload::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("InitiateLayerUpload", "ecrpublic"));
