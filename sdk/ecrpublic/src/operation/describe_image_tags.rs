...
impl DescribeImageTagsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeImageTags`](crate::operation::describe_image_tags::DescribeImageTags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_image_tags::DescribeImageTags, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_image_tags::DescribeImageTagsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_image_tags::ser_describe_image_tags_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_image_tags::DescribeImageTags::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeImageTags", "ecrpublic"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeImageTags`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeImageTags {
                type Output = ::std::result::Result<crate::operation::describe_image_tags::DescribeImageTagsOutput, crate::operation::describe_image_tags::DescribeImageTagsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_image_tags::de_describe_image_tags_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_image_tags::DescribeImageTagsError {
...
mod _describe_image_tags_output;
