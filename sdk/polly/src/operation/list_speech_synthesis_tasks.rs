...
impl ListSpeechSynthesisTasksInput {
    /// Consumes the builder and constructs an Operation<[`ListSpeechSynthesisTasks`](crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/synthesisTasks").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasks::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSpeechSynthesisTasks {
                type Output = ::std::result::Result<crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksOutput, crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_speech_synthesis_tasks::de_list_speech_synthesis_tasks_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_speech_synthesis_tasks::ListSpeechSynthesisTasksError {
