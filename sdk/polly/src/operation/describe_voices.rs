...
impl DescribeVoicesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeVoices`](crate::operation::describe_voices::DescribeVoices)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_voices::DescribeVoices, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_voices::DescribeVoicesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/voices").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_voices::DescribeVoicesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.include_additional_language_codes {
                    if *inner_3 {
                        query.push_kv("IncludeAdditionalLanguageCodes", ::aws_smithy_types::primitive::Encoder::from(*inner_3).encode());
                    }
                }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_voices::DescribeVoices::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVoices {
                type Output = ::std::result::Result<crate::operation::describe_voices::DescribeVoicesOutput, crate::operation::describe_voices::DescribeVoicesError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_voices::DescribeVoicesError {
