...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_polly::Error> {
/// # let client: aws_sdk_polly::Client = unimplemented!();
...
mod get_speech_synthesis_task;

mod list_lexicons;

mod list_speech_synthesis_tasks;
