...
pub fn de_audio_stream_payload(body: &mut ::aws_smithy_http::body::SdkBody) -> std::result::Result<::aws_smithy_http::byte_stream::ByteStream, crate::operation::synthesize_speech::SynthesizeSpeechError> {
...
pub(crate) fn de_request_characters_header(header_map: &::http::HeaderMap) -> std::result::Result<::std::option::Option<i32>, ::aws_smithy_http::header::ParseError> {
