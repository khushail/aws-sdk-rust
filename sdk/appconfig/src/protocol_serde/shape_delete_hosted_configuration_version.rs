...
pub fn de_delete_hosted_configuration_version_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersionOutput, crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_hosted_configuration_version_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersionOutput, crate::operation::delete_hosted_configuration_version::DeleteHostedConfigurationVersionError> {
    Ok({
        #[allow(unused_mut)]
