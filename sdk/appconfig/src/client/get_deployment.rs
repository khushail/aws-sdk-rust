...
impl super::Client  {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::get_deployment::builders::GetDeploymentFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_deployment::builders::GetDeploymentFluentBuilder::set_application_id): <p>The ID of the application that includes the deployment you want to get. </p>
    ///   - [`environment_id(impl ::std::convert::Into<String>)`](crate::operation::get_deployment::builders::GetDeploymentFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::get_deployment::builders::GetDeploymentFluentBuilder::set_environment_id): <p>The ID of the environment that includes the deployment you want to get. </p>
    ...
    ///   - [`kms_key_identifier(Option<String>)`](crate::operation::get_deployment::GetDeploymentOutput::kms_key_identifier): <p>The KMS key identifier (key ID, key alias, or key ARN). AppConfig uses this ID to encrypt the configuration data using a customer managed key. </p>
