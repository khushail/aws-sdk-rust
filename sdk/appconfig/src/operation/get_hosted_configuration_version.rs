...
impl GetHostedConfigurationVersionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_hosted_configuration_version::GetHostedConfigurationVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_hosted_configuration_version::GetHostedConfigurationVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `GetHostedConfigurationVersion`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHostedConfigurationVersion {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_hosted_configuration_version::de_get_hosted_configuration_version_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_hosted_configuration_version::de_get_hosted_configuration_version_http_response_with_props(status, headers, body)
                     }
                }
