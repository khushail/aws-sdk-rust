...
impl UpdateDeploymentStrategyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDeploymentStrategy`](crate::operation::update_deployment_strategy::UpdateDeploymentStrategy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_deployment_strategy::UpdateDeploymentStrategy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_deployment_strategy::UpdateDeploymentStrategyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if deployment_strategy_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("deployment_strategy_id", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_deployment_strategy::UpdateDeploymentStrategy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDeploymentStrategy", "appconfig"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateDeploymentStrategy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDeploymentStrategy {
                type Output = ::std::result::Result<crate::operation::update_deployment_strategy::UpdateDeploymentStrategyOutput, crate::operation::update_deployment_strategy::UpdateDeploymentStrategyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_deployment_strategy::de_update_deployment_strategy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_deployment_strategy::de_update_deployment_strategy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_deployment_strategy::UpdateDeploymentStrategyError {
...
pub use crate::operation::update_deployment_strategy::_update_deployment_strategy_output::UpdateDeploymentStrategyOutput;

pub use crate::operation::update_deployment_strategy::_update_deployment_strategy_input::UpdateDeploymentStrategyInput;

mod _update_deployment_strategy_input;

mod _update_deployment_strategy_output;
