...
impl ListHostedConfigurationVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListHostedConfigurationVersions`](crate::operation::list_hosted_configuration_versions::ListHostedConfigurationVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_hosted_configuration_versions::ListHostedConfigurationVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_hosted_configuration_versions::ListHostedConfigurationVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_hosted_configuration_versions::ListHostedConfigurationVersionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHostedConfigurationVersions {
                type Output = ::std::result::Result<crate::operation::list_hosted_configuration_versions::ListHostedConfigurationVersionsOutput, crate::operation::list_hosted_configuration_versions::ListHostedConfigurationVersionsError>;
...
mod _list_hosted_configuration_versions_output;
