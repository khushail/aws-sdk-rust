...
impl DeleteConfigurationProfileInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_configuration_profile::DeleteConfigurationProfileInput, ::aws_smithy_http::operation::error::BuildError> {
