...
impl CreateDeploymentStrategyInput {
    /// Consumes the builder and constructs an Operation<[`CreateDeploymentStrategy`](crate::operation::create_deployment_strategy::CreateDeploymentStrategy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_deployment_strategy::CreateDeploymentStrategy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_deployment_strategy::CreateDeploymentStrategyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/deploymentstrategies").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_deployment_strategy::CreateDeploymentStrategy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDeploymentStrategy", "appconfig"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateDeploymentStrategy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDeploymentStrategy {
                type Output = ::std::result::Result<crate::operation::create_deployment_strategy::CreateDeploymentStrategyOutput, crate::operation::create_deployment_strategy::CreateDeploymentStrategyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_deployment_strategy::de_create_deployment_strategy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_deployment_strategy::de_create_deployment_strategy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_deployment_strategy::CreateDeploymentStrategyError {
...
pub use crate::operation::create_deployment_strategy::_create_deployment_strategy_output::CreateDeploymentStrategyOutput;

pub use crate::operation::create_deployment_strategy::_create_deployment_strategy_input::CreateDeploymentStrategyInput;

mod _create_deployment_strategy_input;

mod _create_deployment_strategy_output;
