...
impl UpdateExtensionAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_extension_association::UpdateExtensionAssociationInput, ::aws_smithy_http::operation::error::BuildError> {
