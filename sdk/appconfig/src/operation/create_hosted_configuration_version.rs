...
impl CreateHostedConfigurationVersionInput {
    /// Consumes the builder and constructs an Operation<[`CreateHostedConfigurationVersion`](crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if configuration_profile_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("configuration_profile_id", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersion::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHostedConfigurationVersion {
                type Output = ::std::result::Result<crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionOutput, crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_hosted_configuration_version::de_create_hosted_configuration_version_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_hosted_configuration_version::de_create_hosted_configuration_version_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_hosted_configuration_version::CreateHostedConfigurationVersionError {
...
mod _create_hosted_configuration_version_output;
