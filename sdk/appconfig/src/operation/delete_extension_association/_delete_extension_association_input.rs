...
impl DeleteExtensionAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_extension_association::DeleteExtensionAssociationInput, ::aws_smithy_http::operation::error::BuildError> {
