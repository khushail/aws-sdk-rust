...
impl GetExtensionInput {
    /// Consumes the builder and constructs an Operation<[`GetExtension`](crate::operation::get_extension::GetExtension)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_extension::GetExtension, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_extension::GetExtensionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if extension_identifier.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("extension_identifier", "cannot be empty or unset"))
                            }
            ...
            fn uri_query(_input: &crate::operation::get_extension::GetExtensionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                if let ::std::option::Option::Some(inner_2) = &_input.version_number {
                    if *inner_2 != 0 {
                        query.push_kv("version_number", ::aws_smithy_types::primitive::Encoder::from(*inner_2).encode());
                    }
                }
                ::std::result::Result::Ok(())
            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_extension::GetExtension::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetExtension {
                type Output = ::std::result::Result<crate::operation::get_extension::GetExtensionOutput, crate::operation::get_extension::GetExtensionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_extension::de_get_extension_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_extension::GetExtensionError {
