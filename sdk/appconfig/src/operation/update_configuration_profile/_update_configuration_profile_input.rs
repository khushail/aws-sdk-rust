...
impl UpdateConfigurationProfileInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_configuration_profile::UpdateConfigurationProfileInput, ::aws_smithy_http::operation::error::BuildError> {
