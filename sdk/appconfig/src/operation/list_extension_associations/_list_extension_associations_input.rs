...
impl ListExtensionAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_extension_associations::ListExtensionAssociationsInput, ::aws_smithy_http::operation::error::BuildError> {
