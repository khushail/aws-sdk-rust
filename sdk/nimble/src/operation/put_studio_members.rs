...
impl PutStudioMembersInput {
    /// Consumes the builder and constructs an Operation<[`PutStudioMembers`](crate::operation::put_studio_members::PutStudioMembers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_studio_members::PutStudioMembers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_studio_members::PutStudioMembersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_studio_members::PutStudioMembers::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutStudioMembers {
                type Output = ::std::result::Result<crate::operation::put_studio_members::PutStudioMembersOutput, crate::operation::put_studio_members::PutStudioMembersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_studio_members::de_put_studio_members_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_studio_members::de_put_studio_members_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_studio_members::PutStudioMembersError {
...
pub use crate::operation::put_studio_members::_put_studio_members_output::PutStudioMembersOutput;

pub use crate::operation::put_studio_members::_put_studio_members_input::PutStudioMembersInput;

mod _put_studio_members_input;

mod _put_studio_members_output;
