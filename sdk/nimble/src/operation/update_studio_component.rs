...
impl UpdateStudioComponentInput {
    /// Consumes the builder and constructs an Operation<[`UpdateStudioComponent`](crate::operation::update_studio_component::UpdateStudioComponent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_studio_component::UpdateStudioComponent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_studio_component::UpdateStudioComponentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if studio_component_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("studio_component_id", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_studio_component::UpdateStudioComponent::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateStudioComponent {
                type Output = ::std::result::Result<crate::operation::update_studio_component::UpdateStudioComponentOutput, crate::operation::update_studio_component::UpdateStudioComponentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_studio_component::de_update_studio_component_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_studio_component::de_update_studio_component_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_studio_component::UpdateStudioComponentError {
...
pub use crate::operation::update_studio_component::_update_studio_component_output::UpdateStudioComponentOutput;

pub use crate::operation::update_studio_component::_update_studio_component_input::UpdateStudioComponentInput;

mod _update_studio_component_input;

mod _update_studio_component_output;
