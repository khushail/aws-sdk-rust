...
pub fn ser_update_launch_profile_headers(
...
pub fn ser_update_launch_profile_input(input: &crate::operation::update_launch_profile::UpdateLaunchProfileInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_update_launch_profile_input::ser_update_launch_profile_input(&mut object, input)?;
    object.finish();
...
pub fn de_update_launch_profile_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_launch_profile::UpdateLaunchProfileOutput, crate::operation::update_launch_profile::UpdateLaunchProfileError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::update_launch_profile::UpdateLaunchProfileError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::update_launch_profile::UpdateLaunchProfileError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ConflictException" => crate::operation::update_launch_profile::UpdateLaunchProfileError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServerErrorException" => crate::operation::update_launch_profile::UpdateLaunchProfileError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::update_launch_profile::UpdateLaunchProfileError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => crate::operation::update_launch_profile::UpdateLaunchProfileError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::update_launch_profile::UpdateLaunchProfileError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::update_launch_profile::UpdateLaunchProfileError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::update_launch_profile::UpdateLaunchProfileError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_update_launch_profile_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_launch_profile::UpdateLaunchProfileOutput, crate::operation::update_launch_profile::UpdateLaunchProfileError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_update_launch_profile(value: &[u8], mut builder: crate::operation::update_launch_profile::builders::UpdateLaunchProfileOutputBuilder) -> Result<crate::operation::update_launch_profile::builders::UpdateLaunchProfileOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
