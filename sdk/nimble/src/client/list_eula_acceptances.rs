...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_eula_acceptances::builders::ListEulaAcceptancesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_eula_acceptances::builders::ListEulaAcceptancesFluentBuilder::set_next_token): <p>The token for the next set of results, or null if there are no more results.</p>
    ///   - [`studio_id(impl ::std::convert::Into<String>)`](crate::operation::list_eula_acceptances::builders::ListEulaAcceptancesFluentBuilder::studio_id) / [`set_studio_id(Option<String>)`](crate::operation::list_eula_acceptances::builders::ListEulaAcceptancesFluentBuilder::set_studio_id): <p>The studio ID. </p>
