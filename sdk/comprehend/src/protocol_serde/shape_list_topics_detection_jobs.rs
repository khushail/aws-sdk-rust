...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_topics_detection_jobs_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsOutput, crate::operation::list_topics_detection_jobs::ListTopicsDetectionJobsError> {
    Ok({
        #[allow(unused_mut)]
