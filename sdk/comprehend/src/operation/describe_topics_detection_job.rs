...
impl DescribeTopicsDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTopicsDetectionJob`](crate::operation::describe_topics_detection_job::DescribeTopicsDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_topics_detection_job::DescribeTopicsDetectionJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_topics_detection_job::DescribeTopicsDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_topics_detection_job::DescribeTopicsDetectionJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeTopicsDetectionJob", "comprehend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeTopicsDetectionJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTopicsDetectionJob {
                type Output = ::std::result::Result<crate::operation::describe_topics_detection_job::DescribeTopicsDetectionJobOutput, crate::operation::describe_topics_detection_job::DescribeTopicsDetectionJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_topics_detection_job::de_describe_topics_detection_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_topics_detection_job::de_describe_topics_detection_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_topics_detection_job::DescribeTopicsDetectionJobError {
...
pub use crate::operation::describe_topics_detection_job::_describe_topics_detection_job_output::DescribeTopicsDetectionJobOutput;

pub use crate::operation::describe_topics_detection_job::_describe_topics_detection_job_input::DescribeTopicsDetectionJobInput;

mod _describe_topics_detection_job_input;

mod _describe_topics_detection_job_output;
