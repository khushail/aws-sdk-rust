...
impl DescribeTopicsDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_topics_detection_job::DescribeTopicsDetectionJobInput, ::aws_smithy_http::operation::error::BuildError> {
