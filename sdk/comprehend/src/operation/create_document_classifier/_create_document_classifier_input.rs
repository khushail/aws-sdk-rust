...
impl CreateDocumentClassifierInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_document_classifier::CreateDocumentClassifierInput, ::aws_smithy_http::operation::error::BuildError> {
