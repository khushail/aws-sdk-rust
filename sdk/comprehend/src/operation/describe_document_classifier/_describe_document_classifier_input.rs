...
impl DescribeDocumentClassifierInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_document_classifier::DescribeDocumentClassifierInput, ::aws_smithy_http::operation::error::BuildError> {
