...
impl DescribePiiEntitiesDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribePiiEntitiesDetectionJob`](crate::operation::describe_pii_entities_detection_job::DescribePiiEntitiesDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_pii_entities_detection_job::DescribePiiEntitiesDetectionJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_pii_entities_detection_job::DescribePiiEntitiesDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_pii_entities_detection_job::DescribePiiEntitiesDetectionJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePiiEntitiesDetectionJob {
                type Output = ::std::result::Result<crate::operation::describe_pii_entities_detection_job::DescribePiiEntitiesDetectionJobOutput, crate::operation::describe_pii_entities_detection_job::DescribePiiEntitiesDetectionJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_pii_entities_detection_job::de_describe_pii_entities_detection_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_pii_entities_detection_job::de_describe_pii_entities_detection_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_pii_entities_detection_job::DescribePiiEntitiesDetectionJobError {
...
pub use crate::operation::describe_pii_entities_detection_job::_describe_pii_entities_detection_job_output::DescribePiiEntitiesDetectionJobOutput;

pub use crate::operation::describe_pii_entities_detection_job::_describe_pii_entities_detection_job_input::DescribePiiEntitiesDetectionJobInput;

mod _describe_pii_entities_detection_job_input;

mod _describe_pii_entities_detection_job_output;
