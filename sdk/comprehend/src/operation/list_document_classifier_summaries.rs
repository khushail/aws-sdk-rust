...
impl ListDocumentClassifierSummariesInput {
    /// Consumes the builder and constructs an Operation<[`ListDocumentClassifierSummaries`](crate::operation::list_document_classifier_summaries::ListDocumentClassifierSummaries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_document_classifier_summaries::ListDocumentClassifierSummaries, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_document_classifier_summaries::ListDocumentClassifierSummariesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_document_classifier_summaries::ListDocumentClassifierSummaries::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDocumentClassifierSummaries", "comprehend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListDocumentClassifierSummaries`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDocumentClassifierSummaries {
                type Output = ::std::result::Result<crate::operation::list_document_classifier_summaries::ListDocumentClassifierSummariesOutput, crate::operation::list_document_classifier_summaries::ListDocumentClassifierSummariesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_document_classifier_summaries::de_list_document_classifier_summaries_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_document_classifier_summaries::de_list_document_classifier_summaries_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_document_classifier_summaries::ListDocumentClassifierSummariesError {
...
pub use crate::operation::list_document_classifier_summaries::_list_document_classifier_summaries_output::ListDocumentClassifierSummariesOutput;

pub use crate::operation::list_document_classifier_summaries::_list_document_classifier_summaries_input::ListDocumentClassifierSummariesInput;

mod _list_document_classifier_summaries_input;

mod _list_document_classifier_summaries_output;
