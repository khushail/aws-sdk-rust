...
impl ImportModelInput {
    /// Consumes the builder and constructs an Operation<[`ImportModel`](crate::operation::import_model::ImportModel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_model::ImportModel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_model::ImportModelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_model::ImportModel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ImportModel", "comprehend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ImportModel`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportModel {
                type Output = ::std::result::Result<crate::operation::import_model::ImportModelOutput, crate::operation::import_model::ImportModelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_import_model::de_import_model_http_response_with_props(status, headers, body)
                     }
                }
