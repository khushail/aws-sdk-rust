...
impl DescribeFlywheelIterationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_flywheel_iteration::DescribeFlywheelIterationInput, ::aws_smithy_http::operation::error::BuildError> {
