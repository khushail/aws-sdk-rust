...
impl DescribeDominantLanguageDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDominantLanguageDetectionJob`](crate::operation::describe_dominant_language_detection_job::DescribeDominantLanguageDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_dominant_language_detection_job::DescribeDominantLanguageDetectionJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_dominant_language_detection_job::DescribeDominantLanguageDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_dominant_language_detection_job::DescribeDominantLanguageDetectionJobInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_dominant_language_detection_job::DescribeDominantLanguageDetectionJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDominantLanguageDetectionJob", "comprehend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeDominantLanguageDetectionJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDominantLanguageDetectionJob {
                type Output = ::std::result::Result<crate::operation::describe_dominant_language_detection_job::DescribeDominantLanguageDetectionJobOutput, crate::operation::describe_dominant_language_detection_job::DescribeDominantLanguageDetectionJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_dominant_language_detection_job::de_describe_dominant_language_detection_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_dominant_language_detection_job::de_describe_dominant_language_detection_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_dominant_language_detection_job::DescribeDominantLanguageDetectionJobError {
...
pub use crate::operation::describe_dominant_language_detection_job::_describe_dominant_language_detection_job_output::DescribeDominantLanguageDetectionJobOutput;

pub use crate::operation::describe_dominant_language_detection_job::_describe_dominant_language_detection_job_input::DescribeDominantLanguageDetectionJobInput;

mod _describe_dominant_language_detection_job_input;

mod _describe_dominant_language_detection_job_output;
