...
impl StartPiiEntitiesDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_pii_entities_detection_job::StartPiiEntitiesDetectionJobInput, ::aws_smithy_http::operation::error::BuildError> {
