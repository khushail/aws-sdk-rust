...
impl StopKeyPhrasesDetectionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_key_phrases_detection_job::StopKeyPhrasesDetectionJobInput, ::aws_smithy_http::operation::error::BuildError> {
