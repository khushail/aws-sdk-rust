...
impl DescribeEntityRecognizerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_entity_recognizer::DescribeEntityRecognizerInput, ::aws_smithy_http::operation::error::BuildError> {
