...
impl BatchDetectDominantLanguageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageInput, ::aws_smithy_http::operation::error::BuildError> {
