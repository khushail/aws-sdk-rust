...
impl StartSentimentDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`StartSentimentDetectionJob`](crate::operation::start_sentiment_detection_job::StartSentimentDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_sentiment_detection_job::StartSentimentDetectionJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_sentiment_detection_job::StartSentimentDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_sentiment_detection_job::StartSentimentDetectionJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartSentimentDetectionJob", "comprehend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartSentimentDetectionJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSentimentDetectionJob {
                type Output = ::std::result::Result<crate::operation::start_sentiment_detection_job::StartSentimentDetectionJobOutput, crate::operation::start_sentiment_detection_job::StartSentimentDetectionJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_sentiment_detection_job::de_start_sentiment_detection_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_sentiment_detection_job::de_start_sentiment_detection_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_sentiment_detection_job::StartSentimentDetectionJobError {
...
impl StartSentimentDetectionJobError {
    ...
    /// Returns `true` if the error kind is `StartSentimentDetectionJobError::ResourceInUseException`.
...
mod _start_sentiment_detection_job_output;
