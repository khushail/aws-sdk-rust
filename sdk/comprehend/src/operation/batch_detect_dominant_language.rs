...
impl BatchDetectDominantLanguageInput {
    /// Consumes the builder and constructs an Operation<[`BatchDetectDominantLanguage`](crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchDetectDominantLanguage", "comprehend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchDetectDominantLanguage`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDetectDominantLanguage {
                type Output = ::std::result::Result<crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageOutput, crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_detect_dominant_language::de_batch_detect_dominant_language_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_detect_dominant_language::de_batch_detect_dominant_language_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_detect_dominant_language::BatchDetectDominantLanguageError {
...
mod _batch_detect_dominant_language_output;
