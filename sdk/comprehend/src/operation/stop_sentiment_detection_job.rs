...
impl StopSentimentDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`StopSentimentDetectionJob`](crate::operation::stop_sentiment_detection_job::StopSentimentDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_sentiment_detection_job::StopSentimentDetectionJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_sentiment_detection_job::StopSentimentDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_sentiment_detection_job::StopSentimentDetectionJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopSentimentDetectionJob", "comprehend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StopSentimentDetectionJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopSentimentDetectionJob {
                type Output = ::std::result::Result<crate::operation::stop_sentiment_detection_job::StopSentimentDetectionJobOutput, crate::operation::stop_sentiment_detection_job::StopSentimentDetectionJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_sentiment_detection_job::de_stop_sentiment_detection_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_sentiment_detection_job::de_stop_sentiment_detection_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_sentiment_detection_job::StopSentimentDetectionJobError {
...
mod _stop_sentiment_detection_job_output;
