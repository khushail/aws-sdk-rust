...
impl ListEventsDetectionJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_events_detection_jobs::ListEventsDetectionJobsInput, ::aws_smithy_http::operation::error::BuildError> {
