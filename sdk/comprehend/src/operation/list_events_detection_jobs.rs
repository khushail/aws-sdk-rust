...
impl ListEventsDetectionJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListEventsDetectionJobs`](crate::operation::list_events_detection_jobs::ListEventsDetectionJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_events_detection_jobs::ListEventsDetectionJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_events_detection_jobs::ListEventsDetectionJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_events_detection_jobs::ListEventsDetectionJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEventsDetectionJobs {
                type Output = ::std::result::Result<crate::operation::list_events_detection_jobs::ListEventsDetectionJobsOutput, crate::operation::list_events_detection_jobs::ListEventsDetectionJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_events_detection_jobs::de_list_events_detection_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_events_detection_jobs::de_list_events_detection_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_events_detection_jobs::ListEventsDetectionJobsError {
...
mod _list_events_detection_jobs_output;
