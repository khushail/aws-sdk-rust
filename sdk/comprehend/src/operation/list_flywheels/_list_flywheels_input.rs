...
impl ListFlywheelsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_flywheels::ListFlywheelsInput, ::aws_smithy_http::operation::error::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::list_flywheels::ListFlywheelsInput {
                filter: self.filter
                ,
