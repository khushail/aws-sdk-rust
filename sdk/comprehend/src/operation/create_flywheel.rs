...
impl CreateFlywheelInput {
    /// Consumes the builder and constructs an Operation<[`CreateFlywheel`](crate::operation::create_flywheel::CreateFlywheel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_flywheel::CreateFlywheel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_flywheel::CreateFlywheelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_flywheel::ser_create_flywheel_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_flywheel::CreateFlywheel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateFlywheel", "comprehend"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFlywheel {
                type Output = ::std::result::Result<crate::operation::create_flywheel::CreateFlywheelOutput, crate::operation::create_flywheel::CreateFlywheelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_flywheel::de_create_flywheel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_flywheel::de_create_flywheel_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateFlywheelErrorKind = CreateFlywheelError;
/// Error type for the `CreateFlywheelError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateFlywheelError {
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateFlywheelError {
...
impl ::std::fmt::Display for CreateFlywheelError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateFlywheelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_flywheel::CreateFlywheelError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateFlywheelError {
...
impl CreateFlywheelError {
    /// Creates the `CreateFlywheelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateFlywheelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateFlywheelError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `CreateFlywheelError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateFlywheelError::KmsKeyValidationException`.
    pub fn is_kms_key_validation_exception(&self) -> bool {
        matches!(self, Self::KmsKeyValidationException(_))
    }
    /// Returns `true` if the error kind is `CreateFlywheelError::ResourceInUseException`.
    pub fn is_resource_in_use_exception(&self) -> bool {
        matches!(self, Self::ResourceInUseException(_))
    }
    /// Returns `true` if the error kind is `CreateFlywheelError::ResourceLimitExceededException`.
    pub fn is_resource_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::ResourceLimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateFlywheelError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateFlywheelError::ResourceUnavailableException`.
    pub fn is_resource_unavailable_exception(&self) -> bool {
        matches!(self, Self::ResourceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `CreateFlywheelError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `CreateFlywheelError::TooManyTagsException`.
    pub fn is_too_many_tags_exception(&self) -> bool {
        matches!(self, Self::TooManyTagsException(_))
    }
    /// Returns `true` if the error kind is `CreateFlywheelError::UnsupportedLanguageException`.
    pub fn is_unsupported_language_exception(&self) -> bool {
        matches!(self, Self::UnsupportedLanguageException(_))
    }
}
impl ::std::error::Error for CreateFlywheelError {
