...
impl StartEntitiesDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`StartEntitiesDetectionJob`](crate::operation::start_entities_detection_job::StartEntitiesDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_entities_detection_job::StartEntitiesDetectionJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_entities_detection_job::StartEntitiesDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_entities_detection_job::StartEntitiesDetectionJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartEntitiesDetectionJob", "comprehend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartEntitiesDetectionJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartEntitiesDetectionJob {
                type Output = ::std::result::Result<crate::operation::start_entities_detection_job::StartEntitiesDetectionJobOutput, crate::operation::start_entities_detection_job::StartEntitiesDetectionJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_entities_detection_job::de_start_entities_detection_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_entities_detection_job::de_start_entities_detection_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_entities_detection_job::StartEntitiesDetectionJobError {
...
impl StartEntitiesDetectionJobError {
    ...
    /// Returns `true` if the error kind is `StartEntitiesDetectionJobError::ResourceInUseException`.
...
mod _start_entities_detection_job_output;
