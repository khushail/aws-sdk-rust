...
impl StartDominantLanguageDetectionJobInput {
    /// Consumes the builder and constructs an Operation<[`StartDominantLanguageDetectionJob`](crate::operation::start_dominant_language_detection_job::StartDominantLanguageDetectionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_dominant_language_detection_job::StartDominantLanguageDetectionJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_dominant_language_detection_job::StartDominantLanguageDetectionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_dominant_language_detection_job::StartDominantLanguageDetectionJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDominantLanguageDetectionJob {
                type Output = ::std::result::Result<crate::operation::start_dominant_language_detection_job::StartDominantLanguageDetectionJobOutput, crate::operation::start_dominant_language_detection_job::StartDominantLanguageDetectionJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_dominant_language_detection_job::de_start_dominant_language_detection_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_dominant_language_detection_job::de_start_dominant_language_detection_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_dominant_language_detection_job::StartDominantLanguageDetectionJobError {
...
impl StartDominantLanguageDetectionJobError {
    ...
    /// Returns `true` if the error kind is `StartDominantLanguageDetectionJobError::ResourceInUseException`.
...
mod _start_dominant_language_detection_job_output;
