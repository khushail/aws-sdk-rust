...
impl DetectSentimentInput {
    /// Consumes the builder and constructs an Operation<[`DetectSentiment`](crate::operation::detect_sentiment::DetectSentiment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::detect_sentiment::DetectSentiment, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detect_sentiment::DetectSentimentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detect_sentiment::DetectSentiment::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetectSentiment", "comprehend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DetectSentiment`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectSentiment {
                type Output = ::std::result::Result<crate::operation::detect_sentiment::DetectSentimentOutput, crate::operation::detect_sentiment::DetectSentimentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_detect_sentiment::de_detect_sentiment_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_detect_sentiment::de_detect_sentiment_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::detect_sentiment::DetectSentimentError {
