...
impl super::Client  {
    ...
    ///   - [`text(impl ::std::convert::Into<String>)`](crate::operation::detect_key_phrases::builders::DetectKeyPhrasesFluentBuilder::text) / [`set_text(Option<String>)`](crate::operation::detect_key_phrases::builders::DetectKeyPhrasesFluentBuilder::set_text): <p>A UTF-8 text string. The string must contain less than 100 KB of UTF-8 encoded characters.</p>
