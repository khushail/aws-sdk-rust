...
impl super::Client  {
    ...
    ///   - [`space_name(impl ::std::convert::Into<String>)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::set_space_name): <p>The name of the space.</p>
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::set_project_name): <p>The name of the project in the space.</p>
    ///   - [`source_repository_name(impl ::std::convert::Into<String>)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::source_repository_name) / [`set_source_repository_name(Option<String>)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::set_source_repository_name): <p>The name of the source repository.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::set_next_token): <p>A token returned from a call to this API to indicate the next batch of results to return, if any.</p>
    ///   - [`max_results(i32)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_source_repository_branches::builders::ListSourceRepositoryBranchesFluentBuilder::set_max_results): <p>The maximum number of results to show in a single call to this API. If the number of results is larger than the number you specified, the response will include a <code>NextToken</code> element, which you can use to obtain additional results.</p>
