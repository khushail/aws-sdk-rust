...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_access_tokens::builders::ListAccessTokensFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_access_tokens::builders::ListAccessTokensFluentBuilder::set_next_token): <p>A token returned from a call to this API to indicate the next batch of results to return, if any.</p>
