...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::list_dev_environment_sessions::ListDevEnvironmentSessionsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
