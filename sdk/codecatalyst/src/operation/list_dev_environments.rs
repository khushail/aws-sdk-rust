...
impl ListDevEnvironmentsInput {
    /// Consumes the builder and constructs an Operation<[`ListDevEnvironments`](crate::operation::list_dev_environments::ListDevEnvironments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_dev_environments::ListDevEnvironments, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_dev_environments::ListDevEnvironmentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_dev_environments::ser_list_dev_environments_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_dev_environments::ListDevEnvironments::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDevEnvironments {
                type Output = ::std::result::Result<crate::operation::list_dev_environments::ListDevEnvironmentsOutput, crate::operation::list_dev_environments::ListDevEnvironmentsError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_dev_environments::ListDevEnvironmentsError {
