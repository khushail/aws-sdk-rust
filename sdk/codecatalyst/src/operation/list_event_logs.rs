...
impl ListEventLogsInput {
    /// Consumes the builder and constructs an Operation<[`ListEventLogs`](crate::operation::list_event_logs::ListEventLogs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_event_logs::ListEventLogs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_event_logs::ListEventLogsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_event_logs::ser_list_event_logs_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_event_logs::ListEventLogs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEventLogs {
                type Output = ::std::result::Result<crate::operation::list_event_logs::ListEventLogsOutput, crate::operation::list_event_logs::ListEventLogsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_event_logs::de_list_event_logs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_event_logs::ListEventLogsError {
...
pub use crate::operation::list_event_logs::_list_event_logs_output::ListEventLogsOutput;

pub use crate::operation::list_event_logs::_list_event_logs_input::ListEventLogsInput;

mod _list_event_logs_input;

mod _list_event_logs_output;
