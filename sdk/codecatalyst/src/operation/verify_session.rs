...
impl VerifySessionInput {
    /// Consumes the builder and constructs an Operation<[`VerifySession`](crate::operation::verify_session::VerifySession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::verify_session::VerifySession, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::verify_session::VerifySessionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::verify_session::VerifySession::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for VerifySession {
                type Output = ::std::result::Result<crate::operation::verify_session::VerifySessionOutput, crate::operation::verify_session::VerifySessionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_verify_session::de_verify_session_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::verify_session::VerifySessionError {
