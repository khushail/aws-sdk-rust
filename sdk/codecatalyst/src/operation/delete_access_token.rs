...
impl DeleteAccessTokenInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAccessToken`](crate::operation::delete_access_token::DeleteAccessToken)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_access_token::DeleteAccessToken, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_access_token::DeleteAccessTokenInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_access_token::DeleteAccessToken::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccessToken {
                type Output = ::std::result::Result<crate::operation::delete_access_token::DeleteAccessTokenOutput, crate::operation::delete_access_token::DeleteAccessTokenError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_access_token::de_delete_access_token_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_access_token::DeleteAccessTokenError {
