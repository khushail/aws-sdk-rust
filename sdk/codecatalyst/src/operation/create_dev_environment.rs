...
impl CreateDevEnvironmentInput {
    /// Consumes the builder and constructs an Operation<[`CreateDevEnvironment`](crate::operation::create_dev_environment::CreateDevEnvironment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_dev_environment::CreateDevEnvironment, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_dev_environment::CreateDevEnvironmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/spaces/{spaceName}/projects/{projectName}/devEnvironments", spaceName = space_name, projectName = project_name).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_dev_environment::ser_create_dev_environment_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_dev_environment::CreateDevEnvironment::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDevEnvironment {
                type Output = ::std::result::Result<crate::operation::create_dev_environment::CreateDevEnvironmentOutput, crate::operation::create_dev_environment::CreateDevEnvironmentError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_dev_environment::CreateDevEnvironmentError {
