...
impl ListSourceRepositoriesInput {
    /// Consumes the builder and constructs an Operation<[`ListSourceRepositories`](crate::operation::list_source_repositories::ListSourceRepositories)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_source_repositories::ListSourceRepositories, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_source_repositories::ListSourceRepositoriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/spaces/{spaceName}/projects/{projectName}/sourceRepositories", spaceName = space_name, projectName = project_name).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_source_repositories::ser_list_source_repositories_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_source_repositories::ListSourceRepositories::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSourceRepositories {
                type Output = ::std::result::Result<crate::operation::list_source_repositories::ListSourceRepositoriesOutput, crate::operation::list_source_repositories::ListSourceRepositoriesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_source_repositories::de_list_source_repositories_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_source_repositories::ListSourceRepositoriesError {
...
mod _list_source_repositories_output;
