...
impl StopDevEnvironmentSessionInput {
    /// Consumes the builder and constructs an Operation<[`StopDevEnvironmentSession`](crate::operation::stop_dev_environment_session::StopDevEnvironmentSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_dev_environment_session::StopDevEnvironmentSession, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_dev_environment_session::StopDevEnvironmentSessionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if space_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("space_name", "cannot be empty or unset"))
                            }
                ...
                if project_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("project_name", "cannot be empty or unset"))
                            }
                ...
                if session_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("session_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/v1/spaces/{spaceName}/projects/{projectName}/devEnvironments/{id}/session/{sessionId}", spaceName = space_name, projectName = project_name, id = id, sessionId = session_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_dev_environment_session::StopDevEnvironmentSession::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopDevEnvironmentSession", "codecatalyst"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDevEnvironmentSession {
                type Output = ::std::result::Result<crate::operation::stop_dev_environment_session::StopDevEnvironmentSessionOutput, crate::operation::stop_dev_environment_session::StopDevEnvironmentSessionError>;
...
/// Do not use this.
            ...
            pub type StopDevEnvironmentSessionErrorKind = StopDevEnvironmentSessionError;
/// Error type for the `StopDevEnvironmentSessionError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum StopDevEnvironmentSessionError {
...
impl ::aws_smithy_http::result::CreateUnhandledError for StopDevEnvironmentSessionError {
...
impl ::std::fmt::Display for StopDevEnvironmentSessionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopDevEnvironmentSessionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_dev_environment_session::StopDevEnvironmentSessionError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for StopDevEnvironmentSessionError {
...
impl StopDevEnvironmentSessionError {
    /// Creates the `StopDevEnvironmentSessionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopDevEnvironmentSessionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `StopDevEnvironmentSessionError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `StopDevEnvironmentSessionError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `StopDevEnvironmentSessionError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StopDevEnvironmentSessionError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `StopDevEnvironmentSessionError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `StopDevEnvironmentSessionError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for StopDevEnvironmentSessionError {
