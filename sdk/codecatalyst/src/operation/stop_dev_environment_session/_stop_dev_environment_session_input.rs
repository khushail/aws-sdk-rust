...
impl StopDevEnvironmentSessionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_dev_environment_session::StopDevEnvironmentSessionInput, ::aws_smithy_http::operation::error::BuildError> {
