...
impl DescribeIdentityPoolUsageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_identity_pool_usage::DescribeIdentityPoolUsageInput, ::aws_smithy_http::operation::error::BuildError> {
