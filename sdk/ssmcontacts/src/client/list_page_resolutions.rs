...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_page_resolutions::builders::ListPageResolutionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_page_resolutions::builders::ListPageResolutionsFluentBuilder::set_next_token): <p>A token to start the list. Use this token to get the next set of results.</p>
    ///   - [`page_id(impl ::std::convert::Into<String>)`](crate::operation::list_page_resolutions::builders::ListPageResolutionsFluentBuilder::page_id) / [`set_page_id(Option<String>)`](crate::operation::list_page_resolutions::builders::ListPageResolutionsFluentBuilder::set_page_id): <p>The Amazon Resource Name (ARN) of the contact engaged for the incident.</p>
