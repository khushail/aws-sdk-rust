...
impl super::Client  {
    ...
    ///   - [`rotation_id(impl ::std::convert::Into<String>)`](crate::operation::list_rotation_shifts::builders::ListRotationShiftsFluentBuilder::rotation_id) / [`set_rotation_id(Option<String>)`](crate::operation::list_rotation_shifts::builders::ListRotationShiftsFluentBuilder::set_rotation_id): <p>The Amazon Resource Name (ARN) of the rotation to retrieve shift information about. </p>
    ///   - [`start_time(DateTime)`](crate::operation::list_rotation_shifts::builders::ListRotationShiftsFluentBuilder::start_time) / [`set_start_time(Option<DateTime>)`](crate::operation::list_rotation_shifts::builders::ListRotationShiftsFluentBuilder::set_start_time): <p>The date and time for the beginning of the time range to list shifts for.</p>
    ///   - [`end_time(DateTime)`](crate::operation::list_rotation_shifts::builders::ListRotationShiftsFluentBuilder::end_time) / [`set_end_time(Option<DateTime>)`](crate::operation::list_rotation_shifts::builders::ListRotationShiftsFluentBuilder::set_end_time): <p>The date and time for the end of the time range to list shifts for.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_rotation_shifts::builders::ListRotationShiftsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_rotation_shifts::builders::ListRotationShiftsFluentBuilder::set_next_token): <p>A token to start the list. Use this token to get the next set of results.</p>
