...
pub fn ser_recurrence_settings(
    ...
    if let Some(var_13) = &input.number_of_on_calls {
        object.key("NumberOfOnCalls").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
    ...
    if let Some(var_21) = &input.recurrence_multiplier {
        object.key("RecurrenceMultiplier").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_21).into()));
    }
    Ok(())
}

pub(crate) fn de_recurrence_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RecurrenceSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "DailySettings" => {
                                builder = builder.set_daily_settings(
                                    crate::protocol_serde::shape_daily_settings::de_daily_settings(tokens)?
                                );
                            }
                            "NumberOfOnCalls" => {
