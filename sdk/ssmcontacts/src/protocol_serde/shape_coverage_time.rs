...
pub(crate) fn de_coverage_time<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CoverageTime>, ::aws_smithy_json::deserialize::error::DeserializeError>
