...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_intent_versions::builders::GetIntentVersionsFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_intent_versions::builders::GetIntentVersionsFluentBuilder::set_name): <p>The name of the intent for which versions should be returned.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_intent_versions::builders::GetIntentVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_intent_versions::builders::GetIntentVersionsFluentBuilder::set_next_token): <p>A pagination token for fetching the next page of intent versions. If the response to this call is truncated, Amazon Lex returns a pagination token in the response. To fetch the next page of versions, specify the pagination token in the next request. </p>
