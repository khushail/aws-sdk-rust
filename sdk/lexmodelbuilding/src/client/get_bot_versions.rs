...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_bot_versions::builders::GetBotVersionsFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_bot_versions::builders::GetBotVersionsFluentBuilder::set_name): <p>The name of the bot for which versions should be returned.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_bot_versions::builders::GetBotVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_bot_versions::builders::GetBotVersionsFluentBuilder::set_next_token): <p>A pagination token for fetching the next page of bot versions. If the response to this call is truncated, Amazon Lex returns a pagination token in the response. To fetch the next page of versions, specify the pagination token in the next request. </p>
