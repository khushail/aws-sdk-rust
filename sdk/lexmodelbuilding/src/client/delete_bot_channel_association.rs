...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_channel_association::builders::DeleteBotChannelAssociationFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_bot_channel_association::builders::DeleteBotChannelAssociationFluentBuilder::set_name): <p>The name of the association. The name is case sensitive. </p>
    ///   - [`bot_name(impl ::std::convert::Into<String>)`](crate::operation::delete_bot_channel_association::builders::DeleteBotChannelAssociationFluentBuilder::bot_name) / [`set_bot_name(Option<String>)`](crate::operation::delete_bot_channel_association::builders::DeleteBotChannelAssociationFluentBuilder::set_bot_name): <p>The name of the Amazon Lex bot.</p>
