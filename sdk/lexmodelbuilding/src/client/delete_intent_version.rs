...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_intent_version::builders::DeleteIntentVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_intent_version::builders::DeleteIntentVersionFluentBuilder::set_name): <p>The name of the intent.</p>
