...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_intent::builders::GetIntentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_intent::builders::GetIntentFluentBuilder::set_name): <p>The name of the intent. The name is case sensitive. </p>
    ///   - [`version(impl ::std::convert::Into<String>)`](crate::operation::get_intent::builders::GetIntentFluentBuilder::version) / [`set_version(Option<String>)`](crate::operation::get_intent::builders::GetIntentFluentBuilder::set_version): <p>The version of the intent.</p>
