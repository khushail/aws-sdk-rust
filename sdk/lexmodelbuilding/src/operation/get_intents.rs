...
impl GetIntentsInput {
    /// Consumes the builder and constructs an Operation<[`GetIntents`](crate::operation::get_intents::GetIntents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_intents::GetIntents, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_intents::GetIntentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/intents").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_intents::GetIntentsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_intents::GetIntentsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_intents::GetIntents::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetIntents", "lexmodelbuildingservice"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetIntents`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIntents {
                type Output = ::std::result::Result<crate::operation::get_intents::GetIntentsOutput, crate::operation::get_intents::GetIntentsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_intents::de_get_intents_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_intents::de_get_intents_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_intents::GetIntentsError {
...
pub use crate::operation::get_intents::_get_intents_output::GetIntentsOutput;

pub use crate::operation::get_intents::_get_intents_input::GetIntentsInput;

mod _get_intents_input;

mod _get_intents_output;
