...
impl GetMigrationsFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_migrations::GetMigrationsOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_migrations::GetMigrationsError>>
                         {
    ...
    pub fn get_v1_bot_name_contains(&self) -> &::std::option::Option<::std::string::String> {
        self.inner.get_v1_bot_name_contains()
    }
