...
impl GetSlotTypeVersionsInput {
    /// Consumes the builder and constructs an Operation<[`GetSlotTypeVersions`](crate::operation::get_slot_type_versions::GetSlotTypeVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_slot_type_versions::GetSlotTypeVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_slot_type_versions::GetSlotTypeVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_slot_type_versions::GetSlotTypeVersionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_slot_type_versions::GetSlotTypeVersionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_slot_type_versions::GetSlotTypeVersions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSlotTypeVersions", "lexmodelbuildingservice"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSlotTypeVersions {
                type Output = ::std::result::Result<crate::operation::get_slot_type_versions::GetSlotTypeVersionsOutput, crate::operation::get_slot_type_versions::GetSlotTypeVersionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_slot_type_versions::de_get_slot_type_versions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_slot_type_versions::de_get_slot_type_versions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_slot_type_versions::GetSlotTypeVersionsError {
...
mod _get_slot_type_versions_output;
