...
impl GetMigrationsInput {
    /// Consumes the builder and constructs an Operation<[`GetMigrations`](crate::operation::get_migrations::GetMigrations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_migrations::GetMigrations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_migrations::GetMigrationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/migrations").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_migrations::GetMigrationsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_migrations::GetMigrationsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_migrations::GetMigrations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetMigrations", "lexmodelbuildingservice"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetMigrations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMigrations {
                type Output = ::std::result::Result<crate::operation::get_migrations::GetMigrationsOutput, crate::operation::get_migrations::GetMigrationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_migrations::de_get_migrations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_migrations::de_get_migrations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_migrations::GetMigrationsError {
