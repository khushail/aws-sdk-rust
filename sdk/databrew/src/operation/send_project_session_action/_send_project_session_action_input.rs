...
impl SendProjectSessionActionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::send_project_session_action::SendProjectSessionActionInput, ::aws_smithy_http::operation::error::BuildError> {
