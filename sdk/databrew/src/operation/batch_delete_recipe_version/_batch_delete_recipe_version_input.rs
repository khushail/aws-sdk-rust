...
impl BatchDeleteRecipeVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_delete_recipe_version::BatchDeleteRecipeVersionInput, ::aws_smithy_http::operation::error::BuildError> {
