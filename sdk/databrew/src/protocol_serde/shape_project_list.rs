...
pub(crate) fn de_project_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::Project>>, ::aws_smithy_json::deserialize::error::DeserializeError>
