...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_recipe_version::builders::DeleteRecipeVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_recipe_version::builders::DeleteRecipeVersionFluentBuilder::set_name): <p>The name of the recipe.</p>
    ///   - [`recipe_version(impl ::std::convert::Into<String>)`](crate::operation::delete_recipe_version::builders::DeleteRecipeVersionFluentBuilder::recipe_version) / [`set_recipe_version(Option<String>)`](crate::operation::delete_recipe_version::builders::DeleteRecipeVersionFluentBuilder::set_recipe_version): <p>The version of the recipe to be deleted. You can specify a numeric versions (<code>X.Y</code>) or <code>LATEST_WORKING</code>. <code>LATEST_PUBLISHED</code> is not supported.</p>
