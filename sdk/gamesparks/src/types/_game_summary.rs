...
impl GameSummary {
    /// Creates a new builder-style object to manufacture [`GameSummary`](crate::types::GameSummary).
    pub fn builder() -> crate::types::builders::GameSummaryBuilder {
        crate::types::builders::GameSummaryBuilder::default()
    }
}

/// A builder for [`GameSummary`](crate::types::GameSummary).
#[non_exhaustive]
