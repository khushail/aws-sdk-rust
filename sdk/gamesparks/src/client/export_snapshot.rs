...
impl super::Client  {
    ...
    ///   - [`game_name(impl ::std::convert::Into<String>)`](crate::operation::export_snapshot::builders::ExportSnapshotFluentBuilder::game_name) / [`set_game_name(Option<String>)`](crate::operation::export_snapshot::builders::ExportSnapshotFluentBuilder::set_game_name): <p>The name of the game.</p>
    ///   - [`snapshot_id(impl ::std::convert::Into<String>)`](crate::operation::export_snapshot::builders::ExportSnapshotFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::export_snapshot::builders::ExportSnapshotFluentBuilder::set_snapshot_id): <p>The identifier of the snapshot to export.</p>
