...
impl super::Client  {
    ...
    ///   - [`namespace(impl ::std::convert::Into<String>)`](crate::operation::get_extension_version::builders::GetExtensionVersionFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::get_extension_version::builders::GetExtensionVersionFluentBuilder::set_namespace): <p>The namespace (qualifier) of the extension.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_extension_version::builders::GetExtensionVersionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_extension_version::builders::GetExtensionVersionFluentBuilder::set_name): <p>The name of the extension.</p>
    ///   - [`extension_version(impl ::std::convert::Into<String>)`](crate::operation::get_extension_version::builders::GetExtensionVersionFluentBuilder::extension_version) / [`set_extension_version(Option<String>)`](crate::operation::get_extension_version::builders::GetExtensionVersionFluentBuilder::set_extension_version): <p>The version of the extension.</p>
