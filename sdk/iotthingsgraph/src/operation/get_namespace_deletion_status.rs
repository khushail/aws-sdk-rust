...
impl GetNamespaceDeletionStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetNamespaceDeletionStatus`](crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatusInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_namespace_deletion_status::ser_get_namespace_deletion_status_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatus::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetNamespaceDeletionStatus", "iotthingsgraph"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetNamespaceDeletionStatus`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNamespaceDeletionStatus {
                type Output = ::std::result::Result<crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatusOutput, crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatusError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatusError {
...
mod _get_namespace_deletion_status_output;
