...
impl CreateSystemInstanceInput {
    /// Consumes the builder and constructs an Operation<[`CreateSystemInstance`](crate::operation::create_system_instance::CreateSystemInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_system_instance::CreateSystemInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_system_instance::CreateSystemInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_system_instance::ser_create_system_instance_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_system_instance::CreateSystemInstance::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateSystemInstance", "iotthingsgraph"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSystemInstance {
                type Output = ::std::result::Result<crate::operation::create_system_instance::CreateSystemInstanceOutput, crate::operation::create_system_instance::CreateSystemInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_system_instance::de_create_system_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_system_instance::de_create_system_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_system_instance::CreateSystemInstanceError {
...
mod _create_system_instance_output;
