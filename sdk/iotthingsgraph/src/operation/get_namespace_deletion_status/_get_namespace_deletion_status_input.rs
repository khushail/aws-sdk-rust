...
impl GetNamespaceDeletionStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_namespace_deletion_status::GetNamespaceDeletionStatusInput, ::aws_smithy_http::operation::error::BuildError> {
