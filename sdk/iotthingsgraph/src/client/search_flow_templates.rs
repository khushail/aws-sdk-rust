...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_flow_templates::builders::SearchFlowTemplatesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_flow_templates::builders::SearchFlowTemplatesFluentBuilder::set_next_token): <p>The string that specifies the next page of results. Use this when you're paginating results.</p>
