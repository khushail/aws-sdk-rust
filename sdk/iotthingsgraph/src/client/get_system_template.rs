...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_system_template::builders::GetSystemTemplateFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_system_template::builders::GetSystemTemplateFluentBuilder::set_id): <p>The ID of the system to get. This ID must be in the user's namespace.</p>  <p>The ID should be in the following format.</p>  <p> <code>urn:tdm:REGION/ACCOUNT ID/default:system:SYSTEMNAME</code> </p>
