...
impl super::Client  {
    ...
    ///   - [`thing_name(impl ::std::convert::Into<String>)`](crate::operation::dissociate_entity_from_thing::builders::DissociateEntityFromThingFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::dissociate_entity_from_thing::builders::DissociateEntityFromThingFluentBuilder::set_thing_name): <p>The name of the thing to disassociate.</p>
