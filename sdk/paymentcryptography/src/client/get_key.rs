...
impl super::Client  {
    ...
    ///   - [`key_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_key::builders::GetKeyFluentBuilder::key_identifier) / [`set_key_identifier(Option<String>)`](crate::operation::get_key::builders::GetKeyFluentBuilder::set_key_identifier): <p>The <code>KeyARN</code> of the Amazon Web Services Payment Cryptography key.</p>
