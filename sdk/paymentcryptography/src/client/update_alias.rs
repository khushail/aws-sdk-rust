...
impl super::Client  {
    ...
    ///   - [`alias_name(impl ::std::convert::Into<String>)`](crate::operation::update_alias::builders::UpdateAliasFluentBuilder::alias_name) / [`set_alias_name(Option<String>)`](crate::operation::update_alias::builders::UpdateAliasFluentBuilder::set_alias_name): <p>The alias whose associated key is changing.</p>
    ///   - [`key_arn(impl ::std::convert::Into<String>)`](crate::operation::update_alias::builders::UpdateAliasFluentBuilder::key_arn) / [`set_key_arn(Option<String>)`](crate::operation::update_alias::builders::UpdateAliasFluentBuilder::set_key_arn): <p>The <code>KeyARN</code> for the key that you are updating or removing from the alias.</p>
