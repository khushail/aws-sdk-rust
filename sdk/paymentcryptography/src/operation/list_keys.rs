...
impl ListKeysInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_keys::ListKeys, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_keys::ListKeysInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_keys::ListKeys::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListKeys", "paymentcryptography"));
...
impl ListKeysError {
    ...
    /// Returns `true` if the error kind is `ListKeysError::ServiceUnavailableException`.
