...
impl UpdateAliasInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_alias::UpdateAlias, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_alias::UpdateAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            builder = ::aws_smithy_http::header::set_request_header_if_absent(
                                ...
                                "PaymentCryptographyControlPlane.UpdateAlias"
                            );
            builder
        };
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_alias::UpdateAlias::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateAlias", "paymentcryptography"));
...
impl UpdateAliasError {
    ...
    /// Returns `true` if the error kind is `UpdateAliasError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `UpdateAliasError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `UpdateAliasError::InternalServerException`.
    ...
    /// Returns `true` if the error kind is `UpdateAliasError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `UpdateAliasError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `UpdateAliasError::ValidationException`.
