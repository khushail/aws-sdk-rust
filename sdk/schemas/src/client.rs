...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_schemas::Error> {
/// # let client: aws_sdk_schemas::Client = unimplemented!();
...
mod delete_schema_version;

mod describe_code_binding;

mod describe_discoverer;
...
mod get_code_binding_source;

mod get_discovered_schema;

mod get_resource_policy;

mod list_discoverers;
...
mod put_code_binding;

mod put_resource_policy;

mod search_schemas;

mod start_discoverer;
