...
impl super::Client  {
    ...
    ///   - [`registry_name(impl ::std::convert::Into<String>)`](crate::operation::delete_schema_version::builders::DeleteSchemaVersionFluentBuilder::registry_name) / [`set_registry_name(Option<String>)`](crate::operation::delete_schema_version::builders::DeleteSchemaVersionFluentBuilder::set_registry_name): <p>The name of the registry.</p>
    ///   - [`schema_name(impl ::std::convert::Into<String>)`](crate::operation::delete_schema_version::builders::DeleteSchemaVersionFluentBuilder::schema_name) / [`set_schema_name(Option<String>)`](crate::operation::delete_schema_version::builders::DeleteSchemaVersionFluentBuilder::set_schema_name): <p>The name of the schema.</p>
