...
impl super::Client  {
    ...
    ///   - [`discoverer_id(impl ::std::convert::Into<String>)`](crate::operation::start_discoverer::builders::StartDiscovererFluentBuilder::discoverer_id) / [`set_discoverer_id(Option<String>)`](crate::operation::start_discoverer::builders::StartDiscovererFluentBuilder::set_discoverer_id): <p>The ID of the discoverer.</p>
