...
impl GetDiscoveredSchemaInput {
    /// Consumes the builder and constructs an Operation<[`GetDiscoveredSchema`](crate::operation::get_discovered_schema::GetDiscoveredSchema)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_discovered_schema::GetDiscoveredSchema, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_discovered_schema::GetDiscoveredSchemaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/discover").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_discovered_schema::ser_get_discovered_schema_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_discovered_schema::GetDiscoveredSchema::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDiscoveredSchema", "schemas"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDiscoveredSchema {
                type Output = ::std::result::Result<crate::operation::get_discovered_schema::GetDiscoveredSchemaOutput, crate::operation::get_discovered_schema::GetDiscoveredSchemaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_discovered_schema::de_get_discovered_schema_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_discovered_schema::de_get_discovered_schema_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_discovered_schema::GetDiscoveredSchemaError {
...
mod _get_discovered_schema_output;
