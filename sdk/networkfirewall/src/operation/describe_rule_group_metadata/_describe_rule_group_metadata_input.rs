...
impl DescribeRuleGroupMetadataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_rule_group_metadata::DescribeRuleGroupMetadataInput, ::aws_smithy_http::operation::error::BuildError> {
