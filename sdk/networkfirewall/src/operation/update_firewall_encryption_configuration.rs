...
impl UpdateFirewallEncryptionConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFirewallEncryptionConfiguration`](crate::operation::update_firewall_encryption_configuration::UpdateFirewallEncryptionConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_firewall_encryption_configuration::UpdateFirewallEncryptionConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_firewall_encryption_configuration::UpdateFirewallEncryptionConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_firewall_encryption_configuration::UpdateFirewallEncryptionConfigurationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_firewall_encryption_configuration::UpdateFirewallEncryptionConfiguration::new())
...
/// Orchestration and serialization glue logic for `UpdateFirewallEncryptionConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFirewallEncryptionConfiguration {
                type Output = ::std::result::Result<crate::operation::update_firewall_encryption_configuration::UpdateFirewallEncryptionConfigurationOutput, crate::operation::update_firewall_encryption_configuration::UpdateFirewallEncryptionConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_firewall_encryption_configuration::de_update_firewall_encryption_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_firewall_encryption_configuration::de_update_firewall_encryption_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateFirewallEncryptionConfigurationErrorKind = UpdateFirewallEncryptionConfigurationError;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateFirewallEncryptionConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_firewall_encryption_configuration::UpdateFirewallEncryptionConfigurationError {
...
mod _update_firewall_encryption_configuration_output;
