...
impl ListFirewallsInput {
    /// Consumes the builder and constructs an Operation<[`ListFirewalls`](crate::operation::list_firewalls::ListFirewalls)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_firewalls::ListFirewalls, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_firewalls::ListFirewallsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_firewalls::ListFirewalls::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListFirewalls", "networkfirewall"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListFirewalls`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFirewalls {
                type Output = ::std::result::Result<crate::operation::list_firewalls::ListFirewallsOutput, crate::operation::list_firewalls::ListFirewallsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_firewalls::de_list_firewalls_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_firewalls::de_list_firewalls_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_firewalls::ListFirewallsError {
...
pub use crate::operation::list_firewalls::_list_firewalls_output::ListFirewallsOutput;

pub use crate::operation::list_firewalls::_list_firewalls_input::ListFirewallsInput;

mod _list_firewalls_input;

mod _list_firewalls_output;
