...
impl DisassociateSubnetsInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateSubnets`](crate::operation::disassociate_subnets::DisassociateSubnets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_subnets::DisassociateSubnets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_subnets::DisassociateSubnetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_subnets::ser_disassociate_subnets_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_subnets::DisassociateSubnets::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateSubnets", "networkfirewall"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisassociateSubnets`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateSubnets {
                type Output = ::std::result::Result<crate::operation::disassociate_subnets::DisassociateSubnetsOutput, crate::operation::disassociate_subnets::DisassociateSubnetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_subnets::de_disassociate_subnets_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_subnets::de_disassociate_subnets_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_subnets::DisassociateSubnetsError {
...
mod _disassociate_subnets_output;
