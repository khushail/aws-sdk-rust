...
impl DescribeLoggingConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_logging_configuration::DescribeLoggingConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
