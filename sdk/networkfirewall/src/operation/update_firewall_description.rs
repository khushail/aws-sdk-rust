...
impl UpdateFirewallDescriptionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFirewallDescription`](crate::operation::update_firewall_description::UpdateFirewallDescription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_firewall_description::UpdateFirewallDescription, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_firewall_description::UpdateFirewallDescriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_firewall_description::UpdateFirewallDescription::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateFirewallDescription", "networkfirewall"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateFirewallDescription`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFirewallDescription {
                type Output = ::std::result::Result<crate::operation::update_firewall_description::UpdateFirewallDescriptionOutput, crate::operation::update_firewall_description::UpdateFirewallDescriptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_firewall_description::de_update_firewall_description_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_firewall_description::de_update_firewall_description_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_firewall_description::UpdateFirewallDescriptionError {
...
mod _update_firewall_description_output;
