...
pub(crate) fn de_stateful_rule_group_reference<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::StatefulRuleGroupReference>, ::aws_smithy_json::deserialize::error::DeserializeError>
