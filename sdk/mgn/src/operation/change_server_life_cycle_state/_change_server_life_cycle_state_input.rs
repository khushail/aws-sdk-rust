...
impl ChangeServerLifeCycleStateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::change_server_life_cycle_state::ChangeServerLifeCycleStateInput, ::aws_smithy_http::operation::error::BuildError> {
