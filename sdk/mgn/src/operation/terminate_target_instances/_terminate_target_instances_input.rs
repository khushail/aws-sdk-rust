...
impl TerminateTargetInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::terminate_target_instances::TerminateTargetInstancesInput, ::aws_smithy_http::operation::error::BuildError> {
