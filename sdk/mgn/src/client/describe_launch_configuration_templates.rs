...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_launch_configuration_templates::builders::DescribeLaunchConfigurationTemplatesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_launch_configuration_templates::builders::DescribeLaunchConfigurationTemplatesFluentBuilder::set_next_token): <p>Next pagination token returned from DescribeLaunchConfigurationTemplates.</p>
