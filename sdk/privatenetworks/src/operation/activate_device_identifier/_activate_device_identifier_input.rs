...
impl ActivateDeviceIdentifierInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::activate_device_identifier::ActivateDeviceIdentifierInput, ::aws_smithy_http::operation::error::BuildError> {
