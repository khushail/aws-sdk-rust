...
#[allow(clippy::unnecessary_wraps)]
pub fn de_configure_access_point_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::configure_access_point::ConfigureAccessPointOutput, crate::operation::configure_access_point::ConfigureAccessPointError> {
    Ok({
        #[allow(unused_mut)]
