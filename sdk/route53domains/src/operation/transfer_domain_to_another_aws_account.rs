...
impl TransferDomainToAnotherAwsAccountInput {
    /// Consumes the builder and constructs an Operation<[`TransferDomainToAnotherAwsAccount`](crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccount)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccount::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for TransferDomainToAnotherAwsAccount {
                type Output = ::std::result::Result<crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountOutput, crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_transfer_domain_to_another_aws_account::de_transfer_domain_to_another_aws_account_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_transfer_domain_to_another_aws_account::de_transfer_domain_to_another_aws_account_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::transfer_domain_to_another_aws_account::TransferDomainToAnotherAwsAccountError {
...
mod _transfer_domain_to_another_aws_account_output;
