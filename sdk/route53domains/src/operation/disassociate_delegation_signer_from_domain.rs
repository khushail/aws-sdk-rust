...
impl DisassociateDelegationSignerFromDomainInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateDelegationSignerFromDomain`](crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateDelegationSignerFromDomain", "route53domains"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateDelegationSignerFromDomain {
                type Output = ::std::result::Result<crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainOutput, crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_delegation_signer_from_domain::de_disassociate_delegation_signer_from_domain_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_delegation_signer_from_domain::de_disassociate_delegation_signer_from_domain_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_delegation_signer_from_domain::DisassociateDelegationSignerFromDomainError {
...
mod _disassociate_delegation_signer_from_domain_output;
