...
impl ListPricesInput {
    /// Consumes the builder and constructs an Operation<[`ListPrices`](crate::operation::list_prices::ListPrices)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_prices::ListPrices, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_prices::ListPricesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_prices::ListPrices::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPrices {
                type Output = ::std::result::Result<crate::operation::list_prices::ListPricesOutput, crate::operation::list_prices::ListPricesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_prices::de_list_prices_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_prices::de_list_prices_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_prices::ListPricesError {
...
pub use crate::operation::list_prices::_list_prices_output::ListPricesOutput;

pub use crate::operation::list_prices::_list_prices_input::ListPricesInput;

mod _list_prices_input;

mod _list_prices_output;
