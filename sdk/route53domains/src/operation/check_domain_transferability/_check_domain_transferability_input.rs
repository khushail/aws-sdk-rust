...
impl CheckDomainTransferabilityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::check_domain_transferability::CheckDomainTransferabilityInput, ::aws_smithy_http::operation::error::BuildError> {
