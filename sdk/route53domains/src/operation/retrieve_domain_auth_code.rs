...
impl RetrieveDomainAuthCodeInput {
    /// Consumes the builder and constructs an Operation<[`RetrieveDomainAuthCode`](crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCode, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCode::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RetrieveDomainAuthCode", "route53domains"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RetrieveDomainAuthCode`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RetrieveDomainAuthCode {
                type Output = ::std::result::Result<crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeOutput, crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_retrieve_domain_auth_code::de_retrieve_domain_auth_code_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_retrieve_domain_auth_code::de_retrieve_domain_auth_code_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::retrieve_domain_auth_code::RetrieveDomainAuthCodeError {
...
mod _retrieve_domain_auth_code_output;
