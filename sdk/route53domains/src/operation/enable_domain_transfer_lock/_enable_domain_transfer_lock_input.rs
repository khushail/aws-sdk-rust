...
impl EnableDomainTransferLockInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_domain_transfer_lock::EnableDomainTransferLockInput, ::aws_smithy_http::operation::error::BuildError> {
