...
impl DisableDomainAutoRenewInput {
    /// Consumes the builder and constructs an Operation<[`DisableDomainAutoRenew`](crate::operation::disable_domain_auto_renew::DisableDomainAutoRenew)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenew, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_domain_auto_renew::DisableDomainAutoRenew::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisableDomainAutoRenew", "route53domains"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisableDomainAutoRenew`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableDomainAutoRenew {
                type Output = ::std::result::Result<crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewOutput, crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disable_domain_auto_renew::de_disable_domain_auto_renew_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disable_domain_auto_renew::de_disable_domain_auto_renew_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_domain_auto_renew::DisableDomainAutoRenewError {
...
mod _disable_domain_auto_renew_output;
