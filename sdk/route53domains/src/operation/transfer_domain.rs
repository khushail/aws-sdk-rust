...
impl TransferDomainInput {
    /// Consumes the builder and constructs an Operation<[`TransferDomain`](crate::operation::transfer_domain::TransferDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::transfer_domain::TransferDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::transfer_domain::TransferDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::transfer_domain::TransferDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("TransferDomain", "route53domains"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `TransferDomain`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for TransferDomain {
                type Output = ::std::result::Result<crate::operation::transfer_domain::TransferDomainOutput, crate::operation::transfer_domain::TransferDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_transfer_domain::de_transfer_domain_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_transfer_domain::de_transfer_domain_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::transfer_domain::TransferDomainError {
