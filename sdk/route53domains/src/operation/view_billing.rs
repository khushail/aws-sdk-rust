...
impl ViewBillingInput {
    /// Consumes the builder and constructs an Operation<[`ViewBilling`](crate::operation::view_billing::ViewBilling)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::view_billing::ViewBilling, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::view_billing::ViewBillingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::view_billing::ViewBilling::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ViewBilling {
                type Output = ::std::result::Result<crate::operation::view_billing::ViewBillingOutput, crate::operation::view_billing::ViewBillingError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_view_billing::de_view_billing_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_view_billing::de_view_billing_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::view_billing::ViewBillingError {
...
pub use crate::operation::view_billing::_view_billing_output::ViewBillingOutput;

pub use crate::operation::view_billing::_view_billing_input::ViewBillingInput;

mod _view_billing_input;

mod _view_billing_output;
