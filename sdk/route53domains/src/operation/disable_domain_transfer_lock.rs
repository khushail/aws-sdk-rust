...
impl DisableDomainTransferLockInput {
    /// Consumes the builder and constructs an Operation<[`DisableDomainTransferLock`](crate::operation::disable_domain_transfer_lock::DisableDomainTransferLock)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_domain_transfer_lock::DisableDomainTransferLock, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_domain_transfer_lock::DisableDomainTransferLockInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_domain_transfer_lock::DisableDomainTransferLock::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisableDomainTransferLock", "route53domains"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisableDomainTransferLock`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableDomainTransferLock {
                type Output = ::std::result::Result<crate::operation::disable_domain_transfer_lock::DisableDomainTransferLockOutput, crate::operation::disable_domain_transfer_lock::DisableDomainTransferLockError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disable_domain_transfer_lock::de_disable_domain_transfer_lock_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disable_domain_transfer_lock::de_disable_domain_transfer_lock_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_domain_transfer_lock::DisableDomainTransferLockError {
...
mod _disable_domain_transfer_lock_output;
