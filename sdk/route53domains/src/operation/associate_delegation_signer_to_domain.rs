...
impl AssociateDelegationSignerToDomainInput {
    /// Consumes the builder and constructs an Operation<[`AssociateDelegationSignerToDomain`](crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateDelegationSignerToDomain", "route53domains"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateDelegationSignerToDomain`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDelegationSignerToDomain {
                type Output = ::std::result::Result<crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomainOutput, crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_delegation_signer_to_domain::de_associate_delegation_signer_to_domain_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_delegation_signer_to_domain::de_associate_delegation_signer_to_domain_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_delegation_signer_to_domain::AssociateDelegationSignerToDomainError {
...
mod _associate_delegation_signer_to_domain_output;
