...
impl UpdateDomainContactPrivacyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDomainContactPrivacy`](crate::operation::update_domain_contact_privacy::UpdateDomainContactPrivacy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_domain_contact_privacy::UpdateDomainContactPrivacy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_domain_contact_privacy::UpdateDomainContactPrivacyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_domain_contact_privacy::UpdateDomainContactPrivacy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDomainContactPrivacy", "route53domains"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateDomainContactPrivacy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainContactPrivacy {
                type Output = ::std::result::Result<crate::operation::update_domain_contact_privacy::UpdateDomainContactPrivacyOutput, crate::operation::update_domain_contact_privacy::UpdateDomainContactPrivacyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_domain_contact_privacy::de_update_domain_contact_privacy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_domain_contact_privacy::de_update_domain_contact_privacy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_domain_contact_privacy::UpdateDomainContactPrivacyError {
...
mod _update_domain_contact_privacy_output;
