...
impl RenewDomainInput {
    /// Consumes the builder and constructs an Operation<[`RenewDomain`](crate::operation::renew_domain::RenewDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::renew_domain::RenewDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::renew_domain::RenewDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::renew_domain::RenewDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RenewDomain", "route53domains"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RenewDomain`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RenewDomain {
                type Output = ::std::result::Result<crate::operation::renew_domain::RenewDomainOutput, crate::operation::renew_domain::RenewDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_renew_domain::de_renew_domain_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_renew_domain::de_renew_domain_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::renew_domain::RenewDomainError {
