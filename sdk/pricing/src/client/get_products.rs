...
impl super::Client  {
    ...
    ///   - [`service_code(impl ::std::convert::Into<String>)`](crate::operation::get_products::builders::GetProductsFluentBuilder::service_code) / [`set_service_code(Option<String>)`](crate::operation::get_products::builders::GetProductsFluentBuilder::set_service_code): <p>The code for the service whose products you want to retrieve. </p>
