...
impl GetWirelessDeviceImportTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_wireless_device_import_task::GetWirelessDeviceImportTaskInput, ::aws_smithy_http::operation::error::BuildError> {
