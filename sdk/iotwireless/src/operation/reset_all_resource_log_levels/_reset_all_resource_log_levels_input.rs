...
impl ResetAllResourceLogLevelsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reset_all_resource_log_levels::ResetAllResourceLogLevelsInput, ::aws_smithy_http::operation::error::BuildError> {
