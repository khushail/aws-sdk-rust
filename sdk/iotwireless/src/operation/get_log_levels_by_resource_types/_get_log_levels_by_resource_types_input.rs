...
impl GetLogLevelsByResourceTypesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_log_levels_by_resource_types::GetLogLevelsByResourceTypesInput, ::aws_smithy_http::operation::error::BuildError> {
