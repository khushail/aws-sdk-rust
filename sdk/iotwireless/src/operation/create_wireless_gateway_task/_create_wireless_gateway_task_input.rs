...
impl CreateWirelessGatewayTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_wireless_gateway_task::CreateWirelessGatewayTaskInput, ::aws_smithy_http::operation::error::BuildError> {
