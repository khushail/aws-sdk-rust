...
pub use crate::operation::get_position_configuration::_get_position_configuration_output::GetPositionConfigurationOutputBuilder;

pub use crate::operation::get_position_configuration::_get_position_configuration_input::GetPositionConfigurationInputBuilder;
...
impl GetPositionConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.get_position_configuration();
...
impl GetPositionConfigurationFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::get_position_configuration::GetPositionConfiguration, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_position_configuration::GetPositionConfigurationOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_position_configuration::GetPositionConfigurationError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::get_position_configuration::GetPositionConfigurationOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_position_configuration::GetPositionConfigurationError>>
                             {
