...
impl GetNetworkAnalyzerConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_network_analyzer_configuration::GetNetworkAnalyzerConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
