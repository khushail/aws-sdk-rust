...
impl StartMulticastGroupSessionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_multicast_group_session::StartMulticastGroupSessionInput, ::aws_smithy_http::operation::error::BuildError> {
