...
impl DeregisterWirelessDeviceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_wireless_device::DeregisterWirelessDeviceInput, ::aws_smithy_http::operation::error::BuildError> {
