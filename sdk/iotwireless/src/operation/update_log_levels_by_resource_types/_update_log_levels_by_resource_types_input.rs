...
impl UpdateLogLevelsByResourceTypesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_log_levels_by_resource_types::UpdateLogLevelsByResourceTypesInput, ::aws_smithy_http::operation::error::BuildError> {
