...
impl DeleteWirelessGatewayTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_wireless_gateway_task::DeleteWirelessGatewayTaskInput, ::aws_smithy_http::operation::error::BuildError> {
