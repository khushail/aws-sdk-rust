...
impl SendDataToWirelessDeviceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::send_data_to_wireless_device::SendDataToWirelessDeviceInput, ::aws_smithy_http::operation::error::BuildError> {
