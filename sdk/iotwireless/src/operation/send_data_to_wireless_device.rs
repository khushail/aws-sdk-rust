...
impl SendDataToWirelessDeviceInput {
    /// Consumes the builder and constructs an Operation<[`SendDataToWirelessDevice`](crate::operation::send_data_to_wireless_device::SendDataToWirelessDevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::send_data_to_wireless_device::SendDataToWirelessDevice, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_data_to_wireless_device::SendDataToWirelessDeviceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::send_data_to_wireless_device::SendDataToWirelessDevice::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendDataToWirelessDevice {
                type Output = ::std::result::Result<crate::operation::send_data_to_wireless_device::SendDataToWirelessDeviceOutput, crate::operation::send_data_to_wireless_device::SendDataToWirelessDeviceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_send_data_to_wireless_device::de_send_data_to_wireless_device_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_send_data_to_wireless_device::de_send_data_to_wireless_device_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::send_data_to_wireless_device::SendDataToWirelessDeviceError {
...
mod _send_data_to_wireless_device_output;
