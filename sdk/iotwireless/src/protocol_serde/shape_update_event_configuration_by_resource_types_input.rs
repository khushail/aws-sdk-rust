...
pub fn ser_update_event_configuration_by_resource_types_input(
    ...
    if let Some(var_3) = &input.device_registration_state {
        ...
        crate::protocol_serde::shape_device_registration_state_resource_type_event_configuration::ser_device_registration_state_resource_type_event_configuration(&mut object_4, var_3)?;
        object_4.finish();
    }
    if let Some(var_5) = &input.join {
        #[allow(unused_mut)]
        let mut object_6 = object.key("Join").start_object();
        crate::protocol_serde::shape_join_resource_type_event_configuration::ser_join_resource_type_event_configuration(&mut object_6, var_5)?;
        object_6.finish();
    }
    if let Some(var_7) = &input.message_delivery_status {
        #[allow(unused_mut)]
        let mut object_8 = object.key("MessageDeliveryStatus").start_object();
        crate::protocol_serde::shape_message_delivery_status_resource_type_event_configuration::ser_message_delivery_status_resource_type_event_configuration(&mut object_8, var_7)?;
        object_8.finish();
    }
