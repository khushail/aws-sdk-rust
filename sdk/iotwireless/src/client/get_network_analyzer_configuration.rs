...
impl super::Client  {
    ...
    ///   - [`configuration_name(impl ::std::convert::Into<String>)`](crate::operation::get_network_analyzer_configuration::builders::GetNetworkAnalyzerConfigurationFluentBuilder::configuration_name) / [`set_configuration_name(Option<String>)`](crate::operation::get_network_analyzer_configuration::builders::GetNetworkAnalyzerConfigurationFluentBuilder::set_configuration_name): <p>Name of the network analyzer configuration.</p>
