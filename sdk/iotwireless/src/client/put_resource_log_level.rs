...
impl super::Client  {
    ...
    ///   - [`resource_identifier(impl ::std::convert::Into<String>)`](crate::operation::put_resource_log_level::builders::PutResourceLogLevelFluentBuilder::resource_identifier) / [`set_resource_identifier(Option<String>)`](crate::operation::put_resource_log_level::builders::PutResourceLogLevelFluentBuilder::set_resource_identifier): <p>The identifier of the resource. For a Wireless Device, it is the wireless device ID. For a wireless gateway, it is the wireless gateway ID.</p>
    ///   - [`resource_type(impl ::std::convert::Into<String>)`](crate::operation::put_resource_log_level::builders::PutResourceLogLevelFluentBuilder::resource_type) / [`set_resource_type(Option<String>)`](crate::operation::put_resource_log_level::builders::PutResourceLogLevelFluentBuilder::set_resource_type): <p>The type of the resource, which can be <code>WirelessDevice</code> or <code>WirelessGateway</code>.</p>
