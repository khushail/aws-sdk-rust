...
impl super::Client  {
    ...
    ///   - [`resource_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_resource_position::builders::GetResourcePositionFluentBuilder::resource_identifier) / [`set_resource_identifier(Option<String>)`](crate::operation::get_resource_position::builders::GetResourcePositionFluentBuilder::set_resource_identifier): <p>The identifier of the resource for which position information is retrieved. It can be the wireless device ID or the wireless gateway ID, depending on the resource type.</p>
