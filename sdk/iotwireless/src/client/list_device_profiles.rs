...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_device_profiles::builders::ListDeviceProfilesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_device_profiles::builders::ListDeviceProfilesFluentBuilder::set_next_token): <p>To retrieve the next set of results, the <code>nextToken</code> value from a previous response; otherwise <b>null</b> to receive the first set of results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_device_profiles::builders::ListDeviceProfilesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_device_profiles::builders::ListDeviceProfilesFluentBuilder::set_max_results): <p>The maximum number of results to return in this operation.</p>
    ///   - [`device_profile_type(DeviceProfileType)`](crate::operation::list_device_profiles::builders::ListDeviceProfilesFluentBuilder::device_profile_type) / [`set_device_profile_type(Option<DeviceProfileType>)`](crate::operation::list_device_profiles::builders::ListDeviceProfilesFluentBuilder::set_device_profile_type): <p>A filter to list only device profiles that use this type, which can be <code>LoRaWAN</code> or <code>Sidewalk</code>.</p>
