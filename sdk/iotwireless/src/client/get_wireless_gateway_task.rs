...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_wireless_gateway_task::builders::GetWirelessGatewayTaskFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_wireless_gateway_task::builders::GetWirelessGatewayTaskFluentBuilder::set_id): <p>The ID of the resource to get.</p>
