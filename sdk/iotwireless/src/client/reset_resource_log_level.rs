...
impl super::Client  {
    ...
    ///   - [`resource_identifier(impl ::std::convert::Into<String>)`](crate::operation::reset_resource_log_level::builders::ResetResourceLogLevelFluentBuilder::resource_identifier) / [`set_resource_identifier(Option<String>)`](crate::operation::reset_resource_log_level::builders::ResetResourceLogLevelFluentBuilder::set_resource_identifier): <p>The identifier of the resource. For a Wireless Device, it is the wireless device ID. For a wireless gateway, it is the wireless gateway ID.</p>
