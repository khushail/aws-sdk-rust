...
impl AddFlowOutputsInput {
    /// Consumes the builder and constructs an Operation<[`AddFlowOutputs`](crate::operation::add_flow_outputs::AddFlowOutputs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::add_flow_outputs::AddFlowOutputs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_flow_outputs::AddFlowOutputsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/flows/{FlowArn}/outputs", FlowArn = flow_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::add_flow_outputs::AddFlowOutputsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_flow_outputs::AddFlowOutputs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddFlowOutputs {
                type Output = ::std::result::Result<crate::operation::add_flow_outputs::AddFlowOutputsOutput, crate::operation::add_flow_outputs::AddFlowOutputsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_add_flow_outputs::de_add_flow_outputs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_add_flow_outputs::de_add_flow_outputs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::add_flow_outputs::AddFlowOutputsError {
