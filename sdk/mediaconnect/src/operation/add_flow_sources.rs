...
impl AddFlowSourcesInput {
    /// Consumes the builder and constructs an Operation<[`AddFlowSources`](crate::operation::add_flow_sources::AddFlowSources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::add_flow_sources::AddFlowSources, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_flow_sources::AddFlowSourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/flows/{FlowArn}/source", FlowArn = flow_arn).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_flow_sources::AddFlowSources::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AddFlowSources", "mediaconnect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AddFlowSources`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddFlowSources {
                type Output = ::std::result::Result<crate::operation::add_flow_sources::AddFlowSourcesOutput, crate::operation::add_flow_sources::AddFlowSourcesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_add_flow_sources::de_add_flow_sources_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_add_flow_sources::de_add_flow_sources_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::add_flow_sources::AddFlowSourcesError {
