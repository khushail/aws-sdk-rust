...
pub fn ser_update_flow_source_input(
    ...
    if let Some(var_7) = &input.ingest_port {
        object.key("ingestPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    ...
    if let Some(var_9) = &input.max_latency {
        object.key("maxLatency").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    if let Some(var_10) = &input.max_sync_buffer {
        object.key("maxSyncBuffer").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    ...
    if let Some(var_15) = &input.min_latency {
        object.key("minLatency").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_15).into()));
    }
    ...
    if let Some(var_20) = &input.source_listener_port {
        object.key("sourceListenerPort").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
