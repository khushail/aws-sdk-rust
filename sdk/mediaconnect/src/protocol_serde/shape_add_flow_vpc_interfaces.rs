...
pub fn ser_add_flow_vpc_interfaces_input(input: &crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_add_flow_vpc_interfaces_input::ser_add_flow_vpc_interfaces_input(&mut object, input)?;
    object.finish();
...
pub fn de_add_flow_vpc_interfaces_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesOutput, crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "BadRequestException" => crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::BadRequestException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ForbiddenException" => crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::ForbiddenException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServerErrorException" => crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::InternalServerErrorException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "NotFoundException" => crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::NotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "TooManyRequestsException" => crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::TooManyRequestsException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_add_flow_vpc_interfaces_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesOutput, crate::operation::add_flow_vpc_interfaces::AddFlowVpcInterfacesError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_add_flow_vpc_interfaces(value: &[u8], mut builder: crate::operation::add_flow_vpc_interfaces::builders::AddFlowVpcInterfacesOutputBuilder) -> Result<crate::operation::add_flow_vpc_interfaces::builders::AddFlowVpcInterfacesOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
