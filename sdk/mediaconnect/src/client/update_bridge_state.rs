...
impl super::Client  {
    ...
    ///   - [`bridge_arn(impl ::std::convert::Into<String>)`](crate::operation::update_bridge_state::builders::UpdateBridgeStateFluentBuilder::bridge_arn) / [`set_bridge_arn(Option<String>)`](crate::operation::update_bridge_state::builders::UpdateBridgeStateFluentBuilder::set_bridge_arn): The ARN of the bridge that you want to update.
