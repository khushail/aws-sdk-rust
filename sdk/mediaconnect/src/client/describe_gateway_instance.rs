...
impl super::Client  {
    ...
    ///   - [`gateway_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_gateway_instance::builders::DescribeGatewayInstanceFluentBuilder::gateway_instance_arn) / [`set_gateway_instance_arn(Option<String>)`](crate::operation::describe_gateway_instance::builders::DescribeGatewayInstanceFluentBuilder::set_gateway_instance_arn): The Amazon Resource Name (ARN) of the gateway instance that you want to describe.
