...
impl super::Client  {
    ...
    ///   - [`flow_arn(impl ::std::convert::Into<String>)`](crate::operation::add_flow_media_streams::builders::AddFlowMediaStreamsFluentBuilder::flow_arn) / [`set_flow_arn(Option<String>)`](crate::operation::add_flow_media_streams::builders::AddFlowMediaStreamsFluentBuilder::set_flow_arn): The Amazon Resource Name (ARN) of the flow.
