...
impl super::Client  {
    ...
    ///   - [`entitlement_arn(impl ::std::convert::Into<String>)`](crate::operation::revoke_flow_entitlement::builders::RevokeFlowEntitlementFluentBuilder::entitlement_arn) / [`set_entitlement_arn(Option<String>)`](crate::operation::revoke_flow_entitlement::builders::RevokeFlowEntitlementFluentBuilder::set_entitlement_arn): The ARN of the entitlement that you want to revoke.
    ///   - [`flow_arn(impl ::std::convert::Into<String>)`](crate::operation::revoke_flow_entitlement::builders::RevokeFlowEntitlementFluentBuilder::flow_arn) / [`set_flow_arn(Option<String>)`](crate::operation::revoke_flow_entitlement::builders::RevokeFlowEntitlementFluentBuilder::set_flow_arn): The flow that you want to revoke an entitlement from.
