...
impl ListAnalyzedResourcesInput {
    /// Consumes the builder and constructs an Operation<[`ListAnalyzedResources`](crate::operation::list_analyzed_resources::ListAnalyzedResources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_analyzed_resources::ListAnalyzedResources, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_analyzed_resources::ListAnalyzedResourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_analyzed_resources::ListAnalyzedResources::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAnalyzedResources", "accessanalyzer"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListAnalyzedResources`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAnalyzedResources {
                type Output = ::std::result::Result<crate::operation::list_analyzed_resources::ListAnalyzedResourcesOutput, crate::operation::list_analyzed_resources::ListAnalyzedResourcesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_analyzed_resources::de_list_analyzed_resources_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_analyzed_resources::de_list_analyzed_resources_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_analyzed_resources::ListAnalyzedResourcesError {
...
mod _list_analyzed_resources_output;
