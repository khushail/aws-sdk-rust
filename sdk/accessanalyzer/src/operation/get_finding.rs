...
impl GetFindingInput {
    /// Consumes the builder and constructs an Operation<[`GetFinding`](crate::operation::get_finding::GetFinding)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_finding::GetFinding, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_finding::GetFindingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/finding/{id}", id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_finding::GetFindingInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_finding::GetFindingInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_finding::GetFinding::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFinding {
                type Output = ::std::result::Result<crate::operation::get_finding::GetFindingOutput, crate::operation::get_finding::GetFindingError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_finding::de_get_finding_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_finding::de_get_finding_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_finding::GetFindingError {
