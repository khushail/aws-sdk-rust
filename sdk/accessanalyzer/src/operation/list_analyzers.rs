...
impl ListAnalyzersInput {
    /// Consumes the builder and constructs an Operation<[`ListAnalyzers`](crate::operation::list_analyzers::ListAnalyzers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_analyzers::ListAnalyzers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_analyzers::ListAnalyzersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/analyzer").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_analyzers::ListAnalyzersInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_analyzers::ListAnalyzersInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_analyzers::ListAnalyzers::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAnalyzers {
                type Output = ::std::result::Result<crate::operation::list_analyzers::ListAnalyzersOutput, crate::operation::list_analyzers::ListAnalyzersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_analyzers::de_list_analyzers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_analyzers::de_list_analyzers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_analyzers::ListAnalyzersError {
