...
impl ListPolicyGenerationsInput {
    /// Consumes the builder and constructs an Operation<[`ListPolicyGenerations`](crate::operation::list_policy_generations::ListPolicyGenerations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_policy_generations::ListPolicyGenerations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_policy_generations::ListPolicyGenerationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/policy/generation").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_policy_generations::ListPolicyGenerationsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                if let ::std::option::Option::Some(inner_1) = &_input.principal_arn {
                     {
                        query.push_kv("principalArn", &::aws_smithy_http::query::fmt_string(&inner_1));
                    }
                }
            ...
            fn update_http_builder(
                            input: &crate::operation::list_policy_generations::ListPolicyGenerationsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_policy_generations::ListPolicyGenerations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPolicyGenerations", "accessanalyzer"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListPolicyGenerations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyGenerations {
                type Output = ::std::result::Result<crate::operation::list_policy_generations::ListPolicyGenerationsOutput, crate::operation::list_policy_generations::ListPolicyGenerationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_policy_generations::de_list_policy_generations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_policy_generations::de_list_policy_generations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_policy_generations::ListPolicyGenerationsError {
...
mod _list_policy_generations_output;
