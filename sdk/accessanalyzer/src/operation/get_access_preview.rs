...
impl GetAccessPreviewInput {
    /// Consumes the builder and constructs an Operation<[`GetAccessPreview`](crate::operation::get_access_preview::GetAccessPreview)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_access_preview::GetAccessPreview, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_access_preview::GetAccessPreviewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if access_preview_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("access_preview_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/access-preview/{accessPreviewId}", accessPreviewId = access_preview_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_access_preview::GetAccessPreviewInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_2 = &_input.analyzer_arn;
                let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("analyzer_arn", "cannot be empty or unset"))?;
                if inner_2.is_empty() {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_access_preview::GetAccessPreviewInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_access_preview::GetAccessPreview::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAccessPreview", "accessanalyzer"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetAccessPreview`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccessPreview {
                type Output = ::std::result::Result<crate::operation::get_access_preview::GetAccessPreviewOutput, crate::operation::get_access_preview::GetAccessPreviewError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_access_preview::de_get_access_preview_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_access_preview::de_get_access_preview_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_access_preview::GetAccessPreviewError {
...
mod _get_access_preview_output;
