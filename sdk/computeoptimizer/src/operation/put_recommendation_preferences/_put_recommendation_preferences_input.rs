...
impl PutRecommendationPreferencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_recommendation_preferences::PutRecommendationPreferencesInput, ::aws_smithy_http::operation::error::BuildError> {
