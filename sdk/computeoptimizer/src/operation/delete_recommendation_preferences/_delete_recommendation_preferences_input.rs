...
impl DeleteRecommendationPreferencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_recommendation_preferences::DeleteRecommendationPreferencesInput, ::aws_smithy_http::operation::error::BuildError> {
