...
impl GetRecommendationPreferencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_recommendation_preferences::GetRecommendationPreferencesInput, ::aws_smithy_http::operation::error::BuildError> {
