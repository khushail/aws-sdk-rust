...
impl GetEbsVolumeRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_ebs_volume_recommendations::GetEbsVolumeRecommendationsInput, ::aws_smithy_http::operation::error::BuildError> {
