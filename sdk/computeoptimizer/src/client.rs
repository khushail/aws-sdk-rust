...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_computeoptimizer::Error> {
/// # let client: aws_sdk_computeoptimizer::Client = unimplemented!();
...
mod delete_recommendation_preferences;

mod describe_recommendation_export_jobs;

mod export_auto_scaling_group_recommendations;

mod export_ebs_volume_recommendations;

mod export_ec2_instance_recommendations;
...
mod get_ec2_instance_recommendations;

mod get_ec2_recommendation_projected_metrics;

mod get_ecs_service_recommendation_projected_metrics;

mod get_ecs_service_recommendations;

mod get_effective_recommendation_preferences;
...
mod get_recommendation_summaries;

mod put_recommendation_preferences;

mod update_enrollment_status;
