...
pub(crate) fn de_operations_list_input<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::Operation>>, ::aws_smithy_json::deserialize::error::DeserializeError>
