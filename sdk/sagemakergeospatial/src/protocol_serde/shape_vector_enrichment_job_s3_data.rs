...
pub(crate) fn de_vector_enrichment_job_s3_data<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VectorEnrichmentJobS3Data>, ::aws_smithy_json::deserialize::error::DeserializeError>
