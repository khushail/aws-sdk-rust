...
impl GetTileInput {
    /// Consumes the builder and constructs an Operation<[`GetTile`](crate::operation::get_tile::GetTile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_tile::GetTile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_tile::GetTileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.z;
                let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("z", "cannot be empty or unset"))?;
                let mut z_encoder = ::aws_smithy_types::primitive::Encoder::from(*input_1); let z = z_encoder.encode();
                if z.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("z", "cannot be empty or unset"))
                            }
                let input_2 = &_input.x;
                let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("x", "cannot be empty or unset"))?;
                let mut x_encoder = ::aws_smithy_types::primitive::Encoder::from(*input_2); let x = x_encoder.encode();
                if x.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("x", "cannot be empty or unset"))
                            }
                let input_3 = &_input.y;
                let input_3 = input_3.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("y", "cannot be empty or unset"))?;
                let mut y_encoder = ::aws_smithy_types::primitive::Encoder::from(*input_3); let y = y_encoder.encode();
                if y.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("y", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/tile/{z}/{x}/{y}", z = z, x = x, y = y).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_tile::GetTileInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_4 = &_input.image_assets;
                let inner_4 = inner_4.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("image_assets", "cannot be empty or unset"))?;
                for inner_5 in inner_4 {
                    query.push_kv("ImageAssets", &::aws_smithy_http::query::fmt_string(&inner_5));
                }
                let inner_6 = &_input.target;
                let inner_6 = inner_6.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("target", "cannot be empty or unset"))?;
                query.push_kv("Target", &::aws_smithy_http::query::fmt_string(&inner_6));
                let inner_7 = &_input.arn;
                let inner_7 = inner_7.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("arn", "cannot be empty or unset"))?;
                if inner_7.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("arn", "cannot be empty or unset"));
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_tile::GetTileError {
