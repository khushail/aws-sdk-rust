...
impl ListRasterDataCollectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_raster_data_collections::ListRasterDataCollectionsInput, ::aws_smithy_http::operation::error::BuildError> {
