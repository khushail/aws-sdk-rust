...
impl DeleteEarthObservationJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_earth_observation_job::DeleteEarthObservationJobInput, ::aws_smithy_http::operation::error::BuildError> {
