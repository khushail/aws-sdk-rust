...
impl ExportVectorEnrichmentJobInput {
    /// Consumes the builder and constructs an Operation<[`ExportVectorEnrichmentJob`](crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/export-vector-enrichment-jobs").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportVectorEnrichmentJob {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_export_vector_enrichment_job::de_export_vector_enrichment_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::export_vector_enrichment_job::ExportVectorEnrichmentJobError {
...
mod _export_vector_enrichment_job_output;
