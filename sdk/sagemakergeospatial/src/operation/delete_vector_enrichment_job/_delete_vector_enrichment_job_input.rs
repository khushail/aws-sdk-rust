...
impl DeleteVectorEnrichmentJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_vector_enrichment_job::DeleteVectorEnrichmentJobInput, ::aws_smithy_http::operation::error::BuildError> {
