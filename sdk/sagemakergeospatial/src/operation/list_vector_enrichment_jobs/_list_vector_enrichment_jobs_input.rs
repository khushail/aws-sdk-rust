...
impl ListVectorEnrichmentJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_vector_enrichment_jobs::ListVectorEnrichmentJobsInput, ::aws_smithy_http::operation::error::BuildError> {
