...
impl ExportEarthObservationJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::export_earth_observation_job::ExportEarthObservationJobInput, ::aws_smithy_http::operation::error::BuildError> {
