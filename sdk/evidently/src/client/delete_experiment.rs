...
impl super::Client  {
    ...
    ///   - [`project(impl ::std::convert::Into<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::project) / [`set_project(Option<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::set_project): <p>The name or ARN of the project that contains the experiment to delete.</p>
    ///   - [`experiment(impl ::std::convert::Into<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::experiment) / [`set_experiment(Option<String>)`](crate::operation::delete_experiment::builders::DeleteExperimentFluentBuilder::set_experiment): <p>The name of the experiment to delete.</p>
