...
impl UpdateAuditStreamConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAuditStreamConfiguration`](crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/updateAuditStreamConfiguration").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfigurationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateAuditStreamConfiguration", "worklink"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateAuditStreamConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAuditStreamConfiguration {
                type Output = ::std::result::Result<crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfigurationOutput, crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfigurationError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_audit_stream_configuration::UpdateAuditStreamConfigurationError {
...
pub use crate::operation::update_audit_stream_configuration::_update_audit_stream_configuration_output::UpdateAuditStreamConfigurationOutput;

pub use crate::operation::update_audit_stream_configuration::_update_audit_stream_configuration_input::UpdateAuditStreamConfigurationInput;

mod _update_audit_stream_configuration_input;

mod _update_audit_stream_configuration_output;
