...
impl ListWebsiteAuthorizationProvidersInput {
    /// Consumes the builder and constructs an Operation<[`ListWebsiteAuthorizationProviders`](crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProviders)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProviders, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/listWebsiteAuthorizationProviders").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProviders::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWebsiteAuthorizationProviders {
                type Output = ::std::result::Result<crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersOutput, crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_website_authorization_providers::de_list_website_authorization_providers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_website_authorization_providers::de_list_website_authorization_providers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_website_authorization_providers::ListWebsiteAuthorizationProvidersError {
...
pub use crate::operation::list_website_authorization_providers::_list_website_authorization_providers_output::ListWebsiteAuthorizationProvidersOutput;

pub use crate::operation::list_website_authorization_providers::_list_website_authorization_providers_input::ListWebsiteAuthorizationProvidersInput;

mod _list_website_authorization_providers_input;

mod _list_website_authorization_providers_output;
