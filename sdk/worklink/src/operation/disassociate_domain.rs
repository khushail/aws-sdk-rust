...
impl DisassociateDomainInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateDomain`](crate::operation::disassociate_domain::DisassociateDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_domain::DisassociateDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_domain::DisassociateDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/disassociateDomain").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_domain::DisassociateDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateDomain", "worklink"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisassociateDomain`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateDomain {
                type Output = ::std::result::Result<crate::operation::disassociate_domain::DisassociateDomainOutput, crate::operation::disassociate_domain::DisassociateDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_domain::de_disassociate_domain_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_domain::DisassociateDomainError {
...
pub use crate::operation::disassociate_domain::_disassociate_domain_output::DisassociateDomainOutput;

pub use crate::operation::disassociate_domain::_disassociate_domain_input::DisassociateDomainInput;

mod _disassociate_domain_input;

mod _disassociate_domain_output;
