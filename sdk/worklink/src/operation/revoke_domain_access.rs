...
impl RevokeDomainAccessInput {
    /// Consumes the builder and constructs an Operation<[`RevokeDomainAccess`](crate::operation::revoke_domain_access::RevokeDomainAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::revoke_domain_access::RevokeDomainAccess, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_domain_access::RevokeDomainAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/revokeDomainAccess").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_domain_access::RevokeDomainAccess::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeDomainAccess {
                type Output = ::std::result::Result<crate::operation::revoke_domain_access::RevokeDomainAccessOutput, crate::operation::revoke_domain_access::RevokeDomainAccessError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_revoke_domain_access::de_revoke_domain_access_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::revoke_domain_access::RevokeDomainAccessError {
...
pub use crate::operation::revoke_domain_access::_revoke_domain_access_output::RevokeDomainAccessOutput;

pub use crate::operation::revoke_domain_access::_revoke_domain_access_input::RevokeDomainAccessInput;

mod _revoke_domain_access_input;

mod _revoke_domain_access_output;
