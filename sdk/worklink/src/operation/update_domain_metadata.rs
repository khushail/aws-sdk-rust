...
impl UpdateDomainMetadataInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDomainMetadata`](crate::operation::update_domain_metadata::UpdateDomainMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_domain_metadata::UpdateDomainMetadata, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_domain_metadata::UpdateDomainMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/updateDomainMetadata").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_domain_metadata::UpdateDomainMetadata::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDomainMetadata {
                type Output = ::std::result::Result<crate::operation::update_domain_metadata::UpdateDomainMetadataOutput, crate::operation::update_domain_metadata::UpdateDomainMetadataError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_domain_metadata::de_update_domain_metadata_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_domain_metadata::de_update_domain_metadata_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_domain_metadata::UpdateDomainMetadataError {
...
pub use crate::operation::update_domain_metadata::_update_domain_metadata_output::UpdateDomainMetadataOutput;

pub use crate::operation::update_domain_metadata::_update_domain_metadata_input::UpdateDomainMetadataInput;

mod _update_domain_metadata_input;

mod _update_domain_metadata_output;
