...
impl ListWebsiteCertificateAuthoritiesInput {
    /// Consumes the builder and constructs an Operation<[`ListWebsiteCertificateAuthorities`](crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthorities)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthorities, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/listWebsiteCertificateAuthorities").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthorities::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWebsiteCertificateAuthorities {
                type Output = ::std::result::Result<crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesOutput, crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_website_certificate_authorities::de_list_website_certificate_authorities_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_website_certificate_authorities::de_list_website_certificate_authorities_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_website_certificate_authorities::ListWebsiteCertificateAuthoritiesError {
...
pub use crate::operation::list_website_certificate_authorities::_list_website_certificate_authorities_output::ListWebsiteCertificateAuthoritiesOutput;

pub use crate::operation::list_website_certificate_authorities::_list_website_certificate_authorities_input::ListWebsiteCertificateAuthoritiesInput;

mod _list_website_certificate_authorities_input;

mod _list_website_certificate_authorities_output;
