...
impl UpdateDevicePolicyConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDevicePolicyConfiguration`](crate::operation::update_device_policy_configuration::UpdateDevicePolicyConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_device_policy_configuration::UpdateDevicePolicyConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_device_policy_configuration::UpdateDevicePolicyConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/updateDevicePolicyConfiguration").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_device_policy_configuration::UpdateDevicePolicyConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDevicePolicyConfiguration", "worklink"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateDevicePolicyConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDevicePolicyConfiguration {
                type Output = ::std::result::Result<crate::operation::update_device_policy_configuration::UpdateDevicePolicyConfigurationOutput, crate::operation::update_device_policy_configuration::UpdateDevicePolicyConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_device_policy_configuration::de_update_device_policy_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_device_policy_configuration::de_update_device_policy_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_device_policy_configuration::UpdateDevicePolicyConfigurationError {
...
pub use crate::operation::update_device_policy_configuration::_update_device_policy_configuration_output::UpdateDevicePolicyConfigurationOutput;

pub use crate::operation::update_device_policy_configuration::_update_device_policy_configuration_input::UpdateDevicePolicyConfigurationInput;

mod _update_device_policy_configuration_input;

mod _update_device_policy_configuration_output;
