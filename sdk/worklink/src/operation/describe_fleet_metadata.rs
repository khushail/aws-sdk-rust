...
impl DescribeFleetMetadataInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetMetadata`](crate::operation::describe_fleet_metadata::DescribeFleetMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_fleet_metadata::DescribeFleetMetadata, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_metadata::DescribeFleetMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/describeFleetMetadata").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_metadata::DescribeFleetMetadata::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetMetadata {
                type Output = ::std::result::Result<crate::operation::describe_fleet_metadata::DescribeFleetMetadataOutput, crate::operation::describe_fleet_metadata::DescribeFleetMetadataError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_fleet_metadata::de_describe_fleet_metadata_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_fleet_metadata::de_describe_fleet_metadata_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_fleet_metadata::DescribeFleetMetadataError {
...
pub use crate::operation::describe_fleet_metadata::_describe_fleet_metadata_output::DescribeFleetMetadataOutput;

pub use crate::operation::describe_fleet_metadata::_describe_fleet_metadata_input::DescribeFleetMetadataInput;

mod _describe_fleet_metadata_input;

mod _describe_fleet_metadata_output;
