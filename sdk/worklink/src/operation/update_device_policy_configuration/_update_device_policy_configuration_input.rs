...
impl UpdateDevicePolicyConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_device_policy_configuration::UpdateDevicePolicyConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
