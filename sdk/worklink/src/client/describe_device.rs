...
impl super::Client  {
    ...
    ///   - [`fleet_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::set_fleet_arn): <p>The ARN of the fleet.</p>
    ///   - [`device_id(impl ::std::convert::Into<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::describe_device::builders::DescribeDeviceFluentBuilder::set_device_id): <p>A unique identifier for a registered user's device.</p>
