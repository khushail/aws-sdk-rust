...
impl super::Client  {
    ...
    ///   - [`fleet_arn(impl ::std::convert::Into<String>)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::fleet_arn) / [`set_fleet_arn(Option<String>)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::set_fleet_arn): <p>The ARN of the fleet.</p>
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::associate_website_authorization_provider::builders::AssociateWebsiteAuthorizationProviderFluentBuilder::set_domain_name): <p>The domain name of the authorization provider. This applies only to SAML-based authorization providers.</p>
