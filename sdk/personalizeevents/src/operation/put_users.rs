...
impl PutUsersInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_users::PutUsers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_users::PutUsersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/users").expect("formatting should succeed");
...
/// Orchestration and serialization glue logic for `PutUsers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutUsers {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_users::de_put_users_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_users::de_put_users_http_response_with_props(status, headers, body)
                     }
                }
