...
pub(crate) fn de_cross_region_copy_action<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CrossRegionCopyAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
