...
impl super::Client  {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_lifecycle_policy::builders::UpdateLifecyclePolicyFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_lifecycle_policy::builders::UpdateLifecyclePolicyFluentBuilder::set_description): <p>A description of the lifecycle policy.</p>
