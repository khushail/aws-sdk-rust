...
impl super::Client  {
    ...
    ///   - [`policy_id(impl ::std::convert::Into<String>)`](crate::operation::delete_lifecycle_policy::builders::DeleteLifecyclePolicyFluentBuilder::policy_id) / [`set_policy_id(Option<String>)`](crate::operation::delete_lifecycle_policy::builders::DeleteLifecyclePolicyFluentBuilder::set_policy_id): <p>The identifier of the lifecycle policy.</p>
