...
impl BatchAssociateUserStackInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_associate_user_stack::BatchAssociateUserStackInput, ::aws_smithy_http::operation::error::BuildError> {
