...
impl DescribeUserStackAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_user_stack_associations::DescribeUserStackAssociationsInput, ::aws_smithy_http::operation::error::BuildError> {
