...
impl ListEntitledApplicationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_entitled_applications::ListEntitledApplicationsInput, ::aws_smithy_http::operation::error::BuildError> {
