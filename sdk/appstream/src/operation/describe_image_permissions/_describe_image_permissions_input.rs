...
impl DescribeImagePermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_image_permissions::DescribeImagePermissionsInput, ::aws_smithy_http::operation::error::BuildError> {
