...
impl UpdateDirectoryConfigInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDirectoryConfig`](crate::operation::update_directory_config::UpdateDirectoryConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_directory_config::UpdateDirectoryConfig, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_directory_config::UpdateDirectoryConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_directory_config::ser_update_directory_config_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_directory_config::UpdateDirectoryConfig::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDirectoryConfig", "appstream"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateDirectoryConfig`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDirectoryConfig {
                type Output = ::std::result::Result<crate::operation::update_directory_config::UpdateDirectoryConfigOutput, crate::operation::update_directory_config::UpdateDirectoryConfigError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_directory_config::de_update_directory_config_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_directory_config::de_update_directory_config_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_directory_config::UpdateDirectoryConfigError {
...
mod _update_directory_config_output;
