...
impl CreateImageBuilderStreamingUrlInput {
    /// Consumes the builder and constructs an Operation<[`CreateImageBuilderStreamingURL`](crate::operation::create_image_builder_streaming_url::CreateImageBuilderStreamingURL)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_image_builder_streaming_url::CreateImageBuilderStreamingURL, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_image_builder_streaming_url::CreateImageBuilderStreamingUrlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_image_builder_streaming_url::ser_create_image_builder_streaming_url_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_image_builder_streaming_url::CreateImageBuilderStreamingURL::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateImageBuilderStreamingURL", "appstream"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateImageBuilderStreamingURL {
                type Output = ::std::result::Result<crate::operation::create_image_builder_streaming_url::CreateImageBuilderStreamingUrlOutput, crate::operation::create_image_builder_streaming_url::CreateImageBuilderStreamingURLError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_image_builder_streaming_url::de_create_image_builder_streaming_url_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_image_builder_streaming_url::de_create_image_builder_streaming_url_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_image_builder_streaming_url::CreateImageBuilderStreamingURLError {
...
mod _create_image_builder_streaming_url_output;
