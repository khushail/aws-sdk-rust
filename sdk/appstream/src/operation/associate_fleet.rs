...
impl AssociateFleetInput {
    /// Consumes the builder and constructs an Operation<[`AssociateFleet`](crate::operation::associate_fleet::AssociateFleet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_fleet::AssociateFleet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_fleet::AssociateFleetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_fleet::ser_associate_fleet_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_fleet::AssociateFleet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateFleet", "appstream"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateFleet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateFleet {
                type Output = ::std::result::Result<crate::operation::associate_fleet::AssociateFleetOutput, crate::operation::associate_fleet::AssociateFleetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_fleet::de_associate_fleet_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_fleet::de_associate_fleet_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_fleet::AssociateFleetError {
