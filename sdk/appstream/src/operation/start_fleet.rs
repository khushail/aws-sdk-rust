...
impl StartFleetInput {
    /// Consumes the builder and constructs an Operation<[`StartFleet`](crate::operation::start_fleet::StartFleet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_fleet::StartFleet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_fleet::StartFleetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_fleet::ser_start_fleet_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_fleet::StartFleet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartFleet", "appstream"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartFleet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartFleet {
                type Output = ::std::result::Result<crate::operation::start_fleet::StartFleetOutput, crate::operation::start_fleet::StartFleetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_fleet::de_start_fleet_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_fleet::de_start_fleet_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_fleet::StartFleetError {
