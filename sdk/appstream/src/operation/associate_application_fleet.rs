...
impl AssociateApplicationFleetInput {
    /// Consumes the builder and constructs an Operation<[`AssociateApplicationFleet`](crate::operation::associate_application_fleet::AssociateApplicationFleet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_application_fleet::AssociateApplicationFleet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_application_fleet::AssociateApplicationFleetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_application_fleet::ser_associate_application_fleet_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_application_fleet::AssociateApplicationFleet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateApplicationFleet", "appstream"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateApplicationFleet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateApplicationFleet {
                type Output = ::std::result::Result<crate::operation::associate_application_fleet::AssociateApplicationFleetOutput, crate::operation::associate_application_fleet::AssociateApplicationFleetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_application_fleet::de_associate_application_fleet_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_application_fleet::de_associate_application_fleet_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_application_fleet::AssociateApplicationFleetError {
...
mod _associate_application_fleet_output;
