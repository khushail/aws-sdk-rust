...
impl DeleteUsageReportSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_usage_report_subscription::DeleteUsageReportSubscriptionInput, ::aws_smithy_http::operation::error::BuildError> {
