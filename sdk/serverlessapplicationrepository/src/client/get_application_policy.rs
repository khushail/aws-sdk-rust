...
impl super::Client  {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::get_application_policy::builders::GetApplicationPolicyFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_application_policy::builders::GetApplicationPolicyFluentBuilder::set_application_id): <p>The Amazon Resource Name (ARN) of the application.</p>
