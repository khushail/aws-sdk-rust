...
impl GetTimeSeriesServiceStatisticsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_time_series_service_statistics::GetTimeSeriesServiceStatisticsInput, ::aws_smithy_http::operation::error::BuildError> {
