...
impl UpdateSamplingRuleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSamplingRule`](crate::operation::update_sampling_rule::UpdateSamplingRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_sampling_rule::UpdateSamplingRule, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_sampling_rule::UpdateSamplingRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/UpdateSamplingRule").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_sampling_rule::UpdateSamplingRule::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSamplingRule {
                type Output = ::std::result::Result<crate::operation::update_sampling_rule::UpdateSamplingRuleOutput, crate::operation::update_sampling_rule::UpdateSamplingRuleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_sampling_rule::de_update_sampling_rule_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_sampling_rule::de_update_sampling_rule_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_sampling_rule::UpdateSamplingRuleError {
...
mod _update_sampling_rule_output;
