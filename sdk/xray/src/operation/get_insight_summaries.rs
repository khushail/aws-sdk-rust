...
impl GetInsightSummariesInput {
    /// Consumes the builder and constructs an Operation<[`GetInsightSummaries`](crate::operation::get_insight_summaries::GetInsightSummaries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_insight_summaries::GetInsightSummaries, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_insight_summaries::GetInsightSummariesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/InsightSummaries").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_insight_summaries::GetInsightSummaries::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInsightSummaries {
                type Output = ::std::result::Result<crate::operation::get_insight_summaries::GetInsightSummariesOutput, crate::operation::get_insight_summaries::GetInsightSummariesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_insight_summaries::de_get_insight_summaries_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_insight_summaries::de_get_insight_summaries_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_insight_summaries::GetInsightSummariesError {
...
pub use crate::operation::get_insight_summaries::_get_insight_summaries_output::GetInsightSummariesOutput;

pub use crate::operation::get_insight_summaries::_get_insight_summaries_input::GetInsightSummariesInput;

mod _get_insight_summaries_input;

mod _get_insight_summaries_output;
