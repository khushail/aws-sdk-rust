...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_sampling_rules::builders::GetSamplingRulesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_sampling_rules::builders::GetSamplingRulesFluentBuilder::set_next_token): <p>Pagination token.</p>
