...
impl super::Client  {
    ...
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::get_group::builders::GetGroupFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::get_group::builders::GetGroupFluentBuilder::set_group_name): <p>The case-sensitive name of the group.</p>
    ///   - [`group_arn(impl ::std::convert::Into<String>)`](crate::operation::get_group::builders::GetGroupFluentBuilder::group_arn) / [`set_group_arn(Option<String>)`](crate::operation::get_group::builders::GetGroupFluentBuilder::set_group_arn): <p>The ARN of the group that was generated on creation.</p>
