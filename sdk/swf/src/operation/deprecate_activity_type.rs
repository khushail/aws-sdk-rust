...
impl DeprecateActivityTypeInput {
    /// Consumes the builder and constructs an Operation<[`DeprecateActivityType`](crate::operation::deprecate_activity_type::DeprecateActivityType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deprecate_activity_type::DeprecateActivityType, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deprecate_activity_type::DeprecateActivityTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deprecate_activity_type::ser_deprecate_activity_type_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deprecate_activity_type::DeprecateActivityType::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeprecateActivityType", "swf"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeprecateActivityType`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeprecateActivityType {
                type Output = ::std::result::Result<crate::operation::deprecate_activity_type::DeprecateActivityTypeOutput, crate::operation::deprecate_activity_type::DeprecateActivityTypeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deprecate_activity_type::de_deprecate_activity_type_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deprecate_activity_type::de_deprecate_activity_type_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deprecate_activity_type::DeprecateActivityTypeError {
...
mod _deprecate_activity_type_output;
