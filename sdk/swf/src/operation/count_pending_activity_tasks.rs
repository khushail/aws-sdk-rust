...
impl CountPendingActivityTasksInput {
    /// Consumes the builder and constructs an Operation<[`CountPendingActivityTasks`](crate::operation::count_pending_activity_tasks::CountPendingActivityTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::count_pending_activity_tasks::CountPendingActivityTasks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::count_pending_activity_tasks::CountPendingActivityTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_count_pending_activity_tasks::ser_count_pending_activity_tasks_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::count_pending_activity_tasks::CountPendingActivityTasks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CountPendingActivityTasks", "swf"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CountPendingActivityTasks`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CountPendingActivityTasks {
                type Output = ::std::result::Result<crate::operation::count_pending_activity_tasks::CountPendingActivityTasksOutput, crate::operation::count_pending_activity_tasks::CountPendingActivityTasksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_count_pending_activity_tasks::de_count_pending_activity_tasks_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_count_pending_activity_tasks::de_count_pending_activity_tasks_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::count_pending_activity_tasks::CountPendingActivityTasksError {
...
mod _count_pending_activity_tasks_output;
