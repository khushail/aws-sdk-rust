...
impl SignalWorkflowExecutionInput {
    /// Consumes the builder and constructs an Operation<[`SignalWorkflowExecution`](crate::operation::signal_workflow_execution::SignalWorkflowExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::signal_workflow_execution::SignalWorkflowExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::signal_workflow_execution::SignalWorkflowExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_signal_workflow_execution::ser_signal_workflow_execution_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::signal_workflow_execution::SignalWorkflowExecution::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SignalWorkflowExecution", "swf"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SignalWorkflowExecution`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SignalWorkflowExecution {
                type Output = ::std::result::Result<crate::operation::signal_workflow_execution::SignalWorkflowExecutionOutput, crate::operation::signal_workflow_execution::SignalWorkflowExecutionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_signal_workflow_execution::de_signal_workflow_execution_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_signal_workflow_execution::de_signal_workflow_execution_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::signal_workflow_execution::SignalWorkflowExecutionError {
...
mod _signal_workflow_execution_output;
