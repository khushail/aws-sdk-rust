...
/// Paginator for [`ListActivityTypes`](crate::operation::list_activity_types::ListActivityTypes)
            pub struct ListActivityTypesPaginator {
                handle: std::sync::Arc<crate::client::Handle>,
                builder: crate::operation::list_activity_types::builders::ListActivityTypesInputBuilder,
                stop_on_duplicate_token: bool,
            }

            impl ListActivityTypesPaginator  {
                /// Create a new paginator-wrapper
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::list_activity_types::builders::ListActivityTypesInputBuilder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::list_activity_types::ListActivityTypesOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_activity_types::ListActivityTypesError>>> + ::std::marker::Unpin
                 {
...
/// Flattened paginator for `ListActivityTypesPaginator`
                ...
                impl  ListActivityTypesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::ActivityTypeInfo, ::aws_smithy_http::result::SdkError<crate::operation::list_activity_types::ListActivityTypesError>>> + ::std::marker::Unpin
                     {
