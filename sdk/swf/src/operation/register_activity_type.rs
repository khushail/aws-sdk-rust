...
impl RegisterActivityTypeInput {
    /// Consumes the builder and constructs an Operation<[`RegisterActivityType`](crate::operation::register_activity_type::RegisterActivityType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_activity_type::RegisterActivityType, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_activity_type::RegisterActivityTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_activity_type::ser_register_activity_type_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_activity_type::RegisterActivityType::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterActivityType {
                type Output = ::std::result::Result<crate::operation::register_activity_type::RegisterActivityTypeOutput, crate::operation::register_activity_type::RegisterActivityTypeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_register_activity_type::de_register_activity_type_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_register_activity_type::de_register_activity_type_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::register_activity_type::RegisterActivityTypeError {
...
mod _register_activity_type_output;
