...
impl GetWorkflowExecutionHistoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryInput, ::aws_smithy_http::operation::error::BuildError> {
