...
impl ListOpenWorkflowExecutionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_open_workflow_executions::ListOpenWorkflowExecutionsInput, ::aws_smithy_http::operation::error::BuildError> {
