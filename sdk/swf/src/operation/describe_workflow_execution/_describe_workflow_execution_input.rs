...
impl DescribeWorkflowExecutionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_workflow_execution::DescribeWorkflowExecutionInput, ::aws_smithy_http::operation::error::BuildError> {
