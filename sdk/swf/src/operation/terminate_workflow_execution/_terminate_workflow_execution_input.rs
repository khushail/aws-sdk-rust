...
impl TerminateWorkflowExecutionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::terminate_workflow_execution::TerminateWorkflowExecutionInput, ::aws_smithy_http::operation::error::BuildError> {
