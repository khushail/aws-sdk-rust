...
impl PollForActivityTaskInput {
    /// Consumes the builder and constructs an Operation<[`PollForActivityTask`](crate::operation::poll_for_activity_task::PollForActivityTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::poll_for_activity_task::PollForActivityTask, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::poll_for_activity_task::PollForActivityTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::poll_for_activity_task::PollForActivityTaskInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_poll_for_activity_task::ser_poll_for_activity_task_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::poll_for_activity_task::PollForActivityTask::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PollForActivityTask {
                type Output = ::std::result::Result<crate::operation::poll_for_activity_task::PollForActivityTaskOutput, crate::operation::poll_for_activity_task::PollForActivityTaskError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_poll_for_activity_task::de_poll_for_activity_task_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_poll_for_activity_task::de_poll_for_activity_task_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::poll_for_activity_task::PollForActivityTaskError {
...
pub use crate::operation::poll_for_activity_task::_poll_for_activity_task_output::PollForActivityTaskOutput;

pub use crate::operation::poll_for_activity_task::_poll_for_activity_task_input::PollForActivityTaskInput;

mod _poll_for_activity_task_input;

mod _poll_for_activity_task_output;
