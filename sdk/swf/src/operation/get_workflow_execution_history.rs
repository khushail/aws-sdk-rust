...
impl GetWorkflowExecutionHistoryInput {
    /// Consumes the builder and constructs an Operation<[`GetWorkflowExecutionHistory`](crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_workflow_execution_history::ser_get_workflow_execution_history_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistory::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetWorkflowExecutionHistory", "swf"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetWorkflowExecutionHistory`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWorkflowExecutionHistory {
                type Output = ::std::result::Result<crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryOutput, crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_workflow_execution_history::de_get_workflow_execution_history_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_workflow_execution_history::de_get_workflow_execution_history_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_workflow_execution_history::GetWorkflowExecutionHistoryError {
...
mod _get_workflow_execution_history_output;
