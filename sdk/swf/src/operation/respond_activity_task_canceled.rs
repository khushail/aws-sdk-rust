...
impl RespondActivityTaskCanceledInput {
    /// Consumes the builder and constructs an Operation<[`RespondActivityTaskCanceled`](crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceled)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceled, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_respond_activity_task_canceled::ser_respond_activity_task_canceled_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceled::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RespondActivityTaskCanceled {
                type Output = ::std::result::Result<crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledOutput, crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_respond_activity_task_canceled::de_respond_activity_task_canceled_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_respond_activity_task_canceled::de_respond_activity_task_canceled_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::respond_activity_task_canceled::RespondActivityTaskCanceledError {
...
mod _respond_activity_task_canceled_output;
