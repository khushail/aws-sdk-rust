...
impl UndeprecateDomainInput {
    /// Consumes the builder and constructs an Operation<[`UndeprecateDomain`](crate::operation::undeprecate_domain::UndeprecateDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::undeprecate_domain::UndeprecateDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::undeprecate_domain::UndeprecateDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_undeprecate_domain::ser_undeprecate_domain_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::undeprecate_domain::UndeprecateDomain::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UndeprecateDomain {
                type Output = ::std::result::Result<crate::operation::undeprecate_domain::UndeprecateDomainOutput, crate::operation::undeprecate_domain::UndeprecateDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_undeprecate_domain::de_undeprecate_domain_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_undeprecate_domain::de_undeprecate_domain_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::undeprecate_domain::UndeprecateDomainError {
...
mod _undeprecate_domain_output;
