...
impl DeprecateDomainInput {
    /// Consumes the builder and constructs an Operation<[`DeprecateDomain`](crate::operation::deprecate_domain::DeprecateDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deprecate_domain::DeprecateDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deprecate_domain::DeprecateDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deprecate_domain::ser_deprecate_domain_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deprecate_domain::DeprecateDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeprecateDomain", "swf"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeprecateDomain`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeprecateDomain {
                type Output = ::std::result::Result<crate::operation::deprecate_domain::DeprecateDomainOutput, crate::operation::deprecate_domain::DeprecateDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deprecate_domain::de_deprecate_domain_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deprecate_domain::de_deprecate_domain_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deprecate_domain::DeprecateDomainError {
