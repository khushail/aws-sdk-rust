...
impl super::Client  {
    ...
    ///   - [`task_token(impl ::std::convert::Into<String>)`](crate::operation::respond_activity_task_failed::builders::RespondActivityTaskFailedFluentBuilder::task_token) / [`set_task_token(Option<String>)`](crate::operation::respond_activity_task_failed::builders::RespondActivityTaskFailedFluentBuilder::set_task_token): <p>The <code>taskToken</code> of the <code>ActivityTask</code>.</p> <important>   <p> <code>taskToken</code> is generated by the service and should be treated as an opaque value. If the task is passed to another process, its <code>taskToken</code> must also be passed. This enables it to provide its progress and respond with results.</p>  </important>
    ///   - [`reason(impl ::std::convert::Into<String>)`](crate::operation::respond_activity_task_failed::builders::RespondActivityTaskFailedFluentBuilder::reason) / [`set_reason(Option<String>)`](crate::operation::respond_activity_task_failed::builders::RespondActivityTaskFailedFluentBuilder::set_reason): <p>Description of the error that may assist in diagnostics.</p>
