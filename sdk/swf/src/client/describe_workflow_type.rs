...
impl super::Client  {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::describe_workflow_type::builders::DescribeWorkflowTypeFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::describe_workflow_type::builders::DescribeWorkflowTypeFluentBuilder::set_domain): <p>The name of the domain in which this workflow type is registered.</p>
