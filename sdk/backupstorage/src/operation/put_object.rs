...
impl PutObjectInput {
    ...
    pub async fn make_operation(self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_object::PutObject, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_object::PutObjectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if object_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("object_name", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/backup-jobs/{BackupJobId}/object/{ObjectName}/put-object", BackupJobId = backup_job_id, ObjectName = object_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::put_object::PutObjectInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_4) = &_input.inline_chunk_checksum {
                     {
                        query.push_kv("checksum", &::aws_smithy_http::query::fmt_string(&inner_4));
                    }
                }
                if let ::std::option::Option::Some(inner_5) = &_input.inline_chunk_checksum_algorithm {
                     {
                        query.push_kv("checksum-algorithm", &::aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                if let ::std::option::Option::Some(inner_6) = &_input.object_checksum {
                     {
                        query.push_kv("object-checksum", &::aws_smithy_http::query::fmt_string(&inner_6));
                    }
                }
                if let ::std::option::Option::Some(inner_7) = &_input.object_checksum_algorithm {
                     {
