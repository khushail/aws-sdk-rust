        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_objects::ListObjectsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if storage_job_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("storage_job_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/restore-jobs/{StorageJobId}/objects/list", StorageJobId = storage_job_id).expect("formatting should succeed");
            ...
            fn uri_query(_input: &crate::operation::list_objects::ListObjectsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.starting_object_name {
                     {
                        query.push_kv("starting-object-name", &::aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                if let ::std::option::Option::Some(inner_3) = &_input.starting_object_prefix {
                     {
                ...
                if let ::std::option::Option::Some(inner_5) = &_input.created_before {
                     {
                        query.push_kv("created-before", &::aws_smithy_http::query::fmt_timestamp(inner_5, ::aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let ::std::option::Option::Some(inner_6) = &_input.created_after {
                     {
                        query.push_kv("created-after", &::aws_smithy_http::query::fmt_timestamp(inner_6, ::aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                ::std::result::Result::Ok(())
            }
