...
other => DataChecksumAlgorithm::Unknown(crate::primitives::UnknownVariantValue(other.to_owned()))
                    }
                }
            }
impl ::std::str::FromStr for DataChecksumAlgorithm {
                ...
                fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                    ::std::result::Result::Ok(DataChecksumAlgorithm::from(s))
                }
            }
...
impl ::std::convert::AsRef<str> for DataChecksumAlgorithm {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
