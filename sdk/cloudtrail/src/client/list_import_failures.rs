...
impl super::Client  {
    ...
    ///   - [`import_id(impl ::std::convert::Into<String>)`](crate::operation::list_import_failures::builders::ListImportFailuresFluentBuilder::import_id) / [`set_import_id(Option<String>)`](crate::operation::list_import_failures::builders::ListImportFailuresFluentBuilder::set_import_id): <p> The ID of the import. </p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_import_failures::builders::ListImportFailuresFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_import_failures::builders::ListImportFailuresFluentBuilder::set_next_token): <p> A token you can use to get the next page of import failures. </p>
