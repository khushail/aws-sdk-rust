...
impl super::Client  {
    ...
    ///   - [`event_data_store(impl ::std::convert::Into<String>)`](crate::operation::list_queries::builders::ListQueriesFluentBuilder::event_data_store) / [`set_event_data_store(Option<String>)`](crate::operation::list_queries::builders::ListQueriesFluentBuilder::set_event_data_store): <p>The ARN (or the ID suffix of the ARN) of an event data store on which queries were run.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_queries::builders::ListQueriesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_queries::builders::ListQueriesFluentBuilder::set_next_token): <p>A token you can use to get the next page of results.</p>
