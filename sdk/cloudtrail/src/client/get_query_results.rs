...
impl super::Client  {
    ...
    ///   - [`event_data_store(impl ::std::convert::Into<String>)`](crate::operation::get_query_results::builders::GetQueryResultsFluentBuilder::event_data_store) / [`set_event_data_store(Option<String>)`](crate::operation::get_query_results::builders::GetQueryResultsFluentBuilder::set_event_data_store): <p>The ARN (or ID suffix of the ARN) of the event data store against which the query was run.</p>
    ///   - [`query_id(impl ::std::convert::Into<String>)`](crate::operation::get_query_results::builders::GetQueryResultsFluentBuilder::query_id) / [`set_query_id(Option<String>)`](crate::operation::get_query_results::builders::GetQueryResultsFluentBuilder::set_query_id): <p>The ID of the query for which you want to get results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_query_results::builders::GetQueryResultsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_query_results::builders::GetQueryResultsFluentBuilder::set_next_token): <p>A token you can use to get the next page of query results.</p>
