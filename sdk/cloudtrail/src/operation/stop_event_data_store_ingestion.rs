...
impl StopEventDataStoreIngestionInput {
    /// Consumes the builder and constructs an Operation<[`StopEventDataStoreIngestion`](crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            builder = ::aws_smithy_http::header::set_request_header_if_absent(
                                ...
                                "CloudTrail_20131101.StopEventDataStoreIngestion"
                            );
            builder
        };
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_event_data_store_ingestion::ser_stop_event_data_store_ingestion_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestion::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopEventDataStoreIngestion", "cloudtrail"));
...
#[non_exhaustive]
#[doc(hidden)]
pub struct StopEventDataStoreIngestion;
impl StopEventDataStoreIngestion {
    #[doc(hidden)]
    pub fn new() -> Self {
        Self
    }
}
impl ::aws_smithy_http::response::ParseStrictResponse for StopEventDataStoreIngestion {
                type Output = ::std::result::Result<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionOutput, crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_event_data_store_ingestion::de_stop_event_data_store_ingestion_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_event_data_store_ingestion::de_stop_event_data_store_ingestion_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type StopEventDataStoreIngestionErrorKind = StopEventDataStoreIngestionError;
/// Error type for the `StopEventDataStoreIngestionError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for StopEventDataStoreIngestionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for StopEventDataStoreIngestionError {
...
impl StopEventDataStoreIngestionError {
    /// Creates the `StopEventDataStoreIngestionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopEventDataStoreIngestionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `StopEventDataStoreIngestionError::EventDataStoreNotFoundException`.
    pub fn is_event_data_store_not_found_exception(&self) -> bool {
        matches!(self, Self::EventDataStoreNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StopEventDataStoreIngestionError::InsufficientDependencyServiceAccessPermissionException`.
    ...
    /// Returns `true` if the error kind is `StopEventDataStoreIngestionError::InvalidEventDataStoreCategoryException`.
    ...
    /// Returns `true` if the error kind is `StopEventDataStoreIngestionError::InvalidEventDataStoreStatusException`.
    pub fn is_invalid_event_data_store_status_exception(&self) -> bool {
        matches!(self, Self::InvalidEventDataStoreStatusException(_))
    }
    /// Returns `true` if the error kind is `StopEventDataStoreIngestionError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `StopEventDataStoreIngestionError::NoManagementAccountSlrExistsException`.
    pub fn is_no_management_account_slr_exists_exception(&self) -> bool {
        matches!(self, Self::NoManagementAccountSlrExistsException(_))
    }
    /// Returns `true` if the error kind is `StopEventDataStoreIngestionError::NotOrganizationMasterAccountException`.
    pub fn is_not_organization_master_account_exception(&self) -> bool {
        matches!(self, Self::NotOrganizationMasterAccountException(_))
    }
    /// Returns `true` if the error kind is `StopEventDataStoreIngestionError::OperationNotPermittedException`.
    pub fn is_operation_not_permitted_exception(&self) -> bool {
        matches!(self, Self::OperationNotPermittedException(_))
    }
    /// Returns `true` if the error kind is `StopEventDataStoreIngestionError::UnsupportedOperationException`.
...
mod _stop_event_data_store_ingestion_output;
