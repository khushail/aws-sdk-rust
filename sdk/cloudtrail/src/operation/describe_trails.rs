...
impl DescribeTrailsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTrails`](crate::operation::describe_trails::DescribeTrails)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_trails::DescribeTrails, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_trails::DescribeTrailsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_trails::ser_describe_trails_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_trails::DescribeTrails::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeTrails", "cloudtrail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeTrails`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTrails {
                type Output = ::std::result::Result<crate::operation::describe_trails::DescribeTrailsOutput, crate::operation::describe_trails::DescribeTrailsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_trails::de_describe_trails_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_trails::de_describe_trails_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_trails::DescribeTrailsError {
