...
impl StartEventDataStoreIngestionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionInput, ::aws_smithy_http::operation::error::BuildError> {
