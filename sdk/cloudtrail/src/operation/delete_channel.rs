    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_channel::DeleteChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            ...
            builder = ::aws_smithy_http::header::set_request_header_if_absent(
                                ...
                                "CloudTrail_20131101.DeleteChannel"
                            );
            builder
        };
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_channel::DeleteChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteChannel", "cloudtrail"));
...
impl DeleteChannelError {
    ...
    /// Returns `true` if the error kind is `DeleteChannelError::ChannelArnInvalidException`.
    pub fn is_channel_arn_invalid_exception(&self) -> bool {
        matches!(self, Self::ChannelArnInvalidException(_))
    }
    /// Returns `true` if the error kind is `DeleteChannelError::ChannelNotFoundException`.
    pub fn is_channel_not_found_exception(&self) -> bool {
        matches!(self, Self::ChannelNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteChannelError::OperationNotPermittedException`.
    pub fn is_operation_not_permitted_exception(&self) -> bool {
        matches!(self, Self::OperationNotPermittedException(_))
    }
    /// Returns `true` if the error kind is `DeleteChannelError::UnsupportedOperationException`.
