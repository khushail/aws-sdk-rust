...
impl StopEventDataStoreIngestionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionInput, ::aws_smithy_http::operation::error::BuildError> {
