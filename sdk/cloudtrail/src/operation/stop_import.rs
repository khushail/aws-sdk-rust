...
impl StopImportInput {
    /// Consumes the builder and constructs an Operation<[`StopImport`](crate::operation::stop_import::StopImport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_import::StopImport, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_import::StopImportInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_import::ser_stop_import_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_import::StopImport::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopImport", "cloudtrail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StopImport`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopImport {
                type Output = ::std::result::Result<crate::operation::stop_import::StopImportOutput, crate::operation::stop_import::StopImportError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_import::de_stop_import_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_import::de_stop_import_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_import::StopImportError {
