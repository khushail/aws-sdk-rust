...
/// Paginator for [`ListTags`](crate::operation::list_tags::ListTags)
            ...
            impl ListTagsPaginator  {
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::list_tags::ListTagsOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_tags::ListTagsError>>> + ::std::marker::Unpin
                 {
...
/// Flattened paginator for `ListTagsPaginator`
                ...
                impl  ListTagsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::ResourceTag, ::aws_smithy_http::result::SdkError<crate::operation::list_tags::ListTagsError>>> + ::std::marker::Unpin
                     {
