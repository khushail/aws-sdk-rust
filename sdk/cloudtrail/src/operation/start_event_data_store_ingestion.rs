...
impl StartEventDataStoreIngestionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestion::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartEventDataStoreIngestion {
                type Output = ::std::result::Result<crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionOutput, crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionError>;
