...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_http::result::SdkError<crate::operation::start_event_data_store_ingestion::StartEventDataStoreIngestionError, R>) -> Self {
        match err {
            ::aws_smithy_http::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            ::aws_smithy_types::error::Unhandled::builder()
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_http::result::SdkError<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError, R>) -> Self {
        match err {
            ::aws_smithy_http::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            ::aws_smithy_types::error::Unhandled::builder()
