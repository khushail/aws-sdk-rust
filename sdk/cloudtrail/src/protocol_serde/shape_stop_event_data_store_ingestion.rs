...
pub fn ser_stop_event_data_store_ingestion_input(input: &crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_stop_event_data_store_ingestion_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionOutput, crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_event_data_store_ingestion_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionOutput, crate::operation::stop_event_data_store_ingestion::StopEventDataStoreIngestionError> {
    Ok({
        #[allow(unused_mut)]
