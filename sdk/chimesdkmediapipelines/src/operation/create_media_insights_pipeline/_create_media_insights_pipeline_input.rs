...
impl CreateMediaInsightsPipelineInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_media_insights_pipeline::CreateMediaInsightsPipelineInput, ::aws_smithy_http::operation::error::BuildError> {
