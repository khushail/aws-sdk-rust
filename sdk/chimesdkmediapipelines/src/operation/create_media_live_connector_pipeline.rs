...
impl CreateMediaLiveConnectorPipelineInput {
    /// Consumes the builder and constructs an Operation<[`CreateMediaLiveConnectorPipeline`](crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipeline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipeline, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipelineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/sdk-media-live-connector-pipelines").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipeline::new())
...
/// Orchestration and serialization glue logic for `CreateMediaLiveConnectorPipeline`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMediaLiveConnectorPipeline {
                type Output = ::std::result::Result<crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipelineOutput, crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipelineError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_media_live_connector_pipeline::de_create_media_live_connector_pipeline_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_media_live_connector_pipeline::de_create_media_live_connector_pipeline_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_media_live_connector_pipeline::CreateMediaLiveConnectorPipelineError {
...
mod _create_media_live_connector_pipeline_output;
