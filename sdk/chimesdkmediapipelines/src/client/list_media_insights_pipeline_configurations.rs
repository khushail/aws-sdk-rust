...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_media_insights_pipeline_configurations::builders::ListMediaInsightsPipelineConfigurationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_media_insights_pipeline_configurations::builders::ListMediaInsightsPipelineConfigurationsFluentBuilder::set_next_token): <p>The token used to return the next page of results.</p>
