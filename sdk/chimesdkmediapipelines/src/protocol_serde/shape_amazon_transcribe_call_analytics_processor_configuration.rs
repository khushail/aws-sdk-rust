...
pub(crate) fn de_amazon_transcribe_call_analytics_processor_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AmazonTranscribeCallAnalyticsProcessorConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
