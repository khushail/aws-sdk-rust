...
pub(crate) fn de_post_call_analytics_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PostCallAnalyticsSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ContentRedactionOutput" => {
                                builder = builder.set_content_redaction_output(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ContentRedactionOutput::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
