...
pub(crate) fn de_media_insights_pipeline<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MediaInsightsPipeline>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "S3RecordingSinkRuntimeConfiguration" => {
                                builder = builder.set_s3_recording_sink_runtime_configuration(
                                    crate::protocol_serde::shape_s3_recording_sink_runtime_configuration::de_s3_recording_sink_runtime_configuration(tokens)?
                                );
                            }
                            "CreatedTimestamp" => {
