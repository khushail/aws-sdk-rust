        ...
        for item_4 in var_2 {
             {
                ...
                crate::protocol_serde::shape_live_connector_sink_configuration::ser_live_connector_sink_configuration(&mut object_5, item_4)?;
                object_5.finish();
            }
        }
        array_3.finish();
        ...
        for item_8 in var_6 {
             {
                ...
                crate::protocol_serde::shape_live_connector_source_configuration::ser_live_connector_source_configuration(&mut object_9, item_8)?;
                object_9.finish();
            }
        }
        array_7.finish();
