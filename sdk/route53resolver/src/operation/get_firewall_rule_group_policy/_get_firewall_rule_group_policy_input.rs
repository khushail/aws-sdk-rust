...
impl GetFirewallRuleGroupPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_firewall_rule_group_policy::GetFirewallRuleGroupPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
