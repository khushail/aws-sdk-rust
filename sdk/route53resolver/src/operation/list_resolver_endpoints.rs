...
impl ListResolverEndpointsInput {
    /// Consumes the builder and constructs an Operation<[`ListResolverEndpoints`](crate::operation::list_resolver_endpoints::ListResolverEndpoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_resolver_endpoints::ListResolverEndpoints, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resolver_endpoints::ListResolverEndpointsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resolver_endpoints::ListResolverEndpoints::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListResolverEndpoints", "route53resolver"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResolverEndpoints {
                type Output = ::std::result::Result<crate::operation::list_resolver_endpoints::ListResolverEndpointsOutput, crate::operation::list_resolver_endpoints::ListResolverEndpointsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_resolver_endpoints::de_list_resolver_endpoints_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_resolver_endpoints::de_list_resolver_endpoints_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_resolver_endpoints::ListResolverEndpointsError {
...
mod _list_resolver_endpoints_output;
