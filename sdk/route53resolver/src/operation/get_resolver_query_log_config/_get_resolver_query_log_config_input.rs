...
impl GetResolverQueryLogConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_resolver_query_log_config::GetResolverQueryLogConfigInput, ::aws_smithy_http::operation::error::BuildError> {
