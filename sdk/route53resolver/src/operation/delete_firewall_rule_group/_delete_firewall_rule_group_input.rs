...
impl DeleteFirewallRuleGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_firewall_rule_group::DeleteFirewallRuleGroupInput, ::aws_smithy_http::operation::error::BuildError> {
