...
impl DisassociateResolverRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_resolver_rule::DisassociateResolverRuleInput, ::aws_smithy_http::operation::error::BuildError> {
