...
impl GetResolverDnssecConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_resolver_dnssec_config::GetResolverDnssecConfigInput, ::aws_smithy_http::operation::error::BuildError> {
