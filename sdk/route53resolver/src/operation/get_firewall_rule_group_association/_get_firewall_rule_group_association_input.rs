...
impl GetFirewallRuleGroupAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_firewall_rule_group_association::GetFirewallRuleGroupAssociationInput, ::aws_smithy_http::operation::error::BuildError> {
