...
impl DeleteFirewallRuleGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFirewallRuleGroup`](crate::operation::delete_firewall_rule_group::DeleteFirewallRuleGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_firewall_rule_group::DeleteFirewallRuleGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_firewall_rule_group::DeleteFirewallRuleGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_firewall_rule_group::DeleteFirewallRuleGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteFirewallRuleGroup", "route53resolver"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteFirewallRuleGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFirewallRuleGroup {
                type Output = ::std::result::Result<crate::operation::delete_firewall_rule_group::DeleteFirewallRuleGroupOutput, crate::operation::delete_firewall_rule_group::DeleteFirewallRuleGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_firewall_rule_group::de_delete_firewall_rule_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_firewall_rule_group::de_delete_firewall_rule_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_firewall_rule_group::DeleteFirewallRuleGroupError {
...
mod _delete_firewall_rule_group_output;
