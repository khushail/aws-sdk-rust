...
impl GetResolverQueryLogConfigPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetResolverQueryLogConfigPolicy`](crate::operation::get_resolver_query_log_config_policy::GetResolverQueryLogConfigPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_resolver_query_log_config_policy::GetResolverQueryLogConfigPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_resolver_query_log_config_policy::GetResolverQueryLogConfigPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_resolver_query_log_config_policy::GetResolverQueryLogConfigPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetResolverQueryLogConfigPolicy", "route53resolver"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetResolverQueryLogConfigPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResolverQueryLogConfigPolicy {
                type Output = ::std::result::Result<crate::operation::get_resolver_query_log_config_policy::GetResolverQueryLogConfigPolicyOutput, crate::operation::get_resolver_query_log_config_policy::GetResolverQueryLogConfigPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_resolver_query_log_config_policy::de_get_resolver_query_log_config_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_resolver_query_log_config_policy::de_get_resolver_query_log_config_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_resolver_query_log_config_policy::GetResolverQueryLogConfigPolicyError {
...
mod _get_resolver_query_log_config_policy_output;
