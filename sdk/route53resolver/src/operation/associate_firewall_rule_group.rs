...
impl AssociateFirewallRuleGroupInput {
    /// Consumes the builder and constructs an Operation<[`AssociateFirewallRuleGroup`](crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateFirewallRuleGroup", "route53resolver"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateFirewallRuleGroup {
                type Output = ::std::result::Result<crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupOutput, crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_firewall_rule_group::de_associate_firewall_rule_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_firewall_rule_group::de_associate_firewall_rule_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_firewall_rule_group::AssociateFirewallRuleGroupError {
...
mod _associate_firewall_rule_group_output;
