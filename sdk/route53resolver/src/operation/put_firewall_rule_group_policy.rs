...
impl PutFirewallRuleGroupPolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutFirewallRuleGroupPolicy`](crate::operation::put_firewall_rule_group_policy::PutFirewallRuleGroupPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_firewall_rule_group_policy::PutFirewallRuleGroupPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_firewall_rule_group_policy::PutFirewallRuleGroupPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_firewall_rule_group_policy::PutFirewallRuleGroupPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutFirewallRuleGroupPolicy", "route53resolver"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutFirewallRuleGroupPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutFirewallRuleGroupPolicy {
                type Output = ::std::result::Result<crate::operation::put_firewall_rule_group_policy::PutFirewallRuleGroupPolicyOutput, crate::operation::put_firewall_rule_group_policy::PutFirewallRuleGroupPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_firewall_rule_group_policy::de_put_firewall_rule_group_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_firewall_rule_group_policy::de_put_firewall_rule_group_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_firewall_rule_group_policy::PutFirewallRuleGroupPolicyError {
...
mod _put_firewall_rule_group_policy_output;
