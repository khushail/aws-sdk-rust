...
/// Paginator for [`ListResolverRules`](crate::operation::list_resolver_rules::ListResolverRules)
            ...
            impl ListResolverRulesPaginator  {
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::list_resolver_rules::ListResolverRulesOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_resolver_rules::ListResolverRulesError>>> + ::std::marker::Unpin
                 {
...
/// Flattened paginator for `ListResolverRulesPaginator`
                ...
                impl  ListResolverRulesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::ResolverRule, ::aws_smithy_http::result::SdkError<crate::operation::list_resolver_rules::ListResolverRulesError>>> + ::std::marker::Unpin
                     {
