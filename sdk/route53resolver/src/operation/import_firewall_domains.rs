...
impl ImportFirewallDomainsInput {
    /// Consumes the builder and constructs an Operation<[`ImportFirewallDomains`](crate::operation::import_firewall_domains::ImportFirewallDomains)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_firewall_domains::ImportFirewallDomains, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_firewall_domains::ImportFirewallDomainsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_firewall_domains::ImportFirewallDomains::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ImportFirewallDomains", "route53resolver"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportFirewallDomains {
                type Output = ::std::result::Result<crate::operation::import_firewall_domains::ImportFirewallDomainsOutput, crate::operation::import_firewall_domains::ImportFirewallDomainsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_import_firewall_domains::de_import_firewall_domains_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::import_firewall_domains::ImportFirewallDomainsError {
