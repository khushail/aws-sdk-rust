...
impl DeleteResolverEndpointInput {
    /// Consumes the builder and constructs an Operation<[`DeleteResolverEndpoint`](crate::operation::delete_resolver_endpoint::DeleteResolverEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_resolver_endpoint::DeleteResolverEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_resolver_endpoint::DeleteResolverEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_resolver_endpoint::DeleteResolverEndpoint::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteResolverEndpoint", "route53resolver"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteResolverEndpoint`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResolverEndpoint {
                type Output = ::std::result::Result<crate::operation::delete_resolver_endpoint::DeleteResolverEndpointOutput, crate::operation::delete_resolver_endpoint::DeleteResolverEndpointError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_resolver_endpoint::de_delete_resolver_endpoint_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_resolver_endpoint::de_delete_resolver_endpoint_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_resolver_endpoint::DeleteResolverEndpointError {
...
mod _delete_resolver_endpoint_output;
