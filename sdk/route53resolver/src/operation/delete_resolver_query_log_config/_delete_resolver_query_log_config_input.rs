...
impl DeleteResolverQueryLogConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_resolver_query_log_config::DeleteResolverQueryLogConfigInput, ::aws_smithy_http::operation::error::BuildError> {
