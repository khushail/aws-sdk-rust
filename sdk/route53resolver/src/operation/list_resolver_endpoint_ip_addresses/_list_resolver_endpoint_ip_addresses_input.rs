...
impl ListResolverEndpointIpAddressesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_resolver_endpoint_ip_addresses::ListResolverEndpointIpAddressesInput, ::aws_smithy_http::operation::error::BuildError> {
