...
impl DisassociateFirewallRuleGroupInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateFirewallRuleGroup`](crate::operation::disassociate_firewall_rule_group::DisassociateFirewallRuleGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_firewall_rule_group::DisassociateFirewallRuleGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_firewall_rule_group::DisassociateFirewallRuleGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_firewall_rule_group::DisassociateFirewallRuleGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateFirewallRuleGroup", "route53resolver"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisassociateFirewallRuleGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateFirewallRuleGroup {
                type Output = ::std::result::Result<crate::operation::disassociate_firewall_rule_group::DisassociateFirewallRuleGroupOutput, crate::operation::disassociate_firewall_rule_group::DisassociateFirewallRuleGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_firewall_rule_group::de_disassociate_firewall_rule_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_firewall_rule_group::de_disassociate_firewall_rule_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_firewall_rule_group::DisassociateFirewallRuleGroupError {
...
mod _disassociate_firewall_rule_group_output;
