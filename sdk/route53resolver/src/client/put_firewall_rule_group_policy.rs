...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::put_firewall_rule_group_policy::builders::PutFirewallRuleGroupPolicyFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::put_firewall_rule_group_policy::builders::PutFirewallRuleGroupPolicyFluentBuilder::set_arn): <p>The ARN (Amazon Resource Name) for the rule group that you want to share.</p>
    ///   - [`firewall_rule_group_policy(impl ::std::convert::Into<String>)`](crate::operation::put_firewall_rule_group_policy::builders::PutFirewallRuleGroupPolicyFluentBuilder::firewall_rule_group_policy) / [`set_firewall_rule_group_policy(Option<String>)`](crate::operation::put_firewall_rule_group_policy::builders::PutFirewallRuleGroupPolicyFluentBuilder::set_firewall_rule_group_policy): <p>The Identity and Access Management (Amazon Web Services IAM) policy to attach to the rule group.</p>
