...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_firewall_rule_group_policy::builders::GetFirewallRuleGroupPolicyFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_firewall_rule_group_policy::builders::GetFirewallRuleGroupPolicyFluentBuilder::set_arn): <p>The ARN (Amazon Resource Name) for the rule group.</p>
