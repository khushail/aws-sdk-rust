...
impl StartCallAnalyticsStreamTranscriptionInput {
    ...
    pub async fn make_operation(self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscription, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_call_analytics_stream_transcription::StartCallAnalyticsStreamTranscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseHttpResponse for StartCallAnalyticsStreamTranscription {
                ...
                fn parse_unloaded(&self, response: &mut ::aws_smithy_http::operation::Response) -> ::std::option::Option<Self::Output> {
                    ...
                    ::std::option::Option::Some(crate::protocol_serde::shape_start_call_analytics_stream_transcription::de_start_call_analytics_stream_transcription_op_response(response))
                }
                fn parse_loaded(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_start_call_analytics_stream_transcription::de_start_call_analytics_stream_transcription_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
