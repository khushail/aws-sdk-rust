...
impl StartMedicalStreamTranscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_medical_stream_transcription::StartMedicalStreamTranscriptionInput, ::aws_smithy_http::operation::error::BuildError> {
