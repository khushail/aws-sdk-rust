...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_assessment::builders::GetAssessmentFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_assessment::builders::GetAssessmentFluentBuilder::set_id): <p> The <code>assessmentid</code> returned by <code>StartAssessment</code>.</p>
