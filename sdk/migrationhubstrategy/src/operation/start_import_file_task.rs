...
impl StartImportFileTaskInput {
    /// Consumes the builder and constructs an Operation<[`StartImportFileTask`](crate::operation::start_import_file_task::StartImportFileTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_import_file_task::StartImportFileTask, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_import_file_task::StartImportFileTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/start-import-file-task").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_import_file_task::ser_start_import_file_task_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_import_file_task::StartImportFileTask::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartImportFileTask", "migrationhubstrategy"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartImportFileTask {
                type Output = ::std::result::Result<crate::operation::start_import_file_task::StartImportFileTaskOutput, crate::operation::start_import_file_task::StartImportFileTaskError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::start_import_file_task::StartImportFileTaskError {
...
mod _start_import_file_task_output;
