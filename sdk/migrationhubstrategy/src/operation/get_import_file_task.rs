...
impl GetImportFileTaskInput {
    /// Consumes the builder and constructs an Operation<[`GetImportFileTask`](crate::operation::get_import_file_task::GetImportFileTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_import_file_task::GetImportFileTask, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_import_file_task::GetImportFileTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/get-import-file-task/{id}", id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_import_file_task::GetImportFileTaskInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_import_file_task::GetImportFileTask::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetImportFileTask", "migrationhubstrategy"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetImportFileTask`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetImportFileTask {
                type Output = ::std::result::Result<crate::operation::get_import_file_task::GetImportFileTaskOutput, crate::operation::get_import_file_task::GetImportFileTaskError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_import_file_task::de_get_import_file_task_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_import_file_task::de_get_import_file_task_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_import_file_task::GetImportFileTaskError {
...
mod _get_import_file_task_output;
