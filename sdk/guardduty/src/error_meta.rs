...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::get_coverage_statistics::GetCoverageStatisticsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_http::result::SdkError<crate::operation::get_coverage_statistics::GetCoverageStatisticsError, R>) -> Self {
        match err {
            ::aws_smithy_http::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            ::aws_smithy_types::error::Unhandled::builder()
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::start_malware_scan::StartMalwareScanError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_http::result::SdkError<crate::operation::start_malware_scan::StartMalwareScanError, R>) -> Self {
        match err {
            ::aws_smithy_http::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            ::aws_smithy_types::error::Unhandled::builder()
