...
impl UpdatePublishingDestinationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_publishing_destination::UpdatePublishingDestinationInput, ::aws_smithy_http::operation::error::BuildError> {
