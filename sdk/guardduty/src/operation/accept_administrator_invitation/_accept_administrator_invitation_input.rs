...
impl AcceptAdministratorInvitationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::accept_administrator_invitation::AcceptAdministratorInvitationInput, ::aws_smithy_http::operation::error::BuildError> {
