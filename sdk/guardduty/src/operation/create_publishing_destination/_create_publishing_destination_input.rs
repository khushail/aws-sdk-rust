...
impl CreatePublishingDestinationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_publishing_destination::CreatePublishingDestinationInput, ::aws_smithy_http::operation::error::BuildError> {
