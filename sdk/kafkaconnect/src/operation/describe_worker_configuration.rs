...
impl DescribeWorkerConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeWorkerConfiguration`](crate::operation::describe_worker_configuration::DescribeWorkerConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_worker_configuration::DescribeWorkerConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_worker_configuration::DescribeWorkerConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.worker_configuration_arn;
                let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("worker_configuration_arn", "cannot be empty or unset"))?;
                let worker_configuration_arn = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
                if worker_configuration_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("worker_configuration_arn", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/v1/worker-configurations/{workerConfigurationArn}", workerConfigurationArn = worker_configuration_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::describe_worker_configuration::DescribeWorkerConfigurationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_worker_configuration::DescribeWorkerConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeWorkerConfiguration {
                type Output = ::std::result::Result<crate::operation::describe_worker_configuration::DescribeWorkerConfigurationOutput, crate::operation::describe_worker_configuration::DescribeWorkerConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_worker_configuration::de_describe_worker_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_worker_configuration::de_describe_worker_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_worker_configuration::DescribeWorkerConfigurationError {
...
mod _describe_worker_configuration_output;
