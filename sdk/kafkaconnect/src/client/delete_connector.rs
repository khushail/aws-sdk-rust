...
impl super::Client  {
    ...
    ///   - [`connector_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_connector::builders::DeleteConnectorFluentBuilder::connector_arn) / [`set_connector_arn(Option<String>)`](crate::operation::delete_connector::builders::DeleteConnectorFluentBuilder::set_connector_arn): <p>The Amazon Resource Name (ARN) of the connector that you want to delete.</p>
    ///   - [`current_version(impl ::std::convert::Into<String>)`](crate::operation::delete_connector::builders::DeleteConnectorFluentBuilder::current_version) / [`set_current_version(Option<String>)`](crate::operation::delete_connector::builders::DeleteConnectorFluentBuilder::set_current_version): <p>The current version of the connector that you want to delete.</p>
