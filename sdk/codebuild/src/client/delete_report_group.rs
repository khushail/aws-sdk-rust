...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::delete_report_group::builders::DeleteReportGroupFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_report_group::builders::DeleteReportGroupFluentBuilder::set_arn): <p>The ARN of the report group to delete. </p>
