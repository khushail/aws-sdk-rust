...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::update_report_group::builders::UpdateReportGroupFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_report_group::builders::UpdateReportGroupFluentBuilder::set_arn): <p> The ARN of the report group to update. </p>
