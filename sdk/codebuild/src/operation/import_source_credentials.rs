...
impl ImportSourceCredentialsInput {
    /// Consumes the builder and constructs an Operation<[`ImportSourceCredentials`](crate::operation::import_source_credentials::ImportSourceCredentials)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_source_credentials::ImportSourceCredentials, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_source_credentials::ImportSourceCredentialsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_import_source_credentials::ser_import_source_credentials_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_source_credentials::ImportSourceCredentials::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ImportSourceCredentials", "codebuild"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ImportSourceCredentials`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportSourceCredentials {
                type Output = ::std::result::Result<crate::operation::import_source_credentials::ImportSourceCredentialsOutput, crate::operation::import_source_credentials::ImportSourceCredentialsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_import_source_credentials::de_import_source_credentials_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_import_source_credentials::de_import_source_credentials_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::import_source_credentials::ImportSourceCredentialsError {
...
mod _import_source_credentials_output;
