...
impl ListSharedReportGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListSharedReportGroups`](crate::operation::list_shared_report_groups::ListSharedReportGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_shared_report_groups::ListSharedReportGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_shared_report_groups::ListSharedReportGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_shared_report_groups::ser_list_shared_report_groups_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_shared_report_groups::ListSharedReportGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSharedReportGroups {
                type Output = ::std::result::Result<crate::operation::list_shared_report_groups::ListSharedReportGroupsOutput, crate::operation::list_shared_report_groups::ListSharedReportGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_shared_report_groups::de_list_shared_report_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_shared_report_groups::de_list_shared_report_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_shared_report_groups::ListSharedReportGroupsError {
...
mod _list_shared_report_groups_output;
