...
impl GetReportGroupTrendInput {
    /// Consumes the builder and constructs an Operation<[`GetReportGroupTrend`](crate::operation::get_report_group_trend::GetReportGroupTrend)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_report_group_trend::GetReportGroupTrend, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_report_group_trend::GetReportGroupTrendInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_report_group_trend::ser_get_report_group_trend_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_report_group_trend::GetReportGroupTrend::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReportGroupTrend {
                type Output = ::std::result::Result<crate::operation::get_report_group_trend::GetReportGroupTrendOutput, crate::operation::get_report_group_trend::GetReportGroupTrendError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_report_group_trend::de_get_report_group_trend_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_report_group_trend::de_get_report_group_trend_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_report_group_trend::GetReportGroupTrendError {
...
mod _get_report_group_trend_output;
