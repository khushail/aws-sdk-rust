...
impl PutServiceQuotaIncreaseRequestIntoTemplateInput {
    /// Consumes the builder and constructs an Operation<[`PutServiceQuotaIncreaseRequestIntoTemplate`](crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplate::new())
...
/// Orchestration and serialization glue logic for `PutServiceQuotaIncreaseRequestIntoTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutServiceQuotaIncreaseRequestIntoTemplate {
                type Output = ::std::result::Result<crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplateOutput, crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_service_quota_increase_request_into_template::de_put_service_quota_increase_request_into_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_service_quota_increase_request_into_template::de_put_service_quota_increase_request_into_template_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_service_quota_increase_request_into_template::PutServiceQuotaIncreaseRequestIntoTemplateError {
...
pub use crate::operation::put_service_quota_increase_request_into_template::_put_service_quota_increase_request_into_template_output::PutServiceQuotaIncreaseRequestIntoTemplateOutput;

pub use crate::operation::put_service_quota_increase_request_into_template::_put_service_quota_increase_request_into_template_input::PutServiceQuotaIncreaseRequestIntoTemplateInput;

mod _put_service_quota_increase_request_into_template_input;

mod _put_service_quota_increase_request_into_template_output;
