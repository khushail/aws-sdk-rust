...
impl GetAwsDefaultServiceQuotaInput {
    /// Consumes the builder and constructs an Operation<[`GetAWSDefaultServiceQuota`](crate::operation::get_aws_default_service_quota::GetAWSDefaultServiceQuota)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_aws_default_service_quota::GetAWSDefaultServiceQuota, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_aws_default_service_quota::GetAwsDefaultServiceQuotaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_aws_default_service_quota::GetAWSDefaultServiceQuota::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAWSDefaultServiceQuota {
                type Output = ::std::result::Result<crate::operation::get_aws_default_service_quota::GetAwsDefaultServiceQuotaOutput, crate::operation::get_aws_default_service_quota::GetAWSDefaultServiceQuotaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_aws_default_service_quota::de_get_aws_default_service_quota_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_aws_default_service_quota::GetAWSDefaultServiceQuotaError {
