...
impl AssociateServiceQuotaTemplateInput {
    /// Consumes the builder and constructs an Operation<[`AssociateServiceQuotaTemplate`](crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateServiceQuotaTemplate {
                type Output = ::std::result::Result<crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplateOutput, crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_service_quota_template::de_associate_service_quota_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_service_quota_template::de_associate_service_quota_template_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_service_quota_template::AssociateServiceQuotaTemplateError {
...
mod _associate_service_quota_template_output;
