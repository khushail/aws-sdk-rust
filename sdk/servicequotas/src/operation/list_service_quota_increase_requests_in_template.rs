...
impl ListServiceQuotaIncreaseRequestsInTemplateInput {
    /// Consumes the builder and constructs an Operation<[`ListServiceQuotaIncreaseRequestsInTemplate`](crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplate::new())
...
/// Orchestration and serialization glue logic for `ListServiceQuotaIncreaseRequestsInTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListServiceQuotaIncreaseRequestsInTemplate {
                type Output = ::std::result::Result<crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplateOutput, crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_service_quota_increase_requests_in_template::de_list_service_quota_increase_requests_in_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_service_quota_increase_requests_in_template::de_list_service_quota_increase_requests_in_template_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_service_quota_increase_requests_in_template::ListServiceQuotaIncreaseRequestsInTemplateError {
...
pub use crate::operation::list_service_quota_increase_requests_in_template::_list_service_quota_increase_requests_in_template_output::ListServiceQuotaIncreaseRequestsInTemplateOutput;

pub use crate::operation::list_service_quota_increase_requests_in_template::_list_service_quota_increase_requests_in_template_input::ListServiceQuotaIncreaseRequestsInTemplateInput;

mod _list_service_quota_increase_requests_in_template_input;

mod _list_service_quota_increase_requests_in_template_output;
