...
impl ConfigureLogsForChannelInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::configure_logs_for_channel::ConfigureLogsForChannelInput, ::aws_smithy_http::operation::error::BuildError> {
