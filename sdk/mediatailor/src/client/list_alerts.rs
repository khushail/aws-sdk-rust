...
impl super::Client  {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::list_alerts::builders::ListAlertsFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::list_alerts::builders::ListAlertsFluentBuilder::set_resource_arn): <p>The Amazon Resource Name (ARN) of the resource.</p>
