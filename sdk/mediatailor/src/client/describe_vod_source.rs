...
impl super::Client  {
    ...
    ///   - [`source_location_name(impl ::std::convert::Into<String>)`](crate::operation::describe_vod_source::builders::DescribeVodSourceFluentBuilder::source_location_name) / [`set_source_location_name(Option<String>)`](crate::operation::describe_vod_source::builders::DescribeVodSourceFluentBuilder::set_source_location_name): <p>The name of the source location associated with this VOD Source.</p>
    ///   - [`vod_source_name(impl ::std::convert::Into<String>)`](crate::operation::describe_vod_source::builders::DescribeVodSourceFluentBuilder::vod_source_name) / [`set_vod_source_name(Option<String>)`](crate::operation::describe_vod_source::builders::DescribeVodSourceFluentBuilder::set_vod_source_name): <p>The name of the VOD Source.</p>
