...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_playback_configuration_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_playback_configuration::PutPlaybackConfigurationOutput, crate::operation::put_playback_configuration::PutPlaybackConfigurationError> {
    Ok({
        #[allow(unused_mut)]
