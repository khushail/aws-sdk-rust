...
pub(crate) fn de_canaries<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::Canary>>, ::aws_smithy_json::deserialize::error::DeserializeError>
