...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_canary_runs::builders::GetCanaryRunsFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_canary_runs::builders::GetCanaryRunsFluentBuilder::set_name): <p>The name of the canary that you want to see runs for.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_canary_runs::builders::GetCanaryRunsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_canary_runs::builders::GetCanaryRunsFluentBuilder::set_next_token): <p>A token that indicates that there is more data available. You can use this token in a subsequent <code>GetCanaryRuns</code> operation to retrieve the next set of results.</p>
