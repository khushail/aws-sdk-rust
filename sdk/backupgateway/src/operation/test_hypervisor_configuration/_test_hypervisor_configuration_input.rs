...
impl TestHypervisorConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::test_hypervisor_configuration::TestHypervisorConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
