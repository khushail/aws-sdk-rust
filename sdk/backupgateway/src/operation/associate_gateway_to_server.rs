...
impl AssociateGatewayToServerInput {
    /// Consumes the builder and constructs an Operation<[`AssociateGatewayToServer`](crate::operation::associate_gateway_to_server::AssociateGatewayToServer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_gateway_to_server::AssociateGatewayToServer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_gateway_to_server::AssociateGatewayToServerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_gateway_to_server::AssociateGatewayToServer::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateGatewayToServer", "backupgateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateGatewayToServer`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateGatewayToServer {
                type Output = ::std::result::Result<crate::operation::associate_gateway_to_server::AssociateGatewayToServerOutput, crate::operation::associate_gateway_to_server::AssociateGatewayToServerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_gateway_to_server::de_associate_gateway_to_server_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_gateway_to_server::de_associate_gateway_to_server_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_gateway_to_server::AssociateGatewayToServerError {
...
mod _associate_gateway_to_server_output;
