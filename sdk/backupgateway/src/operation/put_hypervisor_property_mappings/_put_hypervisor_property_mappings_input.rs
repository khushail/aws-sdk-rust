...
impl PutHypervisorPropertyMappingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_hypervisor_property_mappings::PutHypervisorPropertyMappingsInput, ::aws_smithy_http::operation::error::BuildError> {
