...
impl PutBandwidthRateLimitScheduleInput {
    /// Consumes the builder and constructs an Operation<[`PutBandwidthRateLimitSchedule`](crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitSchedule, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitSchedule::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutBandwidthRateLimitSchedule", "backupgateway"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBandwidthRateLimitSchedule {
                type Output = ::std::result::Result<crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitScheduleOutput, crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitScheduleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_bandwidth_rate_limit_schedule::de_put_bandwidth_rate_limit_schedule_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_bandwidth_rate_limit_schedule::de_put_bandwidth_rate_limit_schedule_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitScheduleError {
...
mod _put_bandwidth_rate_limit_schedule_output;
