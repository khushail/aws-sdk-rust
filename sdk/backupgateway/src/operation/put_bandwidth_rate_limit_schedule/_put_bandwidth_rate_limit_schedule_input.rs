...
impl PutBandwidthRateLimitScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_bandwidth_rate_limit_schedule::PutBandwidthRateLimitScheduleInput, ::aws_smithy_http::operation::error::BuildError> {
