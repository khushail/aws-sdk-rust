...
impl PutHypervisorPropertyMappingsInput {
    /// Consumes the builder and constructs an Operation<[`PutHypervisorPropertyMappings`](crate::operation::put_hypervisor_property_mappings::PutHypervisorPropertyMappings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_hypervisor_property_mappings::PutHypervisorPropertyMappings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_hypervisor_property_mappings::PutHypervisorPropertyMappingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_hypervisor_property_mappings::PutHypervisorPropertyMappings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutHypervisorPropertyMappings", "backupgateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutHypervisorPropertyMappings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutHypervisorPropertyMappings {
                type Output = ::std::result::Result<crate::operation::put_hypervisor_property_mappings::PutHypervisorPropertyMappingsOutput, crate::operation::put_hypervisor_property_mappings::PutHypervisorPropertyMappingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_hypervisor_property_mappings::de_put_hypervisor_property_mappings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_hypervisor_property_mappings::de_put_hypervisor_property_mappings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_hypervisor_property_mappings::PutHypervisorPropertyMappingsError {
...
mod _put_hypervisor_property_mappings_output;
