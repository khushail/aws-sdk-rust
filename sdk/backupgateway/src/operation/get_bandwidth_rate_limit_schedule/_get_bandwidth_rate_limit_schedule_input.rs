...
impl GetBandwidthRateLimitScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_bandwidth_rate_limit_schedule::GetBandwidthRateLimitScheduleInput, ::aws_smithy_http::operation::error::BuildError> {
