...
impl super::Client  {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::get_virtual_machine::builders::GetVirtualMachineFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::get_virtual_machine::builders::GetVirtualMachineFluentBuilder::set_resource_arn): <p>The Amazon Resource Name (ARN) of the virtual machine.</p>
