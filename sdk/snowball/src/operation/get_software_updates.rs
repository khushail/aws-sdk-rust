...
impl GetSoftwareUpdatesInput {
    /// Consumes the builder and constructs an Operation<[`GetSoftwareUpdates`](crate::operation::get_software_updates::GetSoftwareUpdates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_software_updates::GetSoftwareUpdates, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_software_updates::GetSoftwareUpdatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_software_updates::GetSoftwareUpdates::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSoftwareUpdates", "snowball"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetSoftwareUpdates`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSoftwareUpdates {
                type Output = ::std::result::Result<crate::operation::get_software_updates::GetSoftwareUpdatesOutput, crate::operation::get_software_updates::GetSoftwareUpdatesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_software_updates::de_get_software_updates_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_software_updates::de_get_software_updates_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_software_updates::GetSoftwareUpdatesError {
...
mod _get_software_updates_output;
