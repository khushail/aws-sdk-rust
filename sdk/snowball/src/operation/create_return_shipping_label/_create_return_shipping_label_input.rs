...
impl CreateReturnShippingLabelInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_return_shipping_label::CreateReturnShippingLabelInput, ::aws_smithy_http::operation::error::BuildError> {
