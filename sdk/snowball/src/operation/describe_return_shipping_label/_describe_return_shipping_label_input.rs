...
impl DescribeReturnShippingLabelInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_return_shipping_label::DescribeReturnShippingLabelInput, ::aws_smithy_http::operation::error::BuildError> {
