...
impl DescribeAddressInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAddress`](crate::operation::describe_address::DescribeAddress)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_address::DescribeAddress, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_address::DescribeAddressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_address::DescribeAddress::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAddress", "snowball"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeAddress`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAddress {
                type Output = ::std::result::Result<crate::operation::describe_address::DescribeAddressOutput, crate::operation::describe_address::DescribeAddressError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_address::de_describe_address_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_address::de_describe_address_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_address::DescribeAddressError {
...
pub use crate::operation::describe_address::_describe_address_output::DescribeAddressOutput;

pub use crate::operation::describe_address::_describe_address_input::DescribeAddressInput;

mod _describe_address_input;

mod _describe_address_output;
