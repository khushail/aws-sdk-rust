...
impl super::Client  {
    ...
    ///   - [`service_name(ServiceName)`](crate::operation::list_service_versions::builders::ListServiceVersionsFluentBuilder::service_name) / [`set_service_name(Option<ServiceName>)`](crate::operation::list_service_versions::builders::ListServiceVersionsFluentBuilder::set_service_name): <p>The name of the service for which you're requesting supported versions.</p>
    ///   - [`dependent_services(Vec<DependentService>)`](crate::operation::list_service_versions::builders::ListServiceVersionsFluentBuilder::dependent_services) / [`set_dependent_services(Option<Vec<DependentService>>)`](crate::operation::list_service_versions::builders::ListServiceVersionsFluentBuilder::set_dependent_services): <p>A list of names and versions of dependant services of the requested service.</p>
    ///   - [`max_results(i32)`](crate::operation::list_service_versions::builders::ListServiceVersionsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_service_versions::builders::ListServiceVersionsFluentBuilder::set_max_results): <p>The maximum number of <code>ListServiceVersions</code> objects to return.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_service_versions::builders::ListServiceVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_service_versions::builders::ListServiceVersionsFluentBuilder::set_next_token): <p>Because HTTP requests are stateless, this is the starting point for the next list of returned <code>ListServiceVersionsRequest</code> versions.</p>
    ...
    ///   - [`service_versions(Option<Vec<ServiceVersion>>)`](crate::operation::list_service_versions::ListServiceVersionsOutput::service_versions): <p>A list of supported versions.</p>
    ///   - [`service_name(Option<ServiceName>)`](crate::operation::list_service_versions::ListServiceVersionsOutput::service_name): <p>The name of the service for which the system provided supported versions.</p>
