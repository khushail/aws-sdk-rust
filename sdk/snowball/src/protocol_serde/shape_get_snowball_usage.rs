...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_snowball_usage_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_snowball_usage::GetSnowballUsageOutput, crate::operation::get_snowball_usage::GetSnowballUsageError> {
    Ok({
        #[allow(unused_mut)]
