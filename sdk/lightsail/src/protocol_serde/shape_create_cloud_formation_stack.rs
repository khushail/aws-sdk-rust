...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_cloud_formation_stack_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackOutput, crate::operation::create_cloud_formation_stack::CreateCloudFormationStackError> {
    Ok({
        #[allow(unused_mut)]
