...
impl SendContactMethodVerificationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::send_contact_method_verification::SendContactMethodVerificationInput, ::aws_smithy_http::operation::error::BuildError> {
