...
impl GetDistributionBundlesInput {
    /// Consumes the builder and constructs an Operation<[`GetDistributionBundles`](crate::operation::get_distribution_bundles::GetDistributionBundles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_distribution_bundles::GetDistributionBundles, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_distribution_bundles::GetDistributionBundlesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_distribution_bundles::GetDistributionBundlesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_distribution_bundles::ser_get_distribution_bundles_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_distribution_bundles::GetDistributionBundles::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDistributionBundles", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDistributionBundles {
                type Output = ::std::result::Result<crate::operation::get_distribution_bundles::GetDistributionBundlesOutput, crate::operation::get_distribution_bundles::GetDistributionBundlesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_distribution_bundles::de_get_distribution_bundles_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_distribution_bundles::de_get_distribution_bundles_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_distribution_bundles::GetDistributionBundlesError {
...
mod _get_distribution_bundles_output;
