...
impl GetContainerApiMetadataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_container_api_metadata::GetContainerApiMetadataInput, ::aws_smithy_http::operation::error::BuildError> {
