...
impl GetInstanceSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`GetInstanceSnapshot`](crate::operation::get_instance_snapshot::GetInstanceSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_instance_snapshot::GetInstanceSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_instance_snapshot::GetInstanceSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_instance_snapshot::GetInstanceSnapshotInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_instance_snapshot::ser_get_instance_snapshot_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_instance_snapshot::GetInstanceSnapshot::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetInstanceSnapshot", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetInstanceSnapshot`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInstanceSnapshot {
                type Output = ::std::result::Result<crate::operation::get_instance_snapshot::GetInstanceSnapshotOutput, crate::operation::get_instance_snapshot::GetInstanceSnapshotError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_instance_snapshot::de_get_instance_snapshot_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_instance_snapshot::de_get_instance_snapshot_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_instance_snapshot::GetInstanceSnapshotError {
...
mod _get_instance_snapshot_output;
