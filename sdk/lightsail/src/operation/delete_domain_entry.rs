...
impl DeleteDomainEntryInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDomainEntry`](crate::operation::delete_domain_entry::DeleteDomainEntry)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_domain_entry::DeleteDomainEntry, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_domain_entry::DeleteDomainEntryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_domain_entry::ser_delete_domain_entry_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_domain_entry::DeleteDomainEntry::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDomainEntry", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteDomainEntry`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDomainEntry {
                type Output = ::std::result::Result<crate::operation::delete_domain_entry::DeleteDomainEntryOutput, crate::operation::delete_domain_entry::DeleteDomainEntryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_domain_entry::de_delete_domain_entry_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_domain_entry::de_delete_domain_entry_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_domain_entry::DeleteDomainEntryError {
...
mod _delete_domain_entry_output;
