...
impl CreateRelationalDatabaseSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`CreateRelationalDatabaseSnapshot`](crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_relational_database_snapshot::ser_create_relational_database_snapshot_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshot::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateRelationalDatabaseSnapshot", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateRelationalDatabaseSnapshot`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRelationalDatabaseSnapshot {
                type Output = ::std::result::Result<crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshotOutput, crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshotError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_relational_database_snapshot::de_create_relational_database_snapshot_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_relational_database_snapshot::de_create_relational_database_snapshot_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateRelationalDatabaseSnapshotError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_relational_database_snapshot::CreateRelationalDatabaseSnapshotError {
...
pub use crate::operation::create_relational_database_snapshot::_create_relational_database_snapshot_output::CreateRelationalDatabaseSnapshotOutput;

pub use crate::operation::create_relational_database_snapshot::_create_relational_database_snapshot_input::CreateRelationalDatabaseSnapshotInput;

mod _create_relational_database_snapshot_input;

mod _create_relational_database_snapshot_output;
