...
impl CreateDiskFromSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`CreateDiskFromSnapshot`](crate::operation::create_disk_from_snapshot::CreateDiskFromSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_disk_from_snapshot::CreateDiskFromSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_disk_from_snapshot::CreateDiskFromSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_disk_from_snapshot::ser_create_disk_from_snapshot_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_disk_from_snapshot::CreateDiskFromSnapshot::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDiskFromSnapshot", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateDiskFromSnapshot`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDiskFromSnapshot {
                type Output = ::std::result::Result<crate::operation::create_disk_from_snapshot::CreateDiskFromSnapshotOutput, crate::operation::create_disk_from_snapshot::CreateDiskFromSnapshotError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_disk_from_snapshot::de_create_disk_from_snapshot_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_disk_from_snapshot::de_create_disk_from_snapshot_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_disk_from_snapshot::CreateDiskFromSnapshotError {
...
mod _create_disk_from_snapshot_output;
