...
impl DeleteInstanceSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`DeleteInstanceSnapshot`](crate::operation::delete_instance_snapshot::DeleteInstanceSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_instance_snapshot::DeleteInstanceSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_instance_snapshot::DeleteInstanceSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_instance_snapshot::DeleteInstanceSnapshotInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_instance_snapshot::ser_delete_instance_snapshot_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_instance_snapshot::DeleteInstanceSnapshot::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteInstanceSnapshot", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteInstanceSnapshot {
                type Output = ::std::result::Result<crate::operation::delete_instance_snapshot::DeleteInstanceSnapshotOutput, crate::operation::delete_instance_snapshot::DeleteInstanceSnapshotError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_instance_snapshot::de_delete_instance_snapshot_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_instance_snapshot::de_delete_instance_snapshot_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_instance_snapshot::DeleteInstanceSnapshotError {
...
mod _delete_instance_snapshot_output;
