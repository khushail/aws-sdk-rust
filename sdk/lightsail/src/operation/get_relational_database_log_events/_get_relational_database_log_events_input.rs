...
impl GetRelationalDatabaseLogEventsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_relational_database_log_events::GetRelationalDatabaseLogEventsInput, ::aws_smithy_http::operation::error::BuildError> {
