...
impl GetStaticIpInput {
    /// Consumes the builder and constructs an Operation<[`GetStaticIp`](crate::operation::get_static_ip::GetStaticIp)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_static_ip::GetStaticIp, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_static_ip::GetStaticIpInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_static_ip::ser_get_static_ip_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_static_ip::GetStaticIp::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetStaticIp", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetStaticIp`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStaticIp {
                type Output = ::std::result::Result<crate::operation::get_static_ip::GetStaticIpOutput, crate::operation::get_static_ip::GetStaticIpError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_static_ip::de_get_static_ip_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_static_ip::de_get_static_ip_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_static_ip::GetStaticIpError {
...
pub use crate::operation::get_static_ip::_get_static_ip_output::GetStaticIpOutput;

pub use crate::operation::get_static_ip::_get_static_ip_input::GetStaticIpInput;

mod _get_static_ip_input;

mod _get_static_ip_output;
