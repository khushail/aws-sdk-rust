...
impl GetRelationalDatabaseBlueprintsInput {
    /// Consumes the builder and constructs an Operation<[`GetRelationalDatabaseBlueprints`](crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprints, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprintsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_relational_database_blueprints::ser_get_relational_database_blueprints_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprints::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetRelationalDatabaseBlueprints", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetRelationalDatabaseBlueprints`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseBlueprints {
                type Output = ::std::result::Result<crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprintsOutput, crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprintsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_relational_database_blueprints::de_get_relational_database_blueprints_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_relational_database_blueprints::de_get_relational_database_blueprints_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetRelationalDatabaseBlueprintsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_relational_database_blueprints::GetRelationalDatabaseBlueprintsError {
...
mod _get_relational_database_blueprints_output;
