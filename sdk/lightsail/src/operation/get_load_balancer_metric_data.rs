...
impl GetLoadBalancerMetricDataInput {
    /// Consumes the builder and constructs an Operation<[`GetLoadBalancerMetricData`](crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricData, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_load_balancer_metric_data::ser_get_load_balancer_metric_data_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricData::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetLoadBalancerMetricData", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLoadBalancerMetricData {
                type Output = ::std::result::Result<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataOutput, crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_load_balancer_metric_data::de_get_load_balancer_metric_data_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_load_balancer_metric_data::de_get_load_balancer_metric_data_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataError {
...
mod _get_load_balancer_metric_data_output;
