...
impl GetLoadBalancersInput {
    /// Consumes the builder and constructs an Operation<[`GetLoadBalancers`](crate::operation::get_load_balancers::GetLoadBalancers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_load_balancers::GetLoadBalancers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_load_balancers::GetLoadBalancersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_load_balancers::ser_get_load_balancers_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_load_balancers::GetLoadBalancers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetLoadBalancers", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetLoadBalancers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLoadBalancers {
                type Output = ::std::result::Result<crate::operation::get_load_balancers::GetLoadBalancersOutput, crate::operation::get_load_balancers::GetLoadBalancersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_load_balancers::de_get_load_balancers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_load_balancers::de_get_load_balancers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_load_balancers::GetLoadBalancersError {
...
mod _get_load_balancers_output;
