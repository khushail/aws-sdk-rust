...
impl DeleteAlarmInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAlarm`](crate::operation::delete_alarm::DeleteAlarm)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_alarm::DeleteAlarm, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_alarm::DeleteAlarmInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_alarm::ser_delete_alarm_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_alarm::DeleteAlarm::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAlarm", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteAlarm`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAlarm {
                type Output = ::std::result::Result<crate::operation::delete_alarm::DeleteAlarmOutput, crate::operation::delete_alarm::DeleteAlarmError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_alarm::de_delete_alarm_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_alarm::de_delete_alarm_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_alarm::DeleteAlarmError {
