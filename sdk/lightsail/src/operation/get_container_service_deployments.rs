...
impl GetContainerServiceDeploymentsInput {
    /// Consumes the builder and constructs an Operation<[`GetContainerServiceDeployments`](crate::operation::get_container_service_deployments::GetContainerServiceDeployments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_container_service_deployments::GetContainerServiceDeployments, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_service_deployments::ser_get_container_service_deployments_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_service_deployments::GetContainerServiceDeployments::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetContainerServiceDeployments", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetContainerServiceDeployments`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContainerServiceDeployments {
                type Output = ::std::result::Result<crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsOutput, crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsError>;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetContainerServiceDeploymentsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_container_service_deployments::GetContainerServiceDeploymentsError {
...
pub use crate::operation::get_container_service_deployments::_get_container_service_deployments_output::GetContainerServiceDeploymentsOutput;

pub use crate::operation::get_container_service_deployments::_get_container_service_deployments_input::GetContainerServiceDeploymentsInput;

mod _get_container_service_deployments_input;

mod _get_container_service_deployments_output;
