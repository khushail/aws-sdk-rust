...
impl DeleteRelationalDatabaseInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_relational_database::DeleteRelationalDatabaseInput, ::aws_smithy_http::operation::error::BuildError> {
