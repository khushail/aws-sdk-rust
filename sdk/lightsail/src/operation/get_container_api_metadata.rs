...
impl GetContainerApiMetadataInput {
    /// Consumes the builder and constructs an Operation<[`GetContainerAPIMetadata`](crate::operation::get_container_api_metadata::GetContainerAPIMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_container_api_metadata::GetContainerAPIMetadata, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_container_api_metadata::GetContainerApiMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_container_api_metadata::GetContainerApiMetadataInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_api_metadata::ser_get_container_api_metadata_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_api_metadata::GetContainerAPIMetadata::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetContainerAPIMetadata", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContainerAPIMetadata {
                type Output = ::std::result::Result<crate::operation::get_container_api_metadata::GetContainerApiMetadataOutput, crate::operation::get_container_api_metadata::GetContainerAPIMetadataError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_container_api_metadata::de_get_container_api_metadata_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_container_api_metadata::de_get_container_api_metadata_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_container_api_metadata::GetContainerAPIMetadataError {
...
mod _get_container_api_metadata_output;
