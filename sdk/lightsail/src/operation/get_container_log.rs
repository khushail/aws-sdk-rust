...
impl GetContainerLogInput {
    /// Consumes the builder and constructs an Operation<[`GetContainerLog`](crate::operation::get_container_log::GetContainerLog)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_container_log::GetContainerLog, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_container_log::GetContainerLogInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_container_log::GetContainerLogInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_log::ser_get_container_log_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_log::GetContainerLog::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetContainerLog", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContainerLog {
                type Output = ::std::result::Result<crate::operation::get_container_log::GetContainerLogOutput, crate::operation::get_container_log::GetContainerLogError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_container_log::de_get_container_log_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_container_log::GetContainerLogError {
