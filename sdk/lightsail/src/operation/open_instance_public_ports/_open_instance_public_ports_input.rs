...
impl OpenInstancePublicPortsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::open_instance_public_ports::OpenInstancePublicPortsInput, ::aws_smithy_http::operation::error::BuildError> {
