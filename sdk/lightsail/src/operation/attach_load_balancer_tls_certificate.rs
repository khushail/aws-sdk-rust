...
impl AttachLoadBalancerTlsCertificateInput {
    /// Consumes the builder and constructs an Operation<[`AttachLoadBalancerTlsCertificate`](crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_attach_load_balancer_tls_certificate::ser_attach_load_balancer_tls_certificate_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AttachLoadBalancerTlsCertificate", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachLoadBalancerTlsCertificate {
                type Output = ::std::result::Result<crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateOutput, crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateError>;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AttachLoadBalancerTlsCertificateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_load_balancer_tls_certificate::AttachLoadBalancerTlsCertificateError {
...
mod _attach_load_balancer_tls_certificate_output;
