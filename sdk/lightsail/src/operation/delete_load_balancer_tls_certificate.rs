...
impl DeleteLoadBalancerTlsCertificateInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLoadBalancerTlsCertificate`](crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_load_balancer_tls_certificate::ser_delete_load_balancer_tls_certificate_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteLoadBalancerTlsCertificate", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteLoadBalancerTlsCertificate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLoadBalancerTlsCertificate {
                type Output = ::std::result::Result<crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateOutput, crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_load_balancer_tls_certificate::de_delete_load_balancer_tls_certificate_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_load_balancer_tls_certificate::de_delete_load_balancer_tls_certificate_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteLoadBalancerTlsCertificateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_load_balancer_tls_certificate::DeleteLoadBalancerTlsCertificateError {
...
mod _delete_load_balancer_tls_certificate_output;
