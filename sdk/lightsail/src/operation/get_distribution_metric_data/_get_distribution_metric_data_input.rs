...
impl GetDistributionMetricDataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_distribution_metric_data::GetDistributionMetricDataInput, ::aws_smithy_http::operation::error::BuildError> {
