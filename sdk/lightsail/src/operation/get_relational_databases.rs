...
impl GetRelationalDatabasesInput {
    /// Consumes the builder and constructs an Operation<[`GetRelationalDatabases`](crate::operation::get_relational_databases::GetRelationalDatabases)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_relational_databases::GetRelationalDatabases, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_relational_databases::GetRelationalDatabasesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_relational_databases::ser_get_relational_databases_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_relational_databases::GetRelationalDatabases::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetRelationalDatabases", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabases {
                type Output = ::std::result::Result<crate::operation::get_relational_databases::GetRelationalDatabasesOutput, crate::operation::get_relational_databases::GetRelationalDatabasesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_relational_databases::de_get_relational_databases_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_relational_databases::de_get_relational_databases_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_relational_databases::GetRelationalDatabasesError {
...
pub use crate::operation::get_relational_databases::_get_relational_databases_output::GetRelationalDatabasesOutput;

pub use crate::operation::get_relational_databases::_get_relational_databases_input::GetRelationalDatabasesInput;

mod _get_relational_databases_input;

mod _get_relational_databases_output;
