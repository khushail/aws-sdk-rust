...
impl UpdateInstanceMetadataOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_instance_metadata_options::UpdateInstanceMetadataOptionsInput, ::aws_smithy_http::operation::error::BuildError> {
