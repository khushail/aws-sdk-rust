...
impl GetDistributionLatestCacheResetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_distribution_latest_cache_reset::GetDistributionLatestCacheResetInput, ::aws_smithy_http::operation::error::BuildError> {
