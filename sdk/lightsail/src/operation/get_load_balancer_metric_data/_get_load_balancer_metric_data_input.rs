...
impl GetLoadBalancerMetricDataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_load_balancer_metric_data::GetLoadBalancerMetricDataInput, ::aws_smithy_http::operation::error::BuildError> {
