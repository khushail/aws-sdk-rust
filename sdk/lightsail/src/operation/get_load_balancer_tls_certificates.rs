...
impl GetLoadBalancerTlsCertificatesInput {
    /// Consumes the builder and constructs an Operation<[`GetLoadBalancerTlsCertificates`](crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificates, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_load_balancer_tls_certificates::ser_get_load_balancer_tls_certificates_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificates::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetLoadBalancerTlsCertificates", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetLoadBalancerTlsCertificates`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLoadBalancerTlsCertificates {
                type Output = ::std::result::Result<crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesOutput, crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesError>;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetLoadBalancerTlsCertificatesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_load_balancer_tls_certificates::GetLoadBalancerTlsCertificatesError {
...
mod _get_load_balancer_tls_certificates_output;
