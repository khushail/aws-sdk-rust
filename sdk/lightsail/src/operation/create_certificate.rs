...
impl CreateCertificateInput {
    /// Consumes the builder and constructs an Operation<[`CreateCertificate`](crate::operation::create_certificate::CreateCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_certificate::CreateCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_certificate::CreateCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_certificate::ser_create_certificate_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_certificate::CreateCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateCertificate", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateCertificate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCertificate {
                type Output = ::std::result::Result<crate::operation::create_certificate::CreateCertificateOutput, crate::operation::create_certificate::CreateCertificateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_certificate::de_create_certificate_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_certificate::de_create_certificate_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_certificate::CreateCertificateError {
...
pub use crate::operation::create_certificate::_create_certificate_output::CreateCertificateOutput;

pub use crate::operation::create_certificate::_create_certificate_input::CreateCertificateInput;

mod _create_certificate_input;

mod _create_certificate_output;
