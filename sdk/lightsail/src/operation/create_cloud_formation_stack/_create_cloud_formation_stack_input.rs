...
impl CreateCloudFormationStackInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_cloud_formation_stack::CreateCloudFormationStackInput, ::aws_smithy_http::operation::error::BuildError> {
