...
impl SetResourceAccessForBucketInput {
    /// Consumes the builder and constructs an Operation<[`SetResourceAccessForBucket`](crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucket)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucket, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_resource_access_for_bucket::ser_set_resource_access_for_bucket_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucket::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SetResourceAccessForBucket", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetResourceAccessForBucket {
                type Output = ::std::result::Result<crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketOutput, crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_set_resource_access_for_bucket::de_set_resource_access_for_bucket_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_set_resource_access_for_bucket::de_set_resource_access_for_bucket_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_resource_access_for_bucket::SetResourceAccessForBucketError {
...
mod _set_resource_access_for_bucket_output;
