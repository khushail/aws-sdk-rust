...
impl GetRelationalDatabaseBundlesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesInput, ::aws_smithy_http::operation::error::BuildError> {
