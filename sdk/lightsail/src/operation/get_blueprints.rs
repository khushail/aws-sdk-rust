...
impl GetBlueprintsInput {
    /// Consumes the builder and constructs an Operation<[`GetBlueprints`](crate::operation::get_blueprints::GetBlueprints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_blueprints::GetBlueprints, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_blueprints::GetBlueprintsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_blueprints::ser_get_blueprints_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_blueprints::GetBlueprints::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetBlueprints", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBlueprints {
                type Output = ::std::result::Result<crate::operation::get_blueprints::GetBlueprintsOutput, crate::operation::get_blueprints::GetBlueprintsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_blueprints::de_get_blueprints_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_blueprints::de_get_blueprints_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_blueprints::GetBlueprintsError {
...
pub use crate::operation::get_blueprints::_get_blueprints_output::GetBlueprintsOutput;

pub use crate::operation::get_blueprints::_get_blueprints_input::GetBlueprintsInput;

mod _get_blueprints_input;

mod _get_blueprints_output;
