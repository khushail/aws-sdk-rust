...
impl UnpeerVpcInput {
    /// Consumes the builder and constructs an Operation<[`UnpeerVpc`](crate::operation::unpeer_vpc::UnpeerVpc)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::unpeer_vpc::UnpeerVpc, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::unpeer_vpc::UnpeerVpcInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::unpeer_vpc::UnpeerVpcInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_unpeer_vpc::ser_unpeer_vpc_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::unpeer_vpc::UnpeerVpc::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UnpeerVpc", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnpeerVpc {
                type Output = ::std::result::Result<crate::operation::unpeer_vpc::UnpeerVpcOutput, crate::operation::unpeer_vpc::UnpeerVpcError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_unpeer_vpc::de_unpeer_vpc_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_unpeer_vpc::de_unpeer_vpc_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::unpeer_vpc::UnpeerVpcError {
