...
impl GetDiskSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`GetDiskSnapshot`](crate::operation::get_disk_snapshot::GetDiskSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_disk_snapshot::GetDiskSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_disk_snapshot::GetDiskSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_disk_snapshot::GetDiskSnapshotInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_disk_snapshot::ser_get_disk_snapshot_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_disk_snapshot::GetDiskSnapshot::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDiskSnapshot", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetDiskSnapshot`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDiskSnapshot {
                type Output = ::std::result::Result<crate::operation::get_disk_snapshot::GetDiskSnapshotOutput, crate::operation::get_disk_snapshot::GetDiskSnapshotError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_disk_snapshot::de_get_disk_snapshot_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_disk_snapshot::de_get_disk_snapshot_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_disk_snapshot::GetDiskSnapshotError {
...
pub use crate::operation::get_disk_snapshot::_get_disk_snapshot_output::GetDiskSnapshotOutput;

pub use crate::operation::get_disk_snapshot::_get_disk_snapshot_input::GetDiskSnapshotInput;

mod _get_disk_snapshot_input;

mod _get_disk_snapshot_output;
