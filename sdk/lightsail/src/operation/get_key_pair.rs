...
impl GetKeyPairInput {
    /// Consumes the builder and constructs an Operation<[`GetKeyPair`](crate::operation::get_key_pair::GetKeyPair)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_key_pair::GetKeyPair, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_key_pair::GetKeyPairInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_key_pair::ser_get_key_pair_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_key_pair::GetKeyPair::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetKeyPair", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetKeyPair`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetKeyPair {
                type Output = ::std::result::Result<crate::operation::get_key_pair::GetKeyPairOutput, crate::operation::get_key_pair::GetKeyPairError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_key_pair::de_get_key_pair_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_key_pair::de_get_key_pair_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_key_pair::GetKeyPairError {
...
pub use crate::operation::get_key_pair::_get_key_pair_output::GetKeyPairOutput;

pub use crate::operation::get_key_pair::_get_key_pair_input::GetKeyPairInput;

mod _get_key_pair_input;

mod _get_key_pair_output;
