...
impl GetContainerServiceMetricDataInput {
    /// Consumes the builder and constructs an Operation<[`GetContainerServiceMetricData`](crate::operation::get_container_service_metric_data::GetContainerServiceMetricData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_container_service_metric_data::GetContainerServiceMetricData, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.metric_name;
                let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("metric_name", "cannot be empty or unset"))?;
                ...
                let inner_5 = inner_5.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("statistics", "cannot be empty or unset"))?;
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_service_metric_data::ser_get_container_service_metric_data_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_service_metric_data::GetContainerServiceMetricData::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetContainerServiceMetricData", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContainerServiceMetricData {
                type Output = ::std::result::Result<crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataOutput, crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError>;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetContainerServiceMetricDataError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_container_service_metric_data::GetContainerServiceMetricDataError {
...
mod _get_container_service_metric_data_output;
