...
impl CreateGuiSessionAccessDetailsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_gui_session_access_details::CreateGuiSessionAccessDetailsInput, ::aws_smithy_http::operation::error::BuildError> {
