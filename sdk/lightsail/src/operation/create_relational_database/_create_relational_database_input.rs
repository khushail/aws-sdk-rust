...
impl CreateRelationalDatabaseInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_relational_database::CreateRelationalDatabaseInput, ::aws_smithy_http::operation::error::BuildError> {
