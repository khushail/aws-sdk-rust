...
impl UpdateLoadBalancerAttributeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateLoadBalancerAttribute`](crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttribute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_load_balancer_attribute::ser_update_load_balancer_attribute_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttribute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateLoadBalancerAttribute", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateLoadBalancerAttribute`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLoadBalancerAttribute {
                type Output = ::std::result::Result<crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttributeOutput, crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttributeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_load_balancer_attribute::de_update_load_balancer_attribute_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_load_balancer_attribute::de_update_load_balancer_attribute_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_load_balancer_attribute::UpdateLoadBalancerAttributeError {
...
pub use crate::operation::update_load_balancer_attribute::_update_load_balancer_attribute_output::UpdateLoadBalancerAttributeOutput;

pub use crate::operation::update_load_balancer_attribute::_update_load_balancer_attribute_input::UpdateLoadBalancerAttributeInput;

mod _update_load_balancer_attribute_input;

mod _update_load_balancer_attribute_output;
