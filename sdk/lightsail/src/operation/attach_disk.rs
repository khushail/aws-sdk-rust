...
impl AttachDiskInput {
    /// Consumes the builder and constructs an Operation<[`AttachDisk`](crate::operation::attach_disk::AttachDisk)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::attach_disk::AttachDisk, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_disk::AttachDiskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_attach_disk::ser_attach_disk_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_disk::AttachDisk::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AttachDisk", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AttachDisk`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachDisk {
                type Output = ::std::result::Result<crate::operation::attach_disk::AttachDiskOutput, crate::operation::attach_disk::AttachDiskError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_attach_disk::de_attach_disk_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_attach_disk::de_attach_disk_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_disk::AttachDiskError {
