...
impl GetRelationalDatabaseParametersInput {
    /// Consumes the builder and constructs an Operation<[`GetRelationalDatabaseParameters`](crate::operation::get_relational_database_parameters::GetRelationalDatabaseParameters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_relational_database_parameters::GetRelationalDatabaseParameters, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_relational_database_parameters::GetRelationalDatabaseParametersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_relational_database_parameters::GetRelationalDatabaseParametersInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_relational_database_parameters::ser_get_relational_database_parameters_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_relational_database_parameters::GetRelationalDatabaseParameters::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetRelationalDatabaseParameters", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseParameters {
                type Output = ::std::result::Result<crate::operation::get_relational_database_parameters::GetRelationalDatabaseParametersOutput, crate::operation::get_relational_database_parameters::GetRelationalDatabaseParametersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_relational_database_parameters::de_get_relational_database_parameters_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_relational_database_parameters::de_get_relational_database_parameters_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetRelationalDatabaseParametersError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_relational_database_parameters::GetRelationalDatabaseParametersError {
...
mod _get_relational_database_parameters_output;
