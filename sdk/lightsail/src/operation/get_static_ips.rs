...
impl GetStaticIpsInput {
    /// Consumes the builder and constructs an Operation<[`GetStaticIps`](crate::operation::get_static_ips::GetStaticIps)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_static_ips::GetStaticIps, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_static_ips::GetStaticIpsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_static_ips::ser_get_static_ips_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_static_ips::GetStaticIps::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetStaticIps", "lightsail"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStaticIps {
                type Output = ::std::result::Result<crate::operation::get_static_ips::GetStaticIpsOutput, crate::operation::get_static_ips::GetStaticIpsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_static_ips::de_get_static_ips_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_static_ips::de_get_static_ips_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_static_ips::GetStaticIpsError {
