...
impl GetDiskInput {
    /// Consumes the builder and constructs an Operation<[`GetDisk`](crate::operation::get_disk::GetDisk)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_disk::GetDisk, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_disk::GetDiskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_disk::ser_get_disk_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_disk::GetDisk::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDisk", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetDisk`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDisk {
                type Output = ::std::result::Result<crate::operation::get_disk::GetDiskOutput, crate::operation::get_disk::GetDiskError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_disk::de_get_disk_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_disk::de_get_disk_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_disk::GetDiskError {
