...
impl GetRelationalDatabaseBundlesInput {
    /// Consumes the builder and constructs an Operation<[`GetRelationalDatabaseBundles`](crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundles, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_relational_database_bundles::ser_get_relational_database_bundles_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundles::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetRelationalDatabaseBundles", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetRelationalDatabaseBundles`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRelationalDatabaseBundles {
                type Output = ::std::result::Result<crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesOutput, crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_relational_database_bundles::de_get_relational_database_bundles_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_relational_database_bundles::de_get_relational_database_bundles_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_relational_database_bundles::GetRelationalDatabaseBundlesError {
...
mod _get_relational_database_bundles_output;
