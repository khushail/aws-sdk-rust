...
impl CreateInstancesInput {
    /// Consumes the builder and constructs an Operation<[`CreateInstances`](crate::operation::create_instances::CreateInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_instances::CreateInstances, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_instances::CreateInstancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_instances::ser_create_instances_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_instances::CreateInstances::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateInstances", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateInstances`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInstances {
                type Output = ::std::result::Result<crate::operation::create_instances::CreateInstancesOutput, crate::operation::create_instances::CreateInstancesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_instances::de_create_instances_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_instances::de_create_instances_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_instances::CreateInstancesError {
