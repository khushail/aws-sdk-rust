...
impl CreateLoadBalancerTlsCertificateInput {
    /// Consumes the builder and constructs an Operation<[`CreateLoadBalancerTlsCertificate`](crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_load_balancer_tls_certificate::ser_create_load_balancer_tls_certificate_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateLoadBalancerTlsCertificate", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateLoadBalancerTlsCertificate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLoadBalancerTlsCertificate {
                type Output = ::std::result::Result<crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateOutput, crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_load_balancer_tls_certificate::de_create_load_balancer_tls_certificate_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_load_balancer_tls_certificate::de_create_load_balancer_tls_certificate_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateLoadBalancerTlsCertificateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_load_balancer_tls_certificate::CreateLoadBalancerTlsCertificateError {
...
pub use crate::operation::create_load_balancer_tls_certificate::_create_load_balancer_tls_certificate_output::CreateLoadBalancerTlsCertificateOutput;

pub use crate::operation::create_load_balancer_tls_certificate::_create_load_balancer_tls_certificate_input::CreateLoadBalancerTlsCertificateInput;

mod _create_load_balancer_tls_certificate_input;

mod _create_load_balancer_tls_certificate_output;
