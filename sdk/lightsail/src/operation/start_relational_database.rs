...
impl StartRelationalDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`StartRelationalDatabase`](crate::operation::start_relational_database::StartRelationalDatabase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_relational_database::StartRelationalDatabase, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_relational_database::StartRelationalDatabaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_relational_database::ser_start_relational_database_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_relational_database::StartRelationalDatabase::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartRelationalDatabase", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartRelationalDatabase`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartRelationalDatabase {
                type Output = ::std::result::Result<crate::operation::start_relational_database::StartRelationalDatabaseOutput, crate::operation::start_relational_database::StartRelationalDatabaseError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_relational_database::de_start_relational_database_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_relational_database::de_start_relational_database_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_relational_database::StartRelationalDatabaseError {
...
mod _start_relational_database_output;
