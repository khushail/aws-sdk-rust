...
impl IsVpcPeeredInput {
    /// Consumes the builder and constructs an Operation<[`IsVpcPeered`](crate::operation::is_vpc_peered::IsVpcPeered)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::is_vpc_peered::IsVpcPeered, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::is_vpc_peered::IsVpcPeeredInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::is_vpc_peered::IsVpcPeeredInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_is_vpc_peered::ser_is_vpc_peered_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::is_vpc_peered::IsVpcPeered::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("IsVpcPeered", "lightsail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `IsVpcPeered`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for IsVpcPeered {
                type Output = ::std::result::Result<crate::operation::is_vpc_peered::IsVpcPeeredOutput, crate::operation::is_vpc_peered::IsVpcPeeredError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_is_vpc_peered::de_is_vpc_peered_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_is_vpc_peered::de_is_vpc_peered_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::is_vpc_peered::IsVpcPeeredError {
