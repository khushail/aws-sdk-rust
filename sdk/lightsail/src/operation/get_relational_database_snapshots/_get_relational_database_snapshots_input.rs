...
impl GetRelationalDatabaseSnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_relational_database_snapshots::GetRelationalDatabaseSnapshotsInput, ::aws_smithy_http::operation::error::BuildError> {
