...
impl super::Client  {
    ...
    ///   - [`resource_name(impl ::std::convert::Into<String>)`](crate::operation::enable_add_on::builders::EnableAddOnFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::enable_add_on::builders::EnableAddOnFluentBuilder::set_resource_name): <p>The name of the source resource for which to enable or modify the add-on.</p>
