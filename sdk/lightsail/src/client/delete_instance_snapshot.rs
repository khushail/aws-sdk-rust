...
impl super::Client  {
    ...
    ///   - [`instance_snapshot_name(impl ::std::convert::Into<String>)`](crate::operation::delete_instance_snapshot::builders::DeleteInstanceSnapshotFluentBuilder::instance_snapshot_name) / [`set_instance_snapshot_name(Option<String>)`](crate::operation::delete_instance_snapshot::builders::DeleteInstanceSnapshotFluentBuilder::set_instance_snapshot_name): <p>The name of the snapshot to delete.</p>
