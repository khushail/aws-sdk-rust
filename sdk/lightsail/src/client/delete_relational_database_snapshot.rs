...
impl super::Client  {
    ...
    ///   - [`relational_database_snapshot_name(impl ::std::convert::Into<String>)`](crate::operation::delete_relational_database_snapshot::builders::DeleteRelationalDatabaseSnapshotFluentBuilder::relational_database_snapshot_name) / [`set_relational_database_snapshot_name(Option<String>)`](crate::operation::delete_relational_database_snapshot::builders::DeleteRelationalDatabaseSnapshotFluentBuilder::set_relational_database_snapshot_name): <p>The name of the database snapshot that you are deleting.</p>
