...
impl super::Client  {
    ...
    ///   - [`instance_name(impl ::std::convert::Into<String>)`](crate::operation::get_instance::builders::GetInstanceFluentBuilder::instance_name) / [`set_instance_name(Option<String>)`](crate::operation::get_instance::builders::GetInstanceFluentBuilder::set_instance_name): <p>The name of the instance.</p>
