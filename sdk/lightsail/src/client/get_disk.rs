...
impl super::Client  {
    ...
    ///   - [`disk_name(impl ::std::convert::Into<String>)`](crate::operation::get_disk::builders::GetDiskFluentBuilder::disk_name) / [`set_disk_name(Option<String>)`](crate::operation::get_disk::builders::GetDiskFluentBuilder::set_disk_name): <p>The name of the disk (e.g., <code>my-disk</code>).</p>
