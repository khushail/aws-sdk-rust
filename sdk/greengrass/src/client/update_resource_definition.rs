...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_resource_definition::builders::UpdateResourceDefinitionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_resource_definition::builders::UpdateResourceDefinitionFluentBuilder::set_name): The name of the definition.
