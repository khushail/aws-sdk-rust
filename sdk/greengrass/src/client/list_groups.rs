...
impl super::Client  {
    ...
    ///   - [`max_results(impl ::std::convert::Into<String>)`](crate::operation::list_groups::builders::ListGroupsFluentBuilder::max_results) / [`set_max_results(Option<String>)`](crate::operation::list_groups::builders::ListGroupsFluentBuilder::set_max_results): The maximum number of results to be returned per request.
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_groups::builders::ListGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_groups::builders::ListGroupsFluentBuilder::set_next_token): The token for the next set of results, or ''null'' if there are no additional results.
