...
impl super::Client  {
    ...
    ///   - [`group_id(impl ::std::convert::Into<String>)`](crate::operation::reset_deployments::builders::ResetDeploymentsFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::reset_deployments::builders::ResetDeploymentsFluentBuilder::set_group_id): The ID of the Greengrass group.
