...
impl super::Client  {
    ...
    ///   - [`thing_name(impl ::std::convert::Into<String>)`](crate::operation::get_thing_runtime_configuration::builders::GetThingRuntimeConfigurationFluentBuilder::thing_name) / [`set_thing_name(Option<String>)`](crate::operation::get_thing_runtime_configuration::builders::GetThingRuntimeConfigurationFluentBuilder::set_thing_name): The thing name.
