...
impl DeleteLoggerDefinitionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLoggerDefinition`](crate::operation::delete_logger_definition::DeleteLoggerDefinition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_logger_definition::DeleteLoggerDefinition, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_logger_definition::DeleteLoggerDefinitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_logger_definition::DeleteLoggerDefinitionInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_logger_definition::DeleteLoggerDefinition::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLoggerDefinition {
                type Output = ::std::result::Result<crate::operation::delete_logger_definition::DeleteLoggerDefinitionOutput, crate::operation::delete_logger_definition::DeleteLoggerDefinitionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_logger_definition::de_delete_logger_definition_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_logger_definition::de_delete_logger_definition_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_logger_definition::DeleteLoggerDefinitionError {
...
mod _delete_logger_definition_output;
