...
impl ListCoreDefinitionsInput {
    /// Consumes the builder and constructs an Operation<[`ListCoreDefinitions`](crate::operation::list_core_definitions::ListCoreDefinitions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_core_definitions::ListCoreDefinitions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_core_definitions::ListCoreDefinitionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/greengrass/definition/cores").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_core_definitions::ListCoreDefinitionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_core_definitions::ListCoreDefinitionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_core_definitions::ListCoreDefinitions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCoreDefinitions {
                type Output = ::std::result::Result<crate::operation::list_core_definitions::ListCoreDefinitionsOutput, crate::operation::list_core_definitions::ListCoreDefinitionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_core_definitions::de_list_core_definitions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_core_definitions::de_list_core_definitions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_core_definitions::ListCoreDefinitionsError {
...
mod _list_core_definitions_output;
