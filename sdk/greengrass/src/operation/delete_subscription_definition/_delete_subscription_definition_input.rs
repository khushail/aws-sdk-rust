...
impl DeleteSubscriptionDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_subscription_definition::DeleteSubscriptionDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
