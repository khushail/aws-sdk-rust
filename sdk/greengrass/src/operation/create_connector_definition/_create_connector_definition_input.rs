...
impl CreateConnectorDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_connector_definition::CreateConnectorDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
