...
impl ListDeviceDefinitionVersionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_device_definition_versions::ListDeviceDefinitionVersionsInput, ::aws_smithy_http::operation::error::BuildError> {
