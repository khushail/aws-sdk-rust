...
impl AssociateRoleToGroupInput {
    /// Consumes the builder and constructs an Operation<[`AssociateRoleToGroup`](crate::operation::associate_role_to_group::AssociateRoleToGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_role_to_group::AssociateRoleToGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_role_to_group::AssociateRoleToGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_role_to_group::AssociateRoleToGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateRoleToGroup", "greengrass"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateRoleToGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateRoleToGroup {
                type Output = ::std::result::Result<crate::operation::associate_role_to_group::AssociateRoleToGroupOutput, crate::operation::associate_role_to_group::AssociateRoleToGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_role_to_group::de_associate_role_to_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_role_to_group::de_associate_role_to_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_role_to_group::AssociateRoleToGroupError {
...
mod _associate_role_to_group_output;
