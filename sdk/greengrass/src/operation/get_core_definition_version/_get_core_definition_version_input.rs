...
impl GetCoreDefinitionVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_core_definition_version::GetCoreDefinitionVersionInput, ::aws_smithy_http::operation::error::BuildError> {
