...
impl ListGroupCertificateAuthoritiesInput {
    /// Consumes the builder and constructs an Operation<[`ListGroupCertificateAuthorities`](crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthorities)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthorities, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthoritiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthoritiesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthorities::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListGroupCertificateAuthorities", "greengrass"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListGroupCertificateAuthorities`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGroupCertificateAuthorities {
                type Output = ::std::result::Result<crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthoritiesOutput, crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthoritiesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_group_certificate_authorities::de_list_group_certificate_authorities_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_group_certificate_authorities::de_list_group_certificate_authorities_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_group_certificate_authorities::ListGroupCertificateAuthoritiesError {
...
mod _list_group_certificate_authorities_output;
