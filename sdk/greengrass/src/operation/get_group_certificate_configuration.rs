...
impl GetGroupCertificateConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetGroupCertificateConfiguration`](crate::operation::get_group_certificate_configuration::GetGroupCertificateConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_group_certificate_configuration::GetGroupCertificateConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_group_certificate_configuration::GetGroupCertificateConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if group_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("group_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/greengrass/groups/{GroupId}/certificateauthorities/configuration/expiry", GroupId = group_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_group_certificate_configuration::GetGroupCertificateConfigurationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_group_certificate_configuration::GetGroupCertificateConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetGroupCertificateConfiguration", "greengrass"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetGroupCertificateConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupCertificateConfiguration {
                type Output = ::std::result::Result<crate::operation::get_group_certificate_configuration::GetGroupCertificateConfigurationOutput, crate::operation::get_group_certificate_configuration::GetGroupCertificateConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_group_certificate_configuration::de_get_group_certificate_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_group_certificate_configuration::de_get_group_certificate_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_group_certificate_configuration::GetGroupCertificateConfigurationError {
...
mod _get_group_certificate_configuration_output;
