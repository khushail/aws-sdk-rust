...
impl UpdateThingRuntimeConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_thing_runtime_configuration::UpdateThingRuntimeConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
