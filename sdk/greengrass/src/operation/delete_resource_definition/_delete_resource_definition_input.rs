...
impl DeleteResourceDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_resource_definition::DeleteResourceDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
