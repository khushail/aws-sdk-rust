...
impl CreateSubscriptionDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_subscription_definition::CreateSubscriptionDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
