...
impl ListResourceDefinitionsInput {
    /// Consumes the builder and constructs an Operation<[`ListResourceDefinitions`](crate::operation::list_resource_definitions::ListResourceDefinitions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_resource_definitions::ListResourceDefinitions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resource_definitions::ListResourceDefinitionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/greengrass/definition/resources").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_resource_definitions::ListResourceDefinitionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_resource_definitions::ListResourceDefinitionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_definitions::ListResourceDefinitions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourceDefinitions {
                type Output = ::std::result::Result<crate::operation::list_resource_definitions::ListResourceDefinitionsOutput, crate::operation::list_resource_definitions::ListResourceDefinitionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_resource_definitions::de_list_resource_definitions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_resource_definitions::de_list_resource_definitions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_resource_definitions::ListResourceDefinitionsError {
...
mod _list_resource_definitions_output;
