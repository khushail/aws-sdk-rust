...
impl CreateCoreDefinitionVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_core_definition_version::CreateCoreDefinitionVersionInput, ::aws_smithy_http::operation::error::BuildError> {
