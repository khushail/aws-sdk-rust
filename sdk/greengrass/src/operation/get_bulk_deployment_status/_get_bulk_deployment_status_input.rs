...
impl GetBulkDeploymentStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_bulk_deployment_status::GetBulkDeploymentStatusInput, ::aws_smithy_http::operation::error::BuildError> {
