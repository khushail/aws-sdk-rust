...
impl GetAssociatedRoleInput {
    /// Consumes the builder and constructs an Operation<[`GetAssociatedRole`](crate::operation::get_associated_role::GetAssociatedRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_associated_role::GetAssociatedRole, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_associated_role::GetAssociatedRoleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_associated_role::GetAssociatedRoleInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_associated_role::GetAssociatedRole::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAssociatedRole", "greengrass"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetAssociatedRole`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAssociatedRole {
                type Output = ::std::result::Result<crate::operation::get_associated_role::GetAssociatedRoleOutput, crate::operation::get_associated_role::GetAssociatedRoleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_associated_role::de_get_associated_role_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_associated_role::de_get_associated_role_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_associated_role::GetAssociatedRoleError {
...
mod _get_associated_role_output;
