...
impl UpdateRescoreExecutionPlanInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_rescore_execution_plan::UpdateRescoreExecutionPlanInput, ::aws_smithy_http::operation::error::BuildError> {
