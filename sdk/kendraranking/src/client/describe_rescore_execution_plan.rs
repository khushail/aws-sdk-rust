...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::describe_rescore_execution_plan::builders::DescribeRescoreExecutionPlanFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_rescore_execution_plan::builders::DescribeRescoreExecutionPlanFluentBuilder::set_id): <p>The identifier of the rescore execution plan that you want to get information on.</p>
