...
impl super::Client  {
    ...
    ///   - [`cell_name(impl ::std::convert::Into<String>)`](crate::operation::get_cell_readiness_summary::builders::GetCellReadinessSummaryFluentBuilder::cell_name) / [`set_cell_name(Option<String>)`](crate::operation::get_cell_readiness_summary::builders::GetCellReadinessSummaryFluentBuilder::set_cell_name): <p>The name of the cell.</p>
