...
impl GetReadinessCheckStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_readiness_check_status::GetReadinessCheckStatusInput, ::aws_smithy_http::operation::error::BuildError> {
