...
impl GetReadinessCheckResourceStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_readiness_check_resource_status::GetReadinessCheckResourceStatusInput, ::aws_smithy_http::operation::error::BuildError> {
