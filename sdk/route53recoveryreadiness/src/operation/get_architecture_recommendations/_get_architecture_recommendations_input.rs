...
impl GetArchitectureRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_architecture_recommendations::GetArchitectureRecommendationsInput, ::aws_smithy_http::operation::error::BuildError> {
