...
impl ListCrossAccountAuthorizationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_cross_account_authorizations::ListCrossAccountAuthorizationsInput, ::aws_smithy_http::operation::error::BuildError> {
