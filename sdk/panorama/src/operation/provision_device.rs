...
impl ProvisionDeviceInput {
    /// Consumes the builder and constructs an Operation<[`ProvisionDevice`](crate::operation::provision_device::ProvisionDevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::provision_device::ProvisionDevice, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::provision_device::ProvisionDeviceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::provision_device::ProvisionDevice::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ProvisionDevice {
                type Output = ::std::result::Result<crate::operation::provision_device::ProvisionDeviceOutput, crate::operation::provision_device::ProvisionDeviceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_provision_device::de_provision_device_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_provision_device::de_provision_device_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::provision_device::ProvisionDeviceError {
