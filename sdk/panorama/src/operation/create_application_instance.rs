...
impl CreateApplicationInstanceInput {
    /// Consumes the builder and constructs an Operation<[`CreateApplicationInstance`](crate::operation::create_application_instance::CreateApplicationInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_application_instance::CreateApplicationInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_application_instance::CreateApplicationInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_application_instance::CreateApplicationInstance::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateApplicationInstance", "panorama"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateApplicationInstance`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateApplicationInstance {
                type Output = ::std::result::Result<crate::operation::create_application_instance::CreateApplicationInstanceOutput, crate::operation::create_application_instance::CreateApplicationInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_application_instance::de_create_application_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_application_instance::de_create_application_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_application_instance::CreateApplicationInstanceError {
...
pub use crate::operation::create_application_instance::_create_application_instance_output::CreateApplicationInstanceOutput;

pub use crate::operation::create_application_instance::_create_application_instance_input::CreateApplicationInstanceInput;

mod _create_application_instance_input;

mod _create_application_instance_output;
