...
impl ListApplicationInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_application_instances::ListApplicationInstancesInput, ::aws_smithy_http::operation::error::BuildError> {
