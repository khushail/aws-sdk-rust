...
impl ListPackageImportJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListPackageImportJobs`](crate::operation::list_package_import_jobs::ListPackageImportJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_package_import_jobs::ListPackageImportJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_package_import_jobs::ListPackageImportJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/packages/import-jobs").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_package_import_jobs::ListPackageImportJobsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_package_import_jobs::ListPackageImportJobsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_package_import_jobs::ListPackageImportJobs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPackageImportJobs", "panorama"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListPackageImportJobs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPackageImportJobs {
                type Output = ::std::result::Result<crate::operation::list_package_import_jobs::ListPackageImportJobsOutput, crate::operation::list_package_import_jobs::ListPackageImportJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_package_import_jobs::de_list_package_import_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_package_import_jobs::de_list_package_import_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_package_import_jobs::ListPackageImportJobsError {
...
pub use crate::operation::list_package_import_jobs::_list_package_import_jobs_output::ListPackageImportJobsOutput;

pub use crate::operation::list_package_import_jobs::_list_package_import_jobs_input::ListPackageImportJobsInput;

mod _list_package_import_jobs_input;

mod _list_package_import_jobs_output;
