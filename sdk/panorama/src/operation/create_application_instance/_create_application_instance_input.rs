...
impl CreateApplicationInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_application_instance::CreateApplicationInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
