...
impl DescribeApplicationInstanceInput {
    /// Consumes the builder and constructs an Operation<[`DescribeApplicationInstance`](crate::operation::describe_application_instance::DescribeApplicationInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_application_instance::DescribeApplicationInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_application_instance::DescribeApplicationInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if application_instance_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("application_instance_id", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_application_instance::DescribeApplicationInstanceInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_application_instance::DescribeApplicationInstance::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeApplicationInstance {
                type Output = ::std::result::Result<crate::operation::describe_application_instance::DescribeApplicationInstanceOutput, crate::operation::describe_application_instance::DescribeApplicationInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_application_instance::de_describe_application_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_application_instance::de_describe_application_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_application_instance::DescribeApplicationInstanceError {
...
pub use crate::operation::describe_application_instance::_describe_application_instance_output::DescribeApplicationInstanceOutput;

pub use crate::operation::describe_application_instance::_describe_application_instance_input::DescribeApplicationInstanceInput;

mod _describe_application_instance_input;

mod _describe_application_instance_output;
