...
pub use crate::operation::describe_node_from_template_job::_describe_node_from_template_job_output::DescribeNodeFromTemplateJobOutputBuilder;

pub use crate::operation::describe_node_from_template_job::_describe_node_from_template_job_input::DescribeNodeFromTemplateJobInputBuilder;
...
impl DescribeNodeFromTemplateJobInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.describe_node_from_template_job();
...
impl DescribeNodeFromTemplateJobFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobError>>
                             {
