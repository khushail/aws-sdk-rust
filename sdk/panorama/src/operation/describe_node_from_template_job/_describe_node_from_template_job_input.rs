...
impl DescribeNodeFromTemplateJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_node_from_template_job::DescribeNodeFromTemplateJobInput, ::aws_smithy_http::operation::error::BuildError> {
