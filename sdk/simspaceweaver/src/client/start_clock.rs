...
impl super::Client  {
    ...
    ///   - [`simulation(impl ::std::convert::Into<String>)`](crate::operation::start_clock::builders::StartClockFluentBuilder::simulation) / [`set_simulation(Option<String>)`](crate::operation::start_clock::builders::StartClockFluentBuilder::set_simulation): <p>The name of the simulation.</p>
