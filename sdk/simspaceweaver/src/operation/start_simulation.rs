...
impl StartSimulationInput {
    /// Consumes the builder and constructs an Operation<[`StartSimulation`](crate::operation::start_simulation::StartSimulation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_simulation::StartSimulation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_simulation::StartSimulationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/startsimulation").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_simulation::StartSimulation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartSimulation", "simspaceweaver"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartSimulation`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSimulation {
                type Output = ::std::result::Result<crate::operation::start_simulation::StartSimulationOutput, crate::operation::start_simulation::StartSimulationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_simulation::de_start_simulation_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_simulation::de_start_simulation_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_simulation::StartSimulationError {
