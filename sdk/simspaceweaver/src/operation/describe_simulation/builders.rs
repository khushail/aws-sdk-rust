...
impl DescribeSimulationFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::describe_simulation::DescribeSimulation, ::aws_http::retry::AwsResponseRetryClassifier,>,
                            ::aws_smithy_http::result::SdkError<crate::operation::describe_simulation::DescribeSimulationError>
                        >  {
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::describe_simulation::DescribeSimulationOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_simulation::DescribeSimulationError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::describe_simulation::DescribeSimulationOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_simulation::DescribeSimulationError>>
                             {
