...
impl super::Client  {
    ...
    ///   - [`subnet_ids(Vec<String>)`](crate::operation::update_subnet_group::builders::UpdateSubnetGroupFluentBuilder::subnet_ids) / [`set_subnet_ids(Option<Vec<String>>)`](crate::operation::update_subnet_group::builders::UpdateSubnetGroupFluentBuilder::set_subnet_ids): <p>A list of subnet IDs in the subnet group.</p>
