...
impl super::Client  {
    ...
    ///   - [`resource_name(impl ::std::convert::Into<String>)`](crate::operation::list_tags::builders::ListTagsFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::list_tags::builders::ListTagsFluentBuilder::set_resource_name): <p>The name of the DAX resource to which the tags belong.</p>
