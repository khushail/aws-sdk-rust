...
pub fn ser_increase_replication_factor_input(input: &crate::operation::increase_replication_factor::IncreaseReplicationFactorInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_increase_replication_factor_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::increase_replication_factor::IncreaseReplicationFactorOutput, crate::operation::increase_replication_factor::IncreaseReplicationFactorError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::increase_replication_factor::IncreaseReplicationFactorError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "ClusterNotFoundFault" => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::ClusterNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InsufficientClusterCapacityFault" => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::InsufficientClusterCapacityFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidClusterStateFault" => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::InvalidClusterStateFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterCombinationException" => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::InvalidParameterCombinationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterValueException" => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidVPCNetworkStateFault" => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::InvalidVpcNetworkStateFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "NodeQuotaForClusterExceededFault" => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::NodeQuotaForClusterExceededFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "NodeQuotaForCustomerExceededFault" => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::NodeQuotaForCustomerExceededFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceLinkedRoleNotFoundFault" => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::ServiceLinkedRoleNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::increase_replication_factor::IncreaseReplicationFactorError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_increase_replication_factor_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::increase_replication_factor::IncreaseReplicationFactorOutput, crate::operation::increase_replication_factor::IncreaseReplicationFactorError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_increase_replication_factor(value: &[u8], mut builder: crate::operation::increase_replication_factor::builders::IncreaseReplicationFactorOutputBuilder) -> Result<crate::operation::increase_replication_factor::builders::IncreaseReplicationFactorOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
