...
pub fn de_create_cluster_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_cluster::CreateClusterOutput, crate::operation::create_cluster::CreateClusterError> {
    ...
    Err(match error_code {
        "ClusterAlreadyExistsFault" => crate::operation::create_cluster::CreateClusterError::ClusterAlreadyExistsFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ClusterQuotaForCustomerExceededFault" => crate::operation::create_cluster::CreateClusterError::ClusterQuotaForCustomerExceededFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InsufficientClusterCapacityFault" => crate::operation::create_cluster::CreateClusterError::InsufficientClusterCapacityFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidClusterStateFault" => crate::operation::create_cluster::CreateClusterError::InvalidClusterStateFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidClusterStateFaultBuilder::default();
                    output = crate::protocol_serde::shape_invalid_cluster_state_fault::de_invalid_cluster_state_fault_json_err(_response_body, output).map_err(crate::operation::create_cluster::CreateClusterError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "InvalidParameterGroupStateFault" => crate::operation::create_cluster::CreateClusterError::InvalidParameterGroupStateFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
                    let mut output = crate::types::error::builders::InvalidParameterGroupStateFaultBuilder::default();
                    output = crate::protocol_serde::shape_invalid_parameter_group_state_fault::de_invalid_parameter_group_state_fault_json_err(_response_body, output).map_err(crate::operation::create_cluster::CreateClusterError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
        ...
        "InvalidParameterValueException" => crate::operation::create_cluster::CreateClusterError::InvalidParameterValueException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "NodeQuotaForClusterExceededFault" => crate::operation::create_cluster::CreateClusterError::NodeQuotaForClusterExceededFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "NodeQuotaForCustomerExceededFault" => crate::operation::create_cluster::CreateClusterError::NodeQuotaForCustomerExceededFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ParameterGroupNotFoundFault" => crate::operation::create_cluster::CreateClusterError::ParameterGroupNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceLinkedRoleNotFoundFault" => crate::operation::create_cluster::CreateClusterError::ServiceLinkedRoleNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "SubnetGroupNotFoundFault" => crate::operation::create_cluster::CreateClusterError::SubnetGroupNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "TagQuotaPerResourceExceeded" => crate::operation::create_cluster::CreateClusterError::TagQuotaPerResourceExceeded({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
