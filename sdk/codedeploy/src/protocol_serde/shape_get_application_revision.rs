...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_application_revision_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_application_revision::GetApplicationRevisionOutput, crate::operation::get_application_revision::GetApplicationRevisionError> {
    Ok({
        #[allow(unused_mut)]
