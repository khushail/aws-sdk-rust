...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_application_revisions_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_application_revisions::ListApplicationRevisionsOutput, crate::operation::list_application_revisions::ListApplicationRevisionsError> {
    Ok({
        #[allow(unused_mut)]
