...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_git_hub_account_token_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_git_hub_account_token::DeleteGitHubAccountTokenOutput, crate::operation::delete_git_hub_account_token::DeleteGitHubAccountTokenError> {
    Ok({
        #[allow(unused_mut)]
