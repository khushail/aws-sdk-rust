...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_deployment_group_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_deployment_group::DeleteDeploymentGroupOutput, crate::operation::delete_deployment_group::DeleteDeploymentGroupError> {
    Ok({
        #[allow(unused_mut)]
