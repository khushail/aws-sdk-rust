...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_get_deployment_instances_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::batch_get_deployment_instances::BatchGetDeploymentInstancesOutput, crate::operation::batch_get_deployment_instances::BatchGetDeploymentInstancesError> {
    Ok({
        #[allow(unused_mut)]
