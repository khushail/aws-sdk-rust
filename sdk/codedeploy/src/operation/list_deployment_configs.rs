...
impl ListDeploymentConfigsInput {
    /// Consumes the builder and constructs an Operation<[`ListDeploymentConfigs`](crate::operation::list_deployment_configs::ListDeploymentConfigs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_deployment_configs::ListDeploymentConfigs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_deployment_configs::ListDeploymentConfigsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_deployment_configs::ListDeploymentConfigs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDeploymentConfigs", "codedeploy"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListDeploymentConfigs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDeploymentConfigs {
                type Output = ::std::result::Result<crate::operation::list_deployment_configs::ListDeploymentConfigsOutput, crate::operation::list_deployment_configs::ListDeploymentConfigsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_deployment_configs::de_list_deployment_configs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_deployment_configs::de_list_deployment_configs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_deployment_configs::ListDeploymentConfigsError {
...
mod _list_deployment_configs_output;
