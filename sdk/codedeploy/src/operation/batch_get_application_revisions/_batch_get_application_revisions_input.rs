...
impl BatchGetApplicationRevisionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_get_application_revisions::BatchGetApplicationRevisionsInput, ::aws_smithy_http::operation::error::BuildError> {
