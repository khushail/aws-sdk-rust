...
impl RegisterOnPremisesInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::register_on_premises_instance::RegisterOnPremisesInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
