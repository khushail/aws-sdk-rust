...
impl ListOnPremisesInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_on_premises_instances::ListOnPremisesInstancesInput, ::aws_smithy_http::operation::error::BuildError> {
