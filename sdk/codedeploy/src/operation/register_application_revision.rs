...
impl RegisterApplicationRevisionInput {
    /// Consumes the builder and constructs an Operation<[`RegisterApplicationRevision`](crate::operation::register_application_revision::RegisterApplicationRevision)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_application_revision::RegisterApplicationRevision, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_application_revision::RegisterApplicationRevisionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_application_revision::RegisterApplicationRevision::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RegisterApplicationRevision", "codedeploy"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RegisterApplicationRevision`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterApplicationRevision {
                type Output = ::std::result::Result<crate::operation::register_application_revision::RegisterApplicationRevisionOutput, crate::operation::register_application_revision::RegisterApplicationRevisionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_register_application_revision::de_register_application_revision_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_register_application_revision::de_register_application_revision_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::register_application_revision::RegisterApplicationRevisionError {
...
mod _register_application_revision_output;
