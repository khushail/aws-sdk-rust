...
impl DeleteResourcesByExternalIdInput {
    /// Consumes the builder and constructs an Operation<[`DeleteResourcesByExternalId`](crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalId)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalId, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalId::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteResourcesByExternalId", "codedeploy"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteResourcesByExternalId`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResourcesByExternalId {
                type Output = ::std::result::Result<crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdOutput, crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_resources_by_external_id::DeleteResourcesByExternalIdError {
...
mod _delete_resources_by_external_id_output;
