...
impl BatchGetDeploymentsInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetDeployments`](crate::operation::batch_get_deployments::BatchGetDeployments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_get_deployments::BatchGetDeployments, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_deployments::BatchGetDeploymentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_deployments::BatchGetDeployments::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchGetDeployments", "codedeploy"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchGetDeployments`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetDeployments {
                type Output = ::std::result::Result<crate::operation::batch_get_deployments::BatchGetDeploymentsOutput, crate::operation::batch_get_deployments::BatchGetDeploymentsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_get_deployments::de_batch_get_deployments_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_deployments::BatchGetDeploymentsError {
...
pub use crate::operation::batch_get_deployments::_batch_get_deployments_output::BatchGetDeploymentsOutput;

pub use crate::operation::batch_get_deployments::_batch_get_deployments_input::BatchGetDeploymentsInput;

mod _batch_get_deployments_input;

mod _batch_get_deployments_output;
