...
impl BatchGetApplicationsInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetApplications`](crate::operation::batch_get_applications::BatchGetApplications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_get_applications::BatchGetApplications, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_applications::BatchGetApplicationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_applications::BatchGetApplications::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchGetApplications", "codedeploy"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchGetApplications`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetApplications {
                type Output = ::std::result::Result<crate::operation::batch_get_applications::BatchGetApplicationsOutput, crate::operation::batch_get_applications::BatchGetApplicationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_get_applications::de_batch_get_applications_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_get_applications::de_batch_get_applications_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_applications::BatchGetApplicationsError {
...
pub use crate::operation::batch_get_applications::_batch_get_applications_output::BatchGetApplicationsOutput;

pub use crate::operation::batch_get_applications::_batch_get_applications_input::BatchGetApplicationsInput;

mod _batch_get_applications_input;

mod _batch_get_applications_output;
