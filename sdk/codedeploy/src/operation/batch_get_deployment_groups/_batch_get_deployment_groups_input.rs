...
impl BatchGetDeploymentGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_get_deployment_groups::BatchGetDeploymentGroupsInput, ::aws_smithy_http::operation::error::BuildError> {
