...
impl DeregisterOnPremisesInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_on_premises_instance::DeregisterOnPremisesInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
