...
impl DeregisterOnPremisesInstanceInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterOnPremisesInstance`](crate::operation::deregister_on_premises_instance::DeregisterOnPremisesInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deregister_on_premises_instance::DeregisterOnPremisesInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_on_premises_instance::DeregisterOnPremisesInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_on_premises_instance::DeregisterOnPremisesInstance::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeregisterOnPremisesInstance", "codedeploy"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeregisterOnPremisesInstance`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterOnPremisesInstance {
                type Output = ::std::result::Result<crate::operation::deregister_on_premises_instance::DeregisterOnPremisesInstanceOutput, crate::operation::deregister_on_premises_instance::DeregisterOnPremisesInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deregister_on_premises_instance::de_deregister_on_premises_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deregister_on_premises_instance::de_deregister_on_premises_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_on_premises_instance::DeregisterOnPremisesInstanceError {
...
mod _deregister_on_premises_instance_output;
