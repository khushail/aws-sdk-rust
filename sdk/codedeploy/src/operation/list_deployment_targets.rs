...
impl ListDeploymentTargetsInput {
    /// Consumes the builder and constructs an Operation<[`ListDeploymentTargets`](crate::operation::list_deployment_targets::ListDeploymentTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_deployment_targets::ListDeploymentTargets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_deployment_targets::ListDeploymentTargetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_deployment_targets::ListDeploymentTargets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDeploymentTargets {
                type Output = ::std::result::Result<crate::operation::list_deployment_targets::ListDeploymentTargetsOutput, crate::operation::list_deployment_targets::ListDeploymentTargetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_deployment_targets::de_list_deployment_targets_http_response_with_props(status, headers, body)
                     }
                }
