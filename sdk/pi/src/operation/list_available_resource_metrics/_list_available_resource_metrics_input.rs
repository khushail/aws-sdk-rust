...
impl ListAvailableResourceMetricsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_available_resource_metrics::ListAvailableResourceMetricsInput, ::aws_smithy_http::operation::error::BuildError> {
