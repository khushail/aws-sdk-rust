...
impl GetResourceMetricsInput {
    /// Consumes the builder and constructs an Operation<[`GetResourceMetrics`](crate::operation::get_resource_metrics::GetResourceMetrics)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_resource_metrics::GetResourceMetrics, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_resource_metrics::GetResourceMetricsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource_metrics::GetResourceMetrics::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetResourceMetrics", "pi"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetResourceMetrics`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceMetrics {
                type Output = ::std::result::Result<crate::operation::get_resource_metrics::GetResourceMetricsOutput, crate::operation::get_resource_metrics::GetResourceMetricsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_resource_metrics::de_get_resource_metrics_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_resource_metrics::de_get_resource_metrics_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_resource_metrics::GetResourceMetricsError {
...
mod _get_resource_metrics_output;
