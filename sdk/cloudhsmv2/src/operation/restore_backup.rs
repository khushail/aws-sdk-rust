...
impl RestoreBackupInput {
    /// Consumes the builder and constructs an Operation<[`RestoreBackup`](crate::operation::restore_backup::RestoreBackup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::restore_backup::RestoreBackup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_backup::RestoreBackupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::restore_backup::RestoreBackupInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::restore_backup::RestoreBackup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreBackup {
                type Output = ::std::result::Result<crate::operation::restore_backup::RestoreBackupOutput, crate::operation::restore_backup::RestoreBackupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_restore_backup::de_restore_backup_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_restore_backup::de_restore_backup_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::restore_backup::RestoreBackupError {
