...
impl InitializeClusterInput {
    /// Consumes the builder and constructs an Operation<[`InitializeCluster`](crate::operation::initialize_cluster::InitializeCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::initialize_cluster::InitializeCluster, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::initialize_cluster::InitializeClusterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::initialize_cluster::InitializeCluster::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for InitializeCluster {
                type Output = ::std::result::Result<crate::operation::initialize_cluster::InitializeClusterOutput, crate::operation::initialize_cluster::InitializeClusterError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_initialize_cluster::de_initialize_cluster_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_initialize_cluster::de_initialize_cluster_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::initialize_cluster::InitializeClusterError {
...
mod _initialize_cluster_output;
