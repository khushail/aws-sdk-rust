...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_continuous_export_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::start_continuous_export::StartContinuousExportOutput, crate::operation::start_continuous_export::StartContinuousExportError> {
    Ok({
        #[allow(unused_mut)]
