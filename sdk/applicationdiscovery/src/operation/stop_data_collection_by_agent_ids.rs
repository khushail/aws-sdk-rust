...
impl StopDataCollectionByAgentIdsInput {
    /// Consumes the builder and constructs an Operation<[`StopDataCollectionByAgentIds`](crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIds)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIds, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIdsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIds::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDataCollectionByAgentIds {
                type Output = ::std::result::Result<crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIdsOutput, crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIdsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_data_collection_by_agent_ids::de_stop_data_collection_by_agent_ids_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_data_collection_by_agent_ids::de_stop_data_collection_by_agent_ids_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_data_collection_by_agent_ids::StopDataCollectionByAgentIdsError {
...
mod _stop_data_collection_by_agent_ids_output;
