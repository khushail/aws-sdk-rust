...
impl StartDataCollectionByAgentIdsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_data_collection_by_agent_ids::StartDataCollectionByAgentIdsInput, ::aws_smithy_http::operation::error::BuildError> {
