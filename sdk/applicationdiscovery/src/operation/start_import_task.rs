...
impl StartImportTaskInput {
    /// Consumes the builder and constructs an Operation<[`StartImportTask`](crate::operation::start_import_task::StartImportTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_import_task::StartImportTask, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_import_task::StartImportTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_import_task::StartImportTask::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartImportTask {
                type Output = ::std::result::Result<crate::operation::start_import_task::StartImportTaskOutput, crate::operation::start_import_task::StartImportTaskError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_start_import_task::de_start_import_task_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_import_task::StartImportTaskError {
