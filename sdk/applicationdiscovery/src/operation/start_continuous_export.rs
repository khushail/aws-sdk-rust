...
impl StartContinuousExportInput {
    /// Consumes the builder and constructs an Operation<[`StartContinuousExport`](crate::operation::start_continuous_export::StartContinuousExport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_continuous_export::StartContinuousExport, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_continuous_export::StartContinuousExportInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_continuous_export::StartContinuousExport::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartContinuousExport {
                type Output = ::std::result::Result<crate::operation::start_continuous_export::StartContinuousExportOutput, crate::operation::start_continuous_export::StartContinuousExportError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_start_continuous_export::de_start_continuous_export_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_continuous_export::StartContinuousExportError {
