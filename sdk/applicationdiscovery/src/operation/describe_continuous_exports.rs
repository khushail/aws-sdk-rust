...
impl DescribeContinuousExportsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeContinuousExports`](crate::operation::describe_continuous_exports::DescribeContinuousExports)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_continuous_exports::DescribeContinuousExports, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_continuous_exports::DescribeContinuousExportsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_continuous_exports::DescribeContinuousExports::new())
...
/// Orchestration and serialization glue logic for `DescribeContinuousExports`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeContinuousExports {
                type Output = ::std::result::Result<crate::operation::describe_continuous_exports::DescribeContinuousExportsOutput, crate::operation::describe_continuous_exports::DescribeContinuousExportsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_continuous_exports::de_describe_continuous_exports_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_continuous_exports::de_describe_continuous_exports_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_continuous_exports::DescribeContinuousExportsError {
...
mod _describe_continuous_exports_output;
