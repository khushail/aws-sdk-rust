...
impl DescribeExportConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeExportConfigurations`](crate::operation::describe_export_configurations::DescribeExportConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_export_configurations::DescribeExportConfigurations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_export_configurations::DescribeExportConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_export_configurations::DescribeExportConfigurations::new())
...
/// Orchestration and serialization glue logic for `DescribeExportConfigurations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeExportConfigurations {
                type Output = ::std::result::Result<crate::operation::describe_export_configurations::DescribeExportConfigurationsOutput, crate::operation::describe_export_configurations::DescribeExportConfigurationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_export_configurations::de_describe_export_configurations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_export_configurations::de_describe_export_configurations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_export_configurations::DescribeExportConfigurationsError {
...
pub use crate::operation::describe_export_configurations::_describe_export_configurations_output::DescribeExportConfigurationsOutput;

pub use crate::operation::describe_export_configurations::_describe_export_configurations_input::DescribeExportConfigurationsInput;

mod _describe_export_configurations_input;

mod _describe_export_configurations_output;
