...
impl super::Client  {
    ...
    ///   - [`log_group_name(impl ::std::convert::Into<String>)`](crate::operation::get_log_group_fields::builders::GetLogGroupFieldsFluentBuilder::log_group_name) / [`set_log_group_name(Option<String>)`](crate::operation::get_log_group_fields::builders::GetLogGroupFieldsFluentBuilder::set_log_group_name): <p>The name of the log group to search.</p> <note>   <p> You must include either <code>logGroupIdentifier</code> or <code>logGroupName</code>, but not both. </p>  </note>
    ...
    ///   - [`log_group_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_log_group_fields::builders::GetLogGroupFieldsFluentBuilder::log_group_identifier) / [`set_log_group_identifier(Option<String>)`](crate::operation::get_log_group_fields::builders::GetLogGroupFieldsFluentBuilder::set_log_group_identifier): <p>Specify either the name or ARN of the log group to view. If the log group is in a source account and you are using a monitoring account, you must specify the ARN.</p> <note>   <p> You must include either <code>logGroupIdentifier</code> or <code>logGroupName</code>, but not both. </p>  </note>
