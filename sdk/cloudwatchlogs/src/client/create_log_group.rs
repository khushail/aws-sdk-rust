...
impl super::Client  {
    ...
    ///   - [`log_group_name(impl ::std::convert::Into<String>)`](crate::operation::create_log_group::builders::CreateLogGroupFluentBuilder::log_group_name) / [`set_log_group_name(Option<String>)`](crate::operation::create_log_group::builders::CreateLogGroupFluentBuilder::set_log_group_name): <p>The name of the log group.</p>
    ///   - [`kms_key_id(impl ::std::convert::Into<String>)`](crate::operation::create_log_group::builders::CreateLogGroupFluentBuilder::kms_key_id) / [`set_kms_key_id(Option<String>)`](crate::operation::create_log_group::builders::CreateLogGroupFluentBuilder::set_kms_key_id): <p>The Amazon Resource Name (ARN) of the KMS key to use when encrypting log data. For more information, see <a href="https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kms">Amazon Resource Names</a>.</p>
