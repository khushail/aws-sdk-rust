...
impl GetDataProtectionPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_data_protection_policy::GetDataProtectionPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
