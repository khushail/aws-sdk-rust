...
impl DescribeResourcePoliciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_resource_policies::DescribeResourcePoliciesInput, ::aws_smithy_http::operation::error::BuildError> {
