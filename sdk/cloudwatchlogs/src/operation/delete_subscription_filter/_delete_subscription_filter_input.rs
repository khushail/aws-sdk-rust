...
impl DeleteSubscriptionFilterInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_subscription_filter::DeleteSubscriptionFilterInput, ::aws_smithy_http::operation::error::BuildError> {
