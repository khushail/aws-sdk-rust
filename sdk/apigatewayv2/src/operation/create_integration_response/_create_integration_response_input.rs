...
impl CreateIntegrationResponseInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_integration_response::CreateIntegrationResponseInput, ::aws_smithy_http::operation::error::BuildError> {
