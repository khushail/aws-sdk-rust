...
impl super::Client  {
    ...
    ///   - [`auto_deploy(Option<bool>)`](crate::operation::get_stage::GetStageOutput::auto_deploy): <p>Specifies whether updates to an API automatically trigger a new deployment. The default value is false.</p>
