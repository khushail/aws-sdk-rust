...
impl super::Client  {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::create_route_response::builders::CreateRouteResponseFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::create_route_response::builders::CreateRouteResponseFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`model_selection_expression(impl ::std::convert::Into<String>)`](crate::operation::create_route_response::builders::CreateRouteResponseFluentBuilder::model_selection_expression) / [`set_model_selection_expression(Option<String>)`](crate::operation::create_route_response::builders::CreateRouteResponseFluentBuilder::set_model_selection_expression): <p>The model selection expression for the route response. Supported only for WebSocket APIs.</p>
    ...
    ///   - [`route_id(impl ::std::convert::Into<String>)`](crate::operation::create_route_response::builders::CreateRouteResponseFluentBuilder::route_id) / [`set_route_id(Option<String>)`](crate::operation::create_route_response::builders::CreateRouteResponseFluentBuilder::set_route_id): <p>The route ID.</p>
    ///   - [`route_response_key(impl ::std::convert::Into<String>)`](crate::operation::create_route_response::builders::CreateRouteResponseFluentBuilder::route_response_key) / [`set_route_response_key(Option<String>)`](crate::operation::create_route_response::builders::CreateRouteResponseFluentBuilder::set_route_response_key): <p>The route response key.</p>
