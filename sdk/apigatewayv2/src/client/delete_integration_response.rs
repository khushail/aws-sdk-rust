...
impl super::Client  {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_integration_response::builders::DeleteIntegrationResponseFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_integration_response::builders::DeleteIntegrationResponseFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`integration_id(impl ::std::convert::Into<String>)`](crate::operation::delete_integration_response::builders::DeleteIntegrationResponseFluentBuilder::integration_id) / [`set_integration_id(Option<String>)`](crate::operation::delete_integration_response::builders::DeleteIntegrationResponseFluentBuilder::set_integration_id): <p>The integration ID.</p>
