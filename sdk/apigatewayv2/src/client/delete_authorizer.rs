...
impl super::Client  {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_authorizer::builders::DeleteAuthorizerFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_authorizer::builders::DeleteAuthorizerFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`authorizer_id(impl ::std::convert::Into<String>)`](crate::operation::delete_authorizer::builders::DeleteAuthorizerFluentBuilder::authorizer_id) / [`set_authorizer_id(Option<String>)`](crate::operation::delete_authorizer::builders::DeleteAuthorizerFluentBuilder::set_authorizer_id): <p>The authorizer identifier.</p>
