...
impl super::Client  {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_route_request_parameter::builders::DeleteRouteRequestParameterFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_route_request_parameter::builders::DeleteRouteRequestParameterFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`request_parameter_key(impl ::std::convert::Into<String>)`](crate::operation::delete_route_request_parameter::builders::DeleteRouteRequestParameterFluentBuilder::request_parameter_key) / [`set_request_parameter_key(Option<String>)`](crate::operation::delete_route_request_parameter::builders::DeleteRouteRequestParameterFluentBuilder::set_request_parameter_key): <p>The route request parameter key.</p>
