...
impl super::Client  {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_route_settings::builders::DeleteRouteSettingsFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_route_settings::builders::DeleteRouteSettingsFluentBuilder::set_api_id): <p>The API identifier.</p>
    ///   - [`route_key(impl ::std::convert::Into<String>)`](crate::operation::delete_route_settings::builders::DeleteRouteSettingsFluentBuilder::route_key) / [`set_route_key(Option<String>)`](crate::operation::delete_route_settings::builders::DeleteRouteSettingsFluentBuilder::set_route_key): <p>The route key.</p>
