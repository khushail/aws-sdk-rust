...
impl DeleteProtectionGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteProtectionGroup`](crate::operation::delete_protection_group::DeleteProtectionGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_protection_group::DeleteProtectionGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_protection_group::DeleteProtectionGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_protection_group::DeleteProtectionGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteProtectionGroup {
                type Output = ::std::result::Result<crate::operation::delete_protection_group::DeleteProtectionGroupOutput, crate::operation::delete_protection_group::DeleteProtectionGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_protection_group::de_delete_protection_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_protection_group::de_delete_protection_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_protection_group::DeleteProtectionGroupError {
...
pub use crate::operation::delete_protection_group::_delete_protection_group_output::DeleteProtectionGroupOutput;

pub use crate::operation::delete_protection_group::_delete_protection_group_input::DeleteProtectionGroupInput;

mod _delete_protection_group_input;

mod _delete_protection_group_output;
