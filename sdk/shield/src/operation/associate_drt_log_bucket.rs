...
impl AssociateDrtLogBucketInput {
    /// Consumes the builder and constructs an Operation<[`AssociateDRTLogBucket`](crate::operation::associate_drt_log_bucket::AssociateDRTLogBucket)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_drt_log_bucket::AssociateDRTLogBucket, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_drt_log_bucket::AssociateDrtLogBucketInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_drt_log_bucket::AssociateDRTLogBucket::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateDRTLogBucket", "shield"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateDRTLogBucket`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDRTLogBucket {
                type Output = ::std::result::Result<crate::operation::associate_drt_log_bucket::AssociateDrtLogBucketOutput, crate::operation::associate_drt_log_bucket::AssociateDRTLogBucketError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_drt_log_bucket::de_associate_drt_log_bucket_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_drt_log_bucket::de_associate_drt_log_bucket_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_drt_log_bucket::AssociateDRTLogBucketError {
...
mod _associate_drt_log_bucket_output;
