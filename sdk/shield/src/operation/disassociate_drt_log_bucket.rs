...
impl DisassociateDrtLogBucketInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateDRTLogBucket`](crate::operation::disassociate_drt_log_bucket::DisassociateDRTLogBucket)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_drt_log_bucket::DisassociateDRTLogBucket, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_drt_log_bucket::DisassociateDrtLogBucketInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_drt_log_bucket::DisassociateDRTLogBucket::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateDRTLogBucket", "shield"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisassociateDRTLogBucket`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateDRTLogBucket {
                type Output = ::std::result::Result<crate::operation::disassociate_drt_log_bucket::DisassociateDrtLogBucketOutput, crate::operation::disassociate_drt_log_bucket::DisassociateDRTLogBucketError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_drt_log_bucket::de_disassociate_drt_log_bucket_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_drt_log_bucket::de_disassociate_drt_log_bucket_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_drt_log_bucket::DisassociateDRTLogBucketError {
...
mod _disassociate_drt_log_bucket_output;
