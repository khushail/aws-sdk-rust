...
impl AssociateProactiveEngagementDetailsInput {
    /// Consumes the builder and constructs an Operation<[`AssociateProactiveEngagementDetails`](crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetails)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetails, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetails::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateProactiveEngagementDetails", "shield"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateProactiveEngagementDetails`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateProactiveEngagementDetails {
                type Output = ::std::result::Result<crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsOutput, crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_proactive_engagement_details::de_associate_proactive_engagement_details_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_proactive_engagement_details::de_associate_proactive_engagement_details_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_proactive_engagement_details::AssociateProactiveEngagementDetailsError {
...
mod _associate_proactive_engagement_details_output;
