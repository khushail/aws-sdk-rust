...
impl UpdateEmergencyContactSettingsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateEmergencyContactSettings`](crate::operation::update_emergency_contact_settings::UpdateEmergencyContactSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_emergency_contact_settings::UpdateEmergencyContactSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_emergency_contact_settings::UpdateEmergencyContactSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_emergency_contact_settings::UpdateEmergencyContactSettings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEmergencyContactSettings {
                type Output = ::std::result::Result<crate::operation::update_emergency_contact_settings::UpdateEmergencyContactSettingsOutput, crate::operation::update_emergency_contact_settings::UpdateEmergencyContactSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_emergency_contact_settings::de_update_emergency_contact_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_emergency_contact_settings::de_update_emergency_contact_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_emergency_contact_settings::UpdateEmergencyContactSettingsError {
...
mod _update_emergency_contact_settings_output;
