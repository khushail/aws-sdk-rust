...
impl UpdateProtectionGroupInput {
    /// Consumes the builder and constructs an Operation<[`UpdateProtectionGroup`](crate::operation::update_protection_group::UpdateProtectionGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_protection_group::UpdateProtectionGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_protection_group::UpdateProtectionGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_protection_group::UpdateProtectionGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateProtectionGroup", "shield"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateProtectionGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateProtectionGroup {
                type Output = ::std::result::Result<crate::operation::update_protection_group::UpdateProtectionGroupOutput, crate::operation::update_protection_group::UpdateProtectionGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_protection_group::de_update_protection_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_protection_group::de_update_protection_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_protection_group::UpdateProtectionGroupError {
...
mod _update_protection_group_output;
