...
impl super::Client  {
    ...
    ///   - [`attack_id(impl ::std::convert::Into<String>)`](crate::operation::describe_attack::builders::DescribeAttackFluentBuilder::attack_id) / [`set_attack_id(Option<String>)`](crate::operation::describe_attack::builders::DescribeAttackFluentBuilder::set_attack_id): <p>The unique identifier (ID) for the attack.</p>
