...
impl super::Client  {
    ...
    ///   - [`identifier(impl ::std::convert::Into<String>)`](crate::operation::unlock_rule::builders::UnlockRuleFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::unlock_rule::builders::UnlockRuleFluentBuilder::set_identifier): <p>The unique ID of the retention rule.</p>
