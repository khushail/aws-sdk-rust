...
impl ApplyPendingMaintenanceActionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::apply_pending_maintenance_action::ApplyPendingMaintenanceAction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::apply_pending_maintenance_action::ApplyPendingMaintenanceActionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::apply_pending_maintenance_action::ApplyPendingMaintenanceAction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ApplyPendingMaintenanceAction", "neptune"));
