...
impl ModifyDbClusterSnapshotAttributeInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_db_cluster_snapshot_attribute::ModifyDBClusterSnapshotAttribute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_db_cluster_snapshot_attribute::ModifyDbClusterSnapshotAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_db_cluster_snapshot_attribute::ModifyDBClusterSnapshotAttribute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyDBClusterSnapshotAttribute", "neptune"));
