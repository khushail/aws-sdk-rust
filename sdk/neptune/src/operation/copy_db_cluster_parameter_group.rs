...
impl CopyDbClusterParameterGroupInput {
    /// Consumes the builder and constructs an Operation<[`CopyDBClusterParameterGroup`](crate::operation::copy_db_cluster_parameter_group::CopyDBClusterParameterGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::copy_db_cluster_parameter_group::CopyDBClusterParameterGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::copy_db_cluster_parameter_group::CopyDbClusterParameterGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::copy_db_cluster_parameter_group::CopyDBClusterParameterGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CopyDBClusterParameterGroup", "neptune"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyDBClusterParameterGroup {
                type Output = ::std::result::Result<crate::operation::copy_db_cluster_parameter_group::CopyDbClusterParameterGroupOutput, crate::operation::copy_db_cluster_parameter_group::CopyDBClusterParameterGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_copy_db_cluster_parameter_group::de_copy_db_cluster_parameter_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_copy_db_cluster_parameter_group::de_copy_db_cluster_parameter_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::copy_db_cluster_parameter_group::CopyDBClusterParameterGroupError {
...
mod _copy_db_cluster_parameter_group_output;
