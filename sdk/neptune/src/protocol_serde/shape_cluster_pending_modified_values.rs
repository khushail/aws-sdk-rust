...
pub fn de_cluster_pending_modified_values(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ClusterPendingModifiedValues, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            ,
            s if s.matches("DBClusterIdentifier") /* DBClusterIdentifier com.amazonaws.neptune#ClusterPendingModifiedValues$DBClusterIdentifier */ =>  {
                let var_2 =
                    Some(
            ...
            ,
            s if s.matches("IAMDatabaseAuthenticationEnabled") /* IAMDatabaseAuthenticationEnabled com.amazonaws.neptune#ClusterPendingModifiedValues$IAMDatabaseAuthenticationEnabled */ =>  {
                let var_3 =
                    Some(
                         {
                ...
                ;
                builder = builder.set_iam_database_authentication_enabled(var_3);
            }
            ,
            s if s.matches("EngineVersion") /* EngineVersion com.amazonaws.neptune#ClusterPendingModifiedValues$EngineVersion */ =>  {
                let var_4 =
                    Some(
                        Result::<::std::string::String, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                ...
                ;
                builder = builder.set_engine_version(var_4);
            }
            ,
            s if s.matches("BackupRetentionPeriod") /* BackupRetentionPeriod com.amazonaws.neptune#ClusterPendingModifiedValues$BackupRetentionPeriod */ =>  {
                let var_5 =
                    Some(
                         {
