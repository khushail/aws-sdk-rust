...
pub(crate) fn de_aws_managed_rules_atp_rule_set<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsManagedRulesAtpRuleSet>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "RequestInspection" => {
                                builder = builder.set_request_inspection(
                                    crate::protocol_serde::shape_request_inspection::de_request_inspection(tokens)?
                                );
                            }
                            "ResponseInspection" => {
