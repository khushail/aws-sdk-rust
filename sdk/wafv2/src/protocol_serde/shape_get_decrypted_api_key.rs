...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_decrypted_api_key_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_decrypted_api_key::GetDecryptedApiKeyOutput, crate::operation::get_decrypted_api_key::GetDecryptedAPIKeyError> {
    Ok({
        #[allow(unused_mut)]
