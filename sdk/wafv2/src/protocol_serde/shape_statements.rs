...
pub(crate) fn de_statements<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::Statement>>, ::aws_smithy_json::deserialize::error::DeserializeError>
