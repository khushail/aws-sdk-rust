...
pub fn ser_byte_match_statement(
    ...
    if let Some(var_1) = &input.search_string {
        object.key("SearchString").string_unchecked(&::aws_smithy_types::base64::encode(var_1));
    }
    ...
    if let Some(var_8) = &input.positional_constraint {
        object.key("PositionalConstraint").string(var_8.as_str());
    }
    Ok(())
}

pub(crate) fn de_byte_match_statement<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ByteMatchStatement>, ::aws_smithy_json::deserialize::error::DeserializeError>
