...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::describe_all_managed_products::DescribeAllManagedProductsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
