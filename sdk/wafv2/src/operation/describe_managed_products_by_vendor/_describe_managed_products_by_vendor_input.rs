...
impl DescribeManagedProductsByVendorInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_managed_products_by_vendor::DescribeManagedProductsByVendorInput, ::aws_smithy_http::operation::error::BuildError> {
