...
impl GenerateMobileSdkReleaseUrlInput {
    /// Consumes the builder and constructs an Operation<[`GenerateMobileSdkReleaseUrl`](crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrl)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrl, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrl::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GenerateMobileSdkReleaseUrl", "wafv2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GenerateMobileSdkReleaseUrl`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateMobileSdkReleaseUrl {
                type Output = ::std::result::Result<crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlOutput, crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_generate_mobile_sdk_release_url::de_generate_mobile_sdk_release_url_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_generate_mobile_sdk_release_url::de_generate_mobile_sdk_release_url_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::generate_mobile_sdk_release_url::GenerateMobileSdkReleaseUrlError {
...
mod _generate_mobile_sdk_release_url_output;
