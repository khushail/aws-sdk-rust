...
impl DeleteFirewallManagerRuleGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_firewall_manager_rule_groups::DeleteFirewallManagerRuleGroupsInput, ::aws_smithy_http::operation::error::BuildError> {
