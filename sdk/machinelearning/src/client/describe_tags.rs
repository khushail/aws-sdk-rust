...
impl super::Client  {
    ...
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::describe_tags::builders::DescribeTagsFluentBuilder::set_resource_id): <p>The ID of the ML object. For example, <code>exampleModelId</code>. </p>
