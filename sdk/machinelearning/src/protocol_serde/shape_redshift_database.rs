...
pub(crate) fn de_redshift_database<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RedshiftDatabase>, ::aws_smithy_json::deserialize::error::DeserializeError>
