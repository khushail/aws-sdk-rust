...
impl CreateBatchPredictionInput {
    /// Consumes the builder and constructs an Operation<[`CreateBatchPrediction`](crate::operation::create_batch_prediction::CreateBatchPrediction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_batch_prediction::CreateBatchPrediction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_batch_prediction::CreateBatchPredictionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_batch_prediction::CreateBatchPrediction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateBatchPrediction", "machinelearning"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateBatchPrediction`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBatchPrediction {
                type Output = ::std::result::Result<crate::operation::create_batch_prediction::CreateBatchPredictionOutput, crate::operation::create_batch_prediction::CreateBatchPredictionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_batch_prediction::de_create_batch_prediction_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_batch_prediction::de_create_batch_prediction_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_batch_prediction::CreateBatchPredictionError {
...
mod _create_batch_prediction_output;
