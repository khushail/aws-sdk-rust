...
impl CreateDataSourceFromS3Input {
    /// Consumes the builder and constructs an Operation<[`CreateDataSourceFromS3`](crate::operation::create_data_source_from_s3::CreateDataSourceFromS3)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_data_source_from_s3::CreateDataSourceFromS3, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_data_source_from_s3::CreateDataSourceFromS3Input, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_data_source_from_s3::CreateDataSourceFromS3::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDataSourceFromS3", "machinelearning"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateDataSourceFromS3`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDataSourceFromS3 {
                type Output = ::std::result::Result<crate::operation::create_data_source_from_s3::CreateDataSourceFromS3Output, crate::operation::create_data_source_from_s3::CreateDataSourceFromS3Error>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_data_source_from_s3::de_create_data_source_from_s3_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_data_source_from_s3::de_create_data_source_from_s3_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_data_source_from_s3::CreateDataSourceFromS3Error {
...
mod _create_data_source_from_s3_output;
