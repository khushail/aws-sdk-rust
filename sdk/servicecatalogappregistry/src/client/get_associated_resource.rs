...
impl super::Client  {
    ...
    ///   - [`application(impl ::std::convert::Into<String>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::application) / [`set_application(Option<String>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::set_application): <p> The name, ID, or ARN of the application. </p>
    ...
    ///   - [`resource(impl ::std::convert::Into<String>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::resource) / [`set_resource(Option<String>)`](crate::operation::get_associated_resource::builders::GetAssociatedResourceFluentBuilder::set_resource): <p>The name or ID of the resource associated with the application.</p>
