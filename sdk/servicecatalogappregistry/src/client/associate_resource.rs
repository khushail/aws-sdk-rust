...
impl super::Client  {
    ...
    ///   - [`application(impl ::std::convert::Into<String>)`](crate::operation::associate_resource::builders::AssociateResourceFluentBuilder::application) / [`set_application(Option<String>)`](crate::operation::associate_resource::builders::AssociateResourceFluentBuilder::set_application): <p> The name, ID, or ARN of the application. </p>
