...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_connectcontactlens::Error> {
/// # let client: aws_sdk_connectcontactlens::Client = unimplemented!();
...
mod list_realtime_contact_analysis_segments;
