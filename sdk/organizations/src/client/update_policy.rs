...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::set_name): <p>If provided, the new name for the policy.</p>  <p>The <a href="http://wikipedia.org/wiki/regex">regex pattern</a> that is used to validate this parameter is a string of any of the characters in the ASCII character range.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::set_description): <p>If provided, the new description for the policy.</p>
    ///   - [`content(impl ::std::convert::Into<String>)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::content) / [`set_content(Option<String>)`](crate::operation::update_policy::builders::UpdatePolicyFluentBuilder::set_content): <p>If provided, the new content for the policy. The text must be correctly formatted JSON that complies with the syntax for the policy's type. For more information, see <a href="https://docs.aws.amazon.com/organizations/latest/userguide/orgs_reference_scp-syntax.html">Service Control Policy Syntax</a> in the <i>Organizations User Guide.</i> </p>
