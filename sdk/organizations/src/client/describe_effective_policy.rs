...
impl super::Client  {
    ...
    ///   - [`target_id(impl ::std::convert::Into<String>)`](crate::operation::describe_effective_policy::builders::DescribeEffectivePolicyFluentBuilder::target_id) / [`set_target_id(Option<String>)`](crate::operation::describe_effective_policy::builders::DescribeEffectivePolicyFluentBuilder::set_target_id): <p>When you're signed in as the management account, specify the ID of the account that you want details about. Specifying an organization root or organizational unit (OU) as the target is not supported.</p>
