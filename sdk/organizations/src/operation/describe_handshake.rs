...
impl DescribeHandshakeInput {
    /// Consumes the builder and constructs an Operation<[`DescribeHandshake`](crate::operation::describe_handshake::DescribeHandshake)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_handshake::DescribeHandshake, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_handshake::DescribeHandshakeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_handshake::DescribeHandshake::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeHandshake", "organizations"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeHandshake`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHandshake {
                type Output = ::std::result::Result<crate::operation::describe_handshake::DescribeHandshakeOutput, crate::operation::describe_handshake::DescribeHandshakeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_handshake::de_describe_handshake_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_handshake::de_describe_handshake_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeHandshakeErrorKind = DescribeHandshakeError;
/// Error type for the `DescribeHandshakeError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeHandshakeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_handshake::DescribeHandshakeError {
...
impl DescribeHandshakeError {
    /// Creates the `DescribeHandshakeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeHandshakeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeHandshakeError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DescribeHandshakeError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `DescribeHandshakeError::HandshakeNotFoundException`.
    pub fn is_handshake_not_found_exception(&self) -> bool {
        matches!(self, Self::HandshakeNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeHandshakeError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DescribeHandshakeError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeHandshakeError::TooManyRequestsException`.
...
mod _describe_handshake_output;
