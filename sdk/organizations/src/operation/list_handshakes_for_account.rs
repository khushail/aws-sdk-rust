...
impl ListHandshakesForAccountInput {
    /// Consumes the builder and constructs an Operation<[`ListHandshakesForAccount`](crate::operation::list_handshakes_for_account::ListHandshakesForAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_handshakes_for_account::ListHandshakesForAccount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_handshakes_for_account::ListHandshakesForAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_handshakes_for_account::ListHandshakesForAccount::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHandshakesForAccount {
                type Output = ::std::result::Result<crate::operation::list_handshakes_for_account::ListHandshakesForAccountOutput, crate::operation::list_handshakes_for_account::ListHandshakesForAccountError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_handshakes_for_account::de_list_handshakes_for_account_http_response_with_props(status, headers, body)
                     }
                }
