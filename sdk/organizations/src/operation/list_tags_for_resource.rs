...
impl ListTagsForResourceError {
    ...
    /// Returns `true` if the error kind is `ListTagsForResourceError::AwsOrganizationsNotInUseException`.
    ...
    /// Returns `true` if the error kind is `ListTagsForResourceError::TargetNotFoundException`.
