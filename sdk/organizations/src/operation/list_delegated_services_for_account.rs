...
impl ListDelegatedServicesForAccountInput {
    /// Consumes the builder and constructs an Operation<[`ListDelegatedServicesForAccount`](crate::operation::list_delegated_services_for_account::ListDelegatedServicesForAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_delegated_services_for_account::ListDelegatedServicesForAccount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_delegated_services_for_account::ListDelegatedServicesForAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_delegated_services_for_account::ListDelegatedServicesForAccount::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDelegatedServicesForAccount", "organizations"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListDelegatedServicesForAccount`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDelegatedServicesForAccount {
                type Output = ::std::result::Result<crate::operation::list_delegated_services_for_account::ListDelegatedServicesForAccountOutput, crate::operation::list_delegated_services_for_account::ListDelegatedServicesForAccountError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_delegated_services_for_account::de_list_delegated_services_for_account_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_delegated_services_for_account::de_list_delegated_services_for_account_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListDelegatedServicesForAccountErrorKind = ListDelegatedServicesForAccountError;
/// Error type for the `ListDelegatedServicesForAccountError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListDelegatedServicesForAccountError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_delegated_services_for_account::ListDelegatedServicesForAccountError {
...
impl ListDelegatedServicesForAccountError {
    /// Creates the `ListDelegatedServicesForAccountError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDelegatedServicesForAccountError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListDelegatedServicesForAccountError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedServicesForAccountError::AccountNotFoundException`.
    pub fn is_account_not_found_exception(&self) -> bool {
        matches!(self, Self::AccountNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedServicesForAccountError::AccountNotRegisteredException`.
    pub fn is_account_not_registered_exception(&self) -> bool {
        matches!(self, Self::AccountNotRegisteredException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedServicesForAccountError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedServicesForAccountError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedServicesForAccountError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedServicesForAccountError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedServicesForAccountError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `ListDelegatedServicesForAccountError::UnsupportedApiEndpointException`.
...
mod _list_delegated_services_for_account_output;
