...
impl InviteAccountToOrganizationInput {
    /// Consumes the builder and constructs an Operation<[`InviteAccountToOrganization`](crate::operation::invite_account_to_organization::InviteAccountToOrganization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::invite_account_to_organization::InviteAccountToOrganization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::invite_account_to_organization::InviteAccountToOrganizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::invite_account_to_organization::InviteAccountToOrganization::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("InviteAccountToOrganization", "organizations"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `InviteAccountToOrganization`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for InviteAccountToOrganization {
                type Output = ::std::result::Result<crate::operation::invite_account_to_organization::InviteAccountToOrganizationOutput, crate::operation::invite_account_to_organization::InviteAccountToOrganizationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_invite_account_to_organization::de_invite_account_to_organization_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_invite_account_to_organization::de_invite_account_to_organization_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type InviteAccountToOrganizationErrorKind = InviteAccountToOrganizationError;
/// Error type for the `InviteAccountToOrganizationError` operation.
#[non_exhaustive]
...
impl ::std::fmt::Display for InviteAccountToOrganizationError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            _inner.fmt(f)
            ,
            Self::AccountOwnerNotVerifiedException(_inner) =>
            _inner.fmt(f)
            ,
            ...
            _inner.fmt(f)
            ,
            Self::DuplicateHandshakeException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for InviteAccountToOrganizationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::invite_account_to_organization::InviteAccountToOrganizationError {
...
impl InviteAccountToOrganizationError {
    /// Creates the `InviteAccountToOrganizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `InviteAccountToOrganizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::AccountOwnerNotVerifiedException(e) => e.meta(),
            ...
            Self::DuplicateHandshakeException(e) => e.meta(),
    ...
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::AccountOwnerNotVerifiedException`.
    pub fn is_account_owner_not_verified_exception(&self) -> bool {
        matches!(self, Self::AccountOwnerNotVerifiedException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::DuplicateHandshakeException`.
    pub fn is_duplicate_handshake_exception(&self) -> bool {
        matches!(self, Self::DuplicateHandshakeException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::FinalizingOrganizationException`.
    pub fn is_finalizing_organization_exception(&self) -> bool {
        matches!(self, Self::FinalizingOrganizationException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::HandshakeConstraintViolationException`.
    pub fn is_handshake_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::HandshakeConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `InviteAccountToOrganizationError::TooManyRequestsException`.
...
mod _invite_account_to_organization_output;
