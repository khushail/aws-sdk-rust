...
impl DescribeCreateAccountStatusInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCreateAccountStatus`](crate::operation::describe_create_account_status::DescribeCreateAccountStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_create_account_status::DescribeCreateAccountStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_create_account_status::DescribeCreateAccountStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_create_account_status::DescribeCreateAccountStatus::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeCreateAccountStatus", "organizations"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeCreateAccountStatus`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCreateAccountStatus {
                type Output = ::std::result::Result<crate::operation::describe_create_account_status::DescribeCreateAccountStatusOutput, crate::operation::describe_create_account_status::DescribeCreateAccountStatusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_create_account_status::de_describe_create_account_status_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_create_account_status::de_describe_create_account_status_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeCreateAccountStatusErrorKind = DescribeCreateAccountStatusError;
/// Error type for the `DescribeCreateAccountStatusError` operation.
#[non_exhaustive]
...
impl ::std::fmt::Display for DescribeCreateAccountStatusError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            _inner.fmt(f)
            ,
            Self::CreateAccountStatusNotFoundException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeCreateAccountStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_create_account_status::DescribeCreateAccountStatusError {
...
impl DescribeCreateAccountStatusError {
    /// Creates the `DescribeCreateAccountStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeCreateAccountStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::CreateAccountStatusNotFoundException(e) => e.meta(),
    ...
    /// Returns `true` if the error kind is `DescribeCreateAccountStatusError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DescribeCreateAccountStatusError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `DescribeCreateAccountStatusError::CreateAccountStatusNotFoundException`.
    pub fn is_create_account_status_not_found_exception(&self) -> bool {
        matches!(self, Self::CreateAccountStatusNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeCreateAccountStatusError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DescribeCreateAccountStatusError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `DescribeCreateAccountStatusError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `DescribeCreateAccountStatusError::UnsupportedApiEndpointException`.
...
mod _describe_create_account_status_output;
