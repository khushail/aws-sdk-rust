...
impl DescribeOrganizationalUnitInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_organizational_unit::DescribeOrganizationalUnitInput, ::aws_smithy_http::operation::error::BuildError> {
