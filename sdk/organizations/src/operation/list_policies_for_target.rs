...
impl ListPoliciesForTargetInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_policies_for_target::ListPoliciesForTarget, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_policies_for_target::ListPoliciesForTargetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `ListPoliciesForTarget`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPoliciesForTarget {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_policies_for_target::de_list_policies_for_target_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_policies_for_target::de_list_policies_for_target_http_response_with_props(status, headers, body)
                     }
                }
