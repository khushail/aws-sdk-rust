...
impl RegisterDelegatedAdministratorInput {
    /// Consumes the builder and constructs an Operation<[`RegisterDelegatedAdministrator`](crate::operation::register_delegated_administrator::RegisterDelegatedAdministrator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_delegated_administrator::RegisterDelegatedAdministrator, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_delegated_administrator::RegisterDelegatedAdministrator::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterDelegatedAdministrator {
                type Output = ::std::result::Result<crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorOutput, crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_register_delegated_administrator::de_register_delegated_administrator_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_register_delegated_administrator::de_register_delegated_administrator_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type RegisterDelegatedAdministratorErrorKind = RegisterDelegatedAdministratorError;
/// Error type for the `RegisterDelegatedAdministratorError` operation.
#[non_exhaustive]
...
impl ::std::fmt::Display for RegisterDelegatedAdministratorError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            _inner.fmt(f)
            ,
            Self::AccountAlreadyRegisteredException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterDelegatedAdministratorError {
...
impl ::aws_http::request_id::RequestId for crate::operation::register_delegated_administrator::RegisterDelegatedAdministratorError {
...
impl RegisterDelegatedAdministratorError {
    /// Creates the `RegisterDelegatedAdministratorError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterDelegatedAdministratorError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::AccountAlreadyRegisteredException(e) => e.meta(),
    ...
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::AccountAlreadyRegisteredException`.
    pub fn is_account_already_registered_exception(&self) -> bool {
        matches!(self, Self::AccountAlreadyRegisteredException(_))
    }
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::AccountNotFoundException`.
    pub fn is_account_not_found_exception(&self) -> bool {
        matches!(self, Self::AccountNotFoundException(_))
    }
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `RegisterDelegatedAdministratorError::UnsupportedApiEndpointException`.
...
mod _register_delegated_administrator_output;
