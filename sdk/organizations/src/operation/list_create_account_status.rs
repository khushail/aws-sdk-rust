...
impl ListCreateAccountStatusInput {
    /// Consumes the builder and constructs an Operation<[`ListCreateAccountStatus`](crate::operation::list_create_account_status::ListCreateAccountStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_create_account_status::ListCreateAccountStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_create_account_status::ListCreateAccountStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_create_account_status::ListCreateAccountStatus::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListCreateAccountStatus", "organizations"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListCreateAccountStatus`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCreateAccountStatus {
                type Output = ::std::result::Result<crate::operation::list_create_account_status::ListCreateAccountStatusOutput, crate::operation::list_create_account_status::ListCreateAccountStatusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_create_account_status::de_list_create_account_status_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_create_account_status::de_list_create_account_status_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListCreateAccountStatusErrorKind = ListCreateAccountStatusError;
/// Error type for the `ListCreateAccountStatusError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListCreateAccountStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_create_account_status::ListCreateAccountStatusError {
...
impl ListCreateAccountStatusError {
    /// Creates the `ListCreateAccountStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCreateAccountStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListCreateAccountStatusError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListCreateAccountStatusError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `ListCreateAccountStatusError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListCreateAccountStatusError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `ListCreateAccountStatusError::TooManyRequestsException`.
    pub fn is_too_many_requests_exception(&self) -> bool {
        matches!(self, Self::TooManyRequestsException(_))
    }
    /// Returns `true` if the error kind is `ListCreateAccountStatusError::UnsupportedApiEndpointException`.
...
mod _list_create_account_status_output;
