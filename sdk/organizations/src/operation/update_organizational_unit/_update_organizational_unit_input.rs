...
impl UpdateOrganizationalUnitInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_organizational_unit::UpdateOrganizationalUnitInput, ::aws_smithy_http::operation::error::BuildError> {
