...
impl LeaveOrganizationInput {
    /// Consumes the builder and constructs an Operation<[`LeaveOrganization`](crate::operation::leave_organization::LeaveOrganization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::leave_organization::LeaveOrganization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::leave_organization::LeaveOrganizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::leave_organization::LeaveOrganizationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::leave_organization::LeaveOrganization::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("LeaveOrganization", "organizations"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `LeaveOrganization`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for LeaveOrganization {
                type Output = ::std::result::Result<crate::operation::leave_organization::LeaveOrganizationOutput, crate::operation::leave_organization::LeaveOrganizationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_leave_organization::de_leave_organization_http_error(status, headers, body)
                     } else {
...
/// Do not use this.
            ...
            pub type LeaveOrganizationErrorKind = LeaveOrganizationError;
/// Error type for the `LeaveOrganizationError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for LeaveOrganizationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::leave_organization::LeaveOrganizationError {
...
impl LeaveOrganizationError {
    /// Creates the `LeaveOrganizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `LeaveOrganizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `LeaveOrganizationError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `LeaveOrganizationError::AccountNotFoundException`.
    pub fn is_account_not_found_exception(&self) -> bool {
        matches!(self, Self::AccountNotFoundException(_))
    }
    /// Returns `true` if the error kind is `LeaveOrganizationError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `LeaveOrganizationError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `LeaveOrganizationError::ConstraintViolationException`.
    pub fn is_constraint_violation_exception(&self) -> bool {
        matches!(self, Self::ConstraintViolationException(_))
    }
    /// Returns `true` if the error kind is `LeaveOrganizationError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `LeaveOrganizationError::MasterCannotLeaveOrganizationException`.
    pub fn is_master_cannot_leave_organization_exception(&self) -> bool {
        matches!(self, Self::MasterCannotLeaveOrganizationException(_))
    }
    /// Returns `true` if the error kind is `LeaveOrganizationError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `LeaveOrganizationError::TooManyRequestsException`.
...
mod _leave_organization_output;
