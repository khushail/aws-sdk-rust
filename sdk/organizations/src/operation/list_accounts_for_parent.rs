...
impl ListAccountsForParentInput {
    /// Consumes the builder and constructs an Operation<[`ListAccountsForParent`](crate::operation::list_accounts_for_parent::ListAccountsForParent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_accounts_for_parent::ListAccountsForParent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_accounts_for_parent::ListAccountsForParentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_accounts_for_parent::ListAccountsForParent::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAccountsForParent", "organizations"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListAccountsForParent`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAccountsForParent {
                type Output = ::std::result::Result<crate::operation::list_accounts_for_parent::ListAccountsForParentOutput, crate::operation::list_accounts_for_parent::ListAccountsForParentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_accounts_for_parent::de_list_accounts_for_parent_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_accounts_for_parent::de_list_accounts_for_parent_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListAccountsForParentErrorKind = ListAccountsForParentError;
/// Error type for the `ListAccountsForParentError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListAccountsForParentError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_accounts_for_parent::ListAccountsForParentError {
...
impl ListAccountsForParentError {
    /// Creates the `ListAccountsForParentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAccountsForParentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListAccountsForParentError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListAccountsForParentError::AwsOrganizationsNotInUseException`.
    pub fn is_aws_organizations_not_in_use_exception(&self) -> bool {
        matches!(self, Self::AwsOrganizationsNotInUseException(_))
    }
    /// Returns `true` if the error kind is `ListAccountsForParentError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListAccountsForParentError::ParentNotFoundException`.
    pub fn is_parent_not_found_exception(&self) -> bool {
        matches!(self, Self::ParentNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListAccountsForParentError::ServiceException`.
    pub fn is_service_exception(&self) -> bool {
        matches!(self, Self::ServiceException(_))
    }
    /// Returns `true` if the error kind is `ListAccountsForParentError::TooManyRequestsException`.
...
pub use crate::operation::list_accounts_for_parent::_list_accounts_for_parent_output::ListAccountsForParentOutput;

pub use crate::operation::list_accounts_for_parent::_list_accounts_for_parent_input::ListAccountsForParentInput;

mod _list_accounts_for_parent_input;

mod _list_accounts_for_parent_output;
