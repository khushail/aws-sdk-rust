...
impl TagResourceError {
    ...
    /// Returns `true` if the error kind is `TagResourceError::AwsOrganizationsNotInUseException`.
    ...
    /// Returns `true` if the error kind is `TagResourceError::ConstraintViolationException`.
    ...
    /// Returns `true` if the error kind is `TagResourceError::TargetNotFoundException`.
