...
impl GetTrustStoreCertificateInput {
    /// Consumes the builder and constructs an Operation<[`GetTrustStoreCertificate`](crate::operation::get_trust_store_certificate::GetTrustStoreCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_trust_store_certificate::GetTrustStoreCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_trust_store_certificate::GetTrustStoreCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/trustStores/{trustStoreArn}/certificate", trustStoreArn = trust_store_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_trust_store_certificate::GetTrustStoreCertificateInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_2 = &_input.thumbprint;
                let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("thumbprint", "cannot be empty or unset"))?;
                if inner_2.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("thumbprint", "cannot be empty or unset"));
                }
                query.push_kv("thumbprint", &::aws_smithy_http::query::fmt_string(&inner_2));
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_trust_store_certificate::GetTrustStoreCertificateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_trust_store_certificate::GetTrustStoreCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetTrustStoreCertificate", "workspacesweb"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetTrustStoreCertificate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTrustStoreCertificate {
                type Output = ::std::result::Result<crate::operation::get_trust_store_certificate::GetTrustStoreCertificateOutput, crate::operation::get_trust_store_certificate::GetTrustStoreCertificateError>;
...
mod _get_trust_store_certificate_output;
