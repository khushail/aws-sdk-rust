...
impl UpdateUserAccessLoggingSettingsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateUserAccessLoggingSettings`](crate::operation::update_user_access_logging_settings::UpdateUserAccessLoggingSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_user_access_logging_settings::UpdateUserAccessLoggingSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_user_access_logging_settings::UpdateUserAccessLoggingSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_user_access_logging_settings::UpdateUserAccessLoggingSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateUserAccessLoggingSettings", "workspacesweb"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateUserAccessLoggingSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUserAccessLoggingSettings {
                type Output = ::std::result::Result<crate::operation::update_user_access_logging_settings::UpdateUserAccessLoggingSettingsOutput, crate::operation::update_user_access_logging_settings::UpdateUserAccessLoggingSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_user_access_logging_settings::de_update_user_access_logging_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_user_access_logging_settings::de_update_user_access_logging_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_user_access_logging_settings::UpdateUserAccessLoggingSettingsError {
...
mod _update_user_access_logging_settings_output;
