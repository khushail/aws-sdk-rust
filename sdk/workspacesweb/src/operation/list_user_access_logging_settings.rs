...
impl ListUserAccessLoggingSettingsInput {
    /// Consumes the builder and constructs an Operation<[`ListUserAccessLoggingSettings`](crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/userAccessLoggingSettings").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListUserAccessLoggingSettings", "workspacesweb"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListUserAccessLoggingSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUserAccessLoggingSettings {
                type Output = ::std::result::Result<crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsOutput, crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_user_access_logging_settings::de_list_user_access_logging_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_user_access_logging_settings::de_list_user_access_logging_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_user_access_logging_settings::ListUserAccessLoggingSettingsError {
...
mod _list_user_access_logging_settings_output;
