...
impl DisassociateUserSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateUserSettings`](crate::operation::disassociate_user_settings::DisassociateUserSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_user_settings::DisassociateUserSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_user_settings::DisassociateUserSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::disassociate_user_settings::DisassociateUserSettingsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_user_settings::DisassociateUserSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateUserSettings", "workspacesweb"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisassociateUserSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateUserSettings {
                type Output = ::std::result::Result<crate::operation::disassociate_user_settings::DisassociateUserSettingsOutput, crate::operation::disassociate_user_settings::DisassociateUserSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_user_settings::de_disassociate_user_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_user_settings::de_disassociate_user_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_user_settings::DisassociateUserSettingsError {
...
pub use crate::operation::disassociate_user_settings::_disassociate_user_settings_output::DisassociateUserSettingsOutput;

pub use crate::operation::disassociate_user_settings::_disassociate_user_settings_input::DisassociateUserSettingsInput;

mod _disassociate_user_settings_input;

mod _disassociate_user_settings_output;
