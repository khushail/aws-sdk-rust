...
pub use crate::operation::disassociate_user_settings::_disassociate_user_settings_output::DisassociateUserSettingsOutputBuilder;

pub use crate::operation::disassociate_user_settings::_disassociate_user_settings_input::DisassociateUserSettingsInputBuilder;
...
impl DisassociateUserSettingsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.disassociate_user_settings();
...
impl DisassociateUserSettingsFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::disassociate_user_settings::DisassociateUserSettings, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::disassociate_user_settings::DisassociateUserSettingsOutput, ::aws_smithy_http::result::SdkError<crate::operation::disassociate_user_settings::DisassociateUserSettingsError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::disassociate_user_settings::DisassociateUserSettingsOutput, ::aws_smithy_http::result::SdkError<crate::operation::disassociate_user_settings::DisassociateUserSettingsError>>
                             {
