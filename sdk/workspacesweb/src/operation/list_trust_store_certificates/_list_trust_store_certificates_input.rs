...
impl ListTrustStoreCertificatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesInput, ::aws_smithy_http::operation::error::BuildError> {
