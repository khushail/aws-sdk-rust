...
impl AssociateTrustStoreInput {
    /// Consumes the builder and constructs an Operation<[`AssociateTrustStore`](crate::operation::associate_trust_store::AssociateTrustStore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_trust_store::AssociateTrustStore, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_trust_store::AssociateTrustStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::associate_trust_store::AssociateTrustStoreInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_2 = &_input.trust_store_arn;
                let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("trust_store_arn", "cannot be empty or unset"))?;
                if inner_2.is_empty() {
                ...
                query.push_kv("trustStoreArn", &::aws_smithy_http::query::fmt_string(&inner_2));
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::associate_trust_store::AssociateTrustStoreInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_trust_store::AssociateTrustStore::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateTrustStore", "workspacesweb"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateTrustStore`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateTrustStore {
                type Output = ::std::result::Result<crate::operation::associate_trust_store::AssociateTrustStoreOutput, crate::operation::associate_trust_store::AssociateTrustStoreError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_trust_store::de_associate_trust_store_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_trust_store::AssociateTrustStoreError {
...
mod _associate_trust_store_output;
