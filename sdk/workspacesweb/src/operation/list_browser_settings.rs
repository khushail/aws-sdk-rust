...
impl ListBrowserSettingsInput {
    /// Consumes the builder and constructs an Operation<[`ListBrowserSettings`](crate::operation::list_browser_settings::ListBrowserSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_browser_settings::ListBrowserSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_browser_settings::ListBrowserSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/browserSettings").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_browser_settings::ListBrowserSettingsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_browser_settings::ListBrowserSettingsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_browser_settings::ListBrowserSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListBrowserSettings", "workspacesweb"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListBrowserSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBrowserSettings {
                type Output = ::std::result::Result<crate::operation::list_browser_settings::ListBrowserSettingsOutput, crate::operation::list_browser_settings::ListBrowserSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_browser_settings::de_list_browser_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_browser_settings::de_list_browser_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_browser_settings::ListBrowserSettingsError {
...
mod _list_browser_settings_output;
