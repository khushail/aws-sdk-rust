...
impl GetUserAccessLoggingSettingsInput {
    /// Consumes the builder and constructs an Operation<[`GetUserAccessLoggingSettings`](crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettingsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetUserAccessLoggingSettings", "workspacesweb"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetUserAccessLoggingSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetUserAccessLoggingSettings {
                type Output = ::std::result::Result<crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettingsOutput, crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_user_access_logging_settings::de_get_user_access_logging_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_user_access_logging_settings::de_get_user_access_logging_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettingsError {
...
mod _get_user_access_logging_settings_output;
