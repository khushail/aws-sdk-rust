...
impl AssociateUserAccessLoggingSettingsInput {
    /// Consumes the builder and constructs an Operation<[`AssociateUserAccessLoggingSettings`](crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if portal_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("portal_arn", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/portals/{portalArn}/userAccessLoggingSettings", portalArn = portal_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettingsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_2 = &_input.user_access_logging_settings_arn;
                let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("user_access_logging_settings_arn", "cannot be empty or unset"))?;
                if inner_2.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("user_access_logging_settings_arn", "cannot be empty or unset"));
                }
                query.push_kv("userAccessLoggingSettingsArn", &::aws_smithy_http::query::fmt_string(&inner_2));
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettingsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateUserAccessLoggingSettings {
                type Output = ::std::result::Result<crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettingsOutput, crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_user_access_logging_settings::de_associate_user_access_logging_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_user_access_logging_settings::de_associate_user_access_logging_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_user_access_logging_settings::AssociateUserAccessLoggingSettingsError {
...
mod _associate_user_access_logging_settings_output;
