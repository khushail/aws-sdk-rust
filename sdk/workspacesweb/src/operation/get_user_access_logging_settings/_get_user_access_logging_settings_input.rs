...
impl GetUserAccessLoggingSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_user_access_logging_settings::GetUserAccessLoggingSettingsInput, ::aws_smithy_http::operation::error::BuildError> {
