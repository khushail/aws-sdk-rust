...
impl GetBrowserSettingsInput {
    /// Consumes the builder and constructs an Operation<[`GetBrowserSettings`](crate::operation::get_browser_settings::GetBrowserSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_browser_settings::GetBrowserSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_browser_settings::GetBrowserSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if browser_settings_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("browser_settings_arn", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::get_browser_settings::GetBrowserSettingsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_browser_settings::GetBrowserSettings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBrowserSettings {
                type Output = ::std::result::Result<crate::operation::get_browser_settings::GetBrowserSettingsOutput, crate::operation::get_browser_settings::GetBrowserSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_browser_settings::de_get_browser_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_browser_settings::de_get_browser_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_browser_settings::GetBrowserSettingsError {
...
mod _get_browser_settings_output;
