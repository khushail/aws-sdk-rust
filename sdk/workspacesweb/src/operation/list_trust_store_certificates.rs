...
impl ListTrustStoreCertificatesInput {
    /// Consumes the builder and constructs an Operation<[`ListTrustStoreCertificates`](crate::operation::list_trust_store_certificates::ListTrustStoreCertificates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_trust_store_certificates::ListTrustStoreCertificates, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if trust_store_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("trust_store_arn", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/trustStores/{trustStoreArn}/certificates", trustStoreArn = trust_store_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_trust_store_certificates::ListTrustStoreCertificates::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTrustStoreCertificates", "workspacesweb"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListTrustStoreCertificates`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTrustStoreCertificates {
                type Output = ::std::result::Result<crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesOutput, crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_trust_store_certificates::de_list_trust_store_certificates_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_trust_store_certificates::de_list_trust_store_certificates_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_trust_store_certificates::ListTrustStoreCertificatesError {
...
pub use crate::operation::list_trust_store_certificates::_list_trust_store_certificates_output::ListTrustStoreCertificatesOutput;

pub use crate::operation::list_trust_store_certificates::_list_trust_store_certificates_input::ListTrustStoreCertificatesInput;

mod _list_trust_store_certificates_input;

mod _list_trust_store_certificates_output;
