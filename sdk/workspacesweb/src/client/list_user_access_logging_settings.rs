...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_user_access_logging_settings::builders::ListUserAccessLoggingSettingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_user_access_logging_settings::builders::ListUserAccessLoggingSettingsFluentBuilder::set_next_token): <p>The pagination token used to retrieve the next page of results for this operation.</p>
