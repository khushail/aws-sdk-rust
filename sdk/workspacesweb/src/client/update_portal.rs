...
impl super::Client  {
    ...
    ///   - [`portal_arn(impl ::std::convert::Into<String>)`](crate::operation::update_portal::builders::UpdatePortalFluentBuilder::portal_arn) / [`set_portal_arn(Option<String>)`](crate::operation::update_portal::builders::UpdatePortalFluentBuilder::set_portal_arn): <p>The ARN of the web portal.</p>
    ///   - [`display_name(impl ::std::convert::Into<String>)`](crate::operation::update_portal::builders::UpdatePortalFluentBuilder::display_name) / [`set_display_name(Option<String>)`](crate::operation::update_portal::builders::UpdatePortalFluentBuilder::set_display_name): <p>The name of the web portal. This is not visible to users who log into the web portal.</p>
