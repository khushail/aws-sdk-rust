...
pub fn ser_create_browser_settings_input(input: &crate::operation::create_browser_settings::CreateBrowserSettingsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_create_browser_settings_input::ser_create_browser_settings_input(&mut object, input)?;
    object.finish();
...
pub fn de_create_browser_settings_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_browser_settings::CreateBrowserSettingsOutput, crate::operation::create_browser_settings::CreateBrowserSettingsError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::create_browser_settings::CreateBrowserSettingsError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::create_browser_settings::CreateBrowserSettingsError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ConflictException" => crate::operation::create_browser_settings::CreateBrowserSettingsError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::create_browser_settings::CreateBrowserSettingsError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotFoundException" => crate::operation::create_browser_settings::CreateBrowserSettingsError::ResourceNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => crate::operation::create_browser_settings::CreateBrowserSettingsError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::create_browser_settings::CreateBrowserSettingsError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::create_browser_settings::CreateBrowserSettingsError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::create_browser_settings::CreateBrowserSettingsError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_create_browser_settings_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_browser_settings::CreateBrowserSettingsOutput, crate::operation::create_browser_settings::CreateBrowserSettingsError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_create_browser_settings(value: &[u8], mut builder: crate::operation::create_browser_settings::builders::CreateBrowserSettingsOutputBuilder) -> Result<crate::operation::create_browser_settings::builders::CreateBrowserSettingsOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
