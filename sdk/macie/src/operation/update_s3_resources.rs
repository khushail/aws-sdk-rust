...
impl UpdateS3ResourcesInput {
    /// Consumes the builder and constructs an Operation<[`UpdateS3Resources`](crate::operation::update_s3_resources::UpdateS3Resources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_s3_resources::UpdateS3Resources, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_s3_resources::UpdateS3ResourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_s3_resources::UpdateS3Resources::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateS3Resources", "macie"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateS3Resources`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateS3Resources {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_s3_resources::de_update_s3_resources_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_s3_resources::UpdateS3ResourcesError {
...
pub use crate::operation::update_s3_resources::_update_s3_resources_output::UpdateS3ResourcesOutput;

pub use crate::operation::update_s3_resources::_update_s3_resources_input::UpdateS3ResourcesInput;

mod _update_s3_resources_input;

mod _update_s3_resources_output;
