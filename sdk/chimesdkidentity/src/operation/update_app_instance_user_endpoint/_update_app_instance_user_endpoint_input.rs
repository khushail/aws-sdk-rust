...
impl UpdateAppInstanceUserEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_app_instance_user_endpoint::UpdateAppInstanceUserEndpointInput, ::aws_smithy_http::operation::error::BuildError> {
