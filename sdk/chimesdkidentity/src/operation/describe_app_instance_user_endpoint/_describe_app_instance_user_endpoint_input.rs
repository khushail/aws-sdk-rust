...
impl DescribeAppInstanceUserEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_app_instance_user_endpoint::DescribeAppInstanceUserEndpointInput, ::aws_smithy_http::operation::error::BuildError> {
