...
pub use crate::operation::describe_app_instance_bot::_describe_app_instance_bot_output::DescribeAppInstanceBotOutputBuilder;

pub use crate::operation::describe_app_instance_bot::_describe_app_instance_bot_input::DescribeAppInstanceBotInputBuilder;
...
impl DescribeAppInstanceBotInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.describe_app_instance_bot();
                        fluent_builder.inner = self;
                        fluent_builder.send().await
                    }
}
/// Fluent builder constructing a request to `DescribeAppInstanceBot`.
/// 
...
impl DescribeAppInstanceBotFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::describe_app_instance_bot::DescribeAppInstanceBot, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::describe_app_instance_bot::DescribeAppInstanceBotOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_app_instance_bot::DescribeAppInstanceBotError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::describe_app_instance_bot::DescribeAppInstanceBotOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_app_instance_bot::DescribeAppInstanceBotError>>
                             {
