...
impl CreateSafetyRuleInput {
    /// Consumes the builder and constructs an Operation<[`CreateSafetyRule`](crate::operation::create_safety_rule::CreateSafetyRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_safety_rule::CreateSafetyRule, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_safety_rule::CreateSafetyRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_safety_rule::CreateSafetyRule::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateSafetyRule", "route53recoverycontrolconfig"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateSafetyRule`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSafetyRule {
                type Output = ::std::result::Result<crate::operation::create_safety_rule::CreateSafetyRuleOutput, crate::operation::create_safety_rule::CreateSafetyRuleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_safety_rule::de_create_safety_rule_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_safety_rule::CreateSafetyRuleError {
...
mod _create_safety_rule_output;
