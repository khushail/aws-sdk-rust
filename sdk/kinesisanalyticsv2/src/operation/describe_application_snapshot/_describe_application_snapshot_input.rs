...
impl DescribeApplicationSnapshotInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_application_snapshot::DescribeApplicationSnapshotInput, ::aws_smithy_http::operation::error::BuildError> {
