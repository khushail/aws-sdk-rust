...
impl CreateApplicationSnapshotInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_application_snapshot::CreateApplicationSnapshotInput, ::aws_smithy_http::operation::error::BuildError> {
