...
impl DescribeApplicationVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_application_version::DescribeApplicationVersionInput, ::aws_smithy_http::operation::error::BuildError> {
