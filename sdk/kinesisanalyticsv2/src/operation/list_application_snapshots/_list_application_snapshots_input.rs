...
impl ListApplicationSnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_application_snapshots::ListApplicationSnapshotsInput, ::aws_smithy_http::operation::error::BuildError> {
