...
impl super::Client  {
    ...
    ///   - [`application_name(impl ::std::convert::Into<String>)`](crate::operation::describe_application::builders::DescribeApplicationFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::describe_application::builders::DescribeApplicationFluentBuilder::set_application_name): <p>The name of the application.</p>
