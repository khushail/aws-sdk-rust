...
impl super::Client  {
    ...
    ///   - [`application_name(impl ::std::convert::Into<String>)`](crate::operation::stop_application::builders::StopApplicationFluentBuilder::application_name) / [`set_application_name(Option<String>)`](crate::operation::stop_application::builders::StopApplicationFluentBuilder::set_application_name): <p>The name of the running application to stop.</p>
