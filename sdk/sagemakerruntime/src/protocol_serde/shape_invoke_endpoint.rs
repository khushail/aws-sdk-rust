...
#[allow(clippy::unnecessary_wraps)]
pub fn de_invoke_endpoint_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::invoke_endpoint::InvokeEndpointOutput, crate::operation::invoke_endpoint::InvokeEndpointError> {
    Ok({
        #[allow(unused_mut)]
