...
#[allow(clippy::unnecessary_wraps)]
pub fn de_invoke_endpoint_async_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::invoke_endpoint_async::InvokeEndpointAsyncOutput, crate::operation::invoke_endpoint_async::InvokeEndpointAsyncError> {
    Ok({
        #[allow(unused_mut)]
