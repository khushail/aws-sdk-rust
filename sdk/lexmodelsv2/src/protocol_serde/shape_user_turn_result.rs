...
pub(crate) fn de_user_turn_result<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::UserTurnResult>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "errorDetails" => {
                                builder = builder.set_error_details(
                                    crate::protocol_serde::shape_execution_error_details::de_execution_error_details(tokens)?
                                );
                            }
                            "endToEndResult" => {
