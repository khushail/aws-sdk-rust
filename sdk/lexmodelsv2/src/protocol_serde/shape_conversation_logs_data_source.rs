...
pub(crate) fn de_conversation_logs_data_source<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ConversationLogsDataSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "filter" => {
                                builder = builder.set_filter(
                                    crate::protocol_serde::shape_conversation_logs_data_source_filter_by::de_conversation_logs_data_source_filter_by(tokens)?
                                );
                            }
