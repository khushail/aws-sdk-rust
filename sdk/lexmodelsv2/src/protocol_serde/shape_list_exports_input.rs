...
pub fn ser_list_exports_input(
        ...
        for item_5 in var_3 {
             {
                ...
                crate::protocol_serde::shape_export_filter::ser_export_filter(&mut object_6, item_5)?;
                object_6.finish();
            }
        }
        array_4.finish();
    ...
    if let Some(var_10) = &input.sort_by {
        ...
        crate::protocol_serde::shape_export_sort_by::ser_export_sort_by(&mut object_11, var_10)?;
        object_11.finish();
    }
    Ok(())
}
