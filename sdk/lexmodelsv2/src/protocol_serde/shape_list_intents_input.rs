...
pub fn ser_list_intents_input(
        ...
        for item_3 in var_1 {
             {
                ...
                crate::protocol_serde::shape_intent_filter::ser_intent_filter(&mut object_4, item_3)?;
                object_4.finish();
            }
        }
        array_2.finish();
    ...
    if let Some(var_7) = &input.sort_by {
        ...
        crate::protocol_serde::shape_intent_sort_by::ser_intent_sort_by(&mut object_8, var_7)?;
        object_8.finish();
    }
    Ok(())
}
