...
pub(crate) fn de_fulfillment_update_response_specification<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::FulfillmentUpdateResponseSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_fulfillment_update_response_specification(
    ...
    if let Some(var_1) = &input.frequency_in_seconds {
        object.key("frequencyInSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
