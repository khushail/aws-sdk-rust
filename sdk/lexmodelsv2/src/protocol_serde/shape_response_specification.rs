...
pub(crate) fn de_response_specification<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ResponseSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
...
pub fn ser_response_specification(
    ...
    if let Some(var_5) = &input.allow_interrupt {
        object.key("allowInterrupt").boolean(*var_5);
    }
    Ok(())
}
