...
impl CreateResourcePolicyInput {
    /// Consumes the builder and constructs an Operation<[`CreateResourcePolicy`](crate::operation::create_resource_policy::CreateResourcePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_resource_policy::CreateResourcePolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_resource_policy::CreateResourcePolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_resource_policy::ser_create_resource_policy_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_resource_policy::CreateResourcePolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateResourcePolicy", "lexmodelsv2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateResourcePolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateResourcePolicy {
                type Output = ::std::result::Result<crate::operation::create_resource_policy::CreateResourcePolicyOutput, crate::operation::create_resource_policy::CreateResourcePolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_resource_policy::de_create_resource_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_resource_policy::de_create_resource_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_resource_policy::CreateResourcePolicyError {
...
mod _create_resource_policy_output;
