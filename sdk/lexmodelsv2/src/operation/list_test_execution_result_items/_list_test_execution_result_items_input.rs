...
impl ListTestExecutionResultItemsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_test_execution_result_items::ListTestExecutionResultItemsInput, ::aws_smithy_http::operation::error::BuildError> {
