...
impl DescribeBotRecommendationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_bot_recommendation::DescribeBotRecommendationInput, ::aws_smithy_http::operation::error::BuildError> {
