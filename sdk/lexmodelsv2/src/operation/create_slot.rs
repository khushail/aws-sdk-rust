...
impl CreateSlotInput {
    /// Consumes the builder and constructs an Operation<[`CreateSlot`](crate::operation::create_slot::CreateSlot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_slot::CreateSlot, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_slot::CreateSlotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if intent_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("intent_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/bots/{botId}/botversions/{botVersion}/botlocales/{localeId}/intents/{intentId}/slots", botId = bot_id, botVersion = bot_version, localeId = locale_id, intentId = intent_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_slot::CreateSlot::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSlot {
                type Output = ::std::result::Result<crate::operation::create_slot::CreateSlotOutput, crate::operation::create_slot::CreateSlotError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_slot::de_create_slot_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_slot::de_create_slot_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_slot::CreateSlotError {
