...
impl BatchCreateCustomVocabularyItemInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_create_custom_vocabulary_item::BatchCreateCustomVocabularyItemInput, ::aws_smithy_http::operation::error::BuildError> {
