...
impl ListAggregatedUtterancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_aggregated_utterances::ListAggregatedUtterancesInput, ::aws_smithy_http::operation::error::BuildError> {
