...
impl GetTestExecutionArtifactsUrlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_test_execution_artifacts_url::GetTestExecutionArtifactsUrlInput, ::aws_smithy_http::operation::error::BuildError> {
