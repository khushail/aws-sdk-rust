...
impl BatchDeleteCustomVocabularyItemInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_delete_custom_vocabulary_item::BatchDeleteCustomVocabularyItemInput, ::aws_smithy_http::operation::error::BuildError> {
