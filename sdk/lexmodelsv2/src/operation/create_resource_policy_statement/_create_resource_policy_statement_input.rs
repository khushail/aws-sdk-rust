...
impl CreateResourcePolicyStatementInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_resource_policy_statement::CreateResourcePolicyStatementInput, ::aws_smithy_http::operation::error::BuildError> {
