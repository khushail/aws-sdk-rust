...
impl CreateTestSetDiscrepancyReportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_test_set_discrepancy_report::CreateTestSetDiscrepancyReportInput, ::aws_smithy_http::operation::error::BuildError> {
