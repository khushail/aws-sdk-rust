...
impl BuildBotLocaleInput {
    /// Consumes the builder and constructs an Operation<[`BuildBotLocale`](crate::operation::build_bot_locale::BuildBotLocale)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::build_bot_locale::BuildBotLocale, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::build_bot_locale::BuildBotLocaleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::build_bot_locale::BuildBotLocale::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BuildBotLocale {
                type Output = ::std::result::Result<crate::operation::build_bot_locale::BuildBotLocaleOutput, crate::operation::build_bot_locale::BuildBotLocaleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        ...
                        crate::protocol_serde::shape_build_bot_locale::de_build_bot_locale_http_response_with_props(status, headers, body)
                     }
                }
