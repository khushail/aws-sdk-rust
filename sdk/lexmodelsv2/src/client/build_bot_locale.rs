...
impl super::Client  {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::build_bot_locale::builders::BuildBotLocaleFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::build_bot_locale::builders::BuildBotLocaleFluentBuilder::set_bot_id): <p>The identifier of the bot to build. The identifier is returned in the response from the <a href="https://docs.aws.amazon.com/lexv2/latest/APIReference/API_CreateBot.html">CreateBot</a> operation.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::build_bot_locale::builders::BuildBotLocaleFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::build_bot_locale::builders::BuildBotLocaleFluentBuilder::set_bot_version): <p>The version of the bot to build. This can only be the draft version of the bot.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::build_bot_locale::builders::BuildBotLocaleFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::build_bot_locale::builders::BuildBotLocaleFluentBuilder::set_locale_id): <p>The identifier of the language and locale that the bot will be used in. The string must match one of the supported locales. All of the intents, slot types, and slots used in the bot must have the same locale. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
