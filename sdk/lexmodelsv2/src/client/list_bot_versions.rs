...
impl super::Client  {
    ...
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::list_bot_versions::builders::ListBotVersionsFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::list_bot_versions::builders::ListBotVersionsFluentBuilder::set_bot_id): <p>The identifier of the bot to list versions for.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_bot_versions::builders::ListBotVersionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_bot_versions::builders::ListBotVersionsFluentBuilder::set_next_token): <p>If the response to the <code>ListBotVersion</code> operation contains more results than specified in the <code>maxResults</code> parameter, a token is returned in the response. Use that token in the <code>nextToken</code> parameter to return the next page of results.</p>
