...
impl super::Client  {
    ...
    ///   - [`test_set_discrepancy_report_id(impl ::std::convert::Into<String>)`](crate::operation::describe_test_set_discrepancy_report::builders::DescribeTestSetDiscrepancyReportFluentBuilder::test_set_discrepancy_report_id) / [`set_test_set_discrepancy_report_id(Option<String>)`](crate::operation::describe_test_set_discrepancy_report::builders::DescribeTestSetDiscrepancyReportFluentBuilder::set_test_set_discrepancy_report_id): <p>The unique identifier of the test set discrepancy report.</p>
