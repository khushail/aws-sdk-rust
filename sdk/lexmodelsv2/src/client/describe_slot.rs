...
impl super::Client  {
    ...
    ///   - [`slot_id(impl ::std::convert::Into<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::slot_id) / [`set_slot_id(Option<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::set_slot_id): <p>The unique identifier for the slot.</p>
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::set_bot_id): <p>The identifier of the bot associated with the slot.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::set_bot_version): <p>The version of the bot associated with the slot.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::set_locale_id): <p>The identifier of the language and locale of the slot to describe. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
    ///   - [`intent_id(impl ::std::convert::Into<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::intent_id) / [`set_intent_id(Option<String>)`](crate::operation::describe_slot::builders::DescribeSlotFluentBuilder::set_intent_id): <p>The identifier of the intent that contains the slot.</p>
