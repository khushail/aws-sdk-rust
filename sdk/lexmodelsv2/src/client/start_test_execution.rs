...
impl super::Client  {
    ...
    ///   - [`test_set_id(impl ::std::convert::Into<String>)`](crate::operation::start_test_execution::builders::StartTestExecutionFluentBuilder::test_set_id) / [`set_test_set_id(Option<String>)`](crate::operation::start_test_execution::builders::StartTestExecutionFluentBuilder::set_test_set_id): <p>The test set Id for the test set execution.</p>
    ///   - [`target(TestExecutionTarget)`](crate::operation::start_test_execution::builders::StartTestExecutionFluentBuilder::target) / [`set_target(Option<TestExecutionTarget>)`](crate::operation::start_test_execution::builders::StartTestExecutionFluentBuilder::set_target): <p>The target bot for the test set execution.</p>
    ///   - [`api_mode(TestExecutionApiMode)`](crate::operation::start_test_execution::builders::StartTestExecutionFluentBuilder::api_mode) / [`set_api_mode(Option<TestExecutionApiMode>)`](crate::operation::start_test_execution::builders::StartTestExecutionFluentBuilder::set_api_mode): <p>Indicates whether we use streaming or non-streaming APIs for the test set execution. For streaming, StartConversation Runtime API is used. Whereas, for non-streaming, RecognizeUtterance and RecognizeText Amazon Lex Runtime API are used.</p>
    ///   - [`test_execution_modality(TestExecutionModality)`](crate::operation::start_test_execution::builders::StartTestExecutionFluentBuilder::test_execution_modality) / [`set_test_execution_modality(Option<TestExecutionModality>)`](crate::operation::start_test_execution::builders::StartTestExecutionFluentBuilder::set_test_execution_modality): <p>Indicates whether audio or text is used.</p>
