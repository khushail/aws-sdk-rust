...
impl super::Client  {
    ...
    ///   - [`slot_type_id(impl ::std::convert::Into<String>)`](crate::operation::delete_slot_type::builders::DeleteSlotTypeFluentBuilder::slot_type_id) / [`set_slot_type_id(Option<String>)`](crate::operation::delete_slot_type::builders::DeleteSlotTypeFluentBuilder::set_slot_type_id): <p>The identifier of the slot type to delete.</p>
    ///   - [`bot_id(impl ::std::convert::Into<String>)`](crate::operation::delete_slot_type::builders::DeleteSlotTypeFluentBuilder::bot_id) / [`set_bot_id(Option<String>)`](crate::operation::delete_slot_type::builders::DeleteSlotTypeFluentBuilder::set_bot_id): <p>The identifier of the bot associated with the slot type.</p>
    ///   - [`bot_version(impl ::std::convert::Into<String>)`](crate::operation::delete_slot_type::builders::DeleteSlotTypeFluentBuilder::bot_version) / [`set_bot_version(Option<String>)`](crate::operation::delete_slot_type::builders::DeleteSlotTypeFluentBuilder::set_bot_version): <p>The version of the bot associated with the slot type.</p>
    ///   - [`locale_id(impl ::std::convert::Into<String>)`](crate::operation::delete_slot_type::builders::DeleteSlotTypeFluentBuilder::locale_id) / [`set_locale_id(Option<String>)`](crate::operation::delete_slot_type::builders::DeleteSlotTypeFluentBuilder::set_locale_id): <p>The identifier of the language and locale that the slot type will be deleted from. The string must match one of the supported locales. For more information, see <a href="https://docs.aws.amazon.com/lexv2/latest/dg/how-languages.html">Supported languages</a>.</p>
