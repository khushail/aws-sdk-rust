...
impl super::Client  {
    ...
    ///   - [`stream_name(impl ::std::convert::Into<String>)`](crate::operation::merge_shards::builders::MergeShardsFluentBuilder::stream_name) / [`set_stream_name(Option<String>)`](crate::operation::merge_shards::builders::MergeShardsFluentBuilder::set_stream_name): <p>The name of the stream for the merge.</p>
    ///   - [`shard_to_merge(impl ::std::convert::Into<String>)`](crate::operation::merge_shards::builders::MergeShardsFluentBuilder::shard_to_merge) / [`set_shard_to_merge(Option<String>)`](crate::operation::merge_shards::builders::MergeShardsFluentBuilder::set_shard_to_merge): <p>The shard ID of the shard to combine with the adjacent shard for the merge.</p>
    ///   - [`adjacent_shard_to_merge(impl ::std::convert::Into<String>)`](crate::operation::merge_shards::builders::MergeShardsFluentBuilder::adjacent_shard_to_merge) / [`set_adjacent_shard_to_merge(Option<String>)`](crate::operation::merge_shards::builders::MergeShardsFluentBuilder::set_adjacent_shard_to_merge): <p>The shard ID of the adjacent shard for the merge.</p>
