...
impl AddTagsToStreamInput {
    /// Consumes the builder and constructs an Operation<[`AddTagsToStream`](crate::operation::add_tags_to_stream::AddTagsToStream)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::add_tags_to_stream::AddTagsToStream, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_tags_to_stream::AddTagsToStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_tags_to_stream::AddTagsToStream::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddTagsToStream {
                type Output = ::std::result::Result<crate::operation::add_tags_to_stream::AddTagsToStreamOutput, crate::operation::add_tags_to_stream::AddTagsToStreamError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::add_tags_to_stream::AddTagsToStreamError {
