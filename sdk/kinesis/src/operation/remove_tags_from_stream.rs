...
impl RemoveTagsFromStreamInput {
    /// Consumes the builder and constructs an Operation<[`RemoveTagsFromStream`](crate::operation::remove_tags_from_stream::RemoveTagsFromStream)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::remove_tags_from_stream::RemoveTagsFromStream, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_tags_from_stream::RemoveTagsFromStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_tags_from_stream::RemoveTagsFromStream::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RemoveTagsFromStream", "kinesis"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RemoveTagsFromStream`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveTagsFromStream {
                type Output = ::std::result::Result<crate::operation::remove_tags_from_stream::RemoveTagsFromStreamOutput, crate::operation::remove_tags_from_stream::RemoveTagsFromStreamError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_remove_tags_from_stream::de_remove_tags_from_stream_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_remove_tags_from_stream::de_remove_tags_from_stream_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::remove_tags_from_stream::RemoveTagsFromStreamError {
...
mod _remove_tags_from_stream_output;
