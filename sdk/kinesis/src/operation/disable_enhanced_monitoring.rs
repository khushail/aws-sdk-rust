...
impl DisableEnhancedMonitoringInput {
    /// Consumes the builder and constructs an Operation<[`DisableEnhancedMonitoring`](crate::operation::disable_enhanced_monitoring::DisableEnhancedMonitoring)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_enhanced_monitoring::DisableEnhancedMonitoring, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_enhanced_monitoring::DisableEnhancedMonitoringInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_enhanced_monitoring::DisableEnhancedMonitoring::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableEnhancedMonitoring {
                type Output = ::std::result::Result<crate::operation::disable_enhanced_monitoring::DisableEnhancedMonitoringOutput, crate::operation::disable_enhanced_monitoring::DisableEnhancedMonitoringError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_disable_enhanced_monitoring::de_disable_enhanced_monitoring_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_enhanced_monitoring::DisableEnhancedMonitoringError {
