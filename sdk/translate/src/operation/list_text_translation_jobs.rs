...
impl ListTextTranslationJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListTextTranslationJobs`](crate::operation::list_text_translation_jobs::ListTextTranslationJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_text_translation_jobs::ListTextTranslationJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_text_translation_jobs::ListTextTranslationJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_text_translation_jobs::ListTextTranslationJobs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTextTranslationJobs", "translate"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListTextTranslationJobs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTextTranslationJobs {
                type Output = ::std::result::Result<crate::operation::list_text_translation_jobs::ListTextTranslationJobsOutput, crate::operation::list_text_translation_jobs::ListTextTranslationJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_text_translation_jobs::de_list_text_translation_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_text_translation_jobs::de_list_text_translation_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_text_translation_jobs::ListTextTranslationJobsError {
...
mod _list_text_translation_jobs_output;
