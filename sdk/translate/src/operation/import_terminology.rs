...
impl ImportTerminologyInput {
    /// Consumes the builder and constructs an Operation<[`ImportTerminology`](crate::operation::import_terminology::ImportTerminology)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_terminology::ImportTerminology, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_terminology::ImportTerminologyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_terminology::ImportTerminology::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ImportTerminology", "translate"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ImportTerminology`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportTerminology {
                type Output = ::std::result::Result<crate::operation::import_terminology::ImportTerminologyOutput, crate::operation::import_terminology::ImportTerminologyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_import_terminology::de_import_terminology_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_import_terminology::de_import_terminology_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::import_terminology::ImportTerminologyError {
...
mod _import_terminology_output;
