...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::translate_document::TranslateDocumentError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
