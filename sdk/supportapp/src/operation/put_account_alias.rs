...
impl PutAccountAliasInput {
    /// Consumes the builder and constructs an Operation<[`PutAccountAlias`](crate::operation::put_account_alias::PutAccountAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_account_alias::PutAccountAlias, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_account_alias::PutAccountAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/control/put-account-alias").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_account_alias::PutAccountAlias::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutAccountAlias", "supportapp"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutAccountAlias`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAccountAlias {
                type Output = ::std::result::Result<crate::operation::put_account_alias::PutAccountAliasOutput, crate::operation::put_account_alias::PutAccountAliasError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_account_alias::de_put_account_alias_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_account_alias::de_put_account_alias_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_account_alias::PutAccountAliasError {
