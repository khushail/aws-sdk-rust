...
impl GetAccountAliasInput {
    /// Consumes the builder and constructs an Operation<[`GetAccountAlias`](crate::operation::get_account_alias::GetAccountAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_account_alias::GetAccountAlias, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_account_alias::GetAccountAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/control/get-account-alias").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_account_alias::GetAccountAliasInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_account_alias::GetAccountAlias::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccountAlias {
                type Output = ::std::result::Result<crate::operation::get_account_alias::GetAccountAliasOutput, crate::operation::get_account_alias::GetAccountAliasError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_account_alias::de_get_account_alias_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_account_alias::de_get_account_alias_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_account_alias::GetAccountAliasError {
