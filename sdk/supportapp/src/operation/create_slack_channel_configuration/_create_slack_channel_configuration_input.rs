...
impl CreateSlackChannelConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_slack_channel_configuration::CreateSlackChannelConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
