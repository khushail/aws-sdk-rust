...
impl super::Client  {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::update_workspace_alias::builders::UpdateWorkspaceAliasFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::update_workspace_alias::builders::UpdateWorkspaceAliasFluentBuilder::set_workspace_id): The ID of the workspace being updated.
    ///   - [`alias(impl ::std::convert::Into<String>)`](crate::operation::update_workspace_alias::builders::UpdateWorkspaceAliasFluentBuilder::alias) / [`set_alias(Option<String>)`](crate::operation::update_workspace_alias::builders::UpdateWorkspaceAliasFluentBuilder::set_alias): The new alias of the workspace.
