...
impl DeleteRuleGroupsNamespaceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_rule_groups_namespace::DeleteRuleGroupsNamespaceInput, ::aws_smithy_http::operation::error::BuildError> {
