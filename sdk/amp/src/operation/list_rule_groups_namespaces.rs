...
impl ListRuleGroupsNamespacesInput {
    /// Consumes the builder and constructs an Operation<[`ListRuleGroupsNamespaces`](crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespaces)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespaces, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespaces::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListRuleGroupsNamespaces", "amp"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListRuleGroupsNamespaces`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRuleGroupsNamespaces {
                type Output = ::std::result::Result<crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesOutput, crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesError {
...
mod _list_rule_groups_namespaces_output;
