...
impl CreateAlertManagerDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_alert_manager_definition::CreateAlertManagerDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
