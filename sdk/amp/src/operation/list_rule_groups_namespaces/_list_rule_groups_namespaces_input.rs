...
impl ListRuleGroupsNamespacesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_rule_groups_namespaces::ListRuleGroupsNamespacesInput, ::aws_smithy_http::operation::error::BuildError> {
