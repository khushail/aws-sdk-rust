...
impl PutAlertManagerDefinitionInput {
    /// Consumes the builder and constructs an Operation<[`PutAlertManagerDefinition`](crate::operation::put_alert_manager_definition::PutAlertManagerDefinition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_alert_manager_definition::PutAlertManagerDefinition, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_alert_manager_definition::PutAlertManagerDefinitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_alert_manager_definition::PutAlertManagerDefinition::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutAlertManagerDefinition", "amp"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutAlertManagerDefinition`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAlertManagerDefinition {
                type Output = ::std::result::Result<crate::operation::put_alert_manager_definition::PutAlertManagerDefinitionOutput, crate::operation::put_alert_manager_definition::PutAlertManagerDefinitionError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::put_alert_manager_definition::PutAlertManagerDefinitionError {
...
mod _put_alert_manager_definition_output;
