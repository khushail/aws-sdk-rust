...
impl DescribeAcceleratorOfferingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_accelerator_offerings::DescribeAcceleratorOfferingsInput, ::aws_smithy_http::operation::error::BuildError> {
