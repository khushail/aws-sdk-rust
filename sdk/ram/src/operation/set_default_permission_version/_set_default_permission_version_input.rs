...
impl SetDefaultPermissionVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_default_permission_version::SetDefaultPermissionVersionInput, ::aws_smithy_http::operation::error::BuildError> {
