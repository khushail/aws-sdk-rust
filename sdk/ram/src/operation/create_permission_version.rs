...
impl CreatePermissionVersionInput {
    /// Consumes the builder and constructs an Operation<[`CreatePermissionVersion`](crate::operation::create_permission_version::CreatePermissionVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_permission_version::CreatePermissionVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_permission_version::CreatePermissionVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_permission_version::ser_create_permission_version_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_permission_version::CreatePermissionVersion::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePermissionVersion", "ram"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePermissionVersion {
                type Output = ::std::result::Result<crate::operation::create_permission_version::CreatePermissionVersionOutput, crate::operation::create_permission_version::CreatePermissionVersionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_permission_version::de_create_permission_version_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreatePermissionVersionErrorKind = CreatePermissionVersionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreatePermissionVersionError {
...
impl ::std::fmt::Display for CreatePermissionVersionError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            _inner.fmt(f)
            ,
            Self::PermissionVersionsLimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ::aws_http::request_id::RequestId for crate::operation::create_permission_version::CreatePermissionVersionError {
...
impl CreatePermissionVersionError {
    /// Creates the `CreatePermissionVersionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreatePermissionVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::PermissionVersionsLimitExceededException(e) => e.meta(),
