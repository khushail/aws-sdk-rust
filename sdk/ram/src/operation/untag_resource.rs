...
impl UntagResourceError {
    ...
    /// Returns `true` if the error kind is `UntagResourceError::MalformedArnException`.
    ...
    /// Returns `true` if the error kind is `UntagResourceError::UnknownResourceException`.
