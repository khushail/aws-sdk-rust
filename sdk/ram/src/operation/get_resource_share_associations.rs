...
impl GetResourceShareAssociationsInput {
    /// Consumes the builder and constructs an Operation<[`GetResourceShareAssociations`](crate::operation::get_resource_share_associations::GetResourceShareAssociations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_resource_share_associations::GetResourceShareAssociations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_resource_share_associations::GetResourceShareAssociationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/getresourceshareassociations").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_resource_share_associations::GetResourceShareAssociations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetResourceShareAssociations", "ram"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetResourceShareAssociations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResourceShareAssociations {
                type Output = ::std::result::Result<crate::operation::get_resource_share_associations::GetResourceShareAssociationsOutput, crate::operation::get_resource_share_associations::GetResourceShareAssociationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_resource_share_associations::de_get_resource_share_associations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_resource_share_associations::de_get_resource_share_associations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_resource_share_associations::GetResourceShareAssociationsError {
...
mod _get_resource_share_associations_output;
