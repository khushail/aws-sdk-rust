...
impl ListPermissionAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_permission_associations::ListPermissionAssociationsInput, ::aws_smithy_http::operation::error::BuildError> {
