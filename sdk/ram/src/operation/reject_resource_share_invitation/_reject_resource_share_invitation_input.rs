...
impl RejectResourceShareInvitationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reject_resource_share_invitation::RejectResourceShareInvitationInput, ::aws_smithy_http::operation::error::BuildError> {
