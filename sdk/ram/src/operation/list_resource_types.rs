...
impl ListResourceTypesInput {
    /// Consumes the builder and constructs an Operation<[`ListResourceTypes`](crate::operation::list_resource_types::ListResourceTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_resource_types::ListResourceTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resource_types::ListResourceTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/listresourcetypes").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_types::ListResourceTypes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListResourceTypes", "ram"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListResourceTypes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourceTypes {
                type Output = ::std::result::Result<crate::operation::list_resource_types::ListResourceTypesOutput, crate::operation::list_resource_types::ListResourceTypesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_resource_types::de_list_resource_types_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_resource_types::de_list_resource_types_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_resource_types::ListResourceTypesError {
...
pub use crate::operation::list_resource_types::_list_resource_types_output::ListResourceTypesOutput;

pub use crate::operation::list_resource_types::_list_resource_types_input::ListResourceTypesInput;

mod _list_resource_types_input;

mod _list_resource_types_output;
