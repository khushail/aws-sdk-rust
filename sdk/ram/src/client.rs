...
mod accept_resource_share_invitation;

mod associate_resource_share;

mod associate_resource_share_permission;

mod create_permission;

mod create_permission_version;
...
mod delete_permission_version;

mod delete_resource_share;

mod disassociate_resource_share;

mod disassociate_resource_share_permission;

mod enable_sharing_with_aws_organization;

mod get_permission;

mod get_resource_policies;

mod get_resource_share_associations;

mod get_resource_share_invitations;

mod get_resource_shares;

mod list_pending_invitation_resources;

mod list_permission_associations;

mod list_permission_versions;

mod list_permissions;

mod list_principals;

mod list_replace_permission_associations_work;

mod list_resource_share_permissions;
...
mod reject_resource_share_invitation;

mod replace_permission_associations;

mod set_default_permission_version;

mod tag_resource;

mod untag_resource;

mod update_resource_share;
