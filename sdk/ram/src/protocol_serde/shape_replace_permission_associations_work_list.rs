...
pub(crate) fn de_replace_permission_associations_work_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::ReplacePermissionAssociationsWork>>, ::aws_smithy_json::deserialize::error::DeserializeError>
