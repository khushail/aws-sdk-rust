...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_resourcegroupstagging::Error> {
/// # let client: aws_sdk_resourcegroupstagging::Client = unimplemented!();
/// use ::http::header::{HeaderName, HeaderValue};
/// 
/// let result = client.describe_report_creation()
///     .customize()
///     .await?
///     .mutate_request(|req| {
...
mod describe_report_creation;

mod get_compliance_summary;
