...
impl super::Client  {
    ...
    ///   - [`pagination_token(impl ::std::convert::Into<String>)`](crate::operation::get_tag_values::builders::GetTagValuesFluentBuilder::pagination_token) / [`set_pagination_token(Option<String>)`](crate::operation::get_tag_values::builders::GetTagValuesFluentBuilder::set_pagination_token): <p>Specifies a <code>PaginationToken</code> response value from a previous request to indicate that you want the next page of results. Leave this parameter empty in your initial request.</p>
    ///   - [`key(impl ::std::convert::Into<String>)`](crate::operation::get_tag_values::builders::GetTagValuesFluentBuilder::key) / [`set_key(Option<String>)`](crate::operation::get_tag_values::builders::GetTagValuesFluentBuilder::set_key): <p>Specifies the tag key for which you want to list all existing values that are currently used in the specified Amazon Web Services Region for the calling account.</p>
