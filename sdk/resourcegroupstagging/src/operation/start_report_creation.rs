...
impl StartReportCreationInput {
    /// Consumes the builder and constructs an Operation<[`StartReportCreation`](crate::operation::start_report_creation::StartReportCreation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_report_creation::StartReportCreation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_report_creation::StartReportCreationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_report_creation::StartReportCreation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartReportCreation", "resourcegroupstaggingapi"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartReportCreation`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartReportCreation {
                type Output = ::std::result::Result<crate::operation::start_report_creation::StartReportCreationOutput, crate::operation::start_report_creation::StartReportCreationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_report_creation::de_start_report_creation_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_report_creation::de_start_report_creation_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_report_creation::StartReportCreationError {
...
mod _start_report_creation_output;
