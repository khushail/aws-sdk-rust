...
impl GetTrafficPolicyInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_traffic_policy_instance::GetTrafficPolicyInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
