...
impl ChangeCidrCollectionInput {
    /// Consumes the builder and constructs an Operation<[`ChangeCidrCollection`](crate::operation::change_cidr_collection::ChangeCidrCollection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::change_cidr_collection::ChangeCidrCollection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::change_cidr_collection::ChangeCidrCollectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::change_cidr_collection::ChangeCidrCollection::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ChangeCidrCollection", "route53"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ChangeCidrCollection`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ChangeCidrCollection {
                type Output = ::std::result::Result<crate::operation::change_cidr_collection::ChangeCidrCollectionOutput, crate::operation::change_cidr_collection::ChangeCidrCollectionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_change_cidr_collection::de_change_cidr_collection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_change_cidr_collection::de_change_cidr_collection_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::change_cidr_collection::ChangeCidrCollectionError {
