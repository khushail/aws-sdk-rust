...
impl CreateTrafficPolicyInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_traffic_policy_instance::CreateTrafficPolicyInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
