...
impl DeleteKeySigningKeyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteKeySigningKey`](crate::operation::delete_key_signing_key::DeleteKeySigningKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_key_signing_key::DeleteKeySigningKey, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_key_signing_key::DeleteKeySigningKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2013-04-01/keysigningkey/{HostedZoneId}/{Name}", HostedZoneId = hosted_zone_id, Name = name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_key_signing_key::DeleteKeySigningKey::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteKeySigningKey {
                type Output = ::std::result::Result<crate::operation::delete_key_signing_key::DeleteKeySigningKeyOutput, crate::operation::delete_key_signing_key::DeleteKeySigningKeyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_key_signing_key::de_delete_key_signing_key_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_key_signing_key::DeleteKeySigningKeyError {
