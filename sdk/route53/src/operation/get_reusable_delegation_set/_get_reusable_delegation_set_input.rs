...
impl GetReusableDelegationSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetInput, ::aws_smithy_http::operation::error::BuildError> {
