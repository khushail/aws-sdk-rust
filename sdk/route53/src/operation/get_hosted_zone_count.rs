...
impl GetHostedZoneCountInput {
    /// Consumes the builder and constructs an Operation<[`GetHostedZoneCount`](crate::operation::get_hosted_zone_count::GetHostedZoneCount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_hosted_zone_count::GetHostedZoneCount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_hosted_zone_count::GetHostedZoneCountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_hosted_zone_count::GetHostedZoneCount::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHostedZoneCount {
                type Output = ::std::result::Result<crate::operation::get_hosted_zone_count::GetHostedZoneCountOutput, crate::operation::get_hosted_zone_count::GetHostedZoneCountError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_hosted_zone_count::GetHostedZoneCountError {
