...
impl GetHealthCheckCountInput {
    /// Consumes the builder and constructs an Operation<[`GetHealthCheckCount`](crate::operation::get_health_check_count::GetHealthCheckCount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_health_check_count::GetHealthCheckCount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_health_check_count::GetHealthCheckCountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_health_check_count::GetHealthCheckCount::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHealthCheckCount {
                type Output = ::std::result::Result<crate::operation::get_health_check_count::GetHealthCheckCountOutput, crate::operation::get_health_check_count::GetHealthCheckCountError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_health_check_count::de_get_health_check_count_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_health_check_count::GetHealthCheckCountError {
