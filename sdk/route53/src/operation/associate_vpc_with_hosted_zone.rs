...
impl AssociateVpcWithHostedZoneInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_vpc_with_hosted_zone::AssociateVPCWithHostedZone, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_vpc_with_hosted_zone::AssociateVpcWithHostedZoneInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2013-04-01/hostedzone/{HostedZoneId}/associatevpc", HostedZoneId = hosted_zone_id).expect("formatting should succeed");
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateVPCWithHostedZone {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_associate_vpc_with_hosted_zone::de_associate_vpc_with_hosted_zone_http_response_with_props(status, headers, body)
                     }
                }
