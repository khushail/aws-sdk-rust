...
impl UpdateHealthCheckInput {
    /// Consumes the builder and constructs an Operation<[`UpdateHealthCheck`](crate::operation::update_health_check::UpdateHealthCheck)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_health_check::UpdateHealthCheck, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_health_check::UpdateHealthCheckInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if health_check_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("health_check_id", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_health_check::UpdateHealthCheck::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateHealthCheck {
                type Output = ::std::result::Result<crate::operation::update_health_check::UpdateHealthCheckOutput, crate::operation::update_health_check::UpdateHealthCheckError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_health_check::de_update_health_check_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_health_check::UpdateHealthCheckError {
