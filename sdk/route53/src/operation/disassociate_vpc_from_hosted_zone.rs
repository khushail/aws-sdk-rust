...
impl DisassociateVpcFromHostedZoneInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateVPCFromHostedZone`](crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVPCFromHostedZone)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVPCFromHostedZone, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVpcFromHostedZoneInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2013-04-01/hostedzone/{HostedZoneId}/disassociatevpc", HostedZoneId = hosted_zone_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVPCFromHostedZone::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateVPCFromHostedZone {
                type Output = ::std::result::Result<crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVpcFromHostedZoneOutput, crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVPCFromHostedZoneError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_disassociate_vpc_from_hosted_zone::de_disassociate_vpc_from_hosted_zone_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVPCFromHostedZoneError {
