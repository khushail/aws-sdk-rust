...
impl DeleteQueryLoggingConfigInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.delete_query_logging_config();
...
impl DeleteQueryLoggingConfigFluentBuilder  {
    ...
    /// Access the DeleteQueryLoggingConfig as a reference.
    pub fn as_input(&self) -> &crate::operation::delete_query_logging_config::builders::DeleteQueryLoggingConfigInputBuilder {
        &self.inner
    }
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            ...
                            ::aws_smithy_http::result::SdkError<crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigError>
                        >  {
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigOutput, ::aws_smithy_http::result::SdkError<crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigOutput, ::aws_smithy_http::result::SdkError<crate::operation::delete_query_logging_config::DeleteQueryLoggingConfigError>>
                             {
