...
impl DisableHostedZoneDnssecInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDNSSEC, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2013-04-01/hostedzone/{HostedZoneId}/disable-dnssec", HostedZoneId = hosted_zone_id).expect("formatting should succeed");
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableHostedZoneDNSSEC {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_disable_hosted_zone_dnssec::de_disable_hosted_zone_dnssec_http_response_with_props(status, headers, body)
                     }
                }
