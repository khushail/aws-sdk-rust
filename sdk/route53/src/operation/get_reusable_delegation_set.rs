...
impl GetReusableDelegationSetInput {
    /// Consumes the builder and constructs an Operation<[`GetReusableDelegationSet`](crate::operation::get_reusable_delegation_set::GetReusableDelegationSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_reusable_delegation_set::GetReusableDelegationSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_reusable_delegation_set::GetReusableDelegationSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_reusable_delegation_set::GetReusableDelegationSet::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReusableDelegationSet {
                type Output = ::std::result::Result<crate::operation::get_reusable_delegation_set::GetReusableDelegationSetOutput, crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_reusable_delegation_set::de_get_reusable_delegation_set_http_response_with_props(status, headers, body)
                     }
                }
...
mod get_reusable_delegation_set_request_test {
    ...
    async fn get_reusable_delegation_set_trim_delegation_set_id_request() {
        ...
        let result = client.get_reusable_delegation_set()
        .set_id(
...
impl ::aws_http::request_id::RequestId for crate::operation::get_reusable_delegation_set::GetReusableDelegationSetError {
