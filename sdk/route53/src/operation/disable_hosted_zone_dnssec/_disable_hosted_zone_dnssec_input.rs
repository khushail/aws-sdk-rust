...
impl DisableHostedZoneDnssecInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disable_hosted_zone_dnssec::DisableHostedZoneDnssecInput, ::aws_smithy_http::operation::error::BuildError> {
