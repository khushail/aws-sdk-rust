...
impl DeleteReusableDelegationSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_reusable_delegation_set::DeleteReusableDelegationSetInput, ::aws_smithy_http::operation::error::BuildError> {
