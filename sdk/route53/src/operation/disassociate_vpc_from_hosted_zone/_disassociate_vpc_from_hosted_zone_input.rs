...
impl DisassociateVpcFromHostedZoneInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_vpc_from_hosted_zone::DisassociateVpcFromHostedZoneInput, ::aws_smithy_http::operation::error::BuildError> {
