...
impl GetAccountLimitInput {
    /// Consumes the builder and constructs an Operation<[`GetAccountLimit`](crate::operation::get_account_limit::GetAccountLimit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_account_limit::GetAccountLimit, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_account_limit::GetAccountLimitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.r#type;
                let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("r#type", "cannot be empty or unset"))?;
                let r#type = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
                if r#type.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("r#type", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/2013-04-01/accountlimit/{Type}", Type = r#type).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_account_limit::GetAccountLimit::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccountLimit {
                type Output = ::std::result::Result<crate::operation::get_account_limit::GetAccountLimitOutput, crate::operation::get_account_limit::GetAccountLimitError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_account_limit::de_get_account_limit_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_account_limit::GetAccountLimitError {
