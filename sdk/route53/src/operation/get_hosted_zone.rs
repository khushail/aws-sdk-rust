...
impl GetHostedZoneInput {
    /// Consumes the builder and constructs an Operation<[`GetHostedZone`](crate::operation::get_hosted_zone::GetHostedZone)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_hosted_zone::GetHostedZone, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_hosted_zone::GetHostedZoneInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_hosted_zone::GetHostedZone::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetHostedZone {
                type Output = ::std::result::Result<crate::operation::get_hosted_zone::GetHostedZoneOutput, crate::operation::get_hosted_zone::GetHostedZoneError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_hosted_zone::de_get_hosted_zone_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_hosted_zone::GetHostedZoneError {
