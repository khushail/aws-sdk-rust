...
pub fn de_test_dns_answer_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::test_dns_answer::TestDnsAnswerOutput, crate::operation::test_dns_answer::TestDNSAnswerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::test_dns_answer::TestDNSAnswerError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(_response_body, output).map_err(crate::operation::test_dns_answer::TestDNSAnswerError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_no_such_hosted_zone::de_no_such_hosted_zone_xml_err(_response_body, output).map_err(crate::operation::test_dns_answer::TestDNSAnswerError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_test_dns_answer_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::test_dns_answer::TestDnsAnswerOutput, crate::operation::test_dns_answer::TestDNSAnswerError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::test_dns_answer::builders::TestDnsAnswerOutputBuilder::default();
        output = crate::protocol_serde::shape_test_dns_answer::de_test_dns_answer(_response_body, output).map_err(crate::operation::test_dns_answer::TestDNSAnswerError::unhandled)?;
