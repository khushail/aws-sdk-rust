...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_traffic_policy_instances_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesOutput, crate::operation::list_traffic_policy_instances::ListTrafficPolicyInstancesError> {
    Ok({
        #[allow(unused_mut)]
