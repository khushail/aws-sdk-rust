...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_resource_record_sets_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_resource_record_sets::ListResourceRecordSetsOutput, crate::operation::list_resource_record_sets::ListResourceRecordSetsError> {
    Ok({
        #[allow(unused_mut)]
