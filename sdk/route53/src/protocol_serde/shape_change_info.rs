...
pub fn de_change_info(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ChangeInfo, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::ChangeInfo::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Status") /* Status com.amazonaws.route53#ChangeInfo$Status */ =>  {
                let var_2 =
                    Some(
                        Result::<crate::types::ChangeStatus, ::aws_smithy_xml::decode::XmlDecodeError>::Ok(
                            crate::types::ChangeStatus::from(
                                ::aws_smithy_xml::decode::try_data(&mut tag)?.as_ref()
                            )
                        )
                        ?
