...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_vpc_association_authorizations_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_vpc_association_authorizations::ListVpcAssociationAuthorizationsOutput, crate::operation::list_vpc_association_authorizations::ListVPCAssociationAuthorizationsError> {
    Ok({
        #[allow(unused_mut)]
