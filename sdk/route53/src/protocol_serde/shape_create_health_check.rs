...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_health_check_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_health_check::CreateHealthCheckOutput, crate::operation::create_health_check::CreateHealthCheckError> {
    Ok({
        #[allow(unused_mut)]
