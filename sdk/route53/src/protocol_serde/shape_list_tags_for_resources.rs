...
pub fn ser_list_tags_for_resources_op_input(input: &crate::operation::list_tags_for_resources::ListTagsForResourcesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_tags_for_resources_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_tags_for_resources::ListTagsForResourcesOutput, crate::operation::list_tags_for_resources::ListTagsForResourcesError> {
    Ok({
        #[allow(unused_mut)]
