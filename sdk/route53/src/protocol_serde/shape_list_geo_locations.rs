...
pub fn de_list_geo_locations_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_geo_locations::ListGeoLocationsOutput, crate::operation::list_geo_locations::ListGeoLocationsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::list_geo_locations::ListGeoLocationsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_input::de_invalid_input_xml_err(_response_body, output).map_err(crate::operation::list_geo_locations::ListGeoLocationsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_geo_locations_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_geo_locations::ListGeoLocationsOutput, crate::operation::list_geo_locations::ListGeoLocationsError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_geo_locations::builders::ListGeoLocationsOutputBuilder::default();
        output = crate::protocol_serde::shape_list_geo_locations::de_list_geo_locations(_response_body, output).map_err(crate::operation::list_geo_locations::ListGeoLocationsError::unhandled)?;
