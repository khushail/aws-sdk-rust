...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_reusable_delegation_sets_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsOutput, crate::operation::list_reusable_delegation_sets::ListReusableDelegationSetsError> {
    Ok({
        #[allow(unused_mut)]
