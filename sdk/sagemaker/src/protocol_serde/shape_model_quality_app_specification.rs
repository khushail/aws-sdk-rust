...
pub fn ser_model_quality_app_specification(
    ...
    if let Some(var_10) = &input.problem_type {
        object.key("ProblemType").string(var_10.as_str());
    }
    if let Some(var_11) = &input.environment {
        #[allow(unused_mut)]
        let mut object_12 = object.key("Environment").start_object();
...
pub(crate) fn de_model_quality_app_specification<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ModelQualityAppSpecification>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::ModelQualityAppSpecificationBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "ProblemType" => {
                                builder = builder.set_problem_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::MonitoringProblemType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
