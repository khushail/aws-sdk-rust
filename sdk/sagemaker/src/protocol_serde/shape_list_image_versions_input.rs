...
pub fn ser_list_image_versions_input(
    ...
    if let Some(var_4) = &input.last_modified_time_after {
        object.key("LastModifiedTimeAfter").date_time(var_4, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
    if let Some(var_5) = &input.last_modified_time_before {
        object.key("LastModifiedTimeBefore").date_time(var_5, ::aws_smithy_types::date_time::Format::EpochSeconds)?;
    }
