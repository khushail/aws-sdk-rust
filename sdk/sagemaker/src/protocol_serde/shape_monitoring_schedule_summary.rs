...
pub(crate) fn de_monitoring_schedule_summary<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MonitoringScheduleSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
