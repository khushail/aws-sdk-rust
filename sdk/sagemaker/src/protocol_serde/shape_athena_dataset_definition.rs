...
pub fn ser_athena_dataset_definition(
    ...
    if let Some(var_8) = &input.output_compression {
        object.key("OutputCompression").string(var_8.as_str());
    }
    Ok(())
}

pub(crate) fn de_athena_dataset_definition<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AthenaDatasetDefinition>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::AthenaDatasetDefinitionBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "OutputFormat" => {
                                builder = builder.set_output_format(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AthenaResultFormat::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "OutputCompression" => {
                                builder = builder.set_output_compression(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AthenaResultCompressionType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
