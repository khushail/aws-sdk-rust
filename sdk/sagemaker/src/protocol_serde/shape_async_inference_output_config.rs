...
pub fn ser_async_inference_output_config(
                     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                     input: &crate::types::AsyncInferenceOutputConfig,
    ...
    if let Some(var_3) = &input.notification_config {
        #[allow(unused_mut)]
        let mut object_4 = object.key("NotificationConfig").start_object();
...
pub(crate) fn de_async_inference_output_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AsyncInferenceOutputConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::AsyncInferenceOutputConfigBuilder::default();
            loop {
                match tokens.next().transpose()? {
