...
pub(crate) fn de_recommendation_metrics<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RecommendationMetrics>, ::aws_smithy_json::deserialize::error::DeserializeError>
