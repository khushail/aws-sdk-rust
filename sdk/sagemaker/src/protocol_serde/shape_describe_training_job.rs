...
pub fn de_describe_training_job_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_training_job::DescribeTrainingJobOutput, crate::operation::describe_training_job::DescribeTrainingJobError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_training_job::DescribeTrainingJobError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_resource_not_found::de_resource_not_found_json_err(_response_body, output).map_err(crate::operation::describe_training_job::DescribeTrainingJobError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_training_job_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_training_job::DescribeTrainingJobOutput, crate::operation::describe_training_job::DescribeTrainingJobError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_training_job::builders::DescribeTrainingJobOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_training_job::de_describe_training_job(_response_body, output).map_err(crate::operation::describe_training_job::DescribeTrainingJobError::unhandled)?;
