...
pub fn ser_auto_ml_problem_type_config(object_9: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AutoMlProblemTypeConfig) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
        ...
        crate::types::AutoMlProblemTypeConfig::Unknown => return Err(::aws_smithy_http::operation::error::SerializationError::unknown_variant("AutoMlProblemTypeConfig"))
    }
    Ok(())
}

pub(crate) fn de_auto_ml_problem_type_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AutoMlProblemTypeConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
