...
pub fn ser_describe_action_input(input: &crate::operation::describe_action::DescribeActionInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_describe_action_input::ser_describe_action_input(&mut object, input)?;
    object.finish();
...
pub fn de_describe_action_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_action::DescribeActionOutput, crate::operation::describe_action::DescribeActionError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::describe_action::DescribeActionError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "ResourceNotFound" => crate::operation::describe_action::DescribeActionError::ResourceNotFound({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::describe_action::DescribeActionError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_action_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_action::DescribeActionOutput, crate::operation::describe_action::DescribeActionError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_describe_action(value: &[u8], mut builder: crate::operation::describe_action::builders::DescribeActionOutputBuilder) -> Result<crate::operation::describe_action::builders::DescribeActionOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
