...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_algorithm_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_algorithm::CreateAlgorithmOutput, crate::operation::create_algorithm::CreateAlgorithmError> {
    Ok({
        #[allow(unused_mut)]
