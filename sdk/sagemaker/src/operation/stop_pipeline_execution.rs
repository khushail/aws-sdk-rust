...
impl StopPipelineExecutionInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_pipeline_execution::StopPipelineExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_pipeline_execution::StopPipelineExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_pipeline_execution::StopPipelineExecution::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopPipelineExecution", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopPipelineExecution {
                type Output = ::std::result::Result<crate::operation::stop_pipeline_execution::StopPipelineExecutionOutput, crate::operation::stop_pipeline_execution::StopPipelineExecutionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_stop_pipeline_execution::de_stop_pipeline_execution_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_pipeline_execution::StopPipelineExecutionError {
...
impl StopPipelineExecutionError {
    ...
    /// Returns `true` if the error kind is `StopPipelineExecutionError::ResourceNotFound`.
