...
/// Paginator for [`ListEdgePackagingJobs`](crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobs)
            ...
            impl ListEdgePackagingJobsPaginator  {
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError>>> + ::std::marker::Unpin
                 {
...
/// Flattened paginator for `ListEdgePackagingJobsPaginator`
                ...
                impl  ListEdgePackagingJobsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::EdgePackagingJobSummary, ::aws_smithy_http::result::SdkError<crate::operation::list_edge_packaging_jobs::ListEdgePackagingJobsError>>> + ::std::marker::Unpin
                     {
