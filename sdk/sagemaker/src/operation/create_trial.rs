...
impl CreateTrialInput {
    /// Consumes the builder and constructs an Operation<[`CreateTrial`](crate::operation::create_trial::CreateTrial)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_trial::CreateTrial, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_trial::CreateTrialInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_trial::ser_create_trial_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_trial::CreateTrial::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateTrial", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateTrial`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrial {
                type Output = ::std::result::Result<crate::operation::create_trial::CreateTrialOutput, crate::operation::create_trial::CreateTrialError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_trial::de_create_trial_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_trial::de_create_trial_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateTrialErrorKind = CreateTrialError;
/// Error type for the `CreateTrialError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateTrialError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateTrialError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_trial::CreateTrialError {
...
impl CreateTrialError {
    /// Creates the `CreateTrialError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateTrialError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateTrialError::ResourceLimitExceeded`.
    pub fn is_resource_limit_exceeded(&self) -> bool {
        matches!(self, Self::ResourceLimitExceeded(_))
    }
    /// Returns `true` if the error kind is `CreateTrialError::ResourceNotFound`.
