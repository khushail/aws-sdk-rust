...
impl RegisterDevicesInput {
    /// Consumes the builder and constructs an Operation<[`RegisterDevices`](crate::operation::register_devices::RegisterDevices)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_devices::RegisterDevices, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_devices::RegisterDevicesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_devices::ser_register_devices_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_devices::RegisterDevices::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RegisterDevices", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterDevices {
                type Output = ::std::result::Result<crate::operation::register_devices::RegisterDevicesOutput, crate::operation::register_devices::RegisterDevicesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_register_devices::de_register_devices_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_register_devices::de_register_devices_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type RegisterDevicesErrorKind = RegisterDevicesError;
/// Error type for the `RegisterDevicesError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for RegisterDevicesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RegisterDevicesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::register_devices::RegisterDevicesError {
...
impl RegisterDevicesError {
    /// Creates the `RegisterDevicesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RegisterDevicesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `RegisterDevicesError::ResourceLimitExceeded`.
