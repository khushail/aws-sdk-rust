...
impl CreateModelBiasJobDefinitionInput {
    /// Consumes the builder and constructs an Operation<[`CreateModelBiasJobDefinition`](crate::operation::create_model_bias_job_definition::CreateModelBiasJobDefinition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_model_bias_job_definition::CreateModelBiasJobDefinition, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_model_bias_job_definition::CreateModelBiasJobDefinitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_model_bias_job_definition::ser_create_model_bias_job_definition_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_model_bias_job_definition::CreateModelBiasJobDefinition::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateModelBiasJobDefinition", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateModelBiasJobDefinition`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateModelBiasJobDefinition {
                type Output = ::std::result::Result<crate::operation::create_model_bias_job_definition::CreateModelBiasJobDefinitionOutput, crate::operation::create_model_bias_job_definition::CreateModelBiasJobDefinitionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_model_bias_job_definition::de_create_model_bias_job_definition_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_model_bias_job_definition::de_create_model_bias_job_definition_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateModelBiasJobDefinitionErrorKind = CreateModelBiasJobDefinitionError;
/// Error type for the `CreateModelBiasJobDefinitionError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateModelBiasJobDefinitionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateModelBiasJobDefinitionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_model_bias_job_definition::CreateModelBiasJobDefinitionError {
...
impl CreateModelBiasJobDefinitionError {
    /// Creates the `CreateModelBiasJobDefinitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateModelBiasJobDefinitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateModelBiasJobDefinitionError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateModelBiasJobDefinitionError::ResourceLimitExceeded`.
...
mod _create_model_bias_job_definition_output;
