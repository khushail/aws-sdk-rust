...
impl DescribeStudioLifecycleConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_studio_lifecycle_config::DescribeStudioLifecycleConfigInput, ::aws_smithy_http::operation::error::BuildError> {
