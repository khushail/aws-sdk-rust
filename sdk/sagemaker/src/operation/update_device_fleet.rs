...
impl UpdateDeviceFleetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDeviceFleet`](crate::operation::update_device_fleet::UpdateDeviceFleet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_device_fleet::UpdateDeviceFleet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_device_fleet::UpdateDeviceFleetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_device_fleet::ser_update_device_fleet_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_device_fleet::UpdateDeviceFleet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDeviceFleet", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDeviceFleet {
                type Output = ::std::result::Result<crate::operation::update_device_fleet::UpdateDeviceFleetOutput, crate::operation::update_device_fleet::UpdateDeviceFleetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_device_fleet::de_update_device_fleet_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_device_fleet::de_update_device_fleet_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateDeviceFleetErrorKind = UpdateDeviceFleetError;
/// Error type for the `UpdateDeviceFleetError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateDeviceFleetError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateDeviceFleetError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_device_fleet::UpdateDeviceFleetError {
...
impl UpdateDeviceFleetError {
    /// Creates the `UpdateDeviceFleetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateDeviceFleetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateDeviceFleetError::ResourceInUse`.
...
mod _update_device_fleet_output;
