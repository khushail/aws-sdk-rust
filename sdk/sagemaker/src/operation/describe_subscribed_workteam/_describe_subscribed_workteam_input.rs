...
impl DescribeSubscribedWorkteamInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_subscribed_workteam::DescribeSubscribedWorkteamInput, ::aws_smithy_http::operation::error::BuildError> {
