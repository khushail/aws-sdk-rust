...
impl CreatePresignedDomainUrlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_presigned_domain_url::CreatePresignedDomainUrlInput, ::aws_smithy_http::operation::error::BuildError> {
