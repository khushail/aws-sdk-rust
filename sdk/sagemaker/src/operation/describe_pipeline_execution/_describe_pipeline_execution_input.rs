...
impl DescribePipelineExecutionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_pipeline_execution::DescribePipelineExecutionInput, ::aws_smithy_http::operation::error::BuildError> {
