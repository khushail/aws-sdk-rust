...
impl DeleteImageInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_image::DeleteImage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_image::DeleteImage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteImage", "sagemaker"));
...
impl DeleteImageError {
    ...
    /// Returns `true` if the error kind is `DeleteImageError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `DeleteImageError::ResourceNotFound`.
