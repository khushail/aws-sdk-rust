...
impl CreateImageVersionInput {
    /// Consumes the builder and constructs an Operation<[`CreateImageVersion`](crate::operation::create_image_version::CreateImageVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_image_version::CreateImageVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_image_version::CreateImageVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_image_version::ser_create_image_version_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_image_version::CreateImageVersion::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateImageVersion", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateImageVersion`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateImageVersion {
                type Output = ::std::result::Result<crate::operation::create_image_version::CreateImageVersionOutput, crate::operation::create_image_version::CreateImageVersionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_image_version::de_create_image_version_http_error(status, headers, body)
                     } else {
...
/// Do not use this.
            ...
            pub type CreateImageVersionErrorKind = CreateImageVersionError;
/// Error type for the `CreateImageVersionError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateImageVersionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateImageVersionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_image_version::CreateImageVersionError {
...
impl CreateImageVersionError {
    /// Creates the `CreateImageVersionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateImageVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateImageVersionError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateImageVersionError::ResourceLimitExceeded`.
    pub fn is_resource_limit_exceeded(&self) -> bool {
        matches!(self, Self::ResourceLimitExceeded(_))
    }
    /// Returns `true` if the error kind is `CreateImageVersionError::ResourceNotFound`.
...
mod _create_image_version_output;
