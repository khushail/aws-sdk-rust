...
impl DescribeHyperParameterTuningJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_hyper_parameter_tuning_job::DescribeHyperParameterTuningJobInput, ::aws_smithy_http::operation::error::BuildError> {
