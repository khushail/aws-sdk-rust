...
impl DescribeModelCardExportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_model_card_export_job::DescribeModelCardExportJobInput, ::aws_smithy_http::operation::error::BuildError> {
