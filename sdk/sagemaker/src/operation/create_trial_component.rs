...
impl CreateTrialComponentInput {
    /// Consumes the builder and constructs an Operation<[`CreateTrialComponent`](crate::operation::create_trial_component::CreateTrialComponent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_trial_component::CreateTrialComponent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_trial_component::CreateTrialComponentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_trial_component::ser_create_trial_component_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_trial_component::CreateTrialComponent::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateTrialComponent", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTrialComponent {
                type Output = ::std::result::Result<crate::operation::create_trial_component::CreateTrialComponentOutput, crate::operation::create_trial_component::CreateTrialComponentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_trial_component::de_create_trial_component_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_trial_component::de_create_trial_component_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateTrialComponentErrorKind = CreateTrialComponentError;
/// Error type for the `CreateTrialComponentError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateTrialComponentError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateTrialComponentError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_trial_component::CreateTrialComponentError {
...
impl CreateTrialComponentError {
    /// Creates the `CreateTrialComponentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateTrialComponentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateTrialComponentError::ResourceLimitExceeded`.
...
mod _create_trial_component_output;
