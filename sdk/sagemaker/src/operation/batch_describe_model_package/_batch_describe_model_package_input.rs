...
impl BatchDescribeModelPackageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_describe_model_package::BatchDescribeModelPackageInput, ::aws_smithy_http::operation::error::BuildError> {
