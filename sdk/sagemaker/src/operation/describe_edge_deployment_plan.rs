...
impl DescribeEdgeDeploymentPlanInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEdgeDeploymentPlan`](crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlan, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_edge_deployment_plan::ser_describe_edge_deployment_plan_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlan::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeEdgeDeploymentPlan", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeEdgeDeploymentPlan`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEdgeDeploymentPlan {
                type Output = ::std::result::Result<crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlanOutput, crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlanError>;
...
/// Do not use this.
            ...
            pub type DescribeEdgeDeploymentPlanErrorKind = DescribeEdgeDeploymentPlanError;
/// Error type for the `DescribeEdgeDeploymentPlanError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DescribeEdgeDeploymentPlanError {
    /// <p>Resource being access is not found.</p>
    ResourceNotFound(crate::types::error::ResourceNotFound),
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeEdgeDeploymentPlanError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeEdgeDeploymentPlanError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_edge_deployment_plan::DescribeEdgeDeploymentPlanError {
...
impl DescribeEdgeDeploymentPlanError {
    /// Creates the `DescribeEdgeDeploymentPlanError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeEdgeDeploymentPlanError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeEdgeDeploymentPlanError::ResourceNotFound`.
...
mod _describe_edge_deployment_plan_output;
