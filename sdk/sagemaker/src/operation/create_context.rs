...
impl CreateContextInput {
    /// Consumes the builder and constructs an Operation<[`CreateContext`](crate::operation::create_context::CreateContext)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_context::CreateContext, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_context::CreateContextInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_context::ser_create_context_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_context::CreateContext::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateContext", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateContext {
                type Output = ::std::result::Result<crate::operation::create_context::CreateContextOutput, crate::operation::create_context::CreateContextError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_context::de_create_context_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateContextErrorKind = CreateContextError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateContextError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_context::CreateContextError {
...
impl CreateContextError {
    /// Creates the `CreateContextError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateContextError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateContextError::ResourceLimitExceeded`.
