...
impl DeleteModelPackageGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_model_package_group::DeleteModelPackageGroupInput, ::aws_smithy_http::operation::error::BuildError> {
