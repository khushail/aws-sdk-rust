...
impl ListLabelingJobsForWorkteamInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteamInput, ::aws_smithy_http::operation::error::BuildError> {
