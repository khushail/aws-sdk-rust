...
impl RenderUiTemplateInput {
    /// Consumes the builder and constructs an Operation<[`RenderUiTemplate`](crate::operation::render_ui_template::RenderUiTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::render_ui_template::RenderUiTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::render_ui_template::RenderUiTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_render_ui_template::ser_render_ui_template_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::render_ui_template::RenderUiTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RenderUiTemplate", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RenderUiTemplate {
                type Output = ::std::result::Result<crate::operation::render_ui_template::RenderUiTemplateOutput, crate::operation::render_ui_template::RenderUiTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_render_ui_template::de_render_ui_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_render_ui_template::de_render_ui_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type RenderUiTemplateErrorKind = RenderUiTemplateError;
/// Error type for the `RenderUiTemplateError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for RenderUiTemplateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RenderUiTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::render_ui_template::RenderUiTemplateError {
...
impl RenderUiTemplateError {
    /// Creates the `RenderUiTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RenderUiTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `RenderUiTemplateError::ResourceNotFound`.
...
mod _render_ui_template_output;
