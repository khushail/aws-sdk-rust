...
impl StopEdgeDeploymentStageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_edge_deployment_stage::StopEdgeDeploymentStageInput, ::aws_smithy_http::operation::error::BuildError> {
