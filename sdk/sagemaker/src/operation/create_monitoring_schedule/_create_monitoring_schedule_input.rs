...
impl CreateMonitoringScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_monitoring_schedule::CreateMonitoringScheduleInput, ::aws_smithy_http::operation::error::BuildError> {
