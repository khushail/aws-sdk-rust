...
impl CreateDeviceFleetInput {
    /// Consumes the builder and constructs an Operation<[`CreateDeviceFleet`](crate::operation::create_device_fleet::CreateDeviceFleet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_device_fleet::CreateDeviceFleet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_device_fleet::CreateDeviceFleetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_device_fleet::ser_create_device_fleet_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_device_fleet::CreateDeviceFleet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDeviceFleet", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateDeviceFleet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDeviceFleet {
                type Output = ::std::result::Result<crate::operation::create_device_fleet::CreateDeviceFleetOutput, crate::operation::create_device_fleet::CreateDeviceFleetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_device_fleet::de_create_device_fleet_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_device_fleet::de_create_device_fleet_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateDeviceFleetErrorKind = CreateDeviceFleetError;
/// Error type for the `CreateDeviceFleetError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateDeviceFleetError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateDeviceFleetError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_device_fleet::CreateDeviceFleetError {
...
impl CreateDeviceFleetError {
    /// Creates the `CreateDeviceFleetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateDeviceFleetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateDeviceFleetError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateDeviceFleetError::ResourceLimitExceeded`.
...
mod _create_device_fleet_output;
