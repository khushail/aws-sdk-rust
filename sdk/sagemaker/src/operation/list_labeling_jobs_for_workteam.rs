...
impl ListLabelingJobsForWorkteamInput {
    /// Consumes the builder and constructs an Operation<[`ListLabelingJobsForWorkteam`](crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteam)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteam, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_labeling_jobs_for_workteam::ser_list_labeling_jobs_for_workteam_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteam::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListLabelingJobsForWorkteam", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLabelingJobsForWorkteam {
                type Output = ::std::result::Result<crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteamOutput, crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteamError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_labeling_jobs_for_workteam::de_list_labeling_jobs_for_workteam_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_labeling_jobs_for_workteam::de_list_labeling_jobs_for_workteam_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListLabelingJobsForWorkteamErrorKind = ListLabelingJobsForWorkteamError;
/// Error type for the `ListLabelingJobsForWorkteamError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListLabelingJobsForWorkteamError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListLabelingJobsForWorkteamError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_labeling_jobs_for_workteam::ListLabelingJobsForWorkteamError {
...
impl ListLabelingJobsForWorkteamError {
    /// Creates the `ListLabelingJobsForWorkteamError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListLabelingJobsForWorkteamError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListLabelingJobsForWorkteamError::ResourceNotFound`.
...
mod _list_labeling_jobs_for_workteam_output;
