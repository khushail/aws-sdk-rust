...
impl DeleteModelQualityJobDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_model_quality_job_definition::DeleteModelQualityJobDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
