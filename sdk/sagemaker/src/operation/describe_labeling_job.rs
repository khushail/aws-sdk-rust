...
impl DescribeLabelingJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLabelingJob`](crate::operation::describe_labeling_job::DescribeLabelingJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_labeling_job::DescribeLabelingJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_labeling_job::DescribeLabelingJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_labeling_job::ser_describe_labeling_job_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_labeling_job::DescribeLabelingJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeLabelingJob", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeLabelingJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLabelingJob {
                type Output = ::std::result::Result<crate::operation::describe_labeling_job::DescribeLabelingJobOutput, crate::operation::describe_labeling_job::DescribeLabelingJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_labeling_job::de_describe_labeling_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_labeling_job::de_describe_labeling_job_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeLabelingJobErrorKind = DescribeLabelingJobError;
/// Error type for the `DescribeLabelingJobError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeLabelingJobError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeLabelingJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_labeling_job::DescribeLabelingJobError {
...
impl DescribeLabelingJobError {
    /// Creates the `DescribeLabelingJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeLabelingJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeLabelingJobError::ResourceNotFound`.
...
mod _describe_labeling_job_output;
