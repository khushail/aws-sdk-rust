...
impl RetryPipelineExecutionInput {
    /// Consumes the builder and constructs an Operation<[`RetryPipelineExecution`](crate::operation::retry_pipeline_execution::RetryPipelineExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::retry_pipeline_execution::RetryPipelineExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::retry_pipeline_execution::RetryPipelineExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_retry_pipeline_execution::ser_retry_pipeline_execution_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::retry_pipeline_execution::RetryPipelineExecution::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RetryPipelineExecution", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RetryPipelineExecution {
                type Output = ::std::result::Result<crate::operation::retry_pipeline_execution::RetryPipelineExecutionOutput, crate::operation::retry_pipeline_execution::RetryPipelineExecutionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_retry_pipeline_execution::de_retry_pipeline_execution_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_retry_pipeline_execution::de_retry_pipeline_execution_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type RetryPipelineExecutionErrorKind = RetryPipelineExecutionError;
/// Error type for the `RetryPipelineExecutionError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum RetryPipelineExecutionError {
...
impl ::aws_smithy_http::result::CreateUnhandledError for RetryPipelineExecutionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RetryPipelineExecutionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::retry_pipeline_execution::RetryPipelineExecutionError {
...
impl RetryPipelineExecutionError {
    /// Creates the `RetryPipelineExecutionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RetryPipelineExecutionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `RetryPipelineExecutionError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `RetryPipelineExecutionError::ResourceLimitExceeded`.
    pub fn is_resource_limit_exceeded(&self) -> bool {
        matches!(self, Self::ResourceLimitExceeded(_))
    }
    /// Returns `true` if the error kind is `RetryPipelineExecutionError::ResourceNotFound`.
...
mod _retry_pipeline_execution_output;
