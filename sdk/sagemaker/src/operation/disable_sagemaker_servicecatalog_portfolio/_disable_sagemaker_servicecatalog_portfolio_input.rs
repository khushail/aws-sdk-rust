...
impl DisableSagemakerServicecatalogPortfolioInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disable_sagemaker_servicecatalog_portfolio::DisableSagemakerServicecatalogPortfolioInput, ::aws_smithy_http::operation::error::BuildError> {
