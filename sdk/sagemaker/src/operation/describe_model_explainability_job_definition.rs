...
impl DescribeModelExplainabilityJobDefinitionInput {
    /// Consumes the builder and constructs an Operation<[`DescribeModelExplainabilityJobDefinition`](crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinition, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_model_explainability_job_definition::ser_describe_model_explainability_job_definition_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinition::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeModelExplainabilityJobDefinition", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeModelExplainabilityJobDefinition {
                type Output = ::std::result::Result<crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinitionOutput, crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinitionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_model_explainability_job_definition::de_describe_model_explainability_job_definition_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_model_explainability_job_definition::de_describe_model_explainability_job_definition_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeModelExplainabilityJobDefinitionErrorKind = DescribeModelExplainabilityJobDefinitionError;
/// Error type for the `DescribeModelExplainabilityJobDefinitionError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeModelExplainabilityJobDefinitionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeModelExplainabilityJobDefinitionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_model_explainability_job_definition::DescribeModelExplainabilityJobDefinitionError {
...
impl DescribeModelExplainabilityJobDefinitionError {
    /// Creates the `DescribeModelExplainabilityJobDefinitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeModelExplainabilityJobDefinitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeModelExplainabilityJobDefinitionError::ResourceNotFound`.
...
mod _describe_model_explainability_job_definition_output;
