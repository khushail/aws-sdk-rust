...
impl DescribeContextInput {
    /// Consumes the builder and constructs an Operation<[`DescribeContext`](crate::operation::describe_context::DescribeContext)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_context::DescribeContext, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_context::DescribeContextInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_context::ser_describe_context_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_context::DescribeContext::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeContext", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeContext`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeContext {
                type Output = ::std::result::Result<crate::operation::describe_context::DescribeContextOutput, crate::operation::describe_context::DescribeContextError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_context::de_describe_context_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_context::de_describe_context_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeContextErrorKind = DescribeContextError;
/// Error type for the `DescribeContextError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeContextError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeContextError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_context::DescribeContextError {
...
impl DescribeContextError {
    /// Creates the `DescribeContextError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeContextError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeContextError::ResourceNotFound`.
