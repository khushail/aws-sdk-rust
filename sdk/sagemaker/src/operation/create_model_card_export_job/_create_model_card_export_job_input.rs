...
impl CreateModelCardExportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_model_card_export_job::CreateModelCardExportJobInput, ::aws_smithy_http::operation::error::BuildError> {
