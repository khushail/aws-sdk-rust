...
impl DeleteUserProfileInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_user_profile::DeleteUserProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user_profile::DeleteUserProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_profile::DeleteUserProfile::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteUserProfile", "sagemaker"));
...
impl DeleteUserProfileError {
    ...
    /// Returns `true` if the error kind is `DeleteUserProfileError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `DeleteUserProfileError::ResourceNotFound`.
