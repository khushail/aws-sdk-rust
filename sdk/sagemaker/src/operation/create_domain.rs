...
impl CreateDomainInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_domain::CreateDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_domain::CreateDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDomain", "sagemaker"));
...
impl CreateDomainError {
    ...
    /// Returns `true` if the error kind is `CreateDomainError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateDomainError::ResourceLimitExceeded`.
