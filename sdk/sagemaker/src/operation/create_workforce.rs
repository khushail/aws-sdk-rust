...
impl CreateWorkforceInput {
    /// Consumes the builder and constructs an Operation<[`CreateWorkforce`](crate::operation::create_workforce::CreateWorkforce)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_workforce::CreateWorkforce, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_workforce::CreateWorkforceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_workforce::ser_create_workforce_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_workforce::CreateWorkforce::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateWorkforce", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateWorkforce`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWorkforce {
                type Output = ::std::result::Result<crate::operation::create_workforce::CreateWorkforceOutput, crate::operation::create_workforce::CreateWorkforceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_workforce::de_create_workforce_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_workforce::de_create_workforce_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateWorkforceErrorKind = CreateWorkforceError;
/// Error type for the `CreateWorkforceError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateWorkforceError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateWorkforceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_workforce::CreateWorkforceError {
...
impl CreateWorkforceError {
    /// Creates the `CreateWorkforceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateWorkforceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
