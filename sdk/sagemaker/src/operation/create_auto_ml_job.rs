...
impl CreateAutoMlJobInput {
    /// Consumes the builder and constructs an Operation<[`CreateAutoMLJob`](crate::operation::create_auto_ml_job::CreateAutoMLJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_auto_ml_job::CreateAutoMLJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_auto_ml_job::CreateAutoMlJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_auto_ml_job::ser_create_auto_ml_job_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_auto_ml_job::CreateAutoMLJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAutoMLJob", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateAutoMLJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAutoMLJob {
                type Output = ::std::result::Result<crate::operation::create_auto_ml_job::CreateAutoMlJobOutput, crate::operation::create_auto_ml_job::CreateAutoMLJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_auto_ml_job::de_create_auto_ml_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_auto_ml_job::de_create_auto_ml_job_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateAutoMLJobErrorKind = CreateAutoMLJobError;
/// Error type for the `CreateAutoMLJobError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateAutoMLJobError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateAutoMLJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_auto_ml_job::CreateAutoMLJobError {
...
impl CreateAutoMLJobError {
    /// Creates the `CreateAutoMLJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateAutoMLJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateAutoMLJobError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateAutoMLJobError::ResourceLimitExceeded`.
...
mod _create_auto_ml_job_output;
