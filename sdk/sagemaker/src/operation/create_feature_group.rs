...
impl CreateFeatureGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateFeatureGroup`](crate::operation::create_feature_group::CreateFeatureGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_feature_group::CreateFeatureGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_feature_group::CreateFeatureGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_feature_group::ser_create_feature_group_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_feature_group::CreateFeatureGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateFeatureGroup", "sagemaker"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateFeatureGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFeatureGroup {
                type Output = ::std::result::Result<crate::operation::create_feature_group::CreateFeatureGroupOutput, crate::operation::create_feature_group::CreateFeatureGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_feature_group::de_create_feature_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_feature_group::de_create_feature_group_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateFeatureGroupErrorKind = CreateFeatureGroupError;
/// Error type for the `CreateFeatureGroupError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateFeatureGroupError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateFeatureGroupError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_feature_group::CreateFeatureGroupError {
...
impl CreateFeatureGroupError {
    /// Creates the `CreateFeatureGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateFeatureGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateFeatureGroupError::ResourceInUse`.
    pub fn is_resource_in_use(&self) -> bool {
        matches!(self, Self::ResourceInUse(_))
    }
    /// Returns `true` if the error kind is `CreateFeatureGroupError::ResourceLimitExceeded`.
...
mod _create_feature_group_output;
