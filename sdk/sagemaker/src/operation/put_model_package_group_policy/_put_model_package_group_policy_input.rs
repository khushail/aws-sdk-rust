...
impl PutModelPackageGroupPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_model_package_group_policy::PutModelPackageGroupPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
