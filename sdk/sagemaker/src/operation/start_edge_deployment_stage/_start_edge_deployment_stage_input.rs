...
impl StartEdgeDeploymentStageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_edge_deployment_stage::StartEdgeDeploymentStageInput, ::aws_smithy_http::operation::error::BuildError> {
