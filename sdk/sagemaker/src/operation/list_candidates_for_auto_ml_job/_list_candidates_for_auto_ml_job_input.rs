...
impl ListCandidatesForAutoMlJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_candidates_for_auto_ml_job::ListCandidatesForAutoMlJobInput, ::aws_smithy_http::operation::error::BuildError> {
