...
/// Paginator for [`ListSubscribedWorkteams`](crate::operation::list_subscribed_workteams::ListSubscribedWorkteams)
            ...
            impl ListSubscribedWorkteamsPaginator  {
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::list_subscribed_workteams::ListSubscribedWorkteamsOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_subscribed_workteams::ListSubscribedWorkteamsError>>> + ::std::marker::Unpin
                 {
...
/// Flattened paginator for `ListSubscribedWorkteamsPaginator`
                ...
                impl  ListSubscribedWorkteamsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::SubscribedWorkteam, ::aws_smithy_http::result::SdkError<crate::operation::list_subscribed_workteams::ListSubscribedWorkteamsError>>> + ::std::marker::Unpin
                     {
