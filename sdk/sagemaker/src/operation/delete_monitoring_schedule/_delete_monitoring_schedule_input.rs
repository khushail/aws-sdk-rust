...
impl DeleteMonitoringScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_monitoring_schedule::DeleteMonitoringScheduleInput, ::aws_smithy_http::operation::error::BuildError> {
