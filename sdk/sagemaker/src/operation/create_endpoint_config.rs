...
impl CreateEndpointConfigInput {
    /// Consumes the builder and constructs an Operation<[`CreateEndpointConfig`](crate::operation::create_endpoint_config::CreateEndpointConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_endpoint_config::CreateEndpointConfig, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_endpoint_config::CreateEndpointConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_endpoint_config::ser_create_endpoint_config_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_endpoint_config::CreateEndpointConfig::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateEndpointConfig", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEndpointConfig {
                type Output = ::std::result::Result<crate::operation::create_endpoint_config::CreateEndpointConfigOutput, crate::operation::create_endpoint_config::CreateEndpointConfigError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_endpoint_config::de_create_endpoint_config_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_endpoint_config::de_create_endpoint_config_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateEndpointConfigErrorKind = CreateEndpointConfigError;
/// Error type for the `CreateEndpointConfigError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateEndpointConfigError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateEndpointConfigError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_endpoint_config::CreateEndpointConfigError {
...
impl CreateEndpointConfigError {
    /// Creates the `CreateEndpointConfigError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateEndpointConfigError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateEndpointConfigError::ResourceLimitExceeded`.
...
mod _create_endpoint_config_output;
