...
impl ListCandidatesForAutoMlJobInput {
    /// Consumes the builder and constructs an Operation<[`ListCandidatesForAutoMLJob`](crate::operation::list_candidates_for_auto_ml_job::ListCandidatesForAutoMLJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_candidates_for_auto_ml_job::ListCandidatesForAutoMLJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_candidates_for_auto_ml_job::ListCandidatesForAutoMlJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_candidates_for_auto_ml_job::ser_list_candidates_for_auto_ml_job_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_candidates_for_auto_ml_job::ListCandidatesForAutoMLJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListCandidatesForAutoMLJob", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCandidatesForAutoMLJob {
                type Output = ::std::result::Result<crate::operation::list_candidates_for_auto_ml_job::ListCandidatesForAutoMlJobOutput, crate::operation::list_candidates_for_auto_ml_job::ListCandidatesForAutoMLJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_candidates_for_auto_ml_job::de_list_candidates_for_auto_ml_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_candidates_for_auto_ml_job::de_list_candidates_for_auto_ml_job_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListCandidatesForAutoMLJobErrorKind = ListCandidatesForAutoMLJobError;
/// Error type for the `ListCandidatesForAutoMLJobError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListCandidatesForAutoMLJobError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListCandidatesForAutoMLJobError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_candidates_for_auto_ml_job::ListCandidatesForAutoMLJobError {
...
impl ListCandidatesForAutoMLJobError {
    /// Creates the `ListCandidatesForAutoMLJobError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCandidatesForAutoMLJobError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListCandidatesForAutoMLJobError::ResourceNotFound`.
...
mod _list_candidates_for_auto_ml_job_output;
