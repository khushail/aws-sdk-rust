...
impl ListAlgorithmsInput {
    /// Consumes the builder and constructs an Operation<[`ListAlgorithms`](crate::operation::list_algorithms::ListAlgorithms)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_algorithms::ListAlgorithms, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_algorithms::ListAlgorithmsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_algorithms::ser_list_algorithms_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_algorithms::ListAlgorithms::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAlgorithms", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAlgorithms {
                type Output = ::std::result::Result<crate::operation::list_algorithms::ListAlgorithmsOutput, crate::operation::list_algorithms::ListAlgorithmsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_algorithms::de_list_algorithms_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_algorithms::de_list_algorithms_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListAlgorithmsErrorKind = ListAlgorithmsError;
/// Error type for the `ListAlgorithmsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ListAlgorithmsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListAlgorithmsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_algorithms::ListAlgorithmsError {
...
impl ListAlgorithmsError {
    /// Creates the `ListAlgorithmsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListAlgorithmsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
