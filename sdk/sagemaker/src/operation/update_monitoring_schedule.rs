...
impl UpdateMonitoringScheduleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMonitoringSchedule`](crate::operation::update_monitoring_schedule::UpdateMonitoringSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_monitoring_schedule::UpdateMonitoringSchedule, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_monitoring_schedule::UpdateMonitoringScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_monitoring_schedule::ser_update_monitoring_schedule_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_monitoring_schedule::UpdateMonitoringSchedule::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateMonitoringSchedule", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMonitoringSchedule {
                type Output = ::std::result::Result<crate::operation::update_monitoring_schedule::UpdateMonitoringScheduleOutput, crate::operation::update_monitoring_schedule::UpdateMonitoringScheduleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_monitoring_schedule::de_update_monitoring_schedule_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_monitoring_schedule::de_update_monitoring_schedule_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateMonitoringScheduleErrorKind = UpdateMonitoringScheduleError;
/// Error type for the `UpdateMonitoringScheduleError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateMonitoringScheduleError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateMonitoringScheduleError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_monitoring_schedule::UpdateMonitoringScheduleError {
...
impl UpdateMonitoringScheduleError {
    /// Creates the `UpdateMonitoringScheduleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateMonitoringScheduleError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateMonitoringScheduleError::ResourceLimitExceeded`.
    pub fn is_resource_limit_exceeded(&self) -> bool {
        matches!(self, Self::ResourceLimitExceeded(_))
    }
    /// Returns `true` if the error kind is `UpdateMonitoringScheduleError::ResourceNotFound`.
...
mod _update_monitoring_schedule_output;
