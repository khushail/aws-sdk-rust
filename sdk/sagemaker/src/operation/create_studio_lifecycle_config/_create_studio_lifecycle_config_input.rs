...
impl CreateStudioLifecycleConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_studio_lifecycle_config::CreateStudioLifecycleConfigInput, ::aws_smithy_http::operation::error::BuildError> {
