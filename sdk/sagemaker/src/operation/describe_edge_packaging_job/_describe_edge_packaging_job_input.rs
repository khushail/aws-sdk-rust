...
impl DescribeEdgePackagingJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_edge_packaging_job::DescribeEdgePackagingJobInput, ::aws_smithy_http::operation::error::BuildError> {
