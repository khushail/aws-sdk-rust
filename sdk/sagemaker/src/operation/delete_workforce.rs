...
impl DeleteWorkforceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteWorkforce`](crate::operation::delete_workforce::DeleteWorkforce)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_workforce::DeleteWorkforce, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_workforce::DeleteWorkforceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_workforce::ser_delete_workforce_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_workforce::DeleteWorkforce::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteWorkforce", "sagemaker"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteWorkforce {
                type Output = ::std::result::Result<crate::operation::delete_workforce::DeleteWorkforceOutput, crate::operation::delete_workforce::DeleteWorkforceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_workforce::de_delete_workforce_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_workforce::de_delete_workforce_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteWorkforceErrorKind = DeleteWorkforceError;
/// Error type for the `DeleteWorkforceError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteWorkforceError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteWorkforceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_workforce::DeleteWorkforceError {
...
impl DeleteWorkforceError {
    /// Creates the `DeleteWorkforceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteWorkforceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
