...
impl super::Client  {
    ...
    ///   - [`app_image_config_name(impl ::std::convert::Into<String>)`](crate::operation::update_app_image_config::builders::UpdateAppImageConfigFluentBuilder::app_image_config_name) / [`set_app_image_config_name(Option<String>)`](crate::operation::update_app_image_config::builders::UpdateAppImageConfigFluentBuilder::set_app_image_config_name): <p>The name of the AppImageConfig to update.</p>
