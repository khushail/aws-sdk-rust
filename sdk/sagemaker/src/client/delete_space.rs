...
impl super::Client  {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::delete_space::builders::DeleteSpaceFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::delete_space::builders::DeleteSpaceFluentBuilder::set_domain_id): <p>The ID of the associated Domain.</p>
