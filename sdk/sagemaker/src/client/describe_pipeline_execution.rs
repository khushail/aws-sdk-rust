...
impl super::Client  {
    ...
    ///   - [`pipeline_execution_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_pipeline_execution::builders::DescribePipelineExecutionFluentBuilder::pipeline_execution_arn) / [`set_pipeline_execution_arn(Option<String>)`](crate::operation::describe_pipeline_execution::builders::DescribePipelineExecutionFluentBuilder::set_pipeline_execution_arn): <p>The Amazon Resource Name (ARN) of the pipeline execution.</p>
