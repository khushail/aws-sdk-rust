...
impl super::Client  {
    ...
    ///   - [`resource(ResourceType)`](crate::operation::search::builders::SearchFluentBuilder::resource) / [`set_resource(Option<ResourceType>)`](crate::operation::search::builders::SearchFluentBuilder::set_resource): <p>The name of the SageMaker resource to search for.</p>
    ...
    ///   - [`sort_by(impl ::std::convert::Into<String>)`](crate::operation::search::builders::SearchFluentBuilder::sort_by) / [`set_sort_by(Option<String>)`](crate::operation::search::builders::SearchFluentBuilder::set_sort_by): <p>The name of the resource property used to sort the <code>SearchResults</code>. The default is <code>LastModifiedTime</code>.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search::builders::SearchFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search::builders::SearchFluentBuilder::set_next_token): <p>If more than <code>MaxResults</code> resources match the specified <code>SearchExpression</code>, the response includes a <code>NextToken</code>. The <code>NextToken</code> can be passed to the next <code>SearchRequest</code> to continue retrieving results.</p>
