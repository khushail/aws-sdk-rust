...
impl super::Client  {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::create_presigned_domain_url::builders::CreatePresignedDomainUrlFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::create_presigned_domain_url::builders::CreatePresignedDomainUrlFluentBuilder::set_domain_id): <p>The domain ID.</p>
    ///   - [`user_profile_name(impl ::std::convert::Into<String>)`](crate::operation::create_presigned_domain_url::builders::CreatePresignedDomainUrlFluentBuilder::user_profile_name) / [`set_user_profile_name(Option<String>)`](crate::operation::create_presigned_domain_url::builders::CreatePresignedDomainUrlFluentBuilder::set_user_profile_name): <p>The name of the UserProfile to sign-in as.</p>
    ...
    ///   - [`space_name(impl ::std::convert::Into<String>)`](crate::operation::create_presigned_domain_url::builders::CreatePresignedDomainUrlFluentBuilder::space_name) / [`set_space_name(Option<String>)`](crate::operation::create_presigned_domain_url::builders::CreatePresignedDomainUrlFluentBuilder::set_space_name): <p>The name of the space.</p>
