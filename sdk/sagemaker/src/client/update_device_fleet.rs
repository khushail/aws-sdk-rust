...
impl super::Client  {
    ...
    ///   - [`device_fleet_name(impl ::std::convert::Into<String>)`](crate::operation::update_device_fleet::builders::UpdateDeviceFleetFluentBuilder::device_fleet_name) / [`set_device_fleet_name(Option<String>)`](crate::operation::update_device_fleet::builders::UpdateDeviceFleetFluentBuilder::set_device_fleet_name): <p>The name of the fleet.</p>
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::update_device_fleet::builders::UpdateDeviceFleetFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::update_device_fleet::builders::UpdateDeviceFleetFluentBuilder::set_role_arn): <p>The Amazon Resource Name (ARN) of the device.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_device_fleet::builders::UpdateDeviceFleetFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_device_fleet::builders::UpdateDeviceFleetFluentBuilder::set_description): <p>Description of the fleet.</p>
