...
impl super::Client  {
    ...
    ///   - [`image_name(impl ::std::convert::Into<String>)`](crate::operation::describe_image::builders::DescribeImageFluentBuilder::image_name) / [`set_image_name(Option<String>)`](crate::operation::describe_image::builders::DescribeImageFluentBuilder::set_image_name): <p>The name of the image to describe.</p>
