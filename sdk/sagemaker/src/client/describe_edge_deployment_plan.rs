...
impl super::Client  {
    ...
    ///   - [`edge_deployment_plan_name(impl ::std::convert::Into<String>)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::edge_deployment_plan_name) / [`set_edge_deployment_plan_name(Option<String>)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::set_edge_deployment_plan_name): <p>The name of the deployment plan to describe.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_edge_deployment_plan::builders::DescribeEdgeDeploymentPlanFluentBuilder::set_next_token): <p>If the edge deployment plan has enough stages to require tokening, then this is the response from the last list of stages returned.</p>
