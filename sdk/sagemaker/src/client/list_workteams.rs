...
impl super::Client  {
    ...
    ///   - [`name_contains(impl ::std::convert::Into<String>)`](crate::operation::list_workteams::builders::ListWorkteamsFluentBuilder::name_contains) / [`set_name_contains(Option<String>)`](crate::operation::list_workteams::builders::ListWorkteamsFluentBuilder::set_name_contains): <p>A string in the work team's name. This filter returns only work teams whose name contains the specified string.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_workteams::builders::ListWorkteamsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_workteams::builders::ListWorkteamsFluentBuilder::set_next_token): <p>If the result of the previous <code>ListWorkteams</code> request was truncated, the response includes a <code>NextToken</code>. To retrieve the next set of labeling jobs, use the token in the next request.</p>
