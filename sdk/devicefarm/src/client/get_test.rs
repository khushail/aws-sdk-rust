...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_test::builders::GetTestFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_test::builders::GetTestFluentBuilder::set_arn): <p>The test's ARN.</p>
