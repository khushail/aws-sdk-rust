...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::list_samples::builders::ListSamplesFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::list_samples::builders::ListSamplesFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) of the job used to list samples.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_samples::builders::ListSamplesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_samples::builders::ListSamplesFluentBuilder::set_next_token): <p>An identifier that was returned from the previous call to this operation, which can be used to return the next set of items in the list.</p>
