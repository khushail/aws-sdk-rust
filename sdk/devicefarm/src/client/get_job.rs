...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_job::builders::GetJobFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_job::builders::GetJobFluentBuilder::set_arn): <p>The job's ARN.</p>
