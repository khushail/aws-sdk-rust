...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_test_grid_session_actions::builders::ListTestGridSessionActionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_test_grid_session_actions::builders::ListTestGridSessionActionsFluentBuilder::set_next_token): <p>Pagination token.</p>
