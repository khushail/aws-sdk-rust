...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_project::builders::GetProjectFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_project::builders::GetProjectFluentBuilder::set_arn): <p>The project's ARN.</p>
