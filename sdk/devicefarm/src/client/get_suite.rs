...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_suite::builders::GetSuiteFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_suite::builders::GetSuiteFluentBuilder::set_arn): <p>The suite's ARN.</p>
