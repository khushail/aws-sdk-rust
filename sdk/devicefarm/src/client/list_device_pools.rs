...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::list_device_pools::builders::ListDevicePoolsFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::list_device_pools::builders::ListDevicePoolsFluentBuilder::set_arn): <p>The project ARN.</p>
