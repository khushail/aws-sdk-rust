...
impl ListTestGridProjectsInput {
    /// Consumes the builder and constructs an Operation<[`ListTestGridProjects`](crate::operation::list_test_grid_projects::ListTestGridProjects)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_test_grid_projects::ListTestGridProjects, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_test_grid_projects::ListTestGridProjectsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_test_grid_projects::ListTestGridProjects::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTestGridProjects", "devicefarm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListTestGridProjects`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTestGridProjects {
                type Output = ::std::result::Result<crate::operation::list_test_grid_projects::ListTestGridProjectsOutput, crate::operation::list_test_grid_projects::ListTestGridProjectsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_test_grid_projects::de_list_test_grid_projects_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_test_grid_projects::de_list_test_grid_projects_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_test_grid_projects::ListTestGridProjectsError {
...
mod _list_test_grid_projects_output;
