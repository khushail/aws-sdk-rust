...
impl DeleteDevicePoolInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDevicePool`](crate::operation::delete_device_pool::DeleteDevicePool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_device_pool::DeleteDevicePool, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_device_pool::DeleteDevicePoolInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_device_pool::DeleteDevicePool::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDevicePool", "devicefarm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteDevicePool`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDevicePool {
                type Output = ::std::result::Result<crate::operation::delete_device_pool::DeleteDevicePoolOutput, crate::operation::delete_device_pool::DeleteDevicePoolError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_device_pool::de_delete_device_pool_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_device_pool::de_delete_device_pool_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_device_pool::DeleteDevicePoolError {
...
mod _delete_device_pool_output;
