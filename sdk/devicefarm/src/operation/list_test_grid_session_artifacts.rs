...
impl ListTestGridSessionArtifactsInput {
    /// Consumes the builder and constructs an Operation<[`ListTestGridSessionArtifacts`](crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifacts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifacts, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifacts::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTestGridSessionArtifacts {
                type Output = ::std::result::Result<crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsOutput, crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_test_grid_session_artifacts::de_list_test_grid_session_artifacts_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_test_grid_session_artifacts::de_list_test_grid_session_artifacts_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_test_grid_session_artifacts::ListTestGridSessionArtifactsError {
...
pub use crate::operation::list_test_grid_session_artifacts::_list_test_grid_session_artifacts_output::ListTestGridSessionArtifactsOutput;

pub use crate::operation::list_test_grid_session_artifacts::_list_test_grid_session_artifacts_input::ListTestGridSessionArtifactsInput;

mod _list_test_grid_session_artifacts_input;

mod _list_test_grid_session_artifacts_output;
