...
impl ListTestGridSessionsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_test_grid_sessions::ListTestGridSessions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_test_grid_sessions::ListTestGridSessionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `ListTestGridSessions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTestGridSessions {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_test_grid_sessions::de_list_test_grid_sessions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_test_grid_sessions::de_list_test_grid_sessions_http_response_with_props(status, headers, body)
                     }
                }
