...
impl StopRemoteAccessSessionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_remote_access_session::StopRemoteAccessSessionInput, ::aws_smithy_http::operation::error::BuildError> {
