...
impl ListOfferingTransactionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_offering_transactions::ListOfferingTransactionsInput, ::aws_smithy_http::operation::error::BuildError> {
