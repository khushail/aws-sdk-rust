...
impl CreateRemoteAccessSessionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_remote_access_session::CreateRemoteAccessSessionInput, ::aws_smithy_http::operation::error::BuildError> {
