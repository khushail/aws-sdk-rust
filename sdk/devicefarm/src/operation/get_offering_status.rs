...
impl GetOfferingStatusInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_offering_status::GetOfferingStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_offering_status::GetOfferingStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `GetOfferingStatus`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOfferingStatus {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_offering_status::de_get_offering_status_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_offering_status::de_get_offering_status_http_response_with_props(status, headers, body)
                     }
                }
