...
impl DeleteUploadInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUpload`](crate::operation::delete_upload::DeleteUpload)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_upload::DeleteUpload, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_upload::DeleteUploadInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_upload::DeleteUpload::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteUpload", "devicefarm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteUpload`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUpload {
                type Output = ::std::result::Result<crate::operation::delete_upload::DeleteUploadOutput, crate::operation::delete_upload::DeleteUploadError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_upload::de_delete_upload_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_upload::de_delete_upload_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_upload::DeleteUploadError {
...
pub use crate::operation::delete_upload::_delete_upload_output::DeleteUploadOutput;

pub use crate::operation::delete_upload::_delete_upload_input::DeleteUploadInput;

mod _delete_upload_input;

mod _delete_upload_output;
