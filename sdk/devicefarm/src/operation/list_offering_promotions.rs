...
impl ListOfferingPromotionsInput {
    /// Consumes the builder and constructs an Operation<[`ListOfferingPromotions`](crate::operation::list_offering_promotions::ListOfferingPromotions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_offering_promotions::ListOfferingPromotions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_offering_promotions::ListOfferingPromotionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_offering_promotions::ListOfferingPromotions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListOfferingPromotions", "devicefarm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListOfferingPromotions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOfferingPromotions {
                type Output = ::std::result::Result<crate::operation::list_offering_promotions::ListOfferingPromotionsOutput, crate::operation::list_offering_promotions::ListOfferingPromotionsError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_offering_promotions::ListOfferingPromotionsError {
...
mod _list_offering_promotions_output;
