...
impl UpdateDeviceInstanceInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDeviceInstance`](crate::operation::update_device_instance::UpdateDeviceInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_device_instance::UpdateDeviceInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_device_instance::UpdateDeviceInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_device_instance::UpdateDeviceInstance::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDeviceInstance", "devicefarm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateDeviceInstance`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDeviceInstance {
                type Output = ::std::result::Result<crate::operation::update_device_instance::UpdateDeviceInstanceOutput, crate::operation::update_device_instance::UpdateDeviceInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_device_instance::de_update_device_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_device_instance::de_update_device_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_device_instance::UpdateDeviceInstanceError {
...
pub use crate::operation::update_device_instance::_update_device_instance_output::UpdateDeviceInstanceOutput;

pub use crate::operation::update_device_instance::_update_device_instance_input::UpdateDeviceInstanceInput;

mod _update_device_instance_input;

mod _update_device_instance_output;
