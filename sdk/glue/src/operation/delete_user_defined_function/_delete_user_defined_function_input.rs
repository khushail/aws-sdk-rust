...
impl DeleteUserDefinedFunctionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_user_defined_function::DeleteUserDefinedFunctionInput, ::aws_smithy_http::operation::error::BuildError> {
