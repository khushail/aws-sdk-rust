...
impl UpdateCrawlerScheduleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCrawlerSchedule`](crate::operation::update_crawler_schedule::UpdateCrawlerSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_crawler_schedule::UpdateCrawlerSchedule, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_crawler_schedule::UpdateCrawlerScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_crawler_schedule::ser_update_crawler_schedule_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_crawler_schedule::UpdateCrawlerSchedule::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateCrawlerSchedule", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateCrawlerSchedule`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCrawlerSchedule {
                type Output = ::std::result::Result<crate::operation::update_crawler_schedule::UpdateCrawlerScheduleOutput, crate::operation::update_crawler_schedule::UpdateCrawlerScheduleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_crawler_schedule::de_update_crawler_schedule_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_crawler_schedule::de_update_crawler_schedule_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateCrawlerScheduleErrorKind = UpdateCrawlerScheduleError;
/// Error type for the `UpdateCrawlerScheduleError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateCrawlerScheduleError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_crawler_schedule::UpdateCrawlerScheduleError {
...
impl UpdateCrawlerScheduleError {
    /// Creates the `UpdateCrawlerScheduleError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateCrawlerScheduleError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateCrawlerScheduleError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateCrawlerScheduleError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UpdateCrawlerScheduleError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `UpdateCrawlerScheduleError::SchedulerTransitioningException`.
    pub fn is_scheduler_transitioning_exception(&self) -> bool {
        matches!(self, Self::SchedulerTransitioningException(_))
    }
    /// Returns `true` if the error kind is `UpdateCrawlerScheduleError::VersionMismatchException`.
...
mod _update_crawler_schedule_output;
