...
impl DeleteTriggerInput {
    /// Consumes the builder and constructs an Operation<[`DeleteTrigger`](crate::operation::delete_trigger::DeleteTrigger)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_trigger::DeleteTrigger, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_trigger::DeleteTriggerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_trigger::ser_delete_trigger_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_trigger::DeleteTrigger::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteTrigger", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTrigger {
                type Output = ::std::result::Result<crate::operation::delete_trigger::DeleteTriggerOutput, crate::operation::delete_trigger::DeleteTriggerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_trigger::de_delete_trigger_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteTriggerErrorKind = DeleteTriggerError;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_trigger::DeleteTriggerError {
...
impl DeleteTriggerError {
    /// Creates the `DeleteTriggerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteTriggerError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteTriggerError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `DeleteTriggerError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteTriggerError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeleteTriggerError::OperationTimeoutException`.
