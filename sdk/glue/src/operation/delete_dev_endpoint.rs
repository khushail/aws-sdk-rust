...
impl DeleteDevEndpointInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDevEndpoint`](crate::operation::delete_dev_endpoint::DeleteDevEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_dev_endpoint::DeleteDevEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_dev_endpoint::DeleteDevEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_dev_endpoint::ser_delete_dev_endpoint_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_dev_endpoint::DeleteDevEndpoint::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDevEndpoint", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteDevEndpoint`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDevEndpoint {
                type Output = ::std::result::Result<crate::operation::delete_dev_endpoint::DeleteDevEndpointOutput, crate::operation::delete_dev_endpoint::DeleteDevEndpointError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_dev_endpoint::de_delete_dev_endpoint_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_dev_endpoint::de_delete_dev_endpoint_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteDevEndpointErrorKind = DeleteDevEndpointError;
/// Error type for the `DeleteDevEndpointError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteDevEndpointError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_dev_endpoint::DeleteDevEndpointError {
...
impl DeleteDevEndpointError {
    /// Creates the `DeleteDevEndpointError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteDevEndpointError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteDevEndpointError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteDevEndpointError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DeleteDevEndpointError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `DeleteDevEndpointError::OperationTimeoutException`.
...
mod _delete_dev_endpoint_output;
