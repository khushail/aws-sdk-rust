...
impl DeleteSchemaInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_schema::DeleteSchema, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_schema::DeleteSchema::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteSchema", "glue"));
...
impl DeleteSchemaError {
    ...
    /// Returns `true` if the error kind is `DeleteSchemaError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `DeleteSchemaError::EntityNotFoundException`.
