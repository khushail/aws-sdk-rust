...
impl ListRegistriesInput {
    /// Consumes the builder and constructs an Operation<[`ListRegistries`](crate::operation::list_registries::ListRegistries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_registries::ListRegistries, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_registries::ListRegistriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_registries::ser_list_registries_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_registries::ListRegistries::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListRegistries", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRegistries {
                type Output = ::std::result::Result<crate::operation::list_registries::ListRegistriesOutput, crate::operation::list_registries::ListRegistriesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_registries::de_list_registries_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_registries::de_list_registries_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_registries::ListRegistriesError {
...
impl ListRegistriesError {
    ...
    /// Returns `true` if the error kind is `ListRegistriesError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListRegistriesError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ListRegistriesError::InvalidInputException`.
