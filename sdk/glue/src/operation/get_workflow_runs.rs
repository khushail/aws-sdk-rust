...
impl GetWorkflowRunsInput {
    /// Consumes the builder and constructs an Operation<[`GetWorkflowRuns`](crate::operation::get_workflow_runs::GetWorkflowRuns)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_workflow_runs::GetWorkflowRuns, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_workflow_runs::GetWorkflowRunsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_workflow_runs::ser_get_workflow_runs_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_workflow_runs::GetWorkflowRuns::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetWorkflowRuns", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetWorkflowRuns`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWorkflowRuns {
                type Output = ::std::result::Result<crate::operation::get_workflow_runs::GetWorkflowRunsOutput, crate::operation::get_workflow_runs::GetWorkflowRunsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_workflow_runs::de_get_workflow_runs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_workflow_runs::de_get_workflow_runs_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetWorkflowRunsErrorKind = GetWorkflowRunsError;
/// Error type for the `GetWorkflowRunsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetWorkflowRunsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_workflow_runs::GetWorkflowRunsError {
...
impl GetWorkflowRunsError {
    /// Creates the `GetWorkflowRunsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetWorkflowRunsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetWorkflowRunsError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetWorkflowRunsError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetWorkflowRunsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetWorkflowRunsError::OperationTimeoutException`.
...
pub use crate::operation::get_workflow_runs::_get_workflow_runs_output::GetWorkflowRunsOutput;

pub use crate::operation::get_workflow_runs::_get_workflow_runs_input::GetWorkflowRunsInput;

mod _get_workflow_runs_input;

mod _get_workflow_runs_output;
