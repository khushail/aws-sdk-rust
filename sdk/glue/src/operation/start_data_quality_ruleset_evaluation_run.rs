...
impl StartDataQualityRulesetEvaluationRunInput {
    /// Consumes the builder and constructs an Operation<[`StartDataQualityRulesetEvaluationRun`](crate::operation::start_data_quality_ruleset_evaluation_run::StartDataQualityRulesetEvaluationRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_data_quality_ruleset_evaluation_run::StartDataQualityRulesetEvaluationRun, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_data_quality_ruleset_evaluation_run::StartDataQualityRulesetEvaluationRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_data_quality_ruleset_evaluation_run::ser_start_data_quality_ruleset_evaluation_run_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_data_quality_ruleset_evaluation_run::StartDataQualityRulesetEvaluationRun::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartDataQualityRulesetEvaluationRun", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartDataQualityRulesetEvaluationRun`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDataQualityRulesetEvaluationRun {
                type Output = ::std::result::Result<crate::operation::start_data_quality_ruleset_evaluation_run::StartDataQualityRulesetEvaluationRunOutput, crate::operation::start_data_quality_ruleset_evaluation_run::StartDataQualityRulesetEvaluationRunError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_data_quality_ruleset_evaluation_run::de_start_data_quality_ruleset_evaluation_run_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_data_quality_ruleset_evaluation_run::de_start_data_quality_ruleset_evaluation_run_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type StartDataQualityRulesetEvaluationRunErrorKind = StartDataQualityRulesetEvaluationRunError;
/// Error type for the `StartDataQualityRulesetEvaluationRunError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartDataQualityRulesetEvaluationRunError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_data_quality_ruleset_evaluation_run::StartDataQualityRulesetEvaluationRunError {
...
impl StartDataQualityRulesetEvaluationRunError {
    /// Creates the `StartDataQualityRulesetEvaluationRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartDataQualityRulesetEvaluationRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `StartDataQualityRulesetEvaluationRunError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `StartDataQualityRulesetEvaluationRunError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StartDataQualityRulesetEvaluationRunError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StartDataQualityRulesetEvaluationRunError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `StartDataQualityRulesetEvaluationRunError::OperationTimeoutException`.
...
mod _start_data_quality_ruleset_evaluation_run_output;
