...
impl ListBlueprintsInput {
    /// Consumes the builder and constructs an Operation<[`ListBlueprints`](crate::operation::list_blueprints::ListBlueprints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_blueprints::ListBlueprints, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_blueprints::ListBlueprintsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_blueprints::ser_list_blueprints_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_blueprints::ListBlueprints::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListBlueprints", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBlueprints {
                type Output = ::std::result::Result<crate::operation::list_blueprints::ListBlueprintsOutput, crate::operation::list_blueprints::ListBlueprintsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_blueprints::de_list_blueprints_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListBlueprintsErrorKind = ListBlueprintsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_blueprints::ListBlueprintsError {
...
impl ListBlueprintsError {
    /// Creates the `ListBlueprintsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListBlueprintsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListBlueprintsError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ListBlueprintsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListBlueprintsError::OperationTimeoutException`.
