...
impl GetUnfilteredTableMetadataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_unfiltered_table_metadata::GetUnfilteredTableMetadataInput, ::aws_smithy_http::operation::error::BuildError> {
