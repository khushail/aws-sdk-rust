...
impl BatchDeleteTableVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_delete_table_version::BatchDeleteTableVersionInput, ::aws_smithy_http::operation::error::BuildError> {
