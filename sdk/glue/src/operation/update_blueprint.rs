...
impl UpdateBlueprintInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBlueprint`](crate::operation::update_blueprint::UpdateBlueprint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_blueprint::UpdateBlueprint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_blueprint::UpdateBlueprintInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_blueprint::ser_update_blueprint_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_blueprint::UpdateBlueprint::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateBlueprint", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBlueprint {
                type Output = ::std::result::Result<crate::operation::update_blueprint::UpdateBlueprintOutput, crate::operation::update_blueprint::UpdateBlueprintError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_blueprint::de_update_blueprint_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateBlueprintErrorKind = UpdateBlueprintError;
...
impl ::aws_http::request_id::RequestId for crate::operation::update_blueprint::UpdateBlueprintError {
...
impl UpdateBlueprintError {
    /// Creates the `UpdateBlueprintError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateBlueprintError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateBlueprintError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `UpdateBlueprintError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateBlueprintError::IllegalBlueprintStateException`.
    pub fn is_illegal_blueprint_state_exception(&self) -> bool {
        matches!(self, Self::IllegalBlueprintStateException(_))
    }
    /// Returns `true` if the error kind is `UpdateBlueprintError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateBlueprintError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `UpdateBlueprintError::OperationTimeoutException`.
