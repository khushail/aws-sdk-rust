...
impl CheckSchemaVersionValidityInput {
    /// Consumes the builder and constructs an Operation<[`CheckSchemaVersionValidity`](crate::operation::check_schema_version_validity::CheckSchemaVersionValidity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::check_schema_version_validity::CheckSchemaVersionValidity, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::check_schema_version_validity::CheckSchemaVersionValidityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_check_schema_version_validity::ser_check_schema_version_validity_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::check_schema_version_validity::CheckSchemaVersionValidity::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CheckSchemaVersionValidity", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckSchemaVersionValidity {
                type Output = ::std::result::Result<crate::operation::check_schema_version_validity::CheckSchemaVersionValidityOutput, crate::operation::check_schema_version_validity::CheckSchemaVersionValidityError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_check_schema_version_validity::de_check_schema_version_validity_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_check_schema_version_validity::de_check_schema_version_validity_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CheckSchemaVersionValidityErrorKind = CheckSchemaVersionValidityError;
/// Error type for the `CheckSchemaVersionValidityError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CheckSchemaVersionValidityError {
...
impl ::aws_http::request_id::RequestId for crate::operation::check_schema_version_validity::CheckSchemaVersionValidityError {
...
impl CheckSchemaVersionValidityError {
    /// Creates the `CheckSchemaVersionValidityError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CheckSchemaVersionValidityError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CheckSchemaVersionValidityError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CheckSchemaVersionValidityError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CheckSchemaVersionValidityError::InvalidInputException`.
...
mod _check_schema_version_validity_output;
