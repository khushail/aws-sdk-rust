...
impl StartJobRunFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::start_job_run::StartJobRunOutput, ::aws_smithy_http::result::SdkError<crate::operation::start_job_run::StartJobRunError>>
                         {
    ...
    /// <p>The type of predefined worker that is allocated when a job runs. Accepts a value of Standard, G.1X, G.2X, or G.025X for Spark jobs. Accepts the value Z.2X for Ray jobs.</p> 
    /// <ul> 
    ...
    /// <li> <p>For the <code>Z.2X</code> worker type, each worker maps to 2 DPU (8vCPU, 64 GB of m emory, 128 GB disk), and provides up to 8 Ray workers (one per vCPU) based on the autoscaler.</p> </li> 
    /// </ul>
