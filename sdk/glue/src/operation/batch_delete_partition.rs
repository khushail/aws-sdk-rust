...
impl BatchDeletePartitionInput {
    /// Consumes the builder and constructs an Operation<[`BatchDeletePartition`](crate::operation::batch_delete_partition::BatchDeletePartition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_delete_partition::BatchDeletePartition, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_delete_partition::BatchDeletePartitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_delete_partition::ser_batch_delete_partition_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_delete_partition::BatchDeletePartition::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchDeletePartition", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeletePartition {
                type Output = ::std::result::Result<crate::operation::batch_delete_partition::BatchDeletePartitionOutput, crate::operation::batch_delete_partition::BatchDeletePartitionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_delete_partition::de_batch_delete_partition_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_delete_partition::de_batch_delete_partition_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type BatchDeletePartitionErrorKind = BatchDeletePartitionError;
/// Error type for the `BatchDeletePartitionError` operation.
#[non_exhaustive]
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_delete_partition::BatchDeletePartitionError {
...
impl BatchDeletePartitionError {
    /// Creates the `BatchDeletePartitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `BatchDeletePartitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `BatchDeletePartitionError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `BatchDeletePartitionError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `BatchDeletePartitionError::OperationTimeoutException`.
...
mod _batch_delete_partition_output;
