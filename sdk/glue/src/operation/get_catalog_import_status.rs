...
impl GetCatalogImportStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetCatalogImportStatus`](crate::operation::get_catalog_import_status::GetCatalogImportStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_catalog_import_status::GetCatalogImportStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_catalog_import_status::GetCatalogImportStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_catalog_import_status::ser_get_catalog_import_status_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_catalog_import_status::GetCatalogImportStatus::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCatalogImportStatus", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetCatalogImportStatus`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCatalogImportStatus {
                type Output = ::std::result::Result<crate::operation::get_catalog_import_status::GetCatalogImportStatusOutput, crate::operation::get_catalog_import_status::GetCatalogImportStatusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_catalog_import_status::de_get_catalog_import_status_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_catalog_import_status::de_get_catalog_import_status_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetCatalogImportStatusErrorKind = GetCatalogImportStatusError;
/// Error type for the `GetCatalogImportStatusError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCatalogImportStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_catalog_import_status::GetCatalogImportStatusError {
...
impl GetCatalogImportStatusError {
    /// Creates the `GetCatalogImportStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCatalogImportStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetCatalogImportStatusError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetCatalogImportStatusError::OperationTimeoutException`.
...
mod _get_catalog_import_status_output;
