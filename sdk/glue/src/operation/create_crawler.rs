...
impl CreateCrawlerInput {
    /// Consumes the builder and constructs an Operation<[`CreateCrawler`](crate::operation::create_crawler::CreateCrawler)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_crawler::CreateCrawler, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_crawler::CreateCrawlerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_crawler::ser_create_crawler_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_crawler::CreateCrawler::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateCrawler", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateCrawler`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCrawler {
                type Output = ::std::result::Result<crate::operation::create_crawler::CreateCrawlerOutput, crate::operation::create_crawler::CreateCrawlerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_crawler::de_create_crawler_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_crawler::de_create_crawler_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateCrawlerErrorKind = CreateCrawlerError;
/// Error type for the `CreateCrawlerError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateCrawlerError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_crawler::CreateCrawlerError {
...
impl CreateCrawlerError {
    /// Creates the `CreateCrawlerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateCrawlerError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateCrawlerError::AlreadyExistsException`.
    pub fn is_already_exists_exception(&self) -> bool {
        matches!(self, Self::AlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateCrawlerError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateCrawlerError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `CreateCrawlerError::ResourceNumberLimitExceededException`.
