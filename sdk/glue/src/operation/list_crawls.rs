...
impl ListCrawlsInput {
    /// Consumes the builder and constructs an Operation<[`ListCrawls`](crate::operation::list_crawls::ListCrawls)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_crawls::ListCrawls, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_crawls::ListCrawlsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_crawls::ser_list_crawls_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_crawls::ListCrawls::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListCrawls", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListCrawls`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCrawls {
                type Output = ::std::result::Result<crate::operation::list_crawls::ListCrawlsOutput, crate::operation::list_crawls::ListCrawlsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_crawls::de_list_crawls_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_crawls::de_list_crawls_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListCrawlsErrorKind = ListCrawlsError;
/// Error type for the `ListCrawlsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListCrawlsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_crawls::ListCrawlsError {
...
impl ListCrawlsError {
    /// Creates the `ListCrawlsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCrawlsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListCrawlsError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListCrawlsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListCrawlsError::OperationTimeoutException`.
