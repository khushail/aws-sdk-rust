...
impl CreateSchemaInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_schema::CreateSchema, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_schema::CreateSchemaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_schema::CreateSchema::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateSchema", "glue"));
...
impl CreateSchemaError {
    ...
    /// Returns `true` if the error kind is `CreateSchemaError::AlreadyExistsException`.
    pub fn is_already_exists_exception(&self) -> bool {
        matches!(self, Self::AlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateSchemaError::ConcurrentModificationException`.
    pub fn is_concurrent_modification_exception(&self) -> bool {
        matches!(self, Self::ConcurrentModificationException(_))
    }
    /// Returns `true` if the error kind is `CreateSchemaError::EntityNotFoundException`.
    ...
    /// Returns `true` if the error kind is `CreateSchemaError::ResourceNumberLimitExceededException`.
