...
impl GetJobsInput {
    /// Consumes the builder and constructs an Operation<[`GetJobs`](crate::operation::get_jobs::GetJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_jobs::GetJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_jobs::GetJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_jobs::ser_get_jobs_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_jobs::GetJobs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetJobs", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetJobs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetJobs {
                type Output = ::std::result::Result<crate::operation::get_jobs::GetJobsOutput, crate::operation::get_jobs::GetJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_jobs::de_get_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_jobs::de_get_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetJobsErrorKind = GetJobsError;
/// Error type for the `GetJobsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetJobsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_jobs::GetJobsError {
...
impl GetJobsError {
    /// Creates the `GetJobsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetJobsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetJobsError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetJobsError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetJobsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetJobsError::OperationTimeoutException`.
...
pub use crate::operation::get_jobs::_get_jobs_output::GetJobsOutput;

pub use crate::operation::get_jobs::_get_jobs_input::GetJobsInput;

mod _get_jobs_input;

mod _get_jobs_output;
