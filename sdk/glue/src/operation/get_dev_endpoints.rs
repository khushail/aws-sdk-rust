...
impl GetDevEndpointsInput {
    /// Consumes the builder and constructs an Operation<[`GetDevEndpoints`](crate::operation::get_dev_endpoints::GetDevEndpoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_dev_endpoints::GetDevEndpoints, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_dev_endpoints::GetDevEndpointsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_dev_endpoints::ser_get_dev_endpoints_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_dev_endpoints::GetDevEndpoints::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDevEndpoints", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetDevEndpoints`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDevEndpoints {
                type Output = ::std::result::Result<crate::operation::get_dev_endpoints::GetDevEndpointsOutput, crate::operation::get_dev_endpoints::GetDevEndpointsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_dev_endpoints::de_get_dev_endpoints_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_dev_endpoints::de_get_dev_endpoints_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetDevEndpointsErrorKind = GetDevEndpointsError;
/// Error type for the `GetDevEndpointsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetDevEndpointsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_dev_endpoints::GetDevEndpointsError {
...
impl GetDevEndpointsError {
    /// Creates the `GetDevEndpointsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDevEndpointsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetDevEndpointsError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetDevEndpointsError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetDevEndpointsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetDevEndpointsError::OperationTimeoutException`.
