...
impl ListCustomEntityTypesInput {
    /// Consumes the builder and constructs an Operation<[`ListCustomEntityTypes`](crate::operation::list_custom_entity_types::ListCustomEntityTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_custom_entity_types::ListCustomEntityTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_custom_entity_types::ListCustomEntityTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_custom_entity_types::ser_list_custom_entity_types_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_custom_entity_types::ListCustomEntityTypes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListCustomEntityTypes", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListCustomEntityTypes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCustomEntityTypes {
                type Output = ::std::result::Result<crate::operation::list_custom_entity_types::ListCustomEntityTypesOutput, crate::operation::list_custom_entity_types::ListCustomEntityTypesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_custom_entity_types::de_list_custom_entity_types_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_custom_entity_types::de_list_custom_entity_types_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListCustomEntityTypesErrorKind = ListCustomEntityTypesError;
/// Error type for the `ListCustomEntityTypesError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ListCustomEntityTypesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListCustomEntityTypesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_custom_entity_types::ListCustomEntityTypesError {
...
impl ListCustomEntityTypesError {
    /// Creates the `ListCustomEntityTypesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListCustomEntityTypesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListCustomEntityTypesError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ListCustomEntityTypesError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListCustomEntityTypesError::OperationTimeoutException`.
...
mod _list_custom_entity_types_output;
