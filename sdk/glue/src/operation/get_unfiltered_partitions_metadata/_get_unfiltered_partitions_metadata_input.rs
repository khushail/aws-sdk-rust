...
impl GetUnfilteredPartitionsMetadataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_unfiltered_partitions_metadata::GetUnfilteredPartitionsMetadataInput, ::aws_smithy_http::operation::error::BuildError> {
