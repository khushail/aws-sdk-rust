...
impl GetSchemaVersionInput {
    /// Consumes the builder and constructs an Operation<[`GetSchemaVersion`](crate::operation::get_schema_version::GetSchemaVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_schema_version::GetSchemaVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_schema_version::GetSchemaVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_schema_version::ser_get_schema_version_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_schema_version::GetSchemaVersion::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSchemaVersion", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSchemaVersion {
                type Output = ::std::result::Result<crate::operation::get_schema_version::GetSchemaVersionOutput, crate::operation::get_schema_version::GetSchemaVersionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_schema_version::de_get_schema_version_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetSchemaVersionErrorKind = GetSchemaVersionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_schema_version::GetSchemaVersionError {
...
impl GetSchemaVersionError {
    /// Creates the `GetSchemaVersionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSchemaVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetSchemaVersionError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetSchemaVersionError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetSchemaVersionError::InvalidInputException`.
