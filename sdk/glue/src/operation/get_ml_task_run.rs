...
impl GetMlTaskRunInput {
    /// Consumes the builder and constructs an Operation<[`GetMLTaskRun`](crate::operation::get_ml_task_run::GetMLTaskRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_ml_task_run::GetMLTaskRun, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_ml_task_run::GetMlTaskRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_ml_task_run::ser_get_ml_task_run_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_ml_task_run::GetMLTaskRun::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetMLTaskRun", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetMLTaskRun`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMLTaskRun {
                type Output = ::std::result::Result<crate::operation::get_ml_task_run::GetMlTaskRunOutput, crate::operation::get_ml_task_run::GetMLTaskRunError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_ml_task_run::de_get_ml_task_run_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_ml_task_run::de_get_ml_task_run_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetMLTaskRunErrorKind = GetMLTaskRunError;
/// Error type for the `GetMLTaskRunError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetMLTaskRunError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_ml_task_run::GetMLTaskRunError {
...
impl GetMLTaskRunError {
    /// Creates the `GetMLTaskRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetMLTaskRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetMLTaskRunError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetMLTaskRunError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetMLTaskRunError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetMLTaskRunError::OperationTimeoutException`.
...
pub use crate::operation::get_ml_task_run::_get_ml_task_run_output::GetMlTaskRunOutput;

pub use crate::operation::get_ml_task_run::_get_ml_task_run_input::GetMlTaskRunInput;

mod _get_ml_task_run_input;

mod _get_ml_task_run_output;
