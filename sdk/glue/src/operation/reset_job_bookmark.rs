...
impl ResetJobBookmarkInput {
    /// Consumes the builder and constructs an Operation<[`ResetJobBookmark`](crate::operation::reset_job_bookmark::ResetJobBookmark)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reset_job_bookmark::ResetJobBookmark, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_job_bookmark::ResetJobBookmarkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_job_bookmark::ser_reset_job_bookmark_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reset_job_bookmark::ResetJobBookmark::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResetJobBookmark", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ResetJobBookmark`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetJobBookmark {
                type Output = ::std::result::Result<crate::operation::reset_job_bookmark::ResetJobBookmarkOutput, crate::operation::reset_job_bookmark::ResetJobBookmarkError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_reset_job_bookmark::de_reset_job_bookmark_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_reset_job_bookmark::de_reset_job_bookmark_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ResetJobBookmarkErrorKind = ResetJobBookmarkError;
/// Error type for the `ResetJobBookmarkError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ResetJobBookmarkError {
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_job_bookmark::ResetJobBookmarkError {
...
impl ResetJobBookmarkError {
    /// Creates the `ResetJobBookmarkError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResetJobBookmarkError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ResetJobBookmarkError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ResetJobBookmarkError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ResetJobBookmarkError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ResetJobBookmarkError::OperationTimeoutException`.
...
mod _reset_job_bookmark_output;
