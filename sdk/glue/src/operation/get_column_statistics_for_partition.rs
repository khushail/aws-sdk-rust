...
impl GetColumnStatisticsForPartitionInput {
    /// Consumes the builder and constructs an Operation<[`GetColumnStatisticsForPartition`](crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartition, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_column_statistics_for_partition::ser_get_column_statistics_for_partition_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartition::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetColumnStatisticsForPartition", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetColumnStatisticsForPartition`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetColumnStatisticsForPartition {
                type Output = ::std::result::Result<crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionOutput, crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_column_statistics_for_partition::de_get_column_statistics_for_partition_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_column_statistics_for_partition::de_get_column_statistics_for_partition_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetColumnStatisticsForPartitionErrorKind = GetColumnStatisticsForPartitionError;
/// Error type for the `GetColumnStatisticsForPartitionError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetColumnStatisticsForPartitionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_column_statistics_for_partition::GetColumnStatisticsForPartitionError {
...
impl GetColumnStatisticsForPartitionError {
    /// Creates the `GetColumnStatisticsForPartitionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetColumnStatisticsForPartitionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetColumnStatisticsForPartitionError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetColumnStatisticsForPartitionError::GlueEncryptionException`.
    pub fn is_glue_encryption_exception(&self) -> bool {
        matches!(self, Self::GlueEncryptionException(_))
    }
    /// Returns `true` if the error kind is `GetColumnStatisticsForPartitionError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetColumnStatisticsForPartitionError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetColumnStatisticsForPartitionError::OperationTimeoutException`.
...
mod _get_column_statistics_for_partition_output;
