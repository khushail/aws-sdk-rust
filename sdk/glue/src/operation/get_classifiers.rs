...
impl GetClassifiersInput {
    /// Consumes the builder and constructs an Operation<[`GetClassifiers`](crate::operation::get_classifiers::GetClassifiers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_classifiers::GetClassifiers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_classifiers::GetClassifiersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_classifiers::ser_get_classifiers_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_classifiers::GetClassifiers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetClassifiers", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetClassifiers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetClassifiers {
                type Output = ::std::result::Result<crate::operation::get_classifiers::GetClassifiersOutput, crate::operation::get_classifiers::GetClassifiersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_classifiers::de_get_classifiers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_classifiers::de_get_classifiers_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetClassifiersErrorKind = GetClassifiersError;
/// Error type for the `GetClassifiersError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetClassifiersError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_classifiers::GetClassifiersError {
...
impl GetClassifiersError {
    /// Creates the `GetClassifiersError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetClassifiersError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetClassifiersError::OperationTimeoutException`.
