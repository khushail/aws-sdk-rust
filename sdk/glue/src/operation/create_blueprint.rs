...
impl CreateBlueprintInput {
    /// Consumes the builder and constructs an Operation<[`CreateBlueprint`](crate::operation::create_blueprint::CreateBlueprint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_blueprint::CreateBlueprint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_blueprint::CreateBlueprintInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_blueprint::ser_create_blueprint_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_blueprint::CreateBlueprint::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateBlueprint", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBlueprint {
                type Output = ::std::result::Result<crate::operation::create_blueprint::CreateBlueprintOutput, crate::operation::create_blueprint::CreateBlueprintError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_blueprint::de_create_blueprint_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateBlueprintErrorKind = CreateBlueprintError;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_blueprint::CreateBlueprintError {
...
impl CreateBlueprintError {
    /// Creates the `CreateBlueprintError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateBlueprintError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateBlueprintError::AlreadyExistsException`.
    pub fn is_already_exists_exception(&self) -> bool {
        matches!(self, Self::AlreadyExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateBlueprintError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateBlueprintError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateBlueprintError::OperationTimeoutException`.
    pub fn is_operation_timeout_exception(&self) -> bool {
        matches!(self, Self::OperationTimeoutException(_))
    }
    /// Returns `true` if the error kind is `CreateBlueprintError::ResourceNumberLimitExceededException`.
