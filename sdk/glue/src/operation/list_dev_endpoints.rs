...
impl ListDevEndpointsInput {
    /// Consumes the builder and constructs an Operation<[`ListDevEndpoints`](crate::operation::list_dev_endpoints::ListDevEndpoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_dev_endpoints::ListDevEndpoints, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_dev_endpoints::ListDevEndpointsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_dev_endpoints::ser_list_dev_endpoints_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_dev_endpoints::ListDevEndpoints::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDevEndpoints", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDevEndpoints {
                type Output = ::std::result::Result<crate::operation::list_dev_endpoints::ListDevEndpointsOutput, crate::operation::list_dev_endpoints::ListDevEndpointsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_dev_endpoints::de_list_dev_endpoints_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_dev_endpoints::de_list_dev_endpoints_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListDevEndpointsErrorKind = ListDevEndpointsError;
/// Error type for the `ListDevEndpointsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListDevEndpointsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_dev_endpoints::ListDevEndpointsError {
...
impl ListDevEndpointsError {
    /// Creates the `ListDevEndpointsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDevEndpointsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListDevEndpointsError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListDevEndpointsError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ListDevEndpointsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `ListDevEndpointsError::OperationTimeoutException`.
...
mod _list_dev_endpoints_output;
