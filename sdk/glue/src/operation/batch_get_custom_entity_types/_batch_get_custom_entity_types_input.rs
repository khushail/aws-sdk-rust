...
impl BatchGetCustomEntityTypesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_get_custom_entity_types::BatchGetCustomEntityTypesInput, ::aws_smithy_http::operation::error::BuildError> {
