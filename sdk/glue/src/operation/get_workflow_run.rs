...
impl GetWorkflowRunInput {
    /// Consumes the builder and constructs an Operation<[`GetWorkflowRun`](crate::operation::get_workflow_run::GetWorkflowRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_workflow_run::GetWorkflowRun, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_workflow_run::GetWorkflowRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_workflow_run::ser_get_workflow_run_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_workflow_run::GetWorkflowRun::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetWorkflowRun", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWorkflowRun {
                type Output = ::std::result::Result<crate::operation::get_workflow_run::GetWorkflowRunOutput, crate::operation::get_workflow_run::GetWorkflowRunError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_workflow_run::de_get_workflow_run_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetWorkflowRunErrorKind = GetWorkflowRunError;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_workflow_run::GetWorkflowRunError {
...
impl GetWorkflowRunError {
    /// Creates the `GetWorkflowRunError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetWorkflowRunError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetWorkflowRunError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetWorkflowRunError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetWorkflowRunError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetWorkflowRunError::OperationTimeoutException`.
