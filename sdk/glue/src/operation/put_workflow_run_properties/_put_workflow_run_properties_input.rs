...
impl PutWorkflowRunPropertiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_workflow_run_properties::PutWorkflowRunPropertiesInput, ::aws_smithy_http::operation::error::BuildError> {
