...
impl DeleteClassifierInput {
    /// Consumes the builder and constructs an Operation<[`DeleteClassifier`](crate::operation::delete_classifier::DeleteClassifier)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_classifier::DeleteClassifier, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_classifier::DeleteClassifierInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_classifier::ser_delete_classifier_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_classifier::DeleteClassifier::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteClassifier", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteClassifier`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteClassifier {
                type Output = ::std::result::Result<crate::operation::delete_classifier::DeleteClassifierOutput, crate::operation::delete_classifier::DeleteClassifierError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_classifier::de_delete_classifier_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_classifier::de_delete_classifier_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteClassifierErrorKind = DeleteClassifierError;
/// Error type for the `DeleteClassifierError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteClassifierError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_classifier::DeleteClassifierError {
...
impl DeleteClassifierError {
    /// Creates the `DeleteClassifierError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteClassifierError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteClassifierError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteClassifierError::OperationTimeoutException`.
