...
impl StopCrawlerInput {
    /// Consumes the builder and constructs an Operation<[`StopCrawler`](crate::operation::stop_crawler::StopCrawler)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_crawler::StopCrawler, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_crawler::StopCrawlerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_crawler::ser_stop_crawler_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_crawler::StopCrawler::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopCrawler", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopCrawler {
                type Output = ::std::result::Result<crate::operation::stop_crawler::StopCrawlerOutput, crate::operation::stop_crawler::StopCrawlerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_crawler::de_stop_crawler_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_crawler::de_stop_crawler_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type StopCrawlerErrorKind = StopCrawlerError;
/// Error type for the `StopCrawlerError` operation.
#[non_exhaustive]
...
impl ::std::fmt::Display for StopCrawlerError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            Self::CrawlerNotRunningException(_inner) =>
            _inner.fmt(f)
            ,
            Self::CrawlerStoppingException(_inner) =>
            _inner.fmt(f)
            ,
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopCrawlerError {
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_crawler::StopCrawlerError {
...
impl StopCrawlerError {
    /// Creates the `StopCrawlerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StopCrawlerError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            Self::CrawlerNotRunningException(e) => e.meta(),
            Self::CrawlerStoppingException(e) => e.meta(),
            Self::EntityNotFoundException(e) => e.meta(),
            Self::OperationTimeoutException(e) => e.meta(),
            Self::Unhandled(e) => e.meta(),
        }
    }
    /// Returns `true` if the error kind is `StopCrawlerError::CrawlerNotRunningException`.
    pub fn is_crawler_not_running_exception(&self) -> bool {
        matches!(self, Self::CrawlerNotRunningException(_))
    }
    /// Returns `true` if the error kind is `StopCrawlerError::CrawlerStoppingException`.
    pub fn is_crawler_stopping_exception(&self) -> bool {
        matches!(self, Self::CrawlerStoppingException(_))
    }
    /// Returns `true` if the error kind is `StopCrawlerError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StopCrawlerError::OperationTimeoutException`.
