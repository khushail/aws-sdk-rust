...
impl QuerySchemaVersionMetadataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::query_schema_version_metadata::QuerySchemaVersionMetadataInput, ::aws_smithy_http::operation::error::BuildError> {
