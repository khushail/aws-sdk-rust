...
impl GetSchemaVersionsDiffInput {
    /// Consumes the builder and constructs an Operation<[`GetSchemaVersionsDiff`](crate::operation::get_schema_versions_diff::GetSchemaVersionsDiff)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiff, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_schema_versions_diff::ser_get_schema_versions_diff_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_schema_versions_diff::GetSchemaVersionsDiff::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSchemaVersionsDiff", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetSchemaVersionsDiff`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSchemaVersionsDiff {
                type Output = ::std::result::Result<crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffOutput, crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_schema_versions_diff::de_get_schema_versions_diff_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_schema_versions_diff::de_get_schema_versions_diff_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetSchemaVersionsDiffErrorKind = GetSchemaVersionsDiffError;
/// Error type for the `GetSchemaVersionsDiffError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetSchemaVersionsDiffError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_schema_versions_diff::GetSchemaVersionsDiffError {
...
impl GetSchemaVersionsDiffError {
    /// Creates the `GetSchemaVersionsDiffError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSchemaVersionsDiffError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetSchemaVersionsDiffError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GetSchemaVersionsDiffError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetSchemaVersionsDiffError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetSchemaVersionsDiffError::InvalidInputException`.
...
mod _get_schema_versions_diff_output;
