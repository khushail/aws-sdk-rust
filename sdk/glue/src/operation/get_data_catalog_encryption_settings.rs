...
impl GetDataCatalogEncryptionSettingsInput {
    /// Consumes the builder and constructs an Operation<[`GetDataCatalogEncryptionSettings`](crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_data_catalog_encryption_settings::ser_get_data_catalog_encryption_settings_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDataCatalogEncryptionSettings", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetDataCatalogEncryptionSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataCatalogEncryptionSettings {
                type Output = ::std::result::Result<crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsOutput, crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_data_catalog_encryption_settings::de_get_data_catalog_encryption_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_data_catalog_encryption_settings::de_get_data_catalog_encryption_settings_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetDataCatalogEncryptionSettingsErrorKind = GetDataCatalogEncryptionSettingsError;
/// Error type for the `GetDataCatalogEncryptionSettingsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetDataCatalogEncryptionSettingsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_data_catalog_encryption_settings::GetDataCatalogEncryptionSettingsError {
...
impl GetDataCatalogEncryptionSettingsError {
    /// Creates the `GetDataCatalogEncryptionSettingsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDataCatalogEncryptionSettingsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetDataCatalogEncryptionSettingsError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetDataCatalogEncryptionSettingsError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetDataCatalogEncryptionSettingsError::OperationTimeoutException`.
...
mod _get_data_catalog_encryption_settings_output;
