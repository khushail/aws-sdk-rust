...
impl GetCrawlerInput {
    /// Consumes the builder and constructs an Operation<[`GetCrawler`](crate::operation::get_crawler::GetCrawler)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_crawler::GetCrawler, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_crawler::GetCrawlerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_crawler::GetCrawlerInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_crawler::ser_get_crawler_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_crawler::GetCrawler::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCrawler", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCrawler {
                type Output = ::std::result::Result<crate::operation::get_crawler::GetCrawlerOutput, crate::operation::get_crawler::GetCrawlerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_crawler::de_get_crawler_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_crawler::de_get_crawler_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetCrawlerErrorKind = GetCrawlerError;
/// Error type for the `GetCrawlerError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCrawlerError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_crawler::GetCrawlerError {
...
impl GetCrawlerError {
    /// Creates the `GetCrawlerError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCrawlerError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetCrawlerError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetCrawlerError::OperationTimeoutException`.
...
pub use crate::operation::get_crawler::_get_crawler_output::GetCrawlerOutput;

pub use crate::operation::get_crawler::_get_crawler_input::GetCrawlerInput;

mod _get_crawler_input;

mod _get_crawler_output;
