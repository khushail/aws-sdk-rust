...
impl GetSecurityConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetSecurityConfiguration`](crate::operation::get_security_configuration::GetSecurityConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_security_configuration::GetSecurityConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_security_configuration::GetSecurityConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_security_configuration::ser_get_security_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_security_configuration::GetSecurityConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSecurityConfiguration", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetSecurityConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSecurityConfiguration {
                type Output = ::std::result::Result<crate::operation::get_security_configuration::GetSecurityConfigurationOutput, crate::operation::get_security_configuration::GetSecurityConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_security_configuration::de_get_security_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_security_configuration::de_get_security_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetSecurityConfigurationErrorKind = GetSecurityConfigurationError;
/// Error type for the `GetSecurityConfigurationError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetSecurityConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_security_configuration::GetSecurityConfigurationError {
...
impl GetSecurityConfigurationError {
    /// Creates the `GetSecurityConfigurationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSecurityConfigurationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetSecurityConfigurationError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetSecurityConfigurationError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetSecurityConfigurationError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetSecurityConfigurationError::OperationTimeoutException`.
...
mod _get_security_configuration_output;
