...
impl CreateScriptInput {
    /// Consumes the builder and constructs an Operation<[`CreateScript`](crate::operation::create_script::CreateScript)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_script::CreateScript, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_script::CreateScriptInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_script::ser_create_script_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_script::CreateScript::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateScript", "glue"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateScript {
                type Output = ::std::result::Result<crate::operation::create_script::CreateScriptOutput, crate::operation::create_script::CreateScriptError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_script::de_create_script_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_script::de_create_script_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_script::CreateScriptError {
...
impl CreateScriptError {
    ...
    /// Returns `true` if the error kind is `CreateScriptError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `CreateScriptError::OperationTimeoutException`.
