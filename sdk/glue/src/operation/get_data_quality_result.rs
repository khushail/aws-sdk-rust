...
impl GetDataQualityResultInput {
    /// Consumes the builder and constructs an Operation<[`GetDataQualityResult`](crate::operation::get_data_quality_result::GetDataQualityResult)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_data_quality_result::GetDataQualityResult, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_data_quality_result::GetDataQualityResultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_data_quality_result::ser_get_data_quality_result_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_data_quality_result::GetDataQualityResult::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDataQualityResult", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetDataQualityResult`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDataQualityResult {
                type Output = ::std::result::Result<crate::operation::get_data_quality_result::GetDataQualityResultOutput, crate::operation::get_data_quality_result::GetDataQualityResultError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_data_quality_result::de_get_data_quality_result_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_data_quality_result::de_get_data_quality_result_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetDataQualityResultErrorKind = GetDataQualityResultError;
/// Error type for the `GetDataQualityResultError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetDataQualityResultError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetDataQualityResultError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_data_quality_result::GetDataQualityResultError {
...
impl GetDataQualityResultError {
    /// Creates the `GetDataQualityResultError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDataQualityResultError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetDataQualityResultError::EntityNotFoundException`.
    pub fn is_entity_not_found_exception(&self) -> bool {
        matches!(self, Self::EntityNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetDataQualityResultError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `GetDataQualityResultError::InvalidInputException`.
    pub fn is_invalid_input_exception(&self) -> bool {
        matches!(self, Self::InvalidInputException(_))
    }
    /// Returns `true` if the error kind is `GetDataQualityResultError::OperationTimeoutException`.
...
mod _get_data_quality_result_output;
