...
impl GetCrawlerMetricsInput {
    /// Consumes the builder and constructs an Operation<[`GetCrawlerMetrics`](crate::operation::get_crawler_metrics::GetCrawlerMetrics)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_crawler_metrics::GetCrawlerMetrics, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_crawler_metrics::GetCrawlerMetricsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_crawler_metrics::ser_get_crawler_metrics_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_crawler_metrics::GetCrawlerMetrics::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCrawlerMetrics", "glue"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetCrawlerMetrics`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCrawlerMetrics {
                type Output = ::std::result::Result<crate::operation::get_crawler_metrics::GetCrawlerMetricsOutput, crate::operation::get_crawler_metrics::GetCrawlerMetricsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_crawler_metrics::de_get_crawler_metrics_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetCrawlerMetricsErrorKind = GetCrawlerMetricsError;
/// Error type for the `GetCrawlerMetricsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCrawlerMetricsError {
...
impl GetCrawlerMetricsError {
    /// Creates the `GetCrawlerMetricsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCrawlerMetricsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetCrawlerMetricsError::OperationTimeoutException`.
...
mod _get_crawler_metrics_output;
