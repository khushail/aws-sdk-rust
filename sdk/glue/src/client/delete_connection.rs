...
impl super::Client  {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::delete_connection::builders::DeleteConnectionFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::delete_connection::builders::DeleteConnectionFluentBuilder::set_catalog_id): <p>The ID of the Data Catalog in which the connection resides. If none is provided, the Amazon Web Services account ID is used by default.</p>
    ///   - [`connection_name(impl ::std::convert::Into<String>)`](crate::operation::delete_connection::builders::DeleteConnectionFluentBuilder::connection_name) / [`set_connection_name(Option<String>)`](crate::operation::delete_connection::builders::DeleteConnectionFluentBuilder::set_connection_name): <p>The name of the connection to delete.</p>
