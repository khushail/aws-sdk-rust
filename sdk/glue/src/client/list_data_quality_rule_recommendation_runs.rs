...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_data_quality_rule_recommendation_runs::builders::ListDataQualityRuleRecommendationRunsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_data_quality_rule_recommendation_runs::builders::ListDataQualityRuleRecommendationRunsFluentBuilder::set_next_token): <p>A paginated token to offset the results.</p>
