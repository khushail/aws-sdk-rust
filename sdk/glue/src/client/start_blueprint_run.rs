...
impl super::Client  {
    ...
    ///   - [`blueprint_name(impl ::std::convert::Into<String>)`](crate::operation::start_blueprint_run::builders::StartBlueprintRunFluentBuilder::blueprint_name) / [`set_blueprint_name(Option<String>)`](crate::operation::start_blueprint_run::builders::StartBlueprintRunFluentBuilder::set_blueprint_name): <p>The name of the blueprint.</p>
    ///   - [`parameters(impl ::std::convert::Into<String>)`](crate::operation::start_blueprint_run::builders::StartBlueprintRunFluentBuilder::parameters) / [`set_parameters(Option<String>)`](crate::operation::start_blueprint_run::builders::StartBlueprintRunFluentBuilder::set_parameters): <p>Specifies the parameters as a <code>BlueprintParameters</code> object.</p>
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::start_blueprint_run::builders::StartBlueprintRunFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::start_blueprint_run::builders::StartBlueprintRunFluentBuilder::set_role_arn): <p>Specifies the IAM role used to create the workflow.</p>
