...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_triggers::builders::GetTriggersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_triggers::builders::GetTriggersFluentBuilder::set_next_token): <p>A continuation token, if this is a continuation call.</p>
    ///   - [`dependent_job_name(impl ::std::convert::Into<String>)`](crate::operation::get_triggers::builders::GetTriggersFluentBuilder::dependent_job_name) / [`set_dependent_job_name(Option<String>)`](crate::operation::get_triggers::builders::GetTriggersFluentBuilder::set_dependent_job_name): <p>The name of the job to retrieve triggers for. The trigger that can start this job is returned, and if there is no such trigger, all triggers are returned.</p>
