...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::put_workflow_run_properties::builders::PutWorkflowRunPropertiesFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::put_workflow_run_properties::builders::PutWorkflowRunPropertiesFluentBuilder::set_name): <p>Name of the workflow which was run.</p>
    ///   - [`run_id(impl ::std::convert::Into<String>)`](crate::operation::put_workflow_run_properties::builders::PutWorkflowRunPropertiesFluentBuilder::run_id) / [`set_run_id(Option<String>)`](crate::operation::put_workflow_run_properties::builders::PutWorkflowRunPropertiesFluentBuilder::set_run_id): <p>The ID of the workflow run for which the run properties should be updated.</p>
