...
impl super::Client  {
    ...
    ///   - [`job_name(impl ::std::convert::Into<String>)`](crate::operation::reset_job_bookmark::builders::ResetJobBookmarkFluentBuilder::job_name) / [`set_job_name(Option<String>)`](crate::operation::reset_job_bookmark::builders::ResetJobBookmarkFluentBuilder::set_job_name): <p>The name of the job in question.</p>
    ///   - [`run_id(impl ::std::convert::Into<String>)`](crate::operation::reset_job_bookmark::builders::ResetJobBookmarkFluentBuilder::run_id) / [`set_run_id(Option<String>)`](crate::operation::reset_job_bookmark::builders::ResetJobBookmarkFluentBuilder::set_run_id): <p>The unique run identifier associated with this job run.</p>
