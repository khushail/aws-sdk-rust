...
impl super::Client  {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::create_partition::builders::CreatePartitionFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::create_partition::builders::CreatePartitionFluentBuilder::set_catalog_id): <p>The Amazon Web Services account ID of the catalog in which the partition is to be created.</p>
    ///   - [`database_name(impl ::std::convert::Into<String>)`](crate::operation::create_partition::builders::CreatePartitionFluentBuilder::database_name) / [`set_database_name(Option<String>)`](crate::operation::create_partition::builders::CreatePartitionFluentBuilder::set_database_name): <p>The name of the metadata database in which the partition is to be created.</p>
    ///   - [`table_name(impl ::std::convert::Into<String>)`](crate::operation::create_partition::builders::CreatePartitionFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::create_partition::builders::CreatePartitionFluentBuilder::set_table_name): <p>The name of the metadata table in which the partition is to be created.</p>
