...
impl super::Client  {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::batch_update_partition::builders::BatchUpdatePartitionFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::batch_update_partition::builders::BatchUpdatePartitionFluentBuilder::set_catalog_id): <p>The ID of the catalog in which the partition is to be updated. Currently, this should be the Amazon Web Services account ID.</p>
    ///   - [`database_name(impl ::std::convert::Into<String>)`](crate::operation::batch_update_partition::builders::BatchUpdatePartitionFluentBuilder::database_name) / [`set_database_name(Option<String>)`](crate::operation::batch_update_partition::builders::BatchUpdatePartitionFluentBuilder::set_database_name): <p>The name of the metadata database in which the partition is to be updated.</p>
    ///   - [`table_name(impl ::std::convert::Into<String>)`](crate::operation::batch_update_partition::builders::BatchUpdatePartitionFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::batch_update_partition::builders::BatchUpdatePartitionFluentBuilder::set_table_name): <p>The name of the metadata table in which the partition is to be updated.</p>
