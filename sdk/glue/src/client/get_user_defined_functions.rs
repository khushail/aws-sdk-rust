...
impl super::Client  {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::get_user_defined_functions::builders::GetUserDefinedFunctionsFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::get_user_defined_functions::builders::GetUserDefinedFunctionsFluentBuilder::set_catalog_id): <p>The ID of the Data Catalog where the functions to be retrieved are located. If none is provided, the Amazon Web Services account ID is used by default.</p>
    ///   - [`database_name(impl ::std::convert::Into<String>)`](crate::operation::get_user_defined_functions::builders::GetUserDefinedFunctionsFluentBuilder::database_name) / [`set_database_name(Option<String>)`](crate::operation::get_user_defined_functions::builders::GetUserDefinedFunctionsFluentBuilder::set_database_name): <p>The name of the catalog database where the functions are located. If none is provided, functions from all the databases across the catalog will be returned.</p>
    ///   - [`pattern(impl ::std::convert::Into<String>)`](crate::operation::get_user_defined_functions::builders::GetUserDefinedFunctionsFluentBuilder::pattern) / [`set_pattern(Option<String>)`](crate::operation::get_user_defined_functions::builders::GetUserDefinedFunctionsFluentBuilder::set_pattern): <p>An optional function-name pattern string that filters the function definitions returned.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_user_defined_functions::builders::GetUserDefinedFunctionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_user_defined_functions::builders::GetUserDefinedFunctionsFluentBuilder::set_next_token): <p>A continuation token, if this is a continuation call.</p>
