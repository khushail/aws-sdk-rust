...
impl super::Client  {
    ...
    ///   - [`transform_id(impl ::std::convert::Into<String>)`](crate::operation::start_ml_labeling_set_generation_task_run::builders::StartMLLabelingSetGenerationTaskRunFluentBuilder::transform_id) / [`set_transform_id(Option<String>)`](crate::operation::start_ml_labeling_set_generation_task_run::builders::StartMLLabelingSetGenerationTaskRunFluentBuilder::set_transform_id): <p>The unique identifier of the machine learning transform.</p>
    ///   - [`output_s3_path(impl ::std::convert::Into<String>)`](crate::operation::start_ml_labeling_set_generation_task_run::builders::StartMLLabelingSetGenerationTaskRunFluentBuilder::output_s3_path) / [`set_output_s3_path(Option<String>)`](crate::operation::start_ml_labeling_set_generation_task_run::builders::StartMLLabelingSetGenerationTaskRunFluentBuilder::set_output_s3_path): <p>The Amazon Simple Storage Service (Amazon S3) path where you generate the labeling set.</p>
