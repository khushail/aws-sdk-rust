...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_workflow::builders::DeleteWorkflowFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_workflow::builders::DeleteWorkflowFluentBuilder::set_name): <p>Name of the workflow to be deleted.</p>
