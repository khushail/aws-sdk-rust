...
pub(crate) fn de_partition_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::Partition>>, ::aws_smithy_json::deserialize::error::DeserializeError>
