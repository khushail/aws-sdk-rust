...
pub fn ser_s3_catalog_source(
                     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                     input: &crate::types::S3CatalogSource,
...
pub(crate) fn de_s3_catalog_source<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::S3CatalogSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::S3CatalogSourceBuilder::default();
            loop {
                match tokens.next().transpose()? {
