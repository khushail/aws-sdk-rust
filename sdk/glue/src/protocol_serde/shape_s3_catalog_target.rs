...
pub(crate) fn de_s3_catalog_target<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::S3CatalogTarget>, ::aws_smithy_json::deserialize::error::DeserializeError>
