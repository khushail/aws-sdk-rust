...
pub(crate) fn de_oracle_sql_catalog_target<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::OracleSqlCatalogTarget>, ::aws_smithy_json::deserialize::error::DeserializeError>
