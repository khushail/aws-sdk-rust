...
pub fn ser_aggregate(
    ...
    if let Some(var_10) = &input.aggs {
        let mut array_11 = object.key("Aggs").start_array();
...
pub(crate) fn de_aggregate<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::Aggregate>, ::aws_smithy_json::deserialize::error::DeserializeError>
