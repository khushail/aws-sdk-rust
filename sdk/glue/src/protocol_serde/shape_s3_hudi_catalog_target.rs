...
pub fn ser_s3_hudi_catalog_target(
                     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                     input: &crate::types::S3HudiCatalogTarget,
...
pub(crate) fn de_s3_hudi_catalog_target<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::S3HudiCatalogTarget>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::S3HudiCatalogTargetBuilder::default();
            loop {
                match tokens.next().transpose()? {
