...
pub(crate) fn de_s3_delta_source<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::S3DeltaSource>, ::aws_smithy_json::deserialize::error::DeserializeError>
