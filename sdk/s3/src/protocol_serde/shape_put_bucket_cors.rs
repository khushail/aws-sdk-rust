...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_bucket_cors_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_bucket_cors::PutBucketCorsOutput, crate::operation::put_bucket_cors::PutBucketCorsError> {
    Ok({
        #[allow(unused_mut)]
