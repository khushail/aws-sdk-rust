...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_bucket_acl_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_bucket_acl::PutBucketAclOutput, crate::operation::put_bucket_acl::PutBucketAclError> {
    Ok({
        #[allow(unused_mut)]
