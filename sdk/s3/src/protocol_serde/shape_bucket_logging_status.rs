...
pub fn ser_bucket_logging_status(input: &crate::types::BucketLoggingStatus, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
