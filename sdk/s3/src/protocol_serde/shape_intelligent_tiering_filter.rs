...
pub fn de_intelligent_tiering_filter(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::IntelligentTieringFilter, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
...
pub fn ser_intelligent_tiering_filter(input: &crate::types::IntelligentTieringFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
