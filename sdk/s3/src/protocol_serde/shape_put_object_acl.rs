...
pub fn de_put_object_acl_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_object_acl::PutObjectAclOutput, crate::operation::put_object_acl::PutObjectAclError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::put_object_acl::PutObjectAclError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_no_such_key::de_no_such_key_xml_err(_response_body, output).map_err(crate::operation::put_object_acl::PutObjectAclError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_object_acl_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_object_acl::PutObjectAclOutput, crate::operation::put_object_acl::PutObjectAclError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::put_object_acl::builders::PutObjectAclOutputBuilder::default();
        output = output.set_request_charged(
            crate::protocol_serde::shape_put_object_acl_output::de_request_charged_header(_response_headers)
                                    .map_err(|_|crate::operation::put_object_acl::PutObjectAclError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged"))?
        );
