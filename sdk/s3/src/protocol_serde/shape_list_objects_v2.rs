...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_objects_v2_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_objects_v2::ListObjectsV2Output, crate::operation::list_objects_v2::ListObjectsV2Error> {
    Ok({
        #[allow(unused_mut)]
    ...
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("ContinuationToken") /* ContinuationToken com.amazonaws.s3.synthetic#ListObjectsV2Output$ContinuationToken */ =>  {
                ...
                ;
                builder = builder.set_continuation_token(var_8);
            }
            ,
            ...
            s if s.matches("Contents") /* Contents com.amazonaws.s3.synthetic#ListObjectsV2Output$Contents */ =>  {
                let var_14 =
                    Some(
                        Result::<::std::vec::Vec<crate::types::Object>, ::aws_smithy_xml::decode::XmlDecodeError>::Ok({
                            let mut list_15 = builder.contents.take().unwrap_or_default();
                            list_15.push(
                ...
                ;
                builder = builder.set_contents(var_14);
            }
            ,
            s if s.matches("StartAfter") /* StartAfter com.amazonaws.s3.synthetic#ListObjectsV2Output$StartAfter */ =>  {
                ...
                ;
                builder = builder.set_start_after(var_16);
            }
            ,
            ...
            s if s.matches("KeyCount") /* KeyCount com.amazonaws.s3.synthetic#ListObjectsV2Output$KeyCount */ =>  {
                ...
                ;
                builder = builder.set_key_count(var_18);
            }
            ,
            _ => {}
        }
