...
#[allow(clippy::unnecessary_wraps)]
pub fn de_upload_part_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::upload_part::UploadPartOutput, crate::operation::upload_part::UploadPartError> {
    Ok({
        #[allow(unused_mut)]
