...
#[allow(clippy::unnecessary_wraps)]
pub fn de_write_get_object_response_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::write_get_object_response::WriteGetObjectResponseOutput, crate::operation::write_get_object_response::WriteGetObjectResponseError> {
    Ok({
        #[allow(unused_mut)]
