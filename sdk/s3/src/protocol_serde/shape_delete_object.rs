...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_object_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_object::DeleteObjectOutput, crate::operation::delete_object::DeleteObjectError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_object::builders::DeleteObjectOutputBuilder::default();
        output = output.set_delete_marker(
            crate::protocol_serde::shape_delete_object_output::de_delete_marker_header(_response_headers)
        ...
        output = output.set_request_charged(
            crate::protocol_serde::shape_delete_object_output::de_request_charged_header(_response_headers)
        ...
        output = output.set_version_id(
            crate::protocol_serde::shape_delete_object_output::de_version_id_header(_response_headers)
