...
pub fn ser_input_serialization(input: &crate::types::InputSerialization, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
