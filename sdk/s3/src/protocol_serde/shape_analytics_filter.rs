...
pub fn de_analytics_filter(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::AnalyticsFilter, ::aws_smithy_xml::decode::XmlDecodeError> {
...
pub fn ser_analytics_filter(input: &crate::types::AnalyticsFilter, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    ...
    match input {
        ...
        ,
        crate::types::AnalyticsFilter::Unknown => return Err(::aws_smithy_http::operation::error::SerializationError::unknown_variant("AnalyticsFilter"))
    }
    Ok(())
}
