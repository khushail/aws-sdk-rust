...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_multipart_uploads_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_multipart_uploads::ListMultipartUploadsOutput, crate::operation::list_multipart_uploads::ListMultipartUploadsError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_request_charged(
            crate::protocol_serde::shape_list_multipart_uploads_output::de_request_charged_header(_response_headers)
                                    .map_err(|_|crate::operation::list_multipart_uploads::ListMultipartUploadsError::unhandled("Failed to parse RequestCharged from header `x-amz-request-charged"))?
        );
