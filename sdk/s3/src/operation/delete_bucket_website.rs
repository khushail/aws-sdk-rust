...
impl DeleteBucketWebsiteInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBucketWebsite`](crate::operation::delete_bucket_website::DeleteBucketWebsite)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_bucket_website::DeleteBucketWebsite, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_bucket_website::DeleteBucketWebsiteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_bucket_website::DeleteBucketWebsiteInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_bucket_website::DeleteBucketWebsite::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteBucketWebsite", "s3"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBucketWebsite {
                type Output = ::std::result::Result<crate::operation::delete_bucket_website::DeleteBucketWebsiteOutput, crate::operation::delete_bucket_website::DeleteBucketWebsiteError>;
...
::tracing::debug!(request_id = ?::aws_http::request_id::RequestId::request_id(response));
                     if !success && status != 204 {
                        ...
                        crate::protocol_serde::shape_delete_bucket_website::de_delete_bucket_website_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_bucket_website::DeleteBucketWebsiteError {
