...
impl GetBucketOwnershipControlsInput {
    /// Consumes the builder and constructs an Operation<[`GetBucketOwnershipControls`](crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControls)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControls, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControlsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControlsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControls::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetBucketOwnershipControls", "s3"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBucketOwnershipControls {
                type Output = ::std::result::Result<crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControlsOutput, crate::operation::get_bucket_ownership_controls::GetBucketOwnershipControlsError>;
...
::tracing::debug!(request_id = ?::aws_http::request_id::RequestId::request_id(response));
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_bucket_ownership_controls::de_get_bucket_ownership_controls_http_response_with_props(status, headers, body)
                     }
                }
