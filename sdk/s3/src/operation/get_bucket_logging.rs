...
impl GetBucketLoggingInput {
    /// Consumes the builder and constructs an Operation<[`GetBucketLogging`](crate::operation::get_bucket_logging::GetBucketLogging)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_bucket_logging::GetBucketLogging, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_bucket_logging::GetBucketLoggingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_bucket_logging::GetBucketLoggingInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_bucket_logging::GetBucketLogging::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetBucketLogging", "s3"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBucketLogging {
                type Output = ::std::result::Result<crate::operation::get_bucket_logging::GetBucketLoggingOutput, crate::operation::get_bucket_logging::GetBucketLoggingError>;
...
::tracing::debug!(request_id = ?::aws_http::request_id::RequestId::request_id(response));
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_bucket_logging::de_get_bucket_logging_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_bucket_logging::GetBucketLoggingError {
