...
impl WriteGetObjectResponseInput {
    ...
    pub async fn make_operation(self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::write_get_object_response::WriteGetObjectResponse, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        .set_use_object_lambda_endpoint(::std::option::Option::Some(true)).build()
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::write_get_object_response::WriteGetObjectResponseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/WriteGetObjectResponse").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::write_get_object_response::WriteGetObjectResponseInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
