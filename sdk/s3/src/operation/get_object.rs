...
impl GetObjectInput {
    ...
    async fn _make_presigned_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_object::GetObject, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_object::GetObjectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_object::GetObjectInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let (mut request, _) = self._make_presigned_operation(config)
                            ...
                            .into_request_response();
         {
            // Change signature type to query params and wire up presigning config
                                ...
                                props.insert(::aws_smithy_async::time::SharedTimeSource::new(::aws_smithy_async::time::StaticTimeSource::new(presigning_config.start_time())));
            props.insert(
                ::aws_sigv4::http_request::SignableBody::UnsignedPayload
            );
            let config = props.get_mut::<::aws_sig_auth::signer::OperationSigningConfig>()
...
::tracing::debug!(request_id = ?::aws_http::request_id::RequestId::request_id(response));
                    ...
                    ::std::option::Option::Some(crate::protocol_serde::shape_get_object::de_get_object_op_response(response))
                }
