...
impl GetObjectTorrentInput {
    /// Consumes the builder and constructs an Operation<[`GetObjectTorrent`](crate::operation::get_object_torrent::GetObjectTorrent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_object_torrent::GetObjectTorrent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_object_torrent::GetObjectTorrentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_object_torrent::GetObjectTorrentInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_object_torrent::GetObjectTorrent::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetObjectTorrent", "s3"));
...
::tracing::debug!(request_id = ?::aws_http::request_id::RequestId::request_id(response));
                    ...
                    ::std::option::Option::Some(crate::protocol_serde::shape_get_object_torrent::de_get_object_torrent_op_response(response))
                }
                fn parse_loaded(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_get_object_torrent::de_get_object_torrent_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
