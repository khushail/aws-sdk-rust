...
impl HeadBucketInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::head_bucket::HeadBucket, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::head_bucket::HeadBucketInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::head_bucket::HeadBucket::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("HeadBucket", "s3"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for HeadBucket {
                type Output = ::std::result::Result<crate::operation::head_bucket::HeadBucketOutput, crate::operation::head_bucket::HeadBucketError>;
...
::tracing::debug!(request_id = ?::aws_http::request_id::RequestId::request_id(response));
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_head_bucket::de_head_bucket_http_response_with_props(status, headers, body)
                     }
                }
