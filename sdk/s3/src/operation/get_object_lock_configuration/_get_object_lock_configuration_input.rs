...
impl GetObjectLockConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_object_lock_configuration::GetObjectLockConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
