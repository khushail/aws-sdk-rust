...
impl SelectObjectContentOutputBuilder {
    ...
    /// <p>The array of results.</p>
    pub fn get_payload(&self) -> &::std::option::Option<::aws_smithy_http::event_stream::Receiver<crate::types::SelectObjectContentEventStream, crate::types::error::SelectObjectContentEventStreamError>> {
        &self.payload
    }
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::select_object_content::SelectObjectContentOutput, ::aws_smithy_http::operation::error::BuildError> {
