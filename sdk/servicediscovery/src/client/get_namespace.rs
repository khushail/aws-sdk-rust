...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_namespace::builders::GetNamespaceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_namespace::builders::GetNamespaceFluentBuilder::set_id): <p>The ID of the namespace that you want to get information about.</p>
