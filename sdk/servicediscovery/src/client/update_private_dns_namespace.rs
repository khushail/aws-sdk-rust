...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_private_dns_namespace::builders::UpdatePrivateDnsNamespaceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_private_dns_namespace::builders::UpdatePrivateDnsNamespaceFluentBuilder::set_id): <p>The ID of the namespace that you want to update.</p>
    ///   - [`updater_request_id(impl ::std::convert::Into<String>)`](crate::operation::update_private_dns_namespace::builders::UpdatePrivateDnsNamespaceFluentBuilder::updater_request_id) / [`set_updater_request_id(Option<String>)`](crate::operation::update_private_dns_namespace::builders::UpdatePrivateDnsNamespaceFluentBuilder::set_updater_request_id): <p>A unique string that identifies the request and that allows failed <code>UpdatePrivateDnsNamespace</code> requests to be retried without the risk of running the operation twice. <code>UpdaterRequestId</code> can be any unique string (for example, a date/timestamp).</p>
