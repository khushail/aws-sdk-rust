...
impl CreatePrivateDnsNamespaceInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_private_dns_namespace::CreatePrivateDnsNamespace, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_private_dns_namespace::CreatePrivateDnsNamespaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `CreatePrivateDnsNamespace`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePrivateDnsNamespace {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_private_dns_namespace::de_create_private_dns_namespace_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_private_dns_namespace::de_create_private_dns_namespace_http_response_with_props(status, headers, body)
                     }
                }
