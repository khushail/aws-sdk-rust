...
impl UpdatePrivateDnsNamespaceInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePrivateDnsNamespace`](crate::operation::update_private_dns_namespace::UpdatePrivateDnsNamespace)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_private_dns_namespace::UpdatePrivateDnsNamespace, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_private_dns_namespace::UpdatePrivateDnsNamespaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_private_dns_namespace::ser_update_private_dns_namespace_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_private_dns_namespace::UpdatePrivateDnsNamespace::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePrivateDnsNamespace", "servicediscovery"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePrivateDnsNamespace {
                type Output = ::std::result::Result<crate::operation::update_private_dns_namespace::UpdatePrivateDnsNamespaceOutput, crate::operation::update_private_dns_namespace::UpdatePrivateDnsNamespaceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_private_dns_namespace::de_update_private_dns_namespace_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_private_dns_namespace::UpdatePrivateDnsNamespaceError {
