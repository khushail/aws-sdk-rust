...
impl DeregisterInstanceInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterInstance`](crate::operation::deregister_instance::DeregisterInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deregister_instance::DeregisterInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_instance::DeregisterInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_instance::DeregisterInstance::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeregisterInstance", "servicediscovery"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeregisterInstance`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterInstance {
                type Output = ::std::result::Result<crate::operation::deregister_instance::DeregisterInstanceOutput, crate::operation::deregister_instance::DeregisterInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deregister_instance::de_deregister_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deregister_instance::de_deregister_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_instance::DeregisterInstanceError {
...
pub use crate::operation::deregister_instance::_deregister_instance_output::DeregisterInstanceOutput;

pub use crate::operation::deregister_instance::_deregister_instance_input::DeregisterInstanceInput;

mod _deregister_instance_input;

mod _deregister_instance_output;
