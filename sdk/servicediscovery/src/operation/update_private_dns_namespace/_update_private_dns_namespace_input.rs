...
impl UpdatePrivateDnsNamespaceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_private_dns_namespace::UpdatePrivateDnsNamespaceInput, ::aws_smithy_http::operation::error::BuildError> {
