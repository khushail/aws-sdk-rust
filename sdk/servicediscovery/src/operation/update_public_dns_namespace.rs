...
impl UpdatePublicDnsNamespaceInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespace, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_public_dns_namespace::UpdatePublicDnsNamespaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `UpdatePublicDnsNamespace`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePublicDnsNamespace {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_public_dns_namespace::de_update_public_dns_namespace_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_public_dns_namespace::de_update_public_dns_namespace_http_response_with_props(status, headers, body)
                     }
                }
