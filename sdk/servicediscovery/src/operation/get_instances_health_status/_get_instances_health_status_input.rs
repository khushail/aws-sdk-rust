...
impl GetInstancesHealthStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_instances_health_status::GetInstancesHealthStatusInput, ::aws_smithy_http::operation::error::BuildError> {
