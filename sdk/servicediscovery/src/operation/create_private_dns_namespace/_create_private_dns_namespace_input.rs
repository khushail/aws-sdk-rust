...
impl CreatePrivateDnsNamespaceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_private_dns_namespace::CreatePrivateDnsNamespaceInput, ::aws_smithy_http::operation::error::BuildError> {
