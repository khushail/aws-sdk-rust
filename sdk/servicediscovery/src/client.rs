...
mod create_http_namespace;

mod create_private_dns_namespace;

mod create_public_dns_namespace;
...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_servicediscovery::Error> {
/// # let client: aws_sdk_servicediscovery::Client = unimplemented!();
...
mod update_http_namespace;

mod update_instance_custom_health_status;

mod update_private_dns_namespace;
