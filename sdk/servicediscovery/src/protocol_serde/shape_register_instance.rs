...
#[allow(clippy::unnecessary_wraps)]
pub fn de_register_instance_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::register_instance::RegisterInstanceOutput, crate::operation::register_instance::RegisterInstanceError> {
    Ok({
        #[allow(unused_mut)]
