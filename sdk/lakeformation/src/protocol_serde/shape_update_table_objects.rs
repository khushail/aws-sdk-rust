...
pub fn ser_update_table_objects_input(input: &crate::operation::update_table_objects::UpdateTableObjectsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_update_table_objects_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_table_objects::UpdateTableObjectsOutput, crate::operation::update_table_objects::UpdateTableObjectsError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::update_table_objects::UpdateTableObjectsError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "ConcurrentModificationException" => crate::operation::update_table_objects::UpdateTableObjectsError::ConcurrentModificationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "EntityNotFoundException" => crate::operation::update_table_objects::UpdateTableObjectsError::EntityNotFoundException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServiceException" => crate::operation::update_table_objects::UpdateTableObjectsError::InternalServiceException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidInputException" => crate::operation::update_table_objects::UpdateTableObjectsError::InvalidInputException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "OperationTimeoutException" => crate::operation::update_table_objects::UpdateTableObjectsError::OperationTimeoutException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceNotReadyException" => crate::operation::update_table_objects::UpdateTableObjectsError::ResourceNotReadyException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "TransactionCanceledException" => crate::operation::update_table_objects::UpdateTableObjectsError::TransactionCanceledException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "TransactionCommitInProgressException" => crate::operation::update_table_objects::UpdateTableObjectsError::TransactionCommitInProgressException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "TransactionCommittedException" => crate::operation::update_table_objects::UpdateTableObjectsError::TransactionCommittedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::update_table_objects::UpdateTableObjectsError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_update_table_objects_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_table_objects::UpdateTableObjectsOutput, crate::operation::update_table_objects::UpdateTableObjectsError> {
    Ok({
        #[allow(unused_mut)]
