...
impl super::Client  {
    ...
    ///   - [`query_string(impl ::std::convert::Into<String>)`](crate::operation::start_query_planning::builders::StartQueryPlanningFluentBuilder::query_string) / [`set_query_string(Option<String>)`](crate::operation::start_query_planning::builders::StartQueryPlanningFluentBuilder::set_query_string): <p>A PartiQL query statement used as an input to the planner service.</p>
