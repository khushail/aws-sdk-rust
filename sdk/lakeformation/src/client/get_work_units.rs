...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_work_units::builders::GetWorkUnitsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_work_units::builders::GetWorkUnitsFluentBuilder::set_next_token): <p>A continuation token, if this is a continuation call.</p>
    ...
    ///   - [`query_id(impl ::std::convert::Into<String>)`](crate::operation::get_work_units::builders::GetWorkUnitsFluentBuilder::query_id) / [`set_query_id(Option<String>)`](crate::operation::get_work_units::builders::GetWorkUnitsFluentBuilder::set_query_id): <p>The ID of the plan query operation.</p>
