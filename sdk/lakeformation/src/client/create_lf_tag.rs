...
impl super::Client  {
    ...
    ///   - [`catalog_id(impl ::std::convert::Into<String>)`](crate::operation::create_lf_tag::builders::CreateLFTagFluentBuilder::catalog_id) / [`set_catalog_id(Option<String>)`](crate::operation::create_lf_tag::builders::CreateLFTagFluentBuilder::set_catalog_id): <p>The identifier for the Data Catalog. By default, the account ID. The Data Catalog is the persistent metadata store. It contains database definitions, table definitions, and other control information to manage your Lake Formation environment. </p>
    ///   - [`tag_key(impl ::std::convert::Into<String>)`](crate::operation::create_lf_tag::builders::CreateLFTagFluentBuilder::tag_key) / [`set_tag_key(Option<String>)`](crate::operation::create_lf_tag::builders::CreateLFTagFluentBuilder::set_tag_key): <p>The key-name for the LF-tag.</p>
