...
impl UpdateLfTagInput {
    /// Consumes the builder and constructs an Operation<[`UpdateLFTag`](crate::operation::update_lf_tag::UpdateLFTag)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_lf_tag::UpdateLFTag, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_lf_tag::UpdateLfTagInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/UpdateLFTag").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_lf_tag::UpdateLFTag::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateLFTag", "lakeformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateLFTag`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLFTag {
                type Output = ::std::result::Result<crate::operation::update_lf_tag::UpdateLfTagOutput, crate::operation::update_lf_tag::UpdateLFTagError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_lf_tag::de_update_lf_tag_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_lf_tag::de_update_lf_tag_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_lf_tag::UpdateLFTagError {
