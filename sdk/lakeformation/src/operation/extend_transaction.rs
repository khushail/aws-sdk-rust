...
impl ExtendTransactionInput {
    /// Consumes the builder and constructs an Operation<[`ExtendTransaction`](crate::operation::extend_transaction::ExtendTransaction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::extend_transaction::ExtendTransaction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::extend_transaction::ExtendTransactionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/ExtendTransaction").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::extend_transaction::ExtendTransaction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ExtendTransaction", "lakeformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ExtendTransaction`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExtendTransaction {
                type Output = ::std::result::Result<crate::operation::extend_transaction::ExtendTransactionOutput, crate::operation::extend_transaction::ExtendTransactionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_extend_transaction::de_extend_transaction_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_extend_transaction::de_extend_transaction_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::extend_transaction::ExtendTransactionError {
...
mod _extend_transaction_output;
