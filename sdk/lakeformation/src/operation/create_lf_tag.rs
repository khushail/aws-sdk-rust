...
impl CreateLfTagInput {
    /// Consumes the builder and constructs an Operation<[`CreateLFTag`](crate::operation::create_lf_tag::CreateLFTag)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_lf_tag::CreateLFTag, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_lf_tag::CreateLfTagInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/CreateLFTag").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_lf_tag::CreateLFTag::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateLFTag", "lakeformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateLFTag`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLFTag {
                type Output = ::std::result::Result<crate::operation::create_lf_tag::CreateLfTagOutput, crate::operation::create_lf_tag::CreateLFTagError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_lf_tag::de_create_lf_tag_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_lf_tag::de_create_lf_tag_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_lf_tag::CreateLFTagError {
