...
impl ListTableStorageOptimizersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_table_storage_optimizers::ListTableStorageOptimizersInput, ::aws_smithy_http::operation::error::BuildError> {
