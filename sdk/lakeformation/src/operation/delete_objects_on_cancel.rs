...
impl DeleteObjectsOnCancelInput {
    /// Consumes the builder and constructs an Operation<[`DeleteObjectsOnCancel`](crate::operation::delete_objects_on_cancel::DeleteObjectsOnCancel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_objects_on_cancel::DeleteObjectsOnCancel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_objects_on_cancel::DeleteObjectsOnCancelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/DeleteObjectsOnCancel").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_objects_on_cancel::DeleteObjectsOnCancel::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteObjectsOnCancel {
                type Output = ::std::result::Result<crate::operation::delete_objects_on_cancel::DeleteObjectsOnCancelOutput, crate::operation::delete_objects_on_cancel::DeleteObjectsOnCancelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_objects_on_cancel::de_delete_objects_on_cancel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_objects_on_cancel::de_delete_objects_on_cancel_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_objects_on_cancel::DeleteObjectsOnCancelError {
...
mod _delete_objects_on_cancel_output;
