...
impl AssumeDecoratedRoleWithSamlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::assume_decorated_role_with_saml::AssumeDecoratedRoleWithSamlInput, ::aws_smithy_http::operation::error::BuildError> {
