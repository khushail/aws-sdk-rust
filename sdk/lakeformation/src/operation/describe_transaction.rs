...
impl DescribeTransactionInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTransaction`](crate::operation::describe_transaction::DescribeTransaction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_transaction::DescribeTransaction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_transaction::DescribeTransactionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/DescribeTransaction").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_transaction::DescribeTransaction::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTransaction {
                type Output = ::std::result::Result<crate::operation::describe_transaction::DescribeTransactionOutput, crate::operation::describe_transaction::DescribeTransactionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_transaction::de_describe_transaction_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_transaction::de_describe_transaction_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_transaction::DescribeTransactionError {
...
mod _describe_transaction_output;
