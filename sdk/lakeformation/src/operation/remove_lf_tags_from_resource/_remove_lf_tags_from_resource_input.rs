...
impl RemoveLfTagsFromResourceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_lf_tags_from_resource::RemoveLfTagsFromResourceInput, ::aws_smithy_http::operation::error::BuildError> {
