...
impl CancelTransactionInput {
    /// Consumes the builder and constructs an Operation<[`CancelTransaction`](crate::operation::cancel_transaction::CancelTransaction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_transaction::CancelTransaction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_transaction::CancelTransactionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/CancelTransaction").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_transaction::CancelTransaction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelTransaction", "lakeformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CancelTransaction`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelTransaction {
                type Output = ::std::result::Result<crate::operation::cancel_transaction::CancelTransactionOutput, crate::operation::cancel_transaction::CancelTransactionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_cancel_transaction::de_cancel_transaction_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_cancel_transaction::de_cancel_transaction_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_transaction::CancelTransactionError {
...
mod _cancel_transaction_output;
