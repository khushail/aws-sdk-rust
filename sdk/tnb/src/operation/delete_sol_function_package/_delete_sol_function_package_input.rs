...
impl DeleteSolFunctionPackageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_sol_function_package::DeleteSolFunctionPackageInput, ::aws_smithy_http::operation::error::BuildError> {
