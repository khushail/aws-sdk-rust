...
impl UpdateSolFunctionPackageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_sol_function_package::UpdateSolFunctionPackageInput, ::aws_smithy_http::operation::error::BuildError> {
