...
impl TerminateSolNetworkInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::terminate_sol_network_instance::TerminateSolNetworkInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
