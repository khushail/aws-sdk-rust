...
impl InstantiateSolNetworkInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::instantiate_sol_network_instance::InstantiateSolNetworkInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
