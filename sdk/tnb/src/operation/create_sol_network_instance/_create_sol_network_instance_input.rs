...
impl CreateSolNetworkInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_sol_network_instance::CreateSolNetworkInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
