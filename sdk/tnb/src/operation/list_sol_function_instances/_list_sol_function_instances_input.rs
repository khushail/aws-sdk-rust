...
impl ListSolFunctionInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_sol_function_instances::ListSolFunctionInstancesInput, ::aws_smithy_http::operation::error::BuildError> {
