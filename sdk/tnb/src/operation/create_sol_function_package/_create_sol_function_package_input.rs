...
impl CreateSolFunctionPackageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_sol_function_package::CreateSolFunctionPackageInput, ::aws_smithy_http::operation::error::BuildError> {
