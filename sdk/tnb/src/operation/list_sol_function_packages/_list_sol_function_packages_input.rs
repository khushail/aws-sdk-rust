...
impl ListSolFunctionPackagesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_sol_function_packages::ListSolFunctionPackagesInput, ::aws_smithy_http::operation::error::BuildError> {
