...
impl GetSolNetworkPackageContentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_sol_network_package_content::GetSolNetworkPackageContentInput, ::aws_smithy_http::operation::error::BuildError> {
