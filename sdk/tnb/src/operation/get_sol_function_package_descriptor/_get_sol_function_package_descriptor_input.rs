...
impl GetSolFunctionPackageDescriptorInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_sol_function_package_descriptor::GetSolFunctionPackageDescriptorInput, ::aws_smithy_http::operation::error::BuildError> {
