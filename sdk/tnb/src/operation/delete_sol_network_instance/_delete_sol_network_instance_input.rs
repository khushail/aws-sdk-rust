...
impl DeleteSolNetworkInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_sol_network_instance::DeleteSolNetworkInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
