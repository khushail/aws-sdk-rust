...
impl UpdateSolNetworkPackageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_sol_network_package::UpdateSolNetworkPackageInput, ::aws_smithy_http::operation::error::BuildError> {
