...
impl ListRumMetricsDestinationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_rum_metrics_destinations::ListRumMetricsDestinationsInput, ::aws_smithy_http::operation::error::BuildError> {
