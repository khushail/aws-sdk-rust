...
impl UpdateRumMetricDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_rum_metric_definition::UpdateRumMetricDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
