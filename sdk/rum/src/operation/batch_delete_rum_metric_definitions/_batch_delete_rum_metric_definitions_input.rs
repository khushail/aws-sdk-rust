...
impl BatchDeleteRumMetricDefinitionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_delete_rum_metric_definitions::BatchDeleteRumMetricDefinitionsInput, ::aws_smithy_http::operation::error::BuildError> {
