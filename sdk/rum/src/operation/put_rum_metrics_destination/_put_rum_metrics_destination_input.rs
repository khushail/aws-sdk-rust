...
impl PutRumMetricsDestinationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_rum_metrics_destination::PutRumMetricsDestinationInput, ::aws_smithy_http::operation::error::BuildError> {
