...
impl GetAppMonitorDataInput {
    /// Consumes the builder and constructs an Operation<[`GetAppMonitorData`](crate::operation::get_app_monitor_data::GetAppMonitorData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_app_monitor_data::GetAppMonitorData, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_app_monitor_data::GetAppMonitorDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/appmonitor/{Name}/data", Name = name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_app_monitor_data::GetAppMonitorData::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAppMonitorData", "rum"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetAppMonitorData`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAppMonitorData {
                type Output = ::std::result::Result<crate::operation::get_app_monitor_data::GetAppMonitorDataOutput, crate::operation::get_app_monitor_data::GetAppMonitorDataError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_app_monitor_data::de_get_app_monitor_data_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_app_monitor_data::GetAppMonitorDataError {
...
mod _get_app_monitor_data_output;
