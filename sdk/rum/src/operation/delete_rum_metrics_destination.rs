...
impl DeleteRumMetricsDestinationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteRumMetricsDestination`](crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestination)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestination, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestinationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if app_monitor_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("app_monitor_name", "cannot be empty or unset"))
                            }
            ...
            fn uri_query(_input: &crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestinationInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestinationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestination::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteRumMetricsDestination {
                type Output = ::std::result::Result<crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestinationOutput, crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestinationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_rum_metrics_destination::de_delete_rum_metrics_destination_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_rum_metrics_destination::de_delete_rum_metrics_destination_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_rum_metrics_destination::DeleteRumMetricsDestinationError {
...
mod _delete_rum_metrics_destination_output;
