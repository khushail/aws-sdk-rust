...
impl PutRumEventsInput {
    /// Consumes the builder and constructs an Operation<[`PutRumEvents`](crate::operation::put_rum_events::PutRumEvents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_rum_events::PutRumEvents, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_rum_events::PutRumEventsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/appmonitors/{Id}", Id = id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_rum_events::PutRumEvents::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutRumEvents", "rum"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutRumEvents`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRumEvents {
                type Output = ::std::result::Result<crate::operation::put_rum_events::PutRumEventsOutput, crate::operation::put_rum_events::PutRumEventsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_rum_events::de_put_rum_events_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_rum_events::de_put_rum_events_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_rum_events::PutRumEventsError {
