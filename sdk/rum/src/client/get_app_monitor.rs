...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_app_monitor::builders::GetAppMonitorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_app_monitor::builders::GetAppMonitorFluentBuilder::set_name): <p>The app monitor to retrieve information for.</p>
