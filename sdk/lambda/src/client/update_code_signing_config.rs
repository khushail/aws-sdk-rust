...
impl super::Client  {
    ...
    ///   - [`code_signing_config_arn(impl ::std::convert::Into<String>)`](crate::operation::update_code_signing_config::builders::UpdateCodeSigningConfigFluentBuilder::code_signing_config_arn) / [`set_code_signing_config_arn(Option<String>)`](crate::operation::update_code_signing_config::builders::UpdateCodeSigningConfigFluentBuilder::set_code_signing_config_arn): <p>The The Amazon Resource Name (ARN) of the code signing configuration.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_code_signing_config::builders::UpdateCodeSigningConfigFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_code_signing_config::builders::UpdateCodeSigningConfigFluentBuilder::set_description): <p>Descriptive name for this code signing configuration.</p>
