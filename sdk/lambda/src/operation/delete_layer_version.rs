...
impl DeleteLayerVersionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLayerVersion`](crate::operation::delete_layer_version::DeleteLayerVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_layer_version::DeleteLayerVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_layer_version::DeleteLayerVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_layer_version::DeleteLayerVersion::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLayerVersion {
                type Output = ::std::result::Result<crate::operation::delete_layer_version::DeleteLayerVersionOutput, crate::operation::delete_layer_version::DeleteLayerVersionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        ...
                        crate::protocol_serde::shape_delete_layer_version::de_delete_layer_version_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_layer_version::DeleteLayerVersionError {
