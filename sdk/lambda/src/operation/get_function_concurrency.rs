...
impl GetFunctionConcurrencyInput {
    /// Consumes the builder and constructs an Operation<[`GetFunctionConcurrency`](crate::operation::get_function_concurrency::GetFunctionConcurrency)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_function_concurrency::GetFunctionConcurrency, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_function_concurrency::GetFunctionConcurrencyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2019-09-30/functions/{FunctionName}/concurrency", FunctionName = function_name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_function_concurrency::GetFunctionConcurrency::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFunctionConcurrency {
                type Output = ::std::result::Result<crate::operation::get_function_concurrency::GetFunctionConcurrencyOutput, crate::operation::get_function_concurrency::GetFunctionConcurrencyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_function_concurrency::de_get_function_concurrency_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_function_concurrency::GetFunctionConcurrencyError {
