...
impl PublishVersionInput {
    /// Consumes the builder and constructs an Operation<[`PublishVersion`](crate::operation::publish_version::PublishVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::publish_version::PublishVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::publish_version::PublishVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::publish_version::PublishVersion::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PublishVersion {
                type Output = ::std::result::Result<crate::operation::publish_version::PublishVersionOutput, crate::operation::publish_version::PublishVersionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        ...
                        crate::protocol_serde::shape_publish_version::de_publish_version_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::publish_version::PublishVersionError {
