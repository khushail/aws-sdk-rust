...
impl GetFunctionUrlConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetFunctionUrlConfig`](crate::operation::get_function_url_config::GetFunctionUrlConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_function_url_config::GetFunctionUrlConfig, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_function_url_config::GetFunctionUrlConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_function_url_config::GetFunctionUrlConfigInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_function_url_config::GetFunctionUrlConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFunctionUrlConfig {
                type Output = ::std::result::Result<crate::operation::get_function_url_config::GetFunctionUrlConfigOutput, crate::operation::get_function_url_config::GetFunctionUrlConfigError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_function_url_config::de_get_function_url_config_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_function_url_config::GetFunctionUrlConfigError {
