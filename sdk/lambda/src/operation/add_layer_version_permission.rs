...
impl AddLayerVersionPermissionInput {
    /// Consumes the builder and constructs an Operation<[`AddLayerVersionPermission`](crate::operation::add_layer_version_permission::AddLayerVersionPermission)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::add_layer_version_permission::AddLayerVersionPermission, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_layer_version_permission::AddLayerVersionPermissionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2018-10-31/layers/{LayerName}/versions/{VersionNumber}/policy", LayerName = layer_name, VersionNumber = version_number).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::add_layer_version_permission::AddLayerVersionPermissionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_layer_version_permission::AddLayerVersionPermission::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddLayerVersionPermission {
                type Output = ::std::result::Result<crate::operation::add_layer_version_permission::AddLayerVersionPermissionOutput, crate::operation::add_layer_version_permission::AddLayerVersionPermissionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        ...
                        crate::protocol_serde::shape_add_layer_version_permission::de_add_layer_version_permission_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::add_layer_version_permission::AddLayerVersionPermissionError {
