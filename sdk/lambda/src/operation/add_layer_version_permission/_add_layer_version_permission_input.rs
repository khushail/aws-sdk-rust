...
impl AddLayerVersionPermissionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::add_layer_version_permission::AddLayerVersionPermissionInput, ::aws_smithy_http::operation::error::BuildError> {
