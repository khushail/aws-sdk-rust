...
impl DeleteFunctionUrlConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_function_url_config::DeleteFunctionUrlConfigInput, ::aws_smithy_http::operation::error::BuildError> {
