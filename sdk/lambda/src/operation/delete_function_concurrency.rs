...
impl DeleteFunctionConcurrencyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFunctionConcurrency`](crate::operation::delete_function_concurrency::DeleteFunctionConcurrency)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_function_concurrency::DeleteFunctionConcurrency, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_function_concurrency::DeleteFunctionConcurrencyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_function_concurrency::DeleteFunctionConcurrency::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFunctionConcurrency {
                type Output = ::std::result::Result<crate::operation::delete_function_concurrency::DeleteFunctionConcurrencyOutput, crate::operation::delete_function_concurrency::DeleteFunctionConcurrencyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        ...
                        crate::protocol_serde::shape_delete_function_concurrency::de_delete_function_concurrency_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_function_concurrency::DeleteFunctionConcurrencyError {
