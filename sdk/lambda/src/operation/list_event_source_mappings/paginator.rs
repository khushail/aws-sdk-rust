...
/// Paginator for [`ListEventSourceMappings`](crate::operation::list_event_source_mappings::ListEventSourceMappings)
            ...
            impl ListEventSourceMappingsPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::list_event_source_mappings::builders::ListEventSourceMappingsInputBuilder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::list_event_source_mappings::ListEventSourceMappingsOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_event_source_mappings::ListEventSourceMappingsError>>> + ::std::marker::Unpin
                 {
...
/// Flattened paginator for `ListEventSourceMappingsPaginator`
                ...
                impl  ListEventSourceMappingsPaginatorItems  {
                    ...
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::EventSourceMappingConfiguration, ::aws_smithy_http::result::SdkError<crate::operation::list_event_source_mappings::ListEventSourceMappingsError>>> + ::std::marker::Unpin
                     {
