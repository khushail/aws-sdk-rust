...
impl ListEventSourceMappingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_event_source_mappings::ListEventSourceMappingsInput, ::aws_smithy_http::operation::error::BuildError> {
