...
impl RemoveLayerVersionPermissionInput {
    /// Consumes the builder and constructs an Operation<[`RemoveLayerVersionPermission`](crate::operation::remove_layer_version_permission::RemoveLayerVersionPermission)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::remove_layer_version_permission::RemoveLayerVersionPermission, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_layer_version_permission::RemoveLayerVersionPermissionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if layer_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("layer_name", "cannot be empty or unset"))
                            }
                ...
                let input_3 = input_3.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("statement_id", "cannot be empty or unset"))?;
                ...
                ::std::write!(output, "/2018-10-31/layers/{LayerName}/versions/{VersionNumber}/policy/{StatementId}", LayerName = layer_name, VersionNumber = version_number, StatementId = statement_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::remove_layer_version_permission::RemoveLayerVersionPermissionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_layer_version_permission::RemoveLayerVersionPermission::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveLayerVersionPermission {
                type Output = ::std::result::Result<crate::operation::remove_layer_version_permission::RemoveLayerVersionPermissionOutput, crate::operation::remove_layer_version_permission::RemoveLayerVersionPermissionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        ...
                        crate::protocol_serde::shape_remove_layer_version_permission::de_remove_layer_version_permission_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::remove_layer_version_permission::RemoveLayerVersionPermissionError {
