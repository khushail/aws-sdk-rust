...
impl DeleteCodeSigningConfigInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCodeSigningConfig`](crate::operation::delete_code_signing_config::DeleteCodeSigningConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_code_signing_config::DeleteCodeSigningConfig, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_code_signing_config::DeleteCodeSigningConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if code_signing_config_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("code_signing_config_arn", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_code_signing_config::DeleteCodeSigningConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCodeSigningConfig {
                type Output = ::std::result::Result<crate::operation::delete_code_signing_config::DeleteCodeSigningConfigOutput, crate::operation::delete_code_signing_config::DeleteCodeSigningConfigError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        ...
                        crate::protocol_serde::shape_delete_code_signing_config::de_delete_code_signing_config_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_code_signing_config::DeleteCodeSigningConfigError {
