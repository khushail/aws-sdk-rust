...
impl UpdateEventSourceMappingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_event_source_mapping::UpdateEventSourceMappingInput, ::aws_smithy_http::operation::error::BuildError> {
