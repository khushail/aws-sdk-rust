...
impl DeleteEventSourceMappingInput {
    /// Consumes the builder and constructs an Operation<[`DeleteEventSourceMapping`](crate::operation::delete_event_source_mapping::DeleteEventSourceMapping)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_event_source_mapping::DeleteEventSourceMapping, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_event_source_mapping::DeleteEventSourceMappingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if uuid.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("uuid", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_event_source_mapping::DeleteEventSourceMapping::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEventSourceMapping {
                type Output = ::std::result::Result<crate::operation::delete_event_source_mapping::DeleteEventSourceMappingOutput, crate::operation::delete_event_source_mapping::DeleteEventSourceMappingError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        ...
                        crate::protocol_serde::shape_delete_event_source_mapping::de_delete_event_source_mapping_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_event_source_mapping::DeleteEventSourceMappingError {
