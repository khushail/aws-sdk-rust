...
impl ListCodeSigningConfigsInput {
    /// Consumes the builder and constructs an Operation<[`ListCodeSigningConfigs`](crate::operation::list_code_signing_configs::ListCodeSigningConfigs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_code_signing_configs::ListCodeSigningConfigs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_code_signing_configs::ListCodeSigningConfigsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2020-04-22/code-signing-configs").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_code_signing_configs::ListCodeSigningConfigsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_code_signing_configs::ListCodeSigningConfigs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCodeSigningConfigs {
                type Output = ::std::result::Result<crate::operation::list_code_signing_configs::ListCodeSigningConfigsOutput, crate::operation::list_code_signing_configs::ListCodeSigningConfigsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_code_signing_configs::de_list_code_signing_configs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_code_signing_configs::ListCodeSigningConfigsError {
