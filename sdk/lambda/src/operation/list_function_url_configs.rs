...
impl ListFunctionUrlConfigsInput {
    /// Consumes the builder and constructs an Operation<[`ListFunctionUrlConfigs`](crate::operation::list_function_url_configs::ListFunctionUrlConfigs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_function_url_configs::ListFunctionUrlConfigs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_function_url_configs::ListFunctionUrlConfigsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_function_url_configs::ListFunctionUrlConfigsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_function_url_configs::ListFunctionUrlConfigs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFunctionUrlConfigs {
                type Output = ::std::result::Result<crate::operation::list_function_url_configs::ListFunctionUrlConfigsOutput, crate::operation::list_function_url_configs::ListFunctionUrlConfigsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_function_url_configs::de_list_function_url_configs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_function_url_configs::ListFunctionUrlConfigsError {
