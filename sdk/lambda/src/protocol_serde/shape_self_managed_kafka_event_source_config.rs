...
pub(crate) fn de_self_managed_kafka_event_source_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SelfManagedKafkaEventSourceConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
