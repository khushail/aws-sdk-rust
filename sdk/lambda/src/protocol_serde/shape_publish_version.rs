...
#[allow(clippy::unnecessary_wraps)]
pub fn de_publish_version_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::publish_version::PublishVersionOutput, crate::operation::publish_version::PublishVersionError> {
    Ok({
        #[allow(unused_mut)]
