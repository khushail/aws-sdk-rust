...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_event_source_mapping_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_event_source_mapping::DeleteEventSourceMappingOutput, crate::operation::delete_event_source_mapping::DeleteEventSourceMappingError> {
    Ok({
        #[allow(unused_mut)]
