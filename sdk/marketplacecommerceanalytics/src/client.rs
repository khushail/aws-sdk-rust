...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_marketplacecommerceanalytics::Error> {
/// # let client: aws_sdk_marketplacecommerceanalytics::Client = unimplemented!();
