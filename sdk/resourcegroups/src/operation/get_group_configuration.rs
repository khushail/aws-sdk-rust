...
impl GetGroupConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetGroupConfiguration`](crate::operation::get_group_configuration::GetGroupConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_group_configuration::GetGroupConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_group_configuration::GetGroupConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/get-group-configuration").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_group_configuration::GetGroupConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetGroupConfiguration", "resourcegroups"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetGroupConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupConfiguration {
                type Output = ::std::result::Result<crate::operation::get_group_configuration::GetGroupConfigurationOutput, crate::operation::get_group_configuration::GetGroupConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_group_configuration::de_get_group_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_group_configuration::de_get_group_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_group_configuration::GetGroupConfigurationError {
...
mod _get_group_configuration_output;
