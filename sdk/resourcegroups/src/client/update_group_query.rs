...
impl super::Client  {
    ...
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::set_group_name): <p>Don't use this parameter. Use <code>Group</code> instead.</p>
    ///   - [`group(impl ::std::convert::Into<String>)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::group) / [`set_group(Option<String>)`](crate::operation::update_group_query::builders::UpdateGroupQueryFluentBuilder::set_group): <p>The name or the ARN of the resource group to query.</p>
