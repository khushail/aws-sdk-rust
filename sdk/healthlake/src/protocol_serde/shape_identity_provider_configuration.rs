...
pub fn ser_identity_provider_configuration(
    ...
    if input.fine_grained_authorization_enabled {
        object.key("FineGrainedAuthorizationEnabled").boolean(input.fine_grained_authorization_enabled);
    }
...
pub(crate) fn de_identity_provider_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::IdentityProviderConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_authorization_strategy(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AuthorizationStrategy::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "FineGrainedAuthorizationEnabled" => {
                                builder = builder.set_fine_grained_authorization_enabled(
