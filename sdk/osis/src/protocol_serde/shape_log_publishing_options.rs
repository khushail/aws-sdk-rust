...
pub(crate) fn de_log_publishing_options<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::LogPublishingOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "IsLoggingEnabled" => {
                                builder = builder.set_is_logging_enabled(
