...
impl GetPipelineChangeProgressInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_pipeline_change_progress::GetPipelineChangeProgressInput, ::aws_smithy_http::operation::error::BuildError> {
