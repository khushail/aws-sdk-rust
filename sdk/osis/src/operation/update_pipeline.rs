...
impl UpdatePipelineInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_pipeline::UpdatePipeline, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_pipeline::UpdatePipelineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2022-01-01/osis/updatePipeline/{PipelineName}", PipelineName = pipeline_name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_pipeline::UpdatePipeline::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePipeline", "osis"));
...
impl UpdatePipelineError {
    ...
    /// Returns `true` if the error kind is `UpdatePipelineError::InternalException`.
