...
impl ListPipelinesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_pipelines::ListPipelines, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_pipelines::ListPipelinesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2022-01-01/osis/listPipelines").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_pipelines::ListPipelinesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_pipelines::ListPipelines::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPipelines", "osis"));
...
impl ListPipelinesError {
    ...
    /// Returns `true` if the error kind is `ListPipelinesError::InvalidPaginationTokenException`.
