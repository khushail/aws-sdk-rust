...
pub fn de_delete_connect_instance_config_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigOutput, crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output).map_err(crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_internal_server_exception::de_internal_server_exception_json_err(_response_body, output).map_err(crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError::unhandled)?;
                    output = output.set_x_amz_error_type(
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_state_exception::de_invalid_state_exception_json_err(_response_body, output).map_err(crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError::unhandled)?;
                    output = output.set_x_amz_error_type(
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_resource_not_found_exception::de_resource_not_found_exception_json_err(_response_body, output).map_err(crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError::unhandled)?;
                    output = output.set_x_amz_error_type(
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_throttling_exception::de_throttling_exception_json_err(_response_body, output).map_err(crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError::unhandled)?;
                    output = output.set_x_amz_error_type(
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_validation_exception::de_validation_exception_json_err(_response_body, output).map_err(crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError::unhandled)?;
                    output = output.set_x_amz_error_type(
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_connect_instance_config_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigOutput, crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigError> {
    Ok({
        #[allow(unused_mut)]
