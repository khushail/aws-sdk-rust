...
impl DeleteConnectInstanceConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_connect_instance_config::DeleteConnectInstanceConfigInput, ::aws_smithy_http::operation::error::BuildError> {
