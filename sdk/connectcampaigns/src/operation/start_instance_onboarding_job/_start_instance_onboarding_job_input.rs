...
impl StartInstanceOnboardingJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_instance_onboarding_job::StartInstanceOnboardingJobInput, ::aws_smithy_http::operation::error::BuildError> {
