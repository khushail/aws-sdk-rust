...
impl StopCampaignInput {
    /// Consumes the builder and constructs an Operation<[`StopCampaign`](crate::operation::stop_campaign::StopCampaign)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_campaign::StopCampaign, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_campaign::StopCampaignInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/campaigns/{id}/stop", id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::stop_campaign::StopCampaignInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_campaign::StopCampaign::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopCampaign", "connectcampaigns"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopCampaign {
                type Output = ::std::result::Result<crate::operation::stop_campaign::StopCampaignOutput, crate::operation::stop_campaign::StopCampaignError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_campaign::de_stop_campaign_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_campaign::de_stop_campaign_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_campaign::StopCampaignError {
