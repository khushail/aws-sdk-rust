...
impl GetCampaignStateInput {
    /// Consumes the builder and constructs an Operation<[`GetCampaignState`](crate::operation::get_campaign_state::GetCampaignState)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_campaign_state::GetCampaignState, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_campaign_state::GetCampaignStateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/campaigns/{id}/state", id = id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_campaign_state::GetCampaignState::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCampaignState", "connectcampaigns"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCampaignState {
                type Output = ::std::result::Result<crate::operation::get_campaign_state::GetCampaignStateOutput, crate::operation::get_campaign_state::GetCampaignStateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_campaign_state::de_get_campaign_state_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_campaign_state::GetCampaignStateError {
