...
impl ResumeCampaignInput {
    /// Consumes the builder and constructs an Operation<[`ResumeCampaign`](crate::operation::resume_campaign::ResumeCampaign)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::resume_campaign::ResumeCampaign, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resume_campaign::ResumeCampaignInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/campaigns/{id}/resume", id = id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::resume_campaign::ResumeCampaign::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResumeCampaign", "connectcampaigns"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeCampaign {
                type Output = ::std::result::Result<crate::operation::resume_campaign::ResumeCampaignOutput, crate::operation::resume_campaign::ResumeCampaignError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_resume_campaign::de_resume_campaign_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::resume_campaign::ResumeCampaignError {
