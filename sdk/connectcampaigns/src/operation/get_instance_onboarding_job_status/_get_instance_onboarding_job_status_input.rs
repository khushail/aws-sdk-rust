...
impl GetInstanceOnboardingJobStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_instance_onboarding_job_status::GetInstanceOnboardingJobStatusInput, ::aws_smithy_http::operation::error::BuildError> {
