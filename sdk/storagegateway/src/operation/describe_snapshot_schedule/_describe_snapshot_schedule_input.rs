...
impl DescribeSnapshotScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_snapshot_schedule::DescribeSnapshotScheduleInput, ::aws_smithy_http::operation::error::BuildError> {
