...
impl UpdateMaintenanceStartTimeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_maintenance_start_time::UpdateMaintenanceStartTimeInput, ::aws_smithy_http::operation::error::BuildError> {
