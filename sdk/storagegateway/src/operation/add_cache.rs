...
impl AddCacheInput {
    /// Consumes the builder and constructs an Operation<[`AddCache`](crate::operation::add_cache::AddCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::add_cache::AddCache, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_cache::AddCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_cache::ser_add_cache_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_cache::AddCache::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AddCache", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AddCache`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddCache {
                type Output = ::std::result::Result<crate::operation::add_cache::AddCacheOutput, crate::operation::add_cache::AddCacheError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_add_cache::de_add_cache_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_add_cache::de_add_cache_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::add_cache::AddCacheError {
