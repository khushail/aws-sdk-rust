...
impl ListTapesInput {
    /// Consumes the builder and constructs an Operation<[`ListTapes`](crate::operation::list_tapes::ListTapes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_tapes::ListTapes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_tapes::ListTapesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_tapes::ListTapesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_tapes::ser_list_tapes_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_tapes::ListTapes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTapes", "storagegateway"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTapes {
                type Output = ::std::result::Result<crate::operation::list_tapes::ListTapesOutput, crate::operation::list_tapes::ListTapesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_tapes::de_list_tapes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_tapes::de_list_tapes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_tapes::ListTapesError {
