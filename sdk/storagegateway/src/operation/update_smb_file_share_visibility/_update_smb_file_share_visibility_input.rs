...
impl UpdateSmbFileShareVisibilityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_smb_file_share_visibility::UpdateSmbFileShareVisibilityInput, ::aws_smithy_http::operation::error::BuildError> {
