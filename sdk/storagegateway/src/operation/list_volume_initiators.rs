...
impl ListVolumeInitiatorsInput {
    /// Consumes the builder and constructs an Operation<[`ListVolumeInitiators`](crate::operation::list_volume_initiators::ListVolumeInitiators)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_volume_initiators::ListVolumeInitiators, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_volume_initiators::ListVolumeInitiatorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_volume_initiators::ser_list_volume_initiators_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_volume_initiators::ListVolumeInitiators::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListVolumeInitiators", "storagegateway"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVolumeInitiators {
                type Output = ::std::result::Result<crate::operation::list_volume_initiators::ListVolumeInitiatorsOutput, crate::operation::list_volume_initiators::ListVolumeInitiatorsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_volume_initiators::de_list_volume_initiators_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_volume_initiators::de_list_volume_initiators_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_volume_initiators::ListVolumeInitiatorsError {
...
mod _list_volume_initiators_output;
