...
impl DisableGatewayInput {
    /// Consumes the builder and constructs an Operation<[`DisableGateway`](crate::operation::disable_gateway::DisableGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_gateway::DisableGateway, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_gateway::DisableGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_gateway::ser_disable_gateway_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_gateway::DisableGateway::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisableGateway", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisableGateway`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableGateway {
                type Output = ::std::result::Result<crate::operation::disable_gateway::DisableGatewayOutput, crate::operation::disable_gateway::DisableGatewayError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disable_gateway::de_disable_gateway_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disable_gateway::de_disable_gateway_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_gateway::DisableGatewayError {
