...
impl UpdateNfsFileShareInput {
    /// Consumes the builder and constructs an Operation<[`UpdateNFSFileShare`](crate::operation::update_nfs_file_share::UpdateNFSFileShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_nfs_file_share::UpdateNFSFileShare, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_nfs_file_share::UpdateNfsFileShareInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_nfs_file_share::ser_update_nfs_file_share_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_nfs_file_share::UpdateNFSFileShare::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateNFSFileShare", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateNFSFileShare`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateNFSFileShare {
                type Output = ::std::result::Result<crate::operation::update_nfs_file_share::UpdateNfsFileShareOutput, crate::operation::update_nfs_file_share::UpdateNFSFileShareError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_nfs_file_share::de_update_nfs_file_share_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_nfs_file_share::de_update_nfs_file_share_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_nfs_file_share::UpdateNFSFileShareError {
...
mod _update_nfs_file_share_output;
