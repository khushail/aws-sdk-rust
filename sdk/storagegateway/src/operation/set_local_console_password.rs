...
impl SetLocalConsolePasswordInput {
    /// Consumes the builder and constructs an Operation<[`SetLocalConsolePassword`](crate::operation::set_local_console_password::SetLocalConsolePassword)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_local_console_password::SetLocalConsolePassword, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_local_console_password::SetLocalConsolePasswordInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_local_console_password::ser_set_local_console_password_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_local_console_password::SetLocalConsolePassword::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SetLocalConsolePassword", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SetLocalConsolePassword`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetLocalConsolePassword {
                type Output = ::std::result::Result<crate::operation::set_local_console_password::SetLocalConsolePasswordOutput, crate::operation::set_local_console_password::SetLocalConsolePasswordError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_set_local_console_password::de_set_local_console_password_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_set_local_console_password::de_set_local_console_password_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_local_console_password::SetLocalConsolePasswordError {
...
mod _set_local_console_password_output;
