...
impl RemoveTagsFromResourceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::remove_tags_from_resource::RemoveTagsFromResource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_tags_from_resource::RemoveTagsFromResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_tags_from_resource::RemoveTagsFromResource::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RemoveTagsFromResource", "storagegateway"));
