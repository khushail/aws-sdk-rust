...
impl DeleteFileShareInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFileShare`](crate::operation::delete_file_share::DeleteFileShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_file_share::DeleteFileShare, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_file_share::DeleteFileShareInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_file_share::ser_delete_file_share_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_file_share::DeleteFileShare::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteFileShare", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteFileShare`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFileShare {
                type Output = ::std::result::Result<crate::operation::delete_file_share::DeleteFileShareOutput, crate::operation::delete_file_share::DeleteFileShareError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_file_share::de_delete_file_share_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_file_share::de_delete_file_share_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_file_share::DeleteFileShareError {
