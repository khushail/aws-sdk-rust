...
impl ListFileSystemAssociationsInput {
    /// Consumes the builder and constructs an Operation<[`ListFileSystemAssociations`](crate::operation::list_file_system_associations::ListFileSystemAssociations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_file_system_associations::ListFileSystemAssociations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_file_system_associations::ListFileSystemAssociationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_file_system_associations::ser_list_file_system_associations_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_file_system_associations::ListFileSystemAssociations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListFileSystemAssociations", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListFileSystemAssociations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFileSystemAssociations {
                type Output = ::std::result::Result<crate::operation::list_file_system_associations::ListFileSystemAssociationsOutput, crate::operation::list_file_system_associations::ListFileSystemAssociationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_file_system_associations::de_list_file_system_associations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_file_system_associations::de_list_file_system_associations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_file_system_associations::ListFileSystemAssociationsError {
...
pub use crate::operation::list_file_system_associations::_list_file_system_associations_output::ListFileSystemAssociationsOutput;

pub use crate::operation::list_file_system_associations::_list_file_system_associations_input::ListFileSystemAssociationsInput;

mod _list_file_system_associations_input;

mod _list_file_system_associations_output;
