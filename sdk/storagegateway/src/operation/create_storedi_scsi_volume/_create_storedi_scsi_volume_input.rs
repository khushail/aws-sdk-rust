...
impl CreateStorediScsiVolumeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_storedi_scsi_volume::CreateStorediScsiVolumeInput, ::aws_smithy_http::operation::error::BuildError> {
