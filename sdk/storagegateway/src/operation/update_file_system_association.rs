...
impl UpdateFileSystemAssociationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFileSystemAssociation`](crate::operation::update_file_system_association::UpdateFileSystemAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_file_system_association::UpdateFileSystemAssociation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_file_system_association::UpdateFileSystemAssociationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_file_system_association::ser_update_file_system_association_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_file_system_association::UpdateFileSystemAssociation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateFileSystemAssociation", "storagegateway"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFileSystemAssociation {
                type Output = ::std::result::Result<crate::operation::update_file_system_association::UpdateFileSystemAssociationOutput, crate::operation::update_file_system_association::UpdateFileSystemAssociationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_file_system_association::de_update_file_system_association_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_file_system_association::de_update_file_system_association_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_file_system_association::UpdateFileSystemAssociationError {
...
pub use crate::operation::update_file_system_association::_update_file_system_association_output::UpdateFileSystemAssociationOutput;

pub use crate::operation::update_file_system_association::_update_file_system_association_input::UpdateFileSystemAssociationInput;

mod _update_file_system_association_input;

mod _update_file_system_association_output;
