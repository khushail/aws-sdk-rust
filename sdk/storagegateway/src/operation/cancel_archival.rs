...
impl CancelArchivalInput {
    /// Consumes the builder and constructs an Operation<[`CancelArchival`](crate::operation::cancel_archival::CancelArchival)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_archival::CancelArchival, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_archival::CancelArchivalInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_archival::ser_cancel_archival_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_archival::CancelArchival::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelArchival", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CancelArchival`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelArchival {
                type Output = ::std::result::Result<crate::operation::cancel_archival::CancelArchivalOutput, crate::operation::cancel_archival::CancelArchivalError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_cancel_archival::de_cancel_archival_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_cancel_archival::de_cancel_archival_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_archival::CancelArchivalError {
