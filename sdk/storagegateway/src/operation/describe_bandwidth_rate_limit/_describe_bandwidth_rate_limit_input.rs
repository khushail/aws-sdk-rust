...
impl DescribeBandwidthRateLimitInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_bandwidth_rate_limit::DescribeBandwidthRateLimitInput, ::aws_smithy_http::operation::error::BuildError> {
