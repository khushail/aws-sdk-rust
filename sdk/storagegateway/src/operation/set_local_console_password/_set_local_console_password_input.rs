...
impl SetLocalConsolePasswordInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_local_console_password::SetLocalConsolePasswordInput, ::aws_smithy_http::operation::error::BuildError> {
