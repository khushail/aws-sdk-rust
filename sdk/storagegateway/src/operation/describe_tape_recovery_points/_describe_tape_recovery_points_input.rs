...
impl DescribeTapeRecoveryPointsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_tape_recovery_points::DescribeTapeRecoveryPointsInput, ::aws_smithy_http::operation::error::BuildError> {
