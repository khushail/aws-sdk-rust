...
impl NotifyWhenUploadedInput {
    /// Consumes the builder and constructs an Operation<[`NotifyWhenUploaded`](crate::operation::notify_when_uploaded::NotifyWhenUploaded)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::notify_when_uploaded::NotifyWhenUploaded, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::notify_when_uploaded::NotifyWhenUploadedInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_notify_when_uploaded::ser_notify_when_uploaded_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::notify_when_uploaded::NotifyWhenUploaded::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("NotifyWhenUploaded", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `NotifyWhenUploaded`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for NotifyWhenUploaded {
                type Output = ::std::result::Result<crate::operation::notify_when_uploaded::NotifyWhenUploadedOutput, crate::operation::notify_when_uploaded::NotifyWhenUploadedError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_notify_when_uploaded::de_notify_when_uploaded_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_notify_when_uploaded::de_notify_when_uploaded_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::notify_when_uploaded::NotifyWhenUploadedError {
...
mod _notify_when_uploaded_output;
