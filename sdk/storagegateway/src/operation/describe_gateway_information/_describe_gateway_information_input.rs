...
impl DescribeGatewayInformationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_gateway_information::DescribeGatewayInformationInput, ::aws_smithy_http::operation::error::BuildError> {
