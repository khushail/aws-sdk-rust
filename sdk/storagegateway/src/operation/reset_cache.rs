...
impl ResetCacheInput {
    /// Consumes the builder and constructs an Operation<[`ResetCache`](crate::operation::reset_cache::ResetCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reset_cache::ResetCache, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_cache::ResetCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_cache::ser_reset_cache_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reset_cache::ResetCache::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResetCache", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ResetCache`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetCache {
                type Output = ::std::result::Result<crate::operation::reset_cache::ResetCacheOutput, crate::operation::reset_cache::ResetCacheError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_reset_cache::de_reset_cache_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_reset_cache::de_reset_cache_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_cache::ResetCacheError {
