...
impl RetrieveTapeRecoveryPointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::retrieve_tape_recovery_point::RetrieveTapeRecoveryPointInput, ::aws_smithy_http::operation::error::BuildError> {
