...
impl DeleteAutomaticTapeCreationPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAutomaticTapeCreationPolicy`](crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_automatic_tape_creation_policy::ser_delete_automatic_tape_creation_policy_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAutomaticTapeCreationPolicy", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteAutomaticTapeCreationPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAutomaticTapeCreationPolicy {
                type Output = ::std::result::Result<crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyOutput, crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_automatic_tape_creation_policy::DeleteAutomaticTapeCreationPolicyError {
...
mod _delete_automatic_tape_creation_policy_output;
