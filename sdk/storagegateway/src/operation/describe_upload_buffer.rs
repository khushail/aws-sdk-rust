...
impl DescribeUploadBufferInput {
    /// Consumes the builder and constructs an Operation<[`DescribeUploadBuffer`](crate::operation::describe_upload_buffer::DescribeUploadBuffer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_upload_buffer::DescribeUploadBuffer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_upload_buffer::DescribeUploadBufferInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_upload_buffer::ser_describe_upload_buffer_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_upload_buffer::DescribeUploadBuffer::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeUploadBuffer", "storagegateway"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUploadBuffer {
                type Output = ::std::result::Result<crate::operation::describe_upload_buffer::DescribeUploadBufferOutput, crate::operation::describe_upload_buffer::DescribeUploadBufferError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_upload_buffer::de_describe_upload_buffer_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_upload_buffer::de_describe_upload_buffer_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_upload_buffer::DescribeUploadBufferError {
...
mod _describe_upload_buffer_output;
