...
impl RetrieveTapeArchiveInput {
    /// Consumes the builder and constructs an Operation<[`RetrieveTapeArchive`](crate::operation::retrieve_tape_archive::RetrieveTapeArchive)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::retrieve_tape_archive::RetrieveTapeArchive, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::retrieve_tape_archive::RetrieveTapeArchiveInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_retrieve_tape_archive::ser_retrieve_tape_archive_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::retrieve_tape_archive::RetrieveTapeArchive::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RetrieveTapeArchive", "storagegateway"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RetrieveTapeArchive {
                type Output = ::std::result::Result<crate::operation::retrieve_tape_archive::RetrieveTapeArchiveOutput, crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_retrieve_tape_archive::de_retrieve_tape_archive_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_retrieve_tape_archive::de_retrieve_tape_archive_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::retrieve_tape_archive::RetrieveTapeArchiveError {
...
mod _retrieve_tape_archive_output;
