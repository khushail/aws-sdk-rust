...
impl DescribeGatewayInformationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGatewayInformation`](crate::operation::describe_gateway_information::DescribeGatewayInformation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_gateway_information::DescribeGatewayInformation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_gateway_information::DescribeGatewayInformationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_gateway_information::ser_describe_gateway_information_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_gateway_information::DescribeGatewayInformation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeGatewayInformation", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeGatewayInformation`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGatewayInformation {
                type Output = ::std::result::Result<crate::operation::describe_gateway_information::DescribeGatewayInformationOutput, crate::operation::describe_gateway_information::DescribeGatewayInformationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_gateway_information::de_describe_gateway_information_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_gateway_information::de_describe_gateway_information_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_gateway_information::DescribeGatewayInformationError {
...
mod _describe_gateway_information_output;
