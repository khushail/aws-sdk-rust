...
impl StartAvailabilityMonitorTestInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestInput, ::aws_smithy_http::operation::error::BuildError> {
