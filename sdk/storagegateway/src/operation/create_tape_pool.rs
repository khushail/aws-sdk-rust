...
impl CreateTapePoolInput {
    /// Consumes the builder and constructs an Operation<[`CreateTapePool`](crate::operation::create_tape_pool::CreateTapePool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_tape_pool::CreateTapePool, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_tape_pool::CreateTapePoolInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_tape_pool::ser_create_tape_pool_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_tape_pool::CreateTapePool::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateTapePool", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateTapePool`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTapePool {
                type Output = ::std::result::Result<crate::operation::create_tape_pool::CreateTapePoolOutput, crate::operation::create_tape_pool::CreateTapePoolError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_tape_pool::de_create_tape_pool_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_tape_pool::de_create_tape_pool_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_tape_pool::CreateTapePoolError {
...
pub use crate::operation::create_tape_pool::_create_tape_pool_output::CreateTapePoolOutput;

pub use crate::operation::create_tape_pool::_create_tape_pool_input::CreateTapePoolInput;

mod _create_tape_pool_input;

mod _create_tape_pool_output;
