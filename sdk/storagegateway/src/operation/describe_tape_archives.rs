...
impl DescribeTapeArchivesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTapeArchives`](crate::operation::describe_tape_archives::DescribeTapeArchives)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_tape_archives::DescribeTapeArchives, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_tape_archives::DescribeTapeArchivesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_tape_archives::DescribeTapeArchivesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_tape_archives::ser_describe_tape_archives_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_tape_archives::DescribeTapeArchives::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeTapeArchives", "storagegateway"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTapeArchives {
                type Output = ::std::result::Result<crate::operation::describe_tape_archives::DescribeTapeArchivesOutput, crate::operation::describe_tape_archives::DescribeTapeArchivesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_tape_archives::de_describe_tape_archives_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_tape_archives::de_describe_tape_archives_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_tape_archives::DescribeTapeArchivesError {
...
mod _describe_tape_archives_output;
