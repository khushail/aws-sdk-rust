...
impl UpdateSmbSecurityStrategyInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSMBSecurityStrategy`](crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_smb_security_strategy::UpdateSmbSecurityStrategyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_smb_security_strategy::ser_update_smb_security_strategy_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateSMBSecurityStrategy", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateSMBSecurityStrategy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSMBSecurityStrategy {
                type Output = ::std::result::Result<crate::operation::update_smb_security_strategy::UpdateSmbSecurityStrategyOutput, crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_smb_security_strategy::de_update_smb_security_strategy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_smb_security_strategy::de_update_smb_security_strategy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_smb_security_strategy::UpdateSMBSecurityStrategyError {
...
mod _update_smb_security_strategy_output;
