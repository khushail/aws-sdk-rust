...
impl DescribeCachediScsiVolumesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCachediSCSIVolumes`](crate::operation::describe_cachedi_scsi_volumes::DescribeCachediSCSIVolumes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_cachedi_scsi_volumes::DescribeCachediSCSIVolumes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cachedi_scsi_volumes::DescribeCachediScsiVolumesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_cachedi_scsi_volumes::ser_describe_cachedi_scsi_volumes_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cachedi_scsi_volumes::DescribeCachediSCSIVolumes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeCachediSCSIVolumes", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeCachediSCSIVolumes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCachediSCSIVolumes {
                type Output = ::std::result::Result<crate::operation::describe_cachedi_scsi_volumes::DescribeCachediScsiVolumesOutput, crate::operation::describe_cachedi_scsi_volumes::DescribeCachediSCSIVolumesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_cachedi_scsi_volumes::de_describe_cachedi_scsi_volumes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_cachedi_scsi_volumes::de_describe_cachedi_scsi_volumes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_cachedi_scsi_volumes::DescribeCachediSCSIVolumesError {
...
pub use crate::operation::describe_cachedi_scsi_volumes::_describe_cachedi_scsi_volumes_output::DescribeCachediScsiVolumesOutput;

pub use crate::operation::describe_cachedi_scsi_volumes::_describe_cachedi_scsi_volumes_input::DescribeCachediScsiVolumesInput;

mod _describe_cachedi_scsi_volumes_input;

mod _describe_cachedi_scsi_volumes_output;
