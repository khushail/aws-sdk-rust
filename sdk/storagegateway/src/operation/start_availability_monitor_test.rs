...
impl StartAvailabilityMonitorTestInput {
    /// Consumes the builder and constructs an Operation<[`StartAvailabilityMonitorTest`](crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTest)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTest, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_availability_monitor_test::ser_start_availability_monitor_test_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTest::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartAvailabilityMonitorTest", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartAvailabilityMonitorTest`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAvailabilityMonitorTest {
                type Output = ::std::result::Result<crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestOutput, crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_availability_monitor_test::de_start_availability_monitor_test_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_availability_monitor_test::de_start_availability_monitor_test_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_availability_monitor_test::StartAvailabilityMonitorTestError {
...
mod _start_availability_monitor_test_output;
