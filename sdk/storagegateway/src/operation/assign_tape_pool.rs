...
impl AssignTapePoolInput {
    /// Consumes the builder and constructs an Operation<[`AssignTapePool`](crate::operation::assign_tape_pool::AssignTapePool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::assign_tape_pool::AssignTapePool, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::assign_tape_pool::AssignTapePoolInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_assign_tape_pool::ser_assign_tape_pool_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::assign_tape_pool::AssignTapePool::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssignTapePool", "storagegateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssignTapePool`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssignTapePool {
                type Output = ::std::result::Result<crate::operation::assign_tape_pool::AssignTapePoolOutput, crate::operation::assign_tape_pool::AssignTapePoolError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_assign_tape_pool::de_assign_tape_pool_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_assign_tape_pool::de_assign_tape_pool_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::assign_tape_pool::AssignTapePoolError {
