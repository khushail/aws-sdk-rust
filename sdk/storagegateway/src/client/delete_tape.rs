...
impl super::Client  {
    ...
    ///   - [`gateway_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_tape::builders::DeleteTapeFluentBuilder::gateway_arn) / [`set_gateway_arn(Option<String>)`](crate::operation::delete_tape::builders::DeleteTapeFluentBuilder::set_gateway_arn): <p>The unique Amazon Resource Name (ARN) of the gateway that the virtual tape to delete is associated with. Use the <code>ListGateways</code> operation to return a list of gateways for your account and Amazon Web Services Region.</p>
    ///   - [`tape_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_tape::builders::DeleteTapeFluentBuilder::tape_arn) / [`set_tape_arn(Option<String>)`](crate::operation::delete_tape::builders::DeleteTapeFluentBuilder::set_tape_arn): <p>The Amazon Resource Name (ARN) of the virtual tape to delete.</p>
