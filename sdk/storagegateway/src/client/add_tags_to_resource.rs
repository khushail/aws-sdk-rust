...
impl super::Client  {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::add_tags_to_resource::builders::AddTagsToResourceFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::add_tags_to_resource::builders::AddTagsToResourceFluentBuilder::set_resource_arn): <p>The Amazon Resource Name (ARN) of the resource you want to add tags to.</p>
