...
pub fn de_delete_volume_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_volume::DeleteVolumeOutput, crate::operation::delete_volume::DeleteVolumeError> {
    ...
    Err(match error_code {
        ...
        "InvalidGatewayRequestException" => crate::operation::delete_volume::DeleteVolumeError::InvalidGatewayRequestException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_volume_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_volume::DeleteVolumeOutput, crate::operation::delete_volume::DeleteVolumeError> {
    Ok({
        #[allow(unused_mut)]
