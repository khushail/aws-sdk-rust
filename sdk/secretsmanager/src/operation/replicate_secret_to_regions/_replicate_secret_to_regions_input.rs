...
impl ReplicateSecretToRegionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::replicate_secret_to_regions::ReplicateSecretToRegionsInput, ::aws_smithy_http::operation::error::BuildError> {
