...
impl CancelRotateSecretInput {
    /// Consumes the builder and constructs an Operation<[`CancelRotateSecret`](crate::operation::cancel_rotate_secret::CancelRotateSecret)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_rotate_secret::CancelRotateSecret, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_rotate_secret::CancelRotateSecretInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_rotate_secret::ser_cancel_rotate_secret_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_rotate_secret::CancelRotateSecret::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelRotateSecret {
                type Output = ::std::result::Result<crate::operation::cancel_rotate_secret::CancelRotateSecretOutput, crate::operation::cancel_rotate_secret::CancelRotateSecretError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_cancel_rotate_secret::de_cancel_rotate_secret_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_cancel_rotate_secret::de_cancel_rotate_secret_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_rotate_secret::CancelRotateSecretError {
...
mod _cancel_rotate_secret_output;
