...
impl StopReplicationToReplicaInput {
    /// Consumes the builder and constructs an Operation<[`StopReplicationToReplica`](crate::operation::stop_replication_to_replica::StopReplicationToReplica)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_replication_to_replica::StopReplicationToReplica, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_replication_to_replica::StopReplicationToReplicaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_replication_to_replica::ser_stop_replication_to_replica_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_replication_to_replica::StopReplicationToReplica::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopReplicationToReplica", "secretsmanager"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StopReplicationToReplica`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopReplicationToReplica {
                type Output = ::std::result::Result<crate::operation::stop_replication_to_replica::StopReplicationToReplicaOutput, crate::operation::stop_replication_to_replica::StopReplicationToReplicaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_replication_to_replica::de_stop_replication_to_replica_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_replication_to_replica::de_stop_replication_to_replica_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_replication_to_replica::StopReplicationToReplicaError {
...
pub use crate::operation::stop_replication_to_replica::_stop_replication_to_replica_output::StopReplicationToReplicaOutput;

pub use crate::operation::stop_replication_to_replica::_stop_replication_to_replica_input::StopReplicationToReplicaInput;

mod _stop_replication_to_replica_input;

mod _stop_replication_to_replica_output;
