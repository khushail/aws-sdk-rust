...
impl UpdateSecretVersionStageInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSecretVersionStage`](crate::operation::update_secret_version_stage::UpdateSecretVersionStage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_secret_version_stage::UpdateSecretVersionStage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_secret_version_stage::UpdateSecretVersionStageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_secret_version_stage::ser_update_secret_version_stage_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_secret_version_stage::UpdateSecretVersionStage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateSecretVersionStage", "secretsmanager"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateSecretVersionStage`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSecretVersionStage {
                type Output = ::std::result::Result<crate::operation::update_secret_version_stage::UpdateSecretVersionStageOutput, crate::operation::update_secret_version_stage::UpdateSecretVersionStageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_secret_version_stage::de_update_secret_version_stage_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_secret_version_stage::de_update_secret_version_stage_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_secret_version_stage::UpdateSecretVersionStageError {
...
mod _update_secret_version_stage_output;
