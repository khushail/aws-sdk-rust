...
impl RotateSecretInput {
    /// Consumes the builder and constructs an Operation<[`RotateSecret`](crate::operation::rotate_secret::RotateSecret)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::rotate_secret::RotateSecret, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::rotate_secret::RotateSecretInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_rotate_secret::ser_rotate_secret_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::rotate_secret::RotateSecret::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RotateSecret {
                type Output = ::std::result::Result<crate::operation::rotate_secret::RotateSecretOutput, crate::operation::rotate_secret::RotateSecretError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_rotate_secret::de_rotate_secret_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_rotate_secret::de_rotate_secret_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::rotate_secret::RotateSecretError {
