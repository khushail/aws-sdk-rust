...
impl StopReplicationToReplicaInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_replication_to_replica::StopReplicationToReplicaInput, ::aws_smithy_http::operation::error::BuildError> {
