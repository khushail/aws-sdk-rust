...
impl ListBatchJobDefinitionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_batch_job_definitions::ListBatchJobDefinitionsInput, ::aws_smithy_http::operation::error::BuildError> {
