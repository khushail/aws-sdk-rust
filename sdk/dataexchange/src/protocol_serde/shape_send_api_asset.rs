...
#[allow(clippy::unnecessary_wraps)]
pub fn de_send_api_asset_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::send_api_asset::SendApiAssetOutput, crate::operation::send_api_asset::SendApiAssetError> {
    Ok({
        #[allow(unused_mut)]
