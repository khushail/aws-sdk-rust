...
pub(crate) fn de_lake_formation_data_permission_asset<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::LakeFormationDataPermissionAsset>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::LakeFormationDataPermissionAssetBuilder::default();
            loop {
                match tokens.next().transpose()? {
                                ...
                                builder = builder.set_lake_formation_data_permission_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::LakeFormationDataPermissionType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
