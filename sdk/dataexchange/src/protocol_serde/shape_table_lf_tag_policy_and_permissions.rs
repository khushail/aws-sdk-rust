...
pub(crate) fn de_table_lf_tag_policy_and_permissions<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TableLfTagPolicyAndPermissions>, ::aws_smithy_json::deserialize::error::DeserializeError>
