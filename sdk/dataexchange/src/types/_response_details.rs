...
impl ResponseDetailsBuilder {
    ...
    /// <p>Details from an import from Amazon Redshift datashare response.</p>
    pub fn get_import_assets_from_redshift_data_shares(&self) -> &::std::option::Option<crate::types::ImportAssetsFromRedshiftDataSharesResponseDetails> {
    ...
    /// <p>Response details from the ImportAssetsFromLakeFormationTagPolicy job.</p>
    pub fn get_import_assets_from_lake_formation_tag_policy(&self) -> &::std::option::Option<crate::types::ImportAssetsFromLakeFormationTagPolicyResponseDetails> {
