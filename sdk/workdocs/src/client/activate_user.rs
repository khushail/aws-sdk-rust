...
impl super::Client  {
    ...
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::activate_user::builders::ActivateUserFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::activate_user::builders::ActivateUserFluentBuilder::set_user_id): <p>The ID of the user.</p>
    ///   - [`authentication_token(impl ::std::convert::Into<String>)`](crate::operation::activate_user::builders::ActivateUserFluentBuilder::authentication_token) / [`set_authentication_token(Option<String>)`](crate::operation::activate_user::builders::ActivateUserFluentBuilder::set_authentication_token): <p>Amazon WorkDocs authentication token. Not required when using Amazon Web Services administrator credentials to access the API.</p>
