...
impl super::Client  {
    ...
    ///   - [`authentication_token(impl ::std::convert::Into<String>)`](crate::operation::describe_comments::builders::DescribeCommentsFluentBuilder::authentication_token) / [`set_authentication_token(Option<String>)`](crate::operation::describe_comments::builders::DescribeCommentsFluentBuilder::set_authentication_token): <p>Amazon WorkDocs authentication token. Not required when using Amazon Web Services administrator credentials to access the API.</p>
    ///   - [`document_id(impl ::std::convert::Into<String>)`](crate::operation::describe_comments::builders::DescribeCommentsFluentBuilder::document_id) / [`set_document_id(Option<String>)`](crate::operation::describe_comments::builders::DescribeCommentsFluentBuilder::set_document_id): <p>The ID of the document.</p>
    ///   - [`version_id(impl ::std::convert::Into<String>)`](crate::operation::describe_comments::builders::DescribeCommentsFluentBuilder::version_id) / [`set_version_id(Option<String>)`](crate::operation::describe_comments::builders::DescribeCommentsFluentBuilder::set_version_id): <p>The ID of the document version.</p>
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::describe_comments::builders::DescribeCommentsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_comments::builders::DescribeCommentsFluentBuilder::set_marker): <p>The marker for the next set of results. This marker was received from a previous call.</p>
