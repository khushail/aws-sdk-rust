...
impl super::Client  {
    ...
    ///   - [`authentication_token(impl ::std::convert::Into<String>)`](crate::operation::create_custom_metadata::builders::CreateCustomMetadataFluentBuilder::authentication_token) / [`set_authentication_token(Option<String>)`](crate::operation::create_custom_metadata::builders::CreateCustomMetadataFluentBuilder::set_authentication_token): <p>Amazon WorkDocs authentication token. Not required when using Amazon Web Services administrator credentials to access the API.</p>
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::create_custom_metadata::builders::CreateCustomMetadataFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::create_custom_metadata::builders::CreateCustomMetadataFluentBuilder::set_resource_id): <p>The ID of the resource.</p>
    ///   - [`version_id(impl ::std::convert::Into<String>)`](crate::operation::create_custom_metadata::builders::CreateCustomMetadataFluentBuilder::version_id) / [`set_version_id(Option<String>)`](crate::operation::create_custom_metadata::builders::CreateCustomMetadataFluentBuilder::set_version_id): <p>The ID of the version, if the custom metadata is being added to a document version.</p>
