...
impl super::Client  {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::describe_notification_subscriptions::builders::DescribeNotificationSubscriptionsFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::describe_notification_subscriptions::builders::DescribeNotificationSubscriptionsFluentBuilder::set_organization_id): <p>The ID of the organization.</p>
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::describe_notification_subscriptions::builders::DescribeNotificationSubscriptionsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::describe_notification_subscriptions::builders::DescribeNotificationSubscriptionsFluentBuilder::set_marker): <p>The marker for the next set of results. (You received this marker from a previous call.)</p>
