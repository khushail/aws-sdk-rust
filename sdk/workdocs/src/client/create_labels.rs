...
impl super::Client  {
    ...
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::create_labels::builders::CreateLabelsFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::create_labels::builders::CreateLabelsFluentBuilder::set_resource_id): <p>The ID of the resource.</p>
