...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_document_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_document::UpdateDocumentOutput, crate::operation::update_document::UpdateDocumentError> {
    Ok({
        #[allow(unused_mut)]
