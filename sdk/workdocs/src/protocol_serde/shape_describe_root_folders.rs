...
pub fn ser_describe_root_folders_headers(
...
pub fn de_describe_root_folders_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_root_folders::DescribeRootFoldersOutput, crate::operation::describe_root_folders::DescribeRootFoldersError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::describe_root_folders::DescribeRootFoldersError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "FailedDependencyException" => crate::operation::describe_root_folders::DescribeRootFoldersError::FailedDependencyException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidArgumentException" => crate::operation::describe_root_folders::DescribeRootFoldersError::InvalidArgumentException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceUnavailableException" => crate::operation::describe_root_folders::DescribeRootFoldersError::ServiceUnavailableException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedOperationException" => crate::operation::describe_root_folders::DescribeRootFoldersError::UnauthorizedOperationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "UnauthorizedResourceAccessException" => crate::operation::describe_root_folders::DescribeRootFoldersError::UnauthorizedResourceAccessException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::describe_root_folders::DescribeRootFoldersError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_root_folders_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_root_folders::DescribeRootFoldersOutput, crate::operation::describe_root_folders::DescribeRootFoldersError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_describe_root_folders(value: &[u8], mut builder: crate::operation::describe_root_folders::builders::DescribeRootFoldersOutputBuilder) -> Result<crate::operation::describe_root_folders::builders::DescribeRootFoldersOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
