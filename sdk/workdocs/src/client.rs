...
mod abort_document_version_upload;

mod activate_user;

mod add_resource_permissions;

mod create_comment;

mod create_custom_metadata;

mod create_folder;

mod create_labels;

mod create_notification_subscription;
...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_workdocs::Error> {
/// # let client: aws_sdk_workdocs::Client = unimplemented!();
...
mod delete_custom_metadata;

mod delete_document;

mod delete_document_version;

mod delete_folder;

mod delete_folder_contents;

mod delete_labels;

mod delete_notification_subscription;

mod delete_user;

mod describe_activities;

mod describe_comments;

mod describe_document_versions;

mod describe_folder_contents;

mod describe_groups;

mod describe_notification_subscriptions;

mod describe_resource_permissions;

mod describe_root_folders;
...
mod initiate_document_version_upload;

mod remove_all_resource_permissions;

mod remove_resource_permission;
