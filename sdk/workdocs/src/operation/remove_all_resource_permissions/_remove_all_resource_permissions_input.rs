...
impl RemoveAllResourcePermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_all_resource_permissions::RemoveAllResourcePermissionsInput, ::aws_smithy_http::operation::error::BuildError> {
