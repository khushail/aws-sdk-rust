...
impl DeleteFolderContentsInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFolderContents`](crate::operation::delete_folder_contents::DeleteFolderContents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_folder_contents::DeleteFolderContents, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_folder_contents::DeleteFolderContentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_folder_contents::DeleteFolderContents::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteFolderContents", "workdocs"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteFolderContents`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFolderContents {
                type Output = ::std::result::Result<crate::operation::delete_folder_contents::DeleteFolderContentsOutput, crate::operation::delete_folder_contents::DeleteFolderContentsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_delete_folder_contents::de_delete_folder_contents_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_folder_contents::de_delete_folder_contents_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_folder_contents::DeleteFolderContentsError {
...
mod _delete_folder_contents_output;
