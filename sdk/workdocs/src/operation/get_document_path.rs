...
impl GetDocumentPathInput {
    /// Consumes the builder and constructs an Operation<[`GetDocumentPath`](crate::operation::get_document_path::GetDocumentPath)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_document_path::GetDocumentPath, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_document_path::GetDocumentPathInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if document_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("document_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/api/v1/documents/{DocumentId}/path", DocumentId = document_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_document_path::GetDocumentPathInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_document_path::GetDocumentPath::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDocumentPath", "workdocs"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetDocumentPath`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDocumentPath {
                type Output = ::std::result::Result<crate::operation::get_document_path::GetDocumentPathOutput, crate::operation::get_document_path::GetDocumentPathError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_document_path::de_get_document_path_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_document_path::de_get_document_path_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_document_path::GetDocumentPathError {
...
pub use crate::operation::get_document_path::_get_document_path_output::GetDocumentPathOutput;

pub use crate::operation::get_document_path::_get_document_path_input::GetDocumentPathInput;

mod _get_document_path_input;

mod _get_document_path_output;
