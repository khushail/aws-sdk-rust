...
impl AddResourcePermissionsInput {
    /// Consumes the builder and constructs an Operation<[`AddResourcePermissions`](crate::operation::add_resource_permissions::AddResourcePermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::add_resource_permissions::AddResourcePermissions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_resource_permissions::AddResourcePermissionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_resource_permissions::AddResourcePermissions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddResourcePermissions {
                type Output = ::std::result::Result<crate::operation::add_resource_permissions::AddResourcePermissionsOutput, crate::operation::add_resource_permissions::AddResourcePermissionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_add_resource_permissions::de_add_resource_permissions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_add_resource_permissions::de_add_resource_permissions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::add_resource_permissions::AddResourcePermissionsError {
...
mod _add_resource_permissions_output;
