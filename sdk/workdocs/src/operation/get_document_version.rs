...
impl GetDocumentVersionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_document_version::GetDocumentVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_document_version::GetDocumentVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_document_version::GetDocumentVersionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_4) = &_input.include_custom_metadata {
                    if *inner_4 {
                        query.push_kv("includeCustomMetadata", ::aws_smithy_types::primitive::Encoder::from(*inner_4).encode());
                    }
                }
                ::std::result::Result::Ok(())
            }
...
/// Orchestration and serialization glue logic for `GetDocumentVersion`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDocumentVersion {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_document_version::de_get_document_version_http_error(status, headers, body)
                     } else {
