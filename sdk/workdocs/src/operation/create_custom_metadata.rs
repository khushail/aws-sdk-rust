...
impl CreateCustomMetadataInput {
    /// Consumes the builder and constructs an Operation<[`CreateCustomMetadata`](crate::operation::create_custom_metadata::CreateCustomMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_custom_metadata::CreateCustomMetadata, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_custom_metadata::CreateCustomMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_custom_metadata::CreateCustomMetadataInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_custom_metadata::CreateCustomMetadata::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCustomMetadata {
                type Output = ::std::result::Result<crate::operation::create_custom_metadata::CreateCustomMetadataOutput, crate::operation::create_custom_metadata::CreateCustomMetadataError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_custom_metadata::de_create_custom_metadata_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_custom_metadata::de_create_custom_metadata_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_custom_metadata::CreateCustomMetadataError {
...
mod _create_custom_metadata_output;
