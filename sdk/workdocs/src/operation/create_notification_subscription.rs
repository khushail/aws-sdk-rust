...
impl CreateNotificationSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`CreateNotificationSubscription`](crate::operation::create_notification_subscription::CreateNotificationSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_notification_subscription::CreateNotificationSubscription, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_notification_subscription::CreateNotificationSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_notification_subscription::CreateNotificationSubscription::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateNotificationSubscription", "workdocs"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateNotificationSubscription`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNotificationSubscription {
                type Output = ::std::result::Result<crate::operation::create_notification_subscription::CreateNotificationSubscriptionOutput, crate::operation::create_notification_subscription::CreateNotificationSubscriptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_notification_subscription::de_create_notification_subscription_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_notification_subscription::de_create_notification_subscription_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_notification_subscription::CreateNotificationSubscriptionError {
...
pub use crate::operation::create_notification_subscription::_create_notification_subscription_output::CreateNotificationSubscriptionOutput;

pub use crate::operation::create_notification_subscription::_create_notification_subscription_input::CreateNotificationSubscriptionInput;

mod _create_notification_subscription_input;

mod _create_notification_subscription_output;
