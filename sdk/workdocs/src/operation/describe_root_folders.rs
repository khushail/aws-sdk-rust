...
impl DescribeRootFoldersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRootFolders`](crate::operation::describe_root_folders::DescribeRootFolders)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_root_folders::DescribeRootFolders, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_root_folders::DescribeRootFoldersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/api/v1/me/root").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_root_folders::DescribeRootFoldersInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_root_folders::DescribeRootFoldersInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_root_folders::DescribeRootFolders::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeRootFolders", "workdocs"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeRootFolders`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRootFolders {
                type Output = ::std::result::Result<crate::operation::describe_root_folders::DescribeRootFoldersOutput, crate::operation::describe_root_folders::DescribeRootFoldersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_root_folders::de_describe_root_folders_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_root_folders::de_describe_root_folders_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_root_folders::DescribeRootFoldersError {
...
mod _describe_root_folders_output;
