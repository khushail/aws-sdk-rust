...
impl DescribeCommentsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeComments`](crate::operation::describe_comments::DescribeComments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_comments::DescribeComments, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_comments::DescribeCommentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if version_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("version_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/api/v1/documents/{DocumentId}/versions/{VersionId}/comments", DocumentId = document_id, VersionId = version_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_comments::DescribeCommentsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_comments::DescribeComments::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeComments {
                type Output = ::std::result::Result<crate::operation::describe_comments::DescribeCommentsOutput, crate::operation::describe_comments::DescribeCommentsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_comments::de_describe_comments_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_comments::de_describe_comments_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_comments::DescribeCommentsError {
