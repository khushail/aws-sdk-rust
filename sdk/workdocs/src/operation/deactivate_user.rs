...
impl DeactivateUserInput {
    /// Consumes the builder and constructs an Operation<[`DeactivateUser`](crate::operation::deactivate_user::DeactivateUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deactivate_user::DeactivateUser, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deactivate_user::DeactivateUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deactivate_user::DeactivateUser::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeactivateUser {
                type Output = ::std::result::Result<crate::operation::deactivate_user::DeactivateUserOutput, crate::operation::deactivate_user::DeactivateUserError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_deactivate_user::de_deactivate_user_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deactivate_user::de_deactivate_user_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deactivate_user::DeactivateUserError {
