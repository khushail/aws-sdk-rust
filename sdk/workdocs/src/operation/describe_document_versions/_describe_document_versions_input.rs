...
impl DescribeDocumentVersionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_document_versions::DescribeDocumentVersionsInput, ::aws_smithy_http::operation::error::BuildError> {
