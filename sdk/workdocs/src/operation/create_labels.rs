...
impl CreateLabelsInput {
    /// Consumes the builder and constructs an Operation<[`CreateLabels`](crate::operation::create_labels::CreateLabels)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_labels::CreateLabels, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_labels::CreateLabelsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_labels::CreateLabels::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLabels {
                type Output = ::std::result::Result<crate::operation::create_labels::CreateLabelsOutput, crate::operation::create_labels::CreateLabelsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_labels::de_create_labels_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_labels::de_create_labels_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_labels::CreateLabelsError {
...
pub use crate::operation::create_labels::_create_labels_output::CreateLabelsOutput;

pub use crate::operation::create_labels::_create_labels_input::CreateLabelsInput;

mod _create_labels_input;

mod _create_labels_output;
