...
impl DescribeResourcePermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_resource_permissions::DescribeResourcePermissionsInput, ::aws_smithy_http::operation::error::BuildError> {
