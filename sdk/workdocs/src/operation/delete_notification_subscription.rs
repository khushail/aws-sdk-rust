...
impl DeleteNotificationSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteNotificationSubscription`](crate::operation::delete_notification_subscription::DeleteNotificationSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_notification_subscription::DeleteNotificationSubscription, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_notification_subscription::DeleteNotificationSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if organization_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("organization_id", "cannot be empty or unset"))
                            }
                let input_2 = &_input.subscription_id;
                let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("subscription_id", "cannot be empty or unset"))?;
                let subscription_id = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
                if subscription_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("subscription_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/api/v1/organizations/{OrganizationId}/subscriptions/{SubscriptionId}", OrganizationId = organization_id, SubscriptionId = subscription_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::delete_notification_subscription::DeleteNotificationSubscriptionInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_notification_subscription::DeleteNotificationSubscription::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNotificationSubscription {
                type Output = ::std::result::Result<crate::operation::delete_notification_subscription::DeleteNotificationSubscriptionOutput, crate::operation::delete_notification_subscription::DeleteNotificationSubscriptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_notification_subscription::de_delete_notification_subscription_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_notification_subscription::de_delete_notification_subscription_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_notification_subscription::DeleteNotificationSubscriptionError {
...
pub use crate::operation::delete_notification_subscription::_delete_notification_subscription_output::DeleteNotificationSubscriptionOutput;

pub use crate::operation::delete_notification_subscription::_delete_notification_subscription_input::DeleteNotificationSubscriptionInput;

mod _delete_notification_subscription_input;

mod _delete_notification_subscription_output;
