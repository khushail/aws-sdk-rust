...
impl super::Client  {
    ...
    ///   - [`disabled(bool)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::disabled) / [`set_disabled(Option<bool>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::set_disabled): <p>The new value that indicates whether the rule is disabled.</p>
