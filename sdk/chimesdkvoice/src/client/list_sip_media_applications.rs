...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_sip_media_applications::builders::ListSipMediaApplicationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_sip_media_applications::builders::ListSipMediaApplicationsFluentBuilder::set_next_token): <p>The token used to return the next page of results.</p>
