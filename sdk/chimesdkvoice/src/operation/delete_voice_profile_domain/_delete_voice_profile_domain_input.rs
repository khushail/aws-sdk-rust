...
impl DeleteVoiceProfileDomainInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_voice_profile_domain::DeleteVoiceProfileDomainInput, ::aws_smithy_http::operation::error::BuildError> {
