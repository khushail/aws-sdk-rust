...
impl SearchAvailablePhoneNumbersInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_available_phone_numbers::SearchAvailablePhoneNumbersInput, ::aws_smithy_http::operation::error::BuildError> {
