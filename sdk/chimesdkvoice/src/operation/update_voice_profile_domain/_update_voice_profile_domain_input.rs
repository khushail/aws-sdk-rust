...
impl UpdateVoiceProfileDomainInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_voice_profile_domain::UpdateVoiceProfileDomainInput, ::aws_smithy_http::operation::error::BuildError> {
