...
impl DeleteVoiceConnectorGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_voice_connector_group::DeleteVoiceConnectorGroupInput, ::aws_smithy_http::operation::error::BuildError> {
