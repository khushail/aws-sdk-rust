...
impl UpdateSipMediaApplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_sip_media_application::UpdateSipMediaApplicationInput, ::aws_smithy_http::operation::error::BuildError> {
