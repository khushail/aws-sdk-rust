...
impl GetVoiceConnectorTerminationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_voice_connector_termination::GetVoiceConnectorTerminationInput, ::aws_smithy_http::operation::error::BuildError> {
