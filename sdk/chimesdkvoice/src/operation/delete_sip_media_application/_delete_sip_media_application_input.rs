...
impl DeleteSipMediaApplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_sip_media_application::DeleteSipMediaApplicationInput, ::aws_smithy_http::operation::error::BuildError> {
