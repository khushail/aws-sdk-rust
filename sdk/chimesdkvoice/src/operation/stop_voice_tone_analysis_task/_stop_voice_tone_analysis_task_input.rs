...
impl StopVoiceToneAnalysisTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_voice_tone_analysis_task::StopVoiceToneAnalysisTaskInput, ::aws_smithy_http::operation::error::BuildError> {
