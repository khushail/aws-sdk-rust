...
impl GetVoiceToneAnalysisTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_voice_tone_analysis_task::GetVoiceToneAnalysisTaskInput, ::aws_smithy_http::operation::error::BuildError> {
