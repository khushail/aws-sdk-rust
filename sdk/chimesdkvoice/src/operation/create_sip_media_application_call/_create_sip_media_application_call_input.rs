...
impl CreateSipMediaApplicationCallInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_sip_media_application_call::CreateSipMediaApplicationCallInput, ::aws_smithy_http::operation::error::BuildError> {
