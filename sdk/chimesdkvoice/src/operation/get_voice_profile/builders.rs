...
pub use crate::operation::get_voice_profile::_get_voice_profile_output::GetVoiceProfileOutputBuilder;

pub use crate::operation::get_voice_profile::_get_voice_profile_input::GetVoiceProfileInputBuilder;
...
/// Fluent builder constructing a request to `GetVoiceProfile`.
/// 
/// <p>Retrieves the details of the specified voice profile.</p>
#[derive(::std::clone::Clone, ::std::fmt::Debug)]
pub struct GetVoiceProfileFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::get_voice_profile::builders::GetVoiceProfileInputBuilder,
}
impl GetVoiceProfileFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::get_voice_profile::GetVoiceProfile, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_voice_profile::GetVoiceProfileOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_voice_profile::GetVoiceProfileError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::get_voice_profile::GetVoiceProfileOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_voice_profile::GetVoiceProfileError>>
                             {
