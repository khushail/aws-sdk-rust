...
pub fn ser_hls_package(
    ...
    if let Some(var_11) = &input.playlist_window_seconds {
        object.key("playlistWindowSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    if let Some(var_12) = &input.program_date_time_interval_seconds {
        object.key("programDateTimeIntervalSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_12).into()));
    }
    if let Some(var_13) = &input.segment_duration_seconds {
        object.key("segmentDurationSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
    if let Some(var_14) = &input.stream_selection {
        #[allow(unused_mut)]
        let mut object_15 = object.key("streamSelection").start_object();
        crate::protocol_serde::shape_stream_selection::ser_stream_selection(&mut object_15, var_14)?;
        object_15.finish();
    }
