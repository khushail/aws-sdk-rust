...
pub fn ser_create_origin_endpoint_input(
    ...
    if let Some(var_16) = &input.startover_window_seconds {
        object.key("startoverWindowSeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    ...
    if let Some(var_21) = &input.time_delay_seconds {
        object.key("timeDelaySeconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_21).into()));
    }
