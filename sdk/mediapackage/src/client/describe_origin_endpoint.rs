...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::describe_origin_endpoint::builders::DescribeOriginEndpointFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_origin_endpoint::builders::DescribeOriginEndpointFluentBuilder::set_id): The ID of the OriginEndpoint.
