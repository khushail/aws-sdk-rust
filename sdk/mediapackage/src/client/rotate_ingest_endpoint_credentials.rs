...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::rotate_ingest_endpoint_credentials::builders::RotateIngestEndpointCredentialsFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::rotate_ingest_endpoint_credentials::builders::RotateIngestEndpointCredentialsFluentBuilder::set_id): The ID of the channel the IngestEndpoint is on.
    ///   - [`ingest_endpoint_id(impl ::std::convert::Into<String>)`](crate::operation::rotate_ingest_endpoint_credentials::builders::RotateIngestEndpointCredentialsFluentBuilder::ingest_endpoint_id) / [`set_ingest_endpoint_id(Option<String>)`](crate::operation::rotate_ingest_endpoint_credentials::builders::RotateIngestEndpointCredentialsFluentBuilder::set_ingest_endpoint_id): The id of the IngestEndpoint whose credentials should be rotated
