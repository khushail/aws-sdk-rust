...
impl RotateIngestEndpointCredentialsInput {
    /// Consumes the builder and constructs an Operation<[`RotateIngestEndpointCredentials`](crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentials)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentials, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = &_input.ingest_endpoint_id;
                let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("ingest_endpoint_id", "cannot be empty or unset"))?;
                let ingest_endpoint_id = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
                if ingest_endpoint_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("ingest_endpoint_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/channels/{Id}/ingest_endpoints/{IngestEndpointId}/credentials", Id = id, IngestEndpointId = ingest_endpoint_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentials::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RotateIngestEndpointCredentials {
                type Output = ::std::result::Result<crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsOutput, crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_rotate_ingest_endpoint_credentials::de_rotate_ingest_endpoint_credentials_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_rotate_ingest_endpoint_credentials::de_rotate_ingest_endpoint_credentials_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::rotate_ingest_endpoint_credentials::RotateIngestEndpointCredentialsError {
...
mod _rotate_ingest_endpoint_credentials_output;
