...
impl DescribeHarvestJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeHarvestJob`](crate::operation::describe_harvest_job::DescribeHarvestJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_harvest_job::DescribeHarvestJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_harvest_job::DescribeHarvestJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/harvest_jobs/{Id}", Id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::describe_harvest_job::DescribeHarvestJobInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_harvest_job::DescribeHarvestJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeHarvestJob", "mediapackage"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeHarvestJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHarvestJob {
                type Output = ::std::result::Result<crate::operation::describe_harvest_job::DescribeHarvestJobOutput, crate::operation::describe_harvest_job::DescribeHarvestJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_harvest_job::de_describe_harvest_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_harvest_job::de_describe_harvest_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_harvest_job::DescribeHarvestJobError {
...
mod _describe_harvest_job_output;
