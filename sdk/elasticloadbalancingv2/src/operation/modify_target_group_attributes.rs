...
impl ModifyTargetGroupAttributesInput {
    /// Consumes the builder and constructs an Operation<[`ModifyTargetGroupAttributes`](crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyTargetGroupAttributes {
                type Output = ::std::result::Result<crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributesOutput, crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_target_group_attributes::de_modify_target_group_attributes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_target_group_attributes::de_modify_target_group_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_target_group_attributes::ModifyTargetGroupAttributesError {
...
mod _modify_target_group_attributes_output;
