...
impl DescribeTargetGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTargetGroups`](crate::operation::describe_target_groups::DescribeTargetGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_target_groups::DescribeTargetGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_target_groups::DescribeTargetGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_target_groups::DescribeTargetGroups::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeTargetGroups", "elasticloadbalancingv2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeTargetGroups`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTargetGroups {
                type Output = ::std::result::Result<crate::operation::describe_target_groups::DescribeTargetGroupsOutput, crate::operation::describe_target_groups::DescribeTargetGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_target_groups::de_describe_target_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_target_groups::de_describe_target_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_target_groups::DescribeTargetGroupsError {
...
mod _describe_target_groups_output;
