...
impl ModifyTargetGroupInput {
    /// Consumes the builder and constructs an Operation<[`ModifyTargetGroup`](crate::operation::modify_target_group::ModifyTargetGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_target_group::ModifyTargetGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_target_group::ModifyTargetGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_target_group::ModifyTargetGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyTargetGroup", "elasticloadbalancingv2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifyTargetGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyTargetGroup {
                type Output = ::std::result::Result<crate::operation::modify_target_group::ModifyTargetGroupOutput, crate::operation::modify_target_group::ModifyTargetGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_target_group::de_modify_target_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_target_group::de_modify_target_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_target_group::ModifyTargetGroupError {
...
pub use crate::operation::modify_target_group::_modify_target_group_output::ModifyTargetGroupOutput;

pub use crate::operation::modify_target_group::_modify_target_group_input::ModifyTargetGroupInput;

mod _modify_target_group_input;

mod _modify_target_group_output;
