...
impl DescribeTargetGroupAttributesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTargetGroupAttributes`](crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributes::new())
...
/// Orchestration and serialization glue logic for `DescribeTargetGroupAttributes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTargetGroupAttributes {
                type Output = ::std::result::Result<crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributesOutput, crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_target_group_attributes::de_describe_target_group_attributes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_target_group_attributes::de_describe_target_group_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_target_group_attributes::DescribeTargetGroupAttributesError {
...
pub use crate::operation::describe_target_group_attributes::_describe_target_group_attributes_output::DescribeTargetGroupAttributesOutput;

pub use crate::operation::describe_target_group_attributes::_describe_target_group_attributes_input::DescribeTargetGroupAttributesInput;

mod _describe_target_group_attributes_input;

mod _describe_target_group_attributes_output;
