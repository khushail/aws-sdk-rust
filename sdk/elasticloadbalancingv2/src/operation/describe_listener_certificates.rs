...
impl DescribeListenerCertificatesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeListenerCertificates`](crate::operation::describe_listener_certificates::DescribeListenerCertificates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_listener_certificates::DescribeListenerCertificates, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_listener_certificates::DescribeListenerCertificatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_listener_certificates::DescribeListenerCertificatesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_listener_certificates::DescribeListenerCertificates::new())
...
/// Orchestration and serialization glue logic for `DescribeListenerCertificates`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeListenerCertificates {
                type Output = ::std::result::Result<crate::operation::describe_listener_certificates::DescribeListenerCertificatesOutput, crate::operation::describe_listener_certificates::DescribeListenerCertificatesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_listener_certificates::de_describe_listener_certificates_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_listener_certificates::de_describe_listener_certificates_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_listener_certificates::DescribeListenerCertificatesError {
...
mod _describe_listener_certificates_output;
