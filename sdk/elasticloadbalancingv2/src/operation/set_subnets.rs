...
impl SetSubnetsInput {
    /// Consumes the builder and constructs an Operation<[`SetSubnets`](crate::operation::set_subnets::SetSubnets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_subnets::SetSubnets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_subnets::SetSubnetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_subnets::SetSubnets::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SetSubnets", "elasticloadbalancingv2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SetSubnets`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetSubnets {
                type Output = ::std::result::Result<crate::operation::set_subnets::SetSubnetsOutput, crate::operation::set_subnets::SetSubnetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_set_subnets::de_set_subnets_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_set_subnets::de_set_subnets_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_subnets::SetSubnetsError {
