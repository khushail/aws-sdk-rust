...
impl DescribeRulesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRules`](crate::operation::describe_rules::DescribeRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_rules::DescribeRules, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_rules::DescribeRulesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_rules::DescribeRules::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRules {
                type Output = ::std::result::Result<crate::operation::describe_rules::DescribeRulesOutput, crate::operation::describe_rules::DescribeRulesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_rules::de_describe_rules_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_rules::de_describe_rules_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_rules::DescribeRulesError {
