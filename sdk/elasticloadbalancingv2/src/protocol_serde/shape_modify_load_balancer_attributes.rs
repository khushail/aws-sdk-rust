            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_load_balancer_not_found_exception::de_load_balancer_not_found_exception_xml_err(_response_body, output).map_err(crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_load_balancer_attributes_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesOutput, crate::operation::modify_load_balancer_attributes::ModifyLoadBalancerAttributesError> {
    Ok({
        #[allow(unused_mut)]
