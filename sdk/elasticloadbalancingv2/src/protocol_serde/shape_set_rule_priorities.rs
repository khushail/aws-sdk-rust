...
#[allow(clippy::unnecessary_wraps)]
pub fn de_set_rule_priorities_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::set_rule_priorities::SetRulePrioritiesOutput, crate::operation::set_rule_priorities::SetRulePrioritiesError> {
    Ok({
        #[allow(unused_mut)]
