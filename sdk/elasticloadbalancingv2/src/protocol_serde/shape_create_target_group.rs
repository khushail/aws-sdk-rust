...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_target_group_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_target_group::CreateTargetGroupOutput, crate::operation::create_target_group::CreateTargetGroupError> {
    Ok({
        #[allow(unused_mut)]
