...
pub fn ser_add_listener_certificates_input_input(input: &crate::operation::add_listener_certificates::AddListenerCertificatesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
