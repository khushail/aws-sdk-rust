...
pub fn de_modify_target_group_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_target_group::ModifyTargetGroupOutput, crate::operation::modify_target_group::ModifyTargetGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::modify_target_group::ModifyTargetGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_target_group_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_target_group::ModifyTargetGroupOutput, crate::operation::modify_target_group::ModifyTargetGroupError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_target_group::builders::ModifyTargetGroupOutputBuilder::default();
        output = crate::protocol_serde::shape_modify_target_group::de_modify_target_group(_response_body, output).map_err(crate::operation::modify_target_group::ModifyTargetGroupError::unhandled)?;
