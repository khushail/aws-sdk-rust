...
pub fn de_modify_rule_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_rule::ModifyRuleOutput, crate::operation::modify_rule::ModifyRuleError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_incompatible_protocols_exception::de_incompatible_protocols_exception_xml_err(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_load_balancer_action_exception::de_invalid_load_balancer_action_exception_xml_err(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_operation_not_permitted_exception::de_operation_not_permitted_exception_xml_err(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_rule_not_found_exception::de_rule_not_found_exception_xml_err(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_target_group_association_limit_exception::de_target_group_association_limit_exception_xml_err(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_target_group_not_found_exception::de_target_group_not_found_exception_xml_err(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_too_many_actions_exception::de_too_many_actions_exception_xml_err(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_too_many_targets_exception::de_too_many_targets_exception_xml_err(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_unsupported_protocol_exception::de_unsupported_protocol_exception_xml_err(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_rule_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_rule::ModifyRuleOutput, crate::operation::modify_rule::ModifyRuleError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::modify_rule::builders::ModifyRuleOutputBuilder::default();
        output = crate::protocol_serde::shape_modify_rule::de_modify_rule(_response_body, output).map_err(crate::operation::modify_rule::ModifyRuleError::unhandled)?;
