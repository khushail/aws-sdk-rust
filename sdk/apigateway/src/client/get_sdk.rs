...
impl super::Client  {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::get_sdk::builders::GetSdkFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::get_sdk::builders::GetSdkFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`stage_name(impl ::std::convert::Into<String>)`](crate::operation::get_sdk::builders::GetSdkFluentBuilder::stage_name) / [`set_stage_name(Option<String>)`](crate::operation::get_sdk::builders::GetSdkFluentBuilder::set_stage_name): <p>The name of the Stage that the SDK will use.</p>
    ///   - [`sdk_type(impl ::std::convert::Into<String>)`](crate::operation::get_sdk::builders::GetSdkFluentBuilder::sdk_type) / [`set_sdk_type(Option<String>)`](crate::operation::get_sdk::builders::GetSdkFluentBuilder::set_sdk_type): <p>The language for the generated SDK. Currently <code>java</code>, <code>javascript</code>, <code>android</code>, <code>objectivec</code> (for iOS), <code>swift</code> (for iOS), and <code>ruby</code> are supported.</p>
