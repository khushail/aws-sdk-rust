...
impl super::Client  {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::create_request_validator::builders::CreateRequestValidatorFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::create_request_validator::builders::CreateRequestValidatorFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_request_validator::builders::CreateRequestValidatorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_request_validator::builders::CreateRequestValidatorFluentBuilder::set_name): <p>The name of the to-be-created RequestValidator.</p>
