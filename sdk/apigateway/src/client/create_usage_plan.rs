...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_usage_plan::builders::CreateUsagePlanFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_usage_plan::builders::CreateUsagePlanFluentBuilder::set_name): <p>The name of the usage plan.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_usage_plan::builders::CreateUsagePlanFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_usage_plan::builders::CreateUsagePlanFluentBuilder::set_description): <p>The description of the usage plan.</p>
