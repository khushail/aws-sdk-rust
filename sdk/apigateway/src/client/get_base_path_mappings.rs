...
impl super::Client  {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::get_base_path_mappings::builders::GetBasePathMappingsFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::get_base_path_mappings::builders::GetBasePathMappingsFluentBuilder::set_domain_name): <p>The domain name of a BasePathMapping resource.</p>
    ///   - [`position(impl ::std::convert::Into<String>)`](crate::operation::get_base_path_mappings::builders::GetBasePathMappingsFluentBuilder::position) / [`set_position(Option<String>)`](crate::operation::get_base_path_mappings::builders::GetBasePathMappingsFluentBuilder::set_position): <p>The current pagination position in the paged result set.</p>
