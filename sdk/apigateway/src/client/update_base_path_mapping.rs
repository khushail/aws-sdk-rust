...
impl super::Client  {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::update_base_path_mapping::builders::UpdateBasePathMappingFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::update_base_path_mapping::builders::UpdateBasePathMappingFluentBuilder::set_domain_name): <p>The domain name of the BasePathMapping resource to change.</p>
    ///   - [`base_path(impl ::std::convert::Into<String>)`](crate::operation::update_base_path_mapping::builders::UpdateBasePathMappingFluentBuilder::base_path) / [`set_base_path(Option<String>)`](crate::operation::update_base_path_mapping::builders::UpdateBasePathMappingFluentBuilder::set_base_path): <p>The base path of the BasePathMapping resource to change.</p>  <p>To specify an empty base path, set this parameter to <code>'(none)'</code>.</p>
