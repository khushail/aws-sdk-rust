...
impl super::Client  {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_method::builders::DeleteMethodFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::delete_method::builders::DeleteMethodFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::delete_method::builders::DeleteMethodFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::delete_method::builders::DeleteMethodFluentBuilder::set_resource_id): <p>The Resource identifier for the Method resource.</p>
