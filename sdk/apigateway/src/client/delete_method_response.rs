...
impl super::Client  {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_method_response::builders::DeleteMethodResponseFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::delete_method_response::builders::DeleteMethodResponseFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::delete_method_response::builders::DeleteMethodResponseFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::delete_method_response::builders::DeleteMethodResponseFluentBuilder::set_resource_id): <p>The Resource identifier for the MethodResponse resource.</p>
    ///   - [`http_method(impl ::std::convert::Into<String>)`](crate::operation::delete_method_response::builders::DeleteMethodResponseFluentBuilder::http_method) / [`set_http_method(Option<String>)`](crate::operation::delete_method_response::builders::DeleteMethodResponseFluentBuilder::set_http_method): <p>The HTTP verb of the Method resource.</p>
