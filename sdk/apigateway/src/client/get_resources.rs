...
impl super::Client  {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::get_resources::builders::GetResourcesFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::get_resources::builders::GetResourcesFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`position(impl ::std::convert::Into<String>)`](crate::operation::get_resources::builders::GetResourcesFluentBuilder::position) / [`set_position(Option<String>)`](crate::operation::get_resources::builders::GetResourcesFluentBuilder::set_position): <p>The current pagination position in the paged result set.</p>
