...
impl super::Client  {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::create_base_path_mapping::builders::CreateBasePathMappingFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::create_base_path_mapping::builders::CreateBasePathMappingFluentBuilder::set_domain_name): <p>The domain name of the BasePathMapping resource to create.</p>
    ///   - [`base_path(impl ::std::convert::Into<String>)`](crate::operation::create_base_path_mapping::builders::CreateBasePathMappingFluentBuilder::base_path) / [`set_base_path(Option<String>)`](crate::operation::create_base_path_mapping::builders::CreateBasePathMappingFluentBuilder::set_base_path): <p>The base path name that callers of the API must provide as part of the URL after the domain name. This value must be unique for all of the mappings across a single API. Specify '(none)' if you do not want callers to specify a base path name after the domain name.</p>
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::create_base_path_mapping::builders::CreateBasePathMappingFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::create_base_path_mapping::builders::CreateBasePathMappingFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`stage(impl ::std::convert::Into<String>)`](crate::operation::create_base_path_mapping::builders::CreateBasePathMappingFluentBuilder::stage) / [`set_stage(Option<String>)`](crate::operation::create_base_path_mapping::builders::CreateBasePathMappingFluentBuilder::set_stage): <p>The name of the API's stage that you want to use for this mapping. Specify '(none)' if you want callers to explicitly specify the stage name after any base path name.</p>
