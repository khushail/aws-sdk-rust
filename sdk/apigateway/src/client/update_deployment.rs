...
impl super::Client  {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::update_deployment::builders::UpdateDeploymentFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::update_deployment::builders::UpdateDeploymentFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`deployment_id(impl ::std::convert::Into<String>)`](crate::operation::update_deployment::builders::UpdateDeploymentFluentBuilder::deployment_id) / [`set_deployment_id(Option<String>)`](crate::operation::update_deployment::builders::UpdateDeploymentFluentBuilder::set_deployment_id): <p>The replacement identifier for the Deployment resource to change information about.</p>
