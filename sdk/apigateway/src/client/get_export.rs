...
impl super::Client  {
    ...
    ///   - [`rest_api_id(impl ::std::convert::Into<String>)`](crate::operation::get_export::builders::GetExportFluentBuilder::rest_api_id) / [`set_rest_api_id(Option<String>)`](crate::operation::get_export::builders::GetExportFluentBuilder::set_rest_api_id): <p>The string identifier of the associated RestApi.</p>
    ///   - [`stage_name(impl ::std::convert::Into<String>)`](crate::operation::get_export::builders::GetExportFluentBuilder::stage_name) / [`set_stage_name(Option<String>)`](crate::operation::get_export::builders::GetExportFluentBuilder::set_stage_name): <p>The name of the Stage that will be exported.</p>
    ///   - [`export_type(impl ::std::convert::Into<String>)`](crate::operation::get_export::builders::GetExportFluentBuilder::export_type) / [`set_export_type(Option<String>)`](crate::operation::get_export::builders::GetExportFluentBuilder::set_export_type): <p>The type of export. Acceptable values are 'oas30' for OpenAPI 3.0.x and 'swagger' for Swagger/OpenAPI 2.0.</p>
    ...
    ///   - [`accepts(impl ::std::convert::Into<String>)`](crate::operation::get_export::builders::GetExportFluentBuilder::accepts) / [`set_accepts(Option<String>)`](crate::operation::get_export::builders::GetExportFluentBuilder::set_accepts): <p>The content-type of the export, for example <code>application/json</code>. Currently <code>application/json</code> and <code>application/yaml</code> are supported for <code>exportType</code> of<code>oas30</code> and <code>swagger</code>. This should be specified in the <code>Accept</code> header for direct API requests.</p>
