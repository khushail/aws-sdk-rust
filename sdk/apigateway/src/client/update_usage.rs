...
impl super::Client  {
    ...
    ///   - [`usage_plan_id(impl ::std::convert::Into<String>)`](crate::operation::update_usage::builders::UpdateUsageFluentBuilder::usage_plan_id) / [`set_usage_plan_id(Option<String>)`](crate::operation::update_usage::builders::UpdateUsageFluentBuilder::set_usage_plan_id): <p>The Id of the usage plan associated with the usage data.</p>
    ///   - [`key_id(impl ::std::convert::Into<String>)`](crate::operation::update_usage::builders::UpdateUsageFluentBuilder::key_id) / [`set_key_id(Option<String>)`](crate::operation::update_usage::builders::UpdateUsageFluentBuilder::set_key_id): <p>The identifier of the API key associated with the usage plan in which a temporary extension is granted to the remaining quota.</p>
