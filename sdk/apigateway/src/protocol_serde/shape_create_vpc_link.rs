...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_vpc_link_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_vpc_link::CreateVpcLinkOutput, crate::operation::create_vpc_link::CreateVpcLinkError> {
    Ok({
        #[allow(unused_mut)]
