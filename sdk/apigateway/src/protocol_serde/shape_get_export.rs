...
pub fn ser_get_export_headers(
    ...
    if let ::std::option::Option::Some(inner_1) = &input.accepts {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_export_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_export::GetExportOutput, crate::operation::get_export::GetExportError> {
    Ok({
        #[allow(unused_mut)]
