...
impl GetRestApiInput {
    /// Consumes the builder and constructs an Operation<[`GetRestApi`](crate::operation::get_rest_api::GetRestApi)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_rest_api::GetRestApi, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_rest_api::GetRestApiInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_rest_api::GetRestApiInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_rest_api::GetRestApi::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetRestApi", "apigateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetRestApi`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRestApi {
                type Output = ::std::result::Result<crate::operation::get_rest_api::GetRestApiOutput, crate::operation::get_rest_api::GetRestApiError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_rest_api::de_get_rest_api_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_rest_api::de_get_rest_api_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_rest_api::GetRestApiError {
