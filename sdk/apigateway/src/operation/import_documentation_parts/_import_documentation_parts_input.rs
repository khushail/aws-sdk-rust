...
impl ImportDocumentationPartsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::import_documentation_parts::ImportDocumentationPartsInput, ::aws_smithy_http::operation::error::BuildError> {
