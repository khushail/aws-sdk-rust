...
impl CreateRestApiInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_rest_api::CreateRestApiInput, ::aws_smithy_http::operation::error::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::create_rest_api::CreateRestApiInput {
                name: self.name
                ,
