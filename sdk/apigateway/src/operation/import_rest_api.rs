...
impl ImportRestApiInput {
    /// Consumes the builder and constructs an Operation<[`ImportRestApi`](crate::operation::import_rest_api::ImportRestApi)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_rest_api::ImportRestApi, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_rest_api::ImportRestApiInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/restapis").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::import_rest_api::ImportRestApiInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                query.push_kv("mode", "import");
                let protected_params = ["mode", "failonwarnings"];
                if let ::std::option::Option::Some(inner_1) = &_input.parameters {
                     {
                        for (k, v) in inner_1 {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_import_rest_api_input::ser_body_http_payload( self.body)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_rest_api::ImportRestApi::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ImportRestApi", "apigateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ImportRestApi`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportRestApi {
                type Output = ::std::result::Result<crate::operation::import_rest_api::ImportRestApiOutput, crate::operation::import_rest_api::ImportRestApiError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_import_rest_api::de_import_rest_api_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_import_rest_api::de_import_rest_api_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::import_rest_api::ImportRestApiError {
