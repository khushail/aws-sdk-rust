...
impl CreateDocumentationVersionInput {
    /// Consumes the builder and constructs an Operation<[`CreateDocumentationVersion`](crate::operation::create_documentation_version::CreateDocumentationVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_documentation_version::CreateDocumentationVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_documentation_version::CreateDocumentationVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_documentation_version::ser_create_documentation_version_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_documentation_version::CreateDocumentationVersion::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDocumentationVersion", "apigateway"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateDocumentationVersion`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDocumentationVersion {
                type Output = ::std::result::Result<crate::operation::create_documentation_version::CreateDocumentationVersionOutput, crate::operation::create_documentation_version::CreateDocumentationVersionError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_documentation_version::CreateDocumentationVersionError {
...
mod _create_documentation_version_output;
