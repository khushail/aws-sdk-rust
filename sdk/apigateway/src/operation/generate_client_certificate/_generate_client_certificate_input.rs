...
impl GenerateClientCertificateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::generate_client_certificate::GenerateClientCertificateInput, ::aws_smithy_http::operation::error::BuildError> {
