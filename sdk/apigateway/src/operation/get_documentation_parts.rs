...
impl GetDocumentationPartsInput {
    /// Consumes the builder and constructs an Operation<[`GetDocumentationParts`](crate::operation::get_documentation_parts::GetDocumentationParts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_documentation_parts::GetDocumentationParts, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_documentation_parts::GetDocumentationPartsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_documentation_parts::GetDocumentationPartsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_4) = &_input.path {
                     {
                ...
                if let ::std::option::Option::Some(inner_7) = &_input.location_status {
                     {
                        query.push_kv("locationStatus", &::aws_smithy_http::query::fmt_string(&inner_7));
                    }
                }
                ::std::result::Result::Ok(())
            }
            ...
            fn update_http_builder(
                            input: &crate::operation::get_documentation_parts::GetDocumentationPartsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_documentation_parts::GetDocumentationParts::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDocumentationParts", "apigateway"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDocumentationParts {
                type Output = ::std::result::Result<crate::operation::get_documentation_parts::GetDocumentationPartsOutput, crate::operation::get_documentation_parts::GetDocumentationPartsError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_documentation_parts::GetDocumentationPartsError {
...
mod _get_documentation_parts_output;
