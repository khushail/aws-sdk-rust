...
impl DeleteIntegrationResponseInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_integration_response::DeleteIntegrationResponseInput, ::aws_smithy_http::operation::error::BuildError> {
