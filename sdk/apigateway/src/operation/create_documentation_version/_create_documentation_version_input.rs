...
impl CreateDocumentationVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_documentation_version::CreateDocumentationVersionInput, ::aws_smithy_http::operation::error::BuildError> {
