...
impl CreateResourceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_resource::CreateResource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_resource::CreateResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = &_input.parent_id;
                let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("parent_id", "cannot be empty or unset"))?;
                let parent_id = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
                if parent_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("parent_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/restapis/{restApiId}/resources/{parentId}", restApiId = rest_api_id, parentId = parent_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_resource::CreateResource::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateResource", "apigateway"));
