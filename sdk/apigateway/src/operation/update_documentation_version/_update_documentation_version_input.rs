...
impl UpdateDocumentationVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_documentation_version::UpdateDocumentationVersionInput, ::aws_smithy_http::operation::error::BuildError> {
