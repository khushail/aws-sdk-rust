...
pub fn de_create_platform_version_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_platform_version::CreatePlatformVersionOutput, crate::operation::create_platform_version::CreatePlatformVersionError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_platform_version::CreatePlatformVersionError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_platform_version_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_platform_version::CreatePlatformVersionOutput, crate::operation::create_platform_version::CreatePlatformVersionError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::create_platform_version::builders::CreatePlatformVersionOutputBuilder::default();
        output = crate::protocol_serde::shape_create_platform_version::de_create_platform_version(_response_body, output).map_err(crate::operation::create_platform_version::CreatePlatformVersionError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_create_platform_version(inp: &[u8], mut builder: crate::operation::create_platform_version::builders::CreatePlatformVersionOutputBuilder) -> Result<crate::operation::create_platform_version::builders::CreatePlatformVersionOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Builder") /* Builder com.amazonaws.elasticbeanstalk.synthetic#CreatePlatformVersionOutput$Builder */ =>  {
                ...
                ;
                builder = builder.set_builder(var_2);
            }
            ,
            _ => {}
        }
