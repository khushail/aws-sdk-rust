...
#[allow(unused_mut)]
pub fn ser_max_age_rule(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::MaxAgeRule) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
