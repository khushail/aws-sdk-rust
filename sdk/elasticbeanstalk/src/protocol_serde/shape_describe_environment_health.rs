...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_environment_health_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_environment_health::DescribeEnvironmentHealthOutput, crate::operation::describe_environment_health::DescribeEnvironmentHealthError> {
    Ok({
        #[allow(unused_mut)]
