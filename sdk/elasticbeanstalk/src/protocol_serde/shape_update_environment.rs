            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_insufficient_privileges_exception::de_insufficient_privileges_exception_xml_err(_response_body, output).map_err(crate::operation::update_environment::UpdateEnvironmentError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_too_many_buckets_exception::de_too_many_buckets_exception_xml_err(_response_body, output).map_err(crate::operation::update_environment::UpdateEnvironmentError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_environment_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_environment::UpdateEnvironmentOutput, crate::operation::update_environment::UpdateEnvironmentError> {
    Ok({
        #[allow(unused_mut)]
