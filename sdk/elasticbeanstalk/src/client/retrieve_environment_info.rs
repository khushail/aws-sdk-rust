...
impl super::Client  {
    ...
    ///   - [`environment_id(impl ::std::convert::Into<String>)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::set_environment_id): <p>The ID of the data's environment.</p>  <p>If no such environment is found, returns an <code>InvalidParameterValue</code> error.</p>  <p>Condition: You must specify either this or an EnvironmentName, or both. If you do not specify either, AWS Elastic Beanstalk returns <code>MissingRequiredParameter</code> error.</p>
    ///   - [`environment_name(impl ::std::convert::Into<String>)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::environment_name) / [`set_environment_name(Option<String>)`](crate::operation::retrieve_environment_info::builders::RetrieveEnvironmentInfoFluentBuilder::set_environment_name): <p>The name of the data's environment.</p>  <p> If no such environment is found, returns an <code>InvalidParameterValue</code> error. </p>  <p> Condition: You must specify either this or an EnvironmentId, or both. If you do not specify either, AWS Elastic Beanstalk returns <code>MissingRequiredParameter</code> error. </p>
