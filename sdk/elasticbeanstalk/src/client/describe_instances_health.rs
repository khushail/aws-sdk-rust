...
impl super::Client  {
    ...
    ///   - [`environment_name(impl ::std::convert::Into<String>)`](crate::operation::describe_instances_health::builders::DescribeInstancesHealthFluentBuilder::environment_name) / [`set_environment_name(Option<String>)`](crate::operation::describe_instances_health::builders::DescribeInstancesHealthFluentBuilder::set_environment_name): <p>Specify the AWS Elastic Beanstalk environment by name.</p>
    ///   - [`environment_id(impl ::std::convert::Into<String>)`](crate::operation::describe_instances_health::builders::DescribeInstancesHealthFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::describe_instances_health::builders::DescribeInstancesHealthFluentBuilder::set_environment_id): <p>Specify the AWS Elastic Beanstalk environment by ID.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_instances_health::builders::DescribeInstancesHealthFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_instances_health::builders::DescribeInstancesHealthFluentBuilder::set_next_token): <p>Specify the pagination token returned by a previous call.</p>
