...
impl ListPlatformVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListPlatformVersions`](crate::operation::list_platform_versions::ListPlatformVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_platform_versions::ListPlatformVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_platform_versions::ListPlatformVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_platform_versions::ListPlatformVersions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPlatformVersions", "elasticbeanstalk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListPlatformVersions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPlatformVersions {
                type Output = ::std::result::Result<crate::operation::list_platform_versions::ListPlatformVersionsOutput, crate::operation::list_platform_versions::ListPlatformVersionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_platform_versions::de_list_platform_versions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_platform_versions::de_list_platform_versions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_platform_versions::ListPlatformVersionsError {
...
mod _list_platform_versions_output;
