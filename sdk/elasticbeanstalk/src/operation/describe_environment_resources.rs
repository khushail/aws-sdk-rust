...
impl DescribeEnvironmentResourcesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEnvironmentResources`](crate::operation::describe_environment_resources::DescribeEnvironmentResources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_environment_resources::DescribeEnvironmentResources, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_environment_resources::DescribeEnvironmentResourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_environment_resources::DescribeEnvironmentResources::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeEnvironmentResources", "elasticbeanstalk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeEnvironmentResources`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEnvironmentResources {
                type Output = ::std::result::Result<crate::operation::describe_environment_resources::DescribeEnvironmentResourcesOutput, crate::operation::describe_environment_resources::DescribeEnvironmentResourcesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_environment_resources::de_describe_environment_resources_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_environment_resources::de_describe_environment_resources_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_environment_resources::DescribeEnvironmentResourcesError {
...
pub use crate::operation::describe_environment_resources::_describe_environment_resources_output::DescribeEnvironmentResourcesOutput;

pub use crate::operation::describe_environment_resources::_describe_environment_resources_input::DescribeEnvironmentResourcesInput;

mod _describe_environment_resources_input;

mod _describe_environment_resources_output;
