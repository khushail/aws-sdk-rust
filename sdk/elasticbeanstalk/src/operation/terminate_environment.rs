...
impl TerminateEnvironmentInput {
    /// Consumes the builder and constructs an Operation<[`TerminateEnvironment`](crate::operation::terminate_environment::TerminateEnvironment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::terminate_environment::TerminateEnvironment, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::terminate_environment::TerminateEnvironmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::terminate_environment::TerminateEnvironmentInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::terminate_environment::TerminateEnvironment::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("TerminateEnvironment", "elasticbeanstalk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `TerminateEnvironment`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for TerminateEnvironment {
                type Output = ::std::result::Result<crate::operation::terminate_environment::TerminateEnvironmentOutput, crate::operation::terminate_environment::TerminateEnvironmentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_terminate_environment::de_terminate_environment_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_terminate_environment::de_terminate_environment_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::terminate_environment::TerminateEnvironmentError {
...
mod _terminate_environment_output;
