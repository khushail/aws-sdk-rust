...
impl UpdateApplicationVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_application_version::UpdateApplicationVersionInput, ::aws_smithy_http::operation::error::BuildError> {
