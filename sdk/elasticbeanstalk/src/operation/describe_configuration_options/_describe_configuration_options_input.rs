...
impl DescribeConfigurationOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_configuration_options::DescribeConfigurationOptionsInput, ::aws_smithy_http::operation::error::BuildError> {
