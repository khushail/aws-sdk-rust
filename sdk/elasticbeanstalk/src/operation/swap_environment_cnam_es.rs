...
impl SwapEnvironmentCnamEsInput {
    /// Consumes the builder and constructs an Operation<[`SwapEnvironmentCNAMEs`](crate::operation::swap_environment_cnam_es::SwapEnvironmentCNAMEs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::swap_environment_cnam_es::SwapEnvironmentCNAMEs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::swap_environment_cnam_es::SwapEnvironmentCnamEsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::swap_environment_cnam_es::SwapEnvironmentCnamEsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::swap_environment_cnam_es::SwapEnvironmentCNAMEs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SwapEnvironmentCNAMEs {
                type Output = ::std::result::Result<crate::operation::swap_environment_cnam_es::SwapEnvironmentCnamEsOutput, crate::operation::swap_environment_cnam_es::SwapEnvironmentCNAMEsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_swap_environment_cnam_es::de_swap_environment_cnam_es_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_swap_environment_cnam_es::de_swap_environment_cnam_es_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::swap_environment_cnam_es::SwapEnvironmentCNAMEsError {
...
pub use crate::operation::swap_environment_cnam_es::_swap_environment_cnam_es_output::SwapEnvironmentCnamEsOutput;

pub use crate::operation::swap_environment_cnam_es::_swap_environment_cnam_es_input::SwapEnvironmentCnamEsInput;

mod _swap_environment_cnam_es_input;

mod _swap_environment_cnam_es_output;
