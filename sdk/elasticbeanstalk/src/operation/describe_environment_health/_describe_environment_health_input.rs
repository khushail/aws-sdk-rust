...
impl DescribeEnvironmentHealthInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_environment_health::DescribeEnvironmentHealthInput, ::aws_smithy_http::operation::error::BuildError> {
