...
impl DeleteEnvironmentConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_environment_configuration::DeleteEnvironmentConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
