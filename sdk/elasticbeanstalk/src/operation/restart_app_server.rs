...
impl RestartAppServerInput {
    /// Consumes the builder and constructs an Operation<[`RestartAppServer`](crate::operation::restart_app_server::RestartAppServer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::restart_app_server::RestartAppServer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restart_app_server::RestartAppServerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::restart_app_server::RestartAppServer::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RestartAppServer", "elasticbeanstalk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RestartAppServer`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestartAppServer {
                type Output = ::std::result::Result<crate::operation::restart_app_server::RestartAppServerOutput, crate::operation::restart_app_server::RestartAppServerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_restart_app_server::de_restart_app_server_http_response_with_props(status, headers, body)
                     }
                }
...
mod _restart_app_server_output;
