...
impl DeleteApplicationVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_application_version::DeleteApplicationVersionInput, ::aws_smithy_http::operation::error::BuildError> {
