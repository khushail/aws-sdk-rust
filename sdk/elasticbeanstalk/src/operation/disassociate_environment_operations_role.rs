...
impl DisassociateEnvironmentOperationsRoleInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateEnvironmentOperationsRole`](crate::operation::disassociate_environment_operations_role::DisassociateEnvironmentOperationsRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_environment_operations_role::DisassociateEnvironmentOperationsRole, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_environment_operations_role::DisassociateEnvironmentOperationsRoleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::disassociate_environment_operations_role::DisassociateEnvironmentOperationsRoleInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_environment_operations_role::DisassociateEnvironmentOperationsRole::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateEnvironmentOperationsRole {
                type Output = ::std::result::Result<crate::operation::disassociate_environment_operations_role::DisassociateEnvironmentOperationsRoleOutput, crate::operation::disassociate_environment_operations_role::DisassociateEnvironmentOperationsRoleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_environment_operations_role::de_disassociate_environment_operations_role_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_environment_operations_role::de_disassociate_environment_operations_role_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_environment_operations_role::DisassociateEnvironmentOperationsRoleError {
...
pub use crate::operation::disassociate_environment_operations_role::_disassociate_environment_operations_role_output::DisassociateEnvironmentOperationsRoleOutput;

pub use crate::operation::disassociate_environment_operations_role::_disassociate_environment_operations_role_input::DisassociateEnvironmentOperationsRoleInput;

mod _disassociate_environment_operations_role_input;

mod _disassociate_environment_operations_role_output;
