...
impl RetrieveEnvironmentInfoInput {
    /// Consumes the builder and constructs an Operation<[`RetrieveEnvironmentInfo`](crate::operation::retrieve_environment_info::RetrieveEnvironmentInfo)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfo, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::retrieve_environment_info::RetrieveEnvironmentInfo::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RetrieveEnvironmentInfo", "elasticbeanstalk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RetrieveEnvironmentInfo`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RetrieveEnvironmentInfo {
                type Output = ::std::result::Result<crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoOutput, crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_retrieve_environment_info::de_retrieve_environment_info_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_retrieve_environment_info::de_retrieve_environment_info_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::retrieve_environment_info::RetrieveEnvironmentInfoError {
...
mod _retrieve_environment_info_output;
