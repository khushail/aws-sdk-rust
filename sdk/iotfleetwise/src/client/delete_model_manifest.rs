...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_model_manifest::builders::DeleteModelManifestFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_model_manifest::builders::DeleteModelManifestFluentBuilder::set_name): <p> The name of the model manifest to delete. </p>
