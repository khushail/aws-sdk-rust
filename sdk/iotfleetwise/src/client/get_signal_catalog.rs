...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_signal_catalog::builders::GetSignalCatalogFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_signal_catalog::builders::GetSignalCatalogFluentBuilder::set_name): <p> The name of the signal catalog to retrieve information about. </p>
