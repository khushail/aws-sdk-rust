...
impl ListVehiclesInput {
    /// Consumes the builder and constructs an Operation<[`ListVehicles`](crate::operation::list_vehicles::ListVehicles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_vehicles::ListVehicles, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_vehicles::ListVehiclesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_vehicles::ListVehiclesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_vehicles::ListVehicles::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListVehicles", "iotfleetwise"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListVehicles`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVehicles {
                type Output = ::std::result::Result<crate::operation::list_vehicles::ListVehiclesOutput, crate::operation::list_vehicles::ListVehiclesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_vehicles::de_list_vehicles_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_vehicles::de_list_vehicles_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_vehicles::ListVehiclesError {
