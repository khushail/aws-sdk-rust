...
impl ListVehiclesInFleetInput {
    /// Consumes the builder and constructs an Operation<[`ListVehiclesInFleet`](crate::operation::list_vehicles_in_fleet::ListVehiclesInFleet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_vehicles_in_fleet::ListVehiclesInFleet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_vehicles_in_fleet::ListVehiclesInFleetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_vehicles_in_fleet::ListVehiclesInFleetInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_vehicles_in_fleet::ListVehiclesInFleet::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVehiclesInFleet {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_vehicles_in_fleet::de_list_vehicles_in_fleet_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_vehicles_in_fleet::ListVehiclesInFleetError {
...
pub use crate::operation::list_vehicles_in_fleet::_list_vehicles_in_fleet_output::ListVehiclesInFleetOutput;

pub use crate::operation::list_vehicles_in_fleet::_list_vehicles_in_fleet_input::ListVehiclesInFleetInput;

mod _list_vehicles_in_fleet_input;

mod _list_vehicles_in_fleet_output;
