...
mod associate_vehicle_fleet;

mod batch_create_vehicle;

mod batch_update_vehicle;

mod create_campaign;

mod create_decoder_manifest;

mod create_fleet;

mod create_model_manifest;
...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_iotfleetwise::Error> {
...
mod delete_decoder_manifest;

mod delete_fleet;

mod delete_model_manifest;
...
mod get_vehicle_status;

mod import_decoder_manifest;

mod import_signal_catalog;

mod list_campaigns;

mod list_decoder_manifest_network_interfaces;

mod list_decoder_manifest_signals;

mod list_decoder_manifests;

mod list_fleets;

mod list_fleets_for_vehicle;

mod list_model_manifest_nodes;

mod list_model_manifests;

mod list_signal_catalog_nodes;
