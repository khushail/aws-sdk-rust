...
pub fn ser_timestream_config(
    ...
    if let Some(var_1) = &input.timestream_table_arn {
        object.key("timestreamTableArn").string(var_1.as_str());
    }
...
pub(crate) fn de_timestream_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TimestreamConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
