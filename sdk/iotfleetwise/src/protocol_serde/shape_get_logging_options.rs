...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_logging_options_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_logging_options::GetLoggingOptionsOutput, crate::operation::get_logging_options::GetLoggingOptionsError> {
    Ok({
        #[allow(unused_mut)]
