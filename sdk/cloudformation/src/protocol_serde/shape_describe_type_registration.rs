...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_type_registration_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_type_registration::DescribeTypeRegistrationOutput, crate::operation::describe_type_registration::DescribeTypeRegistrationError> {
    Ok({
        #[allow(unused_mut)]
