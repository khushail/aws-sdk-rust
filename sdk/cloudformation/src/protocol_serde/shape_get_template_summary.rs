...
pub fn de_get_template_summary_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_template_summary::GetTemplateSummaryOutput, crate::operation::get_template_summary::GetTemplateSummaryError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_template_summary::GetTemplateSummaryError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_stack_set_not_found_exception::de_stack_set_not_found_exception_xml_err(_response_body, output).map_err(crate::operation::get_template_summary::GetTemplateSummaryError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_template_summary_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_template_summary::GetTemplateSummaryOutput, crate::operation::get_template_summary::GetTemplateSummaryError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_template_summary::builders::GetTemplateSummaryOutputBuilder::default();
        output = crate::protocol_serde::shape_get_template_summary::de_get_template_summary(_response_body, output).map_err(crate::operation::get_template_summary::GetTemplateSummaryError::unhandled)?;
