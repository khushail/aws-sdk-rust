...
pub fn ser_list_stack_sets_input_input(input: &crate::operation::list_stack_sets::ListStackSetsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
