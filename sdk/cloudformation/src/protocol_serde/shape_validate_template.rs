...
pub fn de_validate_template_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::validate_template::ValidateTemplateOutput, crate::operation::validate_template::ValidateTemplateError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::validate_template::ValidateTemplateError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_validate_template_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::validate_template::ValidateTemplateOutput, crate::operation::validate_template::ValidateTemplateError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::validate_template::builders::ValidateTemplateOutputBuilder::default();
        output = crate::protocol_serde::shape_validate_template::de_validate_template(_response_body, output).map_err(crate::operation::validate_template::ValidateTemplateError::unhandled)?;
