...
pub fn de_activate_organizations_access_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::activate_organizations_access::ActivateOrganizationsAccessOutput, crate::operation::activate_organizations_access::ActivateOrganizationsAccessError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_activate_organizations_access_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::activate_organizations_access::ActivateOrganizationsAccessOutput, crate::operation::activate_organizations_access::ActivateOrganizationsAccessError> {
    Ok({
        #[allow(unused_mut)]
