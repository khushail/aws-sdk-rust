...
impl ExecuteChangeSetInput {
    /// Consumes the builder and constructs an Operation<[`ExecuteChangeSet`](crate::operation::execute_change_set::ExecuteChangeSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::execute_change_set::ExecuteChangeSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::execute_change_set::ExecuteChangeSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_execute_change_set_input::ser_execute_change_set_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::execute_change_set::ExecuteChangeSet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ExecuteChangeSet", "cloudformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ExecuteChangeSet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecuteChangeSet {
                type Output = ::std::result::Result<crate::operation::execute_change_set::ExecuteChangeSetOutput, crate::operation::execute_change_set::ExecuteChangeSetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_execute_change_set::de_execute_change_set_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_execute_change_set::de_execute_change_set_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::execute_change_set::ExecuteChangeSetError {
...
mod _execute_change_set_output;
