...
impl CreateChangeSetInput {
    /// Consumes the builder and constructs an Operation<[`CreateChangeSet`](crate::operation::create_change_set::CreateChangeSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_change_set::CreateChangeSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_change_set::CreateChangeSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_change_set_input::ser_create_change_set_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_change_set::CreateChangeSet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateChangeSet", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateChangeSet {
                type Output = ::std::result::Result<crate::operation::create_change_set::CreateChangeSetOutput, crate::operation::create_change_set::CreateChangeSetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_change_set::de_create_change_set_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_change_set::de_create_change_set_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_change_set::CreateChangeSetError {
