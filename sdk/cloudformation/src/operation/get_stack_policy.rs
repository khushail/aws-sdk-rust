...
impl GetStackPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetStackPolicy`](crate::operation::get_stack_policy::GetStackPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_stack_policy::GetStackPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_stack_policy::GetStackPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_stack_policy::GetStackPolicyInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_stack_policy_input::ser_get_stack_policy_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_stack_policy::GetStackPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetStackPolicy", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStackPolicy {
                type Output = ::std::result::Result<crate::operation::get_stack_policy::GetStackPolicyOutput, crate::operation::get_stack_policy::GetStackPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_stack_policy::de_get_stack_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_stack_policy::de_get_stack_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_stack_policy::GetStackPolicyError {
