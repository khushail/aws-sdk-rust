...
impl ListStackSetOperationsInput {
    /// Consumes the builder and constructs an Operation<[`ListStackSetOperations`](crate::operation::list_stack_set_operations::ListStackSetOperations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_stack_set_operations::ListStackSetOperations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_stack_set_operations::ListStackSetOperationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_stack_set_operations_input::ser_list_stack_set_operations_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_stack_set_operations::ListStackSetOperations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListStackSetOperations", "cloudformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListStackSetOperations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListStackSetOperations {
                type Output = ::std::result::Result<crate::operation::list_stack_set_operations::ListStackSetOperationsOutput, crate::operation::list_stack_set_operations::ListStackSetOperationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_stack_set_operations::de_list_stack_set_operations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_stack_set_operations::de_list_stack_set_operations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_stack_set_operations::ListStackSetOperationsError {
...
pub use crate::operation::list_stack_set_operations::_list_stack_set_operations_output::ListStackSetOperationsOutput;

pub use crate::operation::list_stack_set_operations::_list_stack_set_operations_input::ListStackSetOperationsInput;

mod _list_stack_set_operations_input;

mod _list_stack_set_operations_output;
