...
impl CancelUpdateStackInput {
    /// Consumes the builder and constructs an Operation<[`CancelUpdateStack`](crate::operation::cancel_update_stack::CancelUpdateStack)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_update_stack::CancelUpdateStack, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_update_stack::CancelUpdateStackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_update_stack_input::ser_cancel_update_stack_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_update_stack::CancelUpdateStack::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelUpdateStack", "cloudformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CancelUpdateStack`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelUpdateStack {
                type Output = ::std::result::Result<crate::operation::cancel_update_stack::CancelUpdateStackOutput, crate::operation::cancel_update_stack::CancelUpdateStackError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_cancel_update_stack::de_cancel_update_stack_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_cancel_update_stack::de_cancel_update_stack_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_update_stack::CancelUpdateStackError {
...
mod _cancel_update_stack_output;
