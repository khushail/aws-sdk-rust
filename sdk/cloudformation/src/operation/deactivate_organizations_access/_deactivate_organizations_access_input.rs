...
impl DeactivateOrganizationsAccessInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deactivate_organizations_access::DeactivateOrganizationsAccessInput, ::aws_smithy_http::operation::error::BuildError> {
