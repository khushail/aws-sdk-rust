...
impl ListTypeVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListTypeVersions`](crate::operation::list_type_versions::ListTypeVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_type_versions::ListTypeVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_type_versions::ListTypeVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_type_versions_input::ser_list_type_versions_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_type_versions::ListTypeVersions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTypeVersions", "cloudformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListTypeVersions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTypeVersions {
                type Output = ::std::result::Result<crate::operation::list_type_versions::ListTypeVersionsOutput, crate::operation::list_type_versions::ListTypeVersionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_type_versions::de_list_type_versions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_type_versions::de_list_type_versions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_type_versions::ListTypeVersionsError {
...
mod _list_type_versions_output;
