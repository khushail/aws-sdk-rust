...
impl DescribeTypeRegistrationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTypeRegistration`](crate::operation::describe_type_registration::DescribeTypeRegistration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_type_registration::DescribeTypeRegistration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_type_registration::DescribeTypeRegistrationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_type_registration_input::ser_describe_type_registration_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_type_registration::DescribeTypeRegistration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeTypeRegistration", "cloudformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeTypeRegistration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTypeRegistration {
                type Output = ::std::result::Result<crate::operation::describe_type_registration::DescribeTypeRegistrationOutput, crate::operation::describe_type_registration::DescribeTypeRegistrationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_type_registration::de_describe_type_registration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_type_registration::de_describe_type_registration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_type_registration::DescribeTypeRegistrationError {
...
mod _describe_type_registration_output;
