...
impl ActivateTypeInput {
    /// Consumes the builder and constructs an Operation<[`ActivateType`](crate::operation::activate_type::ActivateType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::activate_type::ActivateType, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::activate_type::ActivateTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_activate_type_input::ser_activate_type_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::activate_type::ActivateType::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ActivateType", "cloudformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ActivateType`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ActivateType {
                type Output = ::std::result::Result<crate::operation::activate_type::ActivateTypeOutput, crate::operation::activate_type::ActivateTypeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_activate_type::de_activate_type_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_activate_type::de_activate_type_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::activate_type::ActivateTypeError {
