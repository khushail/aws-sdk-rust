...
impl DescribeStackInstanceInput {
    /// Consumes the builder and constructs an Operation<[`DescribeStackInstance`](crate::operation::describe_stack_instance::DescribeStackInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_stack_instance::DescribeStackInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_stack_instance::DescribeStackInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_stack_instance_input::ser_describe_stack_instance_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_stack_instance::DescribeStackInstance::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeStackInstance", "cloudformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeStackInstance`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStackInstance {
                type Output = ::std::result::Result<crate::operation::describe_stack_instance::DescribeStackInstanceOutput, crate::operation::describe_stack_instance::DescribeStackInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_stack_instance::de_describe_stack_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_stack_instance::de_describe_stack_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_stack_instance::DescribeStackInstanceError {
...
pub use crate::operation::describe_stack_instance::_describe_stack_instance_output::DescribeStackInstanceOutput;

pub use crate::operation::describe_stack_instance::_describe_stack_instance_input::DescribeStackInstanceInput;

mod _describe_stack_instance_input;

mod _describe_stack_instance_output;
