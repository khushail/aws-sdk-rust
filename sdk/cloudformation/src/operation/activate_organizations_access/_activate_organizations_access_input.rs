...
impl ActivateOrganizationsAccessInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::activate_organizations_access::ActivateOrganizationsAccessInput, ::aws_smithy_http::operation::error::BuildError> {
