...
impl GetTemplateSummaryInput {
    /// Consumes the builder and constructs an Operation<[`GetTemplateSummary`](crate::operation::get_template_summary::GetTemplateSummary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_template_summary::GetTemplateSummary, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_template_summary::GetTemplateSummaryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_template_summary_input::ser_get_template_summary_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_template_summary::GetTemplateSummary::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetTemplateSummary", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetTemplateSummary {
                type Output = ::std::result::Result<crate::operation::get_template_summary::GetTemplateSummaryOutput, crate::operation::get_template_summary::GetTemplateSummaryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_template_summary::de_get_template_summary_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_template_summary::de_get_template_summary_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_template_summary::GetTemplateSummaryError {
...
mod _get_template_summary_output;
