...
impl UpdateTerminationProtectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_termination_protection::UpdateTerminationProtectionInput, ::aws_smithy_http::operation::error::BuildError> {
