...
impl DescribeStackResourceDriftsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_stack_resource_drifts::DescribeStackResourceDriftsInput, ::aws_smithy_http::operation::error::BuildError> {
