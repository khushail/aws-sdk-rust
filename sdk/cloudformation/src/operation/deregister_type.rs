...
impl DeregisterTypeInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterType`](crate::operation::deregister_type::DeregisterType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deregister_type::DeregisterType, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_type::DeregisterTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_type_input::ser_deregister_type_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_type::DeregisterType::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeregisterType", "cloudformation"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterType {
                type Output = ::std::result::Result<crate::operation::deregister_type::DeregisterTypeOutput, crate::operation::deregister_type::DeregisterTypeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deregister_type::de_deregister_type_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deregister_type::de_deregister_type_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_type::DeregisterTypeError {
