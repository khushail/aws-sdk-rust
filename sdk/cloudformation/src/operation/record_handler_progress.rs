...
impl RecordHandlerProgressInput {
    /// Consumes the builder and constructs an Operation<[`RecordHandlerProgress`](crate::operation::record_handler_progress::RecordHandlerProgress)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::record_handler_progress::RecordHandlerProgress, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::record_handler_progress::RecordHandlerProgressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_record_handler_progress_input::ser_record_handler_progress_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::record_handler_progress::RecordHandlerProgress::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RecordHandlerProgress", "cloudformation"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RecordHandlerProgress`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RecordHandlerProgress {
                type Output = ::std::result::Result<crate::operation::record_handler_progress::RecordHandlerProgressOutput, crate::operation::record_handler_progress::RecordHandlerProgressError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_record_handler_progress::de_record_handler_progress_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_record_handler_progress::de_record_handler_progress_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::record_handler_progress::RecordHandlerProgressError {
...
mod _record_handler_progress_output;
