...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::activate_organizations_access::ActivateOrganizationsAccessError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::deactivate_organizations_access::DeactivateOrganizationsAccessError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
    fn from(err: ::aws_smithy_http::result::SdkError<crate::operation::deactivate_organizations_access::DeactivateOrganizationsAccessError, R>) -> Self {
        match err {
            ::aws_smithy_http::result::SdkError::ServiceError(context) => Self::from(context.into_err()),
            _ => Error::Unhandled(
                                            ::aws_smithy_types::error::Unhandled::builder()
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::describe_organizations_access::DescribeOrganizationsAccessError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
