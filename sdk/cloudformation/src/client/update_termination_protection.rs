...
impl super::Client  {
    ...
    ///   - [`stack_name(impl ::std::convert::Into<String>)`](crate::operation::update_termination_protection::builders::UpdateTerminationProtectionFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::update_termination_protection::builders::UpdateTerminationProtectionFluentBuilder::set_stack_name): <p>The name or unique ID of the stack for which you want to set termination protection.</p>
