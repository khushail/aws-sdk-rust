...
impl super::Client  {
    ...
    ///   - [`stack_name(impl ::std::convert::Into<String>)`](crate::operation::detect_stack_drift::builders::DetectStackDriftFluentBuilder::stack_name) / [`set_stack_name(Option<String>)`](crate::operation::detect_stack_drift::builders::DetectStackDriftFluentBuilder::set_stack_name): <p>The name of the stack for which you want to detect drift.</p>
