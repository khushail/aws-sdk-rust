...
impl super::Client  {
    ...
    ///   - [`publisher_id(impl ::std::convert::Into<String>)`](crate::operation::describe_publisher::builders::DescribePublisherFluentBuilder::publisher_id) / [`set_publisher_id(Option<String>)`](crate::operation::describe_publisher::builders::DescribePublisherFluentBuilder::set_publisher_id): <p>The ID of the extension publisher.</p>  <p>If you don't supply a <code>PublisherId</code>, and you have registered as an extension publisher, <code>DescribePublisher</code> returns information about your own publisher account.</p>
