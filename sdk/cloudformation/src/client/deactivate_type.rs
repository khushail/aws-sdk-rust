...
impl super::Client  {
    ...
    ///   - [`type_name(impl ::std::convert::Into<String>)`](crate::operation::deactivate_type::builders::DeactivateTypeFluentBuilder::type_name) / [`set_type_name(Option<String>)`](crate::operation::deactivate_type::builders::DeactivateTypeFluentBuilder::set_type_name): <p>The type name of the extension, in this account and Region. If you specified a type name alias when enabling the extension, use the type name alias.</p>  <p>Conditional: You must specify either <code>Arn</code>, or <code>TypeName</code> and <code>Type</code>.</p>
