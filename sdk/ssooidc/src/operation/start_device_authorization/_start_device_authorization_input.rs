...
impl StartDeviceAuthorizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_device_authorization::StartDeviceAuthorizationInput, ::aws_smithy_http::operation::error::BuildError> {
