...
impl super::Client  {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::create_type::builders::CreateTypeFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::create_type::builders::CreateTypeFluentBuilder::set_api_id): <p>The API ID.</p>
    ///   - [`definition(impl ::std::convert::Into<String>)`](crate::operation::create_type::builders::CreateTypeFluentBuilder::definition) / [`set_definition(Option<String>)`](crate::operation::create_type::builders::CreateTypeFluentBuilder::set_definition): <p>The type definition, in GraphQL Schema Definition Language (SDL) format.</p>  <p>For more information, see the <a href="http://graphql.org/learn/schema/">GraphQL SDL documentation</a>.</p>
