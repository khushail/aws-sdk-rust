...
impl super::Client  {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::get_api_association::builders::GetApiAssociationFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::get_api_association::builders::GetApiAssociationFluentBuilder::set_domain_name): <p>The domain name.</p>
