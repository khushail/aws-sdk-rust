...
impl super::Client  {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::delete_resolver::builders::DeleteResolverFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::delete_resolver::builders::DeleteResolverFluentBuilder::set_api_id): <p>The API ID.</p>
    ///   - [`type_name(impl ::std::convert::Into<String>)`](crate::operation::delete_resolver::builders::DeleteResolverFluentBuilder::type_name) / [`set_type_name(Option<String>)`](crate::operation::delete_resolver::builders::DeleteResolverFluentBuilder::set_type_name): <p>The name of the resolver type.</p>
