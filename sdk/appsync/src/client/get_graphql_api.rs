...
impl super::Client  {
    ...
    ///   - [`api_id(impl ::std::convert::Into<String>)`](crate::operation::get_graphql_api::builders::GetGraphqlApiFluentBuilder::api_id) / [`set_api_id(Option<String>)`](crate::operation::get_graphql_api::builders::GetGraphqlApiFluentBuilder::set_api_id): <p>The API ID for the GraphQL API.</p>
