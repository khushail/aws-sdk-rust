...
impl GetApiCacheInput {
    /// Consumes the builder and constructs an Operation<[`GetApiCache`](crate::operation::get_api_cache::GetApiCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_api_cache::GetApiCache, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_api_cache::GetApiCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_api_cache::GetApiCacheInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_api_cache::GetApiCache::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApiCache {
                type Output = ::std::result::Result<crate::operation::get_api_cache::GetApiCacheOutput, crate::operation::get_api_cache::GetApiCacheError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_api_cache::de_get_api_cache_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_api_cache::de_get_api_cache_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_api_cache::GetApiCacheError {
