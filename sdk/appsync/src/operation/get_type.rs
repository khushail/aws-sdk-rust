...
impl GetTypeInput {
    /// Consumes the builder and constructs an Operation<[`GetType`](crate::operation::get_type::GetType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_type::GetType, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_type::GetTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_type::GetTypeInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_3 = &_input.format;
                let inner_3 = inner_3.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("format", "cannot be empty or unset"))?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_type::GetType::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetType {
                type Output = ::std::result::Result<crate::operation::get_type::GetTypeOutput, crate::operation::get_type::GetTypeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_type::de_get_type_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_type::GetTypeError {
