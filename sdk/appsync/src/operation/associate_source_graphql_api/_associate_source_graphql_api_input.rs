...
impl AssociateSourceGraphqlApiInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_source_graphql_api::AssociateSourceGraphqlApiInput, ::aws_smithy_http::operation::error::BuildError> {
