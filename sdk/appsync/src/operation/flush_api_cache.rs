...
impl FlushApiCacheInput {
    /// Consumes the builder and constructs an Operation<[`FlushApiCache`](crate::operation::flush_api_cache::FlushApiCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::flush_api_cache::FlushApiCache, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::flush_api_cache::FlushApiCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/apis/{apiId}/FlushCache", apiId = api_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::flush_api_cache::FlushApiCacheInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::flush_api_cache::FlushApiCache::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("FlushApiCache", "appsync"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `FlushApiCache`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for FlushApiCache {
                type Output = ::std::result::Result<crate::operation::flush_api_cache::FlushApiCacheOutput, crate::operation::flush_api_cache::FlushApiCacheError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_flush_api_cache::de_flush_api_cache_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_flush_api_cache::de_flush_api_cache_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::flush_api_cache::FlushApiCacheError {
