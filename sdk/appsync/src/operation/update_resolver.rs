...
impl UpdateResolverInput {
    /// Consumes the builder and constructs an Operation<[`UpdateResolver`](crate::operation::update_resolver::UpdateResolver)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_resolver::UpdateResolver, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_resolver::UpdateResolverInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if type_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("type_name", "cannot be empty or unset"))
                            }
                ...
                if field_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("field_name", "cannot be empty or unset"))
                            }
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_resolver::ser_update_resolver_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_resolver::UpdateResolver::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateResolver", "appsync"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateResolver`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateResolver {
                type Output = ::std::result::Result<crate::operation::update_resolver::UpdateResolverOutput, crate::operation::update_resolver::UpdateResolverError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_resolver::de_update_resolver_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_resolver::de_update_resolver_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_resolver::UpdateResolverError {
