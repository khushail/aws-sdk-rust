...
impl CreateApiCacheInput {
    /// Consumes the builder and constructs an Operation<[`CreateApiCache`](crate::operation::create_api_cache::CreateApiCache)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_api_cache::CreateApiCache, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_api_cache::CreateApiCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_api_cache::ser_create_api_cache_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_api_cache::CreateApiCache::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateApiCache", "appsync"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateApiCache`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateApiCache {
                type Output = ::std::result::Result<crate::operation::create_api_cache::CreateApiCacheOutput, crate::operation::create_api_cache::CreateApiCacheError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_api_cache::de_create_api_cache_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_api_cache::de_create_api_cache_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_api_cache::CreateApiCacheError {
