...
impl AssociateMergedGraphqlApiInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_merged_graphql_api::AssociateMergedGraphqlApiInput, ::aws_smithy_http::operation::error::BuildError> {
