...
impl DeleteGraphqlApiInput {
    /// Consumes the builder and constructs an Operation<[`DeleteGraphqlApi`](crate::operation::delete_graphql_api::DeleteGraphqlApi)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_graphql_api::DeleteGraphqlApi, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_graphql_api::DeleteGraphqlApiInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_graphql_api::DeleteGraphqlApiInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_graphql_api::DeleteGraphqlApi::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteGraphqlApi", "appsync"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteGraphqlApi`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGraphqlApi {
                type Output = ::std::result::Result<crate::operation::delete_graphql_api::DeleteGraphqlApiOutput, crate::operation::delete_graphql_api::DeleteGraphqlApiError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_graphql_api::de_delete_graphql_api_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_graphql_api::de_delete_graphql_api_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_graphql_api::DeleteGraphqlApiError {
...
mod _delete_graphql_api_output;
