...
impl DisassociateMergedGraphqlApiInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_merged_graphql_api::DisassociateMergedGraphqlApiInput, ::aws_smithy_http::operation::error::BuildError> {
