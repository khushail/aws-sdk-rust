...
impl StartSigningJobInput {
    /// Consumes the builder and constructs an Operation<[`StartSigningJob`](crate::operation::start_signing_job::StartSigningJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_signing_job::StartSigningJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_signing_job::StartSigningJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_signing_job::StartSigningJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartSigningJob", "signer"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartSigningJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSigningJob {
                type Output = ::std::result::Result<crate::operation::start_signing_job::StartSigningJobOutput, crate::operation::start_signing_job::StartSigningJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_signing_job::de_start_signing_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_signing_job::de_start_signing_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_signing_job::StartSigningJobError {
