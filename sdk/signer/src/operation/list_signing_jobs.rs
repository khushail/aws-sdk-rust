...
impl ListSigningJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListSigningJobs`](crate::operation::list_signing_jobs::ListSigningJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_signing_jobs::ListSigningJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_signing_jobs::ListSigningJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/signing-jobs").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_signing_jobs::ListSigningJobsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_6) = &_input.is_revoked {
                    if *inner_6 {
                        query.push_kv("isRevoked", ::aws_smithy_types::primitive::Encoder::from(*inner_6).encode());
                    }
                }
                if let ::std::option::Option::Some(inner_7) = &_input.signature_expires_before {
                     {
                        query.push_kv("signatureExpiresBefore", &::aws_smithy_http::query::fmt_timestamp(inner_7, ::aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let ::std::option::Option::Some(inner_8) = &_input.signature_expires_after {
                     {
                        query.push_kv("signatureExpiresAfter", &::aws_smithy_http::query::fmt_timestamp(inner_8, ::aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
            ...
            fn update_http_builder(
                            input: &crate::operation::list_signing_jobs::ListSigningJobsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_signing_jobs::ListSigningJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSigningJobs {
                type Output = ::std::result::Result<crate::operation::list_signing_jobs::ListSigningJobsOutput, crate::operation::list_signing_jobs::ListSigningJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_signing_jobs::de_list_signing_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_signing_jobs::de_list_signing_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_signing_jobs::ListSigningJobsError {
