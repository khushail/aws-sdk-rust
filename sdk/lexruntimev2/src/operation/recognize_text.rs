...
impl RecognizeTextInput {
    /// Consumes the builder and constructs an Operation<[`RecognizeText`](crate::operation::recognize_text::RecognizeText)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::recognize_text::RecognizeText, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::recognize_text::RecognizeTextInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if bot_alias_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("bot_alias_id", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::recognize_text::RecognizeText::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RecognizeText {
                type Output = ::std::result::Result<crate::operation::recognize_text::RecognizeTextOutput, crate::operation::recognize_text::RecognizeTextError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_recognize_text::de_recognize_text_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_recognize_text::de_recognize_text_http_response_with_props(status, headers, body)
                     }
                }
