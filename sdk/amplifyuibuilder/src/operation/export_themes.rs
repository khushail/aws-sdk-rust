...
impl ExportThemesInput {
    /// Consumes the builder and constructs an Operation<[`ExportThemes`](crate::operation::export_themes::ExportThemes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::export_themes::ExportThemes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::export_themes::ExportThemesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/export/app/{appId}/environment/{environmentName}/themes", appId = app_id, environmentName = environment_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::export_themes::ExportThemesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::export_themes::ExportThemesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::export_themes::ExportThemes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportThemes {
                type Output = ::std::result::Result<crate::operation::export_themes::ExportThemesOutput, crate::operation::export_themes::ExportThemesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_export_themes::de_export_themes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_export_themes::de_export_themes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::export_themes::ExportThemesError {
