...
impl StartCodegenJobInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_codegen_job::StartCodegenJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_codegen_job::StartCodegenJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::start_codegen_job::StartCodegenJobInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartCodegenJob {
                type Output = ::std::result::Result<crate::operation::start_codegen_job::StartCodegenJobOutput, crate::operation::start_codegen_job::StartCodegenJobError>;
