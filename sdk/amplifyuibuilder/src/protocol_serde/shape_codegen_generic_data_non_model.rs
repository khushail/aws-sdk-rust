...
pub(crate) fn de_codegen_generic_data_non_model<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CodegenGenericDataNonModel>, ::aws_smithy_json::deserialize::error::DeserializeError>
