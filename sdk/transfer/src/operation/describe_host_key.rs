...
impl DescribeHostKeyInput {
    /// Consumes the builder and constructs an Operation<[`DescribeHostKey`](crate::operation::describe_host_key::DescribeHostKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_host_key::DescribeHostKey, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_host_key::DescribeHostKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_host_key::DescribeHostKey::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeHostKey", "transfer"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeHostKey`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHostKey {
                type Output = ::std::result::Result<crate::operation::describe_host_key::DescribeHostKeyOutput, crate::operation::describe_host_key::DescribeHostKeyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_host_key::de_describe_host_key_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_host_key::de_describe_host_key_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_host_key::DescribeHostKeyError {
...
pub use crate::operation::describe_host_key::_describe_host_key_output::DescribeHostKeyOutput;

pub use crate::operation::describe_host_key::_describe_host_key_input::DescribeHostKeyInput;

mod _describe_host_key_input;

mod _describe_host_key_output;
