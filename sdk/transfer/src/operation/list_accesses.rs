...
impl ListAccessesInput {
    /// Consumes the builder and constructs an Operation<[`ListAccesses`](crate::operation::list_accesses::ListAccesses)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_accesses::ListAccesses, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_accesses::ListAccessesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_accesses::ListAccesses::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAccesses", "transfer"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListAccesses`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAccesses {
                type Output = ::std::result::Result<crate::operation::list_accesses::ListAccessesOutput, crate::operation::list_accesses::ListAccessesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_accesses::de_list_accesses_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_accesses::de_list_accesses_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_accesses::ListAccessesError {
