...
impl super::Client  {
    ...
    ///   - [`server_id(impl ::std::convert::Into<String>)`](crate::operation::update_host_key::builders::UpdateHostKeyFluentBuilder::server_id) / [`set_server_id(Option<String>)`](crate::operation::update_host_key::builders::UpdateHostKeyFluentBuilder::set_server_id): <p>The identifier of the server that contains the host key that you are updating.</p>
    ///   - [`host_key_id(impl ::std::convert::Into<String>)`](crate::operation::update_host_key::builders::UpdateHostKeyFluentBuilder::host_key_id) / [`set_host_key_id(Option<String>)`](crate::operation::update_host_key::builders::UpdateHostKeyFluentBuilder::set_host_key_id): <p>The identifier of the host key that you are updating.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_host_key::builders::UpdateHostKeyFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_host_key::builders::UpdateHostKeyFluentBuilder::set_description): <p>An updated description for the host key.</p>
