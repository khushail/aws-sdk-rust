...
impl super::Client  {
    ...
    ///   - [`as2_id(impl ::std::convert::Into<String>)`](crate::operation::create_profile::builders::CreateProfileFluentBuilder::as2_id) / [`set_as2_id(Option<String>)`](crate::operation::create_profile::builders::CreateProfileFluentBuilder::set_as2_id): <p>The <code>As2Id</code> is the <i>AS2-name</i>, as defined in the <a href="https://datatracker.ietf.org/doc/html/rfc4130">RFC 4130</a>. For inbound transfers, this is the <code>AS2-From</code> header for the AS2 messages sent from the partner. For outbound connectors, this is the <code>AS2-To</code> header for the AS2 messages sent to the partner using the <code>StartFileTransfer</code> API operation. This ID cannot include spaces.</p>
