...
impl super::Client  {
    ...
    ///   - [`connector_id(impl ::std::convert::Into<String>)`](crate::operation::start_file_transfer::builders::StartFileTransferFluentBuilder::connector_id) / [`set_connector_id(Option<String>)`](crate::operation::start_file_transfer::builders::StartFileTransferFluentBuilder::set_connector_id): <p>The unique identifier for the connector. </p>
