...
impl super::Client  {
    ...
    ///   - [`server_id(impl ::std::convert::Into<String>)`](crate::operation::delete_access::builders::DeleteAccessFluentBuilder::server_id) / [`set_server_id(Option<String>)`](crate::operation::delete_access::builders::DeleteAccessFluentBuilder::set_server_id): <p>A system-assigned unique identifier for a server that has this user assigned.</p>
