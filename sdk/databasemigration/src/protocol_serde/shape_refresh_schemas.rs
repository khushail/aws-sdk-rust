...
#[allow(clippy::unnecessary_wraps)]
pub fn de_refresh_schemas_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::refresh_schemas::RefreshSchemasOutput, crate::operation::refresh_schemas::RefreshSchemasError> {
    Ok({
        #[allow(unused_mut)]
