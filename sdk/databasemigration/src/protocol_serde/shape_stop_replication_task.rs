...
#[allow(clippy::unnecessary_wraps)]
pub fn de_stop_replication_task_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::stop_replication_task::StopReplicationTaskOutput, crate::operation::stop_replication_task::StopReplicationTaskError> {
    Ok({
        #[allow(unused_mut)]
