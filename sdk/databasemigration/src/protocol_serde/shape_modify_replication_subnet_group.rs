...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_replication_subnet_group_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupOutput, crate::operation::modify_replication_subnet_group::ModifyReplicationSubnetGroupError> {
    Ok({
        #[allow(unused_mut)]
