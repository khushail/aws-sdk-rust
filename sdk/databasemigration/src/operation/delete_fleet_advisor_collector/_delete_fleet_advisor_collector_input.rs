...
impl DeleteFleetAdvisorCollectorInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_fleet_advisor_collector::DeleteFleetAdvisorCollectorInput, ::aws_smithy_http::operation::error::BuildError> {
