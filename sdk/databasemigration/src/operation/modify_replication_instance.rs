...
impl ModifyReplicationInstanceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_replication_instance::ModifyReplicationInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_replication_instance::ModifyReplicationInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyReplicationInstance {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_replication_instance::de_modify_replication_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_replication_instance::de_modify_replication_instance_http_response_with_props(status, headers, body)
                     }
                }
