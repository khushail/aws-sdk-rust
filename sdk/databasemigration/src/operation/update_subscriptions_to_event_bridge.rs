...
impl UpdateSubscriptionsToEventBridgeInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSubscriptionsToEventBridge`](crate::operation::update_subscriptions_to_event_bridge::UpdateSubscriptionsToEventBridge)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_subscriptions_to_event_bridge::UpdateSubscriptionsToEventBridge, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_subscriptions_to_event_bridge::UpdateSubscriptionsToEventBridgeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_subscriptions_to_event_bridge::UpdateSubscriptionsToEventBridge::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSubscriptionsToEventBridge {
                type Output = ::std::result::Result<crate::operation::update_subscriptions_to_event_bridge::UpdateSubscriptionsToEventBridgeOutput, crate::operation::update_subscriptions_to_event_bridge::UpdateSubscriptionsToEventBridgeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_subscriptions_to_event_bridge::de_update_subscriptions_to_event_bridge_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_subscriptions_to_event_bridge::de_update_subscriptions_to_event_bridge_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_subscriptions_to_event_bridge::UpdateSubscriptionsToEventBridgeError {
...
mod _update_subscriptions_to_event_bridge_output;
