...
impl DescribeFleetAdvisorDatabasesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetAdvisorDatabases`](crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabases)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabases, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabases::new())
...
/// Orchestration and serialization glue logic for `DescribeFleetAdvisorDatabases`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetAdvisorDatabases {
                type Output = ::std::result::Result<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesOutput, crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_fleet_advisor_databases::de_describe_fleet_advisor_databases_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_fleet_advisor_databases::de_describe_fleet_advisor_databases_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesError {
...
mod _describe_fleet_advisor_databases_output;
