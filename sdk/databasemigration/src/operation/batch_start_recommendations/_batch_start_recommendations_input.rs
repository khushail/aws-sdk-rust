...
impl BatchStartRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_start_recommendations::BatchStartRecommendationsInput, ::aws_smithy_http::operation::error::BuildError> {
