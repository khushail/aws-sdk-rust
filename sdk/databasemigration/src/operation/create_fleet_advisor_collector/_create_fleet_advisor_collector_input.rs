...
impl CreateFleetAdvisorCollectorInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_fleet_advisor_collector::CreateFleetAdvisorCollectorInput, ::aws_smithy_http::operation::error::BuildError> {
