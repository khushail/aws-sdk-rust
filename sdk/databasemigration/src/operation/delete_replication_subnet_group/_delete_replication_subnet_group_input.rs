...
impl DeleteReplicationSubnetGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_replication_subnet_group::DeleteReplicationSubnetGroupInput, ::aws_smithy_http::operation::error::BuildError> {
