...
impl DescribeFleetAdvisorDatabasesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_fleet_advisor_databases::DescribeFleetAdvisorDatabasesInput, ::aws_smithy_http::operation::error::BuildError> {
