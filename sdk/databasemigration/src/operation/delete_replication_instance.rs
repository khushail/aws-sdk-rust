...
impl DeleteReplicationInstanceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteReplicationInstance`](crate::operation::delete_replication_instance::DeleteReplicationInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_replication_instance::DeleteReplicationInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_replication_instance::DeleteReplicationInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_replication_instance::DeleteReplicationInstance::new())
...
/// Orchestration and serialization glue logic for `DeleteReplicationInstance`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReplicationInstance {
                type Output = ::std::result::Result<crate::operation::delete_replication_instance::DeleteReplicationInstanceOutput, crate::operation::delete_replication_instance::DeleteReplicationInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_replication_instance::de_delete_replication_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_replication_instance::de_delete_replication_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_replication_instance::DeleteReplicationInstanceError {
...
pub use crate::operation::delete_replication_instance::_delete_replication_instance_output::DeleteReplicationInstanceOutput;

pub use crate::operation::delete_replication_instance::_delete_replication_instance_input::DeleteReplicationInstanceInput;

mod _delete_replication_instance_input;

mod _delete_replication_instance_output;
