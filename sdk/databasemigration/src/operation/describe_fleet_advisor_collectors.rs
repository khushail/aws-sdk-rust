...
impl DescribeFleetAdvisorCollectorsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetAdvisorCollectors`](crate::operation::describe_fleet_advisor_collectors::DescribeFleetAdvisorCollectors)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_fleet_advisor_collectors::DescribeFleetAdvisorCollectors, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_advisor_collectors::DescribeFleetAdvisorCollectorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_advisor_collectors::DescribeFleetAdvisorCollectors::new())
...
/// Orchestration and serialization glue logic for `DescribeFleetAdvisorCollectors`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetAdvisorCollectors {
                type Output = ::std::result::Result<crate::operation::describe_fleet_advisor_collectors::DescribeFleetAdvisorCollectorsOutput, crate::operation::describe_fleet_advisor_collectors::DescribeFleetAdvisorCollectorsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_fleet_advisor_collectors::de_describe_fleet_advisor_collectors_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_fleet_advisor_collectors::de_describe_fleet_advisor_collectors_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_fleet_advisor_collectors::DescribeFleetAdvisorCollectorsError {
...
pub use crate::operation::describe_fleet_advisor_collectors::_describe_fleet_advisor_collectors_output::DescribeFleetAdvisorCollectorsOutput;

pub use crate::operation::describe_fleet_advisor_collectors::_describe_fleet_advisor_collectors_input::DescribeFleetAdvisorCollectorsInput;

mod _describe_fleet_advisor_collectors_input;

mod _describe_fleet_advisor_collectors_output;
