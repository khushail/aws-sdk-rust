...
impl DescribeFleetAdvisorLsaAnalysisInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetAdvisorLsaAnalysis`](crate::operation::describe_fleet_advisor_lsa_analysis::DescribeFleetAdvisorLsaAnalysis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_fleet_advisor_lsa_analysis::DescribeFleetAdvisorLsaAnalysis, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_advisor_lsa_analysis::DescribeFleetAdvisorLsaAnalysisInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_advisor_lsa_analysis::DescribeFleetAdvisorLsaAnalysis::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetAdvisorLsaAnalysis {
                type Output = ::std::result::Result<crate::operation::describe_fleet_advisor_lsa_analysis::DescribeFleetAdvisorLsaAnalysisOutput, crate::operation::describe_fleet_advisor_lsa_analysis::DescribeFleetAdvisorLsaAnalysisError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_fleet_advisor_lsa_analysis::de_describe_fleet_advisor_lsa_analysis_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_fleet_advisor_lsa_analysis::de_describe_fleet_advisor_lsa_analysis_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_fleet_advisor_lsa_analysis::DescribeFleetAdvisorLsaAnalysisError {
...
pub use crate::operation::describe_fleet_advisor_lsa_analysis::_describe_fleet_advisor_lsa_analysis_output::DescribeFleetAdvisorLsaAnalysisOutput;

pub use crate::operation::describe_fleet_advisor_lsa_analysis::_describe_fleet_advisor_lsa_analysis_input::DescribeFleetAdvisorLsaAnalysisInput;

mod _describe_fleet_advisor_lsa_analysis_input;

mod _describe_fleet_advisor_lsa_analysis_output;
