...
impl StartReplicationTaskAssessmentRunInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_replication_task_assessment_run::StartReplicationTaskAssessmentRun, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_replication_task_assessment_run::StartReplicationTaskAssessmentRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `StartReplicationTaskAssessmentRun`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartReplicationTaskAssessmentRun {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_replication_task_assessment_run::de_start_replication_task_assessment_run_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_replication_task_assessment_run::de_start_replication_task_assessment_run_http_response_with_props(status, headers, body)
                     }
                }
