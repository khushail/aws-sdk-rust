...
impl DescribeSchemasInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSchemas`](crate::operation::describe_schemas::DescribeSchemas)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_schemas::DescribeSchemas, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_schemas::DescribeSchemasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_schemas::DescribeSchemas::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSchemas {
                type Output = ::std::result::Result<crate::operation::describe_schemas::DescribeSchemasOutput, crate::operation::describe_schemas::DescribeSchemasError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_schemas::de_describe_schemas_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_schemas::de_describe_schemas_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_schemas::DescribeSchemasError {
