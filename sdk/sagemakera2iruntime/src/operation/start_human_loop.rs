...
impl StartHumanLoopInput {
    /// Consumes the builder and constructs an Operation<[`StartHumanLoop`](crate::operation::start_human_loop::StartHumanLoop)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_human_loop::StartHumanLoop, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_human_loop::StartHumanLoopInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/human-loops").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_human_loop::StartHumanLoop::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartHumanLoop", "sagemakera2iruntime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartHumanLoop`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartHumanLoop {
                type Output = ::std::result::Result<crate::operation::start_human_loop::StartHumanLoopOutput, crate::operation::start_human_loop::StartHumanLoopError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_human_loop::de_start_human_loop_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_human_loop::de_start_human_loop_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_human_loop::StartHumanLoopError {
