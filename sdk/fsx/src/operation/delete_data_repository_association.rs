...
impl DeleteDataRepositoryAssociationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDataRepositoryAssociation`](crate::operation::delete_data_repository_association::DeleteDataRepositoryAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_data_repository_association::DeleteDataRepositoryAssociation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_data_repository_association::DeleteDataRepositoryAssociationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_data_repository_association::DeleteDataRepositoryAssociation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDataRepositoryAssociation", "fsx"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteDataRepositoryAssociation`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDataRepositoryAssociation {
                type Output = ::std::result::Result<crate::operation::delete_data_repository_association::DeleteDataRepositoryAssociationOutput, crate::operation::delete_data_repository_association::DeleteDataRepositoryAssociationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_data_repository_association::de_delete_data_repository_association_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_data_repository_association::de_delete_data_repository_association_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_data_repository_association::DeleteDataRepositoryAssociationError {
...
mod _delete_data_repository_association_output;
