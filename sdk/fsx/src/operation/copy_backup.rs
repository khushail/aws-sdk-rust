...
impl CopyBackupInput {
    /// Consumes the builder and constructs an Operation<[`CopyBackup`](crate::operation::copy_backup::CopyBackup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::copy_backup::CopyBackup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::copy_backup::CopyBackupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::copy_backup::CopyBackup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CopyBackup", "fsx"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CopyBackup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyBackup {
                type Output = ::std::result::Result<crate::operation::copy_backup::CopyBackupOutput, crate::operation::copy_backup::CopyBackupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_copy_backup::de_copy_backup_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_copy_backup::de_copy_backup_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::copy_backup::CopyBackupError {
