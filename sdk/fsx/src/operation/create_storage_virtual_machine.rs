...
impl CreateStorageVirtualMachineInput {
    /// Consumes the builder and constructs an Operation<[`CreateStorageVirtualMachine`](crate::operation::create_storage_virtual_machine::CreateStorageVirtualMachine)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_storage_virtual_machine::CreateStorageVirtualMachine, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_storage_virtual_machine::CreateStorageVirtualMachineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_storage_virtual_machine::CreateStorageVirtualMachine::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateStorageVirtualMachine {
                type Output = ::std::result::Result<crate::operation::create_storage_virtual_machine::CreateStorageVirtualMachineOutput, crate::operation::create_storage_virtual_machine::CreateStorageVirtualMachineError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_storage_virtual_machine::de_create_storage_virtual_machine_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_storage_virtual_machine::de_create_storage_virtual_machine_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_storage_virtual_machine::CreateStorageVirtualMachineError {
...
mod _create_storage_virtual_machine_output;
