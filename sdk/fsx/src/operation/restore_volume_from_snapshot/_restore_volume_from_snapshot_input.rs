...
impl RestoreVolumeFromSnapshotInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_volume_from_snapshot::RestoreVolumeFromSnapshotInput, ::aws_smithy_http::operation::error::BuildError> {
