...
impl CreateFileCacheInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_file_cache::CreateFileCache, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_file_cache::CreateFileCacheInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `CreateFileCache`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFileCache {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_file_cache::de_create_file_cache_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_file_cache::de_create_file_cache_http_response_with_props(status, headers, body)
                     }
                }
