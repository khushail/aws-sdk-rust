...
impl DescribeFileCachesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFileCaches`](crate::operation::describe_file_caches::DescribeFileCaches)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_file_caches::DescribeFileCaches, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_file_caches::DescribeFileCachesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_file_caches::DescribeFileCachesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_file_caches::DescribeFileCaches::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeFileCaches", "fsx"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeFileCaches`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFileCaches {
                type Output = ::std::result::Result<crate::operation::describe_file_caches::DescribeFileCachesOutput, crate::operation::describe_file_caches::DescribeFileCachesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_file_caches::de_describe_file_caches_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_file_caches::de_describe_file_caches_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_file_caches::DescribeFileCachesError {
...
mod _describe_file_caches_output;
