...
impl UpdateStorageVirtualMachineInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineInput, ::aws_smithy_http::operation::error::BuildError> {
