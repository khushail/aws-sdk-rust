...
impl ReleaseFileSystemNfsV3LocksInput {
    /// Consumes the builder and constructs an Operation<[`ReleaseFileSystemNfsV3Locks`](crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3Locks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3Locks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3Locks::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReleaseFileSystemNfsV3Locks {
                type Output = ::std::result::Result<crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksOutput, crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::release_file_system_nfs_v3_locks::ReleaseFileSystemNfsV3LocksError {
...
mod _release_file_system_nfs_v3_locks_output;
