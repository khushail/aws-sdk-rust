...
impl DeleteStorageVirtualMachineInput {
    /// Consumes the builder and constructs an Operation<[`DeleteStorageVirtualMachine`](crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachine)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachine, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachine::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStorageVirtualMachine {
                type Output = ::std::result::Result<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineOutput, crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_storage_virtual_machine::de_delete_storage_virtual_machine_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_storage_virtual_machine::de_delete_storage_virtual_machine_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineError {
...
mod _delete_storage_virtual_machine_output;
