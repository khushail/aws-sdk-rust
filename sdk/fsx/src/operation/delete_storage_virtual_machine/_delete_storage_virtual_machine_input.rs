...
impl DeleteStorageVirtualMachineInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_storage_virtual_machine::DeleteStorageVirtualMachineInput, ::aws_smithy_http::operation::error::BuildError> {
