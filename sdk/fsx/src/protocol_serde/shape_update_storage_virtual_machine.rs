...
pub fn ser_update_storage_virtual_machine_input(input: &crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_update_storage_virtual_machine_input::ser_update_storage_virtual_machine_input(&mut object, input)?;
    object.finish();
...
pub fn de_update_storage_virtual_machine_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineOutput, crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "BadRequest" => crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError::BadRequest({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "IncompatibleParameterError" => crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError::IncompatibleParameterError({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServerError" => crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError::InternalServerError({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "StorageVirtualMachineNotFound" => crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError::StorageVirtualMachineNotFound({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "UnsupportedOperation" => crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError::UnsupportedOperation({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_update_storage_virtual_machine_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineOutput, crate::operation::update_storage_virtual_machine::UpdateStorageVirtualMachineError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_update_storage_virtual_machine(value: &[u8], mut builder: crate::operation::update_storage_virtual_machine::builders::UpdateStorageVirtualMachineOutputBuilder) -> Result<crate::operation::update_storage_virtual_machine::builders::UpdateStorageVirtualMachineOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
