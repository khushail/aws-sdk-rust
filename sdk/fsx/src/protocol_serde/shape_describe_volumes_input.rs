...
pub fn ser_describe_volumes_input(
    ...
    if let Some(var_1) = &input.volume_ids {
        let mut array_2 = object.key("VolumeIds").start_array();
        for item_3 in var_1 {
             {
        ...
        for item_6 in var_4 {
             {
                ...
                crate::protocol_serde::shape_volume_filter::ser_volume_filter(&mut object_7, item_6)?;
                object_7.finish();
            }
        }
        array_5.finish();
