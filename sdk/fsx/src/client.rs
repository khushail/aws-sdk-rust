...
mod associate_file_system_aliases;

mod cancel_data_repository_task;
...
mod create_data_repository_task;

mod create_file_cache;

mod create_file_system;

mod create_file_system_from_backup;

mod create_snapshot;

mod create_storage_virtual_machine;

mod create_volume;

mod create_volume_from_backup;
...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_fsx::Error> {
/// # let client: aws_sdk_fsx::Client = unimplemented!();
...
mod delete_data_repository_association;

mod delete_file_cache;

mod delete_file_system;

mod delete_snapshot;

mod delete_storage_virtual_machine;

mod delete_volume;

mod describe_backups;

mod describe_data_repository_associations;

mod describe_data_repository_tasks;

mod describe_file_caches;

mod describe_file_system_aliases;
...
mod release_file_system_nfs_v3_locks;
...
mod update_data_repository_association;
...
mod update_storage_virtual_machine;
