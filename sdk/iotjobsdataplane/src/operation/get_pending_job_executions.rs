...
impl GetPendingJobExecutionsInput {
    /// Consumes the builder and constructs an Operation<[`GetPendingJobExecutions`](crate::operation::get_pending_job_executions::GetPendingJobExecutions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_pending_job_executions::GetPendingJobExecutions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_pending_job_executions::GetPendingJobExecutionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_pending_job_executions::GetPendingJobExecutionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_pending_job_executions::GetPendingJobExecutions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPendingJobExecutions {
                type Output = ::std::result::Result<crate::operation::get_pending_job_executions::GetPendingJobExecutionsOutput, crate::operation::get_pending_job_executions::GetPendingJobExecutionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_pending_job_executions::de_get_pending_job_executions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_pending_job_executions::de_get_pending_job_executions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_pending_job_executions::GetPendingJobExecutionsError {
...
mod _get_pending_job_executions_output;
