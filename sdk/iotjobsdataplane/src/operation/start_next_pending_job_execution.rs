...
impl StartNextPendingJobExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StartNextPendingJobExecution`](crate::operation::start_next_pending_job_execution::StartNextPendingJobExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_next_pending_job_execution::StartNextPendingJobExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_next_pending_job_execution::StartNextPendingJobExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/things/{thingName}/jobs/$next", thingName = thing_name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_next_pending_job_execution::StartNextPendingJobExecution::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartNextPendingJobExecution", "iotjobsdataplane"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartNextPendingJobExecution`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartNextPendingJobExecution {
                type Output = ::std::result::Result<crate::operation::start_next_pending_job_execution::StartNextPendingJobExecutionOutput, crate::operation::start_next_pending_job_execution::StartNextPendingJobExecutionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_next_pending_job_execution::de_start_next_pending_job_execution_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_next_pending_job_execution::de_start_next_pending_job_execution_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_next_pending_job_execution::StartNextPendingJobExecutionError {
...
mod _start_next_pending_job_execution_output;
