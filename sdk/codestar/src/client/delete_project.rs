...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_id): <p>The ID of the project to be deleted in AWS CodeStar.</p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::delete_project::builders::DeleteProjectFluentBuilder::set_client_request_token): <p>A user- or system-generated token that identifies the entity that requested project deletion. This token can be used to repeat the request. </p>
