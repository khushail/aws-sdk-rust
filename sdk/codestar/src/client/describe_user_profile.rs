...
impl super::Client  {
    ...
    ///   - [`user_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_user_profile::builders::DescribeUserProfileFluentBuilder::user_arn) / [`set_user_arn(Option<String>)`](crate::operation::describe_user_profile::builders::DescribeUserProfileFluentBuilder::set_user_arn): <p>The Amazon Resource Name (ARN) of the user.</p>
