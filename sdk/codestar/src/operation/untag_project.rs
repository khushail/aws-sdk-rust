...
impl UntagProjectInput {
    /// Consumes the builder and constructs an Operation<[`UntagProject`](crate::operation::untag_project::UntagProject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::untag_project::UntagProject, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_project::UntagProjectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::untag_project::UntagProjectInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_untag_project::ser_untag_project_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::untag_project::UntagProject::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UntagProject", "codestar"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagProject {
                type Output = ::std::result::Result<crate::operation::untag_project::UntagProjectOutput, crate::operation::untag_project::UntagProjectError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_untag_project::de_untag_project_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_untag_project::de_untag_project_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::untag_project::UntagProjectError {
...
pub use crate::operation::untag_project::_untag_project_output::UntagProjectOutput;

pub use crate::operation::untag_project::_untag_project_input::UntagProjectInput;

mod _untag_project_input;

mod _untag_project_output;
