...
impl DisassociateTeamMemberInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateTeamMember`](crate::operation::disassociate_team_member::DisassociateTeamMember)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_team_member::DisassociateTeamMember, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_team_member::DisassociateTeamMemberInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_team_member::ser_disassociate_team_member_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_team_member::DisassociateTeamMember::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateTeamMember", "codestar"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisassociateTeamMember`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateTeamMember {
                type Output = ::std::result::Result<crate::operation::disassociate_team_member::DisassociateTeamMemberOutput, crate::operation::disassociate_team_member::DisassociateTeamMemberError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_team_member::de_disassociate_team_member_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_team_member::de_disassociate_team_member_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_team_member::DisassociateTeamMemberError {
...
pub use crate::operation::disassociate_team_member::_disassociate_team_member_output::DisassociateTeamMemberOutput;

pub use crate::operation::disassociate_team_member::_disassociate_team_member_input::DisassociateTeamMemberInput;

mod _disassociate_team_member_input;

mod _disassociate_team_member_output;
