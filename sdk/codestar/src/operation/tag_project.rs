...
impl TagProjectInput {
    /// Consumes the builder and constructs an Operation<[`TagProject`](crate::operation::tag_project::TagProject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::tag_project::TagProject, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_project::TagProjectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::tag_project::TagProjectInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_tag_project::ser_tag_project_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::tag_project::TagProject::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("TagProject", "codestar"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `TagProject`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagProject {
                type Output = ::std::result::Result<crate::operation::tag_project::TagProjectOutput, crate::operation::tag_project::TagProjectError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_tag_project::de_tag_project_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_tag_project::de_tag_project_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::tag_project::TagProjectError {
...
pub use crate::operation::tag_project::_tag_project_output::TagProjectOutput;

pub use crate::operation::tag_project::_tag_project_input::TagProjectInput;

mod _tag_project_input;

mod _tag_project_output;
