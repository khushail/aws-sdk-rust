...
impl UpdateThingShadowInput {
    /// Consumes the builder and constructs an Operation<[`UpdateThingShadow`](crate::operation::update_thing_shadow::UpdateThingShadow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_thing_shadow::UpdateThingShadow, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_thing_shadow::UpdateThingShadowInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::update_thing_shadow::UpdateThingShadowInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_thing_shadow::UpdateThingShadowInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_thing_shadow::UpdateThingShadow::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateThingShadow", "iotdataplane"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateThingShadow`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateThingShadow {
                type Output = ::std::result::Result<crate::operation::update_thing_shadow::UpdateThingShadowOutput, crate::operation::update_thing_shadow::UpdateThingShadowError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_thing_shadow::de_update_thing_shadow_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_thing_shadow::de_update_thing_shadow_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_thing_shadow::UpdateThingShadowError {
...
mod _update_thing_shadow_output;
