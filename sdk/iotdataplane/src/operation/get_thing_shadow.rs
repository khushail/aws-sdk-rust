...
impl GetThingShadowInput {
    /// Consumes the builder and constructs an Operation<[`GetThingShadow`](crate::operation::get_thing_shadow::GetThingShadow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_thing_shadow::GetThingShadow, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_thing_shadow::GetThingShadowInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_thing_shadow::GetThingShadowInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_thing_shadow::GetThingShadowInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_thing_shadow::GetThingShadow::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetThingShadow {
                type Output = ::std::result::Result<crate::operation::get_thing_shadow::GetThingShadowOutput, crate::operation::get_thing_shadow::GetThingShadowError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_thing_shadow::de_get_thing_shadow_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_thing_shadow::de_get_thing_shadow_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_thing_shadow::GetThingShadowError {
