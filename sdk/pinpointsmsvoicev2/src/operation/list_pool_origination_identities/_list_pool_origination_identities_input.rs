...
impl ListPoolOriginationIdentitiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_pool_origination_identities::ListPoolOriginationIdentitiesInput, ::aws_smithy_http::operation::error::BuildError> {
