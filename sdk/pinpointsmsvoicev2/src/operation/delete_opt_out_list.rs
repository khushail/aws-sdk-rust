...
impl DeleteOptOutListInput {
    /// Consumes the builder and constructs an Operation<[`DeleteOptOutList`](crate::operation::delete_opt_out_list::DeleteOptOutList)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_opt_out_list::DeleteOptOutList, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_opt_out_list::DeleteOptOutListInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_opt_out_list::DeleteOptOutList::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteOptOutList {
                type Output = ::std::result::Result<crate::operation::delete_opt_out_list::DeleteOptOutListOutput, crate::operation::delete_opt_out_list::DeleteOptOutListError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_opt_out_list::de_delete_opt_out_list_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_opt_out_list::de_delete_opt_out_list_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_opt_out_list::DeleteOptOutListError {
...
mod _delete_opt_out_list_output;
