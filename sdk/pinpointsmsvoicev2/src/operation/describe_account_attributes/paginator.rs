...
/// Paginator for [`DescribeAccountAttributes`](crate::operation::describe_account_attributes::DescribeAccountAttributes)
            ...
            impl DescribeAccountAttributesPaginator  {
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::describe_account_attributes::DescribeAccountAttributesOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_account_attributes::DescribeAccountAttributesError>>> + ::std::marker::Unpin
                 {
...
/// Flattened paginator for `DescribeAccountAttributesPaginator`
                ...
                impl  DescribeAccountAttributesPaginatorItems  {
                    ...
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::AccountAttribute, ::aws_smithy_http::result::SdkError<crate::operation::describe_account_attributes::DescribeAccountAttributesError>>> + ::std::marker::Unpin
                     {
