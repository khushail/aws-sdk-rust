...
impl SetVoiceMessageSpendLimitOverrideInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverride, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_voice_message_spend_limit_override::SetVoiceMessageSpendLimitOverrideInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
