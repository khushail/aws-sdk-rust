...
impl RequestPhoneNumberInput {
    /// Consumes the builder and constructs an Operation<[`RequestPhoneNumber`](crate::operation::request_phone_number::RequestPhoneNumber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::request_phone_number::RequestPhoneNumber, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::request_phone_number::RequestPhoneNumberInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::request_phone_number::RequestPhoneNumber::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RequestPhoneNumber", "pinpointsmsvoicev2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RequestPhoneNumber`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RequestPhoneNumber {
                type Output = ::std::result::Result<crate::operation::request_phone_number::RequestPhoneNumberOutput, crate::operation::request_phone_number::RequestPhoneNumberError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_request_phone_number::de_request_phone_number_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::request_phone_number::RequestPhoneNumberError {
...
mod _request_phone_number_output;
