...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_query_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_query::CancelQueryOutput, crate::operation::cancel_query::CancelQueryError> {
    Ok({
        #[allow(unused_mut)]
