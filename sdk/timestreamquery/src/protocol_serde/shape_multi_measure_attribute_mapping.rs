...
pub(crate) fn de_multi_measure_attribute_mapping<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MultiMeasureAttributeMapping>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "MeasureValueType" => {
                                builder = builder.set_measure_value_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ScalarMeasureValueType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
