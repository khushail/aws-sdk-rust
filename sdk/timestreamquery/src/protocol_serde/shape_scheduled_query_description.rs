...
pub(crate) fn de_scheduled_query_description<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ScheduledQueryDescription>, ::aws_smithy_json::deserialize::error::DeserializeError>
