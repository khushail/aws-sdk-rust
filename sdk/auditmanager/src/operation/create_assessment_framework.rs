...
impl CreateAssessmentFrameworkInput {
    /// Consumes the builder and constructs an Operation<[`CreateAssessmentFramework`](crate::operation::create_assessment_framework::CreateAssessmentFramework)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_assessment_framework::CreateAssessmentFramework, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_assessment_framework::CreateAssessmentFrameworkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_assessment_framework::CreateAssessmentFramework::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAssessmentFramework", "auditmanager"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateAssessmentFramework`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAssessmentFramework {
                type Output = ::std::result::Result<crate::operation::create_assessment_framework::CreateAssessmentFrameworkOutput, crate::operation::create_assessment_framework::CreateAssessmentFrameworkError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_assessment_framework::de_create_assessment_framework_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_assessment_framework::de_create_assessment_framework_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_assessment_framework::CreateAssessmentFrameworkError {
...
mod _create_assessment_framework_output;
