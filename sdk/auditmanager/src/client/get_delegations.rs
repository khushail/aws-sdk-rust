...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_delegations::builders::GetDelegationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_delegations::builders::GetDelegationsFluentBuilder::set_next_token): <p> The pagination token that's used to fetch the next set of results. </p>
