...
impl UpdateIndexTypeInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_index_type::UpdateIndexType, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_index_type::UpdateIndexTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/UpdateIndexType").expect("formatting should succeed");
...
/// Orchestration and serialization glue logic for `UpdateIndexType`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIndexType {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_index_type::de_update_index_type_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_index_type::de_update_index_type_http_response_with_props(status, headers, body)
                     }
                }
