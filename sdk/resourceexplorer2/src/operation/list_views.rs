...
impl ListViewsInput {
    /// Consumes the builder and constructs an Operation<[`ListViews`](crate::operation::list_views::ListViews)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_views::ListViews, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_views::ListViewsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/ListViews").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_views::ListViews::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListViews {
                type Output = ::std::result::Result<crate::operation::list_views::ListViewsOutput, crate::operation::list_views::ListViewsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_views::de_list_views_http_response_with_props(status, headers, body)
                     }
                }
