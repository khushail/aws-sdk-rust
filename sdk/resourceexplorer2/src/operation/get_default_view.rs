...
impl GetDefaultViewInput {
    /// Consumes the builder and constructs an Operation<[`GetDefaultView`](crate::operation::get_default_view::GetDefaultView)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_default_view::GetDefaultView, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_default_view::GetDefaultViewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/GetDefaultView").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_default_view::GetDefaultViewInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_default_view::GetDefaultView::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDefaultView", "resourceexplorer2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetDefaultView`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDefaultView {
                type Output = ::std::result::Result<crate::operation::get_default_view::GetDefaultViewOutput, crate::operation::get_default_view::GetDefaultViewError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_default_view::de_get_default_view_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_default_view::de_get_default_view_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_default_view::GetDefaultViewError {
