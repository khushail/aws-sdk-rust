...
impl AssociateDefaultViewInput {
    /// Consumes the builder and constructs an Operation<[`AssociateDefaultView`](crate::operation::associate_default_view::AssociateDefaultView)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_default_view::AssociateDefaultView, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_default_view::AssociateDefaultViewInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/AssociateDefaultView").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_default_view::ser_associate_default_view_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_default_view::AssociateDefaultView::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateDefaultView", "resourceexplorer2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateDefaultView`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateDefaultView {
                type Output = ::std::result::Result<crate::operation::associate_default_view::AssociateDefaultViewOutput, crate::operation::associate_default_view::AssociateDefaultViewError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_default_view::de_associate_default_view_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_default_view::de_associate_default_view_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_default_view::AssociateDefaultViewError {
...
mod _associate_default_view_output;
