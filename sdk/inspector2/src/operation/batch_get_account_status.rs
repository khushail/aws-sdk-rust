...
impl BatchGetAccountStatusInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetAccountStatus`](crate::operation::batch_get_account_status::BatchGetAccountStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_get_account_status::BatchGetAccountStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_account_status::BatchGetAccountStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/status/batch/get").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_account_status::BatchGetAccountStatus::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchGetAccountStatus", "inspector2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchGetAccountStatus`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetAccountStatus {
                type Output = ::std::result::Result<crate::operation::batch_get_account_status::BatchGetAccountStatusOutput, crate::operation::batch_get_account_status::BatchGetAccountStatusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_batch_get_account_status::de_batch_get_account_status_http_response_with_props(status, headers, body)
                     }
                }
...
mod _batch_get_account_status_output;
