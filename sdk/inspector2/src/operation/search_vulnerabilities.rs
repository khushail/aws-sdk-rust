...
impl SearchVulnerabilitiesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_vulnerabilities::SearchVulnerabilities, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_vulnerabilities::SearchVulnerabilitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_vulnerabilities::ser_search_vulnerabilities_input(&self)?
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchVulnerabilities {
                type Output = ::std::result::Result<crate::operation::search_vulnerabilities::SearchVulnerabilitiesOutput, crate::operation::search_vulnerabilities::SearchVulnerabilitiesError>;
