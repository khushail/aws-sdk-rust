...
impl DisableDelegatedAdminAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disable_delegated_admin_account::DisableDelegatedAdminAccountInput, ::aws_smithy_http::operation::error::BuildError> {
