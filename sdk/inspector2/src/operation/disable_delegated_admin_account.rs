...
impl DisableDelegatedAdminAccountInput {
    /// Consumes the builder and constructs an Operation<[`DisableDelegatedAdminAccount`](crate::operation::disable_delegated_admin_account::DisableDelegatedAdminAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_delegated_admin_account::DisableDelegatedAdminAccount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_delegated_admin_account::DisableDelegatedAdminAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/delegatedadminaccounts/disable").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_delegated_admin_account::DisableDelegatedAdminAccount::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisableDelegatedAdminAccount", "inspector2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisableDelegatedAdminAccount`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableDelegatedAdminAccount {
                type Output = ::std::result::Result<crate::operation::disable_delegated_admin_account::DisableDelegatedAdminAccountOutput, crate::operation::disable_delegated_admin_account::DisableDelegatedAdminAccountError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_disable_delegated_admin_account::de_disable_delegated_admin_account_http_response_with_props(status, headers, body)
                     }
                }
...
mod _disable_delegated_admin_account_output;
