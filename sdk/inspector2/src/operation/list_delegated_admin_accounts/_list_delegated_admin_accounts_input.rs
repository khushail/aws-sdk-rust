...
impl ListDelegatedAdminAccountsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_delegated_admin_accounts::ListDelegatedAdminAccountsInput, ::aws_smithy_http::operation::error::BuildError> {
