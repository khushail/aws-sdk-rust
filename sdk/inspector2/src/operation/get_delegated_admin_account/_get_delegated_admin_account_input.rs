...
impl GetDelegatedAdminAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_delegated_admin_account::GetDelegatedAdminAccountInput, ::aws_smithy_http::operation::error::BuildError> {
