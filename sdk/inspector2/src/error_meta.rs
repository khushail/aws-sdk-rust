...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::search_vulnerabilities::SearchVulnerabilitiesError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
