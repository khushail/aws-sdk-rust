...
impl super::Client  {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_brokers::builders::ListBrokersFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_brokers::builders::ListBrokersFluentBuilder::set_max_results): <p>The maximum number of brokers that Amazon MQ can return per page (20 by default). This value must be an integer from 5 to 100.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_brokers::builders::ListBrokersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_brokers::builders::ListBrokersFluentBuilder::set_next_token): <p>The token that specifies the next page of results Amazon MQ should return. To request the first page, leave nextToken empty.</p>
