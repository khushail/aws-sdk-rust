...
impl super::Client  {
    ...
    ///   - [`configuration_id(impl ::std::convert::Into<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::configuration_id) / [`set_configuration_id(Option<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::set_configuration_id): <p>The unique ID that Amazon MQ generates for the configuration.</p>
    ///   - [`configuration_revision(impl ::std::convert::Into<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::configuration_revision) / [`set_configuration_revision(Option<String>)`](crate::operation::describe_configuration_revision::builders::DescribeConfigurationRevisionFluentBuilder::set_configuration_revision): <p>The revision of the configuration.</p>
