...
impl ListConfigurationRevisionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_configuration_revisions::ListConfigurationRevisionsInput, ::aws_smithy_http::operation::error::BuildError> {
