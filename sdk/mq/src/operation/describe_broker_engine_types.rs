...
impl DescribeBrokerEngineTypesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeBrokerEngineTypes`](crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/broker-engine-types").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBrokerEngineTypes {
                type Output = ::std::result::Result<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesOutput, crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_broker_engine_types::de_describe_broker_engine_types_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_broker_engine_types::de_describe_broker_engine_types_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesError {
...
mod _describe_broker_engine_types_output;
