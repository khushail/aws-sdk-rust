...
impl DescribeBrokerInstanceOptionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeBrokerInstanceOptions`](crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/broker-instance-options").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.host_instance_type {
                     {
                        query.push_kv("hostInstanceType", &::aws_smithy_http::query::fmt_string(&inner_2));
                    }
                }
                ...
                if let ::std::option::Option::Some(inner_5) = &_input.storage_type {
                     {
                        query.push_kv("storageType", &::aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                ::std::result::Result::Ok(())
            }
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeBrokerInstanceOptions {
                type Output = ::std::result::Result<crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptionsOutput, crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_broker_instance_options::de_describe_broker_instance_options_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_broker_instance_options::de_describe_broker_instance_options_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_broker_instance_options::DescribeBrokerInstanceOptionsError {
...
mod _describe_broker_instance_options_output;
