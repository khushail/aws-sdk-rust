        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_users::ListUsersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if broker_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("broker_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/v1/brokers/{BrokerId}/users", BrokerId = broker_id).expect("formatting should succeed");
