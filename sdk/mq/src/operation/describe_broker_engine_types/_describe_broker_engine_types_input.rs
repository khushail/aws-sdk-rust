...
impl DescribeBrokerEngineTypesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_broker_engine_types::DescribeBrokerEngineTypesInput, ::aws_smithy_http::operation::error::BuildError> {
