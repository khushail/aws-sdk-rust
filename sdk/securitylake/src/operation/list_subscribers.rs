...
impl ListSubscribersInput {
    /// Consumes the builder and constructs an Operation<[`ListSubscribers`](crate::operation::list_subscribers::ListSubscribers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_subscribers::ListSubscribers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_subscribers::ListSubscribersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/subscribers").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_subscribers::ListSubscribersInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_subscribers::ListSubscribers::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSubscribers {
                type Output = ::std::result::Result<crate::operation::list_subscribers::ListSubscribersOutput, crate::operation::list_subscribers::ListSubscribersError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_subscribers::ListSubscribersError {
...
impl ListSubscribersError {
    ...
    /// Returns `true` if the error kind is `ListSubscribersError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `ListSubscribersError::ConflictException`.
