...
impl DeleteDataLakeInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_data_lake::DeleteDataLake, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_data_lake::DeleteDataLakeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDataLake {
                type Output = ::std::result::Result<crate::operation::delete_data_lake::DeleteDataLakeOutput, crate::operation::delete_data_lake::DeleteDataLakeError>;
