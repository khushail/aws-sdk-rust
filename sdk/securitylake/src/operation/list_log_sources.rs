...
impl ListLogSourcesInput {
    /// Consumes the builder and constructs an Operation<[`ListLogSources`](crate::operation::list_log_sources::ListLogSources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_log_sources::ListLogSources, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_log_sources::ListLogSourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/v1/datalake/logsources/list").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_log_sources::ListLogSources::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLogSources {
                type Output = ::std::result::Result<crate::operation::list_log_sources::ListLogSourcesOutput, crate::operation::list_log_sources::ListLogSourcesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_log_sources::de_list_log_sources_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_log_sources::de_list_log_sources_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_log_sources::ListLogSourcesError {
...
impl ListLogSourcesError {
    ...
    /// Returns `true` if the error kind is `ListLogSourcesError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `ListLogSourcesError::ConflictException`.
    ...
    /// Returns `true` if the error kind is `ListLogSourcesError::ThrottlingException`.
