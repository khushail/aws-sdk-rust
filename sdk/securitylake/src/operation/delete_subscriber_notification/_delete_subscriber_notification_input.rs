...
impl DeleteSubscriberNotificationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_subscriber_notification::DeleteSubscriberNotificationInput, ::aws_smithy_http::operation::error::BuildError> {
