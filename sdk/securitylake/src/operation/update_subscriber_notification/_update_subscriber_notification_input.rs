...
impl UpdateSubscriberNotificationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_subscriber_notification::UpdateSubscriberNotificationInput, ::aws_smithy_http::operation::error::BuildError> {
