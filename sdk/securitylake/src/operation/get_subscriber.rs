...
impl GetSubscriberInput {
    /// Consumes the builder and constructs an Operation<[`GetSubscriber`](crate::operation::get_subscriber::GetSubscriber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_subscriber::GetSubscriber, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_subscriber::GetSubscriberInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_subscriber::GetSubscriberInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_subscriber::GetSubscriber::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSubscriber", "securitylake"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetSubscriber`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSubscriber {
                type Output = ::std::result::Result<crate::operation::get_subscriber::GetSubscriberOutput, crate::operation::get_subscriber::GetSubscriberError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_subscriber::de_get_subscriber_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_subscriber::de_get_subscriber_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_subscriber::GetSubscriberError {
...
impl GetSubscriberError {
    ...
    /// Returns `true` if the error kind is `GetSubscriberError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `GetSubscriberError::ConflictException`.
    ...
    /// Returns `true` if the error kind is `GetSubscriberError::ThrottlingException`.
