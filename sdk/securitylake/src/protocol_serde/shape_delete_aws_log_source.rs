...
pub fn de_delete_aws_log_source_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_aws_log_source::DeleteAwsLogSourceOutput, crate::operation::delete_aws_log_source::DeleteAwsLogSourceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_aws_log_source::DeleteAwsLogSourceError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_access_denied_exception::de_access_denied_exception_json_err(_response_body, output).map_err(crate::operation::delete_aws_log_source::DeleteAwsLogSourceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_aws_log_source_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_aws_log_source::DeleteAwsLogSourceOutput, crate::operation::delete_aws_log_source::DeleteAwsLogSourceError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_aws_log_source::builders::DeleteAwsLogSourceOutputBuilder::default();
        output = crate::protocol_serde::shape_delete_aws_log_source::de_delete_aws_log_source(_response_body, output).map_err(crate::operation::delete_aws_log_source::DeleteAwsLogSourceError::unhandled)?;
