...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_custom_log_source_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_custom_log_source::DeleteCustomLogSourceOutput, crate::operation::delete_custom_log_source::DeleteCustomLogSourceError> {
    Ok({
        #[allow(unused_mut)]
