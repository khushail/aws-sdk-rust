...
pub fn ser_resource_id(object_4: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::ResourceId) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
