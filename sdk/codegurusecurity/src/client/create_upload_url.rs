...
impl super::Client  {
    ...
    ///   - [`scan_name(impl ::std::convert::Into<String>)`](crate::operation::create_upload_url::builders::CreateUploadUrlFluentBuilder::scan_name) / [`set_scan_name(Option<String>)`](crate::operation::create_upload_url::builders::CreateUploadUrlFluentBuilder::set_scan_name): <p>The name of the scan that will use the uploaded resource. CodeGuru Security uses the unique scan name to track revisions across multiple scans of the same resource. Use this <code>scanName</code> when you call <code>CreateScan</code> on the code resource you upload to this URL.</p>
                            /// - On success, responds with [`CreateUploadUrlOutput`](crate::operation::create_upload_url::CreateUploadUrlOutput) with field(s):
    ///   - [`s3_url(Option<String>)`](crate::operation::create_upload_url::CreateUploadUrlOutput::s3_url): <p>A pre-signed S3 URL. You can upload the code file you want to scan and add the required <code>requestHeaders</code> using any HTTP client.</p>
