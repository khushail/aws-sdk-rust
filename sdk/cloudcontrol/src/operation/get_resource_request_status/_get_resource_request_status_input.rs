...
impl GetResourceRequestStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_resource_request_status::GetResourceRequestStatusInput, ::aws_smithy_http::operation::error::BuildError> {
