...
impl super::Client  {
    ...
    ///   - [`report_name(impl ::std::convert::Into<String>)`](crate::operation::modify_report_definition::builders::ModifyReportDefinitionFluentBuilder::report_name) / [`set_report_name(Option<String>)`](crate::operation::modify_report_definition::builders::ModifyReportDefinitionFluentBuilder::set_report_name): <p>The name of the report that you want to create. The name must be unique, is case sensitive, and can't include spaces. </p>
