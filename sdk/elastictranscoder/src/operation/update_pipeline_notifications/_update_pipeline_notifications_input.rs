...
impl UpdatePipelineNotificationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_pipeline_notifications::UpdatePipelineNotificationsInput, ::aws_smithy_http::operation::error::BuildError> {
