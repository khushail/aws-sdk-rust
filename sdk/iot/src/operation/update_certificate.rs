...
impl UpdateCertificateInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_certificate::UpdateCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_certificate::UpdateCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::update_certificate::UpdateCertificateInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_2 = &_input.new_status;
                let inner_2 = inner_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("new_status", "cannot be empty or unset"))?;
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_certificate::UpdateCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateCertificate", "iot"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateCertificate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCertificate {
                type Output = ::std::result::Result<crate::operation::update_certificate::UpdateCertificateOutput, crate::operation::update_certificate::UpdateCertificateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_certificate::de_update_certificate_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_certificate::UpdateCertificateError {
