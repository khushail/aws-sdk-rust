...
impl ListThingRegistrationTasksInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_thing_registration_tasks::ListThingRegistrationTasksInput, ::aws_smithy_http::operation::error::BuildError> {
