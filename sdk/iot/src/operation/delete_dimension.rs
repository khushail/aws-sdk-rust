...
impl DeleteDimensionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDimension`](crate::operation::delete_dimension::DeleteDimension)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_dimension::DeleteDimension, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_dimension::DeleteDimensionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_dimension::DeleteDimension::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDimension", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDimension {
                type Output = ::std::result::Result<crate::operation::delete_dimension::DeleteDimensionOutput, crate::operation::delete_dimension::DeleteDimensionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_dimension::de_delete_dimension_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteDimensionErrorKind = DeleteDimensionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_dimension::DeleteDimensionError {
...
impl DeleteDimensionError {
    /// Creates the `DeleteDimensionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteDimensionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteDimensionError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DeleteDimensionError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteDimensionError::ThrottlingException`.
