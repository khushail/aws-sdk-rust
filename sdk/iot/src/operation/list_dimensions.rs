...
impl ListDimensionsInput {
    /// Consumes the builder and constructs an Operation<[`ListDimensions`](crate::operation::list_dimensions::ListDimensions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_dimensions::ListDimensions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_dimensions::ListDimensionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/dimensions").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_dimensions::ListDimensionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_dimensions::ListDimensions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDimensions", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDimensions {
                type Output = ::std::result::Result<crate::operation::list_dimensions::ListDimensionsOutput, crate::operation::list_dimensions::ListDimensionsError>;
...
/// Do not use this.
            ...
            pub type ListDimensionsErrorKind = ListDimensionsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_dimensions::ListDimensionsError {
...
impl ListDimensionsError {
    /// Creates the `ListDimensionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDimensionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListDimensionsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ListDimensionsError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListDimensionsError::ThrottlingException`.
