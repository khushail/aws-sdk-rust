...
impl UpdateTopicRuleDestinationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_topic_rule_destination::UpdateTopicRuleDestinationInput, ::aws_smithy_http::operation::error::BuildError> {
