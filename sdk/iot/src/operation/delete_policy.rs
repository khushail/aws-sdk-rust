...
impl DeletePolicyInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_policy::DeletePolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_policy::DeletePolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_policy::DeletePolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeletePolicy", "iot"));
...
impl DeletePolicyError {
    ...
    /// Returns `true` if the error kind is `DeletePolicyError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyError::InvalidRequestException`.
    ...
    /// Returns `true` if the error kind is `DeletePolicyError::ServiceUnavailableException`.
    ...
    /// Returns `true` if the error kind is `DeletePolicyError::UnauthorizedException`.
