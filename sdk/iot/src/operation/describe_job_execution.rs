...
impl DescribeJobExecutionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_job_execution::DescribeJobExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_job_execution::DescribeJobExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_job_execution::DescribeJobExecutionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                if let ::std::option::Option::Some(inner_3) = &_input.execution_number {
                    if *inner_3 != 0 {
                        query.push_kv("executionNumber", ::aws_smithy_types::primitive::Encoder::from(*inner_3).encode());
                    }
                }
                ::std::result::Result::Ok(())
            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_job_execution::DescribeJobExecution::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeJobExecution", "iot"));
