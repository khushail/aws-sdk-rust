...
impl UpdateEventConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateEventConfigurations`](crate::operation::update_event_configurations::UpdateEventConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_event_configurations::UpdateEventConfigurations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_event_configurations::UpdateEventConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/event-configurations").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_event_configurations::ser_update_event_configurations_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_event_configurations::UpdateEventConfigurations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateEventConfigurations", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEventConfigurations {
                type Output = ::std::result::Result<crate::operation::update_event_configurations::UpdateEventConfigurationsOutput, crate::operation::update_event_configurations::UpdateEventConfigurationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_event_configurations::de_update_event_configurations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_event_configurations::de_update_event_configurations_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateEventConfigurationsErrorKind = UpdateEventConfigurationsError;
/// Error type for the `UpdateEventConfigurationsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateEventConfigurationsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_event_configurations::UpdateEventConfigurationsError {
...
impl UpdateEventConfigurationsError {
    /// Creates the `UpdateEventConfigurationsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateEventConfigurationsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateEventConfigurationsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `UpdateEventConfigurationsError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateEventConfigurationsError::ThrottlingException`.
...
mod _update_event_configurations_output;
