...
impl CreateTopicRuleDestinationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_topic_rule_destination::CreateTopicRuleDestinationInput, ::aws_smithy_http::operation::error::BuildError> {
