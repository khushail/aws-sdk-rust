...
impl ListDomainConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_domain_configurations::ListDomainConfigurationsInput, ::aws_smithy_http::operation::error::BuildError> {
