...
impl DeleteDynamicThingGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_dynamic_thing_group::DeleteDynamicThingGroupInput, ::aws_smithy_http::operation::error::BuildError> {
