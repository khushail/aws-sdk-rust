...
impl DeleteDomainConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_domain_configuration::DeleteDomainConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
