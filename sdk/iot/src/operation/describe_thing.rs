...
impl DescribeThingInput {
    /// Consumes the builder and constructs an Operation<[`DescribeThing`](crate::operation::describe_thing::DescribeThing)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_thing::DescribeThing, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_thing::DescribeThingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_thing::DescribeThingInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_thing::DescribeThing::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeThing", "iot"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeThing`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeThing {
                type Output = ::std::result::Result<crate::operation::describe_thing::DescribeThingOutput, crate::operation::describe_thing::DescribeThingError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_thing::de_describe_thing_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_thing::de_describe_thing_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeThingErrorKind = DescribeThingError;
/// Error type for the `DescribeThingError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeThingError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_thing::DescribeThingError {
...
impl DescribeThingError {
    /// Creates the `DescribeThingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeThingError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeThingError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DescribeThingError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DescribeThingError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeThingError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `DescribeThingError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `DescribeThingError::UnauthorizedException`.
