...
impl DescribeDomainConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_domain_configuration::DescribeDomainConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
