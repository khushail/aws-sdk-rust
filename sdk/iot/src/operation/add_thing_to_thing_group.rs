...
impl AddThingToThingGroupInput {
    /// Consumes the builder and constructs an Operation<[`AddThingToThingGroup`](crate::operation::add_thing_to_thing_group::AddThingToThingGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::add_thing_to_thing_group::AddThingToThingGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_thing_to_thing_group::AddThingToThingGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/thing-groups/addThingToThingGroup").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_add_thing_to_thing_group::ser_add_thing_to_thing_group_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_thing_to_thing_group::AddThingToThingGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AddThingToThingGroup", "iot"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AddThingToThingGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddThingToThingGroup {
                type Output = ::std::result::Result<crate::operation::add_thing_to_thing_group::AddThingToThingGroupOutput, crate::operation::add_thing_to_thing_group::AddThingToThingGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_add_thing_to_thing_group::de_add_thing_to_thing_group_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type AddThingToThingGroupErrorKind = AddThingToThingGroupError;
/// Error type for the `AddThingToThingGroupError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AddThingToThingGroupError {
...
impl AddThingToThingGroupError {
    /// Creates the `AddThingToThingGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AddThingToThingGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `AddThingToThingGroupError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `AddThingToThingGroupError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `AddThingToThingGroupError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `AddThingToThingGroupError::ThrottlingException`.
...
mod _add_thing_to_thing_group_output;
