...
impl GetStatisticsInput {
    /// Consumes the builder and constructs an Operation<[`GetStatistics`](crate::operation::get_statistics::GetStatistics)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_statistics::GetStatistics, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_statistics::GetStatisticsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/indices/statistics").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_statistics::ser_get_statistics_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_statistics::GetStatistics::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetStatistics", "iot"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetStatistics`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStatistics {
                type Output = ::std::result::Result<crate::operation::get_statistics::GetStatisticsOutput, crate::operation::get_statistics::GetStatisticsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_statistics::de_get_statistics_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_statistics::de_get_statistics_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetStatisticsErrorKind = GetStatisticsError;
/// Error type for the `GetStatisticsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetStatisticsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_statistics::GetStatisticsError {
...
impl GetStatisticsError {
    /// Creates the `GetStatisticsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetStatisticsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetStatisticsError::IndexNotReadyException`.
    pub fn is_index_not_ready_exception(&self) -> bool {
        matches!(self, Self::IndexNotReadyException(_))
    }
    /// Returns `true` if the error kind is `GetStatisticsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `GetStatisticsError::InvalidAggregationException`.
    pub fn is_invalid_aggregation_exception(&self) -> bool {
        matches!(self, Self::InvalidAggregationException(_))
    }
    /// Returns `true` if the error kind is `GetStatisticsError::InvalidQueryException`.
    pub fn is_invalid_query_exception(&self) -> bool {
        matches!(self, Self::InvalidQueryException(_))
    }
    /// Returns `true` if the error kind is `GetStatisticsError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `GetStatisticsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetStatisticsError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `GetStatisticsError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `GetStatisticsError::UnauthorizedException`.
...
pub use crate::operation::get_statistics::_get_statistics_output::GetStatisticsOutput;

pub use crate::operation::get_statistics::_get_statistics_input::GetStatisticsInput;

mod _get_statistics_input;

mod _get_statistics_output;
