...
impl ListPolicyVersionsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_policy_versions::ListPolicyVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_policy_versions::ListPolicyVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_policy_versions::ListPolicyVersions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPolicyVersions", "iot"));
...
impl ListPolicyVersionsError {
    ...
    /// Returns `true` if the error kind is `ListPolicyVersionsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ListPolicyVersionsError::InvalidRequestException`.
    ...
    /// Returns `true` if the error kind is `ListPolicyVersionsError::ServiceUnavailableException`.
    ...
    /// Returns `true` if the error kind is `ListPolicyVersionsError::UnauthorizedException`.
