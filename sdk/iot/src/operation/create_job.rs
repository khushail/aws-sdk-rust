...
impl CreateJobInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_job::CreateJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_job::CreateJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateJob", "iot"));
...
impl CreateJobError {
    ...
    /// Returns `true` if the error kind is `CreateJobError::InvalidRequestException`.
    ...
    /// Returns `true` if the error kind is `CreateJobError::ResourceAlreadyExistsException`.
    ...
    /// Returns `true` if the error kind is `CreateJobError::ServiceUnavailableException`.
