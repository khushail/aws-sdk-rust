...
impl CreateDomainConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_domain_configuration::CreateDomainConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
