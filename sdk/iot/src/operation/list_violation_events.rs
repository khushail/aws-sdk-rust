...
impl ListViolationEventsInput {
    /// Consumes the builder and constructs an Operation<[`ListViolationEvents`](crate::operation::list_violation_events::ListViolationEvents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_violation_events::ListViolationEvents, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_violation_events::ListViolationEventsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/violation-events").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_violation_events::ListViolationEventsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_4) = &_input.security_profile_name {
                     {
                        query.push_kv("securityProfileName", &::aws_smithy_http::query::fmt_string(&inner_4));
                    }
                }
                if let ::std::option::Option::Some(inner_5) = &_input.behavior_criteria_type {
                     {
                        query.push_kv("behaviorCriteriaType", &::aws_smithy_http::query::fmt_string(&inner_5));
                    }
                }
                ...
                if let ::std::option::Option::Some(inner_7) = &_input.verification_state {
                     {
                        query.push_kv("verificationState", &::aws_smithy_http::query::fmt_string(&inner_7));
                    }
                }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_violation_events::ListViolationEvents::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListViolationEvents", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListViolationEvents {
                type Output = ::std::result::Result<crate::operation::list_violation_events::ListViolationEventsOutput, crate::operation::list_violation_events::ListViolationEventsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_violation_events::de_list_violation_events_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_violation_events::de_list_violation_events_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListViolationEventsErrorKind = ListViolationEventsError;
/// Error type for the `ListViolationEventsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListViolationEventsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_violation_events::ListViolationEventsError {
...
impl ListViolationEventsError {
    /// Creates the `ListViolationEventsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListViolationEventsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListViolationEventsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ListViolationEventsError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListViolationEventsError::ThrottlingException`.
...
mod _list_violation_events_output;
