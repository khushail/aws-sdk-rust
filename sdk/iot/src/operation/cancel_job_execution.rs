...
impl CancelJobExecutionInput {
    /// Consumes the builder and constructs an Operation<[`CancelJobExecution`](crate::operation::cancel_job_execution::CancelJobExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_job_execution::CancelJobExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_job_execution::CancelJobExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/things/{thingName}/jobs/{jobId}/cancel", thingName = thing_name, jobId = job_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::cancel_job_execution::CancelJobExecutionInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_job_execution::ser_cancel_job_execution_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_job_execution::CancelJobExecution::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelJobExecution", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelJobExecution {
                type Output = ::std::result::Result<crate::operation::cancel_job_execution::CancelJobExecutionOutput, crate::operation::cancel_job_execution::CancelJobExecutionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_cancel_job_execution::de_cancel_job_execution_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CancelJobExecutionErrorKind = CancelJobExecutionError;
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_job_execution::CancelJobExecutionError {
...
impl CancelJobExecutionError {
    /// Creates the `CancelJobExecutionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelJobExecutionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
