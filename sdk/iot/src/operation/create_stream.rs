...
impl CreateStreamInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_stream::CreateStream, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_stream::CreateStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_stream::CreateStream::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateStream", "iot"));
...
impl CreateStreamError {
    ...
    /// Returns `true` if the error kind is `CreateStreamError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `CreateStreamError::InvalidRequestException`.
    ...
    /// Returns `true` if the error kind is `CreateStreamError::ResourceAlreadyExistsException`.
    ...
    /// Returns `true` if the error kind is `CreateStreamError::ServiceUnavailableException`.
    ...
    /// Returns `true` if the error kind is `CreateStreamError::UnauthorizedException`.
