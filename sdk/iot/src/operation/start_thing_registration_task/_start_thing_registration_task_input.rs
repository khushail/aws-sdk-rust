...
impl StartThingRegistrationTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_thing_registration_task::StartThingRegistrationTaskInput, ::aws_smithy_http::operation::error::BuildError> {
