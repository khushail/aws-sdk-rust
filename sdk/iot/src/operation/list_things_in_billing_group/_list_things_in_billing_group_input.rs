...
impl ListThingsInBillingGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_things_in_billing_group::ListThingsInBillingGroupInput, ::aws_smithy_http::operation::error::BuildError> {
