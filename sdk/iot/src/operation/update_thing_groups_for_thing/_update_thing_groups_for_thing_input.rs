...
impl UpdateThingGroupsForThingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_thing_groups_for_thing::UpdateThingGroupsForThingInput, ::aws_smithy_http::operation::error::BuildError> {
