...
impl CreateDynamicThingGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_dynamic_thing_group::CreateDynamicThingGroupInput, ::aws_smithy_http::operation::error::BuildError> {
