...
impl UpdatePackageConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_package_configuration::UpdatePackageConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
