...
pub use crate::operation::describe_scheduled_audit::_describe_scheduled_audit_output::DescribeScheduledAuditOutputBuilder;

pub use crate::operation::describe_scheduled_audit::_describe_scheduled_audit_input::DescribeScheduledAuditInputBuilder;
...
impl DescribeScheduledAuditInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.describe_scheduled_audit();
...
pub struct DescribeScheduledAuditFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::describe_scheduled_audit::builders::DescribeScheduledAuditInputBuilder,
}
impl DescribeScheduledAuditFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::describe_scheduled_audit::DescribeScheduledAudit, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::describe_scheduled_audit::DescribeScheduledAuditOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_scheduled_audit::DescribeScheduledAuditError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::describe_scheduled_audit::DescribeScheduledAuditOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_scheduled_audit::DescribeScheduledAuditError>>
                             {
