...
impl CancelAuditTaskInput {
    /// Consumes the builder and constructs an Operation<[`CancelAuditTask`](crate::operation::cancel_audit_task::CancelAuditTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_audit_task::CancelAuditTask, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_audit_task::CancelAuditTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/audit/tasks/{taskId}/cancel", taskId = task_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::cancel_audit_task::CancelAuditTaskInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_audit_task::CancelAuditTask::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelAuditTask", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelAuditTask {
                type Output = ::std::result::Result<crate::operation::cancel_audit_task::CancelAuditTaskOutput, crate::operation::cancel_audit_task::CancelAuditTaskError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_cancel_audit_task::de_cancel_audit_task_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CancelAuditTaskErrorKind = CancelAuditTaskError;
/// Error type for the `CancelAuditTaskError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CancelAuditTaskError {
...
impl CancelAuditTaskError {
    /// Creates the `CancelAuditTaskError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelAuditTaskError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CancelAuditTaskError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `CancelAuditTaskError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CancelAuditTaskError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CancelAuditTaskError::ThrottlingException`.
