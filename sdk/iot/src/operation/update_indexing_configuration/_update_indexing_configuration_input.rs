...
impl UpdateIndexingConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_indexing_configuration::UpdateIndexingConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
