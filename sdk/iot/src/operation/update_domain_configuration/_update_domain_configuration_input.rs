...
impl UpdateDomainConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_domain_configuration::UpdateDomainConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
