...
impl RemoveThingFromThingGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_thing_from_thing_group::RemoveThingFromThingGroupInput, ::aws_smithy_http::operation::error::BuildError> {
