...
impl SearchIndexInput {
    /// Consumes the builder and constructs an Operation<[`SearchIndex`](crate::operation::search_index::SearchIndex)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_index::SearchIndex, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_index::SearchIndexInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/indices/search").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::search_index::SearchIndexInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_index::ser_search_index_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_index::SearchIndex::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchIndex", "iot"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SearchIndex`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchIndex {
                type Output = ::std::result::Result<crate::operation::search_index::SearchIndexOutput, crate::operation::search_index::SearchIndexError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_search_index::de_search_index_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_search_index::de_search_index_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type SearchIndexErrorKind = SearchIndexError;
/// Error type for the `SearchIndexError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SearchIndexError {
...
impl ::aws_http::request_id::RequestId for crate::operation::search_index::SearchIndexError {
...
impl SearchIndexError {
    /// Creates the `SearchIndexError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchIndexError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `SearchIndexError::IndexNotReadyException`.
    pub fn is_index_not_ready_exception(&self) -> bool {
        matches!(self, Self::IndexNotReadyException(_))
    }
    /// Returns `true` if the error kind is `SearchIndexError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `SearchIndexError::InvalidQueryException`.
    pub fn is_invalid_query_exception(&self) -> bool {
        matches!(self, Self::InvalidQueryException(_))
    }
    /// Returns `true` if the error kind is `SearchIndexError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `SearchIndexError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `SearchIndexError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `SearchIndexError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `SearchIndexError::UnauthorizedException`.
