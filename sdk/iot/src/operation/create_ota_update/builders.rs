...
impl CreateOTAUpdateFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::create_ota_update::CreateOtaUpdateOutput, ::aws_smithy_http::result::SdkError<crate::operation::create_ota_update::CreateOTAUpdateError>>
                         {
    ...
    pub fn additional_parameters(mut self, k: impl ::std::convert::Into<::std::string::String>, v: impl ::std::convert::Into<::std::string::String>) -> Self {
