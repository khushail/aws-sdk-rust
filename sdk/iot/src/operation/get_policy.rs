...
impl GetPolicyInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_policy::GetPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_policy::GetPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_policy::GetPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetPolicy", "iot"));
...
impl GetPolicyError {
    ...
    /// Returns `true` if the error kind is `GetPolicyError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyError::InvalidRequestException`.
    ...
    /// Returns `true` if the error kind is `GetPolicyError::ServiceUnavailableException`.
    ...
    /// Returns `true` if the error kind is `GetPolicyError::UnauthorizedException`.
