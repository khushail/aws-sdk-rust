...
impl ListManagedJobTemplatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_managed_job_templates::ListManagedJobTemplatesInput, ::aws_smithy_http::operation::error::BuildError> {
