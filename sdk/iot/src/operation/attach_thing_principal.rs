...
impl AttachThingPrincipalInput {
    /// Consumes the builder and constructs an Operation<[`AttachThingPrincipal`](crate::operation::attach_thing_principal::AttachThingPrincipal)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::attach_thing_principal::AttachThingPrincipal, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_thing_principal::AttachThingPrincipalInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_thing_principal::AttachThingPrincipal::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AttachThingPrincipal", "iot"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachThingPrincipal {
                type Output = ::std::result::Result<crate::operation::attach_thing_principal::AttachThingPrincipalOutput, crate::operation::attach_thing_principal::AttachThingPrincipalError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_attach_thing_principal::de_attach_thing_principal_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_attach_thing_principal::de_attach_thing_principal_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type AttachThingPrincipalErrorKind = AttachThingPrincipalError;
/// Error type for the `AttachThingPrincipalError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AttachThingPrincipalError {
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_thing_principal::AttachThingPrincipalError {
...
impl AttachThingPrincipalError {
    /// Creates the `AttachThingPrincipalError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AttachThingPrincipalError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `AttachThingPrincipalError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `AttachThingPrincipalError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `AttachThingPrincipalError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `AttachThingPrincipalError::ServiceUnavailableException`.
    pub fn is_service_unavailable_exception(&self) -> bool {
        matches!(self, Self::ServiceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `AttachThingPrincipalError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `AttachThingPrincipalError::UnauthorizedException`.
...
mod _attach_thing_principal_output;
