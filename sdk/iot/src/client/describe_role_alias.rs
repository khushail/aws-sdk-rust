...
impl super::Client  {
    ...
    ///   - [`role_alias(impl ::std::convert::Into<String>)`](crate::operation::describe_role_alias::builders::DescribeRoleAliasFluentBuilder::role_alias) / [`set_role_alias(Option<String>)`](crate::operation::describe_role_alias::builders::DescribeRoleAliasFluentBuilder::set_role_alias): <p>The role alias to describe.</p>
