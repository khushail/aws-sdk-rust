...
impl super::Client  {
    ...
    ///   - [`ota_update_id(impl ::std::convert::Into<String>)`](crate::operation::delete_ota_update::builders::DeleteOTAUpdateFluentBuilder::ota_update_id) / [`set_ota_update_id(Option<String>)`](crate::operation::delete_ota_update::builders::DeleteOTAUpdateFluentBuilder::set_ota_update_id): <p>The ID of the OTA update to delete.</p>
    ///   - [`delete_stream(bool)`](crate::operation::delete_ota_update::builders::DeleteOTAUpdateFluentBuilder::delete_stream) / [`set_delete_stream(Option<bool>)`](crate::operation::delete_ota_update::builders::DeleteOTAUpdateFluentBuilder::set_delete_stream): <p>When true, the stream created by the OTAUpdate process is deleted when the OTA update is deleted. Ignored if the stream specified in the OTAUpdate is supplied by the user.</p>
