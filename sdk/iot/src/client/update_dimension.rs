...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_dimension::builders::UpdateDimensionFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_dimension::builders::UpdateDimensionFluentBuilder::set_name): <p>A unique identifier for the dimension. Choose something that describes the type and value to make it easy to remember what it does.</p>
