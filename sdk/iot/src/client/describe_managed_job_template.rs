...
impl super::Client  {
    ...
    ///   - [`template_name(impl ::std::convert::Into<String>)`](crate::operation::describe_managed_job_template::builders::DescribeManagedJobTemplateFluentBuilder::template_name) / [`set_template_name(Option<String>)`](crate::operation::describe_managed_job_template::builders::DescribeManagedJobTemplateFluentBuilder::set_template_name): <p>The unique name of a managed job template, which is required.</p>
    ///   - [`template_version(impl ::std::convert::Into<String>)`](crate::operation::describe_managed_job_template::builders::DescribeManagedJobTemplateFluentBuilder::template_version) / [`set_template_version(Option<String>)`](crate::operation::describe_managed_job_template::builders::DescribeManagedJobTemplateFluentBuilder::set_template_version): <p>An optional parameter to specify version of a managed template. If not specified, the pre-defined default version is returned.</p>
