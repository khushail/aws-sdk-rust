...
impl super::Client  {
    ...
    ///   - [`package_name(impl ::std::convert::Into<String>)`](crate::operation::get_package::builders::GetPackageFluentBuilder::package_name) / [`set_package_name(Option<String>)`](crate::operation::get_package::builders::GetPackageFluentBuilder::set_package_name): <p>The name of the target package.</p>
                            /// - On success, responds with [`GetPackageOutput`](crate::operation::get_package::GetPackageOutput) with field(s):
    ///   - [`package_name(Option<String>)`](crate::operation::get_package::GetPackageOutput::package_name): <p>The name of the package.</p>
