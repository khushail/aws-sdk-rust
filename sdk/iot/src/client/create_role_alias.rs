...
impl super::Client  {
    ...
    ///   - [`role_alias(impl ::std::convert::Into<String>)`](crate::operation::create_role_alias::builders::CreateRoleAliasFluentBuilder::role_alias) / [`set_role_alias(Option<String>)`](crate::operation::create_role_alias::builders::CreateRoleAliasFluentBuilder::set_role_alias): <p>The role alias that points to a role ARN. This allows you to change the role without having to update the device.</p>
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::create_role_alias::builders::CreateRoleAliasFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::create_role_alias::builders::CreateRoleAliasFluentBuilder::set_role_arn): <p>The role ARN.</p>
