...
impl super::Client  {
    ...
    ///   - [`metric_name(impl ::std::convert::Into<String>)`](crate::operation::delete_fleet_metric::builders::DeleteFleetMetricFluentBuilder::metric_name) / [`set_metric_name(Option<String>)`](crate::operation::delete_fleet_metric::builders::DeleteFleetMetricFluentBuilder::set_metric_name): <p>The name of the fleet metric to delete.</p>
