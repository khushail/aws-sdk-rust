...
impl super::Client  {
    ...
    ///   - [`task_id(impl ::std::convert::Into<String>)`](crate::operation::list_thing_registration_task_reports::builders::ListThingRegistrationTaskReportsFluentBuilder::task_id) / [`set_task_id(Option<String>)`](crate::operation::list_thing_registration_task_reports::builders::ListThingRegistrationTaskReportsFluentBuilder::set_task_id): <p>The id of the task.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_thing_registration_task_reports::builders::ListThingRegistrationTaskReportsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_thing_registration_task_reports::builders::ListThingRegistrationTaskReportsFluentBuilder::set_next_token): <p>To retrieve the next set of results, the <code>nextToken</code> value from a previous response; otherwise <b>null</b> to receive the first set of results.</p>
