...
impl super::Client  {
    ...
    ///   - [`index_name(impl ::std::convert::Into<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::index_name) / [`set_index_name(Option<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::set_index_name): <p>The name of the index to search.</p>
    ///   - [`query_string(impl ::std::convert::Into<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::query_string) / [`set_query_string(Option<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::set_query_string): <p>The search query string.</p>
    ///   - [`aggregation_field(impl ::std::convert::Into<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::aggregation_field) / [`set_aggregation_field(Option<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::set_aggregation_field): <p>The aggregation field.</p>
    ///   - [`query_version(impl ::std::convert::Into<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::query_version) / [`set_query_version(Option<String>)`](crate::operation::get_buckets_aggregation::builders::GetBucketsAggregationFluentBuilder::set_query_version): <p>The version of the query.</p>
