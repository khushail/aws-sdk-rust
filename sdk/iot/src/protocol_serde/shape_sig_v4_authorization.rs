...
pub(crate) fn de_sig_v4_authorization<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SigV4Authorization>, ::aws_smithy_json::deserialize::error::DeserializeError>
