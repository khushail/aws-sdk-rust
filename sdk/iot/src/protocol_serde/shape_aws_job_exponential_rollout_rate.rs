...
pub fn ser_aws_job_exponential_rollout_rate(
...
pub(crate) fn de_aws_job_exponential_rollout_rate<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsJobExponentialRolloutRate>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::AwsJobExponentialRolloutRateBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "rateIncreaseCriteria" => {
                                builder = builder.set_rate_increase_criteria(
                                    crate::protocol_serde::shape_aws_job_rate_increase_criteria::de_aws_job_rate_increase_criteria(tokens)?
                                );
                            }
