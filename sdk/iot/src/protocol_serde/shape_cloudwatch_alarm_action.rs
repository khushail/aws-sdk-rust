...
pub(crate) fn de_cloudwatch_alarm_action<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CloudwatchAlarmAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
