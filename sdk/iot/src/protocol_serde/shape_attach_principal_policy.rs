...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_principal_policy_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_principal_policy::AttachPrincipalPolicyOutput, crate::operation::attach_principal_policy::AttachPrincipalPolicyError> {
    Ok({
        #[allow(unused_mut)]
