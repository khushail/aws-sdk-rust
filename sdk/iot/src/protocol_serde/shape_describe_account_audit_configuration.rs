...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_account_audit_configuration_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_account_audit_configuration::DescribeAccountAuditConfigurationOutput, crate::operation::describe_account_audit_configuration::DescribeAccountAuditConfigurationError> {
    Ok({
        #[allow(unused_mut)]
