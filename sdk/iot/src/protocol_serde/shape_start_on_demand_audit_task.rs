...
#[allow(clippy::unnecessary_wraps)]
pub fn de_start_on_demand_audit_task_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::start_on_demand_audit_task::StartOnDemandAuditTaskOutput, crate::operation::start_on_demand_audit_task::StartOnDemandAuditTaskError> {
    Ok({
        #[allow(unused_mut)]
