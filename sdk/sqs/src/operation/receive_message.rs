...
impl ReceiveMessageInput {
    /// Consumes the builder and constructs an Operation<[`ReceiveMessage`](crate::operation::receive_message::ReceiveMessage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::receive_message::ReceiveMessage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::receive_message::ReceiveMessageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_receive_message_input::ser_receive_message_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::receive_message::ReceiveMessage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ReceiveMessage", "sqs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReceiveMessage {
                type Output = ::std::result::Result<crate::operation::receive_message::ReceiveMessageOutput, crate::operation::receive_message::ReceiveMessageError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::receive_message::ReceiveMessageError {
