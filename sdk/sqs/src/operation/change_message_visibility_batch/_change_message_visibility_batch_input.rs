...
impl ChangeMessageVisibilityBatchInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::change_message_visibility_batch::ChangeMessageVisibilityBatchInput, ::aws_smithy_http::operation::error::BuildError> {
