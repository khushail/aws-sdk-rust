...
impl DeleteMessageBatchInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMessageBatch`](crate::operation::delete_message_batch::DeleteMessageBatch)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_message_batch::DeleteMessageBatch, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_message_batch::DeleteMessageBatchInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_message_batch_input::ser_delete_message_batch_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_message_batch::DeleteMessageBatch::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteMessageBatch", "sqs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMessageBatch {
                type Output = ::std::result::Result<crate::operation::delete_message_batch::DeleteMessageBatchOutput, crate::operation::delete_message_batch::DeleteMessageBatchError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_message_batch::de_delete_message_batch_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_message_batch::DeleteMessageBatchError {
