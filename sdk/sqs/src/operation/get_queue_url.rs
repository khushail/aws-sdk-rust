...
impl GetQueueUrlInput {
    /// Consumes the builder and constructs an Operation<[`GetQueueUrl`](crate::operation::get_queue_url::GetQueueUrl)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_queue_url::GetQueueUrl, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_queue_url::GetQueueUrlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_queue_url_input::ser_get_queue_url_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_queue_url::GetQueueUrl::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetQueueUrl", "sqs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetQueueUrl {
                type Output = ::std::result::Result<crate::operation::get_queue_url::GetQueueUrlOutput, crate::operation::get_queue_url::GetQueueUrlError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_queue_url::de_get_queue_url_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_queue_url::GetQueueUrlError {
