...
impl PurgeQueueInput {
    /// Consumes the builder and constructs an Operation<[`PurgeQueue`](crate::operation::purge_queue::PurgeQueue)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::purge_queue::PurgeQueue, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::purge_queue::PurgeQueueInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_purge_queue_input::ser_purge_queue_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::purge_queue::PurgeQueue::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PurgeQueue", "sqs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PurgeQueue {
                type Output = ::std::result::Result<crate::operation::purge_queue::PurgeQueueOutput, crate::operation::purge_queue::PurgeQueueError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_purge_queue::de_purge_queue_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::purge_queue::PurgeQueueError {
