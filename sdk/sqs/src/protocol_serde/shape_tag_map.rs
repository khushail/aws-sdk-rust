...
pub fn de_tag_map_entry(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder, out: &mut ::std::collections::HashMap<::std::string::String, ::std::string::String>) -> Result<(), ::aws_smithy_xml::decode::XmlDecodeError> {
