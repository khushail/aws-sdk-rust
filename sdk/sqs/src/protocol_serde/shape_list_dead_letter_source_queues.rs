            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_queue_does_not_exist::de_queue_does_not_exist_xml_err(_response_body, output).map_err(crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_dead_letter_source_queues_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesOutput, crate::operation::list_dead_letter_source_queues::ListDeadLetterSourceQueuesError> {
    Ok({
        #[allow(unused_mut)]
