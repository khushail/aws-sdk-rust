...
#[allow(clippy::unnecessary_wraps)]
pub fn de_purge_queue_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::purge_queue::PurgeQueueOutput, crate::operation::purge_queue::PurgeQueueError> {
    Ok({
        #[allow(unused_mut)]
