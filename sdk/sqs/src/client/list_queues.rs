...
impl super::Client  {
    ...
    ///   - [`queue_name_prefix(impl ::std::convert::Into<String>)`](crate::operation::list_queues::builders::ListQueuesFluentBuilder::queue_name_prefix) / [`set_queue_name_prefix(Option<String>)`](crate::operation::list_queues::builders::ListQueuesFluentBuilder::set_queue_name_prefix): <p>A string to use for filtering the list results. Only those queues whose name begins with the specified string are returned.</p>  <p>Queue URLs and names are case-sensitive.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_queues::builders::ListQueuesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_queues::builders::ListQueuesFluentBuilder::set_next_token): <p>Pagination token to request the next set of results.</p>
