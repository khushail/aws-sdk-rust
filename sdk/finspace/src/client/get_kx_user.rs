...
impl super::Client  {
    ...
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::get_kx_user::builders::GetKxUserFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::get_kx_user::builders::GetKxUserFluentBuilder::set_user_name): <p>A unique identifier for the user.</p>
    ///   - [`environment_id(impl ::std::convert::Into<String>)`](crate::operation::get_kx_user::builders::GetKxUserFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::get_kx_user::builders::GetKxUserFluentBuilder::set_environment_id): <p>A unique identifier for the kdb environment.</p>
