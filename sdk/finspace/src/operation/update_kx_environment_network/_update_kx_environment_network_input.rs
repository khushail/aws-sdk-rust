...
impl UpdateKxEnvironmentNetworkInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_kx_environment_network::UpdateKxEnvironmentNetworkInput, ::aws_smithy_http::operation::error::BuildError> {
