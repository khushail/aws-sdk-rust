...
impl super::Client  {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_queue::builders::UpdateQueueFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_queue::builders::UpdateQueueFluentBuilder::set_description): The new description for the queue, if you are changing it.
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_queue::builders::UpdateQueueFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_queue::builders::UpdateQueueFluentBuilder::set_name): The name of the queue that you are modifying.
