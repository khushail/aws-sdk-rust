...
pub fn ser_m3u8_settings(
    ...
    if let Some(var_16) = &input.scte35_pid {
        object.key("scte35Pid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    ...
    if let Some(var_19) = &input.timed_metadata_pid {
        object.key("timedMetadataPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_19).into()));
    }
    if let Some(var_20) = &input.transport_stream_id {
        object.key("transportStreamId").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
    if let Some(var_21) = &input.video_pid {
        object.key("videoPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_21).into()));
    }
    Ok(())
}
