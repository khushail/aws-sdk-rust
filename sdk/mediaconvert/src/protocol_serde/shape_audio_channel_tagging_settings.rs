...
pub(crate) fn de_audio_channel_tagging_settings<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AudioChannelTaggingSettings>, ::aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_channel_tag(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AudioChannelTag::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
