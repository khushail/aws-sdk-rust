...
pub fn ser_color_corrector(
    ...
    if let Some(var_1) = &input.brightness {
        object.key("brightness").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    ...
    if let Some(var_5) = &input.contrast {
        object.key("contrast").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    ...
    if let Some(var_9) = &input.hue {
        object.key("hue").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    ...
    if let Some(var_11) = &input.saturation {
        object.key("saturation").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    if let Some(var_12) = &input.sdr_reference_white_level {
        object.key("sdrReferenceWhiteLevel").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_12).into()));
    }
    Ok(())
}
