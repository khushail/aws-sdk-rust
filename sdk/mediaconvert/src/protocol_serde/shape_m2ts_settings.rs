...
pub fn ser_m2ts_settings(
    ...
    if let Some(var_40) = &input.scte35_pid {
        object.key("scte35Pid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_40).into()));
    }
    ...
    if let Some(var_44) = &input.segmentation_time {
        object.key("segmentationTime").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_44).into()));
    }
    if let Some(var_45) = &input.timed_metadata_pid {
        object.key("timedMetadataPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_45).into()));
    }
    if let Some(var_46) = &input.transport_stream_id {
        object.key("transportStreamId").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_46).into()));
    }
    if let Some(var_47) = &input.video_pid {
        object.key("videoPid").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_47).into()));
    }
    Ok(())
}
