...
pub fn ser_input(
    ...
    if let Some(var_28) = &input.filter_strength {
        object.key("filterStrength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_28).into()));
    }
    ...
    if let Some(var_38) = &input.program_number {
        object.key("programNumber").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_38).into()));
    }
