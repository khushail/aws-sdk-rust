...
pub fn ser_ms_smooth_additional_manifest(
                     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                     input: &crate::types::MsSmoothAdditionalManifest,
...
pub(crate) fn de_ms_smooth_additional_manifest<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MsSmoothAdditionalManifest>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::MsSmoothAdditionalManifestBuilder::default();
            loop {
                match tokens.next().transpose()? {
