...
pub fn ser_dvb_sub_destination_settings(
    ...
    if let Some(var_6) = &input.dds_x_coordinate {
        object.key("ddsXCoordinate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    if let Some(var_7) = &input.dds_y_coordinate {
        object.key("ddsYCoordinate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    ...
    if let Some(var_10) = &input.font_opacity {
        object.key("fontOpacity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    if let Some(var_11) = &input.font_resolution {
        object.key("fontResolution").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    if let Some(var_12) = &input.font_script {
        object.key("fontScript").string(var_12.as_str());
    }
    if let Some(var_13) = &input.font_size {
        object.key("fontSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
    if let Some(var_14) = &input.height {
        object.key("height").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_14).into()));
    }
    ...
    if let Some(var_17) = &input.outline_size {
        object.key("outlineSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_17).into()));
    }
    if let Some(var_18) = &input.shadow_color {
        object.key("shadowColor").string(var_18.as_str());
    }
    if let Some(var_19) = &input.shadow_opacity {
        object.key("shadowOpacity").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_19).into()));
    }
    if let Some(var_20) = &input.shadow_x_offset {
        object.key("shadowXOffset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
    if let Some(var_21) = &input.shadow_y_offset {
        object.key("shadowYOffset").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_21).into()));
    }
    ...
    if let Some(var_25) = &input.width {
        object.key("width").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_25).into()));
    }
    if let Some(var_26) = &input.x_position {
        object.key("xPosition").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_26).into()));
    }
    if let Some(var_27) = &input.y_position {
        object.key("yPosition").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_27).into()));
    }
    Ok(())
}
