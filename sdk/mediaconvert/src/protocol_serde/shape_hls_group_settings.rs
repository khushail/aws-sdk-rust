...
pub fn ser_hls_group_settings(
    ...
    if let Some(var_29) = &input.min_final_segment_length {
        object.key("minFinalSegmentLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_29).into()));
    }
    if let Some(var_30) = &input.min_segment_length {
        object.key("minSegmentLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_30).into()));
    }
    ...
    if let Some(var_33) = &input.program_date_time_period {
        object.key("programDateTimePeriod").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_33).into()));
    }
    ...
    if let Some(var_35) = &input.segment_length {
        object.key("segmentLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_35).into()));
    }
    ...
    if let Some(var_37) = &input.segments_per_subdirectory {
        object.key("segmentsPerSubdirectory").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_37).into()));
    }
    ...
    if let Some(var_39) = &input.target_duration_compatibility_mode {
        object.key("targetDurationCompatibilityMode").string(var_39.as_str());
    }
    ...
    if let Some(var_41) = &input.timed_metadata_id3_period {
        object.key("timedMetadataId3Period").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_41).into()));
    }
    if let Some(var_42) = &input.timestamp_delta_milliseconds {
        object.key("timestampDeltaMilliseconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_42).into()));
    }
    Ok(())
}
