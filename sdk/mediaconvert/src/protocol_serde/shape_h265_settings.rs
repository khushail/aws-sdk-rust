...
pub fn ser_h265_settings(
    ...
    if let Some(var_3) = &input.bitrate {
        object.key("bitrate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    ...
    if let Some(var_10) = &input.framerate_denominator {
        object.key("framerateDenominator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    if let Some(var_11) = &input.framerate_numerator {
        object.key("framerateNumerator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    ...
    if let Some(var_13) = &input.gop_closed_cadence {
        object.key("gopClosedCadence").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
    if let Some(var_14) = &input.gop_size {
        object.key("gopSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_14).into()));
    }
    ...
    if let Some(var_16) = &input.hrd_buffer_final_fill_percentage {
        object.key("hrdBufferFinalFillPercentage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    if let Some(var_17) = &input.hrd_buffer_initial_fill_percentage {
        object.key("hrdBufferInitialFillPercentage").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_17).into()));
    }
    if let Some(var_18) = &input.hrd_buffer_size {
        object.key("hrdBufferSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_18).into()));
    }
    if let Some(var_19) = &input.interlace_mode {
        object.key("interlaceMode").string(var_19.as_str());
    }
    if let Some(var_20) = &input.max_bitrate {
        object.key("maxBitrate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
    if let Some(var_21) = &input.min_i_interval {
        object.key("minIInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_21).into()));
    }
    if let Some(var_22) = &input.number_b_frames_between_reference_frames {
        object.key("numberBFramesBetweenReferenceFrames").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_22).into()));
    }
    if let Some(var_23) = &input.number_reference_frames {
        object.key("numberReferenceFrames").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_23).into()));
    }
    if let Some(var_24) = &input.par_control {
        object.key("parControl").string(var_24.as_str());
    }
    if let Some(var_25) = &input.par_denominator {
        object.key("parDenominator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_25).into()));
    }
    if let Some(var_26) = &input.par_numerator {
        object.key("parNumerator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_26).into()));
    }
    ...
    if let Some(var_28) = &input.qvbr_settings {
        ...
        crate::protocol_serde::shape_h265_qvbr_settings::ser_h265_qvbr_settings(&mut object_29, var_28)?;
        object_29.finish();
    }
    ...
    if let Some(var_31) = &input.sample_adaptive_offset_filter_mode {
        object.key("sampleAdaptiveOffsetFilterMode").string(var_31.as_str());
    }
    ...
    if let Some(var_34) = &input.slices {
        object.key("slices").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_34).into()));
    }
    ...
    if let Some(var_36) = &input.spatial_adaptive_quantization {
        object.key("spatialAdaptiveQuantization").string(var_36.as_str());
    }
    ...
    if let Some(var_38) = &input.temporal_adaptive_quantization {
        object.key("temporalAdaptiveQuantization").string(var_38.as_str());
    }
    ...
    if let Some(var_41) = &input.unregistered_sei_timecode {
        object.key("unregisteredSeiTimecode").string(var_41.as_str());
    }
