...
impl UpdatePresetInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePreset`](crate::operation::update_preset::UpdatePreset)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_preset::UpdatePreset, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_preset::UpdatePresetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_preset::UpdatePreset::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePreset", "mediaconvert"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdatePreset`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePreset {
                type Output = ::std::result::Result<crate::operation::update_preset::UpdatePresetOutput, crate::operation::update_preset::UpdatePresetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_preset::de_update_preset_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_preset::de_update_preset_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_preset::UpdatePresetError {
