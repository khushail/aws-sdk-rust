...
impl super::Client  {
    ...
    ///   - [`component_name(impl ::std::convert::Into<String>)`](crate::operation::cancel_component_deployment::builders::CancelComponentDeploymentFluentBuilder::component_name) / [`set_component_name(Option<String>)`](crate::operation::cancel_component_deployment::builders::CancelComponentDeploymentFluentBuilder::set_component_name): <p>The name of the component with the deployment to cancel.</p>
