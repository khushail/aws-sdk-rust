...
impl ListServiceTemplateVersionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_service_template_versions::ListServiceTemplateVersionsInput, ::aws_smithy_http::operation::error::BuildError> {
