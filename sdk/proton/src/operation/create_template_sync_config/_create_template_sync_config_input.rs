...
impl CreateTemplateSyncConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_template_sync_config::CreateTemplateSyncConfigInput, ::aws_smithy_http::operation::error::BuildError> {
