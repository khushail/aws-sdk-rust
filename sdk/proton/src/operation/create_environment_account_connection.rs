...
impl CreateEnvironmentAccountConnectionInput {
    /// Consumes the builder and constructs an Operation<[`CreateEnvironmentAccountConnection`](crate::operation::create_environment_account_connection::CreateEnvironmentAccountConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_environment_account_connection::CreateEnvironmentAccountConnection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_environment_account_connection::CreateEnvironmentAccountConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_environment_account_connection::CreateEnvironmentAccountConnection::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateEnvironmentAccountConnection", "proton"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateEnvironmentAccountConnection`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEnvironmentAccountConnection {
                type Output = ::std::result::Result<crate::operation::create_environment_account_connection::CreateEnvironmentAccountConnectionOutput, crate::operation::create_environment_account_connection::CreateEnvironmentAccountConnectionError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_environment_account_connection::CreateEnvironmentAccountConnectionError {
...
mod _create_environment_account_connection_output;
