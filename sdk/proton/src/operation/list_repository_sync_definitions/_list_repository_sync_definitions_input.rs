...
impl ListRepositorySyncDefinitionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_repository_sync_definitions::ListRepositorySyncDefinitionsInput, ::aws_smithy_http::operation::error::BuildError> {
