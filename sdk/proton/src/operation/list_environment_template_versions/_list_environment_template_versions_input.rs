...
impl ListEnvironmentTemplateVersionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_environment_template_versions::ListEnvironmentTemplateVersionsInput, ::aws_smithy_http::operation::error::BuildError> {
