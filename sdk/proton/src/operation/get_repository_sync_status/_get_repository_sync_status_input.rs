...
impl GetRepositorySyncStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_repository_sync_status::GetRepositorySyncStatusInput, ::aws_smithy_http::operation::error::BuildError> {
