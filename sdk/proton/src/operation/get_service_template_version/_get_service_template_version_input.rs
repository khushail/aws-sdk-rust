...
impl GetServiceTemplateVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_service_template_version::GetServiceTemplateVersionInput, ::aws_smithy_http::operation::error::BuildError> {
