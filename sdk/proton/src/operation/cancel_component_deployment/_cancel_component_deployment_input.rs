...
impl CancelComponentDeploymentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::cancel_component_deployment::CancelComponentDeploymentInput, ::aws_smithy_http::operation::error::BuildError> {
