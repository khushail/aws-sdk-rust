...
pub fn ser_pipe_target_sage_maker_pipeline_parameters(
...
pub(crate) fn de_pipe_target_sage_maker_pipeline_parameters<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PipeTargetSageMakerPipelineParameters>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::PipeTargetSageMakerPipelineParametersBuilder::default();
            loop {
                match tokens.next().transpose()? {
