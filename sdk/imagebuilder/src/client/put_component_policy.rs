...
impl super::Client  {
    ...
    ///   - [`component_arn(impl ::std::convert::Into<String>)`](crate::operation::put_component_policy::builders::PutComponentPolicyFluentBuilder::component_arn) / [`set_component_arn(Option<String>)`](crate::operation::put_component_policy::builders::PutComponentPolicyFluentBuilder::set_component_arn): <p>The Amazon Resource Name (ARN) of the component that this policy should be applied to.</p>
    ///   - [`policy(impl ::std::convert::Into<String>)`](crate::operation::put_component_policy::builders::PutComponentPolicyFluentBuilder::policy) / [`set_policy(Option<String>)`](crate::operation::put_component_policy::builders::PutComponentPolicyFluentBuilder::set_policy): <p>The policy to apply.</p>
