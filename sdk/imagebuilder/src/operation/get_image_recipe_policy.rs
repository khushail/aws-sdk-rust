...
impl GetImageRecipePolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetImageRecipePolicy`](crate::operation::get_image_recipe_policy::GetImageRecipePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_image_recipe_policy::GetImageRecipePolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_image_recipe_policy::GetImageRecipePolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/GetImageRecipePolicy").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_image_recipe_policy::GetImageRecipePolicyInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if inner_1.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("image_recipe_arn", "cannot be empty or unset"));
                }
            ...
            fn update_http_builder(
                            input: &crate::operation::get_image_recipe_policy::GetImageRecipePolicyInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_image_recipe_policy::GetImageRecipePolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetImageRecipePolicy", "imagebuilder"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetImageRecipePolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetImageRecipePolicy {
                type Output = ::std::result::Result<crate::operation::get_image_recipe_policy::GetImageRecipePolicyOutput, crate::operation::get_image_recipe_policy::GetImageRecipePolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_image_recipe_policy::de_get_image_recipe_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_image_recipe_policy::de_get_image_recipe_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_image_recipe_policy::GetImageRecipePolicyError {
...
mod _get_image_recipe_policy_output;
