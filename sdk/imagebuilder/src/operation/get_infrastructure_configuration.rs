...
impl GetInfrastructureConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetInfrastructureConfiguration`](crate::operation::get_infrastructure_configuration::GetInfrastructureConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_infrastructure_configuration::GetInfrastructureConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_infrastructure_configuration::GetInfrastructureConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/GetInfrastructureConfiguration").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_infrastructure_configuration::GetInfrastructureConfigurationInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if inner_1.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("infrastructure_configuration_arn", "cannot be empty or unset"));
                }
            ...
            fn update_http_builder(
                            input: &crate::operation::get_infrastructure_configuration::GetInfrastructureConfigurationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_infrastructure_configuration::GetInfrastructureConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetInfrastructureConfiguration", "imagebuilder"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetInfrastructureConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInfrastructureConfiguration {
                type Output = ::std::result::Result<crate::operation::get_infrastructure_configuration::GetInfrastructureConfigurationOutput, crate::operation::get_infrastructure_configuration::GetInfrastructureConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_infrastructure_configuration::de_get_infrastructure_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_infrastructure_configuration::de_get_infrastructure_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_infrastructure_configuration::GetInfrastructureConfigurationError {
...
mod _get_infrastructure_configuration_output;
