...
impl GetImagePolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetImagePolicy`](crate::operation::get_image_policy::GetImagePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_image_policy::GetImagePolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_image_policy::GetImagePolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/GetImagePolicy").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_image_policy::GetImagePolicyInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.image_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("image_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("image_arn", "cannot be empty or unset"));
                }
                query.push_kv("imageArn", &::aws_smithy_http::query::fmt_string(&inner_1));
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_image_policy::GetImagePolicyInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_image_policy::GetImagePolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetImagePolicy", "imagebuilder"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetImagePolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetImagePolicy {
                type Output = ::std::result::Result<crate::operation::get_image_policy::GetImagePolicyOutput, crate::operation::get_image_policy::GetImagePolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_image_policy::de_get_image_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_image_policy::de_get_image_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_image_policy::GetImagePolicyError {
...
pub use crate::operation::get_image_policy::_get_image_policy_output::GetImagePolicyOutput;

pub use crate::operation::get_image_policy::_get_image_policy_input::GetImagePolicyInput;

mod _get_image_policy_input;

mod _get_image_policy_output;
