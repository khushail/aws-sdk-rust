...
impl CreateDistributionConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`CreateDistributionConfiguration`](crate::operation::create_distribution_configuration::CreateDistributionConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_distribution_configuration::CreateDistributionConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_distribution_configuration::CreateDistributionConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/CreateDistributionConfiguration").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_distribution_configuration::CreateDistributionConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDistributionConfiguration", "imagebuilder"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateDistributionConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDistributionConfiguration {
                type Output = ::std::result::Result<crate::operation::create_distribution_configuration::CreateDistributionConfigurationOutput, crate::operation::create_distribution_configuration::CreateDistributionConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_distribution_configuration::de_create_distribution_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_distribution_configuration::de_create_distribution_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_distribution_configuration::CreateDistributionConfigurationError {
...
mod _create_distribution_configuration_output;
