...
impl CancelImageCreationInput {
    /// Consumes the builder and constructs an Operation<[`CancelImageCreation`](crate::operation::cancel_image_creation::CancelImageCreation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_image_creation::CancelImageCreation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_image_creation::CancelImageCreationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/CancelImageCreation").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_image_creation::CancelImageCreation::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelImageCreation {
                type Output = ::std::result::Result<crate::operation::cancel_image_creation::CancelImageCreationOutput, crate::operation::cancel_image_creation::CancelImageCreationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_cancel_image_creation::de_cancel_image_creation_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_cancel_image_creation::de_cancel_image_creation_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_image_creation::CancelImageCreationError {
...
mod _cancel_image_creation_output;
