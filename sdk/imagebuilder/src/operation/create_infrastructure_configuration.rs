...
impl CreateInfrastructureConfigurationInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_infrastructure_configuration::CreateInfrastructureConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_infrastructure_configuration::CreateInfrastructureConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/CreateInfrastructureConfiguration").expect("formatting should succeed");
...
/// Orchestration and serialization glue logic for `CreateInfrastructureConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInfrastructureConfiguration {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_infrastructure_configuration::de_create_infrastructure_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_infrastructure_configuration::de_create_infrastructure_configuration_http_response_with_props(status, headers, body)
                     }
                }
