...
impl DeleteImageRecipeInput {
    /// Consumes the builder and constructs an Operation<[`DeleteImageRecipe`](crate::operation::delete_image_recipe::DeleteImageRecipe)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_image_recipe::DeleteImageRecipe, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_image_recipe::DeleteImageRecipeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/DeleteImageRecipe").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_image_recipe::DeleteImageRecipeInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_image_recipe::DeleteImageRecipeInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_image_recipe::DeleteImageRecipe::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteImageRecipe", "imagebuilder"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteImageRecipe`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteImageRecipe {
                type Output = ::std::result::Result<crate::operation::delete_image_recipe::DeleteImageRecipeOutput, crate::operation::delete_image_recipe::DeleteImageRecipeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_image_recipe::de_delete_image_recipe_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_image_recipe::de_delete_image_recipe_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_image_recipe::DeleteImageRecipeError {
...
mod _delete_image_recipe_output;
