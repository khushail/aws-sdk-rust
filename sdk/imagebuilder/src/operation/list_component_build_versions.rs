...
impl ListComponentBuildVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListComponentBuildVersions`](crate::operation::list_component_build_versions::ListComponentBuildVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_component_build_versions::ListComponentBuildVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_component_build_versions::ListComponentBuildVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/ListComponentBuildVersions").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_component_build_versions::ListComponentBuildVersions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListComponentBuildVersions", "imagebuilder"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListComponentBuildVersions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListComponentBuildVersions {
                type Output = ::std::result::Result<crate::operation::list_component_build_versions::ListComponentBuildVersionsOutput, crate::operation::list_component_build_versions::ListComponentBuildVersionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_component_build_versions::de_list_component_build_versions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_component_build_versions::de_list_component_build_versions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_component_build_versions::ListComponentBuildVersionsError {
...
pub use crate::operation::list_component_build_versions::_list_component_build_versions_output::ListComponentBuildVersionsOutput;

pub use crate::operation::list_component_build_versions::_list_component_build_versions_input::ListComponentBuildVersionsInput;

mod _list_component_build_versions_input;

mod _list_component_build_versions_output;
