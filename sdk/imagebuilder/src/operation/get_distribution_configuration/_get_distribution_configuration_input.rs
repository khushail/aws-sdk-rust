...
impl GetDistributionConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_distribution_configuration::GetDistributionConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
