...
impl GetComponentPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetComponentPolicy`](crate::operation::get_component_policy::GetComponentPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_component_policy::GetComponentPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_component_policy::GetComponentPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/GetComponentPolicy").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_component_policy::GetComponentPolicyInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_1 = &_input.component_arn;
                let inner_1 = inner_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("component_arn", "cannot be empty or unset"))?;
                if inner_1.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("component_arn", "cannot be empty or unset"));
                }
                query.push_kv("componentArn", &::aws_smithy_http::query::fmt_string(&inner_1));
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_component_policy::GetComponentPolicyInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_component_policy::GetComponentPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetComponentPolicy {
                type Output = ::std::result::Result<crate::operation::get_component_policy::GetComponentPolicyOutput, crate::operation::get_component_policy::GetComponentPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_component_policy::de_get_component_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_component_policy::de_get_component_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_component_policy::GetComponentPolicyError {
...
mod _get_component_policy_output;
