...
impl ListDistributionConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`ListDistributionConfigurations`](crate::operation::list_distribution_configurations::ListDistributionConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_distribution_configurations::ListDistributionConfigurations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_distribution_configurations::ListDistributionConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/ListDistributionConfigurations").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_distribution_configurations::ListDistributionConfigurations::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDistributionConfigurations {
                type Output = ::std::result::Result<crate::operation::list_distribution_configurations::ListDistributionConfigurationsOutput, crate::operation::list_distribution_configurations::ListDistributionConfigurationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_distribution_configurations::de_list_distribution_configurations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_distribution_configurations::de_list_distribution_configurations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_distribution_configurations::ListDistributionConfigurationsError {
...
mod _list_distribution_configurations_output;
