...
impl ListContainerRecipesInput {
    /// Consumes the builder and constructs an Operation<[`ListContainerRecipes`](crate::operation::list_container_recipes::ListContainerRecipes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_container_recipes::ListContainerRecipes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_container_recipes::ListContainerRecipesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/ListContainerRecipes").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_container_recipes::ListContainerRecipes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListContainerRecipes {
                type Output = ::std::result::Result<crate::operation::list_container_recipes::ListContainerRecipesOutput, crate::operation::list_container_recipes::ListContainerRecipesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_container_recipes::de_list_container_recipes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_container_recipes::de_list_container_recipes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_container_recipes::ListContainerRecipesError {
...
mod _list_container_recipes_output;
