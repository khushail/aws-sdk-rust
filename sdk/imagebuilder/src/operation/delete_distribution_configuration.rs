...
impl DeleteDistributionConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDistributionConfiguration`](crate::operation::delete_distribution_configuration::DeleteDistributionConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_distribution_configuration::DeleteDistributionConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_distribution_configuration::DeleteDistributionConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/DeleteDistributionConfiguration").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_distribution_configuration::DeleteDistributionConfigurationInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if inner_1.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("distribution_configuration_arn", "cannot be empty or unset"));
                }
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_distribution_configuration::DeleteDistributionConfigurationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_distribution_configuration::DeleteDistributionConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDistributionConfiguration {
                type Output = ::std::result::Result<crate::operation::delete_distribution_configuration::DeleteDistributionConfigurationOutput, crate::operation::delete_distribution_configuration::DeleteDistributionConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_distribution_configuration::de_delete_distribution_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_distribution_configuration::de_delete_distribution_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_distribution_configuration::DeleteDistributionConfigurationError {
...
mod _delete_distribution_configuration_output;
