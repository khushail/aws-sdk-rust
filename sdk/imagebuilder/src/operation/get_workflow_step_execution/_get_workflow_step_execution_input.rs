...
impl GetWorkflowStepExecutionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_workflow_step_execution::GetWorkflowStepExecutionInput, ::aws_smithy_http::operation::error::BuildError> {
