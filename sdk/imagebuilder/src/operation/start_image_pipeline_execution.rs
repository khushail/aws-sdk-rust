...
impl StartImagePipelineExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StartImagePipelineExecution`](crate::operation::start_image_pipeline_execution::StartImagePipelineExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_image_pipeline_execution::StartImagePipelineExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_image_pipeline_execution::StartImagePipelineExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/StartImagePipelineExecution").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_image_pipeline_execution::StartImagePipelineExecution::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartImagePipelineExecution {
                type Output = ::std::result::Result<crate::operation::start_image_pipeline_execution::StartImagePipelineExecutionOutput, crate::operation::start_image_pipeline_execution::StartImagePipelineExecutionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_image_pipeline_execution::de_start_image_pipeline_execution_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_image_pipeline_execution::de_start_image_pipeline_execution_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_image_pipeline_execution::StartImagePipelineExecutionError {
...
mod _start_image_pipeline_execution_output;
