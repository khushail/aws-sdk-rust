...
impl CreateDistributionConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_distribution_configuration::CreateDistributionConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
