...
impl DeleteContainerRecipeInput {
    /// Consumes the builder and constructs an Operation<[`DeleteContainerRecipe`](crate::operation::delete_container_recipe::DeleteContainerRecipe)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_container_recipe::DeleteContainerRecipe, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_container_recipe::DeleteContainerRecipeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/DeleteContainerRecipe").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_container_recipe::DeleteContainerRecipeInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_container_recipe::DeleteContainerRecipeInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_container_recipe::DeleteContainerRecipe::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteContainerRecipe", "imagebuilder"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteContainerRecipe`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteContainerRecipe {
                type Output = ::std::result::Result<crate::operation::delete_container_recipe::DeleteContainerRecipeOutput, crate::operation::delete_container_recipe::DeleteContainerRecipeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_container_recipe::de_delete_container_recipe_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_container_recipe::de_delete_container_recipe_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_container_recipe::DeleteContainerRecipeError {
...
mod _delete_container_recipe_output;
