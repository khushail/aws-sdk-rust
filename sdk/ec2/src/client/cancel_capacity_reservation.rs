...
impl super::Client  {
    ...
    ///   - [`capacity_reservation_id(impl ::std::convert::Into<String>)`](crate::operation::cancel_capacity_reservation::builders::CancelCapacityReservationFluentBuilder::capacity_reservation_id) / [`set_capacity_reservation_id(Option<String>)`](crate::operation::cancel_capacity_reservation::builders::CancelCapacityReservationFluentBuilder::set_capacity_reservation_id): <p>The ID of the Capacity Reservation to be cancelled.</p>
