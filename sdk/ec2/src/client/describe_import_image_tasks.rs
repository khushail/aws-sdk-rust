...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_import_image_tasks::builders::DescribeImportImageTasksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_import_image_tasks::builders::DescribeImportImageTasksFluentBuilder::set_next_token): <p>A token that indicates the next page of results.</p>
