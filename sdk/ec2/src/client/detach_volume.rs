...
impl super::Client  {
    ...
    ///   - [`device(impl ::std::convert::Into<String>)`](crate::operation::detach_volume::builders::DetachVolumeFluentBuilder::device) / [`set_device(Option<String>)`](crate::operation::detach_volume::builders::DetachVolumeFluentBuilder::set_device): <p>The device name.</p>
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::detach_volume::builders::DetachVolumeFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::detach_volume::builders::DetachVolumeFluentBuilder::set_instance_id): <p>The ID of the instance. If you are detaching a Multi-Attach enabled volume, you must specify an instance ID.</p>
    ///   - [`volume_id(impl ::std::convert::Into<String>)`](crate::operation::detach_volume::builders::DetachVolumeFluentBuilder::volume_id) / [`set_volume_id(Option<String>)`](crate::operation::detach_volume::builders::DetachVolumeFluentBuilder::set_volume_id): <p>The ID of the volume.</p>
