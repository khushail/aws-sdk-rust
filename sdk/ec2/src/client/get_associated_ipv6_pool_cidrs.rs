...
impl super::Client  {
    ...
    ///   - [`pool_id(impl ::std::convert::Into<String>)`](crate::operation::get_associated_ipv6_pool_cidrs::builders::GetAssociatedIpv6PoolCidrsFluentBuilder::pool_id) / [`set_pool_id(Option<String>)`](crate::operation::get_associated_ipv6_pool_cidrs::builders::GetAssociatedIpv6PoolCidrsFluentBuilder::set_pool_id): <p>The ID of the IPv6 address pool.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_associated_ipv6_pool_cidrs::builders::GetAssociatedIpv6PoolCidrsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_associated_ipv6_pool_cidrs::builders::GetAssociatedIpv6PoolCidrsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
