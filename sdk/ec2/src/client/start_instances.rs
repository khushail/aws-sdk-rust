...
impl super::Client  {
    ...
    ///   - [`additional_info(impl ::std::convert::Into<String>)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::additional_info) / [`set_additional_info(Option<String>)`](crate::operation::start_instances::builders::StartInstancesFluentBuilder::set_additional_info): <p>Reserved.</p>
