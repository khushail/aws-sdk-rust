...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_coip_pools::builders::DescribeCoipPoolsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
