...
impl super::Client  {
    ...
    ///   - [`image_id(impl ::std::convert::Into<String>)`](crate::operation::reset_image_attribute::builders::ResetImageAttributeFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::reset_image_attribute::builders::ResetImageAttributeFluentBuilder::set_image_id): <p>The ID of the AMI.</p>
