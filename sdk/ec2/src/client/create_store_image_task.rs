...
impl super::Client  {
    ...
    ///   - [`image_id(impl ::std::convert::Into<String>)`](crate::operation::create_store_image_task::builders::CreateStoreImageTaskFluentBuilder::image_id) / [`set_image_id(Option<String>)`](crate::operation::create_store_image_task::builders::CreateStoreImageTaskFluentBuilder::set_image_id): <p>The ID of the AMI.</p>
    ///   - [`bucket(impl ::std::convert::Into<String>)`](crate::operation::create_store_image_task::builders::CreateStoreImageTaskFluentBuilder::bucket) / [`set_bucket(Option<String>)`](crate::operation::create_store_image_task::builders::CreateStoreImageTaskFluentBuilder::set_bucket): <p>The name of the Amazon S3 bucket in which the AMI object will be stored. The bucket must be in the Region in which the request is being made. The AMI object appears in the bucket only after the upload task has completed. </p>
