...
impl super::Client  {
    ...
    ///   - [`device(impl ::std::convert::Into<String>)`](crate::operation::attach_volume::builders::AttachVolumeFluentBuilder::device) / [`set_device(Option<String>)`](crate::operation::attach_volume::builders::AttachVolumeFluentBuilder::set_device): <p>The device name (for example, <code>/dev/sdh</code> or <code>xvdh</code>).</p>
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::attach_volume::builders::AttachVolumeFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::attach_volume::builders::AttachVolumeFluentBuilder::set_instance_id): <p>The ID of the instance.</p>
    ///   - [`volume_id(impl ::std::convert::Into<String>)`](crate::operation::attach_volume::builders::AttachVolumeFluentBuilder::volume_id) / [`set_volume_id(Option<String>)`](crate::operation::attach_volume::builders::AttachVolumeFluentBuilder::set_volume_id): <p>The ID of the EBS volume. The volume and instance must be within the same Availability Zone.</p>
