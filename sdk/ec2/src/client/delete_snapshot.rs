...
impl super::Client  {
    ...
    ///   - [`snapshot_id(impl ::std::convert::Into<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::delete_snapshot::builders::DeleteSnapshotFluentBuilder::set_snapshot_id): <p>The ID of the EBS snapshot.</p>
