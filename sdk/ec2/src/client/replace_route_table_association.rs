...
impl super::Client  {
    ...
    ///   - [`association_id(impl ::std::convert::Into<String>)`](crate::operation::replace_route_table_association::builders::ReplaceRouteTableAssociationFluentBuilder::association_id) / [`set_association_id(Option<String>)`](crate::operation::replace_route_table_association::builders::ReplaceRouteTableAssociationFluentBuilder::set_association_id): <p>The association ID.</p>
    ...
    ///   - [`route_table_id(impl ::std::convert::Into<String>)`](crate::operation::replace_route_table_association::builders::ReplaceRouteTableAssociationFluentBuilder::route_table_id) / [`set_route_table_id(Option<String>)`](crate::operation::replace_route_table_association::builders::ReplaceRouteTableAssociationFluentBuilder::set_route_table_id): <p>The ID of the new route table to associate with the subnet.</p>
