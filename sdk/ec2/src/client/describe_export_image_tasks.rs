...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_export_image_tasks::builders::DescribeExportImageTasksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_export_image_tasks::builders::DescribeExportImageTasksFluentBuilder::set_next_token): <p>A token that indicates the next page of results.</p>
