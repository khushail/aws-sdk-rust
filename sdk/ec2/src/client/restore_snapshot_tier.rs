...
impl super::Client  {
    ...
    ///   - [`snapshot_id(impl ::std::convert::Into<String>)`](crate::operation::restore_snapshot_tier::builders::RestoreSnapshotTierFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::restore_snapshot_tier::builders::RestoreSnapshotTierFluentBuilder::set_snapshot_id): <p>The ID of the snapshot to restore.</p>
