...
impl super::Client  {
    ...
    ///   - [`dhcp_options_id(impl ::std::convert::Into<String>)`](crate::operation::delete_dhcp_options::builders::DeleteDhcpOptionsFluentBuilder::dhcp_options_id) / [`set_dhcp_options_id(Option<String>)`](crate::operation::delete_dhcp_options::builders::DeleteDhcpOptionsFluentBuilder::set_dhcp_options_id): <p>The ID of the DHCP options set.</p>
