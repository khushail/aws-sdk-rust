...
impl super::Client  {
    ...
    ///   - [`key_name(impl ::std::convert::Into<String>)`](crate::operation::create_key_pair::builders::CreateKeyPairFluentBuilder::key_name) / [`set_key_name(Option<String>)`](crate::operation::create_key_pair::builders::CreateKeyPairFluentBuilder::set_key_name): <p>A unique name for the key pair.</p>  <p>Constraints: Up to 255 ASCII characters</p>
