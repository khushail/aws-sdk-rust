...
impl super::Client  {
    ...
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::set_description): <p>A description for the Verified Access instance.</p>
    ///   - [`tag_specifications(Vec<TagSpecification>)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::tag_specifications) / [`set_tag_specifications(Option<Vec<TagSpecification>>)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::set_tag_specifications): <p>The tags to assign to the Verified Access instance.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_verified_access_instance::builders::CreateVerifiedAccessInstanceFluentBuilder::set_client_token): <p>A unique, case-sensitive token that you provide to ensure idempotency of your modification request. For more information, see <a href="https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Run_Instance_Idempotency.html">Ensuring Idempotency</a>.</p>
