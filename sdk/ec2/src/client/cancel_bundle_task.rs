...
impl super::Client  {
    ...
    ///   - [`bundle_id(impl ::std::convert::Into<String>)`](crate::operation::cancel_bundle_task::builders::CancelBundleTaskFluentBuilder::bundle_id) / [`set_bundle_id(Option<String>)`](crate::operation::cancel_bundle_task::builders::CancelBundleTaskFluentBuilder::set_bundle_id): <p>The ID of the bundle task.</p>
