...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_capacity_reservation_fleet_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetOutput, crate::operation::create_capacity_reservation_fleet::CreateCapacityReservationFleetError> {
    Ok({
        #[allow(unused_mut)]
