...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_launch_template_versions_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsOutput, crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsError> {
    Ok({
        #[allow(unused_mut)]
