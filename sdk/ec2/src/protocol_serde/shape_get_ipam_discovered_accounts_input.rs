...
pub fn ser_get_ipam_discovered_accounts_input_input(input: &crate::operation::get_ipam_discovered_accounts::GetIpamDiscoveredAccountsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "GetIpamDiscoveredAccounts", "2016-11-15");
    #[allow(unused_mut)]
    ...
    #[allow(unused_mut)]
    let mut scope_5 = writer.prefix("DiscoveryRegion");
    if let Some(var_6) = &input.discovery_region {
