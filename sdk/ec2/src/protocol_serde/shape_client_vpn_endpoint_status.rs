...
pub fn de_client_vpn_endpoint_status(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ClientVpnEndpointStatus, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
