...
pub fn ser_describe_vpc_endpoint_services_input_input(input: &crate::operation::describe_vpc_endpoint_services::DescribeVpcEndpointServicesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    if let Some(var_4) = &input.service_names {
