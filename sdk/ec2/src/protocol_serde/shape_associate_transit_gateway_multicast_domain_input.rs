...
pub fn ser_associate_transit_gateway_multicast_domain_input_input(input: &crate::operation::associate_transit_gateway_multicast_domain::AssociateTransitGatewayMulticastDomainInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
