...
pub fn de_authorize_security_group_ingress_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngressOutput, crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngressError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_authorize_security_group_ingress_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngressOutput, crate::operation::authorize_security_group_ingress::AuthorizeSecurityGroupIngressError> {
    Ok({
        #[allow(unused_mut)]
