...
pub fn ser_describe_store_image_tasks_input_input(input: &crate::operation::describe_store_image_tasks::DescribeStoreImageTasksInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
