...
#[allow(unused_mut)]
pub fn ser_capacity_reservation_specification(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::CapacityReservationSpecification) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
