...
pub fn ser_associate_route_table_input_input(input: &crate::operation::associate_route_table::AssociateRouteTableInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
