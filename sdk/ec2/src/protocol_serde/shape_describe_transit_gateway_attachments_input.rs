...
pub fn ser_describe_transit_gateway_attachments_input_input(input: &crate::operation::describe_transit_gateway_attachments::DescribeTransitGatewayAttachmentsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
