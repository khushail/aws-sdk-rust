...
pub fn de_prefix_list_entry(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::PrefixListEntry, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::PrefixListEntry::builder();
