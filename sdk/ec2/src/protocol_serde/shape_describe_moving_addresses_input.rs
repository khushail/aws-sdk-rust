...
pub fn ser_describe_moving_addresses_input_input(input: &crate::operation::describe_moving_addresses::DescribeMovingAddressesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_12 = writer.prefix("PublicIp");
    if let Some(var_13) = &input.public_ips {
