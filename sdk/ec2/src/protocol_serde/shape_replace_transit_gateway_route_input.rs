...
pub fn ser_replace_transit_gateway_route_input_input(input: &crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
