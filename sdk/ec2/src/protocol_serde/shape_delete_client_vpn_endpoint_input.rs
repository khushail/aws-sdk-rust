...
pub fn ser_delete_client_vpn_endpoint_input_input(input: &crate::operation::delete_client_vpn_endpoint::DeleteClientVpnEndpointInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
