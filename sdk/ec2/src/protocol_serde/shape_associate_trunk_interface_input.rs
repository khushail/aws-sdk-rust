...
pub fn ser_associate_trunk_interface_input_input(input: &crate::operation::associate_trunk_interface::AssociateTrunkInterfaceInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
