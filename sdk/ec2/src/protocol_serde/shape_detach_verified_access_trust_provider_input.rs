...
pub fn ser_detach_verified_access_trust_provider_input_input(input: &crate::operation::detach_verified_access_trust_provider::DetachVerifiedAccessTrustProviderInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
