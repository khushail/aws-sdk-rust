...
#[allow(unused_mut)]
pub fn ser_instance_event_window_association_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::InstanceEventWindowAssociationRequest) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
