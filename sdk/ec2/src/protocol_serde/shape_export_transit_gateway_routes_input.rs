...
pub fn ser_export_transit_gateway_routes_input_input(input: &crate::operation::export_transit_gateway_routes::ExportTransitGatewayRoutesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_8 = writer.prefix("S3Bucket");
