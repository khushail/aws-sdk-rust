...
pub fn de_launch_template_capacity_reservation_specification_response(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::LaunchTemplateCapacityReservationSpecificationResponse, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::LaunchTemplateCapacityReservationSpecificationResponse::builder();
