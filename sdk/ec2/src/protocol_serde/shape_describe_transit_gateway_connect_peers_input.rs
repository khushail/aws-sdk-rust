...
pub fn ser_describe_transit_gateway_connect_peers_input_input(input: &crate::operation::describe_transit_gateway_connect_peers::DescribeTransitGatewayConnectPeersInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeTransitGatewayConnectPeers", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("TransitGatewayConnectPeerIds");
    if let Some(var_2) = &input.transit_gateway_connect_peer_ids {
