...
pub fn ser_describe_spot_instance_requests_input_input(input: &crate::operation::describe_spot_instance_requests::DescribeSpotInstanceRequestsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
