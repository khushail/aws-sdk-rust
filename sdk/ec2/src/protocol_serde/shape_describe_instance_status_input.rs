...
pub fn ser_describe_instance_status_input_input(input: &crate::operation::describe_instance_status::DescribeInstanceStatusInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_17 = writer.prefix("IncludeAllInstances");
    if let Some(var_18) = &input.include_all_instances {
