...
pub fn ser_reset_instance_attribute_input_input(input: &crate::operation::reset_instance_attribute::ResetInstanceAttributeInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
