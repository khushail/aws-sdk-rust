...
pub fn ser_describe_transit_gateway_policy_tables_input_input(input: &crate::operation::describe_transit_gateway_policy_tables::DescribeTransitGatewayPolicyTablesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    #[allow(unused_mut)]
    let mut writer = ::aws_smithy_query::QueryWriter::new(&mut out, "DescribeTransitGatewayPolicyTables", "2016-11-15");
    #[allow(unused_mut)]
    let mut scope_1 = writer.prefix("TransitGatewayPolicyTableIds");
    if let Some(var_2) = &input.transit_gateway_policy_table_ids {
