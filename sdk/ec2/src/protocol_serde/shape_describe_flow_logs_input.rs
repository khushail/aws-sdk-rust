...
pub fn ser_describe_flow_logs_input_input(input: &crate::operation::describe_flow_logs::DescribeFlowLogsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_8 = writer.prefix("FlowLogId");
    if let Some(var_9) = &input.flow_log_ids {
