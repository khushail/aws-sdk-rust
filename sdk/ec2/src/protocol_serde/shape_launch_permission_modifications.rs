...
#[allow(unused_mut)]
pub fn ser_launch_permission_modifications(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::LaunchPermissionModifications) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
    ...
    if let Some(var_2) = &input.add {
        ...
        for item_3 in var_2 {
            ...
            crate::protocol_serde::shape_launch_permission::ser_launch_permission(entry_5, item_3)?;
        }
        list_4.finish();
    }
    #[allow(unused_mut)]
