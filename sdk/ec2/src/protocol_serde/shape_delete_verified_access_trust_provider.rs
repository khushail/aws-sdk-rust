...
pub fn de_delete_verified_access_trust_provider_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProviderOutput, crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProviderError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProviderError::unhandled)?;
...
pub fn de_delete_verified_access_trust_provider_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProviderOutput, crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProviderError> {
    Ok({
        ...
        output = crate::protocol_serde::shape_delete_verified_access_trust_provider::de_delete_verified_access_trust_provider(_response_body, output).map_err(crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProviderError::unhandled)?;
...
pub fn de_delete_verified_access_trust_provider(inp: &[u8], mut builder: crate::operation::delete_verified_access_trust_provider::builders::DeleteVerifiedAccessTrustProviderOutputBuilder) -> Result<crate::operation::delete_verified_access_trust_provider::builders::DeleteVerifiedAccessTrustProviderOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("DeleteVerifiedAccessTrustProviderResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected DeleteVerifiedAccessTrustProviderResponse got {:?}", start_el)))
                    }
