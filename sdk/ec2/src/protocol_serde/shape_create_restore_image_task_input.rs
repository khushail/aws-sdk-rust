...
pub fn ser_create_restore_image_task_input_input(input: &crate::operation::create_restore_image_task::CreateRestoreImageTaskInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("ObjectKey");
    if let Some(var_4) = &input.object_key {
