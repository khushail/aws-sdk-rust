...
pub fn de_create_network_insights_access_scope_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeOutput, crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_network_insights_access_scope_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeOutput, crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = crate::protocol_serde::shape_create_network_insights_access_scope::de_create_network_insights_access_scope(_response_body, output).map_err(crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeError::unhandled)?;
