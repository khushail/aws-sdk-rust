...
pub fn de_import_image_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::import_image::ImportImageOutput, crate::operation::import_image::ImportImageError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::import_image::ImportImageError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_import_image_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::import_image::ImportImageOutput, crate::operation::import_image::ImportImageError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::import_image::builders::ImportImageOutputBuilder::default();
        output = crate::protocol_serde::shape_import_image::de_import_image(_response_body, output).map_err(crate::operation::import_image::ImportImageError::unhandled)?;
