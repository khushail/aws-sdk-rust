...
pub fn ser_describe_traffic_mirror_targets_input_input(input: &crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
