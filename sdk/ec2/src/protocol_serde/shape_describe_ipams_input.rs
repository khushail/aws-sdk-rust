...
pub fn ser_describe_ipams_input_input(input: &crate::operation::describe_ipams::DescribeIpamsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_12 = writer.prefix("IpamId");
    if let Some(var_13) = &input.ipam_ids {
