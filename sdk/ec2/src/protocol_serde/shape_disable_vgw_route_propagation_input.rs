...
pub fn ser_disable_vgw_route_propagation_input_input(input: &crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
