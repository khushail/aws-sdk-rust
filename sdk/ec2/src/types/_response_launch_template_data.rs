...
impl ResponseLaunchTemplateDataBuilder {
    ...
    /// <p>The network interfaces.</p>
    pub fn get_network_interfaces(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::LaunchTemplateInstanceNetworkInterfaceSpecification>> {
    ...
    /// <p> The elastic inference accelerator for the instance. </p>
    pub fn get_elastic_inference_accelerators(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::LaunchTemplateElasticInferenceAcceleratorResponse>> {
    ...
    /// <p>Information about the Capacity Reservation targeting option.</p>
    pub fn get_capacity_reservation_specification(&self) -> &::std::option::Option<crate::types::LaunchTemplateCapacityReservationSpecificationResponse> {
