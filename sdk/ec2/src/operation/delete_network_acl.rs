...
impl DeleteNetworkAclInput {
    /// Consumes the builder and constructs an Operation<[`DeleteNetworkAcl`](crate::operation::delete_network_acl::DeleteNetworkAcl)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_network_acl::DeleteNetworkAcl, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_network_acl::DeleteNetworkAclInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_network_acl_input::ser_delete_network_acl_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_network_acl::DeleteNetworkAcl::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteNetworkAcl", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNetworkAcl {
                type Output = ::std::result::Result<crate::operation::delete_network_acl::DeleteNetworkAclOutput, crate::operation::delete_network_acl::DeleteNetworkAclError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_network_acl::de_delete_network_acl_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteNetworkAclErrorKind = DeleteNetworkAclError;
/// Error type for the `DeleteNetworkAclError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteNetworkAclError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteNetworkAclError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_network_acl::DeleteNetworkAclError {
...
impl DeleteNetworkAclError {
    /// Creates the `DeleteNetworkAclError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteNetworkAclError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _delete_network_acl_output;
