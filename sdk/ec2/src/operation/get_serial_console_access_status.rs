...
impl GetSerialConsoleAccessStatusInput {
    /// Consumes the builder and constructs an Operation<[`GetSerialConsoleAccessStatus`](crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_serial_console_access_status_input::ser_get_serial_console_access_status_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatus::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSerialConsoleAccessStatus", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSerialConsoleAccessStatus {
                type Output = ::std::result::Result<crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusOutput, crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_serial_console_access_status::de_get_serial_console_access_status_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetSerialConsoleAccessStatusErrorKind = GetSerialConsoleAccessStatusError;
/// Error type for the `GetSerialConsoleAccessStatusError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetSerialConsoleAccessStatusError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for GetSerialConsoleAccessStatusError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetSerialConsoleAccessStatusError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_serial_console_access_status::GetSerialConsoleAccessStatusError {
...
impl GetSerialConsoleAccessStatusError {
    /// Creates the `GetSerialConsoleAccessStatusError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSerialConsoleAccessStatusError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
