...
impl DescribeSpotFleetRequestsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_spot_fleet_requests::DescribeSpotFleetRequestsInput, ::aws_smithy_http::operation::error::BuildError> {
