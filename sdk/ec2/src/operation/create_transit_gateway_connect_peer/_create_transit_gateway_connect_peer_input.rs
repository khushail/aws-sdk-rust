...
impl CreateTransitGatewayConnectPeerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_transit_gateway_connect_peer::CreateTransitGatewayConnectPeerInput, ::aws_smithy_http::operation::error::BuildError> {
