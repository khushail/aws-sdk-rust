...
impl AssociateIamInstanceProfileInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_iam_instance_profile::AssociateIamInstanceProfileInput, ::aws_smithy_http::operation::error::BuildError> {
