...
impl DescribeTrafficMirrorTargetsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTrafficMirrorTargets`](crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_traffic_mirror_targets_input::ser_describe_traffic_mirror_targets_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargets::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeTrafficMirrorTargets", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTrafficMirrorTargets {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_traffic_mirror_targets::de_describe_traffic_mirror_targets_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeTrafficMirrorTargetsErrorKind = DescribeTrafficMirrorTargetsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeTrafficMirrorTargetsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeTrafficMirrorTargetsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_traffic_mirror_targets::DescribeTrafficMirrorTargetsError {
...
impl DescribeTrafficMirrorTargetsError {
    /// Creates the `DescribeTrafficMirrorTargetsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeTrafficMirrorTargetsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
pub use crate::operation::describe_traffic_mirror_targets::_describe_traffic_mirror_targets_output::DescribeTrafficMirrorTargetsOutput;

pub use crate::operation::describe_traffic_mirror_targets::_describe_traffic_mirror_targets_input::DescribeTrafficMirrorTargetsInput;

mod _describe_traffic_mirror_targets_input;

mod _describe_traffic_mirror_targets_output;
