...
impl DescribeVerifiedAccessGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_verified_access_groups::DescribeVerifiedAccessGroupsInput, ::aws_smithy_http::operation::error::BuildError> {
