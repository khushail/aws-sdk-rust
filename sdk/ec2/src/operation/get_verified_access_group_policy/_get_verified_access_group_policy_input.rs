...
impl GetVerifiedAccessGroupPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_verified_access_group_policy::GetVerifiedAccessGroupPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
