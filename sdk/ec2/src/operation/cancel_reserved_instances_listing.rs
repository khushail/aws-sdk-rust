...
impl CancelReservedInstancesListingInput {
    /// Consumes the builder and constructs an Operation<[`CancelReservedInstancesListing`](crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListing)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListing, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_cancel_reserved_instances_listing_input::ser_cancel_reserved_instances_listing_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListing::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelReservedInstancesListing", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelReservedInstancesListing {
                type Output = ::std::result::Result<crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingOutput, crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_cancel_reserved_instances_listing::de_cancel_reserved_instances_listing_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CancelReservedInstancesListingErrorKind = CancelReservedInstancesListingError;
/// Error type for the `CancelReservedInstancesListingError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CancelReservedInstancesListingError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CancelReservedInstancesListingError {
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_reserved_instances_listing::CancelReservedInstancesListingError {
...
impl CancelReservedInstancesListingError {
    /// Creates the `CancelReservedInstancesListingError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CancelReservedInstancesListingError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _cancel_reserved_instances_listing_output;
