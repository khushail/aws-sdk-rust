...
impl DeprovisionIpamPoolCidrInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deprovision_ipam_pool_cidr::DeprovisionIpamPoolCidrInput, ::aws_smithy_http::operation::error::BuildError> {
