...
impl EnableImageDeprecationInput {
    /// Consumes the builder and constructs an Operation<[`EnableImageDeprecation`](crate::operation::enable_image_deprecation::EnableImageDeprecation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::enable_image_deprecation::EnableImageDeprecation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_image_deprecation::EnableImageDeprecationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_image_deprecation_input::ser_enable_image_deprecation_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_image_deprecation::EnableImageDeprecation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("EnableImageDeprecation", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableImageDeprecation {
                type Output = ::std::result::Result<crate::operation::enable_image_deprecation::EnableImageDeprecationOutput, crate::operation::enable_image_deprecation::EnableImageDeprecationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_enable_image_deprecation::de_enable_image_deprecation_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type EnableImageDeprecationErrorKind = EnableImageDeprecationError;
/// Error type for the `EnableImageDeprecationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum EnableImageDeprecationError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for EnableImageDeprecationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnableImageDeprecationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_image_deprecation::EnableImageDeprecationError {
...
impl EnableImageDeprecationError {
    /// Creates the `EnableImageDeprecationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableImageDeprecationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
