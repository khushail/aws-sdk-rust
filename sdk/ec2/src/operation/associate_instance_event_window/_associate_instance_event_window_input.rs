...
impl AssociateInstanceEventWindowInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_instance_event_window::AssociateInstanceEventWindowInput, ::aws_smithy_http::operation::error::BuildError> {
