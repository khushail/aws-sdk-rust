...
impl RevokeSecurityGroupIngressInput {
    /// Consumes the builder and constructs an Operation<[`RevokeSecurityGroupIngress`](crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngress)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngress, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_security_group_ingress_input::ser_revoke_security_group_ingress_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngress::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RevokeSecurityGroupIngress", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeSecurityGroupIngress {
                type Output = ::std::result::Result<crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngressOutput, crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngressError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_revoke_security_group_ingress::de_revoke_security_group_ingress_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type RevokeSecurityGroupIngressErrorKind = RevokeSecurityGroupIngressError;
/// Error type for the `RevokeSecurityGroupIngressError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for RevokeSecurityGroupIngressError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RevokeSecurityGroupIngressError {
...
impl ::aws_http::request_id::RequestId for crate::operation::revoke_security_group_ingress::RevokeSecurityGroupIngressError {
...
impl RevokeSecurityGroupIngressError {
    /// Creates the `RevokeSecurityGroupIngressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RevokeSecurityGroupIngressError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
