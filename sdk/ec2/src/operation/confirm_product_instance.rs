...
impl ConfirmProductInstanceInput {
    /// Consumes the builder and constructs an Operation<[`ConfirmProductInstance`](crate::operation::confirm_product_instance::ConfirmProductInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::confirm_product_instance::ConfirmProductInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::confirm_product_instance::ConfirmProductInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_confirm_product_instance_input::ser_confirm_product_instance_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::confirm_product_instance::ConfirmProductInstance::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ConfirmProductInstance", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmProductInstance {
                type Output = ::std::result::Result<crate::operation::confirm_product_instance::ConfirmProductInstanceOutput, crate::operation::confirm_product_instance::ConfirmProductInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_confirm_product_instance::de_confirm_product_instance_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ConfirmProductInstanceErrorKind = ConfirmProductInstanceError;
/// Error type for the `ConfirmProductInstanceError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ConfirmProductInstanceError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ConfirmProductInstanceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::confirm_product_instance::ConfirmProductInstanceError {
...
impl ConfirmProductInstanceError {
    /// Creates the `ConfirmProductInstanceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ConfirmProductInstanceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _confirm_product_instance_output;
