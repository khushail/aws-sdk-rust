...
impl ModifyTrafficMirrorSessionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_traffic_mirror_session::ModifyTrafficMirrorSessionInput, ::aws_smithy_http::operation::error::BuildError> {
