...
impl GetIpamDiscoveredAccountsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_ipam_discovered_accounts::GetIpamDiscoveredAccountsInput, ::aws_smithy_http::operation::error::BuildError> {
