...
impl RejectVpcPeeringConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reject_vpc_peering_connection::RejectVpcPeeringConnectionInput, ::aws_smithy_http::operation::error::BuildError> {
