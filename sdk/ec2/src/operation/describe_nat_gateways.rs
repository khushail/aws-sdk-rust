...
impl DescribeNatGatewaysInput {
    /// Consumes the builder and constructs an Operation<[`DescribeNatGateways`](crate::operation::describe_nat_gateways::DescribeNatGateways)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_nat_gateways::DescribeNatGateways, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_nat_gateways::DescribeNatGatewaysInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_nat_gateways_input::ser_describe_nat_gateways_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_nat_gateways::DescribeNatGateways::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeNatGateways", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNatGateways {
                type Output = ::std::result::Result<crate::operation::describe_nat_gateways::DescribeNatGatewaysOutput, crate::operation::describe_nat_gateways::DescribeNatGatewaysError>;
...
/// Do not use this.
            ...
            pub type DescribeNatGatewaysErrorKind = DescribeNatGatewaysError;
/// Error type for the `DescribeNatGatewaysError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeNatGatewaysError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeNatGatewaysError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_nat_gateways::DescribeNatGatewaysError {
...
impl DescribeNatGatewaysError {
    /// Creates the `DescribeNatGatewaysError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeNatGatewaysError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
