...
impl DeleteFpgaImageInput {
    /// Consumes the builder and constructs an Operation<[`DeleteFpgaImage`](crate::operation::delete_fpga_image::DeleteFpgaImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_fpga_image::DeleteFpgaImage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_fpga_image::DeleteFpgaImageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_fpga_image_input::ser_delete_fpga_image_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_fpga_image::DeleteFpgaImage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteFpgaImage", "ec2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteFpgaImage`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFpgaImage {
                type Output = ::std::result::Result<crate::operation::delete_fpga_image::DeleteFpgaImageOutput, crate::operation::delete_fpga_image::DeleteFpgaImageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_fpga_image::de_delete_fpga_image_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_fpga_image::de_delete_fpga_image_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteFpgaImageErrorKind = DeleteFpgaImageError;
/// Error type for the `DeleteFpgaImageError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteFpgaImageError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteFpgaImageError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_fpga_image::DeleteFpgaImageError {
...
impl DeleteFpgaImageError {
    /// Creates the `DeleteFpgaImageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteFpgaImageError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
