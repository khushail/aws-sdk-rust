...
impl CreateVerifiedAccessEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_verified_access_endpoint::CreateVerifiedAccessEndpointInput, ::aws_smithy_http::operation::error::BuildError> {
