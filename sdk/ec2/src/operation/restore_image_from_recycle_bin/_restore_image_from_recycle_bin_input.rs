...
impl RestoreImageFromRecycleBinInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_image_from_recycle_bin::RestoreImageFromRecycleBinInput, ::aws_smithy_http::operation::error::BuildError> {
