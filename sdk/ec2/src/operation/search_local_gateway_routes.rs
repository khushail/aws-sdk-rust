...
impl SearchLocalGatewayRoutesInput {
    /// Consumes the builder and constructs an Operation<[`SearchLocalGatewayRoutes`](crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_local_gateway_routes_input::ser_search_local_gateway_routes_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchLocalGatewayRoutes", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchLocalGatewayRoutes {
                type Output = ::std::result::Result<crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutesOutput, crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_search_local_gateway_routes::de_search_local_gateway_routes_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type SearchLocalGatewayRoutesErrorKind = SearchLocalGatewayRoutesError;
/// Error type for the `SearchLocalGatewayRoutesError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum SearchLocalGatewayRoutesError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for SearchLocalGatewayRoutesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SearchLocalGatewayRoutesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::search_local_gateway_routes::SearchLocalGatewayRoutesError {
...
impl SearchLocalGatewayRoutesError {
    /// Creates the `SearchLocalGatewayRoutesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchLocalGatewayRoutesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
