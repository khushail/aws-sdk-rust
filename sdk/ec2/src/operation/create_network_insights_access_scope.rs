...
impl CreateNetworkInsightsAccessScopeInput {
    /// Consumes the builder and constructs an Operation<[`CreateNetworkInsightsAccessScope`](crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScope)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScope, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_network_insights_access_scope_input::ser_create_network_insights_access_scope_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScope::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateNetworkInsightsAccessScope", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNetworkInsightsAccessScope {
                type Output = ::std::result::Result<crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeOutput, crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeError>;
...
/// Do not use this.
            ...
            pub type CreateNetworkInsightsAccessScopeErrorKind = CreateNetworkInsightsAccessScopeError;
/// Error type for the `CreateNetworkInsightsAccessScopeError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateNetworkInsightsAccessScopeError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for CreateNetworkInsightsAccessScopeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateNetworkInsightsAccessScopeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_network_insights_access_scope::CreateNetworkInsightsAccessScopeError {
...
impl CreateNetworkInsightsAccessScopeError {
    /// Creates the `CreateNetworkInsightsAccessScopeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateNetworkInsightsAccessScopeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
