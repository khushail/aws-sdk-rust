...
impl CancelSpotFleetRequestsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::cancel_spot_fleet_requests::CancelSpotFleetRequestsInput, ::aws_smithy_http::operation::error::BuildError> {
