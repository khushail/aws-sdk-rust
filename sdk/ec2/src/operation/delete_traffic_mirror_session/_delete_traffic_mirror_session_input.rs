...
impl DeleteTrafficMirrorSessionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_traffic_mirror_session::DeleteTrafficMirrorSessionInput, ::aws_smithy_http::operation::error::BuildError> {
