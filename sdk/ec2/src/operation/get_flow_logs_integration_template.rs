...
impl GetFlowLogsIntegrationTemplateInput {
    /// Consumes the builder and constructs an Operation<[`GetFlowLogsIntegrationTemplate`](crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_flow_logs_integration_template_input::ser_get_flow_logs_integration_template_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetFlowLogsIntegrationTemplate", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetFlowLogsIntegrationTemplate {
                type Output = ::std::result::Result<crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateOutput, crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_flow_logs_integration_template::de_get_flow_logs_integration_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetFlowLogsIntegrationTemplateErrorKind = GetFlowLogsIntegrationTemplateError;
/// Error type for the `GetFlowLogsIntegrationTemplateError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetFlowLogsIntegrationTemplateError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for GetFlowLogsIntegrationTemplateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetFlowLogsIntegrationTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_flow_logs_integration_template::GetFlowLogsIntegrationTemplateError {
...
impl GetFlowLogsIntegrationTemplateError {
    /// Creates the `GetFlowLogsIntegrationTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetFlowLogsIntegrationTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _get_flow_logs_integration_template_output;
