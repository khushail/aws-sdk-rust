...
impl DisassociateVpcCidrBlockInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_vpc_cidr_block::DisassociateVpcCidrBlockInput, ::aws_smithy_http::operation::error::BuildError> {
