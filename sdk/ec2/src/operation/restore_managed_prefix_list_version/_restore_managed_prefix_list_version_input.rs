...
impl RestoreManagedPrefixListVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_managed_prefix_list_version::RestoreManagedPrefixListVersionInput, ::aws_smithy_http::operation::error::BuildError> {
