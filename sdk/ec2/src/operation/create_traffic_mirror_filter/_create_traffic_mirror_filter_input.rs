...
impl CreateTrafficMirrorFilterInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_traffic_mirror_filter::CreateTrafficMirrorFilterInput, ::aws_smithy_http::operation::error::BuildError> {
