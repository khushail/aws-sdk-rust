...
impl GetManagedPrefixListEntriesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_managed_prefix_list_entries::GetManagedPrefixListEntriesInput, ::aws_smithy_http::operation::error::BuildError> {
