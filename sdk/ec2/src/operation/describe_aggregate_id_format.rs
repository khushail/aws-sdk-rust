...
impl DescribeAggregateIdFormatInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAggregateIdFormat`](crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormat)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormat, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_aggregate_id_format_input::ser_describe_aggregate_id_format_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormat::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAggregateIdFormat", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAggregateIdFormat {
                type Output = ::std::result::Result<crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatOutput, crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_aggregate_id_format::de_describe_aggregate_id_format_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeAggregateIdFormatErrorKind = DescribeAggregateIdFormatError;
/// Error type for the `DescribeAggregateIdFormatError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeAggregateIdFormatError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeAggregateIdFormatError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_aggregate_id_format::DescribeAggregateIdFormatError {
...
impl DescribeAggregateIdFormatError {
    /// Creates the `DescribeAggregateIdFormatError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAggregateIdFormatError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _describe_aggregate_id_format_output;
