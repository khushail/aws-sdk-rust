...
impl DeleteVpcInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVpc`](crate::operation::delete_vpc::DeleteVpc)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_vpc::DeleteVpc, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_vpc::DeleteVpcInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_vpc_input::ser_delete_vpc_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_vpc::DeleteVpc::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteVpc", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVpc {
                type Output = ::std::result::Result<crate::operation::delete_vpc::DeleteVpcOutput, crate::operation::delete_vpc::DeleteVpcError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_vpc::de_delete_vpc_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteVpcErrorKind = DeleteVpcError;
/// Error type for the `DeleteVpcError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteVpcError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteVpcError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_vpc::DeleteVpcError {
...
impl DeleteVpcError {
    /// Creates the `DeleteVpcError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVpcError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
