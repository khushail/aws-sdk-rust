...
impl DeleteNatGatewayInput {
    /// Consumes the builder and constructs an Operation<[`DeleteNatGateway`](crate::operation::delete_nat_gateway::DeleteNatGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_nat_gateway::DeleteNatGateway, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_nat_gateway::DeleteNatGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_nat_gateway_input::ser_delete_nat_gateway_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_nat_gateway::DeleteNatGateway::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteNatGateway", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNatGateway {
                type Output = ::std::result::Result<crate::operation::delete_nat_gateway::DeleteNatGatewayOutput, crate::operation::delete_nat_gateway::DeleteNatGatewayError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_nat_gateway::de_delete_nat_gateway_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteNatGatewayErrorKind = DeleteNatGatewayError;
/// Error type for the `DeleteNatGatewayError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteNatGatewayError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteNatGatewayError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_nat_gateway::DeleteNatGatewayError {
...
impl DeleteNatGatewayError {
    /// Creates the `DeleteNatGatewayError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteNatGatewayError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _delete_nat_gateway_output;
