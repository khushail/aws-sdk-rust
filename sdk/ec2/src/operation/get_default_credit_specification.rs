...
impl GetDefaultCreditSpecificationInput {
    /// Consumes the builder and constructs an Operation<[`GetDefaultCreditSpecification`](crate::operation::get_default_credit_specification::GetDefaultCreditSpecification)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_default_credit_specification::GetDefaultCreditSpecification, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_default_credit_specification_input::ser_get_default_credit_specification_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_default_credit_specification::GetDefaultCreditSpecification::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetDefaultCreditSpecification", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDefaultCreditSpecification {
                type Output = ::std::result::Result<crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationOutput, crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationError>;
...
/// Do not use this.
            ...
            pub type GetDefaultCreditSpecificationErrorKind = GetDefaultCreditSpecificationError;
/// Error type for the `GetDefaultCreditSpecificationError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetDefaultCreditSpecificationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetDefaultCreditSpecificationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_default_credit_specification::GetDefaultCreditSpecificationError {
...
impl GetDefaultCreditSpecificationError {
    /// Creates the `GetDefaultCreditSpecificationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetDefaultCreditSpecificationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _get_default_credit_specification_output;
