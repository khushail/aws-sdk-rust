...
impl DeleteVpnConnectionRouteInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_vpn_connection_route::DeleteVpnConnectionRouteInput, ::aws_smithy_http::operation::error::BuildError> {
