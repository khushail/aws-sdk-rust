...
impl DescribePublicIpv4PoolsInput {
    /// Consumes the builder and constructs an Operation<[`DescribePublicIpv4Pools`](crate::operation::describe_public_ipv4_pools::DescribePublicIpv4Pools)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_public_ipv4_pools::DescribePublicIpv4Pools, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_public_ipv4_pools_input::ser_describe_public_ipv4_pools_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_public_ipv4_pools::DescribePublicIpv4Pools::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribePublicIpv4Pools", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePublicIpv4Pools {
                type Output = ::std::result::Result<crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsOutput, crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_public_ipv4_pools::de_describe_public_ipv4_pools_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribePublicIpv4PoolsErrorKind = DescribePublicIpv4PoolsError;
/// Error type for the `DescribePublicIpv4PoolsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribePublicIpv4PoolsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribePublicIpv4PoolsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsError {
...
impl DescribePublicIpv4PoolsError {
    /// Creates the `DescribePublicIpv4PoolsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribePublicIpv4PoolsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _describe_public_ipv4_pools_output;
