...
impl DisableVgwRoutePropagationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disable_vgw_route_propagation::DisableVgwRoutePropagationInput, ::aws_smithy_http::operation::error::BuildError> {
