...
impl CreateTransitGatewayConnectInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_transit_gateway_connect::CreateTransitGatewayConnectInput, ::aws_smithy_http::operation::error::BuildError> {
