...
impl AssociateSubnetCidrBlockInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_subnet_cidr_block::AssociateSubnetCidrBlockInput, ::aws_smithy_http::operation::error::BuildError> {
