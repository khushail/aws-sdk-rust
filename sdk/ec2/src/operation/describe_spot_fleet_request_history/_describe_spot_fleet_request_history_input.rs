...
impl DescribeSpotFleetRequestHistoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistoryInput, ::aws_smithy_http::operation::error::BuildError> {
