...
impl DescribeFpgaImageAttributeInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFpgaImageAttribute`](crate::operation::describe_fpga_image_attribute::DescribeFpgaImageAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_fpga_image_attribute::DescribeFpgaImageAttribute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fpga_image_attribute::DescribeFpgaImageAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_fpga_image_attribute_input::ser_describe_fpga_image_attribute_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fpga_image_attribute::DescribeFpgaImageAttribute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeFpgaImageAttribute", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFpgaImageAttribute {
                type Output = ::std::result::Result<crate::operation::describe_fpga_image_attribute::DescribeFpgaImageAttributeOutput, crate::operation::describe_fpga_image_attribute::DescribeFpgaImageAttributeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_fpga_image_attribute::de_describe_fpga_image_attribute_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeFpgaImageAttributeErrorKind = DescribeFpgaImageAttributeError;
/// Error type for the `DescribeFpgaImageAttributeError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeFpgaImageAttributeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeFpgaImageAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_fpga_image_attribute::DescribeFpgaImageAttributeError {
...
impl DescribeFpgaImageAttributeError {
    /// Creates the `DescribeFpgaImageAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeFpgaImageAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
