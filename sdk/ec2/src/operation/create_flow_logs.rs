...
impl CreateFlowLogsInput {
    /// Consumes the builder and constructs an Operation<[`CreateFlowLogs`](crate::operation::create_flow_logs::CreateFlowLogs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_flow_logs::CreateFlowLogs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_flow_logs::CreateFlowLogsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_flow_logs_input::ser_create_flow_logs_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_flow_logs::CreateFlowLogs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateFlowLogs", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFlowLogs {
                type Output = ::std::result::Result<crate::operation::create_flow_logs::CreateFlowLogsOutput, crate::operation::create_flow_logs::CreateFlowLogsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_flow_logs::de_create_flow_logs_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateFlowLogsErrorKind = CreateFlowLogsError;
/// Error type for the `CreateFlowLogsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateFlowLogsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateFlowLogsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_flow_logs::CreateFlowLogsError {
...
impl CreateFlowLogsError {
    /// Creates the `CreateFlowLogsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateFlowLogsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
