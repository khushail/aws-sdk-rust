...
impl DescribeVerifiedAccessInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_verified_access_instances::DescribeVerifiedAccessInstancesInput, ::aws_smithy_http::operation::error::BuildError> {
