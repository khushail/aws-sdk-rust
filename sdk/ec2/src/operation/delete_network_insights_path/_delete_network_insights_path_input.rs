...
impl DeleteNetworkInsightsPathInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_network_insights_path::DeleteNetworkInsightsPathInput, ::aws_smithy_http::operation::error::BuildError> {
