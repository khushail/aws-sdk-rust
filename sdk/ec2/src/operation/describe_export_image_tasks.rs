...
impl DescribeExportImageTasksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeExportImageTasks`](crate::operation::describe_export_image_tasks::DescribeExportImageTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_export_image_tasks::DescribeExportImageTasks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_export_image_tasks::DescribeExportImageTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_export_image_tasks_input::ser_describe_export_image_tasks_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_export_image_tasks::DescribeExportImageTasks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeExportImageTasks", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeExportImageTasks {
                type Output = ::std::result::Result<crate::operation::describe_export_image_tasks::DescribeExportImageTasksOutput, crate::operation::describe_export_image_tasks::DescribeExportImageTasksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_export_image_tasks::de_describe_export_image_tasks_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeExportImageTasksErrorKind = DescribeExportImageTasksError;
/// Error type for the `DescribeExportImageTasksError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeExportImageTasksError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeExportImageTasksError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_export_image_tasks::DescribeExportImageTasksError {
...
impl DescribeExportImageTasksError {
    /// Creates the `DescribeExportImageTasksError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeExportImageTasksError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
