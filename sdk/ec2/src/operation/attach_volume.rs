...
impl AttachVolumeInput {
    /// Consumes the builder and constructs an Operation<[`AttachVolume`](crate::operation::attach_volume::AttachVolume)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::attach_volume::AttachVolume, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_volume::AttachVolumeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_attach_volume_input::ser_attach_volume_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_volume::AttachVolume::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AttachVolume", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachVolume {
                type Output = ::std::result::Result<crate::operation::attach_volume::AttachVolumeOutput, crate::operation::attach_volume::AttachVolumeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_attach_volume::de_attach_volume_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_volume::AttachVolumeError {
