...
impl DescribePublicIpv4PoolsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_public_ipv4_pools::DescribePublicIpv4PoolsInput, ::aws_smithy_http::operation::error::BuildError> {
