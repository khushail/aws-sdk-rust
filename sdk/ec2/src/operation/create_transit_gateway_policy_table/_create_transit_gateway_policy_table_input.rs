...
impl CreateTransitGatewayPolicyTableInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_transit_gateway_policy_table::CreateTransitGatewayPolicyTableInput, ::aws_smithy_http::operation::error::BuildError> {
