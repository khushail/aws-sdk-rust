...
impl CreateReplaceRootVolumeTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_replace_root_volume_task::CreateReplaceRootVolumeTaskInput, ::aws_smithy_http::operation::error::BuildError> {
