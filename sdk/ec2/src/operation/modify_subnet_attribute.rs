...
impl ModifySubnetAttributeInput {
    /// Consumes the builder and constructs an Operation<[`ModifySubnetAttribute`](crate::operation::modify_subnet_attribute::ModifySubnetAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_subnet_attribute::ModifySubnetAttribute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_subnet_attribute::ModifySubnetAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_subnet_attribute_input::ser_modify_subnet_attribute_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_subnet_attribute::ModifySubnetAttribute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifySubnetAttribute", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifySubnetAttribute {
                type Output = ::std::result::Result<crate::operation::modify_subnet_attribute::ModifySubnetAttributeOutput, crate::operation::modify_subnet_attribute::ModifySubnetAttributeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_modify_subnet_attribute::de_modify_subnet_attribute_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ModifySubnetAttributeErrorKind = ModifySubnetAttributeError;
/// Error type for the `ModifySubnetAttributeError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifySubnetAttributeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifySubnetAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_subnet_attribute::ModifySubnetAttributeError {
...
impl ModifySubnetAttributeError {
    /// Creates the `ModifySubnetAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifySubnetAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _modify_subnet_attribute_output;
