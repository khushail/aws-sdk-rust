...
impl DescribeIpamResourceDiscoveriesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_ipam_resource_discoveries::DescribeIpamResourceDiscoveriesInput, ::aws_smithy_http::operation::error::BuildError> {
