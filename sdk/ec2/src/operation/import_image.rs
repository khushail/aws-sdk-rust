...
impl ImportImageInput {
    /// Consumes the builder and constructs an Operation<[`ImportImage`](crate::operation::import_image::ImportImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_image::ImportImage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_image::ImportImageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_import_image_input::ser_import_image_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_image::ImportImage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ImportImage", "ec2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ImportImage`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportImage {
                type Output = ::std::result::Result<crate::operation::import_image::ImportImageOutput, crate::operation::import_image::ImportImageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_import_image::de_import_image_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_import_image::de_import_image_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ImportImageErrorKind = ImportImageError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for ImportImageError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ImportImageError {
...
impl ::aws_http::request_id::RequestId for crate::operation::import_image::ImportImageError {
...
impl ImportImageError {
    /// Creates the `ImportImageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ImportImageError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
