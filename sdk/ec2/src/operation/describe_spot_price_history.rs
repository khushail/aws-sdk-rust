...
impl DescribeSpotPriceHistoryInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSpotPriceHistory`](crate::operation::describe_spot_price_history::DescribeSpotPriceHistory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_spot_price_history::DescribeSpotPriceHistory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_spot_price_history::DescribeSpotPriceHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_spot_price_history_input::ser_describe_spot_price_history_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_spot_price_history::DescribeSpotPriceHistory::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeSpotPriceHistory", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSpotPriceHistory {
                type Output = ::std::result::Result<crate::operation::describe_spot_price_history::DescribeSpotPriceHistoryOutput, crate::operation::describe_spot_price_history::DescribeSpotPriceHistoryError>;
...
/// Do not use this.
            ...
            pub type DescribeSpotPriceHistoryErrorKind = DescribeSpotPriceHistoryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSpotPriceHistoryError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeSpotPriceHistoryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_spot_price_history::DescribeSpotPriceHistoryError {
...
impl DescribeSpotPriceHistoryError {
    /// Creates the `DescribeSpotPriceHistoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeSpotPriceHistoryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
