...
impl StartNetworkInsightsAnalysisInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_network_insights_analysis::StartNetworkInsightsAnalysisInput, ::aws_smithy_http::operation::error::BuildError> {
