...
impl CreateDhcpOptionsInput {
    /// Consumes the builder and constructs an Operation<[`CreateDhcpOptions`](crate::operation::create_dhcp_options::CreateDhcpOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_dhcp_options::CreateDhcpOptions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_dhcp_options::CreateDhcpOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_dhcp_options_input::ser_create_dhcp_options_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_dhcp_options::CreateDhcpOptions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDhcpOptions", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDhcpOptions {
                type Output = ::std::result::Result<crate::operation::create_dhcp_options::CreateDhcpOptionsOutput, crate::operation::create_dhcp_options::CreateDhcpOptionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_dhcp_options::de_create_dhcp_options_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateDhcpOptionsErrorKind = CreateDhcpOptionsError;
/// Error type for the `CreateDhcpOptionsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateDhcpOptionsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateDhcpOptionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_dhcp_options::CreateDhcpOptionsError {
...
impl CreateDhcpOptionsError {
    /// Creates the `CreateDhcpOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateDhcpOptionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _create_dhcp_options_output;
