...
impl RestoreSnapshotFromRecycleBinInput {
    /// Consumes the builder and constructs an Operation<[`RestoreSnapshotFromRecycleBin`](crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBin)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBin, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBinInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_restore_snapshot_from_recycle_bin_input::ser_restore_snapshot_from_recycle_bin_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBin::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RestoreSnapshotFromRecycleBin", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreSnapshotFromRecycleBin {
                type Output = ::std::result::Result<crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBinOutput, crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBinError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_restore_snapshot_from_recycle_bin::de_restore_snapshot_from_recycle_bin_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type RestoreSnapshotFromRecycleBinErrorKind = RestoreSnapshotFromRecycleBinError;
/// Error type for the `RestoreSnapshotFromRecycleBinError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum RestoreSnapshotFromRecycleBinError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for RestoreSnapshotFromRecycleBinError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RestoreSnapshotFromRecycleBinError {
...
impl ::aws_http::request_id::RequestId for crate::operation::restore_snapshot_from_recycle_bin::RestoreSnapshotFromRecycleBinError {
...
impl RestoreSnapshotFromRecycleBinError {
    /// Creates the `RestoreSnapshotFromRecycleBinError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RestoreSnapshotFromRecycleBinError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
