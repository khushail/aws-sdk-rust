...
impl DescribeFastLaunchImagesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_fast_launch_images::DescribeFastLaunchImagesInput, ::aws_smithy_http::operation::error::BuildError> {
