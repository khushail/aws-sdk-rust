...
impl ApplySecurityGroupsToClientVpnTargetNetworkInput {
    /// Consumes the builder and constructs an Operation<[`ApplySecurityGroupsToClientVpnTargetNetwork`](crate::operation::apply_security_groups_to_client_vpn_target_network::ApplySecurityGroupsToClientVpnTargetNetwork)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::apply_security_groups_to_client_vpn_target_network::ApplySecurityGroupsToClientVpnTargetNetwork, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::apply_security_groups_to_client_vpn_target_network::ApplySecurityGroupsToClientVpnTargetNetworkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_apply_security_groups_to_client_vpn_target_network_input::ser_apply_security_groups_to_client_vpn_target_network_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::apply_security_groups_to_client_vpn_target_network::ApplySecurityGroupsToClientVpnTargetNetwork::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ApplySecurityGroupsToClientVpnTargetNetwork", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ApplySecurityGroupsToClientVpnTargetNetwork {
                type Output = ::std::result::Result<crate::operation::apply_security_groups_to_client_vpn_target_network::ApplySecurityGroupsToClientVpnTargetNetworkOutput, crate::operation::apply_security_groups_to_client_vpn_target_network::ApplySecurityGroupsToClientVpnTargetNetworkError>;
...
/// Do not use this.
            ...
            pub type ApplySecurityGroupsToClientVpnTargetNetworkErrorKind = ApplySecurityGroupsToClientVpnTargetNetworkError;
/// Error type for the `ApplySecurityGroupsToClientVpnTargetNetworkError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ApplySecurityGroupsToClientVpnTargetNetworkError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ApplySecurityGroupsToClientVpnTargetNetworkError {
...
impl ::aws_http::request_id::RequestId for crate::operation::apply_security_groups_to_client_vpn_target_network::ApplySecurityGroupsToClientVpnTargetNetworkError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for ApplySecurityGroupsToClientVpnTargetNetworkError {
...
impl ApplySecurityGroupsToClientVpnTargetNetworkError {
    /// Creates the `ApplySecurityGroupsToClientVpnTargetNetworkError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ApplySecurityGroupsToClientVpnTargetNetworkError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
