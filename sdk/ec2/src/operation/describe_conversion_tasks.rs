...
impl DescribeConversionTasksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeConversionTasks`](crate::operation::describe_conversion_tasks::DescribeConversionTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_conversion_tasks::DescribeConversionTasks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_conversion_tasks::DescribeConversionTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_conversion_tasks_input::ser_describe_conversion_tasks_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_conversion_tasks::DescribeConversionTasks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeConversionTasks", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeConversionTasks {
                type Output = ::std::result::Result<crate::operation::describe_conversion_tasks::DescribeConversionTasksOutput, crate::operation::describe_conversion_tasks::DescribeConversionTasksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_conversion_tasks::de_describe_conversion_tasks_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeConversionTasksErrorKind = DescribeConversionTasksError;
/// Error type for the `DescribeConversionTasksError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeConversionTasksError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeConversionTasksError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_conversion_tasks::DescribeConversionTasksError {
...
impl DescribeConversionTasksError {
    /// Creates the `DescribeConversionTasksError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeConversionTasksError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _describe_conversion_tasks_output;
