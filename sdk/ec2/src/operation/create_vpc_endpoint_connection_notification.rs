...
impl CreateVpcEndpointConnectionNotificationInput {
    /// Consumes the builder and constructs an Operation<[`CreateVpcEndpointConnectionNotification`](crate::operation::create_vpc_endpoint_connection_notification::CreateVpcEndpointConnectionNotification)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_vpc_endpoint_connection_notification::CreateVpcEndpointConnectionNotification, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_vpc_endpoint_connection_notification::CreateVpcEndpointConnectionNotificationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_vpc_endpoint_connection_notification_input::ser_create_vpc_endpoint_connection_notification_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_vpc_endpoint_connection_notification::CreateVpcEndpointConnectionNotification::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateVpcEndpointConnectionNotification", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVpcEndpointConnectionNotification {
                type Output = ::std::result::Result<crate::operation::create_vpc_endpoint_connection_notification::CreateVpcEndpointConnectionNotificationOutput, crate::operation::create_vpc_endpoint_connection_notification::CreateVpcEndpointConnectionNotificationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_vpc_endpoint_connection_notification::de_create_vpc_endpoint_connection_notification_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_vpc_endpoint_connection_notification::de_create_vpc_endpoint_connection_notification_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateVpcEndpointConnectionNotificationErrorKind = CreateVpcEndpointConnectionNotificationError;
/// Error type for the `CreateVpcEndpointConnectionNotificationError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateVpcEndpointConnectionNotificationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateVpcEndpointConnectionNotificationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_vpc_endpoint_connection_notification::CreateVpcEndpointConnectionNotificationError {
...
impl CreateVpcEndpointConnectionNotificationError {
    /// Creates the `CreateVpcEndpointConnectionNotificationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateVpcEndpointConnectionNotificationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
