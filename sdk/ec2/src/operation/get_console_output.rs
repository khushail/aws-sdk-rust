...
impl GetConsoleOutputInput {
    /// Consumes the builder and constructs an Operation<[`GetConsoleOutput`](crate::operation::get_console_output::GetConsoleOutput)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_console_output::GetConsoleOutput, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_console_output::GetConsoleOutputInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_console_output_input::ser_get_console_output_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_console_output::GetConsoleOutput::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetConsoleOutput", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetConsoleOutput {
                type Output = ::std::result::Result<crate::operation::get_console_output::GetConsoleOutputOutput, crate::operation::get_console_output::GetConsoleOutputError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_console_output::de_get_console_output_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_console_output::de_get_console_output_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetConsoleOutputErrorKind = GetConsoleOutputError;
/// Error type for the `GetConsoleOutputError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetConsoleOutputError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetConsoleOutputError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_console_output::GetConsoleOutputError {
...
impl GetConsoleOutputError {
    /// Creates the `GetConsoleOutputError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetConsoleOutputError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _get_console_output_output;
