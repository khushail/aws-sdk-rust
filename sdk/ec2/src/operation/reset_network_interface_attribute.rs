...
impl ResetNetworkInterfaceAttributeInput {
    /// Consumes the builder and constructs an Operation<[`ResetNetworkInterfaceAttribute`](crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttribute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_network_interface_attribute_input::ser_reset_network_interface_attribute_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttribute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResetNetworkInterfaceAttribute", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetNetworkInterfaceAttribute {
                type Output = ::std::result::Result<crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeOutput, crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_reset_network_interface_attribute::de_reset_network_interface_attribute_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ResetNetworkInterfaceAttributeErrorKind = ResetNetworkInterfaceAttributeError;
/// Error type for the `ResetNetworkInterfaceAttributeError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ResetNetworkInterfaceAttributeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ResetNetworkInterfaceAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_network_interface_attribute::ResetNetworkInterfaceAttributeError {
...
impl ResetNetworkInterfaceAttributeError {
    /// Creates the `ResetNetworkInterfaceAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResetNetworkInterfaceAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
