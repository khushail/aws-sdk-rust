...
impl RestoreAddressToClassicInput {
    /// Consumes the builder and constructs an Operation<[`RestoreAddressToClassic`](crate::operation::restore_address_to_classic::RestoreAddressToClassic)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::restore_address_to_classic::RestoreAddressToClassic, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_address_to_classic::RestoreAddressToClassicInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_restore_address_to_classic_input::ser_restore_address_to_classic_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::restore_address_to_classic::RestoreAddressToClassic::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RestoreAddressToClassic", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreAddressToClassic {
                type Output = ::std::result::Result<crate::operation::restore_address_to_classic::RestoreAddressToClassicOutput, crate::operation::restore_address_to_classic::RestoreAddressToClassicError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_restore_address_to_classic::de_restore_address_to_classic_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type RestoreAddressToClassicErrorKind = RestoreAddressToClassicError;
/// Error type for the `RestoreAddressToClassicError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for RestoreAddressToClassicError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RestoreAddressToClassicError {
...
impl ::aws_http::request_id::RequestId for crate::operation::restore_address_to_classic::RestoreAddressToClassicError {
...
impl RestoreAddressToClassicError {
    /// Creates the `RestoreAddressToClassicError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RestoreAddressToClassicError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
