...
impl DescribeNetworkInterfaceAttributeInput {
    /// Consumes the builder and constructs an Operation<[`DescribeNetworkInterfaceAttribute`](crate::operation::describe_network_interface_attribute::DescribeNetworkInterfaceAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_network_interface_attribute::DescribeNetworkInterfaceAttribute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_network_interface_attribute::DescribeNetworkInterfaceAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_network_interface_attribute_input::ser_describe_network_interface_attribute_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_network_interface_attribute::DescribeNetworkInterfaceAttribute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeNetworkInterfaceAttribute", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNetworkInterfaceAttribute {
                type Output = ::std::result::Result<crate::operation::describe_network_interface_attribute::DescribeNetworkInterfaceAttributeOutput, crate::operation::describe_network_interface_attribute::DescribeNetworkInterfaceAttributeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_network_interface_attribute::de_describe_network_interface_attribute_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_network_interface_attribute::de_describe_network_interface_attribute_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeNetworkInterfaceAttributeErrorKind = DescribeNetworkInterfaceAttributeError;
/// Error type for the `DescribeNetworkInterfaceAttributeError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeNetworkInterfaceAttributeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeNetworkInterfaceAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_network_interface_attribute::DescribeNetworkInterfaceAttributeError {
...
impl DescribeNetworkInterfaceAttributeError {
    /// Creates the `DescribeNetworkInterfaceAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeNetworkInterfaceAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
