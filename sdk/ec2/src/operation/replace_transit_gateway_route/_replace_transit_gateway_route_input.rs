...
impl ReplaceTransitGatewayRouteInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteInput, ::aws_smithy_http::operation::error::BuildError> {
