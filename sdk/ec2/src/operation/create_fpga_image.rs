...
impl CreateFpgaImageInput {
    /// Consumes the builder and constructs an Operation<[`CreateFpgaImage`](crate::operation::create_fpga_image::CreateFpgaImage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_fpga_image::CreateFpgaImage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_fpga_image::CreateFpgaImageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_fpga_image_input::ser_create_fpga_image_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_fpga_image::CreateFpgaImage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateFpgaImage", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFpgaImage {
                type Output = ::std::result::Result<crate::operation::create_fpga_image::CreateFpgaImageOutput, crate::operation::create_fpga_image::CreateFpgaImageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_fpga_image::de_create_fpga_image_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateFpgaImageErrorKind = CreateFpgaImageError;
/// Error type for the `CreateFpgaImageError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateFpgaImageError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_fpga_image::CreateFpgaImageError {
...
impl CreateFpgaImageError {
    /// Creates the `CreateFpgaImageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateFpgaImageError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
