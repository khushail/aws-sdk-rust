...
impl DescribeSpotDatafeedSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSpotDatafeedSubscription`](crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscription, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_spot_datafeed_subscription_input::ser_describe_spot_datafeed_subscription_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscription::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeSpotDatafeedSubscription", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSpotDatafeedSubscription {
                type Output = ::std::result::Result<crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscriptionOutput, crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscriptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_spot_datafeed_subscription::de_describe_spot_datafeed_subscription_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeSpotDatafeedSubscriptionErrorKind = DescribeSpotDatafeedSubscriptionError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSpotDatafeedSubscriptionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeSpotDatafeedSubscriptionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_spot_datafeed_subscription::DescribeSpotDatafeedSubscriptionError {
...
impl DescribeSpotDatafeedSubscriptionError {
    /// Creates the `DescribeSpotDatafeedSubscriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeSpotDatafeedSubscriptionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _describe_spot_datafeed_subscription_output;
