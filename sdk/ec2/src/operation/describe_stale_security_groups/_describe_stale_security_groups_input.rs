...
impl DescribeStaleSecurityGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_stale_security_groups::DescribeStaleSecurityGroupsInput, ::aws_smithy_http::operation::error::BuildError> {
