...
impl ModifySnapshotAttributeInput {
    /// Consumes the builder and constructs an Operation<[`ModifySnapshotAttribute`](crate::operation::modify_snapshot_attribute::ModifySnapshotAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_snapshot_attribute::ModifySnapshotAttribute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_snapshot_attribute::ModifySnapshotAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_snapshot_attribute_input::ser_modify_snapshot_attribute_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_snapshot_attribute::ModifySnapshotAttribute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifySnapshotAttribute", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifySnapshotAttribute {
                type Output = ::std::result::Result<crate::operation::modify_snapshot_attribute::ModifySnapshotAttributeOutput, crate::operation::modify_snapshot_attribute::ModifySnapshotAttributeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_modify_snapshot_attribute::de_modify_snapshot_attribute_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ModifySnapshotAttributeErrorKind = ModifySnapshotAttributeError;
/// Error type for the `ModifySnapshotAttributeError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifySnapshotAttributeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifySnapshotAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_snapshot_attribute::ModifySnapshotAttributeError {
...
impl ModifySnapshotAttributeError {
    /// Creates the `ModifySnapshotAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifySnapshotAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _modify_snapshot_attribute_output;
