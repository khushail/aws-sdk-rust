...
impl DescribeAvailabilityZonesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_availability_zones::DescribeAvailabilityZonesInput, ::aws_smithy_http::operation::error::BuildError> {
