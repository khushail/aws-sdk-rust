...
impl GetSpotPlacementScoresInput {
    /// Consumes the builder and constructs an Operation<[`GetSpotPlacementScores`](crate::operation::get_spot_placement_scores::GetSpotPlacementScores)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_spot_placement_scores::GetSpotPlacementScores, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_spot_placement_scores::GetSpotPlacementScoresInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_spot_placement_scores_input::ser_get_spot_placement_scores_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_spot_placement_scores::GetSpotPlacementScores::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSpotPlacementScores", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSpotPlacementScores {
                type Output = ::std::result::Result<crate::operation::get_spot_placement_scores::GetSpotPlacementScoresOutput, crate::operation::get_spot_placement_scores::GetSpotPlacementScoresError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_spot_placement_scores::de_get_spot_placement_scores_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetSpotPlacementScoresErrorKind = GetSpotPlacementScoresError;
/// Error type for the `GetSpotPlacementScoresError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetSpotPlacementScoresError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for GetSpotPlacementScoresError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetSpotPlacementScoresError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_spot_placement_scores::GetSpotPlacementScoresError {
...
impl GetSpotPlacementScoresError {
    /// Creates the `GetSpotPlacementScoresError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetSpotPlacementScoresError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
