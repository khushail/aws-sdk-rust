...
impl RestoreAddressToClassicInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_address_to_classic::RestoreAddressToClassicInput, ::aws_smithy_http::operation::error::BuildError> {
