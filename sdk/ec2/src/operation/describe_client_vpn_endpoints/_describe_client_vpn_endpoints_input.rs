...
impl DescribeClientVpnEndpointsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_client_vpn_endpoints::DescribeClientVpnEndpointsInput, ::aws_smithy_http::operation::error::BuildError> {
