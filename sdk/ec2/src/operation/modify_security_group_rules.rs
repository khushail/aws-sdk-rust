...
impl ModifySecurityGroupRulesInput {
    /// Consumes the builder and constructs an Operation<[`ModifySecurityGroupRules`](crate::operation::modify_security_group_rules::ModifySecurityGroupRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_security_group_rules::ModifySecurityGroupRules, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_security_group_rules::ModifySecurityGroupRulesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::modify_security_group_rules::ModifySecurityGroupRulesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_security_group_rules_input::ser_modify_security_group_rules_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_security_group_rules::ModifySecurityGroupRules::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifySecurityGroupRules", "ec2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifySecurityGroupRules`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifySecurityGroupRules {
                type Output = ::std::result::Result<crate::operation::modify_security_group_rules::ModifySecurityGroupRulesOutput, crate::operation::modify_security_group_rules::ModifySecurityGroupRulesError>;
...
/// Do not use this.
            ...
            pub type ModifySecurityGroupRulesErrorKind = ModifySecurityGroupRulesError;
/// Error type for the `ModifySecurityGroupRulesError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ModifySecurityGroupRulesError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for ModifySecurityGroupRulesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifySecurityGroupRulesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_security_group_rules::ModifySecurityGroupRulesError {
...
impl ModifySecurityGroupRulesError {
    /// Creates the `ModifySecurityGroupRulesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifySecurityGroupRulesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _modify_security_group_rules_output;
