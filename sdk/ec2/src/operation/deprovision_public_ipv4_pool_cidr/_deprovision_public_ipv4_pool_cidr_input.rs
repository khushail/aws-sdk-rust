...
impl DeprovisionPublicIpv4PoolCidrInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deprovision_public_ipv4_pool_cidr::DeprovisionPublicIpv4PoolCidrInput, ::aws_smithy_http::operation::error::BuildError> {
