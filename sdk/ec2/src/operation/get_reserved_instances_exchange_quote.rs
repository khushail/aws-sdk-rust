...
impl GetReservedInstancesExchangeQuoteInput {
    /// Consumes the builder and constructs an Operation<[`GetReservedInstancesExchangeQuote`](crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuote)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuote, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_reserved_instances_exchange_quote_input::ser_get_reserved_instances_exchange_quote_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuote::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetReservedInstancesExchangeQuote", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReservedInstancesExchangeQuote {
                type Output = ::std::result::Result<crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteOutput, crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteError>;
...
/// Do not use this.
            ...
            pub type GetReservedInstancesExchangeQuoteErrorKind = GetReservedInstancesExchangeQuoteError;
/// Error type for the `GetReservedInstancesExchangeQuoteError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetReservedInstancesExchangeQuoteError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetReservedInstancesExchangeQuoteError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_reserved_instances_exchange_quote::GetReservedInstancesExchangeQuoteError {
...
impl GetReservedInstancesExchangeQuoteError {
    /// Creates the `GetReservedInstancesExchangeQuoteError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetReservedInstancesExchangeQuoteError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
