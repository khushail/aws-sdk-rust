...
impl DescribeManagedPrefixListsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_managed_prefix_lists::DescribeManagedPrefixListsInput, ::aws_smithy_http::operation::error::BuildError> {
