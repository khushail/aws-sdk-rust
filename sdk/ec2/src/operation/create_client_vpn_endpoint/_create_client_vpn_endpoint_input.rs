...
impl CreateClientVpnEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_client_vpn_endpoint::CreateClientVpnEndpointInput, ::aws_smithy_http::operation::error::BuildError> {
