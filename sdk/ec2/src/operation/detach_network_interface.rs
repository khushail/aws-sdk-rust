...
impl DetachNetworkInterfaceInput {
    /// Consumes the builder and constructs an Operation<[`DetachNetworkInterface`](crate::operation::detach_network_interface::DetachNetworkInterface)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::detach_network_interface::DetachNetworkInterface, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_network_interface::DetachNetworkInterfaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_detach_network_interface_input::ser_detach_network_interface_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detach_network_interface::DetachNetworkInterface::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetachNetworkInterface", "ec2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DetachNetworkInterface`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachNetworkInterface {
                type Output = ::std::result::Result<crate::operation::detach_network_interface::DetachNetworkInterfaceOutput, crate::operation::detach_network_interface::DetachNetworkInterfaceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_detach_network_interface::de_detach_network_interface_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_detach_network_interface::de_detach_network_interface_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DetachNetworkInterfaceErrorKind = DetachNetworkInterfaceError;
/// Error type for the `DetachNetworkInterfaceError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DetachNetworkInterfaceError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DetachNetworkInterfaceError {
...
impl ::aws_http::request_id::RequestId for crate::operation::detach_network_interface::DetachNetworkInterfaceError {
...
impl DetachNetworkInterfaceError {
    /// Creates the `DetachNetworkInterfaceError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DetachNetworkInterfaceError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
