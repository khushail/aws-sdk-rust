...
impl CreateNatGatewayInput {
    /// Consumes the builder and constructs an Operation<[`CreateNatGateway`](crate::operation::create_nat_gateway::CreateNatGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_nat_gateway::CreateNatGateway, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_nat_gateway::CreateNatGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_nat_gateway_input::ser_create_nat_gateway_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_nat_gateway::CreateNatGateway::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateNatGateway", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateNatGateway {
                type Output = ::std::result::Result<crate::operation::create_nat_gateway::CreateNatGatewayOutput, crate::operation::create_nat_gateway::CreateNatGatewayError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_nat_gateway::de_create_nat_gateway_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateNatGatewayErrorKind = CreateNatGatewayError;
/// Error type for the `CreateNatGatewayError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateNatGatewayError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateNatGatewayError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_nat_gateway::CreateNatGatewayError {
...
impl CreateNatGatewayError {
    /// Creates the `CreateNatGatewayError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateNatGatewayError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
