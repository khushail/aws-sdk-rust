...
impl ModifyIpamResourceDiscoveryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_ipam_resource_discovery::ModifyIpamResourceDiscoveryInput, ::aws_smithy_http::operation::error::BuildError> {
