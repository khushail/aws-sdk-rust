...
impl EnableFastSnapshotRestoresInput {
    /// Consumes the builder and constructs an Operation<[`EnableFastSnapshotRestores`](crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestores)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestores, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestoresInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_fast_snapshot_restores_input::ser_enable_fast_snapshot_restores_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestores::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("EnableFastSnapshotRestores", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableFastSnapshotRestores {
                type Output = ::std::result::Result<crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestoresOutput, crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestoresError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_enable_fast_snapshot_restores::de_enable_fast_snapshot_restores_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type EnableFastSnapshotRestoresErrorKind = EnableFastSnapshotRestoresError;
/// Error type for the `EnableFastSnapshotRestoresError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for EnableFastSnapshotRestoresError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnableFastSnapshotRestoresError {
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_fast_snapshot_restores::EnableFastSnapshotRestoresError {
...
impl EnableFastSnapshotRestoresError {
    /// Creates the `EnableFastSnapshotRestoresError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `EnableFastSnapshotRestoresError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
