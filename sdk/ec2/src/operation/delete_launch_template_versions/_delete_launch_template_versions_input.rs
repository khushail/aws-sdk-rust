...
impl DeleteLaunchTemplateVersionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_launch_template_versions::DeleteLaunchTemplateVersionsInput, ::aws_smithy_http::operation::error::BuildError> {
