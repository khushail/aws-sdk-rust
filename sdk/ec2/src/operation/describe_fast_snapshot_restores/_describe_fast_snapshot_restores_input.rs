...
impl DescribeFastSnapshotRestoresInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_fast_snapshot_restores::DescribeFastSnapshotRestoresInput, ::aws_smithy_http::operation::error::BuildError> {
