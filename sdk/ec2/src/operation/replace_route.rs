...
impl ReplaceRouteInput {
    /// Consumes the builder and constructs an Operation<[`ReplaceRoute`](crate::operation::replace_route::ReplaceRoute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::replace_route::ReplaceRoute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::replace_route::ReplaceRouteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_replace_route_input::ser_replace_route_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::replace_route::ReplaceRoute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ReplaceRoute", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplaceRoute {
                type Output = ::std::result::Result<crate::operation::replace_route::ReplaceRouteOutput, crate::operation::replace_route::ReplaceRouteError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_replace_route::de_replace_route_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ReplaceRouteErrorKind = ReplaceRouteError;
/// Error type for the `ReplaceRouteError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ReplaceRouteError {
...
impl ::aws_http::request_id::RequestId for crate::operation::replace_route::ReplaceRouteError {
...
impl ReplaceRouteError {
    /// Creates the `ReplaceRouteError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReplaceRouteError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
