...
impl ListImagesInRecycleBinInput {
    /// Consumes the builder and constructs an Operation<[`ListImagesInRecycleBin`](crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBin)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBin, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBinInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBinInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_images_in_recycle_bin_input::ser_list_images_in_recycle_bin_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBin::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListImagesInRecycleBin", "ec2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListImagesInRecycleBin`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListImagesInRecycleBin {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_images_in_recycle_bin::de_list_images_in_recycle_bin_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListImagesInRecycleBinErrorKind = ListImagesInRecycleBinError;
/// Error type for the `ListImagesInRecycleBinError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ListImagesInRecycleBinError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for ListImagesInRecycleBinError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListImagesInRecycleBinError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_images_in_recycle_bin::ListImagesInRecycleBinError {
...
impl ListImagesInRecycleBinError {
    /// Creates the `ListImagesInRecycleBinError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListImagesInRecycleBinError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _list_images_in_recycle_bin_output;
