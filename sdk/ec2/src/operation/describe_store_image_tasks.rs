...
impl DescribeStoreImageTasksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeStoreImageTasks`](crate::operation::describe_store_image_tasks::DescribeStoreImageTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_store_image_tasks::DescribeStoreImageTasks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_store_image_tasks::DescribeStoreImageTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_store_image_tasks_input::ser_describe_store_image_tasks_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_store_image_tasks::DescribeStoreImageTasks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeStoreImageTasks", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStoreImageTasks {
                type Output = ::std::result::Result<crate::operation::describe_store_image_tasks::DescribeStoreImageTasksOutput, crate::operation::describe_store_image_tasks::DescribeStoreImageTasksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_store_image_tasks::de_describe_store_image_tasks_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeStoreImageTasksErrorKind = DescribeStoreImageTasksError;
/// Error type for the `DescribeStoreImageTasksError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DescribeStoreImageTasksError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeStoreImageTasksError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeStoreImageTasksError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_store_image_tasks::DescribeStoreImageTasksError {
...
impl DescribeStoreImageTasksError {
    /// Creates the `DescribeStoreImageTasksError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeStoreImageTasksError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
