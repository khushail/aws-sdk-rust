...
impl DeleteVerifiedAccessTrustProviderInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_verified_access_trust_provider::DeleteVerifiedAccessTrustProviderInput, ::aws_smithy_http::operation::error::BuildError> {
