...
impl ModifyFleetInput {
    /// Consumes the builder and constructs an Operation<[`ModifyFleet`](crate::operation::modify_fleet::ModifyFleet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_fleet::ModifyFleet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_fleet::ModifyFleetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_fleet_input::ser_modify_fleet_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_fleet::ModifyFleet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyFleet", "ec2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifyFleet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyFleet {
                type Output = ::std::result::Result<crate::operation::modify_fleet::ModifyFleetOutput, crate::operation::modify_fleet::ModifyFleetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_fleet::de_modify_fleet_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_fleet::de_modify_fleet_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ModifyFleetErrorKind = ModifyFleetError;
/// Error type for the `ModifyFleetError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyFleetError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyFleetError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_fleet::ModifyFleetError {
...
impl ModifyFleetError {
    /// Creates the `ModifyFleetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyFleetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
