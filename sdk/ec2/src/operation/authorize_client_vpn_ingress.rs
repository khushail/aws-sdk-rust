...
impl AuthorizeClientVpnIngressInput {
    /// Consumes the builder and constructs an Operation<[`AuthorizeClientVpnIngress`](crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngress)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngress, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_authorize_client_vpn_ingress_input::ser_authorize_client_vpn_ingress_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngress::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AuthorizeClientVpnIngress", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AuthorizeClientVpnIngress {
                type Output = ::std::result::Result<crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressOutput, crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressError>;
...
/// Do not use this.
            ...
            pub type AuthorizeClientVpnIngressErrorKind = AuthorizeClientVpnIngressError;
/// Error type for the `AuthorizeClientVpnIngressError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for AuthorizeClientVpnIngressError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AuthorizeClientVpnIngressError {
...
impl ::aws_http::request_id::RequestId for crate::operation::authorize_client_vpn_ingress::AuthorizeClientVpnIngressError {
...
impl AuthorizeClientVpnIngressError {
    /// Creates the `AuthorizeClientVpnIngressError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AuthorizeClientVpnIngressError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
