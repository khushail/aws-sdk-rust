...
impl DeleteSubnetCidrReservationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSubnetCidrReservation`](crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_subnet_cidr_reservation_input::ser_delete_subnet_cidr_reservation_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteSubnetCidrReservation", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSubnetCidrReservation {
                type Output = ::std::result::Result<crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservationOutput, crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_subnet_cidr_reservation::de_delete_subnet_cidr_reservation_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteSubnetCidrReservationErrorKind = DeleteSubnetCidrReservationError;
/// Error type for the `DeleteSubnetCidrReservationError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteSubnetCidrReservationError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteSubnetCidrReservationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteSubnetCidrReservationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_subnet_cidr_reservation::DeleteSubnetCidrReservationError {
...
impl DeleteSubnetCidrReservationError {
    /// Creates the `DeleteSubnetCidrReservationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteSubnetCidrReservationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
