...
impl DescribeSpotInstanceRequestsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_spot_instance_requests::DescribeSpotInstanceRequestsInput, ::aws_smithy_http::operation::error::BuildError> {
