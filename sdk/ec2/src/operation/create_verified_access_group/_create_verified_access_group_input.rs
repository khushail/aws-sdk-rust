...
impl CreateVerifiedAccessGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_verified_access_group::CreateVerifiedAccessGroupInput, ::aws_smithy_http::operation::error::BuildError> {
