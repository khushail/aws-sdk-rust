...
impl DescribeIpv6PoolsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeIpv6Pools`](crate::operation::describe_ipv6_pools::DescribeIpv6Pools)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_ipv6_pools::DescribeIpv6Pools, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_ipv6_pools::DescribeIpv6PoolsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_ipv6_pools_input::ser_describe_ipv6_pools_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_ipv6_pools::DescribeIpv6Pools::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeIpv6Pools", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIpv6Pools {
                type Output = ::std::result::Result<crate::operation::describe_ipv6_pools::DescribeIpv6PoolsOutput, crate::operation::describe_ipv6_pools::DescribeIpv6PoolsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_ipv6_pools::de_describe_ipv6_pools_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_ipv6_pools::de_describe_ipv6_pools_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeIpv6PoolsErrorKind = DescribeIpv6PoolsError;
/// Error type for the `DescribeIpv6PoolsError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DescribeIpv6PoolsError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeIpv6PoolsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeIpv6PoolsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_ipv6_pools::DescribeIpv6PoolsError {
...
impl DescribeIpv6PoolsError {
    /// Creates the `DescribeIpv6PoolsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeIpv6PoolsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _describe_ipv6_pools_output;
