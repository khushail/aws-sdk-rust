...
impl DescribeTrafficMirrorSessionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_traffic_mirror_sessions::DescribeTrafficMirrorSessionsInput, ::aws_smithy_http::operation::error::BuildError> {
