...
impl DescribeNetworkInsightsAnalysesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeNetworkInsightsAnalyses`](crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalyses)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalyses, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalysesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_network_insights_analyses_input::ser_describe_network_insights_analyses_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalyses::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeNetworkInsightsAnalyses", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNetworkInsightsAnalyses {
                type Output = ::std::result::Result<crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalysesOutput, crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalysesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_network_insights_analyses::de_describe_network_insights_analyses_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeNetworkInsightsAnalysesErrorKind = DescribeNetworkInsightsAnalysesError;
/// Error type for the `DescribeNetworkInsightsAnalysesError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DescribeNetworkInsightsAnalysesError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeNetworkInsightsAnalysesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeNetworkInsightsAnalysesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_network_insights_analyses::DescribeNetworkInsightsAnalysesError {
...
impl DescribeNetworkInsightsAnalysesError {
    /// Creates the `DescribeNetworkInsightsAnalysesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeNetworkInsightsAnalysesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
