...
impl RequestSpotFleetInput {
    /// Consumes the builder and constructs an Operation<[`RequestSpotFleet`](crate::operation::request_spot_fleet::RequestSpotFleet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::request_spot_fleet::RequestSpotFleet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::request_spot_fleet::RequestSpotFleetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_request_spot_fleet_input::ser_request_spot_fleet_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::request_spot_fleet::RequestSpotFleet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RequestSpotFleet", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RequestSpotFleet {
                type Output = ::std::result::Result<crate::operation::request_spot_fleet::RequestSpotFleetOutput, crate::operation::request_spot_fleet::RequestSpotFleetError>;
...
/// Do not use this.
            ...
            pub type RequestSpotFleetErrorKind = RequestSpotFleetError;
/// Error type for the `RequestSpotFleetError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for RequestSpotFleetError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RequestSpotFleetError {
...
impl ::aws_http::request_id::RequestId for crate::operation::request_spot_fleet::RequestSpotFleetError {
...
impl RequestSpotFleetError {
    /// Creates the `RequestSpotFleetError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RequestSpotFleetError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
pub use crate::operation::request_spot_fleet::_request_spot_fleet_output::RequestSpotFleetOutput;

pub use crate::operation::request_spot_fleet::_request_spot_fleet_input::RequestSpotFleetInput;

mod _request_spot_fleet_input;

mod _request_spot_fleet_output;
