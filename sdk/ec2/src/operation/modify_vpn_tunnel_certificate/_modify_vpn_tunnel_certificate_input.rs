...
impl ModifyVpnTunnelCertificateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_vpn_tunnel_certificate::ModifyVpnTunnelCertificateInput, ::aws_smithy_http::operation::error::BuildError> {
