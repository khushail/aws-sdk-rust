...
impl SearchTransitGatewayRoutesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_transit_gateway_routes::SearchTransitGatewayRoutesInput, ::aws_smithy_http::operation::error::BuildError> {
