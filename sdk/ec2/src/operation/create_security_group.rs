...
impl CreateSecurityGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateSecurityGroup`](crate::operation::create_security_group::CreateSecurityGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_security_group::CreateSecurityGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_security_group::CreateSecurityGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_security_group_input::ser_create_security_group_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_security_group::CreateSecurityGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateSecurityGroup", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSecurityGroup {
                type Output = ::std::result::Result<crate::operation::create_security_group::CreateSecurityGroupOutput, crate::operation::create_security_group::CreateSecurityGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_security_group::de_create_security_group_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateSecurityGroupErrorKind = CreateSecurityGroupError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateSecurityGroupError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_security_group::CreateSecurityGroupError {
...
impl CreateSecurityGroupError {
    /// Creates the `CreateSecurityGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateSecurityGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
