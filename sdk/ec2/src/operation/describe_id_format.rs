...
impl DescribeIdFormatInput {
    /// Consumes the builder and constructs an Operation<[`DescribeIdFormat`](crate::operation::describe_id_format::DescribeIdFormat)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_id_format::DescribeIdFormat, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_id_format::DescribeIdFormatInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_id_format_input::ser_describe_id_format_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_id_format::DescribeIdFormat::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeIdFormat", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIdFormat {
                type Output = ::std::result::Result<crate::operation::describe_id_format::DescribeIdFormatOutput, crate::operation::describe_id_format::DescribeIdFormatError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_id_format::de_describe_id_format_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_id_format::de_describe_id_format_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeIdFormatErrorKind = DescribeIdFormatError;
/// Error type for the `DescribeIdFormatError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeIdFormatError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeIdFormatError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_id_format::DescribeIdFormatError {
...
impl DescribeIdFormatError {
    /// Creates the `DescribeIdFormatError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeIdFormatError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _describe_id_format_output;
