...
impl PurchaseScheduledInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::purchase_scheduled_instances::PurchaseScheduledInstancesInput, ::aws_smithy_http::operation::error::BuildError> {
