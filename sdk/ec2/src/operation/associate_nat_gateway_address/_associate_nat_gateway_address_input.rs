...
impl AssociateNatGatewayAddressInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_nat_gateway_address::AssociateNatGatewayAddressInput, ::aws_smithy_http::operation::error::BuildError> {
