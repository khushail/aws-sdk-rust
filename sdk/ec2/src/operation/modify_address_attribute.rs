...
impl ModifyAddressAttributeInput {
    /// Consumes the builder and constructs an Operation<[`ModifyAddressAttribute`](crate::operation::modify_address_attribute::ModifyAddressAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_address_attribute::ModifyAddressAttribute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_address_attribute::ModifyAddressAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_address_attribute_input::ser_modify_address_attribute_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_address_attribute::ModifyAddressAttribute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyAddressAttribute", "ec2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifyAddressAttribute`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyAddressAttribute {
                type Output = ::std::result::Result<crate::operation::modify_address_attribute::ModifyAddressAttributeOutput, crate::operation::modify_address_attribute::ModifyAddressAttributeError>;
...
/// Do not use this.
            ...
            pub type ModifyAddressAttributeErrorKind = ModifyAddressAttributeError;
/// Error type for the `ModifyAddressAttributeError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ModifyAddressAttributeError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyAddressAttributeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyAddressAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_address_attribute::ModifyAddressAttributeError {
...
impl ModifyAddressAttributeError {
    /// Creates the `ModifyAddressAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyAddressAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _modify_address_attribute_output;
