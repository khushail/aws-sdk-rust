...
impl DeleteTransitGatewayPolicyTableInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_transit_gateway_policy_table::DeleteTransitGatewayPolicyTableInput, ::aws_smithy_http::operation::error::BuildError> {
