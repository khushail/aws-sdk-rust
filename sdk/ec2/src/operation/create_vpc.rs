...
impl CreateVpcInput {
    /// Consumes the builder and constructs an Operation<[`CreateVpc`](crate::operation::create_vpc::CreateVpc)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_vpc::CreateVpc, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_vpc::CreateVpcInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_vpc_input::ser_create_vpc_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_vpc::CreateVpc::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateVpc", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVpc {
                type Output = ::std::result::Result<crate::operation::create_vpc::CreateVpcOutput, crate::operation::create_vpc::CreateVpcError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_vpc::de_create_vpc_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateVpcErrorKind = CreateVpcError;
/// Error type for the `CreateVpcError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateVpcError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateVpcError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_vpc::CreateVpcError {
...
impl CreateVpcError {
    /// Creates the `CreateVpcError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateVpcError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
