...
impl CreateVpnConnectionRouteInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_vpn_connection_route::CreateVpnConnectionRouteInput, ::aws_smithy_http::operation::error::BuildError> {
