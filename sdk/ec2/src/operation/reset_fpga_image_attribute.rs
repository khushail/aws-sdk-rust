...
impl ResetFpgaImageAttributeInput {
    /// Consumes the builder and constructs an Operation<[`ResetFpgaImageAttribute`](crate::operation::reset_fpga_image_attribute::ResetFpgaImageAttribute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reset_fpga_image_attribute::ResetFpgaImageAttribute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_fpga_image_attribute::ResetFpgaImageAttributeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_fpga_image_attribute_input::ser_reset_fpga_image_attribute_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reset_fpga_image_attribute::ResetFpgaImageAttribute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResetFpgaImageAttribute", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetFpgaImageAttribute {
                type Output = ::std::result::Result<crate::operation::reset_fpga_image_attribute::ResetFpgaImageAttributeOutput, crate::operation::reset_fpga_image_attribute::ResetFpgaImageAttributeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_reset_fpga_image_attribute::de_reset_fpga_image_attribute_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ResetFpgaImageAttributeErrorKind = ResetFpgaImageAttributeError;
/// Error type for the `ResetFpgaImageAttributeError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ResetFpgaImageAttributeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ResetFpgaImageAttributeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_fpga_image_attribute::ResetFpgaImageAttributeError {
...
impl ResetFpgaImageAttributeError {
    /// Creates the `ResetFpgaImageAttributeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResetFpgaImageAttributeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _reset_fpga_image_attribute_output;
