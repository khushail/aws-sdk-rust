...
impl AssociateClientVpnTargetNetworkInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_client_vpn_target_network::AssociateClientVpnTargetNetworkInput, ::aws_smithy_http::operation::error::BuildError> {
