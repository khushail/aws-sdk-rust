...
impl UnassignPrivateIpAddressesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::unassign_private_ip_addresses::UnassignPrivateIpAddressesInput, ::aws_smithy_http::operation::error::BuildError> {
