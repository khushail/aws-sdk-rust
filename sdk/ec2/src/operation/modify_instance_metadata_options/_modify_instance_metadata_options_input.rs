...
impl ModifyInstanceMetadataOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_instance_metadata_options::ModifyInstanceMetadataOptionsInput, ::aws_smithy_http::operation::error::BuildError> {
