...
impl DescribeNetworkInterfacesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_network_interfaces::DescribeNetworkInterfacesInput, ::aws_smithy_http::operation::error::BuildError> {
