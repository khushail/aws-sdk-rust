...
impl DescribeAccountAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_account_attributes::DescribeAccountAttributesInput, ::aws_smithy_http::operation::error::BuildError> {
