...
impl DeleteInstanceConnectEndpointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_instance_connect_endpoint::DeleteInstanceConnectEndpointInput, ::aws_smithy_http::operation::error::BuildError> {
