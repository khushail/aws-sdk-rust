...
impl DescribeAvailabilityZonesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAvailabilityZones`](crate::operation::describe_availability_zones::DescribeAvailabilityZones)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_availability_zones::DescribeAvailabilityZones, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_availability_zones::DescribeAvailabilityZonesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_availability_zones_input::ser_describe_availability_zones_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_availability_zones::DescribeAvailabilityZones::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAvailabilityZones", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAvailabilityZones {
                type Output = ::std::result::Result<crate::operation::describe_availability_zones::DescribeAvailabilityZonesOutput, crate::operation::describe_availability_zones::DescribeAvailabilityZonesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_availability_zones::de_describe_availability_zones_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeAvailabilityZonesErrorKind = DescribeAvailabilityZonesError;
/// Error type for the `DescribeAvailabilityZonesError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeAvailabilityZonesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeAvailabilityZonesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_availability_zones::DescribeAvailabilityZonesError {
...
impl DescribeAvailabilityZonesError {
    /// Creates the `DescribeAvailabilityZonesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAvailabilityZonesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _describe_availability_zones_output;
