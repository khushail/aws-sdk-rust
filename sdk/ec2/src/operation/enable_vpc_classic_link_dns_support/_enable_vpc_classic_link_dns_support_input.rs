...
impl EnableVpcClassicLinkDnsSupportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::enable_vpc_classic_link_dns_support::EnableVpcClassicLinkDnsSupportInput, ::aws_smithy_http::operation::error::BuildError> {
