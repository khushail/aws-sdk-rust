...
impl DescribeImportImageTasksInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_import_image_tasks::DescribeImportImageTasksInput, ::aws_smithy_http::operation::error::BuildError> {
