...
impl ResetEbsDefaultKmsKeyIdInput {
    /// Consumes the builder and constructs an Operation<[`ResetEbsDefaultKmsKeyId`](crate::operation::reset_ebs_default_kms_key_id::ResetEbsDefaultKmsKeyId)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reset_ebs_default_kms_key_id::ResetEbsDefaultKmsKeyId, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_ebs_default_kms_key_id::ResetEbsDefaultKmsKeyIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_ebs_default_kms_key_id_input::ser_reset_ebs_default_kms_key_id_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reset_ebs_default_kms_key_id::ResetEbsDefaultKmsKeyId::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResetEbsDefaultKmsKeyId", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetEbsDefaultKmsKeyId {
                type Output = ::std::result::Result<crate::operation::reset_ebs_default_kms_key_id::ResetEbsDefaultKmsKeyIdOutput, crate::operation::reset_ebs_default_kms_key_id::ResetEbsDefaultKmsKeyIdError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_reset_ebs_default_kms_key_id::de_reset_ebs_default_kms_key_id_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ResetEbsDefaultKmsKeyIdErrorKind = ResetEbsDefaultKmsKeyIdError;
/// Error type for the `ResetEbsDefaultKmsKeyIdError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ResetEbsDefaultKmsKeyIdError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ResetEbsDefaultKmsKeyIdError {
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_ebs_default_kms_key_id::ResetEbsDefaultKmsKeyIdError {
...
impl ResetEbsDefaultKmsKeyIdError {
    /// Creates the `ResetEbsDefaultKmsKeyIdError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ResetEbsDefaultKmsKeyIdError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _reset_ebs_default_kms_key_id_output;
