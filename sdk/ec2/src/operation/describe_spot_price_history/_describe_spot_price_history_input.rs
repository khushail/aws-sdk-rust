...
impl DescribeSpotPriceHistoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_spot_price_history::DescribeSpotPriceHistoryInput, ::aws_smithy_http::operation::error::BuildError> {
