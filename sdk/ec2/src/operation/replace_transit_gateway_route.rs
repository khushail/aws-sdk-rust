...
impl ReplaceTransitGatewayRouteInput {
    /// Consumes the builder and constructs an Operation<[`ReplaceTransitGatewayRoute`](crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRoute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRoute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_replace_transit_gateway_route_input::ser_replace_transit_gateway_route_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRoute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ReplaceTransitGatewayRoute", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReplaceTransitGatewayRoute {
                type Output = ::std::result::Result<crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteOutput, crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_replace_transit_gateway_route::de_replace_transit_gateway_route_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ReplaceTransitGatewayRouteErrorKind = ReplaceTransitGatewayRouteError;
/// Error type for the `ReplaceTransitGatewayRouteError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ReplaceTransitGatewayRouteError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ReplaceTransitGatewayRouteError {
...
impl ::aws_http::request_id::RequestId for crate::operation::replace_transit_gateway_route::ReplaceTransitGatewayRouteError {
...
impl ReplaceTransitGatewayRouteError {
    /// Creates the `ReplaceTransitGatewayRouteError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ReplaceTransitGatewayRouteError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _replace_transit_gateway_route_output;
