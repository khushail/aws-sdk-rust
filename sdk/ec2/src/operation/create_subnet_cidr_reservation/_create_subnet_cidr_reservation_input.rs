...
impl CreateSubnetCidrReservationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_subnet_cidr_reservation::CreateSubnetCidrReservationInput, ::aws_smithy_http::operation::error::BuildError> {
