...
impl ModifyEbsDefaultKmsKeyIdInput {
    /// Consumes the builder and constructs an Operation<[`ModifyEbsDefaultKmsKeyId`](crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyId)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyId, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_ebs_default_kms_key_id_input::ser_modify_ebs_default_kms_key_id_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyId::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyEbsDefaultKmsKeyId", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyEbsDefaultKmsKeyId {
                type Output = ::std::result::Result<crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdOutput, crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_modify_ebs_default_kms_key_id::de_modify_ebs_default_kms_key_id_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ModifyEbsDefaultKmsKeyIdErrorKind = ModifyEbsDefaultKmsKeyIdError;
/// Error type for the `ModifyEbsDefaultKmsKeyIdError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyEbsDefaultKmsKeyIdError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyEbsDefaultKmsKeyIdError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_ebs_default_kms_key_id::ModifyEbsDefaultKmsKeyIdError {
...
impl ModifyEbsDefaultKmsKeyIdError {
    /// Creates the `ModifyEbsDefaultKmsKeyIdError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyEbsDefaultKmsKeyIdError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _modify_ebs_default_kms_key_id_output;
