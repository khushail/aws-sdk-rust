...
impl EnableTransitGatewayRouteTablePropagationInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::enable_transit_gateway_route_table_propagation::EnableTransitGatewayRouteTablePropagation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_transit_gateway_route_table_propagation::EnableTransitGatewayRouteTablePropagationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
