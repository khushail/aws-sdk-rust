...
impl DescribeSpotFleetRequestHistoryInput {
    /// Consumes the builder and constructs an Operation<[`DescribeSpotFleetRequestHistory`](crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_spot_fleet_request_history_input::ser_describe_spot_fleet_request_history_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistory::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeSpotFleetRequestHistory", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSpotFleetRequestHistory {
                type Output = ::std::result::Result<crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistoryOutput, crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistoryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_spot_fleet_request_history::de_describe_spot_fleet_request_history_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeSpotFleetRequestHistoryErrorKind = DescribeSpotFleetRequestHistoryError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeSpotFleetRequestHistoryError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeSpotFleetRequestHistoryError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_spot_fleet_request_history::DescribeSpotFleetRequestHistoryError {
...
impl DescribeSpotFleetRequestHistoryError {
    /// Creates the `DescribeSpotFleetRequestHistoryError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeSpotFleetRequestHistoryError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
