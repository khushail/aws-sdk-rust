...
impl CreateIpamScopeInput {
    /// Consumes the builder and constructs an Operation<[`CreateIpamScope`](crate::operation::create_ipam_scope::CreateIpamScope)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_ipam_scope::CreateIpamScope, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_ipam_scope::CreateIpamScopeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_ipam_scope_input::ser_create_ipam_scope_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_ipam_scope::CreateIpamScope::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateIpamScope", "ec2"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateIpamScope`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIpamScope {
                type Output = ::std::result::Result<crate::operation::create_ipam_scope::CreateIpamScopeOutput, crate::operation::create_ipam_scope::CreateIpamScopeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_ipam_scope::de_create_ipam_scope_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_ipam_scope::de_create_ipam_scope_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateIpamScopeErrorKind = CreateIpamScopeError;
/// Error type for the `CreateIpamScopeError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateIpamScopeError {
    /// An unexpected error occurred (e.g., invalid JSON returned by the service or an unknown error code).
                    Unhandled(::aws_smithy_types::error::Unhandled),
}
impl ::aws_smithy_http::result::CreateUnhandledError for CreateIpamScopeError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateIpamScopeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_ipam_scope::CreateIpamScopeError {
...
impl CreateIpamScopeError {
    /// Creates the `CreateIpamScopeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateIpamScopeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
