...
impl DescribeReservedInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_reserved_instances::DescribeReservedInstancesInput, ::aws_smithy_http::operation::error::BuildError> {
