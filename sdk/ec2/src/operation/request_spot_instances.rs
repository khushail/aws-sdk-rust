...
impl RequestSpotInstancesInput {
    /// Consumes the builder and constructs an Operation<[`RequestSpotInstances`](crate::operation::request_spot_instances::RequestSpotInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::request_spot_instances::RequestSpotInstances, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::request_spot_instances::RequestSpotInstancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_request_spot_instances_input::ser_request_spot_instances_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::request_spot_instances::RequestSpotInstances::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RequestSpotInstances", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RequestSpotInstances {
                type Output = ::std::result::Result<crate::operation::request_spot_instances::RequestSpotInstancesOutput, crate::operation::request_spot_instances::RequestSpotInstancesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_request_spot_instances::de_request_spot_instances_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type RequestSpotInstancesErrorKind = RequestSpotInstancesError;
/// Error type for the `RequestSpotInstancesError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for RequestSpotInstancesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RequestSpotInstancesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::request_spot_instances::RequestSpotInstancesError {
...
impl RequestSpotInstancesError {
    /// Creates the `RequestSpotInstancesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RequestSpotInstancesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _request_spot_instances_output;
