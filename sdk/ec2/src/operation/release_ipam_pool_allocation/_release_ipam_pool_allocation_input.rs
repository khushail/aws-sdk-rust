...
impl ReleaseIpamPoolAllocationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::release_ipam_pool_allocation::ReleaseIpamPoolAllocationInput, ::aws_smithy_http::operation::error::BuildError> {
