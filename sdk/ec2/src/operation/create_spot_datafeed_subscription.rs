...
impl CreateSpotDatafeedSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`CreateSpotDatafeedSubscription`](crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscription, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_spot_datafeed_subscription_input::ser_create_spot_datafeed_subscription_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscription::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateSpotDatafeedSubscription", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSpotDatafeedSubscription {
                type Output = ::std::result::Result<crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscriptionOutput, crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscriptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_spot_datafeed_subscription::de_create_spot_datafeed_subscription_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateSpotDatafeedSubscriptionErrorKind = CreateSpotDatafeedSubscriptionError;
/// Error type for the `CreateSpotDatafeedSubscriptionError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateSpotDatafeedSubscriptionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateSpotDatafeedSubscriptionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_spot_datafeed_subscription::CreateSpotDatafeedSubscriptionError {
...
impl CreateSpotDatafeedSubscriptionError {
    /// Creates the `CreateSpotDatafeedSubscriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateSpotDatafeedSubscriptionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
