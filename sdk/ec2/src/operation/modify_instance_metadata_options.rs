...
impl ModifyInstanceMetadataOptionsInput {
    /// Consumes the builder and constructs an Operation<[`ModifyInstanceMetadataOptions`](crate::operation::modify_instance_metadata_options::ModifyInstanceMetadataOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_instance_metadata_options::ModifyInstanceMetadataOptions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_instance_metadata_options::ModifyInstanceMetadataOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_instance_metadata_options_input::ser_modify_instance_metadata_options_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_instance_metadata_options::ModifyInstanceMetadataOptions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyInstanceMetadataOptions", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyInstanceMetadataOptions {
                type Output = ::std::result::Result<crate::operation::modify_instance_metadata_options::ModifyInstanceMetadataOptionsOutput, crate::operation::modify_instance_metadata_options::ModifyInstanceMetadataOptionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_modify_instance_metadata_options::de_modify_instance_metadata_options_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ModifyInstanceMetadataOptionsErrorKind = ModifyInstanceMetadataOptionsError;
/// Error type for the `ModifyInstanceMetadataOptionsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for ModifyInstanceMetadataOptionsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ModifyInstanceMetadataOptionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_instance_metadata_options::ModifyInstanceMetadataOptionsError {
...
impl ModifyInstanceMetadataOptionsError {
    /// Creates the `ModifyInstanceMetadataOptionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ModifyInstanceMetadataOptionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
...
mod _modify_instance_metadata_options_output;
