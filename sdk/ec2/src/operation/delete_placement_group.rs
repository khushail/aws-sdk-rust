...
impl DeletePlacementGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeletePlacementGroup`](crate::operation::delete_placement_group::DeletePlacementGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_placement_group::DeletePlacementGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_placement_group::DeletePlacementGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_placement_group_input::ser_delete_placement_group_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_placement_group::DeletePlacementGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeletePlacementGroup", "ec2"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePlacementGroup {
                type Output = ::std::result::Result<crate::operation::delete_placement_group::DeletePlacementGroupOutput, crate::operation::delete_placement_group::DeletePlacementGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_placement_group::de_delete_placement_group_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeletePlacementGroupErrorKind = DeletePlacementGroupError;
/// Error type for the `DeletePlacementGroupError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeletePlacementGroupError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeletePlacementGroupError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_placement_group::DeletePlacementGroupError {
...
impl DeletePlacementGroupError {
    /// Creates the `DeletePlacementGroupError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeletePlacementGroupError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
