...
impl CreateLocalGatewayRouteInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_local_gateway_route::CreateLocalGatewayRouteInput, ::aws_smithy_http::operation::error::BuildError> {
