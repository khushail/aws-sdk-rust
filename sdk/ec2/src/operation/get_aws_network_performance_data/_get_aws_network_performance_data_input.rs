...
impl GetAwsNetworkPerformanceDataInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_aws_network_performance_data::GetAwsNetworkPerformanceDataInput, ::aws_smithy_http::operation::error::BuildError> {
