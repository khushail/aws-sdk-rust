...
impl CommitTransactionInput {
    /// Consumes the builder and constructs an Operation<[`CommitTransaction`](crate::operation::commit_transaction::CommitTransaction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::commit_transaction::CommitTransaction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::commit_transaction::CommitTransactionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/CommitTransaction").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::commit_transaction::CommitTransaction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CommitTransaction", "rdsdata"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CommitTransaction`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CommitTransaction {
                type Output = ::std::result::Result<crate::operation::commit_transaction::CommitTransactionOutput, crate::operation::commit_transaction::CommitTransactionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_commit_transaction::de_commit_transaction_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_commit_transaction::de_commit_transaction_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::commit_transaction::CommitTransactionError {
...
mod _commit_transaction_output;
