...
impl DescribeNotificationRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_notification_rule::DescribeNotificationRuleInput, ::aws_smithy_http::operation::error::BuildError> {
