...
impl DeleteMedicalVocabularyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMedicalVocabulary`](crate::operation::delete_medical_vocabulary::DeleteMedicalVocabulary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabulary, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_medical_vocabulary::ser_delete_medical_vocabulary_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_medical_vocabulary::DeleteMedicalVocabulary::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteMedicalVocabulary", "transcribe"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteMedicalVocabulary`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMedicalVocabulary {
                type Output = ::std::result::Result<crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyOutput, crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_medical_vocabulary::de_delete_medical_vocabulary_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_medical_vocabulary::de_delete_medical_vocabulary_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_medical_vocabulary::DeleteMedicalVocabularyError {
...
mod _delete_medical_vocabulary_output;
