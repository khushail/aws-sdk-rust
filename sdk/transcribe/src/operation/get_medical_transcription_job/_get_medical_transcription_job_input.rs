...
impl GetMedicalTranscriptionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_medical_transcription_job::GetMedicalTranscriptionJobInput, ::aws_smithy_http::operation::error::BuildError> {
