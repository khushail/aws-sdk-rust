...
impl DeleteLanguageModelInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLanguageModel`](crate::operation::delete_language_model::DeleteLanguageModel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_language_model::DeleteLanguageModel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_language_model::DeleteLanguageModelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_language_model::ser_delete_language_model_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_language_model::DeleteLanguageModel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteLanguageModel", "transcribe"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLanguageModel {
                type Output = ::std::result::Result<crate::operation::delete_language_model::DeleteLanguageModelOutput, crate::operation::delete_language_model::DeleteLanguageModelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_language_model::de_delete_language_model_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_language_model::de_delete_language_model_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_language_model::DeleteLanguageModelError {
...
mod _delete_language_model_output;
