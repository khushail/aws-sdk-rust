...
impl DeleteCallAnalyticsJobInput {
    /// Consumes the builder and constructs an Operation<[`DeleteCallAnalyticsJob`](crate::operation::delete_call_analytics_job::DeleteCallAnalyticsJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_call_analytics_job::DeleteCallAnalyticsJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_call_analytics_job::DeleteCallAnalyticsJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_call_analytics_job::ser_delete_call_analytics_job_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_call_analytics_job::DeleteCallAnalyticsJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteCallAnalyticsJob", "transcribe"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteCallAnalyticsJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCallAnalyticsJob {
                type Output = ::std::result::Result<crate::operation::delete_call_analytics_job::DeleteCallAnalyticsJobOutput, crate::operation::delete_call_analytics_job::DeleteCallAnalyticsJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_call_analytics_job::de_delete_call_analytics_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_call_analytics_job::de_delete_call_analytics_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_call_analytics_job::DeleteCallAnalyticsJobError {
...
mod _delete_call_analytics_job_output;
