...
impl StartMedicalTranscriptionJobInput {
    /// Consumes the builder and constructs an Operation<[`StartMedicalTranscriptionJob`](crate::operation::start_medical_transcription_job::StartMedicalTranscriptionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_medical_transcription_job::StartMedicalTranscriptionJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_medical_transcription_job::StartMedicalTranscriptionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_medical_transcription_job::ser_start_medical_transcription_job_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_medical_transcription_job::StartMedicalTranscriptionJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartMedicalTranscriptionJob", "transcribe"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartMedicalTranscriptionJob {
                type Output = ::std::result::Result<crate::operation::start_medical_transcription_job::StartMedicalTranscriptionJobOutput, crate::operation::start_medical_transcription_job::StartMedicalTranscriptionJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_medical_transcription_job::de_start_medical_transcription_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_medical_transcription_job::de_start_medical_transcription_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_medical_transcription_job::StartMedicalTranscriptionJobError {
...
mod _start_medical_transcription_job_output;
