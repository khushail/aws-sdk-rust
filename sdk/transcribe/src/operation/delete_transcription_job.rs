...
impl DeleteTranscriptionJobInput {
    /// Consumes the builder and constructs an Operation<[`DeleteTranscriptionJob`](crate::operation::delete_transcription_job::DeleteTranscriptionJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_transcription_job::DeleteTranscriptionJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_transcription_job::DeleteTranscriptionJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_transcription_job::ser_delete_transcription_job_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_transcription_job::DeleteTranscriptionJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteTranscriptionJob", "transcribe"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteTranscriptionJob {
                type Output = ::std::result::Result<crate::operation::delete_transcription_job::DeleteTranscriptionJobOutput, crate::operation::delete_transcription_job::DeleteTranscriptionJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_transcription_job::de_delete_transcription_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_transcription_job::de_delete_transcription_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_transcription_job::DeleteTranscriptionJobError {
...
mod _delete_transcription_job_output;
