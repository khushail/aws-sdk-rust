...
impl DeleteMedicalTranscriptionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_medical_transcription_job::DeleteMedicalTranscriptionJobInput, ::aws_smithy_http::operation::error::BuildError> {
