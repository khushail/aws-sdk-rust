...
impl DeleteVocabularyFilterInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVocabularyFilter`](crate::operation::delete_vocabulary_filter::DeleteVocabularyFilter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_vocabulary_filter::DeleteVocabularyFilter, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_vocabulary_filter::DeleteVocabularyFilterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_vocabulary_filter::ser_delete_vocabulary_filter_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_vocabulary_filter::DeleteVocabularyFilter::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteVocabularyFilter", "transcribe"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteVocabularyFilter`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVocabularyFilter {
                type Output = ::std::result::Result<crate::operation::delete_vocabulary_filter::DeleteVocabularyFilterOutput, crate::operation::delete_vocabulary_filter::DeleteVocabularyFilterError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_vocabulary_filter::de_delete_vocabulary_filter_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_vocabulary_filter::de_delete_vocabulary_filter_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_vocabulary_filter::DeleteVocabularyFilterError {
...
mod _delete_vocabulary_filter_output;
