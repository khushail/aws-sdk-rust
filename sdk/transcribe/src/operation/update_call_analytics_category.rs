...
impl UpdateCallAnalyticsCategoryInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCallAnalyticsCategory`](crate::operation::update_call_analytics_category::UpdateCallAnalyticsCategory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_call_analytics_category::UpdateCallAnalyticsCategory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_call_analytics_category::UpdateCallAnalyticsCategoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_call_analytics_category::ser_update_call_analytics_category_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_call_analytics_category::UpdateCallAnalyticsCategory::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateCallAnalyticsCategory", "transcribe"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateCallAnalyticsCategory`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCallAnalyticsCategory {
                type Output = ::std::result::Result<crate::operation::update_call_analytics_category::UpdateCallAnalyticsCategoryOutput, crate::operation::update_call_analytics_category::UpdateCallAnalyticsCategoryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_call_analytics_category::de_update_call_analytics_category_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_call_analytics_category::de_update_call_analytics_category_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_call_analytics_category::UpdateCallAnalyticsCategoryError {
...
mod _update_call_analytics_category_output;
