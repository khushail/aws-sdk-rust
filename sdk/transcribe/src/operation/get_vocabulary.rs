...
impl GetVocabularyInput {
    /// Consumes the builder and constructs an Operation<[`GetVocabulary`](crate::operation::get_vocabulary::GetVocabulary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_vocabulary::GetVocabulary, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_vocabulary::GetVocabularyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_vocabulary::ser_get_vocabulary_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_vocabulary::GetVocabulary::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetVocabulary", "transcribe"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVocabulary {
                type Output = ::std::result::Result<crate::operation::get_vocabulary::GetVocabularyOutput, crate::operation::get_vocabulary::GetVocabularyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_vocabulary::de_get_vocabulary_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_vocabulary::de_get_vocabulary_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_vocabulary::GetVocabularyError {
