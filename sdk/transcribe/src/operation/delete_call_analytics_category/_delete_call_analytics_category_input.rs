...
impl DeleteCallAnalyticsCategoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_call_analytics_category::DeleteCallAnalyticsCategoryInput, ::aws_smithy_http::operation::error::BuildError> {
