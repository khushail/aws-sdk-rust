...
pub(crate) fn de_external_events_detail<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ExternalEventsDetail>, ::aws_smithy_json::deserialize::error::DeserializeError>
