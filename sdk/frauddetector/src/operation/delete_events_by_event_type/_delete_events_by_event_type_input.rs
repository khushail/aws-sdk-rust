...
impl DeleteEventsByEventTypeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_events_by_event_type::DeleteEventsByEventTypeInput, ::aws_smithy_http::operation::error::BuildError> {
