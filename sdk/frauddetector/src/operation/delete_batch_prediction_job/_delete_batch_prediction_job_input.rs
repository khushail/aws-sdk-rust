...
impl DeleteBatchPredictionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_batch_prediction_job::DeleteBatchPredictionJobInput, ::aws_smithy_http::operation::error::BuildError> {
