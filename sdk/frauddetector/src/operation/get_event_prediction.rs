...
impl GetEventPredictionInput {
    /// Consumes the builder and constructs an Operation<[`GetEventPrediction`](crate::operation::get_event_prediction::GetEventPrediction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_event_prediction::GetEventPrediction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_event_prediction::GetEventPredictionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_event_prediction::ser_get_event_prediction_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_event_prediction::GetEventPrediction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetEventPrediction", "frauddetector"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetEventPrediction {
                type Output = ::std::result::Result<crate::operation::get_event_prediction::GetEventPredictionOutput, crate::operation::get_event_prediction::GetEventPredictionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_event_prediction::de_get_event_prediction_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_event_prediction::de_get_event_prediction_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_event_prediction::GetEventPredictionError {
...
mod _get_event_prediction_output;
