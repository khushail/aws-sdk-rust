...
impl UpdateModelVersionStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_model_version_status::UpdateModelVersionStatusInput, ::aws_smithy_http::operation::error::BuildError> {
