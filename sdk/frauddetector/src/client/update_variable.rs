...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_variable::builders::UpdateVariableFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_variable::builders::UpdateVariableFluentBuilder::set_name): <p>The name of the variable.</p>
    ///   - [`default_value(impl ::std::convert::Into<String>)`](crate::operation::update_variable::builders::UpdateVariableFluentBuilder::default_value) / [`set_default_value(Option<String>)`](crate::operation::update_variable::builders::UpdateVariableFluentBuilder::set_default_value): <p>The new default value of the variable.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_variable::builders::UpdateVariableFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_variable::builders::UpdateVariableFluentBuilder::set_description): <p>The new description.</p>
