...
impl super::Client  {
    ...
    ///   - [`model_endpoint(impl ::std::convert::Into<String>)`](crate::operation::get_external_models::builders::GetExternalModelsFluentBuilder::model_endpoint) / [`set_model_endpoint(Option<String>)`](crate::operation::get_external_models::builders::GetExternalModelsFluentBuilder::set_model_endpoint): <p>The Amazon SageMaker model endpoint.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_external_models::builders::GetExternalModelsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_external_models::builders::GetExternalModelsFluentBuilder::set_next_token): <p>The next page token for the request.</p>
