...
impl super::Client  {
    ...
    ///   - [`model_id(impl ::std::convert::Into<String>)`](crate::operation::get_model_version::builders::GetModelVersionFluentBuilder::model_id) / [`set_model_id(Option<String>)`](crate::operation::get_model_version::builders::GetModelVersionFluentBuilder::set_model_id): <p>The model ID.</p>
    ...
    ///   - [`model_version_number(impl ::std::convert::Into<String>)`](crate::operation::get_model_version::builders::GetModelVersionFluentBuilder::model_version_number) / [`set_model_version_number(Option<String>)`](crate::operation::get_model_version::builders::GetModelVersionFluentBuilder::set_model_version_number): <p>The model version number.</p>
