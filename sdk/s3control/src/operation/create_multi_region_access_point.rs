...
impl CreateMultiRegionAccessPointInput {
    /// Consumes the builder and constructs an Operation<[`CreateMultiRegionAccessPoint`](crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPoint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPoint::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateMultiRegionAccessPoint", "s3control"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateMultiRegionAccessPoint`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMultiRegionAccessPoint {
                type Output = ::std::result::Result<crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPointOutput, crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPointError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_multi_region_access_point::de_create_multi_region_access_point_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_multi_region_access_point::de_create_multi_region_access_point_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPointError {
