...
impl CreateMultiRegionAccessPointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_multi_region_access_point::CreateMultiRegionAccessPointInput, ::aws_smithy_http::operation::error::BuildError> {
