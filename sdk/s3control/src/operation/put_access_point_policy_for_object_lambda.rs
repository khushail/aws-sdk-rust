...
impl PutAccessPointPolicyForObjectLambdaInput {
    /// Consumes the builder and constructs an Operation<[`PutAccessPointPolicyForObjectLambda`](crate::operation::put_access_point_policy_for_object_lambda::PutAccessPointPolicyForObjectLambda)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_access_point_policy_for_object_lambda::PutAccessPointPolicyForObjectLambda, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_access_point_policy_for_object_lambda::PutAccessPointPolicyForObjectLambdaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_access_point_policy_for_object_lambda::PutAccessPointPolicyForObjectLambda::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAccessPointPolicyForObjectLambda {
                type Output = ::std::result::Result<crate::operation::put_access_point_policy_for_object_lambda::PutAccessPointPolicyForObjectLambdaOutput, crate::operation::put_access_point_policy_for_object_lambda::PutAccessPointPolicyForObjectLambdaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_access_point_policy_for_object_lambda::de_put_access_point_policy_for_object_lambda_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_access_point_policy_for_object_lambda::de_put_access_point_policy_for_object_lambda_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_access_point_policy_for_object_lambda::PutAccessPointPolicyForObjectLambdaError {
...
mod _put_access_point_policy_for_object_lambda_output;
