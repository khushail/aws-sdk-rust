...
impl DeletePublicAccessBlockInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_public_access_block::DeletePublicAccessBlockInput, ::aws_smithy_http::operation::error::BuildError> {
