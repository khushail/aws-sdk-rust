...
impl PutBucketReplicationInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_bucket_replication::PutBucketReplication, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_bucket_replication::PutBucketReplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_bucket_replication::PutBucketReplication::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutBucketReplication", "s3control"));
