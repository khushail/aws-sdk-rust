...
impl GetAccessPointPolicyStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_access_point_policy_status::GetAccessPointPolicyStatusInput, ::aws_smithy_http::operation::error::BuildError> {
