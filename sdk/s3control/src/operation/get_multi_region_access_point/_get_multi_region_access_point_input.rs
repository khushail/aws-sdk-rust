...
impl GetMultiRegionAccessPointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointInput, ::aws_smithy_http::operation::error::BuildError> {
