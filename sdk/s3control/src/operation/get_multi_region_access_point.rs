...
impl GetMultiRegionAccessPointInput {
    /// Consumes the builder and constructs an Operation<[`GetMultiRegionAccessPoint`](crate::operation::get_multi_region_access_point::GetMultiRegionAccessPoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_multi_region_access_point::GetMultiRegionAccessPoint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_multi_region_access_point::GetMultiRegionAccessPoint::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMultiRegionAccessPoint {
                type Output = ::std::result::Result<crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointOutput, crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_multi_region_access_point::de_get_multi_region_access_point_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_multi_region_access_point::de_get_multi_region_access_point_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_multi_region_access_point::GetMultiRegionAccessPointError {
...
mod _get_multi_region_access_point_output;
