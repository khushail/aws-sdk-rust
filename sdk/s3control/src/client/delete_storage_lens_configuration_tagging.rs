...
impl super::Client  {
    ...
    ///   - [`config_id(impl ::std::convert::Into<String>)`](crate::operation::delete_storage_lens_configuration_tagging::builders::DeleteStorageLensConfigurationTaggingFluentBuilder::config_id) / [`set_config_id(Option<String>)`](crate::operation::delete_storage_lens_configuration_tagging::builders::DeleteStorageLensConfigurationTaggingFluentBuilder::set_config_id): <p>The ID of the S3 Storage Lens configuration.</p>
