...
impl super::Client  {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::get_access_point_policy_status_for_object_lambda::builders::GetAccessPointPolicyStatusForObjectLambdaFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::get_access_point_policy_status_for_object_lambda::builders::GetAccessPointPolicyStatusForObjectLambdaFluentBuilder::set_account_id): <p>The account ID for the account that owns the specified Object Lambda Access Point.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::get_access_point_policy_status_for_object_lambda::builders::GetAccessPointPolicyStatusForObjectLambdaFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::get_access_point_policy_status_for_object_lambda::builders::GetAccessPointPolicyStatusForObjectLambdaFluentBuilder::set_name): <p>The name of the Object Lambda Access Point.</p>
