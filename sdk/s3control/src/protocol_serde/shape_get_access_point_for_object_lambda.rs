...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_access_point_for_object_lambda_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_access_point_for_object_lambda::GetAccessPointForObjectLambdaOutput, crate::operation::get_access_point_for_object_lambda::GetAccessPointForObjectLambdaError> {
    Ok({
        #[allow(unused_mut)]
