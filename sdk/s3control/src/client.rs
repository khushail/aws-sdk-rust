...
mod delete_access_point_for_object_lambda;
...
mod delete_multi_region_access_point;

mod delete_public_access_block;

mod delete_storage_lens_configuration;
...
mod get_access_point_configuration_for_object_lambda;

mod get_access_point_for_object_lambda;

mod get_access_point_policy;

mod get_access_point_policy_for_object_lambda;

mod get_access_point_policy_status;
...
mod get_multi_region_access_point_policy;

mod get_multi_region_access_point_policy_status;

mod get_multi_region_access_point_routes;

mod get_public_access_block;

mod get_storage_lens_configuration;
...
mod put_multi_region_access_point_policy;

mod put_public_access_block;

mod put_storage_lens_configuration;

mod put_storage_lens_configuration_tagging;
