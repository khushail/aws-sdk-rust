...
impl DeleteOriginAccessControlInput {
    /// Consumes the builder and constructs an Operation<[`DeleteOriginAccessControl`](crate::operation::delete_origin_access_control::DeleteOriginAccessControl)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_origin_access_control::DeleteOriginAccessControl, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_origin_access_control::DeleteOriginAccessControlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_origin_access_control::DeleteOriginAccessControl::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteOriginAccessControl {
                type Output = ::std::result::Result<crate::operation::delete_origin_access_control::DeleteOriginAccessControlOutput, crate::operation::delete_origin_access_control::DeleteOriginAccessControlError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_delete_origin_access_control::de_delete_origin_access_control_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_origin_access_control::de_delete_origin_access_control_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_origin_access_control::DeleteOriginAccessControlError {
...
mod _delete_origin_access_control_output;
