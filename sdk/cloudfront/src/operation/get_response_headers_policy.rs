...
impl GetResponseHeadersPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetResponseHeadersPolicy`](crate::operation::get_response_headers_policy::GetResponseHeadersPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_response_headers_policy::GetResponseHeadersPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_response_headers_policy::GetResponseHeadersPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_response_headers_policy::GetResponseHeadersPolicyInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_response_headers_policy::GetResponseHeadersPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetResponseHeadersPolicy", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetResponseHeadersPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetResponseHeadersPolicy {
                type Output = ::std::result::Result<crate::operation::get_response_headers_policy::GetResponseHeadersPolicyOutput, crate::operation::get_response_headers_policy::GetResponseHeadersPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_response_headers_policy::de_get_response_headers_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_response_headers_policy::de_get_response_headers_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_response_headers_policy::GetResponseHeadersPolicyError {
...
pub use crate::operation::get_response_headers_policy::_get_response_headers_policy_output::GetResponseHeadersPolicyOutput;

pub use crate::operation::get_response_headers_policy::_get_response_headers_policy_input::GetResponseHeadersPolicyInput;

mod _get_response_headers_policy_input;

mod _get_response_headers_policy_output;
