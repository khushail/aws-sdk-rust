...
impl CreateStreamingDistributionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_streaming_distribution::CreateStreamingDistributionInput, ::aws_smithy_http::operation::error::BuildError> {
