...
impl GetStreamingDistributionConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfigInput, ::aws_smithy_http::operation::error::BuildError> {
