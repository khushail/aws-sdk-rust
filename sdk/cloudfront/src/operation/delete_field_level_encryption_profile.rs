...
impl DeleteFieldLevelEncryptionProfileInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_field_level_encryption_profile::DeleteFieldLevelEncryptionProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `DeleteFieldLevelEncryptionProfile`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteFieldLevelEncryptionProfile {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_delete_field_level_encryption_profile::de_delete_field_level_encryption_profile_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_field_level_encryption_profile::de_delete_field_level_encryption_profile_http_response_with_props(status, headers, body)
                     }
                }
