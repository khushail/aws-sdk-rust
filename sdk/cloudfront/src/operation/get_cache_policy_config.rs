...
impl GetCachePolicyConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetCachePolicyConfig`](crate::operation::get_cache_policy_config::GetCachePolicyConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_cache_policy_config::GetCachePolicyConfig, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_cache_policy_config::GetCachePolicyConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/2020-05-31/cache-policy/{Id}/config", Id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_cache_policy_config::GetCachePolicyConfigInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_cache_policy_config::GetCachePolicyConfig::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCachePolicyConfig", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetCachePolicyConfig`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCachePolicyConfig {
                type Output = ::std::result::Result<crate::operation::get_cache_policy_config::GetCachePolicyConfigOutput, crate::operation::get_cache_policy_config::GetCachePolicyConfigError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_cache_policy_config::de_get_cache_policy_config_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_cache_policy_config::de_get_cache_policy_config_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_cache_policy_config::GetCachePolicyConfigError {
...
mod _get_cache_policy_config_output;
