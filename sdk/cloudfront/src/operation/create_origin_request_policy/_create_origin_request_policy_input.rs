...
impl CreateOriginRequestPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_origin_request_policy::CreateOriginRequestPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
