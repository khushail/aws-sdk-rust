...
impl UpdatePublicKeyInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePublicKey`](crate::operation::update_public_key::UpdatePublicKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_public_key::UpdatePublicKey, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_public_key::UpdatePublicKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_public_key::UpdatePublicKey::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePublicKey", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdatePublicKey`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePublicKey {
                type Output = ::std::result::Result<crate::operation::update_public_key::UpdatePublicKeyOutput, crate::operation::update_public_key::UpdatePublicKeyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_public_key::de_update_public_key_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_public_key::de_update_public_key_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_public_key::UpdatePublicKeyError {
...
pub use crate::operation::update_public_key::_update_public_key_output::UpdatePublicKeyOutput;

pub use crate::operation::update_public_key::_update_public_key_input::UpdatePublicKeyInput;

mod _update_public_key_input;

mod _update_public_key_output;
