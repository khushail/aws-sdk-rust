...
impl CreateFieldLevelEncryptionConfigInput {
    /// Consumes the builder and constructs an Operation<[`CreateFieldLevelEncryptionConfig`](crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfig, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfig::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateFieldLevelEncryptionConfig", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateFieldLevelEncryptionConfig`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFieldLevelEncryptionConfig {
                type Output = ::std::result::Result<crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigOutput, crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_field_level_encryption_config::de_create_field_level_encryption_config_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_field_level_encryption_config::de_create_field_level_encryption_config_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateFieldLevelEncryptionConfigError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_field_level_encryption_config::CreateFieldLevelEncryptionConfigError {
...
pub use crate::operation::create_field_level_encryption_config::_create_field_level_encryption_config_output::CreateFieldLevelEncryptionConfigOutput;

pub use crate::operation::create_field_level_encryption_config::_create_field_level_encryption_config_input::CreateFieldLevelEncryptionConfigInput;

mod _create_field_level_encryption_config_input;

mod _create_field_level_encryption_config_output;
