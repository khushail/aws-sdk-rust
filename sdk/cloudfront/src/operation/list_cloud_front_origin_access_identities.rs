...
impl ListCloudFrontOriginAccessIdentitiesInput {
    /// Consumes the builder and constructs an Operation<[`ListCloudFrontOriginAccessIdentities`](crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentities)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentities, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2020-05-31/origin-access-identity/cloudfront").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentities::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCloudFrontOriginAccessIdentities {
                type Output = ::std::result::Result<crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesOutput, crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_cloud_front_origin_access_identities::de_list_cloud_front_origin_access_identities_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_cloud_front_origin_access_identities::de_list_cloud_front_origin_access_identities_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListCloudFrontOriginAccessIdentitiesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_cloud_front_origin_access_identities::ListCloudFrontOriginAccessIdentitiesError {
...
mod _list_cloud_front_origin_access_identities_output;
