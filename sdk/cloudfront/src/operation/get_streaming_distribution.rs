...
impl GetStreamingDistributionInput {
    /// Consumes the builder and constructs an Operation<[`GetStreamingDistribution`](crate::operation::get_streaming_distribution::GetStreamingDistribution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_streaming_distribution::GetStreamingDistribution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_streaming_distribution::GetStreamingDistributionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_streaming_distribution::GetStreamingDistributionInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_streaming_distribution::GetStreamingDistribution::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStreamingDistribution {
                type Output = ::std::result::Result<crate::operation::get_streaming_distribution::GetStreamingDistributionOutput, crate::operation::get_streaming_distribution::GetStreamingDistributionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_streaming_distribution::de_get_streaming_distribution_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_streaming_distribution::de_get_streaming_distribution_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_streaming_distribution::GetStreamingDistributionError {
...
mod _get_streaming_distribution_output;
