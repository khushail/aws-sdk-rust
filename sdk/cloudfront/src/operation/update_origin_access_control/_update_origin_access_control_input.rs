...
impl UpdateOriginAccessControlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_origin_access_control::UpdateOriginAccessControlInput, ::aws_smithy_http::operation::error::BuildError> {
