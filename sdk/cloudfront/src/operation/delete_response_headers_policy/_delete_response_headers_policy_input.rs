...
impl DeleteResponseHeadersPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_response_headers_policy::DeleteResponseHeadersPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
