...
impl UpdateRealtimeLogConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_realtime_log_config::UpdateRealtimeLogConfigInput, ::aws_smithy_http::operation::error::BuildError> {
