...
impl GetOriginAccessControlConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_origin_access_control_config::GetOriginAccessControlConfigInput, ::aws_smithy_http::operation::error::BuildError> {
