...
impl ListDistributionsByWebAclIdInput {
    /// Consumes the builder and constructs an Operation<[`ListDistributionsByWebACLId`](crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLId)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLId, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.web_acl_id;
                let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("web_acl_id", "cannot be empty or unset"))?;
                let web_acl_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
                if web_acl_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("web_acl_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/2020-05-31/distributionsByWebACLId/{WebACLId}", WebACLId = web_acl_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLId::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDistributionsByWebACLId", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListDistributionsByWebACLId`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDistributionsByWebACLId {
                type Output = ::std::result::Result<crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebAclIdOutput, crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_distributions_by_web_acl_id::de_list_distributions_by_web_acl_id_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_distributions_by_web_acl_id::de_list_distributions_by_web_acl_id_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_distributions_by_web_acl_id::ListDistributionsByWebACLIdError {
...
mod _list_distributions_by_web_acl_id_output;
