...
impl GetCachePolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetCachePolicy`](crate::operation::get_cache_policy::GetCachePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_cache_policy::GetCachePolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_cache_policy::GetCachePolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_cache_policy::GetCachePolicyInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_cache_policy::GetCachePolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCachePolicy", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetCachePolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCachePolicy {
                type Output = ::std::result::Result<crate::operation::get_cache_policy::GetCachePolicyOutput, crate::operation::get_cache_policy::GetCachePolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_cache_policy::de_get_cache_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_cache_policy::de_get_cache_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_cache_policy::GetCachePolicyError {
...
pub use crate::operation::get_cache_policy::_get_cache_policy_output::GetCachePolicyOutput;

pub use crate::operation::get_cache_policy::_get_cache_policy_input::GetCachePolicyInput;

mod _get_cache_policy_input;

mod _get_cache_policy_output;
