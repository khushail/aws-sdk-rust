...
impl CreateOriginAccessControlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_origin_access_control::CreateOriginAccessControlInput, ::aws_smithy_http::operation::error::BuildError> {
