...
impl ListDistributionsByCachePolicyIdInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_distributions_by_cache_policy_id::ListDistributionsByCachePolicyId, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_distributions_by_cache_policy_id::ListDistributionsByCachePolicyIdInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if cache_policy_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("cache_policy_id", "cannot be empty or unset"))
                            }
            ...
            fn uri_query(_input: &crate::operation::list_distributions_by_cache_policy_id::ListDistributionsByCachePolicyIdInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
