...
impl ListOriginRequestPoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListOriginRequestPolicies`](crate::operation::list_origin_request_policies::ListOriginRequestPolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_origin_request_policies::ListOriginRequestPolicies, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_origin_request_policies::ListOriginRequestPoliciesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2020-05-31/origin-request-policy").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_origin_request_policies::ListOriginRequestPoliciesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_origin_request_policies::ListOriginRequestPoliciesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_origin_request_policies::ListOriginRequestPolicies::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOriginRequestPolicies {
                type Output = ::std::result::Result<crate::operation::list_origin_request_policies::ListOriginRequestPoliciesOutput, crate::operation::list_origin_request_policies::ListOriginRequestPoliciesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_origin_request_policies::de_list_origin_request_policies_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_origin_request_policies::de_list_origin_request_policies_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_origin_request_policies::ListOriginRequestPoliciesError {
...
mod _list_origin_request_policies_output;
