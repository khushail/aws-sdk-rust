...
impl DeleteOriginAccessControlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_origin_access_control::DeleteOriginAccessControlInput, ::aws_smithy_http::operation::error::BuildError> {
