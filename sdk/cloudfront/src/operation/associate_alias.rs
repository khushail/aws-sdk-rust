...
impl AssociateAliasInput {
    /// Consumes the builder and constructs an Operation<[`AssociateAlias`](crate::operation::associate_alias::AssociateAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_alias::AssociateAlias, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_alias::AssociateAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if target_distribution_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("target_distribution_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/2020-05-31/distribution/{TargetDistributionId}/associate-alias", TargetDistributionId = target_distribution_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::associate_alias::AssociateAliasInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::associate_alias::AssociateAliasInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_alias::AssociateAlias::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateAlias", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateAlias`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateAlias {
                type Output = ::std::result::Result<crate::operation::associate_alias::AssociateAliasOutput, crate::operation::associate_alias::AssociateAliasError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_alias::de_associate_alias_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_alias::de_associate_alias_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_alias::AssociateAliasError {
