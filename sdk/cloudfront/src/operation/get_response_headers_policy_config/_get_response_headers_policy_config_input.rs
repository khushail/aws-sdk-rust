...
impl GetResponseHeadersPolicyConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_response_headers_policy_config::GetResponseHeadersPolicyConfigInput, ::aws_smithy_http::operation::error::BuildError> {
