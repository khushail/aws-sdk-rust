...
impl GetCloudFrontOriginAccessIdentityInput {
    /// Consumes the builder and constructs an Operation<[`GetCloudFrontOriginAccessIdentity`](crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentity, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentityInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentity::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCloudFrontOriginAccessIdentity", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetCloudFrontOriginAccessIdentity`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCloudFrontOriginAccessIdentity {
                type Output = ::std::result::Result<crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentityOutput, crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentityError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_cloud_front_origin_access_identity::de_get_cloud_front_origin_access_identity_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_cloud_front_origin_access_identity::de_get_cloud_front_origin_access_identity_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCloudFrontOriginAccessIdentityError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_cloud_front_origin_access_identity::GetCloudFrontOriginAccessIdentityError {
...
pub use crate::operation::get_cloud_front_origin_access_identity::_get_cloud_front_origin_access_identity_output::GetCloudFrontOriginAccessIdentityOutput;

pub use crate::operation::get_cloud_front_origin_access_identity::_get_cloud_front_origin_access_identity_input::GetCloudFrontOriginAccessIdentityInput;

mod _get_cloud_front_origin_access_identity_input;

mod _get_cloud_front_origin_access_identity_output;
