...
impl CreateInvalidationInput {
    /// Consumes the builder and constructs an Operation<[`CreateInvalidation`](crate::operation::create_invalidation::CreateInvalidation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_invalidation::CreateInvalidation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_invalidation::CreateInvalidationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if distribution_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("distribution_id", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::create_invalidation::CreateInvalidationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_invalidation::CreateInvalidation::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInvalidation {
                type Output = ::std::result::Result<crate::operation::create_invalidation::CreateInvalidationOutput, crate::operation::create_invalidation::CreateInvalidationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_invalidation::de_create_invalidation_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_invalidation::de_create_invalidation_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_invalidation::CreateInvalidationError {
...
mod _create_invalidation_output;
