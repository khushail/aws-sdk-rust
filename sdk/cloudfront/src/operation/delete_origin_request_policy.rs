...
impl DeleteOriginRequestPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteOriginRequestPolicy`](crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteOriginRequestPolicy", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteOriginRequestPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteOriginRequestPolicy {
                type Output = ::std::result::Result<crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyOutput, crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_delete_origin_request_policy::de_delete_origin_request_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_origin_request_policy::de_delete_origin_request_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_origin_request_policy::DeleteOriginRequestPolicyError {
...
mod _delete_origin_request_policy_output;
