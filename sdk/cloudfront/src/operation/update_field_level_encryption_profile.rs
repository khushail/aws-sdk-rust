...
impl UpdateFieldLevelEncryptionProfileInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_field_level_encryption_profile::UpdateFieldLevelEncryptionProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_field_level_encryption_profile::UpdateFieldLevelEncryptionProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFieldLevelEncryptionProfile {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_field_level_encryption_profile::de_update_field_level_encryption_profile_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_field_level_encryption_profile::de_update_field_level_encryption_profile_http_response_with_props(status, headers, body)
                     }
                }
