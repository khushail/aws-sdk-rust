...
impl ListStreamingDistributionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_streaming_distributions::ListStreamingDistributionsInput, ::aws_smithy_http::operation::error::BuildError> {
