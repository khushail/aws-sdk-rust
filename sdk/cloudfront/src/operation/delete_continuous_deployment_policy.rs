...
impl DeleteContinuousDeploymentPolicyInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_continuous_deployment_policy::DeleteContinuousDeploymentPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_continuous_deployment_policy::DeleteContinuousDeploymentPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `DeleteContinuousDeploymentPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteContinuousDeploymentPolicy {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_delete_continuous_deployment_policy::de_delete_continuous_deployment_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_continuous_deployment_policy::de_delete_continuous_deployment_policy_http_response_with_props(status, headers, body)
                     }
                }
