...
impl GetMonitoringSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_monitoring_subscription::GetMonitoringSubscriptionInput, ::aws_smithy_http::operation::error::BuildError> {
