...
impl GetStreamingDistributionConfigInput {
    /// Consumes the builder and constructs an Operation<[`GetStreamingDistributionConfig`](crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfig, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfigInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfig::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetStreamingDistributionConfig", "cloudfront"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetStreamingDistributionConfig`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetStreamingDistributionConfig {
                type Output = ::std::result::Result<crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfigOutput, crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfigError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_streaming_distribution_config::de_get_streaming_distribution_config_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_streaming_distribution_config::de_get_streaming_distribution_config_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetStreamingDistributionConfigError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_streaming_distribution_config::GetStreamingDistributionConfigError {
...
pub use crate::operation::get_streaming_distribution_config::_get_streaming_distribution_config_output::GetStreamingDistributionConfigOutput;

pub use crate::operation::get_streaming_distribution_config::_get_streaming_distribution_config_input::GetStreamingDistributionConfigInput;

mod _get_streaming_distribution_config_input;

mod _get_streaming_distribution_config_output;
