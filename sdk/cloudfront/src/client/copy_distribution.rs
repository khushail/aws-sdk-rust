...
impl super::Client  {
    ...
    ///   - [`primary_distribution_id(impl ::std::convert::Into<String>)`](crate::operation::copy_distribution::builders::CopyDistributionFluentBuilder::primary_distribution_id) / [`set_primary_distribution_id(Option<String>)`](crate::operation::copy_distribution::builders::CopyDistributionFluentBuilder::set_primary_distribution_id): <p>The identifier of the primary distribution whose configuration you are copying. To get a distribution ID, use <code>ListDistributions</code>.</p>
