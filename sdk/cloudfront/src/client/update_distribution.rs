...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_distribution::builders::UpdateDistributionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_distribution::builders::UpdateDistributionFluentBuilder::set_id): <p>The distribution's id.</p>
    ///   - [`if_match(impl ::std::convert::Into<String>)`](crate::operation::update_distribution::builders::UpdateDistributionFluentBuilder::if_match) / [`set_if_match(Option<String>)`](crate::operation::update_distribution::builders::UpdateDistributionFluentBuilder::set_if_match): <p>The value of the <code>ETag</code> header that you received when retrieving the distribution's configuration. For example: <code>E2QWRUHAPOMQZL</code>.</p>
