...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::get_cache_policy_config::builders::GetCachePolicyConfigFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::get_cache_policy_config::builders::GetCachePolicyConfigFluentBuilder::set_id): <p>The unique identifier for the cache policy. If the cache policy is attached to a distribution's cache behavior, you can get the policy's identifier using <code>ListDistributions</code> or <code>GetDistribution</code>. If the cache policy is not attached to a cache behavior, you can get the identifier using <code>ListCachePolicies</code>.</p>
