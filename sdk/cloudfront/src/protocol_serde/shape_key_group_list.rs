...
pub fn de_key_group_list(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::KeyGroupList, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::KeyGroupList::builder();
    while let Some(mut tag) = decoder.next_tag() {
        match tag.start_el() {
            ...
            s if s.matches("Items") /* Items com.amazonaws.cloudfront#KeyGroupList$Items */ =>  {
                let var_4 =
                    Some(
                        crate::protocol_serde::shape_key_group_summary_list::de_key_group_summary_list(&mut tag)
                        ?
                    )
                ;
