...
pub fn de_create_monitoring_subscription_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionOutput, crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_monitoring_subscription_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionOutput, crate::operation::create_monitoring_subscription::CreateMonitoringSubscriptionError> {
    Ok({
        #[allow(unused_mut)]
