            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_access_denied::de_access_denied_xml_err(_response_body, output).map_err(crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_cloud_front_origin_access_identity_in_use::de_cloud_front_origin_access_identity_in_use_xml_err(_response_body, output).map_err(crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_if_match_version::de_invalid_if_match_version_xml_err(_response_body, output).map_err(crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_no_such_cloud_front_origin_access_identity::de_no_such_cloud_front_origin_access_identity_xml_err(_response_body, output).map_err(crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_precondition_failed::de_precondition_failed_xml_err(_response_body, output).map_err(crate::operation::delete_cloud_front_origin_access_identity::DeleteCloudFrontOriginAccessIdentityError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
