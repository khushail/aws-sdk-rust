...
pub(crate) fn de_origin_request_policy_config_payload(body: &[u8]) -> std::result::Result<::std::option::Option<crate::types::OriginRequestPolicyConfig>, crate::operation::get_origin_request_policy_config::GetOriginRequestPolicyConfigError> {
    (!body.is_empty()).then(||{
