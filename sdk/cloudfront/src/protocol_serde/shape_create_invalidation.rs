...
pub fn de_create_invalidation_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_invalidation::CreateInvalidationOutput, crate::operation::create_invalidation::CreateInvalidationError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_invalidation::CreateInvalidationError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_invalidation_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_invalidation::CreateInvalidationOutput, crate::operation::create_invalidation::CreateInvalidationError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = output.set_invalidation(
            crate::protocol_serde::shape_create_invalidation_output::de_invalidation_payload(_response_body)?
        );
        output = output.set_location(
            crate::protocol_serde::shape_create_invalidation_output::de_location_header(_response_headers)
