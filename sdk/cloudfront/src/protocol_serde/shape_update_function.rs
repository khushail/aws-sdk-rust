            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_argument::de_invalid_argument_xml_err(_response_body, output).map_err(crate::operation::update_function::UpdateFunctionError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
pub fn de_update_function_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_function::UpdateFunctionOutput, crate::operation::update_function::UpdateFunctionError> {
    Ok({
        ...
        output = output.set_function_summary(
            crate::protocol_serde::shape_update_function_output::de_function_summary_payload(_response_body)?
        );
