...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_field_level_encryption_profiles_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_field_level_encryption_profiles::ListFieldLevelEncryptionProfilesOutput, crate::operation::list_field_level_encryption_profiles::ListFieldLevelEncryptionProfilesError> {
    Ok({
        #[allow(unused_mut)]
