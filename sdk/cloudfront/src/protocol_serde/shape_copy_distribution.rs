...
#[allow(clippy::unnecessary_wraps)]
pub fn de_copy_distribution_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::copy_distribution::CopyDistributionOutput, crate::operation::copy_distribution::CopyDistributionError> {
    Ok({
        #[allow(unused_mut)]
