...
pub fn ser_response_headers_policy_remove_headers_config(input: &crate::types::ResponseHeadersPolicyRemoveHeadersConfig, writer: ::aws_smithy_xml::encode::ElWriter) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
        ...
        for list_item_3 in var_2 {
             {
                ...
                crate::protocol_serde::shape_response_headers_policy_remove_header::ser_response_headers_policy_remove_header(list_item_3, inner_writer)?
            }
        }
    }
    scope.finish();
...
pub fn de_response_headers_policy_remove_headers_config(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::ResponseHeadersPolicyRemoveHeadersConfig, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
    let mut builder = crate::types::ResponseHeadersPolicyRemoveHeadersConfig::builder();
