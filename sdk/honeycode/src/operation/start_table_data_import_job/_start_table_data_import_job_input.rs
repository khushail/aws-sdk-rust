...
impl StartTableDataImportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_table_data_import_job::StartTableDataImportJobInput, ::aws_smithy_http::operation::error::BuildError> {
