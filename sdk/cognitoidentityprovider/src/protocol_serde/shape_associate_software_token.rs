...
#[allow(clippy::unnecessary_wraps)]
pub fn de_associate_software_token_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::associate_software_token::AssociateSoftwareTokenOutput, crate::operation::associate_software_token::AssociateSoftwareTokenError> {
    Ok({
        #[allow(unused_mut)]
