...
#[allow(clippy::unnecessary_wraps)]
pub fn de_admin_reset_user_password_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::admin_reset_user_password::AdminResetUserPasswordOutput, crate::operation::admin_reset_user_password::AdminResetUserPasswordError> {
    Ok({
        #[allow(unused_mut)]
