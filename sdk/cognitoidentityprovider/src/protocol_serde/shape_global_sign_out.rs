...
#[allow(clippy::unnecessary_wraps)]
pub fn de_global_sign_out_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::global_sign_out::GlobalSignOutOutput, crate::operation::global_sign_out::GlobalSignOutError> {
    Ok({
        #[allow(unused_mut)]
