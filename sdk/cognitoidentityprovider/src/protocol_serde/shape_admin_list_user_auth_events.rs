...
#[allow(clippy::unnecessary_wraps)]
pub fn de_admin_list_user_auth_events_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsOutput, crate::operation::admin_list_user_auth_events::AdminListUserAuthEventsError> {
    Ok({
        #[allow(unused_mut)]
