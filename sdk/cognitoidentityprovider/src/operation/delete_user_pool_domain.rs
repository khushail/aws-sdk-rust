...
impl DeleteUserPoolDomainInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUserPoolDomain`](crate::operation::delete_user_pool_domain::DeleteUserPoolDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_user_pool_domain::DeleteUserPoolDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user_pool_domain::DeleteUserPoolDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_user_pool_domain::ser_delete_user_pool_domain_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_pool_domain::DeleteUserPoolDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteUserPoolDomain", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserPoolDomain {
                type Output = ::std::result::Result<crate::operation::delete_user_pool_domain::DeleteUserPoolDomainOutput, crate::operation::delete_user_pool_domain::DeleteUserPoolDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_user_pool_domain::de_delete_user_pool_domain_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_user_pool_domain::DeleteUserPoolDomainError {
