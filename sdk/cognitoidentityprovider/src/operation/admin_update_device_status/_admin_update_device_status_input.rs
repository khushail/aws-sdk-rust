...
impl AdminUpdateDeviceStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::admin_update_device_status::AdminUpdateDeviceStatusInput, ::aws_smithy_http::operation::error::BuildError> {
