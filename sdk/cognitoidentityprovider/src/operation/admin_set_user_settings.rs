...
impl AdminSetUserSettingsInput {
    /// Consumes the builder and constructs an Operation<[`AdminSetUserSettings`](crate::operation::admin_set_user_settings::AdminSetUserSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::admin_set_user_settings::AdminSetUserSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_set_user_settings::AdminSetUserSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_set_user_settings::ser_admin_set_user_settings_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::admin_set_user_settings::AdminSetUserSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AdminSetUserSettings", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminSetUserSettings {
                type Output = ::std::result::Result<crate::operation::admin_set_user_settings::AdminSetUserSettingsOutput, crate::operation::admin_set_user_settings::AdminSetUserSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_admin_set_user_settings::de_admin_set_user_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::admin_set_user_settings::AdminSetUserSettingsError {
