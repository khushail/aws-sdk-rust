...
impl GetIdentityProviderByIdentifierInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_identity_provider_by_identifier::GetIdentityProviderByIdentifierInput, ::aws_smithy_http::operation::error::BuildError> {
