...
impl ConfirmForgotPasswordInput {
    /// Consumes the builder and constructs an Operation<[`ConfirmForgotPassword`](crate::operation::confirm_forgot_password::ConfirmForgotPassword)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::confirm_forgot_password::ConfirmForgotPassword, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::confirm_forgot_password::ConfirmForgotPasswordInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_confirm_forgot_password::ser_confirm_forgot_password_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::confirm_forgot_password::ConfirmForgotPassword::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ConfirmForgotPassword", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmForgotPassword {
                type Output = ::std::result::Result<crate::operation::confirm_forgot_password::ConfirmForgotPasswordOutput, crate::operation::confirm_forgot_password::ConfirmForgotPasswordError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_confirm_forgot_password::de_confirm_forgot_password_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::confirm_forgot_password::ConfirmForgotPasswordError {
