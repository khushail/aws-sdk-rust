...
impl ListResourceServersInput {
    /// Consumes the builder and constructs an Operation<[`ListResourceServers`](crate::operation::list_resource_servers::ListResourceServers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_resource_servers::ListResourceServers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resource_servers::ListResourceServersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_resource_servers::ser_list_resource_servers_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_servers::ListResourceServers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListResourceServers", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourceServers {
                type Output = ::std::result::Result<crate::operation::list_resource_servers::ListResourceServersOutput, crate::operation::list_resource_servers::ListResourceServersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_resource_servers::de_list_resource_servers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_resource_servers::de_list_resource_servers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_resource_servers::ListResourceServersError {
