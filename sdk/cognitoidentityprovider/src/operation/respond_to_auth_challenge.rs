...
impl RespondToAuthChallengeInput {
    /// Consumes the builder and constructs an Operation<[`RespondToAuthChallenge`](crate::operation::respond_to_auth_challenge::RespondToAuthChallenge)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::respond_to_auth_challenge::RespondToAuthChallenge, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::respond_to_auth_challenge::RespondToAuthChallengeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_respond_to_auth_challenge::ser_respond_to_auth_challenge_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::respond_to_auth_challenge::RespondToAuthChallenge::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RespondToAuthChallenge", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RespondToAuthChallenge {
                type Output = ::std::result::Result<crate::operation::respond_to_auth_challenge::RespondToAuthChallengeOutput, crate::operation::respond_to_auth_challenge::RespondToAuthChallengeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_respond_to_auth_challenge::de_respond_to_auth_challenge_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::respond_to_auth_challenge::RespondToAuthChallengeError {
