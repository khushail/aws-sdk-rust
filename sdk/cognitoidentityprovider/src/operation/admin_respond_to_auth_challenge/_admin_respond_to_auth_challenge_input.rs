...
impl AdminRespondToAuthChallengeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::admin_respond_to_auth_challenge::AdminRespondToAuthChallengeInput, ::aws_smithy_http::operation::error::BuildError> {
