...
impl ListUserPoolsInput {
    /// Consumes the builder and constructs an Operation<[`ListUserPools`](crate::operation::list_user_pools::ListUserPools)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_user_pools::ListUserPools, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_user_pools::ListUserPoolsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_user_pools::ser_list_user_pools_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_user_pools::ListUserPools::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListUserPools", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUserPools {
                type Output = ::std::result::Result<crate::operation::list_user_pools::ListUserPoolsOutput, crate::operation::list_user_pools::ListUserPoolsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_user_pools::de_list_user_pools_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_user_pools::ListUserPoolsError {
