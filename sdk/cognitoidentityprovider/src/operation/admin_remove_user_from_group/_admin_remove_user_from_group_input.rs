...
impl AdminRemoveUserFromGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupInput, ::aws_smithy_http::operation::error::BuildError> {
