...
impl DescribeIdentityProviderInput {
    /// Consumes the builder and constructs an Operation<[`DescribeIdentityProvider`](crate::operation::describe_identity_provider::DescribeIdentityProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_identity_provider::DescribeIdentityProvider, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_identity_provider::DescribeIdentityProviderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_identity_provider::ser_describe_identity_provider_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_identity_provider::DescribeIdentityProvider::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeIdentityProvider", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIdentityProvider {
                type Output = ::std::result::Result<crate::operation::describe_identity_provider::DescribeIdentityProviderOutput, crate::operation::describe_identity_provider::DescribeIdentityProviderError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_identity_provider::de_describe_identity_provider_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_identity_provider::DescribeIdentityProviderError {
