...
impl SetRiskConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`SetRiskConfiguration`](crate::operation::set_risk_configuration::SetRiskConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_risk_configuration::SetRiskConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_risk_configuration::SetRiskConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_risk_configuration::ser_set_risk_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_risk_configuration::SetRiskConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SetRiskConfiguration", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetRiskConfiguration {
                type Output = ::std::result::Result<crate::operation::set_risk_configuration::SetRiskConfigurationOutput, crate::operation::set_risk_configuration::SetRiskConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_set_risk_configuration::de_set_risk_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_risk_configuration::SetRiskConfigurationError {
