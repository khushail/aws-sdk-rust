...
impl UpdateAuthEventFeedbackInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAuthEventFeedback`](crate::operation::update_auth_event_feedback::UpdateAuthEventFeedback)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_auth_event_feedback::UpdateAuthEventFeedback, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_auth_event_feedback::UpdateAuthEventFeedbackInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_auth_event_feedback::ser_update_auth_event_feedback_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_auth_event_feedback::UpdateAuthEventFeedback::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateAuthEventFeedback", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAuthEventFeedback {
                type Output = ::std::result::Result<crate::operation::update_auth_event_feedback::UpdateAuthEventFeedbackOutput, crate::operation::update_auth_event_feedback::UpdateAuthEventFeedbackError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_auth_event_feedback::de_update_auth_event_feedback_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_auth_event_feedback::UpdateAuthEventFeedbackError {
