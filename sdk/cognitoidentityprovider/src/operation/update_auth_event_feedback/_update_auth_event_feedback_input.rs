...
impl UpdateAuthEventFeedbackInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_auth_event_feedback::UpdateAuthEventFeedbackInput, ::aws_smithy_http::operation::error::BuildError> {
