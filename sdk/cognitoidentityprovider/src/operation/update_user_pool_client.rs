...
impl UpdateUserPoolClientInput {
    /// Consumes the builder and constructs an Operation<[`UpdateUserPoolClient`](crate::operation::update_user_pool_client::UpdateUserPoolClient)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_user_pool_client::UpdateUserPoolClient, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_user_pool_client::UpdateUserPoolClientInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_user_pool_client::ser_update_user_pool_client_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_user_pool_client::UpdateUserPoolClient::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateUserPoolClient", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUserPoolClient {
                type Output = ::std::result::Result<crate::operation::update_user_pool_client::UpdateUserPoolClientOutput, crate::operation::update_user_pool_client::UpdateUserPoolClientError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_user_pool_client::de_update_user_pool_client_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_user_pool_client::UpdateUserPoolClientError {
