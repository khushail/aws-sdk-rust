...
impl AdminRemoveUserFromGroupInput {
    /// Consumes the builder and constructs an Operation<[`AdminRemoveUserFromGroup`](crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_remove_user_from_group::ser_admin_remove_user_from_group_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AdminRemoveUserFromGroup", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminRemoveUserFromGroup {
                type Output = ::std::result::Result<crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupOutput, crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_admin_remove_user_from_group::de_admin_remove_user_from_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::admin_remove_user_from_group::AdminRemoveUserFromGroupError {
