...
impl GetSigningCertificateInput {
    /// Consumes the builder and constructs an Operation<[`GetSigningCertificate`](crate::operation::get_signing_certificate::GetSigningCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_signing_certificate::GetSigningCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_signing_certificate::GetSigningCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_signing_certificate::ser_get_signing_certificate_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_signing_certificate::GetSigningCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSigningCertificate", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSigningCertificate {
                type Output = ::std::result::Result<crate::operation::get_signing_certificate::GetSigningCertificateOutput, crate::operation::get_signing_certificate::GetSigningCertificateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_signing_certificate::de_get_signing_certificate_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_signing_certificate::GetSigningCertificateError {
