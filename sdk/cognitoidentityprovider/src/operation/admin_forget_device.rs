...
impl AdminForgetDeviceInput {
    /// Consumes the builder and constructs an Operation<[`AdminForgetDevice`](crate::operation::admin_forget_device::AdminForgetDevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::admin_forget_device::AdminForgetDevice, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_forget_device::AdminForgetDeviceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_forget_device::ser_admin_forget_device_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::admin_forget_device::AdminForgetDevice::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AdminForgetDevice", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminForgetDevice {
                type Output = ::std::result::Result<crate::operation::admin_forget_device::AdminForgetDeviceOutput, crate::operation::admin_forget_device::AdminForgetDeviceError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::admin_forget_device::AdminForgetDeviceError {
