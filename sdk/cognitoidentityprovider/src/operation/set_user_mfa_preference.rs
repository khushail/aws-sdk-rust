...
impl SetUserMfaPreferenceInput {
    /// Consumes the builder and constructs an Operation<[`SetUserMFAPreference`](crate::operation::set_user_mfa_preference::SetUserMFAPreference)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_user_mfa_preference::SetUserMFAPreference, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_user_mfa_preference::SetUserMfaPreferenceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_user_mfa_preference::ser_set_user_mfa_preference_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_user_mfa_preference::SetUserMFAPreference::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SetUserMFAPreference", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetUserMFAPreference {
                type Output = ::std::result::Result<crate::operation::set_user_mfa_preference::SetUserMfaPreferenceOutput, crate::operation::set_user_mfa_preference::SetUserMFAPreferenceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_set_user_mfa_preference::de_set_user_mfa_preference_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_user_mfa_preference::SetUserMFAPreferenceError {
