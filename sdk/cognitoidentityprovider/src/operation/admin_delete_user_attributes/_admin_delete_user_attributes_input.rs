...
impl AdminDeleteUserAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::admin_delete_user_attributes::AdminDeleteUserAttributesInput, ::aws_smithy_http::operation::error::BuildError> {
