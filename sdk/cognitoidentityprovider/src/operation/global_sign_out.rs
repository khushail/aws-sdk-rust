...
impl GlobalSignOutInput {
    /// Consumes the builder and constructs an Operation<[`GlobalSignOut`](crate::operation::global_sign_out::GlobalSignOut)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::global_sign_out::GlobalSignOut, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::global_sign_out::GlobalSignOutInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_global_sign_out::ser_global_sign_out_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::global_sign_out::GlobalSignOut::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GlobalSignOut", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GlobalSignOut {
                type Output = ::std::result::Result<crate::operation::global_sign_out::GlobalSignOutOutput, crate::operation::global_sign_out::GlobalSignOutError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_global_sign_out::de_global_sign_out_http_response_with_props(status, headers, body)
                     }
                }
