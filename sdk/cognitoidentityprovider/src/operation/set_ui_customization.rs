...
impl SetUiCustomizationInput {
    /// Consumes the builder and constructs an Operation<[`SetUICustomization`](crate::operation::set_ui_customization::SetUICustomization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_ui_customization::SetUICustomization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_ui_customization::SetUiCustomizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_ui_customization::ser_set_ui_customization_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_ui_customization::SetUICustomization::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SetUICustomization", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetUICustomization {
                type Output = ::std::result::Result<crate::operation::set_ui_customization::SetUiCustomizationOutput, crate::operation::set_ui_customization::SetUICustomizationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_set_ui_customization::de_set_ui_customization_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_ui_customization::SetUICustomizationError {
