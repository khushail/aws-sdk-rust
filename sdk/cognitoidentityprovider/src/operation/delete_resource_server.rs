...
impl DeleteResourceServerInput {
    /// Consumes the builder and constructs an Operation<[`DeleteResourceServer`](crate::operation::delete_resource_server::DeleteResourceServer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_resource_server::DeleteResourceServer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_resource_server::DeleteResourceServerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_resource_server::ser_delete_resource_server_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_resource_server::DeleteResourceServer::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteResourceServer", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteResourceServer {
                type Output = ::std::result::Result<crate::operation::delete_resource_server::DeleteResourceServerOutput, crate::operation::delete_resource_server::DeleteResourceServerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_resource_server::de_delete_resource_server_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_resource_server::DeleteResourceServerError {
