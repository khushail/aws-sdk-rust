...
impl DescribeUserImportJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeUserImportJob`](crate::operation::describe_user_import_job::DescribeUserImportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_user_import_job::DescribeUserImportJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_user_import_job::DescribeUserImportJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_user_import_job::ser_describe_user_import_job_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_user_import_job::DescribeUserImportJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeUserImportJob", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUserImportJob {
                type Output = ::std::result::Result<crate::operation::describe_user_import_job::DescribeUserImportJobOutput, crate::operation::describe_user_import_job::DescribeUserImportJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_user_import_job::de_describe_user_import_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_user_import_job::DescribeUserImportJobError {
