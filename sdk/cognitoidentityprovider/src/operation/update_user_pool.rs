...
impl UpdateUserPoolInput {
    /// Consumes the builder and constructs an Operation<[`UpdateUserPool`](crate::operation::update_user_pool::UpdateUserPool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_user_pool::UpdateUserPool, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_user_pool::UpdateUserPoolInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_user_pool::ser_update_user_pool_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_user_pool::UpdateUserPool::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateUserPool", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUserPool {
                type Output = ::std::result::Result<crate::operation::update_user_pool::UpdateUserPoolOutput, crate::operation::update_user_pool::UpdateUserPoolError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_user_pool::de_update_user_pool_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_user_pool::UpdateUserPoolError {
