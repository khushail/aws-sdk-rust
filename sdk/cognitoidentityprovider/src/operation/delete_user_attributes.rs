...
impl DeleteUserAttributesInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUserAttributes`](crate::operation::delete_user_attributes::DeleteUserAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_user_attributes::DeleteUserAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user_attributes::DeleteUserAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_user_attributes::ser_delete_user_attributes_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_attributes::DeleteUserAttributes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteUserAttributes", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserAttributes {
                type Output = ::std::result::Result<crate::operation::delete_user_attributes::DeleteUserAttributesOutput, crate::operation::delete_user_attributes::DeleteUserAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_user_attributes::de_delete_user_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_user_attributes::DeleteUserAttributesError {
