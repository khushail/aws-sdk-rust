...
impl AdminSetUserMfaPreferenceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::admin_set_user_mfa_preference::AdminSetUserMfaPreferenceInput, ::aws_smithy_http::operation::error::BuildError> {
