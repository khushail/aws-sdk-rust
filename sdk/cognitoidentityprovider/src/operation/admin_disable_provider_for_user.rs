...
impl AdminDisableProviderForUserInput {
    /// Consumes the builder and constructs an Operation<[`AdminDisableProviderForUser`](crate::operation::admin_disable_provider_for_user::AdminDisableProviderForUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::admin_disable_provider_for_user::AdminDisableProviderForUser, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::admin_disable_provider_for_user::AdminDisableProviderForUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_admin_disable_provider_for_user::ser_admin_disable_provider_for_user_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::admin_disable_provider_for_user::AdminDisableProviderForUser::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AdminDisableProviderForUser", "cognitoidentityprovider"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AdminDisableProviderForUser {
                type Output = ::std::result::Result<crate::operation::admin_disable_provider_for_user::AdminDisableProviderForUserOutput, crate::operation::admin_disable_provider_for_user::AdminDisableProviderForUserError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_admin_disable_provider_for_user::de_admin_disable_provider_for_user_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::admin_disable_provider_for_user::AdminDisableProviderForUserError {
