...
impl super::Client  {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::update_user_pool_domain::builders::UpdateUserPoolDomainFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::update_user_pool_domain::builders::UpdateUserPoolDomainFluentBuilder::set_domain): <p>The domain name for the custom domain that hosts the sign-up and sign-in pages for your application. One example might be <code>auth.example.com</code>. </p>  <p>This string can include only lowercase letters, numbers, and hyphens. Don't use a hyphen for the first or last character. Use periods to separate subdomain names.</p>
    ///   - [`user_pool_id(impl ::std::convert::Into<String>)`](crate::operation::update_user_pool_domain::builders::UpdateUserPoolDomainFluentBuilder::user_pool_id) / [`set_user_pool_id(Option<String>)`](crate::operation::update_user_pool_domain::builders::UpdateUserPoolDomainFluentBuilder::set_user_pool_id): <p>The ID of the user pool that is associated with the custom domain whose certificate you're updating.</p>
