...
impl BatchGetRecordInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetRecord`](crate::operation::batch_get_record::BatchGetRecord)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_get_record::BatchGetRecord, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_record::BatchGetRecordInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/BatchGetRecord").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_record::ser_batch_get_record_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_record::BatchGetRecord::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchGetRecord", "sagemakerfeaturestoreruntime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchGetRecord`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetRecord {
                type Output = ::std::result::Result<crate::operation::batch_get_record::BatchGetRecordOutput, crate::operation::batch_get_record::BatchGetRecordError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_get_record::de_batch_get_record_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_get_record::de_batch_get_record_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_record::BatchGetRecordError {
