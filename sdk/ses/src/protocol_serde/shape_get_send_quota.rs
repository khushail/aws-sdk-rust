...
pub fn de_get_send_quota_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_send_quota::GetSendQuotaOutput, crate::operation::get_send_quota::GetSendQuotaError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_send_quota::GetSendQuotaError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_send_quota_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_send_quota::GetSendQuotaOutput, crate::operation::get_send_quota::GetSendQuotaError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_send_quota::builders::GetSendQuotaOutputBuilder::default();
        output = crate::protocol_serde::shape_get_send_quota::de_get_send_quota(_response_body, output).map_err(crate::operation::get_send_quota::GetSendQuotaError::unhandled)?;
