...
impl super::Client  {
    ...
    ///   - [`domain(impl ::std::convert::Into<String>)`](crate::operation::verify_domain_identity::builders::VerifyDomainIdentityFluentBuilder::domain) / [`set_domain(Option<String>)`](crate::operation::verify_domain_identity::builders::VerifyDomainIdentityFluentBuilder::set_domain): <p>The domain to be verified.</p>
