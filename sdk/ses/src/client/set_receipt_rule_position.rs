...
impl super::Client  {
    ...
    ///   - [`rule_set_name(impl ::std::convert::Into<String>)`](crate::operation::set_receipt_rule_position::builders::SetReceiptRulePositionFluentBuilder::rule_set_name) / [`set_rule_set_name(Option<String>)`](crate::operation::set_receipt_rule_position::builders::SetReceiptRulePositionFluentBuilder::set_rule_set_name): <p>The name of the receipt rule set that contains the receipt rule to reposition.</p>
    ///   - [`rule_name(impl ::std::convert::Into<String>)`](crate::operation::set_receipt_rule_position::builders::SetReceiptRulePositionFluentBuilder::rule_name) / [`set_rule_name(Option<String>)`](crate::operation::set_receipt_rule_position::builders::SetReceiptRulePositionFluentBuilder::set_rule_name): <p>The name of the receipt rule to reposition.</p>
