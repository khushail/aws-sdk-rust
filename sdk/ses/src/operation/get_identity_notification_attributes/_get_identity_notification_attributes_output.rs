...
impl GetIdentityNotificationAttributesOutputBuilder {
    ...
    ///
    /// <p>A map of Identity to IdentityNotificationAttributes.</p>
    pub fn notification_attributes(mut self, k: impl ::std::convert::Into<::std::string::String>, v: crate::types::IdentityNotificationAttributes) -> Self {
    ...
    /// <p>A map of Identity to IdentityNotificationAttributes.</p>
    pub fn get_notification_attributes(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, crate::types::IdentityNotificationAttributes>> {
