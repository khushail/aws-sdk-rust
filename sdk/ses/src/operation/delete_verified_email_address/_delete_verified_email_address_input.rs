...
impl DeleteVerifiedEmailAddressInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_verified_email_address::DeleteVerifiedEmailAddressInput, ::aws_smithy_http::operation::error::BuildError> {
