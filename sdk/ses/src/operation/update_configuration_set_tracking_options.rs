...
impl UpdateConfigurationSetTrackingOptionsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateConfigurationSetTrackingOptions`](crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateConfigurationSetTrackingOptions", "ses"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConfigurationSetTrackingOptions {
                type Output = ::std::result::Result<crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsOutput, crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_configuration_set_tracking_options::de_update_configuration_set_tracking_options_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_configuration_set_tracking_options::de_update_configuration_set_tracking_options_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_configuration_set_tracking_options::UpdateConfigurationSetTrackingOptionsError {
...
mod _update_configuration_set_tracking_options_output;
