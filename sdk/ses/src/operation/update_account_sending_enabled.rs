...
impl UpdateAccountSendingEnabledInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAccountSendingEnabled`](crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabled)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabled, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabled::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateAccountSendingEnabled", "ses"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAccountSendingEnabled {
                type Output = ::std::result::Result<crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledOutput, crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_account_sending_enabled::de_update_account_sending_enabled_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_account_sending_enabled::de_update_account_sending_enabled_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledError {
...
mod _update_account_sending_enabled_output;
