...
impl SetIdentityFeedbackForwardingEnabledInput {
    /// Consumes the builder and constructs an Operation<[`SetIdentityFeedbackForwardingEnabled`](crate::operation::set_identity_feedback_forwarding_enabled::SetIdentityFeedbackForwardingEnabled)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_identity_feedback_forwarding_enabled::SetIdentityFeedbackForwardingEnabled, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_identity_feedback_forwarding_enabled::SetIdentityFeedbackForwardingEnabledInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_identity_feedback_forwarding_enabled::SetIdentityFeedbackForwardingEnabled::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SetIdentityFeedbackForwardingEnabled", "ses"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SetIdentityFeedbackForwardingEnabled`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetIdentityFeedbackForwardingEnabled {
                type Output = ::std::result::Result<crate::operation::set_identity_feedback_forwarding_enabled::SetIdentityFeedbackForwardingEnabledOutput, crate::operation::set_identity_feedback_forwarding_enabled::SetIdentityFeedbackForwardingEnabledError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_set_identity_feedback_forwarding_enabled::de_set_identity_feedback_forwarding_enabled_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_set_identity_feedback_forwarding_enabled::de_set_identity_feedback_forwarding_enabled_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_identity_feedback_forwarding_enabled::SetIdentityFeedbackForwardingEnabledError {
...
mod _set_identity_feedback_forwarding_enabled_output;
