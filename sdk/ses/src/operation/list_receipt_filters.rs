...
impl ListReceiptFiltersInput {
    /// Consumes the builder and constructs an Operation<[`ListReceiptFilters`](crate::operation::list_receipt_filters::ListReceiptFilters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_receipt_filters::ListReceiptFilters, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_receipt_filters::ListReceiptFiltersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_receipt_filters::ListReceiptFilters::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListReceiptFilters", "ses"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReceiptFilters {
                type Output = ::std::result::Result<crate::operation::list_receipt_filters::ListReceiptFiltersOutput, crate::operation::list_receipt_filters::ListReceiptFiltersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_receipt_filters::de_list_receipt_filters_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_receipt_filters::ListReceiptFiltersError {
...
mod _list_receipt_filters_output;
