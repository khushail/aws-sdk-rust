...
impl SetIdentityMailFromDomainInput {
    /// Consumes the builder and constructs an Operation<[`SetIdentityMailFromDomain`](crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomain)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomain, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomainInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomain::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SetIdentityMailFromDomain", "ses"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetIdentityMailFromDomain {
                type Output = ::std::result::Result<crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomainOutput, crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomainError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_set_identity_mail_from_domain::de_set_identity_mail_from_domain_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_set_identity_mail_from_domain::de_set_identity_mail_from_domain_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_identity_mail_from_domain::SetIdentityMailFromDomainError {
...
mod _set_identity_mail_from_domain_output;
