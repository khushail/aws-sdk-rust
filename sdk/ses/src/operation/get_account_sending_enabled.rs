...
impl GetAccountSendingEnabledInput {
    /// Consumes the builder and constructs an Operation<[`GetAccountSendingEnabled`](crate::operation::get_account_sending_enabled::GetAccountSendingEnabled)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_account_sending_enabled::GetAccountSendingEnabled, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_account_sending_enabled::GetAccountSendingEnabledInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_account_sending_enabled::GetAccountSendingEnabled::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAccountSendingEnabled", "ses"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccountSendingEnabled {
                type Output = ::std::result::Result<crate::operation::get_account_sending_enabled::GetAccountSendingEnabledOutput, crate::operation::get_account_sending_enabled::GetAccountSendingEnabledError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_account_sending_enabled::de_get_account_sending_enabled_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_account_sending_enabled::de_get_account_sending_enabled_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_account_sending_enabled::GetAccountSendingEnabledError {
...
mod _get_account_sending_enabled_output;
