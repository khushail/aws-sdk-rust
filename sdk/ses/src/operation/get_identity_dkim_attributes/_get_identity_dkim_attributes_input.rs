...
impl GetIdentityDkimAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_identity_dkim_attributes::GetIdentityDkimAttributesInput, ::aws_smithy_http::operation::error::BuildError> {
