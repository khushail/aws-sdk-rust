...
impl ListVerifiedEmailAddressesInput {
    /// Consumes the builder and constructs an Operation<[`ListVerifiedEmailAddresses`](crate::operation::list_verified_email_addresses::ListVerifiedEmailAddresses)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_verified_email_addresses::ListVerifiedEmailAddresses, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_verified_email_addresses::ListVerifiedEmailAddressesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_verified_email_addresses::ListVerifiedEmailAddresses::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListVerifiedEmailAddresses", "ses"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVerifiedEmailAddresses {
                type Output = ::std::result::Result<crate::operation::list_verified_email_addresses::ListVerifiedEmailAddressesOutput, crate::operation::list_verified_email_addresses::ListVerifiedEmailAddressesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_verified_email_addresses::de_list_verified_email_addresses_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_verified_email_addresses::de_list_verified_email_addresses_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_verified_email_addresses::ListVerifiedEmailAddressesError {
...
mod _list_verified_email_addresses_output;
