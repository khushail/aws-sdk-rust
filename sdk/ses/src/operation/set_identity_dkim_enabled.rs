...
impl SetIdentityDkimEnabledInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabled, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_identity_dkim_enabled::SetIdentityDkimEnabledInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetIdentityDkimEnabled {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_set_identity_dkim_enabled::de_set_identity_dkim_enabled_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_set_identity_dkim_enabled::de_set_identity_dkim_enabled_http_response_with_props(status, headers, body)
                     }
                }
