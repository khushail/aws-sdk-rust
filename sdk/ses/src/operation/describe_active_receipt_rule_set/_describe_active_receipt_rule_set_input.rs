...
impl DescribeActiveReceiptRuleSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_active_receipt_rule_set::DescribeActiveReceiptRuleSetInput, ::aws_smithy_http::operation::error::BuildError> {
