...
impl UpdateAccountSendingEnabledInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_account_sending_enabled::UpdateAccountSendingEnabledInput, ::aws_smithy_http::operation::error::BuildError> {
