...
impl ListIdentityPoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListIdentityPolicies`](crate::operation::list_identity_policies::ListIdentityPolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_identity_policies::ListIdentityPolicies, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_identity_policies::ListIdentityPoliciesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_identity_policies::ListIdentityPolicies::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListIdentityPolicies", "ses"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListIdentityPolicies`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIdentityPolicies {
                type Output = ::std::result::Result<crate::operation::list_identity_policies::ListIdentityPoliciesOutput, crate::operation::list_identity_policies::ListIdentityPoliciesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_identity_policies::de_list_identity_policies_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_identity_policies::de_list_identity_policies_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_identity_policies::ListIdentityPoliciesError {
...
pub use crate::operation::list_identity_policies::_list_identity_policies_output::ListIdentityPoliciesOutput;

pub use crate::operation::list_identity_policies::_list_identity_policies_input::ListIdentityPoliciesInput;

mod _list_identity_policies_input;

mod _list_identity_policies_output;
