...
pub fn de_payload_payload(body: &mut ::aws_smithy_http::body::SdkBody) -> std::result::Result<::aws_smithy_http::byte_stream::ByteStream, crate::operation::get_media::GetMediaError> {
