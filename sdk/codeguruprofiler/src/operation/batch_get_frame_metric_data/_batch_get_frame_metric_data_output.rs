...
impl BatchGetFrameMetricDataOutputBuilder {
    ...
    ///
    /// <p>List of instances which remained unprocessed. This will create a missing time step in the list of end times.</p>
    pub fn unprocessed_end_times(mut self, k: impl ::std::convert::Into<::std::string::String>, v: ::std::vec::Vec<crate::types::TimestampStructure>) -> Self {
    ...
    /// <p>List of instances which remained unprocessed. This will create a missing time step in the list of end times.</p>
    pub fn get_unprocessed_end_times(&self) -> &::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::vec::Vec<crate::types::TimestampStructure>>> {
