...
impl ListTypedLinkFacetAttributesInput {
    /// Consumes the builder and constructs an Operation<[`ListTypedLinkFacetAttributes`](crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/facet/attributes").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTypedLinkFacetAttributes", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListTypedLinkFacetAttributes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListTypedLinkFacetAttributes {
                type Output = ::std::result::Result<crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributesOutput, crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_typed_link_facet_attributes::de_list_typed_link_facet_attributes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_typed_link_facet_attributes::de_list_typed_link_facet_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_typed_link_facet_attributes::ListTypedLinkFacetAttributesError {
...
pub use crate::operation::list_typed_link_facet_attributes::_list_typed_link_facet_attributes_output::ListTypedLinkFacetAttributesOutput;

pub use crate::operation::list_typed_link_facet_attributes::_list_typed_link_facet_attributes_input::ListTypedLinkFacetAttributesInput;

mod _list_typed_link_facet_attributes_input;

mod _list_typed_link_facet_attributes_output;
