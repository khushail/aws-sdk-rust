...
impl ListPolicyAttachmentsInput {
    /// Consumes the builder and constructs an Operation<[`ListPolicyAttachments`](crate::operation::list_policy_attachments::ListPolicyAttachments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_policy_attachments::ListPolicyAttachments, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_policy_attachments::ListPolicyAttachmentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/policy/attachment").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_policy_attachments::ListPolicyAttachments::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPolicyAttachments", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListPolicyAttachments`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyAttachments {
                type Output = ::std::result::Result<crate::operation::list_policy_attachments::ListPolicyAttachmentsOutput, crate::operation::list_policy_attachments::ListPolicyAttachmentsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_policy_attachments::de_list_policy_attachments_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_policy_attachments::de_list_policy_attachments_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_policy_attachments::ListPolicyAttachmentsError {
...
pub use crate::operation::list_policy_attachments::_list_policy_attachments_output::ListPolicyAttachmentsOutput;

pub use crate::operation::list_policy_attachments::_list_policy_attachments_input::ListPolicyAttachmentsInput;

mod _list_policy_attachments_input;

mod _list_policy_attachments_output;
