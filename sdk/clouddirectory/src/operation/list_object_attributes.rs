...
impl ListObjectAttributesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_object_attributes::ListObjectAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_object_attributes::ListObjectAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/object/attributes").expect("formatting should succeed");
...
/// Orchestration and serialization glue logic for `ListObjectAttributes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListObjectAttributes {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_object_attributes::de_list_object_attributes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_object_attributes::de_list_object_attributes_http_response_with_props(status, headers, body)
                     }
                }
