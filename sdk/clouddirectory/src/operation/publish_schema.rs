...
impl PublishSchemaInput {
    /// Consumes the builder and constructs an Operation<[`PublishSchema`](crate::operation::publish_schema::PublishSchema)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::publish_schema::PublishSchema, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::publish_schema::PublishSchemaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/publish").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::publish_schema::PublishSchema::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PublishSchema", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PublishSchema`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PublishSchema {
                type Output = ::std::result::Result<crate::operation::publish_schema::PublishSchemaOutput, crate::operation::publish_schema::PublishSchemaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_publish_schema::de_publish_schema_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_publish_schema::de_publish_schema_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::publish_schema::PublishSchemaError {
