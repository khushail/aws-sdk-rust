...
impl ListManagedSchemaArnsInput {
    /// Consumes the builder and constructs an Operation<[`ListManagedSchemaArns`](crate::operation::list_managed_schema_arns::ListManagedSchemaArns)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_managed_schema_arns::ListManagedSchemaArns, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_managed_schema_arns::ListManagedSchemaArnsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/managed").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_managed_schema_arns::ListManagedSchemaArns::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListManagedSchemaArns", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListManagedSchemaArns`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListManagedSchemaArns {
                type Output = ::std::result::Result<crate::operation::list_managed_schema_arns::ListManagedSchemaArnsOutput, crate::operation::list_managed_schema_arns::ListManagedSchemaArnsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_managed_schema_arns::de_list_managed_schema_arns_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_managed_schema_arns::de_list_managed_schema_arns_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_managed_schema_arns::ListManagedSchemaArnsError {
...
mod _list_managed_schema_arns_output;
