...
impl UpgradePublishedSchemaInput {
    /// Consumes the builder and constructs an Operation<[`UpgradePublishedSchema`](crate::operation::upgrade_published_schema::UpgradePublishedSchema)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::upgrade_published_schema::UpgradePublishedSchema, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upgrade_published_schema::UpgradePublishedSchemaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/upgradepublished").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::upgrade_published_schema::UpgradePublishedSchema::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpgradePublishedSchema", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpgradePublishedSchema`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpgradePublishedSchema {
                type Output = ::std::result::Result<crate::operation::upgrade_published_schema::UpgradePublishedSchemaOutput, crate::operation::upgrade_published_schema::UpgradePublishedSchemaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_upgrade_published_schema::de_upgrade_published_schema_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_upgrade_published_schema::de_upgrade_published_schema_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::upgrade_published_schema::UpgradePublishedSchemaError {
...
mod _upgrade_published_schema_output;
