...
impl UpgradeAppliedSchemaInput {
    /// Consumes the builder and constructs an Operation<[`UpgradeAppliedSchema`](crate::operation::upgrade_applied_schema::UpgradeAppliedSchema)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::upgrade_applied_schema::UpgradeAppliedSchema, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upgrade_applied_schema::UpgradeAppliedSchemaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/schema/upgradeapplied").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::upgrade_applied_schema::UpgradeAppliedSchema::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpgradeAppliedSchema", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpgradeAppliedSchema`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpgradeAppliedSchema {
                type Output = ::std::result::Result<crate::operation::upgrade_applied_schema::UpgradeAppliedSchemaOutput, crate::operation::upgrade_applied_schema::UpgradeAppliedSchemaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_upgrade_applied_schema::de_upgrade_applied_schema_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_upgrade_applied_schema::de_upgrade_applied_schema_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::upgrade_applied_schema::UpgradeAppliedSchemaError {
...
pub use crate::operation::upgrade_applied_schema::_upgrade_applied_schema_output::UpgradeAppliedSchemaOutput;

pub use crate::operation::upgrade_applied_schema::_upgrade_applied_schema_input::UpgradeAppliedSchemaInput;

mod _upgrade_applied_schema_input;

mod _upgrade_applied_schema_output;
