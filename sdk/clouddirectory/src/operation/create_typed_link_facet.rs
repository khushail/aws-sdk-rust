...
impl CreateTypedLinkFacetInput {
    /// Consumes the builder and constructs an Operation<[`CreateTypedLinkFacet`](crate::operation::create_typed_link_facet::CreateTypedLinkFacet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_typed_link_facet::CreateTypedLinkFacet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_typed_link_facet::CreateTypedLinkFacetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/facet/create").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_typed_link_facet::CreateTypedLinkFacet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateTypedLinkFacet", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateTypedLinkFacet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateTypedLinkFacet {
                type Output = ::std::result::Result<crate::operation::create_typed_link_facet::CreateTypedLinkFacetOutput, crate::operation::create_typed_link_facet::CreateTypedLinkFacetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_typed_link_facet::de_create_typed_link_facet_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_typed_link_facet::de_create_typed_link_facet_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_typed_link_facet::CreateTypedLinkFacetError {
...
pub use crate::operation::create_typed_link_facet::_create_typed_link_facet_output::CreateTypedLinkFacetOutput;

pub use crate::operation::create_typed_link_facet::_create_typed_link_facet_input::CreateTypedLinkFacetInput;

mod _create_typed_link_facet_input;

mod _create_typed_link_facet_output;
