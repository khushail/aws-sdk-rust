...
impl AttachTypedLinkInput {
    /// Consumes the builder and constructs an Operation<[`AttachTypedLink`](crate::operation::attach_typed_link::AttachTypedLink)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::attach_typed_link::AttachTypedLink, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_typed_link::AttachTypedLinkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/attach").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_typed_link::AttachTypedLink::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachTypedLink {
                type Output = ::std::result::Result<crate::operation::attach_typed_link::AttachTypedLinkOutput, crate::operation::attach_typed_link::AttachTypedLinkError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_attach_typed_link::de_attach_typed_link_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_attach_typed_link::de_attach_typed_link_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_typed_link::AttachTypedLinkError {
