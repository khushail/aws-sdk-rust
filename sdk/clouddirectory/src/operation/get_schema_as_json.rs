...
impl GetSchemaAsJsonInput {
    /// Consumes the builder and constructs an Operation<[`GetSchemaAsJson`](crate::operation::get_schema_as_json::GetSchemaAsJson)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_schema_as_json::GetSchemaAsJson, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_schema_as_json::GetSchemaAsJsonInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_schema_as_json::GetSchemaAsJson::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSchemaAsJson {
                type Output = ::std::result::Result<crate::operation::get_schema_as_json::GetSchemaAsJsonOutput, crate::operation::get_schema_as_json::GetSchemaAsJsonError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_schema_as_json::de_get_schema_as_json_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_schema_as_json::GetSchemaAsJsonError {
...
mod _get_schema_as_json_output;
