...
impl ListAttachedIndicesInput {
    /// Consumes the builder and constructs an Operation<[`ListAttachedIndices`](crate::operation::list_attached_indices::ListAttachedIndices)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_attached_indices::ListAttachedIndices, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_attached_indices::ListAttachedIndicesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/object/indices").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_attached_indices::ListAttachedIndices::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAttachedIndices", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListAttachedIndices`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttachedIndices {
                type Output = ::std::result::Result<crate::operation::list_attached_indices::ListAttachedIndicesOutput, crate::operation::list_attached_indices::ListAttachedIndicesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_attached_indices::de_list_attached_indices_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_attached_indices::de_list_attached_indices_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_attached_indices::ListAttachedIndicesError {
...
mod _list_attached_indices_output;
