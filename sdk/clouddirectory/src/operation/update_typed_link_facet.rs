...
impl UpdateTypedLinkFacetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTypedLinkFacet`](crate::operation::update_typed_link_facet::UpdateTypedLinkFacet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_typed_link_facet::UpdateTypedLinkFacet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_typed_link_facet::UpdateTypedLinkFacetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/facet").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_typed_link_facet::UpdateTypedLinkFacet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateTypedLinkFacet", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateTypedLinkFacet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTypedLinkFacet {
                type Output = ::std::result::Result<crate::operation::update_typed_link_facet::UpdateTypedLinkFacetOutput, crate::operation::update_typed_link_facet::UpdateTypedLinkFacetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_typed_link_facet::de_update_typed_link_facet_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_typed_link_facet::de_update_typed_link_facet_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_typed_link_facet::UpdateTypedLinkFacetError {
...
mod _update_typed_link_facet_output;
