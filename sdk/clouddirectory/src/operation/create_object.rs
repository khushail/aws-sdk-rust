...
impl CreateObjectInput {
    /// Consumes the builder and constructs an Operation<[`CreateObject`](crate::operation::create_object::CreateObject)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_object::CreateObject, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_object::CreateObjectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/object").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_object::CreateObject::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateObject", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateObject`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateObject {
                type Output = ::std::result::Result<crate::operation::create_object::CreateObjectOutput, crate::operation::create_object::CreateObjectError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_object::de_create_object_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_object::de_create_object_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_object::CreateObjectError {
...
pub use crate::operation::create_object::_create_object_output::CreateObjectOutput;

pub use crate::operation::create_object::_create_object_input::CreateObjectInput;

mod _create_object_input;

mod _create_object_output;
