...
impl AttachToIndexInput {
    /// Consumes the builder and constructs an Operation<[`AttachToIndex`](crate::operation::attach_to_index::AttachToIndex)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::attach_to_index::AttachToIndex, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_to_index::AttachToIndexInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/index/attach").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_to_index::AttachToIndex::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachToIndex {
                type Output = ::std::result::Result<crate::operation::attach_to_index::AttachToIndexOutput, crate::operation::attach_to_index::AttachToIndexError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_attach_to_index::de_attach_to_index_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_attach_to_index::de_attach_to_index_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_to_index::AttachToIndexError {
