...
impl GetLinkAttributesInput {
    /// Consumes the builder and constructs an Operation<[`GetLinkAttributes`](crate::operation::get_link_attributes::GetLinkAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_link_attributes::GetLinkAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_link_attributes::GetLinkAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/amazonclouddirectory/2017-01-11/typedlink/attributes/get").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_link_attributes::GetLinkAttributes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetLinkAttributes", "clouddirectory"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetLinkAttributes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetLinkAttributes {
                type Output = ::std::result::Result<crate::operation::get_link_attributes::GetLinkAttributesOutput, crate::operation::get_link_attributes::GetLinkAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_link_attributes::de_get_link_attributes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_link_attributes::de_get_link_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_link_attributes::GetLinkAttributesError {
...
mod _get_link_attributes_output;
