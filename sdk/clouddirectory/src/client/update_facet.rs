...
impl super::Client  {
    ...
    ///   - [`schema_arn(impl ::std::convert::Into<String>)`](crate::operation::update_facet::builders::UpdateFacetFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::update_facet::builders::UpdateFacetFluentBuilder::set_schema_arn): <p>The Amazon Resource Name (ARN) that is associated with the <code>Facet</code>. For more information, see <code>arns</code>.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_facet::builders::UpdateFacetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_facet::builders::UpdateFacetFluentBuilder::set_name): <p>The name of the facet.</p>
