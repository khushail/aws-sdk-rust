...
impl super::Client  {
    ...
    ///   - [`link_name(impl ::std::convert::Into<String>)`](crate::operation::attach_object::builders::AttachObjectFluentBuilder::link_name) / [`set_link_name(Option<String>)`](crate::operation::attach_object::builders::AttachObjectFluentBuilder::set_link_name): <p>The link name with which the child object is attached to the parent.</p>
