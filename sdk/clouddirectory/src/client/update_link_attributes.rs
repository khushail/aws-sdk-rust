...
impl super::Client  {
    ...
    ///   - [`directory_arn(impl ::std::convert::Into<String>)`](crate::operation::update_link_attributes::builders::UpdateLinkAttributesFluentBuilder::directory_arn) / [`set_directory_arn(Option<String>)`](crate::operation::update_link_attributes::builders::UpdateLinkAttributesFluentBuilder::set_directory_arn): <p>The Amazon Resource Name (ARN) that is associated with the Directory where the updated typed link resides. For more information, see <code>arns</code> or <a href="https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink">Typed Links</a>.</p>
