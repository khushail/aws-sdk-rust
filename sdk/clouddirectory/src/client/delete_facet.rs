...
impl super::Client  {
    ...
    ///   - [`schema_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_facet::builders::DeleteFacetFluentBuilder::schema_arn) / [`set_schema_arn(Option<String>)`](crate::operation::delete_facet::builders::DeleteFacetFluentBuilder::set_schema_arn): <p>The Amazon Resource Name (ARN) that is associated with the <code>Facet</code>. For more information, see <code>arns</code>.</p>
