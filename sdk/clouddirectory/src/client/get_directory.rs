...
impl super::Client  {
    ...
    ///   - [`directory_arn(impl ::std::convert::Into<String>)`](crate::operation::get_directory::builders::GetDirectoryFluentBuilder::directory_arn) / [`set_directory_arn(Option<String>)`](crate::operation::get_directory::builders::GetDirectoryFluentBuilder::set_directory_arn): <p>The ARN of the directory.</p>
