...
pub fn ser_attach_object_input(input: &crate::operation::attach_object::AttachObjectInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
...
pub fn de_attach_object_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_object::AttachObjectOutput, crate::operation::attach_object::AttachObjectError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::attach_object::AttachObjectError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::attach_object::AttachObjectError::unhandled(generic))
                            };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_object_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_object::AttachObjectOutput, crate::operation::attach_object::AttachObjectError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::attach_object::builders::AttachObjectOutputBuilder::default();
        output = crate::protocol_serde::shape_attach_object::de_attach_object(_response_body, output).map_err(crate::operation::attach_object::AttachObjectError::unhandled)?;
        output._set_request_id(::aws_http::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_attach_object(value: &[u8], mut builder: crate::operation::attach_object::builders::AttachObjectOutputBuilder) -> Result<crate::operation::attach_object::builders::AttachObjectOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
