...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_object_attributes_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_object_attributes::UpdateObjectAttributesOutput, crate::operation::update_object_attributes::UpdateObjectAttributesError> {
    Ok({
        #[allow(unused_mut)]
