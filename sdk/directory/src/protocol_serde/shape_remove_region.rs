...
pub fn ser_remove_region_input(input: &crate::operation::remove_region::RemoveRegionInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_region_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_region::RemoveRegionOutput, crate::operation::remove_region::RemoveRegionError> {
    Ok({
        #[allow(unused_mut)]
