...
#[allow(clippy::unnecessary_wraps)]
pub fn de_unshare_directory_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::unshare_directory::UnshareDirectoryOutput, crate::operation::unshare_directory::UnshareDirectoryError> {
    Ok({
        #[allow(unused_mut)]
