...
impl super::Client  {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::register_certificate::builders::RegisterCertificateFluentBuilder::set_directory_id): <p>The identifier of the directory.</p>
