...
impl super::Client  {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::describe_conditional_forwarders::builders::DescribeConditionalForwardersFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::describe_conditional_forwarders::builders::DescribeConditionalForwardersFluentBuilder::set_directory_id): <p>The directory ID for which to get the list of associated conditional forwarders.</p>
