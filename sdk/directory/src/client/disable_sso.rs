...
impl super::Client  {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::disable_sso::builders::DisableSsoFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::disable_sso::builders::DisableSsoFluentBuilder::set_directory_id): <p>The identifier of the directory for which to disable single-sign on.</p>
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::disable_sso::builders::DisableSsoFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::disable_sso::builders::DisableSsoFluentBuilder::set_user_name): <p>The username of an alternate account to use to disable single-sign on. This is only used for AD Connector directories. This account must have privileges to remove a service principal name.</p>  <p>If the AD Connector service account does not have privileges to remove a service principal name, you can specify an alternate account with the <i>UserName</i> and <i>Password</i> parameters. These credentials are only used to disable single sign-on and are not stored by the service. The AD Connector service account is not changed.</p>
    ///   - [`password(impl ::std::convert::Into<String>)`](crate::operation::disable_sso::builders::DisableSsoFluentBuilder::password) / [`set_password(Option<String>)`](crate::operation::disable_sso::builders::DisableSsoFluentBuilder::set_password): <p>The password of an alternate account to use to disable single-sign on. This is only used for AD Connector directories. For more information, see the <i>UserName</i> parameter.</p>
