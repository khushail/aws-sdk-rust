...
impl super::Client  {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::describe_ldaps_settings::builders::DescribeLDAPSSettingsFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::describe_ldaps_settings::builders::DescribeLDAPSSettingsFluentBuilder::set_directory_id): <p>The identifier of the directory.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_ldaps_settings::builders::DescribeLDAPSSettingsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_ldaps_settings::builders::DescribeLDAPSSettingsFluentBuilder::set_next_token): <p>The type of next token used for pagination.</p>
