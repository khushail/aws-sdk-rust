...
impl super::Client  {
    ...
    ///   - [`directory_id(impl ::std::convert::Into<String>)`](crate::operation::add_region::builders::AddRegionFluentBuilder::directory_id) / [`set_directory_id(Option<String>)`](crate::operation::add_region::builders::AddRegionFluentBuilder::set_directory_id): <p>The identifier of the directory to which you want to add Region replication.</p>
    ///   - [`region_name(impl ::std::convert::Into<String>)`](crate::operation::add_region::builders::AddRegionFluentBuilder::region_name) / [`set_region_name(Option<String>)`](crate::operation::add_region::builders::AddRegionFluentBuilder::set_region_name): <p>The name of the Region where you want to add domain controllers for replication. For example, <code>us-east-1</code>.</p>
