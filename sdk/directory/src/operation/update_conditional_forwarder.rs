...
impl UpdateConditionalForwarderInput {
    /// Consumes the builder and constructs an Operation<[`UpdateConditionalForwarder`](crate::operation::update_conditional_forwarder::UpdateConditionalForwarder)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_conditional_forwarder::UpdateConditionalForwarder, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_conditional_forwarder::UpdateConditionalForwarderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_conditional_forwarder::UpdateConditionalForwarder::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConditionalForwarder {
                type Output = ::std::result::Result<crate::operation::update_conditional_forwarder::UpdateConditionalForwarderOutput, crate::operation::update_conditional_forwarder::UpdateConditionalForwarderError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_conditional_forwarder::de_update_conditional_forwarder_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_conditional_forwarder::UpdateConditionalForwarderError {
