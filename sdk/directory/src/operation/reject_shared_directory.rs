...
impl RejectSharedDirectoryInput {
    /// Consumes the builder and constructs an Operation<[`RejectSharedDirectory`](crate::operation::reject_shared_directory::RejectSharedDirectory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reject_shared_directory::RejectSharedDirectory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reject_shared_directory::RejectSharedDirectoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reject_shared_directory::RejectSharedDirectory::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RejectSharedDirectory", "directoryservice"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RejectSharedDirectory`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RejectSharedDirectory {
                type Output = ::std::result::Result<crate::operation::reject_shared_directory::RejectSharedDirectoryOutput, crate::operation::reject_shared_directory::RejectSharedDirectoryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_reject_shared_directory::de_reject_shared_directory_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_reject_shared_directory::de_reject_shared_directory_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::reject_shared_directory::RejectSharedDirectoryError {
...
mod _reject_shared_directory_output;
