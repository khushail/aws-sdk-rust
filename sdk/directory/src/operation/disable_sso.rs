...
impl DisableSsoInput {
    /// Consumes the builder and constructs an Operation<[`DisableSso`](crate::operation::disable_sso::DisableSso)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_sso::DisableSso, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_sso::DisableSsoInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_sso::DisableSso::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableSso {
                type Output = ::std::result::Result<crate::operation::disable_sso::DisableSsoOutput, crate::operation::disable_sso::DisableSsoError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disable_sso::de_disable_sso_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disable_sso::de_disable_sso_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_sso::DisableSsoError {
