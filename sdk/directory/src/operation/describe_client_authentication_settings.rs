...
impl DescribeClientAuthenticationSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeClientAuthenticationSettings`](crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettings::new())
...
/// Orchestration and serialization glue logic for `DescribeClientAuthenticationSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClientAuthenticationSettings {
                type Output = ::std::result::Result<crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettingsOutput, crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_client_authentication_settings::de_describe_client_authentication_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_client_authentication_settings::de_describe_client_authentication_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_client_authentication_settings::DescribeClientAuthenticationSettingsError {
...
mod _describe_client_authentication_settings_output;
