...
impl DescribeDomainControllersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDomainControllers`](crate::operation::describe_domain_controllers::DescribeDomainControllers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_domain_controllers::DescribeDomainControllers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_domain_controllers::DescribeDomainControllersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_domain_controllers::DescribeDomainControllers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDomainControllers", "directoryservice"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeDomainControllers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDomainControllers {
                type Output = ::std::result::Result<crate::operation::describe_domain_controllers::DescribeDomainControllersOutput, crate::operation::describe_domain_controllers::DescribeDomainControllersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_domain_controllers::de_describe_domain_controllers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_domain_controllers::de_describe_domain_controllers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_domain_controllers::DescribeDomainControllersError {
...
pub use crate::operation::describe_domain_controllers::_describe_domain_controllers_output::DescribeDomainControllersOutput;

pub use crate::operation::describe_domain_controllers::_describe_domain_controllers_input::DescribeDomainControllersInput;

mod _describe_domain_controllers_input;

mod _describe_domain_controllers_output;
