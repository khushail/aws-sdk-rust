...
impl UnshareDirectoryInput {
    /// Consumes the builder and constructs an Operation<[`UnshareDirectory`](crate::operation::unshare_directory::UnshareDirectory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::unshare_directory::UnshareDirectory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::unshare_directory::UnshareDirectoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::unshare_directory::UnshareDirectory::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UnshareDirectory", "directoryservice"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UnshareDirectory`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnshareDirectory {
                type Output = ::std::result::Result<crate::operation::unshare_directory::UnshareDirectoryOutput, crate::operation::unshare_directory::UnshareDirectoryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_unshare_directory::de_unshare_directory_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_unshare_directory::de_unshare_directory_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::unshare_directory::UnshareDirectoryError {
