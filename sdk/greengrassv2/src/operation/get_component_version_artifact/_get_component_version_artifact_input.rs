...
impl GetComponentVersionArtifactInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_component_version_artifact::GetComponentVersionArtifactInput, ::aws_smithy_http::operation::error::BuildError> {
