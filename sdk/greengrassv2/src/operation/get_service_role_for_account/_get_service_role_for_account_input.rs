...
impl GetServiceRoleForAccountInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_service_role_for_account::GetServiceRoleForAccountInput, ::aws_smithy_http::operation::error::BuildError> {
