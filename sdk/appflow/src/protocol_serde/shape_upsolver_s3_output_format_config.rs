...
pub fn ser_upsolver_s3_output_format_config(
...
pub(crate) fn de_upsolver_s3_output_format_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::UpsolverS3OutputFormatConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::UpsolverS3OutputFormatConfigBuilder::default();
            loop {
                match tokens.next().transpose()? {
