...
pub(crate) fn de_glue_data_catalog_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::GlueDataCatalogConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
