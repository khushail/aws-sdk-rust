...
pub fn ser_s3_source_properties(
    ...
    if let Some(var_3) = &input.s3_input_format_config {
        ...
        crate::protocol_serde::shape_s3_input_format_config::ser_s3_input_format_config(&mut object_4, var_3)?;
        object_4.finish();
    }
    Ok(())
}

pub(crate) fn de_s3_source_properties<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::S3SourceProperties>, ::aws_smithy_json::deserialize::error::DeserializeError>
