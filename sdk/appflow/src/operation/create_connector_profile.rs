...
impl CreateConnectorProfileInput {
    /// Consumes the builder and constructs an Operation<[`CreateConnectorProfile`](crate::operation::create_connector_profile::CreateConnectorProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_connector_profile::CreateConnectorProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_connector_profile::CreateConnectorProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/create-connector-profile").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_connector_profile::CreateConnectorProfile::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateConnectorProfile", "appflow"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateConnectorProfile`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateConnectorProfile {
                type Output = ::std::result::Result<crate::operation::create_connector_profile::CreateConnectorProfileOutput, crate::operation::create_connector_profile::CreateConnectorProfileError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_connector_profile::de_create_connector_profile_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_connector_profile::de_create_connector_profile_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_connector_profile::CreateConnectorProfileError {
...
mod _create_connector_profile_output;
