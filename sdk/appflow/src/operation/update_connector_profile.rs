...
impl UpdateConnectorProfileInput {
    /// Consumes the builder and constructs an Operation<[`UpdateConnectorProfile`](crate::operation::update_connector_profile::UpdateConnectorProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_connector_profile::UpdateConnectorProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_connector_profile::UpdateConnectorProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/update-connector-profile").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_connector_profile::UpdateConnectorProfile::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateConnectorProfile {
                type Output = ::std::result::Result<crate::operation::update_connector_profile::UpdateConnectorProfileOutput, crate::operation::update_connector_profile::UpdateConnectorProfileError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_connector_profile::de_update_connector_profile_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_connector_profile::de_update_connector_profile_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_connector_profile::UpdateConnectorProfileError {
...
mod _update_connector_profile_output;
