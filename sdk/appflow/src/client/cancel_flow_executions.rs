...
impl super::Client  {
    ...
    ///   - [`flow_name(impl ::std::convert::Into<String>)`](crate::operation::cancel_flow_executions::builders::CancelFlowExecutionsFluentBuilder::flow_name) / [`set_flow_name(Option<String>)`](crate::operation::cancel_flow_executions::builders::CancelFlowExecutionsFluentBuilder::set_flow_name): <p>The name of a flow with active runs that you want to cancel.</p>
    ///   - [`execution_ids(Vec<String>)`](crate::operation::cancel_flow_executions::builders::CancelFlowExecutionsFluentBuilder::execution_ids) / [`set_execution_ids(Option<Vec<String>>)`](crate::operation::cancel_flow_executions::builders::CancelFlowExecutionsFluentBuilder::set_execution_ids): <p>The ID of each active run to cancel. These runs must belong to the flow you specify in your request.</p>  <p>If you omit this parameter, your request ends all active runs that belong to the flow.</p>
