...
impl DisableCrlInput {
    /// Consumes the builder and constructs an Operation<[`DisableCrl`](crate::operation::disable_crl::DisableCrl)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_crl::DisableCrl, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_crl::DisableCrlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if crl_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("crl_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/crl/{crlId}/disable", crlId = crl_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::disable_crl::DisableCrlInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_crl::DisableCrl::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableCrl {
                type Output = ::std::result::Result<crate::operation::disable_crl::DisableCrlOutput, crate::operation::disable_crl::DisableCrlError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disable_crl::de_disable_crl_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disable_crl::de_disable_crl_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_crl::DisableCrlError {
