...
impl super::Client  {
    ...
    ///   - [`trust_anchor_id(impl ::std::convert::Into<String>)`](crate::operation::delete_trust_anchor::builders::DeleteTrustAnchorFluentBuilder::trust_anchor_id) / [`set_trust_anchor_id(Option<String>)`](crate::operation::delete_trust_anchor::builders::DeleteTrustAnchorFluentBuilder::set_trust_anchor_id): <p>The unique identifier of the trust anchor.</p>
