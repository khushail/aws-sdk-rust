...
impl super::Client  {
    ...
    ///   - [`trust_anchor_id(impl ::std::convert::Into<String>)`](crate::operation::reset_notification_settings::builders::ResetNotificationSettingsFluentBuilder::trust_anchor_id) / [`set_trust_anchor_id(Option<String>)`](crate::operation::reset_notification_settings::builders::ResetNotificationSettingsFluentBuilder::set_trust_anchor_id): <p>The unique identifier of the trust anchor.</p>
    ///   - [`notification_setting_keys(Vec<NotificationSettingKey>)`](crate::operation::reset_notification_settings::builders::ResetNotificationSettingsFluentBuilder::notification_setting_keys) / [`set_notification_setting_keys(Option<Vec<NotificationSettingKey>>)`](crate::operation::reset_notification_settings::builders::ResetNotificationSettingsFluentBuilder::set_notification_setting_keys): <p>A list of notification setting keys to reset. A notification setting key includes the event and the channel. </p>
