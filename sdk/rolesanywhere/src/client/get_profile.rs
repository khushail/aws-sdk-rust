...
impl super::Client  {
    ...
    ///   - [`profile_id(impl ::std::convert::Into<String>)`](crate::operation::get_profile::builders::GetProfileFluentBuilder::profile_id) / [`set_profile_id(Option<String>)`](crate::operation::get_profile::builders::GetProfileFluentBuilder::set_profile_id): <p>The unique identifier of the profile.</p>
