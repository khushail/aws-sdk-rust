...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_apigatewaymanagement::Error> {
/// # let client: aws_sdk_apigatewaymanagement::Client = unimplemented!();
