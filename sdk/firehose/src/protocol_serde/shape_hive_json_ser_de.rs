...
pub(crate) fn de_hive_json_ser_de<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::HiveJsonSerDe>, ::aws_smithy_json::deserialize::error::DeserializeError>
