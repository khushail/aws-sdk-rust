...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_firehose::Error> {
/// # let client: aws_sdk_firehose::Client = unimplemented!();
...
mod delete_delivery_stream;

mod describe_delivery_stream;

mod list_delivery_streams;

mod list_tags_for_delivery_stream;

mod put_record;

mod put_record_batch;

mod start_delivery_stream_encryption;

mod stop_delivery_stream_encryption;

mod tag_delivery_stream;

mod untag_delivery_stream;
