...
impl TagDeliveryStreamInput {
    /// Consumes the builder and constructs an Operation<[`TagDeliveryStream`](crate::operation::tag_delivery_stream::TagDeliveryStream)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::tag_delivery_stream::TagDeliveryStream, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_delivery_stream::TagDeliveryStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::tag_delivery_stream::TagDeliveryStream::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("TagDeliveryStream", "firehose"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `TagDeliveryStream`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagDeliveryStream {
                type Output = ::std::result::Result<crate::operation::tag_delivery_stream::TagDeliveryStreamOutput, crate::operation::tag_delivery_stream::TagDeliveryStreamError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_tag_delivery_stream::de_tag_delivery_stream_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_tag_delivery_stream::de_tag_delivery_stream_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::tag_delivery_stream::TagDeliveryStreamError {
...
mod _tag_delivery_stream_output;
