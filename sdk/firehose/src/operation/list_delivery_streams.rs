...
impl ListDeliveryStreamsInput {
    /// Consumes the builder and constructs an Operation<[`ListDeliveryStreams`](crate::operation::list_delivery_streams::ListDeliveryStreams)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_delivery_streams::ListDeliveryStreams, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_delivery_streams::ListDeliveryStreamsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_delivery_streams::ser_list_delivery_streams_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_delivery_streams::ListDeliveryStreams::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDeliveryStreams", "firehose"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDeliveryStreams {
                type Output = ::std::result::Result<crate::operation::list_delivery_streams::ListDeliveryStreamsOutput, crate::operation::list_delivery_streams::ListDeliveryStreamsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_delivery_streams::de_list_delivery_streams_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_delivery_streams::de_list_delivery_streams_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_delivery_streams::ListDeliveryStreamsError {
...
mod _list_delivery_streams_output;
