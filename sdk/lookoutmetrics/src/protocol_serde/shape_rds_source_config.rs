...
pub(crate) fn de_rds_source_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RdsSourceConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
