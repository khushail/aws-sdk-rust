...
impl ListAnomalyGroupTimeSeriesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_anomaly_group_time_series::ListAnomalyGroupTimeSeriesInput, ::aws_smithy_http::operation::error::BuildError> {
