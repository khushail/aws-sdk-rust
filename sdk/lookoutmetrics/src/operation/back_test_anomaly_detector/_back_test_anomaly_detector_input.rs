...
impl BackTestAnomalyDetectorInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::back_test_anomaly_detector::BackTestAnomalyDetectorInput, ::aws_smithy_http::operation::error::BuildError> {
