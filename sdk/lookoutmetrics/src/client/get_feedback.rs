...
impl super::Client  {
    ...
    ///   - [`anomaly_detector_arn(impl ::std::convert::Into<String>)`](crate::operation::get_feedback::builders::GetFeedbackFluentBuilder::anomaly_detector_arn) / [`set_anomaly_detector_arn(Option<String>)`](crate::operation::get_feedback::builders::GetFeedbackFluentBuilder::set_anomaly_detector_arn): <p>The Amazon Resource Name (ARN) of the anomaly detector.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_feedback::builders::GetFeedbackFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_feedback::builders::GetFeedbackFluentBuilder::set_next_token): <p>Specify the pagination token that's returned by a previous request to retrieve the next page of results.</p>
