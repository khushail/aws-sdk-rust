...
impl super::Client  {
    ...
    ///   - [`exclusive_start_application_name(impl ::std::convert::Into<String>)`](crate::operation::list_applications::builders::ListApplicationsFluentBuilder::exclusive_start_application_name) / [`set_exclusive_start_application_name(Option<String>)`](crate::operation::list_applications::builders::ListApplicationsFluentBuilder::set_exclusive_start_application_name): <p>Name of the application to start the list with. When using pagination to retrieve the list, you don't need to specify this parameter in the first request. However, in subsequent requests, you add the last application name from the previous response to get the next page of applications.</p>
