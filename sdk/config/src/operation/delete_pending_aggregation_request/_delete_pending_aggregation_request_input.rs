...
impl DeletePendingAggregationRequestInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_pending_aggregation_request::DeletePendingAggregationRequestInput, ::aws_smithy_http::operation::error::BuildError> {
