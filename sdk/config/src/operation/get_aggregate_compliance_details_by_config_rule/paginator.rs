...
/// Paginator for [`GetAggregateComplianceDetailsByConfigRule`](crate::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRule)
            ...
            impl GetAggregateComplianceDetailsByConfigRulePaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::get_aggregate_compliance_details_by_config_rule::builders::GetAggregateComplianceDetailsByConfigRuleInputBuilder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                /// Create a flattened paginator
                    ...
                    pub fn items(self) -> crate::operation::get_aggregate_compliance_details_by_config_rule::paginator::GetAggregateComplianceDetailsByConfigRulePaginatorItems {
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError>>> + ::std::marker::Unpin
                 {
...
/// Flattened paginator for `GetAggregateComplianceDetailsByConfigRulePaginator`
                ...
                impl  GetAggregateComplianceDetailsByConfigRulePaginatorItems  {
                    ...
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::AggregateEvaluationResult, ::aws_smithy_http::result::SdkError<crate::operation::get_aggregate_compliance_details_by_config_rule::GetAggregateComplianceDetailsByConfigRuleError>>> + ::std::marker::Unpin
                     {
