...
impl PutConfigurationAggregatorInput {
    /// Consumes the builder and constructs an Operation<[`PutConfigurationAggregator`](crate::operation::put_configuration_aggregator::PutConfigurationAggregator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_configuration_aggregator::PutConfigurationAggregator, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_configuration_aggregator::PutConfigurationAggregatorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_configuration_aggregator::ser_put_configuration_aggregator_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_configuration_aggregator::PutConfigurationAggregator::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutConfigurationAggregator {
                type Output = ::std::result::Result<crate::operation::put_configuration_aggregator::PutConfigurationAggregatorOutput, crate::operation::put_configuration_aggregator::PutConfigurationAggregatorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_put_configuration_aggregator::de_put_configuration_aggregator_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_configuration_aggregator::PutConfigurationAggregatorError {
