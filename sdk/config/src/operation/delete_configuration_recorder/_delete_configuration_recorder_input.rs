...
impl DeleteConfigurationRecorderInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_configuration_recorder::DeleteConfigurationRecorderInput, ::aws_smithy_http::operation::error::BuildError> {
