...
impl GetResourceConfigHistoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_resource_config_history::GetResourceConfigHistoryInput, ::aws_smithy_http::operation::error::BuildError> {
