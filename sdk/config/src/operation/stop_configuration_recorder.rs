...
impl StopConfigurationRecorderInput {
    /// Consumes the builder and constructs an Operation<[`StopConfigurationRecorder`](crate::operation::stop_configuration_recorder::StopConfigurationRecorder)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_configuration_recorder::StopConfigurationRecorder, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_configuration_recorder::StopConfigurationRecorderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_configuration_recorder::ser_stop_configuration_recorder_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_configuration_recorder::StopConfigurationRecorder::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopConfigurationRecorder {
                type Output = ::std::result::Result<crate::operation::stop_configuration_recorder::StopConfigurationRecorderOutput, crate::operation::stop_configuration_recorder::StopConfigurationRecorderError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_stop_configuration_recorder::de_stop_configuration_recorder_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_configuration_recorder::StopConfigurationRecorderError {
