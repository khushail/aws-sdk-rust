...
impl PutAggregationAuthorizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_aggregation_authorization::PutAggregationAuthorizationInput, ::aws_smithy_http::operation::error::BuildError> {
