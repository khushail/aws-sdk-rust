...
impl PutAggregationAuthorizationInput {
    /// Consumes the builder and constructs an Operation<[`PutAggregationAuthorization`](crate::operation::put_aggregation_authorization::PutAggregationAuthorization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_aggregation_authorization::PutAggregationAuthorization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_aggregation_authorization::PutAggregationAuthorizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_aggregation_authorization::ser_put_aggregation_authorization_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_aggregation_authorization::PutAggregationAuthorization::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAggregationAuthorization {
                type Output = ::std::result::Result<crate::operation::put_aggregation_authorization::PutAggregationAuthorizationOutput, crate::operation::put_aggregation_authorization::PutAggregationAuthorizationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_put_aggregation_authorization::de_put_aggregation_authorization_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_aggregation_authorization::PutAggregationAuthorizationError {
