...
impl DeleteAggregationAuthorizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_aggregation_authorization::DeleteAggregationAuthorizationInput, ::aws_smithy_http::operation::error::BuildError> {
