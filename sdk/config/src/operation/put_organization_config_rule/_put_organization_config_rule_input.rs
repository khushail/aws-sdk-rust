...
impl PutOrganizationConfigRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_organization_config_rule::PutOrganizationConfigRuleInput, ::aws_smithy_http::operation::error::BuildError> {
