...
impl DescribeRemediationExceptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_remediation_exceptions::DescribeRemediationExceptionsInput, ::aws_smithy_http::operation::error::BuildError> {
