...
impl PutRemediationExceptionsInput {
    /// Consumes the builder and constructs an Operation<[`PutRemediationExceptions`](crate::operation::put_remediation_exceptions::PutRemediationExceptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_remediation_exceptions::PutRemediationExceptions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_remediation_exceptions::PutRemediationExceptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_remediation_exceptions::ser_put_remediation_exceptions_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_remediation_exceptions::PutRemediationExceptions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRemediationExceptions {
                type Output = ::std::result::Result<crate::operation::put_remediation_exceptions::PutRemediationExceptionsOutput, crate::operation::put_remediation_exceptions::PutRemediationExceptionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_put_remediation_exceptions::de_put_remediation_exceptions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_remediation_exceptions::PutRemediationExceptionsError {
