...
impl super::Client  {
    ...
    ///   - [`config_rule_name(impl ::std::convert::Into<String>)`](crate::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsFluentBuilder::config_rule_name) / [`set_config_rule_name(Option<String>)`](crate::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsFluentBuilder::set_config_rule_name): <p>The name of the Config rule.</p>
    ...
    ///   - [`limit(i32)`](crate::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsFluentBuilder::limit) / [`set_limit(Option<i32>)`](crate::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsFluentBuilder::set_limit): <p>The maximum number of RemediationExceptionResourceKey returned on each page. The default is 25. If you specify 0, Config uses the default.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::describe_remediation_exceptions::builders::DescribeRemediationExceptionsFluentBuilder::set_next_token): <p>The <code>nextToken</code> string returned in a previous request that you use to request the next page of results in a paginated response.</p>
