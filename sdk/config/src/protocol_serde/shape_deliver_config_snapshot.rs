...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deliver_config_snapshot_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::deliver_config_snapshot::DeliverConfigSnapshotOutput, crate::operation::deliver_config_snapshot::DeliverConfigSnapshotError> {
    Ok({
        #[allow(unused_mut)]
