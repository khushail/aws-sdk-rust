...
pub(crate) fn de_evaluation_mode_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::EvaluationModeConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
