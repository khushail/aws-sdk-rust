...
impl GetChannelMembershipPreferencesInput {
    /// Consumes the builder and constructs an Operation<[`GetChannelMembershipPreferences`](crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferences)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferences, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if member_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("member_arn", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/channels/{ChannelArn}/memberships/{MemberArn}/preferences", ChannelArn = channel_arn, MemberArn = member_arn).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferences::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetChannelMembershipPreferences {
                type Output = ::std::result::Result<crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesOutput, crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_channel_membership_preferences::de_get_channel_membership_preferences_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_channel_membership_preferences::de_get_channel_membership_preferences_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_channel_membership_preferences::GetChannelMembershipPreferencesError {
...
mod _get_channel_membership_preferences_output;
