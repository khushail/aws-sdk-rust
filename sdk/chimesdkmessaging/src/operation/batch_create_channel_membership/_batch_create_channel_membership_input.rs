...
impl BatchCreateChannelMembershipInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_create_channel_membership::BatchCreateChannelMembershipInput, ::aws_smithy_http::operation::error::BuildError> {
