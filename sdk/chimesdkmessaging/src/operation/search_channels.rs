...
impl SearchChannelsInput {
    /// Consumes the builder and constructs an Operation<[`SearchChannels`](crate::operation::search_channels::SearchChannels)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_channels::SearchChannels, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_channels::SearchChannelsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/channels").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::search_channels::SearchChannelsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_channels::SearchChannels::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchChannels", "chimesdkmessaging"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SearchChannels`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchChannels {
                type Output = ::std::result::Result<crate::operation::search_channels::SearchChannelsOutput, crate::operation::search_channels::SearchChannelsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_search_channels::de_search_channels_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_search_channels::de_search_channels_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::search_channels::SearchChannelsError {
