...
impl PutChannelMembershipPreferencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_channel_membership_preferences::PutChannelMembershipPreferencesInput, ::aws_smithy_http::operation::error::BuildError> {
