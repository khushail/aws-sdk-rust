...
impl PutChannelExpirationSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_channel_expiration_settings::PutChannelExpirationSettingsInput, ::aws_smithy_http::operation::error::BuildError> {
