...
impl DeleteChannelMessageInput {
    /// Consumes the builder and constructs an Operation<[`DeleteChannelMessage`](crate::operation::delete_channel_message::DeleteChannelMessage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_channel_message::DeleteChannelMessage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_channel_message::DeleteChannelMessageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_channel_message::DeleteChannelMessageInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_channel_message::DeleteChannelMessage::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteChannelMessage {
                type Output = ::std::result::Result<crate::operation::delete_channel_message::DeleteChannelMessageOutput, crate::operation::delete_channel_message::DeleteChannelMessageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_delete_channel_message::de_delete_channel_message_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_channel_message::de_delete_channel_message_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_channel_message::DeleteChannelMessageError {
...
mod _delete_channel_message_output;
