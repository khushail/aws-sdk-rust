...
impl super::Client  {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_channel_message::builders::DeleteChannelMessageFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::delete_channel_message::builders::DeleteChannelMessageFluentBuilder::set_channel_arn): <p>The ARN of the channel.</p>
    ///   - [`message_id(impl ::std::convert::Into<String>)`](crate::operation::delete_channel_message::builders::DeleteChannelMessageFluentBuilder::message_id) / [`set_message_id(Option<String>)`](crate::operation::delete_channel_message::builders::DeleteChannelMessageFluentBuilder::set_message_id): <p>The ID of the message being deleted.</p>
    ///   - [`chime_bearer(impl ::std::convert::Into<String>)`](crate::operation::delete_channel_message::builders::DeleteChannelMessageFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::delete_channel_message::builders::DeleteChannelMessageFluentBuilder::set_chime_bearer): <p>The ARN of the <code>AppInstanceUser</code> or <code>AppInstanceBot</code> that makes the API call.</p>
