...
impl super::Client  {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::list_sub_channels::builders::ListSubChannelsFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::list_sub_channels::builders::ListSubChannelsFluentBuilder::set_channel_arn): <p>The ARN of elastic channel.</p>
    ///   - [`chime_bearer(impl ::std::convert::Into<String>)`](crate::operation::list_sub_channels::builders::ListSubChannelsFluentBuilder::chime_bearer) / [`set_chime_bearer(Option<String>)`](crate::operation::list_sub_channels::builders::ListSubChannelsFluentBuilder::set_chime_bearer): <p>The <code>AppInstanceUserArn</code> of the user making the API call.</p>
