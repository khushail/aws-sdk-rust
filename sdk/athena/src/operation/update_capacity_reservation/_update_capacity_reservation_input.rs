...
impl UpdateCapacityReservationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_capacity_reservation::UpdateCapacityReservationInput, ::aws_smithy_http::operation::error::BuildError> {
