...
impl BatchGetNamedQueryInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetNamedQuery`](crate::operation::batch_get_named_query::BatchGetNamedQuery)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_get_named_query::BatchGetNamedQuery, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_named_query::BatchGetNamedQueryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_named_query::ser_batch_get_named_query_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_named_query::BatchGetNamedQuery::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetNamedQuery {
                type Output = ::std::result::Result<crate::operation::batch_get_named_query::BatchGetNamedQueryOutput, crate::operation::batch_get_named_query::BatchGetNamedQueryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_get_named_query::de_batch_get_named_query_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_named_query::BatchGetNamedQueryError {
...
mod _batch_get_named_query_output;
