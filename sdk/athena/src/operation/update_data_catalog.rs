...
impl UpdateDataCatalogInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDataCatalog`](crate::operation::update_data_catalog::UpdateDataCatalog)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_data_catalog::UpdateDataCatalog, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_data_catalog::UpdateDataCatalogInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_data_catalog::UpdateDataCatalog::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDataCatalog", "athena"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateDataCatalog`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDataCatalog {
                type Output = ::std::result::Result<crate::operation::update_data_catalog::UpdateDataCatalogOutput, crate::operation::update_data_catalog::UpdateDataCatalogError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_data_catalog::de_update_data_catalog_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_data_catalog::de_update_data_catalog_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_data_catalog::UpdateDataCatalogError {
...
mod _update_data_catalog_output;
