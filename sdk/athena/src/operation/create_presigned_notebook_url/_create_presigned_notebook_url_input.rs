...
impl CreatePresignedNotebookUrlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_presigned_notebook_url::CreatePresignedNotebookUrlInput, ::aws_smithy_http::operation::error::BuildError> {
