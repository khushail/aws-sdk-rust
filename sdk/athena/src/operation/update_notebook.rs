...
impl UpdateNotebookInput {
    /// Consumes the builder and constructs an Operation<[`UpdateNotebook`](crate::operation::update_notebook::UpdateNotebook)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_notebook::UpdateNotebook, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_notebook::UpdateNotebookInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_notebook::UpdateNotebook::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateNotebook", "athena"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateNotebook`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateNotebook {
                type Output = ::std::result::Result<crate::operation::update_notebook::UpdateNotebookOutput, crate::operation::update_notebook::UpdateNotebookError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_notebook::de_update_notebook_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_notebook::de_update_notebook_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_notebook::UpdateNotebookError {
...
pub use crate::operation::update_notebook::_update_notebook_output::UpdateNotebookOutput;

pub use crate::operation::update_notebook::_update_notebook_input::UpdateNotebookInput;

mod _update_notebook_input;

mod _update_notebook_output;
