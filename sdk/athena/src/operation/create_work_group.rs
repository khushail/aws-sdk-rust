...
impl CreateWorkGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateWorkGroup`](crate::operation::create_work_group::CreateWorkGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_work_group::CreateWorkGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_work_group::CreateWorkGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_work_group::CreateWorkGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWorkGroup {
                type Output = ::std::result::Result<crate::operation::create_work_group::CreateWorkGroupOutput, crate::operation::create_work_group::CreateWorkGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_work_group::de_create_work_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_work_group::de_create_work_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_work_group::CreateWorkGroupError {
