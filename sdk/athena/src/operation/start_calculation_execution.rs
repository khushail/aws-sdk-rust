...
impl StartCalculationExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StartCalculationExecution`](crate::operation::start_calculation_execution::StartCalculationExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_calculation_execution::StartCalculationExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_calculation_execution::StartCalculationExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_calculation_execution::StartCalculationExecution::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartCalculationExecution", "athena"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartCalculationExecution`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartCalculationExecution {
                type Output = ::std::result::Result<crate::operation::start_calculation_execution::StartCalculationExecutionOutput, crate::operation::start_calculation_execution::StartCalculationExecutionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_calculation_execution::de_start_calculation_execution_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_calculation_execution::de_start_calculation_execution_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_calculation_execution::StartCalculationExecutionError {
...
mod _start_calculation_execution_output;
