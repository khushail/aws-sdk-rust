...
impl StopQueryExecutionInput {
    /// Consumes the builder and constructs an Operation<[`StopQueryExecution`](crate::operation::stop_query_execution::StopQueryExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_query_execution::StopQueryExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        if self.query_execution_id.is_none() {
                                self.query_execution_id = ::std::option::Option::Some(_config.idempotency_token_provider.make_idempotency_token());
                            }
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_query_execution::StopQueryExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_query_execution::ser_stop_query_execution_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_query_execution::StopQueryExecution::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopQueryExecution {
                type Output = ::std::result::Result<crate::operation::stop_query_execution::StopQueryExecutionOutput, crate::operation::stop_query_execution::StopQueryExecutionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_query_execution::de_stop_query_execution_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_query_execution::de_stop_query_execution_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_query_execution::StopQueryExecutionError {
...
mod _stop_query_execution_output;
