...
impl GetQueryExecutionInput {
    /// Consumes the builder and constructs an Operation<[`GetQueryExecution`](crate::operation::get_query_execution::GetQueryExecution)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_query_execution::GetQueryExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_query_execution::GetQueryExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_query_execution::GetQueryExecution::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetQueryExecution", "athena"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetQueryExecution`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetQueryExecution {
                type Output = ::std::result::Result<crate::operation::get_query_execution::GetQueryExecutionOutput, crate::operation::get_query_execution::GetQueryExecutionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_query_execution::de_get_query_execution_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_query_execution::de_get_query_execution_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_query_execution::GetQueryExecutionError {
...
mod _get_query_execution_output;
