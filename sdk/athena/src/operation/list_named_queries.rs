...
impl ListNamedQueriesInput {
    /// Consumes the builder and constructs an Operation<[`ListNamedQueries`](crate::operation::list_named_queries::ListNamedQueries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_named_queries::ListNamedQueries, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_named_queries::ListNamedQueriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_named_queries::ListNamedQueries::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListNamedQueries", "athena"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListNamedQueries`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListNamedQueries {
                type Output = ::std::result::Result<crate::operation::list_named_queries::ListNamedQueriesOutput, crate::operation::list_named_queries::ListNamedQueriesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_named_queries::de_list_named_queries_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_named_queries::de_list_named_queries_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_named_queries::ListNamedQueriesError {
...
mod _list_named_queries_output;
