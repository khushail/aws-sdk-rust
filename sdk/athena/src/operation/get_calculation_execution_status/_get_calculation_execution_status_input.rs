...
impl GetCalculationExecutionStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_calculation_execution_status::GetCalculationExecutionStatusInput, ::aws_smithy_http::operation::error::BuildError> {
