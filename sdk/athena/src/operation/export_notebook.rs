...
impl ExportNotebookInput {
    /// Consumes the builder and constructs an Operation<[`ExportNotebook`](crate::operation::export_notebook::ExportNotebook)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::export_notebook::ExportNotebook, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::export_notebook::ExportNotebookInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::export_notebook::ExportNotebook::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ExportNotebook", "athena"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ExportNotebook`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExportNotebook {
                type Output = ::std::result::Result<crate::operation::export_notebook::ExportNotebookOutput, crate::operation::export_notebook::ExportNotebookError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_export_notebook::de_export_notebook_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_export_notebook::de_export_notebook_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::export_notebook::ExportNotebookError {
