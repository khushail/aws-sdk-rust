...
impl StopCalculationExecutionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_calculation_execution::StopCalculationExecutionInput, ::aws_smithy_http::operation::error::BuildError> {
