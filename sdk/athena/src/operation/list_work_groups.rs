...
impl ListWorkGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListWorkGroups`](crate::operation::list_work_groups::ListWorkGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_work_groups::ListWorkGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_work_groups::ListWorkGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_work_groups::ListWorkGroupsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_work_groups::ListWorkGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkGroups {
                type Output = ::std::result::Result<crate::operation::list_work_groups::ListWorkGroupsOutput, crate::operation::list_work_groups::ListWorkGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_work_groups::de_list_work_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_work_groups::de_list_work_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_work_groups::ListWorkGroupsError {
...
pub use crate::operation::list_work_groups::_list_work_groups_output::ListWorkGroupsOutput;

pub use crate::operation::list_work_groups::_list_work_groups_input::ListWorkGroupsInput;

mod _list_work_groups_input;

mod _list_work_groups_output;
