...
impl GetNamedQueryInput {
    /// Consumes the builder and constructs an Operation<[`GetNamedQuery`](crate::operation::get_named_query::GetNamedQuery)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_named_query::GetNamedQuery, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_named_query::GetNamedQueryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_named_query::GetNamedQuery::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetNamedQuery", "athena"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetNamedQuery`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetNamedQuery {
                type Output = ::std::result::Result<crate::operation::get_named_query::GetNamedQueryOutput, crate::operation::get_named_query::GetNamedQueryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_named_query::de_get_named_query_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_named_query::de_get_named_query_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_named_query::GetNamedQueryError {
