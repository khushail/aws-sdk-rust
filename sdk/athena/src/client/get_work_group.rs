...
impl super::Client  {
    ...
    ///   - [`work_group(impl ::std::convert::Into<String>)`](crate::operation::get_work_group::builders::GetWorkGroupFluentBuilder::work_group) / [`set_work_group(Option<String>)`](crate::operation::get_work_group::builders::GetWorkGroupFluentBuilder::set_work_group): <p>The name of the workgroup.</p>
