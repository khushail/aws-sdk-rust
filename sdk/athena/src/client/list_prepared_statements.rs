...
impl super::Client  {
    ...
    ///   - [`work_group(impl ::std::convert::Into<String>)`](crate::operation::list_prepared_statements::builders::ListPreparedStatementsFluentBuilder::work_group) / [`set_work_group(Option<String>)`](crate::operation::list_prepared_statements::builders::ListPreparedStatementsFluentBuilder::set_work_group): <p>The workgroup to list the prepared statements for.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_prepared_statements::builders::ListPreparedStatementsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_prepared_statements::builders::ListPreparedStatementsFluentBuilder::set_next_token): <p>A token generated by the Athena service that specifies where to continue pagination if a previous request was truncated. To obtain the next set of pages, pass in the <code>NextToken</code> from the response object of the previous page call.</p>
