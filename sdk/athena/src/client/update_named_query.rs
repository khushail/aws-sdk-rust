...
impl super::Client  {
    ...
    ///   - [`named_query_id(impl ::std::convert::Into<String>)`](crate::operation::update_named_query::builders::UpdateNamedQueryFluentBuilder::named_query_id) / [`set_named_query_id(Option<String>)`](crate::operation::update_named_query::builders::UpdateNamedQueryFluentBuilder::set_named_query_id): <p>The unique identifier (UUID) of the query.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_named_query::builders::UpdateNamedQueryFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_named_query::builders::UpdateNamedQueryFluentBuilder::set_name): <p>The name of the query.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_named_query::builders::UpdateNamedQueryFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_named_query::builders::UpdateNamedQueryFluentBuilder::set_description): <p>The query description.</p>
