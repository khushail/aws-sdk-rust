...
impl ResolveCaseInput {
    /// Consumes the builder and constructs an Operation<[`ResolveCase`](crate::operation::resolve_case::ResolveCase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::resolve_case::ResolveCase, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resolve_case::ResolveCaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_resolve_case::ser_resolve_case_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::resolve_case::ResolveCase::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResolveCase {
                type Output = ::std::result::Result<crate::operation::resolve_case::ResolveCaseOutput, crate::operation::resolve_case::ResolveCaseError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_resolve_case::de_resolve_case_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_resolve_case::de_resolve_case_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::resolve_case::ResolveCaseError {
