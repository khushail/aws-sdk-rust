...
impl DescribeTrustedAdvisorChecksInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecksInput, ::aws_smithy_http::operation::error::BuildError> {
