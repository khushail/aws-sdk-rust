...
impl RefreshTrustedAdvisorCheckInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckInput, ::aws_smithy_http::operation::error::BuildError> {
