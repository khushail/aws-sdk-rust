...
impl RefreshTrustedAdvisorCheckInput {
    /// Consumes the builder and constructs an Operation<[`RefreshTrustedAdvisorCheck`](crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheck)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheck, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_refresh_trusted_advisor_check::ser_refresh_trusted_advisor_check_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheck::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RefreshTrustedAdvisorCheck {
                type Output = ::std::result::Result<crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckOutput, crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_refresh_trusted_advisor_check::de_refresh_trusted_advisor_check_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_refresh_trusted_advisor_check::de_refresh_trusted_advisor_check_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::refresh_trusted_advisor_check::RefreshTrustedAdvisorCheckError {
...
mod _refresh_trusted_advisor_check_output;
