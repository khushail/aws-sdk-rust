...
impl DescribeTrustedAdvisorChecksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTrustedAdvisorChecks`](crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_trusted_advisor_checks::ser_describe_trusted_advisor_checks_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecks::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTrustedAdvisorChecks {
                type Output = ::std::result::Result<crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecksOutput, crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_trusted_advisor_checks::de_describe_trusted_advisor_checks_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_trusted_advisor_checks::de_describe_trusted_advisor_checks_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_trusted_advisor_checks::DescribeTrustedAdvisorChecksError {
...
impl DescribeTrustedAdvisorChecksError {
    ...
    /// Returns `true` if the error kind is `DescribeTrustedAdvisorChecksError::ThrottlingException`.
...
pub use crate::operation::describe_trusted_advisor_checks::_describe_trusted_advisor_checks_output::DescribeTrustedAdvisorChecksOutput;

pub use crate::operation::describe_trusted_advisor_checks::_describe_trusted_advisor_checks_input::DescribeTrustedAdvisorChecksInput;

mod _describe_trusted_advisor_checks_input;

mod _describe_trusted_advisor_checks_output;
