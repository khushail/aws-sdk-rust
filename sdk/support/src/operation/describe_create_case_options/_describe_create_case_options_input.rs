...
impl DescribeCreateCaseOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_create_case_options::DescribeCreateCaseOptionsInput, ::aws_smithy_http::operation::error::BuildError> {
