...
impl GetMobileDeviceAccessEffectInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_mobile_device_access_effect::GetMobileDeviceAccessEffectInput, ::aws_smithy_http::operation::error::BuildError> {
