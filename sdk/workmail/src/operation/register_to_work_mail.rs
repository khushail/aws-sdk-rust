...
impl RegisterToWorkMailInput {
    /// Consumes the builder and constructs an Operation<[`RegisterToWorkMail`](crate::operation::register_to_work_mail::RegisterToWorkMail)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_to_work_mail::RegisterToWorkMail, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_to_work_mail::RegisterToWorkMailInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_to_work_mail::RegisterToWorkMail::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterToWorkMail {
                type Output = ::std::result::Result<crate::operation::register_to_work_mail::RegisterToWorkMailOutput, crate::operation::register_to_work_mail::RegisterToWorkMailError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_register_to_work_mail::de_register_to_work_mail_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_register_to_work_mail::de_register_to_work_mail_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::register_to_work_mail::RegisterToWorkMailError {
...
mod _register_to_work_mail_output;
