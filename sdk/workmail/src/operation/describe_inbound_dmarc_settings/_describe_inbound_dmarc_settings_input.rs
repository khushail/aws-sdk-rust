...
impl DescribeInboundDmarcSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_inbound_dmarc_settings::DescribeInboundDmarcSettingsInput, ::aws_smithy_http::operation::error::BuildError> {
