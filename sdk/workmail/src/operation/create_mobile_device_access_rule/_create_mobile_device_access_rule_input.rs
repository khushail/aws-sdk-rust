...
impl CreateMobileDeviceAccessRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_mobile_device_access_rule::CreateMobileDeviceAccessRuleInput, ::aws_smithy_http::operation::error::BuildError> {
