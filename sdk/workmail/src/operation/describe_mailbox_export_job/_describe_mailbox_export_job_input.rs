...
impl DescribeMailboxExportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_mailbox_export_job::DescribeMailboxExportJobInput, ::aws_smithy_http::operation::error::BuildError> {
