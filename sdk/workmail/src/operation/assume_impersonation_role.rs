...
impl AssumeImpersonationRoleInput {
    /// Consumes the builder and constructs an Operation<[`AssumeImpersonationRole`](crate::operation::assume_impersonation_role::AssumeImpersonationRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::assume_impersonation_role::AssumeImpersonationRole, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::assume_impersonation_role::AssumeImpersonationRoleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::assume_impersonation_role::AssumeImpersonationRole::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssumeImpersonationRole {
                type Output = ::std::result::Result<crate::operation::assume_impersonation_role::AssumeImpersonationRoleOutput, crate::operation::assume_impersonation_role::AssumeImpersonationRoleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_assume_impersonation_role::de_assume_impersonation_role_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_assume_impersonation_role::de_assume_impersonation_role_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::assume_impersonation_role::AssumeImpersonationRoleError {
...
mod _assume_impersonation_role_output;
