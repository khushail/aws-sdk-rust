...
impl UpdateAvailabilityConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAvailabilityConfiguration`](crate::operation::update_availability_configuration::UpdateAvailabilityConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_availability_configuration::UpdateAvailabilityConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_availability_configuration::UpdateAvailabilityConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_availability_configuration::UpdateAvailabilityConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAvailabilityConfiguration {
                type Output = ::std::result::Result<crate::operation::update_availability_configuration::UpdateAvailabilityConfigurationOutput, crate::operation::update_availability_configuration::UpdateAvailabilityConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_availability_configuration::de_update_availability_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_availability_configuration::de_update_availability_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateAvailabilityConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_availability_configuration::UpdateAvailabilityConfigurationError {
...
mod _update_availability_configuration_output;
