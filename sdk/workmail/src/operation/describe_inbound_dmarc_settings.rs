...
impl DescribeInboundDmarcSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInboundDmarcSettings`](crate::operation::describe_inbound_dmarc_settings::DescribeInboundDmarcSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_inbound_dmarc_settings::DescribeInboundDmarcSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_inbound_dmarc_settings::DescribeInboundDmarcSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_inbound_dmarc_settings::DescribeInboundDmarcSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeInboundDmarcSettings", "workmail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeInboundDmarcSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInboundDmarcSettings {
                type Output = ::std::result::Result<crate::operation::describe_inbound_dmarc_settings::DescribeInboundDmarcSettingsOutput, crate::operation::describe_inbound_dmarc_settings::DescribeInboundDmarcSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_inbound_dmarc_settings::de_describe_inbound_dmarc_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_inbound_dmarc_settings::de_describe_inbound_dmarc_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_inbound_dmarc_settings::DescribeInboundDmarcSettingsError {
...
pub use crate::operation::describe_inbound_dmarc_settings::_describe_inbound_dmarc_settings_output::DescribeInboundDmarcSettingsOutput;

pub use crate::operation::describe_inbound_dmarc_settings::_describe_inbound_dmarc_settings_input::DescribeInboundDmarcSettingsInput;

mod _describe_inbound_dmarc_settings_input;

mod _describe_inbound_dmarc_settings_output;
