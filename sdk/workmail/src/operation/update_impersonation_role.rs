...
impl UpdateImpersonationRoleInput {
    /// Consumes the builder and constructs an Operation<[`UpdateImpersonationRole`](crate::operation::update_impersonation_role::UpdateImpersonationRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_impersonation_role::UpdateImpersonationRole, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_impersonation_role::UpdateImpersonationRoleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_impersonation_role::UpdateImpersonationRole::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateImpersonationRole", "workmail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateImpersonationRole`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateImpersonationRole {
                type Output = ::std::result::Result<crate::operation::update_impersonation_role::UpdateImpersonationRoleOutput, crate::operation::update_impersonation_role::UpdateImpersonationRoleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_impersonation_role::de_update_impersonation_role_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_impersonation_role::de_update_impersonation_role_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_impersonation_role::UpdateImpersonationRoleError {
...
mod _update_impersonation_role_output;
