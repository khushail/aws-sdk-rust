...
impl PutEmailMonitoringConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_email_monitoring_configuration::PutEmailMonitoringConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
