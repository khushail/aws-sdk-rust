...
impl GetImpersonationRoleEffectInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_impersonation_role_effect::GetImpersonationRoleEffectInput, ::aws_smithy_http::operation::error::BuildError> {
