...
impl ListMailboxExportJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListMailboxExportJobs`](crate::operation::list_mailbox_export_jobs::ListMailboxExportJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_mailbox_export_jobs::ListMailboxExportJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_mailbox_export_jobs::ListMailboxExportJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_mailbox_export_jobs::ListMailboxExportJobsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_mailbox_export_jobs::ListMailboxExportJobs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMailboxExportJobs {
                type Output = ::std::result::Result<crate::operation::list_mailbox_export_jobs::ListMailboxExportJobsOutput, crate::operation::list_mailbox_export_jobs::ListMailboxExportJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_mailbox_export_jobs::de_list_mailbox_export_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_mailbox_export_jobs::de_list_mailbox_export_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_mailbox_export_jobs::ListMailboxExportJobsError {
...
mod _list_mailbox_export_jobs_output;
