...
impl DeleteMailboxPermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_mailbox_permissions::DeleteMailboxPermissionsInput, ::aws_smithy_http::operation::error::BuildError> {
