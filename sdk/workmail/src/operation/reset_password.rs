...
impl ResetPasswordInput {
    /// Consumes the builder and constructs an Operation<[`ResetPassword`](crate::operation::reset_password::ResetPassword)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reset_password::ResetPassword, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_password::ResetPasswordInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reset_password::ResetPassword::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResetPassword", "workmail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ResetPassword`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetPassword {
                type Output = ::std::result::Result<crate::operation::reset_password::ResetPasswordOutput, crate::operation::reset_password::ResetPasswordError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_reset_password::de_reset_password_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_reset_password::de_reset_password_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_password::ResetPasswordError {
...
pub use crate::operation::reset_password::_reset_password_output::ResetPasswordOutput;

pub use crate::operation::reset_password::_reset_password_input::ResetPasswordInput;

mod _reset_password_input;

mod _reset_password_output;
