...
impl DeleteAccessControlRuleInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAccessControlRule`](crate::operation::delete_access_control_rule::DeleteAccessControlRule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_access_control_rule::DeleteAccessControlRule, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_access_control_rule::DeleteAccessControlRuleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_access_control_rule::DeleteAccessControlRule::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccessControlRule {
                type Output = ::std::result::Result<crate::operation::delete_access_control_rule::DeleteAccessControlRuleOutput, crate::operation::delete_access_control_rule::DeleteAccessControlRuleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_access_control_rule::de_delete_access_control_rule_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_access_control_rule::de_delete_access_control_rule_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_access_control_rule::DeleteAccessControlRuleError {
...
mod _delete_access_control_rule_output;
