...
impl DeleteImpersonationRoleInput {
    /// Consumes the builder and constructs an Operation<[`DeleteImpersonationRole`](crate::operation::delete_impersonation_role::DeleteImpersonationRole)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_impersonation_role::DeleteImpersonationRole, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_impersonation_role::DeleteImpersonationRoleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_impersonation_role::DeleteImpersonationRole::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteImpersonationRole", "workmail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteImpersonationRole`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteImpersonationRole {
                type Output = ::std::result::Result<crate::operation::delete_impersonation_role::DeleteImpersonationRoleOutput, crate::operation::delete_impersonation_role::DeleteImpersonationRoleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_impersonation_role::de_delete_impersonation_role_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_impersonation_role::de_delete_impersonation_role_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_impersonation_role::DeleteImpersonationRoleError {
...
mod _delete_impersonation_role_output;
