...
impl UpdateMailboxQuotaInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMailboxQuota`](crate::operation::update_mailbox_quota::UpdateMailboxQuota)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_mailbox_quota::UpdateMailboxQuota, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_mailbox_quota::UpdateMailboxQuotaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_mailbox_quota::UpdateMailboxQuota::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMailboxQuota {
                type Output = ::std::result::Result<crate::operation::update_mailbox_quota::UpdateMailboxQuotaOutput, crate::operation::update_mailbox_quota::UpdateMailboxQuotaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_mailbox_quota::de_update_mailbox_quota_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_mailbox_quota::de_update_mailbox_quota_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_mailbox_quota::UpdateMailboxQuotaError {
...
mod _update_mailbox_quota_output;
