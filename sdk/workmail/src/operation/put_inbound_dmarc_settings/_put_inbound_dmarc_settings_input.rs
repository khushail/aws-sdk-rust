...
impl PutInboundDmarcSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_inbound_dmarc_settings::PutInboundDmarcSettingsInput, ::aws_smithy_http::operation::error::BuildError> {
