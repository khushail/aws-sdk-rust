...
impl DeregisterFromWorkMailInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterFromWorkMail`](crate::operation::deregister_from_work_mail::DeregisterFromWorkMail)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deregister_from_work_mail::DeregisterFromWorkMail, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_from_work_mail::DeregisterFromWorkMailInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_from_work_mail::DeregisterFromWorkMail::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeregisterFromWorkMail", "workmail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeregisterFromWorkMail`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterFromWorkMail {
                type Output = ::std::result::Result<crate::operation::deregister_from_work_mail::DeregisterFromWorkMailOutput, crate::operation::deregister_from_work_mail::DeregisterFromWorkMailError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deregister_from_work_mail::de_deregister_from_work_mail_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deregister_from_work_mail::de_deregister_from_work_mail_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_from_work_mail::DeregisterFromWorkMailError {
...
mod _deregister_from_work_mail_output;
