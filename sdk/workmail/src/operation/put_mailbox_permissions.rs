...
impl PutMailboxPermissionsInput {
    /// Consumes the builder and constructs an Operation<[`PutMailboxPermissions`](crate::operation::put_mailbox_permissions::PutMailboxPermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_mailbox_permissions::PutMailboxPermissions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_mailbox_permissions::PutMailboxPermissionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_mailbox_permissions::PutMailboxPermissions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutMailboxPermissions", "workmail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutMailboxPermissions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutMailboxPermissions {
                type Output = ::std::result::Result<crate::operation::put_mailbox_permissions::PutMailboxPermissionsOutput, crate::operation::put_mailbox_permissions::PutMailboxPermissionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_mailbox_permissions::de_put_mailbox_permissions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_mailbox_permissions::de_put_mailbox_permissions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_mailbox_permissions::PutMailboxPermissionsError {
...
mod _put_mailbox_permissions_output;
