...
impl UpdateMobileDeviceAccessRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_mobile_device_access_rule::UpdateMobileDeviceAccessRuleInput, ::aws_smithy_http::operation::error::BuildError> {
