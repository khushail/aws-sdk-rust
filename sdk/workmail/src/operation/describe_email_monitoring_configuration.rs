...
impl DescribeEmailMonitoringConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEmailMonitoringConfiguration`](crate::operation::describe_email_monitoring_configuration::DescribeEmailMonitoringConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_email_monitoring_configuration::DescribeEmailMonitoringConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_email_monitoring_configuration::DescribeEmailMonitoringConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_email_monitoring_configuration::DescribeEmailMonitoringConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeEmailMonitoringConfiguration", "workmail"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeEmailMonitoringConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEmailMonitoringConfiguration {
                type Output = ::std::result::Result<crate::operation::describe_email_monitoring_configuration::DescribeEmailMonitoringConfigurationOutput, crate::operation::describe_email_monitoring_configuration::DescribeEmailMonitoringConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_email_monitoring_configuration::de_describe_email_monitoring_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_email_monitoring_configuration::de_describe_email_monitoring_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeEmailMonitoringConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_email_monitoring_configuration::DescribeEmailMonitoringConfigurationError {
...
mod _describe_email_monitoring_configuration_output;
