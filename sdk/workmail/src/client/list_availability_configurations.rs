...
impl super::Client  {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::list_availability_configurations::builders::ListAvailabilityConfigurationsFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::list_availability_configurations::builders::ListAvailabilityConfigurationsFluentBuilder::set_organization_id): <p>The WorkMail organization for which the <code>AvailabilityConfiguration</code>'s will be listed.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_availability_configurations::builders::ListAvailabilityConfigurationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_availability_configurations::builders::ListAvailabilityConfigurationsFluentBuilder::set_next_token): <p>The token to use to retrieve the next page of results. The first call does not require a token.</p>
