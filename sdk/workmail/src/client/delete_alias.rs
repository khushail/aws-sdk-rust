...
impl super::Client  {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::delete_alias::builders::DeleteAliasFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::delete_alias::builders::DeleteAliasFluentBuilder::set_organization_id): <p>The identifier for the organization under which the user exists.</p>
    ///   - [`entity_id(impl ::std::convert::Into<String>)`](crate::operation::delete_alias::builders::DeleteAliasFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::delete_alias::builders::DeleteAliasFluentBuilder::set_entity_id): <p>The identifier for the member (user or group) from which to have the aliases removed.</p>
