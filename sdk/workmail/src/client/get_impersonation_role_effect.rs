...
impl super::Client  {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::get_impersonation_role_effect::builders::GetImpersonationRoleEffectFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::get_impersonation_role_effect::builders::GetImpersonationRoleEffectFluentBuilder::set_organization_id): <p>The WorkMail organization where the impersonation role is defined.</p>
    ///   - [`impersonation_role_id(impl ::std::convert::Into<String>)`](crate::operation::get_impersonation_role_effect::builders::GetImpersonationRoleEffectFluentBuilder::impersonation_role_id) / [`set_impersonation_role_id(Option<String>)`](crate::operation::get_impersonation_role_effect::builders::GetImpersonationRoleEffectFluentBuilder::set_impersonation_role_id): <p>The impersonation role ID to test.</p>
    ///   - [`target_user(impl ::std::convert::Into<String>)`](crate::operation::get_impersonation_role_effect::builders::GetImpersonationRoleEffectFluentBuilder::target_user) / [`set_target_user(Option<String>)`](crate::operation::get_impersonation_role_effect::builders::GetImpersonationRoleEffectFluentBuilder::set_target_user): <p>The WorkMail organization user chosen to test the impersonation role. The following identity formats are available:</p>  <ul>   <li> <p>User ID: <code>12345678-1234-1234-1234-123456789012</code> or <code>S-1-1-12-1234567890-123456789-123456789-1234</code> </p> </li>   <li> <p>Email address: <code>user@domain.tld</code> </p> </li>   <li> <p>User name: <code>user</code> </p> </li>  </ul>
