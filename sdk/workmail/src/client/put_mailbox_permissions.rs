...
impl super::Client  {
    ...
    ///   - [`organization_id(impl ::std::convert::Into<String>)`](crate::operation::put_mailbox_permissions::builders::PutMailboxPermissionsFluentBuilder::organization_id) / [`set_organization_id(Option<String>)`](crate::operation::put_mailbox_permissions::builders::PutMailboxPermissionsFluentBuilder::set_organization_id): <p>The identifier of the organization under which the user, group, or resource exists.</p>
    ///   - [`entity_id(impl ::std::convert::Into<String>)`](crate::operation::put_mailbox_permissions::builders::PutMailboxPermissionsFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::put_mailbox_permissions::builders::PutMailboxPermissionsFluentBuilder::set_entity_id): <p>The identifier of the user, group, or resource for which to update mailbox permissions.</p>
    ///   - [`grantee_id(impl ::std::convert::Into<String>)`](crate::operation::put_mailbox_permissions::builders::PutMailboxPermissionsFluentBuilder::grantee_id) / [`set_grantee_id(Option<String>)`](crate::operation::put_mailbox_permissions::builders::PutMailboxPermissionsFluentBuilder::set_grantee_id): <p>The identifier of the user, group, or resource to which to grant the permissions.</p>
