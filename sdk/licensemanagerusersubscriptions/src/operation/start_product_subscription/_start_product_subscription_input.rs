...
impl StartProductSubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_product_subscription::StartProductSubscriptionInput, ::aws_smithy_http::operation::error::BuildError> {
