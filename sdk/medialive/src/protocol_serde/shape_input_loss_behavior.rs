...
pub fn ser_input_loss_behavior(
    ...
    if let Some(var_1) = &input.black_frame_msec {
        object.key("blackFrameMsec").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    ...
    if let Some(var_6) = &input.repeat_frame_msec {
        object.key("repeatFrameMsec").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_6).into()));
    }
    Ok(())
}
