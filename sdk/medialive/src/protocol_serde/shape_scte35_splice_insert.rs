...
pub fn ser_scte35_splice_insert(
                     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                     input: &crate::types::Scte35SpliceInsert,
...
pub(crate) fn de_scte35_splice_insert<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::Scte35SpliceInsert>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::Scte35SpliceInsertBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_no_regional_blackout_flag(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::Scte35SpliceInsertNoRegionalBlackoutBehavior::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "webDeliveryAllowedFlag" => {
                                builder = builder.set_web_delivery_allowed_flag(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::Scte35SpliceInsertWebDeliveryAllowedBehavior::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
