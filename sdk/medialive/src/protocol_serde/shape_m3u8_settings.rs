...
pub fn ser_m3u8_settings(
    ...
    if let Some(var_1) = &input.audio_frames_per_pes {
        object.key("audioFramesPerPes").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_1).into()));
    }
    ...
    if let Some(var_5) = &input.pat_interval {
        object.key("patInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    if let Some(var_6) = &input.pcr_control {
        object.key("pcrControl").string(var_6.as_str());
    }
    if let Some(var_7) = &input.pcr_period {
        object.key("pcrPeriod").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    if let Some(var_8) = &input.pcr_pid {
        object.key("pcrPid").string(var_8.as_str());
    }
    if let Some(var_9) = &input.pmt_interval {
        object.key("pmtInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_9).into()));
    }
    if let Some(var_10) = &input.pmt_pid {
        object.key("pmtPid").string(var_10.as_str());
    }
    if let Some(var_11) = &input.program_num {
        object.key("programNum").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_11).into()));
    }
    ...
    if let Some(var_16) = &input.transport_stream_id {
        object.key("transportStreamId").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
