...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_channel_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_channel::DeleteChannelOutput, crate::operation::delete_channel::DeleteChannelError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_channel::builders::DeleteChannelOutputBuilder::default();
        output = crate::protocol_serde::shape_delete_channel::de_delete_channel(_response_body, output).map_err(crate::operation::delete_channel::DeleteChannelError::unhandled)?;
        output._set_request_id(::aws_http::request_id::RequestId::request_id(_response_headers).map(str::to_string));
        output.build()
    })
}

pub(crate) fn de_delete_channel(value: &[u8], mut builder: crate::operation::delete_channel::builders::DeleteChannelOutputBuilder) -> Result<crate::operation::delete_channel::builders::DeleteChannelOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
