...
pub fn ser_h264_settings(
    ...
    if let Some(var_4) = &input.buf_fill_pct {
        object.key("bufFillPct").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    if let Some(var_5) = &input.buf_size {
        object.key("bufSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_5).into()));
    }
    ...
    if let Some(var_16) = &input.framerate_denominator {
        object.key("framerateDenominator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
    if let Some(var_17) = &input.framerate_numerator {
        object.key("framerateNumerator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_17).into()));
    }
    ...
    if let Some(var_19) = &input.gop_closed_cadence {
        object.key("gopClosedCadence").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_19).into()));
    }
    if let Some(var_20) = &input.gop_num_b_frames {
        object.key("gopNumBFrames").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_20).into()));
    }
    if let Some(var_21) = &input.gop_size {
        object.key("gopSize").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_21).into()));
    }
    ...
    if let Some(var_25) = &input.max_bitrate {
        object.key("maxBitrate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_25).into()));
    }
    if let Some(var_26) = &input.min_i_interval {
        object.key("minIInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_26).into()));
    }
    if let Some(var_27) = &input.num_ref_frames {
        object.key("numRefFrames").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_27).into()));
    }
    if let Some(var_28) = &input.par_control {
        object.key("parControl").string(var_28.as_str());
    }
    if let Some(var_29) = &input.par_denominator {
        object.key("parDenominator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_29).into()));
    }
    if let Some(var_30) = &input.par_numerator {
        object.key("parNumerator").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_30).into()));
    }
    ...
    if let Some(var_33) = &input.qvbr_quality_level {
        object.key("qvbrQualityLevel").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_33).into()));
    }
    ...
    if let Some(var_38) = &input.softness {
        object.key("softness").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_38).into()));
    }
