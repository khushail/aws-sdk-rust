...
pub fn ser_hls_group_settings(
    ...
    if let Some(var_26) = &input.index_n_segments {
        object.key("indexNSegments").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_26).into()));
    }
    ...
    if let Some(var_30) = &input.keep_segments {
        object.key("keepSegments").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_30).into()));
    }
    ...
    if let Some(var_37) = &input.min_segment_length {
        object.key("minSegmentLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_37).into()));
    }
    ...
    if let Some(var_42) = &input.program_date_time_period {
        object.key("programDateTimePeriod").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_42).into()));
    }
    ...
    if let Some(var_44) = &input.segment_length {
        object.key("segmentLength").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_44).into()));
    }
    ...
    if let Some(var_46) = &input.segments_per_subdirectory {
        object.key("segmentsPerSubdirectory").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_46).into()));
    }
    ...
    if let Some(var_49) = &input.timed_metadata_id3_period {
        object.key("timedMetadataId3Period").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_49).into()));
    }
    if let Some(var_50) = &input.timestamp_delta_milliseconds {
        object.key("timestampDeltaMilliseconds").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_50).into()));
    }
