...
pub fn ser_video_description(
    ...
    if let Some(var_3) = &input.height {
        object.key("height").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_3).into()));
    }
    ...
    if let Some(var_7) = &input.sharpness {
        object.key("sharpness").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_7).into()));
    }
    if let Some(var_8) = &input.width {
        object.key("width").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_8).into()));
    }
    Ok(())
}
