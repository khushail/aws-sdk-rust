...
pub fn ser_aac_settings(
    ...
    if let Some(var_7) = &input.sample_rate {
        object.key("sampleRate").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::Float((*var_7).into()));
    }
    if let Some(var_8) = &input.spec {
        object.key("spec").string(var_8.as_str());
    }
