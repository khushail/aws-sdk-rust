...
pub fn ser_ms_smooth_group_settings(
    ...
    if let Some(var_4) = &input.connection_retry_interval {
        object.key("connectionRetryInterval").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_4).into()));
    }
    ...
    if let Some(var_10) = &input.filecache_duration {
        object.key("filecacheDuration").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_10).into()));
    }
    ...
    if let Some(var_13) = &input.num_retries {
        object.key("numRetries").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_13).into()));
    }
    if let Some(var_14) = &input.restart_delay {
        object.key("restartDelay").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_14).into()));
    }
    ...
    if let Some(var_16) = &input.send_delay_ms {
        object.key("sendDelayMs").number(#[allow(clippy::useless_conversion)]::aws_smithy_types::Number::NegInt((*var_16).into()));
    }
