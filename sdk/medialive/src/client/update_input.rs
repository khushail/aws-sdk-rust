...
impl super::Client  {
    ...
    ///   - [`input_id(impl ::std::convert::Into<String>)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::input_id) / [`set_input_id(Option<String>)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::set_input_id): Unique ID of the input.
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::set_name): Name of the input.
    ///   - [`role_arn(impl ::std::convert::Into<String>)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::role_arn) / [`set_role_arn(Option<String>)`](crate::operation::update_input::builders::UpdateInputFluentBuilder::set_role_arn): The Amazon Resource Name (ARN) of the role this input assumes during and after creation.
