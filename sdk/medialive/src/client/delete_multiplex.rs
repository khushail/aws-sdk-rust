...
impl super::Client  {
    ...
    ///   - [`multiplex_id(impl ::std::convert::Into<String>)`](crate::operation::delete_multiplex::builders::DeleteMultiplexFluentBuilder::multiplex_id) / [`set_multiplex_id(Option<String>)`](crate::operation::delete_multiplex::builders::DeleteMultiplexFluentBuilder::set_multiplex_id): The ID of the multiplex.
