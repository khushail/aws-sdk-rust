...
impl PurchaseOfferingInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::purchase_offering::PurchaseOffering, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::purchase_offering::PurchaseOfferingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if offering_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("offering_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/prod/offerings/{OfferingId}/purchase", OfferingId = offering_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::purchase_offering::PurchaseOffering::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PurchaseOffering", "medialive"));
