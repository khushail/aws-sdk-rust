...
impl CancelInputDeviceTransferInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::cancel_input_device_transfer::CancelInputDeviceTransferInput, ::aws_smithy_http::operation::error::BuildError> {
