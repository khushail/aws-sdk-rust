...
impl DescribeInputDeviceThumbnailInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_input_device_thumbnail::DescribeInputDeviceThumbnailInput, ::aws_smithy_http::operation::error::BuildError> {
