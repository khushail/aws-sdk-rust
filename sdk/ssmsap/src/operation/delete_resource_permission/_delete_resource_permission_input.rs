...
impl DeleteResourcePermissionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_resource_permission::DeleteResourcePermissionInput, ::aws_smithy_http::operation::error::BuildError> {
