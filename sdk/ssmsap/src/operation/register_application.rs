...
impl RegisterApplicationInput {
    /// Consumes the builder and constructs an Operation<[`RegisterApplication`](crate::operation::register_application::RegisterApplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_application::RegisterApplication, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_application::RegisterApplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/register-application").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_application::ser_register_application_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_application::RegisterApplication::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterApplication {
                type Output = ::std::result::Result<crate::operation::register_application::RegisterApplicationOutput, crate::operation::register_application::RegisterApplicationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_register_application::de_register_application_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::register_application::RegisterApplicationError {
...
mod _register_application_output;
