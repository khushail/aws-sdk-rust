...
impl super::Client  {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::list_components::builders::ListComponentsFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::list_components::builders::ListComponentsFluentBuilder::set_application_id): <p>The ID of the application.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_components::builders::ListComponentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_components::builders::ListComponentsFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
