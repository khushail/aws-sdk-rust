...
impl super::Client  {
    ...
    ///   - [`channel_group_name(impl ::std::convert::Into<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::channel_group_name) / [`set_channel_group_name(Option<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::set_channel_group_name): <p>The name that describes the channel group. The name is the primary identifier for the channel group, and must be unique for your account in the AWS Region.</p>
    ///   - [`max_results(i32)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::set_max_results): <p>The maximum number of results to return in the response.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_channels::builders::ListChannelsFluentBuilder::set_next_token): <p>The pagination token from the GET list request. Use the token to fetch the next page of results.</p>
