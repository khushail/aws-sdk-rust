...
impl super::Client  {
    /// Constructs a fluent builder for the [`GetOriginEndpoint`](crate::operation::get_origin_endpoint::builders::GetOriginEndpointFluentBuilder) operation.
                            ///
                            /// - The fluent builder is configurable:
    ///   - [`channel_group_name(impl ::std::convert::Into<String>)`](crate::operation::get_origin_endpoint::builders::GetOriginEndpointFluentBuilder::channel_group_name) / [`set_channel_group_name(Option<String>)`](crate::operation::get_origin_endpoint::builders::GetOriginEndpointFluentBuilder::set_channel_group_name): <p>The name that describes the channel group. The name is the primary identifier for the channel group, and must be unique for your account in the AWS Region.</p>
    ///   - [`channel_name(impl ::std::convert::Into<String>)`](crate::operation::get_origin_endpoint::builders::GetOriginEndpointFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::get_origin_endpoint::builders::GetOriginEndpointFluentBuilder::set_channel_name): <p>The name that describes the channel. The name is the primary identifier for the channel, and must be unique for your account in the AWS Region and channel group. </p>
    ///   - [`origin_endpoint_name(impl ::std::convert::Into<String>)`](crate::operation::get_origin_endpoint::builders::GetOriginEndpointFluentBuilder::origin_endpoint_name) / [`set_origin_endpoint_name(Option<String>)`](crate::operation::get_origin_endpoint::builders::GetOriginEndpointFluentBuilder::set_origin_endpoint_name): <p>The name that describes the origin endpoint. The name is the primary identifier for the origin endpoint, and and must be unique for your account in the AWS Region and channel. </p>
                            /// - On success, responds with [`GetOriginEndpointOutput`](crate::operation::get_origin_endpoint::GetOriginEndpointOutput) with field(s):
    ///   - [`arn(Option<String>)`](crate::operation::get_origin_endpoint::GetOriginEndpointOutput::arn): <p>The Amazon Resource Name (ARN) associated with the resource.</p>
    ///   - [`channel_group_name(Option<String>)`](crate::operation::get_origin_endpoint::GetOriginEndpointOutput::channel_group_name): <p>The name that describes the channel group. The name is the primary identifier for the channel group, and must be unique for your account in the AWS Region.</p>
    ///   - [`channel_name(Option<String>)`](crate::operation::get_origin_endpoint::GetOriginEndpointOutput::channel_name): <p>The name that describes the channel. The name is the primary identifier for the channel, and must be unique for your account in the AWS Region and channel group.</p>
    ///   - [`origin_endpoint_name(Option<String>)`](crate::operation::get_origin_endpoint::GetOriginEndpointOutput::origin_endpoint_name): <p>The name that describes the origin endpoint. The name is the primary identifier for the origin endpoint, and and must be unique for your account in the AWS Region and channel.</p>
    ///   - [`container_type(Option<ContainerType>)`](crate::operation::get_origin_endpoint::GetOriginEndpointOutput::container_type): <p>The type of container attached to this origin endpoint.</p>
    ...
    ///   - [`created_at(Option<DateTime>)`](crate::operation::get_origin_endpoint::GetOriginEndpointOutput::created_at): <p>The date and time the origin endpoint was created.</p>
    ///   - [`modified_at(Option<DateTime>)`](crate::operation::get_origin_endpoint::GetOriginEndpointOutput::modified_at): <p>The date and time the origin endpoint was modified.</p>
