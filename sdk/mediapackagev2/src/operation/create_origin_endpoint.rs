...
impl CreateOriginEndpointInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_origin_endpoint::CreateOriginEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_origin_endpoint::CreateOriginEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateOriginEndpoint {
                type Output = ::std::result::Result<crate::operation::create_origin_endpoint::CreateOriginEndpointOutput, crate::operation::create_origin_endpoint::CreateOriginEndpointError>;
