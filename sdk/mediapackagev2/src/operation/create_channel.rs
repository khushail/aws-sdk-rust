...
impl CreateChannelInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_channel::CreateChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_channel::CreateChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_channel::CreateChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateChannel", "mediapackagev2"));
...
impl CreateChannelError {
    ...
    /// Returns `true` if the error kind is `CreateChannelError::InternalServerException`.
