...
impl ListCostCategoryDefinitionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_cost_category_definitions::ListCostCategoryDefinitionsInput, ::aws_smithy_http::operation::error::BuildError> {
