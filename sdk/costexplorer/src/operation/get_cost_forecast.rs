...
impl GetCostForecastInput {
    /// Consumes the builder and constructs an Operation<[`GetCostForecast`](crate::operation::get_cost_forecast::GetCostForecast)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_cost_forecast::GetCostForecast, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_cost_forecast::GetCostForecastInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_cost_forecast::GetCostForecast::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCostForecast", "costexplorer"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetCostForecast`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCostForecast {
                type Output = ::std::result::Result<crate::operation::get_cost_forecast::GetCostForecastOutput, crate::operation::get_cost_forecast::GetCostForecastError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_cost_forecast::de_get_cost_forecast_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_cost_forecast::de_get_cost_forecast_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_cost_forecast::GetCostForecastError {
