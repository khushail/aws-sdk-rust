...
impl DeleteAnomalySubscriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_anomaly_subscription::DeleteAnomalySubscriptionInput, ::aws_smithy_http::operation::error::BuildError> {
