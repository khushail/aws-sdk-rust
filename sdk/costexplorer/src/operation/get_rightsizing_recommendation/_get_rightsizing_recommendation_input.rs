...
impl GetRightsizingRecommendationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_rightsizing_recommendation::GetRightsizingRecommendationInput, ::aws_smithy_http::operation::error::BuildError> {
