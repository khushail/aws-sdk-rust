...
impl DeleteCostCategoryDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_cost_category_definition::DeleteCostCategoryDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
