...
pub(crate) fn de_dimension_values<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DimensionValues>, ::aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_key(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::Dimension::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
