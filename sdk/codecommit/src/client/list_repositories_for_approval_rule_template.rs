...
impl super::Client  {
    ...
    ///   - [`approval_rule_template_name(impl ::std::convert::Into<String>)`](crate::operation::list_repositories_for_approval_rule_template::builders::ListRepositoriesForApprovalRuleTemplateFluentBuilder::approval_rule_template_name) / [`set_approval_rule_template_name(Option<String>)`](crate::operation::list_repositories_for_approval_rule_template::builders::ListRepositoriesForApprovalRuleTemplateFluentBuilder::set_approval_rule_template_name): <p>The name of the approval rule template for which you want to list repositories that are associated with that template.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_repositories_for_approval_rule_template::builders::ListRepositoriesForApprovalRuleTemplateFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_repositories_for_approval_rule_template::builders::ListRepositoriesForApprovalRuleTemplateFluentBuilder::set_next_token): <p>An enumeration token that, when provided in a request, returns the next batch of the results.</p>
