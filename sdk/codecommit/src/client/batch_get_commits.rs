...
impl super::Client  {
    ...
    ///   - [`repository_name(impl ::std::convert::Into<String>)`](crate::operation::batch_get_commits::builders::BatchGetCommitsFluentBuilder::repository_name) / [`set_repository_name(Option<String>)`](crate::operation::batch_get_commits::builders::BatchGetCommitsFluentBuilder::set_repository_name): <p>The name of the repository that contains the commits.</p>
