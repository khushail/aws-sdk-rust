...
impl super::Client  {
    ...
    ///   - [`pull_request_id(impl ::std::convert::Into<String>)`](crate::operation::get_pull_request_approval_states::builders::GetPullRequestApprovalStatesFluentBuilder::pull_request_id) / [`set_pull_request_id(Option<String>)`](crate::operation::get_pull_request_approval_states::builders::GetPullRequestApprovalStatesFluentBuilder::set_pull_request_id): <p>The system-generated ID for the pull request.</p>
    ///   - [`revision_id(impl ::std::convert::Into<String>)`](crate::operation::get_pull_request_approval_states::builders::GetPullRequestApprovalStatesFluentBuilder::revision_id) / [`set_revision_id(Option<String>)`](crate::operation::get_pull_request_approval_states::builders::GetPullRequestApprovalStatesFluentBuilder::set_revision_id): <p>The system-generated ID for the pull request revision.</p>
