...
impl UpdatePullRequestTitleInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_pull_request_title::UpdatePullRequestTitle, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_pull_request_title::UpdatePullRequestTitleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePullRequestTitle {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_pull_request_title::de_update_pull_request_title_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_pull_request_title::de_update_pull_request_title_http_response_with_props(status, headers, body)
                     }
                }
