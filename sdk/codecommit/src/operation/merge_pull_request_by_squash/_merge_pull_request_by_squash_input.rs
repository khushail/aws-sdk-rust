...
impl MergePullRequestBySquashInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::merge_pull_request_by_squash::MergePullRequestBySquashInput, ::aws_smithy_http::operation::error::BuildError> {
