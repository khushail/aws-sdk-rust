...
impl MergeBranchesByThreeWayInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::merge_branches_by_three_way::MergeBranchesByThreeWayInput, ::aws_smithy_http::operation::error::BuildError> {
