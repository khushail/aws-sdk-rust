...
impl DescribeMergeConflictsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMergeConflicts`](crate::operation::describe_merge_conflicts::DescribeMergeConflicts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_merge_conflicts::DescribeMergeConflicts, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_merge_conflicts::DescribeMergeConflictsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_merge_conflicts::ser_describe_merge_conflicts_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_merge_conflicts::DescribeMergeConflicts::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeMergeConflicts", "codecommit"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMergeConflicts {
                type Output = ::std::result::Result<crate::operation::describe_merge_conflicts::DescribeMergeConflictsOutput, crate::operation::describe_merge_conflicts::DescribeMergeConflictsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_merge_conflicts::de_describe_merge_conflicts_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_merge_conflicts::DescribeMergeConflictsError {
