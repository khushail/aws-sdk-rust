...
impl DeletePullRequestApprovalRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_pull_request_approval_rule::DeletePullRequestApprovalRuleInput, ::aws_smithy_http::operation::error::BuildError> {
