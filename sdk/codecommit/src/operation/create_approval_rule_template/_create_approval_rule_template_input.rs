...
impl CreateApprovalRuleTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_approval_rule_template::CreateApprovalRuleTemplateInput, ::aws_smithy_http::operation::error::BuildError> {
