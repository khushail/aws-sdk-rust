...
impl GetCommentsForPullRequestInput {
    /// Consumes the builder and constructs an Operation<[`GetCommentsForPullRequest`](crate::operation::get_comments_for_pull_request::GetCommentsForPullRequest)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_comments_for_pull_request::GetCommentsForPullRequest, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_comments_for_pull_request::ser_get_comments_for_pull_request_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_comments_for_pull_request::GetCommentsForPullRequest::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCommentsForPullRequest", "codecommit"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCommentsForPullRequest {
                type Output = ::std::result::Result<crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestOutput, crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_comments_for_pull_request::de_get_comments_for_pull_request_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestError {
