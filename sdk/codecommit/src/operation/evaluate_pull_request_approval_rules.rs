...
impl EvaluatePullRequestApprovalRulesInput {
    /// Consumes the builder and constructs an Operation<[`EvaluatePullRequestApprovalRules`](crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRules, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRulesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_evaluate_pull_request_approval_rules::ser_evaluate_pull_request_approval_rules_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRules::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("EvaluatePullRequestApprovalRules", "codecommit"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `EvaluatePullRequestApprovalRules`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for EvaluatePullRequestApprovalRules {
                type Output = ::std::result::Result<crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRulesOutput, crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRulesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_evaluate_pull_request_approval_rules::de_evaluate_pull_request_approval_rules_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_evaluate_pull_request_approval_rules::de_evaluate_pull_request_approval_rules_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EvaluatePullRequestApprovalRulesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::evaluate_pull_request_approval_rules::EvaluatePullRequestApprovalRulesError {
...
pub use crate::operation::evaluate_pull_request_approval_rules::_evaluate_pull_request_approval_rules_output::EvaluatePullRequestApprovalRulesOutput;

pub use crate::operation::evaluate_pull_request_approval_rules::_evaluate_pull_request_approval_rules_input::EvaluatePullRequestApprovalRulesInput;

mod _evaluate_pull_request_approval_rules_input;

mod _evaluate_pull_request_approval_rules_output;
