...
impl BatchGetRepositoriesInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetRepositories`](crate::operation::batch_get_repositories::BatchGetRepositories)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_get_repositories::BatchGetRepositories, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_repositories::BatchGetRepositoriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_get_repositories::ser_batch_get_repositories_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_repositories::BatchGetRepositories::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchGetRepositories", "codecommit"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetRepositories {
                type Output = ::std::result::Result<crate::operation::batch_get_repositories::BatchGetRepositoriesOutput, crate::operation::batch_get_repositories::BatchGetRepositoriesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_get_repositories::de_batch_get_repositories_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_get_repositories::de_batch_get_repositories_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_repositories::BatchGetRepositoriesError {
...
mod _batch_get_repositories_output;
