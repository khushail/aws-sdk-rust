...
impl CreatePullRequestApprovalRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_pull_request_approval_rule::CreatePullRequestApprovalRuleInput, ::aws_smithy_http::operation::error::BuildError> {
