...
impl PostCommentForComparedCommitInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::post_comment_for_compared_commit::PostCommentForComparedCommitInput, ::aws_smithy_http::operation::error::BuildError> {
