...
impl DeleteCommentContentInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_comment_content::DeleteCommentContent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_comment_content::DeleteCommentContentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `DeleteCommentContent`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteCommentContent {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_comment_content::de_delete_comment_content_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_comment_content::de_delete_comment_content_http_response_with_props(status, headers, body)
                     }
                }
