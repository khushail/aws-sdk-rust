...
impl GetCommentsForPullRequestInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_comments_for_pull_request::GetCommentsForPullRequestInput, ::aws_smithy_http::operation::error::BuildError> {
