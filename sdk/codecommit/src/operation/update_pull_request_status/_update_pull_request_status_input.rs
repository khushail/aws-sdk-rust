...
impl UpdatePullRequestStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_pull_request_status::UpdatePullRequestStatusInput, ::aws_smithy_http::operation::error::BuildError> {
