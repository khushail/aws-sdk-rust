...
impl UpdateDefaultBranchInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDefaultBranch`](crate::operation::update_default_branch::UpdateDefaultBranch)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_default_branch::UpdateDefaultBranch, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_default_branch::UpdateDefaultBranchInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_default_branch::ser_update_default_branch_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_default_branch::UpdateDefaultBranch::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDefaultBranch", "codecommit"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateDefaultBranch`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDefaultBranch {
                type Output = ::std::result::Result<crate::operation::update_default_branch::UpdateDefaultBranchOutput, crate::operation::update_default_branch::UpdateDefaultBranchError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_default_branch::de_update_default_branch_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_default_branch::UpdateDefaultBranchError {
...
mod _update_default_branch_output;
