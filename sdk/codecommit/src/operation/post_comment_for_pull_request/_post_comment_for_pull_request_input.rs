...
impl PostCommentForPullRequestInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::post_comment_for_pull_request::PostCommentForPullRequestInput, ::aws_smithy_http::operation::error::BuildError> {
