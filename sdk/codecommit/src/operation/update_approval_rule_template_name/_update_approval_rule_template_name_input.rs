...
impl UpdateApprovalRuleTemplateNameInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_approval_rule_template_name::UpdateApprovalRuleTemplateNameInput, ::aws_smithy_http::operation::error::BuildError> {
