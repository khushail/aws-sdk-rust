...
impl UpdateRepositoryDescriptionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_repository_description::UpdateRepositoryDescriptionInput, ::aws_smithy_http::operation::error::BuildError> {
