...
impl GetCommentsForComparedCommitInput {
    /// Consumes the builder and constructs an Operation<[`GetCommentsForComparedCommit`](crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommit)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommit, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_comments_for_compared_commit::ser_get_comments_for_compared_commit_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommit::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCommentsForComparedCommit", "codecommit"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetCommentsForComparedCommit`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCommentsForComparedCommit {
                type Output = ::std::result::Result<crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitOutput, crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_comments_for_compared_commit::de_get_comments_for_compared_commit_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_comments_for_compared_commit::de_get_comments_for_compared_commit_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_comments_for_compared_commit::GetCommentsForComparedCommitError {
...
mod _get_comments_for_compared_commit_output;
