...
impl MergeBranchesByFastForwardInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::merge_branches_by_fast_forward::MergeBranchesByFastForwardInput, ::aws_smithy_http::operation::error::BuildError> {
