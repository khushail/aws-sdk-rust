...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_default_branch_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_default_branch::UpdateDefaultBranchOutput, crate::operation::update_default_branch::UpdateDefaultBranchError> {
    Ok({
        #[allow(unused_mut)]
