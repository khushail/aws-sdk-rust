...
pub fn ser_update_approval_rule_template_description_input(input: &crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_update_approval_rule_template_description_input::ser_update_approval_rule_template_description_input(&mut object, input)?;
    object.finish();
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_approval_rule_template_description_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionOutput, crate::operation::update_approval_rule_template_description::UpdateApprovalRuleTemplateDescriptionError> {
    Ok({
        #[allow(unused_mut)]
