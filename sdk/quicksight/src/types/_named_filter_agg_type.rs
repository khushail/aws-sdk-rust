...
other => NamedFilterAggType::Unknown(crate::primitives::UnknownVariantValue(other.to_owned()))
                    }
                }
            }
...
impl NamedFilterAggType {
    ...
    NamedFilterAggType::Unknown(value) => value.as_str()
                ...
                pub const fn values() -> &'static [&'static str] {
                    &["AVERAGE", "COUNT", "DISTINCT_COUNT", "MAX", "MEDIAN", "MIN", "NO_AGGREGATION", "STDEV", "STDEVP", "SUM", "VAR", "VARP"]
                }
            }
