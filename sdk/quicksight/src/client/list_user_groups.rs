...
impl super::Client  {
    ...
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::set_user_name): <p>The Amazon QuickSight user name that you want to list group memberships for.</p>
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID that the user is in. Currently, you use the ID for the Amazon Web Services account that contains your Amazon QuickSight account.</p>
    ///   - [`namespace(impl ::std::convert::Into<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::set_namespace): <p>The namespace. Currently, you should set this to <code>default</code>.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_user_groups::builders::ListUserGroupsFluentBuilder::set_next_token): <p>A pagination token that can be used in a subsequent request.</p>
