...
impl super::Client  {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::list_users::builders::ListUsersFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_users::builders::ListUsersFluentBuilder::set_aws_account_id): <p>The ID for the Amazon Web Services account that the user is in. Currently, you use the ID for the Amazon Web Services account that contains your Amazon QuickSight account.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_users::builders::ListUsersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_users::builders::ListUsersFluentBuilder::set_next_token): <p>A pagination token that can be used in a subsequent request.</p>
    ...
    ///   - [`namespace(impl ::std::convert::Into<String>)`](crate::operation::list_users::builders::ListUsersFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::list_users::builders::ListUsersFluentBuilder::set_namespace): <p>The namespace. Currently, you should set this to <code>default</code>.</p>
