...
impl super::Client  {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::delete_vpc_connection::builders::DeleteVPCConnectionFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::delete_vpc_connection::builders::DeleteVPCConnectionFluentBuilder::set_aws_account_id): <p>The Amazon Web Services account ID of the account where you want to delete a VPC connection.</p>
    ///   - [`vpc_connection_id(impl ::std::convert::Into<String>)`](crate::operation::delete_vpc_connection::builders::DeleteVPCConnectionFluentBuilder::vpc_connection_id) / [`set_vpc_connection_id(Option<String>)`](crate::operation::delete_vpc_connection::builders::DeleteVPCConnectionFluentBuilder::set_vpc_connection_id): <p>The ID of the VPC connection that you're creating. This ID is a unique identifier for each Amazon Web Services Region in an Amazon Web Services account.</p>
