...
impl super::Client  {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::describe_namespace::builders::DescribeNamespaceFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_namespace::builders::DescribeNamespaceFluentBuilder::set_aws_account_id): <p>The ID for the Amazon Web Services account that contains the Amazon QuickSight namespace that you want to describe.</p>
    ///   - [`namespace(impl ::std::convert::Into<String>)`](crate::operation::describe_namespace::builders::DescribeNamespaceFluentBuilder::namespace) / [`set_namespace(Option<String>)`](crate::operation::describe_namespace::builders::DescribeNamespaceFluentBuilder::set_namespace): <p>The namespace that you want to describe.</p>
