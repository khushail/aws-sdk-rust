...
impl super::Client  {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::describe_account_settings::builders::DescribeAccountSettingsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_account_settings::builders::DescribeAccountSettingsFluentBuilder::set_aws_account_id): <p>The ID for the Amazon Web Services account that contains the settings that you want to list.</p>
