...
impl super::Client  {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::list_analyses::builders::ListAnalysesFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::list_analyses::builders::ListAnalysesFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the analyses.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_analyses::builders::ListAnalysesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_analyses::builders::ListAnalysesFluentBuilder::set_next_token): <p>A pagination token that can be used in a subsequent request.</p>
