...
impl super::Client  {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::describe_folder_permissions::builders::DescribeFolderPermissionsFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::describe_folder_permissions::builders::DescribeFolderPermissionsFluentBuilder::set_aws_account_id): <p>The ID for the Amazon Web Services account that contains the folder.</p>
    ///   - [`folder_id(impl ::std::convert::Into<String>)`](crate::operation::describe_folder_permissions::builders::DescribeFolderPermissionsFluentBuilder::folder_id) / [`set_folder_id(Option<String>)`](crate::operation::describe_folder_permissions::builders::DescribeFolderPermissionsFluentBuilder::set_folder_id): <p>The ID of the folder.</p>
