...
impl super::Client  {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::search_folders::builders::SearchFoldersFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::search_folders::builders::SearchFoldersFluentBuilder::set_aws_account_id): <p>The ID for the Amazon Web Services account that contains the folder.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::search_folders::builders::SearchFoldersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::search_folders::builders::SearchFoldersFluentBuilder::set_next_token): <p>The token for the next set of results, or null if there are no more results.</p>
