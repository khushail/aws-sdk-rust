...
impl super::Client  {
    ...
    ///   - [`aws_account_id(impl ::std::convert::Into<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::aws_account_id) / [`set_aws_account_id(Option<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::set_aws_account_id): <p>The ID of the Amazon Web Services account that contains the topic whose refresh schedule you want to update.</p>
    ///   - [`topic_id(impl ::std::convert::Into<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::topic_id) / [`set_topic_id(Option<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::set_topic_id): <p>The ID of the topic that you want to modify. This ID is unique per Amazon Web Services Region for each Amazon Web Services account.</p>
    ///   - [`dataset_id(impl ::std::convert::Into<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::dataset_id) / [`set_dataset_id(Option<String>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::set_dataset_id): <p>The ID of the dataset.</p>
    ///   - [`refresh_schedule(TopicRefreshSchedule)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::refresh_schedule) / [`set_refresh_schedule(Option<TopicRefreshSchedule>)`](crate::operation::update_topic_refresh_schedule::builders::UpdateTopicRefreshScheduleFluentBuilder::set_refresh_schedule): <p>The definition of a refresh schedule.</p>
