...
impl CreateIamPolicyAssignmentInput {
    /// Consumes the builder and constructs an Operation<[`CreateIAMPolicyAssignment`](crate::operation::create_iam_policy_assignment::CreateIAMPolicyAssignment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_iam_policy_assignment::CreateIAMPolicyAssignment, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_iam_policy_assignment::CreateIamPolicyAssignmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/namespaces/{Namespace}/iam-policy-assignments", AwsAccountId = aws_account_id, Namespace = namespace).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_iam_policy_assignment::ser_create_iam_policy_assignment_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_iam_policy_assignment::CreateIAMPolicyAssignment::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateIAMPolicyAssignment", "quicksight"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateIAMPolicyAssignment`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIAMPolicyAssignment {
                type Output = ::std::result::Result<crate::operation::create_iam_policy_assignment::CreateIamPolicyAssignmentOutput, crate::operation::create_iam_policy_assignment::CreateIAMPolicyAssignmentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_iam_policy_assignment::de_create_iam_policy_assignment_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_iam_policy_assignment::de_create_iam_policy_assignment_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateIAMPolicyAssignmentErrorKind = CreateIAMPolicyAssignmentError;
/// Error type for the `CreateIAMPolicyAssignmentError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateIAMPolicyAssignmentError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_iam_policy_assignment::CreateIAMPolicyAssignmentError {
...
impl CreateIAMPolicyAssignmentError {
    /// Creates the `CreateIAMPolicyAssignmentError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateIAMPolicyAssignmentError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateIAMPolicyAssignmentError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CreateIAMPolicyAssignmentError::ConcurrentUpdatingException`.
    pub fn is_concurrent_updating_exception(&self) -> bool {
        matches!(self, Self::ConcurrentUpdatingException(_))
    }
    /// Returns `true` if the error kind is `CreateIAMPolicyAssignmentError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `CreateIAMPolicyAssignmentError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `CreateIAMPolicyAssignmentError::ResourceExistsException`.
    pub fn is_resource_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateIAMPolicyAssignmentError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateIAMPolicyAssignmentError::ThrottlingException`.
...
mod _create_iam_policy_assignment_output;
