...
impl ListTopicRefreshSchedulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_topic_refresh_schedules::ListTopicRefreshSchedulesInput, ::aws_smithy_http::operation::error::BuildError> {
