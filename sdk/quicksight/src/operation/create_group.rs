...
impl CreateGroupInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_group::CreateGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_group::CreateGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_group::CreateGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateGroup", "quicksight"));
...
impl CreateGroupError {
    ...
    /// Returns `true` if the error kind is `CreateGroupError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `CreateGroupError::InvalidParameterValueException`.
    ...
    /// Returns `true` if the error kind is `CreateGroupError::PreconditionNotMetException`.
    pub fn is_precondition_not_met_exception(&self) -> bool {
        matches!(self, Self::PreconditionNotMetException(_))
    }
    /// Returns `true` if the error kind is `CreateGroupError::ResourceExistsException`.
    ...
    /// Returns `true` if the error kind is `CreateGroupError::ResourceUnavailableException`.
