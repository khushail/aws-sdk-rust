...
impl SearchDataSourcesInput {
    /// Consumes the builder and constructs an Operation<[`SearchDataSources`](crate::operation::search_data_sources::SearchDataSources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_data_sources::SearchDataSources, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_data_sources::SearchDataSourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/search/data-sources", AwsAccountId = aws_account_id).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_data_sources::ser_search_data_sources_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_data_sources::SearchDataSources::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchDataSources", "quicksight"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SearchDataSources`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchDataSources {
                type Output = ::std::result::Result<crate::operation::search_data_sources::SearchDataSourcesOutput, crate::operation::search_data_sources::SearchDataSourcesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_search_data_sources::de_search_data_sources_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_search_data_sources::de_search_data_sources_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type SearchDataSourcesErrorKind = SearchDataSourcesError;
/// Error type for the `SearchDataSourcesError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum SearchDataSourcesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SearchDataSourcesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::search_data_sources::SearchDataSourcesError {
...
impl SearchDataSourcesError {
    /// Creates the `SearchDataSourcesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchDataSourcesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `SearchDataSourcesError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `SearchDataSourcesError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `SearchDataSourcesError::InvalidNextTokenException`.
    pub fn is_invalid_next_token_exception(&self) -> bool {
        matches!(self, Self::InvalidNextTokenException(_))
    }
    /// Returns `true` if the error kind is `SearchDataSourcesError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `SearchDataSourcesError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `SearchDataSourcesError::ThrottlingException`.
...
mod _search_data_sources_output;
