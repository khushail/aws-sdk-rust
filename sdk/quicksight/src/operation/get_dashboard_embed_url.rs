...
impl GetDashboardEmbedUrlInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_dashboard_embed_url::GetDashboardEmbedUrl, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_dashboard_embed_url::GetDashboardEmbedUrlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::get_dashboard_embed_url::GetDashboardEmbedUrlInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDashboardEmbedUrl {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_dashboard_embed_url::de_get_dashboard_embed_url_http_response_with_props(status, headers, body)
                     }
                }
