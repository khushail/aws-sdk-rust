...
impl DescribeDataSetPermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_data_set_permissions::DescribeDataSetPermissionsInput, ::aws_smithy_http::operation::error::BuildError> {
