...
impl DescribeAnalysisDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_analysis_definition::DescribeAnalysisDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
