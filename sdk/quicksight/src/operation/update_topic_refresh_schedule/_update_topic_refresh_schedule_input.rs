...
impl UpdateTopicRefreshScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_topic_refresh_schedule::UpdateTopicRefreshScheduleInput, ::aws_smithy_http::operation::error::BuildError> {
