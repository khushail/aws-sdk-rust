...
pub use crate::operation::put_data_set_refresh_properties::_put_data_set_refresh_properties_output::PutDataSetRefreshPropertiesOutputBuilder;
...
pub struct PutDataSetRefreshPropertiesFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::put_data_set_refresh_properties::builders::PutDataSetRefreshPropertiesInputBuilder,
}
impl PutDataSetRefreshPropertiesFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::put_data_set_refresh_properties::PutDataSetRefreshProperties, ::aws_http::retry::AwsResponseRetryClassifier,>,
                            ::aws_smithy_http::result::SdkError<crate::operation::put_data_set_refresh_properties::PutDataSetRefreshPropertiesError>
                        >  {
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::put_data_set_refresh_properties::PutDataSetRefreshPropertiesOutput, ::aws_smithy_http::result::SdkError<crate::operation::put_data_set_refresh_properties::PutDataSetRefreshPropertiesError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::put_data_set_refresh_properties::PutDataSetRefreshPropertiesOutput, ::aws_smithy_http::result::SdkError<crate::operation::put_data_set_refresh_properties::PutDataSetRefreshPropertiesError>>
                             {
    ...
    pub fn data_set_refresh_properties(mut self, input: crate::types::DataSetRefreshProperties) -> Self {
        self.inner = self.inner.data_set_refresh_properties(input);
        self
    }
    /// <p>The dataset refresh properties.</p>
