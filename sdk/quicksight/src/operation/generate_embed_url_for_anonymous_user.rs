...
impl GenerateEmbedUrlForAnonymousUserInput {
    /// Consumes the builder and constructs an Operation<[`GenerateEmbedUrlForAnonymousUser`](crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUser, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/embed-url/anonymous-user", AwsAccountId = aws_account_id).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_generate_embed_url_for_anonymous_user::ser_generate_embed_url_for_anonymous_user_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUser::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GenerateEmbedUrlForAnonymousUser", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateEmbedUrlForAnonymousUser {
                type Output = ::std::result::Result<crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUserOutput, crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUserError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_generate_embed_url_for_anonymous_user::de_generate_embed_url_for_anonymous_user_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_generate_embed_url_for_anonymous_user::de_generate_embed_url_for_anonymous_user_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GenerateEmbedUrlForAnonymousUserErrorKind = GenerateEmbedUrlForAnonymousUserError;
/// Error type for the `GenerateEmbedUrlForAnonymousUserError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GenerateEmbedUrlForAnonymousUserError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GenerateEmbedUrlForAnonymousUserError {
...
impl ::aws_http::request_id::RequestId for crate::operation::generate_embed_url_for_anonymous_user::GenerateEmbedUrlForAnonymousUserError {
...
impl GenerateEmbedUrlForAnonymousUserError {
    /// Creates the `GenerateEmbedUrlForAnonymousUserError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GenerateEmbedUrlForAnonymousUserError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GenerateEmbedUrlForAnonymousUserError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForAnonymousUserError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForAnonymousUserError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForAnonymousUserError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForAnonymousUserError::SessionLifetimeInMinutesInvalidException`.
    ...
    /// Returns `true` if the error kind is `GenerateEmbedUrlForAnonymousUserError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForAnonymousUserError::UnsupportedPricingPlanException`.
    pub fn is_unsupported_pricing_plan_exception(&self) -> bool {
        matches!(self, Self::UnsupportedPricingPlanException(_))
    }
    /// Returns `true` if the error kind is `GenerateEmbedUrlForAnonymousUserError::UnsupportedUserEditionException`.
...
mod _generate_embed_url_for_anonymous_user_output;
