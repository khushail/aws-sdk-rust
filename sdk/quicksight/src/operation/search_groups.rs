...
impl SearchGroupsInput {
    /// Consumes the builder and constructs an Operation<[`SearchGroups`](crate::operation::search_groups::SearchGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_groups::SearchGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_groups::SearchGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/namespaces/{Namespace}/groups-search", AwsAccountId = aws_account_id, Namespace = namespace).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::search_groups::SearchGroupsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_search_groups::ser_search_groups_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_groups::SearchGroups::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchGroups", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchGroups {
                type Output = ::std::result::Result<crate::operation::search_groups::SearchGroupsOutput, crate::operation::search_groups::SearchGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_search_groups::de_search_groups_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type SearchGroupsErrorKind = SearchGroupsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::search_groups::SearchGroupsError {
...
impl SearchGroupsError {
    /// Creates the `SearchGroupsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SearchGroupsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `SearchGroupsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `SearchGroupsError::InvalidNextTokenException`.
    pub fn is_invalid_next_token_exception(&self) -> bool {
        matches!(self, Self::InvalidNextTokenException(_))
    }
    /// Returns `true` if the error kind is `SearchGroupsError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `SearchGroupsError::PreconditionNotMetException`.
    pub fn is_precondition_not_met_exception(&self) -> bool {
        matches!(self, Self::PreconditionNotMetException(_))
    }
    /// Returns `true` if the error kind is `SearchGroupsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `SearchGroupsError::ResourceUnavailableException`.
