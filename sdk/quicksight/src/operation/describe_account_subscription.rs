...
impl DescribeAccountSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAccountSubscription`](crate::operation::describe_account_subscription::DescribeAccountSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_account_subscription::DescribeAccountSubscription, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_account_subscription::DescribeAccountSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_account_subscription::DescribeAccountSubscriptionInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_account_subscription::DescribeAccountSubscription::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAccountSubscription", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAccountSubscription {
                type Output = ::std::result::Result<crate::operation::describe_account_subscription::DescribeAccountSubscriptionOutput, crate::operation::describe_account_subscription::DescribeAccountSubscriptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_account_subscription::de_describe_account_subscription_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_account_subscription::de_describe_account_subscription_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeAccountSubscriptionErrorKind = DescribeAccountSubscriptionError;
/// Error type for the `DescribeAccountSubscriptionError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DescribeAccountSubscriptionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeAccountSubscriptionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_account_subscription::DescribeAccountSubscriptionError {
...
impl DescribeAccountSubscriptionError {
    /// Creates the `DescribeAccountSubscriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAccountSubscriptionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeAccountSubscriptionError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountSubscriptionError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountSubscriptionError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountSubscriptionError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountSubscriptionError::ResourceUnavailableException`.
    pub fn is_resource_unavailable_exception(&self) -> bool {
        matches!(self, Self::ResourceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountSubscriptionError::ThrottlingException`.
...
mod _describe_account_subscription_output;
