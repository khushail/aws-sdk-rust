...
impl ListThemeVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListThemeVersions`](crate::operation::list_theme_versions::ListThemeVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_theme_versions::ListThemeVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_theme_versions::ListThemeVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/themes/{ThemeId}/versions", AwsAccountId = aws_account_id, ThemeId = theme_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_theme_versions::ListThemeVersionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_theme_versions::ListThemeVersionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_theme_versions::ListThemeVersions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListThemeVersions", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListThemeVersions {
                type Output = ::std::result::Result<crate::operation::list_theme_versions::ListThemeVersionsOutput, crate::operation::list_theme_versions::ListThemeVersionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_theme_versions::de_list_theme_versions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_theme_versions::de_list_theme_versions_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListThemeVersionsErrorKind = ListThemeVersionsError;
/// Error type for the `ListThemeVersionsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListThemeVersionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_theme_versions::ListThemeVersionsError {
...
impl ListThemeVersionsError {
    /// Creates the `ListThemeVersionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListThemeVersionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListThemeVersionsError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListThemeVersionsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ListThemeVersionsError::InvalidNextTokenException`.
    pub fn is_invalid_next_token_exception(&self) -> bool {
        matches!(self, Self::InvalidNextTokenException(_))
    }
    /// Returns `true` if the error kind is `ListThemeVersionsError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `ListThemeVersionsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListThemeVersionsError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `ListThemeVersionsError::UnsupportedUserEditionException`.
...
mod _list_theme_versions_output;
