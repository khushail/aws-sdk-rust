    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_templates::ListTemplates, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_templates::ListTemplatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/templates", AwsAccountId = aws_account_id).expect("formatting should succeed");
            ...
            fn uri_query(_input: &crate::operation::list_templates::ListTemplatesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.max_results {
                    if *inner_3 != 0 {
                        query.push_kv("max-result", ::aws_smithy_types::primitive::Encoder::from(*inner_3).encode());
                    }
                }
                ::std::result::Result::Ok(())
            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_templates::ListTemplates::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListTemplates", "quicksight"));
...
impl ListTemplatesError {
    ...
    /// Returns `true` if the error kind is `ListTemplatesError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `ListTemplatesError::InvalidNextTokenException`.
    pub fn is_invalid_next_token_exception(&self) -> bool {
        matches!(self, Self::InvalidNextTokenException(_))
    }
    /// Returns `true` if the error kind is `ListTemplatesError::InvalidParameterValueException`.
    ...
    /// Returns `true` if the error kind is `ListTemplatesError::UnsupportedUserEditionException`.
