...
impl DeleteAccountCustomizationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAccountCustomization`](crate::operation::delete_account_customization::DeleteAccountCustomization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_account_customization::DeleteAccountCustomization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_account_customization::DeleteAccountCustomizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_account_customization::DeleteAccountCustomizationInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_account_customization::DeleteAccountCustomizationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_account_customization::DeleteAccountCustomization::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAccountCustomization", "quicksight"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteAccountCustomization`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccountCustomization {
                type Output = ::std::result::Result<crate::operation::delete_account_customization::DeleteAccountCustomizationOutput, crate::operation::delete_account_customization::DeleteAccountCustomizationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_account_customization::de_delete_account_customization_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_account_customization::de_delete_account_customization_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteAccountCustomizationErrorKind = DeleteAccountCustomizationError;
/// Error type for the `DeleteAccountCustomizationError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteAccountCustomizationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_account_customization::DeleteAccountCustomizationError {
...
impl DeleteAccountCustomizationError {
    /// Creates the `DeleteAccountCustomizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteAccountCustomizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteAccountCustomizationError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccountCustomizationError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccountCustomizationError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccountCustomizationError::InvalidParameterValueException`.
    ...
    /// Returns `true` if the error kind is `DeleteAccountCustomizationError::ResourceUnavailableException`.
    pub fn is_resource_unavailable_exception(&self) -> bool {
        matches!(self, Self::ResourceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `DeleteAccountCustomizationError::ThrottlingException`.
...
mod _delete_account_customization_output;
