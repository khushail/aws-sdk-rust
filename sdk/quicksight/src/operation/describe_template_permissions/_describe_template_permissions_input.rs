...
impl DescribeTemplatePermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_template_permissions::DescribeTemplatePermissionsInput, ::aws_smithy_http::operation::error::BuildError> {
