...
impl UpdateIamPolicyAssignmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_iam_policy_assignment::UpdateIamPolicyAssignmentInput, ::aws_smithy_http::operation::error::BuildError> {
