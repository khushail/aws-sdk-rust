...
impl UpdateTemplatePermissionsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTemplatePermissions`](crate::operation::update_template_permissions::UpdateTemplatePermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_template_permissions::UpdateTemplatePermissions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_template_permissions::UpdateTemplatePermissionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if template_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("template_id", "cannot be empty or unset"))
                            }
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_template_permissions::ser_update_template_permissions_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_template_permissions::UpdateTemplatePermissions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateTemplatePermissions", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTemplatePermissions {
                type Output = ::std::result::Result<crate::operation::update_template_permissions::UpdateTemplatePermissionsOutput, crate::operation::update_template_permissions::UpdateTemplatePermissionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_template_permissions::de_update_template_permissions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_template_permissions::de_update_template_permissions_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateTemplatePermissionsErrorKind = UpdateTemplatePermissionsError;
/// Error type for the `UpdateTemplatePermissionsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateTemplatePermissionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_template_permissions::UpdateTemplatePermissionsError {
...
impl UpdateTemplatePermissionsError {
    /// Creates the `UpdateTemplatePermissionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateTemplatePermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateTemplatePermissionsError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplatePermissionsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplatePermissionsError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplatePermissionsError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplatePermissionsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplatePermissionsError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplatePermissionsError::UnsupportedUserEditionException`.
...
mod _update_template_permissions_output;
