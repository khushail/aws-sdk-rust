...
pub use crate::operation::describe_topic_permissions::_describe_topic_permissions_output::DescribeTopicPermissionsOutputBuilder;

pub use crate::operation::describe_topic_permissions::_describe_topic_permissions_input::DescribeTopicPermissionsInputBuilder;
...
impl DescribeTopicPermissionsInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.describe_topic_permissions();
                        fluent_builder.inner = self;
                        fluent_builder.send().await
                    }
}
/// Fluent builder constructing a request to `DescribeTopicPermissions`.
/// 
...
impl DescribeTopicPermissionsFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::describe_topic_permissions::DescribeTopicPermissions, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::describe_topic_permissions::DescribeTopicPermissionsOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_topic_permissions::DescribeTopicPermissionsError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::describe_topic_permissions::DescribeTopicPermissionsOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_topic_permissions::DescribeTopicPermissionsError>>
                             {
