...
impl StartAssetBundleExportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_asset_bundle_export_job::StartAssetBundleExportJobInput, ::aws_smithy_http::operation::error::BuildError> {
