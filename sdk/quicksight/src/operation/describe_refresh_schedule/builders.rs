...
impl DescribeRefreshScheduleInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.describe_refresh_schedule();
...
pub struct DescribeRefreshScheduleFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::describe_refresh_schedule::builders::DescribeRefreshScheduleInputBuilder,
}
impl DescribeRefreshScheduleFluentBuilder  {
    ...
    pub fn as_input(&self) -> &crate::operation::describe_refresh_schedule::builders::DescribeRefreshScheduleInputBuilder {
        &self.inner
    }
    // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::describe_refresh_schedule::DescribeRefreshSchedule, ::aws_http::retry::AwsResponseRetryClassifier,>,
                            ::aws_smithy_http::result::SdkError<crate::operation::describe_refresh_schedule::DescribeRefreshScheduleError>
                        >  {
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::describe_refresh_schedule::DescribeRefreshScheduleOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_refresh_schedule::DescribeRefreshScheduleError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::describe_refresh_schedule::DescribeRefreshScheduleOutput, ::aws_smithy_http::result::SdkError<crate::operation::describe_refresh_schedule::DescribeRefreshScheduleError>>
                             {
