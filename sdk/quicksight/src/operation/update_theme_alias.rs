...
impl UpdateThemeAliasInput {
    /// Consumes the builder and constructs an Operation<[`UpdateThemeAlias`](crate::operation::update_theme_alias::UpdateThemeAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_theme_alias::UpdateThemeAlias, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_theme_alias::UpdateThemeAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_theme_alias::ser_update_theme_alias_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_theme_alias::UpdateThemeAlias::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateThemeAlias", "quicksight"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateThemeAlias`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateThemeAlias {
                type Output = ::std::result::Result<crate::operation::update_theme_alias::UpdateThemeAliasOutput, crate::operation::update_theme_alias::UpdateThemeAliasError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_theme_alias::de_update_theme_alias_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_theme_alias::de_update_theme_alias_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateThemeAliasErrorKind = UpdateThemeAliasError;
/// Error type for the `UpdateThemeAliasError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateThemeAliasError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_theme_alias::UpdateThemeAliasError {
...
impl UpdateThemeAliasError {
    /// Creates the `UpdateThemeAliasError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateThemeAliasError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateThemeAliasError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `UpdateThemeAliasError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `UpdateThemeAliasError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `UpdateThemeAliasError::ResourceExistsException`.
    pub fn is_resource_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceExistsException(_))
    }
    /// Returns `true` if the error kind is `UpdateThemeAliasError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateThemeAliasError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `UpdateThemeAliasError::UnsupportedUserEditionException`.
...
mod _update_theme_alias_output;
