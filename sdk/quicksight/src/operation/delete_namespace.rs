...
impl DeleteNamespaceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteNamespace`](crate::operation::delete_namespace::DeleteNamespace)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_namespace::DeleteNamespace, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_namespace::DeleteNamespaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/namespaces/{Namespace}", AwsAccountId = aws_account_id, Namespace = namespace).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_namespace::DeleteNamespace::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteNamespace", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteNamespace {
                type Output = ::std::result::Result<crate::operation::delete_namespace::DeleteNamespaceOutput, crate::operation::delete_namespace::DeleteNamespaceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_namespace::de_delete_namespace_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_namespace::DeleteNamespaceError {
...
impl DeleteNamespaceError {
    ...
    /// Returns `true` if the error kind is `DeleteNamespaceError::AccessDeniedException`.
    ...
    /// Returns `true` if the error kind is `DeleteNamespaceError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `DeleteNamespaceError::PreconditionNotMetException`.
    ...
    /// Returns `true` if the error kind is `DeleteNamespaceError::ResourceUnavailableException`.
