...
impl DescribeAnalysisPermissionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAnalysisPermissions`](crate::operation::describe_analysis_permissions::DescribeAnalysisPermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_analysis_permissions::DescribeAnalysisPermissions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_analysis_permissions::DescribeAnalysisPermissionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_analysis_permissions::DescribeAnalysisPermissionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_analysis_permissions::DescribeAnalysisPermissions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAnalysisPermissions", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAnalysisPermissions {
                type Output = ::std::result::Result<crate::operation::describe_analysis_permissions::DescribeAnalysisPermissionsOutput, crate::operation::describe_analysis_permissions::DescribeAnalysisPermissionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_analysis_permissions::de_describe_analysis_permissions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_analysis_permissions::de_describe_analysis_permissions_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeAnalysisPermissionsErrorKind = DescribeAnalysisPermissionsError;
/// Error type for the `DescribeAnalysisPermissionsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeAnalysisPermissionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_analysis_permissions::DescribeAnalysisPermissionsError {
...
impl DescribeAnalysisPermissionsError {
    /// Creates the `DescribeAnalysisPermissionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAnalysisPermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeAnalysisPermissionsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DescribeAnalysisPermissionsError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `DescribeAnalysisPermissionsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeAnalysisPermissionsError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `DescribeAnalysisPermissionsError::UnsupportedUserEditionException`.
...
mod _describe_analysis_permissions_output;
