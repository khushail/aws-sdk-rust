...
impl CreateTopicRefreshScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_topic_refresh_schedule::CreateTopicRefreshScheduleInput, ::aws_smithy_http::operation::error::BuildError> {
