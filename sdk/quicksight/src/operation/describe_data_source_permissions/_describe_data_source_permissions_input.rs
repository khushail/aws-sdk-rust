...
impl DescribeDataSourcePermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_data_source_permissions::DescribeDataSourcePermissionsInput, ::aws_smithy_http::operation::error::BuildError> {
