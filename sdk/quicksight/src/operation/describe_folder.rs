...
impl DescribeFolderInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFolder`](crate::operation::describe_folder::DescribeFolder)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_folder::DescribeFolder, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_folder::DescribeFolderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_folder::DescribeFolder::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeFolder", "quicksight"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFolder {
                type Output = ::std::result::Result<crate::operation::describe_folder::DescribeFolderOutput, crate::operation::describe_folder::DescribeFolderError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_folder::de_describe_folder_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeFolderErrorKind = DescribeFolderError;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_folder::DescribeFolderError {
...
impl DescribeFolderError {
    /// Creates the `DescribeFolderError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeFolderError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
