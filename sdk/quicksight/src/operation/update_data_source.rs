...
impl UpdateDataSourceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_data_source::UpdateDataSource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_data_source::UpdateDataSourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if data_source_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("data_source_id", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_data_source::UpdateDataSource::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDataSource", "quicksight"));
...
impl UpdateDataSourceError {
    ...
    /// Returns `true` if the error kind is `UpdateDataSourceError::InvalidParameterValueException`.
