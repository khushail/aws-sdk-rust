...
impl ListIamPolicyAssignmentsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_iam_policy_assignments::ListIamPolicyAssignmentsInput, ::aws_smithy_http::operation::error::BuildError> {
