...
impl DescribeAssetBundleExportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_asset_bundle_export_job::DescribeAssetBundleExportJobInput, ::aws_smithy_http::operation::error::BuildError> {
