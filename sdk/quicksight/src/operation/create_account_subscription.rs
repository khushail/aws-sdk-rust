...
impl CreateAccountSubscriptionInput {
    /// Consumes the builder and constructs an Operation<[`CreateAccountSubscription`](crate::operation::create_account_subscription::CreateAccountSubscription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_account_subscription::CreateAccountSubscription, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_account_subscription::CreateAccountSubscriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_account_subscription::ser_create_account_subscription_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_account_subscription::CreateAccountSubscription::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAccountSubscription", "quicksight"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateAccountSubscription`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAccountSubscription {
                type Output = ::std::result::Result<crate::operation::create_account_subscription::CreateAccountSubscriptionOutput, crate::operation::create_account_subscription::CreateAccountSubscriptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_account_subscription::de_create_account_subscription_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_account_subscription::de_create_account_subscription_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateAccountSubscriptionErrorKind = CreateAccountSubscriptionError;
/// Error type for the `CreateAccountSubscriptionError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateAccountSubscriptionError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateAccountSubscriptionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_account_subscription::CreateAccountSubscriptionError {
...
impl CreateAccountSubscriptionError {
    /// Creates the `CreateAccountSubscriptionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateAccountSubscriptionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateAccountSubscriptionError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountSubscriptionError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountSubscriptionError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountSubscriptionError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountSubscriptionError::PreconditionNotMetException`.
    pub fn is_precondition_not_met_exception(&self) -> bool {
        matches!(self, Self::PreconditionNotMetException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountSubscriptionError::ResourceExistsException`.
    pub fn is_resource_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountSubscriptionError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountSubscriptionError::ResourceUnavailableException`.
    pub fn is_resource_unavailable_exception(&self) -> bool {
        matches!(self, Self::ResourceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountSubscriptionError::ThrottlingException`.
...
mod _create_account_subscription_output;
