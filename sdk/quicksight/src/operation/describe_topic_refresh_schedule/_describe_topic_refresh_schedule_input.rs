...
impl DescribeTopicRefreshScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_topic_refresh_schedule::DescribeTopicRefreshScheduleInput, ::aws_smithy_http::operation::error::BuildError> {
