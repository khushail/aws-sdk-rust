...
impl UpdateAnalysisPermissionsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAnalysisPermissions`](crate::operation::update_analysis_permissions::UpdateAnalysisPermissions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_analysis_permissions::UpdateAnalysisPermissions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_analysis_permissions::UpdateAnalysisPermissionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/accounts/{AwsAccountId}/analyses/{AnalysisId}/permissions", AwsAccountId = aws_account_id, AnalysisId = analysis_id).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_analysis_permissions::ser_update_analysis_permissions_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_analysis_permissions::UpdateAnalysisPermissions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateAnalysisPermissions", "quicksight"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateAnalysisPermissions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAnalysisPermissions {
                type Output = ::std::result::Result<crate::operation::update_analysis_permissions::UpdateAnalysisPermissionsOutput, crate::operation::update_analysis_permissions::UpdateAnalysisPermissionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_analysis_permissions::de_update_analysis_permissions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_analysis_permissions::de_update_analysis_permissions_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateAnalysisPermissionsErrorKind = UpdateAnalysisPermissionsError;
/// Error type for the `UpdateAnalysisPermissionsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateAnalysisPermissionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_analysis_permissions::UpdateAnalysisPermissionsError {
...
impl UpdateAnalysisPermissionsError {
    /// Creates the `UpdateAnalysisPermissionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateAnalysisPermissionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateAnalysisPermissionsError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `UpdateAnalysisPermissionsError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `UpdateAnalysisPermissionsError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `UpdateAnalysisPermissionsError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `UpdateAnalysisPermissionsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateAnalysisPermissionsError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `UpdateAnalysisPermissionsError::UnsupportedUserEditionException`.
...
mod _update_analysis_permissions_output;
