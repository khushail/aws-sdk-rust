...
impl DescribeAccountCustomizationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAccountCustomization`](crate::operation::describe_account_customization::DescribeAccountCustomization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_account_customization::DescribeAccountCustomization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_account_customization::DescribeAccountCustomizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_account_customization::DescribeAccountCustomizationInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_account_customization::DescribeAccountCustomizationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_account_customization::DescribeAccountCustomization::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAccountCustomization", "quicksight"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeAccountCustomization`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAccountCustomization {
                type Output = ::std::result::Result<crate::operation::describe_account_customization::DescribeAccountCustomizationOutput, crate::operation::describe_account_customization::DescribeAccountCustomizationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_account_customization::de_describe_account_customization_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_account_customization::de_describe_account_customization_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeAccountCustomizationErrorKind = DescribeAccountCustomizationError;
/// Error type for the `DescribeAccountCustomizationError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeAccountCustomizationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_account_customization::DescribeAccountCustomizationError {
...
impl DescribeAccountCustomizationError {
    /// Creates the `DescribeAccountCustomizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeAccountCustomizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeAccountCustomizationError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountCustomizationError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountCustomizationError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountCustomizationError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountCustomizationError::ResourceUnavailableException`.
    pub fn is_resource_unavailable_exception(&self) -> bool {
        matches!(self, Self::ResourceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `DescribeAccountCustomizationError::ThrottlingException`.
...
mod _describe_account_customization_output;
