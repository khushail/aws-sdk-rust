...
impl CreateAccountCustomizationInput {
    /// Consumes the builder and constructs an Operation<[`CreateAccountCustomization`](crate::operation::create_account_customization::CreateAccountCustomization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_account_customization::CreateAccountCustomization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_account_customization::CreateAccountCustomizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_account_customization::CreateAccountCustomizationInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_account_customization::ser_create_account_customization_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_account_customization::CreateAccountCustomization::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAccountCustomization", "quicksight"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateAccountCustomization`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAccountCustomization {
                type Output = ::std::result::Result<crate::operation::create_account_customization::CreateAccountCustomizationOutput, crate::operation::create_account_customization::CreateAccountCustomizationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_account_customization::de_create_account_customization_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_account_customization::de_create_account_customization_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateAccountCustomizationErrorKind = CreateAccountCustomizationError;
/// Error type for the `CreateAccountCustomizationError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateAccountCustomizationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_account_customization::CreateAccountCustomizationError {
...
impl CreateAccountCustomizationError {
    /// Creates the `CreateAccountCustomizationError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateAccountCustomizationError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateAccountCustomizationError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountCustomizationError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountCustomizationError::InternalFailureException`.
    pub fn is_internal_failure_exception(&self) -> bool {
        matches!(self, Self::InternalFailureException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountCustomizationError::InvalidParameterValueException`.
    pub fn is_invalid_parameter_value_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterValueException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountCustomizationError::ResourceExistsException`.
    pub fn is_resource_exists_exception(&self) -> bool {
        matches!(self, Self::ResourceExistsException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountCustomizationError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountCustomizationError::ResourceUnavailableException`.
    pub fn is_resource_unavailable_exception(&self) -> bool {
        matches!(self, Self::ResourceUnavailableException(_))
    }
    /// Returns `true` if the error kind is `CreateAccountCustomizationError::ThrottlingException`.
...
mod _create_account_customization_output;
