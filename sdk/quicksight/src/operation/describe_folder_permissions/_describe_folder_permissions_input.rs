...
impl DescribeFolderPermissionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_folder_permissions::DescribeFolderPermissionsInput, ::aws_smithy_http::operation::error::BuildError> {
