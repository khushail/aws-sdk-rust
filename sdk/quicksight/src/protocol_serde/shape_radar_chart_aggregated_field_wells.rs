...
pub fn ser_radar_chart_aggregated_field_wells(
    ...
    if let Some(var_5) = &input.color {
        let mut array_6 = object.key("Color").start_array();
        for item_7 in var_5 {
             {
                #[allow(unused_mut)]
...
pub(crate) fn de_radar_chart_aggregated_field_wells<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RadarChartAggregatedFieldWells>, ::aws_smithy_json::deserialize::error::DeserializeError>
