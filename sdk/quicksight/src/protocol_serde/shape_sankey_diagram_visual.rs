...
pub fn ser_sankey_diagram_visual(
                     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                     input: &crate::types::SankeyDiagramVisual,
    ...
    if let Some(var_6) = &input.chart_configuration {
        ...
        crate::protocol_serde::shape_sankey_diagram_chart_configuration::ser_sankey_diagram_chart_configuration(&mut object_7, var_6)?;
        object_7.finish();
    }
...
pub(crate) fn de_sankey_diagram_visual<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::SankeyDiagramVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::SankeyDiagramVisualBuilder::default();
            loop {
                match tokens.next().transpose()? {
