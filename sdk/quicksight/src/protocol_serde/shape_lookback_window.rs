...
pub(crate) fn de_lookback_window<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::LookbackWindow>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "SizeUnit" => {
                                builder = builder.set_size_unit(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::LookbackWindowSizeUnit::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
