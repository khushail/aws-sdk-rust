...
pub fn ser_pie_chart_sort_configuration(
                     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                     input: &crate::types::PieChartSortConfiguration,
    ...
    if let Some(var_7) = &input.small_multiples_sort {
        let mut array_8 = object.key("SmallMultiplesSort").start_array();
        for item_9 in var_7 {
             {
                #[allow(unused_mut)]
    ...
    if let Some(var_11) = &input.small_multiples_limit_configuration {
        #[allow(unused_mut)]
        let mut object_12 = object.key("SmallMultiplesLimitConfiguration").start_object();
...
pub(crate) fn de_pie_chart_sort_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PieChartSortConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::PieChartSortConfigurationBuilder::default();
            loop {
                match tokens.next().transpose()? {
