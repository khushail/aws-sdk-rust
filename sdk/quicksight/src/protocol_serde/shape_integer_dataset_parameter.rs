...
pub(crate) fn de_integer_dataset_parameter<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::IntegerDatasetParameter>, ::aws_smithy_json::deserialize::error::DeserializeError>
