...
pub(crate) fn de_header_footer_section_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::HeaderFooterSectionConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
