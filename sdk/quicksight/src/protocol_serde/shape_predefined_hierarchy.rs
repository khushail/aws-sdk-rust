...
pub(crate) fn de_predefined_hierarchy<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::PredefinedHierarchy>, ::aws_smithy_json::deserialize::error::DeserializeError>
