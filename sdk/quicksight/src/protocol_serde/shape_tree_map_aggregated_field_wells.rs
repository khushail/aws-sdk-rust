...
pub fn ser_tree_map_aggregated_field_wells(
...
pub(crate) fn de_tree_map_aggregated_field_wells<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::TreeMapAggregatedFieldWells>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::TreeMapAggregatedFieldWellsBuilder::default();
            loop {
                match tokens.next().transpose()? {
