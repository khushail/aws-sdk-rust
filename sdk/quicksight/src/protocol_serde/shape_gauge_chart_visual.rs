...
pub fn ser_gauge_chart_visual(
                     object: &mut ::aws_smithy_json::serialize::JsonObjectWriter,
                     input: &crate::types::GaugeChartVisual,
    ...
    if let Some(var_8) = &input.conditional_formatting {
        ...
        crate::protocol_serde::shape_gauge_chart_conditional_formatting::ser_gauge_chart_conditional_formatting(&mut object_9, var_8)?;
        object_9.finish();
    }
...
pub(crate) fn de_gauge_chart_visual<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::GaugeChartVisual>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::GaugeChartVisualBuilder::default();
            loop {
                match tokens.next().transpose()? {
