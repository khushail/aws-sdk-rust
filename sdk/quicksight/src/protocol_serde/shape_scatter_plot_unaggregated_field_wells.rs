...
pub fn ser_scatter_plot_unaggregated_field_wells(
    ...
    if let Some(var_9) = &input.size {
        let mut array_10 = object.key("Size").start_array();
...
pub(crate) fn de_scatter_plot_unaggregated_field_wells<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ScatterPlotUnaggregatedFieldWells>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::ScatterPlotUnaggregatedFieldWellsBuilder::default();
            loop {
                match tokens.next().transpose()? {
