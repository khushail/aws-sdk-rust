...
pub fn de_describe_topic_refresh_schedule_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_topic_refresh_schedule::DescribeTopicRefreshScheduleOutput, crate::operation::describe_topic_refresh_schedule::DescribeTopicRefreshScheduleError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_topic_refresh_schedule_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_topic_refresh_schedule::DescribeTopicRefreshScheduleOutput, crate::operation::describe_topic_refresh_schedule::DescribeTopicRefreshScheduleError> {
    Ok({
        #[allow(unused_mut)]
