...
pub(crate) fn de_redshift_parameters<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RedshiftParameters>, ::aws_smithy_json::deserialize::error::DeserializeError>
