...
impl CreateRecordingConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_recording_configuration::CreateRecordingConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
