...
impl DeleteRecordingConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_recording_configuration::DeleteRecordingConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
