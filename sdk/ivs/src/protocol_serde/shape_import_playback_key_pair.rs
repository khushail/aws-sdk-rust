...
pub fn ser_import_playback_key_pair_input(input: &crate::operation::import_playback_key_pair::ImportPlaybackKeyPairInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_import_playback_key_pair_input::ser_import_playback_key_pair_input(&mut object, input)?;
    object.finish();
...
pub fn de_import_playback_key_pair_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::import_playback_key_pair::ImportPlaybackKeyPairOutput, crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "AccessDeniedException" => crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::AccessDeniedException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ConflictException" => crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::ConflictException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "PendingVerification" => crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::PendingVerification({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ServiceQuotaExceededException" => crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::ServiceQuotaExceededException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ValidationException" => crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::ValidationException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_import_playback_key_pair_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::import_playback_key_pair::ImportPlaybackKeyPairOutput, crate::operation::import_playback_key_pair::ImportPlaybackKeyPairError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_import_playback_key_pair(value: &[u8], mut builder: crate::operation::import_playback_key_pair::builders::ImportPlaybackKeyPairOutputBuilder) -> Result<crate::operation::import_playback_key_pair::builders::ImportPlaybackKeyPairOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
