...
impl super::Client  {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::list_stream_keys::builders::ListStreamKeysFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::list_stream_keys::builders::ListStreamKeysFluentBuilder::set_channel_arn): <p>Channel ARN used to filter the list.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_stream_keys::builders::ListStreamKeysFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_stream_keys::builders::ListStreamKeysFluentBuilder::set_next_token): <p>The first stream key to retrieve. This is used for pagination; see the <code>nextToken</code> response field.</p>
