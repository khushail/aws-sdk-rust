...
impl super::Client  {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::get_stream::builders::GetStreamFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::get_stream::builders::GetStreamFluentBuilder::set_channel_arn): <p>Channel ARN for stream to be accessed.</p>
