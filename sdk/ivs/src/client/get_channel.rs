...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::get_channel::builders::GetChannelFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::get_channel::builders::GetChannelFluentBuilder::set_arn): <p>ARN of the channel for which the configuration is to be retrieved.</p>
