...
impl super::Client  {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::list_stream_sessions::builders::ListStreamSessionsFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::list_stream_sessions::builders::ListStreamSessionsFluentBuilder::set_channel_arn): <p>Channel ARN used to filter the list.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_stream_sessions::builders::ListStreamSessionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_stream_sessions::builders::ListStreamSessionsFluentBuilder::set_next_token): <p>The first stream to retrieve. This is used for pagination; see the <code>nextToken</code> response field.</p>
