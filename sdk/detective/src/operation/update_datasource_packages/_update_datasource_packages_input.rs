...
impl UpdateDatasourcePackagesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_datasource_packages::UpdateDatasourcePackagesInput, ::aws_smithy_http::operation::error::BuildError> {
