...
impl BatchGetMembershipDatasourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_get_membership_datasources::BatchGetMembershipDatasourcesInput, ::aws_smithy_http::operation::error::BuildError> {
