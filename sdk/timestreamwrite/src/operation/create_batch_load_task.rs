...
impl CreateBatchLoadTaskInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_batch_load_task::CreateBatchLoadTask, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_batch_load_task::CreateBatchLoadTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_batch_load_task::ser_create_batch_load_task_input(&self)?
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBatchLoadTask {
                type Output = ::std::result::Result<crate::operation::create_batch_load_task::CreateBatchLoadTaskOutput, crate::operation::create_batch_load_task::CreateBatchLoadTaskError>;
