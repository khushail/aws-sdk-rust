...
impl ListDatabasesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_databases::ListDatabases, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_databases::ListDatabasesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_databases::ListDatabases::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDatabases", "timestreamwrite"));
...
impl ListDatabasesError {
    ...
    /// Returns `true` if the error kind is `ListDatabasesError::AccessDeniedException`.
    ...
    /// Returns `true` if the error kind is `ListDatabasesError::InvalidEndpointException`.
    pub fn is_invalid_endpoint_exception(&self) -> bool {
        matches!(self, Self::InvalidEndpointException(_))
    }
    /// Returns `true` if the error kind is `ListDatabasesError::ThrottlingException`.
