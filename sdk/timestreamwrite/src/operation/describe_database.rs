...
impl DescribeDatabaseInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDatabase`](crate::operation::describe_database::DescribeDatabase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_database::DescribeDatabase, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_database::DescribeDatabaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_database::ser_describe_database_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_database::DescribeDatabase::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDatabase", "timestreamwrite"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDatabase {
                type Output = ::std::result::Result<crate::operation::describe_database::DescribeDatabaseOutput, crate::operation::describe_database::DescribeDatabaseError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_database::de_describe_database_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeDatabaseErrorKind = DescribeDatabaseError;
/// Error type for the `DescribeDatabaseError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeDatabaseError {
...
impl ::std::fmt::Display for DescribeDatabaseError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeDatabaseError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_database::DescribeDatabaseError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for DescribeDatabaseError {
...
impl DescribeDatabaseError {
    /// Creates the `DescribeDatabaseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DescribeDatabaseError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DescribeDatabaseError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DescribeDatabaseError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `DescribeDatabaseError::InvalidEndpointException`.
    pub fn is_invalid_endpoint_exception(&self) -> bool {
        matches!(self, Self::InvalidEndpointException(_))
    }
    /// Returns `true` if the error kind is `DescribeDatabaseError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DescribeDatabaseError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `DescribeDatabaseError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for DescribeDatabaseError {
