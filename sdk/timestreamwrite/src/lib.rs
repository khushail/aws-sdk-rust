...
async fn resolve_endpoint(client: &crate::Client) -> Result<(::aws_smithy_types::endpoint::Endpoint, ::std::time::SystemTime), ::aws_smithy_http::endpoint::ResolveEndpointError> {
                    let describe_endpoints =
                        client.describe_endpoints().send().await.map_err(|e| {
                            ::aws_smithy_http::endpoint::ResolveEndpointError::from_source("failed to call describe_endpoints", e)
                        })?;
                ...
                impl Client {
                    ...
                    pub async fn enable_endpoint_discovery(self) -> ::std::result::Result<(Self, crate::endpoint_discovery::ReloadEndpoint), ::aws_smithy_http::endpoint::ResolveEndpointError> {
