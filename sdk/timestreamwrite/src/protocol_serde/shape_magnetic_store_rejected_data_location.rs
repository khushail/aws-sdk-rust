...
pub(crate) fn de_magnetic_store_rejected_data_location<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::MagneticStoreRejectedDataLocation>, ::aws_smithy_json::deserialize::error::DeserializeError>
