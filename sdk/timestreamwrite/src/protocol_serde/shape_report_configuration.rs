...
pub(crate) fn de_report_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ReportConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
