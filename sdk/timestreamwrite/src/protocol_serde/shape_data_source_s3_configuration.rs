...
pub(crate) fn de_data_source_s3_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::DataSourceS3Configuration>, ::aws_smithy_json::deserialize::error::DeserializeError>
