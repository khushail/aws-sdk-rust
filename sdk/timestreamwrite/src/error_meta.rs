...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::create_batch_load_task::CreateBatchLoadTaskError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::describe_batch_load_task::DescribeBatchLoadTaskError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::describe_database::DescribeDatabaseError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::list_batch_load_tasks::ListBatchLoadTasksError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::resume_batch_load_task::ResumeBatchLoadTaskError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::write_records::WriteRecordsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
