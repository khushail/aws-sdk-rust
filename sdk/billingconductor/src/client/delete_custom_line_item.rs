...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::delete_custom_line_item::builders::DeleteCustomLineItemFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_custom_line_item::builders::DeleteCustomLineItemFluentBuilder::set_arn): <p> The ARN of the custom line item to be deleted. </p>
