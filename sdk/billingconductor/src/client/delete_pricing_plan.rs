...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::delete_pricing_plan::builders::DeletePricingPlanFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::delete_pricing_plan::builders::DeletePricingPlanFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) of the pricing plan that you're deleting. </p>
