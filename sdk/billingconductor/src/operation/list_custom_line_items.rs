...
impl ListCustomLineItemsInput {
    /// Consumes the builder and constructs an Operation<[`ListCustomLineItems`](crate::operation::list_custom_line_items::ListCustomLineItems)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_custom_line_items::ListCustomLineItems, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_custom_line_items::ListCustomLineItemsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/list-custom-line-items").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_custom_line_items::ser_list_custom_line_items_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_custom_line_items::ListCustomLineItems::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListCustomLineItems {
                type Output = ::std::result::Result<crate::operation::list_custom_line_items::ListCustomLineItemsOutput, crate::operation::list_custom_line_items::ListCustomLineItemsError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_custom_line_items::ListCustomLineItemsError {
...
mod _list_custom_line_items_output;
