...
impl CreateMonitorInput {
    /// Consumes the builder and constructs an Operation<[`CreateMonitor`](crate::operation::create_monitor::CreateMonitor)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_monitor::CreateMonitor, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_monitor::CreateMonitorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_monitor::CreateMonitor::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateMonitor", "internetmonitor"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMonitor {
                type Output = ::std::result::Result<crate::operation::create_monitor::CreateMonitorOutput, crate::operation::create_monitor::CreateMonitorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_monitor::de_create_monitor_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_monitor::CreateMonitorError {
