...
impl PutImageTagMutabilityInput {
    /// Consumes the builder and constructs an Operation<[`PutImageTagMutability`](crate::operation::put_image_tag_mutability::PutImageTagMutability)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_image_tag_mutability::PutImageTagMutability, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_image_tag_mutability::PutImageTagMutabilityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_image_tag_mutability::ser_put_image_tag_mutability_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_image_tag_mutability::PutImageTagMutability::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutImageTagMutability", "ecr"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutImageTagMutability`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutImageTagMutability {
                type Output = ::std::result::Result<crate::operation::put_image_tag_mutability::PutImageTagMutabilityOutput, crate::operation::put_image_tag_mutability::PutImageTagMutabilityError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_image_tag_mutability::de_put_image_tag_mutability_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_image_tag_mutability::de_put_image_tag_mutability_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_image_tag_mutability::PutImageTagMutabilityError {
...
mod _put_image_tag_mutability_output;
