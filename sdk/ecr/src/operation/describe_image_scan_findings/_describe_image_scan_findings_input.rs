...
impl DescribeImageScanFindingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_image_scan_findings::DescribeImageScanFindingsInput, ::aws_smithy_http::operation::error::BuildError> {
