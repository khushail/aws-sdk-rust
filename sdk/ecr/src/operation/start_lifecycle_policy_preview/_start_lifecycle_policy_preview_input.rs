...
impl StartLifecyclePolicyPreviewInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_lifecycle_policy_preview::StartLifecyclePolicyPreviewInput, ::aws_smithy_http::operation::error::BuildError> {
