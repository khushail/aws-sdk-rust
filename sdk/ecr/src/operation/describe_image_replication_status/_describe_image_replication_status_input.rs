...
impl DescribeImageReplicationStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_image_replication_status::DescribeImageReplicationStatusInput, ::aws_smithy_http::operation::error::BuildError> {
