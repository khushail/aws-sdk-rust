...
impl CreatePullThroughCacheRuleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_pull_through_cache_rule::CreatePullThroughCacheRuleInput, ::aws_smithy_http::operation::error::BuildError> {
