...
impl StartImageScanInput {
    /// Consumes the builder and constructs an Operation<[`StartImageScan`](crate::operation::start_image_scan::StartImageScan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_image_scan::StartImageScan, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_image_scan::StartImageScanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_image_scan::ser_start_image_scan_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_image_scan::StartImageScan::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartImageScan", "ecr"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartImageScan`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartImageScan {
                type Output = ::std::result::Result<crate::operation::start_image_scan::StartImageScanOutput, crate::operation::start_image_scan::StartImageScanError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_image_scan::de_start_image_scan_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_image_scan::de_start_image_scan_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_image_scan::StartImageScanError {
