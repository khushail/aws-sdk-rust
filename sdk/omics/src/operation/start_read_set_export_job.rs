...
impl StartReadSetExportJobInput {
    /// Consumes the builder and constructs an Operation<[`StartReadSetExportJob`](crate::operation::start_read_set_export_job::StartReadSetExportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_read_set_export_job::StartReadSetExportJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_read_set_export_job::StartReadSetExportJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/sequencestore/{sequenceStoreId}/exportjob", sequenceStoreId = sequence_store_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_read_set_export_job::StartReadSetExportJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartReadSetExportJob {
                type Output = ::std::result::Result<crate::operation::start_read_set_export_job::StartReadSetExportJobOutput, crate::operation::start_read_set_export_job::StartReadSetExportJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_read_set_export_job::de_start_read_set_export_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_read_set_export_job::de_start_read_set_export_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_read_set_export_job::StartReadSetExportJobError {
...
mod _start_read_set_export_job_output;
