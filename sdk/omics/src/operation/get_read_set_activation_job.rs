...
impl GetReadSetActivationJobInput {
    /// Consumes the builder and constructs an Operation<[`GetReadSetActivationJob`](crate::operation::get_read_set_activation_job::GetReadSetActivationJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_read_set_activation_job::GetReadSetActivationJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_read_set_activation_job::GetReadSetActivationJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/sequencestore/{sequenceStoreId}/activationjob/{id}", sequenceStoreId = sequence_store_id, id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_read_set_activation_job::GetReadSetActivationJobInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_read_set_activation_job::GetReadSetActivationJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetReadSetActivationJob", "omics"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetReadSetActivationJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReadSetActivationJob {
                type Output = ::std::result::Result<crate::operation::get_read_set_activation_job::GetReadSetActivationJobOutput, crate::operation::get_read_set_activation_job::GetReadSetActivationJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_read_set_activation_job::de_get_read_set_activation_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_read_set_activation_job::de_get_read_set_activation_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_read_set_activation_job::GetReadSetActivationJobError {
...
mod _get_read_set_activation_job_output;
