...
impl UploadReadSetPartInput {
    ...
    pub async fn make_operation(self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::upload_read_set_part::UploadReadSetPart, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upload_read_set_part::UploadReadSetPartInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::upload_read_set_part::UploadReadSetPartInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                let inner_3 = &_input.part_source;
                let inner_3 = inner_3.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("part_source", "cannot be empty or unset"))?;
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_upload_read_set_part_input::ser_payload_http_payload( self.payload)?
            .into_inner()
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadReadSetPart {
                type Output = ::std::result::Result<crate::operation::upload_read_set_part::UploadReadSetPartOutput, crate::operation::upload_read_set_part::UploadReadSetPartError>;
