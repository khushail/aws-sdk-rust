...
impl CancelRunInput {
    /// Consumes the builder and constructs an Operation<[`CancelRun`](crate::operation::cancel_run::CancelRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_run::CancelRun, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_run::CancelRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/run/{id}/cancel", id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::cancel_run::CancelRunInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_run::CancelRun::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelRun", "omics"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CancelRun`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelRun {
                type Output = ::std::result::Result<crate::operation::cancel_run::CancelRunOutput, crate::operation::cancel_run::CancelRunError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        ...
                        crate::protocol_serde::shape_cancel_run::de_cancel_run_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_run::CancelRunError {
