...
impl CreateSequenceStoreInput {
    /// Consumes the builder and constructs an Operation<[`CreateSequenceStore`](crate::operation::create_sequence_store::CreateSequenceStore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_sequence_store::CreateSequenceStore, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_sequence_store::CreateSequenceStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/sequencestore").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_sequence_store::CreateSequenceStore::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSequenceStore {
                type Output = ::std::result::Result<crate::operation::create_sequence_store::CreateSequenceStoreOutput, crate::operation::create_sequence_store::CreateSequenceStoreError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_sequence_store::de_create_sequence_store_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_sequence_store::de_create_sequence_store_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_sequence_store::CreateSequenceStoreError {
...
mod _create_sequence_store_output;
