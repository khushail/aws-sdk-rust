...
impl UpdateAnnotationStoreInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAnnotationStore`](crate::operation::update_annotation_store::UpdateAnnotationStore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_annotation_store::UpdateAnnotationStore, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_annotation_store::UpdateAnnotationStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_annotation_store::UpdateAnnotationStore::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateAnnotationStore", "omics"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateAnnotationStore`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAnnotationStore {
                type Output = ::std::result::Result<crate::operation::update_annotation_store::UpdateAnnotationStoreOutput, crate::operation::update_annotation_store::UpdateAnnotationStoreError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_annotation_store::de_update_annotation_store_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_annotation_store::de_update_annotation_store_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_annotation_store::UpdateAnnotationStoreError {
...
mod _update_annotation_store_output;
