...
impl BatchDeleteReadSetInput {
    /// Consumes the builder and constructs an Operation<[`BatchDeleteReadSet`](crate::operation::batch_delete_read_set::BatchDeleteReadSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_delete_read_set::BatchDeleteReadSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_delete_read_set::BatchDeleteReadSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/sequencestore/{sequenceStoreId}/readset/batch/delete", sequenceStoreId = sequence_store_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_delete_read_set::BatchDeleteReadSet::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteReadSet {
                type Output = ::std::result::Result<crate::operation::batch_delete_read_set::BatchDeleteReadSetOutput, crate::operation::batch_delete_read_set::BatchDeleteReadSetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_delete_read_set::de_batch_delete_read_set_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_delete_read_set::de_batch_delete_read_set_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_delete_read_set::BatchDeleteReadSetError {
...
mod _batch_delete_read_set_output;
