...
impl ListVariantStoresInput {
    /// Consumes the builder and constructs an Operation<[`ListVariantStores`](crate::operation::list_variant_stores::ListVariantStores)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_variant_stores::ListVariantStores, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_variant_stores::ListVariantStoresInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/variantStores").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_variant_stores::ListVariantStoresInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_variant_stores::ListVariantStores::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListVariantStores", "omics"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListVariantStores`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVariantStores {
                type Output = ::std::result::Result<crate::operation::list_variant_stores::ListVariantStoresOutput, crate::operation::list_variant_stores::ListVariantStoresError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_variant_stores::de_list_variant_stores_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_variant_stores::de_list_variant_stores_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_variant_stores::ListVariantStoresError {
...
mod _list_variant_stores_output;
