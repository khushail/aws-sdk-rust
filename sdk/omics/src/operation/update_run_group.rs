...
impl UpdateRunGroupInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRunGroup`](crate::operation::update_run_group::UpdateRunGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_run_group::UpdateRunGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_run_group::UpdateRunGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_run_group::UpdateRunGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateRunGroup", "omics"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateRunGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRunGroup {
                type Output = ::std::result::Result<crate::operation::update_run_group::UpdateRunGroupOutput, crate::operation::update_run_group::UpdateRunGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_update_run_group::de_update_run_group_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_run_group::UpdateRunGroupError {
