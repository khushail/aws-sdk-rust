...
impl GetReadSetInput {
    /// Consumes the builder and constructs an Operation<[`GetReadSet`](crate::operation::get_read_set::GetReadSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_read_set::GetReadSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_read_set::GetReadSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/sequencestore/{sequenceStoreId}/readset/{id}", sequenceStoreId = sequence_store_id, id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_read_set::GetReadSetInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                let inner_4 = inner_4.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("part_number", "cannot be empty or unset"))?;
                query.push_kv("partNumber", ::aws_smithy_types::primitive::Encoder::from(*inner_4).encode());
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_read_set::GetReadSetInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_read_set::GetReadSet::new())
...
impl ::aws_smithy_http::response::ParseHttpResponse for GetReadSet {
                type Output = ::std::result::Result<crate::operation::get_read_set::GetReadSetOutput, crate::operation::get_read_set::GetReadSetError>;
                fn parse_unloaded(&self, response: &mut ::aws_smithy_http::operation::Response) -> ::std::option::Option<Self::Output> {
                    ...
                    ::std::option::Option::Some(crate::protocol_serde::shape_get_read_set::de_get_read_set_op_response(response))
                }
                fn parse_loaded(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_get_read_set::de_get_read_set_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_read_set::GetReadSetError {
