...
impl GetReferenceMetadataInput {
    /// Consumes the builder and constructs an Operation<[`GetReferenceMetadata`](crate::operation::get_reference_metadata::GetReferenceMetadata)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_reference_metadata::GetReferenceMetadata, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_reference_metadata::GetReferenceMetadataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/referencestore/{referenceStoreId}/reference/{id}/metadata", referenceStoreId = reference_store_id, id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_reference_metadata::GetReferenceMetadataInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_reference_metadata::GetReferenceMetadata::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetReferenceMetadata {
                type Output = ::std::result::Result<crate::operation::get_reference_metadata::GetReferenceMetadataOutput, crate::operation::get_reference_metadata::GetReferenceMetadataError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_reference_metadata::de_get_reference_metadata_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_reference_metadata::de_get_reference_metadata_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_reference_metadata::GetReferenceMetadataError {
...
mod _get_reference_metadata_output;
