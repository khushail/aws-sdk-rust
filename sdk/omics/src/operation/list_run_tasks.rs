...
impl ListRunTasksInput {
    /// Consumes the builder and constructs an Operation<[`ListRunTasks`](crate::operation::list_run_tasks::ListRunTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_run_tasks::ListRunTasks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_run_tasks::ListRunTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/run/{id}/task", id = id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_run_tasks::ListRunTasksInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_run_tasks::ListRunTasksInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_run_tasks::ListRunTasks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListRunTasks", "omics"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListRunTasks`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRunTasks {
                type Output = ::std::result::Result<crate::operation::list_run_tasks::ListRunTasksOutput, crate::operation::list_run_tasks::ListRunTasksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_run_tasks::de_list_run_tasks_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_run_tasks::de_list_run_tasks_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_run_tasks::ListRunTasksError {
