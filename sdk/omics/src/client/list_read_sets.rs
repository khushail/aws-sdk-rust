...
impl super::Client  {
    ...
    ///   - [`sequence_store_id(impl ::std::convert::Into<String>)`](crate::operation::list_read_sets::builders::ListReadSetsFluentBuilder::sequence_store_id) / [`set_sequence_store_id(Option<String>)`](crate::operation::list_read_sets::builders::ListReadSetsFluentBuilder::set_sequence_store_id): <p>The jobs' sequence store ID.</p>
