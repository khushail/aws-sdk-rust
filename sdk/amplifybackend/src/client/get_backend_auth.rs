...
impl super::Client  {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::set_app_id): <p>The app ID.</p>
    ///   - [`backend_environment_name(impl ::std::convert::Into<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::backend_environment_name) / [`set_backend_environment_name(Option<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::set_backend_environment_name): <p>The name of the backend environment.</p>
    ///   - [`resource_name(impl ::std::convert::Into<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::resource_name) / [`set_resource_name(Option<String>)`](crate::operation::get_backend_auth::builders::GetBackendAuthFluentBuilder::set_resource_name): <p>The name of this resource.</p>
