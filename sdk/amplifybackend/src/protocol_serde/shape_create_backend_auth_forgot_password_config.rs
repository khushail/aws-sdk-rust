...
pub fn ser_create_backend_auth_forgot_password_config(
...
pub(crate) fn de_create_backend_auth_forgot_password_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::CreateBackendAuthForgotPasswordConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::CreateBackendAuthForgotPasswordConfigBuilder::default();
            loop {
                match tokens.next().transpose()? {
