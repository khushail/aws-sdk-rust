...
impl GetBackendInput {
    /// Consumes the builder and constructs an Operation<[`GetBackend`](crate::operation::get_backend::GetBackend)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_backend::GetBackend, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_backend::GetBackendInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/backend/{AppId}/details", AppId = app_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_backend::GetBackend::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetBackend", "amplifybackend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetBackend`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackend {
                type Output = ::std::result::Result<crate::operation::get_backend::GetBackendOutput, crate::operation::get_backend::GetBackendError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_backend::de_get_backend_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_backend::de_get_backend_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_backend::GetBackendError {
