...
impl UpdateBackendApiInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBackendAPI`](crate::operation::update_backend_api::UpdateBackendAPI)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_backend_api::UpdateBackendAPI, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_backend_api::UpdateBackendApiInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if backend_environment_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("backend_environment_name", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/backend/{AppId}/api/{BackendEnvironmentName}", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_backend_api::UpdateBackendAPI::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateBackendAPI", "amplifybackend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateBackendAPI`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBackendAPI {
                type Output = ::std::result::Result<crate::operation::update_backend_api::UpdateBackendApiOutput, crate::operation::update_backend_api::UpdateBackendAPIError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_backend_api::de_update_backend_api_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_backend_api::de_update_backend_api_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_backend_api::UpdateBackendAPIError {
...
pub use crate::operation::update_backend_api::_update_backend_api_output::UpdateBackendApiOutput;

pub use crate::operation::update_backend_api::_update_backend_api_input::UpdateBackendApiInput;

mod _update_backend_api_input;

mod _update_backend_api_output;
