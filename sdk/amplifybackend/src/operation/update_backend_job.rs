...
impl UpdateBackendJobInput {
    /// Consumes the builder and constructs an Operation<[`UpdateBackendJob`](crate::operation::update_backend_job::UpdateBackendJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_backend_job::UpdateBackendJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_backend_job::UpdateBackendJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/backend/{AppId}/job/{BackendEnvironmentName}/{JobId}", AppId = app_id, BackendEnvironmentName = backend_environment_name, JobId = job_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_backend_job::UpdateBackendJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateBackendJob", "amplifybackend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateBackendJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateBackendJob {
                type Output = ::std::result::Result<crate::operation::update_backend_job::UpdateBackendJobOutput, crate::operation::update_backend_job::UpdateBackendJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_backend_job::de_update_backend_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_backend_job::de_update_backend_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_backend_job::UpdateBackendJobError {
...
mod _update_backend_job_output;
