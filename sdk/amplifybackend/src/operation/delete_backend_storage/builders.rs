...
pub use crate::operation::delete_backend_storage::_delete_backend_storage_output::DeleteBackendStorageOutputBuilder;

pub use crate::operation::delete_backend_storage::_delete_backend_storage_input::DeleteBackendStorageInputBuilder;
...
impl DeleteBackendStorageInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.delete_backend_storage();
...
pub struct DeleteBackendStorageFluentBuilder {
    handle: ::std::sync::Arc<crate::client::Handle>,
                    inner: crate::operation::delete_backend_storage::builders::DeleteBackendStorageInputBuilder,
}
impl DeleteBackendStorageFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::delete_backend_storage::DeleteBackendStorage, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::delete_backend_storage::DeleteBackendStorageOutput, ::aws_smithy_http::result::SdkError<crate::operation::delete_backend_storage::DeleteBackendStorageError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::delete_backend_storage::DeleteBackendStorageOutput, ::aws_smithy_http::result::SdkError<crate::operation::delete_backend_storage::DeleteBackendStorageError>>
                             {
