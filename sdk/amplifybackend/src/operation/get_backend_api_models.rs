...
impl GetBackendApiModelsInput {
    /// Consumes the builder and constructs an Operation<[`GetBackendAPIModels`](crate::operation::get_backend_api_models::GetBackendAPIModels)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_backend_api_models::GetBackendAPIModels, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_backend_api_models::GetBackendApiModelsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/backend/{AppId}/api/{BackendEnvironmentName}/getModels", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_backend_api_models::GetBackendAPIModels::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackendAPIModels {
                type Output = ::std::result::Result<crate::operation::get_backend_api_models::GetBackendApiModelsOutput, crate::operation::get_backend_api_models::GetBackendAPIModelsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_backend_api_models::de_get_backend_api_models_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_backend_api_models::de_get_backend_api_models_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_backend_api_models::GetBackendAPIModelsError {
...
mod _get_backend_api_models_output;
