...
impl GetBackendApiInput {
    /// Consumes the builder and constructs an Operation<[`GetBackendAPI`](crate::operation::get_backend_api::GetBackendAPI)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_backend_api::GetBackendAPI, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_backend_api::GetBackendApiInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/backend/{AppId}/api/{BackendEnvironmentName}/details", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_backend_api::GetBackendAPI::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackendAPI {
                type Output = ::std::result::Result<crate::operation::get_backend_api::GetBackendApiOutput, crate::operation::get_backend_api::GetBackendAPIError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_backend_api::de_get_backend_api_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_backend_api::de_get_backend_api_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_backend_api::GetBackendAPIError {
