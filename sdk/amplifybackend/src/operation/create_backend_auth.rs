...
impl CreateBackendAuthInput {
    /// Consumes the builder and constructs an Operation<[`CreateBackendAuth`](crate::operation::create_backend_auth::CreateBackendAuth)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_backend_auth::CreateBackendAuth, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_backend_auth::CreateBackendAuthInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/backend/{AppId}/auth", AppId = app_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_backend_auth::CreateBackendAuth::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBackendAuth {
                type Output = ::std::result::Result<crate::operation::create_backend_auth::CreateBackendAuthOutput, crate::operation::create_backend_auth::CreateBackendAuthError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_backend_auth::de_create_backend_auth_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_backend_auth::de_create_backend_auth_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_backend_auth::CreateBackendAuthError {
...
mod _create_backend_auth_output;
