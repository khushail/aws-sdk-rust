...
impl CreateBackendApiInput {
    /// Consumes the builder and constructs an Operation<[`CreateBackendAPI`](crate::operation::create_backend_api::CreateBackendAPI)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_backend_api::CreateBackendAPI, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_backend_api::CreateBackendApiInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/backend/{AppId}/api", AppId = app_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_backend_api::CreateBackendAPI::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateBackendAPI", "amplifybackend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateBackendAPI`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBackendAPI {
                type Output = ::std::result::Result<crate::operation::create_backend_api::CreateBackendApiOutput, crate::operation::create_backend_api::CreateBackendAPIError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_backend_api::de_create_backend_api_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_backend_api::de_create_backend_api_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_backend_api::CreateBackendAPIError {
...
pub use crate::operation::create_backend_api::_create_backend_api_output::CreateBackendApiOutput;

pub use crate::operation::create_backend_api::_create_backend_api_input::CreateBackendApiInput;

mod _create_backend_api_input;

mod _create_backend_api_output;
