...
impl CloneBackendInput {
    /// Consumes the builder and constructs an Operation<[`CloneBackend`](crate::operation::clone_backend::CloneBackend)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::clone_backend::CloneBackend, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::clone_backend::CloneBackendInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/backend/{AppId}/environments/{BackendEnvironmentName}/clone", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::clone_backend::CloneBackendInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::clone_backend::CloneBackend::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CloneBackend", "amplifybackend"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CloneBackend`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CloneBackend {
                type Output = ::std::result::Result<crate::operation::clone_backend::CloneBackendOutput, crate::operation::clone_backend::CloneBackendError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_clone_backend::de_clone_backend_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_clone_backend::de_clone_backend_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::clone_backend::CloneBackendError {
