...
impl DeleteBackendAuthInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBackendAuth`](crate::operation::delete_backend_auth::DeleteBackendAuth)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_backend_auth::DeleteBackendAuth, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_backend_auth::DeleteBackendAuthInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/backend/{AppId}/auth/{BackendEnvironmentName}/remove", AppId = app_id, BackendEnvironmentName = backend_environment_name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_backend_auth::DeleteBackendAuth::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBackendAuth {
                type Output = ::std::result::Result<crate::operation::delete_backend_auth::DeleteBackendAuthOutput, crate::operation::delete_backend_auth::DeleteBackendAuthError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_backend_auth::de_delete_backend_auth_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_backend_auth::de_delete_backend_auth_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_backend_auth::DeleteBackendAuthError {
...
pub use crate::operation::delete_backend_auth::_delete_backend_auth_output::DeleteBackendAuthOutput;

pub use crate::operation::delete_backend_auth::_delete_backend_auth_input::DeleteBackendAuthInput;

mod _delete_backend_auth_input;

mod _delete_backend_auth_output;
