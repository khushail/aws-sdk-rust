...
pub(crate) fn de_efs_authorization_config<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::EfsAuthorizationConfig>, ::aws_smithy_json::deserialize::error::DeserializeError>
