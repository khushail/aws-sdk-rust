...
pub(crate) fn de_eks_volume<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::EksVolume>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "hostPath" => {
                                builder = builder.set_host_path(
                                    crate::protocol_serde::shape_eks_host_path::de_eks_host_path(tokens)?
                                );
                            }
                            "emptyDir" => {
                                builder = builder.set_empty_dir(
                                    crate::protocol_serde::shape_eks_empty_dir::de_eks_empty_dir(tokens)?
                                );
                            }
                            "secret" => {
                                builder = builder.set_secret(
                                    crate::protocol_serde::shape_eks_secret::de_eks_secret(tokens)?
                                );
                            }
