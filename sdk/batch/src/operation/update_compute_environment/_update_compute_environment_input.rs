...
impl UpdateComputeEnvironmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_compute_environment::UpdateComputeEnvironmentInput, ::aws_smithy_http::operation::error::BuildError> {
