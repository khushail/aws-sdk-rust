...
impl DeleteComputeEnvironmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_compute_environment::DeleteComputeEnvironmentInput, ::aws_smithy_http::operation::error::BuildError> {
