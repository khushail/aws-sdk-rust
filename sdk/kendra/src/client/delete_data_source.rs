...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::delete_data_source::builders::DeleteDataSourceFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::delete_data_source::builders::DeleteDataSourceFluentBuilder::set_id): <p>The identifier of the data source connector you want to delete.</p>
