...
impl BatchDeleteDocumentInput {
    /// Consumes the builder and constructs an Operation<[`BatchDeleteDocument`](crate::operation::batch_delete_document::BatchDeleteDocument)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_delete_document::BatchDeleteDocument, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_delete_document::BatchDeleteDocumentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_delete_document::ser_batch_delete_document_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_delete_document::BatchDeleteDocument::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchDeleteDocument", "kendra"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDeleteDocument {
                type Output = ::std::result::Result<crate::operation::batch_delete_document::BatchDeleteDocumentOutput, crate::operation::batch_delete_document::BatchDeleteDocumentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_batch_delete_document::de_batch_delete_document_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_delete_document::BatchDeleteDocumentError {
