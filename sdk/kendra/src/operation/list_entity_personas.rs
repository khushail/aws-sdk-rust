...
impl ListEntityPersonasInput {
    /// Consumes the builder and constructs an Operation<[`ListEntityPersonas`](crate::operation::list_entity_personas::ListEntityPersonas)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_entity_personas::ListEntityPersonas, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_entity_personas::ListEntityPersonasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_entity_personas::ser_list_entity_personas_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_entity_personas::ListEntityPersonas::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListEntityPersonas", "kendra"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEntityPersonas {
                type Output = ::std::result::Result<crate::operation::list_entity_personas::ListEntityPersonasOutput, crate::operation::list_entity_personas::ListEntityPersonasError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_entity_personas::de_list_entity_personas_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_entity_personas::de_list_entity_personas_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_entity_personas::ListEntityPersonasError {
...
mod _list_entity_personas_output;
