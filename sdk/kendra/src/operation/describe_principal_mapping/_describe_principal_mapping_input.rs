...
impl DescribePrincipalMappingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_principal_mapping::DescribePrincipalMappingInput, ::aws_smithy_http::operation::error::BuildError> {
