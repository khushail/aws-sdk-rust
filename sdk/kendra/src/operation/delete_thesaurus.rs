...
impl DeleteThesaurusInput {
    /// Consumes the builder and constructs an Operation<[`DeleteThesaurus`](crate::operation::delete_thesaurus::DeleteThesaurus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_thesaurus::DeleteThesaurus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_thesaurus::DeleteThesaurusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_thesaurus::ser_delete_thesaurus_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_thesaurus::DeleteThesaurus::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteThesaurus", "kendra"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteThesaurus {
                type Output = ::std::result::Result<crate::operation::delete_thesaurus::DeleteThesaurusOutput, crate::operation::delete_thesaurus::DeleteThesaurusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_thesaurus::de_delete_thesaurus_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_thesaurus::de_delete_thesaurus_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_thesaurus::DeleteThesaurusError {
