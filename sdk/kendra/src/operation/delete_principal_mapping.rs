...
impl DeletePrincipalMappingInput {
    /// Consumes the builder and constructs an Operation<[`DeletePrincipalMapping`](crate::operation::delete_principal_mapping::DeletePrincipalMapping)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_principal_mapping::DeletePrincipalMapping, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_principal_mapping::DeletePrincipalMappingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_principal_mapping::ser_delete_principal_mapping_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_principal_mapping::DeletePrincipalMapping::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeletePrincipalMapping", "kendra"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeletePrincipalMapping`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePrincipalMapping {
                type Output = ::std::result::Result<crate::operation::delete_principal_mapping::DeletePrincipalMappingOutput, crate::operation::delete_principal_mapping::DeletePrincipalMappingError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_principal_mapping::de_delete_principal_mapping_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_principal_mapping::de_delete_principal_mapping_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_principal_mapping::DeletePrincipalMappingError {
...
mod _delete_principal_mapping_output;
