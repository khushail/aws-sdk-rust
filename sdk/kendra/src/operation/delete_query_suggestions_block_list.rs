...
impl DeleteQuerySuggestionsBlockListInput {
    /// Consumes the builder and constructs an Operation<[`DeleteQuerySuggestionsBlockList`](crate::operation::delete_query_suggestions_block_list::DeleteQuerySuggestionsBlockList)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_query_suggestions_block_list::DeleteQuerySuggestionsBlockList, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_query_suggestions_block_list::DeleteQuerySuggestionsBlockListInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_query_suggestions_block_list::ser_delete_query_suggestions_block_list_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_query_suggestions_block_list::DeleteQuerySuggestionsBlockList::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteQuerySuggestionsBlockList", "kendra"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteQuerySuggestionsBlockList`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteQuerySuggestionsBlockList {
                type Output = ::std::result::Result<crate::operation::delete_query_suggestions_block_list::DeleteQuerySuggestionsBlockListOutput, crate::operation::delete_query_suggestions_block_list::DeleteQuerySuggestionsBlockListError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_query_suggestions_block_list::de_delete_query_suggestions_block_list_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_query_suggestions_block_list::de_delete_query_suggestions_block_list_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_query_suggestions_block_list::DeleteQuerySuggestionsBlockListError {
...
mod _delete_query_suggestions_block_list_output;
