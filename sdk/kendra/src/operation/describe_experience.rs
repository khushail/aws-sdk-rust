...
impl DescribeExperienceInput {
    /// Consumes the builder and constructs an Operation<[`DescribeExperience`](crate::operation::describe_experience::DescribeExperience)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_experience::DescribeExperience, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_experience::DescribeExperienceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_experience::DescribeExperienceInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_experience::ser_describe_experience_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_experience::DescribeExperience::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeExperience", "kendra"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeExperience`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeExperience {
                type Output = ::std::result::Result<crate::operation::describe_experience::DescribeExperienceOutput, crate::operation::describe_experience::DescribeExperienceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_experience::de_describe_experience_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_experience::de_describe_experience_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_experience::DescribeExperienceError {
...
mod _describe_experience_output;
