...
impl AssociateEntitiesToExperienceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_entities_to_experience::AssociateEntitiesToExperienceInput, ::aws_smithy_http::operation::error::BuildError> {
