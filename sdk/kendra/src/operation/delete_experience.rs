...
impl DeleteExperienceInput {
    /// Consumes the builder and constructs an Operation<[`DeleteExperience`](crate::operation::delete_experience::DeleteExperience)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_experience::DeleteExperience, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_experience::DeleteExperienceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_experience::ser_delete_experience_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_experience::DeleteExperience::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteExperience", "kendra"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteExperience {
                type Output = ::std::result::Result<crate::operation::delete_experience::DeleteExperienceOutput, crate::operation::delete_experience::DeleteExperienceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_experience::de_delete_experience_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_experience::de_delete_experience_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_experience::DeleteExperienceError {
