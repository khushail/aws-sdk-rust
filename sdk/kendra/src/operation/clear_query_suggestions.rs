...
impl ClearQuerySuggestionsInput {
    /// Consumes the builder and constructs an Operation<[`ClearQuerySuggestions`](crate::operation::clear_query_suggestions::ClearQuerySuggestions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::clear_query_suggestions::ClearQuerySuggestions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::clear_query_suggestions::ClearQuerySuggestionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_clear_query_suggestions::ser_clear_query_suggestions_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::clear_query_suggestions::ClearQuerySuggestions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ClearQuerySuggestions", "kendra"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ClearQuerySuggestions {
                type Output = ::std::result::Result<crate::operation::clear_query_suggestions::ClearQuerySuggestionsOutput, crate::operation::clear_query_suggestions::ClearQuerySuggestionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_clear_query_suggestions::de_clear_query_suggestions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_clear_query_suggestions::de_clear_query_suggestions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::clear_query_suggestions::ClearQuerySuggestionsError {
...
mod _clear_query_suggestions_output;
