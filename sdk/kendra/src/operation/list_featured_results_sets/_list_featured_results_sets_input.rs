...
impl ListFeaturedResultsSetsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_featured_results_sets::ListFeaturedResultsSetsInput, ::aws_smithy_http::operation::error::BuildError> {
