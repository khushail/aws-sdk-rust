...
impl CreateFeaturedResultsSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_featured_results_set::CreateFeaturedResultsSetInput, ::aws_smithy_http::operation::error::BuildError> {
