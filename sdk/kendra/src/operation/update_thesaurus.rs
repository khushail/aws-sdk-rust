...
impl UpdateThesaurusInput {
    /// Consumes the builder and constructs an Operation<[`UpdateThesaurus`](crate::operation::update_thesaurus::UpdateThesaurus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_thesaurus::UpdateThesaurus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_thesaurus::UpdateThesaurusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_thesaurus::UpdateThesaurusInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_thesaurus::ser_update_thesaurus_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_thesaurus::UpdateThesaurus::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateThesaurus", "kendra"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateThesaurus`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateThesaurus {
                type Output = ::std::result::Result<crate::operation::update_thesaurus::UpdateThesaurusOutput, crate::operation::update_thesaurus::UpdateThesaurusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_thesaurus::de_update_thesaurus_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_thesaurus::de_update_thesaurus_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_thesaurus::UpdateThesaurusError {
