...
impl ClaimDevicesByClaimCodeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::claim_devices_by_claim_code::ClaimDevicesByClaimCodeInput, ::aws_smithy_http::operation::error::BuildError> {
