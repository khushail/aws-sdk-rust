...
#[allow(clippy::unnecessary_wraps)]
pub fn de_invoke_device_method_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::invoke_device_method::InvokeDeviceMethodOutput, crate::operation::invoke_device_method::InvokeDeviceMethodError> {
    Ok({
        #[allow(unused_mut)]
