...
impl super::Client  {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::update_permissions::builders::UpdatePermissionsFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::update_permissions::builders::UpdatePermissionsFluentBuilder::set_workspace_id): <p>The ID of the workspace to update.</p>
