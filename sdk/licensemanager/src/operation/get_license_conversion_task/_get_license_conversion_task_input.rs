...
impl GetLicenseConversionTaskInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_license_conversion_task::GetLicenseConversionTaskInput, ::aws_smithy_http::operation::error::BuildError> {
