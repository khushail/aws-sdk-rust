...
impl UpdateLicenseManagerReportGeneratorInput {
    /// Consumes the builder and constructs an Operation<[`UpdateLicenseManagerReportGenerator`](crate::operation::update_license_manager_report_generator::UpdateLicenseManagerReportGenerator)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_license_manager_report_generator::UpdateLicenseManagerReportGenerator, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_license_manager_report_generator::UpdateLicenseManagerReportGeneratorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_license_manager_report_generator::ser_update_license_manager_report_generator_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_license_manager_report_generator::UpdateLicenseManagerReportGenerator::new())
...
/// Orchestration and serialization glue logic for `UpdateLicenseManagerReportGenerator`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLicenseManagerReportGenerator {
                type Output = ::std::result::Result<crate::operation::update_license_manager_report_generator::UpdateLicenseManagerReportGeneratorOutput, crate::operation::update_license_manager_report_generator::UpdateLicenseManagerReportGeneratorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_license_manager_report_generator::de_update_license_manager_report_generator_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_license_manager_report_generator::de_update_license_manager_report_generator_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_license_manager_report_generator::UpdateLicenseManagerReportGeneratorError {
...
pub use crate::operation::update_license_manager_report_generator::_update_license_manager_report_generator_output::UpdateLicenseManagerReportGeneratorOutput;

pub use crate::operation::update_license_manager_report_generator::_update_license_manager_report_generator_input::UpdateLicenseManagerReportGeneratorInput;

mod _update_license_manager_report_generator_input;

mod _update_license_manager_report_generator_output;
