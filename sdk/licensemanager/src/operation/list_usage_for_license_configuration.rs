...
impl ListUsageForLicenseConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`ListUsageForLicenseConfiguration`](crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_usage_for_license_configuration::ser_list_usage_for_license_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUsageForLicenseConfiguration {
                type Output = ::std::result::Result<crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationOutput, crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_usage_for_license_configuration::ListUsageForLicenseConfigurationError {
...
mod _list_usage_for_license_configuration_output;
