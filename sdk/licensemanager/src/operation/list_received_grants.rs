...
impl ListReceivedGrantsInput {
    /// Consumes the builder and constructs an Operation<[`ListReceivedGrants`](crate::operation::list_received_grants::ListReceivedGrants)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_received_grants::ListReceivedGrants, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_received_grants::ListReceivedGrantsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_received_grants::ListReceivedGrantsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_received_grants::ser_list_received_grants_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_received_grants::ListReceivedGrants::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListReceivedGrants", "licensemanager"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListReceivedGrants`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReceivedGrants {
                type Output = ::std::result::Result<crate::operation::list_received_grants::ListReceivedGrantsOutput, crate::operation::list_received_grants::ListReceivedGrantsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_received_grants::de_list_received_grants_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_received_grants::de_list_received_grants_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_received_grants::ListReceivedGrantsError {
...
pub use crate::operation::list_received_grants::_list_received_grants_output::ListReceivedGrantsOutput;

pub use crate::operation::list_received_grants::_list_received_grants_input::ListReceivedGrantsInput;

mod _list_received_grants_input;

mod _list_received_grants_output;
