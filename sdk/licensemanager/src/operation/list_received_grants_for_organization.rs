...
impl ListReceivedGrantsForOrganizationInput {
    /// Consumes the builder and constructs an Operation<[`ListReceivedGrantsForOrganization`](crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_received_grants_for_organization::ser_list_received_grants_for_organization_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganization::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReceivedGrantsForOrganization {
                type Output = ::std::result::Result<crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationOutput, crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_received_grants_for_organization::de_list_received_grants_for_organization_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_received_grants_for_organization::de_list_received_grants_for_organization_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_received_grants_for_organization::ListReceivedGrantsForOrganizationError {
...
mod _list_received_grants_for_organization_output;
