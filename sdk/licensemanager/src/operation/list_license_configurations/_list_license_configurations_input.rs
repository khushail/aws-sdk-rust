...
impl ListLicenseConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_license_configurations::ListLicenseConfigurationsInput, ::aws_smithy_http::operation::error::BuildError> {
