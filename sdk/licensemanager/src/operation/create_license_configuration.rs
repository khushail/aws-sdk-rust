...
impl CreateLicenseConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`CreateLicenseConfiguration`](crate::operation::create_license_configuration::CreateLicenseConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_license_configuration::CreateLicenseConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_license_configuration::CreateLicenseConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_license_configuration::ser_create_license_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_license_configuration::CreateLicenseConfiguration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLicenseConfiguration {
                type Output = ::std::result::Result<crate::operation::create_license_configuration::CreateLicenseConfigurationOutput, crate::operation::create_license_configuration::CreateLicenseConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_license_configuration::de_create_license_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_license_configuration::de_create_license_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_license_configuration::CreateLicenseConfigurationError {
...
mod _create_license_configuration_output;
