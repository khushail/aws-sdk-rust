...
impl CreateLicenseConversionTaskForResourceInput {
    /// Consumes the builder and constructs an Operation<[`CreateLicenseConversionTaskForResource`](crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_license_conversion_task_for_resource::ser_create_license_conversion_task_for_resource_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResource::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLicenseConversionTaskForResource {
                type Output = ::std::result::Result<crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceOutput, crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_license_conversion_task_for_resource::de_create_license_conversion_task_for_resource_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_license_conversion_task_for_resource::de_create_license_conversion_task_for_resource_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_license_conversion_task_for_resource::CreateLicenseConversionTaskForResourceError {
...
mod _create_license_conversion_task_for_resource_output;
