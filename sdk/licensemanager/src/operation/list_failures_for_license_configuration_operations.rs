...
impl ListFailuresForLicenseConfigurationOperationsInput {
    /// Consumes the builder and constructs an Operation<[`ListFailuresForLicenseConfigurationOperations`](crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_failures_for_license_configuration_operations::ser_list_failures_for_license_configuration_operations_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperations::new())
...
/// Orchestration and serialization glue logic for `ListFailuresForLicenseConfigurationOperations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFailuresForLicenseConfigurationOperations {
                type Output = ::std::result::Result<crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsOutput, crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_failures_for_license_configuration_operations::de_list_failures_for_license_configuration_operations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_failures_for_license_configuration_operations::de_list_failures_for_license_configuration_operations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_failures_for_license_configuration_operations::ListFailuresForLicenseConfigurationOperationsError {
...
mod _list_failures_for_license_configuration_operations_output;
