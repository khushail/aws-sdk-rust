...
impl CheckoutBorrowLicenseInput {
    /// Consumes the builder and constructs an Operation<[`CheckoutBorrowLicense`](crate::operation::checkout_borrow_license::CheckoutBorrowLicense)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::checkout_borrow_license::CheckoutBorrowLicense, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::checkout_borrow_license::CheckoutBorrowLicenseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_checkout_borrow_license::ser_checkout_borrow_license_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::checkout_borrow_license::CheckoutBorrowLicense::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CheckoutBorrowLicense {
                type Output = ::std::result::Result<crate::operation::checkout_borrow_license::CheckoutBorrowLicenseOutput, crate::operation::checkout_borrow_license::CheckoutBorrowLicenseError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_checkout_borrow_license::de_checkout_borrow_license_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::checkout_borrow_license::CheckoutBorrowLicenseError {
