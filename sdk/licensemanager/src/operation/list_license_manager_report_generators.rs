...
impl ListLicenseManagerReportGeneratorsInput {
    /// Consumes the builder and constructs an Operation<[`ListLicenseManagerReportGenerators`](crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGenerators)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGenerators, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_license_manager_report_generators::ser_list_license_manager_report_generators_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGenerators::new())
...
/// Orchestration and serialization glue logic for `ListLicenseManagerReportGenerators`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListLicenseManagerReportGenerators {
                type Output = ::std::result::Result<crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsOutput, crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_license_manager_report_generators::de_list_license_manager_report_generators_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_license_manager_report_generators::de_list_license_manager_report_generators_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_license_manager_report_generators::ListLicenseManagerReportGeneratorsError {
...
pub use crate::operation::list_license_manager_report_generators::_list_license_manager_report_generators_output::ListLicenseManagerReportGeneratorsOutput;

pub use crate::operation::list_license_manager_report_generators::_list_license_manager_report_generators_input::ListLicenseManagerReportGeneratorsInput;

mod _list_license_manager_report_generators_input;

mod _list_license_manager_report_generators_output;
