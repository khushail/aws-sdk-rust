...
impl ListReceivedLicensesInput {
    /// Consumes the builder and constructs an Operation<[`ListReceivedLicenses`](crate::operation::list_received_licenses::ListReceivedLicenses)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_received_licenses::ListReceivedLicenses, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_received_licenses::ListReceivedLicensesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_received_licenses::ser_list_received_licenses_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_received_licenses::ListReceivedLicenses::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReceivedLicenses {
                type Output = ::std::result::Result<crate::operation::list_received_licenses::ListReceivedLicensesOutput, crate::operation::list_received_licenses::ListReceivedLicensesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_received_licenses::de_list_received_licenses_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_received_licenses::de_list_received_licenses_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_received_licenses::ListReceivedLicensesError {
...
pub use crate::operation::list_received_licenses::_list_received_licenses_output::ListReceivedLicensesOutput;

pub use crate::operation::list_received_licenses::_list_received_licenses_input::ListReceivedLicensesInput;

mod _list_received_licenses_input;

mod _list_received_licenses_output;
