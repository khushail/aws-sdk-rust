...
impl super::Client  {
    ...
    ///   - [`resource_arn(impl ::std::convert::Into<String>)`](crate::operation::update_license_specifications_for_resource::builders::UpdateLicenseSpecificationsForResourceFluentBuilder::resource_arn) / [`set_resource_arn(Option<String>)`](crate::operation::update_license_specifications_for_resource::builders::UpdateLicenseSpecificationsForResourceFluentBuilder::set_resource_arn): <p>Amazon Resource Name (ARN) of the Amazon Web Services resource.</p>
