...
impl super::Client  {
    ...
    ///   - [`license_configuration_arn(impl ::std::convert::Into<String>)`](crate::operation::get_license_configuration::builders::GetLicenseConfigurationFluentBuilder::license_configuration_arn) / [`set_license_configuration_arn(Option<String>)`](crate::operation::get_license_configuration::builders::GetLicenseConfigurationFluentBuilder::set_license_configuration_arn): <p>Amazon Resource Name (ARN) of the license configuration.</p>
