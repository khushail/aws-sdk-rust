...
impl super::Client  {
    ...
    ///   - [`grant_arn(impl ::std::convert::Into<String>)`](crate::operation::accept_grant::builders::AcceptGrantFluentBuilder::grant_arn) / [`set_grant_arn(Option<String>)`](crate::operation::accept_grant::builders::AcceptGrantFluentBuilder::set_grant_arn): <p>Amazon Resource Name (ARN) of the grant.</p>
