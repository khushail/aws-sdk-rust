...
impl super::Client  {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::set_client_token): <p>Unique, case-sensitive identifier that you provide to ensure the idempotency of the request.</p>
    ///   - [`grant_name(impl ::std::convert::Into<String>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::grant_name) / [`set_grant_name(Option<String>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::set_grant_name): <p>Grant name.</p>
    ///   - [`license_arn(impl ::std::convert::Into<String>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::license_arn) / [`set_license_arn(Option<String>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::set_license_arn): <p>Amazon Resource Name (ARN) of the license.</p>
    ///   - [`principals(Vec<String>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::principals) / [`set_principals(Option<Vec<String>>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::set_principals): <p>The grant principals. You can specify one of the following as an Amazon Resource Name (ARN):</p>  <ul>   <li> <p>An Amazon Web Services account, which includes only the account specified.</p> </li>  </ul>  <ul>   <li> <p>An organizational unit (OU), which includes all accounts in the OU.</p> </li>  </ul>  <ul>   <li> <p>An organization, which will include all accounts across your organization.</p> </li>  </ul>
    ///   - [`home_region(impl ::std::convert::Into<String>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::home_region) / [`set_home_region(Option<String>)`](crate::operation::create_grant::builders::CreateGrantFluentBuilder::set_home_region): <p>Home Region of the grant.</p>
