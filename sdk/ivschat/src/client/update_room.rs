...
impl super::Client  {
    ...
    ///   - [`identifier(impl ::std::convert::Into<String>)`](crate::operation::update_room::builders::UpdateRoomFluentBuilder::identifier) / [`set_identifier(Option<String>)`](crate::operation::update_room::builders::UpdateRoomFluentBuilder::set_identifier): <p>Identifier of the room to be updated. Currently this must be an ARN.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_room::builders::UpdateRoomFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_room::builders::UpdateRoomFluentBuilder::set_name): <p>Room name. The value does not need to be unique.</p>
