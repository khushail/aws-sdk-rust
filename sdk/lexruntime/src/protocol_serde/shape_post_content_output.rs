...
pub(crate) fn de_alternative_intents_header(header_map: &::http::HeaderMap) -> std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
...
pub fn de_audio_stream_payload(body: &mut ::aws_smithy_http::body::SdkBody) -> std::result::Result<::aws_smithy_http::byte_stream::ByteStream, crate::operation::post_content::PostContentError> {
...
pub(crate) fn de_bot_version_header(header_map: &::http::HeaderMap) -> std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_encoded_input_transcript_header(header_map: &::http::HeaderMap) -> std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_nlu_intent_confidence_header(header_map: &::http::HeaderMap) -> std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
...
pub(crate) fn de_sentiment_response_header(header_map: &::http::HeaderMap) -> std::result::Result<::std::option::Option<::std::string::String>, ::aws_smithy_http::header::ParseError> {
