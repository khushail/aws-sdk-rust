...
impl PostContentInput {
    /// Consumes the builder and constructs an Operation<[`PostContent`](crate::operation::post_content::PostContent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::post_content::PostContent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::post_content::PostContentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/bot/{botName}/alias/{botAlias}/user/{userId}/content", botName = bot_name, botAlias = bot_alias, userId = user_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::post_content::PostContent::new())
...
impl ::aws_smithy_http::response::ParseHttpResponse for PostContent {
                type Output = ::std::result::Result<crate::operation::post_content::PostContentOutput, crate::operation::post_content::PostContentError>;
                fn parse_unloaded(&self, response: &mut ::aws_smithy_http::operation::Response) -> ::std::option::Option<Self::Output> {
                    ...
                    ::std::option::Option::Some(crate::protocol_serde::shape_post_content::de_post_content_op_response(response))
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::post_content::PostContentError {
