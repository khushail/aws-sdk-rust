...
impl RegisterAvsDeviceInput {
    /// Consumes the builder and constructs an Operation<[`RegisterAVSDevice`](crate::operation::register_avs_device::RegisterAVSDevice)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_avs_device::RegisterAVSDevice, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_avs_device::RegisterAvsDeviceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_avs_device::RegisterAVSDevice::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterAVSDevice {
                type Output = ::std::result::Result<crate::operation::register_avs_device::RegisterAvsDeviceOutput, crate::operation::register_avs_device::RegisterAVSDeviceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_register_avs_device::de_register_avs_device_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_register_avs_device::de_register_avs_device_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::register_avs_device::RegisterAVSDeviceError {
...
pub use crate::operation::register_avs_device::_register_avs_device_output::RegisterAvsDeviceOutput;

pub use crate::operation::register_avs_device::_register_avs_device_input::RegisterAvsDeviceInput;

mod _register_avs_device_input;

mod _register_avs_device_output;
