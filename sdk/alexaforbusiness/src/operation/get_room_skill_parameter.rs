...
impl GetRoomSkillParameterInput {
    /// Consumes the builder and constructs an Operation<[`GetRoomSkillParameter`](crate::operation::get_room_skill_parameter::GetRoomSkillParameter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_room_skill_parameter::GetRoomSkillParameter, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_room_skill_parameter::GetRoomSkillParameterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_room_skill_parameter::GetRoomSkillParameter::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetRoomSkillParameter", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetRoomSkillParameter`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRoomSkillParameter {
                type Output = ::std::result::Result<crate::operation::get_room_skill_parameter::GetRoomSkillParameterOutput, crate::operation::get_room_skill_parameter::GetRoomSkillParameterError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_room_skill_parameter::de_get_room_skill_parameter_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_room_skill_parameter::de_get_room_skill_parameter_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_room_skill_parameter::GetRoomSkillParameterError {
...
pub use crate::operation::get_room_skill_parameter::_get_room_skill_parameter_output::GetRoomSkillParameterOutput;

pub use crate::operation::get_room_skill_parameter::_get_room_skill_parameter_input::GetRoomSkillParameterInput;

mod _get_room_skill_parameter_input;

mod _get_room_skill_parameter_output;
