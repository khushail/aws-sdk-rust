...
impl SearchSkillGroupsInput {
    /// Consumes the builder and constructs an Operation<[`SearchSkillGroups`](crate::operation::search_skill_groups::SearchSkillGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_skill_groups::SearchSkillGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_skill_groups::SearchSkillGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_skill_groups::SearchSkillGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchSkillGroups {
                type Output = ::std::result::Result<crate::operation::search_skill_groups::SearchSkillGroupsOutput, crate::operation::search_skill_groups::SearchSkillGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_search_skill_groups::de_search_skill_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_search_skill_groups::de_search_skill_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::search_skill_groups::SearchSkillGroupsError {
...
pub use crate::operation::search_skill_groups::_search_skill_groups_output::SearchSkillGroupsOutput;

pub use crate::operation::search_skill_groups::_search_skill_groups_input::SearchSkillGroupsInput;

mod _search_skill_groups_input;

mod _search_skill_groups_output;
