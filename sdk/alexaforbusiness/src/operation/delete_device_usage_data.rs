...
impl DeleteDeviceUsageDataInput {
    /// Consumes the builder and constructs an Operation<[`DeleteDeviceUsageData`](crate::operation::delete_device_usage_data::DeleteDeviceUsageData)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_device_usage_data::DeleteDeviceUsageData, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_device_usage_data::DeleteDeviceUsageDataInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_device_usage_data::DeleteDeviceUsageData::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteDeviceUsageData", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteDeviceUsageData`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteDeviceUsageData {
                type Output = ::std::result::Result<crate::operation::delete_device_usage_data::DeleteDeviceUsageDataOutput, crate::operation::delete_device_usage_data::DeleteDeviceUsageDataError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_device_usage_data::de_delete_device_usage_data_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_device_usage_data::de_delete_device_usage_data_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_device_usage_data::DeleteDeviceUsageDataError {
...
pub use crate::operation::delete_device_usage_data::_delete_device_usage_data_output::DeleteDeviceUsageDataOutput;

pub use crate::operation::delete_device_usage_data::_delete_device_usage_data_input::DeleteDeviceUsageDataInput;

mod _delete_device_usage_data_input;

mod _delete_device_usage_data_output;
