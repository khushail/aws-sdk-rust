...
impl StartDeviceSyncInput {
    /// Consumes the builder and constructs an Operation<[`StartDeviceSync`](crate::operation::start_device_sync::StartDeviceSync)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_device_sync::StartDeviceSync, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_device_sync::StartDeviceSyncInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_device_sync::StartDeviceSync::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartDeviceSync", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartDeviceSync`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartDeviceSync {
                type Output = ::std::result::Result<crate::operation::start_device_sync::StartDeviceSyncOutput, crate::operation::start_device_sync::StartDeviceSyncError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_device_sync::de_start_device_sync_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_device_sync::de_start_device_sync_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_device_sync::StartDeviceSyncError {
...
pub use crate::operation::start_device_sync::_start_device_sync_output::StartDeviceSyncOutput;

pub use crate::operation::start_device_sync::_start_device_sync_input::StartDeviceSyncInput;

mod _start_device_sync_input;

mod _start_device_sync_output;
