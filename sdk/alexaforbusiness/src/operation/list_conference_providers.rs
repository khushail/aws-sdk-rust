...
impl ListConferenceProvidersInput {
    /// Consumes the builder and constructs an Operation<[`ListConferenceProviders`](crate::operation::list_conference_providers::ListConferenceProviders)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_conference_providers::ListConferenceProviders, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_conference_providers::ListConferenceProvidersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_conference_providers::ListConferenceProviders::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListConferenceProviders", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListConferenceProviders`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListConferenceProviders {
                type Output = ::std::result::Result<crate::operation::list_conference_providers::ListConferenceProvidersOutput, crate::operation::list_conference_providers::ListConferenceProvidersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_conference_providers::de_list_conference_providers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_conference_providers::de_list_conference_providers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_conference_providers::ListConferenceProvidersError {
...
pub use crate::operation::list_conference_providers::_list_conference_providers_output::ListConferenceProvidersOutput;

pub use crate::operation::list_conference_providers::_list_conference_providers_input::ListConferenceProvidersInput;

mod _list_conference_providers_input;

mod _list_conference_providers_output;
