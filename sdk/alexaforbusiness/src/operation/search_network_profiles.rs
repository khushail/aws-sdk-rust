...
impl SearchNetworkProfilesInput {
    /// Consumes the builder and constructs an Operation<[`SearchNetworkProfiles`](crate::operation::search_network_profiles::SearchNetworkProfiles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_network_profiles::SearchNetworkProfiles, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_network_profiles::SearchNetworkProfilesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_network_profiles::SearchNetworkProfiles::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchNetworkProfiles", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SearchNetworkProfiles`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchNetworkProfiles {
                type Output = ::std::result::Result<crate::operation::search_network_profiles::SearchNetworkProfilesOutput, crate::operation::search_network_profiles::SearchNetworkProfilesError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::search_network_profiles::SearchNetworkProfilesError {
...
pub use crate::operation::search_network_profiles::_search_network_profiles_output::SearchNetworkProfilesOutput;

pub use crate::operation::search_network_profiles::_search_network_profiles_input::SearchNetworkProfilesInput;

mod _search_network_profiles_input;

mod _search_network_profiles_output;
