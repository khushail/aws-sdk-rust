...
impl AssociateSkillWithUsersInput {
    /// Consumes the builder and constructs an Operation<[`AssociateSkillWithUsers`](crate::operation::associate_skill_with_users::AssociateSkillWithUsers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_skill_with_users::AssociateSkillWithUsers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_skill_with_users::AssociateSkillWithUsersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_skill_with_users::AssociateSkillWithUsers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateSkillWithUsers", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateSkillWithUsers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateSkillWithUsers {
                type Output = ::std::result::Result<crate::operation::associate_skill_with_users::AssociateSkillWithUsersOutput, crate::operation::associate_skill_with_users::AssociateSkillWithUsersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_skill_with_users::de_associate_skill_with_users_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_skill_with_users::de_associate_skill_with_users_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_skill_with_users::AssociateSkillWithUsersError {
...
pub use crate::operation::associate_skill_with_users::_associate_skill_with_users_output::AssociateSkillWithUsersOutput;

pub use crate::operation::associate_skill_with_users::_associate_skill_with_users_input::AssociateSkillWithUsersInput;

mod _associate_skill_with_users_input;

mod _associate_skill_with_users_output;
