...
impl ForgetSmartHomeAppliancesInput {
    /// Consumes the builder and constructs an Operation<[`ForgetSmartHomeAppliances`](crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliances, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliances::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ForgetSmartHomeAppliances", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ForgetSmartHomeAppliances`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ForgetSmartHomeAppliances {
                type Output = ::std::result::Result<crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliancesOutput, crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliancesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_forget_smart_home_appliances::de_forget_smart_home_appliances_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_forget_smart_home_appliances::de_forget_smart_home_appliances_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliancesError {
...
pub use crate::operation::forget_smart_home_appliances::_forget_smart_home_appliances_output::ForgetSmartHomeAppliancesOutput;

pub use crate::operation::forget_smart_home_appliances::_forget_smart_home_appliances_input::ForgetSmartHomeAppliancesInput;

mod _forget_smart_home_appliances_input;

mod _forget_smart_home_appliances_output;
