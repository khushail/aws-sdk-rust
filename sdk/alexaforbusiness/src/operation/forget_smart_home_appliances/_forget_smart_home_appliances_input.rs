...
impl ForgetSmartHomeAppliancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::forget_smart_home_appliances::ForgetSmartHomeAppliancesInput, ::aws_smithy_http::operation::error::BuildError> {
