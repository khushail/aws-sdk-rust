...
impl DeleteSkillAuthorizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_skill_authorization::DeleteSkillAuthorizationInput, ::aws_smithy_http::operation::error::BuildError> {
