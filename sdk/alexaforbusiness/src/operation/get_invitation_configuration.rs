...
impl GetInvitationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`GetInvitationConfiguration`](crate::operation::get_invitation_configuration::GetInvitationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_invitation_configuration::GetInvitationConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_invitation_configuration::GetInvitationConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_invitation_configuration::GetInvitationConfigurationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_invitation_configuration::GetInvitationConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetInvitationConfiguration", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetInvitationConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInvitationConfiguration {
                type Output = ::std::result::Result<crate::operation::get_invitation_configuration::GetInvitationConfigurationOutput, crate::operation::get_invitation_configuration::GetInvitationConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_invitation_configuration::de_get_invitation_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_invitation_configuration::de_get_invitation_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_invitation_configuration::GetInvitationConfigurationError {
...
pub use crate::operation::get_invitation_configuration::_get_invitation_configuration_output::GetInvitationConfigurationOutput;

pub use crate::operation::get_invitation_configuration::_get_invitation_configuration_input::GetInvitationConfigurationInput;

mod _get_invitation_configuration_input;

mod _get_invitation_configuration_output;
