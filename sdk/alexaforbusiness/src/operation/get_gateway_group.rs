...
impl GetGatewayGroupInput {
    /// Consumes the builder and constructs an Operation<[`GetGatewayGroup`](crate::operation::get_gateway_group::GetGatewayGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_gateway_group::GetGatewayGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_gateway_group::GetGatewayGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_gateway_group::GetGatewayGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetGatewayGroup", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetGatewayGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGatewayGroup {
                type Output = ::std::result::Result<crate::operation::get_gateway_group::GetGatewayGroupOutput, crate::operation::get_gateway_group::GetGatewayGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_gateway_group::de_get_gateway_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_gateway_group::de_get_gateway_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_gateway_group::GetGatewayGroupError {
...
pub use crate::operation::get_gateway_group::_get_gateway_group_output::GetGatewayGroupOutput;

pub use crate::operation::get_gateway_group::_get_gateway_group_input::GetGatewayGroupInput;

mod _get_gateway_group_input;

mod _get_gateway_group_output;
