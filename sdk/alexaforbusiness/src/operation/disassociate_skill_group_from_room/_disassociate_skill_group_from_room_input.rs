...
impl DisassociateSkillGroupFromRoomInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_skill_group_from_room::DisassociateSkillGroupFromRoomInput, ::aws_smithy_http::operation::error::BuildError> {
