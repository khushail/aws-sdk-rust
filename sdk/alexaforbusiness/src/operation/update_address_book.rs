...
impl UpdateAddressBookInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAddressBook`](crate::operation::update_address_book::UpdateAddressBook)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_address_book::UpdateAddressBook, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_address_book::UpdateAddressBookInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_address_book::UpdateAddressBook::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAddressBook {
                type Output = ::std::result::Result<crate::operation::update_address_book::UpdateAddressBookOutput, crate::operation::update_address_book::UpdateAddressBookError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_address_book::de_update_address_book_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_address_book::UpdateAddressBookError {
...
pub use crate::operation::update_address_book::_update_address_book_output::UpdateAddressBookOutput;

pub use crate::operation::update_address_book::_update_address_book_input::UpdateAddressBookInput;

mod _update_address_book_input;

mod _update_address_book_output;
