...
impl DeleteBusinessReportScheduleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_business_report_schedule::DeleteBusinessReportScheduleInput, ::aws_smithy_http::operation::error::BuildError> {
