...
impl DeleteSkillGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSkillGroup`](crate::operation::delete_skill_group::DeleteSkillGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_skill_group::DeleteSkillGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_skill_group::DeleteSkillGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_skill_group::DeleteSkillGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteSkillGroup", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteSkillGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSkillGroup {
                type Output = ::std::result::Result<crate::operation::delete_skill_group::DeleteSkillGroupOutput, crate::operation::delete_skill_group::DeleteSkillGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_skill_group::de_delete_skill_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_skill_group::de_delete_skill_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_skill_group::DeleteSkillGroupError {
...
pub use crate::operation::delete_skill_group::_delete_skill_group_output::DeleteSkillGroupOutput;

pub use crate::operation::delete_skill_group::_delete_skill_group_input::DeleteSkillGroupInput;

mod _delete_skill_group_input;

mod _delete_skill_group_output;
