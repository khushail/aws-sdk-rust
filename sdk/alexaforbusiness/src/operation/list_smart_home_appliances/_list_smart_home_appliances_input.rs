...
impl ListSmartHomeAppliancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_smart_home_appliances::ListSmartHomeAppliancesInput, ::aws_smithy_http::operation::error::BuildError> {
