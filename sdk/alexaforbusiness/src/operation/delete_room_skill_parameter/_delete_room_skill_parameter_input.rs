...
impl DeleteRoomSkillParameterInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_room_skill_parameter::DeleteRoomSkillParameterInput, ::aws_smithy_http::operation::error::BuildError> {
