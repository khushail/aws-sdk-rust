...
impl RevokeInvitationInput {
    /// Consumes the builder and constructs an Operation<[`RevokeInvitation`](crate::operation::revoke_invitation::RevokeInvitation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::revoke_invitation::RevokeInvitation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_invitation::RevokeInvitationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_invitation::RevokeInvitation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RevokeInvitation", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RevokeInvitation`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeInvitation {
                type Output = ::std::result::Result<crate::operation::revoke_invitation::RevokeInvitationOutput, crate::operation::revoke_invitation::RevokeInvitationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_revoke_invitation::de_revoke_invitation_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_revoke_invitation::de_revoke_invitation_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::revoke_invitation::RevokeInvitationError {
...
pub use crate::operation::revoke_invitation::_revoke_invitation_output::RevokeInvitationOutput;

pub use crate::operation::revoke_invitation::_revoke_invitation_input::RevokeInvitationInput;

mod _revoke_invitation_input;

mod _revoke_invitation_output;
