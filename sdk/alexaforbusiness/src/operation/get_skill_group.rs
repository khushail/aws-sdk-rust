...
impl GetSkillGroupInput {
    /// Consumes the builder and constructs an Operation<[`GetSkillGroup`](crate::operation::get_skill_group::GetSkillGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_skill_group::GetSkillGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_skill_group::GetSkillGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_skill_group::GetSkillGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSkillGroup {
                type Output = ::std::result::Result<crate::operation::get_skill_group::GetSkillGroupOutput, crate::operation::get_skill_group::GetSkillGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_skill_group::de_get_skill_group_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_skill_group::GetSkillGroupError {
...
pub use crate::operation::get_skill_group::_get_skill_group_output::GetSkillGroupOutput;

pub use crate::operation::get_skill_group::_get_skill_group_input::GetSkillGroupInput;

mod _get_skill_group_input;

mod _get_skill_group_output;
