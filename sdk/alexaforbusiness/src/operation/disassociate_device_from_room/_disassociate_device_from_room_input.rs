...
impl DisassociateDeviceFromRoomInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::disassociate_device_from_room::DisassociateDeviceFromRoomInput, ::aws_smithy_http::operation::error::BuildError> {
