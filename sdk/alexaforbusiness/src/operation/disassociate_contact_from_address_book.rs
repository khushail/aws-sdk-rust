...
impl DisassociateContactFromAddressBookInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateContactFromAddressBook`](crate::operation::disassociate_contact_from_address_book::DisassociateContactFromAddressBook)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_contact_from_address_book::DisassociateContactFromAddressBook, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_contact_from_address_book::DisassociateContactFromAddressBookInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_contact_from_address_book::DisassociateContactFromAddressBook::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateContactFromAddressBook {
                type Output = ::std::result::Result<crate::operation::disassociate_contact_from_address_book::DisassociateContactFromAddressBookOutput, crate::operation::disassociate_contact_from_address_book::DisassociateContactFromAddressBookError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_contact_from_address_book::DisassociateContactFromAddressBookError {
...
pub use crate::operation::disassociate_contact_from_address_book::_disassociate_contact_from_address_book_output::DisassociateContactFromAddressBookOutput;

pub use crate::operation::disassociate_contact_from_address_book::_disassociate_contact_from_address_book_input::DisassociateContactFromAddressBookInput;

mod _disassociate_contact_from_address_book_input;

mod _disassociate_contact_from_address_book_output;
