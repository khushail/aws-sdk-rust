...
impl PutRoomSkillParameterInput {
    /// Consumes the builder and constructs an Operation<[`PutRoomSkillParameter`](crate::operation::put_room_skill_parameter::PutRoomSkillParameter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_room_skill_parameter::PutRoomSkillParameter, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_room_skill_parameter::PutRoomSkillParameterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_room_skill_parameter::PutRoomSkillParameter::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutRoomSkillParameter", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutRoomSkillParameter`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRoomSkillParameter {
                type Output = ::std::result::Result<crate::operation::put_room_skill_parameter::PutRoomSkillParameterOutput, crate::operation::put_room_skill_parameter::PutRoomSkillParameterError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_room_skill_parameter::de_put_room_skill_parameter_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_room_skill_parameter::de_put_room_skill_parameter_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_room_skill_parameter::PutRoomSkillParameterError {
...
pub use crate::operation::put_room_skill_parameter::_put_room_skill_parameter_output::PutRoomSkillParameterOutput;

pub use crate::operation::put_room_skill_parameter::_put_room_skill_parameter_input::PutRoomSkillParameterInput;

mod _put_room_skill_parameter_input;

mod _put_room_skill_parameter_output;
