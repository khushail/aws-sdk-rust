...
pub use crate::operation::list_conference_providers::_list_conference_providers_output::ListConferenceProvidersOutputBuilder;

pub use crate::operation::list_conference_providers::_list_conference_providers_input::ListConferenceProvidersInputBuilder;
...
impl ListConferenceProvidersInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.list_conference_providers();
...
impl ListConferenceProvidersFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::list_conference_providers::ListConferenceProviders, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::list_conference_providers::ListConferenceProvidersOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_conference_providers::ListConferenceProvidersError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::list_conference_providers::ListConferenceProvidersOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_conference_providers::ListConferenceProvidersError>>
                             {
