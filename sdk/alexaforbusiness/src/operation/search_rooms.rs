...
impl SearchRoomsInput {
    /// Consumes the builder and constructs an Operation<[`SearchRooms`](crate::operation::search_rooms::SearchRooms)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_rooms::SearchRooms, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_rooms::SearchRoomsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::search_rooms::SearchRoomsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_rooms::SearchRooms::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchRooms", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SearchRooms`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchRooms {
                type Output = ::std::result::Result<crate::operation::search_rooms::SearchRoomsOutput, crate::operation::search_rooms::SearchRoomsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_search_rooms::de_search_rooms_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_search_rooms::de_search_rooms_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::search_rooms::SearchRoomsError {
...
pub use crate::operation::search_rooms::_search_rooms_output::SearchRoomsOutput;

pub use crate::operation::search_rooms::_search_rooms_input::SearchRoomsInput;

mod _search_rooms_input;

mod _search_rooms_output;
