...
impl ListGatewayGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListGatewayGroups`](crate::operation::list_gateway_groups::ListGatewayGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_gateway_groups::ListGatewayGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_gateway_groups::ListGatewayGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_gateway_groups::ListGatewayGroups::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListGatewayGroups", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListGatewayGroups`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListGatewayGroups {
                type Output = ::std::result::Result<crate::operation::list_gateway_groups::ListGatewayGroupsOutput, crate::operation::list_gateway_groups::ListGatewayGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_gateway_groups::de_list_gateway_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_gateway_groups::de_list_gateway_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_gateway_groups::ListGatewayGroupsError {
...
pub use crate::operation::list_gateway_groups::_list_gateway_groups_output::ListGatewayGroupsOutput;

pub use crate::operation::list_gateway_groups::_list_gateway_groups_input::ListGatewayGroupsInput;

mod _list_gateway_groups_input;

mod _list_gateway_groups_output;
