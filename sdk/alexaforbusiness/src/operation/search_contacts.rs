...
impl SearchContactsInput {
    /// Consumes the builder and constructs an Operation<[`SearchContacts`](crate::operation::search_contacts::SearchContacts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::search_contacts::SearchContacts, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::search_contacts::SearchContactsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::search_contacts::SearchContacts::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SearchContacts", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SearchContacts`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SearchContacts {
                type Output = ::std::result::Result<crate::operation::search_contacts::SearchContactsOutput, crate::operation::search_contacts::SearchContactsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_search_contacts::de_search_contacts_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_search_contacts::de_search_contacts_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::search_contacts::SearchContactsError {
