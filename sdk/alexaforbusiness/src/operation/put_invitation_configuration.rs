...
impl PutInvitationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`PutInvitationConfiguration`](crate::operation::put_invitation_configuration::PutInvitationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_invitation_configuration::PutInvitationConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_invitation_configuration::PutInvitationConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_invitation_configuration::PutInvitationConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutInvitationConfiguration", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutInvitationConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutInvitationConfiguration {
                type Output = ::std::result::Result<crate::operation::put_invitation_configuration::PutInvitationConfigurationOutput, crate::operation::put_invitation_configuration::PutInvitationConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_invitation_configuration::de_put_invitation_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_invitation_configuration::de_put_invitation_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_invitation_configuration::PutInvitationConfigurationError {
...
pub use crate::operation::put_invitation_configuration::_put_invitation_configuration_output::PutInvitationConfigurationOutput;

pub use crate::operation::put_invitation_configuration::_put_invitation_configuration_input::PutInvitationConfigurationInput;

mod _put_invitation_configuration_input;

mod _put_invitation_configuration_output;
