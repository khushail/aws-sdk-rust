...
impl DeleteConferenceProviderInput {
    /// Consumes the builder and constructs an Operation<[`DeleteConferenceProvider`](crate::operation::delete_conference_provider::DeleteConferenceProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_conference_provider::DeleteConferenceProvider, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_conference_provider::DeleteConferenceProviderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_conference_provider::DeleteConferenceProvider::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteConferenceProvider", "alexaforbusiness"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteConferenceProvider`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteConferenceProvider {
                type Output = ::std::result::Result<crate::operation::delete_conference_provider::DeleteConferenceProviderOutput, crate::operation::delete_conference_provider::DeleteConferenceProviderError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_conference_provider::de_delete_conference_provider_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_conference_provider::de_delete_conference_provider_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_conference_provider::DeleteConferenceProviderError {
...
pub use crate::operation::delete_conference_provider::_delete_conference_provider_output::DeleteConferenceProviderOutput;

pub use crate::operation::delete_conference_provider::_delete_conference_provider_input::DeleteConferenceProviderInput;

mod _delete_conference_provider_input;

mod _delete_conference_provider_output;
