...
impl AssociateContactWithAddressBookInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_contact_with_address_book::AssociateContactWithAddressBookInput, ::aws_smithy_http::operation::error::BuildError> {
