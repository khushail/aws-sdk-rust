...
impl AssociateSkillGroupWithRoomInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_skill_group_with_room::AssociateSkillGroupWithRoomInput, ::aws_smithy_http::operation::error::BuildError> {
