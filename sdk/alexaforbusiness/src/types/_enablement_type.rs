...
other => EnablementType::Unknown(crate::primitives::UnknownVariantValue(other.to_owned()))
                    }
                }
            }
impl ::std::str::FromStr for EnablementType {
                ...
                fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                    ::std::result::Result::Ok(EnablementType::from(s))
                }
            }
impl EnablementType {
...
impl ::std::convert::AsRef<str> for EnablementType {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
