...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_business_report_schedules::builders::ListBusinessReportSchedulesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_business_report_schedules::builders::ListBusinessReportSchedulesFluentBuilder::set_next_token): <p>The token used to list the remaining schedules from the previous API call.</p>
