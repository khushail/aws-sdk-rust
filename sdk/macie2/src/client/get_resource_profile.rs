...
impl super::Client  {
    ...
    ///   - [`sensitivity_score(Option<i32>)`](crate::operation::get_resource_profile::GetResourceProfileOutput::sensitivity_score): <p>The current sensitivity score for the bucket, ranging from -1 (classification error) to 100 (sensitive). By default, this score is calculated automatically based on the amount of data that Amazon Macie has analyzed in the bucket and the amount of sensitive data that Macie has found in the bucket.</p>
