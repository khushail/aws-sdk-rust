...
impl super::Client  {
    ...
    ///   - [`administrator_account_id(impl ::std::convert::Into<String>)`](crate::operation::accept_invitation::builders::AcceptInvitationFluentBuilder::administrator_account_id) / [`set_administrator_account_id(Option<String>)`](crate::operation::accept_invitation::builders::AcceptInvitationFluentBuilder::set_administrator_account_id): <p>The Amazon Web Services account ID for the account that sent the invitation.</p>
    ///   - [`invitation_id(impl ::std::convert::Into<String>)`](crate::operation::accept_invitation::builders::AcceptInvitationFluentBuilder::invitation_id) / [`set_invitation_id(Option<String>)`](crate::operation::accept_invitation::builders::AcceptInvitationFluentBuilder::set_invitation_id): <p>The unique identifier for the invitation to accept.</p>
