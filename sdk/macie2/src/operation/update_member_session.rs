...
impl UpdateMemberSessionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMemberSession`](crate::operation::update_member_session::UpdateMemberSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_member_session::UpdateMemberSession, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_member_session::UpdateMemberSessionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/macie/members/{id}", id = id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_member_session::UpdateMemberSession::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMemberSession {
                type Output = ::std::result::Result<crate::operation::update_member_session::UpdateMemberSessionOutput, crate::operation::update_member_session::UpdateMemberSessionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_member_session::de_update_member_session_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_member_session::UpdateMemberSessionError {
...
mod _update_member_session_output;
