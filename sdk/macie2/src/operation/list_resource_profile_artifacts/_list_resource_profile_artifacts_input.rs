...
impl ListResourceProfileArtifactsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_resource_profile_artifacts::ListResourceProfileArtifactsInput, ::aws_smithy_http::operation::error::BuildError> {
