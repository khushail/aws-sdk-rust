...
impl ListResourceProfileDetectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_resource_profile_detections::ListResourceProfileDetectionsInput, ::aws_smithy_http::operation::error::BuildError> {
