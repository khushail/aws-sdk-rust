...
impl UpdateRevealConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_reveal_configuration::UpdateRevealConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
