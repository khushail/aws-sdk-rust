...
impl GetSensitiveDataOccurrencesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_sensitive_data_occurrences::GetSensitiveDataOccurrencesInput, ::aws_smithy_http::operation::error::BuildError> {
