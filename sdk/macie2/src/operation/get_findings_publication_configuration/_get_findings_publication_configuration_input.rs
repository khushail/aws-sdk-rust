...
impl GetFindingsPublicationConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_findings_publication_configuration::GetFindingsPublicationConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
