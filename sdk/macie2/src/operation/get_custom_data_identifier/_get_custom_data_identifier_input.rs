...
impl GetCustomDataIdentifierInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_custom_data_identifier::GetCustomDataIdentifierInput, ::aws_smithy_http::operation::error::BuildError> {
