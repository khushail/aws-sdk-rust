...
impl TestCustomDataIdentifierInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::test_custom_data_identifier::TestCustomDataIdentifierInput, ::aws_smithy_http::operation::error::BuildError> {
