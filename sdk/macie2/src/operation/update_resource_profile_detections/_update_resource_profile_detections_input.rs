...
impl UpdateResourceProfileDetectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_resource_profile_detections::UpdateResourceProfileDetectionsInput, ::aws_smithy_http::operation::error::BuildError> {
