...
impl UpdateClassificationScopeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_classification_scope::UpdateClassificationScopeInput, ::aws_smithy_http::operation::error::BuildError> {
