...
impl CreateVpcConnectorInput {
    /// Consumes the builder and constructs an Operation<[`CreateVpcConnector`](crate::operation::create_vpc_connector::CreateVpcConnector)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_vpc_connector::CreateVpcConnector, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_vpc_connector::CreateVpcConnectorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_vpc_connector::CreateVpcConnector::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateVpcConnector", "apprunner"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateVpcConnector`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVpcConnector {
                type Output = ::std::result::Result<crate::operation::create_vpc_connector::CreateVpcConnectorOutput, crate::operation::create_vpc_connector::CreateVpcConnectorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_vpc_connector::de_create_vpc_connector_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_vpc_connector::de_create_vpc_connector_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_vpc_connector::CreateVpcConnectorError {
...
mod _create_vpc_connector_output;
