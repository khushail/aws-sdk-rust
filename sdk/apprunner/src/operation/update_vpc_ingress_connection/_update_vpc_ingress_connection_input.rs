...
impl UpdateVpcIngressConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_vpc_ingress_connection::UpdateVpcIngressConnectionInput, ::aws_smithy_http::operation::error::BuildError> {
