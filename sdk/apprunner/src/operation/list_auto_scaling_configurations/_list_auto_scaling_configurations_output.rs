...
impl ListAutoScalingConfigurationsOutputBuilder {
    ...
    /// <p>A list of summary information records for auto scaling configurations. In a paginated request, the request returns up to <code>MaxResults</code> records for each call.</p>
    pub fn set_auto_scaling_configuration_summary_list(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::AutoScalingConfigurationSummary>>) -> Self {
        self.auto_scaling_configuration_summary_list = input; self
    }
    /// <p>A list of summary information records for auto scaling configurations. In a paginated request, the request returns up to <code>MaxResults</code> records for each call.</p>
    pub fn get_auto_scaling_configuration_summary_list(&self) -> &::std::option::Option<::std::vec::Vec<crate::types::AutoScalingConfigurationSummary>> {
