...
impl super::Client  {
    ...
    ///   - [`task_id(impl ::std::convert::Into<String>)`](crate::operation::describe_execution::builders::DescribeExecutionFluentBuilder::task_id) / [`set_task_id(Option<String>)`](crate::operation::describe_execution::builders::DescribeExecutionFluentBuilder::set_task_id): <p>The ID of the task that the action is describing.</p>
    ///   - [`managed_device_id(impl ::std::convert::Into<String>)`](crate::operation::describe_execution::builders::DescribeExecutionFluentBuilder::managed_device_id) / [`set_managed_device_id(Option<String>)`](crate::operation::describe_execution::builders::DescribeExecutionFluentBuilder::set_managed_device_id): <p>The ID of the managed device.</p>
