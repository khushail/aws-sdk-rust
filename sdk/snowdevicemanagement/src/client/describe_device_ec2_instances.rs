...
impl super::Client  {
    ...
    ///   - [`managed_device_id(impl ::std::convert::Into<String>)`](crate::operation::describe_device_ec2_instances::builders::DescribeDeviceEc2InstancesFluentBuilder::managed_device_id) / [`set_managed_device_id(Option<String>)`](crate::operation::describe_device_ec2_instances::builders::DescribeDeviceEc2InstancesFluentBuilder::set_managed_device_id): <p>The ID of the managed device.</p>
