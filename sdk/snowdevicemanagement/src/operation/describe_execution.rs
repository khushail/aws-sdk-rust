...
impl DescribeExecutionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_execution::DescribeExecution, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_execution::DescribeExecutionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if managed_device_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("managed_device_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/task/{taskId}/execution/{managedDeviceId}", taskId = task_id, managedDeviceId = managed_device_id).expect("formatting should succeed");
