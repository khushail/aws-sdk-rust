...
impl super::Client  {
    ...
    ///   - [`workspace_id(impl ::std::convert::Into<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::workspace_id) / [`set_workspace_id(Option<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::set_workspace_id): <p>The ID of the workspace that contains the entity.</p>
    ///   - [`entity_id(impl ::std::convert::Into<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::entity_id) / [`set_entity_id(Option<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::set_entity_id): <p>The ID of the entity.</p>
    ///   - [`entity_name(impl ::std::convert::Into<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::entity_name) / [`set_entity_name(Option<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::set_entity_name): <p>The name of the entity.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::set_description): <p>The description of the entity.</p>
    ...
    ///   - [`parent_entity_id(impl ::std::convert::Into<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::parent_entity_id) / [`set_parent_entity_id(Option<String>)`](crate::operation::create_entity::builders::CreateEntityFluentBuilder::set_parent_entity_id): <p>The ID of the entity's parent entity.</p>
