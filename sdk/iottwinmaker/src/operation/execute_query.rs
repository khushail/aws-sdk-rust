...
impl ExecuteQueryInput {
    /// Consumes the builder and constructs an Operation<[`ExecuteQuery`](crate::operation::execute_query::ExecuteQuery)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::execute_query::ExecuteQuery, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::execute_query::ExecuteQueryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/queries/execution").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::execute_query::ExecuteQuery::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecuteQuery {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_execute_query::de_execute_query_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::execute_query::ExecuteQueryError {
...
impl ::aws_smithy_types::retry::ProvideErrorKind for ExecuteQueryError {
    ...
    fn retryable_error_kind(&self) -> ::std::option::Option<::aws_smithy_types::retry::ErrorKind> {
        match self {
            Self::QueryTimeoutException(inner) => ::std::option::Option::Some(inner.retryable_error_kind()),
