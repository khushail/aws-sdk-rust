...
#[allow(clippy::unnecessary_wraps)]
pub fn de_deregister_compute_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::deregister_compute::DeregisterComputeOutput, crate::operation::deregister_compute::DeregisterComputeError> {
    Ok({
        #[allow(unused_mut)]
