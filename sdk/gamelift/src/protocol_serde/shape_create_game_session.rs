...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_game_session_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_game_session::CreateGameSessionOutput, crate::operation::create_game_session::CreateGameSessionError> {
    Ok({
        #[allow(unused_mut)]
