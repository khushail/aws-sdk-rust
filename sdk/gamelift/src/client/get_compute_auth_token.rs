...
impl super::Client  {
    ...
    ///   - [`compute_name(Option<String>)`](crate::operation::get_compute_auth_token::GetComputeAuthTokenOutput::compute_name): <p>The name of the compute resource you are requesting the authentication token for.</p>
