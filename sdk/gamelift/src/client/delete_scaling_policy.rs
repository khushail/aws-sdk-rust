...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_scaling_policy::builders::DeleteScalingPolicyFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_scaling_policy::builders::DeleteScalingPolicyFluentBuilder::set_name): <p>A descriptive label that is associated with a fleet's scaling policy. Policy names do not need to be unique.</p>
