...
impl RegisterGameServerInput {
    /// Consumes the builder and constructs an Operation<[`RegisterGameServer`](crate::operation::register_game_server::RegisterGameServer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_game_server::RegisterGameServer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_game_server::RegisterGameServerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_game_server::ser_register_game_server_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_game_server::RegisterGameServer::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RegisterGameServer", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RegisterGameServer`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterGameServer {
                type Output = ::std::result::Result<crate::operation::register_game_server::RegisterGameServerOutput, crate::operation::register_game_server::RegisterGameServerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_register_game_server::de_register_game_server_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_register_game_server::de_register_game_server_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::register_game_server::RegisterGameServerError {
...
mod _register_game_server_output;
