...
impl DescribeEc2InstanceLimitsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEC2InstanceLimits`](crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimits)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimits, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_ec2_instance_limits::DescribeEc2InstanceLimitsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_ec2_instance_limits::ser_describe_ec2_instance_limits_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimits::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeEC2InstanceLimits", "gamelift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEC2InstanceLimits {
                type Output = ::std::result::Result<crate::operation::describe_ec2_instance_limits::DescribeEc2InstanceLimitsOutput, crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_ec2_instance_limits::de_describe_ec2_instance_limits_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_ec2_instance_limits::de_describe_ec2_instance_limits_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_ec2_instance_limits::DescribeEC2InstanceLimitsError {
...
mod _describe_ec2_instance_limits_output;
