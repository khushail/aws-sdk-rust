...
impl CreateFleetLocationsInput {
    /// Consumes the builder and constructs an Operation<[`CreateFleetLocations`](crate::operation::create_fleet_locations::CreateFleetLocations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_fleet_locations::CreateFleetLocations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_fleet_locations::CreateFleetLocationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_fleet_locations::ser_create_fleet_locations_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_fleet_locations::CreateFleetLocations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateFleetLocations", "gamelift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateFleetLocations {
                type Output = ::std::result::Result<crate::operation::create_fleet_locations::CreateFleetLocationsOutput, crate::operation::create_fleet_locations::CreateFleetLocationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_fleet_locations::de_create_fleet_locations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_fleet_locations::de_create_fleet_locations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_fleet_locations::CreateFleetLocationsError {
...
impl CreateFleetLocationsError {
    ...
    /// Returns `true` if the error kind is `CreateFleetLocationsError::LimitExceededException`.
...
mod _create_fleet_locations_output;
