...
impl CreateMatchmakingRuleSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSetInput, ::aws_smithy_http::operation::error::BuildError> {
