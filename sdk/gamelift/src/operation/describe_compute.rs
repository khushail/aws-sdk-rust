...
impl DescribeComputeInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCompute`](crate::operation::describe_compute::DescribeCompute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_compute::DescribeCompute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_compute::DescribeComputeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_compute::ser_describe_compute_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_compute::DescribeCompute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeCompute", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeCompute`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCompute {
                type Output = ::std::result::Result<crate::operation::describe_compute::DescribeComputeOutput, crate::operation::describe_compute::DescribeComputeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_compute::de_describe_compute_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_compute::DescribeComputeError {
