...
impl CreateMatchmakingConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`CreateMatchmakingConfiguration`](crate::operation::create_matchmaking_configuration::CreateMatchmakingConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_matchmaking_configuration::CreateMatchmakingConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_matchmaking_configuration::CreateMatchmakingConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_matchmaking_configuration::ser_create_matchmaking_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_matchmaking_configuration::CreateMatchmakingConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateMatchmakingConfiguration", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateMatchmakingConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMatchmakingConfiguration {
                type Output = ::std::result::Result<crate::operation::create_matchmaking_configuration::CreateMatchmakingConfigurationOutput, crate::operation::create_matchmaking_configuration::CreateMatchmakingConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_matchmaking_configuration::de_create_matchmaking_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_matchmaking_configuration::de_create_matchmaking_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateMatchmakingConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_matchmaking_configuration::CreateMatchmakingConfigurationError {
...
pub use crate::operation::create_matchmaking_configuration::_create_matchmaking_configuration_output::CreateMatchmakingConfigurationOutput;

pub use crate::operation::create_matchmaking_configuration::_create_matchmaking_configuration_input::CreateMatchmakingConfigurationInput;

mod _create_matchmaking_configuration_input;

mod _create_matchmaking_configuration_output;
