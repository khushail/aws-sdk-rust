...
impl CreateMatchmakingRuleSetInput {
    /// Consumes the builder and constructs an Operation<[`CreateMatchmakingRuleSet`](crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_matchmaking_rule_set::ser_create_matchmaking_rule_set_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateMatchmakingRuleSet", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateMatchmakingRuleSet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMatchmakingRuleSet {
                type Output = ::std::result::Result<crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSetOutput, crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_matchmaking_rule_set::de_create_matchmaking_rule_set_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_matchmaking_rule_set::de_create_matchmaking_rule_set_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_matchmaking_rule_set::CreateMatchmakingRuleSetError {
...
mod _create_matchmaking_rule_set_output;
