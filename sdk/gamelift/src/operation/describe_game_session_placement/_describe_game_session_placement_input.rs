...
impl DescribeGameSessionPlacementInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_game_session_placement::DescribeGameSessionPlacementInput, ::aws_smithy_http::operation::error::BuildError> {
