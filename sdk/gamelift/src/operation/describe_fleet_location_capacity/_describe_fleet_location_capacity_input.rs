...
impl DescribeFleetLocationCapacityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_fleet_location_capacity::DescribeFleetLocationCapacityInput, ::aws_smithy_http::operation::error::BuildError> {
