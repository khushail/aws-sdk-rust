...
impl UpdateGameServerInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGameServer`](crate::operation::update_game_server::UpdateGameServer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_game_server::UpdateGameServer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_game_server::UpdateGameServerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_game_server::ser_update_game_server_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_game_server::UpdateGameServer::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateGameServer", "gamelift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGameServer {
                type Output = ::std::result::Result<crate::operation::update_game_server::UpdateGameServerOutput, crate::operation::update_game_server::UpdateGameServerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_game_server::de_update_game_server_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_game_server::de_update_game_server_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_game_server::UpdateGameServerError {
...
pub use crate::operation::update_game_server::_update_game_server_output::UpdateGameServerOutput;

pub use crate::operation::update_game_server::_update_game_server_input::UpdateGameServerInput;

mod _update_game_server_input;

mod _update_game_server_output;
