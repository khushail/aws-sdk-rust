...
impl DescribeFleetEventsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetEvents`](crate::operation::describe_fleet_events::DescribeFleetEvents)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_fleet_events::DescribeFleetEvents, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_events::DescribeFleetEventsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_fleet_events::ser_describe_fleet_events_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_events::DescribeFleetEvents::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeFleetEvents", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeFleetEvents`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetEvents {
                type Output = ::std::result::Result<crate::operation::describe_fleet_events::DescribeFleetEventsOutput, crate::operation::describe_fleet_events::DescribeFleetEventsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_fleet_events::de_describe_fleet_events_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_fleet_events::de_describe_fleet_events_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_fleet_events::DescribeFleetEventsError {
...
mod _describe_fleet_events_output;
