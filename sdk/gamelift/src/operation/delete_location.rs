...
impl DeleteLocationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLocation`](crate::operation::delete_location::DeleteLocation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_location::DeleteLocation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_location::DeleteLocationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_location::DeleteLocation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteLocation", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteLocation`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLocation {
                type Output = ::std::result::Result<crate::operation::delete_location::DeleteLocationOutput, crate::operation::delete_location::DeleteLocationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_location::de_delete_location_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_location::de_delete_location_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_location::DeleteLocationError {
