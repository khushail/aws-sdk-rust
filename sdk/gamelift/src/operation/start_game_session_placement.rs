...
impl StartGameSessionPlacementInput {
    /// Consumes the builder and constructs an Operation<[`StartGameSessionPlacement`](crate::operation::start_game_session_placement::StartGameSessionPlacement)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_game_session_placement::StartGameSessionPlacement, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_game_session_placement::StartGameSessionPlacementInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_game_session_placement::ser_start_game_session_placement_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_game_session_placement::StartGameSessionPlacement::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartGameSessionPlacement", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartGameSessionPlacement`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartGameSessionPlacement {
                type Output = ::std::result::Result<crate::operation::start_game_session_placement::StartGameSessionPlacementOutput, crate::operation::start_game_session_placement::StartGameSessionPlacementError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_game_session_placement::de_start_game_session_placement_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_game_session_placement::de_start_game_session_placement_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_game_session_placement::StartGameSessionPlacementError {
...
mod _start_game_session_placement_output;
