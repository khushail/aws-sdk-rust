...
impl DescribeGameSessionDetailsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGameSessionDetails`](crate::operation::describe_game_session_details::DescribeGameSessionDetails)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_game_session_details::DescribeGameSessionDetails, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_game_session_details::DescribeGameSessionDetailsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_game_session_details::ser_describe_game_session_details_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_game_session_details::DescribeGameSessionDetails::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeGameSessionDetails", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeGameSessionDetails`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGameSessionDetails {
                type Output = ::std::result::Result<crate::operation::describe_game_session_details::DescribeGameSessionDetailsOutput, crate::operation::describe_game_session_details::DescribeGameSessionDetailsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_game_session_details::de_describe_game_session_details_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_game_session_details::de_describe_game_session_details_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_game_session_details::DescribeGameSessionDetailsError {
...
pub use crate::operation::describe_game_session_details::_describe_game_session_details_output::DescribeGameSessionDetailsOutput;

pub use crate::operation::describe_game_session_details::_describe_game_session_details_input::DescribeGameSessionDetailsInput;

mod _describe_game_session_details_input;

mod _describe_game_session_details_output;
