...
/// <li> <p>If the game server is running on an instance in <code>DRAINING</code> status and provided filter option does not allow placing on <code>DRAINING</code> instances.</p> </li> 
/// </ul> 
/// <p> <b>Learn more</b> </p> 
...
impl ClaimGameServerFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::claim_game_server::ClaimGameServerOutput, ::aws_smithy_http::result::SdkError<crate::operation::claim_game_server::ClaimGameServerError>>
                         {
