...
impl ListScriptsInput {
    /// Consumes the builder and constructs an Operation<[`ListScripts`](crate::operation::list_scripts::ListScripts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_scripts::ListScripts, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_scripts::ListScriptsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_scripts::ser_list_scripts_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_scripts::ListScripts::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListScripts", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListScripts`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListScripts {
                type Output = ::std::result::Result<crate::operation::list_scripts::ListScriptsOutput, crate::operation::list_scripts::ListScriptsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_scripts::de_list_scripts_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_scripts::de_list_scripts_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_scripts::ListScriptsError {
...
pub use crate::operation::list_scripts::_list_scripts_output::ListScriptsOutput;

pub use crate::operation::list_scripts::_list_scripts_input::ListScriptsInput;

mod _list_scripts_input;

mod _list_scripts_output;
