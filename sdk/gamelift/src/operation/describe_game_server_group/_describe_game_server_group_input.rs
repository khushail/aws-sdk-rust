...
impl DescribeGameServerGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_game_server_group::DescribeGameServerGroupInput, ::aws_smithy_http::operation::error::BuildError> {
