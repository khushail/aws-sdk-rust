...
impl DescribeFleetPortSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetPortSettings`](crate::operation::describe_fleet_port_settings::DescribeFleetPortSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_fleet_port_settings::DescribeFleetPortSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_port_settings::DescribeFleetPortSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_fleet_port_settings::ser_describe_fleet_port_settings_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_port_settings::DescribeFleetPortSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeFleetPortSettings", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeFleetPortSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetPortSettings {
                type Output = ::std::result::Result<crate::operation::describe_fleet_port_settings::DescribeFleetPortSettingsOutput, crate::operation::describe_fleet_port_settings::DescribeFleetPortSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_fleet_port_settings::de_describe_fleet_port_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_fleet_port_settings::de_describe_fleet_port_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_fleet_port_settings::DescribeFleetPortSettingsError {
...
mod _describe_fleet_port_settings_output;
