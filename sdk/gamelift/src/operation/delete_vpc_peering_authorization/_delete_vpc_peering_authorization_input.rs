...
impl DeleteVpcPeeringAuthorizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_vpc_peering_authorization::DeleteVpcPeeringAuthorizationInput, ::aws_smithy_http::operation::error::BuildError> {
