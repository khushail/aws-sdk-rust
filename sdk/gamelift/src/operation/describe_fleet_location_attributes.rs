...
impl DescribeFleetLocationAttributesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFleetLocationAttributes`](crate::operation::describe_fleet_location_attributes::DescribeFleetLocationAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_fleet_location_attributes::DescribeFleetLocationAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fleet_location_attributes::DescribeFleetLocationAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_fleet_location_attributes::ser_describe_fleet_location_attributes_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fleet_location_attributes::DescribeFleetLocationAttributes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeFleetLocationAttributes", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeFleetLocationAttributes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFleetLocationAttributes {
                type Output = ::std::result::Result<crate::operation::describe_fleet_location_attributes::DescribeFleetLocationAttributesOutput, crate::operation::describe_fleet_location_attributes::DescribeFleetLocationAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_fleet_location_attributes::de_describe_fleet_location_attributes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_fleet_location_attributes::de_describe_fleet_location_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeFleetLocationAttributesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_fleet_location_attributes::DescribeFleetLocationAttributesError {
...
pub use crate::operation::describe_fleet_location_attributes::_describe_fleet_location_attributes_output::DescribeFleetLocationAttributesOutput;

pub use crate::operation::describe_fleet_location_attributes::_describe_fleet_location_attributes_input::DescribeFleetLocationAttributesInput;

mod _describe_fleet_location_attributes_input;

mod _describe_fleet_location_attributes_output;
