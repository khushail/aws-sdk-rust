...
impl StopGameSessionPlacementInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_game_session_placement::StopGameSessionPlacementInput, ::aws_smithy_http::operation::error::BuildError> {
