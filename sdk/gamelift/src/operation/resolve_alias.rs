...
impl ResolveAliasInput {
    /// Consumes the builder and constructs an Operation<[`ResolveAlias`](crate::operation::resolve_alias::ResolveAlias)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::resolve_alias::ResolveAlias, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resolve_alias::ResolveAliasInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_resolve_alias::ser_resolve_alias_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::resolve_alias::ResolveAlias::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResolveAlias", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ResolveAlias`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResolveAlias {
                type Output = ::std::result::Result<crate::operation::resolve_alias::ResolveAliasOutput, crate::operation::resolve_alias::ResolveAliasError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_resolve_alias::de_resolve_alias_http_response_with_props(status, headers, body)
                     }
                }
