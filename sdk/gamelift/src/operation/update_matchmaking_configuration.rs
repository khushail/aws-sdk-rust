...
impl UpdateMatchmakingConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`UpdateMatchmakingConfiguration`](crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_matchmaking_configuration::ser_update_matchmaking_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateMatchmakingConfiguration", "gamelift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateMatchmakingConfiguration {
                type Output = ::std::result::Result<crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfigurationOutput, crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_matchmaking_configuration::de_update_matchmaking_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_matchmaking_configuration::de_update_matchmaking_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateMatchmakingConfigurationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_matchmaking_configuration::UpdateMatchmakingConfigurationError {
...
mod _update_matchmaking_configuration_output;
