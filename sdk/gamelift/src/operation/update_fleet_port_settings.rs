...
impl UpdateFleetPortSettingsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFleetPortSettings`](crate::operation::update_fleet_port_settings::UpdateFleetPortSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_fleet_port_settings::UpdateFleetPortSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_fleet_port_settings::UpdateFleetPortSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_fleet_port_settings::ser_update_fleet_port_settings_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_fleet_port_settings::UpdateFleetPortSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateFleetPortSettings", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateFleetPortSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFleetPortSettings {
                type Output = ::std::result::Result<crate::operation::update_fleet_port_settings::UpdateFleetPortSettingsOutput, crate::operation::update_fleet_port_settings::UpdateFleetPortSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_fleet_port_settings::de_update_fleet_port_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_fleet_port_settings::de_update_fleet_port_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_fleet_port_settings::UpdateFleetPortSettingsError {
...
mod _update_fleet_port_settings_output;
