...
impl StartFleetActionsInput {
    /// Consumes the builder and constructs an Operation<[`StartFleetActions`](crate::operation::start_fleet_actions::StartFleetActions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_fleet_actions::StartFleetActions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_fleet_actions::StartFleetActionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_start_fleet_actions::ser_start_fleet_actions_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_fleet_actions::StartFleetActions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartFleetActions", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartFleetActions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartFleetActions {
                type Output = ::std::result::Result<crate::operation::start_fleet_actions::StartFleetActionsOutput, crate::operation::start_fleet_actions::StartFleetActionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_fleet_actions::de_start_fleet_actions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_fleet_actions::de_start_fleet_actions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_fleet_actions::StartFleetActionsError {
...
mod _start_fleet_actions_output;
