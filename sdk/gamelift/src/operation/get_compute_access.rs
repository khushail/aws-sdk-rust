...
impl GetComputeAccessInput {
    /// Consumes the builder and constructs an Operation<[`GetComputeAccess`](crate::operation::get_compute_access::GetComputeAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_compute_access::GetComputeAccess, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_compute_access::GetComputeAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_compute_access::ser_get_compute_access_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_compute_access::GetComputeAccess::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetComputeAccess", "gamelift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetComputeAccess`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetComputeAccess {
                type Output = ::std::result::Result<crate::operation::get_compute_access::GetComputeAccessOutput, crate::operation::get_compute_access::GetComputeAccessError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_compute_access::de_get_compute_access_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_compute_access::de_get_compute_access_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_compute_access::GetComputeAccessError {
...
mod _get_compute_access_output;
