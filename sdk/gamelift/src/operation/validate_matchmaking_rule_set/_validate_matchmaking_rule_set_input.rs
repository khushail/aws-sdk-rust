...
impl ValidateMatchmakingRuleSetInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::validate_matchmaking_rule_set::ValidateMatchmakingRuleSetInput, ::aws_smithy_http::operation::error::BuildError> {
