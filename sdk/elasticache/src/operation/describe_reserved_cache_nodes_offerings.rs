...
impl DescribeReservedCacheNodesOfferingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReservedCacheNodesOfferings`](crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_reserved_cache_nodes_offerings_input::ser_describe_reserved_cache_nodes_offerings_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeReservedCacheNodesOfferings", "elasticache"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeReservedCacheNodesOfferings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedCacheNodesOfferings {
                type Output = ::std::result::Result<crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsOutput, crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_reserved_cache_nodes_offerings::de_describe_reserved_cache_nodes_offerings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_reserved_cache_nodes_offerings::de_describe_reserved_cache_nodes_offerings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_reserved_cache_nodes_offerings::DescribeReservedCacheNodesOfferingsError {
...
mod _describe_reserved_cache_nodes_offerings_output;
