...
impl DisassociateGlobalReplicationGroupInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateGlobalReplicationGroup`](crate::operation::disassociate_global_replication_group::DisassociateGlobalReplicationGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_global_replication_group::DisassociateGlobalReplicationGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_global_replication_group::DisassociateGlobalReplicationGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_global_replication_group_input::ser_disassociate_global_replication_group_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_global_replication_group::DisassociateGlobalReplicationGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateGlobalReplicationGroup", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateGlobalReplicationGroup {
                type Output = ::std::result::Result<crate::operation::disassociate_global_replication_group::DisassociateGlobalReplicationGroupOutput, crate::operation::disassociate_global_replication_group::DisassociateGlobalReplicationGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_global_replication_group::de_disassociate_global_replication_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_global_replication_group::de_disassociate_global_replication_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_global_replication_group::DisassociateGlobalReplicationGroupError {
...
mod _disassociate_global_replication_group_output;
