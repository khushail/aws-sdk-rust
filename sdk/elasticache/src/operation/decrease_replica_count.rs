...
impl DecreaseReplicaCountInput {
    /// Consumes the builder and constructs an Operation<[`DecreaseReplicaCount`](crate::operation::decrease_replica_count::DecreaseReplicaCount)>
    #[allow(unused_mut)]
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::decrease_replica_count::DecreaseReplicaCount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::decrease_replica_count::DecreaseReplicaCountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for DecreaseReplicaCount {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_decrease_replica_count::de_decrease_replica_count_http_response_with_props(status, headers, body)
                     }
                }
...
pub use crate::operation::decrease_replica_count::_decrease_replica_count_output::DecreaseReplicaCountOutput;

pub use crate::operation::decrease_replica_count::_decrease_replica_count_input::DecreaseReplicaCountInput;

mod _decrease_replica_count_input;

mod _decrease_replica_count_output;
