...
impl BatchStopUpdateActionInput {
    /// Consumes the builder and constructs an Operation<[`BatchStopUpdateAction`](crate::operation::batch_stop_update_action::BatchStopUpdateAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_stop_update_action::BatchStopUpdateAction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_stop_update_action::BatchStopUpdateActionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::batch_stop_update_action::BatchStopUpdateActionInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_stop_update_action_input::ser_batch_stop_update_action_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_stop_update_action::BatchStopUpdateAction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchStopUpdateAction", "elasticache"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchStopUpdateAction`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchStopUpdateAction {
                type Output = ::std::result::Result<crate::operation::batch_stop_update_action::BatchStopUpdateActionOutput, crate::operation::batch_stop_update_action::BatchStopUpdateActionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_stop_update_action::de_batch_stop_update_action_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_stop_update_action::de_batch_stop_update_action_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_stop_update_action::BatchStopUpdateActionError {
...
mod _batch_stop_update_action_output;
