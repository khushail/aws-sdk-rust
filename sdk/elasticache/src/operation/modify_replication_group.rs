...
impl ModifyReplicationGroupInput {
    /// Consumes the builder and constructs an Operation<[`ModifyReplicationGroup`](crate::operation::modify_replication_group::ModifyReplicationGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_replication_group::ModifyReplicationGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_replication_group::ModifyReplicationGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_replication_group_input::ser_modify_replication_group_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_replication_group::ModifyReplicationGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyReplicationGroup", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyReplicationGroup {
                type Output = ::std::result::Result<crate::operation::modify_replication_group::ModifyReplicationGroupOutput, crate::operation::modify_replication_group::ModifyReplicationGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_modify_replication_group::de_modify_replication_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_replication_group::ModifyReplicationGroupError {
