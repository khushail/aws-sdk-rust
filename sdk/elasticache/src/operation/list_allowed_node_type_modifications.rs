...
impl ListAllowedNodeTypeModificationsInput {
    /// Consumes the builder and constructs an Operation<[`ListAllowedNodeTypeModifications`](crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModifications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModifications, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModificationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModificationsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_allowed_node_type_modifications_input::ser_list_allowed_node_type_modifications_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModifications::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAllowedNodeTypeModifications", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAllowedNodeTypeModifications {
                type Output = ::std::result::Result<crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModificationsOutput, crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModificationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_allowed_node_type_modifications::de_list_allowed_node_type_modifications_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_allowed_node_type_modifications::de_list_allowed_node_type_modifications_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModificationsError {
...
pub use crate::operation::list_allowed_node_type_modifications::_list_allowed_node_type_modifications_output::ListAllowedNodeTypeModificationsOutput;

pub use crate::operation::list_allowed_node_type_modifications::_list_allowed_node_type_modifications_input::ListAllowedNodeTypeModificationsInput;

mod _list_allowed_node_type_modifications_input;

mod _list_allowed_node_type_modifications_output;
