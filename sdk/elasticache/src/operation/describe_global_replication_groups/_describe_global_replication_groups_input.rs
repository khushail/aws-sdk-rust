...
impl DescribeGlobalReplicationGroupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_global_replication_groups::DescribeGlobalReplicationGroupsInput, ::aws_smithy_http::operation::error::BuildError> {
