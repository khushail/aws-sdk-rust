...
impl CreateGlobalReplicationGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateGlobalReplicationGroup`](crate::operation::create_global_replication_group::CreateGlobalReplicationGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_global_replication_group::CreateGlobalReplicationGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_global_replication_group::CreateGlobalReplicationGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_global_replication_group_input::ser_create_global_replication_group_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_global_replication_group::CreateGlobalReplicationGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateGlobalReplicationGroup", "elasticache"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateGlobalReplicationGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateGlobalReplicationGroup {
                type Output = ::std::result::Result<crate::operation::create_global_replication_group::CreateGlobalReplicationGroupOutput, crate::operation::create_global_replication_group::CreateGlobalReplicationGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_global_replication_group::de_create_global_replication_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_global_replication_group::de_create_global_replication_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_global_replication_group::CreateGlobalReplicationGroupError {
...
mod _create_global_replication_group_output;
