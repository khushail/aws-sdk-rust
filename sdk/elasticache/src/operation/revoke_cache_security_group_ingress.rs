...
impl RevokeCacheSecurityGroupIngressInput {
    /// Consumes the builder and constructs an Operation<[`RevokeCacheSecurityGroupIngress`](crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngress)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngress, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_cache_security_group_ingress_input::ser_revoke_cache_security_group_ingress_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngress::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RevokeCacheSecurityGroupIngress", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeCacheSecurityGroupIngress {
                type Output = ::std::result::Result<crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressOutput, crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_revoke_cache_security_group_ingress::de_revoke_cache_security_group_ingress_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_revoke_cache_security_group_ingress::de_revoke_cache_security_group_ingress_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::revoke_cache_security_group_ingress::RevokeCacheSecurityGroupIngressError {
...
mod _revoke_cache_security_group_ingress_output;
