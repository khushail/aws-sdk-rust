...
impl DescribeCacheSecurityGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCacheSecurityGroups`](crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_cache_security_groups_input::ser_describe_cache_security_groups_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroups::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeCacheSecurityGroups", "elasticache"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeCacheSecurityGroups`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCacheSecurityGroups {
                type Output = ::std::result::Result<crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsOutput, crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_cache_security_groups::de_describe_cache_security_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_cache_security_groups::de_describe_cache_security_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_cache_security_groups::DescribeCacheSecurityGroupsError {
...
mod _describe_cache_security_groups_output;
