...
impl CompleteMigrationInput {
    /// Consumes the builder and constructs an Operation<[`CompleteMigration`](crate::operation::complete_migration::CompleteMigration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::complete_migration::CompleteMigration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::complete_migration::CompleteMigrationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_complete_migration_input::ser_complete_migration_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::complete_migration::CompleteMigration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CompleteMigration", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CompleteMigration {
                type Output = ::std::result::Result<crate::operation::complete_migration::CompleteMigrationOutput, crate::operation::complete_migration::CompleteMigrationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_complete_migration::de_complete_migration_http_response_with_props(status, headers, body)
                     }
                }
