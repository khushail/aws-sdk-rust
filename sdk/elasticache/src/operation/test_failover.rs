...
impl TestFailoverInput {
    /// Consumes the builder and constructs an Operation<[`TestFailover`](crate::operation::test_failover::TestFailover)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::test_failover::TestFailover, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::test_failover::TestFailoverInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_test_failover_input::ser_test_failover_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::test_failover::TestFailover::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("TestFailover", "elasticache"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for TestFailover {
                type Output = ::std::result::Result<crate::operation::test_failover::TestFailoverOutput, crate::operation::test_failover::TestFailoverError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_test_failover::de_test_failover_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::test_failover::TestFailoverError {
