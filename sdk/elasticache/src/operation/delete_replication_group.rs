...
impl DeleteReplicationGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteReplicationGroup`](crate::operation::delete_replication_group::DeleteReplicationGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_replication_group::DeleteReplicationGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_replication_group::DeleteReplicationGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_replication_group::DeleteReplicationGroupInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_replication_group_input::ser_delete_replication_group_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_replication_group::DeleteReplicationGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteReplicationGroup", "elasticache"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteReplicationGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReplicationGroup {
                type Output = ::std::result::Result<crate::operation::delete_replication_group::DeleteReplicationGroupOutput, crate::operation::delete_replication_group::DeleteReplicationGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_replication_group::de_delete_replication_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_replication_group::de_delete_replication_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_replication_group::DeleteReplicationGroupError {
...
mod _delete_replication_group_output;
