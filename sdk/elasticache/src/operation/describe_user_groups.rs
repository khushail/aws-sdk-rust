...
impl DescribeUserGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeUserGroups`](crate::operation::describe_user_groups::DescribeUserGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_user_groups::DescribeUserGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_user_groups::DescribeUserGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_user_groups::DescribeUserGroupsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_user_groups_input::ser_describe_user_groups_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_user_groups::DescribeUserGroups::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeUserGroups", "elasticache"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeUserGroups`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUserGroups {
                type Output = ::std::result::Result<crate::operation::describe_user_groups::DescribeUserGroupsOutput, crate::operation::describe_user_groups::DescribeUserGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_user_groups::de_describe_user_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_user_groups::de_describe_user_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_user_groups::DescribeUserGroupsError {
...
pub use crate::operation::describe_user_groups::_describe_user_groups_output::DescribeUserGroupsOutput;

pub use crate::operation::describe_user_groups::_describe_user_groups_input::DescribeUserGroupsInput;

mod _describe_user_groups_input;

mod _describe_user_groups_output;
