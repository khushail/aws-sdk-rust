...
impl ModifyGlobalReplicationGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_global_replication_group::ModifyGlobalReplicationGroupInput, ::aws_smithy_http::operation::error::BuildError> {
