...
impl super::Client  {
    ...
    ///   - [`user_group_id(impl ::std::convert::Into<String>)`](crate::operation::describe_user_groups::builders::DescribeUserGroupsFluentBuilder::user_group_id) / [`set_user_group_id(Option<String>)`](crate::operation::describe_user_groups::builders::DescribeUserGroupsFluentBuilder::set_user_group_id): <p>The ID of the user group.</p>
