...
impl super::Client  {
    ...
    ///   - [`cache_parameter_group_name(impl ::std::convert::Into<String>)`](crate::operation::reset_cache_parameter_group::builders::ResetCacheParameterGroupFluentBuilder::cache_parameter_group_name) / [`set_cache_parameter_group_name(Option<String>)`](crate::operation::reset_cache_parameter_group::builders::ResetCacheParameterGroupFluentBuilder::set_cache_parameter_group_name): <p>The name of the cache parameter group to reset.</p>
