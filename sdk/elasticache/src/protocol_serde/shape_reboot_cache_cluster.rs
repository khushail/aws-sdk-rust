...
pub fn de_reboot_cache_cluster_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::reboot_cache_cluster::RebootCacheClusterOutput, crate::operation::reboot_cache_cluster::RebootCacheClusterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::reboot_cache_cluster::RebootCacheClusterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_reboot_cache_cluster_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::reboot_cache_cluster::RebootCacheClusterOutput, crate::operation::reboot_cache_cluster::RebootCacheClusterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::reboot_cache_cluster::builders::RebootCacheClusterOutputBuilder::default();
        output = crate::protocol_serde::shape_reboot_cache_cluster::de_reboot_cache_cluster(_response_body, output).map_err(crate::operation::reboot_cache_cluster::RebootCacheClusterError::unhandled)?;
