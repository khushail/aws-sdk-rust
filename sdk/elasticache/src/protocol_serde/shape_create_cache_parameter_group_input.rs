...
pub fn ser_create_cache_parameter_group_input_input(input: &crate::operation::create_cache_parameter_group::CreateCacheParameterGroupInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("CacheParameterGroupFamily");
    if let Some(var_4) = &input.cache_parameter_group_family {
