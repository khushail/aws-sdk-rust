...
pub fn ser_list_allowed_node_type_modifications_input_input(input: &crate::operation::list_allowed_node_type_modifications::ListAllowedNodeTypeModificationsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
