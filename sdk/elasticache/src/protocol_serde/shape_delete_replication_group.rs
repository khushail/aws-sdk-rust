...
pub fn de_delete_replication_group_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_replication_group::DeleteReplicationGroupOutput, crate::operation::delete_replication_group::DeleteReplicationGroupError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_replication_group_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_replication_group::DeleteReplicationGroupOutput, crate::operation::delete_replication_group::DeleteReplicationGroupError> {
    Ok({
        #[allow(unused_mut)]
