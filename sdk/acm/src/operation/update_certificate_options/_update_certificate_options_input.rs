...
impl UpdateCertificateOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_certificate_options::UpdateCertificateOptionsInput, ::aws_smithy_http::operation::error::BuildError> {
