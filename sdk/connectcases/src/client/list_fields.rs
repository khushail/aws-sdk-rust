...
impl super::Client  {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::list_fields::builders::ListFieldsFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::list_fields::builders::ListFieldsFluentBuilder::set_domain_id): <p>The unique identifier of the Cases domain. </p>
