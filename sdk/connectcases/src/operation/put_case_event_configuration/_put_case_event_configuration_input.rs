...
impl PutCaseEventConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_case_event_configuration::PutCaseEventConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
