...
impl BatchPutFieldOptionsInput {
    /// Consumes the builder and constructs an Operation<[`BatchPutFieldOptions`](crate::operation::batch_put_field_options::BatchPutFieldOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_put_field_options::BatchPutFieldOptions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_put_field_options::BatchPutFieldOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if field_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("field_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/domains/{domainId}/fields/{fieldId}/options", domainId = domain_id, fieldId = field_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_put_field_options::BatchPutFieldOptions::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchPutFieldOptions {
                type Output = ::std::result::Result<crate::operation::batch_put_field_options::BatchPutFieldOptionsOutput, crate::operation::batch_put_field_options::BatchPutFieldOptionsError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_put_field_options::BatchPutFieldOptionsError {
...
mod _batch_put_field_options_output;
