...
impl BatchGetFieldInput {
    /// Consumes the builder and constructs an Operation<[`BatchGetField`](crate::operation::batch_get_field::BatchGetField)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_get_field::BatchGetField, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_get_field::BatchGetFieldInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/domains/{domainId}/fields-batch", domainId = domain_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_get_field::BatchGetField::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchGetField", "connectcases"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchGetField`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchGetField {
                type Output = ::std::result::Result<crate::operation::batch_get_field::BatchGetFieldOutput, crate::operation::batch_get_field::BatchGetFieldError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_get_field::de_batch_get_field_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_get_field::de_batch_get_field_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_get_field::BatchGetFieldError {
