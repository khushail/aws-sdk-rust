...
impl ListBundlesInput {
    /// Consumes the builder and constructs an Operation<[`ListBundles`](crate::operation::list_bundles::ListBundles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_bundles::ListBundles, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_bundles::ListBundlesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/bundles").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_bundles::ListBundlesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_bundles::ListBundlesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_bundles::ListBundles::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBundles {
                type Output = ::std::result::Result<crate::operation::list_bundles::ListBundlesOutput, crate::operation::list_bundles::ListBundlesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_bundles::de_list_bundles_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_bundles::de_list_bundles_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_bundles::ListBundlesError {
...
pub use crate::operation::list_bundles::_list_bundles_output::ListBundlesOutput;

pub use crate::operation::list_bundles::_list_bundles_input::ListBundlesInput;

mod _list_bundles_input;

mod _list_bundles_output;
