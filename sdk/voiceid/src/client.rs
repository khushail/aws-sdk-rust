...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_voiceid::Error> {
...
mod describe_fraudster_registration_job;

mod describe_speaker;
...
mod start_fraudster_registration_job;

mod start_speaker_enrollment_job;
