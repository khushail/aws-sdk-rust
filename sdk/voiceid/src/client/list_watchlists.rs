...
impl super::Client  {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder::set_domain_id): <p>The identifier of the domain.</p>
    ///   - [`max_results(i32)`](crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder::set_max_results): <p>The maximum number of results that are returned per call. You can use <code>NextToken</code> to obtain more pages of results. The default is 100; the maximum allowed page size is also 100. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_watchlists::builders::ListWatchlistsFluentBuilder::set_next_token): <p>If <code>NextToken</code> is returned, there are more results available. The value of <code>NextToken</code> is a unique pagination token for each page. Make the call again using the returned token to retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 24 hours. </p>
