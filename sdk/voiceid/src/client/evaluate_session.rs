...
impl super::Client  {
    ...
    ///   - [`domain_id(impl ::std::convert::Into<String>)`](crate::operation::evaluate_session::builders::EvaluateSessionFluentBuilder::domain_id) / [`set_domain_id(Option<String>)`](crate::operation::evaluate_session::builders::EvaluateSessionFluentBuilder::set_domain_id): <p>The identifier of the domain where the session started.</p>
    ///   - [`session_name_or_id(impl ::std::convert::Into<String>)`](crate::operation::evaluate_session::builders::EvaluateSessionFluentBuilder::session_name_or_id) / [`set_session_name_or_id(Option<String>)`](crate::operation::evaluate_session::builders::EvaluateSessionFluentBuilder::set_session_name_or_id): <p>The session identifier, or name of the session, that you want to evaluate. In Voice ID integration, this is the Contact-Id.</p>
