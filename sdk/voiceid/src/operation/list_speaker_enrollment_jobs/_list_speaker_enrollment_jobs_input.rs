...
impl ListSpeakerEnrollmentJobsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_speaker_enrollment_jobs::ListSpeakerEnrollmentJobsInput, ::aws_smithy_http::operation::error::BuildError> {
