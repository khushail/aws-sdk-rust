...
impl CreateWatchlistInput {
    /// Consumes the builder and constructs an Operation<[`CreateWatchlist`](crate::operation::create_watchlist::CreateWatchlist)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_watchlist::CreateWatchlist, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_watchlist::CreateWatchlistInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_watchlist::ser_create_watchlist_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_watchlist::CreateWatchlist::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateWatchlist", "voiceid"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateWatchlist {
                type Output = ::std::result::Result<crate::operation::create_watchlist::CreateWatchlistOutput, crate::operation::create_watchlist::CreateWatchlistError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_watchlist::de_create_watchlist_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_watchlist::de_create_watchlist_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateWatchlistErrorKind = CreateWatchlistError;
/// Error type for the `CreateWatchlistError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreateWatchlistError {
...
impl ::std::fmt::Display for CreateWatchlistError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateWatchlistError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_watchlist::CreateWatchlistError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for CreateWatchlistError {
...
impl CreateWatchlistError {
    /// Creates the `CreateWatchlistError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateWatchlistError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateWatchlistError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CreateWatchlistError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `CreateWatchlistError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `CreateWatchlistError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateWatchlistError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateWatchlistError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `CreateWatchlistError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for CreateWatchlistError {
