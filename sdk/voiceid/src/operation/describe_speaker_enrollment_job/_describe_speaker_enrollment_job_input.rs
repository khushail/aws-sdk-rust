...
impl DescribeSpeakerEnrollmentJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_speaker_enrollment_job::DescribeSpeakerEnrollmentJobInput, ::aws_smithy_http::operation::error::BuildError> {
