...
impl StartSpeakerEnrollmentJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_speaker_enrollment_job::StartSpeakerEnrollmentJobInput, ::aws_smithy_http::operation::error::BuildError> {
