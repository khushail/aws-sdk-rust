...
impl GetMediaForFragmentListInput {
    /// Consumes the builder and constructs an Operation<[`GetMediaForFragmentList`](crate::operation::get_media_for_fragment_list::GetMediaForFragmentList)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_media_for_fragment_list::GetMediaForFragmentList, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_media_for_fragment_list::GetMediaForFragmentListInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_media_for_fragment_list::GetMediaForFragmentList::new())
...
impl ::aws_smithy_http::response::ParseHttpResponse for GetMediaForFragmentList {
                type Output = ::std::result::Result<crate::operation::get_media_for_fragment_list::GetMediaForFragmentListOutput, crate::operation::get_media_for_fragment_list::GetMediaForFragmentListError>;
                fn parse_unloaded(&self, response: &mut ::aws_smithy_http::operation::Response) -> ::std::option::Option<Self::Output> {
                    ...
                    ::std::option::Option::Some(crate::protocol_serde::shape_get_media_for_fragment_list::de_get_media_for_fragment_list_op_response(response))
                }
                fn parse_loaded(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_get_media_for_fragment_list::de_get_media_for_fragment_list_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_media_for_fragment_list::GetMediaForFragmentListError {
