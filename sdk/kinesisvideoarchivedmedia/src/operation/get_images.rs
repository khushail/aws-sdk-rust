...
impl GetImagesInput {
    /// Consumes the builder and constructs an Operation<[`GetImages`](crate::operation::get_images::GetImages)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_images::GetImages, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_images::GetImagesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/getImages").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_images::GetImages::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetImages", "kinesisvideoarchivedmedia"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetImages`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetImages {
                type Output = ::std::result::Result<crate::operation::get_images::GetImagesOutput, crate::operation::get_images::GetImagesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_images::de_get_images_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_images::de_get_images_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_images::GetImagesError {
...
pub use crate::operation::get_images::_get_images_output::GetImagesOutput;

pub use crate::operation::get_images::_get_images_input::GetImagesInput;

mod _get_images_input;

mod _get_images_output;
