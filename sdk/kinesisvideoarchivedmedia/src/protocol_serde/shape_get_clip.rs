...
pub fn de_get_clip_op_response(op_response: &mut ::aws_smithy_http::operation::Response) -> ::std::result::Result<crate::operation::get_clip::GetClipOutput, crate::operation::get_clip::GetClipError> {
    #[allow(unused_variables)]
    let (response, properties) = op_response.parts_mut();
    crate::protocol_serde::shape_get_clip::de_get_clip_http_response_with_props(response, &properties)
}
...
#[allow(clippy::unnecessary_wraps)]
#[allow(unused_variables)]
pub fn de_get_clip_http_response_with_props(response: &mut ::http::Response<::aws_smithy_http::body::SdkBody>, properties: &::aws_smithy_http::property_bag::PropertyBag) -> std::result::Result<crate::operation::get_clip::GetClipOutput, crate::operation::get_clip::GetClipError> {
