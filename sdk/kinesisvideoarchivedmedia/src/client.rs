...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_kinesisvideoarchivedmedia::Error> {
/// # let client: aws_sdk_kinesisvideoarchivedmedia::Client = unimplemented!();
...
mod get_dash_streaming_session_url;

mod get_hls_streaming_session_url;

mod get_images;

mod get_media_for_fragment_list;
