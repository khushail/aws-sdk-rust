...
impl PutRecommendationFeedbackInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_recommendation_feedback::PutRecommendationFeedbackInput, ::aws_smithy_http::operation::error::BuildError> {
