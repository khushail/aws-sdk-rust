...
impl DescribeRepositoryAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_repository_association::DescribeRepositoryAssociationInput, ::aws_smithy_http::operation::error::BuildError> {
