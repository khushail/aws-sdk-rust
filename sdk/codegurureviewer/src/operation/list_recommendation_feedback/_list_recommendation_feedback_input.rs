...
impl ListRecommendationFeedbackInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_recommendation_feedback::ListRecommendationFeedbackInput, ::aws_smithy_http::operation::error::BuildError> {
