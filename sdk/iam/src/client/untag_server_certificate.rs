...
impl super::Client  {
    ...
    ///   - [`server_certificate_name(impl ::std::convert::Into<String>)`](crate::operation::untag_server_certificate::builders::UntagServerCertificateFluentBuilder::server_certificate_name) / [`set_server_certificate_name(Option<String>)`](crate::operation::untag_server_certificate::builders::UntagServerCertificateFluentBuilder::set_server_certificate_name): <p>The name of the IAM server certificate from which you want to remove tags.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
