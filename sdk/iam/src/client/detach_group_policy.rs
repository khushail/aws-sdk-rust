...
impl super::Client  {
    ...
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::detach_group_policy::builders::DetachGroupPolicyFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::detach_group_policy::builders::DetachGroupPolicyFluentBuilder::set_group_name): <p>The name (friendly name, not ARN) of the IAM group to detach the policy from.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
