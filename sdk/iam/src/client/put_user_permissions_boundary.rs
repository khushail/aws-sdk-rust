...
impl super::Client  {
    ...
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::put_user_permissions_boundary::builders::PutUserPermissionsBoundaryFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::put_user_permissions_boundary::builders::PutUserPermissionsBoundaryFluentBuilder::set_user_name): <p>The name (friendly name, not ARN) of the IAM user for which you want to set the permissions boundary.</p>
