...
impl super::Client  {
    ...
    ///   - [`server_certificate_name(impl ::std::convert::Into<String>)`](crate::operation::tag_server_certificate::builders::TagServerCertificateFluentBuilder::server_certificate_name) / [`set_server_certificate_name(Option<String>)`](crate::operation::tag_server_certificate::builders::TagServerCertificateFluentBuilder::set_server_certificate_name): <p>The name of the IAM server certificate to which you want to add tags.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
