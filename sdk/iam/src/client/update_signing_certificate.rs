...
impl super::Client  {
    ...
    ///   - [`user_name(impl ::std::convert::Into<String>)`](crate::operation::update_signing_certificate::builders::UpdateSigningCertificateFluentBuilder::user_name) / [`set_user_name(Option<String>)`](crate::operation::update_signing_certificate::builders::UpdateSigningCertificateFluentBuilder::set_user_name): <p>The name of the IAM user the signing certificate belongs to.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
    ///   - [`certificate_id(impl ::std::convert::Into<String>)`](crate::operation::update_signing_certificate::builders::UpdateSigningCertificateFluentBuilder::certificate_id) / [`set_certificate_id(Option<String>)`](crate::operation::update_signing_certificate::builders::UpdateSigningCertificateFluentBuilder::set_certificate_id): <p>The ID of the signing certificate you want to update.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters that can consist of any upper or lowercased letter or digit.</p>
