...
impl super::Client  {
    ...
    ///   - [`role_name(impl ::std::convert::Into<String>)`](crate::operation::delete_role::builders::DeleteRoleFluentBuilder::role_name) / [`set_role_name(Option<String>)`](crate::operation::delete_role::builders::DeleteRoleFluentBuilder::set_role_name): <p>The name of the role to delete.</p>  <p>This parameter allows (through its <a href="http://wikipedia.org/wiki/regex">regex pattern</a>) a string of characters consisting of upper and lowercase alphanumeric characters with no spaces. You can also include any of the following characters: _+=,.@-</p>
