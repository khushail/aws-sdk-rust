...
pub fn ser_create_role_input_input(input: &crate::operation::create_role::CreateRoleInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
