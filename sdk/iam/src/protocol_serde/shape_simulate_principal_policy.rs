...
#[allow(clippy::unnecessary_wraps)]
pub fn de_simulate_principal_policy_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::simulate_principal_policy::SimulatePrincipalPolicyOutput, crate::operation::simulate_principal_policy::SimulatePrincipalPolicyError> {
    Ok({
        #[allow(unused_mut)]
