...
pub fn ser_get_role_policy_input_input(input: &crate::operation::get_role_policy::GetRolePolicyInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
