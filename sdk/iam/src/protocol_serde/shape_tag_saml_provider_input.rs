...
pub fn ser_tag_saml_provider_input_input(input: &crate::operation::tag_saml_provider::TagSamlProviderInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
