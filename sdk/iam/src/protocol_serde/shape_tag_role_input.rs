...
pub fn ser_tag_role_input_input(input: &crate::operation::tag_role::TagRoleInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
