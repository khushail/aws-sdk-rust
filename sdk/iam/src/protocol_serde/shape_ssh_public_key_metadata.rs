...
pub fn de_ssh_public_key_metadata(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::SshPublicKeyMetadata, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
