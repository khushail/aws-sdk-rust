...
pub fn de_list_mfa_devices_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_mfa_devices::ListMfaDevicesOutput, crate::operation::list_mfa_devices::ListMFADevicesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::list_mfa_devices::ListMFADevicesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_mfa_devices_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_mfa_devices::ListMfaDevicesOutput, crate::operation::list_mfa_devices::ListMFADevicesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::list_mfa_devices::builders::ListMfaDevicesOutputBuilder::default();
        output = crate::protocol_serde::shape_list_mfa_devices::de_list_mfa_devices(_response_body, output).map_err(crate::operation::list_mfa_devices::ListMFADevicesError::unhandled)?;
...
#[allow(unused_mut)]
pub fn de_list_mfa_devices(inp: &[u8], mut builder: crate::operation::list_mfa_devices::builders::ListMfaDevicesOutputBuilder) -> Result<crate::operation::list_mfa_devices::builders::ListMfaDevicesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("ListMFADevicesResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected ListMFADevicesResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("ListMFADevicesResult")) {
                            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected ListMFADevicesResult got {:?}", start_el)))
                        }
