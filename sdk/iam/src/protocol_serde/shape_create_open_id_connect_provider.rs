...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_open_id_connect_provider_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderOutput, crate::operation::create_open_id_connect_provider::CreateOpenIDConnectProviderError> {
    Ok({
        #[allow(unused_mut)]
