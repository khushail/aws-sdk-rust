...
pub fn ser_list_attached_group_policies_input_input(input: &crate::operation::list_attached_group_policies::ListAttachedGroupPoliciesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
