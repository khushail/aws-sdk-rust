...
impl ListUserTagsInput {
    /// Consumes the builder and constructs an Operation<[`ListUserTags`](crate::operation::list_user_tags::ListUserTags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_user_tags::ListUserTags, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_user_tags::ListUserTagsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_user_tags_input::ser_list_user_tags_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_user_tags::ListUserTags::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListUserTags", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListUserTags {
                type Output = ::std::result::Result<crate::operation::list_user_tags::ListUserTagsOutput, crate::operation::list_user_tags::ListUserTagsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_user_tags::de_list_user_tags_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_user_tags::ListUserTagsError {
