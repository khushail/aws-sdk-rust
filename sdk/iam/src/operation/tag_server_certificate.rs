...
impl TagServerCertificateInput {
    /// Consumes the builder and constructs an Operation<[`TagServerCertificate`](crate::operation::tag_server_certificate::TagServerCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::tag_server_certificate::TagServerCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::tag_server_certificate::TagServerCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::tag_server_certificate::TagServerCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("TagServerCertificate", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for TagServerCertificate {
                type Output = ::std::result::Result<crate::operation::tag_server_certificate::TagServerCertificateOutput, crate::operation::tag_server_certificate::TagServerCertificateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_tag_server_certificate::de_tag_server_certificate_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::tag_server_certificate::TagServerCertificateError {
