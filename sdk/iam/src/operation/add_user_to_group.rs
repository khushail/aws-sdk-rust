...
impl AddUserToGroupInput {
    /// Consumes the builder and constructs an Operation<[`AddUserToGroup`](crate::operation::add_user_to_group::AddUserToGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::add_user_to_group::AddUserToGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_user_to_group::AddUserToGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_user_to_group::AddUserToGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AddUserToGroup", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddUserToGroup {
                type Output = ::std::result::Result<crate::operation::add_user_to_group::AddUserToGroupOutput, crate::operation::add_user_to_group::AddUserToGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_add_user_to_group::de_add_user_to_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::add_user_to_group::AddUserToGroupError {
