...
impl ListAccountAliasesInput {
    /// Consumes the builder and constructs an Operation<[`ListAccountAliases`](crate::operation::list_account_aliases::ListAccountAliases)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_account_aliases::ListAccountAliases, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_account_aliases::ListAccountAliasesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_account_aliases::ListAccountAliases::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAccountAliases", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAccountAliases {
                type Output = ::std::result::Result<crate::operation::list_account_aliases::ListAccountAliasesOutput, crate::operation::list_account_aliases::ListAccountAliasesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_account_aliases::de_list_account_aliases_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_account_aliases::ListAccountAliasesError {
