...
impl DetachUserPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DetachUserPolicy`](crate::operation::detach_user_policy::DetachUserPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::detach_user_policy::DetachUserPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_user_policy::DetachUserPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detach_user_policy::DetachUserPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetachUserPolicy", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachUserPolicy {
                type Output = ::std::result::Result<crate::operation::detach_user_policy::DetachUserPolicyOutput, crate::operation::detach_user_policy::DetachUserPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_detach_user_policy::de_detach_user_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::detach_user_policy::DetachUserPolicyError {
