...
impl UploadSshPublicKeyInput {
    /// Consumes the builder and constructs an Operation<[`UploadSSHPublicKey`](crate::operation::upload_ssh_public_key::UploadSSHPublicKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::upload_ssh_public_key::UploadSSHPublicKey, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upload_ssh_public_key::UploadSshPublicKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::upload_ssh_public_key::UploadSSHPublicKey::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UploadSSHPublicKey", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadSSHPublicKey {
                type Output = ::std::result::Result<crate::operation::upload_ssh_public_key::UploadSshPublicKeyOutput, crate::operation::upload_ssh_public_key::UploadSSHPublicKeyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_upload_ssh_public_key::de_upload_ssh_public_key_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::upload_ssh_public_key::UploadSSHPublicKeyError {
