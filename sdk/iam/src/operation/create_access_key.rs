...
impl CreateAccessKeyInput {
    /// Consumes the builder and constructs an Operation<[`CreateAccessKey`](crate::operation::create_access_key::CreateAccessKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_access_key::CreateAccessKey, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_access_key::CreateAccessKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_access_key::CreateAccessKey::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAccessKey", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAccessKey {
                type Output = ::std::result::Result<crate::operation::create_access_key::CreateAccessKeyOutput, crate::operation::create_access_key::CreateAccessKeyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_access_key::de_create_access_key_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_access_key::CreateAccessKeyError {
