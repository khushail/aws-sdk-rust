...
impl CreateOpenIdConnectProviderInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_open_id_connect_provider::CreateOpenIdConnectProviderInput, ::aws_smithy_http::operation::error::BuildError> {
