...
impl CreateInstanceProfileInput {
    /// Consumes the builder and constructs an Operation<[`CreateInstanceProfile`](crate::operation::create_instance_profile::CreateInstanceProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_instance_profile::CreateInstanceProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_instance_profile::CreateInstanceProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_instance_profile::CreateInstanceProfile::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateInstanceProfile", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInstanceProfile {
                type Output = ::std::result::Result<crate::operation::create_instance_profile::CreateInstanceProfileOutput, crate::operation::create_instance_profile::CreateInstanceProfileError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_instance_profile::de_create_instance_profile_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_instance_profile::CreateInstanceProfileError {
