...
impl CreateServiceLinkedRoleInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_service_linked_role::CreateServiceLinkedRole, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_service_linked_role::CreateServiceLinkedRoleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_service_linked_role::CreateServiceLinkedRole::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateServiceLinkedRole", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateServiceLinkedRole {
                type Output = ::std::result::Result<crate::operation::create_service_linked_role::CreateServiceLinkedRoleOutput, crate::operation::create_service_linked_role::CreateServiceLinkedRoleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_service_linked_role::de_create_service_linked_role_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_service_linked_role::CreateServiceLinkedRoleError {
