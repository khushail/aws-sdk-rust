...
impl UntagUserInput {
    /// Consumes the builder and constructs an Operation<[`UntagUser`](crate::operation::untag_user::UntagUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::untag_user::UntagUser, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_user::UntagUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::untag_user::UntagUser::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UntagUser", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagUser {
                type Output = ::std::result::Result<crate::operation::untag_user::UntagUserOutput, crate::operation::untag_user::UntagUserError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_untag_user::de_untag_user_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::untag_user::UntagUserError {
