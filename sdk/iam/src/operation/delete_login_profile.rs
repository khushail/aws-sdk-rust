...
impl DeleteLoginProfileInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLoginProfile`](crate::operation::delete_login_profile::DeleteLoginProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_login_profile::DeleteLoginProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_login_profile::DeleteLoginProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_login_profile::DeleteLoginProfile::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteLoginProfile", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLoginProfile {
                type Output = ::std::result::Result<crate::operation::delete_login_profile::DeleteLoginProfileOutput, crate::operation::delete_login_profile::DeleteLoginProfileError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_login_profile::de_delete_login_profile_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_login_profile::DeleteLoginProfileError {
