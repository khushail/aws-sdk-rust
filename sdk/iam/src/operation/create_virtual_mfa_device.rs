...
impl CreateVirtualMfaDeviceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_virtual_mfa_device::CreateVirtualMFADevice, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_virtual_mfa_device::CreateVirtualMfaDeviceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_virtual_mfa_device::CreateVirtualMFADevice::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateVirtualMFADevice", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVirtualMFADevice {
                type Output = ::std::result::Result<crate::operation::create_virtual_mfa_device::CreateVirtualMfaDeviceOutput, crate::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_virtual_mfa_device::de_create_virtual_mfa_device_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_virtual_mfa_device::CreateVirtualMFADeviceError {
