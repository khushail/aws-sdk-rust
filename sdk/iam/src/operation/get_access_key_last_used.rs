...
impl GetAccessKeyLastUsedInput {
    /// Consumes the builder and constructs an Operation<[`GetAccessKeyLastUsed`](crate::operation::get_access_key_last_used::GetAccessKeyLastUsed)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_access_key_last_used::GetAccessKeyLastUsed, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_access_key_last_used::GetAccessKeyLastUsedInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_access_key_last_used::GetAccessKeyLastUsed::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAccessKeyLastUsed", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAccessKeyLastUsed {
                type Output = ::std::result::Result<crate::operation::get_access_key_last_used::GetAccessKeyLastUsedOutput, crate::operation::get_access_key_last_used::GetAccessKeyLastUsedError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_access_key_last_used::de_get_access_key_last_used_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_access_key_last_used::GetAccessKeyLastUsedError {
