...
impl UpdateRoleDescriptionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRoleDescription`](crate::operation::update_role_description::UpdateRoleDescription)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_role_description::UpdateRoleDescription, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_role_description::UpdateRoleDescriptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_role_description::UpdateRoleDescription::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateRoleDescription", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRoleDescription {
                type Output = ::std::result::Result<crate::operation::update_role_description::UpdateRoleDescriptionOutput, crate::operation::update_role_description::UpdateRoleDescriptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_role_description::de_update_role_description_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_role_description::UpdateRoleDescriptionError {
