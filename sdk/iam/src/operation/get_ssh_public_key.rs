...
impl GetSshPublicKeyInput {
    /// Consumes the builder and constructs an Operation<[`GetSSHPublicKey`](crate::operation::get_ssh_public_key::GetSSHPublicKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_ssh_public_key::GetSSHPublicKey, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_ssh_public_key::GetSshPublicKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_ssh_public_key::GetSSHPublicKey::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetSSHPublicKey", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSSHPublicKey {
                type Output = ::std::result::Result<crate::operation::get_ssh_public_key::GetSshPublicKeyOutput, crate::operation::get_ssh_public_key::GetSSHPublicKeyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_ssh_public_key::de_get_ssh_public_key_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_ssh_public_key::GetSSHPublicKeyError {
