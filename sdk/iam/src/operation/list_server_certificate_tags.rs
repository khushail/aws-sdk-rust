...
impl ListServerCertificateTagsInput {
    /// Consumes the builder and constructs an Operation<[`ListServerCertificateTags`](crate::operation::list_server_certificate_tags::ListServerCertificateTags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_server_certificate_tags::ListServerCertificateTags, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_server_certificate_tags::ListServerCertificateTagsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_server_certificate_tags::ListServerCertificateTags::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListServerCertificateTags", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListServerCertificateTags {
                type Output = ::std::result::Result<crate::operation::list_server_certificate_tags::ListServerCertificateTagsOutput, crate::operation::list_server_certificate_tags::ListServerCertificateTagsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_server_certificate_tags::de_list_server_certificate_tags_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_server_certificate_tags::ListServerCertificateTagsError {
