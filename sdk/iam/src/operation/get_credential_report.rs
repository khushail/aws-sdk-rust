...
impl GetCredentialReportInput {
    /// Consumes the builder and constructs an Operation<[`GetCredentialReport`](crate::operation::get_credential_report::GetCredentialReport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_credential_report::GetCredentialReport, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_credential_report::GetCredentialReportInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_credential_report::GetCredentialReport::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCredentialReport", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCredentialReport {
                type Output = ::std::result::Result<crate::operation::get_credential_report::GetCredentialReportOutput, crate::operation::get_credential_report::GetCredentialReportError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_credential_report::GetCredentialReportError {
