...
impl DeleteSamlProviderInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSAMLProvider`](crate::operation::delete_saml_provider::DeleteSAMLProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_saml_provider::DeleteSAMLProvider, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_saml_provider::DeleteSamlProviderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_saml_provider::DeleteSAMLProvider::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteSAMLProvider", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSAMLProvider {
                type Output = ::std::result::Result<crate::operation::delete_saml_provider::DeleteSamlProviderOutput, crate::operation::delete_saml_provider::DeleteSAMLProviderError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_saml_provider::de_delete_saml_provider_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_saml_provider::DeleteSAMLProviderError {
