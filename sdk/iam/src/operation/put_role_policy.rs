...
impl PutRolePolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutRolePolicy`](crate::operation::put_role_policy::PutRolePolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_role_policy::PutRolePolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_role_policy::PutRolePolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_role_policy_input::ser_put_role_policy_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_role_policy::PutRolePolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutRolePolicy", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutRolePolicy {
                type Output = ::std::result::Result<crate::operation::put_role_policy::PutRolePolicyOutput, crate::operation::put_role_policy::PutRolePolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_put_role_policy::de_put_role_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_role_policy::PutRolePolicyError {
