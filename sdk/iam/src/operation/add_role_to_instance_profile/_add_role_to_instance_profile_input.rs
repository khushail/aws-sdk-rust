...
impl AddRoleToInstanceProfileInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::add_role_to_instance_profile::AddRoleToInstanceProfileInput, ::aws_smithy_http::operation::error::BuildError> {
