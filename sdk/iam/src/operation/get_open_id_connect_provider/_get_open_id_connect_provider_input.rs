...
impl GetOpenIdConnectProviderInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_open_id_connect_provider::GetOpenIdConnectProviderInput, ::aws_smithy_http::operation::error::BuildError> {
