...
impl UploadServerCertificateInput {
    /// Consumes the builder and constructs an Operation<[`UploadServerCertificate`](crate::operation::upload_server_certificate::UploadServerCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::upload_server_certificate::UploadServerCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upload_server_certificate::UploadServerCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::upload_server_certificate::UploadServerCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UploadServerCertificate", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadServerCertificate {
                type Output = ::std::result::Result<crate::operation::upload_server_certificate::UploadServerCertificateOutput, crate::operation::upload_server_certificate::UploadServerCertificateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_upload_server_certificate::de_upload_server_certificate_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::upload_server_certificate::UploadServerCertificateError {
