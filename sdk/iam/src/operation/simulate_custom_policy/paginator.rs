...
/// Paginator for [`SimulateCustomPolicy`](crate::operation::simulate_custom_policy::SimulateCustomPolicy)
            ...
            impl SimulateCustomPolicyPaginator  {
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::simulate_custom_policy::SimulateCustomPolicyOutput, ::aws_smithy_http::result::SdkError<crate::operation::simulate_custom_policy::SimulateCustomPolicyError>>> + ::std::marker::Unpin
                 {
...
/// Flattened paginator for `SimulateCustomPolicyPaginator`
                ...
                impl  SimulateCustomPolicyPaginatorItems  {
                    ...
                    pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::types::EvaluationResult, ::aws_smithy_http::result::SdkError<crate::operation::simulate_custom_policy::SimulateCustomPolicyError>>> + ::std::marker::Unpin
                     {
