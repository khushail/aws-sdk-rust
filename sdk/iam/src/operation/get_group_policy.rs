...
impl GetGroupPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetGroupPolicy`](crate::operation::get_group_policy::GetGroupPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_group_policy::GetGroupPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_group_policy::GetGroupPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_group_policy_input::ser_get_group_policy_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_group_policy::GetGroupPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetGroupPolicy", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetGroupPolicy {
                type Output = ::std::result::Result<crate::operation::get_group_policy::GetGroupPolicyOutput, crate::operation::get_group_policy::GetGroupPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_group_policy::de_get_group_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_group_policy::GetGroupPolicyError {
