...
impl SetDefaultPolicyVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_default_policy_version::SetDefaultPolicyVersionInput, ::aws_smithy_http::operation::error::BuildError> {
