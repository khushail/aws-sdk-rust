...
impl ResetServiceSpecificCredentialInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reset_service_specific_credential::ResetServiceSpecificCredentialInput, ::aws_smithy_http::operation::error::BuildError> {
