...
impl ListAttachedRolePoliciesInput {
    /// Consumes the builder and constructs an Operation<[`ListAttachedRolePolicies`](crate::operation::list_attached_role_policies::ListAttachedRolePolicies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_attached_role_policies::ListAttachedRolePolicies, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_attached_role_policies::ListAttachedRolePoliciesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_attached_role_policies::ListAttachedRolePolicies::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAttachedRolePolicies", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttachedRolePolicies {
                type Output = ::std::result::Result<crate::operation::list_attached_role_policies::ListAttachedRolePoliciesOutput, crate::operation::list_attached_role_policies::ListAttachedRolePoliciesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_attached_role_policies::de_list_attached_role_policies_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_attached_role_policies::ListAttachedRolePoliciesError {
