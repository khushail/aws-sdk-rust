...
impl PutUserPermissionsBoundaryInput {
    /// Consumes the builder and constructs an Operation<[`PutUserPermissionsBoundary`](crate::operation::put_user_permissions_boundary::PutUserPermissionsBoundary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_user_permissions_boundary::PutUserPermissionsBoundary, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_user_permissions_boundary::PutUserPermissionsBoundary::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutUserPermissionsBoundary", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutUserPermissionsBoundary {
                type Output = ::std::result::Result<crate::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryOutput, crate::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_put_user_permissions_boundary::de_put_user_permissions_boundary_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_user_permissions_boundary::PutUserPermissionsBoundaryError {
