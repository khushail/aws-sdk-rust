...
impl GetCredentialReportFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::get_credential_report::GetCredentialReport, ::aws_http::retry::AwsResponseRetryClassifier,>,
                            ::aws_smithy_http::result::SdkError<crate::operation::get_credential_report::GetCredentialReportError>
                        >  {
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::get_credential_report::GetCredentialReportOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_credential_report::GetCredentialReportError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::get_credential_report::GetCredentialReportOutput, ::aws_smithy_http::result::SdkError<crate::operation::get_credential_report::GetCredentialReportError>>
                             {
