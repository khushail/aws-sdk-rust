...
impl GetContextKeysForCustomPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_context_keys_for_custom_policy::GetContextKeysForCustomPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
