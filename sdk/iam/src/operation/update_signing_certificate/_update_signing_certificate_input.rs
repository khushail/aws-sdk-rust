...
impl UpdateSigningCertificateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_signing_certificate::UpdateSigningCertificateInput, ::aws_smithy_http::operation::error::BuildError> {
