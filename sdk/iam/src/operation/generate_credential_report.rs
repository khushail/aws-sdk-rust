...
impl GenerateCredentialReportInput {
    /// Consumes the builder and constructs an Operation<[`GenerateCredentialReport`](crate::operation::generate_credential_report::GenerateCredentialReport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::generate_credential_report::GenerateCredentialReport, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_credential_report::GenerateCredentialReportInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::generate_credential_report::GenerateCredentialReport::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GenerateCredentialReport", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateCredentialReport {
                type Output = ::std::result::Result<crate::operation::generate_credential_report::GenerateCredentialReportOutput, crate::operation::generate_credential_report::GenerateCredentialReportError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_generate_credential_report::de_generate_credential_report_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::generate_credential_report::GenerateCredentialReportError {
