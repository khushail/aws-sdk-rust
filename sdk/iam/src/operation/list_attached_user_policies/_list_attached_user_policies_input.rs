...
impl ListAttachedUserPoliciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_attached_user_policies::ListAttachedUserPoliciesInput, ::aws_smithy_http::operation::error::BuildError> {
