...
impl UpdateSamlProviderInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSAMLProvider`](crate::operation::update_saml_provider::UpdateSAMLProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_saml_provider::UpdateSAMLProvider, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_saml_provider::UpdateSamlProviderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_saml_provider::UpdateSAMLProvider::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateSAMLProvider", "iam"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSAMLProvider {
                type Output = ::std::result::Result<crate::operation::update_saml_provider::UpdateSamlProviderOutput, crate::operation::update_saml_provider::UpdateSAMLProviderError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_saml_provider::de_update_saml_provider_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_saml_provider::UpdateSAMLProviderError {
