...
impl BatchUpdateDevicePositionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_update_device_position::BatchUpdateDevicePositionInput, ::aws_smithy_http::operation::error::BuildError> {
