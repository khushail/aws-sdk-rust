...
impl DeleteGeofenceCollectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_geofence_collection::DeleteGeofenceCollectionInput, ::aws_smithy_http::operation::error::BuildError> {
