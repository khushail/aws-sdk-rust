...
impl CreateMapInput {
    /// Consumes the builder and constructs an Operation<[`CreateMap`](crate::operation::create_map::CreateMap)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_map::CreateMap, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_map::CreateMapInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/maps/v0/maps").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_map::ser_create_map_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_map::CreateMap::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateMap", "location"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMap {
                type Output = ::std::result::Result<crate::operation::create_map::CreateMapOutput, crate::operation::create_map::CreateMapError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_map::de_create_map_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_map::de_create_map_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_map::CreateMapError {
