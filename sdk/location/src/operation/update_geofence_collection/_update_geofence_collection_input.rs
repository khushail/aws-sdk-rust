...
impl UpdateGeofenceCollectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_geofence_collection::UpdateGeofenceCollectionInput, ::aws_smithy_http::operation::error::BuildError> {
