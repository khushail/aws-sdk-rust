...
impl GetDevicePositionHistoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_device_position_history::GetDevicePositionHistoryInput, ::aws_smithy_http::operation::error::BuildError> {
