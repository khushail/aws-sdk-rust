...
pub(crate) fn de_blob_payload(body: &[u8]) -> std::result::Result<::std::option::Option<::aws_smithy_types::Blob>, crate::operation::get_map_style_descriptor::GetMapStyleDescriptorError> {
    (!body.is_empty()).then(||{
