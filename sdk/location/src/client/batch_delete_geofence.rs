...
impl super::Client  {
    ...
    ///   - [`collection_name(impl ::std::convert::Into<String>)`](crate::operation::batch_delete_geofence::builders::BatchDeleteGeofenceFluentBuilder::collection_name) / [`set_collection_name(Option<String>)`](crate::operation::batch_delete_geofence::builders::BatchDeleteGeofenceFluentBuilder::set_collection_name): <p>The geofence collection storing the geofences to be deleted.</p>
