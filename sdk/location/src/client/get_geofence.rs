...
impl super::Client  {
    ...
    ///   - [`geofence_properties(Option<HashMap<String, String>>)`](crate::operation::get_geofence::GetGeofenceOutput::geofence_properties): <p>Contains additional user-defined properties stored with the geofence. An array of key-value pairs.</p>
