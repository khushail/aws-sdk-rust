...
impl super::Client  {
    ...
    ///   - [`map_name(impl ::std::convert::Into<String>)`](crate::operation::delete_map::builders::DeleteMapFluentBuilder::map_name) / [`set_map_name(Option<String>)`](crate::operation::delete_map::builders::DeleteMapFluentBuilder::set_map_name): <p>The name of the map resource to be deleted.</p>
