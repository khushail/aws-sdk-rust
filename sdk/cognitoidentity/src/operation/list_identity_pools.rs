...
impl ListIdentityPoolsInput {
    /// Consumes the builder and constructs an Operation<[`ListIdentityPools`](crate::operation::list_identity_pools::ListIdentityPools)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_identity_pools::ListIdentityPools, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_identity_pools::ListIdentityPoolsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_identity_pools::ListIdentityPoolsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_identity_pools::ser_list_identity_pools_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_identity_pools::ListIdentityPools::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListIdentityPools", "cognitoidentity"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListIdentityPools`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIdentityPools {
                type Output = ::std::result::Result<crate::operation::list_identity_pools::ListIdentityPoolsOutput, crate::operation::list_identity_pools::ListIdentityPoolsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_identity_pools::de_list_identity_pools_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_identity_pools::de_list_identity_pools_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_identity_pools::ListIdentityPoolsError {
...
mod _list_identity_pools_output;
