...
impl DeleteIdentitiesInput {
    /// Consumes the builder and constructs an Operation<[`DeleteIdentities`](crate::operation::delete_identities::DeleteIdentities)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_identities::DeleteIdentities, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_identities::DeleteIdentitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_identities::ser_delete_identities_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_identities::DeleteIdentities::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteIdentities", "cognitoidentity"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteIdentities`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIdentities {
                type Output = ::std::result::Result<crate::operation::delete_identities::DeleteIdentitiesOutput, crate::operation::delete_identities::DeleteIdentitiesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_identities::de_delete_identities_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_identities::de_delete_identities_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_identities::DeleteIdentitiesError {
...
pub use crate::operation::delete_identities::_delete_identities_output::DeleteIdentitiesOutput;

pub use crate::operation::delete_identities::_delete_identities_input::DeleteIdentitiesInput;

mod _delete_identities_input;

mod _delete_identities_output;
