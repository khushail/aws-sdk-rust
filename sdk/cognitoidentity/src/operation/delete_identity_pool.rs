...
impl DeleteIdentityPoolInput {
    /// Consumes the builder and constructs an Operation<[`DeleteIdentityPool`](crate::operation::delete_identity_pool::DeleteIdentityPool)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_identity_pool::DeleteIdentityPool, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_identity_pool::DeleteIdentityPoolInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_identity_pool::DeleteIdentityPoolInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_identity_pool::ser_delete_identity_pool_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_identity_pool::DeleteIdentityPool::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteIdentityPool", "cognitoidentity"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIdentityPool {
                type Output = ::std::result::Result<crate::operation::delete_identity_pool::DeleteIdentityPoolOutput, crate::operation::delete_identity_pool::DeleteIdentityPoolError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_identity_pool::de_delete_identity_pool_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_identity_pool::de_delete_identity_pool_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_identity_pool::DeleteIdentityPoolError {
...
pub use crate::operation::delete_identity_pool::_delete_identity_pool_output::DeleteIdentityPoolOutput;

pub use crate::operation::delete_identity_pool::_delete_identity_pool_input::DeleteIdentityPoolInput;

mod _delete_identity_pool_input;

mod _delete_identity_pool_output;
