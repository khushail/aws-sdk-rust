...
impl MergeDeveloperIdentitiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesInput, ::aws_smithy_http::operation::error::BuildError> {
