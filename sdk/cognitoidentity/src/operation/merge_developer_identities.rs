...
impl MergeDeveloperIdentitiesInput {
    /// Consumes the builder and constructs an Operation<[`MergeDeveloperIdentities`](crate::operation::merge_developer_identities::MergeDeveloperIdentities)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::merge_developer_identities::MergeDeveloperIdentities, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::merge_developer_identities::MergeDeveloperIdentitiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_merge_developer_identities::ser_merge_developer_identities_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::merge_developer_identities::MergeDeveloperIdentities::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("MergeDeveloperIdentities", "cognitoidentity"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `MergeDeveloperIdentities`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for MergeDeveloperIdentities {
                type Output = ::std::result::Result<crate::operation::merge_developer_identities::MergeDeveloperIdentitiesOutput, crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_merge_developer_identities::de_merge_developer_identities_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_merge_developer_identities::de_merge_developer_identities_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::merge_developer_identities::MergeDeveloperIdentitiesError {
...
mod _merge_developer_identities_output;
