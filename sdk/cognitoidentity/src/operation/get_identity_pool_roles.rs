...
impl GetIdentityPoolRolesInput {
    /// Consumes the builder and constructs an Operation<[`GetIdentityPoolRoles`](crate::operation::get_identity_pool_roles::GetIdentityPoolRoles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_identity_pool_roles::GetIdentityPoolRoles, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_identity_pool_roles::GetIdentityPoolRolesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_identity_pool_roles::GetIdentityPoolRolesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_identity_pool_roles::ser_get_identity_pool_roles_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_identity_pool_roles::GetIdentityPoolRoles::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetIdentityPoolRoles", "cognitoidentity"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetIdentityPoolRoles`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIdentityPoolRoles {
                type Output = ::std::result::Result<crate::operation::get_identity_pool_roles::GetIdentityPoolRolesOutput, crate::operation::get_identity_pool_roles::GetIdentityPoolRolesError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::get_identity_pool_roles::GetIdentityPoolRolesError {
...
mod _get_identity_pool_roles_output;
