...
impl SetIdentityPoolRolesInput {
    /// Consumes the builder and constructs an Operation<[`SetIdentityPoolRoles`](crate::operation::set_identity_pool_roles::SetIdentityPoolRoles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_identity_pool_roles::SetIdentityPoolRoles, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_identity_pool_roles::SetIdentityPoolRolesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_identity_pool_roles::ser_set_identity_pool_roles_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_identity_pool_roles::SetIdentityPoolRoles::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SetIdentityPoolRoles", "cognitoidentity"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SetIdentityPoolRoles`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetIdentityPoolRoles {
                type Output = ::std::result::Result<crate::operation::set_identity_pool_roles::SetIdentityPoolRolesOutput, crate::operation::set_identity_pool_roles::SetIdentityPoolRolesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_set_identity_pool_roles::de_set_identity_pool_roles_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_set_identity_pool_roles::de_set_identity_pool_roles_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_identity_pool_roles::SetIdentityPoolRolesError {
...
pub use crate::operation::set_identity_pool_roles::_set_identity_pool_roles_output::SetIdentityPoolRolesOutput;

pub use crate::operation::set_identity_pool_roles::_set_identity_pool_roles_input::SetIdentityPoolRolesInput;

mod _set_identity_pool_roles_input;

mod _set_identity_pool_roles_output;
