...
impl GetCredentialsForIdentityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_credentials_for_identity::GetCredentialsForIdentityInput, ::aws_smithy_http::operation::error::BuildError> {
