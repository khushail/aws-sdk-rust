...
impl UnlinkDeveloperIdentityInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::unlink_developer_identity::UnlinkDeveloperIdentity, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::unlink_developer_identity::UnlinkDeveloperIdentityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `UnlinkDeveloperIdentity`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnlinkDeveloperIdentity {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_unlink_developer_identity::de_unlink_developer_identity_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_unlink_developer_identity::de_unlink_developer_identity_http_response_with_props(status, headers, body)
                     }
                }
