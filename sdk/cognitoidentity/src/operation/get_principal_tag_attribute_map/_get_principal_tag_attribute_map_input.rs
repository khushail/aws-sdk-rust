...
impl GetPrincipalTagAttributeMapInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_principal_tag_attribute_map::GetPrincipalTagAttributeMapInput, ::aws_smithy_http::operation::error::BuildError> {
