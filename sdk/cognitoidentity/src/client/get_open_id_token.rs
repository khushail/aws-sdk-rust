...
impl super::Client  {
    ...
    ///   - [`identity_id(impl ::std::convert::Into<String>)`](crate::operation::get_open_id_token::builders::GetOpenIdTokenFluentBuilder::identity_id) / [`set_identity_id(Option<String>)`](crate::operation::get_open_id_token::builders::GetOpenIdTokenFluentBuilder::set_identity_id): <p>A unique identifier in the format REGION:GUID.</p>
