...
impl GetDocumentTextDetectionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_document_text_detection::GetDocumentTextDetection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_document_text_detection::GetDocumentTextDetectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `GetDocumentTextDetection`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDocumentTextDetection {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_document_text_detection::de_get_document_text_detection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_document_text_detection::de_get_document_text_detection_http_response_with_props(status, headers, body)
                     }
                }
