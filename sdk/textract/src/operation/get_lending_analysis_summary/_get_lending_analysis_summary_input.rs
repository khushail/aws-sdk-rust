...
impl GetLendingAnalysisSummaryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_lending_analysis_summary::GetLendingAnalysisSummaryInput, ::aws_smithy_http::operation::error::BuildError> {
