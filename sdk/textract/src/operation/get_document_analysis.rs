...
impl GetDocumentAnalysisInput {
    /// Consumes the builder and constructs an Operation<[`GetDocumentAnalysis`](crate::operation::get_document_analysis::GetDocumentAnalysis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_document_analysis::GetDocumentAnalysis, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_document_analysis::GetDocumentAnalysisInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_document_analysis::ser_get_document_analysis_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_document_analysis::GetDocumentAnalysis::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetDocumentAnalysis {
                type Output = ::std::result::Result<crate::operation::get_document_analysis::GetDocumentAnalysisOutput, crate::operation::get_document_analysis::GetDocumentAnalysisError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_document_analysis::de_get_document_analysis_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_document_analysis::de_get_document_analysis_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_document_analysis::GetDocumentAnalysisError {
...
mod _get_document_analysis_output;
