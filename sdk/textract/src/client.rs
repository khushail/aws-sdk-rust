...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_textract::Error> {
/// # let client: aws_sdk_textract::Client = unimplemented!();
...
mod get_document_text_detection;

mod get_expense_analysis;

mod get_lending_analysis;
