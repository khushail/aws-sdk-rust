...
pub fn ser_set_topic_attributes_input_input(input: &crate::operation::set_topic_attributes::SetTopicAttributesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
