...
pub fn de_get_topic_attributes_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_topic_attributes::GetTopicAttributesOutput, crate::operation::get_topic_attributes::GetTopicAttributesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::get_topic_attributes::GetTopicAttributesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_topic_attributes_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_topic_attributes::GetTopicAttributesOutput, crate::operation::get_topic_attributes::GetTopicAttributesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::get_topic_attributes::builders::GetTopicAttributesOutputBuilder::default();
        output = crate::protocol_serde::shape_get_topic_attributes::de_get_topic_attributes(_response_body, output).map_err(crate::operation::get_topic_attributes::GetTopicAttributesError::unhandled)?;
