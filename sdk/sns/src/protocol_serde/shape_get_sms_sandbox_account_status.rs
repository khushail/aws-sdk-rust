...
pub fn de_get_sms_sandbox_account_status_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusOutput, crate::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatusError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_sms_sandbox_account_status_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_sms_sandbox_account_status::GetSmsSandboxAccountStatusOutput, crate::operation::get_sms_sandbox_account_status::GetSMSSandboxAccountStatusError> {
    Ok({
        #[allow(unused_mut)]
