...
impl super::Client  {
    ...
    ///   - [`topic_arn(impl ::std::convert::Into<String>)`](crate::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicFluentBuilder::topic_arn) / [`set_topic_arn(Option<String>)`](crate::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicFluentBuilder::set_topic_arn): <p>The ARN of the topic for which you wish to find subscriptions.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_subscriptions_by_topic::builders::ListSubscriptionsByTopicFluentBuilder::set_next_token): <p>Token returned by the previous <code>ListSubscriptionsByTopic</code> request.</p>
