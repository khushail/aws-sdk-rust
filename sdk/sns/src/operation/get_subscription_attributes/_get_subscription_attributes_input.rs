...
impl GetSubscriptionAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_subscription_attributes::GetSubscriptionAttributesInput, ::aws_smithy_http::operation::error::BuildError> {
