...
impl OptInPhoneNumberInput {
    /// Consumes the builder and constructs an Operation<[`OptInPhoneNumber`](crate::operation::opt_in_phone_number::OptInPhoneNumber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::opt_in_phone_number::OptInPhoneNumber, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::opt_in_phone_number::OptInPhoneNumberInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_opt_in_phone_number_input::ser_opt_in_phone_number_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::opt_in_phone_number::OptInPhoneNumber::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for OptInPhoneNumber {
                type Output = ::std::result::Result<crate::operation::opt_in_phone_number::OptInPhoneNumberOutput, crate::operation::opt_in_phone_number::OptInPhoneNumberError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_opt_in_phone_number::de_opt_in_phone_number_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::opt_in_phone_number::OptInPhoneNumberError {
