...
impl ListPhoneNumbersOptedOutInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_phone_numbers_opted_out::ListPhoneNumbersOptedOutInput, ::aws_smithy_http::operation::error::BuildError> {
