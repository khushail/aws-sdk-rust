...
impl SetSubscriptionAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_subscription_attributes::SetSubscriptionAttributesInput, ::aws_smithy_http::operation::error::BuildError> {
