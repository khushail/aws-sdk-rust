...
impl ListOriginationNumbersInput {
    /// Consumes the builder and constructs an Operation<[`ListOriginationNumbers`](crate::operation::list_origination_numbers::ListOriginationNumbers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_origination_numbers::ListOriginationNumbers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_origination_numbers::ListOriginationNumbersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_origination_numbers_input::ser_list_origination_numbers_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_origination_numbers::ListOriginationNumbers::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOriginationNumbers {
                type Output = ::std::result::Result<crate::operation::list_origination_numbers::ListOriginationNumbersOutput, crate::operation::list_origination_numbers::ListOriginationNumbersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_origination_numbers::de_list_origination_numbers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_origination_numbers::ListOriginationNumbersError {
