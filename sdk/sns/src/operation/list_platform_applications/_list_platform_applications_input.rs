...
impl ListPlatformApplicationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_platform_applications::ListPlatformApplicationsInput, ::aws_smithy_http::operation::error::BuildError> {
