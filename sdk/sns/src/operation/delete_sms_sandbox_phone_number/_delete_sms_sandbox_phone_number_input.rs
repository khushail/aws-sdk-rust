...
impl DeleteSmsSandboxPhoneNumberInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_sms_sandbox_phone_number::DeleteSmsSandboxPhoneNumberInput, ::aws_smithy_http::operation::error::BuildError> {
