...
impl CreatePlatformApplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_platform_application::CreatePlatformApplicationInput, ::aws_smithy_http::operation::error::BuildError> {
