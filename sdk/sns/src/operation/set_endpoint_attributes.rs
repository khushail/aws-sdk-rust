...
impl SetEndpointAttributesInput {
    /// Consumes the builder and constructs an Operation<[`SetEndpointAttributes`](crate::operation::set_endpoint_attributes::SetEndpointAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_endpoint_attributes::SetEndpointAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_endpoint_attributes::SetEndpointAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_endpoint_attributes_input::ser_set_endpoint_attributes_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_endpoint_attributes::SetEndpointAttributes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetEndpointAttributes {
                type Output = ::std::result::Result<crate::operation::set_endpoint_attributes::SetEndpointAttributesOutput, crate::operation::set_endpoint_attributes::SetEndpointAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_set_endpoint_attributes::de_set_endpoint_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::set_endpoint_attributes::SetEndpointAttributesError {
