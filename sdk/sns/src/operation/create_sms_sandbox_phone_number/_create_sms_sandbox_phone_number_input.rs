...
impl CreateSmsSandboxPhoneNumberInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_sms_sandbox_phone_number::CreateSmsSandboxPhoneNumberInput, ::aws_smithy_http::operation::error::BuildError> {
