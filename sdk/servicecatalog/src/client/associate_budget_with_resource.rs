...
impl super::Client  {
    ...
    ///   - [`budget_name(impl ::std::convert::Into<String>)`](crate::operation::associate_budget_with_resource::builders::AssociateBudgetWithResourceFluentBuilder::budget_name) / [`set_budget_name(Option<String>)`](crate::operation::associate_budget_with_resource::builders::AssociateBudgetWithResourceFluentBuilder::set_budget_name): <p>The name of the budget you want to associate.</p>
