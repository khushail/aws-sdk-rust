...
impl super::Client  {
    ...
    ///   - [`accept_language(impl ::std::convert::Into<String>)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::accept_language) / [`set_accept_language(Option<String>)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::set_accept_language): <p>The language code.</p>  <ul>   <li> <p> <code>jp</code> - Japanese</p> </li>   <li> <p> <code>zh</code> - Chinese</p> </li>  </ul>
    ///   - [`portfolio_id(impl ::std::convert::Into<String>)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::portfolio_id) / [`set_portfolio_id(Option<String>)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::set_portfolio_id): <p>The portfolio identifier.</p>
    ///   - [`organization_parent_id(impl ::std::convert::Into<String>)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::organization_parent_id) / [`set_organization_parent_id(Option<String>)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::set_organization_parent_id): <p>The ID of an organization node the portfolio is shared with. All children of this node with an inherited portfolio share will be returned.</p>
    ///   - [`page_token(impl ::std::convert::Into<String>)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::page_token) / [`set_page_token(Option<String>)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::set_page_token): <p>The page token for the next set of results. To retrieve the first set of results, use null.</p>
    ///   - [`page_size(i32)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::page_size) / [`set_page_size(Option<i32>)`](crate::operation::list_portfolio_access::builders::ListPortfolioAccessFluentBuilder::set_page_size): <p>The maximum number of items to return with this call.</p>
