...
impl ListOrganizationPortfolioAccessInput {
    /// Consumes the builder and constructs an Operation<[`ListOrganizationPortfolioAccess`](crate::operation::list_organization_portfolio_access::ListOrganizationPortfolioAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_organization_portfolio_access::ListOrganizationPortfolioAccess, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_organization_portfolio_access::ListOrganizationPortfolioAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_organization_portfolio_access::ser_list_organization_portfolio_access_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_organization_portfolio_access::ListOrganizationPortfolioAccess::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListOrganizationPortfolioAccess", "servicecatalog"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOrganizationPortfolioAccess {
                type Output = ::std::result::Result<crate::operation::list_organization_portfolio_access::ListOrganizationPortfolioAccessOutput, crate::operation::list_organization_portfolio_access::ListOrganizationPortfolioAccessError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_organization_portfolio_access::de_list_organization_portfolio_access_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_organization_portfolio_access::de_list_organization_portfolio_access_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListOrganizationPortfolioAccessError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_organization_portfolio_access::ListOrganizationPortfolioAccessError {
...
mod _list_organization_portfolio_access_output;
