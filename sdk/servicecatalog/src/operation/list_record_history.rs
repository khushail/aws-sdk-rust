...
impl ListRecordHistoryInput {
    /// Consumes the builder and constructs an Operation<[`ListRecordHistory`](crate::operation::list_record_history::ListRecordHistory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_record_history::ListRecordHistory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_record_history::ListRecordHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_record_history::ser_list_record_history_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_record_history::ListRecordHistory::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListRecordHistory", "servicecatalog"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRecordHistory {
                type Output = ::std::result::Result<crate::operation::list_record_history::ListRecordHistoryOutput, crate::operation::list_record_history::ListRecordHistoryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_record_history::de_list_record_history_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_record_history::de_list_record_history_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_record_history::ListRecordHistoryError {
...
mod _list_record_history_output;
