...
impl DescribeTagOptionInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTagOption`](crate::operation::describe_tag_option::DescribeTagOption)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_tag_option::DescribeTagOption, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_tag_option::DescribeTagOptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_tag_option::ser_describe_tag_option_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_tag_option::DescribeTagOption::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeTagOption", "servicecatalog"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTagOption {
                type Output = ::std::result::Result<crate::operation::describe_tag_option::DescribeTagOptionOutput, crate::operation::describe_tag_option::DescribeTagOptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_tag_option::de_describe_tag_option_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_tag_option::DescribeTagOptionError {
...
mod _describe_tag_option_output;
