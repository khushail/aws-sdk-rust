...
impl UpdatePortfolioInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePortfolio`](crate::operation::update_portfolio::UpdatePortfolio)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_portfolio::UpdatePortfolio, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_portfolio::UpdatePortfolioInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_portfolio::ser_update_portfolio_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_portfolio::UpdatePortfolio::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePortfolio", "servicecatalog"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePortfolio {
                type Output = ::std::result::Result<crate::operation::update_portfolio::UpdatePortfolioOutput, crate::operation::update_portfolio::UpdatePortfolioError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_portfolio::de_update_portfolio_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_portfolio::UpdatePortfolioError {
