...
impl ExecuteProvisionedProductPlanInput {
    /// Consumes the builder and constructs an Operation<[`ExecuteProvisionedProductPlan`](crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlan, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_execute_provisioned_product_plan::ser_execute_provisioned_product_plan_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlan::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ExecuteProvisionedProductPlan", "servicecatalog"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ExecuteProvisionedProductPlan {
                type Output = ::std::result::Result<crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanOutput, crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_execute_provisioned_product_plan::de_execute_provisioned_product_plan_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_execute_provisioned_product_plan::de_execute_provisioned_product_plan_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ExecuteProvisionedProductPlanError {
...
impl ::aws_http::request_id::RequestId for crate::operation::execute_provisioned_product_plan::ExecuteProvisionedProductPlanError {
...
mod _execute_provisioned_product_plan_output;
