...
impl DescribeProvisioningArtifactInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_provisioning_artifact::DescribeProvisioningArtifactInput, ::aws_smithy_http::operation::error::BuildError> {
