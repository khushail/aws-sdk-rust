...
impl CreatePortfolioShareInput {
    /// Consumes the builder and constructs an Operation<[`CreatePortfolioShare`](crate::operation::create_portfolio_share::CreatePortfolioShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_portfolio_share::CreatePortfolioShare, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_portfolio_share::CreatePortfolioShareInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_portfolio_share::ser_create_portfolio_share_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_portfolio_share::CreatePortfolioShare::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePortfolioShare", "servicecatalog"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreatePortfolioShare`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePortfolioShare {
                type Output = ::std::result::Result<crate::operation::create_portfolio_share::CreatePortfolioShareOutput, crate::operation::create_portfolio_share::CreatePortfolioShareError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_portfolio_share::de_create_portfolio_share_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_portfolio_share::de_create_portfolio_share_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_portfolio_share::CreatePortfolioShareError {
...
pub use crate::operation::create_portfolio_share::_create_portfolio_share_output::CreatePortfolioShareOutput;

pub use crate::operation::create_portfolio_share::_create_portfolio_share_input::CreatePortfolioShareInput;

mod _create_portfolio_share_input;

mod _create_portfolio_share_output;
