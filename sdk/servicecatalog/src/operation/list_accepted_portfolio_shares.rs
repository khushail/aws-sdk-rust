...
impl ListAcceptedPortfolioSharesInput {
    /// Consumes the builder and constructs an Operation<[`ListAcceptedPortfolioShares`](crate::operation::list_accepted_portfolio_shares::ListAcceptedPortfolioShares)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_accepted_portfolio_shares::ListAcceptedPortfolioShares, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_accepted_portfolio_shares::ListAcceptedPortfolioSharesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_accepted_portfolio_shares::ser_list_accepted_portfolio_shares_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_accepted_portfolio_shares::ListAcceptedPortfolioShares::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAcceptedPortfolioShares", "servicecatalog"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListAcceptedPortfolioShares`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAcceptedPortfolioShares {
                type Output = ::std::result::Result<crate::operation::list_accepted_portfolio_shares::ListAcceptedPortfolioSharesOutput, crate::operation::list_accepted_portfolio_shares::ListAcceptedPortfolioSharesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_accepted_portfolio_shares::de_list_accepted_portfolio_shares_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_accepted_portfolio_shares::de_list_accepted_portfolio_shares_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_accepted_portfolio_shares::ListAcceptedPortfolioSharesError {
...
mod _list_accepted_portfolio_shares_output;
