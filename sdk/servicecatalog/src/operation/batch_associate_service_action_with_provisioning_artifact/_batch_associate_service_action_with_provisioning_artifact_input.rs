...
impl BatchAssociateServiceActionWithProvisioningArtifactInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_associate_service_action_with_provisioning_artifact::BatchAssociateServiceActionWithProvisioningArtifactInput, ::aws_smithy_http::operation::error::BuildError> {
