...
impl CreateProvisioningArtifactInput {
    /// Consumes the builder and constructs an Operation<[`CreateProvisioningArtifact`](crate::operation::create_provisioning_artifact::CreateProvisioningArtifact)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_provisioning_artifact::CreateProvisioningArtifact, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_provisioning_artifact::CreateProvisioningArtifactInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_provisioning_artifact::ser_create_provisioning_artifact_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_provisioning_artifact::CreateProvisioningArtifact::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateProvisioningArtifact", "servicecatalog"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProvisioningArtifact {
                type Output = ::std::result::Result<crate::operation::create_provisioning_artifact::CreateProvisioningArtifactOutput, crate::operation::create_provisioning_artifact::CreateProvisioningArtifactError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_provisioning_artifact::de_create_provisioning_artifact_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_provisioning_artifact::de_create_provisioning_artifact_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_provisioning_artifact::CreateProvisioningArtifactError {
...
mod _create_provisioning_artifact_output;
