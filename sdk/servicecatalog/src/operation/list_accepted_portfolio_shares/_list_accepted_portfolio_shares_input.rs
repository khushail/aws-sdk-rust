...
impl ListAcceptedPortfolioSharesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_accepted_portfolio_shares::ListAcceptedPortfolioSharesInput, ::aws_smithy_http::operation::error::BuildError> {
