...
impl CreateConstraintInput {
    /// Consumes the builder and constructs an Operation<[`CreateConstraint`](crate::operation::create_constraint::CreateConstraint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_constraint::CreateConstraint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_constraint::CreateConstraintInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_constraint::CreateConstraintInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_constraint::ser_create_constraint_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_constraint::CreateConstraint::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateConstraint", "servicecatalog"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateConstraint`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateConstraint {
                type Output = ::std::result::Result<crate::operation::create_constraint::CreateConstraintOutput, crate::operation::create_constraint::CreateConstraintError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_constraint::de_create_constraint_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_constraint::de_create_constraint_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_constraint::CreateConstraintError {
