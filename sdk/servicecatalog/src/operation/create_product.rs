...
impl CreateProductInput {
    /// Consumes the builder and constructs an Operation<[`CreateProduct`](crate::operation::create_product::CreateProduct)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_product::CreateProduct, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_product::CreateProductInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_product::ser_create_product_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_product::CreateProduct::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateProduct", "servicecatalog"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateProduct {
                type Output = ::std::result::Result<crate::operation::create_product::CreateProductOutput, crate::operation::create_product::CreateProductError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_product::de_create_product_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_product::de_create_product_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_product::CreateProductError {
