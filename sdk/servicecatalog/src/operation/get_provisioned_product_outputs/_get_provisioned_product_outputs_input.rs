...
impl GetProvisionedProductOutputsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_provisioned_product_outputs::GetProvisionedProductOutputsInput, ::aws_smithy_http::operation::error::BuildError> {
