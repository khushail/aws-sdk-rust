...
impl DescribePortfolioShareStatusInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_portfolio_share_status::DescribePortfolioShareStatusInput, ::aws_smithy_http::operation::error::BuildError> {
