...
impl ListResourcesForTagOptionInput {
    /// Consumes the builder and constructs an Operation<[`ListResourcesForTagOption`](crate::operation::list_resources_for_tag_option::ListResourcesForTagOption)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_resources_for_tag_option::ListResourcesForTagOption, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resources_for_tag_option::ListResourcesForTagOptionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_resources_for_tag_option::ser_list_resources_for_tag_option_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resources_for_tag_option::ListResourcesForTagOption::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListResourcesForTagOption", "servicecatalog"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListResourcesForTagOption`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourcesForTagOption {
                type Output = ::std::result::Result<crate::operation::list_resources_for_tag_option::ListResourcesForTagOptionOutput, crate::operation::list_resources_for_tag_option::ListResourcesForTagOptionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_resources_for_tag_option::de_list_resources_for_tag_option_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_resources_for_tag_option::de_list_resources_for_tag_option_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_resources_for_tag_option::ListResourcesForTagOptionError {
...
mod _list_resources_for_tag_option_output;
