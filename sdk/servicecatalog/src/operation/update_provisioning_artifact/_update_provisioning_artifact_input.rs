...
impl UpdateProvisioningArtifactInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_provisioning_artifact::UpdateProvisioningArtifactInput, ::aws_smithy_http::operation::error::BuildError> {
