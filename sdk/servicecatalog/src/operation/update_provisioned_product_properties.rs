...
impl UpdateProvisionedProductPropertiesInput {
    /// Consumes the builder and constructs an Operation<[`UpdateProvisionedProductProperties`](crate::operation::update_provisioned_product_properties::UpdateProvisionedProductProperties)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_provisioned_product_properties::UpdateProvisionedProductProperties, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_provisioned_product_properties::UpdateProvisionedProductPropertiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_provisioned_product_properties::ser_update_provisioned_product_properties_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_provisioned_product_properties::UpdateProvisionedProductProperties::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateProvisionedProductProperties", "servicecatalog"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateProvisionedProductProperties`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateProvisionedProductProperties {
                type Output = ::std::result::Result<crate::operation::update_provisioned_product_properties::UpdateProvisionedProductPropertiesOutput, crate::operation::update_provisioned_product_properties::UpdateProvisionedProductPropertiesError>;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateProvisionedProductPropertiesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_provisioned_product_properties::UpdateProvisionedProductPropertiesError {
...
pub use crate::operation::update_provisioned_product_properties::_update_provisioned_product_properties_output::UpdateProvisionedProductPropertiesOutput;

pub use crate::operation::update_provisioned_product_properties::_update_provisioned_product_properties_input::UpdateProvisionedProductPropertiesInput;

mod _update_provisioned_product_properties_input;

mod _update_provisioned_product_properties_output;
