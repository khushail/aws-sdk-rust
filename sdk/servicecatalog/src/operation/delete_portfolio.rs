...
impl DeletePortfolioInput {
    /// Consumes the builder and constructs an Operation<[`DeletePortfolio`](crate::operation::delete_portfolio::DeletePortfolio)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_portfolio::DeletePortfolio, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_portfolio::DeletePortfolioInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_portfolio::ser_delete_portfolio_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_portfolio::DeletePortfolio::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeletePortfolio", "servicecatalog"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeletePortfolio`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePortfolio {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_portfolio::de_delete_portfolio_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_portfolio::DeletePortfolioError {
...
pub use crate::operation::delete_portfolio::_delete_portfolio_output::DeletePortfolioOutput;

pub use crate::operation::delete_portfolio::_delete_portfolio_input::DeletePortfolioInput;

mod _delete_portfolio_input;

mod _delete_portfolio_output;
