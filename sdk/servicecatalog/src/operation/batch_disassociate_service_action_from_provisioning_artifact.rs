...
impl BatchDisassociateServiceActionFromProvisioningArtifactInput {
    /// Consumes the builder and constructs an Operation<[`BatchDisassociateServiceActionFromProvisioningArtifact`](crate::operation::batch_disassociate_service_action_from_provisioning_artifact::BatchDisassociateServiceActionFromProvisioningArtifact)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_disassociate_service_action_from_provisioning_artifact::BatchDisassociateServiceActionFromProvisioningArtifact, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_disassociate_service_action_from_provisioning_artifact::BatchDisassociateServiceActionFromProvisioningArtifactInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_disassociate_service_action_from_provisioning_artifact::ser_batch_disassociate_service_action_from_provisioning_artifact_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_disassociate_service_action_from_provisioning_artifact::BatchDisassociateServiceActionFromProvisioningArtifact::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchDisassociateServiceActionFromProvisioningArtifact", "servicecatalog"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchDisassociateServiceActionFromProvisioningArtifact`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDisassociateServiceActionFromProvisioningArtifact {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_disassociate_service_action_from_provisioning_artifact::de_batch_disassociate_service_action_from_provisioning_artifact_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_disassociate_service_action_from_provisioning_artifact::de_batch_disassociate_service_action_from_provisioning_artifact_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type BatchDisassociateServiceActionFromProvisioningArtifactErrorKind = BatchDisassociateServiceActionFromProvisioningArtifactError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for BatchDisassociateServiceActionFromProvisioningArtifactError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for BatchDisassociateServiceActionFromProvisioningArtifactError {
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_disassociate_service_action_from_provisioning_artifact::BatchDisassociateServiceActionFromProvisioningArtifactError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for BatchDisassociateServiceActionFromProvisioningArtifactError {
...
mod _batch_disassociate_service_action_from_provisioning_artifact_output;
