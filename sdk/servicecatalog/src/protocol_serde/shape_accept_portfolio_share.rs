...
#[allow(clippy::unnecessary_wraps)]
pub fn de_accept_portfolio_share_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::accept_portfolio_share::AcceptPortfolioShareOutput, crate::operation::accept_portfolio_share::AcceptPortfolioShareError> {
    Ok({
        #[allow(unused_mut)]
