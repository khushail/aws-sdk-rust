...
pub(crate) fn de_robot_software_suite<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RobotSoftwareSuite>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "version" => {
                                builder = builder.set_version(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::RobotSoftwareSuiteVersionType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
