...
pub(crate) fn de_rendering_engine<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RenderingEngine>, ::aws_smithy_json::deserialize::error::DeserializeError>
