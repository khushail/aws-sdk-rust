...
pub fn ser_create_robot_application_input(input: &crate::operation::create_robot_application::CreateRobotApplicationInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_create_robot_application_input::ser_create_robot_application_input(&mut object, input)?;
    object.finish();
...
pub fn de_create_robot_application_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_robot_application::CreateRobotApplicationOutput, crate::operation::create_robot_application::CreateRobotApplicationError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::create_robot_application::CreateRobotApplicationError::unhandled(generic))
                            };
    
                            let _error_message = generic.message().map(|msg|msg.to_owned());
    Err(match error_code {
        "IdempotentParameterMismatchException" => crate::operation::create_robot_application::CreateRobotApplicationError::IdempotentParameterMismatchException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InternalServerException" => crate::operation::create_robot_application::CreateRobotApplicationError::InternalServerException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterException" => crate::operation::create_robot_application::CreateRobotApplicationError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "LimitExceededException" => crate::operation::create_robot_application::CreateRobotApplicationError::LimitExceededException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ResourceAlreadyExistsException" => crate::operation::create_robot_application::CreateRobotApplicationError::ResourceAlreadyExistsException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ThrottlingException" => crate::operation::create_robot_application::CreateRobotApplicationError::ThrottlingException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        _ => crate::operation::create_robot_application::CreateRobotApplicationError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_create_robot_application_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_robot_application::CreateRobotApplicationOutput, crate::operation::create_robot_application::CreateRobotApplicationError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_create_robot_application(value: &[u8], mut builder: crate::operation::create_robot_application::builders::CreateRobotApplicationOutputBuilder) -> Result<crate::operation::create_robot_application::builders::CreateRobotApplicationOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
