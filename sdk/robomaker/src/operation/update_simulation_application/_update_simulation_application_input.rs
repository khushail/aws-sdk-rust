...
impl UpdateSimulationApplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_simulation_application::UpdateSimulationApplicationInput, ::aws_smithy_http::operation::error::BuildError> {
