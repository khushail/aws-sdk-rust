...
impl ListSimulationApplicationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_simulation_applications::ListSimulationApplicationsInput, ::aws_smithy_http::operation::error::BuildError> {
