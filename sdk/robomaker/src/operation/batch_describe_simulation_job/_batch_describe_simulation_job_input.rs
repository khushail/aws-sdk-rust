...
impl BatchDescribeSimulationJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_describe_simulation_job::BatchDescribeSimulationJobInput, ::aws_smithy_http::operation::error::BuildError> {
