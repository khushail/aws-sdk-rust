...
impl DescribeRobotApplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_robot_application::DescribeRobotApplicationInput, ::aws_smithy_http::operation::error::BuildError> {
