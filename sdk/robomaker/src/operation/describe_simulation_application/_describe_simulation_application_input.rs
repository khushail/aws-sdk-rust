...
impl DescribeSimulationApplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_simulation_application::DescribeSimulationApplicationInput, ::aws_smithy_http::operation::error::BuildError> {
