...
impl StartSimulationJobBatchInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_simulation_job_batch::StartSimulationJobBatchInput, ::aws_smithy_http::operation::error::BuildError> {
