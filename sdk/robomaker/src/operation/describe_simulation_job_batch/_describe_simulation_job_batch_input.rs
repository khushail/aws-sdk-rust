...
impl DescribeSimulationJobBatchInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_simulation_job_batch::DescribeSimulationJobBatchInput, ::aws_smithy_http::operation::error::BuildError> {
