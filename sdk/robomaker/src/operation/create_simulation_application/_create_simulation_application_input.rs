...
impl CreateSimulationApplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_simulation_application::CreateSimulationApplicationInput, ::aws_smithy_http::operation::error::BuildError> {
