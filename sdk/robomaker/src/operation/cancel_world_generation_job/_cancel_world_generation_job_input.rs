...
impl CancelWorldGenerationJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::cancel_world_generation_job::CancelWorldGenerationJobInput, ::aws_smithy_http::operation::error::BuildError> {
