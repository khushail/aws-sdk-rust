...
impl super::Client  {
    ...
    ///   - [`connection_alias(impl ::std::convert::Into<String>)`](crate::operation::create_outbound_connection::builders::CreateOutboundConnectionFluentBuilder::connection_alias) / [`set_connection_alias(Option<String>)`](crate::operation::create_outbound_connection::builders::CreateOutboundConnectionFluentBuilder::set_connection_alias): <p>Name of the connection.</p>
    ...
    ///   - [`connection_properties(ConnectionProperties)`](crate::operation::create_outbound_connection::builders::CreateOutboundConnectionFluentBuilder::connection_properties) / [`set_connection_properties(Option<ConnectionProperties>)`](crate::operation::create_outbound_connection::builders::CreateOutboundConnectionFluentBuilder::set_connection_properties): <p>The <code>ConnectionProperties</code> for the outbound connection.</p>
