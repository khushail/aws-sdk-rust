...
impl super::Client  {
    ...
    ///   - [`package_id(impl ::std::convert::Into<String>)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::package_id) / [`set_package_id(Option<String>)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::set_package_id): <p>The unique identifier of the package for which to list associated domains.</p>
    ///   - [`max_results(i32)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::set_max_results): <p>An optional parameter that specifies the maximum number of results to return. You can use <code>nextToken</code> to get the next page of results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_domains_for_package::builders::ListDomainsForPackageFluentBuilder::set_next_token): <p>If your initial <code>ListDomainsForPackage</code> operation returns a <code>nextToken</code>, you can include the returned <code>nextToken</code> in subsequent <code>ListDomainsForPackage</code> operations, which returns results in the next page.</p>
