...
impl super::Client  {
    ...
    ///   - [`package_id(impl ::std::convert::Into<String>)`](crate::operation::update_package::builders::UpdatePackageFluentBuilder::package_id) / [`set_package_id(Option<String>)`](crate::operation::update_package::builders::UpdatePackageFluentBuilder::set_package_id): <p>The unique identifier for the package.</p>
    ...
    ///   - [`package_description(impl ::std::convert::Into<String>)`](crate::operation::update_package::builders::UpdatePackageFluentBuilder::package_description) / [`set_package_description(Option<String>)`](crate::operation::update_package::builders::UpdatePackageFluentBuilder::set_package_description): <p>A new description of the package.</p>
