...
impl DescribeOutboundConnectionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_outbound_connections::DescribeOutboundConnectionsInput, ::aws_smithy_http::operation::error::BuildError> {
