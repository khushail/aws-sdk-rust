...
impl CancelServiceSoftwareUpdateInput {
    /// Consumes the builder and constructs an Operation<[`CancelServiceSoftwareUpdate`](crate::operation::cancel_service_software_update::CancelServiceSoftwareUpdate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_service_software_update::CancelServiceSoftwareUpdate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_service_software_update::CancelServiceSoftwareUpdateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2021-01-01/opensearch/serviceSoftwareUpdate/cancel").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_service_software_update::CancelServiceSoftwareUpdate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CancelServiceSoftwareUpdate", "opensearch"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CancelServiceSoftwareUpdate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelServiceSoftwareUpdate {
                type Output = ::std::result::Result<crate::operation::cancel_service_software_update::CancelServiceSoftwareUpdateOutput, crate::operation::cancel_service_software_update::CancelServiceSoftwareUpdateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_cancel_service_software_update::de_cancel_service_software_update_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_cancel_service_software_update::de_cancel_service_software_update_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_service_software_update::CancelServiceSoftwareUpdateError {
...
mod _cancel_service_software_update_output;
