...
impl DeleteOutboundConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_outbound_connection::DeleteOutboundConnectionInput, ::aws_smithy_http::operation::error::BuildError> {
