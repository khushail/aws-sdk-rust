...
impl AcceptInboundConnectionInput {
    /// Consumes the builder and constructs an Operation<[`AcceptInboundConnection`](crate::operation::accept_inbound_connection::AcceptInboundConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::accept_inbound_connection::AcceptInboundConnection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::accept_inbound_connection::AcceptInboundConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if connection_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("connection_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/2021-01-01/opensearch/cc/inboundConnection/{ConnectionId}/accept", ConnectionId = connection_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::accept_inbound_connection::AcceptInboundConnectionInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::accept_inbound_connection::AcceptInboundConnection::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AcceptInboundConnection", "opensearch"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AcceptInboundConnection`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptInboundConnection {
                type Output = ::std::result::Result<crate::operation::accept_inbound_connection::AcceptInboundConnectionOutput, crate::operation::accept_inbound_connection::AcceptInboundConnectionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_accept_inbound_connection::de_accept_inbound_connection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_accept_inbound_connection::de_accept_inbound_connection_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::accept_inbound_connection::AcceptInboundConnectionError {
...
mod _accept_inbound_connection_output;
