...
impl CreateOutboundConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_outbound_connection::CreateOutboundConnectionInput, ::aws_smithy_http::operation::error::BuildError> {
