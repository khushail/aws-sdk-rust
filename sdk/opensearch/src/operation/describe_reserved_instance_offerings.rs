...
impl DescribeReservedInstanceOfferingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReservedInstanceOfferings`](crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2021-01-01/opensearch/reservedInstanceOfferings").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                if let ::std::option::Option::Some(inner_1) = &_input.reserved_instance_offering_id {
                     {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedInstanceOfferings {
                type Output = ::std::result::Result<crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsOutput, crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_reserved_instance_offerings::de_describe_reserved_instance_offerings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_reserved_instance_offerings::de_describe_reserved_instance_offerings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_reserved_instance_offerings::DescribeReservedInstanceOfferingsError {
...
pub use crate::operation::describe_reserved_instance_offerings::_describe_reserved_instance_offerings_output::DescribeReservedInstanceOfferingsOutput;

pub use crate::operation::describe_reserved_instance_offerings::_describe_reserved_instance_offerings_input::DescribeReservedInstanceOfferingsInput;

mod _describe_reserved_instance_offerings_input;

mod _describe_reserved_instance_offerings_output;
