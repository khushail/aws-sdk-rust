...
impl ListInstanceTypeDetailsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_instance_type_details::ListInstanceTypeDetailsInput, ::aws_smithy_http::operation::error::BuildError> {
