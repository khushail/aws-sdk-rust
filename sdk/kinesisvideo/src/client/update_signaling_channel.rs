...
impl super::Client  {
    ...
    ///   - [`channel_arn(impl ::std::convert::Into<String>)`](crate::operation::update_signaling_channel::builders::UpdateSignalingChannelFluentBuilder::channel_arn) / [`set_channel_arn(Option<String>)`](crate::operation::update_signaling_channel::builders::UpdateSignalingChannelFluentBuilder::set_channel_arn): <p>The Amazon Resource Name (ARN) of the signaling channel that you want to update.</p>
    ///   - [`current_version(impl ::std::convert::Into<String>)`](crate::operation::update_signaling_channel::builders::UpdateSignalingChannelFluentBuilder::current_version) / [`set_current_version(Option<String>)`](crate::operation::update_signaling_channel::builders::UpdateSignalingChannelFluentBuilder::set_current_version): <p>The current version of the signaling channel that you want to update.</p>
