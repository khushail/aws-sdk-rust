...
impl DescribeEdgeConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEdgeConfiguration`](crate::operation::describe_edge_configuration::DescribeEdgeConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_edge_configuration::DescribeEdgeConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_edge_configuration::DescribeEdgeConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/describeEdgeConfiguration").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_edge_configuration::ser_describe_edge_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_edge_configuration::DescribeEdgeConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeEdgeConfiguration", "kinesisvideo"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeEdgeConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEdgeConfiguration {
                type Output = ::std::result::Result<crate::operation::describe_edge_configuration::DescribeEdgeConfigurationOutput, crate::operation::describe_edge_configuration::DescribeEdgeConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_edge_configuration::de_describe_edge_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_edge_configuration::de_describe_edge_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_edge_configuration::DescribeEdgeConfigurationError {
...
mod _describe_edge_configuration_output;
