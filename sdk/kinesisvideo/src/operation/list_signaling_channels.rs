...
impl ListSignalingChannelsInput {
    /// Consumes the builder and constructs an Operation<[`ListSignalingChannels`](crate::operation::list_signaling_channels::ListSignalingChannels)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_signaling_channels::ListSignalingChannels, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_signaling_channels::ListSignalingChannelsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/listSignalingChannels").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_signaling_channels::ser_list_signaling_channels_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_signaling_channels::ListSignalingChannels::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSignalingChannels {
                type Output = ::std::result::Result<crate::operation::list_signaling_channels::ListSignalingChannelsOutput, crate::operation::list_signaling_channels::ListSignalingChannelsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_signaling_channels::de_list_signaling_channels_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_signaling_channels::de_list_signaling_channels_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_signaling_channels::ListSignalingChannelsError {
...
mod _list_signaling_channels_output;
