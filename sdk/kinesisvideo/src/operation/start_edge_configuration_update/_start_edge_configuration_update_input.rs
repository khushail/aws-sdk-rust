...
impl StartEdgeConfigurationUpdateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_edge_configuration_update::StartEdgeConfigurationUpdateInput, ::aws_smithy_http::operation::error::BuildError> {
