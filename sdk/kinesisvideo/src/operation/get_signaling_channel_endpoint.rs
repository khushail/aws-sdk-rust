...
impl GetSignalingChannelEndpointInput {
    /// Consumes the builder and constructs an Operation<[`GetSignalingChannelEndpoint`](crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpoint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/getSignalingChannelEndpoint").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_signaling_channel_endpoint::ser_get_signaling_channel_endpoint_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpoint::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetSignalingChannelEndpoint {
                type Output = ::std::result::Result<crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpointOutput, crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpointError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_signaling_channel_endpoint::de_get_signaling_channel_endpoint_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_signaling_channel_endpoint::de_get_signaling_channel_endpoint_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_signaling_channel_endpoint::GetSignalingChannelEndpointError {
...
mod _get_signaling_channel_endpoint_output;
