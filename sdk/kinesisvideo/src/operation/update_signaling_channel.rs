...
impl UpdateSignalingChannelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSignalingChannel`](crate::operation::update_signaling_channel::UpdateSignalingChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_signaling_channel::UpdateSignalingChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_signaling_channel::UpdateSignalingChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/updateSignalingChannel").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_signaling_channel::ser_update_signaling_channel_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_signaling_channel::UpdateSignalingChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateSignalingChannel", "kinesisvideo"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateSignalingChannel`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSignalingChannel {
                type Output = ::std::result::Result<crate::operation::update_signaling_channel::UpdateSignalingChannelOutput, crate::operation::update_signaling_channel::UpdateSignalingChannelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_signaling_channel::de_update_signaling_channel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_signaling_channel::de_update_signaling_channel_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_signaling_channel::UpdateSignalingChannelError {
...
mod _update_signaling_channel_output;
