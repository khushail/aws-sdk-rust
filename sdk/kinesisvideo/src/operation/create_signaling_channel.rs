...
impl CreateSignalingChannelInput {
    /// Consumes the builder and constructs an Operation<[`CreateSignalingChannel`](crate::operation::create_signaling_channel::CreateSignalingChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_signaling_channel::CreateSignalingChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_signaling_channel::CreateSignalingChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/createSignalingChannel").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_signaling_channel::ser_create_signaling_channel_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_signaling_channel::CreateSignalingChannel::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSignalingChannel {
                type Output = ::std::result::Result<crate::operation::create_signaling_channel::CreateSignalingChannelOutput, crate::operation::create_signaling_channel::CreateSignalingChannelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_signaling_channel::de_create_signaling_channel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_signaling_channel::de_create_signaling_channel_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_signaling_channel::CreateSignalingChannelError {
...
mod _create_signaling_channel_output;
