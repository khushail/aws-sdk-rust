...
impl DescribeEdgeConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_edge_configuration::DescribeEdgeConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
