...
impl super::Client  {
    ...
    ///   - [`pipeline_id(impl ::std::convert::Into<String>)`](crate::operation::deactivate_pipeline::builders::DeactivatePipelineFluentBuilder::pipeline_id) / [`set_pipeline_id(Option<String>)`](crate::operation::deactivate_pipeline::builders::DeactivatePipelineFluentBuilder::set_pipeline_id): <p>The ID of the pipeline.</p>
