...
impl QueryObjectsInput {
    /// Consumes the builder and constructs an Operation<[`QueryObjects`](crate::operation::query_objects::QueryObjects)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::query_objects::QueryObjects, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::query_objects::QueryObjectsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::query_objects::QueryObjects::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("QueryObjects", "datapipeline"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `QueryObjects`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for QueryObjects {
                type Output = ::std::result::Result<crate::operation::query_objects::QueryObjectsOutput, crate::operation::query_objects::QueryObjectsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_query_objects::de_query_objects_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_query_objects::de_query_objects_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::query_objects::QueryObjectsError {
