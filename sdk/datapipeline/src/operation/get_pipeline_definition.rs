...
impl GetPipelineDefinitionInput {
    /// Consumes the builder and constructs an Operation<[`GetPipelineDefinition`](crate::operation::get_pipeline_definition::GetPipelineDefinition)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_pipeline_definition::GetPipelineDefinition, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_pipeline_definition::GetPipelineDefinitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_pipeline_definition::GetPipelineDefinition::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetPipelineDefinition", "datapipeline"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetPipelineDefinition`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPipelineDefinition {
                type Output = ::std::result::Result<crate::operation::get_pipeline_definition::GetPipelineDefinitionOutput, crate::operation::get_pipeline_definition::GetPipelineDefinitionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_pipeline_definition::de_get_pipeline_definition_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_pipeline_definition::de_get_pipeline_definition_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_pipeline_definition::GetPipelineDefinitionError {
...
mod _get_pipeline_definition_output;
