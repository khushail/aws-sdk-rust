...
impl ReportTaskRunnerHeartbeatInput {
    /// Consumes the builder and constructs an Operation<[`ReportTaskRunnerHeartbeat`](crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeat)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeat, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeat::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ReportTaskRunnerHeartbeat {
                type Output = ::std::result::Result<crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatOutput, crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_report_task_runner_heartbeat::de_report_task_runner_heartbeat_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_report_task_runner_heartbeat::de_report_task_runner_heartbeat_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::report_task_runner_heartbeat::ReportTaskRunnerHeartbeatError {
...
mod _report_task_runner_heartbeat_output;
