...
impl DescribePipelinesInput {
    /// Consumes the builder and constructs an Operation<[`DescribePipelines`](crate::operation::describe_pipelines::DescribePipelines)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_pipelines::DescribePipelines, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_pipelines::DescribePipelinesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_pipelines::DescribePipelines::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribePipelines", "datapipeline"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribePipelines`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribePipelines {
                type Output = ::std::result::Result<crate::operation::describe_pipelines::DescribePipelinesOutput, crate::operation::describe_pipelines::DescribePipelinesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_pipelines::de_describe_pipelines_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_pipelines::de_describe_pipelines_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_pipelines::DescribePipelinesError {
...
pub use crate::operation::describe_pipelines::_describe_pipelines_output::DescribePipelinesOutput;

pub use crate::operation::describe_pipelines::_describe_pipelines_input::DescribePipelinesInput;

mod _describe_pipelines_input;

mod _describe_pipelines_output;
