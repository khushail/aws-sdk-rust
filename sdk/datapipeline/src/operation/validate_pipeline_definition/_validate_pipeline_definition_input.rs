...
impl ValidatePipelineDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::validate_pipeline_definition::ValidatePipelineDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
