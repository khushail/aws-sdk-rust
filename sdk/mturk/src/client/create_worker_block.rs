...
impl super::Client  {
    ...
    ///   - [`worker_id(impl ::std::convert::Into<String>)`](crate::operation::create_worker_block::builders::CreateWorkerBlockFluentBuilder::worker_id) / [`set_worker_id(Option<String>)`](crate::operation::create_worker_block::builders::CreateWorkerBlockFluentBuilder::set_worker_id): <p>The ID of the Worker to block.</p>
