...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_hi_ts::builders::ListHITsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_hi_ts::builders::ListHITsFluentBuilder::set_next_token): <p>Pagination token</p>
