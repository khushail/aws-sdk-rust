...
impl super::Client  {
    ...
    ///   - [`hit_id(impl ::std::convert::Into<String>)`](crate::operation::get_hit::builders::GetHITFluentBuilder::hit_id) / [`set_hit_id(Option<String>)`](crate::operation::get_hit::builders::GetHITFluentBuilder::set_hit_id): <p>The ID of the HIT to be retrieved.</p>
