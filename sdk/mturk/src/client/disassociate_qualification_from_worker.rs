...
impl super::Client  {
    ...
    ///   - [`worker_id(impl ::std::convert::Into<String>)`](crate::operation::disassociate_qualification_from_worker::builders::DisassociateQualificationFromWorkerFluentBuilder::worker_id) / [`set_worker_id(Option<String>)`](crate::operation::disassociate_qualification_from_worker::builders::DisassociateQualificationFromWorkerFluentBuilder::set_worker_id): <p>The ID of the Worker who possesses the Qualification to be revoked.</p>
    ///   - [`qualification_type_id(impl ::std::convert::Into<String>)`](crate::operation::disassociate_qualification_from_worker::builders::DisassociateQualificationFromWorkerFluentBuilder::qualification_type_id) / [`set_qualification_type_id(Option<String>)`](crate::operation::disassociate_qualification_from_worker::builders::DisassociateQualificationFromWorkerFluentBuilder::set_qualification_type_id): <p>The ID of the Qualification type of the Qualification to be revoked.</p>
