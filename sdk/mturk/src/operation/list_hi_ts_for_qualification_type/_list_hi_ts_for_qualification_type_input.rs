...
impl ListHiTsForQualificationTypeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_hi_ts_for_qualification_type::ListHiTsForQualificationTypeInput, ::aws_smithy_http::operation::error::BuildError> {
