...
impl DeleteQualificationTypeInput {
    /// Consumes the builder and constructs an Operation<[`DeleteQualificationType`](crate::operation::delete_qualification_type::DeleteQualificationType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_qualification_type::DeleteQualificationType, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_qualification_type::DeleteQualificationTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_qualification_type::DeleteQualificationType::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteQualificationType", "mturk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteQualificationType`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteQualificationType {
                type Output = ::std::result::Result<crate::operation::delete_qualification_type::DeleteQualificationTypeOutput, crate::operation::delete_qualification_type::DeleteQualificationTypeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_qualification_type::de_delete_qualification_type_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_qualification_type::de_delete_qualification_type_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_qualification_type::DeleteQualificationTypeError {
...
mod _delete_qualification_type_output;
