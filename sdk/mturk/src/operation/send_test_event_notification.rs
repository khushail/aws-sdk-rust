...
impl SendTestEventNotificationInput {
    /// Consumes the builder and constructs an Operation<[`SendTestEventNotification`](crate::operation::send_test_event_notification::SendTestEventNotification)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::send_test_event_notification::SendTestEventNotification, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_test_event_notification::SendTestEventNotificationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::send_test_event_notification::SendTestEventNotification::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SendTestEventNotification", "mturk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `SendTestEventNotification`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendTestEventNotification {
                type Output = ::std::result::Result<crate::operation::send_test_event_notification::SendTestEventNotificationOutput, crate::operation::send_test_event_notification::SendTestEventNotificationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_send_test_event_notification::de_send_test_event_notification_http_response_with_props(status, headers, body)
                     }
                }
...
mod _send_test_event_notification_output;
