...
impl ListWorkersWithQualificationTypeInput {
    /// Consumes the builder and constructs an Operation<[`ListWorkersWithQualificationType`](crate::operation::list_workers_with_qualification_type::ListWorkersWithQualificationType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_workers_with_qualification_type::ListWorkersWithQualificationType, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_workers_with_qualification_type::ListWorkersWithQualificationTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_workers_with_qualification_type::ListWorkersWithQualificationType::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListWorkersWithQualificationType", "mturk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListWorkersWithQualificationType`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkersWithQualificationType {
                type Output = ::std::result::Result<crate::operation::list_workers_with_qualification_type::ListWorkersWithQualificationTypeOutput, crate::operation::list_workers_with_qualification_type::ListWorkersWithQualificationTypeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_workers_with_qualification_type::de_list_workers_with_qualification_type_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_workers_with_qualification_type::de_list_workers_with_qualification_type_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_workers_with_qualification_type::ListWorkersWithQualificationTypeError {
...
mod _list_workers_with_qualification_type_output;
