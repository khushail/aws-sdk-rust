...
impl ListQualificationTypesInput {
    /// Consumes the builder and constructs an Operation<[`ListQualificationTypes`](crate::operation::list_qualification_types::ListQualificationTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_qualification_types::ListQualificationTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_qualification_types::ListQualificationTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_qualification_types::ListQualificationTypes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListQualificationTypes", "mturk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListQualificationTypes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListQualificationTypes {
                type Output = ::std::result::Result<crate::operation::list_qualification_types::ListQualificationTypesOutput, crate::operation::list_qualification_types::ListQualificationTypesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_qualification_types::de_list_qualification_types_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_qualification_types::de_list_qualification_types_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_qualification_types::ListQualificationTypesError {
...
pub use crate::operation::list_qualification_types::_list_qualification_types_output::ListQualificationTypesOutput;

pub use crate::operation::list_qualification_types::_list_qualification_types_input::ListQualificationTypesInput;

mod _list_qualification_types_input;

mod _list_qualification_types_output;
