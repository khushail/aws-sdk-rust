...
impl ListHiTsForQualificationTypeInput {
    /// Consumes the builder and constructs an Operation<[`ListHITsForQualificationType`](crate::operation::list_hi_ts_for_qualification_type::ListHITsForQualificationType)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_hi_ts_for_qualification_type::ListHITsForQualificationType, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_hi_ts_for_qualification_type::ListHiTsForQualificationTypeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_hi_ts_for_qualification_type::ListHITsForQualificationType::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHITsForQualificationType {
                type Output = ::std::result::Result<crate::operation::list_hi_ts_for_qualification_type::ListHiTsForQualificationTypeOutput, crate::operation::list_hi_ts_for_qualification_type::ListHITsForQualificationTypeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_hi_ts_for_qualification_type::de_list_hi_ts_for_qualification_type_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_hi_ts_for_qualification_type::de_list_hi_ts_for_qualification_type_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_hi_ts_for_qualification_type::ListHITsForQualificationTypeError {
...
pub use crate::operation::list_hi_ts_for_qualification_type::_list_hi_ts_for_qualification_type_output::ListHiTsForQualificationTypeOutput;

pub use crate::operation::list_hi_ts_for_qualification_type::_list_hi_ts_for_qualification_type_input::ListHiTsForQualificationTypeInput;

mod _list_hi_ts_for_qualification_type_input;

mod _list_hi_ts_for_qualification_type_output;
