...
impl GetQualificationScoreInput {
    /// Consumes the builder and constructs an Operation<[`GetQualificationScore`](crate::operation::get_qualification_score::GetQualificationScore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_qualification_score::GetQualificationScore, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_qualification_score::GetQualificationScoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_qualification_score::GetQualificationScore::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetQualificationScore", "mturk"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetQualificationScore`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetQualificationScore {
                type Output = ::std::result::Result<crate::operation::get_qualification_score::GetQualificationScoreOutput, crate::operation::get_qualification_score::GetQualificationScoreError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_qualification_score::de_get_qualification_score_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_qualification_score::de_get_qualification_score_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_qualification_score::GetQualificationScoreError {
...
pub use crate::operation::get_qualification_score::_get_qualification_score_output::GetQualificationScoreOutput;

pub use crate::operation::get_qualification_score::_get_qualification_score_input::GetQualificationScoreInput;

mod _get_qualification_score_input;

mod _get_qualification_score_output;
