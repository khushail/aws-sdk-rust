...
impl ListAssistantsInput {
    /// Consumes the builder and constructs an Operation<[`ListAssistants`](crate::operation::list_assistants::ListAssistants)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_assistants::ListAssistants, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_assistants::ListAssistantsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/assistants").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_assistants::ListAssistantsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_assistants::ListAssistants::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAssistants", "wisdom"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAssistants {
                type Output = ::std::result::Result<crate::operation::list_assistants::ListAssistantsOutput, crate::operation::list_assistants::ListAssistantsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_assistants::de_list_assistants_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_assistants::ListAssistantsError {
