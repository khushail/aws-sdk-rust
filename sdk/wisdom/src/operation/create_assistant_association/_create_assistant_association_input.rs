...
impl CreateAssistantAssociationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_assistant_association::CreateAssistantAssociationInput, ::aws_smithy_http::operation::error::BuildError> {
