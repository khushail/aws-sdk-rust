...
impl NotifyRecommendationsReceivedInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::notify_recommendations_received::NotifyRecommendationsReceivedInput, ::aws_smithy_http::operation::error::BuildError> {
