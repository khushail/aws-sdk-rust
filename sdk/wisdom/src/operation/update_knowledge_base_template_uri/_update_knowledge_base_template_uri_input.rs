...
impl UpdateKnowledgeBaseTemplateUriInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_knowledge_base_template_uri::UpdateKnowledgeBaseTemplateUriInput, ::aws_smithy_http::operation::error::BuildError> {
