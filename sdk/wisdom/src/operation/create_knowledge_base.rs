...
impl CreateKnowledgeBaseInput {
    /// Consumes the builder and constructs an Operation<[`CreateKnowledgeBase`](crate::operation::create_knowledge_base::CreateKnowledgeBase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_knowledge_base::CreateKnowledgeBase, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_knowledge_base::CreateKnowledgeBaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_knowledge_base::ser_create_knowledge_base_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_knowledge_base::CreateKnowledgeBase::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateKnowledgeBase", "wisdom"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateKnowledgeBase {
                type Output = ::std::result::Result<crate::operation::create_knowledge_base::CreateKnowledgeBaseOutput, crate::operation::create_knowledge_base::CreateKnowledgeBaseError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_knowledge_base::de_create_knowledge_base_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_knowledge_base::CreateKnowledgeBaseError {
