...
impl CreateAssistantAssociationInput {
    /// Consumes the builder and constructs an Operation<[`CreateAssistantAssociation`](crate::operation::create_assistant_association::CreateAssistantAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_assistant_association::CreateAssistantAssociation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_assistant_association::CreateAssistantAssociationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_assistant_association::ser_create_assistant_association_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_assistant_association::CreateAssistantAssociation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAssistantAssociation", "wisdom"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAssistantAssociation {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_assistant_association::de_create_assistant_association_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_assistant_association::CreateAssistantAssociationError {
