...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_knowledge_base_template_uri_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_knowledge_base_template_uri::RemoveKnowledgeBaseTemplateUriOutput, crate::operation::remove_knowledge_base_template_uri::RemoveKnowledgeBaseTemplateUriError> {
    Ok({
        #[allow(unused_mut)]
