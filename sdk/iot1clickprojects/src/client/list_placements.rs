...
impl super::Client  {
    ...
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::list_placements::builders::ListPlacementsFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::list_placements::builders::ListPlacementsFluentBuilder::set_project_name): <p>The project containing the placements to be listed.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_placements::builders::ListPlacementsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_placements::builders::ListPlacementsFluentBuilder::set_next_token): <p>The token to retrieve the next set of results.</p>
