...
impl super::Client  {
    ...
    ///   - [`cluster(impl ::std::convert::Into<String>)`](crate::operation::describe_container_instances::builders::DescribeContainerInstancesFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::describe_container_instances::builders::DescribeContainerInstancesFluentBuilder::set_cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the container instances to describe. If you do not specify a cluster, the default cluster is assumed. This parameter is required if the container instance or container instances you are describing were launched in any cluster other than the default cluster.</p>
