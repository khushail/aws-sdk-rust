...
impl super::Client  {
    ...
    ///   - [`cluster(impl ::std::convert::Into<String>)`](crate::operation::put_attributes::builders::PutAttributesFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::put_attributes::builders::PutAttributesFluentBuilder::set_cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that contains the resource to apply attributes. If you do not specify a cluster, the default cluster is assumed.</p>
