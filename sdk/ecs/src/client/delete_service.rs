...
impl super::Client  {
    ...
    ///   - [`cluster(impl ::std::convert::Into<String>)`](crate::operation::delete_service::builders::DeleteServiceFluentBuilder::cluster) / [`set_cluster(Option<String>)`](crate::operation::delete_service::builders::DeleteServiceFluentBuilder::set_cluster): <p>The short name or full Amazon Resource Name (ARN) of the cluster that hosts the service to delete. If you do not specify a cluster, the default cluster is assumed.</p>
    ///   - [`service(impl ::std::convert::Into<String>)`](crate::operation::delete_service::builders::DeleteServiceFluentBuilder::service) / [`set_service(Option<String>)`](crate::operation::delete_service::builders::DeleteServiceFluentBuilder::set_service): <p>The name of the service to delete.</p>
