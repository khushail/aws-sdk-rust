...
impl PutClusterCapacityProvidersInput {
    /// Consumes the builder and constructs an Operation<[`PutClusterCapacityProviders`](crate::operation::put_cluster_capacity_providers::PutClusterCapacityProviders)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_cluster_capacity_providers::PutClusterCapacityProviders, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_cluster_capacity_providers::ser_put_cluster_capacity_providers_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_cluster_capacity_providers::PutClusterCapacityProviders::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutClusterCapacityProviders {
                type Output = ::std::result::Result<crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersOutput, crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_put_cluster_capacity_providers::de_put_cluster_capacity_providers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersError {
...
mod _put_cluster_capacity_providers_output;
