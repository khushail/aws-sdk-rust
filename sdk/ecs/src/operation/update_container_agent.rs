...
impl UpdateContainerAgentInput {
    /// Consumes the builder and constructs an Operation<[`UpdateContainerAgent`](crate::operation::update_container_agent::UpdateContainerAgent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_container_agent::UpdateContainerAgent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_container_agent::UpdateContainerAgentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_container_agent::ser_update_container_agent_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_container_agent::UpdateContainerAgent::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContainerAgent {
                type Output = ::std::result::Result<crate::operation::update_container_agent::UpdateContainerAgentOutput, crate::operation::update_container_agent::UpdateContainerAgentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_container_agent::de_update_container_agent_http_response_with_props(status, headers, body)
                     }
                }
