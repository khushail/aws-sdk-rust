...
impl ListServicesByNamespaceInput {
    /// Consumes the builder and constructs an Operation<[`ListServicesByNamespace`](crate::operation::list_services_by_namespace::ListServicesByNamespace)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_services_by_namespace::ListServicesByNamespace, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_services_by_namespace::ListServicesByNamespaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_services_by_namespace::ser_list_services_by_namespace_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_services_by_namespace::ListServicesByNamespace::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListServicesByNamespace", "ecs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListServicesByNamespace {
                type Output = ::std::result::Result<crate::operation::list_services_by_namespace::ListServicesByNamespaceOutput, crate::operation::list_services_by_namespace::ListServicesByNamespaceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_services_by_namespace::de_list_services_by_namespace_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_services_by_namespace::ListServicesByNamespaceError {
...
mod _list_services_by_namespace_output;
