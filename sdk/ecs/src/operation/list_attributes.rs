...
impl ListAttributesInput {
    /// Consumes the builder and constructs an Operation<[`ListAttributes`](crate::operation::list_attributes::ListAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_attributes::ListAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_attributes::ListAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_attributes::ser_list_attributes_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_attributes::ListAttributes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAttributes {
                type Output = ::std::result::Result<crate::operation::list_attributes::ListAttributesOutput, crate::operation::list_attributes::ListAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_attributes::de_list_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_attributes::ListAttributesError {
...
pub use crate::operation::list_attributes::_list_attributes_output::ListAttributesOutput;

pub use crate::operation::list_attributes::_list_attributes_input::ListAttributesInput;

mod _list_attributes_input;

mod _list_attributes_output;
