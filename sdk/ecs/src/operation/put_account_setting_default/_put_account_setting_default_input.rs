...
impl PutAccountSettingDefaultInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_account_setting_default::PutAccountSettingDefaultInput, ::aws_smithy_http::operation::error::BuildError> {
