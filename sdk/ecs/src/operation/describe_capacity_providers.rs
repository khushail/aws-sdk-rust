...
impl DescribeCapacityProvidersInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_capacity_providers::DescribeCapacityProviders, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_capacity_providers::DescribeCapacityProvidersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_capacity_providers::DescribeCapacityProviders::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCapacityProviders {
                type Output = ::std::result::Result<crate::operation::describe_capacity_providers::DescribeCapacityProvidersOutput, crate::operation::describe_capacity_providers::DescribeCapacityProvidersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_capacity_providers::de_describe_capacity_providers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_capacity_providers::DescribeCapacityProvidersError {
