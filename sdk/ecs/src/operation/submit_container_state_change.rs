...
impl SubmitContainerStateChangeInput {
    /// Consumes the builder and constructs an Operation<[`SubmitContainerStateChange`](crate::operation::submit_container_state_change::SubmitContainerStateChange)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::submit_container_state_change::SubmitContainerStateChange, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::submit_container_state_change::SubmitContainerStateChangeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_submit_container_state_change::ser_submit_container_state_change_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::submit_container_state_change::SubmitContainerStateChange::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SubmitContainerStateChange {
                type Output = ::std::result::Result<crate::operation::submit_container_state_change::SubmitContainerStateChangeOutput, crate::operation::submit_container_state_change::SubmitContainerStateChangeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_submit_container_state_change::de_submit_container_state_change_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::submit_container_state_change::SubmitContainerStateChangeError {
