...
impl UpdateCapacityProviderInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCapacityProvider`](crate::operation::update_capacity_provider::UpdateCapacityProvider)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_capacity_provider::UpdateCapacityProvider, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_capacity_provider::UpdateCapacityProviderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_capacity_provider::ser_update_capacity_provider_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_capacity_provider::UpdateCapacityProvider::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCapacityProvider {
                type Output = ::std::result::Result<crate::operation::update_capacity_provider::UpdateCapacityProviderOutput, crate::operation::update_capacity_provider::UpdateCapacityProviderError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_capacity_provider::de_update_capacity_provider_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_capacity_provider::UpdateCapacityProviderError {
