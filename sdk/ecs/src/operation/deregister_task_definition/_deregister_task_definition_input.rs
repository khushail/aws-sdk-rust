...
impl DeregisterTaskDefinitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_task_definition::DeregisterTaskDefinitionInput, ::aws_smithy_http::operation::error::BuildError> {
