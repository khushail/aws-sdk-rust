...
impl DescribeContainerInstancesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeContainerInstances`](crate::operation::describe_container_instances::DescribeContainerInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_container_instances::DescribeContainerInstances, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_container_instances::DescribeContainerInstancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_container_instances::ser_describe_container_instances_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_container_instances::DescribeContainerInstances::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeContainerInstances {
                type Output = ::std::result::Result<crate::operation::describe_container_instances::DescribeContainerInstancesOutput, crate::operation::describe_container_instances::DescribeContainerInstancesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_container_instances::de_describe_container_instances_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_container_instances::DescribeContainerInstancesError {
...
pub use crate::operation::describe_container_instances::_describe_container_instances_output::DescribeContainerInstancesOutput;

pub use crate::operation::describe_container_instances::_describe_container_instances_input::DescribeContainerInstancesInput;

mod _describe_container_instances_input;

mod _describe_container_instances_output;
