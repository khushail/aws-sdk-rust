...
impl RegisterContainerInstanceInput {
    /// Consumes the builder and constructs an Operation<[`RegisterContainerInstance`](crate::operation::register_container_instance::RegisterContainerInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_container_instance::RegisterContainerInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_container_instance::RegisterContainerInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_container_instance::ser_register_container_instance_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_container_instance::RegisterContainerInstance::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterContainerInstance {
                type Output = ::std::result::Result<crate::operation::register_container_instance::RegisterContainerInstanceOutput, crate::operation::register_container_instance::RegisterContainerInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_register_container_instance::de_register_container_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::register_container_instance::RegisterContainerInstanceError {
