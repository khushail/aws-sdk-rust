...
impl RegisterContainerInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::register_container_instance::RegisterContainerInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
