...
impl UpdateClusterSettingsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateClusterSettings`](crate::operation::update_cluster_settings::UpdateClusterSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_cluster_settings::UpdateClusterSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_cluster_settings::UpdateClusterSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_cluster_settings::ser_update_cluster_settings_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_cluster_settings::UpdateClusterSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateClusterSettings", "ecs"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateClusterSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateClusterSettings {
                type Output = ::std::result::Result<crate::operation::update_cluster_settings::UpdateClusterSettingsOutput, crate::operation::update_cluster_settings::UpdateClusterSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_cluster_settings::de_update_cluster_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_cluster_settings::de_update_cluster_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_cluster_settings::UpdateClusterSettingsError {
...
mod _update_cluster_settings_output;
