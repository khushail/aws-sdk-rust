...
pub(crate) fn de_volume_from<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VolumeFrom>, ::aws_smithy_json::deserialize::error::DeserializeError>
