...
#[allow(clippy::unnecessary_wraps)]
pub fn de_discover_poll_endpoint_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::discover_poll_endpoint::DiscoverPollEndpointOutput, crate::operation::discover_poll_endpoint::DiscoverPollEndpointError> {
    Ok({
        #[allow(unused_mut)]
