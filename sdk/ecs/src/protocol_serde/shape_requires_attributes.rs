...
pub(crate) fn de_requires_attributes<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::Attribute>>, ::aws_smithy_json::deserialize::error::DeserializeError>
