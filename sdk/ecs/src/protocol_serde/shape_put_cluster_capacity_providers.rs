...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_cluster_capacity_providers_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersOutput, crate::operation::put_cluster_capacity_providers::PutClusterCapacityProvidersError> {
    Ok({
        #[allow(unused_mut)]
