...
impl super::Client  {
    ...
    ///   - [`access_token(impl ::std::convert::Into<String>)`](crate::operation::logout::builders::LogoutFluentBuilder::access_token) / [`set_access_token(Option<String>)`](crate::operation::logout::builders::LogoutFluentBuilder::set_access_token): <p>The token issued by the <code>CreateToken</code> API call. For more information, see <a href="https://docs.aws.amazon.com/singlesignon/latest/OIDCAPIReference/API_CreateToken.html">CreateToken</a> in the <i>IAM Identity Center OIDC API Reference Guide</i>.</p>
