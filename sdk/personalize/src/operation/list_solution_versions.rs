...
impl ListSolutionVersionsInput {
    /// Consumes the builder and constructs an Operation<[`ListSolutionVersions`](crate::operation::list_solution_versions::ListSolutionVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_solution_versions::ListSolutionVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_solution_versions::ListSolutionVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_solution_versions::ListSolutionVersionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_solution_versions::ListSolutionVersions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListSolutionVersions", "personalize"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListSolutionVersions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSolutionVersions {
                type Output = ::std::result::Result<crate::operation::list_solution_versions::ListSolutionVersionsOutput, crate::operation::list_solution_versions::ListSolutionVersionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_solution_versions::de_list_solution_versions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_solution_versions::de_list_solution_versions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_solution_versions::ListSolutionVersionsError {
...
mod _list_solution_versions_output;
