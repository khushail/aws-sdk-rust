...
impl CreateBatchInferenceJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_batch_inference_job::CreateBatchInferenceJobInput, ::aws_smithy_http::operation::error::BuildError> {
