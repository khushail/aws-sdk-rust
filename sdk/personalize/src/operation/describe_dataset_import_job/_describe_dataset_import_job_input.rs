...
impl DescribeDatasetImportJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_dataset_import_job::DescribeDatasetImportJobInput, ::aws_smithy_http::operation::error::BuildError> {
