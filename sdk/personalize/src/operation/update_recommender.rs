...
impl UpdateRecommenderInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRecommender`](crate::operation::update_recommender::UpdateRecommender)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_recommender::UpdateRecommender, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_recommender::UpdateRecommenderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_recommender::UpdateRecommender::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateRecommender", "personalize"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateRecommender`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRecommender {
                type Output = ::std::result::Result<crate::operation::update_recommender::UpdateRecommenderOutput, crate::operation::update_recommender::UpdateRecommenderError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_recommender::de_update_recommender_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_recommender::de_update_recommender_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_recommender::UpdateRecommenderError {
...
mod _update_recommender_output;
