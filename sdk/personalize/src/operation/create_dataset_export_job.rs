...
impl CreateDatasetExportJobInput {
    /// Consumes the builder and constructs an Operation<[`CreateDatasetExportJob`](crate::operation::create_dataset_export_job::CreateDatasetExportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_dataset_export_job::CreateDatasetExportJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_dataset_export_job::CreateDatasetExportJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_dataset_export_job::CreateDatasetExportJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDatasetExportJob {
                type Output = ::std::result::Result<crate::operation::create_dataset_export_job::CreateDatasetExportJobOutput, crate::operation::create_dataset_export_job::CreateDatasetExportJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_dataset_export_job::de_create_dataset_export_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_dataset_export_job::CreateDatasetExportJobError {
