...
impl DescribeBatchSegmentJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_batch_segment_job::DescribeBatchSegmentJobInput, ::aws_smithy_http::operation::error::BuildError> {
