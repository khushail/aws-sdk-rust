...
impl ListMetricAttributionMetricsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_metric_attribution_metrics::ListMetricAttributionMetricsInput, ::aws_smithy_http::operation::error::BuildError> {
