...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_recommender::builders::CreateRecommenderFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_recommender::builders::CreateRecommenderFluentBuilder::set_name): <p>The name of the recommender.</p>
    ///   - [`dataset_group_arn(impl ::std::convert::Into<String>)`](crate::operation::create_recommender::builders::CreateRecommenderFluentBuilder::dataset_group_arn) / [`set_dataset_group_arn(Option<String>)`](crate::operation::create_recommender::builders::CreateRecommenderFluentBuilder::set_dataset_group_arn): <p>The Amazon Resource Name (ARN) of the destination domain dataset group for the recommender.</p>
