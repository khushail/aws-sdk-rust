...
impl super::Client  {
    ...
    ///   - [`dataset_group_arn(impl ::std::convert::Into<String>)`](crate::operation::list_solutions::builders::ListSolutionsFluentBuilder::dataset_group_arn) / [`set_dataset_group_arn(Option<String>)`](crate::operation::list_solutions::builders::ListSolutionsFluentBuilder::set_dataset_group_arn): <p>The Amazon Resource Name (ARN) of the dataset group.</p>
