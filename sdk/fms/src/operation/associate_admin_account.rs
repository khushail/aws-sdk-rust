...
impl AssociateAdminAccountInput {
    /// Consumes the builder and constructs an Operation<[`AssociateAdminAccount`](crate::operation::associate_admin_account::AssociateAdminAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_admin_account::AssociateAdminAccount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_admin_account::AssociateAdminAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_admin_account::ser_associate_admin_account_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_admin_account::AssociateAdminAccount::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateAdminAccount", "fms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateAdminAccount`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateAdminAccount {
                type Output = ::std::result::Result<crate::operation::associate_admin_account::AssociateAdminAccountOutput, crate::operation::associate_admin_account::AssociateAdminAccountError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_admin_account::de_associate_admin_account_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_admin_account::de_associate_admin_account_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_admin_account::AssociateAdminAccountError {
...
mod _associate_admin_account_output;
