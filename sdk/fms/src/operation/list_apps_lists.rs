...
impl ListAppsListsInput {
    /// Consumes the builder and constructs an Operation<[`ListAppsLists`](crate::operation::list_apps_lists::ListAppsLists)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_apps_lists::ListAppsLists, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_apps_lists::ListAppsListsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_apps_lists::ser_list_apps_lists_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_apps_lists::ListAppsLists::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAppsLists", "fms"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAppsLists {
                type Output = ::std::result::Result<crate::operation::list_apps_lists::ListAppsListsOutput, crate::operation::list_apps_lists::ListAppsListsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_apps_lists::de_list_apps_lists_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_apps_lists::de_list_apps_lists_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_apps_lists::ListAppsListsError {
...
pub use crate::operation::list_apps_lists::_list_apps_lists_output::ListAppsListsOutput;

pub use crate::operation::list_apps_lists::_list_apps_lists_input::ListAppsListsInput;

mod _list_apps_lists_input;

mod _list_apps_lists_output;
