...
impl GetAdminScopeInput {
    /// Consumes the builder and constructs an Operation<[`GetAdminScope`](crate::operation::get_admin_scope::GetAdminScope)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_admin_scope::GetAdminScope, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_admin_scope::GetAdminScopeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_admin_scope::ser_get_admin_scope_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_admin_scope::GetAdminScope::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAdminScope", "fms"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAdminScope {
                type Output = ::std::result::Result<crate::operation::get_admin_scope::GetAdminScopeOutput, crate::operation::get_admin_scope::GetAdminScopeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_admin_scope::de_get_admin_scope_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetAdminScopeErrorKind = GetAdminScopeError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetAdminScopeError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_admin_scope::GetAdminScopeError {
...
impl GetAdminScopeError {
    /// Creates the `GetAdminScopeError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetAdminScopeError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
