...
impl BatchDisassociateResourceInput {
    /// Consumes the builder and constructs an Operation<[`BatchDisassociateResource`](crate::operation::batch_disassociate_resource::BatchDisassociateResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_disassociate_resource::BatchDisassociateResource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_disassociate_resource::BatchDisassociateResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_disassociate_resource::ser_batch_disassociate_resource_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_disassociate_resource::BatchDisassociateResource::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchDisassociateResource", "fms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchDisassociateResource`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchDisassociateResource {
                type Output = ::std::result::Result<crate::operation::batch_disassociate_resource::BatchDisassociateResourceOutput, crate::operation::batch_disassociate_resource::BatchDisassociateResourceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_disassociate_resource::de_batch_disassociate_resource_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_disassociate_resource::de_batch_disassociate_resource_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_disassociate_resource::BatchDisassociateResourceError {
...
mod _batch_disassociate_resource_output;
