...
impl DisassociateThirdPartyFirewallInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateThirdPartyFirewall`](crate::operation::disassociate_third_party_firewall::DisassociateThirdPartyFirewall)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_third_party_firewall::DisassociateThirdPartyFirewall, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_third_party_firewall::DisassociateThirdPartyFirewallInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_third_party_firewall::ser_disassociate_third_party_firewall_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_third_party_firewall::DisassociateThirdPartyFirewall::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateThirdPartyFirewall", "fms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisassociateThirdPartyFirewall`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateThirdPartyFirewall {
                type Output = ::std::result::Result<crate::operation::disassociate_third_party_firewall::DisassociateThirdPartyFirewallOutput, crate::operation::disassociate_third_party_firewall::DisassociateThirdPartyFirewallError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_third_party_firewall::de_disassociate_third_party_firewall_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_third_party_firewall::de_disassociate_third_party_firewall_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_third_party_firewall::DisassociateThirdPartyFirewallError {
...
mod _disassociate_third_party_firewall_output;
