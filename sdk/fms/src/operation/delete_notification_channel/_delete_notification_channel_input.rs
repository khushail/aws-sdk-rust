...
impl DeleteNotificationChannelInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_notification_channel::DeleteNotificationChannelInput, ::aws_smithy_http::operation::error::BuildError> {
