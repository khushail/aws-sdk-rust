...
impl AssociateThirdPartyFirewallInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_third_party_firewall::AssociateThirdPartyFirewallInput, ::aws_smithy_http::operation::error::BuildError> {
