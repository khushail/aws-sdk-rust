...
impl GetProtocolsListInput {
    /// Consumes the builder and constructs an Operation<[`GetProtocolsList`](crate::operation::get_protocols_list::GetProtocolsList)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_protocols_list::GetProtocolsList, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_protocols_list::GetProtocolsListInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_protocols_list::ser_get_protocols_list_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_protocols_list::GetProtocolsList::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetProtocolsList", "fms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetProtocolsList`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetProtocolsList {
                type Output = ::std::result::Result<crate::operation::get_protocols_list::GetProtocolsListOutput, crate::operation::get_protocols_list::GetProtocolsListError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_protocols_list::de_get_protocols_list_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_protocols_list::de_get_protocols_list_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_protocols_list::GetProtocolsListError {
...
pub use crate::operation::get_protocols_list::_get_protocols_list_output::GetProtocolsListOutput;

pub use crate::operation::get_protocols_list::_get_protocols_list_input::GetProtocolsListInput;

mod _get_protocols_list_input;

mod _get_protocols_list_output;
