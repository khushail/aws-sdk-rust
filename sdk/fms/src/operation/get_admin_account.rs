...
impl GetAdminAccountInput {
    /// Consumes the builder and constructs an Operation<[`GetAdminAccount`](crate::operation::get_admin_account::GetAdminAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_admin_account::GetAdminAccount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_admin_account::GetAdminAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_admin_account::ser_get_admin_account_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_admin_account::GetAdminAccount::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetAdminAccount", "fms"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetAdminAccount`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetAdminAccount {
                type Output = ::std::result::Result<crate::operation::get_admin_account::GetAdminAccountOutput, crate::operation::get_admin_account::GetAdminAccountError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_admin_account::de_get_admin_account_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_admin_account::de_get_admin_account_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_admin_account::GetAdminAccountError {
...
pub use crate::operation::get_admin_account::_get_admin_account_output::GetAdminAccountOutput;

pub use crate::operation::get_admin_account::_get_admin_account_input::GetAdminAccountInput;

mod _get_admin_account_input;

mod _get_admin_account_output;
