...
pub(crate) fn de_admin_scope<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AdminScope>, ::aws_smithy_json::deserialize::error::DeserializeError>
                        ...
                        match key.to_unescaped()?.as_ref() {
                            "AccountScope" => {
                                builder = builder.set_account_scope(
                                    crate::protocol_serde::shape_account_scope::de_account_scope(tokens)?
                                );
                            }
