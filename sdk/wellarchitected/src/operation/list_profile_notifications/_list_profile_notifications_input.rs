...
impl ListProfileNotificationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_profile_notifications::ListProfileNotificationsInput, ::aws_smithy_http::operation::error::BuildError> {
