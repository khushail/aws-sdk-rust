...
impl ListLensReviewImprovementsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_lens_review_improvements::ListLensReviewImprovementsInput, ::aws_smithy_http::operation::error::BuildError> {
