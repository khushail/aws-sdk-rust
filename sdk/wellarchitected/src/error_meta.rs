...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::associate_profiles::AssociateProfilesError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::create_profile_share::CreateProfileShareError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::delete_profile_share::DeleteProfileShareError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::disassociate_profiles::DisassociateProfilesError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::get_profile_template::GetProfileTemplateError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::list_profile_notifications::ListProfileNotificationsError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::list_profile_shares::ListProfileSharesError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
...
impl<R> From<::aws_smithy_http::result::SdkError<crate::operation::upgrade_profile_version::UpgradeProfileVersionError, R>> for Error where R: Send + Sync + std::fmt::Debug + 'static {
