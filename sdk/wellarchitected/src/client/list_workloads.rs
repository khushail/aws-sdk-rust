...
impl super::Client  {
    ...
    ///   - [`workload_name_prefix(impl ::std::convert::Into<String>)`](crate::operation::list_workloads::builders::ListWorkloadsFluentBuilder::workload_name_prefix) / [`set_workload_name_prefix(Option<String>)`](crate::operation::list_workloads::builders::ListWorkloadsFluentBuilder::set_workload_name_prefix): <p>An optional string added to the beginning of each workload name returned in the results.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_workloads::builders::ListWorkloadsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_workloads::builders::ListWorkloadsFluentBuilder::set_next_token): <p>The token to use to retrieve the next set of results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_workloads::builders::ListWorkloadsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_workloads::builders::ListWorkloadsFluentBuilder::set_max_results): <p>The maximum number of results to return for this request.</p>
