...
impl super::Client  {
    ...
    ///   - [`workload_id(impl ::std::convert::Into<String>)`](crate::operation::create_milestone::builders::CreateMilestoneFluentBuilder::workload_id) / [`set_workload_id(Option<String>)`](crate::operation::create_milestone::builders::CreateMilestoneFluentBuilder::set_workload_id): <p>The ID assigned to the workload. This ID is unique within an Amazon Web Services Region.</p>
    ///   - [`milestone_name(impl ::std::convert::Into<String>)`](crate::operation::create_milestone::builders::CreateMilestoneFluentBuilder::milestone_name) / [`set_milestone_name(Option<String>)`](crate::operation::create_milestone::builders::CreateMilestoneFluentBuilder::set_milestone_name): <p>The name of the milestone in a workload.</p>  <p>Milestone names must be unique within a workload.</p>
    ///   - [`client_request_token(impl ::std::convert::Into<String>)`](crate::operation::create_milestone::builders::CreateMilestoneFluentBuilder::client_request_token) / [`set_client_request_token(Option<String>)`](crate::operation::create_milestone::builders::CreateMilestoneFluentBuilder::set_client_request_token): <p>A unique case-sensitive string used to ensure that this request is idempotent (executes only once).</p>  <p>You should not reuse the same token for other requests. If you retry a request with the same client request token and the same parameters after the original request has completed successfully, the result of the original request is returned.</p> <important>   <p>This token is listed as required, however, if you do not specify it, the Amazon Web Services SDKs automatically generate one for you. If you are not using the Amazon Web Services SDK or the CLI, you must provide this token or the request will fail.</p>  </important>
