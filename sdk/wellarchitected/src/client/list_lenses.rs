...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_lenses::builders::ListLensesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_lenses::builders::ListLensesFluentBuilder::set_next_token): <p>The token to use to retrieve the next set of results.</p>
    ///   - [`max_results(i32)`](crate::operation::list_lenses::builders::ListLensesFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_lenses::builders::ListLensesFluentBuilder::set_max_results): <p>The maximum number of results to return for this request.</p>
    ...
    ///   - [`lens_name(impl ::std::convert::Into<String>)`](crate::operation::list_lenses::builders::ListLensesFluentBuilder::lens_name) / [`set_lens_name(Option<String>)`](crate::operation::list_lenses::builders::ListLensesFluentBuilder::set_lens_name): <p>The full name of the lens.</p>
