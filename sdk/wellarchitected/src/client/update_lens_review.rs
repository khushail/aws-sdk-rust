...
impl super::Client  {
    ...
    ///   - [`workload_id(impl ::std::convert::Into<String>)`](crate::operation::update_lens_review::builders::UpdateLensReviewFluentBuilder::workload_id) / [`set_workload_id(Option<String>)`](crate::operation::update_lens_review::builders::UpdateLensReviewFluentBuilder::set_workload_id): <p>The ID assigned to the workload. This ID is unique within an Amazon Web Services Region.</p>
    ///   - [`lens_alias(impl ::std::convert::Into<String>)`](crate::operation::update_lens_review::builders::UpdateLensReviewFluentBuilder::lens_alias) / [`set_lens_alias(Option<String>)`](crate::operation::update_lens_review::builders::UpdateLensReviewFluentBuilder::set_lens_alias): <p>The alias of the lens.</p>  <p>For Amazon Web Services official lenses, this is either the lens alias, such as <code>serverless</code>, or the lens ARN, such as <code>arn:aws:wellarchitected:us-east-1::lens/serverless</code>. Note that some operations (such as ExportLens and CreateLensShare) are not permitted on Amazon Web Services official lenses.</p>  <p>For custom lenses, this is the lens ARN, such as <code>arn:aws:wellarchitected:us-west-2:123456789012:lens/0123456789abcdef01234567890abcdef</code>. </p>  <p>Each lens is identified by its <code>LensSummary$LensAlias</code>.</p>
    ///   - [`lens_notes(impl ::std::convert::Into<String>)`](crate::operation::update_lens_review::builders::UpdateLensReviewFluentBuilder::lens_notes) / [`set_lens_notes(Option<String>)`](crate::operation::update_lens_review::builders::UpdateLensReviewFluentBuilder::set_lens_notes): <p>The notes associated with the workload.</p>
