...
pub fn de_define_suggester_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::define_suggester::DefineSuggesterOutput, crate::operation::define_suggester::DefineSuggesterError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::define_suggester::DefineSuggesterError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_base_exception::de_base_exception_xml_err(_response_body, output).map_err(crate::operation::define_suggester::DefineSuggesterError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_define_suggester_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::define_suggester::DefineSuggesterOutput, crate::operation::define_suggester::DefineSuggesterError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::define_suggester::builders::DefineSuggesterOutputBuilder::default();
        output = crate::protocol_serde::shape_define_suggester::de_define_suggester(_response_body, output).map_err(crate::operation::define_suggester::DefineSuggesterError::unhandled)?;
