...
pub fn de_describe_availability_options_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_availability_options::DescribeAvailabilityOptionsOutput, crate::operation::describe_availability_options::DescribeAvailabilityOptionsError> {
    #[allow(unused_mut)]
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_base_exception::de_base_exception_xml_err(_response_body, output).map_err(crate::operation::describe_availability_options::DescribeAvailabilityOptionsError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_disabled_operation_exception::de_disabled_operation_exception_xml_err(_response_body, output).map_err(crate::operation::describe_availability_options::DescribeAvailabilityOptionsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_internal_exception::de_internal_exception_xml_err(_response_body, output).map_err(crate::operation::describe_availability_options::DescribeAvailabilityOptionsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_type_exception::de_invalid_type_exception_xml_err(_response_body, output).map_err(crate::operation::describe_availability_options::DescribeAvailabilityOptionsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_limit_exceeded_exception::de_limit_exceeded_exception_xml_err(_response_body, output).map_err(crate::operation::describe_availability_options::DescribeAvailabilityOptionsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_resource_not_found_exception::de_resource_not_found_exception_xml_err(_response_body, output).map_err(crate::operation::describe_availability_options::DescribeAvailabilityOptionsError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_availability_options_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_availability_options::DescribeAvailabilityOptionsOutput, crate::operation::describe_availability_options::DescribeAvailabilityOptionsError> {
    Ok({
        #[allow(unused_mut)]
