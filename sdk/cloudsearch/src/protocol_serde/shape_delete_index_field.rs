...
pub fn de_delete_index_field_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_index_field::DeleteIndexFieldOutput, crate::operation::delete_index_field::DeleteIndexFieldError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::delete_index_field::DeleteIndexFieldError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_base_exception::de_base_exception_xml_err(_response_body, output).map_err(crate::operation::delete_index_field::DeleteIndexFieldError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_index_field_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_index_field::DeleteIndexFieldOutput, crate::operation::delete_index_field::DeleteIndexFieldError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::delete_index_field::builders::DeleteIndexFieldOutputBuilder::default();
        output = crate::protocol_serde::shape_delete_index_field::de_delete_index_field(_response_body, output).map_err(crate::operation::delete_index_field::DeleteIndexFieldError::unhandled)?;
