...
impl DescribeAvailabilityOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_availability_options::DescribeAvailabilityOptionsInput, ::aws_smithy_http::operation::error::BuildError> {
