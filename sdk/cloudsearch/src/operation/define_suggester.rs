...
impl DefineSuggesterInput {
    /// Consumes the builder and constructs an Operation<[`DefineSuggester`](crate::operation::define_suggester::DefineSuggester)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::define_suggester::DefineSuggester, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::define_suggester::DefineSuggesterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::define_suggester::DefineSuggester::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DefineSuggester", "cloudsearch"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DefineSuggester`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DefineSuggester {
                type Output = ::std::result::Result<crate::operation::define_suggester::DefineSuggesterOutput, crate::operation::define_suggester::DefineSuggesterError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_define_suggester::de_define_suggester_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_define_suggester::de_define_suggester_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::define_suggester::DefineSuggesterError {
