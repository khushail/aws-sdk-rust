...
impl DeleteIndexFieldInput {
    /// Consumes the builder and constructs an Operation<[`DeleteIndexField`](crate::operation::delete_index_field::DeleteIndexField)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_index_field::DeleteIndexField, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_index_field::DeleteIndexFieldInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_index_field::DeleteIndexFieldInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_index_field::DeleteIndexField::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIndexField {
                type Output = ::std::result::Result<crate::operation::delete_index_field::DeleteIndexFieldOutput, crate::operation::delete_index_field::DeleteIndexFieldError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_index_field::de_delete_index_field_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_index_field::de_delete_index_field_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_index_field::DeleteIndexFieldError {
...
mod _delete_index_field_output;
