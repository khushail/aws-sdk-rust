...
impl IndexDocumentsInput {
    /// Consumes the builder and constructs an Operation<[`IndexDocuments`](crate::operation::index_documents::IndexDocuments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::index_documents::IndexDocuments, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::index_documents::IndexDocumentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::index_documents::IndexDocuments::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("IndexDocuments", "cloudsearch"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `IndexDocuments`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for IndexDocuments {
                type Output = ::std::result::Result<crate::operation::index_documents::IndexDocumentsOutput, crate::operation::index_documents::IndexDocumentsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_index_documents::de_index_documents_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_index_documents::de_index_documents_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::index_documents::IndexDocumentsError {
