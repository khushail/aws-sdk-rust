...
impl UpdateDomainEndpointOptionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_domain_endpoint_options::UpdateDomainEndpointOptionsInput, ::aws_smithy_http::operation::error::BuildError> {
