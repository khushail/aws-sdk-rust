...
impl DescribeScalingParametersInput {
    /// Consumes the builder and constructs an Operation<[`DescribeScalingParameters`](crate::operation::describe_scaling_parameters::DescribeScalingParameters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_scaling_parameters::DescribeScalingParameters, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_scaling_parameters::DescribeScalingParametersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_scaling_parameters::DescribeScalingParameters::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeScalingParameters", "cloudsearch"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeScalingParameters`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeScalingParameters {
                type Output = ::std::result::Result<crate::operation::describe_scaling_parameters::DescribeScalingParametersOutput, crate::operation::describe_scaling_parameters::DescribeScalingParametersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_scaling_parameters::de_describe_scaling_parameters_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_scaling_parameters::de_describe_scaling_parameters_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_scaling_parameters::DescribeScalingParametersError {
...
mod _describe_scaling_parameters_output;
