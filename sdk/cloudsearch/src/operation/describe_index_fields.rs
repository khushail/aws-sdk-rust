...
impl DescribeIndexFieldsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeIndexFields`](crate::operation::describe_index_fields::DescribeIndexFields)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_index_fields::DescribeIndexFields, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_index_fields::DescribeIndexFieldsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_index_fields::DescribeIndexFields::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeIndexFields", "cloudsearch"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeIndexFields`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeIndexFields {
                type Output = ::std::result::Result<crate::operation::describe_index_fields::DescribeIndexFieldsOutput, crate::operation::describe_index_fields::DescribeIndexFieldsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_index_fields::de_describe_index_fields_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_index_fields::de_describe_index_fields_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_index_fields::DescribeIndexFieldsError {
...
pub use crate::operation::describe_index_fields::_describe_index_fields_output::DescribeIndexFieldsOutput;

pub use crate::operation::describe_index_fields::_describe_index_fields_input::DescribeIndexFieldsInput;

mod _describe_index_fields_input;

mod _describe_index_fields_output;
