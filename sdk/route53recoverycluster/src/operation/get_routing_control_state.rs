...
impl GetRoutingControlStateInput {
    /// Consumes the builder and constructs an Operation<[`GetRoutingControlState`](crate::operation::get_routing_control_state::GetRoutingControlState)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_routing_control_state::GetRoutingControlState, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_routing_control_state::GetRoutingControlStateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_routing_control_state::GetRoutingControlState::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetRoutingControlState", "route53recoverycluster"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetRoutingControlState`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRoutingControlState {
                type Output = ::std::result::Result<crate::operation::get_routing_control_state::GetRoutingControlStateOutput, crate::operation::get_routing_control_state::GetRoutingControlStateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_routing_control_state::de_get_routing_control_state_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_routing_control_state::de_get_routing_control_state_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_routing_control_state::GetRoutingControlStateError {
...
mod _get_routing_control_state_output;
