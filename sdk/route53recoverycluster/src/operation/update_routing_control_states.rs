...
impl UpdateRoutingControlStatesInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRoutingControlStates`](crate::operation::update_routing_control_states::UpdateRoutingControlStates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_routing_control_states::UpdateRoutingControlStates, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_routing_control_states::UpdateRoutingControlStatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_routing_control_states::UpdateRoutingControlStates::new())
...
/// Orchestration and serialization glue logic for `UpdateRoutingControlStates`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateRoutingControlStates {
                type Output = ::std::result::Result<crate::operation::update_routing_control_states::UpdateRoutingControlStatesOutput, crate::operation::update_routing_control_states::UpdateRoutingControlStatesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_routing_control_states::de_update_routing_control_states_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_routing_control_states::de_update_routing_control_states_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_routing_control_states::UpdateRoutingControlStatesError {
...
mod _update_routing_control_states_output;
