...
impl GetCertificateAuthorityCsrInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_certificate_authority_csr::GetCertificateAuthorityCsrInput, ::aws_smithy_http::operation::error::BuildError> {
