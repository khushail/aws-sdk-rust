...
impl RestoreCertificateAuthorityInput {
    /// Consumes the builder and constructs an Operation<[`RestoreCertificateAuthority`](crate::operation::restore_certificate_authority::RestoreCertificateAuthority)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::restore_certificate_authority::RestoreCertificateAuthority, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_certificate_authority::RestoreCertificateAuthorityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_restore_certificate_authority::ser_restore_certificate_authority_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::restore_certificate_authority::RestoreCertificateAuthority::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RestoreCertificateAuthority", "acmpca"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RestoreCertificateAuthority`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreCertificateAuthority {
                type Output = ::std::result::Result<crate::operation::restore_certificate_authority::RestoreCertificateAuthorityOutput, crate::operation::restore_certificate_authority::RestoreCertificateAuthorityError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_restore_certificate_authority::de_restore_certificate_authority_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_restore_certificate_authority::de_restore_certificate_authority_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::restore_certificate_authority::RestoreCertificateAuthorityError {
...
mod _restore_certificate_authority_output;
