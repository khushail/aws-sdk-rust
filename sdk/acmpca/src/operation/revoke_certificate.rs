...
impl RevokeCertificateInput {
    /// Consumes the builder and constructs an Operation<[`RevokeCertificate`](crate::operation::revoke_certificate::RevokeCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::revoke_certificate::RevokeCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::revoke_certificate::RevokeCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_revoke_certificate::ser_revoke_certificate_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::revoke_certificate::RevokeCertificate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RevokeCertificate {
                type Output = ::std::result::Result<crate::operation::revoke_certificate::RevokeCertificateOutput, crate::operation::revoke_certificate::RevokeCertificateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_revoke_certificate::de_revoke_certificate_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::revoke_certificate::RevokeCertificateError {
