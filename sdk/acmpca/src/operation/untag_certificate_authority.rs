...
impl UntagCertificateAuthorityInput {
    /// Consumes the builder and constructs an Operation<[`UntagCertificateAuthority`](crate::operation::untag_certificate_authority::UntagCertificateAuthority)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::untag_certificate_authority::UntagCertificateAuthority, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_certificate_authority::UntagCertificateAuthorityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_untag_certificate_authority::ser_untag_certificate_authority_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::untag_certificate_authority::UntagCertificateAuthority::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagCertificateAuthority {
                type Output = ::std::result::Result<crate::operation::untag_certificate_authority::UntagCertificateAuthorityOutput, crate::operation::untag_certificate_authority::UntagCertificateAuthorityError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_untag_certificate_authority::de_untag_certificate_authority_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_untag_certificate_authority::de_untag_certificate_authority_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::untag_certificate_authority::UntagCertificateAuthorityError {
...
mod _untag_certificate_authority_output;
