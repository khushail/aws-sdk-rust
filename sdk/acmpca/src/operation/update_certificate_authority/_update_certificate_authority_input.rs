...
impl UpdateCertificateAuthorityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_certificate_authority::UpdateCertificateAuthorityInput, ::aws_smithy_http::operation::error::BuildError> {
