...
impl ListCertificateAuthoritiesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_certificate_authorities::ListCertificateAuthoritiesInput, ::aws_smithy_http::operation::error::BuildError> {
