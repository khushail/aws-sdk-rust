...
impl CreateCertificateAuthorityAuditReportInput {
    /// Consumes the builder and constructs an Operation<[`CreateCertificateAuthorityAuditReport`](crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReport)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReport, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_certificate_authority_audit_report::ser_create_certificate_authority_audit_report_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReport::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateCertificateAuthorityAuditReport", "acmpca"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateCertificateAuthorityAuditReport`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateCertificateAuthorityAuditReport {
                type Output = ::std::result::Result<crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportOutput, crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_certificate_authority_audit_report::de_create_certificate_authority_audit_report_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_certificate_authority_audit_report::de_create_certificate_authority_audit_report_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_certificate_authority_audit_report::CreateCertificateAuthorityAuditReportError {
...
mod _create_certificate_authority_audit_report_output;
