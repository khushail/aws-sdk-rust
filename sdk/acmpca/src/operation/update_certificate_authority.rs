...
impl UpdateCertificateAuthorityInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCertificateAuthority`](crate::operation::update_certificate_authority::UpdateCertificateAuthority)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_certificate_authority::UpdateCertificateAuthority, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_certificate_authority::UpdateCertificateAuthorityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_certificate_authority::ser_update_certificate_authority_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_certificate_authority::UpdateCertificateAuthority::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateCertificateAuthority", "acmpca"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateCertificateAuthority`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCertificateAuthority {
                type Output = ::std::result::Result<crate::operation::update_certificate_authority::UpdateCertificateAuthorityOutput, crate::operation::update_certificate_authority::UpdateCertificateAuthorityError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_certificate_authority::de_update_certificate_authority_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_certificate_authority::de_update_certificate_authority_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_certificate_authority::UpdateCertificateAuthorityError {
...
pub use crate::operation::update_certificate_authority::_update_certificate_authority_output::UpdateCertificateAuthorityOutput;

pub use crate::operation::update_certificate_authority::_update_certificate_authority_input::UpdateCertificateAuthorityInput;

mod _update_certificate_authority_input;

mod _update_certificate_authority_output;
