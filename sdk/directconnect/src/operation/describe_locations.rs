...
impl DescribeLocationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLocations`](crate::operation::describe_locations::DescribeLocations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_locations::DescribeLocations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_locations::DescribeLocationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_locations::DescribeLocationsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_locations::ser_describe_locations_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_locations::DescribeLocations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeLocations", "directconnect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeLocations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLocations {
                type Output = ::std::result::Result<crate::operation::describe_locations::DescribeLocationsOutput, crate::operation::describe_locations::DescribeLocationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_locations::de_describe_locations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_locations::de_describe_locations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_locations::DescribeLocationsError {
...
mod _describe_locations_output;
