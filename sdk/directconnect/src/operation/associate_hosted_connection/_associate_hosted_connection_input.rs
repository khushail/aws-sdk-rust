...
impl AssociateHostedConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_hosted_connection::AssociateHostedConnectionInput, ::aws_smithy_http::operation::error::BuildError> {
