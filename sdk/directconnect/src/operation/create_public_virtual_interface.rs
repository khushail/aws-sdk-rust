...
impl CreatePublicVirtualInterfaceInput {
    /// Consumes the builder and constructs an Operation<[`CreatePublicVirtualInterface`](crate::operation::create_public_virtual_interface::CreatePublicVirtualInterface)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_public_virtual_interface::CreatePublicVirtualInterface, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_public_virtual_interface::ser_create_public_virtual_interface_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_public_virtual_interface::CreatePublicVirtualInterface::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePublicVirtualInterface", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePublicVirtualInterface {
                type Output = ::std::result::Result<crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceOutput, crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_public_virtual_interface::de_create_public_virtual_interface_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_public_virtual_interface::de_create_public_virtual_interface_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceError {
...
mod _create_public_virtual_interface_output;
