...
impl DescribeVirtualGatewaysInput {
    /// Consumes the builder and constructs an Operation<[`DescribeVirtualGateways`](crate::operation::describe_virtual_gateways::DescribeVirtualGateways)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_virtual_gateways::DescribeVirtualGateways, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_virtual_gateways::ser_describe_virtual_gateways_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_virtual_gateways::DescribeVirtualGateways::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeVirtualGateways", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVirtualGateways {
                type Output = ::std::result::Result<crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysOutput, crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_virtual_gateways::de_describe_virtual_gateways_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_virtual_gateways::de_describe_virtual_gateways_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_virtual_gateways::DescribeVirtualGatewaysError {
...
mod _describe_virtual_gateways_output;
