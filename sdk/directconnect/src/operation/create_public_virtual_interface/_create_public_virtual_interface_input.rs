...
impl CreatePublicVirtualInterfaceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_public_virtual_interface::CreatePublicVirtualInterfaceInput, ::aws_smithy_http::operation::error::BuildError> {
