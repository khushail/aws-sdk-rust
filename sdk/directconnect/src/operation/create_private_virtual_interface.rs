...
impl CreatePrivateVirtualInterfaceInput {
    /// Consumes the builder and constructs an Operation<[`CreatePrivateVirtualInterface`](crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterface)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterface, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterfaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_private_virtual_interface::ser_create_private_virtual_interface_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterface::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePrivateVirtualInterface", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePrivateVirtualInterface {
                type Output = ::std::result::Result<crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterfaceOutput, crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterfaceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_private_virtual_interface::de_create_private_virtual_interface_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_private_virtual_interface::de_create_private_virtual_interface_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_private_virtual_interface::CreatePrivateVirtualInterfaceError {
...
mod _create_private_virtual_interface_output;
