...
impl DescribeHostedConnectionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeHostedConnections`](crate::operation::describe_hosted_connections::DescribeHostedConnections)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_hosted_connections::DescribeHostedConnections, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_hosted_connections::DescribeHostedConnectionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_hosted_connections::ser_describe_hosted_connections_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_hosted_connections::DescribeHostedConnections::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeHostedConnections", "directconnect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeHostedConnections`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHostedConnections {
                type Output = ::std::result::Result<crate::operation::describe_hosted_connections::DescribeHostedConnectionsOutput, crate::operation::describe_hosted_connections::DescribeHostedConnectionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_hosted_connections::de_describe_hosted_connections_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_hosted_connections::de_describe_hosted_connections_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_hosted_connections::DescribeHostedConnectionsError {
...
mod _describe_hosted_connections_output;
