...
impl DescribeLagsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLags`](crate::operation::describe_lags::DescribeLags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_lags::DescribeLags, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_lags::DescribeLagsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_lags::ser_describe_lags_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_lags::DescribeLags::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeLags", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLags {
                type Output = ::std::result::Result<crate::operation::describe_lags::DescribeLagsOutput, crate::operation::describe_lags::DescribeLagsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_lags::de_describe_lags_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_lags::de_describe_lags_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_lags::DescribeLagsError {
