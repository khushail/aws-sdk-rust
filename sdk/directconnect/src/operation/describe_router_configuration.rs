...
impl DescribeRouterConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRouterConfiguration`](crate::operation::describe_router_configuration::DescribeRouterConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_router_configuration::DescribeRouterConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_router_configuration::DescribeRouterConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_router_configuration::ser_describe_router_configuration_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_router_configuration::DescribeRouterConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeRouterConfiguration", "directconnect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeRouterConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRouterConfiguration {
                type Output = ::std::result::Result<crate::operation::describe_router_configuration::DescribeRouterConfigurationOutput, crate::operation::describe_router_configuration::DescribeRouterConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_router_configuration::de_describe_router_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_router_configuration::de_describe_router_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_router_configuration::DescribeRouterConfigurationError {
...
mod _describe_router_configuration_output;
