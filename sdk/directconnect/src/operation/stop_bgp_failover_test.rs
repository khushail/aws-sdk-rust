...
impl StopBgpFailoverTestInput {
    /// Consumes the builder and constructs an Operation<[`StopBgpFailoverTest`](crate::operation::stop_bgp_failover_test::StopBgpFailoverTest)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_bgp_failover_test::StopBgpFailoverTest, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_bgp_failover_test::StopBgpFailoverTestInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_bgp_failover_test::ser_stop_bgp_failover_test_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_bgp_failover_test::StopBgpFailoverTest::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopBgpFailoverTest", "directconnect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StopBgpFailoverTest`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopBgpFailoverTest {
                type Output = ::std::result::Result<crate::operation::stop_bgp_failover_test::StopBgpFailoverTestOutput, crate::operation::stop_bgp_failover_test::StopBgpFailoverTestError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_stop_bgp_failover_test::de_stop_bgp_failover_test_http_response_with_props(status, headers, body)
                     }
                }
...
mod _stop_bgp_failover_test_output;
