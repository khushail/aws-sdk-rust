...
impl CreateDirectConnectGatewayInput {
    /// Consumes the builder and constructs an Operation<[`CreateDirectConnectGateway`](crate::operation::create_direct_connect_gateway::CreateDirectConnectGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_direct_connect_gateway::CreateDirectConnectGateway, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_direct_connect_gateway::CreateDirectConnectGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_direct_connect_gateway::ser_create_direct_connect_gateway_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_direct_connect_gateway::CreateDirectConnectGateway::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDirectConnectGateway", "directconnect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateDirectConnectGateway`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDirectConnectGateway {
                type Output = ::std::result::Result<crate::operation::create_direct_connect_gateway::CreateDirectConnectGatewayOutput, crate::operation::create_direct_connect_gateway::CreateDirectConnectGatewayError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_direct_connect_gateway::de_create_direct_connect_gateway_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_direct_connect_gateway::de_create_direct_connect_gateway_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_direct_connect_gateway::CreateDirectConnectGatewayError {
...
mod _create_direct_connect_gateway_output;
