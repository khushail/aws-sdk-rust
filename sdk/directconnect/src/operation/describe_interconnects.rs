...
impl DescribeInterconnectsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInterconnects`](crate::operation::describe_interconnects::DescribeInterconnects)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_interconnects::DescribeInterconnects, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_interconnects::DescribeInterconnectsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_interconnects::ser_describe_interconnects_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_interconnects::DescribeInterconnects::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeInterconnects", "directconnect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeInterconnects`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInterconnects {
                type Output = ::std::result::Result<crate::operation::describe_interconnects::DescribeInterconnectsOutput, crate::operation::describe_interconnects::DescribeInterconnectsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_interconnects::de_describe_interconnects_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_interconnects::de_describe_interconnects_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_interconnects::DescribeInterconnectsError {
...
pub use crate::operation::describe_interconnects::_describe_interconnects_output::DescribeInterconnectsOutput;

pub use crate::operation::describe_interconnects::_describe_interconnects_input::DescribeInterconnectsInput;

mod _describe_interconnects_input;

mod _describe_interconnects_output;
