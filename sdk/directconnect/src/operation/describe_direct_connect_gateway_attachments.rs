...
impl DescribeDirectConnectGatewayAttachmentsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDirectConnectGatewayAttachments`](crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachments)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachments, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_direct_connect_gateway_attachments::ser_describe_direct_connect_gateway_attachments_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachments::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDirectConnectGatewayAttachments", "directconnect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeDirectConnectGatewayAttachments`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDirectConnectGatewayAttachments {
                type Output = ::std::result::Result<crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsOutput, crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_direct_connect_gateway_attachments::de_describe_direct_connect_gateway_attachments_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_direct_connect_gateway_attachments::de_describe_direct_connect_gateway_attachments_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_direct_connect_gateway_attachments::DescribeDirectConnectGatewayAttachmentsError {
...
mod _describe_direct_connect_gateway_attachments_output;
