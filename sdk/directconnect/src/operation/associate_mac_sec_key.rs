...
impl AssociateMacSecKeyInput {
    /// Consumes the builder and constructs an Operation<[`AssociateMacSecKey`](crate::operation::associate_mac_sec_key::AssociateMacSecKey)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_mac_sec_key::AssociateMacSecKey, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_mac_sec_key::AssociateMacSecKeyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_mac_sec_key::ser_associate_mac_sec_key_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_mac_sec_key::AssociateMacSecKey::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateMacSecKey", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateMacSecKey {
                type Output = ::std::result::Result<crate::operation::associate_mac_sec_key::AssociateMacSecKeyOutput, crate::operation::associate_mac_sec_key::AssociateMacSecKeyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_mac_sec_key::de_associate_mac_sec_key_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_mac_sec_key::de_associate_mac_sec_key_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_mac_sec_key::AssociateMacSecKeyError {
...
mod _associate_mac_sec_key_output;
