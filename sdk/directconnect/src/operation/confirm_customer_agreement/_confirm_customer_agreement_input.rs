...
impl ConfirmCustomerAgreementInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::confirm_customer_agreement::ConfirmCustomerAgreementInput, ::aws_smithy_http::operation::error::BuildError> {
