...
impl AssociateVirtualInterfaceInput {
    /// Consumes the builder and constructs an Operation<[`AssociateVirtualInterface`](crate::operation::associate_virtual_interface::AssociateVirtualInterface)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_virtual_interface::AssociateVirtualInterface, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_virtual_interface::AssociateVirtualInterfaceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_virtual_interface::ser_associate_virtual_interface_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_virtual_interface::AssociateVirtualInterface::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateVirtualInterface", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateVirtualInterface {
                type Output = ::std::result::Result<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceOutput, crate::operation::associate_virtual_interface::AssociateVirtualInterfaceError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_virtual_interface::AssociateVirtualInterfaceError {
...
mod _associate_virtual_interface_output;
