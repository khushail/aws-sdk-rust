...
impl ListVirtualInterfaceTestHistoryInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_virtual_interface_test_history::ListVirtualInterfaceTestHistoryInput, ::aws_smithy_http::operation::error::BuildError> {
