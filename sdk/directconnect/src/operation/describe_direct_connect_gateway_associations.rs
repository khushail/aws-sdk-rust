...
impl DescribeDirectConnectGatewayAssociationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDirectConnectGatewayAssociations`](crate::operation::describe_direct_connect_gateway_associations::DescribeDirectConnectGatewayAssociations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_direct_connect_gateway_associations::DescribeDirectConnectGatewayAssociations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_direct_connect_gateway_associations::DescribeDirectConnectGatewayAssociationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_direct_connect_gateway_associations::ser_describe_direct_connect_gateway_associations_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_direct_connect_gateway_associations::DescribeDirectConnectGatewayAssociations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDirectConnectGatewayAssociations", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDirectConnectGatewayAssociations {
                type Output = ::std::result::Result<crate::operation::describe_direct_connect_gateway_associations::DescribeDirectConnectGatewayAssociationsOutput, crate::operation::describe_direct_connect_gateway_associations::DescribeDirectConnectGatewayAssociationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_direct_connect_gateway_associations::de_describe_direct_connect_gateway_associations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_direct_connect_gateway_associations::de_describe_direct_connect_gateway_associations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_direct_connect_gateway_associations::DescribeDirectConnectGatewayAssociationsError {
...
pub use crate::operation::describe_direct_connect_gateway_associations::_describe_direct_connect_gateway_associations_output::DescribeDirectConnectGatewayAssociationsOutput;

pub use crate::operation::describe_direct_connect_gateway_associations::_describe_direct_connect_gateway_associations_input::DescribeDirectConnectGatewayAssociationsInput;

mod _describe_direct_connect_gateway_associations_input;

mod _describe_direct_connect_gateway_associations_output;
