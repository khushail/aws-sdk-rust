...
impl UpdateDirectConnectGatewayInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_direct_connect_gateway::UpdateDirectConnectGatewayInput, ::aws_smithy_http::operation::error::BuildError> {
