...
impl ConfirmConnectionInput {
    /// Consumes the builder and constructs an Operation<[`ConfirmConnection`](crate::operation::confirm_connection::ConfirmConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::confirm_connection::ConfirmConnection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::confirm_connection::ConfirmConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_confirm_connection::ser_confirm_connection_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::confirm_connection::ConfirmConnection::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ConfirmConnection", "directconnect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfirmConnection {
                type Output = ::std::result::Result<crate::operation::confirm_connection::ConfirmConnectionOutput, crate::operation::confirm_connection::ConfirmConnectionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_confirm_connection::de_confirm_connection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_confirm_connection::de_confirm_connection_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::confirm_connection::ConfirmConnectionError {
...
mod _confirm_connection_output;
