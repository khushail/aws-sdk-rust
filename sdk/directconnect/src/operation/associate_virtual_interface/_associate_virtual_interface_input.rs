...
impl AssociateVirtualInterfaceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_virtual_interface::AssociateVirtualInterfaceInput, ::aws_smithy_http::operation::error::BuildError> {
