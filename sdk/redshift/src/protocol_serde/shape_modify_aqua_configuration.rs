...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_aqua_configuration_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_aqua_configuration::ModifyAquaConfigurationOutput, crate::operation::modify_aqua_configuration::ModifyAquaConfigurationError> {
    Ok({
        #[allow(unused_mut)]
