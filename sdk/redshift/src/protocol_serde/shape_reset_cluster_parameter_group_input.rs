...
pub fn ser_reset_cluster_parameter_group_input_input(input: &crate::operation::reset_cluster_parameter_group::ResetClusterParameterGroupInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
