...
#[allow(clippy::unnecessary_wraps)]
pub fn de_batch_modify_cluster_snapshots_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsOutput, crate::operation::batch_modify_cluster_snapshots::BatchModifyClusterSnapshotsError> {
    Ok({
        #[allow(unused_mut)]
