...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_cluster_snapshot_schedule_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_cluster_snapshot_schedule::ModifyClusterSnapshotScheduleOutput, crate::operation::modify_cluster_snapshot_schedule::ModifyClusterSnapshotScheduleError> {
    Ok({
        #[allow(unused_mut)]
