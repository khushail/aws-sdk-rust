...
pub fn de_disassociate_data_share_consumer_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerOutput, crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_data_share_fault::de_invalid_data_share_fault_xml_err(_response_body, output).map_err(crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError::unhandled)?;
            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_invalid_namespace_fault::de_invalid_namespace_fault_xml_err(_response_body, output).map_err(crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError::unhandled)?;
                    let output = output.meta(generic);
                    output.build()
                }
            ;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_disassociate_data_share_consumer_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerOutput, crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError> {
    Ok({
        #[allow(unused_mut)]
        ...
        output = crate::protocol_serde::shape_disassociate_data_share_consumer::de_disassociate_data_share_consumer(_response_body, output).map_err(crate::operation::disassociate_data_share_consumer::DisassociateDataShareConsumerError::unhandled)?;
