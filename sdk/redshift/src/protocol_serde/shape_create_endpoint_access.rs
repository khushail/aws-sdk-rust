...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_endpoint_access_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_endpoint_access::CreateEndpointAccessOutput, crate::operation::create_endpoint_access::CreateEndpointAccessError> {
    Ok({
        #[allow(unused_mut)]
