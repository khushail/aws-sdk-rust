...
pub fn de_create_cluster_security_group_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_cluster_security_group::CreateClusterSecurityGroupOutput, crate::operation::create_cluster_security_group::CreateClusterSecurityGroupError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_cluster_security_group::CreateClusterSecurityGroupError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_cluster_security_group_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_cluster_security_group::CreateClusterSecurityGroupOutput, crate::operation::create_cluster_security_group::CreateClusterSecurityGroupError> {
    Ok({
        #[allow(unused_mut)]
