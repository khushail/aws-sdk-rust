...
pub fn de_update_partner_status_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_partner_status::UpdatePartnerStatusOutput, crate::operation::update_partner_status::UpdatePartnerStatusError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::update_partner_status::UpdatePartnerStatusError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_partner_status_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_partner_status::UpdatePartnerStatusOutput, crate::operation::update_partner_status::UpdatePartnerStatusError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::update_partner_status::builders::UpdatePartnerStatusOutputBuilder::default();
        output = crate::protocol_serde::shape_update_partner_status::de_update_partner_status(_response_body, output).map_err(crate::operation::update_partner_status::UpdatePartnerStatusError::unhandled)?;
