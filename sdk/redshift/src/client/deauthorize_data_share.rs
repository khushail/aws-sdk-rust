...
impl super::Client  {
    ...
    ///   - [`data_share_arn(impl ::std::convert::Into<String>)`](crate::operation::deauthorize_data_share::builders::DeauthorizeDataShareFluentBuilder::data_share_arn) / [`set_data_share_arn(Option<String>)`](crate::operation::deauthorize_data_share::builders::DeauthorizeDataShareFluentBuilder::set_data_share_arn): <p>The Amazon Resource Name (ARN) of the datashare to remove authorization from.</p>
    ///   - [`consumer_identifier(impl ::std::convert::Into<String>)`](crate::operation::deauthorize_data_share::builders::DeauthorizeDataShareFluentBuilder::consumer_identifier) / [`set_consumer_identifier(Option<String>)`](crate::operation::deauthorize_data_share::builders::DeauthorizeDataShareFluentBuilder::set_consumer_identifier): <p>The identifier of the data consumer that is to have authorization removed from the datashare. This identifier is an Amazon Web Services account ID or a keyword, such as ADX.</p>
