...
impl super::Client  {
    ...
    ///   - [`cluster_identifier(impl ::std::convert::Into<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::cluster_identifier) / [`set_cluster_identifier(Option<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::set_cluster_identifier): <p>The unique identifier for the cluster to resize.</p>
    ///   - [`cluster_type(impl ::std::convert::Into<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::cluster_type) / [`set_cluster_type(Option<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::set_cluster_type): <p>The new cluster type for the specified cluster.</p>
    ///   - [`node_type(impl ::std::convert::Into<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::node_type) / [`set_node_type(Option<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::set_node_type): <p>The new node type for the nodes you are adding. If not specified, the cluster's current node type is used.</p>
    ...
    ///   - [`reserved_node_id(impl ::std::convert::Into<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::reserved_node_id) / [`set_reserved_node_id(Option<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::set_reserved_node_id): <p>The identifier of the reserved node.</p>
    ///   - [`target_reserved_node_offering_id(impl ::std::convert::Into<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::target_reserved_node_offering_id) / [`set_target_reserved_node_offering_id(Option<String>)`](crate::operation::resize_cluster::builders::ResizeClusterFluentBuilder::set_target_reserved_node_offering_id): <p>The identifier of the target reserved node offering.</p>
