...
impl super::Client  {
    ...
    ///   - [`cluster_identifier(impl ::std::convert::Into<String>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::cluster_identifier) / [`set_cluster_identifier(Option<String>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::set_cluster_identifier): <p>The cluster to revoke access from.</p>
    ///   - [`account(impl ::std::convert::Into<String>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::account) / [`set_account(Option<String>)`](crate::operation::revoke_endpoint_access::builders::RevokeEndpointAccessFluentBuilder::set_account): <p>The Amazon Web Services account ID whose access is to be revoked.</p>
