...
impl DeauthorizeDataShareInput {
    /// Consumes the builder and constructs an Operation<[`DeauthorizeDataShare`](crate::operation::deauthorize_data_share::DeauthorizeDataShare)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deauthorize_data_share::DeauthorizeDataShare, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deauthorize_data_share::DeauthorizeDataShareInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::deauthorize_data_share::DeauthorizeDataShareInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deauthorize_data_share_input::ser_deauthorize_data_share_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deauthorize_data_share::DeauthorizeDataShare::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeauthorizeDataShare", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeauthorizeDataShare`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeauthorizeDataShare {
                type Output = ::std::result::Result<crate::operation::deauthorize_data_share::DeauthorizeDataShareOutput, crate::operation::deauthorize_data_share::DeauthorizeDataShareError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deauthorize_data_share::de_deauthorize_data_share_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deauthorize_data_share::de_deauthorize_data_share_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deauthorize_data_share::DeauthorizeDataShareError {
...
mod _deauthorize_data_share_output;
