...
impl BatchDeleteClusterSnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_delete_cluster_snapshots::BatchDeleteClusterSnapshotsInput, ::aws_smithy_http::operation::error::BuildError> {
