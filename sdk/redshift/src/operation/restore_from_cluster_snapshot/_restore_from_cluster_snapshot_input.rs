...
impl RestoreFromClusterSnapshotInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_from_cluster_snapshot::RestoreFromClusterSnapshotInput, ::aws_smithy_http::operation::error::BuildError> {
