...
impl DescribeDataSharesForProducerInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDataSharesForProducer`](crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_data_shares_for_producer_input::ser_describe_data_shares_for_producer_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducer::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDataSharesForProducer", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeDataSharesForProducer`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDataSharesForProducer {
                type Output = ::std::result::Result<crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerOutput, crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_data_shares_for_producer::de_describe_data_shares_for_producer_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_data_shares_for_producer::de_describe_data_shares_for_producer_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeDataSharesForProducerError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_data_shares_for_producer::DescribeDataSharesForProducerError {
...
mod _describe_data_shares_for_producer_output;
