...
impl DescribeClusterSecurityGroupsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeClusterSecurityGroups`](crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroupsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_cluster_security_groups_input::ser_describe_cluster_security_groups_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroups::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeClusterSecurityGroups", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeClusterSecurityGroups`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClusterSecurityGroups {
                type Output = ::std::result::Result<crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroupsOutput, crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_cluster_security_groups::de_describe_cluster_security_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_cluster_security_groups::de_describe_cluster_security_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeClusterSecurityGroupsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_cluster_security_groups::DescribeClusterSecurityGroupsError {
...
mod _describe_cluster_security_groups_output;
