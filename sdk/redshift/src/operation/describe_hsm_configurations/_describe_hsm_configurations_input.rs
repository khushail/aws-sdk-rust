...
impl DescribeHsmConfigurationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_hsm_configurations::DescribeHsmConfigurationsInput, ::aws_smithy_http::operation::error::BuildError> {
