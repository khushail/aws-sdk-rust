...
impl DeletePartnerInput {
    /// Consumes the builder and constructs an Operation<[`DeletePartner`](crate::operation::delete_partner::DeletePartner)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_partner::DeletePartner, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_partner::DeletePartnerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_partner_input::ser_delete_partner_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_partner::DeletePartner::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeletePartner", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePartner {
                type Output = ::std::result::Result<crate::operation::delete_partner::DeletePartnerOutput, crate::operation::delete_partner::DeletePartnerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_partner::de_delete_partner_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_partner::de_delete_partner_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_partner::DeletePartnerError {
