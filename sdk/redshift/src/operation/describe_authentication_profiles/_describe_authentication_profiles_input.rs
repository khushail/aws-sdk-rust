...
impl DescribeAuthenticationProfilesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_authentication_profiles::DescribeAuthenticationProfilesInput, ::aws_smithy_http::operation::error::BuildError> {
