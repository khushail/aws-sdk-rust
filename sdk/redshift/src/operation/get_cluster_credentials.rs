...
impl GetClusterCredentialsInput {
    /// Consumes the builder and constructs an Operation<[`GetClusterCredentials`](crate::operation::get_cluster_credentials::GetClusterCredentials)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_cluster_credentials::GetClusterCredentials, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_cluster_credentials::GetClusterCredentialsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_cluster_credentials_input::ser_get_cluster_credentials_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_cluster_credentials::GetClusterCredentials::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetClusterCredentials", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetClusterCredentials`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetClusterCredentials {
                type Output = ::std::result::Result<crate::operation::get_cluster_credentials::GetClusterCredentialsOutput, crate::operation::get_cluster_credentials::GetClusterCredentialsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_cluster_credentials::de_get_cluster_credentials_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_cluster_credentials::de_get_cluster_credentials_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_cluster_credentials::GetClusterCredentialsError {
...
pub use crate::operation::get_cluster_credentials::_get_cluster_credentials_output::GetClusterCredentialsOutput;

pub use crate::operation::get_cluster_credentials::_get_cluster_credentials_input::GetClusterCredentialsInput;

mod _get_cluster_credentials_input;

mod _get_cluster_credentials_output;
