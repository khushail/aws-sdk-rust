...
impl ModifyScheduledActionInput {
    /// Consumes the builder and constructs an Operation<[`ModifyScheduledAction`](crate::operation::modify_scheduled_action::ModifyScheduledAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_scheduled_action::ModifyScheduledAction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_scheduled_action::ModifyScheduledActionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_scheduled_action_input::ser_modify_scheduled_action_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_scheduled_action::ModifyScheduledAction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyScheduledAction", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifyScheduledAction`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyScheduledAction {
                type Output = ::std::result::Result<crate::operation::modify_scheduled_action::ModifyScheduledActionOutput, crate::operation::modify_scheduled_action::ModifyScheduledActionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_scheduled_action::de_modify_scheduled_action_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_scheduled_action::de_modify_scheduled_action_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_scheduled_action::ModifyScheduledActionError {
...
mod _modify_scheduled_action_output;
