...
impl DescribeClusterTracksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeClusterTracks`](crate::operation::describe_cluster_tracks::DescribeClusterTracks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_cluster_tracks::DescribeClusterTracks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_cluster_tracks::DescribeClusterTracksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_cluster_tracks_input::ser_describe_cluster_tracks_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_cluster_tracks::DescribeClusterTracks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeClusterTracks", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeClusterTracks {
                type Output = ::std::result::Result<crate::operation::describe_cluster_tracks::DescribeClusterTracksOutput, crate::operation::describe_cluster_tracks::DescribeClusterTracksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_cluster_tracks::de_describe_cluster_tracks_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_cluster_tracks::de_describe_cluster_tracks_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_cluster_tracks::DescribeClusterTracksError {
...
mod _describe_cluster_tracks_output;
