...
impl CreateClusterSnapshotInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_cluster_snapshot::CreateClusterSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_cluster_snapshot::CreateClusterSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_cluster_snapshot::CreateClusterSnapshot::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateClusterSnapshot", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateClusterSnapshot {
                type Output = ::std::result::Result<crate::operation::create_cluster_snapshot::CreateClusterSnapshotOutput, crate::operation::create_cluster_snapshot::CreateClusterSnapshotError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_cluster_snapshot::CreateClusterSnapshotError {
