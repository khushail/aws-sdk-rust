...
impl AcceptReservedNodeExchangeInput {
    /// Consumes the builder and constructs an Operation<[`AcceptReservedNodeExchange`](crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchange)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchange, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_accept_reserved_node_exchange_input::ser_accept_reserved_node_exchange_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchange::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AcceptReservedNodeExchange", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AcceptReservedNodeExchange`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcceptReservedNodeExchange {
                type Output = ::std::result::Result<crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeOutput, crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_accept_reserved_node_exchange::de_accept_reserved_node_exchange_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_accept_reserved_node_exchange::de_accept_reserved_node_exchange_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::accept_reserved_node_exchange::AcceptReservedNodeExchangeError {
...
mod _accept_reserved_node_exchange_output;
