...
impl DescribeSnapshotSchedulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_snapshot_schedules::DescribeSnapshotSchedulesInput, ::aws_smithy_http::operation::error::BuildError> {
