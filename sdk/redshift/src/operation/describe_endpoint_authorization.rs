...
impl DescribeEndpointAuthorizationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEndpointAuthorization`](crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorization)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorization, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorizationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorizationInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_endpoint_authorization_input::ser_describe_endpoint_authorization_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorization::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeEndpointAuthorization", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeEndpointAuthorization`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEndpointAuthorization {
                type Output = ::std::result::Result<crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorizationOutput, crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorizationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_endpoint_authorization::de_describe_endpoint_authorization_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_endpoint_authorization::de_describe_endpoint_authorization_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeEndpointAuthorizationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorizationError {
...
mod _describe_endpoint_authorization_output;
