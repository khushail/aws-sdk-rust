...
impl DeleteHsmClientCertificateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_hsm_client_certificate::DeleteHsmClientCertificateInput, ::aws_smithy_http::operation::error::BuildError> {
