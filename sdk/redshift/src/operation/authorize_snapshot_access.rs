...
impl AuthorizeSnapshotAccessInput {
    /// Consumes the builder and constructs an Operation<[`AuthorizeSnapshotAccess`](crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccess, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_authorize_snapshot_access_input::ser_authorize_snapshot_access_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccess::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AuthorizeSnapshotAccess", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AuthorizeSnapshotAccess {
                type Output = ::std::result::Result<crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccessOutput, crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccessError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_authorize_snapshot_access::de_authorize_snapshot_access_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::authorize_snapshot_access::AuthorizeSnapshotAccessError {
