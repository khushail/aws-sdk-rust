...
impl DeleteSnapshotCopyGrantInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_snapshot_copy_grant::DeleteSnapshotCopyGrantInput, ::aws_smithy_http::operation::error::BuildError> {
