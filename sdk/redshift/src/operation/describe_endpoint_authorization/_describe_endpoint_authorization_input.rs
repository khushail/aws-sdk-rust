...
impl DescribeEndpointAuthorizationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_endpoint_authorization::DescribeEndpointAuthorizationInput, ::aws_smithy_http::operation::error::BuildError> {
