...
impl DescribeNodeConfigurationOptionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeNodeConfigurationOptions`](crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_node_configuration_options_input::ser_describe_node_configuration_options_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeNodeConfigurationOptions", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeNodeConfigurationOptions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNodeConfigurationOptions {
                type Output = ::std::result::Result<crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptionsOutput, crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_node_configuration_options::de_describe_node_configuration_options_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_node_configuration_options::de_describe_node_configuration_options_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeNodeConfigurationOptionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_node_configuration_options::DescribeNodeConfigurationOptionsError {
...
mod _describe_node_configuration_options_output;
