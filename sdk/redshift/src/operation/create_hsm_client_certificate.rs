...
impl CreateHsmClientCertificateInput {
    /// Consumes the builder and constructs an Operation<[`CreateHsmClientCertificate`](crate::operation::create_hsm_client_certificate::CreateHsmClientCertificate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_hsm_client_certificate::CreateHsmClientCertificate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_hsm_client_certificate_input::ser_create_hsm_client_certificate_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_hsm_client_certificate::CreateHsmClientCertificate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateHsmClientCertificate", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHsmClientCertificate {
                type Output = ::std::result::Result<crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateOutput, crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_hsm_client_certificate::de_create_hsm_client_certificate_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_hsm_client_certificate::de_create_hsm_client_certificate_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateError {
...
mod _create_hsm_client_certificate_output;
