...
impl ModifyEndpointAccessInput {
    /// Consumes the builder and constructs an Operation<[`ModifyEndpointAccess`](crate::operation::modify_endpoint_access::ModifyEndpointAccess)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_endpoint_access::ModifyEndpointAccess, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_endpoint_access::ModifyEndpointAccessInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_endpoint_access_input::ser_modify_endpoint_access_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_endpoint_access::ModifyEndpointAccess::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyEndpointAccess", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifyEndpointAccess`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyEndpointAccess {
                type Output = ::std::result::Result<crate::operation::modify_endpoint_access::ModifyEndpointAccessOutput, crate::operation::modify_endpoint_access::ModifyEndpointAccessError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_endpoint_access::de_modify_endpoint_access_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_endpoint_access::de_modify_endpoint_access_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_endpoint_access::ModifyEndpointAccessError {
...
pub use crate::operation::modify_endpoint_access::_modify_endpoint_access_output::ModifyEndpointAccessOutput;

pub use crate::operation::modify_endpoint_access::_modify_endpoint_access_input::ModifyEndpointAccessInput;

mod _modify_endpoint_access_input;

mod _modify_endpoint_access_output;
