...
impl DescribeSnapshotCopyGrantsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_snapshot_copy_grants::DescribeSnapshotCopyGrants, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_snapshot_copy_grants::DescribeSnapshotCopyGrantsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `DescribeSnapshotCopyGrants`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeSnapshotCopyGrants {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_snapshot_copy_grants::de_describe_snapshot_copy_grants_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_snapshot_copy_grants::de_describe_snapshot_copy_grants_http_response_with_props(status, headers, body)
                     }
                }
