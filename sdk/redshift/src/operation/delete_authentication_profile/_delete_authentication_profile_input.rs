...
impl DeleteAuthenticationProfileInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_authentication_profile::DeleteAuthenticationProfileInput, ::aws_smithy_http::operation::error::BuildError> {
