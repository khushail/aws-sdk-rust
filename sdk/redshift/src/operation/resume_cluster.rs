...
impl ResumeClusterInput {
    /// Consumes the builder and constructs an Operation<[`ResumeCluster`](crate::operation::resume_cluster::ResumeCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::resume_cluster::ResumeCluster, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resume_cluster::ResumeClusterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_resume_cluster_input::ser_resume_cluster_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::resume_cluster::ResumeCluster::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResumeCluster", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeCluster {
                type Output = ::std::result::Result<crate::operation::resume_cluster::ResumeClusterOutput, crate::operation::resume_cluster::ResumeClusterError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_resume_cluster::de_resume_cluster_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_resume_cluster::de_resume_cluster_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::resume_cluster::ResumeClusterError {
