...
impl DescribeAuthenticationProfilesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAuthenticationProfiles`](crate::operation::describe_authentication_profiles::DescribeAuthenticationProfiles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_authentication_profiles::DescribeAuthenticationProfiles, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_authentication_profiles::DescribeAuthenticationProfilesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_authentication_profiles_input::ser_describe_authentication_profiles_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_authentication_profiles::DescribeAuthenticationProfiles::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAuthenticationProfiles", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeAuthenticationProfiles`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAuthenticationProfiles {
                type Output = ::std::result::Result<crate::operation::describe_authentication_profiles::DescribeAuthenticationProfilesOutput, crate::operation::describe_authentication_profiles::DescribeAuthenticationProfilesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_authentication_profiles::de_describe_authentication_profiles_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_authentication_profiles::de_describe_authentication_profiles_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeAuthenticationProfilesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_authentication_profiles::DescribeAuthenticationProfilesError {
...
pub use crate::operation::describe_authentication_profiles::_describe_authentication_profiles_output::DescribeAuthenticationProfilesOutput;

pub use crate::operation::describe_authentication_profiles::_describe_authentication_profiles_input::DescribeAuthenticationProfilesInput;

mod _describe_authentication_profiles_input;

mod _describe_authentication_profiles_output;
