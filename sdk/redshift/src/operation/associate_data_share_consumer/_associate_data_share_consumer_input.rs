...
impl AssociateDataShareConsumerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_data_share_consumer::AssociateDataShareConsumerInput, ::aws_smithy_http::operation::error::BuildError> {
