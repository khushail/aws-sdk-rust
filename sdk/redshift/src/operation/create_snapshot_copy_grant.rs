...
impl CreateSnapshotCopyGrantInput {
    /// Consumes the builder and constructs an Operation<[`CreateSnapshotCopyGrant`](crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrant)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrant, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_snapshot_copy_grant_input::ser_create_snapshot_copy_grant_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrant::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateSnapshotCopyGrant", "redshift"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSnapshotCopyGrant {
                type Output = ::std::result::Result<crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantOutput, crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_snapshot_copy_grant::de_create_snapshot_copy_grant_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_snapshot_copy_grant::de_create_snapshot_copy_grant_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_snapshot_copy_grant::CreateSnapshotCopyGrantError {
...
mod _create_snapshot_copy_grant_output;
