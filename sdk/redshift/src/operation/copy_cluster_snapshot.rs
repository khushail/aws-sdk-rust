...
impl CopyClusterSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`CopyClusterSnapshot`](crate::operation::copy_cluster_snapshot::CopyClusterSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::copy_cluster_snapshot::CopyClusterSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::copy_cluster_snapshot::CopyClusterSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_copy_cluster_snapshot_input::ser_copy_cluster_snapshot_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::copy_cluster_snapshot::CopyClusterSnapshot::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CopyClusterSnapshot", "redshift"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CopyClusterSnapshot`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CopyClusterSnapshot {
                type Output = ::std::result::Result<crate::operation::copy_cluster_snapshot::CopyClusterSnapshotOutput, crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_copy_cluster_snapshot::de_copy_cluster_snapshot_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_copy_cluster_snapshot::de_copy_cluster_snapshot_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::copy_cluster_snapshot::CopyClusterSnapshotError {
...
pub use crate::operation::copy_cluster_snapshot::_copy_cluster_snapshot_output::CopyClusterSnapshotOutput;

pub use crate::operation::copy_cluster_snapshot::_copy_cluster_snapshot_input::CopyClusterSnapshotInput;

mod _copy_cluster_snapshot_input;

mod _copy_cluster_snapshot_output;
