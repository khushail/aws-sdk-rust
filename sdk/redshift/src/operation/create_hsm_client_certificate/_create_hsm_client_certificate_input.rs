...
impl CreateHsmClientCertificateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_hsm_client_certificate::CreateHsmClientCertificateInput, ::aws_smithy_http::operation::error::BuildError> {
