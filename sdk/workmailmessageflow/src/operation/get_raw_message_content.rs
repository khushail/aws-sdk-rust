...
impl GetRawMessageContentInput {
    /// Consumes the builder and constructs an Operation<[`GetRawMessageContent`](crate::operation::get_raw_message_content::GetRawMessageContent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_raw_message_content::GetRawMessageContent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_raw_message_content::GetRawMessageContentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/messages/{messageId}", messageId = message_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_raw_message_content::GetRawMessageContentInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_raw_message_content::GetRawMessageContent::new())
...
impl ::aws_smithy_http::response::ParseHttpResponse for GetRawMessageContent {
                type Output = ::std::result::Result<crate::operation::get_raw_message_content::GetRawMessageContentOutput, crate::operation::get_raw_message_content::GetRawMessageContentError>;
                fn parse_unloaded(&self, response: &mut ::aws_smithy_http::operation::Response) -> ::std::option::Option<Self::Output> {
                    ...
                    ::std::option::Option::Some(crate::protocol_serde::shape_get_raw_message_content::de_get_raw_message_content_op_response(response))
                }
                fn parse_loaded(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                    // if streaming, we only hit this case if its an error
                    crate::protocol_serde::shape_get_raw_message_content::de_get_raw_message_content_http_error(response.status().as_u16(), response.headers(), response.body().as_ref())
                }
            }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_raw_message_content::GetRawMessageContentError {
...
mod _get_raw_message_content_output;
