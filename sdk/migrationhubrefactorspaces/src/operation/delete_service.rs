...
impl DeleteServiceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_service::DeleteService, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_service::DeleteServiceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if application_identifier.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("application_identifier", "cannot be empty or unset"))
                            }
                let input_3 = &_input.service_identifier;
                let input_3 = input_3.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("service_identifier", "cannot be empty or unset"))?;
                ...
                if service_identifier.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("service_identifier", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/environments/{EnvironmentIdentifier}/applications/{ApplicationIdentifier}/services/{ServiceIdentifier}", EnvironmentIdentifier = environment_identifier, ApplicationIdentifier = application_identifier, ServiceIdentifier = service_identifier).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_service::DeleteService::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteService", "migrationhubrefactorspaces"));
