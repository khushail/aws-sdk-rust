...
impl super::Client  {
    ...
    ///   - [`environment_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::environment_identifier) / [`set_environment_identifier(Option<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::set_environment_identifier): <p>The ID of the environment.</p>
    ///   - [`application_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::application_identifier) / [`set_application_identifier(Option<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::set_application_identifier): <p>The ID of the application.</p>
    ///   - [`service_identifier(impl ::std::convert::Into<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::service_identifier) / [`set_service_identifier(Option<String>)`](crate::operation::get_service::builders::GetServiceFluentBuilder::set_service_identifier): <p>The ID of the service.</p>
