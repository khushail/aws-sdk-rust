...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_migrationhubrefactorspaces::Error> {
/// # let client: aws_sdk_migrationhubrefactorspaces::Client = unimplemented!();
