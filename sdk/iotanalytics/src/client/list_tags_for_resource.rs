...
impl super::Client  {
    ...
    ///   - [`tags(Option<Vec<Tag>>)`](crate::operation::list_tags_for_resource::ListTagsForResourceOutput::tags): <p>The tags (metadata) that you have assigned to the resource.</p>
