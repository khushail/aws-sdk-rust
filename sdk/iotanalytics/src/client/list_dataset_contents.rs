...
impl super::Client  {
    ...
    ///   - [`dataset_name(impl ::std::convert::Into<String>)`](crate::operation::list_dataset_contents::builders::ListDatasetContentsFluentBuilder::dataset_name) / [`set_dataset_name(Option<String>)`](crate::operation::list_dataset_contents::builders::ListDatasetContentsFluentBuilder::set_dataset_name): <p>The name of the dataset whose contents information you want to list.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_dataset_contents::builders::ListDatasetContentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_dataset_contents::builders::ListDatasetContentsFluentBuilder::set_next_token): <p>The token for the next set of results.</p>
