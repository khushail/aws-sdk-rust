...
impl super::Client  {
    ...
    ///   - [`channel_name(impl ::std::convert::Into<String>)`](crate::operation::batch_put_message::builders::BatchPutMessageFluentBuilder::channel_name) / [`set_channel_name(Option<String>)`](crate::operation::batch_put_message::builders::BatchPutMessageFluentBuilder::set_channel_name): <p>The name of the channel where the messages are sent.</p>
