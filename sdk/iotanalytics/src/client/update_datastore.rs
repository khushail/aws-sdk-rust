...
impl super::Client  {
    ...
    ///   - [`datastore_name(impl ::std::convert::Into<String>)`](crate::operation::update_datastore::builders::UpdateDatastoreFluentBuilder::datastore_name) / [`set_datastore_name(Option<String>)`](crate::operation::update_datastore::builders::UpdateDatastoreFluentBuilder::set_datastore_name): <p>The name of the data store to be updated.</p>
