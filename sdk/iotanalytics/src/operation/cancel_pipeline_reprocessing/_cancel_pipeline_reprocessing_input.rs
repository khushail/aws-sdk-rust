...
impl CancelPipelineReprocessingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::cancel_pipeline_reprocessing::CancelPipelineReprocessingInput, ::aws_smithy_http::operation::error::BuildError> {
