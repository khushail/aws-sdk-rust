...
impl StartPipelineReprocessingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_pipeline_reprocessing::StartPipelineReprocessingInput, ::aws_smithy_http::operation::error::BuildError> {
