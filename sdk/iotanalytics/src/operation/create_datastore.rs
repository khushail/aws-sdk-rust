...
impl CreateDatastoreInput {
    /// Consumes the builder and constructs an Operation<[`CreateDatastore`](crate::operation::create_datastore::CreateDatastore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_datastore::CreateDatastore, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_datastore::CreateDatastoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_datastore::CreateDatastore::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateDatastore", "iotanalytics"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateDatastore {
                type Output = ::std::result::Result<crate::operation::create_datastore::CreateDatastoreOutput, crate::operation::create_datastore::CreateDatastoreError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_datastore::de_create_datastore_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_datastore::de_create_datastore_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_datastore::CreateDatastoreError {
