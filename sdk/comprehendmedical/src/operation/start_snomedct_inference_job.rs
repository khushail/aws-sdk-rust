...
impl StartSnomedctInferenceJobInput {
    /// Consumes the builder and constructs an Operation<[`StartSNOMEDCTInferenceJob`](crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_snomedct_inference_job::StartSnomedctInferenceJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::start_snomedct_inference_job::StartSnomedctInferenceJobInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartSNOMEDCTInferenceJob {
                type Output = ::std::result::Result<crate::operation::start_snomedct_inference_job::StartSnomedctInferenceJobOutput, crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_snomedct_inference_job::de_start_snomedct_inference_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_snomedct_inference_job::de_start_snomedct_inference_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_snomedct_inference_job::StartSNOMEDCTInferenceJobError {
...
mod _start_snomedct_inference_job_output;
