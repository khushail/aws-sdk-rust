...
impl DescribeRxNormInferenceJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRxNormInferenceJob`](crate::operation::describe_rx_norm_inference_job::DescribeRxNormInferenceJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_rx_norm_inference_job::DescribeRxNormInferenceJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_rx_norm_inference_job::DescribeRxNormInferenceJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_rx_norm_inference_job::DescribeRxNormInferenceJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRxNormInferenceJob {
                type Output = ::std::result::Result<crate::operation::describe_rx_norm_inference_job::DescribeRxNormInferenceJobOutput, crate::operation::describe_rx_norm_inference_job::DescribeRxNormInferenceJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_rx_norm_inference_job::de_describe_rx_norm_inference_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_rx_norm_inference_job::de_describe_rx_norm_inference_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_rx_norm_inference_job::DescribeRxNormInferenceJobError {
...
mod _describe_rx_norm_inference_job_output;
