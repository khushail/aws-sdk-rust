...
impl DetectEntitiesV2Input {
    /// Consumes the builder and constructs an Operation<[`DetectEntitiesV2`](crate::operation::detect_entities_v2::DetectEntitiesV2)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::detect_entities_v2::DetectEntitiesV2, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detect_entities_v2::DetectEntitiesV2Input, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detect_entities_v2::DetectEntitiesV2::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetectEntitiesV2", "comprehendmedical"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DetectEntitiesV2`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetectEntitiesV2 {
                type Output = ::std::result::Result<crate::operation::detect_entities_v2::DetectEntitiesV2Output, crate::operation::detect_entities_v2::DetectEntitiesV2Error>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_detect_entities_v2::de_detect_entities_v2_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_detect_entities_v2::de_detect_entities_v2_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::detect_entities_v2::DetectEntitiesV2Error {
...
mod _detect_entities_v2_output;
