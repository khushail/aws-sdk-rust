...
impl StopRxNormInferenceJobInput {
    /// Consumes the builder and constructs an Operation<[`StopRxNormInferenceJob`](crate::operation::stop_rx_norm_inference_job::StopRxNormInferenceJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_rx_norm_inference_job::StopRxNormInferenceJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_rx_norm_inference_job::StopRxNormInferenceJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_rx_norm_inference_job::StopRxNormInferenceJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopRxNormInferenceJob", "comprehendmedical"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StopRxNormInferenceJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopRxNormInferenceJob {
                type Output = ::std::result::Result<crate::operation::stop_rx_norm_inference_job::StopRxNormInferenceJobOutput, crate::operation::stop_rx_norm_inference_job::StopRxNormInferenceJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_rx_norm_inference_job::de_stop_rx_norm_inference_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_rx_norm_inference_job::de_stop_rx_norm_inference_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_rx_norm_inference_job::StopRxNormInferenceJobError {
...
mod _stop_rx_norm_inference_job_output;
