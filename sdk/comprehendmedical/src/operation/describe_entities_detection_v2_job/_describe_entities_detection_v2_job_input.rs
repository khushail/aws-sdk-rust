...
impl DescribeEntitiesDetectionV2JobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_entities_detection_v2_job::DescribeEntitiesDetectionV2JobInput, ::aws_smithy_http::operation::error::BuildError> {
