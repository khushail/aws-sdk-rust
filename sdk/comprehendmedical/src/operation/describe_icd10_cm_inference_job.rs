...
impl DescribeIcd10CmInferenceJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeICD10CMInferenceJob`](crate::operation::describe_icd10_cm_inference_job::DescribeICD10CMInferenceJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_icd10_cm_inference_job::DescribeICD10CMInferenceJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_icd10_cm_inference_job::DescribeIcd10CmInferenceJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_icd10_cm_inference_job::DescribeICD10CMInferenceJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeICD10CMInferenceJob", "comprehendmedical"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeICD10CMInferenceJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeICD10CMInferenceJob {
                type Output = ::std::result::Result<crate::operation::describe_icd10_cm_inference_job::DescribeIcd10CmInferenceJobOutput, crate::operation::describe_icd10_cm_inference_job::DescribeICD10CMInferenceJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_icd10_cm_inference_job::de_describe_icd10_cm_inference_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_icd10_cm_inference_job::de_describe_icd10_cm_inference_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_icd10_cm_inference_job::DescribeICD10CMInferenceJobError {
...
mod _describe_icd10_cm_inference_job_output;
