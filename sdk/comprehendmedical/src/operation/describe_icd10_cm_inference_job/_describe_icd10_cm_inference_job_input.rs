...
impl DescribeIcd10CmInferenceJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_icd10_cm_inference_job::DescribeIcd10CmInferenceJobInput, ::aws_smithy_http::operation::error::BuildError> {
