...
impl StartEntitiesDetectionV2JobInput {
    /// Consumes the builder and constructs an Operation<[`StartEntitiesDetectionV2Job`](crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2Job)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2Job, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2Job::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartEntitiesDetectionV2Job", "comprehendmedical"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartEntitiesDetectionV2Job`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartEntitiesDetectionV2Job {
                type Output = ::std::result::Result<crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobOutput, crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_entities_detection_v2_job::de_start_entities_detection_v2_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_entities_detection_v2_job::de_start_entities_detection_v2_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_entities_detection_v2_job::StartEntitiesDetectionV2JobError {
...
pub use crate::operation::start_entities_detection_v2_job::_start_entities_detection_v2_job_output::StartEntitiesDetectionV2JobOutput;

pub use crate::operation::start_entities_detection_v2_job::_start_entities_detection_v2_job_input::StartEntitiesDetectionV2JobInput;

mod _start_entities_detection_v2_job_input;

mod _start_entities_detection_v2_job_output;
