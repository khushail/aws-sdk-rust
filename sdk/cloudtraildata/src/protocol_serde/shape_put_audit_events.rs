...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_audit_events_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_audit_events::PutAuditEventsOutput, crate::operation::put_audit_events::PutAuditEventsError> {
    Ok({
        #[allow(unused_mut)]
