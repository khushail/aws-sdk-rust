...
impl super::Client  {
    ...
    ///   - [`vault_name(impl ::std::convert::Into<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::vault_name) / [`set_vault_name(Option<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::set_vault_name): <p>The name of the vault.</p>
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::set_account_id): <p>The <code>AccountId</code> value is the AWS account ID of the account that owns the vault. You can either specify an AWS account ID or optionally a single '<code>-</code>' (hyphen), in which case Amazon S3 Glacier uses the AWS account ID associated with the credentials used to sign the request. If you use an account ID, do not include any hyphens ('-') in the ID. </p>
    ///   - [`archive_description(impl ::std::convert::Into<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::archive_description) / [`set_archive_description(Option<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::set_archive_description): <p>The optional description of the archive you are uploading.</p>
    ///   - [`checksum(impl ::std::convert::Into<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::checksum) / [`set_checksum(Option<String>)`](crate::operation::upload_archive::builders::UploadArchiveFluentBuilder::set_checksum): <p>The SHA256 tree hash of the data being uploaded.</p>
