...
impl super::Client  {
    ...
    ///   - [`account_id(impl ::std::convert::Into<String>)`](crate::operation::list_vaults::builders::ListVaultsFluentBuilder::account_id) / [`set_account_id(Option<String>)`](crate::operation::list_vaults::builders::ListVaultsFluentBuilder::set_account_id): <p>The <code>AccountId</code> value is the AWS account ID. This value must match the AWS account ID associated with the credentials used to sign the request. You can either specify an AWS account ID or optionally a single '<code>-</code>' (hyphen), in which case Amazon Glacier uses the AWS account ID associated with the credentials used to sign the request. If you specify your account ID, do not include any hyphens ('-') in the ID.</p>
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_vaults::builders::ListVaultsFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_vaults::builders::ListVaultsFluentBuilder::set_marker): <p>A string used for pagination. The marker specifies the vault ARN after which the listing of vaults should begin.</p>
