...
pub(crate) fn de_vault_access_policy_payload(input: &[u8]) -> Result<crate::types::VaultAccessPolicy, ::aws_smithy_json::deserialize::error::DeserializeError> {
...
pub(crate) fn de_vault_access_policy<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VaultAccessPolicy>, ::aws_smithy_json::deserialize::error::DeserializeError>
