...
#[allow(clippy::unnecessary_wraps)]
pub fn de_initiate_multipart_upload_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::initiate_multipart_upload::InitiateMultipartUploadOutput, crate::operation::initiate_multipart_upload::InitiateMultipartUploadError> {
    Ok({
        #[allow(unused_mut)]
