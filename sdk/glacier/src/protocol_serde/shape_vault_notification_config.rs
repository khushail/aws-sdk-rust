...
pub(crate) fn de_vault_notification_config_payload(input: &[u8]) -> Result<crate::types::VaultNotificationConfig, ::aws_smithy_json::deserialize::error::DeserializeError> {
