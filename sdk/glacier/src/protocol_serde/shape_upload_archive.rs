...
#[allow(clippy::unnecessary_wraps)]
pub fn de_upload_archive_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::upload_archive::UploadArchiveOutput, crate::operation::upload_archive::UploadArchiveError> {
    Ok({
        #[allow(unused_mut)]
