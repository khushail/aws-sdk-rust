...
#[allow(clippy::unnecessary_wraps)]
pub fn de_upload_multipart_part_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::upload_multipart_part::UploadMultipartPartOutput, crate::operation::upload_multipart_part::UploadMultipartPartError> {
    Ok({
        #[allow(unused_mut)]
