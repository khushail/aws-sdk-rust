...
impl CreateVaultInput {
    /// Consumes the builder and constructs an Operation<[`CreateVault`](crate::operation::create_vault::CreateVault)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_vault::CreateVault, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_vault::CreateVaultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_vault::CreateVault::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVault {
                type Output = ::std::result::Result<crate::operation::create_vault::CreateVaultOutput, crate::operation::create_vault::CreateVaultError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        ...
                        crate::protocol_serde::shape_create_vault::de_create_vault_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_vault::CreateVaultError {
