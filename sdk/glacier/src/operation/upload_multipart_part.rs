...
impl UploadMultipartPartInput {
    /// Consumes the builder and constructs an Operation<[`UploadMultipartPart`](crate::operation::upload_multipart_part::UploadMultipartPart)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::upload_multipart_part::UploadMultipartPart, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::upload_multipart_part::UploadMultipartPartInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/{accountId}/vaults/{vaultName}/multipart-uploads/{uploadId}", accountId = account_id, vaultName = vault_name, uploadId = upload_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::upload_multipart_part::UploadMultipartPart::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UploadMultipartPart {
                type Output = ::std::result::Result<crate::operation::upload_multipart_part::UploadMultipartPartOutput, crate::operation::upload_multipart_part::UploadMultipartPartError>;
...
mod upload_multipart_part_request_test {
    ...
    async fn glacier_multipart_checksums_request() {
        ...
        let result = client.upload_multipart_part()
        .set_account_id(
...
impl ::aws_http::request_id::RequestId for crate::operation::upload_multipart_part::UploadMultipartPartError {
