...
impl DeleteVaultNotificationsInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVaultNotifications`](crate::operation::delete_vault_notifications::DeleteVaultNotifications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_vault_notifications::DeleteVaultNotifications, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_vault_notifications::DeleteVaultNotificationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_vault_notifications::DeleteVaultNotifications::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVaultNotifications {
                type Output = ::std::result::Result<crate::operation::delete_vault_notifications::DeleteVaultNotificationsOutput, crate::operation::delete_vault_notifications::DeleteVaultNotificationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        ...
                        crate::protocol_serde::shape_delete_vault_notifications::de_delete_vault_notifications_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_vault_notifications::DeleteVaultNotificationsError {
...
mod _delete_vault_notifications_output;
