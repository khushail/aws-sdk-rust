...
impl ListProvisionedCapacityInput {
    /// Consumes the builder and constructs an Operation<[`ListProvisionedCapacity`](crate::operation::list_provisioned_capacity::ListProvisionedCapacity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_provisioned_capacity::ListProvisionedCapacity, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_provisioned_capacity::ListProvisionedCapacityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_provisioned_capacity::ListProvisionedCapacity::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListProvisionedCapacity {
                type Output = ::std::result::Result<crate::operation::list_provisioned_capacity::ListProvisionedCapacityOutput, crate::operation::list_provisioned_capacity::ListProvisionedCapacityError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_provisioned_capacity::de_list_provisioned_capacity_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_provisioned_capacity::ListProvisionedCapacityError {
...
mod _list_provisioned_capacity_output;
