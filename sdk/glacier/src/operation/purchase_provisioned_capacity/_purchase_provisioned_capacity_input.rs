...
impl PurchaseProvisionedCapacityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::purchase_provisioned_capacity::PurchaseProvisionedCapacityInput, ::aws_smithy_http::operation::error::BuildError> {
