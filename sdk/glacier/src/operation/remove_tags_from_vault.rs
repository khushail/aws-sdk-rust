...
impl RemoveTagsFromVaultInput {
    /// Consumes the builder and constructs an Operation<[`RemoveTagsFromVault`](crate::operation::remove_tags_from_vault::RemoveTagsFromVault)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::remove_tags_from_vault::RemoveTagsFromVault, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_tags_from_vault::RemoveTagsFromVaultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if vault_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("vault_name", "cannot be empty or unset"))
                            }
            ...
            fn uri_query(_input: &crate::operation::remove_tags_from_vault::RemoveTagsFromVaultInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_tags_from_vault::RemoveTagsFromVault::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveTagsFromVault {
                type Output = ::std::result::Result<crate::operation::remove_tags_from_vault::RemoveTagsFromVaultOutput, crate::operation::remove_tags_from_vault::RemoveTagsFromVaultError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        ...
                        crate::protocol_serde::shape_remove_tags_from_vault::de_remove_tags_from_vault_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::remove_tags_from_vault::RemoveTagsFromVaultError {
...
mod _remove_tags_from_vault_output;
