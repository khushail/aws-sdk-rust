...
impl AbortVaultLockInput {
    /// Consumes the builder and constructs an Operation<[`AbortVaultLock`](crate::operation::abort_vault_lock::AbortVaultLock)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::abort_vault_lock::AbortVaultLock, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::abort_vault_lock::AbortVaultLockInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::abort_vault_lock::AbortVaultLock::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AbortVaultLock {
                type Output = ::std::result::Result<crate::operation::abort_vault_lock::AbortVaultLockOutput, crate::operation::abort_vault_lock::AbortVaultLockError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        ...
                        crate::protocol_serde::shape_abort_vault_lock::de_abort_vault_lock_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::abort_vault_lock::AbortVaultLockError {
