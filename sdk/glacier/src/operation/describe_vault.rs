...
impl DescribeVaultInput {
    ...
    pub async fn make_operation(&mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_vault::DescribeVault, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_vault::DescribeVaultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_vault::DescribeVault::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVault {
                type Output = ::std::result::Result<crate::operation::describe_vault::DescribeVaultOutput, crate::operation::describe_vault::DescribeVaultError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_vault::de_describe_vault_http_response_with_props(status, headers, body)
                     }
                }
