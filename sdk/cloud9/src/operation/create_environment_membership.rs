...
impl CreateEnvironmentMembershipInput {
    /// Consumes the builder and constructs an Operation<[`CreateEnvironmentMembership`](crate::operation::create_environment_membership::CreateEnvironmentMembership)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_environment_membership::CreateEnvironmentMembership, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_environment_membership::CreateEnvironmentMembershipInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_environment_membership::ser_create_environment_membership_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_environment_membership::CreateEnvironmentMembership::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateEnvironmentMembership {
                type Output = ::std::result::Result<crate::operation::create_environment_membership::CreateEnvironmentMembershipOutput, crate::operation::create_environment_membership::CreateEnvironmentMembershipError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_environment_membership::de_create_environment_membership_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_environment_membership::de_create_environment_membership_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_environment_membership::CreateEnvironmentMembershipError {
...
mod _create_environment_membership_output;
