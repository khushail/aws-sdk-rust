...
impl UpdateEnvironmentMembershipInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_environment_membership::UpdateEnvironmentMembershipInput, ::aws_smithy_http::operation::error::BuildError> {
