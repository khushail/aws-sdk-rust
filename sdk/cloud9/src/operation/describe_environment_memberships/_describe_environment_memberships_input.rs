...
impl DescribeEnvironmentMembershipsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_environment_memberships::DescribeEnvironmentMembershipsInput, ::aws_smithy_http::operation::error::BuildError> {
