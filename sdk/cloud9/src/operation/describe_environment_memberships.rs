...
impl DescribeEnvironmentMembershipsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeEnvironmentMemberships`](crate::operation::describe_environment_memberships::DescribeEnvironmentMemberships)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_environment_memberships::DescribeEnvironmentMemberships, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_environment_memberships::DescribeEnvironmentMembershipsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_environment_memberships::ser_describe_environment_memberships_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_environment_memberships::DescribeEnvironmentMemberships::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeEnvironmentMemberships {
                type Output = ::std::result::Result<crate::operation::describe_environment_memberships::DescribeEnvironmentMembershipsOutput, crate::operation::describe_environment_memberships::DescribeEnvironmentMembershipsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_environment_memberships::de_describe_environment_memberships_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_environment_memberships::de_describe_environment_memberships_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_environment_memberships::DescribeEnvironmentMembershipsError {
...
mod _describe_environment_memberships_output;
