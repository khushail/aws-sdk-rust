...
impl super::Client  {
    ...
    ///   - [`environment_id(impl ::std::convert::Into<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::environment_id) / [`set_environment_id(Option<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::set_environment_id): <p>The ID of the environment to change settings.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::set_name): <p>A replacement name for the environment.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_environment::builders::UpdateEnvironmentFluentBuilder::set_description): <p>Any new or replacement description for the environment.</p>
