...
pub fn de_list_managed_insight_rules_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_managed_insight_rules::ListManagedInsightRulesOutput, crate::operation::list_managed_insight_rules::ListManagedInsightRulesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::list_managed_insight_rules::ListManagedInsightRulesError::unhandled)?;
    generic_builder = ::aws_http::request_id::apply_request_id(generic_builder, _response_headers);
    let generic = generic_builder.build();
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::list_managed_insight_rules::ListManagedInsightRulesError::unhandled(generic))
                            };
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_managed_insight_rules_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_managed_insight_rules::ListManagedInsightRulesOutput, crate::operation::list_managed_insight_rules::ListManagedInsightRulesError> {
    Ok({
        #[allow(unused_mut)]
...
#[allow(unused_mut)]
pub fn de_list_managed_insight_rules(inp: &[u8], mut builder: crate::operation::list_managed_insight_rules::builders::ListManagedInsightRulesOutputBuilder) -> Result<crate::operation::list_managed_insight_rules::builders::ListManagedInsightRulesOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
