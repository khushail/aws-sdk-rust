...
pub fn ser_put_anomaly_detector_input_input(input: &crate::operation::put_anomaly_detector::PutAnomalyDetectorInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_12 = writer.prefix("Configuration");
    if let Some(var_13) = &input.configuration {
