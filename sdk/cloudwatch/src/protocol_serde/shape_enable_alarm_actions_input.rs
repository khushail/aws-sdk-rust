...
pub fn ser_enable_alarm_actions_input_input(input: &crate::operation::enable_alarm_actions::EnableAlarmActionsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
