...
pub fn de_enable_insight_rules_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_insight_rules::EnableInsightRulesOutput, crate::operation::enable_insight_rules::EnableInsightRulesError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::enable_insight_rules::EnableInsightRulesError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_enable_insight_rules_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::enable_insight_rules::EnableInsightRulesOutput, crate::operation::enable_insight_rules::EnableInsightRulesError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::enable_insight_rules::builders::EnableInsightRulesOutputBuilder::default();
        output = crate::protocol_serde::shape_enable_insight_rules::de_enable_insight_rules(_response_body, output).map_err(crate::operation::enable_insight_rules::EnableInsightRulesError::unhandled)?;
