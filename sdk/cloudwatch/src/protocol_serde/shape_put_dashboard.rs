...
pub fn de_put_dashboard_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_dashboard::PutDashboardOutput, crate::operation::put_dashboard::PutDashboardError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::put_dashboard::PutDashboardError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_dashboard_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_dashboard::PutDashboardOutput, crate::operation::put_dashboard::PutDashboardError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::put_dashboard::builders::PutDashboardOutputBuilder::default();
        output = crate::protocol_serde::shape_put_dashboard::de_put_dashboard(_response_body, output).map_err(crate::operation::put_dashboard::PutDashboardError::unhandled)?;
