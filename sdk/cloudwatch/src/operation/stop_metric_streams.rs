...
impl StopMetricStreamsInput {
    /// Consumes the builder and constructs an Operation<[`StopMetricStreams`](crate::operation::stop_metric_streams::StopMetricStreams)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_metric_streams::StopMetricStreams, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_metric_streams::StopMetricStreamsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_metric_streams::StopMetricStreams::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopMetricStreams", "cloudwatch"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StopMetricStreams`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopMetricStreams {
                type Output = ::std::result::Result<crate::operation::stop_metric_streams::StopMetricStreamsOutput, crate::operation::stop_metric_streams::StopMetricStreamsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_metric_streams::de_stop_metric_streams_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_metric_streams::de_stop_metric_streams_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_metric_streams::StopMetricStreamsError {
...
mod _stop_metric_streams_output;
