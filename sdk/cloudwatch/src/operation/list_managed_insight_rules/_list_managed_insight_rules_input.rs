...
impl ListManagedInsightRulesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_managed_insight_rules::ListManagedInsightRulesInput, ::aws_smithy_http::operation::error::BuildError> {
