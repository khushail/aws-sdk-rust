...
impl DescribeAlarmsForMetricInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_alarms_for_metric::DescribeAlarmsForMetricInput, ::aws_smithy_http::operation::error::BuildError> {
