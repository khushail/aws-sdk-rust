...
impl SetAlarmStateInput {
    /// Consumes the builder and constructs an Operation<[`SetAlarmState`](crate::operation::set_alarm_state::SetAlarmState)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_alarm_state::SetAlarmState, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_alarm_state::SetAlarmStateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_alarm_state::SetAlarmState::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetAlarmState {
                type Output = ::std::result::Result<crate::operation::set_alarm_state::SetAlarmStateOutput, crate::operation::set_alarm_state::SetAlarmStateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_set_alarm_state::de_set_alarm_state_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::set_alarm_state::SetAlarmStateError {
