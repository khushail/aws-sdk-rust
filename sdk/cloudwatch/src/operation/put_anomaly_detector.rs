...
impl PutAnomalyDetectorInput {
    /// Consumes the builder and constructs an Operation<[`PutAnomalyDetector`](crate::operation::put_anomaly_detector::PutAnomalyDetector)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_anomaly_detector::PutAnomalyDetector, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_anomaly_detector::PutAnomalyDetectorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_anomaly_detector::PutAnomalyDetector::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAnomalyDetector {
                type Output = ::std::result::Result<crate::operation::put_anomaly_detector::PutAnomalyDetectorOutput, crate::operation::put_anomaly_detector::PutAnomalyDetectorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_put_anomaly_detector::de_put_anomaly_detector_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_anomaly_detector::PutAnomalyDetectorError {
