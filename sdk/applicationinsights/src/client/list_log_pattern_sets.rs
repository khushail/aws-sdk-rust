...
impl super::Client  {
    ...
    ///   - [`resource_group_name(impl ::std::convert::Into<String>)`](crate::operation::list_log_pattern_sets::builders::ListLogPatternSetsFluentBuilder::resource_group_name) / [`set_resource_group_name(Option<String>)`](crate::operation::list_log_pattern_sets::builders::ListLogPatternSetsFluentBuilder::set_resource_group_name): <p>The name of the resource group.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_log_pattern_sets::builders::ListLogPatternSetsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_log_pattern_sets::builders::ListLogPatternSetsFluentBuilder::set_next_token): <p>The token to request the next page of results.</p>
