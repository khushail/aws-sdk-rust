...
impl DescribeLogPatternInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLogPattern`](crate::operation::describe_log_pattern::DescribeLogPattern)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_log_pattern::DescribeLogPattern, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_log_pattern::DescribeLogPatternInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_log_pattern::DescribeLogPattern::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLogPattern {
                type Output = ::std::result::Result<crate::operation::describe_log_pattern::DescribeLogPatternOutput, crate::operation::describe_log_pattern::DescribeLogPatternError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_log_pattern::de_describe_log_pattern_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_log_pattern::de_describe_log_pattern_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_log_pattern::DescribeLogPatternError {
...
mod _describe_log_pattern_output;
