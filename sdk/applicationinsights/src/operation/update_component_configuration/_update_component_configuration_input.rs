...
impl UpdateComponentConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_component_configuration::UpdateComponentConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
