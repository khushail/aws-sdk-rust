...
impl DescribeComponentConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_component_configuration::DescribeComponentConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
