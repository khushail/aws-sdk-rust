...
impl ListOrganizationInsightsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_organization_insights::ListOrganizationInsightsInput, ::aws_smithy_http::operation::error::BuildError> {
