...
impl RemoveNotificationChannelInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_notification_channel::RemoveNotificationChannelInput, ::aws_smithy_http::operation::error::BuildError> {
