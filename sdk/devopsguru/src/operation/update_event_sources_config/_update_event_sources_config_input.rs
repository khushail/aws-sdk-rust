...
impl UpdateEventSourcesConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_event_sources_config::UpdateEventSourcesConfigInput, ::aws_smithy_http::operation::error::BuildError> {
