...
impl UpdateServiceIntegrationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_service_integration::UpdateServiceIntegrationInput, ::aws_smithy_http::operation::error::BuildError> {
