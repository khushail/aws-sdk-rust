...
impl DescribeOrganizationHealthInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_organization_health::DescribeOrganizationHealthInput, ::aws_smithy_http::operation::error::BuildError> {
