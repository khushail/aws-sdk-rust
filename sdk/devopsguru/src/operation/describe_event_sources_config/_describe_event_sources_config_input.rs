...
impl DescribeEventSourcesConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_event_sources_config::DescribeEventSourcesConfigInput, ::aws_smithy_http::operation::error::BuildError> {
