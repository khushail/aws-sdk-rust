...
impl RestoreCoreNetworkPolicyVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_core_network_policy_version::RestoreCoreNetworkPolicyVersionInput, ::aws_smithy_http::operation::error::BuildError> {
