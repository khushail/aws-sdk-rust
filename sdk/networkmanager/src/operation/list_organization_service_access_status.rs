...
impl ListOrganizationServiceAccessStatusInput {
    /// Consumes the builder and constructs an Operation<[`ListOrganizationServiceAccessStatus`](crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/organizations/service-access").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatusInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatusInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatus::new())
...
/// Orchestration and serialization glue logic for `ListOrganizationServiceAccessStatus`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListOrganizationServiceAccessStatus {
                type Output = ::std::result::Result<crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatusOutput, crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatusError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::list_organization_service_access_status::ListOrganizationServiceAccessStatusError {
...
mod _list_organization_service_access_status_output;
