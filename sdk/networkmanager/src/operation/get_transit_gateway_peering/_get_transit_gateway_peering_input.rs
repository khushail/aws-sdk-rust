...
impl GetTransitGatewayPeeringInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_transit_gateway_peering::GetTransitGatewayPeeringInput, ::aws_smithy_http::operation::error::BuildError> {
