...
impl DeregisterTransitGatewayInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_transit_gateway::DeregisterTransitGatewayInput, ::aws_smithy_http::operation::error::BuildError> {
