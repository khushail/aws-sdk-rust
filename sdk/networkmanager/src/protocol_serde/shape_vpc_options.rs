...
pub(crate) fn de_vpc_options<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VpcOptions>, ::aws_smithy_json::deserialize::error::DeserializeError>
