...
impl super::Client  {
    ...
    ///   - [`global_network_id(impl ::std::convert::Into<String>)`](crate::operation::delete_global_network::builders::DeleteGlobalNetworkFluentBuilder::global_network_id) / [`set_global_network_id(Option<String>)`](crate::operation::delete_global_network::builders::DeleteGlobalNetworkFluentBuilder::set_global_network_id): <p>The ID of the global network.</p>
