...
impl super::Client  {
    ...
    ///   - [`global_network_id(impl ::std::convert::Into<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::global_network_id) / [`set_global_network_id(Option<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::set_global_network_id): <p>The ID of the global network.</p>
    ...
    ///   - [`site_id(impl ::std::convert::Into<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::site_id) / [`set_site_id(Option<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::set_site_id): <p>The ID of the site.</p>
    ///   - [`r#type(impl ::std::convert::Into<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::type) / [`set_type(Option<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::set_type): <p>The link type.</p>
    ///   - [`provider(impl ::std::convert::Into<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::provider) / [`set_provider(Option<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::set_provider): <p>The link provider.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_links::builders::GetLinksFluentBuilder::set_next_token): <p>The token for the next page of results.</p>
