...
impl super::Client  {
    ...
    ///   - [`global_network_id(impl ::std::convert::Into<String>)`](crate::operation::delete_device::builders::DeleteDeviceFluentBuilder::global_network_id) / [`set_global_network_id(Option<String>)`](crate::operation::delete_device::builders::DeleteDeviceFluentBuilder::set_global_network_id): <p>The ID of the global network.</p>
    ///   - [`device_id(impl ::std::convert::Into<String>)`](crate::operation::delete_device::builders::DeleteDeviceFluentBuilder::device_id) / [`set_device_id(Option<String>)`](crate::operation::delete_device::builders::DeleteDeviceFluentBuilder::set_device_id): <p>The ID of the device.</p>
