...
impl DeleteVirtualGatewayInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVirtualGateway`](crate::operation::delete_virtual_gateway::DeleteVirtualGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_virtual_gateway::DeleteVirtualGateway, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_virtual_gateway::DeleteVirtualGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_virtual_gateway::DeleteVirtualGatewayInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_virtual_gateway::DeleteVirtualGatewayInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_virtual_gateway::DeleteVirtualGateway::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteVirtualGateway", "appmesh"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteVirtualGateway`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVirtualGateway {
                type Output = ::std::result::Result<crate::operation::delete_virtual_gateway::DeleteVirtualGatewayOutput, crate::operation::delete_virtual_gateway::DeleteVirtualGatewayError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_virtual_gateway::de_delete_virtual_gateway_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_virtual_gateway::de_delete_virtual_gateway_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_virtual_gateway::DeleteVirtualGatewayError {
...
mod _delete_virtual_gateway_output;
