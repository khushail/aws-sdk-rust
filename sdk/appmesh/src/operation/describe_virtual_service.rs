...
impl DescribeVirtualServiceInput {
    /// Consumes the builder and constructs an Operation<[`DescribeVirtualService`](crate::operation::describe_virtual_service::DescribeVirtualService)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_virtual_service::DescribeVirtualService, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_virtual_service::DescribeVirtualServiceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if virtual_service_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("virtual_service_name", "cannot be empty or unset"))
                            }
            ...
            fn uri_query(_input: &crate::operation::describe_virtual_service::DescribeVirtualServiceInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_virtual_service::DescribeVirtualServiceInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_virtual_service::DescribeVirtualService::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVirtualService {
                type Output = ::std::result::Result<crate::operation::describe_virtual_service::DescribeVirtualServiceOutput, crate::operation::describe_virtual_service::DescribeVirtualServiceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_virtual_service::de_describe_virtual_service_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_virtual_service::de_describe_virtual_service_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_virtual_service::DescribeVirtualServiceError {
...
mod _describe_virtual_service_output;
