...
impl DeleteVirtualNodeInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVirtualNode`](crate::operation::delete_virtual_node::DeleteVirtualNode)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_virtual_node::DeleteVirtualNode, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_virtual_node::DeleteVirtualNodeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if virtual_node_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("virtual_node_name", "cannot be empty or unset"))
                            }
            ...
            fn uri_query(_input: &crate::operation::delete_virtual_node::DeleteVirtualNodeInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_virtual_node::DeleteVirtualNodeInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_virtual_node::DeleteVirtualNode::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVirtualNode {
                type Output = ::std::result::Result<crate::operation::delete_virtual_node::DeleteVirtualNodeOutput, crate::operation::delete_virtual_node::DeleteVirtualNodeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_virtual_node::de_delete_virtual_node_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_virtual_node::de_delete_virtual_node_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_virtual_node::DeleteVirtualNodeError {
...
mod _delete_virtual_node_output;
