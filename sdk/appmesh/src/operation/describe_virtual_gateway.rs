...
impl DescribeVirtualGatewayInput {
    /// Consumes the builder and constructs an Operation<[`DescribeVirtualGateway`](crate::operation::describe_virtual_gateway::DescribeVirtualGateway)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_virtual_gateway::DescribeVirtualGateway, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_virtual_gateway::DescribeVirtualGatewayInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_virtual_gateway::DescribeVirtualGatewayInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_virtual_gateway::DescribeVirtualGatewayInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_virtual_gateway::DescribeVirtualGateway::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeVirtualGateway", "appmesh"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeVirtualGateway`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeVirtualGateway {
                type Output = ::std::result::Result<crate::operation::describe_virtual_gateway::DescribeVirtualGatewayOutput, crate::operation::describe_virtual_gateway::DescribeVirtualGatewayError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_virtual_gateway::de_describe_virtual_gateway_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_virtual_gateway::de_describe_virtual_gateway_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_virtual_gateway::DescribeVirtualGatewayError {
...
pub use crate::operation::describe_virtual_gateway::_describe_virtual_gateway_output::DescribeVirtualGatewayOutput;

pub use crate::operation::describe_virtual_gateway::_describe_virtual_gateway_input::DescribeVirtualGatewayInput;

mod _describe_virtual_gateway_input;

mod _describe_virtual_gateway_output;
