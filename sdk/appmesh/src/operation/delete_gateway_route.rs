...
impl DeleteGatewayRouteInput {
    /// Consumes the builder and constructs an Operation<[`DeleteGatewayRoute`](crate::operation::delete_gateway_route::DeleteGatewayRoute)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_gateway_route::DeleteGatewayRoute, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_gateway_route::DeleteGatewayRouteInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if mesh_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("mesh_name", "cannot be empty or unset"))
                            }
                ...
                if virtual_gateway_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("virtual_gateway_name", "cannot be empty or unset"))
                            }
                ...
                if gateway_route_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("gateway_route_name", "cannot be empty or unset"))
                            }
            ...
            fn uri_query(_input: &crate::operation::delete_gateway_route::DeleteGatewayRouteInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_gateway_route::DeleteGatewayRouteInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_gateway_route::DeleteGatewayRoute::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteGatewayRoute", "appmesh"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteGatewayRoute`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteGatewayRoute {
                type Output = ::std::result::Result<crate::operation::delete_gateway_route::DeleteGatewayRouteOutput, crate::operation::delete_gateway_route::DeleteGatewayRouteError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_gateway_route::de_delete_gateway_route_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_gateway_route::de_delete_gateway_route_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_gateway_route::DeleteGatewayRouteError {
...
pub use crate::operation::delete_gateway_route::_delete_gateway_route_output::DeleteGatewayRouteOutput;

pub use crate::operation::delete_gateway_route::_delete_gateway_route_input::DeleteGatewayRouteInput;

mod _delete_gateway_route_input;

mod _delete_gateway_route_output;
