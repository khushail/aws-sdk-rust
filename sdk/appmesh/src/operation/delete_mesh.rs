...
impl DeleteMeshInput {
    /// Consumes the builder and constructs an Operation<[`DeleteMesh`](crate::operation::delete_mesh::DeleteMesh)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_mesh::DeleteMesh, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_mesh::DeleteMeshInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_mesh::DeleteMeshInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_mesh::DeleteMesh::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteMesh", "appmesh"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteMesh`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteMesh {
                type Output = ::std::result::Result<crate::operation::delete_mesh::DeleteMeshOutput, crate::operation::delete_mesh::DeleteMeshError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_mesh::de_delete_mesh_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_mesh::de_delete_mesh_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_mesh::DeleteMeshError {
