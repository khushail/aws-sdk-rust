...
impl CreateVirtualServiceInput {
    /// Consumes the builder and constructs an Operation<[`CreateVirtualService`](crate::operation::create_virtual_service::CreateVirtualService)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_virtual_service::CreateVirtualService, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_virtual_service::CreateVirtualServiceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::create_virtual_service::CreateVirtualServiceInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_virtual_service::CreateVirtualService::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateVirtualService", "appmesh"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateVirtualService`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVirtualService {
                type Output = ::std::result::Result<crate::operation::create_virtual_service::CreateVirtualServiceOutput, crate::operation::create_virtual_service::CreateVirtualServiceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_virtual_service::de_create_virtual_service_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_virtual_service::de_create_virtual_service_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_virtual_service::CreateVirtualServiceError {
...
mod _create_virtual_service_output;
