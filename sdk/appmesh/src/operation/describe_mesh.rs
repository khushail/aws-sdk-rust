...
impl DescribeMeshInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMesh`](crate::operation::describe_mesh::DescribeMesh)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_mesh::DescribeMesh, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_mesh::DescribeMeshInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::describe_mesh::DescribeMeshInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_mesh::DescribeMeshInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_mesh::DescribeMesh::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeMesh", "appmesh"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeMesh`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMesh {
                type Output = ::std::result::Result<crate::operation::describe_mesh::DescribeMeshOutput, crate::operation::describe_mesh::DescribeMeshError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_mesh::de_describe_mesh_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_mesh::de_describe_mesh_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_mesh::DescribeMeshError {
