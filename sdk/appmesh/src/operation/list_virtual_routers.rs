...
impl ListVirtualRoutersInput {
    /// Consumes the builder and constructs an Operation<[`ListVirtualRouters`](crate::operation::list_virtual_routers::ListVirtualRouters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_virtual_routers::ListVirtualRouters, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_virtual_routers::ListVirtualRoutersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_virtual_routers::ListVirtualRoutersInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_virtual_routers::ListVirtualRoutersInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_virtual_routers::ListVirtualRouters::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListVirtualRouters", "appmesh"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListVirtualRouters`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVirtualRouters {
                type Output = ::std::result::Result<crate::operation::list_virtual_routers::ListVirtualRoutersOutput, crate::operation::list_virtual_routers::ListVirtualRoutersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_virtual_routers::de_list_virtual_routers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_virtual_routers::de_list_virtual_routers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_virtual_routers::ListVirtualRoutersError {
...
pub use crate::operation::list_virtual_routers::_list_virtual_routers_output::ListVirtualRoutersOutput;

pub use crate::operation::list_virtual_routers::_list_virtual_routers_input::ListVirtualRoutersInput;

mod _list_virtual_routers_input;

mod _list_virtual_routers_output;
