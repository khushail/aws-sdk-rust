...
pub(crate) fn de_virtual_gateway_health_check_policy<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VirtualGatewayHealthCheckPolicy>, ::aws_smithy_json::deserialize::error::DeserializeError>
