...
pub(crate) fn de_virtual_gateway_listener_tls<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::VirtualGatewayListenerTls>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::VirtualGatewayListenerTlsBuilder::default();
            loop {
                match tokens.next().transpose()? {
                        ...
                        match key.to_unescaped()?.as_ref() {
                                ...
                                builder = builder.set_mode(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::VirtualGatewayListenerTlsMode::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
                            "validation" => {
                                builder = builder.set_validation(
                                    crate::protocol_serde::shape_virtual_gateway_listener_tls_validation_context::de_virtual_gateway_listener_tls_validation_context(tokens)?
                                );
                            }
                            "certificate" => {
                                builder = builder.set_certificate(
                                    crate::protocol_serde::shape_virtual_gateway_listener_tls_certificate::de_virtual_gateway_listener_tls_certificate(tokens)?
                                );
                            }
