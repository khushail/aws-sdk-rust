...
impl super::Client  {
    ...
    ///   - [`collection_id(impl ::std::convert::Into<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::collection_id) / [`set_collection_id(Option<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::set_collection_id): <p>ID of the collection from which to list the faces.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::set_next_token): <p>If the previous response was incomplete (because there is more data to retrieve), Amazon Rekognition returns a pagination token in the response. You can use this pagination token to retrieve the next set of faces.</p>
    ...
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::set_user_id): <p>An array of user IDs to match when listing faces in a collection.</p>
    ///   - [`face_ids(Vec<String>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::face_ids) / [`set_face_ids(Option<Vec<String>>)`](crate::operation::list_faces::builders::ListFacesFluentBuilder::set_face_ids): <p>An array of face IDs to match when listing faces in a collection.</p>
