...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::start_stream_processor::builders::StartStreamProcessorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::start_stream_processor::builders::StartStreamProcessorFluentBuilder::set_name): <p>The name of the stream processor to start processing.</p>
