...
impl super::Client  {
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_collections::builders::ListCollectionsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_collections::builders::ListCollectionsFluentBuilder::set_next_token): <p>Pagination token from the previous response.</p>
