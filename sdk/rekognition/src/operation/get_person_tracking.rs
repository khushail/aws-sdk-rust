...
impl GetPersonTrackingInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_person_tracking::GetPersonTracking, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_person_tracking::GetPersonTrackingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `GetPersonTracking`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPersonTracking {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_person_tracking::de_get_person_tracking_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_person_tracking::de_get_person_tracking_http_response_with_props(status, headers, body)
                     }
                }
