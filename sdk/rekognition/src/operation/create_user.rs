...
impl CreateUserInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_user::CreateUser, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_user::CreateUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_user::CreateUser::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateUser", "rekognition"));
...
impl CreateUserError {
    ...
    /// Returns `true` if the error kind is `CreateUserError::IdempotentParameterMismatchException`.
    pub fn is_idempotent_parameter_mismatch_exception(&self) -> bool {
        matches!(self, Self::IdempotentParameterMismatchException(_))
    }
    /// Returns `true` if the error kind is `CreateUserError::InternalServerError`.
    ...
    /// Returns `true` if the error kind is `CreateUserError::ProvisionedThroughputExceededException`.
