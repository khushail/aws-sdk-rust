...
impl RecognizeCelebritiesInput {
    /// Consumes the builder and constructs an Operation<[`RecognizeCelebrities`](crate::operation::recognize_celebrities::RecognizeCelebrities)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::recognize_celebrities::RecognizeCelebrities, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::recognize_celebrities::RecognizeCelebritiesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::recognize_celebrities::RecognizeCelebrities::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RecognizeCelebrities {
                type Output = ::std::result::Result<crate::operation::recognize_celebrities::RecognizeCelebritiesOutput, crate::operation::recognize_celebrities::RecognizeCelebritiesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_recognize_celebrities::de_recognize_celebrities_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::recognize_celebrities::RecognizeCelebritiesError {
...
pub use crate::operation::recognize_celebrities::_recognize_celebrities_output::RecognizeCelebritiesOutput;

pub use crate::operation::recognize_celebrities::_recognize_celebrities_input::RecognizeCelebritiesInput;

mod _recognize_celebrities_input;

mod _recognize_celebrities_output;
