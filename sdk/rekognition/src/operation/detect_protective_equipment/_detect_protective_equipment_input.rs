...
impl DetectProtectiveEquipmentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::detect_protective_equipment::DetectProtectiveEquipmentInput, ::aws_smithy_http::operation::error::BuildError> {
