...
impl StartLabelDetectionInput {
    /// Consumes the builder and constructs an Operation<[`StartLabelDetection`](crate::operation::start_label_detection::StartLabelDetection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_label_detection::StartLabelDetection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_label_detection::StartLabelDetectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_label_detection::StartLabelDetection::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartLabelDetection {
                type Output = ::std::result::Result<crate::operation::start_label_detection::StartLabelDetectionOutput, crate::operation::start_label_detection::StartLabelDetectionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_label_detection::de_start_label_detection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_label_detection::de_start_label_detection_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_label_detection::StartLabelDetectionError {
...
pub use crate::operation::start_label_detection::_start_label_detection_output::StartLabelDetectionOutput;

pub use crate::operation::start_label_detection::_start_label_detection_input::StartLabelDetectionInput;

mod _start_label_detection_input;

mod _start_label_detection_output;
