...
impl DeleteUserInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_user::DeleteUser, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user::DeleteUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user::DeleteUser::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteUser", "rekognition"));
...
impl DeleteUserError {
    ...
    /// Returns `true` if the error kind is `DeleteUserError::IdempotentParameterMismatchException`.
    pub fn is_idempotent_parameter_mismatch_exception(&self) -> bool {
        matches!(self, Self::IdempotentParameterMismatchException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserError::InternalServerError`.
    ...
    /// Returns `true` if the error kind is `DeleteUserError::ProvisionedThroughputExceededException`.
