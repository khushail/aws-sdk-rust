...
impl DeleteStreamProcessorInput {
    /// Consumes the builder and constructs an Operation<[`DeleteStreamProcessor`](crate::operation::delete_stream_processor::DeleteStreamProcessor)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_stream_processor::DeleteStreamProcessor, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_stream_processor::DeleteStreamProcessorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_stream_processor::DeleteStreamProcessor::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteStreamProcessor", "rekognition"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteStreamProcessor`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteStreamProcessor {
                type Output = ::std::result::Result<crate::operation::delete_stream_processor::DeleteStreamProcessorOutput, crate::operation::delete_stream_processor::DeleteStreamProcessorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_stream_processor::de_delete_stream_processor_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_stream_processor::de_delete_stream_processor_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_stream_processor::DeleteStreamProcessorError {
...
mod _delete_stream_processor_output;
