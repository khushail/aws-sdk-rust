...
impl StopStreamProcessorInput {
    /// Consumes the builder and constructs an Operation<[`StopStreamProcessor`](crate::operation::stop_stream_processor::StopStreamProcessor)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_stream_processor::StopStreamProcessor, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_stream_processor::StopStreamProcessorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::stop_stream_processor::StopStreamProcessorInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_stream_processor::StopStreamProcessor::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopStreamProcessor {
                type Output = ::std::result::Result<crate::operation::stop_stream_processor::StopStreamProcessorOutput, crate::operation::stop_stream_processor::StopStreamProcessorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_stream_processor::de_stop_stream_processor_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_stream_processor::de_stop_stream_processor_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_stream_processor::StopStreamProcessorError {
...
mod _stop_stream_processor_output;
