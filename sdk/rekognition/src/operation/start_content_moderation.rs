...
impl StartContentModerationInput {
    /// Consumes the builder and constructs an Operation<[`StartContentModeration`](crate::operation::start_content_moderation::StartContentModeration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_content_moderation::StartContentModeration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_content_moderation::StartContentModerationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_content_moderation::StartContentModeration::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartContentModeration {
                type Output = ::std::result::Result<crate::operation::start_content_moderation::StartContentModerationOutput, crate::operation::start_content_moderation::StartContentModerationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_content_moderation::de_start_content_moderation_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_content_moderation::de_start_content_moderation_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_content_moderation::StartContentModerationError {
...
mod _start_content_moderation_output;
