...
impl StartCelebrityRecognitionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_celebrity_recognition::StartCelebrityRecognitionInput, ::aws_smithy_http::operation::error::BuildError> {
