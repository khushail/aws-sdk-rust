...
impl AssociateFacesInput {
    /// Consumes the builder and constructs an Operation<[`AssociateFaces`](crate::operation::associate_faces::AssociateFaces)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_faces::AssociateFaces, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_faces::AssociateFacesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_faces::ser_associate_faces_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_faces::AssociateFaces::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateFaces", "rekognition"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateFaces`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
#[doc(hidden)]
pub struct AssociateFaces;
impl AssociateFaces {
    #[doc(hidden)]
    pub fn new() -> Self {
        Self
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateFaces {
                type Output = ::std::result::Result<crate::operation::associate_faces::AssociateFacesOutput, crate::operation::associate_faces::AssociateFacesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_faces::de_associate_faces_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_faces::de_associate_faces_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type AssociateFacesErrorKind = AssociateFacesError;
/// Error type for the `AssociateFacesError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for AssociateFacesError {
...
impl ::std::fmt::Display for AssociateFacesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateFacesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_faces::AssociateFacesError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for AssociateFacesError {
...
impl AssociateFacesError {
    /// Creates the `AssociateFacesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateFacesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `AssociateFacesError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `AssociateFacesError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `AssociateFacesError::IdempotentParameterMismatchException`.
    pub fn is_idempotent_parameter_mismatch_exception(&self) -> bool {
        matches!(self, Self::IdempotentParameterMismatchException(_))
    }
    /// Returns `true` if the error kind is `AssociateFacesError::InternalServerError`.
    pub fn is_internal_server_error(&self) -> bool {
        matches!(self, Self::InternalServerError(_))
    }
    /// Returns `true` if the error kind is `AssociateFacesError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `AssociateFacesError::ProvisionedThroughputExceededException`.
    pub fn is_provisioned_throughput_exceeded_exception(&self) -> bool {
        matches!(self, Self::ProvisionedThroughputExceededException(_))
    }
    /// Returns `true` if the error kind is `AssociateFacesError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `AssociateFacesError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `AssociateFacesError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
}
impl ::std::error::Error for AssociateFacesError {
