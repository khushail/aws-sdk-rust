...
impl DistributeDatasetEntriesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::distribute_dataset_entries::DistributeDatasetEntriesInput, ::aws_smithy_http::operation::error::BuildError> {
