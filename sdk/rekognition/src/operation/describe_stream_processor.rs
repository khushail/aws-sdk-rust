...
impl DescribeStreamProcessorInput {
    /// Consumes the builder and constructs an Operation<[`DescribeStreamProcessor`](crate::operation::describe_stream_processor::DescribeStreamProcessor)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_stream_processor::DescribeStreamProcessor, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_stream_processor::DescribeStreamProcessorInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_stream_processor::DescribeStreamProcessorInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_stream_processor::DescribeStreamProcessor::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeStreamProcessor", "rekognition"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeStreamProcessor`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeStreamProcessor {
                type Output = ::std::result::Result<crate::operation::describe_stream_processor::DescribeStreamProcessorOutput, crate::operation::describe_stream_processor::DescribeStreamProcessorError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_stream_processor::de_describe_stream_processor_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_stream_processor::de_describe_stream_processor_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_stream_processor::DescribeStreamProcessorError {
...
mod _describe_stream_processor_output;
