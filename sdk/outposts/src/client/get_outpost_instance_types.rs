...
impl super::Client  {
    ...
    ///   - [`outpost_id(impl ::std::convert::Into<String>)`](crate::operation::get_outpost_instance_types::builders::GetOutpostInstanceTypesFluentBuilder::outpost_id) / [`set_outpost_id(Option<String>)`](crate::operation::get_outpost_instance_types::builders::GetOutpostInstanceTypesFluentBuilder::set_outpost_id): <p> The ID or the Amazon Resource Name (ARN) of the Outpost. </p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::get_outpost_instance_types::builders::GetOutpostInstanceTypesFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::get_outpost_instance_types::builders::GetOutpostInstanceTypesFluentBuilder::set_next_token): <p>The pagination token.</p>
