...
impl UpdateLedgerPermissionsModeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_ledger_permissions_mode::UpdateLedgerPermissionsModeInput, ::aws_smithy_http::operation::error::BuildError> {
