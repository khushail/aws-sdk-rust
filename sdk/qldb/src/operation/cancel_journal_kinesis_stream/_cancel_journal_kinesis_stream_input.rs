...
impl CancelJournalKinesisStreamInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::cancel_journal_kinesis_stream::CancelJournalKinesisStreamInput, ::aws_smithy_http::operation::error::BuildError> {
