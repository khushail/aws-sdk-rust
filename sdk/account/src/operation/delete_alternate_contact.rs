...
impl DeleteAlternateContactInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAlternateContact`](crate::operation::delete_alternate_contact::DeleteAlternateContact)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_alternate_contact::DeleteAlternateContact, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_alternate_contact::DeleteAlternateContactInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/deleteAlternateContact").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_alternate_contact::DeleteAlternateContact::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAlternateContact", "account"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteAlternateContact`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAlternateContact {
                type Output = ::std::result::Result<crate::operation::delete_alternate_contact::DeleteAlternateContactOutput, crate::operation::delete_alternate_contact::DeleteAlternateContactError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_alternate_contact::de_delete_alternate_contact_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_alternate_contact::de_delete_alternate_contact_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_alternate_contact::DeleteAlternateContactError {
...
mod _delete_alternate_contact_output;
