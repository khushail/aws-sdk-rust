...
impl super::Client  {
    ...
    ///   - [`table_name(impl ::std::convert::Into<String>)`](crate::operation::update_time_to_live::builders::UpdateTimeToLiveFluentBuilder::table_name) / [`set_table_name(Option<String>)`](crate::operation::update_time_to_live::builders::UpdateTimeToLiveFluentBuilder::set_table_name): <p>The name of the table to be configured.</p>
