...
pub(crate) fn de_restore_summary<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::RestoreSummary>, ::aws_smithy_json::deserialize::error::DeserializeError>
