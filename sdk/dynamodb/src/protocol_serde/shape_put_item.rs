...
pub fn ser_put_item_input(input: &crate::operation::put_item::PutItemInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_put_item_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_item::PutItemOutput, crate::operation::put_item::PutItemError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_put_item(value: &[u8], mut builder: crate::operation::put_item::builders::PutItemOutputBuilder) -> Result<crate::operation::put_item::builders::PutItemOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
