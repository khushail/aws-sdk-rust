...
impl ImportTableInput {
    /// Consumes the builder and constructs an Operation<[`ImportTable`](crate::operation::import_table::ImportTable)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::import_table::ImportTable, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::import_table::ImportTableInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::import_table::ImportTable::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ImportTable {
                type Output = ::std::result::Result<crate::operation::import_table::ImportTableOutput, crate::operation::import_table::ImportTableError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_import_table::de_import_table_http_response_with_props(status, headers, body)
                     }
                }
