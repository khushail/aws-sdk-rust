...
impl DescribeGlobalTableInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGlobalTable`](crate::operation::describe_global_table::DescribeGlobalTable)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_global_table::DescribeGlobalTable, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_global_table::DescribeGlobalTableInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_global_table::DescribeGlobalTable::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGlobalTable {
                type Output = ::std::result::Result<crate::operation::describe_global_table::DescribeGlobalTableOutput, crate::operation::describe_global_table::DescribeGlobalTableError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_global_table::DescribeGlobalTableError {
