...
impl UpdateContributorInsightsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_contributor_insights::UpdateContributorInsightsInput, ::aws_smithy_http::operation::error::BuildError> {
