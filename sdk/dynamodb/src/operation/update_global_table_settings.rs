...
impl UpdateGlobalTableSettingsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGlobalTableSettings`](crate::operation::update_global_table_settings::UpdateGlobalTableSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_global_table_settings::UpdateGlobalTableSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_global_table_settings::UpdateGlobalTableSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_global_table_settings::UpdateGlobalTableSettings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGlobalTableSettings {
                type Output = ::std::result::Result<crate::operation::update_global_table_settings::UpdateGlobalTableSettingsOutput, crate::operation::update_global_table_settings::UpdateGlobalTableSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_global_table_settings::de_update_global_table_settings_http_response_with_props(status, headers, body)
                     }
                }
