...
impl DescribeGlobalTableSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGlobalTableSettings`](crate::operation::describe_global_table_settings::DescribeGlobalTableSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_global_table_settings::DescribeGlobalTableSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_global_table_settings::DescribeGlobalTableSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_global_table_settings::DescribeGlobalTableSettings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGlobalTableSettings {
                type Output = ::std::result::Result<crate::operation::describe_global_table_settings::DescribeGlobalTableSettingsOutput, crate::operation::describe_global_table_settings::DescribeGlobalTableSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_global_table_settings::de_describe_global_table_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_global_table_settings::DescribeGlobalTableSettingsError {
