...
impl DescribeTimeToLiveInput {
    /// Consumes the builder and constructs an Operation<[`DescribeTimeToLive`](crate::operation::describe_time_to_live::DescribeTimeToLive)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_time_to_live::DescribeTimeToLive, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_time_to_live::DescribeTimeToLiveInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_time_to_live::DescribeTimeToLive::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeTimeToLive {
                type Output = ::std::result::Result<crate::operation::describe_time_to_live::DescribeTimeToLiveOutput, crate::operation::describe_time_to_live::DescribeTimeToLiveError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_time_to_live::de_describe_time_to_live_http_response_with_props(status, headers, body)
                     }
                }
