...
impl ExportTableToPointInTimeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::export_table_to_point_in_time::ExportTableToPointInTimeInput, ::aws_smithy_http::operation::error::BuildError> {
