...
impl DescribeContributorInsightsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_contributor_insights::DescribeContributorInsightsInput, ::aws_smithy_http::operation::error::BuildError> {
