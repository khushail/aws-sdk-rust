...
impl UpdateContinuousBackupsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateContinuousBackups`](crate::operation::update_continuous_backups::UpdateContinuousBackups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_continuous_backups::UpdateContinuousBackups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_continuous_backups::UpdateContinuousBackupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_continuous_backups::UpdateContinuousBackups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateContinuousBackups {
                type Output = ::std::result::Result<crate::operation::update_continuous_backups::UpdateContinuousBackupsOutput, crate::operation::update_continuous_backups::UpdateContinuousBackupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_update_continuous_backups::de_update_continuous_backups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_continuous_backups::UpdateContinuousBackupsError {
