...
impl RestoreTableToPointInTimeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_table_to_point_in_time::RestoreTableToPointInTimeInput, ::aws_smithy_http::operation::error::BuildError> {
