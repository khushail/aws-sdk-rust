...
impl DescribeContinuousBackupsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_continuous_backups::DescribeContinuousBackupsInput, ::aws_smithy_http::operation::error::BuildError> {
