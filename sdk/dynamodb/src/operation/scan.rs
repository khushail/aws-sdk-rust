...
impl ScanInput {
    /// Consumes the builder and constructs an Operation<[`Scan`](crate::operation::scan::Scan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::scan::Scan, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::scan::ScanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::scan::Scan::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for Scan {
                type Output = ::std::result::Result<crate::operation::scan::ScanOutput, crate::operation::scan::ScanError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_scan::de_scan_http_response_with_props(status, headers, body)
                     }
                }
