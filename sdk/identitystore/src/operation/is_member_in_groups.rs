...
impl IsMemberInGroupsInput {
    /// Consumes the builder and constructs an Operation<[`IsMemberInGroups`](crate::operation::is_member_in_groups::IsMemberInGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::is_member_in_groups::IsMemberInGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::is_member_in_groups::IsMemberInGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_is_member_in_groups::ser_is_member_in_groups_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::is_member_in_groups::IsMemberInGroups::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("IsMemberInGroups", "identitystore"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `IsMemberInGroups`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for IsMemberInGroups {
                type Output = ::std::result::Result<crate::operation::is_member_in_groups::IsMemberInGroupsOutput, crate::operation::is_member_in_groups::IsMemberInGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_is_member_in_groups::de_is_member_in_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_is_member_in_groups::de_is_member_in_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::is_member_in_groups::IsMemberInGroupsError {
...
mod _is_member_in_groups_output;
