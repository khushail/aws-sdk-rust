...
impl super::Client  {
    ...
    ///   - [`identity_store_id(impl ::std::convert::Into<String>)`](crate::operation::get_group_membership_id::builders::GetGroupMembershipIdFluentBuilder::identity_store_id) / [`set_identity_store_id(Option<String>)`](crate::operation::get_group_membership_id::builders::GetGroupMembershipIdFluentBuilder::set_identity_store_id): <p>The globally unique identifier for the identity store.</p>
    ///   - [`group_id(impl ::std::convert::Into<String>)`](crate::operation::get_group_membership_id::builders::GetGroupMembershipIdFluentBuilder::group_id) / [`set_group_id(Option<String>)`](crate::operation::get_group_membership_id::builders::GetGroupMembershipIdFluentBuilder::set_group_id): <p>The identifier for a group in the identity store.</p>
