...
impl DescribeMountTargetsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMountTargets`](crate::operation::describe_mount_targets::DescribeMountTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_mount_targets::DescribeMountTargets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_mount_targets::DescribeMountTargetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2015-02-01/mount-targets").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_mount_targets::DescribeMountTargetsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_mount_targets::DescribeMountTargetsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_mount_targets::DescribeMountTargets::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeMountTargets", "efs"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeMountTargets`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMountTargets {
                type Output = ::std::result::Result<crate::operation::describe_mount_targets::DescribeMountTargetsOutput, crate::operation::describe_mount_targets::DescribeMountTargetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_mount_targets::de_describe_mount_targets_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_mount_targets::de_describe_mount_targets_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_mount_targets::DescribeMountTargetsError {
...
mod _describe_mount_targets_output;
