...
impl PutBackupPolicyInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_backup_policy::PutBackupPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_backup_policy::PutBackupPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `PutBackupPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutBackupPolicy {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_backup_policy::de_put_backup_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_backup_policy::de_put_backup_policy_http_response_with_props(status, headers, body)
                     }
                }
