...
impl ModifyMountTargetSecurityGroupsInput {
    /// Consumes the builder and constructs an Operation<[`ModifyMountTargetSecurityGroups`](crate::operation::modify_mount_target_security_groups::ModifyMountTargetSecurityGroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_mount_target_security_groups::ModifyMountTargetSecurityGroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_mount_target_security_groups::ModifyMountTargetSecurityGroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if mount_target_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("mount_target_id", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_mount_target_security_groups::ModifyMountTargetSecurityGroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyMountTargetSecurityGroups {
                type Output = ::std::result::Result<crate::operation::modify_mount_target_security_groups::ModifyMountTargetSecurityGroupsOutput, crate::operation::modify_mount_target_security_groups::ModifyMountTargetSecurityGroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_modify_mount_target_security_groups::de_modify_mount_target_security_groups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_mount_target_security_groups::de_modify_mount_target_security_groups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_mount_target_security_groups::ModifyMountTargetSecurityGroupsError {
...
mod _modify_mount_target_security_groups_output;
