...
impl DescribeReplicationConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReplicationConfigurations`](crate::operation::describe_replication_configurations::DescribeReplicationConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_replication_configurations::DescribeReplicationConfigurations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/2015-02-01/file-systems/replication-configurations").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_replication_configurations::DescribeReplicationConfigurations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeReplicationConfigurations", "efs"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeReplicationConfigurations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReplicationConfigurations {
                type Output = ::std::result::Result<crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsOutput, crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_replication_configurations::de_describe_replication_configurations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_replication_configurations::de_describe_replication_configurations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_replication_configurations::DescribeReplicationConfigurationsError {
...
pub use crate::operation::describe_replication_configurations::_describe_replication_configurations_output::DescribeReplicationConfigurationsOutput;

pub use crate::operation::describe_replication_configurations::_describe_replication_configurations_input::DescribeReplicationConfigurationsInput;

mod _describe_replication_configurations_input;

mod _describe_replication_configurations_output;
