...
impl DescribeLifecycleConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_lifecycle_configuration::DescribeLifecycleConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
