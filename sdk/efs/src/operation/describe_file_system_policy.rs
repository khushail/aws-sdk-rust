...
impl DescribeFileSystemPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFileSystemPolicy`](crate::operation::describe_file_system_policy::DescribeFileSystemPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_file_system_policy::DescribeFileSystemPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_file_system_policy::DescribeFileSystemPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if file_system_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("file_system_id", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_file_system_policy::DescribeFileSystemPolicyInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_file_system_policy::DescribeFileSystemPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeFileSystemPolicy", "efs"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeFileSystemPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFileSystemPolicy {
                type Output = ::std::result::Result<crate::operation::describe_file_system_policy::DescribeFileSystemPolicyOutput, crate::operation::describe_file_system_policy::DescribeFileSystemPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_file_system_policy::de_describe_file_system_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_file_system_policy::de_describe_file_system_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_file_system_policy::DescribeFileSystemPolicyError {
...
mod _describe_file_system_policy_output;
