...
impl PutAccountPreferencesInput {
    /// Consumes the builder and constructs an Operation<[`PutAccountPreferences`](crate::operation::put_account_preferences::PutAccountPreferences)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_account_preferences::PutAccountPreferences, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_account_preferences::PutAccountPreferencesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_account_preferences::PutAccountPreferences::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutAccountPreferences", "efs"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutAccountPreferences`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutAccountPreferences {
                type Output = ::std::result::Result<crate::operation::put_account_preferences::PutAccountPreferencesOutput, crate::operation::put_account_preferences::PutAccountPreferencesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_account_preferences::de_put_account_preferences_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_account_preferences::de_put_account_preferences_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_account_preferences::PutAccountPreferencesError {
...
mod _put_account_preferences_output;
