...
impl ::aws_http::request_id::RequestId for crate::types::error::AccessPointLimitExceeded {
...
impl AccessPointLimitExceededBuilder {
    ...
    pub fn build(self) -> crate::types::error::AccessPointLimitExceeded {
        crate::types::error::AccessPointLimitExceeded {
