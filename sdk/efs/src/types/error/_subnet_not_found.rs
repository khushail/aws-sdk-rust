...
impl ::aws_http::request_id::RequestId for crate::types::error::SubnetNotFound {
...
impl SubnetNotFoundBuilder {
    ...
    pub fn build(self) -> crate::types::error::SubnetNotFound {
        crate::types::error::SubnetNotFound {
