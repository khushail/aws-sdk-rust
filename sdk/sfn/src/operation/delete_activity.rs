...
impl DeleteActivityInput {
    /// Consumes the builder and constructs an Operation<[`DeleteActivity`](crate::operation::delete_activity::DeleteActivity)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_activity::DeleteActivity, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_activity::DeleteActivityInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_activity::ser_delete_activity_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_activity::DeleteActivity::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteActivity", "sfn"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteActivity`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteActivity {
                type Output = ::std::result::Result<crate::operation::delete_activity::DeleteActivityOutput, crate::operation::delete_activity::DeleteActivityError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_activity::de_delete_activity_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_activity::de_delete_activity_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_activity::DeleteActivityError {
...
pub use crate::operation::delete_activity::_delete_activity_output::DeleteActivityOutput;

pub use crate::operation::delete_activity::_delete_activity_input::DeleteActivityInput;

mod _delete_activity_input;

mod _delete_activity_output;
