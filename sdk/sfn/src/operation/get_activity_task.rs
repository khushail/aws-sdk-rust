...
impl GetActivityTaskInput {
    /// Consumes the builder and constructs an Operation<[`GetActivityTask`](crate::operation::get_activity_task::GetActivityTask)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_activity_task::GetActivityTask, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_activity_task::GetActivityTaskInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_activity_task::ser_get_activity_task_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_activity_task::GetActivityTask::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetActivityTask", "sfn"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetActivityTask`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetActivityTask {
                type Output = ::std::result::Result<crate::operation::get_activity_task::GetActivityTaskOutput, crate::operation::get_activity_task::GetActivityTaskError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_activity_task::de_get_activity_task_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_activity_task::de_get_activity_task_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_activity_task::GetActivityTaskError {
...
pub use crate::operation::get_activity_task::_get_activity_task_output::GetActivityTaskOutput;

pub use crate::operation::get_activity_task::_get_activity_task_input::GetActivityTaskInput;

mod _get_activity_task_input;

mod _get_activity_task_output;
