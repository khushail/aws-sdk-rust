...
impl ListMapRunsInput {
    /// Consumes the builder and constructs an Operation<[`ListMapRuns`](crate::operation::list_map_runs::ListMapRuns)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_map_runs::ListMapRuns, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_map_runs::ListMapRunsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_map_runs::ser_list_map_runs_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_map_runs::ListMapRuns::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListMapRuns", "sfn"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListMapRuns`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMapRuns {
                type Output = ::std::result::Result<crate::operation::list_map_runs::ListMapRunsOutput, crate::operation::list_map_runs::ListMapRunsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_map_runs::de_list_map_runs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_map_runs::de_list_map_runs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_map_runs::ListMapRunsError {
