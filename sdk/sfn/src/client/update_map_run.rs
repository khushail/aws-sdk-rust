...
impl super::Client  {
    ...
    ///   - [`map_run_arn(impl ::std::convert::Into<String>)`](crate::operation::update_map_run::builders::UpdateMapRunFluentBuilder::map_run_arn) / [`set_map_run_arn(Option<String>)`](crate::operation::update_map_run::builders::UpdateMapRunFluentBuilder::set_map_run_arn): <p>The Amazon Resource Name (ARN) of a Map Run.</p>
