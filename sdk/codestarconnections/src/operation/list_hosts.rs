...
impl ListHostsInput {
    /// Consumes the builder and constructs an Operation<[`ListHosts`](crate::operation::list_hosts::ListHosts)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_hosts::ListHosts, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_hosts::ListHostsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_hosts::ser_list_hosts_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_hosts::ListHosts::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListHosts", "codestarconnections"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListHosts {
                type Output = ::std::result::Result<crate::operation::list_hosts::ListHostsOutput, crate::operation::list_hosts::ListHostsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_hosts::de_list_hosts_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_hosts::ListHostsError {
