...
impl SetTimeBasedAutoScalingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_time_based_auto_scaling::SetTimeBasedAutoScalingInput, ::aws_smithy_http::operation::error::BuildError> {
