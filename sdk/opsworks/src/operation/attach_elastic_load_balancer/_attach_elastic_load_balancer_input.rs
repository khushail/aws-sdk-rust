...
impl AttachElasticLoadBalancerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::attach_elastic_load_balancer::AttachElasticLoadBalancerInput, ::aws_smithy_http::operation::error::BuildError> {
