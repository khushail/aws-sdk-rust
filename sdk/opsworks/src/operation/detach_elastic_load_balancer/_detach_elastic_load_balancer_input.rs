...
impl DetachElasticLoadBalancerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::detach_elastic_load_balancer::DetachElasticLoadBalancerInput, ::aws_smithy_http::operation::error::BuildError> {
