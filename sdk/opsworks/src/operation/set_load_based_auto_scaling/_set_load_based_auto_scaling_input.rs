...
impl SetLoadBasedAutoScalingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_load_based_auto_scaling::SetLoadBasedAutoScalingInput, ::aws_smithy_http::operation::error::BuildError> {
