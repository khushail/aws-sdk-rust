...
impl DescribeTimeBasedAutoScalingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_time_based_auto_scaling::DescribeTimeBasedAutoScalingInput, ::aws_smithy_http::operation::error::BuildError> {
