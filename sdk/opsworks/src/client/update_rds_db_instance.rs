...
impl super::Client  {
    ...
    ///   - [`rds_db_instance_arn(impl ::std::convert::Into<String>)`](crate::operation::update_rds_db_instance::builders::UpdateRdsDbInstanceFluentBuilder::rds_db_instance_arn) / [`set_rds_db_instance_arn(Option<String>)`](crate::operation::update_rds_db_instance::builders::UpdateRdsDbInstanceFluentBuilder::set_rds_db_instance_arn): <p>The Amazon RDS instance's ARN.</p>
    ///   - [`db_user(impl ::std::convert::Into<String>)`](crate::operation::update_rds_db_instance::builders::UpdateRdsDbInstanceFluentBuilder::db_user) / [`set_db_user(Option<String>)`](crate::operation::update_rds_db_instance::builders::UpdateRdsDbInstanceFluentBuilder::set_db_user): <p>The master user name.</p>
