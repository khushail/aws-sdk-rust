...
impl super::Client  {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::stop_instance::builders::StopInstanceFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::stop_instance::builders::StopInstanceFluentBuilder::set_instance_id): <p>The instance ID.</p>
