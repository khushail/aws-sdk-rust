...
impl PutSinkPolicyInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_sink_policy::PutSinkPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_sink_policy::PutSinkPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/PutSinkPolicy").expect("formatting should succeed");
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutSinkPolicy {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_sink_policy::de_put_sink_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_sink_policy::de_put_sink_policy_http_response_with_props(status, headers, body)
                     }
                }
