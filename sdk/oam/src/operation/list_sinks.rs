...
impl ListSinksInput {
    /// Consumes the builder and constructs an Operation<[`ListSinks`](crate::operation::list_sinks::ListSinks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_sinks::ListSinks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_sinks::ListSinksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/ListSinks").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_sinks::ser_list_sinks_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_sinks::ListSinks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListSinks", "oam"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListSinks`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSinks {
                type Output = ::std::result::Result<crate::operation::list_sinks::ListSinksOutput, crate::operation::list_sinks::ListSinksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_sinks::de_list_sinks_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_sinks::de_list_sinks_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_sinks::ListSinksError {
