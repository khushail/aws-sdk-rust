...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_link_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_link::DeleteLinkOutput, crate::operation::delete_link::DeleteLinkError> {
    Ok({
        #[allow(unused_mut)]
