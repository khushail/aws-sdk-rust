...
pub fn de_create_link_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_link::CreateLinkOutput, crate::operation::create_link::CreateLinkError> {
    ...
    Err(match error_code {
        ...
        "InternalServiceFault" => crate::operation::create_link::CreateLinkError::InternalServiceFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidParameterException" => crate::operation::create_link::CreateLinkError::InvalidParameterException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "MissingRequiredParameterException" => crate::operation::create_link::CreateLinkError::MissingRequiredParameterException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_link_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_link::CreateLinkOutput, crate::operation::create_link::CreateLinkError> {
    Ok({
        #[allow(unused_mut)]
