...
impl DeleteClusterPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteClusterPolicy`](crate::operation::delete_cluster_policy::DeleteClusterPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_cluster_policy::DeleteClusterPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_cluster_policy::DeleteClusterPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_cluster_policy::DeleteClusterPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteClusterPolicy", "kafka"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteClusterPolicy {
                type Output = ::std::result::Result<crate::operation::delete_cluster_policy::DeleteClusterPolicyOutput, crate::operation::delete_cluster_policy::DeleteClusterPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_delete_cluster_policy::de_delete_cluster_policy_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteClusterPolicyErrorKind = DeleteClusterPolicyError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteClusterPolicyError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_cluster_policy::DeleteClusterPolicyError {
...
impl DeleteClusterPolicyError {
    /// Creates the `DeleteClusterPolicyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteClusterPolicyError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
