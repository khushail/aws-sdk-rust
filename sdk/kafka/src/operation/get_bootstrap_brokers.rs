...
impl GetBootstrapBrokersInput {
    /// Consumes the builder and constructs an Operation<[`GetBootstrapBrokers`](crate::operation::get_bootstrap_brokers::GetBootstrapBrokers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_bootstrap_brokers::GetBootstrapBrokers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_bootstrap_brokers::GetBootstrapBrokersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/clusters/{ClusterArn}/bootstrap-brokers", ClusterArn = cluster_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_bootstrap_brokers::GetBootstrapBrokersInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_bootstrap_brokers::GetBootstrapBrokers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetBootstrapBrokers", "kafka"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBootstrapBrokers {
                type Output = ::std::result::Result<crate::operation::get_bootstrap_brokers::GetBootstrapBrokersOutput, crate::operation::get_bootstrap_brokers::GetBootstrapBrokersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_bootstrap_brokers::de_get_bootstrap_brokers_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_bootstrap_brokers::GetBootstrapBrokersError {
...
mod _get_bootstrap_brokers_output;
