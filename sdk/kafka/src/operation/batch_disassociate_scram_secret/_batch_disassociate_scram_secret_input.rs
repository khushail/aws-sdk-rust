...
impl BatchDisassociateScramSecretInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::batch_disassociate_scram_secret::BatchDisassociateScramSecretInput, ::aws_smithy_http::operation::error::BuildError> {
