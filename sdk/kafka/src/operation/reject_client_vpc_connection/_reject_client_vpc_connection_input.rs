...
impl RejectClientVpcConnectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::reject_client_vpc_connection::RejectClientVpcConnectionInput, ::aws_smithy_http::operation::error::BuildError> {
