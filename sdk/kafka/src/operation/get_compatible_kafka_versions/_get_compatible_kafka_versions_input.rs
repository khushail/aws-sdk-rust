...
impl GetCompatibleKafkaVersionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_compatible_kafka_versions::GetCompatibleKafkaVersionsInput, ::aws_smithy_http::operation::error::BuildError> {
