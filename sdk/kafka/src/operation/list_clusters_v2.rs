...
impl ListClustersV2Input {
    /// Consumes the builder and constructs an Operation<[`ListClustersV2`](crate::operation::list_clusters_v2::ListClustersV2)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_clusters_v2::ListClustersV2, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_clusters_v2::ListClustersV2Input, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/api/v2/clusters").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_clusters_v2::ListClustersV2Input, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_clusters_v2::ListClustersV2Input,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_clusters_v2::ListClustersV2::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListClustersV2", "kafka"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListClustersV2`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListClustersV2 {
                type Output = ::std::result::Result<crate::operation::list_clusters_v2::ListClustersV2Output, crate::operation::list_clusters_v2::ListClustersV2Error>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_clusters_v2::de_list_clusters_v2_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_clusters_v2::ListClustersV2Error {
...
pub use crate::operation::list_clusters_v2::_list_clusters_v2_output::ListClustersV2Output;

pub use crate::operation::list_clusters_v2::_list_clusters_v2_input::ListClustersV2Input;

mod _list_clusters_v2_input;

mod _list_clusters_v2_output;
