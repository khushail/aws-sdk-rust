...
impl RebootBrokerInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reboot_broker::RebootBroker, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reboot_broker::RebootBrokerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/clusters/{ClusterArn}/reboot-broker", ClusterArn = cluster_arn).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reboot_broker::ser_reboot_broker_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reboot_broker::RebootBroker::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RebootBroker", "kafka"));
