...
impl UpdateClusterKafkaVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_cluster_kafka_version::UpdateClusterKafkaVersionInput, ::aws_smithy_http::operation::error::BuildError> {
