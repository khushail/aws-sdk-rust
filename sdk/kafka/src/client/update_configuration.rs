...
impl super::Client  {
    ...
    ///   - [`arn(impl ::std::convert::Into<String>)`](crate::operation::update_configuration::builders::UpdateConfigurationFluentBuilder::arn) / [`set_arn(Option<String>)`](crate::operation::update_configuration::builders::UpdateConfigurationFluentBuilder::set_arn): <p>The Amazon Resource Name (ARN) of the configuration.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_configuration::builders::UpdateConfigurationFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_configuration::builders::UpdateConfigurationFluentBuilder::set_description): <p>The description of the configuration revision.</p>
