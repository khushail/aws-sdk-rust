...
impl super::Client  {
    ...
    ///   - [`cluster_name_filter(impl ::std::convert::Into<String>)`](crate::operation::list_clusters_v2::builders::ListClustersV2FluentBuilder::cluster_name_filter) / [`set_cluster_name_filter(Option<String>)`](crate::operation::list_clusters_v2::builders::ListClustersV2FluentBuilder::set_cluster_name_filter): <p>Specify a prefix of the names of the clusters that you want to list. The service lists all the clusters whose names start with this prefix.</p>
    ///   - [`cluster_type_filter(impl ::std::convert::Into<String>)`](crate::operation::list_clusters_v2::builders::ListClustersV2FluentBuilder::cluster_type_filter) / [`set_cluster_type_filter(Option<String>)`](crate::operation::list_clusters_v2::builders::ListClustersV2FluentBuilder::set_cluster_type_filter): <p>Specify either PROVISIONED or SERVERLESS.</p>
    ///   - [`max_results(i32)`](crate::operation::list_clusters_v2::builders::ListClustersV2FluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_clusters_v2::builders::ListClustersV2FluentBuilder::set_max_results): <p>The maximum number of results to return in the response. If there are more results, the response includes a NextToken parameter.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_clusters_v2::builders::ListClustersV2FluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_clusters_v2::builders::ListClustersV2FluentBuilder::set_next_token): <p>The paginated results marker. When the result of the operation is truncated, the call returns NextToken in the response. To get the next batch, provide this token in your next request.</p>
