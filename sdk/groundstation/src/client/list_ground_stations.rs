...
impl super::Client  {
    ...
    ///   - [`satellite_id(impl ::std::convert::Into<String>)`](crate::operation::list_ground_stations::builders::ListGroundStationsFluentBuilder::satellite_id) / [`set_satellite_id(Option<String>)`](crate::operation::list_ground_stations::builders::ListGroundStationsFluentBuilder::set_satellite_id): <p>Satellite ID to retrieve on-boarded ground stations.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_ground_stations::builders::ListGroundStationsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_ground_stations::builders::ListGroundStationsFluentBuilder::set_next_token): <p>Next token that can be supplied in the next call to get the next page of ground stations.</p>
