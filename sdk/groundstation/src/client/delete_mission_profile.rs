...
impl super::Client  {
    ...
    ///   - [`mission_profile_id(impl ::std::convert::Into<String>)`](crate::operation::delete_mission_profile::builders::DeleteMissionProfileFluentBuilder::mission_profile_id) / [`set_mission_profile_id(Option<String>)`](crate::operation::delete_mission_profile::builders::DeleteMissionProfileFluentBuilder::set_mission_profile_id): <p>UUID of a mission profile.</p>
