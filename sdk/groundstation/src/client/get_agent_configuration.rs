...
impl super::Client  {
    ...
    ///   - [`agent_id(impl ::std::convert::Into<String>)`](crate::operation::get_agent_configuration::builders::GetAgentConfigurationFluentBuilder::agent_id) / [`set_agent_id(Option<String>)`](crate::operation::get_agent_configuration::builders::GetAgentConfigurationFluentBuilder::set_agent_id): <p>UUID of agent to get configuration information for.</p>
