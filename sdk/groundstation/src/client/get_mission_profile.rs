...
impl super::Client  {
    ...
    ///   - [`mission_profile_id(impl ::std::convert::Into<String>)`](crate::operation::get_mission_profile::builders::GetMissionProfileFluentBuilder::mission_profile_id) / [`set_mission_profile_id(Option<String>)`](crate::operation::get_mission_profile::builders::GetMissionProfileFluentBuilder::set_mission_profile_id): <p>UUID of a mission profile.</p>
