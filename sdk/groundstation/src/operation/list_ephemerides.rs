...
impl ListEphemeridesInput {
    /// Consumes the builder and constructs an Operation<[`ListEphemerides`](crate::operation::list_ephemerides::ListEphemerides)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_ephemerides::ListEphemerides, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_ephemerides::ListEphemeridesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/ephemerides").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_ephemerides::ListEphemeridesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_ephemerides::ListEphemerides::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListEphemerides {
                type Output = ::std::result::Result<crate::operation::list_ephemerides::ListEphemeridesOutput, crate::operation::list_ephemerides::ListEphemeridesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_ephemerides::de_list_ephemerides_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_ephemerides::de_list_ephemerides_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_ephemerides::ListEphemeridesError {
