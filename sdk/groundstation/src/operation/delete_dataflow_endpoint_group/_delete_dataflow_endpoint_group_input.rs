...
impl DeleteDataflowEndpointGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_dataflow_endpoint_group::DeleteDataflowEndpointGroupInput, ::aws_smithy_http::operation::error::BuildError> {
