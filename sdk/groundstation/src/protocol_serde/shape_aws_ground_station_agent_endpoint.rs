...
pub(crate) fn de_aws_ground_station_agent_endpoint<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AwsGroundStationAgentEndpoint>, ::aws_smithy_json::deserialize::error::DeserializeError>
                ...
                match tokens.next().transpose()? {
                    Some(::aws_smithy_json::deserialize::Token::EndObject { .. }) => break,
                        ...
                        match key.to_unescaped()?.as_ref() {
                            ...
                            "egressAddress" => {
                                builder = builder.set_egress_address(
                            ...
                            "auditResults" => {
                                builder = builder.set_audit_results(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::AuditResults::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
