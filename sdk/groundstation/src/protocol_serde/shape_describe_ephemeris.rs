...
pub fn de_describe_ephemeris_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_ephemeris::DescribeEphemerisOutput, crate::operation::describe_ephemeris::DescribeEphemerisError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_ephemeris::DescribeEphemerisError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_ephemeris_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_ephemeris::DescribeEphemerisOutput, crate::operation::describe_ephemeris::DescribeEphemerisError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::describe_ephemeris::builders::DescribeEphemerisOutputBuilder::default();
        output = crate::protocol_serde::shape_describe_ephemeris::de_describe_ephemeris(_response_body, output).map_err(crate::operation::describe_ephemeris::DescribeEphemerisError::unhandled)?;
