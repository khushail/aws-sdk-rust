...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_sql_injection_match_set::builders::CreateSqlInjectionMatchSetFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_sql_injection_match_set::builders::CreateSqlInjectionMatchSetFluentBuilder::set_name): <p>A friendly name or description for the <code>SqlInjectionMatchSet</code> that you're creating. You can't change <code>Name</code> after you create the <code>SqlInjectionMatchSet</code>.</p>
    ///   - [`change_token(impl ::std::convert::Into<String>)`](crate::operation::create_sql_injection_match_set::builders::CreateSqlInjectionMatchSetFluentBuilder::change_token) / [`set_change_token(Option<String>)`](crate::operation::create_sql_injection_match_set::builders::CreateSqlInjectionMatchSetFluentBuilder::set_change_token): <p>The value returned by the most recent call to <code>GetChangeToken</code>.</p>
