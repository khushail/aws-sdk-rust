...
impl super::Client  {
    ...
    ///   - [`rule_group_id(impl ::std::convert::Into<String>)`](crate::operation::update_rule_group::builders::UpdateRuleGroupFluentBuilder::rule_group_id) / [`set_rule_group_id(Option<String>)`](crate::operation::update_rule_group::builders::UpdateRuleGroupFluentBuilder::set_rule_group_id): <p>The <code>RuleGroupId</code> of the <code>RuleGroup</code> that you want to update. <code>RuleGroupId</code> is returned by <code>CreateRuleGroup</code> and by <code>ListRuleGroups</code>.</p>
