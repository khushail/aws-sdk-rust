...
impl DeleteInferenceSchedulerInput {
    /// Consumes the builder and constructs an Operation<[`DeleteInferenceScheduler`](crate::operation::delete_inference_scheduler::DeleteInferenceScheduler)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_inference_scheduler::DeleteInferenceScheduler, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_inference_scheduler::DeleteInferenceSchedulerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_inference_scheduler::DeleteInferenceScheduler::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteInferenceScheduler", "lookoutequipment"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteInferenceScheduler`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteInferenceScheduler {
                type Output = ::std::result::Result<crate::operation::delete_inference_scheduler::DeleteInferenceSchedulerOutput, crate::operation::delete_inference_scheduler::DeleteInferenceSchedulerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_inference_scheduler::de_delete_inference_scheduler_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_inference_scheduler::de_delete_inference_scheduler_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_inference_scheduler::DeleteInferenceSchedulerError {
...
mod _delete_inference_scheduler_output;
