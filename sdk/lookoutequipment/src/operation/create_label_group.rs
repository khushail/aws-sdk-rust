...
impl CreateLabelGroupInput {
    /// Consumes the builder and constructs an Operation<[`CreateLabelGroup`](crate::operation::create_label_group::CreateLabelGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_label_group::CreateLabelGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_label_group::CreateLabelGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_label_group::CreateLabelGroupInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_label_group::CreateLabelGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLabelGroup {
                type Output = ::std::result::Result<crate::operation::create_label_group::CreateLabelGroupOutput, crate::operation::create_label_group::CreateLabelGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_label_group::de_create_label_group_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_label_group::CreateLabelGroupError {
...
mod _create_label_group_output;
