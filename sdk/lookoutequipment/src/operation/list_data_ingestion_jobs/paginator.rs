...
/// Paginator for [`ListDataIngestionJobs`](crate::operation::list_data_ingestion_jobs::ListDataIngestionJobs)
            ...
            impl ListDataIngestionJobsPaginator  {
                ...
                pub(crate) fn new(handle: std::sync::Arc<crate::client::Handle>, builder: crate::operation::list_data_ingestion_jobs::builders::ListDataIngestionJobsInputBuilder) -> Self {
                    Self {
                        handle,
                        builder,
                ...
                pub fn send(self) -> impl ::tokio_stream::Stream<Item = ::std::result::Result<crate::operation::list_data_ingestion_jobs::ListDataIngestionJobsOutput, ::aws_smithy_http::result::SdkError<crate::operation::list_data_ingestion_jobs::ListDataIngestionJobsError>>> + ::std::marker::Unpin
                 {
