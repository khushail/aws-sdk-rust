...
impl UpdateLabelGroupInput {
    /// Consumes the builder and constructs an Operation<[`UpdateLabelGroup`](crate::operation::update_label_group::UpdateLabelGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_label_group::UpdateLabelGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_label_group::UpdateLabelGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_label_group::UpdateLabelGroupInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_label_group::UpdateLabelGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateLabelGroup", "lookoutequipment"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateLabelGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLabelGroup {
                type Output = ::std::result::Result<crate::operation::update_label_group::UpdateLabelGroupOutput, crate::operation::update_label_group::UpdateLabelGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_label_group::de_update_label_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_label_group::de_update_label_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_label_group::UpdateLabelGroupError {
...
mod _update_label_group_output;
