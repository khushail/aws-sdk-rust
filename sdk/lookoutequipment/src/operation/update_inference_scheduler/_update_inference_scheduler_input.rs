...
impl UpdateInferenceSchedulerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_inference_scheduler::UpdateInferenceSchedulerInput, ::aws_smithy_http::operation::error::BuildError> {
