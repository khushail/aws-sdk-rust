...
impl ListSensorStatisticsInput {
    /// Consumes the builder and constructs an Operation<[`ListSensorStatistics`](crate::operation::list_sensor_statistics::ListSensorStatistics)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_sensor_statistics::ListSensorStatistics, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_sensor_statistics::ListSensorStatisticsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_sensor_statistics::ListSensorStatistics::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListSensorStatistics {
                type Output = ::std::result::Result<crate::operation::list_sensor_statistics::ListSensorStatisticsOutput, crate::operation::list_sensor_statistics::ListSensorStatisticsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_sensor_statistics::de_list_sensor_statistics_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_sensor_statistics::de_list_sensor_statistics_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_sensor_statistics::ListSensorStatisticsError {
...
mod _list_sensor_statistics_output;
