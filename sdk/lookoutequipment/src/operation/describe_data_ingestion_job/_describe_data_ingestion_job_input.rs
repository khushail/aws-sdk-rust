...
impl DescribeDataIngestionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_data_ingestion_job::DescribeDataIngestionJobInput, ::aws_smithy_http::operation::error::BuildError> {
