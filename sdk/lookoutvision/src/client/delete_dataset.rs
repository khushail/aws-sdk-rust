...
impl super::Client  {
    ...
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::set_project_name): <p>The name of the project that contains the dataset that you want to delete.</p>
    ///   - [`dataset_type(impl ::std::convert::Into<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::dataset_type) / [`set_dataset_type(Option<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::set_dataset_type): <p>The type of the dataset to delete. Specify <code>train</code> to delete the training dataset. Specify <code>test</code> to delete the test dataset. To delete the dataset in a single dataset project, specify <code>train</code>.</p>
