...
impl super::Client  {
    ...
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::describe_model::builders::DescribeModelFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::describe_model::builders::DescribeModelFluentBuilder::set_project_name): <p>The project that contains the version of a model that you want to describe.</p>
    ///   - [`model_version(impl ::std::convert::Into<String>)`](crate::operation::describe_model::builders::DescribeModelFluentBuilder::model_version) / [`set_model_version(Option<String>)`](crate::operation::describe_model::builders::DescribeModelFluentBuilder::set_model_version): <p>The version of the model that you want to describe.</p>
