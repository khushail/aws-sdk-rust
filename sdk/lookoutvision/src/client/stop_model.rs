...
impl super::Client  {
    ...
    ///   - [`project_name(impl ::std::convert::Into<String>)`](crate::operation::stop_model::builders::StopModelFluentBuilder::project_name) / [`set_project_name(Option<String>)`](crate::operation::stop_model::builders::StopModelFluentBuilder::set_project_name): <p>The name of the project that contains the model that you want to stop.</p>
    ///   - [`model_version(impl ::std::convert::Into<String>)`](crate::operation::stop_model::builders::StopModelFluentBuilder::model_version) / [`set_model_version(Option<String>)`](crate::operation::stop_model::builders::StopModelFluentBuilder::set_model_version): <p>The version of the model that you want to stop.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::stop_model::builders::StopModelFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::stop_model::builders::StopModelFluentBuilder::set_client_token): <p>ClientToken is an idempotency token that ensures a call to <code>StopModel</code> completes only once. You choose the value to pass. For example, An issue might prevent you from getting a response from <code>StopModel</code>. In this case, safely retry your call to <code>StopModel</code> by using the same <code>ClientToken</code> parameter value.</p>  <p>If you don't supply a value for <code>ClientToken</code>, the AWS SDK you are using inserts a value for you. This prevents retries after a network error from making multiple stop requests. You'll need to provide your own value for other use cases. </p>  <p>An error occurs if the other input parameters are not the same as in the first request. Using a different value for <code>ClientToken</code> is considered a new call to <code>StopModel</code>. An idempotency token is active for 8 hours. </p>
