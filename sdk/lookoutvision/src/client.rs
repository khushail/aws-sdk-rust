...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_lookoutvision::Error> {
/// # let client: aws_sdk_lookoutvision::Client = unimplemented!();
...
mod describe_model_packaging_job;
