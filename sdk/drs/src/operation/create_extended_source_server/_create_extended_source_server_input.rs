...
impl CreateExtendedSourceServerInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_extended_source_server::CreateExtendedSourceServerInput, ::aws_smithy_http::operation::error::BuildError> {
