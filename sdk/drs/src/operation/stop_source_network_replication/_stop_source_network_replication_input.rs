...
impl StopSourceNetworkReplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::stop_source_network_replication::StopSourceNetworkReplicationInput, ::aws_smithy_http::operation::error::BuildError> {
