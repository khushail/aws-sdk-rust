...
impl AssociateSourceNetworkStackInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_source_network_stack::AssociateSourceNetworkStackInput, ::aws_smithy_http::operation::error::BuildError> {
