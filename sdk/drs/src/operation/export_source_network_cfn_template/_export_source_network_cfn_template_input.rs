...
impl ExportSourceNetworkCfnTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::export_source_network_cfn_template::ExportSourceNetworkCfnTemplateInput, ::aws_smithy_http::operation::error::BuildError> {
