...
impl TerminateRecoveryInstancesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::terminate_recovery_instances::TerminateRecoveryInstancesInput, ::aws_smithy_http::operation::error::BuildError> {
