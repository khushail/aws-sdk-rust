...
impl DescribeRecoverySnapshotsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_recovery_snapshots::DescribeRecoverySnapshotsInput, ::aws_smithy_http::operation::error::BuildError> {
