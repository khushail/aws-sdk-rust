...
impl StartSourceNetworkReplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_source_network_replication::StartSourceNetworkReplicationInput, ::aws_smithy_http::operation::error::BuildError> {
