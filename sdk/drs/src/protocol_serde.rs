...
pub(crate) mod shape_create_source_network;
...
pub(crate) mod shape_delete_source_network;
...
pub(crate) mod shape_describe_source_networks;
...
pub(crate) mod shape_export_source_network_cfn_template;
...
pub(crate) mod shape_start_source_network_recovery;

pub(crate) mod shape_start_source_network_replication;

pub(crate) mod shape_stop_failback;

pub(crate) mod shape_stop_replication;

pub(crate) mod shape_stop_source_network_replication;
...
pub(crate) mod shape_create_source_network_input;
...
pub(crate) mod shape_delete_source_network_input;
...
pub(crate) mod shape_describe_source_networks_input;
...
pub(crate) mod shape_export_source_network_cfn_template_input;
...
pub(crate) mod shape_start_source_network_recovery_input;

pub(crate) mod shape_start_source_network_replication_input;

pub(crate) mod shape_stop_failback_input;

pub(crate) mod shape_stop_replication_input;

pub(crate) mod shape_stop_source_network_replication_input;
...
pub(crate) mod shape_describe_source_networks_request_filters;
...
pub(crate) mod shape_source_network;

pub(crate) mod shape_source_networks_list;
...
pub(crate) mod shape_start_source_network_recovery_request_network_entry;
...
pub(crate) mod shape_participating_resources;
...
pub(crate) mod shape_participating_resource;
...
pub(crate) mod shape_event_resource_data;
