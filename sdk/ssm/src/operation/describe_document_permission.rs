...
impl DescribeDocumentPermissionInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDocumentPermission`](crate::operation::describe_document_permission::DescribeDocumentPermission)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_document_permission::DescribeDocumentPermission, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_document_permission::DescribeDocumentPermissionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_document_permission::ser_describe_document_permission_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_document_permission::DescribeDocumentPermission::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDocumentPermission", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeDocumentPermission`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDocumentPermission {
                type Output = ::std::result::Result<crate::operation::describe_document_permission::DescribeDocumentPermissionOutput, crate::operation::describe_document_permission::DescribeDocumentPermissionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_document_permission::de_describe_document_permission_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_document_permission::de_describe_document_permission_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_document_permission::DescribeDocumentPermissionError {
...
mod _describe_document_permission_output;
