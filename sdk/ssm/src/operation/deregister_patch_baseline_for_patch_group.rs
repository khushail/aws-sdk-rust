...
impl DeregisterPatchBaselineForPatchGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterPatchBaselineForPatchGroup`](crate::operation::deregister_patch_baseline_for_patch_group::DeregisterPatchBaselineForPatchGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deregister_patch_baseline_for_patch_group::DeregisterPatchBaselineForPatchGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_patch_baseline_for_patch_group::DeregisterPatchBaselineForPatchGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_patch_baseline_for_patch_group::ser_deregister_patch_baseline_for_patch_group_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_patch_baseline_for_patch_group::DeregisterPatchBaselineForPatchGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeregisterPatchBaselineForPatchGroup", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterPatchBaselineForPatchGroup {
                type Output = ::std::result::Result<crate::operation::deregister_patch_baseline_for_patch_group::DeregisterPatchBaselineForPatchGroupOutput, crate::operation::deregister_patch_baseline_for_patch_group::DeregisterPatchBaselineForPatchGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deregister_patch_baseline_for_patch_group::de_deregister_patch_baseline_for_patch_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deregister_patch_baseline_for_patch_group::de_deregister_patch_baseline_for_patch_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeregisterPatchBaselineForPatchGroupError {
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_patch_baseline_for_patch_group::DeregisterPatchBaselineForPatchGroupError {
...
mod _deregister_patch_baseline_for_patch_group_output;
