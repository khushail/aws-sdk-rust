...
impl UpdatePatchBaselineInput {
    /// Consumes the builder and constructs an Operation<[`UpdatePatchBaseline`](crate::operation::update_patch_baseline::UpdatePatchBaseline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_patch_baseline::UpdatePatchBaseline, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_patch_baseline::UpdatePatchBaselineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_patch_baseline::ser_update_patch_baseline_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_patch_baseline::UpdatePatchBaseline::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdatePatchBaseline", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePatchBaseline {
                type Output = ::std::result::Result<crate::operation::update_patch_baseline::UpdatePatchBaselineOutput, crate::operation::update_patch_baseline::UpdatePatchBaselineError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_patch_baseline::de_update_patch_baseline_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_patch_baseline::de_update_patch_baseline_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_patch_baseline::UpdatePatchBaselineError {
...
mod _update_patch_baseline_output;
