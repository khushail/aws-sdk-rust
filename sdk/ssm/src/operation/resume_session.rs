...
impl ResumeSessionInput {
    /// Consumes the builder and constructs an Operation<[`ResumeSession`](crate::operation::resume_session::ResumeSession)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::resume_session::ResumeSession, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resume_session::ResumeSessionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_resume_session::ser_resume_session_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::resume_session::ResumeSession::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResumeSession", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ResumeSession`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeSession {
                type Output = ::std::result::Result<crate::operation::resume_session::ResumeSessionOutput, crate::operation::resume_session::ResumeSessionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_resume_session::de_resume_session_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_resume_session::de_resume_session_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::resume_session::ResumeSessionError {
