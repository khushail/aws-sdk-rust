...
impl GetInventorySchemaInput {
    /// Consumes the builder and constructs an Operation<[`GetInventorySchema`](crate::operation::get_inventory_schema::GetInventorySchema)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_inventory_schema::GetInventorySchema, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_inventory_schema::GetInventorySchemaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_inventory_schema::ser_get_inventory_schema_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_inventory_schema::GetInventorySchema::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetInventorySchema", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetInventorySchema`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetInventorySchema {
                type Output = ::std::result::Result<crate::operation::get_inventory_schema::GetInventorySchemaOutput, crate::operation::get_inventory_schema::GetInventorySchemaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_inventory_schema::de_get_inventory_schema_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_inventory_schema::GetInventorySchemaError {
...
mod _get_inventory_schema_output;
