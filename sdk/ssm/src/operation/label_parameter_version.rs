...
impl LabelParameterVersionInput {
    /// Consumes the builder and constructs an Operation<[`LabelParameterVersion`](crate::operation::label_parameter_version::LabelParameterVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::label_parameter_version::LabelParameterVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::label_parameter_version::LabelParameterVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_label_parameter_version::ser_label_parameter_version_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::label_parameter_version::LabelParameterVersion::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("LabelParameterVersion", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for LabelParameterVersion {
                type Output = ::std::result::Result<crate::operation::label_parameter_version::LabelParameterVersionOutput, crate::operation::label_parameter_version::LabelParameterVersionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_label_parameter_version::de_label_parameter_version_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_label_parameter_version::de_label_parameter_version_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::label_parameter_version::LabelParameterVersionError {
...
mod _label_parameter_version_output;
