...
impl DescribeInstancePatchStatesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInstancePatchStates`](crate::operation::describe_instance_patch_states::DescribeInstancePatchStates)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_instance_patch_states::DescribeInstancePatchStates, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_instance_patch_states::DescribeInstancePatchStatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_instance_patch_states::DescribeInstancePatchStatesInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_instance_patch_states::ser_describe_instance_patch_states_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_instance_patch_states::DescribeInstancePatchStates::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeInstancePatchStates", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeInstancePatchStates`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInstancePatchStates {
                type Output = ::std::result::Result<crate::operation::describe_instance_patch_states::DescribeInstancePatchStatesOutput, crate::operation::describe_instance_patch_states::DescribeInstancePatchStatesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_instance_patch_states::de_describe_instance_patch_states_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_instance_patch_states::de_describe_instance_patch_states_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_instance_patch_states::DescribeInstancePatchStatesError {
...
pub use crate::operation::describe_instance_patch_states::_describe_instance_patch_states_output::DescribeInstancePatchStatesOutput;

pub use crate::operation::describe_instance_patch_states::_describe_instance_patch_states_input::DescribeInstancePatchStatesInput;

mod _describe_instance_patch_states_input;

mod _describe_instance_patch_states_output;
