...
impl DescribePatchGroupStateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_patch_group_state::DescribePatchGroupStateInput, ::aws_smithy_http::operation::error::BuildError> {
