...
impl RegisterDefaultPatchBaselineInput {
    /// Consumes the builder and constructs an Operation<[`RegisterDefaultPatchBaseline`](crate::operation::register_default_patch_baseline::RegisterDefaultPatchBaseline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::register_default_patch_baseline::RegisterDefaultPatchBaseline, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::register_default_patch_baseline::RegisterDefaultPatchBaselineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_register_default_patch_baseline::ser_register_default_patch_baseline_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::register_default_patch_baseline::RegisterDefaultPatchBaseline::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RegisterDefaultPatchBaseline", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RegisterDefaultPatchBaseline`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RegisterDefaultPatchBaseline {
                type Output = ::std::result::Result<crate::operation::register_default_patch_baseline::RegisterDefaultPatchBaselineOutput, crate::operation::register_default_patch_baseline::RegisterDefaultPatchBaselineError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_register_default_patch_baseline::de_register_default_patch_baseline_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_register_default_patch_baseline::de_register_default_patch_baseline_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::register_default_patch_baseline::RegisterDefaultPatchBaselineError {
...
mod _register_default_patch_baseline_output;
