...
impl GetCommandInvocationInput {
    /// Consumes the builder and constructs an Operation<[`GetCommandInvocation`](crate::operation::get_command_invocation::GetCommandInvocation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_command_invocation::GetCommandInvocation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_command_invocation::GetCommandInvocationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_command_invocation::ser_get_command_invocation_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_command_invocation::GetCommandInvocation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCommandInvocation", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCommandInvocation {
                type Output = ::std::result::Result<crate::operation::get_command_invocation::GetCommandInvocationOutput, crate::operation::get_command_invocation::GetCommandInvocationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_command_invocation::de_get_command_invocation_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_command_invocation::de_get_command_invocation_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_command_invocation::GetCommandInvocationError {
...
mod _get_command_invocation_output;
