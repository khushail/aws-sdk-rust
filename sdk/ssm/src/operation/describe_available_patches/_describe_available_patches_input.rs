...
impl DescribeAvailablePatchesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_available_patches::DescribeAvailablePatchesInput, ::aws_smithy_http::operation::error::BuildError> {
