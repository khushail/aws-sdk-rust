...
impl DescribeMaintenanceWindowExecutionTasksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMaintenanceWindowExecutionTasks`](crate::operation::describe_maintenance_window_execution_tasks::DescribeMaintenanceWindowExecutionTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_maintenance_window_execution_tasks::DescribeMaintenanceWindowExecutionTasks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_maintenance_window_execution_tasks::DescribeMaintenanceWindowExecutionTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_maintenance_window_execution_tasks::ser_describe_maintenance_window_execution_tasks_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_maintenance_window_execution_tasks::DescribeMaintenanceWindowExecutionTasks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeMaintenanceWindowExecutionTasks", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeMaintenanceWindowExecutionTasks`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceWindowExecutionTasks {
                type Output = ::std::result::Result<crate::operation::describe_maintenance_window_execution_tasks::DescribeMaintenanceWindowExecutionTasksOutput, crate::operation::describe_maintenance_window_execution_tasks::DescribeMaintenanceWindowExecutionTasksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_maintenance_window_execution_tasks::de_describe_maintenance_window_execution_tasks_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_maintenance_window_execution_tasks::de_describe_maintenance_window_execution_tasks_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DescribeMaintenanceWindowExecutionTasksErrorKind = DescribeMaintenanceWindowExecutionTasksError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DescribeMaintenanceWindowExecutionTasksError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeMaintenanceWindowExecutionTasksError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_maintenance_window_execution_tasks::DescribeMaintenanceWindowExecutionTasksError {
...
pub use crate::operation::describe_maintenance_window_execution_tasks::_describe_maintenance_window_execution_tasks_output::DescribeMaintenanceWindowExecutionTasksOutput;

pub use crate::operation::describe_maintenance_window_execution_tasks::_describe_maintenance_window_execution_tasks_input::DescribeMaintenanceWindowExecutionTasksInput;

mod _describe_maintenance_window_execution_tasks_input;

mod _describe_maintenance_window_execution_tasks_output;
