...
impl ListResourceComplianceSummariesInput {
    /// Consumes the builder and constructs an Operation<[`ListResourceComplianceSummaries`](crate::operation::list_resource_compliance_summaries::ListResourceComplianceSummaries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_resource_compliance_summaries::ListResourceComplianceSummaries, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_resource_compliance_summaries::ListResourceComplianceSummariesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_resource_compliance_summaries::ser_list_resource_compliance_summaries_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_resource_compliance_summaries::ListResourceComplianceSummaries::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListResourceComplianceSummaries", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListResourceComplianceSummaries`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListResourceComplianceSummaries {
                type Output = ::std::result::Result<crate::operation::list_resource_compliance_summaries::ListResourceComplianceSummariesOutput, crate::operation::list_resource_compliance_summaries::ListResourceComplianceSummariesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_resource_compliance_summaries::de_list_resource_compliance_summaries_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_resource_compliance_summaries::de_list_resource_compliance_summaries_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListResourceComplianceSummariesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_resource_compliance_summaries::ListResourceComplianceSummariesError {
...
mod _list_resource_compliance_summaries_output;
