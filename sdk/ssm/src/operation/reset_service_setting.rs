...
impl ResetServiceSettingInput {
    /// Consumes the builder and constructs an Operation<[`ResetServiceSetting`](crate::operation::reset_service_setting::ResetServiceSetting)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reset_service_setting::ResetServiceSetting, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_service_setting::ResetServiceSettingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_reset_service_setting::ser_reset_service_setting_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reset_service_setting::ResetServiceSetting::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResetServiceSetting", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ResetServiceSetting`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetServiceSetting {
                type Output = ::std::result::Result<crate::operation::reset_service_setting::ResetServiceSettingOutput, crate::operation::reset_service_setting::ResetServiceSettingError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_reset_service_setting::de_reset_service_setting_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_reset_service_setting::de_reset_service_setting_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_service_setting::ResetServiceSettingError {
...
mod _reset_service_setting_output;
