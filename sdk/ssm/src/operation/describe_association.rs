...
impl DescribeAssociationInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAssociation`](crate::operation::describe_association::DescribeAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_association::DescribeAssociation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_association::DescribeAssociationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_association::ser_describe_association_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_association::DescribeAssociation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAssociation", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeAssociation`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAssociation {
                type Output = ::std::result::Result<crate::operation::describe_association::DescribeAssociationOutput, crate::operation::describe_association::DescribeAssociationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_association::de_describe_association_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_association::de_describe_association_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_association::DescribeAssociationError {
...
mod _describe_association_output;
