...
impl GetParametersInput {
    /// Consumes the builder and constructs an Operation<[`GetParameters`](crate::operation::get_parameters::GetParameters)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_parameters::GetParameters, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_parameters::GetParametersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_parameters::ser_get_parameters_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_parameters::GetParameters::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetParameters", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetParameters`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetParameters {
                type Output = ::std::result::Result<crate::operation::get_parameters::GetParametersOutput, crate::operation::get_parameters::GetParametersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_parameters::de_get_parameters_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_parameters::de_get_parameters_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_parameters::GetParametersError {
...
pub use crate::operation::get_parameters::_get_parameters_output::GetParametersOutput;

pub use crate::operation::get_parameters::_get_parameters_input::GetParametersInput;

mod _get_parameters_input;

mod _get_parameters_output;
