...
impl ListInventoryEntriesInput {
    /// Consumes the builder and constructs an Operation<[`ListInventoryEntries`](crate::operation::list_inventory_entries::ListInventoryEntries)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_inventory_entries::ListInventoryEntries, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_inventory_entries::ListInventoryEntriesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_inventory_entries::ser_list_inventory_entries_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_inventory_entries::ListInventoryEntries::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListInventoryEntries", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInventoryEntries {
                type Output = ::std::result::Result<crate::operation::list_inventory_entries::ListInventoryEntriesOutput, crate::operation::list_inventory_entries::ListInventoryEntriesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_inventory_entries::de_list_inventory_entries_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_inventory_entries::de_list_inventory_entries_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_inventory_entries::ListInventoryEntriesError {
...
mod _list_inventory_entries_output;
