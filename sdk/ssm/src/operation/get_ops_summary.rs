...
impl GetOpsSummaryInput {
    /// Consumes the builder and constructs an Operation<[`GetOpsSummary`](crate::operation::get_ops_summary::GetOpsSummary)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_ops_summary::GetOpsSummary, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_ops_summary::GetOpsSummaryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_ops_summary::ser_get_ops_summary_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_ops_summary::GetOpsSummary::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetOpsSummary", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetOpsSummary {
                type Output = ::std::result::Result<crate::operation::get_ops_summary::GetOpsSummaryOutput, crate::operation::get_ops_summary::GetOpsSummaryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_ops_summary::de_get_ops_summary_http_response_with_props(status, headers, body)
                     }
                }
