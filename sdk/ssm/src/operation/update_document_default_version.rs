...
impl UpdateDocumentDefaultVersionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDocumentDefaultVersion`](crate::operation::update_document_default_version::UpdateDocumentDefaultVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_document_default_version::UpdateDocumentDefaultVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_document_default_version::UpdateDocumentDefaultVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_document_default_version::ser_update_document_default_version_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_document_default_version::UpdateDocumentDefaultVersion::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDocumentDefaultVersion", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateDocumentDefaultVersion`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDocumentDefaultVersion {
                type Output = ::std::result::Result<crate::operation::update_document_default_version::UpdateDocumentDefaultVersionOutput, crate::operation::update_document_default_version::UpdateDocumentDefaultVersionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_document_default_version::de_update_document_default_version_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_document_default_version::de_update_document_default_version_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_document_default_version::UpdateDocumentDefaultVersionError {
...
mod _update_document_default_version_output;
