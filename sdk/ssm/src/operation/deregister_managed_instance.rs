...
impl DeregisterManagedInstanceInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterManagedInstance`](crate::operation::deregister_managed_instance::DeregisterManagedInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deregister_managed_instance::DeregisterManagedInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_managed_instance::DeregisterManagedInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_managed_instance::ser_deregister_managed_instance_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_managed_instance::DeregisterManagedInstance::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeregisterManagedInstance", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterManagedInstance {
                type Output = ::std::result::Result<crate::operation::deregister_managed_instance::DeregisterManagedInstanceOutput, crate::operation::deregister_managed_instance::DeregisterManagedInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deregister_managed_instance::de_deregister_managed_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deregister_managed_instance::de_deregister_managed_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_managed_instance::DeregisterManagedInstanceError {
...
mod _deregister_managed_instance_output;
