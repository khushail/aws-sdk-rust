...
impl UpdateManagedInstanceRoleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_managed_instance_role::UpdateManagedInstanceRoleInput, ::aws_smithy_http::operation::error::BuildError> {
