...
impl CreateAssociationInput {
    /// Consumes the builder and constructs an Operation<[`CreateAssociation`](crate::operation::create_association::CreateAssociation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_association::CreateAssociation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_association::CreateAssociationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_association::ser_create_association_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_association::CreateAssociation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAssociation", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAssociation {
                type Output = ::std::result::Result<crate::operation::create_association::CreateAssociationOutput, crate::operation::create_association::CreateAssociationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_association::de_create_association_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_association::CreateAssociationError {
