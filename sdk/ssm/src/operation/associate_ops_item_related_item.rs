...
impl AssociateOpsItemRelatedItemInput {
    /// Consumes the builder and constructs an Operation<[`AssociateOpsItemRelatedItem`](crate::operation::associate_ops_item_related_item::AssociateOpsItemRelatedItem)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_ops_item_related_item::AssociateOpsItemRelatedItem, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_ops_item_related_item::AssociateOpsItemRelatedItemInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_ops_item_related_item::ser_associate_ops_item_related_item_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_ops_item_related_item::AssociateOpsItemRelatedItem::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateOpsItemRelatedItem", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateOpsItemRelatedItem`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateOpsItemRelatedItem {
                type Output = ::std::result::Result<crate::operation::associate_ops_item_related_item::AssociateOpsItemRelatedItemOutput, crate::operation::associate_ops_item_related_item::AssociateOpsItemRelatedItemError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_ops_item_related_item::de_associate_ops_item_related_item_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_ops_item_related_item::de_associate_ops_item_related_item_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_ops_item_related_item::AssociateOpsItemRelatedItemError {
...
pub use crate::operation::associate_ops_item_related_item::_associate_ops_item_related_item_output::AssociateOpsItemRelatedItemOutput;

pub use crate::operation::associate_ops_item_related_item::_associate_ops_item_related_item_input::AssociateOpsItemRelatedItemInput;

mod _associate_ops_item_related_item_input;

mod _associate_ops_item_related_item_output;
