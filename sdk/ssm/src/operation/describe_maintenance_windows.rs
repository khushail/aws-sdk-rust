...
impl DescribeMaintenanceWindowsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMaintenanceWindows`](crate::operation::describe_maintenance_windows::DescribeMaintenanceWindows)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_maintenance_windows::DescribeMaintenanceWindows, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_maintenance_windows::ser_describe_maintenance_windows_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_maintenance_windows::DescribeMaintenanceWindows::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeMaintenanceWindows", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeMaintenanceWindows`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceWindows {
                type Output = ::std::result::Result<crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsOutput, crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_maintenance_windows::de_describe_maintenance_windows_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_maintenance_windows::de_describe_maintenance_windows_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_maintenance_windows::DescribeMaintenanceWindowsError {
...
mod _describe_maintenance_windows_output;
