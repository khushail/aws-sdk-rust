...
impl DescribeAssociationExecutionTargetsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAssociationExecutionTargets`](crate::operation::describe_association_execution_targets::DescribeAssociationExecutionTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_association_execution_targets::DescribeAssociationExecutionTargets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_association_execution_targets::DescribeAssociationExecutionTargetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_association_execution_targets::ser_describe_association_execution_targets_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_association_execution_targets::DescribeAssociationExecutionTargets::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAssociationExecutionTargets", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeAssociationExecutionTargets`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAssociationExecutionTargets {
                type Output = ::std::result::Result<crate::operation::describe_association_execution_targets::DescribeAssociationExecutionTargetsOutput, crate::operation::describe_association_execution_targets::DescribeAssociationExecutionTargetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_association_execution_targets::de_describe_association_execution_targets_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_association_execution_targets::de_describe_association_execution_targets_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeAssociationExecutionTargetsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_association_execution_targets::DescribeAssociationExecutionTargetsError {
...
mod _describe_association_execution_targets_output;
