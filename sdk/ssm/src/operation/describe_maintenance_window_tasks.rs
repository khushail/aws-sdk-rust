...
impl DescribeMaintenanceWindowTasksInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMaintenanceWindowTasks`](crate::operation::describe_maintenance_window_tasks::DescribeMaintenanceWindowTasks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_maintenance_window_tasks::DescribeMaintenanceWindowTasks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_maintenance_window_tasks::DescribeMaintenanceWindowTasksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_maintenance_window_tasks::DescribeMaintenanceWindowTasksInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_maintenance_window_tasks::ser_describe_maintenance_window_tasks_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_maintenance_window_tasks::DescribeMaintenanceWindowTasks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeMaintenanceWindowTasks", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeMaintenanceWindowTasks`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceWindowTasks {
                type Output = ::std::result::Result<crate::operation::describe_maintenance_window_tasks::DescribeMaintenanceWindowTasksOutput, crate::operation::describe_maintenance_window_tasks::DescribeMaintenanceWindowTasksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_maintenance_window_tasks::de_describe_maintenance_window_tasks_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_maintenance_window_tasks::de_describe_maintenance_window_tasks_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeMaintenanceWindowTasksError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_maintenance_window_tasks::DescribeMaintenanceWindowTasksError {
...
pub use crate::operation::describe_maintenance_window_tasks::_describe_maintenance_window_tasks_output::DescribeMaintenanceWindowTasksOutput;

pub use crate::operation::describe_maintenance_window_tasks::_describe_maintenance_window_tasks_input::DescribeMaintenanceWindowTasksInput;

mod _describe_maintenance_window_tasks_input;

mod _describe_maintenance_window_tasks_output;
