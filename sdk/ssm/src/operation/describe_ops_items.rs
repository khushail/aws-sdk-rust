...
impl DescribeOpsItemsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeOpsItems`](crate::operation::describe_ops_items::DescribeOpsItems)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_ops_items::DescribeOpsItems, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_ops_items::DescribeOpsItemsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_ops_items::ser_describe_ops_items_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_ops_items::DescribeOpsItems::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeOpsItems", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeOpsItems {
                type Output = ::std::result::Result<crate::operation::describe_ops_items::DescribeOpsItemsOutput, crate::operation::describe_ops_items::DescribeOpsItemsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_ops_items::de_describe_ops_items_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_ops_items::de_describe_ops_items_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_ops_items::DescribeOpsItemsError {
...
pub use crate::operation::describe_ops_items::_describe_ops_items_output::DescribeOpsItemsOutput;

pub use crate::operation::describe_ops_items::_describe_ops_items_input::DescribeOpsItemsInput;

mod _describe_ops_items_input;

mod _describe_ops_items_output;
