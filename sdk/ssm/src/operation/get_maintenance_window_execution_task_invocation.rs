...
impl GetMaintenanceWindowExecutionTaskInvocationInput {
    /// Consumes the builder and constructs an Operation<[`GetMaintenanceWindowExecutionTaskInvocation`](crate::operation::get_maintenance_window_execution_task_invocation::GetMaintenanceWindowExecutionTaskInvocation)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_maintenance_window_execution_task_invocation::GetMaintenanceWindowExecutionTaskInvocation, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_maintenance_window_execution_task_invocation::GetMaintenanceWindowExecutionTaskInvocationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_maintenance_window_execution_task_invocation::ser_get_maintenance_window_execution_task_invocation_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_maintenance_window_execution_task_invocation::GetMaintenanceWindowExecutionTaskInvocation::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetMaintenanceWindowExecutionTaskInvocation", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetMaintenanceWindowExecutionTaskInvocation`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMaintenanceWindowExecutionTaskInvocation {
                type Output = ::std::result::Result<crate::operation::get_maintenance_window_execution_task_invocation::GetMaintenanceWindowExecutionTaskInvocationOutput, crate::operation::get_maintenance_window_execution_task_invocation::GetMaintenanceWindowExecutionTaskInvocationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_maintenance_window_execution_task_invocation::de_get_maintenance_window_execution_task_invocation_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_maintenance_window_execution_task_invocation::de_get_maintenance_window_execution_task_invocation_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetMaintenanceWindowExecutionTaskInvocationErrorKind = GetMaintenanceWindowExecutionTaskInvocationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetMaintenanceWindowExecutionTaskInvocationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetMaintenanceWindowExecutionTaskInvocationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_maintenance_window_execution_task_invocation::GetMaintenanceWindowExecutionTaskInvocationError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for GetMaintenanceWindowExecutionTaskInvocationError {
...
mod _get_maintenance_window_execution_task_invocation_output;
