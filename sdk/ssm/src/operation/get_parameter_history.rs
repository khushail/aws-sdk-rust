...
impl GetParameterHistoryInput {
    /// Consumes the builder and constructs an Operation<[`GetParameterHistory`](crate::operation::get_parameter_history::GetParameterHistory)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_parameter_history::GetParameterHistory, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_parameter_history::GetParameterHistoryInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_parameter_history::ser_get_parameter_history_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_parameter_history::GetParameterHistory::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetParameterHistory", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetParameterHistory {
                type Output = ::std::result::Result<crate::operation::get_parameter_history::GetParameterHistoryOutput, crate::operation::get_parameter_history::GetParameterHistoryError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_parameter_history::de_get_parameter_history_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_parameter_history::GetParameterHistoryError {
