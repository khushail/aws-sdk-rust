...
impl DeleteParameterInput {
    /// Consumes the builder and constructs an Operation<[`DeleteParameter`](crate::operation::delete_parameter::DeleteParameter)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_parameter::DeleteParameter, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_parameter::DeleteParameterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_parameter::ser_delete_parameter_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_parameter::DeleteParameter::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteParameter", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteParameter {
                type Output = ::std::result::Result<crate::operation::delete_parameter::DeleteParameterOutput, crate::operation::delete_parameter::DeleteParameterError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_parameter::de_delete_parameter_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_parameter::de_delete_parameter_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_parameter::DeleteParameterError {
