...
impl DescribeAutomationExecutionsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_automation_executions::DescribeAutomationExecutionsInput, ::aws_smithy_http::operation::error::BuildError> {
