...
impl GetPatchBaselineForPatchGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_patch_baseline_for_patch_group::GetPatchBaselineForPatchGroupInput, ::aws_smithy_http::operation::error::BuildError> {
