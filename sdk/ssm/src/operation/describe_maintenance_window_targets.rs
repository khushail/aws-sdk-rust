...
impl DescribeMaintenanceWindowTargetsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMaintenanceWindowTargets`](crate::operation::describe_maintenance_window_targets::DescribeMaintenanceWindowTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_maintenance_window_targets::DescribeMaintenanceWindowTargets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_maintenance_window_targets::DescribeMaintenanceWindowTargetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_maintenance_window_targets::ser_describe_maintenance_window_targets_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_maintenance_window_targets::DescribeMaintenanceWindowTargets::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeMaintenanceWindowTargets", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeMaintenanceWindowTargets`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceWindowTargets {
                type Output = ::std::result::Result<crate::operation::describe_maintenance_window_targets::DescribeMaintenanceWindowTargetsOutput, crate::operation::describe_maintenance_window_targets::DescribeMaintenanceWindowTargetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_maintenance_window_targets::de_describe_maintenance_window_targets_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_maintenance_window_targets::de_describe_maintenance_window_targets_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeMaintenanceWindowTargetsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_maintenance_window_targets::DescribeMaintenanceWindowTargetsError {
...
mod _describe_maintenance_window_targets_output;
