...
impl GetMaintenanceWindowInput {
    /// Consumes the builder and constructs an Operation<[`GetMaintenanceWindow`](crate::operation::get_maintenance_window::GetMaintenanceWindow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_maintenance_window::GetMaintenanceWindow, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_maintenance_window::GetMaintenanceWindowInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_maintenance_window::ser_get_maintenance_window_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_maintenance_window::GetMaintenanceWindow::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetMaintenanceWindow", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMaintenanceWindow {
                type Output = ::std::result::Result<crate::operation::get_maintenance_window::GetMaintenanceWindowOutput, crate::operation::get_maintenance_window::GetMaintenanceWindowError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_maintenance_window::de_get_maintenance_window_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_maintenance_window::de_get_maintenance_window_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_maintenance_window::GetMaintenanceWindowError {
...
mod _get_maintenance_window_output;
