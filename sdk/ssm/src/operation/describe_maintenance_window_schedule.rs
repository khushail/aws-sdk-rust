...
impl DescribeMaintenanceWindowScheduleInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMaintenanceWindowSchedule`](crate::operation::describe_maintenance_window_schedule::DescribeMaintenanceWindowSchedule)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_maintenance_window_schedule::DescribeMaintenanceWindowSchedule, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_maintenance_window_schedule::DescribeMaintenanceWindowScheduleInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_maintenance_window_schedule::ser_describe_maintenance_window_schedule_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_maintenance_window_schedule::DescribeMaintenanceWindowSchedule::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeMaintenanceWindowSchedule", "ssm"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMaintenanceWindowSchedule {
                type Output = ::std::result::Result<crate::operation::describe_maintenance_window_schedule::DescribeMaintenanceWindowScheduleOutput, crate::operation::describe_maintenance_window_schedule::DescribeMaintenanceWindowScheduleError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_maintenance_window_schedule::de_describe_maintenance_window_schedule_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_maintenance_window_schedule::de_describe_maintenance_window_schedule_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeMaintenanceWindowScheduleError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_maintenance_window_schedule::DescribeMaintenanceWindowScheduleError {
...
mod _describe_maintenance_window_schedule_output;
