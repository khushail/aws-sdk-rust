...
impl ListComplianceItemsInput {
    /// Consumes the builder and constructs an Operation<[`ListComplianceItems`](crate::operation::list_compliance_items::ListComplianceItems)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_compliance_items::ListComplianceItems, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_compliance_items::ListComplianceItemsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_compliance_items::ser_list_compliance_items_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_compliance_items::ListComplianceItems::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListComplianceItems", "ssm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListComplianceItems`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListComplianceItems {
                type Output = ::std::result::Result<crate::operation::list_compliance_items::ListComplianceItemsOutput, crate::operation::list_compliance_items::ListComplianceItemsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_compliance_items::de_list_compliance_items_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_compliance_items::de_list_compliance_items_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_compliance_items::ListComplianceItemsError {
...
mod _list_compliance_items_output;
