...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_document_metadata::builders::UpdateDocumentMetadataFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_document_metadata::builders::UpdateDocumentMetadataFluentBuilder::set_name): <p>The name of the change template for which a version's metadata is to be updated.</p>
    ///   - [`document_version(impl ::std::convert::Into<String>)`](crate::operation::update_document_metadata::builders::UpdateDocumentMetadataFluentBuilder::document_version) / [`set_document_version(Option<String>)`](crate::operation::update_document_metadata::builders::UpdateDocumentMetadataFluentBuilder::set_document_version): <p>The version of a change template in which to update approval metadata.</p>
