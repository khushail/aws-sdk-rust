...
impl super::Client  {
    ...
    ///   - [`sync_name(impl ::std::convert::Into<String>)`](crate::operation::get_ops_summary::builders::GetOpsSummaryFluentBuilder::sync_name) / [`set_sync_name(Option<String>)`](crate::operation::get_ops_summary::builders::GetOpsSummaryFluentBuilder::set_sync_name): <p>Specify the name of a resource data sync to get.</p>
