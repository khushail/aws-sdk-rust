...
impl super::Client  {
    ...
    ///   - [`ops_item_id(impl ::std::convert::Into<String>)`](crate::operation::get_ops_item::builders::GetOpsItemFluentBuilder::ops_item_id) / [`set_ops_item_id(Option<String>)`](crate::operation::get_ops_item::builders::GetOpsItemFluentBuilder::set_ops_item_id): <p>The ID of the OpsItem that you want to get.</p>
    ///   - [`ops_item_arn(impl ::std::convert::Into<String>)`](crate::operation::get_ops_item::builders::GetOpsItemFluentBuilder::ops_item_arn) / [`set_ops_item_arn(Option<String>)`](crate::operation::get_ops_item::builders::GetOpsItemFluentBuilder::set_ops_item_arn): <p>The OpsItem Amazon Resource Name (ARN).</p>
