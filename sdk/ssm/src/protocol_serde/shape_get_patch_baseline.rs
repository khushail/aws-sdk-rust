...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_patch_baseline_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_patch_baseline::GetPatchBaselineOutput, crate::operation::get_patch_baseline::GetPatchBaselineError> {
    Ok({
        #[allow(unused_mut)]
