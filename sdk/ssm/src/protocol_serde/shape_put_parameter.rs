...
pub fn ser_put_parameter_input(input: &crate::operation::put_parameter::PutParameterInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    let mut out = String::new();
    let mut object = ::aws_smithy_json::serialize::JsonObjectWriter::new(&mut out);
    crate::protocol_serde::shape_put_parameter_input::ser_put_parameter_input(&mut object, input)?;
    object.finish();
...
pub fn de_put_parameter_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_parameter::PutParameterOutput, crate::operation::put_parameter::PutParameterError> {
    ...
    let error_code = match generic.code() {
                                Some(code) => code,
                                None => return Err(crate::operation::put_parameter::PutParameterError::unhandled(generic))
                            };
    ...
    Err(match error_code {
        ...
        _ => crate::operation::put_parameter::PutParameterError::generic(generic)
    })
}

#[allow(clippy::unnecessary_wraps)]
pub fn de_put_parameter_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::put_parameter::PutParameterOutput, crate::operation::put_parameter::PutParameterError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_put_parameter(value: &[u8], mut builder: crate::operation::put_parameter::builders::PutParameterOutputBuilder) -> Result<crate::operation::put_parameter::builders::PutParameterOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
