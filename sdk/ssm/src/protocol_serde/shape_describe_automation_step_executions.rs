...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_automation_step_executions_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_automation_step_executions::DescribeAutomationStepExecutionsOutput, crate::operation::describe_automation_step_executions::DescribeAutomationStepExecutionsError> {
    Ok({
        #[allow(unused_mut)]
