...
impl PutContainerPolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutContainerPolicy`](crate::operation::put_container_policy::PutContainerPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_container_policy::PutContainerPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_container_policy::PutContainerPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_container_policy::ser_put_container_policy_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_container_policy::PutContainerPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutContainerPolicy {
                type Output = ::std::result::Result<crate::operation::put_container_policy::PutContainerPolicyOutput, crate::operation::put_container_policy::PutContainerPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_container_policy::de_put_container_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_container_policy::de_put_container_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_container_policy::PutContainerPolicyError {
...
mod _put_container_policy_output;
