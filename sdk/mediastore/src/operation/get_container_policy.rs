...
impl GetContainerPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetContainerPolicy`](crate::operation::get_container_policy::GetContainerPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_container_policy::GetContainerPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_container_policy::GetContainerPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_container_policy::ser_get_container_policy_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_container_policy::GetContainerPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetContainerPolicy {
                type Output = ::std::result::Result<crate::operation::get_container_policy::GetContainerPolicyOutput, crate::operation::get_container_policy::GetContainerPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_container_policy::de_get_container_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_container_policy::de_get_container_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_container_policy::GetContainerPolicyError {
...
mod _get_container_policy_output;
