...
impl GetMetricPolicyInput {
    /// Consumes the builder and constructs an Operation<[`GetMetricPolicy`](crate::operation::get_metric_policy::GetMetricPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_metric_policy::GetMetricPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_metric_policy::GetMetricPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_metric_policy::ser_get_metric_policy_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_metric_policy::GetMetricPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetMetricPolicy {
                type Output = ::std::result::Result<crate::operation::get_metric_policy::GetMetricPolicyOutput, crate::operation::get_metric_policy::GetMetricPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_metric_policy::de_get_metric_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_metric_policy::de_get_metric_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_metric_policy::GetMetricPolicyError {
...
pub use crate::operation::get_metric_policy::_get_metric_policy_output::GetMetricPolicyOutput;

pub use crate::operation::get_metric_policy::_get_metric_policy_input::GetMetricPolicyInput;

mod _get_metric_policy_input;

mod _get_metric_policy_output;
