...
impl PutCorsPolicyInput {
    /// Consumes the builder and constructs an Operation<[`PutCorsPolicy`](crate::operation::put_cors_policy::PutCorsPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_cors_policy::PutCorsPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_cors_policy::PutCorsPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_put_cors_policy::ser_put_cors_policy_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_cors_policy::PutCorsPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutCorsPolicy", "mediastore"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutCorsPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutCorsPolicy {
                type Output = ::std::result::Result<crate::operation::put_cors_policy::PutCorsPolicyOutput, crate::operation::put_cors_policy::PutCorsPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_cors_policy::de_put_cors_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_cors_policy::de_put_cors_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_cors_policy::PutCorsPolicyError {
