...
impl ListContainersInput {
    /// Consumes the builder and constructs an Operation<[`ListContainers`](crate::operation::list_containers::ListContainers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_containers::ListContainers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_containers::ListContainersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_containers::ser_list_containers_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_containers::ListContainers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListContainers", "mediastore"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListContainers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListContainers {
                type Output = ::std::result::Result<crate::operation::list_containers::ListContainersOutput, crate::operation::list_containers::ListContainersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_containers::de_list_containers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_containers::de_list_containers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_containers::ListContainersError {
