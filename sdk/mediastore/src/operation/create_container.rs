...
impl CreateContainerInput {
    /// Consumes the builder and constructs an Operation<[`CreateContainer`](crate::operation::create_container::CreateContainer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_container::CreateContainer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_container::CreateContainerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_container::ser_create_container_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_container::CreateContainer::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateContainer", "mediastore"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateContainer`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateContainer {
                type Output = ::std::result::Result<crate::operation::create_container::CreateContainerOutput, crate::operation::create_container::CreateContainerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_container::de_create_container_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_container::de_create_container_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_container::CreateContainerError {
...
pub use crate::operation::create_container::_create_container_output::CreateContainerOutput;

pub use crate::operation::create_container::_create_container_input::CreateContainerInput;

mod _create_container_input;

mod _create_container_output;
