...
impl super::Client  {
    ...
    ///   - [`resource(impl ::std::convert::Into<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::resource) / [`set_resource(Option<String>)`](crate::operation::list_tags_for_resource::builders::ListTagsForResourceFluentBuilder::set_resource): <p>The Amazon Resource Name (ARN) for the container.</p>
