...
impl super::Client  {
    ...
    ///   - [`resource(impl ::std::convert::Into<String>)`](crate::operation::untag_resource::builders::UntagResourceFluentBuilder::resource) / [`set_resource(Option<String>)`](crate::operation::untag_resource::builders::UntagResourceFluentBuilder::set_resource): <p>The Amazon Resource Name (ARN) for the container.</p>
