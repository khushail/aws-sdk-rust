...
impl super::Client  {
    ...
    ///   - [`collaboration_identifier(impl ::std::convert::Into<String>)`](crate::operation::list_members::builders::ListMembersFluentBuilder::collaboration_identifier) / [`set_collaboration_identifier(Option<String>)`](crate::operation::list_members::builders::ListMembersFluentBuilder::set_collaboration_identifier): <p>The identifier of the collaboration in which the members are listed.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_members::builders::ListMembersFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_members::builders::ListMembersFluentBuilder::set_next_token): <p>The token value retrieved from a previous call to access the next page of results.</p>
