...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_configured_table::builders::CreateConfiguredTableFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_configured_table::builders::CreateConfiguredTableFluentBuilder::set_name): <p>The name of the configured table.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_configured_table::builders::CreateConfiguredTableFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_configured_table::builders::CreateConfiguredTableFluentBuilder::set_description): <p>A description for the configured table.</p>
