...
pub(crate) fn de_schema_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::Schema>>, ::aws_smithy_json::deserialize::error::DeserializeError>
