...
impl super::Client  {
    ...
    ///   - [`cluster_id(impl ::std::convert::Into<String>)`](crate::operation::add_instance_fleet::builders::AddInstanceFleetFluentBuilder::cluster_id) / [`set_cluster_id(Option<String>)`](crate::operation::add_instance_fleet::builders::AddInstanceFleetFluentBuilder::set_cluster_id): <p>The unique identifier of the cluster.</p>
