...
impl super::Client  {
    ...
    ///   - [`marker(impl ::std::convert::Into<String>)`](crate::operation::list_studios::builders::ListStudiosFluentBuilder::marker) / [`set_marker(Option<String>)`](crate::operation::list_studios::builders::ListStudiosFluentBuilder::set_marker): <p>The pagination token that indicates the set of results to retrieve.</p>
