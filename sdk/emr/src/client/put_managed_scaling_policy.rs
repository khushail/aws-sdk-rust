...
impl super::Client  {
    ...
    ///   - [`cluster_id(impl ::std::convert::Into<String>)`](crate::operation::put_managed_scaling_policy::builders::PutManagedScalingPolicyFluentBuilder::cluster_id) / [`set_cluster_id(Option<String>)`](crate::operation::put_managed_scaling_policy::builders::PutManagedScalingPolicyFluentBuilder::set_cluster_id): <p>Specifies the ID of an Amazon EMR cluster where the managed scaling policy is attached. </p>
