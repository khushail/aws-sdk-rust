...
impl ListBootstrapActionsInput {
    /// Consumes the builder and constructs an Operation<[`ListBootstrapActions`](crate::operation::list_bootstrap_actions::ListBootstrapActions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_bootstrap_actions::ListBootstrapActions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_bootstrap_actions::ListBootstrapActionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_bootstrap_actions::ser_list_bootstrap_actions_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_bootstrap_actions::ListBootstrapActions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListBootstrapActions", "emr"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBootstrapActions {
                type Output = ::std::result::Result<crate::operation::list_bootstrap_actions::ListBootstrapActionsOutput, crate::operation::list_bootstrap_actions::ListBootstrapActionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_bootstrap_actions::de_list_bootstrap_actions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_bootstrap_actions::de_list_bootstrap_actions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_bootstrap_actions::ListBootstrapActionsError {
...
mod _list_bootstrap_actions_output;
