...
impl ListNotebookExecutionsInput {
    /// Consumes the builder and constructs an Operation<[`ListNotebookExecutions`](crate::operation::list_notebook_executions::ListNotebookExecutions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_notebook_executions::ListNotebookExecutions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_notebook_executions::ListNotebookExecutionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_notebook_executions::ser_list_notebook_executions_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_notebook_executions::ListNotebookExecutions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListNotebookExecutions", "emr"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListNotebookExecutions {
                type Output = ::std::result::Result<crate::operation::list_notebook_executions::ListNotebookExecutionsOutput, crate::operation::list_notebook_executions::ListNotebookExecutionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_notebook_executions::de_list_notebook_executions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_notebook_executions::de_list_notebook_executions_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_notebook_executions::ListNotebookExecutionsError {
...
mod _list_notebook_executions_output;
