...
impl SetTerminationProtectionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::set_termination_protection::SetTerminationProtectionInput, ::aws_smithy_http::operation::error::BuildError> {
