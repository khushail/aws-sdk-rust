...
impl ListStudioSessionMappingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_studio_session_mappings::ListStudioSessionMappingsInput, ::aws_smithy_http::operation::error::BuildError> {
