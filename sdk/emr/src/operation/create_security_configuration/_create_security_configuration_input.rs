...
impl CreateSecurityConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_security_configuration::CreateSecurityConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
