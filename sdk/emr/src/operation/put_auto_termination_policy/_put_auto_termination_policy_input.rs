...
impl PutAutoTerminationPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_auto_termination_policy::PutAutoTerminationPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
