...
impl GetAutoTerminationPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_auto_termination_policy::GetAutoTerminationPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
