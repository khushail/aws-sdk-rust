...
impl RunJobFlowInput {
    /// Consumes the builder and constructs an Operation<[`RunJobFlow`](crate::operation::run_job_flow::RunJobFlow)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::run_job_flow::RunJobFlow, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::run_job_flow::RunJobFlowInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_run_job_flow::ser_run_job_flow_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::run_job_flow::RunJobFlow::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RunJobFlow", "emr"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RunJobFlow`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RunJobFlow {
                type Output = ::std::result::Result<crate::operation::run_job_flow::RunJobFlowOutput, crate::operation::run_job_flow::RunJobFlowError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_run_job_flow::de_run_job_flow_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_run_job_flow::de_run_job_flow_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::run_job_flow::RunJobFlowError {
