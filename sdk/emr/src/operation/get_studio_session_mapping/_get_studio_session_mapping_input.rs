...
impl GetStudioSessionMappingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_studio_session_mapping::GetStudioSessionMappingInput, ::aws_smithy_http::operation::error::BuildError> {
