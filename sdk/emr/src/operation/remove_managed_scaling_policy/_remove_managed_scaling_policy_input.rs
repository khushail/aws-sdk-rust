...
impl RemoveManagedScalingPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_managed_scaling_policy::RemoveManagedScalingPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
