...
impl GetClusterSessionCredentialsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_cluster_session_credentials::GetClusterSessionCredentialsInput, ::aws_smithy_http::operation::error::BuildError> {
