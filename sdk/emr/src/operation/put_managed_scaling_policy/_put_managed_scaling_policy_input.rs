...
impl PutManagedScalingPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_managed_scaling_policy::PutManagedScalingPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
