...
impl PutBlockPublicAccessConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_block_public_access_configuration::PutBlockPublicAccessConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
