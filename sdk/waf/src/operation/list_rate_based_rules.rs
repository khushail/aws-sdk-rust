...
impl ListRateBasedRulesInput {
    /// Consumes the builder and constructs an Operation<[`ListRateBasedRules`](crate::operation::list_rate_based_rules::ListRateBasedRules)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_rate_based_rules::ListRateBasedRules, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_rate_based_rules::ListRateBasedRulesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_rate_based_rules::ListRateBasedRules::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRateBasedRules {
                type Output = ::std::result::Result<crate::operation::list_rate_based_rules::ListRateBasedRulesOutput, crate::operation::list_rate_based_rules::ListRateBasedRulesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_rate_based_rules::de_list_rate_based_rules_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_rate_based_rules::de_list_rate_based_rules_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_rate_based_rules::ListRateBasedRulesError {
...
mod _list_rate_based_rules_output;
