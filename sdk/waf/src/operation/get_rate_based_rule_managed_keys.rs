...
impl GetRateBasedRuleManagedKeysInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeys, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `GetRateBasedRuleManagedKeys`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetRateBasedRuleManagedKeys {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_rate_based_rule_managed_keys::de_get_rate_based_rule_managed_keys_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_rate_based_rule_managed_keys::de_get_rate_based_rule_managed_keys_http_response_with_props(status, headers, body)
                     }
                }
