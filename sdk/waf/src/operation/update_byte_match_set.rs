...
impl UpdateByteMatchSetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateByteMatchSet`](crate::operation::update_byte_match_set::UpdateByteMatchSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_byte_match_set::UpdateByteMatchSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_byte_match_set::UpdateByteMatchSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_byte_match_set::UpdateByteMatchSet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateByteMatchSet", "waf"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateByteMatchSet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateByteMatchSet {
                type Output = ::std::result::Result<crate::operation::update_byte_match_set::UpdateByteMatchSetOutput, crate::operation::update_byte_match_set::UpdateByteMatchSetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_byte_match_set::de_update_byte_match_set_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_byte_match_set::de_update_byte_match_set_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_byte_match_set::UpdateByteMatchSetError {
...
pub use crate::operation::update_byte_match_set::_update_byte_match_set_output::UpdateByteMatchSetOutput;

pub use crate::operation::update_byte_match_set::_update_byte_match_set_input::UpdateByteMatchSetInput;

mod _update_byte_match_set_input;

mod _update_byte_match_set_output;
