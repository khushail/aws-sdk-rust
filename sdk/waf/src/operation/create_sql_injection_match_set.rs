...
impl CreateSqlInjectionMatchSetInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_sql_injection_match_set::CreateSqlInjectionMatchSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `CreateSqlInjectionMatchSet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSqlInjectionMatchSet {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_sql_injection_match_set::de_create_sql_injection_match_set_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_sql_injection_match_set::de_create_sql_injection_match_set_http_response_with_props(status, headers, body)
                     }
                }
