...
impl CreateWebAclMigrationStackInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_web_acl_migration_stack::CreateWebAclMigrationStackInput, ::aws_smithy_http::operation::error::BuildError> {
