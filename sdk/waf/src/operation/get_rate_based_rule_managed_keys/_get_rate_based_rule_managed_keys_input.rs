...
impl GetRateBasedRuleManagedKeysInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_rate_based_rule_managed_keys::GetRateBasedRuleManagedKeysInput, ::aws_smithy_http::operation::error::BuildError> {
