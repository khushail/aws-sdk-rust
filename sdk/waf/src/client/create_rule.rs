...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_name): <p>A friendly name or description of the <code>Rule</code>. You can't change the name of a <code>Rule</code> after you create it.</p>
    ///   - [`metric_name(impl ::std::convert::Into<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::metric_name) / [`set_metric_name(Option<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_metric_name): <p>A friendly name or description for the metrics for this <code>Rule</code>. The name can contain only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one. It can't contain whitespace or metric names reserved for AWS WAF, including "All" and "Default_Action." You can't change the name of the metric after you create the <code>Rule</code>.</p>
    ///   - [`change_token(impl ::std::convert::Into<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::change_token) / [`set_change_token(Option<String>)`](crate::operation::create_rule::builders::CreateRuleFluentBuilder::set_change_token): <p>The value returned by the most recent call to <code>GetChangeToken</code>.</p>
