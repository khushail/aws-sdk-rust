...
impl super::Client  {
    ...
    ///   - [`rule_id(impl ::std::convert::Into<String>)`](crate::operation::update_rule::builders::UpdateRuleFluentBuilder::rule_id) / [`set_rule_id(Option<String>)`](crate::operation::update_rule::builders::UpdateRuleFluentBuilder::set_rule_id): <p>The <code>RuleId</code> of the <code>Rule</code> that you want to update. <code>RuleId</code> is returned by <code>CreateRule</code> and by <code>ListRules</code>.</p>
    ///   - [`change_token(impl ::std::convert::Into<String>)`](crate::operation::update_rule::builders::UpdateRuleFluentBuilder::change_token) / [`set_change_token(Option<String>)`](crate::operation::update_rule::builders::UpdateRuleFluentBuilder::set_change_token): <p>The value returned by the most recent call to <code>GetChangeToken</code>.</p>
