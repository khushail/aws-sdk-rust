...
impl GetIdentityResolutionJobInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_identity_resolution_job::GetIdentityResolutionJobInput, ::aws_smithy_http::operation::error::BuildError> {
