...
impl GetProfileObjectTypeTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_profile_object_type_template::GetProfileObjectTypeTemplateInput, ::aws_smithy_http::operation::error::BuildError> {
