...
impl ListWorkflowsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_workflows::ListWorkflows, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_workflows::ListWorkflowsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/domains/{DomainName}/workflows", DomainName = domain_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_workflows::ListWorkflowsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_workflows::ListWorkflows::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListWorkflows", "customerprofiles"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListWorkflows {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_workflows::de_list_workflows_http_response_with_props(status, headers, body)
                     }
                }
