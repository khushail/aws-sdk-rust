...
impl super::Client  {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::get_calculated_attribute_for_profile::builders::GetCalculatedAttributeForProfileFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::get_calculated_attribute_for_profile::builders::GetCalculatedAttributeForProfileFluentBuilder::set_domain_name): <p>The unique name of the domain.</p>
    ///   - [`profile_id(impl ::std::convert::Into<String>)`](crate::operation::get_calculated_attribute_for_profile::builders::GetCalculatedAttributeForProfileFluentBuilder::profile_id) / [`set_profile_id(Option<String>)`](crate::operation::get_calculated_attribute_for_profile::builders::GetCalculatedAttributeForProfileFluentBuilder::set_profile_id): <p>The unique identifier of a customer profile.</p>
    ///   - [`calculated_attribute_name(impl ::std::convert::Into<String>)`](crate::operation::get_calculated_attribute_for_profile::builders::GetCalculatedAttributeForProfileFluentBuilder::calculated_attribute_name) / [`set_calculated_attribute_name(Option<String>)`](crate::operation::get_calculated_attribute_for_profile::builders::GetCalculatedAttributeForProfileFluentBuilder::set_calculated_attribute_name): <p>The unique name of the calculated attribute.</p>
