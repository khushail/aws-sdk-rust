...
impl super::Client  {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::delete_calculated_attribute_definition::builders::DeleteCalculatedAttributeDefinitionFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::delete_calculated_attribute_definition::builders::DeleteCalculatedAttributeDefinitionFluentBuilder::set_domain_name): <p>The unique name of the domain.</p>
