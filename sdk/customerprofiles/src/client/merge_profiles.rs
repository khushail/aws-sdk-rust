...
impl super::Client  {
    ...
    ///   - [`domain_name(impl ::std::convert::Into<String>)`](crate::operation::merge_profiles::builders::MergeProfilesFluentBuilder::domain_name) / [`set_domain_name(Option<String>)`](crate::operation::merge_profiles::builders::MergeProfilesFluentBuilder::set_domain_name): <p>The unique name of the domain.</p>
    ///   - [`main_profile_id(impl ::std::convert::Into<String>)`](crate::operation::merge_profiles::builders::MergeProfilesFluentBuilder::main_profile_id) / [`set_main_profile_id(Option<String>)`](crate::operation::merge_profiles::builders::MergeProfilesFluentBuilder::set_main_profile_id): <p>The identifier of the profile to be taken.</p>
