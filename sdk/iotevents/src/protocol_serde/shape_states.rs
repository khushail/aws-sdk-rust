...
pub(crate) fn de_states<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::State>>, ::aws_smithy_json::deserialize::error::DeserializeError>
