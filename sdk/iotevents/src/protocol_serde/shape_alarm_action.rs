...
pub(crate) fn de_alarm_action<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::AlarmAction>, ::aws_smithy_json::deserialize::error::DeserializeError>
