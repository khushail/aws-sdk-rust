...
impl StartDetectorModelAnalysisInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_detector_model_analysis::StartDetectorModelAnalysisInput, ::aws_smithy_http::operation::error::BuildError> {
