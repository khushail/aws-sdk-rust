...
impl UpdateDetectorModelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateDetectorModel`](crate::operation::update_detector_model::UpdateDetectorModel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_detector_model::UpdateDetectorModel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_detector_model::UpdateDetectorModelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_detector_model::ser_update_detector_model_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_detector_model::UpdateDetectorModel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateDetectorModel", "iotevents"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateDetectorModel`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateDetectorModel {
                type Output = ::std::result::Result<crate::operation::update_detector_model::UpdateDetectorModelOutput, crate::operation::update_detector_model::UpdateDetectorModelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_detector_model::de_update_detector_model_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_detector_model::de_update_detector_model_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_detector_model::UpdateDetectorModelError {
...
mod _update_detector_model_output;
