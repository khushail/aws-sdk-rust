...
impl ListInputRoutingsInput {
    /// Consumes the builder and constructs an Operation<[`ListInputRoutings`](crate::operation::list_input_routings::ListInputRoutings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_input_routings::ListInputRoutings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_input_routings::ListInputRoutingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/input-routings").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_input_routings::ser_list_input_routings_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_input_routings::ListInputRoutings::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListInputRoutings {
                type Output = ::std::result::Result<crate::operation::list_input_routings::ListInputRoutingsOutput, crate::operation::list_input_routings::ListInputRoutingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_input_routings::de_list_input_routings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_input_routings::de_list_input_routings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_input_routings::ListInputRoutingsError {
...
mod _list_input_routings_output;
