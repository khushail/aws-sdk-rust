...
impl DescribeDetectorModelAnalysisInput {
    /// Consumes the builder and constructs an Operation<[`DescribeDetectorModelAnalysis`](crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysis)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysis, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/analysis/detector-models/{analysisId}", analysisId = analysis_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysis::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeDetectorModelAnalysis", "iotevents"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeDetectorModelAnalysis`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeDetectorModelAnalysis {
                type Output = ::std::result::Result<crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisOutput, crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_detector_model_analysis::de_describe_detector_model_analysis_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_detector_model_analysis::de_describe_detector_model_analysis_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_detector_model_analysis::DescribeDetectorModelAnalysisError {
...
mod _describe_detector_model_analysis_output;
