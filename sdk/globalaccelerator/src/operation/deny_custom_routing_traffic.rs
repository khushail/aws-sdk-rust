...
impl DenyCustomRoutingTrafficInput {
    /// Consumes the builder and constructs an Operation<[`DenyCustomRoutingTraffic`](crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTraffic)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTraffic, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTraffic::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DenyCustomRoutingTraffic", "globalaccelerator"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DenyCustomRoutingTraffic`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DenyCustomRoutingTraffic {
                type Output = ::std::result::Result<crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficOutput, crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deny_custom_routing_traffic::de_deny_custom_routing_traffic_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deny_custom_routing_traffic::de_deny_custom_routing_traffic_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::deny_custom_routing_traffic::DenyCustomRoutingTrafficError {
...
mod _deny_custom_routing_traffic_output;
