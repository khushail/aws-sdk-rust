...
impl UpdateAcceleratorAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_accelerator_attributes::UpdateAcceleratorAttributesInput, ::aws_smithy_http::operation::error::BuildError> {
