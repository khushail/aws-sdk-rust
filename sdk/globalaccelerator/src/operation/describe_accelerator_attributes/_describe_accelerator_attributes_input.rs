...
impl DescribeAcceleratorAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_accelerator_attributes::DescribeAcceleratorAttributesInput, ::aws_smithy_http::operation::error::BuildError> {
