...
impl DeleteEndpointGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteEndpointGroup`](crate::operation::delete_endpoint_group::DeleteEndpointGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_endpoint_group::DeleteEndpointGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_endpoint_group::DeleteEndpointGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_endpoint_group::DeleteEndpointGroup::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteEndpointGroup {
                type Output = ::std::result::Result<crate::operation::delete_endpoint_group::DeleteEndpointGroupOutput, crate::operation::delete_endpoint_group::DeleteEndpointGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_endpoint_group::de_delete_endpoint_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_endpoint_group::de_delete_endpoint_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_endpoint_group::DeleteEndpointGroupError {
...
mod _delete_endpoint_group_output;
