...
impl UpdateCustomRoutingAcceleratorAttributesInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCustomRoutingAcceleratorAttributes`](crate::operation::update_custom_routing_accelerator_attributes::UpdateCustomRoutingAcceleratorAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_custom_routing_accelerator_attributes::UpdateCustomRoutingAcceleratorAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_custom_routing_accelerator_attributes::UpdateCustomRoutingAcceleratorAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_custom_routing_accelerator_attributes::UpdateCustomRoutingAcceleratorAttributes::new())
...
/// Orchestration and serialization glue logic for `UpdateCustomRoutingAcceleratorAttributes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCustomRoutingAcceleratorAttributes {
                type Output = ::std::result::Result<crate::operation::update_custom_routing_accelerator_attributes::UpdateCustomRoutingAcceleratorAttributesOutput, crate::operation::update_custom_routing_accelerator_attributes::UpdateCustomRoutingAcceleratorAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_custom_routing_accelerator_attributes::de_update_custom_routing_accelerator_attributes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_custom_routing_accelerator_attributes::de_update_custom_routing_accelerator_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_custom_routing_accelerator_attributes::UpdateCustomRoutingAcceleratorAttributesError {
...
pub use crate::operation::update_custom_routing_accelerator_attributes::_update_custom_routing_accelerator_attributes_output::UpdateCustomRoutingAcceleratorAttributesOutput;

pub use crate::operation::update_custom_routing_accelerator_attributes::_update_custom_routing_accelerator_attributes_input::UpdateCustomRoutingAcceleratorAttributesInput;

mod _update_custom_routing_accelerator_attributes_input;

mod _update_custom_routing_accelerator_attributes_output;
