...
impl AllowCustomRoutingTrafficInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::allow_custom_routing_traffic::AllowCustomRoutingTrafficInput, ::aws_smithy_http::operation::error::BuildError> {
