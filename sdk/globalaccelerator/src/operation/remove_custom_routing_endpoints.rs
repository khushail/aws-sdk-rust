...
impl RemoveCustomRoutingEndpointsInput {
    /// Consumes the builder and constructs an Operation<[`RemoveCustomRoutingEndpoints`](crate::operation::remove_custom_routing_endpoints::RemoveCustomRoutingEndpoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::remove_custom_routing_endpoints::RemoveCustomRoutingEndpoints, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_custom_routing_endpoints::RemoveCustomRoutingEndpointsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_custom_routing_endpoints::RemoveCustomRoutingEndpoints::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveCustomRoutingEndpoints {
                type Output = ::std::result::Result<crate::operation::remove_custom_routing_endpoints::RemoveCustomRoutingEndpointsOutput, crate::operation::remove_custom_routing_endpoints::RemoveCustomRoutingEndpointsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_remove_custom_routing_endpoints::de_remove_custom_routing_endpoints_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::remove_custom_routing_endpoints::RemoveCustomRoutingEndpointsError {
