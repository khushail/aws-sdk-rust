...
impl AddCustomRoutingEndpointsInput {
    /// Consumes the builder and constructs an Operation<[`AddCustomRoutingEndpoints`](crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpoints, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpointsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpoints::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AddCustomRoutingEndpoints", "globalaccelerator"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AddCustomRoutingEndpoints`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AddCustomRoutingEndpoints {
                type Output = ::std::result::Result<crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpointsOutput, crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpointsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_add_custom_routing_endpoints::de_add_custom_routing_endpoints_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_add_custom_routing_endpoints::de_add_custom_routing_endpoints_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::add_custom_routing_endpoints::AddCustomRoutingEndpointsError {
...
mod _add_custom_routing_endpoints_output;
