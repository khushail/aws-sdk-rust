...
impl DescribeAcceleratorAttributesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAcceleratorAttributes`](crate::operation::describe_accelerator_attributes::DescribeAcceleratorAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_accelerator_attributes::DescribeAcceleratorAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_accelerator_attributes::DescribeAcceleratorAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_accelerator_attributes::DescribeAcceleratorAttributes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAcceleratorAttributes", "globalaccelerator"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeAcceleratorAttributes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAcceleratorAttributes {
                type Output = ::std::result::Result<crate::operation::describe_accelerator_attributes::DescribeAcceleratorAttributesOutput, crate::operation::describe_accelerator_attributes::DescribeAcceleratorAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_accelerator_attributes::de_describe_accelerator_attributes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_accelerator_attributes::de_describe_accelerator_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_accelerator_attributes::DescribeAcceleratorAttributesError {
...
pub use crate::operation::describe_accelerator_attributes::_describe_accelerator_attributes_output::DescribeAcceleratorAttributesOutput;

pub use crate::operation::describe_accelerator_attributes::_describe_accelerator_attributes_input::DescribeAcceleratorAttributesInput;

mod _describe_accelerator_attributes_input;

mod _describe_accelerator_attributes_output;
