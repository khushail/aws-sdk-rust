...
impl GetClusterInput {
    /// Consumes the builder and constructs an Operation<[`GetCluster`](crate::operation::get_cluster::GetCluster)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_cluster::GetCluster, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_cluster::GetClusterInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_cluster::GetCluster::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCluster {
                type Output = ::std::result::Result<crate::operation::get_cluster::GetClusterOutput, crate::operation::get_cluster::GetClusterError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_get_cluster::de_get_cluster_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_cluster::GetClusterError {
