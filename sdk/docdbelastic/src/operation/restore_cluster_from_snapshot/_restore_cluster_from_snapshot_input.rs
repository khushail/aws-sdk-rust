...
impl RestoreClusterFromSnapshotInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_cluster_from_snapshot::RestoreClusterFromSnapshotInput, ::aws_smithy_http::operation::error::BuildError> {
