...
impl AssumeRoleWithWebIdentityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::assume_role_with_web_identity::AssumeRoleWithWebIdentityInput, ::aws_smithy_http::operation::error::BuildError> {
