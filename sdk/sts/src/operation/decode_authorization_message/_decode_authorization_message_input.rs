...
impl DecodeAuthorizationMessageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::decode_authorization_message::DecodeAuthorizationMessageInput, ::aws_smithy_http::operation::error::BuildError> {
