...
#[allow(clippy::unnecessary_wraps)]
pub fn de_decode_authorization_message_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::decode_authorization_message::DecodeAuthorizationMessageOutput, crate::operation::decode_authorization_message::DecodeAuthorizationMessageError> {
    Ok({
        #[allow(unused_mut)]
