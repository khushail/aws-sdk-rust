...
#[allow(clippy::unnecessary_wraps)]
pub fn de_assume_role_with_saml_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::assume_role_with_saml::AssumeRoleWithSamlOutput, crate::operation::assume_role_with_saml::AssumeRoleWithSAMLError> {
    Ok({
        #[allow(unused_mut)]
