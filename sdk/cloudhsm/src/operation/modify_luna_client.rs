...
impl ModifyLunaClientInput {
    /// Consumes the builder and constructs an Operation<[`ModifyLunaClient`](crate::operation::modify_luna_client::ModifyLunaClient)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_luna_client::ModifyLunaClient, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_luna_client::ModifyLunaClientInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_luna_client::ModifyLunaClient::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyLunaClient", "cloudhsm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifyLunaClient`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyLunaClient {
                type Output = ::std::result::Result<crate::operation::modify_luna_client::ModifyLunaClientOutput, crate::operation::modify_luna_client::ModifyLunaClientError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_luna_client::de_modify_luna_client_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_luna_client::de_modify_luna_client_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_luna_client::ModifyLunaClientError {
...
pub use crate::operation::modify_luna_client::_modify_luna_client_output::ModifyLunaClientOutput;

pub use crate::operation::modify_luna_client::_modify_luna_client_input::ModifyLunaClientInput;

mod _modify_luna_client_input;

mod _modify_luna_client_output;
