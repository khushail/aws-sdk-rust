...
impl DescribeHapgInput {
    /// Consumes the builder and constructs an Operation<[`DescribeHapg`](crate::operation::describe_hapg::DescribeHapg)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_hapg::DescribeHapg, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_hapg::DescribeHapgInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_hapg::DescribeHapg::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeHapg", "cloudhsm"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeHapg`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeHapg {
                type Output = ::std::result::Result<crate::operation::describe_hapg::DescribeHapgOutput, crate::operation::describe_hapg::DescribeHapgError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_hapg::de_describe_hapg_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_hapg::de_describe_hapg_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_hapg::DescribeHapgError {
