...
impl super::Client  {
    ...
    ///   - [`client_arn(impl ::std::convert::Into<String>)`](crate::operation::delete_luna_client::builders::DeleteLunaClientFluentBuilder::client_arn) / [`set_client_arn(Option<String>)`](crate::operation::delete_luna_client::builders::DeleteLunaClientFluentBuilder::set_client_arn): <p>The ARN of the client to delete.</p>
