...
pub fn de_attach_load_balancer_to_subnets_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsOutput, crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_attach_load_balancer_to_subnets_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsOutput, crate::operation::attach_load_balancer_to_subnets::AttachLoadBalancerToSubnetsError> {
    Ok({
        #[allow(unused_mut)]
