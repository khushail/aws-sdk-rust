...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_load_balancer_policy_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyOutput, crate::operation::create_load_balancer_policy::CreateLoadBalancerPolicyError> {
    Ok({
        #[allow(unused_mut)]
