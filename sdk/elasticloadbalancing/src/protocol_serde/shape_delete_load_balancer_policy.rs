...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_load_balancer_policy_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyOutput, crate::operation::delete_load_balancer_policy::DeleteLoadBalancerPolicyError> {
    Ok({
        #[allow(unused_mut)]
