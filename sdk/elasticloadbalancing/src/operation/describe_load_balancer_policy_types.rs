...
impl DescribeLoadBalancerPolicyTypesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLoadBalancerPolicyTypes`](crate::operation::describe_load_balancer_policy_types::DescribeLoadBalancerPolicyTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_load_balancer_policy_types::DescribeLoadBalancerPolicyTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_load_balancer_policy_types::DescribeLoadBalancerPolicyTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_load_balancer_policy_types_input::ser_describe_load_balancer_policy_types_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_load_balancer_policy_types::DescribeLoadBalancerPolicyTypes::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLoadBalancerPolicyTypes {
                type Output = ::std::result::Result<crate::operation::describe_load_balancer_policy_types::DescribeLoadBalancerPolicyTypesOutput, crate::operation::describe_load_balancer_policy_types::DescribeLoadBalancerPolicyTypesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_load_balancer_policy_types::de_describe_load_balancer_policy_types_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_load_balancer_policy_types::de_describe_load_balancer_policy_types_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeLoadBalancerPolicyTypesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_load_balancer_policy_types::DescribeLoadBalancerPolicyTypesError {
...
mod _describe_load_balancer_policy_types_output;
