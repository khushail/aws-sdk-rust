...
impl EnableAvailabilityZonesForLoadBalancerInput {
    /// Consumes the builder and constructs an Operation<[`EnableAvailabilityZonesForLoadBalancer`](crate::operation::enable_availability_zones_for_load_balancer::EnableAvailabilityZonesForLoadBalancer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::enable_availability_zones_for_load_balancer::EnableAvailabilityZonesForLoadBalancer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_availability_zones_for_load_balancer::EnableAvailabilityZonesForLoadBalancerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_enable_availability_zones_for_load_balancer_input::ser_enable_availability_zones_for_load_balancer_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_availability_zones_for_load_balancer::EnableAvailabilityZonesForLoadBalancer::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableAvailabilityZonesForLoadBalancer {
                type Output = ::std::result::Result<crate::operation::enable_availability_zones_for_load_balancer::EnableAvailabilityZonesForLoadBalancerOutput, crate::operation::enable_availability_zones_for_load_balancer::EnableAvailabilityZonesForLoadBalancerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_enable_availability_zones_for_load_balancer::de_enable_availability_zones_for_load_balancer_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_enable_availability_zones_for_load_balancer::de_enable_availability_zones_for_load_balancer_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type EnableAvailabilityZonesForLoadBalancerErrorKind = EnableAvailabilityZonesForLoadBalancerError;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for EnableAvailabilityZonesForLoadBalancerError {
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_availability_zones_for_load_balancer::EnableAvailabilityZonesForLoadBalancerError {
...
pub use crate::operation::enable_availability_zones_for_load_balancer::_enable_availability_zones_for_load_balancer_output::EnableAvailabilityZonesForLoadBalancerOutput;

pub use crate::operation::enable_availability_zones_for_load_balancer::_enable_availability_zones_for_load_balancer_input::EnableAvailabilityZonesForLoadBalancerInput;

mod _enable_availability_zones_for_load_balancer_input;

mod _enable_availability_zones_for_load_balancer_output;
