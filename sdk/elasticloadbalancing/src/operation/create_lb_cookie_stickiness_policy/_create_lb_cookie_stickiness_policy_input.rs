...
impl CreateLbCookieStickinessPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_lb_cookie_stickiness_policy::CreateLbCookieStickinessPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
