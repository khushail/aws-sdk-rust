...
impl SetLoadBalancerPoliciesOfListenerInput {
    /// Consumes the builder and constructs an Operation<[`SetLoadBalancerPoliciesOfListener`](crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListener)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListener, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_set_load_balancer_policies_of_listener_input::ser_set_load_balancer_policies_of_listener_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListener::new())
...
/// Orchestration and serialization glue logic for `SetLoadBalancerPoliciesOfListener`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for SetLoadBalancerPoliciesOfListener {
                type Output = ::std::result::Result<crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerOutput, crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_set_load_balancer_policies_of_listener::de_set_load_balancer_policies_of_listener_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_set_load_balancer_policies_of_listener::de_set_load_balancer_policies_of_listener_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SetLoadBalancerPoliciesOfListenerError {
...
impl ::aws_http::request_id::RequestId for crate::operation::set_load_balancer_policies_of_listener::SetLoadBalancerPoliciesOfListenerError {
...
mod _set_load_balancer_policies_of_listener_output;
