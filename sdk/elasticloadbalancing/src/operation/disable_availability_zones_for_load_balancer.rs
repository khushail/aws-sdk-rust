...
impl DisableAvailabilityZonesForLoadBalancerInput {
    /// Consumes the builder and constructs an Operation<[`DisableAvailabilityZonesForLoadBalancer`](crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancerInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disable_availability_zones_for_load_balancer_input::ser_disable_availability_zones_for_load_balancer_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancer::new())
...
/// Orchestration and serialization glue logic for `DisableAvailabilityZonesForLoadBalancer`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableAvailabilityZonesForLoadBalancer {
                type Output = ::std::result::Result<crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancerOutput, crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disable_availability_zones_for_load_balancer::de_disable_availability_zones_for_load_balancer_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disable_availability_zones_for_load_balancer::de_disable_availability_zones_for_load_balancer_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DisableAvailabilityZonesForLoadBalancerErrorKind = DisableAvailabilityZonesForLoadBalancerError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DisableAvailabilityZonesForLoadBalancerError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisableAvailabilityZonesForLoadBalancerError {
...
impl ::aws_http::request_id::RequestId for crate::operation::disable_availability_zones_for_load_balancer::DisableAvailabilityZonesForLoadBalancerError {
...
mod _disable_availability_zones_for_load_balancer_output;
