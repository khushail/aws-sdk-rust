...
impl CreateAppCookieStickinessPolicyInput {
    /// Consumes the builder and constructs an Operation<[`CreateAppCookieStickinessPolicy`](crate::operation::create_app_cookie_stickiness_policy::CreateAppCookieStickinessPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_app_cookie_stickiness_policy::CreateAppCookieStickinessPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_app_cookie_stickiness_policy::CreateAppCookieStickinessPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_app_cookie_stickiness_policy_input::ser_create_app_cookie_stickiness_policy_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_app_cookie_stickiness_policy::CreateAppCookieStickinessPolicy::new())
...
/// Orchestration and serialization glue logic for `CreateAppCookieStickinessPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAppCookieStickinessPolicy {
                type Output = ::std::result::Result<crate::operation::create_app_cookie_stickiness_policy::CreateAppCookieStickinessPolicyOutput, crate::operation::create_app_cookie_stickiness_policy::CreateAppCookieStickinessPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_app_cookie_stickiness_policy::de_create_app_cookie_stickiness_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_app_cookie_stickiness_policy::de_create_app_cookie_stickiness_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateAppCookieStickinessPolicyError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_app_cookie_stickiness_policy::CreateAppCookieStickinessPolicyError {
...
mod _create_app_cookie_stickiness_policy_output;
