...
impl CreateLoadBalancerListenersInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_load_balancer_listeners::CreateLoadBalancerListeners, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_load_balancer_listeners::CreateLoadBalancerListenersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_load_balancer_listeners::CreateLoadBalancerListeners::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLoadBalancerListeners {
                type Output = ::std::result::Result<crate::operation::create_load_balancer_listeners::CreateLoadBalancerListenersOutput, crate::operation::create_load_balancer_listeners::CreateLoadBalancerListenersError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_load_balancer_listeners::CreateLoadBalancerListenersError {
