...
impl ConfigureHealthCheckInput {
    /// Consumes the builder and constructs an Operation<[`ConfigureHealthCheck`](crate::operation::configure_health_check::ConfigureHealthCheck)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::configure_health_check::ConfigureHealthCheck, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::configure_health_check::ConfigureHealthCheckInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::configure_health_check::ConfigureHealthCheckInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_configure_health_check_input::ser_configure_health_check_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::configure_health_check::ConfigureHealthCheck::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ConfigureHealthCheck", "elasticloadbalancing"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ConfigureHealthCheck`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ConfigureHealthCheck {
                type Output = ::std::result::Result<crate::operation::configure_health_check::ConfigureHealthCheckOutput, crate::operation::configure_health_check::ConfigureHealthCheckError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_configure_health_check::de_configure_health_check_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_configure_health_check::de_configure_health_check_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::configure_health_check::ConfigureHealthCheckError {
...
mod _configure_health_check_output;
