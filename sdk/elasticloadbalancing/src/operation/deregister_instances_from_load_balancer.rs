...
impl DeregisterInstancesFromLoadBalancerInput {
    /// Consumes the builder and constructs an Operation<[`DeregisterInstancesFromLoadBalancer`](crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancer)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancer, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancerInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_deregister_instances_from_load_balancer_input::ser_deregister_instances_from_load_balancer_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancer::new())
...
/// Orchestration and serialization glue logic for `DeregisterInstancesFromLoadBalancer`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeregisterInstancesFromLoadBalancer {
                type Output = ::std::result::Result<crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancerOutput, crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancerError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_deregister_instances_from_load_balancer::de_deregister_instances_from_load_balancer_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_deregister_instances_from_load_balancer::de_deregister_instances_from_load_balancer_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeregisterInstancesFromLoadBalancerError {
...
impl ::aws_http::request_id::RequestId for crate::operation::deregister_instances_from_load_balancer::DeregisterInstancesFromLoadBalancerError {
...
mod _deregister_instances_from_load_balancer_output;
