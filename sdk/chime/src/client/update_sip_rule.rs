...
impl super::Client  {
    ...
    ///   - [`sip_rule_id(impl ::std::convert::Into<String>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::sip_rule_id) / [`set_sip_rule_id(Option<String>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::set_sip_rule_id): <p>The SIP rule ID.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::set_name): <p>The new name for the specified SIP rule.</p>
    ///   - [`disabled(bool)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::disabled) / [`set_disabled(Option<bool>)`](crate::operation::update_sip_rule::builders::UpdateSipRuleFluentBuilder::set_disabled): <p>The new value specified to indicate whether the rule is disabled.</p>
