...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_voice_connector::builders::CreateVoiceConnectorFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_voice_connector::builders::CreateVoiceConnectorFluentBuilder::set_name): <p>The name of the Amazon Chime Voice Connector.</p>
