...
impl CreateMeetingDialOutInput {
    /// Consumes the builder and constructs an Operation<[`CreateMeetingDialOut`](crate::operation::create_meeting_dial_out::CreateMeetingDialOut)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_meeting_dial_out::CreateMeetingDialOut, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_meeting_dial_out::CreateMeetingDialOutInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/meetings/{MeetingId}/dial-outs", MeetingId = meeting_id).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_meeting_dial_out::ser_create_meeting_dial_out_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_meeting_dial_out::CreateMeetingDialOut::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateMeetingDialOut", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateMeetingDialOut`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMeetingDialOut {
                type Output = ::std::result::Result<crate::operation::create_meeting_dial_out::CreateMeetingDialOutOutput, crate::operation::create_meeting_dial_out::CreateMeetingDialOutError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::create_meeting_dial_out::CreateMeetingDialOutError {
...
mod _create_meeting_dial_out_output;
