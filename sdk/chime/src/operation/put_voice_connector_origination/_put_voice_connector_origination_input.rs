...
impl PutVoiceConnectorOriginationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_voice_connector_origination::PutVoiceConnectorOriginationInput, ::aws_smithy_http::operation::error::BuildError> {
