...
impl ListMediaCapturePipelinesInput {
    /// Consumes the builder and constructs an Operation<[`ListMediaCapturePipelines`](crate::operation::list_media_capture_pipelines::ListMediaCapturePipelines)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_media_capture_pipelines::ListMediaCapturePipelines, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_media_capture_pipelines::ListMediaCapturePipelinesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/media-capture-pipelines").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_media_capture_pipelines::ListMediaCapturePipelinesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_media_capture_pipelines::ListMediaCapturePipelinesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_media_capture_pipelines::ListMediaCapturePipelines::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListMediaCapturePipelines", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListMediaCapturePipelines`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMediaCapturePipelines {
                type Output = ::std::result::Result<crate::operation::list_media_capture_pipelines::ListMediaCapturePipelinesOutput, crate::operation::list_media_capture_pipelines::ListMediaCapturePipelinesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_media_capture_pipelines::de_list_media_capture_pipelines_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_media_capture_pipelines::de_list_media_capture_pipelines_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_media_capture_pipelines::ListMediaCapturePipelinesError {
...
mod _list_media_capture_pipelines_output;
