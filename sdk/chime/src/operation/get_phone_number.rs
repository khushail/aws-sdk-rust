...
impl GetPhoneNumberInput {
    /// Consumes the builder and constructs an Operation<[`GetPhoneNumber`](crate::operation::get_phone_number::GetPhoneNumber)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_phone_number::GetPhoneNumber, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_phone_number::GetPhoneNumberInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if phone_number_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("phone_number_id", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::get_phone_number::GetPhoneNumberInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_phone_number::GetPhoneNumber::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetPhoneNumber", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPhoneNumber {
                type Output = ::std::result::Result<crate::operation::get_phone_number::GetPhoneNumberOutput, crate::operation::get_phone_number::GetPhoneNumberError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_phone_number::de_get_phone_number_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_phone_number::de_get_phone_number_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_phone_number::GetPhoneNumberError {
