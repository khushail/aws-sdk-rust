...
impl CreateMeetingWithAttendeesInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendees, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/meetings").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendeesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_meeting_with_attendees::CreateMeetingWithAttendees::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateMeetingWithAttendees", "chime"));
