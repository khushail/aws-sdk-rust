...
impl DeleteAppInstanceStreamingConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAppInstanceStreamingConfigurations`](crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurationsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAppInstanceStreamingConfigurations", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAppInstanceStreamingConfigurations {
                type Output = ::std::result::Result<crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurationsOutput, crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_delete_app_instance_streaming_configurations::de_delete_app_instance_streaming_configurations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_app_instance_streaming_configurations::de_delete_app_instance_streaming_configurations_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteAppInstanceStreamingConfigurationsErrorKind = DeleteAppInstanceStreamingConfigurationsError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeleteAppInstanceStreamingConfigurationsError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteAppInstanceStreamingConfigurationsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_app_instance_streaming_configurations::DeleteAppInstanceStreamingConfigurationsError {
...
pub use crate::operation::delete_app_instance_streaming_configurations::_delete_app_instance_streaming_configurations_output::DeleteAppInstanceStreamingConfigurationsOutput;

pub use crate::operation::delete_app_instance_streaming_configurations::_delete_app_instance_streaming_configurations_input::DeleteAppInstanceStreamingConfigurationsInput;

mod _delete_app_instance_streaming_configurations_input;

mod _delete_app_instance_streaming_configurations_output;
