...
impl DisassociateSigninDelegateGroupsFromAccountInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateSigninDelegateGroupsFromAccount`](crate::operation::disassociate_signin_delegate_groups_from_account::DisassociateSigninDelegateGroupsFromAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_signin_delegate_groups_from_account::DisassociateSigninDelegateGroupsFromAccount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_signin_delegate_groups_from_account::DisassociateSigninDelegateGroupsFromAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if account_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("account_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/accounts/{AccountId}", AccountId = account_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::disassociate_signin_delegate_groups_from_account::DisassociateSigninDelegateGroupsFromAccountInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_disassociate_signin_delegate_groups_from_account::ser_disassociate_signin_delegate_groups_from_account_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_signin_delegate_groups_from_account::DisassociateSigninDelegateGroupsFromAccount::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DisassociateSigninDelegateGroupsFromAccount", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DisassociateSigninDelegateGroupsFromAccount`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateSigninDelegateGroupsFromAccount {
                type Output = ::std::result::Result<crate::operation::disassociate_signin_delegate_groups_from_account::DisassociateSigninDelegateGroupsFromAccountOutput, crate::operation::disassociate_signin_delegate_groups_from_account::DisassociateSigninDelegateGroupsFromAccountError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_signin_delegate_groups_from_account::de_disassociate_signin_delegate_groups_from_account_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_signin_delegate_groups_from_account::de_disassociate_signin_delegate_groups_from_account_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DisassociateSigninDelegateGroupsFromAccountErrorKind = DisassociateSigninDelegateGroupsFromAccountError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for DisassociateSigninDelegateGroupsFromAccountError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisassociateSigninDelegateGroupsFromAccountError {
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_signin_delegate_groups_from_account::DisassociateSigninDelegateGroupsFromAccountError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for DisassociateSigninDelegateGroupsFromAccountError {
...
mod _disassociate_signin_delegate_groups_from_account_output;
