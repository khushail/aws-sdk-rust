...
impl UpdatePhoneNumberSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_phone_number_settings::UpdatePhoneNumberSettingsInput, ::aws_smithy_http::operation::error::BuildError> {
