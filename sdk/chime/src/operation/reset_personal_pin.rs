...
impl ResetPersonalPinInput {
    /// Consumes the builder and constructs an Operation<[`ResetPersonalPIN`](crate::operation::reset_personal_pin::ResetPersonalPIN)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::reset_personal_pin::ResetPersonalPIN, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::reset_personal_pin::ResetPersonalPinInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::reset_personal_pin::ResetPersonalPinInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::reset_personal_pin::ResetPersonalPinInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::reset_personal_pin::ResetPersonalPIN::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResetPersonalPIN", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResetPersonalPIN {
                type Output = ::std::result::Result<crate::operation::reset_personal_pin::ResetPersonalPinOutput, crate::operation::reset_personal_pin::ResetPersonalPINError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_reset_personal_pin::de_reset_personal_pin_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::reset_personal_pin::ResetPersonalPINError {
...
mod _reset_personal_pin_output;
