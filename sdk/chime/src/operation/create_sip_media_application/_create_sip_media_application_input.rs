...
impl CreateSipMediaApplicationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_sip_media_application::CreateSipMediaApplicationInput, ::aws_smithy_http::operation::error::BuildError> {
