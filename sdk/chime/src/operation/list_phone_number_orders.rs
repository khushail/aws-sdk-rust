...
impl ListPhoneNumberOrdersInput {
    /// Consumes the builder and constructs an Operation<[`ListPhoneNumberOrders`](crate::operation::list_phone_number_orders::ListPhoneNumberOrders)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_phone_number_orders::ListPhoneNumberOrders, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_phone_number_orders::ListPhoneNumberOrdersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/phone-number-orders").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_phone_number_orders::ListPhoneNumberOrdersInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_phone_number_orders::ListPhoneNumberOrdersInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_phone_number_orders::ListPhoneNumberOrders::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPhoneNumberOrders", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListPhoneNumberOrders`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPhoneNumberOrders {
                type Output = ::std::result::Result<crate::operation::list_phone_number_orders::ListPhoneNumberOrdersOutput, crate::operation::list_phone_number_orders::ListPhoneNumberOrdersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_phone_number_orders::de_list_phone_number_orders_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_phone_number_orders::de_list_phone_number_orders_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_phone_number_orders::ListPhoneNumberOrdersError {
...
mod _list_phone_number_orders_output;
