...
impl UpdateVoiceConnectorGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_voice_connector_group::UpdateVoiceConnectorGroupInput, ::aws_smithy_http::operation::error::BuildError> {
