...
impl GetVoiceConnectorTerminationInput {
    /// Consumes the builder and constructs an Operation<[`GetVoiceConnectorTermination`](crate::operation::get_voice_connector_termination::GetVoiceConnectorTermination)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_voice_connector_termination::GetVoiceConnectorTermination, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_voice_connector_termination::GetVoiceConnectorTerminationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_voice_connector_termination::GetVoiceConnectorTerminationInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_voice_connector_termination::GetVoiceConnectorTermination::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetVoiceConnectorTermination", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetVoiceConnectorTermination {
                type Output = ::std::result::Result<crate::operation::get_voice_connector_termination::GetVoiceConnectorTerminationOutput, crate::operation::get_voice_connector_termination::GetVoiceConnectorTerminationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_voice_connector_termination::de_get_voice_connector_termination_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_voice_connector_termination::de_get_voice_connector_termination_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_voice_connector_termination::GetVoiceConnectorTerminationError {
...
pub use crate::operation::get_voice_connector_termination::_get_voice_connector_termination_output::GetVoiceConnectorTerminationOutput;

pub use crate::operation::get_voice_connector_termination::_get_voice_connector_termination_input::GetVoiceConnectorTerminationInput;

mod _get_voice_connector_termination_input;

mod _get_voice_connector_termination_output;
