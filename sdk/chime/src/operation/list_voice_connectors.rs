...
impl ListVoiceConnectorsInput {
    /// Consumes the builder and constructs an Operation<[`ListVoiceConnectors`](crate::operation::list_voice_connectors::ListVoiceConnectors)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_voice_connectors::ListVoiceConnectors, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_voice_connectors::ListVoiceConnectorsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/voice-connectors").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_voice_connectors::ListVoiceConnectorsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_voice_connectors::ListVoiceConnectorsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_voice_connectors::ListVoiceConnectors::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListVoiceConnectors", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListVoiceConnectors {
                type Output = ::std::result::Result<crate::operation::list_voice_connectors::ListVoiceConnectorsOutput, crate::operation::list_voice_connectors::ListVoiceConnectorsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_voice_connectors::de_list_voice_connectors_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_voice_connectors::de_list_voice_connectors_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_voice_connectors::ListVoiceConnectorsError {
...
pub use crate::operation::list_voice_connectors::_list_voice_connectors_output::ListVoiceConnectorsOutput;

pub use crate::operation::list_voice_connectors::_list_voice_connectors_input::ListVoiceConnectorsInput;

mod _list_voice_connectors_input;

mod _list_voice_connectors_output;
