...
impl DescribeAppInstanceAdminInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_app_instance_admin::DescribeAppInstanceAdmin, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_app_instance_admin::DescribeAppInstanceAdminInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if app_instance_admin_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("app_instance_admin_arn", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_app_instance_admin::DescribeAppInstanceAdmin::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAppInstanceAdmin", "chime"));
