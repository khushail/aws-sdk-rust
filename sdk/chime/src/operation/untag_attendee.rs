...
impl UntagAttendeeInput {
    /// Consumes the builder and constructs an Operation<[`UntagAttendee`](crate::operation::untag_attendee::UntagAttendee)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::untag_attendee::UntagAttendee, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_attendee::UntagAttendeeInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if meeting_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("meeting_id", "cannot be empty or unset"))
                            }
                ...
                if attendee_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("attendee_id", "cannot be empty or unset"))
                            }
            ...
            fn uri_query(_input: &crate::operation::untag_attendee::UntagAttendeeInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_untag_attendee::ser_untag_attendee_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::untag_attendee::UntagAttendee::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UntagAttendee", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagAttendee {
                type Output = ::std::result::Result<crate::operation::untag_attendee::UntagAttendeeOutput, crate::operation::untag_attendee::UntagAttendeeError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_untag_attendee::de_untag_attendee_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_untag_attendee::de_untag_attendee_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::untag_attendee::UntagAttendeeError {
...
pub use crate::operation::untag_attendee::_untag_attendee_output::UntagAttendeeOutput;

pub use crate::operation::untag_attendee::_untag_attendee_input::UntagAttendeeInput;

mod _untag_attendee_input;

mod _untag_attendee_output;
