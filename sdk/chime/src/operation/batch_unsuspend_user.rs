...
impl BatchUnsuspendUserInput {
    /// Consumes the builder and constructs an Operation<[`BatchUnsuspendUser`](crate::operation::batch_unsuspend_user::BatchUnsuspendUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_unsuspend_user::BatchUnsuspendUser, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_unsuspend_user::BatchUnsuspendUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::batch_unsuspend_user::BatchUnsuspendUserInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_batch_unsuspend_user::ser_batch_unsuspend_user_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_unsuspend_user::BatchUnsuspendUser::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchUnsuspendUser", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `BatchUnsuspendUser`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for BatchUnsuspendUser {
                type Output = ::std::result::Result<crate::operation::batch_unsuspend_user::BatchUnsuspendUserOutput, crate::operation::batch_unsuspend_user::BatchUnsuspendUserError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_batch_unsuspend_user::de_batch_unsuspend_user_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_batch_unsuspend_user::de_batch_unsuspend_user_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::batch_unsuspend_user::BatchUnsuspendUserError {
...
mod _batch_unsuspend_user_output;
