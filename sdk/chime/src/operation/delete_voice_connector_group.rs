...
impl DeleteVoiceConnectorGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVoiceConnectorGroup`](crate::operation::delete_voice_connector_group::DeleteVoiceConnectorGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_voice_connector_group::DeleteVoiceConnectorGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_voice_connector_group::DeleteVoiceConnectorGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if voice_connector_group_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("voice_connector_group_id", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_voice_connector_group::DeleteVoiceConnectorGroupInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_voice_connector_group::DeleteVoiceConnectorGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteVoiceConnectorGroup", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteVoiceConnectorGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVoiceConnectorGroup {
                type Output = ::std::result::Result<crate::operation::delete_voice_connector_group::DeleteVoiceConnectorGroupOutput, crate::operation::delete_voice_connector_group::DeleteVoiceConnectorGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_delete_voice_connector_group::de_delete_voice_connector_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_voice_connector_group::de_delete_voice_connector_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_voice_connector_group::DeleteVoiceConnectorGroupError {
...
pub use crate::operation::delete_voice_connector_group::_delete_voice_connector_group_output::DeleteVoiceConnectorGroupOutput;

pub use crate::operation::delete_voice_connector_group::_delete_voice_connector_group_input::DeleteVoiceConnectorGroupInput;

mod _delete_voice_connector_group_input;

mod _delete_voice_connector_group_output;
