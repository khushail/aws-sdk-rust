...
impl GetPhoneNumberOrderInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_phone_number_order::GetPhoneNumberOrder, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_phone_number_order::GetPhoneNumberOrderInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if phone_number_order_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("phone_number_order_id", "cannot be empty or unset"))
                            }
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_phone_number_order::GetPhoneNumberOrder::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetPhoneNumberOrder", "chime"));
