...
impl BatchDeletePhoneNumberInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::batch_delete_phone_number::BatchDeletePhoneNumber, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/phone-numbers").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::batch_delete_phone_number::BatchDeletePhoneNumberInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::batch_delete_phone_number::BatchDeletePhoneNumber::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("BatchDeletePhoneNumber", "chime"));
