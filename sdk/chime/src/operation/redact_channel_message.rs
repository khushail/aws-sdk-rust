...
impl RedactChannelMessageInput {
    /// Consumes the builder and constructs an Operation<[`RedactChannelMessage`](crate::operation::redact_channel_message::RedactChannelMessage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::redact_channel_message::RedactChannelMessage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::redact_channel_message::RedactChannelMessageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if message_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("message_id", "cannot be empty or unset"))
                            }
            ...
            fn uri_query(_input: &crate::operation::redact_channel_message::RedactChannelMessageInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::redact_channel_message::RedactChannelMessage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RedactChannelMessage", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RedactChannelMessage`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RedactChannelMessage {
                type Output = ::std::result::Result<crate::operation::redact_channel_message::RedactChannelMessageOutput, crate::operation::redact_channel_message::RedactChannelMessageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_redact_channel_message::de_redact_channel_message_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_redact_channel_message::de_redact_channel_message_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::redact_channel_message::RedactChannelMessageError {
...
mod _redact_channel_message_output;
