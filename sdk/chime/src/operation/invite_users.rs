...
impl InviteUsersInput {
    /// Consumes the builder and constructs an Operation<[`InviteUsers`](crate::operation::invite_users::InviteUsers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::invite_users::InviteUsers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::invite_users::InviteUsersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::invite_users::InviteUsersInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_invite_users::ser_invite_users_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::invite_users::InviteUsers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("InviteUsers", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `InviteUsers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for InviteUsers {
                type Output = ::std::result::Result<crate::operation::invite_users::InviteUsersOutput, crate::operation::invite_users::InviteUsersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_invite_users::de_invite_users_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_invite_users::de_invite_users_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::invite_users::InviteUsersError {
...
pub use crate::operation::invite_users::_invite_users_output::InviteUsersOutput;

pub use crate::operation::invite_users::_invite_users_input::InviteUsersInput;

mod _invite_users_input;

mod _invite_users_output;
