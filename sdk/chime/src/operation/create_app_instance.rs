...
impl CreateAppInstanceInput {
    /// Consumes the builder and constructs an Operation<[`CreateAppInstance`](crate::operation::create_app_instance::CreateAppInstance)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_app_instance::CreateAppInstance, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_app_instance::CreateAppInstanceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_app_instance::CreateAppInstance::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAppInstance", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAppInstance {
                type Output = ::std::result::Result<crate::operation::create_app_instance::CreateAppInstanceOutput, crate::operation::create_app_instance::CreateAppInstanceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_app_instance::de_create_app_instance_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_app_instance::de_create_app_instance_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_app_instance::CreateAppInstanceError {
...
mod _create_app_instance_output;
