...
impl DeleteVoiceConnectorOriginationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_voice_connector_origination::DeleteVoiceConnectorOriginationInput, ::aws_smithy_http::operation::error::BuildError> {
