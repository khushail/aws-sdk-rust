...
impl UntagMeetingInput {
    /// Consumes the builder and constructs an Operation<[`UntagMeeting`](crate::operation::untag_meeting::UntagMeeting)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::untag_meeting::UntagMeeting, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::untag_meeting::UntagMeetingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::untag_meeting::UntagMeetingInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_untag_meeting::ser_untag_meeting_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::untag_meeting::UntagMeeting::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UntagMeeting", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UntagMeeting`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UntagMeeting {
                type Output = ::std::result::Result<crate::operation::untag_meeting::UntagMeetingOutput, crate::operation::untag_meeting::UntagMeetingError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_untag_meeting::de_untag_meeting_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_untag_meeting::de_untag_meeting_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::untag_meeting::UntagMeetingError {
...
pub use crate::operation::untag_meeting::_untag_meeting_output::UntagMeetingOutput;

pub use crate::operation::untag_meeting::_untag_meeting_input::UntagMeetingInput;

mod _untag_meeting_input;

mod _untag_meeting_output;
