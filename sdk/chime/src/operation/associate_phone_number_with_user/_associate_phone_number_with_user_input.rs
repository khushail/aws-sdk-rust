...
impl AssociatePhoneNumberWithUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserInput, ::aws_smithy_http::operation::error::BuildError> {
