...
impl ListAppInstanceAdminsInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_app_instance_admins::ListAppInstanceAdmins, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_app_instance_admins::ListAppInstanceAdminsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_app_instance_admins::ListAppInstanceAdminsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_app_instance_admins::ListAppInstanceAdmins::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListAppInstanceAdmins", "chime"));
