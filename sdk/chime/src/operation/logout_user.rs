...
impl LogoutUserInput {
    /// Consumes the builder and constructs an Operation<[`LogoutUser`](crate::operation::logout_user::LogoutUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::logout_user::LogoutUser, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::logout_user::LogoutUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::logout_user::LogoutUserInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::logout_user::LogoutUserInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::logout_user::LogoutUser::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("LogoutUser", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `LogoutUser`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for LogoutUser {
                type Output = ::std::result::Result<crate::operation::logout_user::LogoutUserOutput, crate::operation::logout_user::LogoutUserError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_logout_user::de_logout_user_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_logout_user::de_logout_user_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::logout_user::LogoutUserError {
