...
impl ListMeetingTagsInput {
    /// Consumes the builder and constructs an Operation<[`ListMeetingTags`](crate::operation::list_meeting_tags::ListMeetingTags)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_meeting_tags::ListMeetingTags, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_meeting_tags::ListMeetingTagsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_meeting_tags::ListMeetingTagsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_meeting_tags::ListMeetingTags::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListMeetingTags", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListMeetingTags {
                type Output = ::std::result::Result<crate::operation::list_meeting_tags::ListMeetingTagsOutput, crate::operation::list_meeting_tags::ListMeetingTagsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_meeting_tags::de_list_meeting_tags_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_meeting_tags::de_list_meeting_tags_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_meeting_tags::ListMeetingTagsError {
...
pub use crate::operation::list_meeting_tags::_list_meeting_tags_output::ListMeetingTagsOutput;

pub use crate::operation::list_meeting_tags::_list_meeting_tags_input::ListMeetingTagsInput;

mod _list_meeting_tags_input;

mod _list_meeting_tags_output;
