...
impl DescribeAppInstanceUserInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_app_instance_user::DescribeAppInstanceUserInput, ::aws_smithy_http::operation::error::BuildError> {
