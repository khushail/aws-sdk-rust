...
impl DeleteVoiceConnectorProxyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_voice_connector_proxy::DeleteVoiceConnectorProxyInput, ::aws_smithy_http::operation::error::BuildError> {
