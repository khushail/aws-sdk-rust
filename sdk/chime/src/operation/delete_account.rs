...
impl DeleteAccountInput {
    /// Consumes the builder and constructs an Operation<[`DeleteAccount`](crate::operation::delete_account::DeleteAccount)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_account::DeleteAccount, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_account::DeleteAccountInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_account::DeleteAccountInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_account::DeleteAccount::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteAccount", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteAccount`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteAccount {
                type Output = ::std::result::Result<crate::operation::delete_account::DeleteAccountOutput, crate::operation::delete_account::DeleteAccountError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 204 {
                        crate::protocol_serde::shape_delete_account::de_delete_account_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_account::de_delete_account_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_account::DeleteAccountError {
...
pub use crate::operation::delete_account::_delete_account_output::DeleteAccountOutput;

pub use crate::operation::delete_account::_delete_account_input::DeleteAccountInput;

mod _delete_account_input;

mod _delete_account_output;
