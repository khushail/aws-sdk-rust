...
impl CreateMediaCapturePipelineInput {
    /// Consumes the builder and constructs an Operation<[`CreateMediaCapturePipeline`](crate::operation::create_media_capture_pipeline::CreateMediaCapturePipeline)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_media_capture_pipeline::CreateMediaCapturePipeline, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_media_capture_pipeline::CreateMediaCapturePipeline::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateMediaCapturePipeline", "chime"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateMediaCapturePipeline`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateMediaCapturePipeline {
                type Output = ::std::result::Result<crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineOutput, crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_media_capture_pipeline::de_create_media_capture_pipeline_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_media_capture_pipeline::de_create_media_capture_pipeline_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_media_capture_pipeline::CreateMediaCapturePipelineError {
...
mod _create_media_capture_pipeline_output;
