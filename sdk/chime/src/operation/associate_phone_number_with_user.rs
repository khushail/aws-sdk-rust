...
impl AssociatePhoneNumberWithUserInput {
    /// Consumes the builder and constructs an Operation<[`AssociatePhoneNumberWithUser`](crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUser)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUser, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_associate_phone_number_with_user::ser_associate_phone_number_with_user_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUser::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociatePhoneNumberWithUser", "chime"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociatePhoneNumberWithUser {
                type Output = ::std::result::Result<crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserOutput, crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_phone_number_with_user::de_associate_phone_number_with_user_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_phone_number_with_user::de_associate_phone_number_with_user_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_phone_number_with_user::AssociatePhoneNumberWithUserError {
...
mod _associate_phone_number_with_user_output;
