...
pub fn ser_engine_transcribe_settings(
    ...
    if let Some(var_12) = &input.identify_language {
        object.key("IdentifyLanguage").boolean(*var_12);
    }
    if let Some(var_13) = &input.language_options {
        object.key("LanguageOptions").string(var_13.as_str());
    }
    if let Some(var_14) = &input.preferred_language {
        object.key("PreferredLanguage").string(var_14.as_str());
    }
    if let Some(var_15) = &input.vocabulary_names {
        object.key("VocabularyNames").string(var_15.as_str());
    }
    if let Some(var_16) = &input.vocabulary_filter_names {
        object.key("VocabularyFilterNames").string(var_16.as_str());
    }
    Ok(())
}
