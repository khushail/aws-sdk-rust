...
pub fn ser_create_channel_ban_input(input: &crate::operation::create_channel_ban::CreateChannelBanInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_channel_ban_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_channel_ban::CreateChannelBanOutput, crate::operation::create_channel_ban::CreateChannelBanError> {
    Ok({
        #[allow(unused_mut)]
...
pub(crate) fn de_create_channel_ban(value: &[u8], mut builder: crate::operation::create_channel_ban::builders::CreateChannelBanOutputBuilder) -> Result<crate::operation::create_channel_ban::builders::CreateChannelBanOutputBuilder, ::aws_smithy_json::deserialize::error::DeserializeError> {
