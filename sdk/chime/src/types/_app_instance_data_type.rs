...
other => AppInstanceDataType::Unknown(crate::primitives::UnknownVariantValue(other.to_owned()))
                    }
                }
            }
impl ::std::str::FromStr for AppInstanceDataType {
                ...
                fn from_str(s: &str) -> ::std::result::Result<Self, <Self as ::std::str::FromStr>::Err> {
                    ::std::result::Result::Ok(AppInstanceDataType::from(s))
                }
            }
...
impl ::std::convert::AsRef<str> for AppInstanceDataType {
                fn as_ref(&self) -> &str {
                    self.as_str()
                }
            }
