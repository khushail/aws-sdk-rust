...
impl CreateHomeRegionControlInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_home_region_control::CreateHomeRegionControlInput, ::aws_smithy_http::operation::error::BuildError> {
