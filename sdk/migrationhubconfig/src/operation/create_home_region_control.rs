...
impl CreateHomeRegionControlInput {
    /// Consumes the builder and constructs an Operation<[`CreateHomeRegionControl`](crate::operation::create_home_region_control::CreateHomeRegionControl)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_home_region_control::CreateHomeRegionControl, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_home_region_control::CreateHomeRegionControlInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_home_region_control::CreateHomeRegionControl::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateHomeRegionControl {
                type Output = ::std::result::Result<crate::operation::create_home_region_control::CreateHomeRegionControlOutput, crate::operation::create_home_region_control::CreateHomeRegionControlError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_create_home_region_control::de_create_home_region_control_http_response_with_props(status, headers, body)
                     }
                }
