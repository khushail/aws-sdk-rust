...
mod create_packaging_configuration;

mod create_packaging_group;
...
/// 
/// ```ignore
/// # async fn wrapper() -> ::std::result::Result<(), aws_sdk_mediapackagevod::Error> {
/// # let client: aws_sdk_mediapackagevod::Client = unimplemented!();
...
mod delete_packaging_configuration;

mod delete_packaging_group;

mod describe_asset;

mod describe_packaging_configuration;

mod describe_packaging_group;

mod list_assets;

mod list_packaging_configurations;

mod list_packaging_groups;
