...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::describe_asset::builders::DescribeAssetFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::describe_asset::builders::DescribeAssetFluentBuilder::set_id): The ID of an MediaPackage VOD Asset resource.
