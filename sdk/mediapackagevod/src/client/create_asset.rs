...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::set_id): The unique identifier for the Asset.
    ///   - [`packaging_group_id(impl ::std::convert::Into<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::packaging_group_id) / [`set_packaging_group_id(Option<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::set_packaging_group_id): The ID of the PackagingGroup for the Asset.
    ///   - [`resource_id(impl ::std::convert::Into<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::resource_id) / [`set_resource_id(Option<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::set_resource_id): The resource ID to include in SPEKE key requests.
    ///   - [`source_arn(impl ::std::convert::Into<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::source_arn) / [`set_source_arn(Option<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::set_source_arn): ARN of the source object in S3.
    ///   - [`source_role_arn(impl ::std::convert::Into<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::source_role_arn) / [`set_source_role_arn(Option<String>)`](crate::operation::create_asset::builders::CreateAssetFluentBuilder::set_source_role_arn): The IAM role ARN used to access the source S3 bucket.
