...
impl DeletePackagingGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeletePackagingGroup`](crate::operation::delete_packaging_group::DeletePackagingGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_packaging_group::DeletePackagingGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_packaging_group::DeletePackagingGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_packaging_group::DeletePackagingGroupInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_packaging_group::DeletePackagingGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeletePackagingGroup", "mediapackagevod"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeletePackagingGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePackagingGroup {
                type Output = ::std::result::Result<crate::operation::delete_packaging_group::DeletePackagingGroupOutput, crate::operation::delete_packaging_group::DeletePackagingGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_delete_packaging_group::de_delete_packaging_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_packaging_group::de_delete_packaging_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_packaging_group::DeletePackagingGroupError {
...
mod _delete_packaging_group_output;
