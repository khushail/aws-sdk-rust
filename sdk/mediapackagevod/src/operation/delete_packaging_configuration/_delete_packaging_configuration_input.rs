...
impl DeletePackagingConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_packaging_configuration::DeletePackagingConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
