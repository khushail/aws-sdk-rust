...
impl DescribeAssessmentTargetsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAssessmentTargets`](crate::operation::describe_assessment_targets::DescribeAssessmentTargets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_assessment_targets::DescribeAssessmentTargets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_assessment_targets::DescribeAssessmentTargetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_assessment_targets::DescribeAssessmentTargets::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAssessmentTargets {
                type Output = ::std::result::Result<crate::operation::describe_assessment_targets::DescribeAssessmentTargetsOutput, crate::operation::describe_assessment_targets::DescribeAssessmentTargetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_assessment_targets::de_describe_assessment_targets_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_assessment_targets::de_describe_assessment_targets_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_assessment_targets::DescribeAssessmentTargetsError {
...
pub use crate::operation::describe_assessment_targets::_describe_assessment_targets_output::DescribeAssessmentTargetsOutput;

pub use crate::operation::describe_assessment_targets::_describe_assessment_targets_input::DescribeAssessmentTargetsInput;

mod _describe_assessment_targets_input;

mod _describe_assessment_targets_output;
