...
impl RemoveAttributesFromFindingsInput {
    /// Consumes the builder and constructs an Operation<[`RemoveAttributesFromFindings`](crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RemoveAttributesFromFindings", "inspector"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RemoveAttributesFromFindings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveAttributesFromFindings {
                type Output = ::std::result::Result<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsOutput, crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_remove_attributes_from_findings::de_remove_attributes_from_findings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_remove_attributes_from_findings::de_remove_attributes_from_findings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsError {
...
mod _remove_attributes_from_findings_output;
