...
impl DescribeCrossAccountAccessRoleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_cross_account_access_role::DescribeCrossAccountAccessRoleInput, ::aws_smithy_http::operation::error::BuildError> {
