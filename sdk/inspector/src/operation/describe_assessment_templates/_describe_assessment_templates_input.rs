...
impl DescribeAssessmentTemplatesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_assessment_templates::DescribeAssessmentTemplatesInput, ::aws_smithy_http::operation::error::BuildError> {
