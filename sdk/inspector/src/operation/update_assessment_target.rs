...
impl UpdateAssessmentTargetInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAssessmentTarget`](crate::operation::update_assessment_target::UpdateAssessmentTarget)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_assessment_target::UpdateAssessmentTarget, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_assessment_target::UpdateAssessmentTargetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_assessment_target::UpdateAssessmentTargetInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_assessment_target::UpdateAssessmentTarget::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateAssessmentTarget", "inspector"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateAssessmentTarget`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAssessmentTarget {
                type Output = ::std::result::Result<crate::operation::update_assessment_target::UpdateAssessmentTargetOutput, crate::operation::update_assessment_target::UpdateAssessmentTargetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_assessment_target::de_update_assessment_target_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_assessment_target::de_update_assessment_target_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_assessment_target::UpdateAssessmentTargetError {
...
pub use crate::operation::update_assessment_target::_update_assessment_target_output::UpdateAssessmentTargetOutput;

pub use crate::operation::update_assessment_target::_update_assessment_target_input::UpdateAssessmentTargetInput;

mod _update_assessment_target_input;

mod _update_assessment_target_output;
