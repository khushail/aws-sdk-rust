...
impl RemoveAttributesFromFindingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_attributes_from_findings::RemoveAttributesFromFindingsInput, ::aws_smithy_http::operation::error::BuildError> {
