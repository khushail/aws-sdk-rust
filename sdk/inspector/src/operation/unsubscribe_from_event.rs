...
impl UnsubscribeFromEventInput {
    /// Consumes the builder and constructs an Operation<[`UnsubscribeFromEvent`](crate::operation::unsubscribe_from_event::UnsubscribeFromEvent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::unsubscribe_from_event::UnsubscribeFromEvent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::unsubscribe_from_event::UnsubscribeFromEventInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::unsubscribe_from_event::UnsubscribeFromEvent::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UnsubscribeFromEvent", "inspector"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UnsubscribeFromEvent`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UnsubscribeFromEvent {
                type Output = ::std::result::Result<crate::operation::unsubscribe_from_event::UnsubscribeFromEventOutput, crate::operation::unsubscribe_from_event::UnsubscribeFromEventError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_unsubscribe_from_event::de_unsubscribe_from_event_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_unsubscribe_from_event::de_unsubscribe_from_event_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::unsubscribe_from_event::UnsubscribeFromEventError {
...
mod _unsubscribe_from_event_output;
