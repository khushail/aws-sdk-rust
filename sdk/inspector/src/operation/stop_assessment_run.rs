...
impl StopAssessmentRunInput {
    /// Consumes the builder and constructs an Operation<[`StopAssessmentRun`](crate::operation::stop_assessment_run::StopAssessmentRun)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_assessment_run::StopAssessmentRun, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_assessment_run::StopAssessmentRunInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_assessment_run::StopAssessmentRun::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopAssessmentRun", "inspector"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StopAssessmentRun`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopAssessmentRun {
                type Output = ::std::result::Result<crate::operation::stop_assessment_run::StopAssessmentRunOutput, crate::operation::stop_assessment_run::StopAssessmentRunError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_assessment_run::de_stop_assessment_run_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_assessment_run::de_stop_assessment_run_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_assessment_run::StopAssessmentRunError {
...
mod _stop_assessment_run_output;
