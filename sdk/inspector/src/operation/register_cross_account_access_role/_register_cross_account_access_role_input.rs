...
impl RegisterCrossAccountAccessRoleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::register_cross_account_access_role::RegisterCrossAccountAccessRoleInput, ::aws_smithy_http::operation::error::BuildError> {
