...
impl CreateAssessmentTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_assessment_template::CreateAssessmentTemplateInput, ::aws_smithy_http::operation::error::BuildError> {
