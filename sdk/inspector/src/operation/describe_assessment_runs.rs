...
impl DescribeAssessmentRunsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAssessmentRuns`](crate::operation::describe_assessment_runs::DescribeAssessmentRuns)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_assessment_runs::DescribeAssessmentRuns, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_assessment_runs::DescribeAssessmentRunsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_assessment_runs::DescribeAssessmentRuns::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAssessmentRuns", "inspector"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeAssessmentRuns`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAssessmentRuns {
                type Output = ::std::result::Result<crate::operation::describe_assessment_runs::DescribeAssessmentRunsOutput, crate::operation::describe_assessment_runs::DescribeAssessmentRunsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_assessment_runs::de_describe_assessment_runs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_assessment_runs::de_describe_assessment_runs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_assessment_runs::DescribeAssessmentRunsError {
...
pub use crate::operation::describe_assessment_runs::_describe_assessment_runs_output::DescribeAssessmentRunsOutput;

pub use crate::operation::describe_assessment_runs::_describe_assessment_runs_input::DescribeAssessmentRunsInput;

mod _describe_assessment_runs_input;

mod _describe_assessment_runs_output;
