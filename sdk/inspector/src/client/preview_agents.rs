...
impl super::Client  {
    ...
    ///   - [`preview_agents_arn(impl ::std::convert::Into<String>)`](crate::operation::preview_agents::builders::PreviewAgentsFluentBuilder::preview_agents_arn) / [`set_preview_agents_arn(Option<String>)`](crate::operation::preview_agents::builders::PreviewAgentsFluentBuilder::set_preview_agents_arn): <p>The ARN of the assessment target whose agents you want to preview.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::preview_agents::builders::PreviewAgentsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::preview_agents::builders::PreviewAgentsFluentBuilder::set_next_token): <p>You can use this parameter when paginating results. Set the value of this parameter to null on your first call to the <b>PreviewAgents</b> action. Subsequent calls to the action fill <b>nextToken</b> in the request with the value of <b>NextToken</b> from the previous response to continue listing data.</p>
