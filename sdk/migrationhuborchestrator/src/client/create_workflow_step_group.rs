...
impl super::Client  {
    ...
    ///   - [`workflow_id(impl ::std::convert::Into<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::workflow_id) / [`set_workflow_id(Option<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::set_workflow_id): <p>The ID of the migration workflow that will contain the step group.</p>
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::set_name): <p>The name of the step group.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::create_workflow_step_group::builders::CreateWorkflowStepGroupFluentBuilder::set_description): <p>The description of the step group.</p>
