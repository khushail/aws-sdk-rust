...
pub fn de_describe_protected_resource_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_protected_resource::DescribeProtectedResourceOutput, crate::operation::describe_protected_resource::DescribeProtectedResourceError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::describe_protected_resource::DescribeProtectedResourceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_protected_resource_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_protected_resource::DescribeProtectedResourceOutput, crate::operation::describe_protected_resource::DescribeProtectedResourceError> {
    Ok({
        #[allow(unused_mut)]
