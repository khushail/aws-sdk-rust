...
impl PutBackupVaultAccessPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_backup_vault_access_policy::PutBackupVaultAccessPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
