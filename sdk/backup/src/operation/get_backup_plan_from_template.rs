...
impl GetBackupPlanFromTemplateInput {
    /// Consumes the builder and constructs an Operation<[`GetBackupPlanFromTemplate`](crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.backup_plan_template_id;
                let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("backup_plan_template_id", "cannot be empty or unset"))?;
                let backup_plan_template_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
                if backup_plan_template_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("backup_plan_template_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/backup/template/plans/{BackupPlanTemplateId}/toPlan", BackupPlanTemplateId = backup_plan_template_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplate::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackupPlanFromTemplate {
                type Output = ::std::result::Result<crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplateOutput, crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_backup_plan_from_template::de_get_backup_plan_from_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_backup_plan_from_template::de_get_backup_plan_from_template_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplateError {
...
pub use crate::operation::get_backup_plan_from_template::_get_backup_plan_from_template_output::GetBackupPlanFromTemplateOutput;

pub use crate::operation::get_backup_plan_from_template::_get_backup_plan_from_template_input::GetBackupPlanFromTemplateInput;

mod _get_backup_plan_from_template_input;

mod _get_backup_plan_from_template_output;
