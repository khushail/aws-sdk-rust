...
impl DeleteBackupSelectionInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBackupSelection`](crate::operation::delete_backup_selection::DeleteBackupSelection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_backup_selection::DeleteBackupSelection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_backup_selection::DeleteBackupSelectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if selection_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("selection_id", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_backup_selection::DeleteBackupSelectionInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_backup_selection::DeleteBackupSelection::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteBackupSelection", "backup"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteBackupSelection`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBackupSelection {
                type Output = ::std::result::Result<crate::operation::delete_backup_selection::DeleteBackupSelectionOutput, crate::operation::delete_backup_selection::DeleteBackupSelectionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_backup_selection::de_delete_backup_selection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_backup_selection::de_delete_backup_selection_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_backup_selection::DeleteBackupSelectionError {
...
mod _delete_backup_selection_output;
