...
impl PutBackupVaultNotificationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_backup_vault_notifications::PutBackupVaultNotificationsInput, ::aws_smithy_http::operation::error::BuildError> {
