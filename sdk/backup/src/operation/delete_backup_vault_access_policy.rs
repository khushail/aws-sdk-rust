...
impl DeleteBackupVaultAccessPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBackupVaultAccessPolicy`](crate::operation::delete_backup_vault_access_policy::DeleteBackupVaultAccessPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_backup_vault_access_policy::DeleteBackupVaultAccessPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_backup_vault_access_policy::DeleteBackupVaultAccessPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_backup_vault_access_policy::DeleteBackupVaultAccessPolicyInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_backup_vault_access_policy::DeleteBackupVaultAccessPolicy::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteBackupVaultAccessPolicy", "backup"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteBackupVaultAccessPolicy`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBackupVaultAccessPolicy {
                type Output = ::std::result::Result<crate::operation::delete_backup_vault_access_policy::DeleteBackupVaultAccessPolicyOutput, crate::operation::delete_backup_vault_access_policy::DeleteBackupVaultAccessPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_backup_vault_access_policy::de_delete_backup_vault_access_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_backup_vault_access_policy::de_delete_backup_vault_access_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_backup_vault_access_policy::DeleteBackupVaultAccessPolicyError {
...
mod _delete_backup_vault_access_policy_output;
