...
impl DeleteReportPlanInput {
    /// Consumes the builder and constructs an Operation<[`DeleteReportPlan`](crate::operation::delete_report_plan::DeleteReportPlan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_report_plan::DeleteReportPlan, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_report_plan::DeleteReportPlanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if report_plan_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("report_plan_name", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_report_plan::DeleteReportPlanInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_report_plan::DeleteReportPlan::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteReportPlan", "backup"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteReportPlan`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteReportPlan {
                type Output = ::std::result::Result<crate::operation::delete_report_plan::DeleteReportPlanOutput, crate::operation::delete_report_plan::DeleteReportPlanError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_report_plan::de_delete_report_plan_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_report_plan::de_delete_report_plan_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_report_plan::DeleteReportPlanError {
...
pub use crate::operation::delete_report_plan::_delete_report_plan_output::DeleteReportPlanOutput;

pub use crate::operation::delete_report_plan::_delete_report_plan_input::DeleteReportPlanInput;

mod _delete_report_plan_input;

mod _delete_report_plan_output;
