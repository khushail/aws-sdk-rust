...
impl CreateReportPlanInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_report_plan::CreateReportPlan, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_report_plan::CreateReportPlanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `CreateReportPlan`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateReportPlan {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_report_plan::de_create_report_plan_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_report_plan::de_create_report_plan_http_response_with_props(status, headers, body)
                     }
                }
