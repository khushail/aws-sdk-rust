...
impl ListReportJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListReportJobs`](crate::operation::list_report_jobs::ListReportJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_report_jobs::ListReportJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_report_jobs::ListReportJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/audit/report-jobs").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_report_jobs::ListReportJobsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_2) = &_input.by_creation_before {
                     {
                        query.push_kv("CreationBefore", &::aws_smithy_http::query::fmt_timestamp(inner_2, ::aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let ::std::option::Option::Some(inner_3) = &_input.by_creation_after {
                     {
                        query.push_kv("CreationAfter", &::aws_smithy_http::query::fmt_timestamp(inner_3, ::aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
            ...
            fn update_http_builder(
                            input: &crate::operation::list_report_jobs::ListReportJobsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_report_jobs::ListReportJobs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListReportJobs", "backup"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListReportJobs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListReportJobs {
                type Output = ::std::result::Result<crate::operation::list_report_jobs::ListReportJobsOutput, crate::operation::list_report_jobs::ListReportJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_report_jobs::de_list_report_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_report_jobs::de_list_report_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_report_jobs::ListReportJobsError {
