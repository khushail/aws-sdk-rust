...
impl DescribeRestoreJobInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_restore_job::DescribeRestoreJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_restore_job::DescribeRestoreJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if restore_job_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("restore_job_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/restore-jobs/{RestoreJobId}", RestoreJobId = restore_job_id).expect("formatting should succeed");
...
/// Orchestration and serialization glue logic for `DescribeRestoreJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRestoreJob {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_restore_job::de_describe_restore_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_restore_job::de_describe_restore_job_http_response_with_props(status, headers, body)
                     }
                }
