...
impl DescribeRecoveryPointInput {
    /// Consumes the builder and constructs an Operation<[`DescribeRecoveryPoint`](crate::operation::describe_recovery_point::DescribeRecoveryPoint)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_recovery_point::DescribeRecoveryPoint, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_recovery_point::DescribeRecoveryPointInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_recovery_point::DescribeRecoveryPoint::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeRecoveryPoint {
                type Output = ::std::result::Result<crate::operation::describe_recovery_point::DescribeRecoveryPointOutput, crate::operation::describe_recovery_point::DescribeRecoveryPointError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_recovery_point::de_describe_recovery_point_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_recovery_point::de_describe_recovery_point_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_recovery_point::DescribeRecoveryPointError {
...
mod _describe_recovery_point_output;
