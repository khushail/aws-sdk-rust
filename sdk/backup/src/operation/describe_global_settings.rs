...
impl DescribeGlobalSettingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeGlobalSettings`](crate::operation::describe_global_settings::DescribeGlobalSettings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_global_settings::DescribeGlobalSettings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_global_settings::DescribeGlobalSettingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_global_settings::DescribeGlobalSettingsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_global_settings::DescribeGlobalSettings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeGlobalSettings", "backup"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeGlobalSettings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeGlobalSettings {
                type Output = ::std::result::Result<crate::operation::describe_global_settings::DescribeGlobalSettingsOutput, crate::operation::describe_global_settings::DescribeGlobalSettingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_global_settings::de_describe_global_settings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_global_settings::de_describe_global_settings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_global_settings::DescribeGlobalSettingsError {
...
mod _describe_global_settings_output;
