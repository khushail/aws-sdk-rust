...
impl StartRestoreJobInput {
    /// Consumes the builder and constructs an Operation<[`StartRestoreJob`](crate::operation::start_restore_job::StartRestoreJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_restore_job::StartRestoreJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_restore_job::StartRestoreJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_restore_job::StartRestoreJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartRestoreJob {
                type Output = ::std::result::Result<crate::operation::start_restore_job::StartRestoreJobOutput, crate::operation::start_restore_job::StartRestoreJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_restore_job::de_start_restore_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_restore_job::de_start_restore_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_restore_job::StartRestoreJobError {
