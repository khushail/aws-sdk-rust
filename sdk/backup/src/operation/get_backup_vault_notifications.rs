...
impl GetBackupVaultNotificationsInput {
    /// Consumes the builder and constructs an Operation<[`GetBackupVaultNotifications`](crate::operation::get_backup_vault_notifications::GetBackupVaultNotifications)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_backup_vault_notifications::GetBackupVaultNotifications, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_backup_vault_notifications::GetBackupVaultNotificationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_backup_vault_notifications::GetBackupVaultNotificationsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_backup_vault_notifications::GetBackupVaultNotifications::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetBackupVaultNotifications {
                type Output = ::std::result::Result<crate::operation::get_backup_vault_notifications::GetBackupVaultNotificationsOutput, crate::operation::get_backup_vault_notifications::GetBackupVaultNotificationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_backup_vault_notifications::de_get_backup_vault_notifications_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_backup_vault_notifications::de_get_backup_vault_notifications_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_backup_vault_notifications::GetBackupVaultNotificationsError {
...
mod _get_backup_vault_notifications_output;
