...
impl CancelLegalHoldInput {
    /// Consumes the builder and constructs an Operation<[`CancelLegalHold`](crate::operation::cancel_legal_hold::CancelLegalHold)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::cancel_legal_hold::CancelLegalHold, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::cancel_legal_hold::CancelLegalHoldInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if legal_hold_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("legal_hold_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/legal-holds/{LegalHoldId}", LegalHoldId = legal_hold_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::cancel_legal_hold::CancelLegalHoldInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if inner_2.is_empty() {
                    return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("cancel_description", "cannot be empty or unset"));
                }
            ...
            fn update_http_builder(
                            input: &crate::operation::cancel_legal_hold::CancelLegalHoldInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::cancel_legal_hold::CancelLegalHold::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CancelLegalHold {
                type Output = ::std::result::Result<crate::operation::cancel_legal_hold::CancelLegalHoldOutput, crate::operation::cancel_legal_hold::CancelLegalHoldError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_cancel_legal_hold::de_cancel_legal_hold_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_cancel_legal_hold::de_cancel_legal_hold_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::cancel_legal_hold::CancelLegalHoldError {
