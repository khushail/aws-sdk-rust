...
impl DescribeCopyJobInput {
    /// Consumes the builder and constructs an Operation<[`DescribeCopyJob`](crate::operation::describe_copy_job::DescribeCopyJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_copy_job::DescribeCopyJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_copy_job::DescribeCopyJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.copy_job_id;
                let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("copy_job_id", "cannot be empty or unset"))?;
                let copy_job_id = ::aws_smithy_http::label::fmt_string(input_1, ::aws_smithy_http::label::EncodingStrategy::Default);
                if copy_job_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("copy_job_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/copy-jobs/{CopyJobId}", CopyJobId = copy_job_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::describe_copy_job::DescribeCopyJobInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_copy_job::DescribeCopyJob::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeCopyJob {
                type Output = ::std::result::Result<crate::operation::describe_copy_job::DescribeCopyJobOutput, crate::operation::describe_copy_job::DescribeCopyJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_copy_job::de_describe_copy_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_copy_job::de_describe_copy_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_copy_job::DescribeCopyJobError {
