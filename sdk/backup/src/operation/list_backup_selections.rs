...
impl ListBackupSelectionsInput {
    /// Consumes the builder and constructs an Operation<[`ListBackupSelections`](crate::operation::list_backup_selections::ListBackupSelections)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_backup_selections::ListBackupSelections, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_backup_selections::ListBackupSelectionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if backup_plan_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("backup_plan_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/backup/plans/{BackupPlanId}/selections", BackupPlanId = backup_plan_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_backup_selections::ListBackupSelectionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_backup_selections::ListBackupSelectionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_backup_selections::ListBackupSelections::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListBackupSelections", "backup"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListBackupSelections`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListBackupSelections {
                type Output = ::std::result::Result<crate::operation::list_backup_selections::ListBackupSelectionsOutput, crate::operation::list_backup_selections::ListBackupSelectionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_backup_selections::de_list_backup_selections_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_backup_selections::de_list_backup_selections_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_backup_selections::ListBackupSelectionsError {
...
mod _list_backup_selections_output;
