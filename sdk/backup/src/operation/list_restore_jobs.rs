...
impl ListRestoreJobsInput {
    /// Consumes the builder and constructs an Operation<[`ListRestoreJobs`](crate::operation::list_restore_jobs::ListRestoreJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_restore_jobs::ListRestoreJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_restore_jobs::ListRestoreJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/restore-jobs").expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_restore_jobs::ListRestoreJobsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if let ::std::option::Option::Some(inner_3) = &_input.by_account_id {
                     {
                ...
                if let ::std::option::Option::Some(inner_5) = &_input.by_created_after {
                     {
                        query.push_kv("createdAfter", &::aws_smithy_http::query::fmt_timestamp(inner_5, ::aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                ...
                if let ::std::option::Option::Some(inner_7) = &_input.by_complete_before {
                     {
                        query.push_kv("completeBefore", &::aws_smithy_http::query::fmt_timestamp(inner_7, ::aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                if let ::std::option::Option::Some(inner_8) = &_input.by_complete_after {
                     {
                        query.push_kv("completeAfter", &::aws_smithy_http::query::fmt_timestamp(inner_8, ::aws_smithy_types::date_time::Format::DateTime)?);
                    }
                }
                ::std::result::Result::Ok(())
            }
            ...
            fn update_http_builder(
                            input: &crate::operation::list_restore_jobs::ListRestoreJobsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_restore_jobs::ListRestoreJobs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListRestoreJobs", "backup"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListRestoreJobs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListRestoreJobs {
                type Output = ::std::result::Result<crate::operation::list_restore_jobs::ListRestoreJobsOutput, crate::operation::list_restore_jobs::ListRestoreJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_restore_jobs::de_list_restore_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_restore_jobs::de_list_restore_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_restore_jobs::ListRestoreJobsError {
