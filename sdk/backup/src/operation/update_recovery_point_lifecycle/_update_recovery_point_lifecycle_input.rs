...
impl UpdateRecoveryPointLifecycleInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_recovery_point_lifecycle::UpdateRecoveryPointLifecycleInput, ::aws_smithy_http::operation::error::BuildError> {
