...
impl CreateBackupPlanInput {
    /// Consumes the builder and constructs an Operation<[`CreateBackupPlan`](crate::operation::create_backup_plan::CreateBackupPlan)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_backup_plan::CreateBackupPlan, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_backup_plan::CreateBackupPlanInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_backup_plan::CreateBackupPlan::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateBackupPlan {
                type Output = ::std::result::Result<crate::operation::create_backup_plan::CreateBackupPlanOutput, crate::operation::create_backup_plan::CreateBackupPlanError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_backup_plan::de_create_backup_plan_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_backup_plan::de_create_backup_plan_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_backup_plan::CreateBackupPlanError {
...
mod _create_backup_plan_output;
