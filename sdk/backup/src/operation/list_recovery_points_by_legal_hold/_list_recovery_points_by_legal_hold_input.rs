...
impl ListRecoveryPointsByLegalHoldInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_recovery_points_by_legal_hold::ListRecoveryPointsByLegalHoldInput, ::aws_smithy_http::operation::error::BuildError> {
