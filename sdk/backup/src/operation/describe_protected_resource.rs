...
impl DescribeProtectedResourceInput {
    /// Consumes the builder and constructs an Operation<[`DescribeProtectedResource`](crate::operation::describe_protected_resource::DescribeProtectedResource)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_protected_resource::DescribeProtectedResource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_protected_resource::DescribeProtectedResourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/resources/{ResourceArn}", ResourceArn = resource_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::describe_protected_resource::DescribeProtectedResourceInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_protected_resource::DescribeProtectedResource::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeProtectedResource", "backup"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeProtectedResource`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeProtectedResource {
                type Output = ::std::result::Result<crate::operation::describe_protected_resource::DescribeProtectedResourceOutput, crate::operation::describe_protected_resource::DescribeProtectedResourceError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_protected_resource::de_describe_protected_resource_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_protected_resource::de_describe_protected_resource_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_protected_resource::DescribeProtectedResourceError {
...
mod _describe_protected_resource_output;
