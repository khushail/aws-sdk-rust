...
impl GetBackupPlanFromTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_backup_plan_from_template::GetBackupPlanFromTemplateInput, ::aws_smithy_http::operation::error::BuildError> {
