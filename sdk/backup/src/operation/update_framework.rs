...
impl UpdateFrameworkInput {
    /// Consumes the builder and constructs an Operation<[`UpdateFramework`](crate::operation::update_framework::UpdateFramework)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_framework::UpdateFramework, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_framework::UpdateFrameworkInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if framework_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("framework_name", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::update_framework::UpdateFrameworkInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_framework::UpdateFramework::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateFramework", "backup"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateFramework`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateFramework {
                type Output = ::std::result::Result<crate::operation::update_framework::UpdateFrameworkOutput, crate::operation::update_framework::UpdateFrameworkError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_framework::de_update_framework_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_framework::UpdateFrameworkError {
...
pub use crate::operation::update_framework::_update_framework_output::UpdateFrameworkOutput;

pub use crate::operation::update_framework::_update_framework_input::UpdateFrameworkInput;

mod _update_framework_input;

mod _update_framework_output;
