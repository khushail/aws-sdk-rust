...
impl DisassociateRecoveryPointFromParentInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateRecoveryPointFromParent`](crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if backup_vault_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("backup_vault_name", "cannot be empty or unset"))
                            }
                ...
                if recovery_point_arn.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("recovery_point_arn", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/backup-vaults/{BackupVaultName}/recovery-points/{RecoveryPointArn}/parentAssociation", BackupVaultName = backup_vault_name, RecoveryPointArn = recovery_point_arn).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParent::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateRecoveryPointFromParent {
                type Output = ::std::result::Result<crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentOutput, crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_recovery_point_from_parent::DisassociateRecoveryPointFromParentError {
...
pub use crate::operation::disassociate_recovery_point_from_parent::_disassociate_recovery_point_from_parent_output::DisassociateRecoveryPointFromParentOutput;

pub use crate::operation::disassociate_recovery_point_from_parent::_disassociate_recovery_point_from_parent_input::DisassociateRecoveryPointFromParentInput;

mod _disassociate_recovery_point_from_parent_input;

mod _disassociate_recovery_point_from_parent_output;
