...
impl GetThirdPartyJobDetailsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsInput, ::aws_smithy_http::operation::error::BuildError> {
