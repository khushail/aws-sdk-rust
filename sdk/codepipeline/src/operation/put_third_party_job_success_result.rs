...
impl PutThirdPartyJobSuccessResultInput {
    /// Consumes the builder and constructs an Operation<[`PutThirdPartyJobSuccessResult`](crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResult)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResult, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResult::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutThirdPartyJobSuccessResult {
                type Output = ::std::result::Result<crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultOutput, crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError>;
...
impl ::aws_http::request_id::RequestId for crate::operation::put_third_party_job_success_result::PutThirdPartyJobSuccessResultError {
...
pub use crate::operation::put_third_party_job_success_result::_put_third_party_job_success_result_output::PutThirdPartyJobSuccessResultOutput;

pub use crate::operation::put_third_party_job_success_result::_put_third_party_job_success_result_input::PutThirdPartyJobSuccessResultInput;

mod _put_third_party_job_success_result_input;

mod _put_third_party_job_success_result_output;
