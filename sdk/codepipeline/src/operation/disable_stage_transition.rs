...
impl DisableStageTransitionInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disable_stage_transition::DisableStageTransition, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disable_stage_transition::DisableStageTransitionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `DisableStageTransition`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisableStageTransition {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disable_stage_transition::de_disable_stage_transition_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disable_stage_transition::de_disable_stage_transition_http_response_with_props(status, headers, body)
                     }
                }
