...
impl PollForJobsInput {
    /// Consumes the builder and constructs an Operation<[`PollForJobs`](crate::operation::poll_for_jobs::PollForJobs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::poll_for_jobs::PollForJobs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::poll_for_jobs::PollForJobsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::poll_for_jobs::PollForJobs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PollForJobs", "codepipeline"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PollForJobs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PollForJobs {
                type Output = ::std::result::Result<crate::operation::poll_for_jobs::PollForJobsOutput, crate::operation::poll_for_jobs::PollForJobsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_poll_for_jobs::de_poll_for_jobs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_poll_for_jobs::de_poll_for_jobs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::poll_for_jobs::PollForJobsError {
