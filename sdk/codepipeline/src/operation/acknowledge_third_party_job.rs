...
impl AcknowledgeThirdPartyJobInput {
    /// Consumes the builder and constructs an Operation<[`AcknowledgeThirdPartyJob`](crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AcknowledgeThirdPartyJob", "codepipeline"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AcknowledgeThirdPartyJob`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AcknowledgeThirdPartyJob {
                type Output = ::std::result::Result<crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobOutput, crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_acknowledge_third_party_job::de_acknowledge_third_party_job_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_acknowledge_third_party_job::de_acknowledge_third_party_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::acknowledge_third_party_job::AcknowledgeThirdPartyJobError {
...
mod _acknowledge_third_party_job_output;
