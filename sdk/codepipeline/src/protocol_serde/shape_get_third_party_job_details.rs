...
#[allow(clippy::unnecessary_wraps)]
pub fn de_get_third_party_job_details_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsOutput, crate::operation::get_third_party_job_details::GetThirdPartyJobDetailsError> {
    Ok({
        #[allow(unused_mut)]
