...
pub fn ser_put_webhook_input(
    ...
    if let Some(var_1) = &input.webhook {
        #[allow(unused_mut)]
        let mut object_2 = object.key("webhook").start_object();
        crate::protocol_serde::shape_webhook_definition::ser_webhook_definition(&mut object_2, var_1)?;
        object_2.finish();
    }
