...
pub(crate) fn de_artifact_store<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::ArtifactStore>, ::aws_smithy_json::deserialize::error::DeserializeError>
                                ...
                                builder = builder.set_type(
                                    ::aws_smithy_json::deserialize::token::expect_string_or_null(tokens.next())?.map(|s|
                                        s.to_unescaped().map(|u|
                                            crate::types::ArtifactStoreType::from(u.as_ref())
                                        )
                                    ).transpose()?
                                );
                            }
