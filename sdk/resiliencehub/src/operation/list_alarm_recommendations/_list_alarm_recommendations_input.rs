...
impl ListAlarmRecommendationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_alarm_recommendations::ListAlarmRecommendationsInput, ::aws_smithy_http::operation::error::BuildError> {
