...
impl CreateRecommendationTemplateInput {
    /// Consumes the builder and constructs an Operation<[`CreateRecommendationTemplate`](crate::operation::create_recommendation_template::CreateRecommendationTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_recommendation_template::CreateRecommendationTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_recommendation_template::CreateRecommendationTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/create-recommendation-template").expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_recommendation_template::ser_create_recommendation_template_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_recommendation_template::CreateRecommendationTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateRecommendationTemplate", "resiliencehub"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateRecommendationTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRecommendationTemplate {
                type Output = ::std::result::Result<crate::operation::create_recommendation_template::CreateRecommendationTemplateOutput, crate::operation::create_recommendation_template::CreateRecommendationTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_recommendation_template::de_create_recommendation_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_recommendation_template::de_create_recommendation_template_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_recommendation_template::CreateRecommendationTemplateError {
...
mod _create_recommendation_template_output;
