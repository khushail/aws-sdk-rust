...
impl PutDraftAppVersionTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_draft_app_version_template::PutDraftAppVersionTemplateInput, ::aws_smithy_http::operation::error::BuildError> {
