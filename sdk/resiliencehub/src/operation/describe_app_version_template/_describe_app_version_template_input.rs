...
impl DescribeAppVersionTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_app_version_template::DescribeAppVersionTemplateInput, ::aws_smithy_http::operation::error::BuildError> {
