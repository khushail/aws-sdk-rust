...
impl ListAppVersionResourceMappingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_app_version_resource_mappings::ListAppVersionResourceMappingsInput, ::aws_smithy_http::operation::error::BuildError> {
