...
impl UpdateAppVersionResourceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_app_version_resource::UpdateAppVersionResourceInput, ::aws_smithy_http::operation::error::BuildError> {
