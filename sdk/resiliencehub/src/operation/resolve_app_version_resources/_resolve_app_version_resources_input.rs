...
impl ResolveAppVersionResourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::resolve_app_version_resources::ResolveAppVersionResourcesInput, ::aws_smithy_http::operation::error::BuildError> {
