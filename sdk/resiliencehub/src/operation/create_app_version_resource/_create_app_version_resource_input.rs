...
impl CreateAppVersionResourceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_app_version_resource::CreateAppVersionResourceInput, ::aws_smithy_http::operation::error::BuildError> {
