...
impl DeleteRecommendationTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_recommendation_template::DeleteRecommendationTemplateInput, ::aws_smithy_http::operation::error::BuildError> {
