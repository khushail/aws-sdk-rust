...
impl DescribeAppVersionResourceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_app_version_resource::DescribeAppVersionResourceInput, ::aws_smithy_http::operation::error::BuildError> {
