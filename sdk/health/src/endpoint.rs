...
mod test {
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://health.us-east-1.amazonaws.com");
                            assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://health.us-east-1.amazonaws.com")
    .build());
                }
    ...
    .build().expect("invalid params");
                    ...
                    let endpoint = endpoint.expect("Expected valid endpoint: https://health.cn-north-1.amazonaws.com.cn");
                            assert_eq!(endpoint, ::aws_smithy_types::endpoint::Endpoint::builder().url("https://health.cn-north-1.amazonaws.com.cn")
    .build());
                }
