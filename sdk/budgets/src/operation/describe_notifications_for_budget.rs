...
impl DescribeNotificationsForBudgetInput {
    /// Consumes the builder and constructs an Operation<[`DescribeNotificationsForBudget`](crate::operation::describe_notifications_for_budget::DescribeNotificationsForBudget)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_notifications_for_budget::DescribeNotificationsForBudget, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_notifications_for_budget::DescribeNotificationsForBudgetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_notifications_for_budget::DescribeNotificationsForBudget::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeNotificationsForBudget", "budgets"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeNotificationsForBudget`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNotificationsForBudget {
                type Output = ::std::result::Result<crate::operation::describe_notifications_for_budget::DescribeNotificationsForBudgetOutput, crate::operation::describe_notifications_for_budget::DescribeNotificationsForBudgetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_notifications_for_budget::de_describe_notifications_for_budget_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_notifications_for_budget::de_describe_notifications_for_budget_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeNotificationsForBudgetError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_notifications_for_budget::DescribeNotificationsForBudgetError {
...
mod _describe_notifications_for_budget_output;
