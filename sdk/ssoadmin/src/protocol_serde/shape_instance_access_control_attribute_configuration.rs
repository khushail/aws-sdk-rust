...
pub(crate) fn de_instance_access_control_attribute_configuration<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::InstanceAccessControlAttributeConfiguration>, ::aws_smithy_json::deserialize::error::DeserializeError>
