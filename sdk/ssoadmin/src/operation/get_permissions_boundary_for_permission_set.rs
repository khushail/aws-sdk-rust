...
impl GetPermissionsBoundaryForPermissionSetInput {
    /// Consumes the builder and constructs an Operation<[`GetPermissionsBoundaryForPermissionSet`](crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSet::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPermissionsBoundaryForPermissionSet {
                type Output = ::std::result::Result<crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetOutput, crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_permissions_boundary_for_permission_set::de_get_permissions_boundary_for_permission_set_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_permissions_boundary_for_permission_set::de_get_permissions_boundary_for_permission_set_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_permissions_boundary_for_permission_set::GetPermissionsBoundaryForPermissionSetError {
...
mod _get_permissions_boundary_for_permission_set_output;
