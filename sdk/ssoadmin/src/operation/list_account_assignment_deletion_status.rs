...
impl ListAccountAssignmentDeletionStatusInput {
    /// Consumes the builder and constructs an Operation<[`ListAccountAssignmentDeletionStatus`](crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatus::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListAccountAssignmentDeletionStatus {
                type Output = ::std::result::Result<crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusOutput, crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_account_assignment_deletion_status::de_list_account_assignment_deletion_status_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_account_assignment_deletion_status::de_list_account_assignment_deletion_status_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_account_assignment_deletion_status::ListAccountAssignmentDeletionStatusError {
...
mod _list_account_assignment_deletion_status_output;
