...
impl CreateAccountAssignmentInput {
    /// Consumes the builder and constructs an Operation<[`CreateAccountAssignment`](crate::operation::create_account_assignment::CreateAccountAssignment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_account_assignment::CreateAccountAssignment, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_account_assignment::CreateAccountAssignmentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_account_assignment::CreateAccountAssignmentInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_account_assignment::CreateAccountAssignment::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateAccountAssignment", "ssoadmin"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateAccountAssignment`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateAccountAssignment {
                type Output = ::std::result::Result<crate::operation::create_account_assignment::CreateAccountAssignmentOutput, crate::operation::create_account_assignment::CreateAccountAssignmentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_account_assignment::de_create_account_assignment_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_account_assignment::de_create_account_assignment_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_account_assignment::CreateAccountAssignmentError {
...
mod _create_account_assignment_output;
