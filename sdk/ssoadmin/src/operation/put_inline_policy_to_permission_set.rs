...
impl PutInlinePolicyToPermissionSetInput {
    /// Consumes the builder and constructs an Operation<[`PutInlinePolicyToPermissionSet`](crate::operation::put_inline_policy_to_permission_set::PutInlinePolicyToPermissionSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_inline_policy_to_permission_set::PutInlinePolicyToPermissionSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_inline_policy_to_permission_set::PutInlinePolicyToPermissionSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_inline_policy_to_permission_set::PutInlinePolicyToPermissionSet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutInlinePolicyToPermissionSet", "ssoadmin"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutInlinePolicyToPermissionSet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutInlinePolicyToPermissionSet {
                type Output = ::std::result::Result<crate::operation::put_inline_policy_to_permission_set::PutInlinePolicyToPermissionSetOutput, crate::operation::put_inline_policy_to_permission_set::PutInlinePolicyToPermissionSetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_inline_policy_to_permission_set::de_put_inline_policy_to_permission_set_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_inline_policy_to_permission_set::de_put_inline_policy_to_permission_set_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_inline_policy_to_permission_set::PutInlinePolicyToPermissionSetError {
...
mod _put_inline_policy_to_permission_set_output;
