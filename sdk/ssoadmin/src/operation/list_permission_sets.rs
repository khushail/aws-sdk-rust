...
impl ListPermissionSetsInput {
    /// Consumes the builder and constructs an Operation<[`ListPermissionSets`](crate::operation::list_permission_sets::ListPermissionSets)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_permission_sets::ListPermissionSets, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_permission_sets::ListPermissionSetsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_permission_sets::ListPermissionSets::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListPermissionSets", "ssoadmin"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListPermissionSets`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPermissionSets {
                type Output = ::std::result::Result<crate::operation::list_permission_sets::ListPermissionSetsOutput, crate::operation::list_permission_sets::ListPermissionSetsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_permission_sets::de_list_permission_sets_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_permission_sets::de_list_permission_sets_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_permission_sets::ListPermissionSetsError {
...
mod _list_permission_sets_output;
