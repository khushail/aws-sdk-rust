...
impl DetachManagedPolicyFromPermissionSetInput {
    /// Consumes the builder and constructs an Operation<[`DetachManagedPolicyFromPermissionSet`](crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSet)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSet, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSet::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetachManagedPolicyFromPermissionSet", "ssoadmin"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DetachManagedPolicyFromPermissionSet`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachManagedPolicyFromPermissionSet {
                type Output = ::std::result::Result<crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetOutput, crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_detach_managed_policy_from_permission_set::de_detach_managed_policy_from_permission_set_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_detach_managed_policy_from_permission_set::de_detach_managed_policy_from_permission_set_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::detach_managed_policy_from_permission_set::DetachManagedPolicyFromPermissionSetError {
...
mod _detach_managed_policy_from_permission_set_output;
