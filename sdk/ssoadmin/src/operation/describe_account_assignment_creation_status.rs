...
impl DescribeAccountAssignmentCreationStatusInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAccountAssignmentCreationStatus`](crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatus)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatus, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatus::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAccountAssignmentCreationStatus {
                type Output = ::std::result::Result<crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusOutput, crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_account_assignment_creation_status::de_describe_account_assignment_creation_status_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_account_assignment_creation_status::de_describe_account_assignment_creation_status_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_account_assignment_creation_status::DescribeAccountAssignmentCreationStatusError {
...
mod _describe_account_assignment_creation_status_output;
