...
impl super::Client  {
    ...
    ///   - [`discovery_job_arn(impl ::std::convert::Into<String>)`](crate::operation::generate_recommendations::builders::GenerateRecommendationsFluentBuilder::discovery_job_arn) / [`set_discovery_job_arn(Option<String>)`](crate::operation::generate_recommendations::builders::GenerateRecommendationsFluentBuilder::set_discovery_job_arn): <p>Specifies the Amazon Resource Name (ARN) of the discovery job that collects information about your on-premises storage system.</p>
    ///   - [`resource_ids(Vec<String>)`](crate::operation::generate_recommendations::builders::GenerateRecommendationsFluentBuilder::resource_ids) / [`set_resource_ids(Option<Vec<String>>)`](crate::operation::generate_recommendations::builders::GenerateRecommendationsFluentBuilder::set_resource_ids): <p>Specifies the universally unique identifiers (UUIDs) of the resources in your storage system that you want recommendations on.</p>
