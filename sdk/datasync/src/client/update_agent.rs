...
impl super::Client  {
    ...
    ///   - [`agent_arn(impl ::std::convert::Into<String>)`](crate::operation::update_agent::builders::UpdateAgentFluentBuilder::agent_arn) / [`set_agent_arn(Option<String>)`](crate::operation::update_agent::builders::UpdateAgentFluentBuilder::set_agent_arn): <p>The Amazon Resource Name (ARN) of the agent to update.</p>
