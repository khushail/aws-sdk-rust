...
impl super::Client  {
    ...
    ///   - [`max_results(i32)`](crate::operation::list_storage_systems::builders::ListStorageSystemsFluentBuilder::max_results) / [`set_max_results(Option<i32>)`](crate::operation::list_storage_systems::builders::ListStorageSystemsFluentBuilder::set_max_results): <p>Specifies how many results you want in the response.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_storage_systems::builders::ListStorageSystemsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_storage_systems::builders::ListStorageSystemsFluentBuilder::set_next_token): <p>Specifies an opaque string that indicates the position to begin the next list of results in the response. </p>
