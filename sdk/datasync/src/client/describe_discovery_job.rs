...
impl super::Client  {
    ...
    ///   - [`discovery_job_arn(impl ::std::convert::Into<String>)`](crate::operation::describe_discovery_job::builders::DescribeDiscoveryJobFluentBuilder::discovery_job_arn) / [`set_discovery_job_arn(Option<String>)`](crate::operation::describe_discovery_job::builders::DescribeDiscoveryJobFluentBuilder::set_discovery_job_arn): <p>Specifies the Amazon Resource Name (ARN) of the discovery job that you want information about.</p>
