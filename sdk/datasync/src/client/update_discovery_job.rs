...
impl super::Client  {
    ...
    ///   - [`discovery_job_arn(impl ::std::convert::Into<String>)`](crate::operation::update_discovery_job::builders::UpdateDiscoveryJobFluentBuilder::discovery_job_arn) / [`set_discovery_job_arn(Option<String>)`](crate::operation::update_discovery_job::builders::UpdateDiscoveryJobFluentBuilder::set_discovery_job_arn): <p>Specifies the Amazon Resource Name (ARN) of the discovery job that you want to update.</p>
