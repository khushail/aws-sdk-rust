...
impl DescribeStorageSystemResourcesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_storage_system_resources::DescribeStorageSystemResourcesInput, ::aws_smithy_http::operation::error::BuildError> {
