...
impl CreateLocationSmbInput {
    /// Consumes the builder and constructs an Operation<[`CreateLocationSmb`](crate::operation::create_location_smb::CreateLocationSmb)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_location_smb::CreateLocationSmb, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_location_smb::CreateLocationSmbInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_location_smb::CreateLocationSmb::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateLocationSmb", "datasync"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateLocationSmb`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateLocationSmb {
                type Output = ::std::result::Result<crate::operation::create_location_smb::CreateLocationSmbOutput, crate::operation::create_location_smb::CreateLocationSmbError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_location_smb::de_create_location_smb_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_location_smb::de_create_location_smb_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_location_smb::CreateLocationSmbError {
...
mod _create_location_smb_output;
