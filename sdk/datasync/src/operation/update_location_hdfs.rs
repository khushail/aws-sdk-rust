...
impl UpdateLocationHdfsInput {
    /// Consumes the builder and constructs an Operation<[`UpdateLocationHdfs`](crate::operation::update_location_hdfs::UpdateLocationHdfs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_location_hdfs::UpdateLocationHdfs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_location_hdfs::UpdateLocationHdfsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_location_hdfs::UpdateLocationHdfs::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateLocationHdfs", "datasync"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateLocationHdfs`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateLocationHdfs {
                type Output = ::std::result::Result<crate::operation::update_location_hdfs::UpdateLocationHdfsOutput, crate::operation::update_location_hdfs::UpdateLocationHdfsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_location_hdfs::de_update_location_hdfs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_location_hdfs::de_update_location_hdfs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_location_hdfs::UpdateLocationHdfsError {
...
mod _update_location_hdfs_output;
