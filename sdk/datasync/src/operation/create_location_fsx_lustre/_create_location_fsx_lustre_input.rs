...
impl CreateLocationFsxLustreInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_location_fsx_lustre::CreateLocationFsxLustreInput, ::aws_smithy_http::operation::error::BuildError> {
