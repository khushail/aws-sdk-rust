...
impl DescribeLocationObjectStorageInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_location_object_storage::DescribeLocationObjectStorageInput, ::aws_smithy_http::operation::error::BuildError> {
