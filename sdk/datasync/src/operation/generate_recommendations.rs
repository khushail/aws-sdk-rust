...
impl GenerateRecommendationsInput {
    /// Consumes the builder and constructs an Operation<[`GenerateRecommendations`](crate::operation::generate_recommendations::GenerateRecommendations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::generate_recommendations::GenerateRecommendations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::generate_recommendations::GenerateRecommendationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            builder = ::aws_smithy_http::header::set_request_header_if_absent(
                                ...
                                "FmrsService.GenerateRecommendations"
                            );
            builder
        };
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_generate_recommendations::ser_generate_recommendations_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::generate_recommendations::GenerateRecommendations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GenerateRecommendations", "datasync"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GenerateRecommendations {
                type Output = ::std::result::Result<crate::operation::generate_recommendations::GenerateRecommendationsOutput, crate::operation::generate_recommendations::GenerateRecommendationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_generate_recommendations::de_generate_recommendations_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GenerateRecommendationsErrorKind = GenerateRecommendationsError;
...
impl ::aws_http::request_id::RequestId for crate::operation::generate_recommendations::GenerateRecommendationsError {
...
impl GenerateRecommendationsError {
    ...
    /// Returns `true` if the error kind is `GenerateRecommendationsError::InternalException`.
    pub fn is_internal_exception(&self) -> bool {
        matches!(self, Self::InternalException(_))
    }
    /// Returns `true` if the error kind is `GenerateRecommendationsError::InvalidRequestException`.
