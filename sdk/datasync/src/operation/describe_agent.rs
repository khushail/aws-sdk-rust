...
impl DescribeAgentInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAgent`](crate::operation::describe_agent::DescribeAgent)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_agent::DescribeAgent, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_agent::DescribeAgentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_agent::DescribeAgent::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAgent {
                type Output = ::std::result::Result<crate::operation::describe_agent::DescribeAgentOutput, crate::operation::describe_agent::DescribeAgentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_describe_agent::de_describe_agent_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_agent::DescribeAgentError {
