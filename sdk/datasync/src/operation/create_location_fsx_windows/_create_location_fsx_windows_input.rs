...
impl CreateLocationFsxWindowsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_location_fsx_windows::CreateLocationFsxWindowsInput, ::aws_smithy_http::operation::error::BuildError> {
