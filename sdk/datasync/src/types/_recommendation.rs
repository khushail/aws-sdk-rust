...
impl RecommendationBuilder {
    ...
    ///
    /// <p>Information about how you can set up a recommended Amazon Web Services storage service.</p>
    pub fn storage_configuration(mut self, k: impl ::std::convert::Into<::std::string::String>, v: impl ::std::convert::Into<::std::string::String>) -> Self {
    ...
    /// <p>Information about how you can set up a recommended Amazon Web Services storage service.</p>
    pub fn set_storage_configuration(mut self, input: ::std::option::Option<::std::collections::HashMap<::std::string::String, ::std::string::String>>) -> Self {
    ...
    pub fn set_estimated_monthly_storage_cost(mut self, input: ::std::option::Option<::std::string::String>) -> Self {
        self.estimated_monthly_storage_cost = input; self
    }
    /// <p>The estimated monthly cost of the recommended Amazon Web Services storage service.</p>
