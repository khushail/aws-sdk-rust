...
#[allow(clippy::unnecessary_wraps)]
pub fn de_failover_shard_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::failover_shard::FailoverShardOutput, crate::operation::failover_shard::FailoverShardError> {
    Ok({
        #[allow(unused_mut)]
