...
pub fn de_create_cluster_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_cluster::CreateClusterOutput, crate::operation::create_cluster::CreateClusterError> {
    ...
    Err(match error_code {
        "ACLNotFoundFault" => crate::operation::create_cluster::CreateClusterError::AclNotFoundFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidACLStateFault" => crate::operation::create_cluster::CreateClusterError::InvalidAclStateFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "InvalidCredentialsException" => crate::operation::create_cluster::CreateClusterError::InvalidCredentialsException({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
        ...
        "ShardsPerClusterQuotaExceededFault" => crate::operation::create_cluster::CreateClusterError::ShardsPerClusterQuotaExceededFault({
            #[allow(unused_mut)]
            let mut tmp =
                 {
                    #[allow(unused_mut)]
