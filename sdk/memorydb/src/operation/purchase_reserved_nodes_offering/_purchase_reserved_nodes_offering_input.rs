...
impl PurchaseReservedNodesOfferingInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::purchase_reserved_nodes_offering::PurchaseReservedNodesOfferingInput, ::aws_smithy_http::operation::error::BuildError> {
