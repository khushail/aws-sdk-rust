...
impl FailoverShardInput {
    /// Consumes the builder and constructs an Operation<[`FailoverShard`](crate::operation::failover_shard::FailoverShard)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::failover_shard::FailoverShard, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::failover_shard::FailoverShardInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_failover_shard::ser_failover_shard_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::failover_shard::FailoverShard::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("FailoverShard", "memorydb"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `FailoverShard`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for FailoverShard {
                type Output = ::std::result::Result<crate::operation::failover_shard::FailoverShardOutput, crate::operation::failover_shard::FailoverShardError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_failover_shard::de_failover_shard_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_failover_shard::de_failover_shard_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::failover_shard::FailoverShardError {
