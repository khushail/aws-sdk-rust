...
#[allow(clippy::unnecessary_wraps)]
pub fn de_send_event_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::send_event::SendEventOutput, crate::operation::send_event::SendEventError> {
    Ok({
        #[allow(unused_mut)]
