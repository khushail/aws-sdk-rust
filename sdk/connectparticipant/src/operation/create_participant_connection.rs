...
impl CreateParticipantConnectionInput {
    /// Consumes the builder and constructs an Operation<[`CreateParticipantConnection`](crate::operation::create_participant_connection::CreateParticipantConnection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_participant_connection::CreateParticipantConnection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_participant_connection::CreateParticipantConnectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/participant/connection").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_participant_connection::CreateParticipantConnection::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateParticipantConnection {
                type Output = ::std::result::Result<crate::operation::create_participant_connection::CreateParticipantConnectionOutput, crate::operation::create_participant_connection::CreateParticipantConnectionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_participant_connection::de_create_participant_connection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_participant_connection::de_create_participant_connection_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::create_participant_connection::CreateParticipantConnectionError {
...
mod _create_participant_connection_output;
