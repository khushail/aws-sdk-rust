...
impl StartAttachmentUploadInput {
    /// Consumes the builder and constructs an Operation<[`StartAttachmentUpload`](crate::operation::start_attachment_upload::StartAttachmentUpload)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_attachment_upload::StartAttachmentUpload, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_attachment_upload::StartAttachmentUploadInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/participant/start-attachment-upload").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_attachment_upload::StartAttachmentUpload::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartAttachmentUpload", "connectparticipant"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartAttachmentUpload`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartAttachmentUpload {
                type Output = ::std::result::Result<crate::operation::start_attachment_upload::StartAttachmentUploadOutput, crate::operation::start_attachment_upload::StartAttachmentUploadError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_attachment_upload::de_start_attachment_upload_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_start_attachment_upload::de_start_attachment_upload_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::start_attachment_upload::StartAttachmentUploadError {
...
mod _start_attachment_upload_output;
