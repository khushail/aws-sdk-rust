...
impl CompleteAttachmentUploadInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::complete_attachment_upload::CompleteAttachmentUploadInput, ::aws_smithy_http::operation::error::BuildError> {
