...
impl super::Client  {
    ...
    ///   - [`app_id(impl ::std::convert::Into<String>)`](crate::operation::create_deployment::builders::CreateDeploymentFluentBuilder::app_id) / [`set_app_id(Option<String>)`](crate::operation::create_deployment::builders::CreateDeploymentFluentBuilder::set_app_id): <p> The unique ID for an Amplify app. </p>
    ///   - [`branch_name(impl ::std::convert::Into<String>)`](crate::operation::create_deployment::builders::CreateDeploymentFluentBuilder::branch_name) / [`set_branch_name(Option<String>)`](crate::operation::create_deployment::builders::CreateDeploymentFluentBuilder::set_branch_name): <p> The name for the branch, for the job. </p>
