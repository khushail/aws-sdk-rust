...
impl ListDomainAssociationsInput {
    /// Consumes the builder and constructs an Operation<[`ListDomainAssociations`](crate::operation::list_domain_associations::ListDomainAssociations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_domain_associations::ListDomainAssociations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_domain_associations::ListDomainAssociationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_domain_associations::ListDomainAssociationsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_domain_associations::ListDomainAssociationsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_domain_associations::ListDomainAssociations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDomainAssociations", "amplify"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListDomainAssociations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDomainAssociations {
                type Output = ::std::result::Result<crate::operation::list_domain_associations::ListDomainAssociationsOutput, crate::operation::list_domain_associations::ListDomainAssociationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_domain_associations::de_list_domain_associations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_domain_associations::de_list_domain_associations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_domain_associations::ListDomainAssociationsError {
...
mod _list_domain_associations_output;
