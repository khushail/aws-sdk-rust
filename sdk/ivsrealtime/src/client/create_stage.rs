...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_name): <p>Optional name that can be specified for the stage being created.</p>
    ///   - [`participant_token_configurations(Vec<ParticipantTokenConfiguration>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::participant_token_configurations) / [`set_participant_token_configurations(Option<Vec<ParticipantTokenConfiguration>>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_participant_token_configurations): <p>Array of participant token configuration objects to attach to the new stage.</p>
    ///   - [`tags(HashMap<String, String>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::tags) / [`set_tags(Option<HashMap<String, String>>)`](crate::operation::create_stage::builders::CreateStageFluentBuilder::set_tags): <p>Tags attached to the resource. Array of maps, each of the form <code>string:string (key:value)</code>. See <a href="https://docs.aws.amazon.com/general/latest/gr/aws_tagging.html">Tagging AWS Resources</a> for details, including restrictions that apply to tags and "Tag naming limits and requirements"; Amazon IVS has no constraints on tags beyond what is documented there. </p>
