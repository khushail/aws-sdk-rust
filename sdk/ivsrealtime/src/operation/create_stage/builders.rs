...
impl CreateStageFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::create_stage::CreateStageOutput, ::aws_smithy_http::result::SdkError<crate::operation::create_stage::CreateStageError>>
                         {
    ...
    /// <p>Array of participant token configuration objects to attach to the new stage.</p>
    pub fn set_participant_token_configurations(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::ParticipantTokenConfiguration>>) -> Self {
