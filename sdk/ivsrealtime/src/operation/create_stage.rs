...
impl CreateStageInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_stage::CreateStage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_stage::CreateStageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/CreateStage").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_stage::CreateStage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateStage", "ivsrealtime"));
...
impl CreateStageError {
    ...
    /// Returns `true` if the error kind is `CreateStageError::PendingVerification`.
    pub fn is_pending_verification(&self) -> bool {
        matches!(self, Self::PendingVerification(_))
    }
    /// Returns `true` if the error kind is `CreateStageError::ServiceQuotaExceededException`.
