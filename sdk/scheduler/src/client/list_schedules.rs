...
impl super::Client  {
    ...
    ///   - [`group_name(impl ::std::convert::Into<String>)`](crate::operation::list_schedules::builders::ListSchedulesFluentBuilder::group_name) / [`set_group_name(Option<String>)`](crate::operation::list_schedules::builders::ListSchedulesFluentBuilder::set_group_name): <p>If specified, only lists the schedules whose associated schedule group matches the given filter.</p>
    ///   - [`name_prefix(impl ::std::convert::Into<String>)`](crate::operation::list_schedules::builders::ListSchedulesFluentBuilder::name_prefix) / [`set_name_prefix(Option<String>)`](crate::operation::list_schedules::builders::ListSchedulesFluentBuilder::set_name_prefix): <p>Schedule name prefix to return the filtered list of resources.</p>
