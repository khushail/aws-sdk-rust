...
impl DeleteScheduleGroupInput {
    /// Consumes the builder and constructs an Operation<[`DeleteScheduleGroup`](crate::operation::delete_schedule_group::DeleteScheduleGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_schedule_group::DeleteScheduleGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_schedule_group::DeleteScheduleGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/schedule-groups/{Name}", Name = name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::delete_schedule_group::DeleteScheduleGroupInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_schedule_group::DeleteScheduleGroupInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_schedule_group::DeleteScheduleGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteScheduleGroup", "scheduler"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteScheduleGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteScheduleGroup {
                type Output = ::std::result::Result<crate::operation::delete_schedule_group::DeleteScheduleGroupOutput, crate::operation::delete_schedule_group::DeleteScheduleGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_schedule_group::de_delete_schedule_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_schedule_group::de_delete_schedule_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_schedule_group::DeleteScheduleGroupError {
...
pub use crate::operation::delete_schedule_group::_delete_schedule_group_output::DeleteScheduleGroupOutput;

pub use crate::operation::delete_schedule_group::_delete_schedule_group_input::DeleteScheduleGroupInput;

mod _delete_schedule_group_input;

mod _delete_schedule_group_output;
