...
impl super::Client  {
    ...
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::set_client_token): <p>A token that ensures idempotency. This token expires in 10 minutes.</p>
    ///   - [`dataset_id(impl ::std::convert::Into<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::dataset_id) / [`set_dataset_id(Option<String>)`](crate::operation::delete_dataset::builders::DeleteDatasetFluentBuilder::set_dataset_id): <p>The unique identifier of the Dataset to be deleted.</p>
