...
impl super::Client  {
    ...
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::disable_user::builders::DisableUserFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::disable_user::builders::DisableUserFluentBuilder::set_user_id): <p>The unique identifier for the user account that you want to disable.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::disable_user::builders::DisableUserFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::disable_user::builders::DisableUserFluentBuilder::set_client_token): <p>A token that ensures idempotency. This token expires in 10 minutes.</p>
