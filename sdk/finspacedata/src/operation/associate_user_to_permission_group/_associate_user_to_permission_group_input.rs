...
impl AssociateUserToPermissionGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_user_to_permission_group::AssociateUserToPermissionGroupInput, ::aws_smithy_http::operation::error::BuildError> {
