...
impl GetApnsSandboxChannelInput {
    /// Consumes the builder and constructs an Operation<[`GetApnsSandboxChannel`](crate::operation::get_apns_sandbox_channel::GetApnsSandboxChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_apns_sandbox_channel::GetApnsSandboxChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_apns_sandbox_channel::GetApnsSandboxChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_apns_sandbox_channel::GetApnsSandboxChannelInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_apns_sandbox_channel::GetApnsSandboxChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetApnsSandboxChannel", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetApnsSandboxChannel`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetApnsSandboxChannel {
                type Output = ::std::result::Result<crate::operation::get_apns_sandbox_channel::GetApnsSandboxChannelOutput, crate::operation::get_apns_sandbox_channel::GetApnsSandboxChannelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_apns_sandbox_channel::de_get_apns_sandbox_channel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_apns_sandbox_channel::de_get_apns_sandbox_channel_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetApnsSandboxChannelErrorKind = GetApnsSandboxChannelError;
/// Error type for the `GetApnsSandboxChannelError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetApnsSandboxChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_apns_sandbox_channel::GetApnsSandboxChannelError {
...
impl GetApnsSandboxChannelError {
    /// Creates the `GetApnsSandboxChannelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetApnsSandboxChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetApnsSandboxChannelError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `GetApnsSandboxChannelError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `GetApnsSandboxChannelError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetApnsSandboxChannelError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `GetApnsSandboxChannelError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetApnsSandboxChannelError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetApnsSandboxChannelError::TooManyRequestsException`.
...
mod _get_apns_sandbox_channel_output;
