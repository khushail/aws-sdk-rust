...
impl PutEventStreamInput {
    /// Consumes the builder and constructs an Operation<[`PutEventStream`](crate::operation::put_event_stream::PutEventStream)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_event_stream::PutEventStream, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_event_stream::PutEventStreamInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::put_event_stream::PutEventStreamInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_event_stream::PutEventStream::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutEventStream", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutEventStream`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutEventStream {
                type Output = ::std::result::Result<crate::operation::put_event_stream::PutEventStreamOutput, crate::operation::put_event_stream::PutEventStreamError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_event_stream::de_put_event_stream_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_event_stream::de_put_event_stream_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type PutEventStreamErrorKind = PutEventStreamError;
/// Error type for the `PutEventStreamError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PutEventStreamError {
...
impl ::aws_http::request_id::RequestId for crate::operation::put_event_stream::PutEventStreamError {
...
impl PutEventStreamError {
    /// Creates the `PutEventStreamError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `PutEventStreamError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `PutEventStreamError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `PutEventStreamError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `PutEventStreamError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `PutEventStreamError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `PutEventStreamError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `PutEventStreamError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `PutEventStreamError::TooManyRequestsException`.
