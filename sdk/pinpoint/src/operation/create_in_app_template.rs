...
impl CreateInAppTemplateInput {
    /// Consumes the builder and constructs an Operation<[`CreateInAppTemplate`](crate::operation::create_in_app_template::CreateInAppTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_in_app_template::CreateInAppTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_in_app_template::CreateInAppTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_in_app_template::CreateInAppTemplateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_in_app_template::CreateInAppTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateInAppTemplate", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreateInAppTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateInAppTemplate {
                type Output = ::std::result::Result<crate::operation::create_in_app_template::CreateInAppTemplateOutput, crate::operation::create_in_app_template::CreateInAppTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_in_app_template::de_create_in_app_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_in_app_template::de_create_in_app_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateInAppTemplateErrorKind = CreateInAppTemplateError;
/// Error type for the `CreateInAppTemplateError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum CreateInAppTemplateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateInAppTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_in_app_template::CreateInAppTemplateError {
...
impl CreateInAppTemplateError {
    /// Creates the `CreateInAppTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateInAppTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateInAppTemplateError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateInAppTemplateError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateInAppTemplateError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateInAppTemplateError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `CreateInAppTemplateError::TooManyRequestsException`.
...
mod _create_in_app_template_output;
