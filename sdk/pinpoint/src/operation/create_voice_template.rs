...
impl CreateVoiceTemplateInput {
    /// Consumes the builder and constructs an Operation<[`CreateVoiceTemplate`](crate::operation::create_voice_template::CreateVoiceTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_voice_template::CreateVoiceTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_voice_template::CreateVoiceTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_voice_template::CreateVoiceTemplateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_voice_template::CreateVoiceTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateVoiceTemplate", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateVoiceTemplate {
                type Output = ::std::result::Result<crate::operation::create_voice_template::CreateVoiceTemplateOutput, crate::operation::create_voice_template::CreateVoiceTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_voice_template::de_create_voice_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_voice_template::de_create_voice_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateVoiceTemplateErrorKind = CreateVoiceTemplateError;
/// Error type for the `CreateVoiceTemplateError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateVoiceTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_voice_template::CreateVoiceTemplateError {
...
impl CreateVoiceTemplateError {
    /// Creates the `CreateVoiceTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateVoiceTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateVoiceTemplateError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateVoiceTemplateError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateVoiceTemplateError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateVoiceTemplateError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `CreateVoiceTemplateError::TooManyRequestsException`.
...
mod _create_voice_template_output;
