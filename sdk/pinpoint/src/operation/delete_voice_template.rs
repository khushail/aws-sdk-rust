...
impl DeleteVoiceTemplateInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVoiceTemplate`](crate::operation::delete_voice_template::DeleteVoiceTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_voice_template::DeleteVoiceTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_voice_template::DeleteVoiceTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_voice_template::DeleteVoiceTemplateInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_voice_template::DeleteVoiceTemplateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_voice_template::DeleteVoiceTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteVoiceTemplate", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteVoiceTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVoiceTemplate {
                type Output = ::std::result::Result<crate::operation::delete_voice_template::DeleteVoiceTemplateOutput, crate::operation::delete_voice_template::DeleteVoiceTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_delete_voice_template::de_delete_voice_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_voice_template::de_delete_voice_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteVoiceTemplateErrorKind = DeleteVoiceTemplateError;
/// Error type for the `DeleteVoiceTemplateError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteVoiceTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_voice_template::DeleteVoiceTemplateError {
...
impl DeleteVoiceTemplateError {
    /// Creates the `DeleteVoiceTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVoiceTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteVoiceTemplateError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceTemplateError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceTemplateError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceTemplateError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceTemplateError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceTemplateError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceTemplateError::TooManyRequestsException`.
...
mod _delete_voice_template_output;
