...
impl SendUsersMessagesInput {
    /// Consumes the builder and constructs an Operation<[`SendUsersMessages`](crate::operation::send_users_messages::SendUsersMessages)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::send_users_messages::SendUsersMessages, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_users_messages::SendUsersMessagesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/apps/{ApplicationId}/users-messages", ApplicationId = application_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::send_users_messages::SendUsersMessagesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::send_users_messages::SendUsersMessages::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SendUsersMessages", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendUsersMessages {
                type Output = ::std::result::Result<crate::operation::send_users_messages::SendUsersMessagesOutput, crate::operation::send_users_messages::SendUsersMessagesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_send_users_messages::de_send_users_messages_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_send_users_messages::de_send_users_messages_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type SendUsersMessagesErrorKind = SendUsersMessagesError;
/// Error type for the `SendUsersMessagesError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SendUsersMessagesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::send_users_messages::SendUsersMessagesError {
...
impl SendUsersMessagesError {
    /// Creates the `SendUsersMessagesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SendUsersMessagesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `SendUsersMessagesError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `SendUsersMessagesError::TooManyRequestsException`.
...
mod _send_users_messages_output;
