...
impl CreateRecommenderConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_recommender_configuration::CreateRecommenderConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
