...
impl SendOtpMessageInput {
    /// Consumes the builder and constructs an Operation<[`SendOTPMessage`](crate::operation::send_otp_message::SendOTPMessage)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::send_otp_message::SendOTPMessage, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::send_otp_message::SendOtpMessageInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/apps/{ApplicationId}/otp", ApplicationId = application_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::send_otp_message::SendOtpMessageInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::send_otp_message::SendOTPMessage::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("SendOTPMessage", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for SendOTPMessage {
                type Output = ::std::result::Result<crate::operation::send_otp_message::SendOtpMessageOutput, crate::operation::send_otp_message::SendOTPMessageError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_send_otp_message::de_send_otp_message_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_send_otp_message::de_send_otp_message_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type SendOTPMessageErrorKind = SendOTPMessageError;
/// Error type for the `SendOTPMessageError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum SendOTPMessageError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for SendOTPMessageError {
...
impl ::aws_http::request_id::RequestId for crate::operation::send_otp_message::SendOTPMessageError {
...
impl SendOTPMessageError {
    /// Creates the `SendOTPMessageError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `SendOTPMessageError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `SendOTPMessageError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `SendOTPMessageError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `SendOTPMessageError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `SendOTPMessageError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `SendOTPMessageError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `SendOTPMessageError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `SendOTPMessageError::TooManyRequestsException`.
...
pub use crate::operation::send_otp_message::_send_otp_message_output::SendOtpMessageOutput;

pub use crate::operation::send_otp_message::_send_otp_message_input::SendOtpMessageInput;

mod _send_otp_message_input;

mod _send_otp_message_output;
