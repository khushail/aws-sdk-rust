...
impl DeleteApnsSandboxChannelInput {
    /// Consumes the builder and constructs an Operation<[`DeleteApnsSandboxChannel`](crate::operation::delete_apns_sandbox_channel::DeleteApnsSandboxChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_apns_sandbox_channel::DeleteApnsSandboxChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_apns_sandbox_channel::DeleteApnsSandboxChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_apns_sandbox_channel::DeleteApnsSandboxChannelInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_apns_sandbox_channel::DeleteApnsSandboxChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteApnsSandboxChannel", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteApnsSandboxChannel {
                type Output = ::std::result::Result<crate::operation::delete_apns_sandbox_channel::DeleteApnsSandboxChannelOutput, crate::operation::delete_apns_sandbox_channel::DeleteApnsSandboxChannelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_apns_sandbox_channel::de_delete_apns_sandbox_channel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_apns_sandbox_channel::de_delete_apns_sandbox_channel_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteApnsSandboxChannelErrorKind = DeleteApnsSandboxChannelError;
/// Error type for the `DeleteApnsSandboxChannelError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteApnsSandboxChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_apns_sandbox_channel::DeleteApnsSandboxChannelError {
...
impl DeleteApnsSandboxChannelError {
    /// Creates the `DeleteApnsSandboxChannelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteApnsSandboxChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteApnsSandboxChannelError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsSandboxChannelError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsSandboxChannelError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsSandboxChannelError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsSandboxChannelError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsSandboxChannelError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteApnsSandboxChannelError::TooManyRequestsException`.
...
mod _delete_apns_sandbox_channel_output;
