...
impl UpdateGcmChannelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateGcmChannel`](crate::operation::update_gcm_channel::UpdateGcmChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_gcm_channel::UpdateGcmChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_gcm_channel::UpdateGcmChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_gcm_channel::UpdateGcmChannelInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_gcm_channel::UpdateGcmChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateGcmChannel", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateGcmChannel {
                type Output = ::std::result::Result<crate::operation::update_gcm_channel::UpdateGcmChannelOutput, crate::operation::update_gcm_channel::UpdateGcmChannelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_gcm_channel::de_update_gcm_channel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_gcm_channel::de_update_gcm_channel_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateGcmChannelErrorKind = UpdateGcmChannelError;
/// Error type for the `UpdateGcmChannelError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateGcmChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_gcm_channel::UpdateGcmChannelError {
...
impl UpdateGcmChannelError {
    /// Creates the `UpdateGcmChannelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateGcmChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateGcmChannelError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateGcmChannelError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateGcmChannelError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateGcmChannelError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `UpdateGcmChannelError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateGcmChannelError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateGcmChannelError::TooManyRequestsException`.
...
mod _update_gcm_channel_output;
