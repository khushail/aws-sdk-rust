...
impl GetJourneyExecutionMetricsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_journey_execution_metrics::GetJourneyExecutionMetricsInput, ::aws_smithy_http::operation::error::BuildError> {
