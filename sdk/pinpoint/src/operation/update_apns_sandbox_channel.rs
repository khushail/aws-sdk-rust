...
impl UpdateApnsSandboxChannelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateApnsSandboxChannel`](crate::operation::update_apns_sandbox_channel::UpdateApnsSandboxChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_apns_sandbox_channel::UpdateApnsSandboxChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_apns_sandbox_channel::UpdateApnsSandboxChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/apps/{ApplicationId}/channels/apns_sandbox", ApplicationId = application_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::update_apns_sandbox_channel::UpdateApnsSandboxChannelInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_apns_sandbox_channel::UpdateApnsSandboxChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateApnsSandboxChannel", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateApnsSandboxChannel`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApnsSandboxChannel {
                type Output = ::std::result::Result<crate::operation::update_apns_sandbox_channel::UpdateApnsSandboxChannelOutput, crate::operation::update_apns_sandbox_channel::UpdateApnsSandboxChannelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_apns_sandbox_channel::de_update_apns_sandbox_channel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_apns_sandbox_channel::de_update_apns_sandbox_channel_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateApnsSandboxChannelErrorKind = UpdateApnsSandboxChannelError;
/// Error type for the `UpdateApnsSandboxChannelError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateApnsSandboxChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_apns_sandbox_channel::UpdateApnsSandboxChannelError {
...
impl UpdateApnsSandboxChannelError {
    /// Creates the `UpdateApnsSandboxChannelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateApnsSandboxChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateApnsSandboxChannelError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsSandboxChannelError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsSandboxChannelError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsSandboxChannelError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsSandboxChannelError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsSandboxChannelError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsSandboxChannelError::TooManyRequestsException`.
...
mod _update_apns_sandbox_channel_output;
