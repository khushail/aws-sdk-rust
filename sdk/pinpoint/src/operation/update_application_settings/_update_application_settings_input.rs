...
impl UpdateApplicationSettingsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_application_settings::UpdateApplicationSettingsInput, ::aws_smithy_http::operation::error::BuildError> {
