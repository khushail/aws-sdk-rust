...
impl UpdateInAppTemplateInput {
    /// Consumes the builder and constructs an Operation<[`UpdateInAppTemplate`](crate::operation::update_in_app_template::UpdateInAppTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_in_app_template::UpdateInAppTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_in_app_template::UpdateInAppTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::update_in_app_template::UpdateInAppTemplateInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_in_app_template::UpdateInAppTemplateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_in_app_template::UpdateInAppTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateInAppTemplate", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateInAppTemplate {
                type Output = ::std::result::Result<crate::operation::update_in_app_template::UpdateInAppTemplateOutput, crate::operation::update_in_app_template::UpdateInAppTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_update_in_app_template::de_update_in_app_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_in_app_template::de_update_in_app_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateInAppTemplateErrorKind = UpdateInAppTemplateError;
/// Error type for the `UpdateInAppTemplateError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum UpdateInAppTemplateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateInAppTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_in_app_template::UpdateInAppTemplateError {
...
impl UpdateInAppTemplateError {
    /// Creates the `UpdateInAppTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateInAppTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateInAppTemplateError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateInAppTemplateError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateInAppTemplateError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateInAppTemplateError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `UpdateInAppTemplateError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateInAppTemplateError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateInAppTemplateError::TooManyRequestsException`.
...
mod _update_in_app_template_output;
