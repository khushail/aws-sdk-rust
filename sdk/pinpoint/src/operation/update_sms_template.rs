...
impl UpdateSmsTemplateInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSmsTemplate`](crate::operation::update_sms_template::UpdateSmsTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_sms_template::UpdateSmsTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_sms_template::UpdateSmsTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::update_sms_template::UpdateSmsTemplateInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_sms_template::UpdateSmsTemplateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_sms_template::UpdateSmsTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateSmsTemplate", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateSmsTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSmsTemplate {
                type Output = ::std::result::Result<crate::operation::update_sms_template::UpdateSmsTemplateOutput, crate::operation::update_sms_template::UpdateSmsTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_update_sms_template::de_update_sms_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_sms_template::de_update_sms_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateSmsTemplateErrorKind = UpdateSmsTemplateError;
/// Error type for the `UpdateSmsTemplateError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateSmsTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_sms_template::UpdateSmsTemplateError {
...
impl UpdateSmsTemplateError {
    /// Creates the `UpdateSmsTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateSmsTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateSmsTemplateError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsTemplateError::TooManyRequestsException`.
...
mod _update_sms_template_output;
