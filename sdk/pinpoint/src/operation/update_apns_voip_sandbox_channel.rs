...
impl UpdateApnsVoipSandboxChannelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateApnsVoipSandboxChannel`](crate::operation::update_apns_voip_sandbox_channel::UpdateApnsVoipSandboxChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_apns_voip_sandbox_channel::UpdateApnsVoipSandboxChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_apns_voip_sandbox_channel::UpdateApnsVoipSandboxChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_apns_voip_sandbox_channel::UpdateApnsVoipSandboxChannelInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_apns_voip_sandbox_channel::UpdateApnsVoipSandboxChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateApnsVoipSandboxChannel", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateApnsVoipSandboxChannel`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateApnsVoipSandboxChannel {
                type Output = ::std::result::Result<crate::operation::update_apns_voip_sandbox_channel::UpdateApnsVoipSandboxChannelOutput, crate::operation::update_apns_voip_sandbox_channel::UpdateApnsVoipSandboxChannelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_apns_voip_sandbox_channel::de_update_apns_voip_sandbox_channel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_apns_voip_sandbox_channel::de_update_apns_voip_sandbox_channel_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateApnsVoipSandboxChannelErrorKind = UpdateApnsVoipSandboxChannelError;
/// Error type for the `UpdateApnsVoipSandboxChannelError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateApnsVoipSandboxChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_apns_voip_sandbox_channel::UpdateApnsVoipSandboxChannelError {
...
impl UpdateApnsVoipSandboxChannelError {
    /// Creates the `UpdateApnsVoipSandboxChannelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateApnsVoipSandboxChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateApnsVoipSandboxChannelError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsVoipSandboxChannelError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsVoipSandboxChannelError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsVoipSandboxChannelError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsVoipSandboxChannelError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsVoipSandboxChannelError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateApnsVoipSandboxChannelError::TooManyRequestsException`.
...
mod _update_apns_voip_sandbox_channel_output;
