...
impl RemoveAttributesInput {
    /// Consumes the builder and constructs an Operation<[`RemoveAttributes`](crate::operation::remove_attributes::RemoveAttributes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::remove_attributes::RemoveAttributes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::remove_attributes::RemoveAttributesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if attribute_type.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("attribute_type", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/v1/apps/{ApplicationId}/attributes/{AttributeType}", ApplicationId = application_id, AttributeType = attribute_type).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::remove_attributes::RemoveAttributesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::remove_attributes::RemoveAttributes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RemoveAttributes", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `RemoveAttributes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for RemoveAttributes {
                type Output = ::std::result::Result<crate::operation::remove_attributes::RemoveAttributesOutput, crate::operation::remove_attributes::RemoveAttributesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_remove_attributes::de_remove_attributes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_remove_attributes::de_remove_attributes_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type RemoveAttributesErrorKind = RemoveAttributesError;
/// Error type for the `RemoveAttributesError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for RemoveAttributesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::remove_attributes::RemoveAttributesError {
...
impl RemoveAttributesError {
    /// Creates the `RemoveAttributesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `RemoveAttributesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `RemoveAttributesError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `RemoveAttributesError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `RemoveAttributesError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `RemoveAttributesError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `RemoveAttributesError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `RemoveAttributesError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `RemoveAttributesError::TooManyRequestsException`.
