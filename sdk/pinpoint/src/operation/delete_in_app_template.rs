...
impl DeleteInAppTemplateInput {
    /// Consumes the builder and constructs an Operation<[`DeleteInAppTemplate`](crate::operation::delete_in_app_template::DeleteInAppTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_in_app_template::DeleteInAppTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_in_app_template::DeleteInAppTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::delete_in_app_template::DeleteInAppTemplateInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_in_app_template::DeleteInAppTemplateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_in_app_template::DeleteInAppTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteInAppTemplate", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteInAppTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteInAppTemplate {
                type Output = ::std::result::Result<crate::operation::delete_in_app_template::DeleteInAppTemplateOutput, crate::operation::delete_in_app_template::DeleteInAppTemplateError>;
...
/// Do not use this.
            ...
            pub type DeleteInAppTemplateErrorKind = DeleteInAppTemplateError;
/// Error type for the `DeleteInAppTemplateError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeleteInAppTemplateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteInAppTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_in_app_template::DeleteInAppTemplateError {
...
impl DeleteInAppTemplateError {
    /// Creates the `DeleteInAppTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteInAppTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteInAppTemplateError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteInAppTemplateError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteInAppTemplateError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteInAppTemplateError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `DeleteInAppTemplateError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteInAppTemplateError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteInAppTemplateError::TooManyRequestsException`.
...
mod _delete_in_app_template_output;
