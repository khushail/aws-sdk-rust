...
impl CreateExportJobInput {
    /// Consumes the builder and constructs an Operation<[`CreateExportJob`](crate::operation::create_export_job::CreateExportJob)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_export_job::CreateExportJob, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_export_job::CreateExportJobInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_export_job::CreateExportJob::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateExportJob", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateExportJob {
                type Output = ::std::result::Result<crate::operation::create_export_job::CreateExportJobOutput, crate::operation::create_export_job::CreateExportJobError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        ...
                        crate::protocol_serde::shape_create_export_job::de_create_export_job_http_response_with_props(status, headers, body)
                     }
                }
...
impl CreateExportJobError {
    ...
    /// Returns `true` if the error kind is `CreateExportJobError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreateExportJobError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreateExportJobError::MethodNotAllowedException`.
    ...
    /// Returns `true` if the error kind is `CreateExportJobError::PayloadTooLargeException`.
