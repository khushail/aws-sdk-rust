...
impl UpdateTemplateActiveVersionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateTemplateActiveVersion`](crate::operation::update_template_active_version::UpdateTemplateActiveVersion)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_template_active_version::UpdateTemplateActiveVersion, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_template_active_version::UpdateTemplateActiveVersionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if template_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("template_name", "cannot be empty or unset"))
                            }
                ...
                if template_type.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("template_type", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/v1/templates/{TemplateName}/{TemplateType}/active-version", TemplateName = template_name, TemplateType = template_type).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_template_active_version::UpdateTemplateActiveVersion::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateTemplateActiveVersion", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateTemplateActiveVersion`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateTemplateActiveVersion {
                type Output = ::std::result::Result<crate::operation::update_template_active_version::UpdateTemplateActiveVersionOutput, crate::operation::update_template_active_version::UpdateTemplateActiveVersionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_template_active_version::de_update_template_active_version_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_template_active_version::de_update_template_active_version_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateTemplateActiveVersionErrorKind = UpdateTemplateActiveVersionError;
/// Error type for the `UpdateTemplateActiveVersionError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateTemplateActiveVersionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_template_active_version::UpdateTemplateActiveVersionError {
...
impl UpdateTemplateActiveVersionError {
    /// Creates the `UpdateTemplateActiveVersionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateTemplateActiveVersionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateTemplateActiveVersionError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplateActiveVersionError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplateActiveVersionError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplateActiveVersionError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplateActiveVersionError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplateActiveVersionError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateTemplateActiveVersionError::TooManyRequestsException`.
...
mod _update_template_active_version_output;
