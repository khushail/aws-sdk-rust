...
impl GetCampaignVersionsInput {
    /// Consumes the builder and constructs an Operation<[`GetCampaignVersions`](crate::operation::get_campaign_versions::GetCampaignVersions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_campaign_versions::GetCampaignVersions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_campaign_versions::GetCampaignVersionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if campaign_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("campaign_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/v1/apps/{ApplicationId}/campaigns/{CampaignId}/versions", ApplicationId = application_id, CampaignId = campaign_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::get_campaign_versions::GetCampaignVersionsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::get_campaign_versions::GetCampaignVersionsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_campaign_versions::GetCampaignVersions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetCampaignVersions", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetCampaignVersions {
                type Output = ::std::result::Result<crate::operation::get_campaign_versions::GetCampaignVersionsOutput, crate::operation::get_campaign_versions::GetCampaignVersionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_campaign_versions::de_get_campaign_versions_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_campaign_versions::de_get_campaign_versions_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetCampaignVersionsErrorKind = GetCampaignVersionsError;
/// Error type for the `GetCampaignVersionsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetCampaignVersionsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_campaign_versions::GetCampaignVersionsError {
...
impl GetCampaignVersionsError {
    /// Creates the `GetCampaignVersionsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetCampaignVersionsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetCampaignVersionsError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignVersionsError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignVersionsError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignVersionsError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignVersionsError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignVersionsError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `GetCampaignVersionsError::TooManyRequestsException`.
...
mod _get_campaign_versions_output;
