...
impl DeleteUserEndpointsInput {
    /// Consumes the builder and constructs an Operation<[`DeleteUserEndpoints`](crate::operation::delete_user_endpoints::DeleteUserEndpoints)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_user_endpoints::DeleteUserEndpoints, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_user_endpoints::DeleteUserEndpointsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if user_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("user_id", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_user_endpoints::DeleteUserEndpointsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_user_endpoints::DeleteUserEndpoints::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteUserEndpoints", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteUserEndpoints`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteUserEndpoints {
                type Output = ::std::result::Result<crate::operation::delete_user_endpoints::DeleteUserEndpointsOutput, crate::operation::delete_user_endpoints::DeleteUserEndpointsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_delete_user_endpoints::de_delete_user_endpoints_http_error(status, headers, body)
                     } else {
...
/// Do not use this.
            ...
            pub type DeleteUserEndpointsErrorKind = DeleteUserEndpointsError;
/// Error type for the `DeleteUserEndpointsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteUserEndpointsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_user_endpoints::DeleteUserEndpointsError {
...
impl DeleteUserEndpointsError {
    /// Creates the `DeleteUserEndpointsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteUserEndpointsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteUserEndpointsError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserEndpointsError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserEndpointsError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserEndpointsError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserEndpointsError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserEndpointsError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteUserEndpointsError::TooManyRequestsException`.
...
pub use crate::operation::delete_user_endpoints::_delete_user_endpoints_output::DeleteUserEndpointsOutput;

pub use crate::operation::delete_user_endpoints::_delete_user_endpoints_input::DeleteUserEndpointsInput;

mod _delete_user_endpoints_input;

mod _delete_user_endpoints_output;
