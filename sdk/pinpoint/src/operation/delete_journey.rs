...
impl DeleteJourneyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteJourney`](crate::operation::delete_journey::DeleteJourney)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_journey::DeleteJourney, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_journey::DeleteJourneyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_journey::DeleteJourneyInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_journey::DeleteJourney::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteJourney", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteJourney`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteJourney {
                type Output = ::std::result::Result<crate::operation::delete_journey::DeleteJourneyOutput, crate::operation::delete_journey::DeleteJourneyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_journey::de_delete_journey_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_journey::de_delete_journey_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteJourneyErrorKind = DeleteJourneyError;
/// Error type for the `DeleteJourneyError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteJourneyError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_journey::DeleteJourneyError {
...
impl DeleteJourneyError {
    /// Creates the `DeleteJourneyError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteJourneyError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteJourneyError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteJourneyError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteJourneyError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteJourneyError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `DeleteJourneyError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteJourneyError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteJourneyError::TooManyRequestsException`.
