...
impl CreatePushTemplateInput {
    /// Consumes the builder and constructs an Operation<[`CreatePushTemplate`](crate::operation::create_push_template::CreatePushTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_push_template::CreatePushTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_push_template::CreatePushTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::create_push_template::CreatePushTemplateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_push_template::CreatePushTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePushTemplate", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreatePushTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePushTemplate {
                type Output = ::std::result::Result<crate::operation::create_push_template::CreatePushTemplateOutput, crate::operation::create_push_template::CreatePushTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 201 {
                        crate::protocol_serde::shape_create_push_template::de_create_push_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_push_template::de_create_push_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreatePushTemplateErrorKind = CreatePushTemplateError;
/// Error type for the `CreatePushTemplateError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreatePushTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_push_template::CreatePushTemplateError {
...
impl CreatePushTemplateError {
    /// Creates the `CreatePushTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreatePushTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreatePushTemplateError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `CreatePushTemplateError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `CreatePushTemplateError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `CreatePushTemplateError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `CreatePushTemplateError::TooManyRequestsException`.
...
mod _create_push_template_output;
