...
impl DeleteVoiceChannelInput {
    /// Consumes the builder and constructs an Operation<[`DeleteVoiceChannel`](crate::operation::delete_voice_channel::DeleteVoiceChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_voice_channel::DeleteVoiceChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_voice_channel::DeleteVoiceChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_voice_channel::DeleteVoiceChannelInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_voice_channel::DeleteVoiceChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteVoiceChannel", "pinpoint"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteVoiceChannel {
                type Output = ::std::result::Result<crate::operation::delete_voice_channel::DeleteVoiceChannelOutput, crate::operation::delete_voice_channel::DeleteVoiceChannelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_voice_channel::de_delete_voice_channel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_voice_channel::de_delete_voice_channel_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeleteVoiceChannelErrorKind = DeleteVoiceChannelError;
/// Error type for the `DeleteVoiceChannelError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeleteVoiceChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_voice_channel::DeleteVoiceChannelError {
...
impl DeleteVoiceChannelError {
    /// Creates the `DeleteVoiceChannelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeleteVoiceChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeleteVoiceChannelError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceChannelError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceChannelError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceChannelError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceChannelError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceChannelError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `DeleteVoiceChannelError::TooManyRequestsException`.
...
mod _delete_voice_channel_output;
