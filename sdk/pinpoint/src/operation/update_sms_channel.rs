...
impl UpdateSmsChannelInput {
    /// Consumes the builder and constructs an Operation<[`UpdateSmsChannel`](crate::operation::update_sms_channel::UpdateSmsChannel)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_sms_channel::UpdateSmsChannel, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_sms_channel::UpdateSmsChannelInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::update_sms_channel::UpdateSmsChannelInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_sms_channel::UpdateSmsChannel::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateSmsChannel", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateSmsChannel`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateSmsChannel {
                type Output = ::std::result::Result<crate::operation::update_sms_channel::UpdateSmsChannelOutput, crate::operation::update_sms_channel::UpdateSmsChannelError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_sms_channel::de_update_sms_channel_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_sms_channel::de_update_sms_channel_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateSmsChannelErrorKind = UpdateSmsChannelError;
/// Error type for the `UpdateSmsChannelError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateSmsChannelError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_sms_channel::UpdateSmsChannelError {
...
impl UpdateSmsChannelError {
    /// Creates the `UpdateSmsChannelError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateSmsChannelError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateSmsChannelError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsChannelError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsChannelError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsChannelError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsChannelError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsChannelError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateSmsChannelError::TooManyRequestsException`.
...
mod _update_sms_channel_output;
