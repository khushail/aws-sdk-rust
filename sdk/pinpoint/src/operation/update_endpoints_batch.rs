...
impl UpdateEndpointsBatchInput {
    /// Consumes the builder and constructs an Operation<[`UpdateEndpointsBatch`](crate::operation::update_endpoints_batch::UpdateEndpointsBatch)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_endpoints_batch::UpdateEndpointsBatch, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_endpoints_batch::UpdateEndpointsBatchInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/v1/apps/{ApplicationId}/endpoints", ApplicationId = application_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            #[allow(clippy::unnecessary_wraps)]
            fn update_http_builder(
                            input: &crate::operation::update_endpoints_batch::UpdateEndpointsBatchInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_endpoints_batch::UpdateEndpointsBatch::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateEndpointsBatch", "pinpoint"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateEndpointsBatch`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateEndpointsBatch {
                type Output = ::std::result::Result<crate::operation::update_endpoints_batch::UpdateEndpointsBatchOutput, crate::operation::update_endpoints_batch::UpdateEndpointsBatchError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        crate::protocol_serde::shape_update_endpoints_batch::de_update_endpoints_batch_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_endpoints_batch::de_update_endpoints_batch_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateEndpointsBatchErrorKind = UpdateEndpointsBatchError;
/// Error type for the `UpdateEndpointsBatchError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateEndpointsBatchError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_endpoints_batch::UpdateEndpointsBatchError {
...
impl UpdateEndpointsBatchError {
    /// Creates the `UpdateEndpointsBatchError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateEndpointsBatchError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateEndpointsBatchError::BadRequestException`.
    pub fn is_bad_request_exception(&self) -> bool {
        matches!(self, Self::BadRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateEndpointsBatchError::ForbiddenException`.
    pub fn is_forbidden_exception(&self) -> bool {
        matches!(self, Self::ForbiddenException(_))
    }
    /// Returns `true` if the error kind is `UpdateEndpointsBatchError::InternalServerErrorException`.
    pub fn is_internal_server_error_exception(&self) -> bool {
        matches!(self, Self::InternalServerErrorException(_))
    }
    /// Returns `true` if the error kind is `UpdateEndpointsBatchError::MethodNotAllowedException`.
    pub fn is_method_not_allowed_exception(&self) -> bool {
        matches!(self, Self::MethodNotAllowedException(_))
    }
    /// Returns `true` if the error kind is `UpdateEndpointsBatchError::NotFoundException`.
    pub fn is_not_found_exception(&self) -> bool {
        matches!(self, Self::NotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateEndpointsBatchError::PayloadTooLargeException`.
    pub fn is_payload_too_large_exception(&self) -> bool {
        matches!(self, Self::PayloadTooLargeException(_))
    }
    /// Returns `true` if the error kind is `UpdateEndpointsBatchError::TooManyRequestsException`.
...
mod _update_endpoints_batch_output;
