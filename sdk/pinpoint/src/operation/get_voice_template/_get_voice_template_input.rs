...
impl GetVoiceTemplateInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_voice_template::GetVoiceTemplateInput, ::aws_smithy_http::operation::error::BuildError> {
        ::std::result::Result::Ok(
            crate::operation::get_voice_template::GetVoiceTemplateInput {
