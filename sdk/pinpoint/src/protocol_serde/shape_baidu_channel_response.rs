...
pub(crate) fn de_baidu_channel_response_payload(input: &[u8]) -> Result<crate::types::BaiduChannelResponse, ::aws_smithy_json::deserialize::error::DeserializeError> {
    let mut tokens_owned = ::aws_smithy_json::deserialize::json_token_iter(crate::protocol_serde::or_empty_doc(input)).peekable();
                        let tokens = &mut tokens_owned;
    let result =
    crate::protocol_serde::shape_baidu_channel_response::de_baidu_channel_response(tokens)?
...
pub(crate) fn de_baidu_channel_response<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<crate::types::BaiduChannelResponse>, ::aws_smithy_json::deserialize::error::DeserializeError>
                    where I: Iterator<Item = Result<::aws_smithy_json::deserialize::Token<'a>, ::aws_smithy_json::deserialize::error::DeserializeError>> {
    match tokens.next().transpose()? {
        Some(::aws_smithy_json::deserialize::Token::ValueNull { .. }) => Ok(None),
                        Some(::aws_smithy_json::deserialize::Token::StartObject { .. }) => {
            #[allow(unused_mut)]
            let mut builder = crate::types::builders::BaiduChannelResponseBuilder::default();
            loop {
                match tokens.next().transpose()? {
