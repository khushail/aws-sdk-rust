...
impl super::Client  {
    ...
    ///   - [`application_id(impl ::std::convert::Into<String>)`](crate::operation::get_journey::builders::GetJourneyFluentBuilder::application_id) / [`set_application_id(Option<String>)`](crate::operation::get_journey::builders::GetJourneyFluentBuilder::set_application_id): <p>The unique identifier for the application. This identifier is displayed as the <b>Project ID</b> on the Amazon Pinpoint console.</p>
    ///   - [`journey_id(impl ::std::convert::Into<String>)`](crate::operation::get_journey::builders::GetJourneyFluentBuilder::journey_id) / [`set_journey_id(Option<String>)`](crate::operation::get_journey::builders::GetJourneyFluentBuilder::set_journey_id): <p>The unique identifier for the journey.</p>
