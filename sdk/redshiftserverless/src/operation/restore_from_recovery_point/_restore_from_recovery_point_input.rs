...
impl RestoreFromRecoveryPointInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_from_recovery_point::RestoreFromRecoveryPointInput, ::aws_smithy_http::operation::error::BuildError> {
