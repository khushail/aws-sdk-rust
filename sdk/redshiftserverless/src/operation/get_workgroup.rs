...
impl GetWorkgroupInput {
    /// Consumes the builder and constructs an Operation<[`GetWorkgroup`](crate::operation::get_workgroup::GetWorkgroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_workgroup::GetWorkgroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_workgroup::GetWorkgroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_workgroup::ser_get_workgroup_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_workgroup::GetWorkgroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetWorkgroup", "redshiftserverless"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetWorkgroup {
                type Output = ::std::result::Result<crate::operation::get_workgroup::GetWorkgroupOutput, crate::operation::get_workgroup::GetWorkgroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_workgroup::de_get_workgroup_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_workgroup::de_get_workgroup_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::get_workgroup::GetWorkgroupError {
