...
impl RestoreTableFromSnapshotInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_table_from_snapshot::RestoreTableFromSnapshotInput, ::aws_smithy_http::operation::error::BuildError> {
