...
impl super::Client  {
    ...
    ///   - [`namespace_name(impl ::std::convert::Into<String>)`](crate::operation::delete_namespace::builders::DeleteNamespaceFluentBuilder::namespace_name) / [`set_namespace_name(Option<String>)`](crate::operation::delete_namespace::builders::DeleteNamespaceFluentBuilder::set_namespace_name): <p>The name of the namespace to delete.</p>
    ///   - [`final_snapshot_name(impl ::std::convert::Into<String>)`](crate::operation::delete_namespace::builders::DeleteNamespaceFluentBuilder::final_snapshot_name) / [`set_final_snapshot_name(Option<String>)`](crate::operation::delete_namespace::builders::DeleteNamespaceFluentBuilder::set_final_snapshot_name): <p>The name of the snapshot to be created before the namespace is deleted.</p>
