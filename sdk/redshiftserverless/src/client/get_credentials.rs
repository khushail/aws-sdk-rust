...
impl super::Client  {
    ...
    ///   - [`workgroup_name(impl ::std::convert::Into<String>)`](crate::operation::get_credentials::builders::GetCredentialsFluentBuilder::workgroup_name) / [`set_workgroup_name(Option<String>)`](crate::operation::get_credentials::builders::GetCredentialsFluentBuilder::set_workgroup_name): <p>The name of the workgroup associated with the database.</p>
    ///   - [`db_name(impl ::std::convert::Into<String>)`](crate::operation::get_credentials::builders::GetCredentialsFluentBuilder::db_name) / [`set_db_name(Option<String>)`](crate::operation::get_credentials::builders::GetCredentialsFluentBuilder::set_db_name): <p>The name of the database to get temporary authorization to log on to.</p>  <p>Constraints:</p>  <ul>   <li> <p>Must be 1 to 64 alphanumeric characters or hyphens.</p> </li>   <li> <p>Must contain only uppercase or lowercase letters, numbers, underscore, plus sign, period (dot), at symbol (@), or hyphen.</p> </li>   <li> <p>The first character must be a letter.</p> </li>   <li> <p>Must not contain a colon ( : ) or slash ( / ).</p> </li>   <li> <p>Cannot be a reserved word. A list of reserved words can be found in <a href="https://docs.aws.amazon.com/redshift/latest/dg/r_pg_keywords.html">Reserved Words </a> in the Amazon Redshift Database Developer Guide</p> </li>  </ul>
