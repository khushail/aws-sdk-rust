...
impl super::Client  {
    ...
    ///   - [`namespace_name(impl ::std::convert::Into<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::namespace_name) / [`set_namespace_name(Option<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::set_namespace_name): <p>The namespace to create a snapshot for.</p>
    ///   - [`snapshot_name(impl ::std::convert::Into<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::snapshot_name) / [`set_snapshot_name(Option<String>)`](crate::operation::create_snapshot::builders::CreateSnapshotFluentBuilder::set_snapshot_name): <p>The name of the snapshot.</p>
