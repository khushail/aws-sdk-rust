...
pub fn ser_describe_db_proxy_target_groups_input_input(input: &crate::operation::describe_db_proxy_target_groups::DescribeDbProxyTargetGroupsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
