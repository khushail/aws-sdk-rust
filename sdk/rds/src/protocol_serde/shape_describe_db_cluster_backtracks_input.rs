...
pub fn ser_describe_db_cluster_backtracks_input_input(input: &crate::operation::describe_db_cluster_backtracks::DescribeDbClusterBacktracksInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_3 = writer.prefix("BacktrackIdentifier");
    if let Some(var_4) = &input.backtrack_identifier {
