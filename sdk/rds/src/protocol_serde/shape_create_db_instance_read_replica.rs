...
pub fn de_create_db_instance_read_replica_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_instance_read_replica::CreateDbInstanceReadReplicaOutput, crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplicaError> {
    #[allow(unused_mut)]
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_db_instance_read_replica_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_db_instance_read_replica::CreateDbInstanceReadReplicaOutput, crate::operation::create_db_instance_read_replica::CreateDBInstanceReadReplicaError> {
    Ok({
        #[allow(unused_mut)]
...
pub fn de_create_db_instance_read_replica(inp: &[u8], mut builder: crate::operation::create_db_instance_read_replica::builders::CreateDbInstanceReadReplicaOutputBuilder) -> Result<crate::operation::create_db_instance_read_replica::builders::CreateDbInstanceReadReplicaOutputBuilder, ::aws_smithy_xml::decode::XmlDecodeError> {
    ...
    if !(start_el.matches("CreateDBInstanceReadReplicaResponse")) {
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid root, expected CreateDBInstanceReadReplicaResponse got {:?}", start_el)))
                    }
                    if let Some(mut result_tag) = decoder.next_tag() {
                        let start_el = result_tag.start_el();
                        if !(start_el.matches("CreateDBInstanceReadReplicaResult")) {
                            return Err(::aws_smithy_xml::decode::XmlDecodeError::custom(format!("invalid result, expected CreateDBInstanceReadReplicaResult got {:?}", start_el)))
                        }
    while let Some(mut tag) = result_tag.next_tag() {
        match tag.start_el() {
            ...
            _ => {}
                        ...
                        return Err(::aws_smithy_xml::decode::XmlDecodeError::custom("expected CreateDBInstanceReadReplicaResult tag"))
                    };
    Ok(builder)
}
