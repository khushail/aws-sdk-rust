...
pub fn ser_describe_db_proxies_input_input(input: &crate::operation::describe_db_proxies::DescribeDbProxiesInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
