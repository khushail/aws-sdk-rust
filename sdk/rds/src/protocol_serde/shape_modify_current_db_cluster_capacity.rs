...
#[allow(clippy::unnecessary_wraps)]
pub fn de_modify_current_db_cluster_capacity_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDbClusterCapacityOutput, crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDBClusterCapacityError> {
    Ok({
        #[allow(unused_mut)]
