...
#[allow(clippy::unnecessary_wraps)]
pub fn de_describe_db_proxy_targets_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::describe_db_proxy_targets::DescribeDbProxyTargetsOutput, crate::operation::describe_db_proxy_targets::DescribeDBProxyTargetsError> {
    Ok({
        #[allow(unused_mut)]
