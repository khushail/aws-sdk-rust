...
pub fn ser_stop_db_instance_input_input(input: &crate::operation::stop_db_instance::StopDbInstanceInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
