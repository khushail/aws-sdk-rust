            ...
            let mut tmp =
                 {
                    ...
                    output = crate::protocol_serde::shape_db_instance_automated_backup_quota_exceeded_fault::de_db_instance_automated_backup_quota_exceeded_fault_xml_err(_response_body, output).map_err(crate::operation::delete_db_instance::DeleteDBInstanceError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_delete_db_instance_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::delete_db_instance::DeleteDbInstanceOutput, crate::operation::delete_db_instance::DeleteDBInstanceError> {
    Ok({
        #[allow(unused_mut)]
