...
pub fn ser_modify_db_parameter_group_input_input(input: &crate::operation::modify_db_parameter_group::ModifyDbParameterGroupInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
