...
#[allow(clippy::unnecessary_wraps)]
pub fn de_remove_from_global_cluster_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterOutput, crate::operation::remove_from_global_cluster::RemoveFromGlobalClusterError> {
    Ok({
        #[allow(unused_mut)]
