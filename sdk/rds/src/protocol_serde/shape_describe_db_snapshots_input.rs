...
pub fn ser_describe_db_snapshots_input_input(input: &crate::operation::describe_db_snapshots::DescribeDbSnapshotsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
    ...
    #[allow(unused_mut)]
    let mut scope_18 = writer.prefix("DbiResourceId");
    if let Some(var_19) = &input.dbi_resource_id {
