...
pub fn ser_describe_db_subnet_groups_input_input(input: &crate::operation::describe_db_subnet_groups::DescribeDbSubnetGroupsInput) -> Result<::aws_smithy_http::body::SdkBody, ::aws_smithy_http::operation::error::SerializationError> {
