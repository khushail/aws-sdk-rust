...
pub fn de_create_blue_green_deployment_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentOutput, crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_blue_green_deployment_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentOutput, crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentError> {
    Ok({
        #[allow(unused_mut)]
