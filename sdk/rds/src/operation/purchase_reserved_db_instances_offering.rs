...
impl PurchaseReservedDbInstancesOfferingInput {
    /// Consumes the builder and constructs an Operation<[`PurchaseReservedDBInstancesOffering`](crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOffering)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOffering, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDbInstancesOfferingInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_purchase_reserved_db_instances_offering_input::ser_purchase_reserved_db_instances_offering_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOffering::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PurchaseReservedDBInstancesOffering", "rds"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for PurchaseReservedDBInstancesOffering {
                type Output = ::std::result::Result<crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDbInstancesOfferingOutput, crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOfferingError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_purchase_reserved_db_instances_offering::de_purchase_reserved_db_instances_offering_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_purchase_reserved_db_instances_offering::de_purchase_reserved_db_instances_offering_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for PurchaseReservedDBInstancesOfferingError {
...
impl ::aws_http::request_id::RequestId for crate::operation::purchase_reserved_db_instances_offering::PurchaseReservedDBInstancesOfferingError {
...
mod _purchase_reserved_db_instances_offering_output;
