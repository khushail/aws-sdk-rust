...
impl CreateCustomDbEngineVersionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_custom_db_engine_version::CreateCustomDbEngineVersionInput, ::aws_smithy_http::operation::error::BuildError> {
