...
impl StopDbInstanceAutomatedBackupsReplicationInput {
    /// Consumes the builder and constructs an Operation<[`StopDBInstanceAutomatedBackupsReplication`](crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplication)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplication, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::stop_db_instance_automated_backups_replication::StopDbInstanceAutomatedBackupsReplicationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::stop_db_instance_automated_backups_replication::StopDbInstanceAutomatedBackupsReplicationInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_stop_db_instance_automated_backups_replication_input::ser_stop_db_instance_automated_backups_replication_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplication::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StopDBInstanceAutomatedBackupsReplication", "rds"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for StopDBInstanceAutomatedBackupsReplication {
                type Output = ::std::result::Result<crate::operation::stop_db_instance_automated_backups_replication::StopDbInstanceAutomatedBackupsReplicationOutput, crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplicationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_stop_db_instance_automated_backups_replication::de_stop_db_instance_automated_backups_replication_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_stop_db_instance_automated_backups_replication::de_stop_db_instance_automated_backups_replication_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type StopDBInstanceAutomatedBackupsReplicationErrorKind = StopDBInstanceAutomatedBackupsReplicationError;
...
impl ::aws_smithy_http::result::CreateUnhandledError for StopDBInstanceAutomatedBackupsReplicationError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StopDBInstanceAutomatedBackupsReplicationError {
...
impl ::aws_http::request_id::RequestId for crate::operation::stop_db_instance_automated_backups_replication::StopDBInstanceAutomatedBackupsReplicationError {
...
mod _stop_db_instance_automated_backups_replication_output;
