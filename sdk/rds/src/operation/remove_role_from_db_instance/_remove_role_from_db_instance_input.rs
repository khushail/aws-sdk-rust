...
impl RemoveRoleFromDbInstanceInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::remove_role_from_db_instance::RemoveRoleFromDbInstanceInput, ::aws_smithy_http::operation::error::BuildError> {
