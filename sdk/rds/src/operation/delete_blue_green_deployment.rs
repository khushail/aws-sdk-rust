...
impl DeleteBlueGreenDeploymentInput {
    /// Consumes the builder and constructs an Operation<[`DeleteBlueGreenDeployment`](crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeployment)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeployment, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_blue_green_deployment_input::ser_delete_blue_green_deployment_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeployment::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteBlueGreenDeployment", "rds"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteBlueGreenDeployment`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteBlueGreenDeployment {
                type Output = ::std::result::Result<crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentOutput, crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_blue_green_deployment::de_delete_blue_green_deployment_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_blue_green_deployment::de_delete_blue_green_deployment_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_blue_green_deployment::DeleteBlueGreenDeploymentError {
...
mod _delete_blue_green_deployment_output;
