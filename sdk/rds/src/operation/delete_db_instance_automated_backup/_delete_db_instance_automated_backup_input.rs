...
impl DeleteDbInstanceAutomatedBackupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_db_instance_automated_backup::DeleteDbInstanceAutomatedBackupInput, ::aws_smithy_http::operation::error::BuildError> {
