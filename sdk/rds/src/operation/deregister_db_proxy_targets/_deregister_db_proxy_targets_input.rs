...
impl DeregisterDbProxyTargetsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::deregister_db_proxy_targets::DeregisterDbProxyTargetsInput, ::aws_smithy_http::operation::error::BuildError> {
