...
impl CreateBlueGreenDeploymentInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_blue_green_deployment::CreateBlueGreenDeploymentInput, ::aws_smithy_http::operation::error::BuildError> {
