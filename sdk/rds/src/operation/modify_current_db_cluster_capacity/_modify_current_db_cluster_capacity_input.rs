...
impl ModifyCurrentDbClusterCapacityInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::modify_current_db_cluster_capacity::ModifyCurrentDbClusterCapacityInput, ::aws_smithy_http::operation::error::BuildError> {
