...
impl ModifyOptionGroupInput {
    /// Consumes the builder and constructs an Operation<[`ModifyOptionGroup`](crate::operation::modify_option_group::ModifyOptionGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::modify_option_group::ModifyOptionGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::modify_option_group::ModifyOptionGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::modify_option_group::ModifyOptionGroupInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_modify_option_group_input::ser_modify_option_group_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::modify_option_group::ModifyOptionGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ModifyOptionGroup", "rds"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ModifyOptionGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ModifyOptionGroup {
                type Output = ::std::result::Result<crate::operation::modify_option_group::ModifyOptionGroupOutput, crate::operation::modify_option_group::ModifyOptionGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_modify_option_group::de_modify_option_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_modify_option_group::de_modify_option_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::modify_option_group::ModifyOptionGroupError {
...
mod _modify_option_group_output;
