...
impl RestoreDbClusterFromS3Input {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::restore_db_cluster_from_s3::RestoreDBClusterFromS3, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::restore_db_cluster_from_s3::RestoreDbClusterFromS3Input, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::restore_db_cluster_from_s3::RestoreDBClusterFromS3::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("RestoreDBClusterFromS3", "rds"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for RestoreDBClusterFromS3 {
                type Output = ::std::result::Result<crate::operation::restore_db_cluster_from_s3::RestoreDbClusterFromS3Output, crate::operation::restore_db_cluster_from_s3::RestoreDBClusterFromS3Error>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_restore_db_cluster_from_s3::de_restore_db_cluster_from_s3_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::restore_db_cluster_from_s3::RestoreDBClusterFromS3Error {
