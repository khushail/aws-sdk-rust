...
impl DescribeReservedDbInstancesOfferingsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeReservedDBInstancesOfferings`](crate::operation::describe_reserved_db_instances_offerings::DescribeReservedDBInstancesOfferings)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_reserved_db_instances_offerings::DescribeReservedDBInstancesOfferings, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_reserved_db_instances_offerings::DescribeReservedDbInstancesOfferingsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_reserved_db_instances_offerings_input::ser_describe_reserved_db_instances_offerings_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_reserved_db_instances_offerings::DescribeReservedDBInstancesOfferings::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeReservedDBInstancesOfferings", "rds"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeReservedDBInstancesOfferings`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeReservedDBInstancesOfferings {
                type Output = ::std::result::Result<crate::operation::describe_reserved_db_instances_offerings::DescribeReservedDbInstancesOfferingsOutput, crate::operation::describe_reserved_db_instances_offerings::DescribeReservedDBInstancesOfferingsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_reserved_db_instances_offerings::de_describe_reserved_db_instances_offerings_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_reserved_db_instances_offerings::de_describe_reserved_db_instances_offerings_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DescribeReservedDBInstancesOfferingsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_reserved_db_instances_offerings::DescribeReservedDBInstancesOfferingsError {
...
pub use crate::operation::describe_reserved_db_instances_offerings::_describe_reserved_db_instances_offerings_output::DescribeReservedDbInstancesOfferingsOutput;

pub use crate::operation::describe_reserved_db_instances_offerings::_describe_reserved_db_instances_offerings_input::DescribeReservedDbInstancesOfferingsInput;

mod _describe_reserved_db_instances_offerings_input;

mod _describe_reserved_db_instances_offerings_output;
