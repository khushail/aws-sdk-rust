...
impl DescribeOptionGroupOptionsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeOptionGroupOptions`](crate::operation::describe_option_group_options::DescribeOptionGroupOptions)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_option_group_options::DescribeOptionGroupOptions, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_option_group_options::DescribeOptionGroupOptionsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_option_group_options::DescribeOptionGroupOptionsInput,
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_describe_option_group_options_input::ser_describe_option_group_options_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_option_group_options::DescribeOptionGroupOptions::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeOptionGroupOptions", "rds"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeOptionGroupOptions`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeOptionGroupOptions {
                type Output = ::std::result::Result<crate::operation::describe_option_group_options::DescribeOptionGroupOptionsOutput, crate::operation::describe_option_group_options::DescribeOptionGroupOptionsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_option_group_options::de_describe_option_group_options_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_option_group_options::de_describe_option_group_options_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_option_group_options::DescribeOptionGroupOptionsError {
...
mod _describe_option_group_options_output;
