...
impl DownloadDbLogFilePortionInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::download_db_log_file_portion::DownloadDbLogFilePortionInput, ::aws_smithy_http::operation::error::BuildError> {
