...
impl RestoreDbClusterToPointInTimeInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::restore_db_cluster_to_point_in_time::RestoreDbClusterToPointInTimeInput, ::aws_smithy_http::operation::error::BuildError> {
