...
impl PromoteReadReplicaInput {
    /// Consumes the builder and constructs an Operation<[`PromoteReadReplica`](crate::operation::promote_read_replica::PromoteReadReplica)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::promote_read_replica::PromoteReadReplica, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::promote_read_replica::PromoteReadReplicaInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_promote_read_replica_input::ser_promote_read_replica_input_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::promote_read_replica::PromoteReadReplica::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PromoteReadReplica", "rds"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PromoteReadReplica`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PromoteReadReplica {
                type Output = ::std::result::Result<crate::operation::promote_read_replica::PromoteReadReplicaOutput, crate::operation::promote_read_replica::PromoteReadReplicaError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_promote_read_replica::de_promote_read_replica_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_promote_read_replica::de_promote_read_replica_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::promote_read_replica::PromoteReadReplicaError {
...
mod _promote_read_replica_output;
