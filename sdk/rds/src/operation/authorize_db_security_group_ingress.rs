...
impl AuthorizeDbSecurityGroupIngressInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::authorize_db_security_group_ingress::AuthorizeDBSecurityGroupIngress, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::authorize_db_security_group_ingress::AuthorizeDbSecurityGroupIngressInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
/// Orchestration and serialization glue logic for `AuthorizeDBSecurityGroupIngress`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AuthorizeDBSecurityGroupIngress {
                ...
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_authorize_db_security_group_ingress::de_authorize_db_security_group_ingress_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_authorize_db_security_group_ingress::de_authorize_db_security_group_ingress_http_response_with_props(status, headers, body)
                     }
                }
