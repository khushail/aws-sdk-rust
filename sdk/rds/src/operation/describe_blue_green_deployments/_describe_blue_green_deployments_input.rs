...
impl DescribeBlueGreenDeploymentsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_blue_green_deployments::DescribeBlueGreenDeploymentsInput, ::aws_smithy_http::operation::error::BuildError> {
