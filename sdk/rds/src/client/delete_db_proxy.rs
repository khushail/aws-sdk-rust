...
impl super::Client  {
    ...
    ///   - [`db_proxy_name(impl ::std::convert::Into<String>)`](crate::operation::delete_db_proxy::builders::DeleteDBProxyFluentBuilder::db_proxy_name) / [`set_db_proxy_name(Option<String>)`](crate::operation::delete_db_proxy::builders::DeleteDBProxyFluentBuilder::set_db_proxy_name): <p>The name of the DB proxy to delete.</p>
