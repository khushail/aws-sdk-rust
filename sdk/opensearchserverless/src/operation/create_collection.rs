...
impl CreateCollectionInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_collection::CreateCollection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_collection::CreateCollectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::std::fmt::Display for CreateCollectionError {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        match self {
            ...
            _inner.fmt(f)
            ,
            Self::OcuLimitExceededException(_inner) =>
            _inner.fmt(f)
            ,
...
impl CreateCollectionError {
    ...
    pub fn meta(&self) -> &::aws_smithy_types::error::ErrorMetadata {
        ...
        match self {
            ...
            Self::OcuLimitExceededException(e) => e.meta(),
    ...
    /// Returns `true` if the error kind is `CreateCollectionError::OcuLimitExceededException`.
    pub fn is_ocu_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::OcuLimitExceededException(_))
    }
