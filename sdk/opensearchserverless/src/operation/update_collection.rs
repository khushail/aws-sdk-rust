...
impl UpdateCollectionInput {
    /// Consumes the builder and constructs an Operation<[`UpdateCollection`](crate::operation::update_collection::UpdateCollection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_collection::UpdateCollection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_collection::UpdateCollectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_collection::ser_update_collection_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_collection::UpdateCollection::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateCollection", "opensearchserverless"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateCollection`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateCollection {
                type Output = ::std::result::Result<crate::operation::update_collection::UpdateCollectionOutput, crate::operation::update_collection::UpdateCollectionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_collection::de_update_collection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_collection::de_update_collection_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_collection::UpdateCollectionError {
