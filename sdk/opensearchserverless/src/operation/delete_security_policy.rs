...
impl DeleteSecurityPolicyInput {
    /// Consumes the builder and constructs an Operation<[`DeleteSecurityPolicy`](crate::operation::delete_security_policy::DeleteSecurityPolicy)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_security_policy::DeleteSecurityPolicy, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_security_policy::DeleteSecurityPolicyInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_security_policy::ser_delete_security_policy_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_security_policy::DeleteSecurityPolicy::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteSecurityPolicy {
                type Output = ::std::result::Result<crate::operation::delete_security_policy::DeleteSecurityPolicyOutput, crate::operation::delete_security_policy::DeleteSecurityPolicyError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_security_policy::de_delete_security_policy_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_security_policy::de_delete_security_policy_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_security_policy::DeleteSecurityPolicyError {
...
mod _delete_security_policy_output;
