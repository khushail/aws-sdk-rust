...
impl super::Client  {
    ...
    ///   - [`id(impl ::std::convert::Into<String>)`](crate::operation::update_collection::builders::UpdateCollectionFluentBuilder::id) / [`set_id(Option<String>)`](crate::operation::update_collection::builders::UpdateCollectionFluentBuilder::set_id): <p>The unique identifier of the collection.</p>
    ///   - [`description(impl ::std::convert::Into<String>)`](crate::operation::update_collection::builders::UpdateCollectionFluentBuilder::description) / [`set_description(Option<String>)`](crate::operation::update_collection::builders::UpdateCollectionFluentBuilder::set_description): <p>A description of the collection.</p>
    ///   - [`client_token(impl ::std::convert::Into<String>)`](crate::operation::update_collection::builders::UpdateCollectionFluentBuilder::client_token) / [`set_client_token(Option<String>)`](crate::operation::update_collection::builders::UpdateCollectionFluentBuilder::set_client_token): <p>Unique, case-sensitive identifier to ensure idempotency of the request.</p>
