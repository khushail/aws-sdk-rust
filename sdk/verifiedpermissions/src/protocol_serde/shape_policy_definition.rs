...
pub fn ser_policy_definition(object_4: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::PolicyDefinition) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
        ...
        crate::types::PolicyDefinition::Unknown => return Err(::aws_smithy_http::operation::error::SerializationError::unknown_variant("PolicyDefinition"))
    }
    Ok(())
}
