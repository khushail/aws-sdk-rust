...
pub fn ser_attribute_value(object_4: &mut ::aws_smithy_json::serialize::JsonObjectWriter, input: &crate::types::AttributeValue) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    match input {
