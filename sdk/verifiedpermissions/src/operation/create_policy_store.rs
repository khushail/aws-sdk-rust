...
impl CreatePolicyStoreInput {
    /// Consumes the builder and constructs an Operation<[`CreatePolicyStore`](crate::operation::create_policy_store::CreatePolicyStore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_policy_store::CreatePolicyStore, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_policy_store::CreatePolicyStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_policy_store::ser_create_policy_store_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_policy_store::CreatePolicyStore::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePolicyStore", "verifiedpermissions"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CreatePolicyStore`.
#[derive(::std::clone::Clone, ::std::default::Default, ::std::fmt::Debug)]
#[non_exhaustive]
#[doc(hidden)]
pub struct CreatePolicyStore;
impl CreatePolicyStore {
    #[doc(hidden)]
    pub fn new() -> Self {
        Self
    }
}
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePolicyStore {
                type Output = ::std::result::Result<crate::operation::create_policy_store::CreatePolicyStoreOutput, crate::operation::create_policy_store::CreatePolicyStoreError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_policy_store::de_create_policy_store_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_policy_store::de_create_policy_store_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreatePolicyStoreErrorKind = CreatePolicyStoreError;
/// Error type for the `CreatePolicyStoreError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreatePolicyStoreError {
...
impl ::std::fmt::Display for CreatePolicyStoreError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreatePolicyStoreError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_policy_store::CreatePolicyStoreError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for CreatePolicyStoreError {
...
impl CreatePolicyStoreError {
    /// Creates the `CreatePolicyStoreError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreatePolicyStoreError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreatePolicyStoreError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyStoreError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyStoreError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyStoreError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyStoreError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for CreatePolicyStoreError {
...
mod _create_policy_store_output;
