...
impl GetPolicyStoreInput {
    /// Consumes the builder and constructs an Operation<[`GetPolicyStore`](crate::operation::get_policy_store::GetPolicyStore)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_policy_store::GetPolicyStore, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_policy_store::GetPolicyStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_policy_store::ser_get_policy_store_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_policy_store::GetPolicyStore::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetPolicyStore", "verifiedpermissions"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetPolicyStore`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPolicyStore {
                type Output = ::std::result::Result<crate::operation::get_policy_store::GetPolicyStoreOutput, crate::operation::get_policy_store::GetPolicyStoreError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_policy_store::de_get_policy_store_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_policy_store::de_get_policy_store_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetPolicyStoreErrorKind = GetPolicyStoreError;
/// Error type for the `GetPolicyStoreError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetPolicyStoreError {
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetPolicyStoreError {
...
impl ::std::fmt::Display for GetPolicyStoreError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetPolicyStoreError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_policy_store::GetPolicyStoreError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for GetPolicyStoreError {
...
impl GetPolicyStoreError {
    /// Creates the `GetPolicyStoreError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPolicyStoreError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetPolicyStoreError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyStoreError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyStoreError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyStoreError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyStoreError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for GetPolicyStoreError {
...
pub use crate::operation::get_policy_store::_get_policy_store_output::GetPolicyStoreOutput;

pub use crate::operation::get_policy_store::_get_policy_store_input::GetPolicyStoreInput;

mod _get_policy_store_input;

mod _get_policy_store_output;
