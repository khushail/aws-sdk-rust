...
impl CreateIdentitySourceInput {
    ...
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_identity_source::CreateIdentitySource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_identity_source::CreateIdentitySourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_identity_source::ser_create_identity_source_input(&self)?
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateIdentitySource {
                type Output = ::std::result::Result<crate::operation::create_identity_source::CreateIdentitySourceOutput, crate::operation::create_identity_source::CreateIdentitySourceError>;
