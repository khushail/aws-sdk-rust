...
impl UpdatePolicyStoreInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_policy_store::UpdatePolicyStore, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_policy_store::UpdatePolicyStoreInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePolicyStore {
                type Output = ::std::result::Result<crate::operation::update_policy_store::UpdatePolicyStoreOutput, crate::operation::update_policy_store::UpdatePolicyStoreError>;
