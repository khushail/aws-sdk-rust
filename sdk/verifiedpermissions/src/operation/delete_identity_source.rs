...
impl DeleteIdentitySourceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_identity_source::DeleteIdentitySource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_identity_source::DeleteIdentitySourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_identity_source::ser_delete_identity_source_input(&self)?
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteIdentitySource {
                type Output = ::std::result::Result<crate::operation::delete_identity_source::DeleteIdentitySourceOutput, crate::operation::delete_identity_source::DeleteIdentitySourceError>;
