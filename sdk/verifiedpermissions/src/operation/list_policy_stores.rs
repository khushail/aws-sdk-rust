...
impl ListPolicyStoresInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_policy_stores::ListPolicyStores, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_policy_stores::ListPolicyStoresInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyStores {
                type Output = ::std::result::Result<crate::operation::list_policy_stores::ListPolicyStoresOutput, crate::operation::list_policy_stores::ListPolicyStoresError>;
