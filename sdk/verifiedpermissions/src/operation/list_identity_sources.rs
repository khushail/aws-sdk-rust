...
impl ListIdentitySourcesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_identity_sources::ListIdentitySources, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_identity_sources::ListIdentitySourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_identity_sources::ser_list_identity_sources_input(&self)?
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIdentitySources {
                type Output = ::std::result::Result<crate::operation::list_identity_sources::ListIdentitySourcesOutput, crate::operation::list_identity_sources::ListIdentitySourcesError>;
