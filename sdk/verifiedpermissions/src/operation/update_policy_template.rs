...
impl UpdatePolicyTemplateInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_policy_template::UpdatePolicyTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_policy_template::UpdatePolicyTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_policy_template::ser_update_policy_template_input(&self)?
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdatePolicyTemplate {
                type Output = ::std::result::Result<crate::operation::update_policy_template::UpdatePolicyTemplateOutput, crate::operation::update_policy_template::UpdatePolicyTemplateError>;
