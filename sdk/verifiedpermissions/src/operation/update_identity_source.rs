...
impl UpdateIdentitySourceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_identity_source::UpdateIdentitySource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_identity_source::UpdateIdentitySourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_update_identity_source::ser_update_identity_source_input(&self)?
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateIdentitySource {
                type Output = ::std::result::Result<crate::operation::update_identity_source::UpdateIdentitySourceOutput, crate::operation::update_identity_source::UpdateIdentitySourceError>;
