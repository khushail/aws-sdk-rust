...
impl DeletePolicyTemplateInput {
    /// Consumes the builder and constructs an Operation<[`DeletePolicyTemplate`](crate::operation::delete_policy_template::DeletePolicyTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_policy_template::DeletePolicyTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_policy_template::DeletePolicyTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_delete_policy_template::ser_delete_policy_template_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_policy_template::DeletePolicyTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeletePolicyTemplate", "verifiedpermissions"));
...
#[non_exhaustive]
#[doc(hidden)]
pub struct DeletePolicyTemplate;
impl DeletePolicyTemplate {
    #[doc(hidden)]
    pub fn new() -> Self {
        Self
    }
}
impl ::aws_smithy_http::response::ParseStrictResponse for DeletePolicyTemplate {
                type Output = ::std::result::Result<crate::operation::delete_policy_template::DeletePolicyTemplateOutput, crate::operation::delete_policy_template::DeletePolicyTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_policy_template::de_delete_policy_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_policy_template::de_delete_policy_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type DeletePolicyTemplateErrorKind = DeletePolicyTemplateError;
/// Error type for the `DeletePolicyTemplateError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DeletePolicyTemplateError {
...
impl ::aws_smithy_http::result::CreateUnhandledError for DeletePolicyTemplateError {
...
impl ::std::fmt::Display for DeletePolicyTemplateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DeletePolicyTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_policy_template::DeletePolicyTemplateError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for DeletePolicyTemplateError {
...
impl DeletePolicyTemplateError {
    /// Creates the `DeletePolicyTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DeletePolicyTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DeletePolicyTemplateError::ConflictException`.
    pub fn is_conflict_exception(&self) -> bool {
        matches!(self, Self::ConflictException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyTemplateError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyTemplateError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyTemplateError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyTemplateError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `DeletePolicyTemplateError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for DeletePolicyTemplateError {
...
pub use crate::operation::delete_policy_template::_delete_policy_template_output::DeletePolicyTemplateOutput;

pub use crate::operation::delete_policy_template::_delete_policy_template_input::DeletePolicyTemplateInput;

mod _delete_policy_template_input;

mod _delete_policy_template_output;
