...
impl ListPolicyTemplatesInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_policy_templates::ListPolicyTemplates, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_policy_templates::ListPolicyTemplatesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_list_policy_templates::ser_list_policy_templates_input(&self)?
        );
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListPolicyTemplates {
                type Output = ::std::result::Result<crate::operation::list_policy_templates::ListPolicyTemplatesOutput, crate::operation::list_policy_templates::ListPolicyTemplatesError>;
