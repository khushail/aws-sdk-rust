...
impl IsAuthorizedWithTokenInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::is_authorized_with_token::IsAuthorizedWithToken, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::is_authorized_with_token::IsAuthorizedWithTokenInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::is_authorized_with_token::IsAuthorizedWithToken::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("IsAuthorizedWithToken", "verifiedpermissions"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for IsAuthorizedWithToken {
                type Output = ::std::result::Result<crate::operation::is_authorized_with_token::IsAuthorizedWithTokenOutput, crate::operation::is_authorized_with_token::IsAuthorizedWithTokenError>;
