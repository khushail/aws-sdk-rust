...
impl GetPolicyTemplateInput {
    /// Consumes the builder and constructs an Operation<[`GetPolicyTemplate`](crate::operation::get_policy_template::GetPolicyTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_policy_template::GetPolicyTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_policy_template::GetPolicyTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_get_policy_template::ser_get_policy_template_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::get_policy_template::GetPolicyTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("GetPolicyTemplate", "verifiedpermissions"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `GetPolicyTemplate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetPolicyTemplate {
                type Output = ::std::result::Result<crate::operation::get_policy_template::GetPolicyTemplateOutput, crate::operation::get_policy_template::GetPolicyTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_get_policy_template::de_get_policy_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_get_policy_template::de_get_policy_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type GetPolicyTemplateErrorKind = GetPolicyTemplateError;
/// Error type for the `GetPolicyTemplateError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum GetPolicyTemplateError {
...
impl ::aws_smithy_http::result::CreateUnhandledError for GetPolicyTemplateError {
...
impl ::std::fmt::Display for GetPolicyTemplateError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for GetPolicyTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::get_policy_template::GetPolicyTemplateError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for GetPolicyTemplateError {
...
impl GetPolicyTemplateError {
    /// Creates the `GetPolicyTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `GetPolicyTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `GetPolicyTemplateError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyTemplateError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyTemplateError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyTemplateError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `GetPolicyTemplateError::ValidationException`.
    pub fn is_validation_exception(&self) -> bool {
        matches!(self, Self::ValidationException(_))
    }
}
impl ::std::error::Error for GetPolicyTemplateError {
...
mod _get_policy_template_output;
