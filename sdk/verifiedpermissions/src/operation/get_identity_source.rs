...
impl GetIdentitySourceInput {
    ...
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::get_identity_source::GetIdentitySource, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::get_identity_source::GetIdentitySourceInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
...
impl ::aws_smithy_http::response::ParseStrictResponse for GetIdentitySource {
                type Output = ::std::result::Result<crate::operation::get_identity_source::GetIdentitySourceOutput, crate::operation::get_identity_source::GetIdentitySourceError>;
