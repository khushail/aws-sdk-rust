...
impl CreatePolicyTemplateInput {
    /// Consumes the builder and constructs an Operation<[`CreatePolicyTemplate`](crate::operation::create_policy_template::CreatePolicyTemplate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_policy_template::CreatePolicyTemplate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_policy_template::CreatePolicyTemplateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_policy_template::ser_create_policy_template_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_policy_template::CreatePolicyTemplate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreatePolicyTemplate", "verifiedpermissions"));
...
impl CreatePolicyTemplate {
    #[doc(hidden)]
    pub fn new() -> Self {
        Self
    }
}
impl ::aws_smithy_http::response::ParseStrictResponse for CreatePolicyTemplate {
                type Output = ::std::result::Result<crate::operation::create_policy_template::CreatePolicyTemplateOutput, crate::operation::create_policy_template::CreatePolicyTemplateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_policy_template::de_create_policy_template_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_policy_template::de_create_policy_template_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreatePolicyTemplateErrorKind = CreatePolicyTemplateError;
/// Error type for the `CreatePolicyTemplateError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for CreatePolicyTemplateError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_policy_template::CreatePolicyTemplateError {
                            fn request_id(&self) -> Option<&str> {
                                self.meta().request_id()
                            }
                        }
impl ::aws_smithy_types::retry::ProvideErrorKind for CreatePolicyTemplateError {
...
impl CreatePolicyTemplateError {
    /// Creates the `CreatePolicyTemplateError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreatePolicyTemplateError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreatePolicyTemplateError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyTemplateError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyTemplateError::InternalServerException`.
    pub fn is_internal_server_exception(&self) -> bool {
        matches!(self, Self::InternalServerException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyTemplateError::ThrottlingException`.
    pub fn is_throttling_exception(&self) -> bool {
        matches!(self, Self::ThrottlingException(_))
    }
    /// Returns `true` if the error kind is `CreatePolicyTemplateError::ValidationException`.
...
pub use crate::operation::create_policy_template::_create_policy_template_output::CreatePolicyTemplateOutput;

pub use crate::operation::create_policy_template::_create_policy_template_input::CreatePolicyTemplateInput;

mod _create_policy_template_input;

mod _create_policy_template_output;
