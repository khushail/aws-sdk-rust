...
impl CreatePolicyStoreFluentBuilder  {
    /// Creates a new `CreatePolicyStore`.
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        pub async fn customize_middleware(self) -> ::std::result::Result<
                            crate::client::customize::CustomizableOperation<crate::operation::create_policy_store::CreatePolicyStore, ::aws_http::retry::AwsResponseRetryClassifier,>,
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::create_policy_store::CreatePolicyStoreOutput, ::aws_smithy_http::result::SdkError<crate::operation::create_policy_store::CreatePolicyStoreError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::create_policy_store::CreatePolicyStoreOutput, ::aws_smithy_http::result::SdkError<crate::operation::create_policy_store::CreatePolicyStoreError>>
                             {
    ...
    /// <p>Specifies a unique, case-sensitive ID that you provide to ensure the idempotency of the request. This lets you safely retry the request without accidentally performing the same operation a second time. Passing the same value to a later call to an operation requires that you also pass the same value for all other parameters. We recommend that you use a <a href="https://wikipedia.org/wiki/Universally_unique_Id">UUID type of value.</a>.</p> 
