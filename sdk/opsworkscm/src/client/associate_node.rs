...
impl super::Client  {
    ...
    ///   - [`server_name(impl ::std::convert::Into<String>)`](crate::operation::associate_node::builders::AssociateNodeFluentBuilder::server_name) / [`set_server_name(Option<String>)`](crate::operation::associate_node::builders::AssociateNodeFluentBuilder::set_server_name): <p>The name of the server with which to associate the node. </p>
    ///   - [`node_name(impl ::std::convert::Into<String>)`](crate::operation::associate_node::builders::AssociateNodeFluentBuilder::node_name) / [`set_node_name(Option<String>)`](crate::operation::associate_node::builders::AssociateNodeFluentBuilder::set_node_name): <p>The name of the node. </p>
