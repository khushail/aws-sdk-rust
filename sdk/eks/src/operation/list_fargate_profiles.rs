...
impl ListFargateProfilesInput {
    /// Consumes the builder and constructs an Operation<[`ListFargateProfiles`](crate::operation::list_fargate_profiles::ListFargateProfiles)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_fargate_profiles::ListFargateProfiles, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_fargate_profiles::ListFargateProfilesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/clusters/{clusterName}/fargate-profiles", clusterName = cluster_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_fargate_profiles::ListFargateProfilesInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_fargate_profiles::ListFargateProfilesInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_fargate_profiles::ListFargateProfiles::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListFargateProfiles", "eks"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListFargateProfiles`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListFargateProfiles {
                type Output = ::std::result::Result<crate::operation::list_fargate_profiles::ListFargateProfilesOutput, crate::operation::list_fargate_profiles::ListFargateProfilesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_fargate_profiles::de_list_fargate_profiles_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_fargate_profiles::de_list_fargate_profiles_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_fargate_profiles::ListFargateProfilesError {
...
mod _list_fargate_profiles_output;
