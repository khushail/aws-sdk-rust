...
impl AssociateEncryptionConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_encryption_config::AssociateEncryptionConfigInput, ::aws_smithy_http::operation::error::BuildError> {
