...
impl DescribeFargateProfileInput {
    /// Consumes the builder and constructs an Operation<[`DescribeFargateProfile`](crate::operation::describe_fargate_profile::DescribeFargateProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_fargate_profile::DescribeFargateProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_fargate_profile::DescribeFargateProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if fargate_profile_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("fargate_profile_name", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_fargate_profile::DescribeFargateProfileInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_fargate_profile::DescribeFargateProfile::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeFargateProfile {
                type Output = ::std::result::Result<crate::operation::describe_fargate_profile::DescribeFargateProfileOutput, crate::operation::describe_fargate_profile::DescribeFargateProfileError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_fargate_profile::de_describe_fargate_profile_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_fargate_profile::de_describe_fargate_profile_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_fargate_profile::DescribeFargateProfileError {
...
mod _describe_fargate_profile_output;
