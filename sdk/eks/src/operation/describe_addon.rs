...
impl DescribeAddonInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAddon`](crate::operation::describe_addon::DescribeAddon)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_addon::DescribeAddon, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_addon::DescribeAddonInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                if addon_name.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("addon_name", "cannot be empty or unset"))
                            }
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_addon::DescribeAddonInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_addon::DescribeAddon::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAddon", "eks"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeAddon`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAddon {
                type Output = ::std::result::Result<crate::operation::describe_addon::DescribeAddonOutput, crate::operation::describe_addon::DescribeAddonError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_addon::de_describe_addon_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_addon::de_describe_addon_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_addon::DescribeAddonError {
