...
impl DisassociateIdentityProviderConfigInput {
    /// Consumes the builder and constructs an Operation<[`DisassociateIdentityProviderConfig`](crate::operation::disassociate_identity_provider_config::DisassociateIdentityProviderConfig)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::disassociate_identity_provider_config::DisassociateIdentityProviderConfig, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::disassociate_identity_provider_config::DisassociateIdentityProviderConfigInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/clusters/{clusterName}/identity-provider-configs/disassociate", clusterName = cluster_name).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::disassociate_identity_provider_config::DisassociateIdentityProviderConfig::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for DisassociateIdentityProviderConfig {
                type Output = ::std::result::Result<crate::operation::disassociate_identity_provider_config::DisassociateIdentityProviderConfigOutput, crate::operation::disassociate_identity_provider_config::DisassociateIdentityProviderConfigError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_disassociate_identity_provider_config::de_disassociate_identity_provider_config_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_disassociate_identity_provider_config::de_disassociate_identity_provider_config_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DisassociateIdentityProviderConfigError {
...
impl ::aws_http::request_id::RequestId for crate::operation::disassociate_identity_provider_config::DisassociateIdentityProviderConfigError {
...
mod _disassociate_identity_provider_config_output;
