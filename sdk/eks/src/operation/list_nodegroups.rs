...
impl ListNodegroupsInput {
    /// Consumes the builder and constructs an Operation<[`ListNodegroups`](crate::operation::list_nodegroups::ListNodegroups)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_nodegroups::ListNodegroups, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_nodegroups::ListNodegroupsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn uri_query(_input: &crate::operation::list_nodegroups::ListNodegroupsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_nodegroups::ListNodegroupsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_nodegroups::ListNodegroups::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListNodegroups {
                type Output = ::std::result::Result<crate::operation::list_nodegroups::ListNodegroupsOutput, crate::operation::list_nodegroups::ListNodegroupsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_nodegroups::de_list_nodegroups_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_nodegroups::de_list_nodegroups_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_nodegroups::ListNodegroupsError {
