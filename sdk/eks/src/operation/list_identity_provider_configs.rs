...
impl ListIdentityProviderConfigsInput {
    /// Consumes the builder and constructs an Operation<[`ListIdentityProviderConfigs`](crate::operation::list_identity_provider_configs::ListIdentityProviderConfigs)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_identity_provider_configs::ListIdentityProviderConfigs, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/clusters/{clusterName}/identity-provider-configs", clusterName = cluster_name).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_identity_provider_configs::ListIdentityProviderConfigs::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListIdentityProviderConfigs {
                type Output = ::std::result::Result<crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsOutput, crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_identity_provider_configs::de_list_identity_provider_configs_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_identity_provider_configs::de_list_identity_provider_configs_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::list_identity_provider_configs::ListIdentityProviderConfigsError {
...
mod _list_identity_provider_configs_output;
