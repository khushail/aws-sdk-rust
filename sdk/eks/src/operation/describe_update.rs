...
impl DescribeUpdateInput {
    /// Consumes the builder and constructs an Operation<[`DescribeUpdate`](crate::operation::describe_update::DescribeUpdate)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_update::DescribeUpdate, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_update::DescribeUpdateInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                let input_2 = input_2.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("update_id", "cannot be empty or unset"))?;
                let update_id = ::aws_smithy_http::label::fmt_string(input_2, ::aws_smithy_http::label::EncodingStrategy::Default);
                if update_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("update_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/clusters/{name}/updates/{updateId}", name = name, updateId = update_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::describe_update::DescribeUpdateInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                let mut query = ::aws_smithy_http::query::Writer::new(output);
                if let ::std::option::Option::Some(inner_3) = &_input.nodegroup_name {
                     {
                        query.push_kv("nodegroupName", &::aws_smithy_http::query::fmt_string(&inner_3));
                    }
                }
            ...
            fn update_http_builder(
                            input: &crate::operation::describe_update::DescribeUpdateInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_update::DescribeUpdate::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeUpdate", "eks"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeUpdate`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeUpdate {
                type Output = ::std::result::Result<crate::operation::describe_update::DescribeUpdateOutput, crate::operation::describe_update::DescribeUpdateError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_update::de_describe_update_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_update::de_describe_update_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_update::DescribeUpdateError {
