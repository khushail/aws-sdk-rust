...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::delete_cluster::builders::DeleteClusterFluentBuilder::set_name): <p>The name of the cluster to delete.</p>
                            /// - On success, responds with [`DeleteClusterOutput`](crate::operation::delete_cluster::DeleteClusterOutput) with field(s):
    ///   - [`cluster(Option<Cluster>)`](crate::operation::delete_cluster::DeleteClusterOutput::cluster): <p>The full description of the cluster to delete.</p>
