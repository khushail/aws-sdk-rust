...
impl super::Client  {
    ...
    ///   - [`name(impl ::std::convert::Into<String>)`](crate::operation::deregister_cluster::builders::DeregisterClusterFluentBuilder::name) / [`set_name(Option<String>)`](crate::operation::deregister_cluster::builders::DeregisterClusterFluentBuilder::set_name): <p>The name of the connected cluster to deregister.</p>
