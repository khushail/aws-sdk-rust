...
impl super::Client  {
    ...
    ///   - [`addon_name(impl ::std::convert::Into<String>)`](crate::operation::describe_addon_configuration::builders::DescribeAddonConfigurationFluentBuilder::addon_name) / [`set_addon_name(Option<String>)`](crate::operation::describe_addon_configuration::builders::DescribeAddonConfigurationFluentBuilder::set_addon_name): <p>The name of the add-on. The name must match one of the names that <a href="https://docs.aws.amazon.com/eks/latest/APIReference/API_DescribeAddonVersions.html"> <code>DescribeAddonVersions</code> </a> returns.</p>
    ///   - [`addon_version(impl ::std::convert::Into<String>)`](crate::operation::describe_addon_configuration::builders::DescribeAddonConfigurationFluentBuilder::addon_version) / [`set_addon_version(Option<String>)`](crate::operation::describe_addon_configuration::builders::DescribeAddonConfigurationFluentBuilder::set_addon_version): <p>The version of the add-on. The version must match one of the versions returned by <a href="https://docs.aws.amazon.com/eks/latest/APIReference/API_DescribeAddonVersions.html"> <code>DescribeAddonVersions</code> </a>.</p>
