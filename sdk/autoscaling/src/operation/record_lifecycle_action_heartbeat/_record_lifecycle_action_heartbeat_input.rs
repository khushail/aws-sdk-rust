...
impl RecordLifecycleActionHeartbeatInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::record_lifecycle_action_heartbeat::RecordLifecycleActionHeartbeatInput, ::aws_smithy_http::operation::error::BuildError> {
