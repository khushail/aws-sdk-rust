...
impl DescribeMetricCollectionTypesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeMetricCollectionTypes`](crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeMetricCollectionTypes", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeMetricCollectionTypes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeMetricCollectionTypes {
                type Output = ::std::result::Result<crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypesOutput, crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_metric_collection_types::de_describe_metric_collection_types_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_metric_collection_types::de_describe_metric_collection_types_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_metric_collection_types::DescribeMetricCollectionTypesError {
...
mod _describe_metric_collection_types_output;
