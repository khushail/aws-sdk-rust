...
impl AttachTrafficSourcesInput {
    /// Consumes the builder and constructs an Operation<[`AttachTrafficSources`](crate::operation::attach_traffic_sources::AttachTrafficSources)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::attach_traffic_sources::AttachTrafficSources, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_traffic_sources::AttachTrafficSourcesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_traffic_sources::AttachTrafficSources::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AttachTrafficSources", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AttachTrafficSources`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachTrafficSources {
                type Output = ::std::result::Result<crate::operation::attach_traffic_sources::AttachTrafficSourcesOutput, crate::operation::attach_traffic_sources::AttachTrafficSourcesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_attach_traffic_sources::de_attach_traffic_sources_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_attach_traffic_sources::de_attach_traffic_sources_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_traffic_sources::AttachTrafficSourcesError {
...
mod _attach_traffic_sources_output;
