...
impl DescribeInstanceRefreshesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeInstanceRefreshes`](crate::operation::describe_instance_refreshes::DescribeInstanceRefreshes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_instance_refreshes::DescribeInstanceRefreshes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_instance_refreshes::DescribeInstanceRefreshesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_instance_refreshes::DescribeInstanceRefreshes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeInstanceRefreshes", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeInstanceRefreshes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeInstanceRefreshes {
                type Output = ::std::result::Result<crate::operation::describe_instance_refreshes::DescribeInstanceRefreshesOutput, crate::operation::describe_instance_refreshes::DescribeInstanceRefreshesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_instance_refreshes::de_describe_instance_refreshes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_instance_refreshes::de_describe_instance_refreshes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_instance_refreshes::DescribeInstanceRefreshesError {
...
mod _describe_instance_refreshes_output;
