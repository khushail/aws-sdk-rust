...
impl DescribeLifecycleHookTypesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLifecycleHookTypes`](crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeLifecycleHookTypes", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeLifecycleHookTypes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLifecycleHookTypes {
                type Output = ::std::result::Result<crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypesOutput, crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_lifecycle_hook_types::de_describe_lifecycle_hook_types_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_lifecycle_hook_types::de_describe_lifecycle_hook_types_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_lifecycle_hook_types::DescribeLifecycleHookTypesError {
...
pub use crate::operation::describe_lifecycle_hook_types::_describe_lifecycle_hook_types_output::DescribeLifecycleHookTypesOutput;

pub use crate::operation::describe_lifecycle_hook_types::_describe_lifecycle_hook_types_input::DescribeLifecycleHookTypesInput;

mod _describe_lifecycle_hook_types_input;

mod _describe_lifecycle_hook_types_output;
