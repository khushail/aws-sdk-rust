...
impl PutScheduledUpdateGroupActionInput {
    /// Consumes the builder and constructs an Operation<[`PutScheduledUpdateGroupAction`](crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupAction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupAction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutScheduledUpdateGroupAction", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutScheduledUpdateGroupAction`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutScheduledUpdateGroupAction {
                type Output = ::std::result::Result<crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionOutput, crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_scheduled_update_group_action::de_put_scheduled_update_group_action_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_scheduled_update_group_action::de_put_scheduled_update_group_action_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_scheduled_update_group_action::PutScheduledUpdateGroupActionError {
...
mod _put_scheduled_update_group_action_output;
