...
impl AttachInstancesInput {
    /// Consumes the builder and constructs an Operation<[`AttachInstances`](crate::operation::attach_instances::AttachInstances)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::attach_instances::AttachInstances, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_instances::AttachInstancesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_instances::AttachInstances::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachInstances {
                type Output = ::std::result::Result<crate::operation::attach_instances::AttachInstancesOutput, crate::operation::attach_instances::AttachInstancesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_attach_instances::de_attach_instances_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_attach_instances::de_attach_instances_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_instances::AttachInstancesError {
