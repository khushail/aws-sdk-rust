...
impl EnableMetricsCollectionInput {
    /// Consumes the builder and constructs an Operation<[`EnableMetricsCollection`](crate::operation::enable_metrics_collection::EnableMetricsCollection)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::enable_metrics_collection::EnableMetricsCollection, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::enable_metrics_collection::EnableMetricsCollectionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::enable_metrics_collection::EnableMetricsCollectionInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::enable_metrics_collection::EnableMetricsCollection::new())
...
impl ::aws_smithy_http::response::ParseStrictResponse for EnableMetricsCollection {
                type Output = ::std::result::Result<crate::operation::enable_metrics_collection::EnableMetricsCollectionOutput, crate::operation::enable_metrics_collection::EnableMetricsCollectionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_enable_metrics_collection::de_enable_metrics_collection_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_enable_metrics_collection::de_enable_metrics_collection_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::enable_metrics_collection::EnableMetricsCollectionError {
...
mod _enable_metrics_collection_output;
