...
impl UpdateAutoScalingGroupInput {
    /// Consumes the builder and constructs an Operation<[`UpdateAutoScalingGroup`](crate::operation::update_auto_scaling_group::UpdateAutoScalingGroup)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_auto_scaling_group::UpdateAutoScalingGroup, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_auto_scaling_group::UpdateAutoScalingGroupInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_auto_scaling_group::UpdateAutoScalingGroup::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateAutoScalingGroup", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `UpdateAutoScalingGroup`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateAutoScalingGroup {
                type Output = ::std::result::Result<crate::operation::update_auto_scaling_group::UpdateAutoScalingGroupOutput, crate::operation::update_auto_scaling_group::UpdateAutoScalingGroupError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_auto_scaling_group::de_update_auto_scaling_group_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_auto_scaling_group::de_update_auto_scaling_group_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::update_auto_scaling_group::UpdateAutoScalingGroupError {
...
mod _update_auto_scaling_group_output;
