...
impl DeleteLaunchConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLaunchConfiguration`](crate::operation::delete_launch_configuration::DeleteLaunchConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_launch_configuration::DeleteLaunchConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_launch_configuration::DeleteLaunchConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_launch_configuration::DeleteLaunchConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteLaunchConfiguration", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteLaunchConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLaunchConfiguration {
                type Output = ::std::result::Result<crate::operation::delete_launch_configuration::DeleteLaunchConfigurationOutput, crate::operation::delete_launch_configuration::DeleteLaunchConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_launch_configuration::de_delete_launch_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_delete_launch_configuration::de_delete_launch_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_launch_configuration::DeleteLaunchConfigurationError {
...
mod _delete_launch_configuration_output;
