...
impl DeleteLifecycleHookInput {
    /// Consumes the builder and constructs an Operation<[`DeleteLifecycleHook`](crate::operation::delete_lifecycle_hook::DeleteLifecycleHook)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::delete_lifecycle_hook::DeleteLifecycleHook, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::delete_lifecycle_hook::DeleteLifecycleHookInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::delete_lifecycle_hook::DeleteLifecycleHook::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DeleteLifecycleHook", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DeleteLifecycleHook`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DeleteLifecycleHook {
                type Output = ::std::result::Result<crate::operation::delete_lifecycle_hook::DeleteLifecycleHookOutput, crate::operation::delete_lifecycle_hook::DeleteLifecycleHookError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_delete_lifecycle_hook::de_delete_lifecycle_hook_http_error(status, headers, body)
                     } else {
...
impl ::aws_http::request_id::RequestId for crate::operation::delete_lifecycle_hook::DeleteLifecycleHookError {
...
mod _delete_lifecycle_hook_output;
