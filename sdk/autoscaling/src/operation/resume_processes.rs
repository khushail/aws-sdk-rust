...
impl ResumeProcessesInput {
    /// Consumes the builder and constructs an Operation<[`ResumeProcesses`](crate::operation::resume_processes::ResumeProcesses)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::resume_processes::ResumeProcesses, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::resume_processes::ResumeProcessesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::resume_processes::ResumeProcesses::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ResumeProcesses", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ResumeProcesses`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ResumeProcesses {
                type Output = ::std::result::Result<crate::operation::resume_processes::ResumeProcessesOutput, crate::operation::resume_processes::ResumeProcessesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_resume_processes::de_resume_processes_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_resume_processes::de_resume_processes_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::resume_processes::ResumeProcessesError {
