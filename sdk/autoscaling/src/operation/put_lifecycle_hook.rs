...
impl PutLifecycleHookInput {
    /// Consumes the builder and constructs an Operation<[`PutLifecycleHook`](crate::operation::put_lifecycle_hook::PutLifecycleHook)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_lifecycle_hook::PutLifecycleHook, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_lifecycle_hook::PutLifecycleHookInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_lifecycle_hook::PutLifecycleHook::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutLifecycleHook", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutLifecycleHook`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutLifecycleHook {
                type Output = ::std::result::Result<crate::operation::put_lifecycle_hook::PutLifecycleHookOutput, crate::operation::put_lifecycle_hook::PutLifecycleHookError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_lifecycle_hook::de_put_lifecycle_hook_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_lifecycle_hook::de_put_lifecycle_hook_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_lifecycle_hook::PutLifecycleHookError {
...
pub use crate::operation::put_lifecycle_hook::_put_lifecycle_hook_output::PutLifecycleHookOutput;

pub use crate::operation::put_lifecycle_hook::_put_lifecycle_hook_input::PutLifecycleHookInput;

mod _put_lifecycle_hook_input;

mod _put_lifecycle_hook_output;
