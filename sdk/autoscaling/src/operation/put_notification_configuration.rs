...
impl PutNotificationConfigurationInput {
    /// Consumes the builder and constructs an Operation<[`PutNotificationConfiguration`](crate::operation::put_notification_configuration::PutNotificationConfiguration)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::put_notification_configuration::PutNotificationConfiguration, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::put_notification_configuration::PutNotificationConfigurationInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::put_notification_configuration::PutNotificationConfiguration::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("PutNotificationConfiguration", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `PutNotificationConfiguration`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for PutNotificationConfiguration {
                type Output = ::std::result::Result<crate::operation::put_notification_configuration::PutNotificationConfigurationOutput, crate::operation::put_notification_configuration::PutNotificationConfigurationError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_put_notification_configuration::de_put_notification_configuration_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_put_notification_configuration::de_put_notification_configuration_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::put_notification_configuration::PutNotificationConfigurationError {
...
pub use crate::operation::put_notification_configuration::_put_notification_configuration_output::PutNotificationConfigurationOutput;

pub use crate::operation::put_notification_configuration::_put_notification_configuration_input::PutNotificationConfigurationInput;

mod _put_notification_configuration_input;

mod _put_notification_configuration_output;
