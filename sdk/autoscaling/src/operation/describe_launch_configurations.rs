...
impl DescribeLaunchConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeLaunchConfigurations`](crate::operation::describe_launch_configurations::DescribeLaunchConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_launch_configurations::DescribeLaunchConfigurations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_launch_configurations::DescribeLaunchConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_launch_configurations::DescribeLaunchConfigurations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeLaunchConfigurations", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeLaunchConfigurations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeLaunchConfigurations {
                type Output = ::std::result::Result<crate::operation::describe_launch_configurations::DescribeLaunchConfigurationsOutput, crate::operation::describe_launch_configurations::DescribeLaunchConfigurationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_launch_configurations::de_describe_launch_configurations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_launch_configurations::de_describe_launch_configurations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_launch_configurations::DescribeLaunchConfigurationsError {
...
pub use crate::operation::describe_launch_configurations::_describe_launch_configurations_output::DescribeLaunchConfigurationsOutput;

pub use crate::operation::describe_launch_configurations::_describe_launch_configurations_input::DescribeLaunchConfigurationsInput;

mod _describe_launch_configurations_input;

mod _describe_launch_configurations_output;
