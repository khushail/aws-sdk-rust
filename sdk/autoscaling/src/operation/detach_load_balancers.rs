...
impl DetachLoadBalancersInput {
    /// Consumes the builder and constructs an Operation<[`DetachLoadBalancers`](crate::operation::detach_load_balancers::DetachLoadBalancers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::detach_load_balancers::DetachLoadBalancers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::detach_load_balancers::DetachLoadBalancersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::detach_load_balancers::DetachLoadBalancers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DetachLoadBalancers", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DetachLoadBalancers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DetachLoadBalancers {
                type Output = ::std::result::Result<crate::operation::detach_load_balancers::DetachLoadBalancersOutput, crate::operation::detach_load_balancers::DetachLoadBalancersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_detach_load_balancers::de_detach_load_balancers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_detach_load_balancers::de_detach_load_balancers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::detach_load_balancers::DetachLoadBalancersError {
...
mod _detach_load_balancers_output;
