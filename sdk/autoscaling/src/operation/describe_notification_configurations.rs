...
impl DescribeNotificationConfigurationsInput {
    /// Consumes the builder and constructs an Operation<[`DescribeNotificationConfigurations`](crate::operation::describe_notification_configurations::DescribeNotificationConfigurations)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_notification_configurations::DescribeNotificationConfigurations, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_notification_configurations::DescribeNotificationConfigurationsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_notification_configurations::DescribeNotificationConfigurations::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeNotificationConfigurations", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeNotificationConfigurations`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeNotificationConfigurations {
                type Output = ::std::result::Result<crate::operation::describe_notification_configurations::DescribeNotificationConfigurationsOutput, crate::operation::describe_notification_configurations::DescribeNotificationConfigurationsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_notification_configurations::de_describe_notification_configurations_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_notification_configurations::de_describe_notification_configurations_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_notification_configurations::DescribeNotificationConfigurationsError {
...
pub use crate::operation::describe_notification_configurations::_describe_notification_configurations_output::DescribeNotificationConfigurationsOutput;

pub use crate::operation::describe_notification_configurations::_describe_notification_configurations_input::DescribeNotificationConfigurationsInput;

mod _describe_notification_configurations_input;

mod _describe_notification_configurations_output;
