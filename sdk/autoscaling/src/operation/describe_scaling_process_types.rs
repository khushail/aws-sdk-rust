...
impl DescribeScalingProcessTypesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeScalingProcessTypes`](crate::operation::describe_scaling_process_types::DescribeScalingProcessTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_scaling_process_types::DescribeScalingProcessTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_scaling_process_types::DescribeScalingProcessTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_scaling_process_types::DescribeScalingProcessTypes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeScalingProcessTypes", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeScalingProcessTypes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeScalingProcessTypes {
                type Output = ::std::result::Result<crate::operation::describe_scaling_process_types::DescribeScalingProcessTypesOutput, crate::operation::describe_scaling_process_types::DescribeScalingProcessTypesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_scaling_process_types::de_describe_scaling_process_types_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_scaling_process_types::de_describe_scaling_process_types_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_scaling_process_types::DescribeScalingProcessTypesError {
...
pub use crate::operation::describe_scaling_process_types::_describe_scaling_process_types_output::DescribeScalingProcessTypesOutput;

pub use crate::operation::describe_scaling_process_types::_describe_scaling_process_types_input::DescribeScalingProcessTypesInput;

mod _describe_scaling_process_types_input;

mod _describe_scaling_process_types_output;
