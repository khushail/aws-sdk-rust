...
impl CompleteLifecycleActionInput {
    /// Consumes the builder and constructs an Operation<[`CompleteLifecycleAction`](crate::operation::complete_lifecycle_action::CompleteLifecycleAction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::complete_lifecycle_action::CompleteLifecycleAction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::complete_lifecycle_action::CompleteLifecycleActionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::complete_lifecycle_action::CompleteLifecycleAction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CompleteLifecycleAction", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `CompleteLifecycleAction`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for CompleteLifecycleAction {
                type Output = ::std::result::Result<crate::operation::complete_lifecycle_action::CompleteLifecycleActionOutput, crate::operation::complete_lifecycle_action::CompleteLifecycleActionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_complete_lifecycle_action::de_complete_lifecycle_action_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_complete_lifecycle_action::de_complete_lifecycle_action_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::complete_lifecycle_action::CompleteLifecycleActionError {
...
mod _complete_lifecycle_action_output;
