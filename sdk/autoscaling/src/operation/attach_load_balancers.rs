...
impl AttachLoadBalancersInput {
    /// Consumes the builder and constructs an Operation<[`AttachLoadBalancers`](crate::operation::attach_load_balancers::AttachLoadBalancers)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::attach_load_balancers::AttachLoadBalancers, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::attach_load_balancers::AttachLoadBalancersInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::attach_load_balancers::AttachLoadBalancers::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AttachLoadBalancers", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AttachLoadBalancers`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AttachLoadBalancers {
                type Output = ::std::result::Result<crate::operation::attach_load_balancers::AttachLoadBalancersOutput, crate::operation::attach_load_balancers::AttachLoadBalancersError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_attach_load_balancers::de_attach_load_balancers_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_attach_load_balancers::de_attach_load_balancers_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::attach_load_balancers::AttachLoadBalancersError {
...
mod _attach_load_balancers_output;
