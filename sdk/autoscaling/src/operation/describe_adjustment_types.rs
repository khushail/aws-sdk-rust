...
impl DescribeAdjustmentTypesInput {
    /// Consumes the builder and constructs an Operation<[`DescribeAdjustmentTypes`](crate::operation::describe_adjustment_types::DescribeAdjustmentTypes)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::describe_adjustment_types::DescribeAdjustmentTypes, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::describe_adjustment_types::DescribeAdjustmentTypesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::describe_adjustment_types::DescribeAdjustmentTypes::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DescribeAdjustmentTypes", "autoscaling"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `DescribeAdjustmentTypes`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for DescribeAdjustmentTypes {
                type Output = ::std::result::Result<crate::operation::describe_adjustment_types::DescribeAdjustmentTypesOutput, crate::operation::describe_adjustment_types::DescribeAdjustmentTypesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_describe_adjustment_types::de_describe_adjustment_types_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_describe_adjustment_types::de_describe_adjustment_types_http_response_with_props(status, headers, body)
                     }
                }
...
impl ::aws_http::request_id::RequestId for crate::operation::describe_adjustment_types::DescribeAdjustmentTypesError {
...
mod _describe_adjustment_types_output;
