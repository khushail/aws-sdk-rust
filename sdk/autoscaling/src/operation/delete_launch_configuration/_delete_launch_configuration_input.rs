...
impl DeleteLaunchConfigurationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_launch_configuration::DeleteLaunchConfigurationInput, ::aws_smithy_http::operation::error::BuildError> {
