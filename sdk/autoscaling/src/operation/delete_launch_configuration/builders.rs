...
pub use crate::operation::delete_launch_configuration::_delete_launch_configuration_output::DeleteLaunchConfigurationOutputBuilder;

pub use crate::operation::delete_launch_configuration::_delete_launch_configuration_input::DeleteLaunchConfigurationInputBuilder;
...
impl DeleteLaunchConfigurationInputBuilder {
    /// Sends a request with this input using the given client.
                    pub async fn send_with(
                        ...
                        >
                    >   {
                        let mut fluent_builder = client.delete_launch_configuration();
...
impl DeleteLaunchConfigurationFluentBuilder  {
    ...
    // This function will go away in the near future. Do not rely on it.
                        ...
                        // This function will go away in the near future. Do not rely on it.
                        #[doc(hidden)]
                        pub async fn send_middleware(self) -> ::std::result::Result<crate::operation::delete_launch_configuration::DeleteLaunchConfigurationOutput, ::aws_smithy_http::result::SdkError<crate::operation::delete_launch_configuration::DeleteLaunchConfigurationError>>
                         {
    ...
    /// Sends the request and returns the response.
                            ...
                            pub async fn send(self) -> ::std::result::Result<crate::operation::delete_launch_configuration::DeleteLaunchConfigurationOutput, ::aws_smithy_http::result::SdkError<crate::operation::delete_launch_configuration::DeleteLaunchConfigurationError>>
                             {
