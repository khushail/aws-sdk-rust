...
pub fn de_cancel_instance_refresh_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_instance_refresh::CancelInstanceRefreshOutput, crate::operation::cancel_instance_refresh::CancelInstanceRefreshError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::cancel_instance_refresh::CancelInstanceRefreshError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_cancel_instance_refresh_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::cancel_instance_refresh::CancelInstanceRefreshOutput, crate::operation::cancel_instance_refresh::CancelInstanceRefreshError> {
    Ok({
        #[allow(unused_mut)]
        let mut output = crate::operation::cancel_instance_refresh::builders::CancelInstanceRefreshOutputBuilder::default();
        output = crate::protocol_serde::shape_cancel_instance_refresh::de_cancel_instance_refresh(_response_body, output).map_err(crate::operation::cancel_instance_refresh::CancelInstanceRefreshError::unhandled)?;
