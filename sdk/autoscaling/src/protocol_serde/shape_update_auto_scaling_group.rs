...
#[allow(clippy::unnecessary_wraps)]
pub fn de_update_auto_scaling_group_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::update_auto_scaling_group::UpdateAutoScalingGroupOutput, crate::operation::update_auto_scaling_group::UpdateAutoScalingGroupError> {
    Ok({
        #[allow(unused_mut)]
