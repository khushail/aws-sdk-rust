...
pub fn de_create_or_update_tags_http_error(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_or_update_tags::CreateOrUpdateTagsOutput, crate::operation::create_or_update_tags::CreateOrUpdateTagsError> {
    #[allow(unused_mut)]
    let mut generic_builder = crate::protocol_serde::parse_http_error_metadata(_response_status, _response_headers, _response_body).map_err(crate::operation::create_or_update_tags::CreateOrUpdateTagsError::unhandled)?;
...
#[allow(clippy::unnecessary_wraps)]
pub fn de_create_or_update_tags_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::create_or_update_tags::CreateOrUpdateTagsOutput, crate::operation::create_or_update_tags::CreateOrUpdateTagsError> {
    Ok({
        #[allow(unused_mut)]
