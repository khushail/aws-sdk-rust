...
#[allow(unused_mut)]
pub fn ser_accelerator_total_memory_mi_b_request(mut writer: ::aws_smithy_query::QueryValueWriter, input: &crate::types::AcceleratorTotalMemoryMiBRequest) -> Result<(), ::aws_smithy_http::operation::error::SerializationError> {
    #[allow(unused_mut)]
...
pub fn de_accelerator_total_memory_mi_b_request(decoder: &mut ::aws_smithy_xml::decode::ScopedDecoder) -> Result<crate::types::AcceleratorTotalMemoryMiBRequest, ::aws_smithy_xml::decode::XmlDecodeError> {
    #[allow(unused_mut)]
