...
impl super::Client  {
    ...
    ///   - [`auto_scaling_group_name(impl ::std::convert::Into<String>)`](crate::operation::attach_load_balancer_target_groups::builders::AttachLoadBalancerTargetGroupsFluentBuilder::auto_scaling_group_name) / [`set_auto_scaling_group_name(Option<String>)`](crate::operation::attach_load_balancer_target_groups::builders::AttachLoadBalancerTargetGroupsFluentBuilder::set_auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
