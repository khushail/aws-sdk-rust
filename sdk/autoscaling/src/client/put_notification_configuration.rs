...
impl super::Client  {
    ...
    ///   - [`auto_scaling_group_name(impl ::std::convert::Into<String>)`](crate::operation::put_notification_configuration::builders::PutNotificationConfigurationFluentBuilder::auto_scaling_group_name) / [`set_auto_scaling_group_name(Option<String>)`](crate::operation::put_notification_configuration::builders::PutNotificationConfigurationFluentBuilder::set_auto_scaling_group_name): <p>The name of the Auto Scaling group.</p>
    ///   - [`topic_arn(impl ::std::convert::Into<String>)`](crate::operation::put_notification_configuration::builders::PutNotificationConfigurationFluentBuilder::topic_arn) / [`set_topic_arn(Option<String>)`](crate::operation::put_notification_configuration::builders::PutNotificationConfigurationFluentBuilder::set_topic_arn): <p>The Amazon Resource Name (ARN) of the Amazon SNS topic.</p>
