...
impl super::Client  {
    ...
    ///   - [`snapshot_id(impl ::std::convert::Into<String>)`](crate::operation::complete_snapshot::builders::CompleteSnapshotFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::complete_snapshot::builders::CompleteSnapshotFluentBuilder::set_snapshot_id): <p>The ID of the snapshot.</p>
