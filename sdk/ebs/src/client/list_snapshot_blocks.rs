...
impl super::Client  {
    ...
    ///   - [`snapshot_id(impl ::std::convert::Into<String>)`](crate::operation::list_snapshot_blocks::builders::ListSnapshotBlocksFluentBuilder::snapshot_id) / [`set_snapshot_id(Option<String>)`](crate::operation::list_snapshot_blocks::builders::ListSnapshotBlocksFluentBuilder::set_snapshot_id): <p>The ID of the snapshot from which to get block indexes and block tokens.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_snapshot_blocks::builders::ListSnapshotBlocksFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_snapshot_blocks::builders::ListSnapshotBlocksFluentBuilder::set_next_token): <p>The token to request the next page of results.</p>  <p>If you specify <b>NextToken</b>, then <b>StartingBlockIndex</b> is ignored.</p>
