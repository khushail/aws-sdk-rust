...
impl ListChangedBlocksInput {
    /// Consumes the builder and constructs an Operation<[`ListChangedBlocks`](crate::operation::list_changed_blocks::ListChangedBlocks)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_changed_blocks::ListChangedBlocks, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_changed_blocks::ListChangedBlocksInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                let input_1 = &_input.second_snapshot_id;
                let input_1 = input_1.as_ref().ok_or_else(|| ::aws_smithy_http::operation::error::BuildError::missing_field("second_snapshot_id", "cannot be empty or unset"))?;
                ...
                if second_snapshot_id.is_empty() {
                                return ::std::result::Result::Err(::aws_smithy_http::operation::error::BuildError::missing_field("second_snapshot_id", "cannot be empty or unset"))
                            }
                ::std::write!(output, "/snapshots/{SecondSnapshotId}/changedblocks", SecondSnapshotId = second_snapshot_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_changed_blocks::ListChangedBlocksInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_changed_blocks::ListChangedBlocks::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListChangedBlocks", "ebs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListChangedBlocks {
                type Output = ::std::result::Result<crate::operation::list_changed_blocks::ListChangedBlocksOutput, crate::operation::list_changed_blocks::ListChangedBlocksError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        ...
                        crate::protocol_serde::shape_list_changed_blocks::de_list_changed_blocks_http_response_with_props(status, headers, body)
                     }
                }
...
mod list_changed_blocks_request_test {
    ...
    async fn lowercase_message_response() {
        ...
        use ::aws_smithy_http::response::ParseHttpResponse;
                        let parser = crate::operation::list_changed_blocks::ListChangedBlocks::new();
                        ...
                        let parsed = parsed.unwrap_or_else(|| {
                            ...
                            <crate::operation::list_changed_blocks::ListChangedBlocks as ::aws_smithy_http::response::ParseHttpResponse>::parse_loaded(&parser, &http_response)
                        });
        let parsed = parsed.expect_err("should be error response");
        if let crate::operation::list_changed_blocks::ListChangedBlocksError::ValidationException(parsed) = parsed {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_changed_blocks::ListChangedBlocksError {
