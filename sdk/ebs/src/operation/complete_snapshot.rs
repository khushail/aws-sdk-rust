...
impl CompleteSnapshotInput {
    /// Consumes the builder and constructs an Operation<[`CompleteSnapshot`](crate::operation::complete_snapshot::CompleteSnapshot)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::complete_snapshot::CompleteSnapshot, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::complete_snapshot::CompleteSnapshotInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::complete_snapshot::CompleteSnapshot::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CompleteSnapshot", "ebs"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CompleteSnapshot {
                type Output = ::std::result::Result<crate::operation::complete_snapshot::CompleteSnapshotOutput, crate::operation::complete_snapshot::CompleteSnapshotError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 202 {
                        ...
                        crate::protocol_serde::shape_complete_snapshot::de_complete_snapshot_http_response_with_props(status, headers, body)
                     }
                }
...
mod complete_snapshot_request_test {
    ...
    async fn lowercase_message_response() {
        ...
        use ::aws_smithy_http::response::ParseHttpResponse;
                        let parser = crate::operation::complete_snapshot::CompleteSnapshot::new();
                        ...
                        let parsed = parsed.unwrap_or_else(|| {
                            ...
                            <crate::operation::complete_snapshot::CompleteSnapshot as ::aws_smithy_http::response::ParseHttpResponse>::parse_loaded(&parser, &http_response)
                        });
