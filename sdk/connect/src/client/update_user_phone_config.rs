...
impl super::Client  {
    ...
    ///   - [`user_id(impl ::std::convert::Into<String>)`](crate::operation::update_user_phone_config::builders::UpdateUserPhoneConfigFluentBuilder::user_id) / [`set_user_id(Option<String>)`](crate::operation::update_user_phone_config::builders::UpdateUserPhoneConfigFluentBuilder::set_user_id): <p>The identifier of the user account.</p>
