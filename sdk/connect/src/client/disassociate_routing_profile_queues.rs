...
impl super::Client  {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::disassociate_routing_profile_queues::builders::DisassociateRoutingProfileQueuesFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::disassociate_routing_profile_queues::builders::DisassociateRoutingProfileQueuesFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`routing_profile_id(impl ::std::convert::Into<String>)`](crate::operation::disassociate_routing_profile_queues::builders::DisassociateRoutingProfileQueuesFluentBuilder::routing_profile_id) / [`set_routing_profile_id(Option<String>)`](crate::operation::disassociate_routing_profile_queues::builders::DisassociateRoutingProfileQueuesFluentBuilder::set_routing_profile_id): <p>The identifier of the routing profile.</p>
