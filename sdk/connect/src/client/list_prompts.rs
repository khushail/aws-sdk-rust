...
impl super::Client  {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::list_prompts::builders::ListPromptsFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::list_prompts::builders::ListPromptsFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance.</p>
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_prompts::builders::ListPromptsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_prompts::builders::ListPromptsFluentBuilder::set_next_token): <p>The token for the next set of results. Use the value returned in the previous response in the next request to retrieve the next set of results.</p>
