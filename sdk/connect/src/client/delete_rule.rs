...
impl super::Client  {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`rule_id(impl ::std::convert::Into<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::rule_id) / [`set_rule_id(Option<String>)`](crate::operation::delete_rule::builders::DeleteRuleFluentBuilder::set_rule_id): <p>A unique identifier for the rule.</p>
