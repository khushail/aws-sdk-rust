...
impl super::Client  {
    ...
    ///   - [`instance_id(impl ::std::convert::Into<String>)`](crate::operation::describe_prompt::builders::DescribePromptFluentBuilder::instance_id) / [`set_instance_id(Option<String>)`](crate::operation::describe_prompt::builders::DescribePromptFluentBuilder::set_instance_id): <p>The identifier of the Amazon Connect instance. You can <a href="https://docs.aws.amazon.com/connect/latest/adminguide/find-instance-arn.html">find the instance ID</a> in the Amazon Resource Name (ARN) of the instance.</p>
    ///   - [`prompt_id(impl ::std::convert::Into<String>)`](crate::operation::describe_prompt::builders::DescribePromptFluentBuilder::prompt_id) / [`set_prompt_id(Option<String>)`](crate::operation::describe_prompt::builders::DescribePromptFluentBuilder::set_prompt_id): <p>A unique identifier for the prompt.</p>
