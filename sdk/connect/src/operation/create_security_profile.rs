...
impl CreateSecurityProfileInput {
    /// Consumes the builder and constructs an Operation<[`CreateSecurityProfile`](crate::operation::create_security_profile::CreateSecurityProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_security_profile::CreateSecurityProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_security_profile::CreateSecurityProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/security-profiles/{InstanceId}", InstanceId = instance_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_security_profile::CreateSecurityProfile::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateSecurityProfile", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateSecurityProfile {
                type Output = ::std::result::Result<crate::operation::create_security_profile::CreateSecurityProfileOutput, crate::operation::create_security_profile::CreateSecurityProfileError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_security_profile::de_create_security_profile_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_security_profile::de_create_security_profile_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateSecurityProfileErrorKind = CreateSecurityProfileError;
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateSecurityProfileError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_security_profile::CreateSecurityProfileError {
...
impl CreateSecurityProfileError {
    ...
    /// Returns `true` if the error kind is `CreateSecurityProfileError::DuplicateResourceException`.
    pub fn is_duplicate_resource_exception(&self) -> bool {
        matches!(self, Self::DuplicateResourceException(_))
    }
    /// Returns `true` if the error kind is `CreateSecurityProfileError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateSecurityProfileError::InvalidParameterException`.
    ...
    /// Returns `true` if the error kind is `CreateSecurityProfileError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateSecurityProfileError::ResourceNotFoundException`.
...
mod _create_security_profile_output;
