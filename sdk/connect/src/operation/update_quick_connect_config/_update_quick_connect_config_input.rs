...
impl UpdateQuickConnectConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_quick_connect_config::UpdateQuickConnectConfigInput, ::aws_smithy_http::operation::error::BuildError> {
