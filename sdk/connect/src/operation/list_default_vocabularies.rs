...
impl ListDefaultVocabulariesInput {
    /// Consumes the builder and constructs an Operation<[`ListDefaultVocabularies`](crate::operation::list_default_vocabularies::ListDefaultVocabularies)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_default_vocabularies::ListDefaultVocabularies, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_default_vocabularies::ListDefaultVocabulariesInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/default-vocabulary-summary/{InstanceId}", InstanceId = instance_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_default_vocabularies::ListDefaultVocabularies::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListDefaultVocabularies", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListDefaultVocabularies {
                type Output = ::std::result::Result<crate::operation::list_default_vocabularies::ListDefaultVocabulariesOutput, crate::operation::list_default_vocabularies::ListDefaultVocabulariesError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_default_vocabularies::de_list_default_vocabularies_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_default_vocabularies::de_list_default_vocabularies_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListDefaultVocabulariesErrorKind = ListDefaultVocabulariesError;
/// Error type for the `ListDefaultVocabulariesError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum ListDefaultVocabulariesError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListDefaultVocabulariesError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_default_vocabularies::ListDefaultVocabulariesError {
...
impl ListDefaultVocabulariesError {
    /// Creates the `ListDefaultVocabulariesError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListDefaultVocabulariesError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListDefaultVocabulariesError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `ListDefaultVocabulariesError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ListDefaultVocabulariesError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListDefaultVocabulariesError::ThrottlingException`.
...
mod _list_default_vocabularies_output;
