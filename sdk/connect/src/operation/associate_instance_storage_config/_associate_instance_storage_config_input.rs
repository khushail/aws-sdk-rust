...
impl AssociateInstanceStorageConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::associate_instance_storage_config::AssociateInstanceStorageConfigInput, ::aws_smithy_http::operation::error::BuildError> {
