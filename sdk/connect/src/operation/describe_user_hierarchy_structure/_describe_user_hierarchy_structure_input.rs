...
impl DescribeUserHierarchyStructureInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_user_hierarchy_structure::DescribeUserHierarchyStructureInput, ::aws_smithy_http::operation::error::BuildError> {
