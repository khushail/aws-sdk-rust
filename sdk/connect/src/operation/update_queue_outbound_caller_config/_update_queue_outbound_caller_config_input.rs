...
impl UpdateQueueOutboundCallerConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_queue_outbound_caller_config::UpdateQueueOutboundCallerConfigInput, ::aws_smithy_http::operation::error::BuildError> {
