...
impl AssociateLambdaFunctionInput {
    /// Consumes the builder and constructs an Operation<[`AssociateLambdaFunction`](crate::operation::associate_lambda_function::AssociateLambdaFunction)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::associate_lambda_function::AssociateLambdaFunction, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::associate_lambda_function::AssociateLambdaFunctionInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::associate_lambda_function::AssociateLambdaFunction::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("AssociateLambdaFunction", "connect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `AssociateLambdaFunction`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for AssociateLambdaFunction {
                type Output = ::std::result::Result<crate::operation::associate_lambda_function::AssociateLambdaFunctionOutput, crate::operation::associate_lambda_function::AssociateLambdaFunctionError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_associate_lambda_function::de_associate_lambda_function_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_associate_lambda_function::de_associate_lambda_function_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type AssociateLambdaFunctionErrorKind = AssociateLambdaFunctionError;
/// Error type for the `AssociateLambdaFunctionError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for AssociateLambdaFunctionError {
...
impl ::aws_http::request_id::RequestId for crate::operation::associate_lambda_function::AssociateLambdaFunctionError {
...
impl AssociateLambdaFunctionError {
    /// Creates the `AssociateLambdaFunctionError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `AssociateLambdaFunctionError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `AssociateLambdaFunctionError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `AssociateLambdaFunctionError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `AssociateLambdaFunctionError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `AssociateLambdaFunctionError::ResourceConflictException`.
    pub fn is_resource_conflict_exception(&self) -> bool {
        matches!(self, Self::ResourceConflictException(_))
    }
    /// Returns `true` if the error kind is `AssociateLambdaFunctionError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `AssociateLambdaFunctionError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `AssociateLambdaFunctionError::ThrottlingException`.
...
mod _associate_lambda_function_output;
