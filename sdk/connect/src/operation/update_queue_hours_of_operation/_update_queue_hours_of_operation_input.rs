...
impl UpdateQueueHoursOfOperationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_queue_hours_of_operation::UpdateQueueHoursOfOperationInput, ::aws_smithy_http::operation::error::BuildError> {
