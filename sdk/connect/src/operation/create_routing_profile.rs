...
impl CreateRoutingProfileInput {
    /// Consumes the builder and constructs an Operation<[`CreateRoutingProfile`](crate::operation::create_routing_profile::CreateRoutingProfile)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_routing_profile::CreateRoutingProfile, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_routing_profile::CreateRoutingProfileInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/routing-profiles/{InstanceId}", InstanceId = instance_id).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_routing_profile::ser_create_routing_profile_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_routing_profile::CreateRoutingProfile::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateRoutingProfile", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateRoutingProfile {
                type Output = ::std::result::Result<crate::operation::create_routing_profile::CreateRoutingProfileOutput, crate::operation::create_routing_profile::CreateRoutingProfileError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_routing_profile::de_create_routing_profile_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_create_routing_profile::de_create_routing_profile_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type CreateRoutingProfileErrorKind = CreateRoutingProfileError;
/// Error type for the `CreateRoutingProfileError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateRoutingProfileError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_routing_profile::CreateRoutingProfileError {
...
impl CreateRoutingProfileError {
    /// Creates the `CreateRoutingProfileError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateRoutingProfileError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateRoutingProfileError::DuplicateResourceException`.
    pub fn is_duplicate_resource_exception(&self) -> bool {
        matches!(self, Self::DuplicateResourceException(_))
    }
    /// Returns `true` if the error kind is `CreateRoutingProfileError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateRoutingProfileError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `CreateRoutingProfileError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateRoutingProfileError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateRoutingProfileError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateRoutingProfileError::ThrottlingException`.
...
mod _create_routing_profile_output;
