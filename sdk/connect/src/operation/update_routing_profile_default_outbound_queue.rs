...
impl UpdateRoutingProfileDefaultOutboundQueueInput {
    /// Consumes the builder and constructs an Operation<[`UpdateRoutingProfileDefaultOutboundQueue`](crate::operation::update_routing_profile_default_outbound_queue::UpdateRoutingProfileDefaultOutboundQueue)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_routing_profile_default_outbound_queue::UpdateRoutingProfileDefaultOutboundQueue, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_routing_profile_default_outbound_queue::UpdateRoutingProfileDefaultOutboundQueueInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/routing-profiles/{InstanceId}/{RoutingProfileId}/default-outbound-queue", InstanceId = instance_id, RoutingProfileId = routing_profile_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_routing_profile_default_outbound_queue::UpdateRoutingProfileDefaultOutboundQueue::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateRoutingProfileDefaultOutboundQueue", "connect"));
...
/// Do not use this.
            ...
            pub type UpdateRoutingProfileDefaultOutboundQueueErrorKind = UpdateRoutingProfileDefaultOutboundQueueError;
/// Error type for the `UpdateRoutingProfileDefaultOutboundQueueError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_http::result::CreateUnhandledError for UpdateRoutingProfileDefaultOutboundQueueError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateRoutingProfileDefaultOutboundQueueError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_routing_profile_default_outbound_queue::UpdateRoutingProfileDefaultOutboundQueueError {
...
impl UpdateRoutingProfileDefaultOutboundQueueError {
    /// Creates the `UpdateRoutingProfileDefaultOutboundQueueError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateRoutingProfileDefaultOutboundQueueError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateRoutingProfileDefaultOutboundQueueError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateRoutingProfileDefaultOutboundQueueError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `UpdateRoutingProfileDefaultOutboundQueueError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateRoutingProfileDefaultOutboundQueueError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateRoutingProfileDefaultOutboundQueueError::ThrottlingException`.
...
mod _update_routing_profile_default_outbound_queue_output;
