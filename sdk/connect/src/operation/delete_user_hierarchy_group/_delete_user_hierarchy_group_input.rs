...
impl DeleteUserHierarchyGroupInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_user_hierarchy_group::DeleteUserHierarchyGroupInput, ::aws_smithy_http::operation::error::BuildError> {
