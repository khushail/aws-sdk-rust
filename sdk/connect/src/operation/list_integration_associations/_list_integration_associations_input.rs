...
impl ListIntegrationAssociationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_integration_associations::ListIntegrationAssociationsInput, ::aws_smithy_http::operation::error::BuildError> {
