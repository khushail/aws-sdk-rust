...
impl CreateQuickConnectInput {
    /// Consumes the builder and constructs an Operation<[`CreateQuickConnect`](crate::operation::create_quick_connect::CreateQuickConnect)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_quick_connect::CreateQuickConnect, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_quick_connect::CreateQuickConnectInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_create_quick_connect::ser_create_quick_connect_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_quick_connect::CreateQuickConnect::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateQuickConnect", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateQuickConnect {
                type Output = ::std::result::Result<crate::operation::create_quick_connect::CreateQuickConnectOutput, crate::operation::create_quick_connect::CreateQuickConnectError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_quick_connect::de_create_quick_connect_http_error(status, headers, body)
                     } else {
...
/// Do not use this.
            ...
            pub type CreateQuickConnectErrorKind = CreateQuickConnectError;
/// Error type for the `CreateQuickConnectError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateQuickConnectError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_quick_connect::CreateQuickConnectError {
...
impl CreateQuickConnectError {
    /// Creates the `CreateQuickConnectError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateQuickConnectError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateQuickConnectError::DuplicateResourceException`.
    pub fn is_duplicate_resource_exception(&self) -> bool {
        matches!(self, Self::DuplicateResourceException(_))
    }
    /// Returns `true` if the error kind is `CreateQuickConnectError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateQuickConnectError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `CreateQuickConnectError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateQuickConnectError::LimitExceededException`.
    pub fn is_limit_exceeded_exception(&self) -> bool {
        matches!(self, Self::LimitExceededException(_))
    }
    /// Returns `true` if the error kind is `CreateQuickConnectError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateQuickConnectError::ThrottlingException`.
...
mod _create_quick_connect_output;
