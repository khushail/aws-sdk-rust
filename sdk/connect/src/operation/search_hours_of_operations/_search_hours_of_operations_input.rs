...
impl SearchHoursOfOperationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::search_hours_of_operations::SearchHoursOfOperationsInput, ::aws_smithy_http::operation::error::BuildError> {
