...
impl DismissUserContactInput {
    /// Consumes the builder and constructs an Operation<[`DismissUserContact`](crate::operation::dismiss_user_contact::DismissUserContact)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::dismiss_user_contact::DismissUserContact, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::dismiss_user_contact::DismissUserContactInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/users/{InstanceId}/{UserId}/contact", InstanceId = instance_id, UserId = user_id).expect("formatting should succeed");
        ...
        let body = ::aws_smithy_http::body::SdkBody::from(
            crate::protocol_serde::shape_dismiss_user_contact::ser_dismiss_user_contact_input(&self)?
        );
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::dismiss_user_contact::DismissUserContact::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("DismissUserContact", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for DismissUserContact {
                type Output = ::std::result::Result<crate::operation::dismiss_user_contact::DismissUserContactOutput, crate::operation::dismiss_user_contact::DismissUserContactError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_dismiss_user_contact::de_dismiss_user_contact_http_error(status, headers, body)
                     } else {
...
/// Do not use this.
            ...
            pub type DismissUserContactErrorKind = DismissUserContactError;
/// Error type for the `DismissUserContactError` operation.
#[non_exhaustive]
#[derive(::std::fmt::Debug)]
pub enum DismissUserContactError {
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for DismissUserContactError {
...
impl ::aws_http::request_id::RequestId for crate::operation::dismiss_user_contact::DismissUserContactError {
...
impl DismissUserContactError {
    /// Creates the `DismissUserContactError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `DismissUserContactError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `DismissUserContactError::AccessDeniedException`.
    pub fn is_access_denied_exception(&self) -> bool {
        matches!(self, Self::AccessDeniedException(_))
    }
    /// Returns `true` if the error kind is `DismissUserContactError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `DismissUserContactError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `DismissUserContactError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `DismissUserContactError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `DismissUserContactError::ThrottlingException`.
...
mod _dismiss_user_contact_output;
