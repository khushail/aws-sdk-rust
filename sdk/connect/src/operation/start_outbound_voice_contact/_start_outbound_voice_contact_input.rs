...
impl StartOutboundVoiceContactInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::start_outbound_voice_contact::StartOutboundVoiceContactInput, ::aws_smithy_http::operation::error::BuildError> {
