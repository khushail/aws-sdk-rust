...
impl CreateUseCaseInput {
    /// Consumes the builder and constructs an Operation<[`CreateUseCase`](crate::operation::create_use_case::CreateUseCase)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::create_use_case::CreateUseCase, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::create_use_case::CreateUseCaseInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::create_use_case::CreateUseCase::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("CreateUseCase", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for CreateUseCase {
                type Output = ::std::result::Result<crate::operation::create_use_case::CreateUseCaseOutput, crate::operation::create_use_case::CreateUseCaseError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_create_use_case::de_create_use_case_http_error(status, headers, body)
                     } else {
...
/// Do not use this.
            ...
            pub type CreateUseCaseErrorKind = CreateUseCaseError;
/// Error type for the `CreateUseCaseError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for CreateUseCaseError {
...
impl ::aws_http::request_id::RequestId for crate::operation::create_use_case::CreateUseCaseError {
...
impl CreateUseCaseError {
    /// Creates the `CreateUseCaseError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `CreateUseCaseError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `CreateUseCaseError::DuplicateResourceException`.
    pub fn is_duplicate_resource_exception(&self) -> bool {
        matches!(self, Self::DuplicateResourceException(_))
    }
    /// Returns `true` if the error kind is `CreateUseCaseError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `CreateUseCaseError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `CreateUseCaseError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `CreateUseCaseError::ThrottlingException`.
