...
impl ListEvaluationFormVersionsOutputBuilder {
    ...
    /// <p>Provides details about a list of evaluation forms belonging to an instance.</p>
    pub fn set_evaluation_form_version_summary_list(mut self, input: ::std::option::Option<::std::vec::Vec<crate::types::EvaluationFormVersionSummary>>) -> Self {
        self.evaluation_form_version_summary_list = input; self
    }
    /// <p>Provides details about a list of evaluation forms belonging to an instance.</p>
