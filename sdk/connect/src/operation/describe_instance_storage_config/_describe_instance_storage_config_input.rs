...
impl DescribeInstanceStorageConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::describe_instance_storage_config::DescribeInstanceStorageConfigInput, ::aws_smithy_http::operation::error::BuildError> {
