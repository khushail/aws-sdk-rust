...
impl ListContactFlowsInput {
    /// Consumes the builder and constructs an Operation<[`ListContactFlows`](crate::operation::list_contact_flows::ListContactFlows)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::list_contact_flows::ListContactFlows, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::list_contact_flows::ListContactFlowsInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/contact-flows-summary/{InstanceId}", InstanceId = instance_id).expect("formatting should succeed");
                ::std::result::Result::Ok(())
            }
            fn uri_query(_input: &crate::operation::list_contact_flows::ListContactFlowsInput, mut output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
            ...
            fn update_http_builder(
                            input: &crate::operation::list_contact_flows::ListContactFlowsInput,
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::list_contact_flows::ListContactFlows::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("ListContactFlows", "connect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `ListContactFlows`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for ListContactFlows {
                type Output = ::std::result::Result<crate::operation::list_contact_flows::ListContactFlowsOutput, crate::operation::list_contact_flows::ListContactFlowsError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_list_contact_flows::de_list_contact_flows_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_list_contact_flows::de_list_contact_flows_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type ListContactFlowsErrorKind = ListContactFlowsError;
/// Error type for the `ListContactFlowsError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for ListContactFlowsError {
...
impl ::aws_http::request_id::RequestId for crate::operation::list_contact_flows::ListContactFlowsError {
...
impl ListContactFlowsError {
    /// Creates the `ListContactFlowsError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `ListContactFlowsError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `ListContactFlowsError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `ListContactFlowsError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `ListContactFlowsError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `ListContactFlowsError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `ListContactFlowsError::ThrottlingException`.
...
mod _list_contact_flows_output;
