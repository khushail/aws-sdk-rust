...
impl UpdateUserIdentityInfoInput {
    /// Consumes the builder and constructs an Operation<[`UpdateUserIdentityInfo`](crate::operation::update_user_identity_info::UpdateUserIdentityInfo)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(&self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::update_user_identity_info::UpdateUserIdentityInfo, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::update_user_identity_info::UpdateUserIdentityInfoInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                ...
                ::std::write!(output, "/users/{InstanceId}/{UserId}/identity-info", InstanceId = instance_id, UserId = user_id).expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::update_user_identity_info::UpdateUserIdentityInfo::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("UpdateUserIdentityInfo", "connect"));
...
impl ::aws_smithy_http::response::ParseStrictResponse for UpdateUserIdentityInfo {
                type Output = ::std::result::Result<crate::operation::update_user_identity_info::UpdateUserIdentityInfoOutput, crate::operation::update_user_identity_info::UpdateUserIdentityInfoError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_update_user_identity_info::de_update_user_identity_info_http_error(status, headers, body)
                     } else {
                        crate::protocol_serde::shape_update_user_identity_info::de_update_user_identity_info_http_response_with_props(status, headers, body)
                     }
                }
...
/// Do not use this.
            ...
            pub type UpdateUserIdentityInfoErrorKind = UpdateUserIdentityInfoError;
/// Error type for the `UpdateUserIdentityInfoError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for UpdateUserIdentityInfoError {
...
impl ::aws_http::request_id::RequestId for crate::operation::update_user_identity_info::UpdateUserIdentityInfoError {
...
impl UpdateUserIdentityInfoError {
    /// Creates the `UpdateUserIdentityInfoError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `UpdateUserIdentityInfoError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `UpdateUserIdentityInfoError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserIdentityInfoError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserIdentityInfoError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserIdentityInfoError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `UpdateUserIdentityInfoError::ThrottlingException`.
...
mod _update_user_identity_info_output;
