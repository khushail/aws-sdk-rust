...
impl UpdateInstanceStorageConfigInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::update_instance_storage_config::UpdateInstanceStorageConfigInput, ::aws_smithy_http::operation::error::BuildError> {
