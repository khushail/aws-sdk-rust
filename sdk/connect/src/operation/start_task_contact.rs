...
impl StartTaskContactInput {
    /// Consumes the builder and constructs an Operation<[`StartTaskContact`](crate::operation::start_task_contact::StartTaskContact)>
    #[allow(unused_mut)]
    #[allow(clippy::let_and_return)]
    #[allow(clippy::needless_borrow)]
    pub async fn make_operation(mut self, _config: &crate::config::Config) -> ::std::result::Result<::aws_smithy_http::operation::Operation<crate::operation::start_task_contact::StartTaskContact, ::aws_http::retry::AwsResponseRetryClassifier>, ::aws_smithy_http::operation::error::BuildError> {
        ...
        let mut request = {
            fn uri_base(_input: &crate::operation::start_task_contact::StartTaskContactInput, output: &mut ::std::string::String) -> ::std::result::Result<(), ::aws_smithy_http::operation::error::BuildError> {
                use ::std::fmt::Write as _;
                ::std::write!(output, "/contact/task").expect("formatting should succeed");
        ...
        let op = ::aws_smithy_http::operation::Operation::new(request, crate::operation::start_task_contact::StartTaskContact::new())
                            .with_metadata(::aws_smithy_http::operation::Metadata::new("StartTaskContact", "connect"));
        let op = op.with_retry_classifier(::aws_http::retry::AwsResponseRetryClassifier::new());
        ::std::result::Result::Ok(op)
    }
}
/// Orchestration and serialization glue logic for `StartTaskContact`.
...
impl ::aws_smithy_http::response::ParseStrictResponse for StartTaskContact {
                type Output = ::std::result::Result<crate::operation::start_task_contact::StartTaskContactOutput, crate::operation::start_task_contact::StartTaskContactError>;
                fn parse(&self, response: &::http::Response<::bytes::Bytes>) -> Self::Output {
                     ...
                     if !success && status != 200 {
                        crate::protocol_serde::shape_start_task_contact::de_start_task_contact_http_error(status, headers, body)
                     } else {
...
/// Do not use this.
            ...
            pub type StartTaskContactErrorKind = StartTaskContactError;
/// Error type for the `StartTaskContactError` operation.
#[non_exhaustive]
...
impl ::aws_smithy_types::error::metadata::ProvideErrorMetadata for StartTaskContactError {
...
impl ::aws_http::request_id::RequestId for crate::operation::start_task_contact::StartTaskContactError {
...
impl StartTaskContactError {
    /// Creates the `StartTaskContactError::Unhandled` variant from any error type.
                    ...
                    /// Creates the `StartTaskContactError::Unhandled` variant from a `::aws_smithy_types::error::ErrorMetadata`.
    ...
    /// Returns `true` if the error kind is `StartTaskContactError::InternalServiceException`.
    pub fn is_internal_service_exception(&self) -> bool {
        matches!(self, Self::InternalServiceException(_))
    }
    /// Returns `true` if the error kind is `StartTaskContactError::InvalidParameterException`.
    pub fn is_invalid_parameter_exception(&self) -> bool {
        matches!(self, Self::InvalidParameterException(_))
    }
    /// Returns `true` if the error kind is `StartTaskContactError::InvalidRequestException`.
    pub fn is_invalid_request_exception(&self) -> bool {
        matches!(self, Self::InvalidRequestException(_))
    }
    /// Returns `true` if the error kind is `StartTaskContactError::ResourceNotFoundException`.
    pub fn is_resource_not_found_exception(&self) -> bool {
        matches!(self, Self::ResourceNotFoundException(_))
    }
    /// Returns `true` if the error kind is `StartTaskContactError::ServiceQuotaExceededException`.
    pub fn is_service_quota_exceeded_exception(&self) -> bool {
        matches!(self, Self::ServiceQuotaExceededException(_))
    }
    /// Returns `true` if the error kind is `StartTaskContactError::ThrottlingException`.
...
mod _start_task_contact_output;
