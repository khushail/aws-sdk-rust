...
#[allow(clippy::unnecessary_wraps)]
pub fn de_list_phone_numbers_v2_http_response_with_props(_response_status: u16, _response_headers: &::http::header::HeaderMap, _response_body: &[u8]) -> std::result::Result<crate::operation::list_phone_numbers_v2::ListPhoneNumbersV2Output, crate::operation::list_phone_numbers_v2::ListPhoneNumbersV2Error> {
    Ok({
        #[allow(unused_mut)]
