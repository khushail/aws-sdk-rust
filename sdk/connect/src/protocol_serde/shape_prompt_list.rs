...
pub(crate) fn de_prompt_list<'a, I>(tokens: &mut ::std::iter::Peekable<I>) -> Result<Option<::std::vec::Vec<crate::types::Prompt>>, ::aws_smithy_json::deserialize::error::DeserializeError>
