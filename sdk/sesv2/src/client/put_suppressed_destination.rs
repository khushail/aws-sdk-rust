...
impl super::Client  {
    ...
    ///   - [`email_address(impl ::std::convert::Into<String>)`](crate::operation::put_suppressed_destination::builders::PutSuppressedDestinationFluentBuilder::email_address) / [`set_email_address(Option<String>)`](crate::operation::put_suppressed_destination::builders::PutSuppressedDestinationFluentBuilder::set_email_address): <p>The email address that should be added to the suppression list for your account.</p>
