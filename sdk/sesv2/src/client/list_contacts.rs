...
impl super::Client  {
    ...
    ///   - [`contact_list_name(impl ::std::convert::Into<String>)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::contact_list_name) / [`set_contact_list_name(Option<String>)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::set_contact_list_name): <p>The name of the contact list.</p>
    ...
    ///   - [`next_token(impl ::std::convert::Into<String>)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::next_token) / [`set_next_token(Option<String>)`](crate::operation::list_contacts::builders::ListContactsFluentBuilder::set_next_token): <p>A string token indicating that there might be additional contacts available to be listed. Use the token provided in the Response to use in the subsequent call to ListContacts with the same parameters to retrieve the next page of contacts.</p>
