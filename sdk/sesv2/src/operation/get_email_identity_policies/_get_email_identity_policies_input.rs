...
impl GetEmailIdentityPoliciesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_email_identity_policies::GetEmailIdentityPoliciesInput, ::aws_smithy_http::operation::error::BuildError> {
