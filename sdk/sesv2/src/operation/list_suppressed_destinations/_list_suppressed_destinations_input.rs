...
impl ListSuppressedDestinationsInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::list_suppressed_destinations::ListSuppressedDestinationsInput, ::aws_smithy_http::operation::error::BuildError> {
