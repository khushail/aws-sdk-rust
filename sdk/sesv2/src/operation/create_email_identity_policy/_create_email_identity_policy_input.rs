...
impl CreateEmailIdentityPolicyInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::create_email_identity_policy::CreateEmailIdentityPolicyInput, ::aws_smithy_http::operation::error::BuildError> {
