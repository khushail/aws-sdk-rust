...
impl DeleteSuppressedDestinationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::delete_suppressed_destination::DeleteSuppressedDestinationInput, ::aws_smithy_http::operation::error::BuildError> {
