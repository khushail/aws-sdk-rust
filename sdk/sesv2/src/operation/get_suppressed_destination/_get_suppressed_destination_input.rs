...
impl GetSuppressedDestinationInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_suppressed_destination::GetSuppressedDestinationInput, ::aws_smithy_http::operation::error::BuildError> {
