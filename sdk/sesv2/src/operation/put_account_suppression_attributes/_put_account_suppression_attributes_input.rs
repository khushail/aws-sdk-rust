...
impl PutAccountSuppressionAttributesInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::put_account_suppression_attributes::PutAccountSuppressionAttributesInput, ::aws_smithy_http::operation::error::BuildError> {
