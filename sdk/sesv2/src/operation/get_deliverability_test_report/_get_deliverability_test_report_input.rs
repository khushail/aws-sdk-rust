...
impl GetDeliverabilityTestReportInputBuilder {
    ...
    pub fn build(self) -> ::std::result::Result<crate::operation::get_deliverability_test_report::GetDeliverabilityTestReportInput, ::aws_smithy_http::operation::error::BuildError> {
